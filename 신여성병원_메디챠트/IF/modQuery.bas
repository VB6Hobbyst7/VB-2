...
'
                If strBarcode <> "" And strTestCd <> "" And sResult <> "" Then
                    ...
                    SQL = SQL & "     , TAT_완료일자    = '" & Format(Now, "yyyy-mm-dd hh:mm:ss") & "'" & vbCrLf
                    ...
                    '-- 상태업데이트
                    SQL = ""
                    SQL = SQL & "Update TB_진료내역 "
                    SQL = SQL & "   Set 진료지원상태    = 5                                 " & vbCrLf '1 : 처치중, 5 : 완료
                    SQL = SQL & "     , 시행2           = '" & Format(Now, "hh:mm:ss") & "'" & vbCrLf
                    SQL = SQL & " Where 진료년          = '" & strYear & "'                 " & vbCrLf
                    SQL = SQL & "   and 진료월          = '" & strMonth & "'                " & vbCrLf
                    SQL = SQL & "   and 진료일          = '" & strDay & "'                  " & vbCrLf
                    SQL = SQL & "   and 챠트번호        = '" & strChartNo & "'              " & vbCrLf
...
On Error GoTo ErrHandle
    ...
    SQL = SQL & "   And (a.진료월 + a.진료일) BETWEEN '" & strFMonth & strFDay & "' and '" & strTMonth & strTDay & "'" & vbCrLf
    'SQL = SQL & "   And a.진료일 BETWEEN '" & strFDay & "' and '" & strTDay & "'    " & vbCrLf
    SQL = SQL & "   And a.처방번호 > 0                                              " & vbCrLf
    'SQL = SQL & "   And c.진료상태 IN ('1','5','6','7','8','9')                     " & vbCrLf
    SQL = SQL & "   And c.진료상태 IN ('1','2','5','6','7','8','9')                     " & vbCrLf
