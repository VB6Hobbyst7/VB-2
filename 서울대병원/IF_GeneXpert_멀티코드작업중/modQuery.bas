...
Function SaveTransData_EASYCARE(ByVal argSpcRow As Integer, ByVal SPD As Object) As Integer
    ...
    Dim varEV           As Variant
    Dim varCov          As Variant
    Dim varCD           As Variant
    Dim varMTB          As Variant
    Dim i               As Integer
        ...
        If Not RS_L.EOF = True And Not RS_L.BOF = True Then
            Do Until RS_L.EOF
                ...
                If strBarcode <> "" And strTestCd <> "" And sResult <> "" Then
                    ...
                    'EV
                    For i = 0 To UBound(varEV)
                        If strTestCd = varEV(i) Then    '"L2531"
                            strEV = ""
                    ...
                    'MTB
                    For i = 0 To UBound(varMTB)
                        If strTestCd = varMTB(i) Then '"L25404"
                    ...
                    For i = 0 To UBound(varCD)
                        If strTestCd = varCD(i) Then    '"L25474"
                    ...
                    For i = 0 To UBound(varCov)
                        'ElseIf strTestCd = "L25616" Then
                        If strTestCd = varCov(i) Then    '"L25622"
                            strCoV = sResult
