...
Begin VB.Form frmMain 
   ...
   Begin VB.PictureBox picComm 
      ...
      Visible         =   0   'False
      Width           =   28560
      Begin FPSpread.vaSpread spdCase 
         Height          =   2235
         Left            =   120
         TabIndex        =   80
         Top             =   30
         ...
         ShadowColor     =   15400959
         ShadowDark      =   0
         SpreadDesigner  =   "frmMain.frx":5826
      End
   ...
   Begin FPSpread.vaSpread spdResult 
      ...
      SpreadDesigner  =   "frmMain.frx":665E
      ScrollBarTrack  =   3
      ShowScrollTips  =   3
   End
      ...
      Begin MSComctlLib.ImageList imlStatus 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMain.frx":72DF
               Key             =   "RUN"
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMain.frx":7879
               Key             =   "NOT"
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMain.frx":7E13
               Key             =   "STOP"
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMain.frx":83AD
               Key             =   "LST"
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMain.frx":8C3F
               Key             =   "ITM"
            EndProperty
            BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMain.frx":8D99
               Key             =   "ERR"
            EndProperty
            BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMain.frx":8EF3
               Key             =   "NOF"
            EndProperty
            BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMain.frx":904D
               Key             =   "ON"
               Object.Tag             =   "OFF"
            EndProperty
            BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMain.frx":9927
               Key             =   ""
            EndProperty
         EndProperty
      End
   ...
   Begin FPSpread.vaSpread spdOrder 
      ...
      ShadowColor     =   16777215
      SpreadDesigner  =   "frmMain.frx":C811
      ScrollBarTrack  =   3
      ShowScrollTips  =   3
   End
   Begin FPSpread.vaSpread spdWork 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   16777215
      SpreadDesigner  =   "frmMain.frx":E7D2
      ScrollBarTrack  =   3
      ShowScrollTips  =   3
   End
...
Private Sub ChkSave1_Click()

    If ChkSave1.Value = "1" Then
        ChkSave2.Value = "0"
    End If

End Sub

Private Sub ChkSave2_Click()
    
    If ChkSave2.Value = "1" Then
        ChkSave1.Value = "0"
    End If
...
Private Sub cmdRef_Click()
    ...
    If cmdRef.Caption = "▽ 참고치정보" Then
        cmdRef.Caption = "△ 참고치정보"
'''        ' Chart Type Settings
'''ChartFX.Gallery = Lines
'''ChartFX.Chart3D = False
'''ChartFX.MarkerShape = MK_NONE
'''ChartFX.Axis(2).Grid = True
'''ChartFX.Axis(0).Grid = True
'''
'''' Color Settings
'''ChartFX.Border = False
'''
'''' Layout Settings
'''ChartFX.SerLegBox = True
'''ChartFX.SerLegBoxObj.Docked = 258
'''ChartFX.Toolbar = False
'''ChartFX.Title(CHART_TOPTIT) = ""
'''
            
'        ChartFX1.TOP = 0
'        ChartFX1.LEFT = spdOrder.LEFT

        spdCase.TOP = 0
        spdCase.LEFT = spdOrder.LEFT
        'spdExcel.LEFT = spdResult.LEFT   'spdCase.LEFT + spdCase.WIDTH + 200
...
'    Call SpreadSheetSort(vasExcel, 6, 2)
    ...
    spdExcel.ColWidth(1) = 0
    spdExcel.ColWidth(2) = 6
    spdExcel.ColWidth(3) = 6
    spdExcel.ColWidth(4) = 7
    spdExcel.ColWidth(8) = 0
...
On Error GoTo ErrHandle
    ...
    With frmMain
        ...
        For intRow = intRow2 To spdExcel.MaxRows
            strWell = GetText(spdExcel, intRow, 2)
            'strBarno = GetText(spdExcel, intRow, 6)
            strBarno = GetText(spdExcel, intRow, 5)
            strTmp = strBarno
            If strBarno = "" Then
               'Exit Sub
            End If
            ...
            strIntBase = GetText(spdExcel, intRow, 3)
            'HEX=E, Cy5=I.C, FAM=RDRP
            If strIntBase = "ORF1ab" Then
                strIntBase = "RdRP"
            End If
            
            If UCase(strIntBase) = "HEX" Then
                strIntBase = "E"
            End If
            If UCase(strIntBase) = "FAM" Then
                strIntBase = "RdRP"
            End If
            If UCase(strIntBase) = "CY5" Then
                strIntBase = "I.C."
            End If
            
            
            'strResult = GetText(spdExcel, intRow, 7)
            strResult = GetText(spdExcel, intRow, 6)
            strIntResult = strResult

            If strIntBase <> "" And strResult <> "" Then
                If (strIntBase = "E" Or strIntBase = "RdRP") And strResult <> "" Then
                    blnPosData = True
                    'spdOrder.Visible = True
                End If
                If strState = "" Or strState = "O" Then
                ...
                If ResultProcess(mResult.BarNo, strIntBase, strResult, strIntResult, False) = True Then
                    strState = "R"
                Else
                    If strState = "" Then
                        strState = ""
        ...
        '연산 : 서울대병원 기준
        'Sample Name    E (JOE) Ct      RdRp (FAM) Ct           IC (CY5) Ct Interpretation  Comment
        'Sample 01      ≤36            ≤36                    기준 X      Positive        33 이후 주의
        'Sample 02      N/A             N/A                     ≤32        Negative
        'Sample 03      N/A             >36,or ≤36             ≤32        Inconclusive    Retest
        'Sample 04      >36             NA, or >36, or ≤36     ≤32        Inconclusive    Retest
        'Sample 05      ≤36            >36                     ≤32        Inconclusive    Retest
        'NC             N/A             N/A                     기준 X      Valid
        'PC             ≤30            ≤30                    ≤32        Valid
        ...
        For intRow = 1 To spdOrder.MaxRows
            ...
            Call GetSampleInfo_EASYCARE(intRow, spdOrder)
            ...
            For intCol = colITEMS To spdOrder.MaxCols
                ...
                End If
                If GetText(spdOrder, 0, intCol) = "ICA" Or GetText(spdOrder, 0, intCol) = "I.C." Then
            ...
            If strResult = "" Then
                If strEval = "" Then
                    strEVal_NP = "Iconclusive"
                End If
                
                If strRdRP <> "" And IsNumeric(strRdRP) Then
                    If CCur(strRdRP) > 36 Or CCur(strRdRP) <= 36 Then
                        strRdRP_NP = "Iconclusive"
                    End If
                End If
                
                If strICA <> "" And IsNumeric(strICA) Then
                    If CCur(strICA) <= 32 Then
                        strICA_NP = "Iconclusive"
                    End If
                End If
                
                If strRdRP_NP = "Iconclusive" And strEVal_NP = "Iconclusive" And strICA_NP = "Iconclusive" Then
                    strResult = "Iconclusive"
                End If
            End If
            ...
            If strIntBase <> "" And strResult <> "" Then
                ...
                If ResultProcess(mResult.BarNo, strIntBase, strResult, strIntResult, True) = True Then
                    strState = "R"
                Else
                    If strState = "" Then
                        strState = ""
...
Private Function ResultProcess(ByVal pBarNo As String, ByVal pIntBase As String, ByVal pResult As String, ByVal pIntResult As String, Optional ByVal pLast As Boolean = False) As Boolean
    Dim RS_L            As ADODB.Recordset
    Dim strOrderCode    As String   '처방코드
    Dim strTestName     As String   '검사코드
    Dim strAbbrName     As String   '검사코드
...
Private Sub spdOrder_DblClick(ByVal Col As Long, ByVal Row As Long)
    ...
    If Col = colSEQNO Then
        'If InputBox("자동발" & Space(5) & "hint:개발자oyh") = "dev0503" Then
...
'    With frmWell
'        If Col = colRACKNO Then
'            If .fraWell.Visible = True Then
'                .fraWell.Visible = False
'            Else
'                .txtRow.Text = Row
'                .spdWell.BackColor = vbWhite
'                .fraWell.LEFT = spdOrder.LEFT + 4000
'                .fraWell.TOP = spdOrder.TOP + 1000
'                .fraWell.Visible = True
'            End If
'        End If
'    End With
...
'                .BackColor = vbYellow
'                Call SetText(spdOrder, Mid(spdWell.Text, 1, 1), txtRow.Text, colRACKNO)
'                Call SetText(spdOrder, Mid(spdWell.Text, 2), txtRow.Text, colPOSNO)
