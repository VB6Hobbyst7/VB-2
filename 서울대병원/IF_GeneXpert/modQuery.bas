...
Function SaveTransData_EASYCARE(ByVal argSpcRow As Integer, ByVal SPD As Object) As Integer
    ...
    Dim strMTBRslt      As String
    Dim strRIFRslt      As String
    Dim strMTBRIF       As String
    
    Dim strCdiff        As String
    Dim str027          As String
    Dim strToxinB       As String
    Dim strBinToxin     As String
    Dim strTcdc         As String
    Dim strCD           As String
    
    Dim strE            As String
    Dim strN2           As String
    Dim strE_Ct         As String
    Dim strN2_Ct        As String
    Dim strCoV          As String
    Dim strCoVid19      As String
...
On Error GoTo ErrHandle
    ...
    With frmMain
        ...
        SQL = SQL & "   AND MID(EXAMDATE,1,10) = '" & Mid(strExamDate, 1, 10) & "'" & vbCr  '검사일
        ...
        If Not RS_L.EOF = True And Not RS_L.BOF = True Then
            Do Until RS_L.EOF
                ...
                If sResult = "INVALID" Then
                    Exit Function
                End If
                
                If strBarcode <> "" And strTestCd <> "" And sResult <> "" Then
                    'EV
                    If strTestCd = "L2531" Then
                        strEV = ""
                        strEV = strEV & "GeneXpert Rapid PCR: " & sResult & vbCrLf
                        strEV = strEV & " - 보고시간: " & Format(Now, "yyyy.mm.dd hh:mm")  '2020.12.03 11:18
                    ...
                    'RIF
                    ElseIf UCase(strTestCd) = "RIF" Then
                        strRIF = "2. Rifampin resistance: " & sResult
                        strRIFRslt = sResult
                    'MTB
                    ElseIf strTestCd = "L25404" Then
                        strMTB = "1. M.tuberculosis (TB): " & sResult
                        strMTBRslt = sResult
                        If pTSTCD = "" Then
                            pTSTCD = strTestCd
                        Else
                    ...
                    '-- CDIFF
                    ElseIf strTestCd = "027" Then
                        str027 = "2. 027/NAP1/BI Strain: " & sResult
                    ElseIf strTestCd = "Binary Toxin" Then
                        strBinToxin = "2. Binary Toxin: " & sResult
                    
                    ElseIf strTestCd = "L25474" Then
                        strCdiff = "1. Toxigenic C. difficile: " & sResult
                    ...
                    ElseIf strTestCd = "TcdC" Then
                        strTcdc = "3. TcdC deletion: " & sResult
                    
                    ElseIf strTestCd = "Toxin B" Then
                        strToxinB = "1. Toxin B: " & sResult
                    
                    '-- CoV
                    ElseIf strTestCd = "E" Then
                        strE = sResult
                    ElseIf strTestCd = "N2" Then
                        strN2 = sResult
                    ElseIf strTestCd = "E Ct" Then
                        strE_Ct = sResult
                    ElseIf strTestCd = "N2 Ct" Then
                        strN2_Ct = sResult
                    'ElseIf strTestCd = "L25616" Then
                    ElseIf strTestCd = "L25622" Then
                        strCoV = sResult
        ...
        If strMTB <> "" Then
            If strRIF = "" Then
                strMTBRIF = ""
                strMTBRIF = strMTBRIF & "[검체]" & vbCrLf
                strMTBRIF = strMTBRIF & strSpcNm & vbCrLf
                strMTBRIF = strMTBRIF & "   " & vbCrLf
                strMTBRIF = strMTBRIF & "[검사결과]" & vbCrLf
                strMTBRIF = strMTBRIF & strMTB & vbCrLf
                strMTBRIF = strMTBRIF & "   " & vbCrLf
                strMTBRIF = strMTBRIF & "[결론]" & vbCrLf
                strMTBRIF = strMTBRIF & "  본 환자의 검체에서 결핵균은 검출되지 않았습니다." & vbCrLf
                strMTBRIF = strMTBRIF & "   " & vbCrLf
                strMTBRIF = strMTBRIF & "--" & vbCrLf
                strMTBRIF = strMTBRIF & "[검사방법] Real-Time Nested PCR(Xpert System)" & vbCrLf
                strMTBRIF = strMTBRIF & "[검사개요]" & vbCrLf
                strMTBRIF = strMTBRIF & "  .검체: 객담, Bronchoalveolar lavage (BAL) fluid." & vbCrLf
                strMTBRIF = strMTBRIF & "         객담 및 BAL fluid 이외의 검체에 대해 임상시험으로 validation 되지 않아 해석에 주의 요망." & vbCrLf
                strMTBRIF = strMTBRIF & "  . 대상: rpoB gene의 80 bp rifampin resistance-determining region" & vbCrLf
                strMTBRIF = strMTBRIF & "  . 의의: 결핵균 유무와 리팜핀 내성 유무를 Real-Time Nested PCR법으로 검사함." & vbCrLf
                strMTBRIF = strMTBRIF & "  . 보고: 익일 보고함." & vbCrLf
                strMTBRIF = strMTBRIF & "--" & vbCrLf
                strMTBRIF = strMTBRIF & "[검사문의] 서울대병원 진단검사의학과 분자유전검사실, T.(02)2072-2937, 0883"
            ...
            ElseIf strRIF <> "" Then
                ...
                If strRIFRslt = "NOT DETECTED" Then
                    strMTBRIF = ""
                    strMTBRIF = strMTBRIF & "[검체]" & vbCrLf
                    strMTBRIF = strMTBRIF & strSpcNm & vbCrLf
                    strMTBRIF = strMTBRIF & "   " & vbCrLf
                    strMTBRIF = strMTBRIF & "[검사결과]" & vbCrLf
                    strMTBRIF = strMTBRIF & strMTB & vbCrLf
                    strMTBRIF = strMTBRIF & strRIF & vbCrLf
                    strMTBRIF = strMTBRIF & "   " & vbCrLf
                    strMTBRIF = strMTBRIF & "[결론]" & vbCrLf
                    strMTBRIF = strMTBRIF & " . 본 환자의 검체에서 결핵균이 검출되었습니다. 그러나 rifampin 내성 돌연변이는" & vbCrLf
                    strMTBRIF = strMTBRIF & "검출되지 않았습니다." & vbCrLf
                    strMTBRIF = strMTBRIF & "   " & vbCrLf
                    strMTBRIF = strMTBRIF & "--" & vbCrLf
                    strMTBRIF = strMTBRIF & "[검사방법] Real-Time Nested PCR(Xpert System)" & vbCrLf
                    strMTBRIF = strMTBRIF & "[검사개요]" & vbCrLf
                ...
                ElseIf strRIFRslt = "DETECTED" Then
                    strMTBRIF = ""
                    strMTBRIF = strMTBRIF & "[검체]" & vbCrLf
                    strMTBRIF = strMTBRIF & strSpcNm & vbCrLf
                    strMTBRIF = strMTBRIF & "   " & vbCrLf
                    ...
                    strMTBRIF = strMTBRIF & "   " & vbCrLf
                    strMTBRIF = strMTBRIF & "[결론]" & vbCrLf
                    strMTBRIF = strMTBRIF & " . 본 환자의 검체에서 결핵균이 검출되었으며, 검출된 결핵균에서 rifampin 내성 돌연변이가 검출되었습니다." & vbCrLf
                    strMTBRIF = strMTBRIF & "   " & vbCrLf
                    strMTBRIF = strMTBRIF & "--" & vbCrLf
                    strMTBRIF = strMTBRIF & "[검사방법] Real-Time Nested PCR(Xpert System)" & vbCrLf
                    strMTBRIF = strMTBRIF & "[검사개요]" & vbCrLf
        ...
        ElseIf strCdiff <> "" Then
            strCD = ""
            strCD = strCD & "[검체]" & vbCrLf
            strCD = strCD & strSpcNm & vbCrLf
            strCD = strCD & "   " & vbCrLf
            strCD = strCD & "[검사결과]" & vbCrLf
            strCD = strCD & strToxinB & vbCrLf
            strCD = strCD & strBinToxin & vbCrLf
            strCD = strCD & strTcdc & vbCrLf
            strCD = strCD & "   " & vbCrLf
            strCD = strCD & "[결론]" & vbCrLf
            strCD = strCD & strCdiff & vbCrLf
            strCD = strCD & str027 & vbCrLf
            strCD = strCD & "   " & vbCrLf
            strCD = strCD & "--" & vbCrLf
            strCD = strCD & "[검사방법] Real-Time Nested PCR(Xpert System)" & vbCrLf
            strCD = strCD & "[검사개요]" & vbCrLf
            strCD = strCD & "  1. Target DNA" & vbCrLf
            strCD = strCD & "     (1) Toxin B: C. difficile infection의 원인독소." & vbCrLf
            strCD = strCD & "     (2) Binary Toxin: C.difficile이 분비하는 제 3의 독소로 Toxin B의 독성을 증폭시킴." & vbCrLf
            strCD = strCD & "     (3) tcdC △117: Toxin B 억제유전자의 돌연변이. Toxin B 생성이 증가함." & vbCrLf
            strCD = strCD & "  2. 의의: Toxigenic C. difficile 유무와 027/NAP1/Bl strain 여부를 Real-Time Nested PCR 법으로 검사함." & vbCrLf
            strCD = strCD & "  3. 보고: 익일 보고함." & vbCrLf
            strCD = strCD & "--" & vbCrLf
            strCD = strCD & "[검사문의] 서울대병원 진단검사의학과 분자유전검사실, T.(02)2072-2937, 0883"
        ...
        ElseIf strCoV <> "" Then
            strCoVid19 = ""
            strCoVid19 = strCoVid19 & "[검사명] Xpert Xpress SARS-CoV-2[응급용 선별검사]" & vbCrLf
            strCoVid19 = strCoVid19 & vbCrLf
            
            If strN2 = "POS" Then
                strCoVid19 = strCoVid19 & "[검사결과 및 의견]" & vbCrLf
                strCoVid19 = strCoVid19 & ". SARS-CoV-2:Positive(양성) (검체: " & strSpcNm & ")" & vbCrLf
                strCoVid19 = strCoVid19 & "(N2: " & strN2_Ct & ", E: " & strE_Ct & " )" & vbCrLf
                strCoVid19 = strCoVid19 & "" & vbCrLf
                strCoVid19 = strCoVid19 & "* Comment: Xpert SARS-CoV-2 양성인 경우는 반드시 [COVID-19 확진검사] L25616 2019-nCoV" & vbCrLf
                strCoVid19 = strCoVid19 & "Real-time RT-PCR 를 의뢰하여 주시기 바랍니다." & vbCrLf
                strCoVid19 = strCoVid19 & "" & vbCrLf
                strCoVid19 = strCoVid19 & "--" & vbCrLf
            ElseIf strE = "POS" Then
                strCoVid19 = strCoVid19 & "[검사결과 및 의견]" & vbCrLf
                strCoVid19 = strCoVid19 & ". SARS-CoV-2:Inconclusive(미결정) (검체: " & strSpcNm & ")" & vbCrLf
                strCoVid19 = strCoVid19 & "(N2: " & strN2_Ct & ", E: " & strE_Ct & " )" & vbCrLf
                strCoVid19 = strCoVid19 & "" & vbCrLf
                strCoVid19 = strCoVid19 & "* Comment: Xpert SARS-CoV-2 검사에서 2개의 유전자중 E 유전자만 증폭이 확인되었습니다." & vbCrLf
                strCoVid19 = strCoVid19 & "추가 확인을 위하여 새로 채취한 검체로 [COVID-19 확진검사] L25616 2019-nCoV Real-time " & vbCrLf
                strCoVid19 = strCoVid19 & "RT-PCR 를 의뢰하여 주시기 바랍니다." & vbCrLf
                strCoVid19 = strCoVid19 & "" & vbCrLf
                strCoVid19 = strCoVid19 & "--" & vbCrLf
            ElseIf strE = "NEG" Then
                strCoVid19 = strCoVid19 & "[검사결과 및 의견]" & vbCrLf
                strCoVid19 = strCoVid19 & ". SARS-CoV-2:Negative(음성) (검체: " & strSpcNm & ")" & vbCrLf
                strCoVid19 = strCoVid19 & "" & vbCrLf
                strCoVid19 = strCoVid19 & "--" & vbCrLf
            Else
                'INVALID, ERROR
            ...
            strCoVid19 = strCoVid19 & "[검사방법] Real-Time RT-PCR" & vbCrLf
            strCoVid19 = strCoVid19 & "[검사개요]" & vbCrLf
            strCoVid19 = strCoVid19 & ". 유전자와 검사 : SARS-CoV-2의 N2 segment, E segment를 real-time RT PCR로 검출함." & vbCrLf
            strCoVid19 = strCoVid19 & ". 관련질환과 의의: 발열, 기침, 호흡곤란, 두통, 오한, 인후통, 호흡부전, 패혈성 쇼크, 다발성 장기 부전 등의 COVID-19 감염증의 원인인 SARS-CoV-2를 검출함" & vbCrLf
            strCoVid19 = strCoVid19 & "--" & vbCrLf
            strCoVid19 = strCoVid19 & "[검사문의] 서울대병원 진단검사의학과 분자유전검사실, T.(02)2072-2937, 0883"
            strCoVid19 = strCoVid19 & vbCrLf
        ...
        If pSPCID <> "" Then
            ...
            sParam = sParam & "<P7><![CDATA[" & "2" & "]]></P7>" & vbCrLf               '1 : 접수, 2 : 입력, 3 : 최종보고
            sParam = sParam & "<P8><![CDATA[" & vbTab & "2" & vbTab & "]]></P8>" & vbCrLf
...
Public Sub GetTestList()
    ...
    If Not AdoRs_Local.EOF = True And Not AdoRs_Local.BOF = True Then
        ...
        Do Until AdoRs_Local.EOF
            ...
            strTestCd = Trim(AdoRs_Local.Fields("TESTCODE").Value)
            If strTestCd <> "" Then
                If intRow = 1 Or gAllTestCd = "" Then
                    gAllTestCd = "'" & strTestCd & "'"
                Else
                    gAllTestCd = gAllTestCd & ",'" & strTestCd & "'"
                End If
                
                If LEFT(strTestCd, 1) = "L" Then
                    If InStr(UCase(AdoRs_Local.Fields("ABBRNAME").Value & ""), "EV") > 0 Then
                        gEVCD = gEVCD & strTestCd & ","
                    ElseIf InStr(UCase(AdoRs_Local.Fields("ABBRNAME").Value & ""), "MTB") > 0 Then
                        gMTBCD = gMTBCD & strTestCd & ","
                    ElseIf InStr(UCase(AdoRs_Local.Fields("ABBRNAME").Value & ""), "CD") > 0 Then
                        gCdiffCD = gCdiffCD & strTestCd & ","
                    ElseIf InStr(UCase(AdoRs_Local.Fields("ABBRNAME").Value & ""), "COVID") > 0 Then
                        gCovCD = gCovCD & strTestCd & ","
                    End If
                End If
            End If
    ...
    If gEVCD <> "" Then
        gEVCD = Mid(gEVCD, 1, Len(gEVCD) - 1)
    End If
    
    If gMTBCD <> "" Then
        gMTBCD = Mid(gMTBCD, 1, Len(gMTBCD) - 1)
    End If

    If gCdiffCD <> "" Then
        gCdiffCD = Mid(gCdiffCD, 1, Len(gCdiffCD) - 1)
    End If

    If gCovCD <> "" Then
        gCovCD = Mid(gCovCD, 1, Len(gCovCD) - 1)
    End If
...
RST:
                ...
                strErrMsg = "위    치 : " & gHOSP.MACHNM & "_GetWorkList_EASYCARE" & vbNewLine & vbNewLine
    strErrMsg = strErrMsg & "오류번호 : " & Err.Number & vbNewLine & vbNewLine
    strErrMsg = strErrMsg & "오류내용 : " & Err.Description & vbNewLine
    frmErrMsg.txtErr = vbNewLine & strErrMsg
    frmErrMsg.Show 'vbModal
...
'<NewDataSet>
'    <Table0>
'        <ACPT_DTE><![CDATA[2020-06-01 오전 12:00:00]]></ACPT_DTE>
'        <ACPTNO_1><![CDATA[215]]></ACPTNO_1>
'        <PT_NO><![CDATA[79892344]]></PT_NO>
'        <PATNAME><![CDATA[안시후]]></PATNAME>
'        <SEX><![CDATA[M]]></SEX>
'        <AGE><![CDATA[0]]></AGE>
...
'        <ACPT_DTETM><![CDATA[2020-06-01 오전 10:50:51]]></ACPT_DTETM>
...
'    End If
    ...
    If XmlInfo.PT_NO <> "" Then
        With SPD
            ...
            SetText SPD, "1", asRow, colCHECKBOX
            SetText SPD, XmlInfo.TST_DTE, asRow, colHOSPDATE
            'SetText SPD, XmlSelectS.BCNO(i), asRow, colBARCODE
            SetText SPD, XmlInfo.PT_NO, asRow, colPID
            SetText SPD, XmlInfo.PATNAME, asRow, colPNAME
            SetText SPD, XmlInfo.SEX, asRow, colPSEX
            SetText SPD, XmlInfo.SPC_NM, asRow, colSPECIMEN
...
'<ACPT_DTE><![CDATA[2020-12-22 오전 12:00:00]]></ACPT_DTE>
'        <ACPTNO_1><![CDATA[344]]></ACPTNO_1>
'        <PT_NO><![CDATA[22041467]]></PT_NO>
'        <PATNAME><![CDATA[이영돈]]></PATNAME>
'        <SEX><![CDATA[M]]></SEX>
'        <AGE><![CDATA[73]]></AGE>
'        <SPC_NO><![CDATA[20122117980]]></SPC_NO>
'        <ORD_SITE><![CDATA[038]]></ORD_SITE>
'        <WRK_UNT_CD><![CDATA[TBPCR]]></WRK_UNT_CD>
'        <TST_CD><![CDATA[L25404]]></TST_CD>
'        <TST_SNM><![CDATA[MTB PCR 리팜핀내성 포함]]></TST_SNM>
'        <SPC_NM><![CDATA[객담]]></SPC_NM>
'        <TST_STAT><![CDATA[1]]></TST_STAT>
'        <ACPT_DTETM><![CDATA[2020-12-22 오후 2:13:29]]></ACPT_DTETM>
'        <DOCTORNOTE_YN><![CDATA[N]]></DOCTORNOTE_YN>
'        <TSNO><![CDATA[]]></TSNO>
'        <DEXM_YENU><![CDATA[]]></DEXM_YENU>
                ...
                For intNodeLen = 0 To xNode.childNodes.Length - 1
                    For i = 0 To xNode.childNodes.Item(intNodeLen).childNodes.Length - 1
                        ...
                        Select Case UCase(xNode.childNodes.Item(intNodeLen).childNodes.Item(i).baseName)
                            ...
                            Case "SPC_NM":             XmlInfo.SPC_NM = xNode.childNodes.Item(intNodeLen).childNodes.Item(i).nodeTypedValue
                        End Select
                    Next
                    J = J + 1
                Next
