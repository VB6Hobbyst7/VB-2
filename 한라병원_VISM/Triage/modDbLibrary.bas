...
'                MsgBox "3" & sRstData
                ...
                If sReturnCode = "0" Then
                    ' 입력 성공
                    frmInterface.StatusBar1.Panels(3).Text = lsID & " 입력 성공"
                End If
            End With
        End If
...
Function GetSampleInfoW_HALLA_test(ByVal asNum As String) As String
    ...
    With frmInterface.VisM1
        ...
        If (sRet = "0") Then    'sReturnCode=0이면 결과값 조회
            sRtnVal = .P9
            MsgBox sRtnVal
        Else
            Exit Function
...
'ABL
'sRtnVal = "001055300\수탁검사실\M\ABL1,E3711,E3712,E3713,E3714,E3715,E3716,E3717,"
'sRtnVal = "001055300\수탁검사실\M\ABL825,E3711,E3712,E3713,E3714,E3715,E3716,E3717,"
    

'/001055300\수탁검사실\M\E3711,E3712,E3713,E3714,E3715,E3716,E3717,E3811,E3812,E3813,E3814,E3815,
'
