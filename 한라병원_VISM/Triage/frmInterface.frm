...
Object = "{88F75480-0574-11D0-8085-0000C0BD354B}#2.0#0"; "VISM.ocx"
   ...
   Begin VB.Frame FrmHideControl 
      ...
      Begin VB.Frame Frame4 
         ...
         Begin FPSpread.vaSpread vasPrint 
            ...
            EndProperty
            MaxCols         =   9
            SpreadDesigner  =   "frmInterface.frx":3A6E
         End
         Begin FPSpread.vaSpread vasPrintBuf 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            SpreadDesigner  =   "frmInterface.frx":54E7
         End
      End
      ...
      Begin FPSpread.vaSpread vasCode 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":56FF
      End
      Begin FPSpread.vaSpread vasTemp1 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":5917
      End
      ...
      Begin FPSpread.vaSpread vasResTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":803F
      End
      Begin FPSpread.vaSpread vasTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":8257
      End
...
'    Call GetSampleInfoW_HALLA_test(txtRstNum)
'
'    Exit Sub
...
'        strOutput = "1H|\^&|||1234567890|||||||P||" & Format(Now, "yyyymmddhhmmdd") & vbCr & ETX
'        strOutput = STX & strOutput & GetChkSum(strOutput) & vbCrLf
'        comEqp.Output = strOutput
'        Debug.Print strOutput
'        SetRawData "[Tx]" & strOutput
'
'        strOutput = "2Q|1|" & txtRstNum.Text & "||||" & Format(dtpRstDt.Value, "yyyymmdd000000") & "|" & Format(dtpRstDt.Value, "yyyymmdd000000") & "|||S||F" & vbCr & ETX
'        strOutput = STX & strOutput & GetChkSum(strOutput) & vbCrLf
'        comEqp.Output = strOutput
'        Debug.Print strOutput
'        SetRawData "[Tx]" & strOutput
'
'        strOutput = "3L|1|N|" & vbCr & ETX
'        strOutput = STX & strOutput & GetChkSum(strOutput) & vbCrLf
'        comEqp.Output = strOutput
'        Debug.Print strOutput
'        SetRawData "[Tx]" & strOutput
    ...
    Select Case intSndPhase
        ...
        Case 2  '## Q 결과요청
            ...
            strOutput = intFrameNo & "Q|1|" & Trim(txtRstNum.Text) & "||||" & Format(dtpRstDt.Value, "yyyymmdd000000") & "|" & Format(dtpRstDt.Value, "yyyymmdd235959") & "|||S||F" & vbCr & ETX
            intSndPhase = 3
            intFrameNo = intFrameNo + 1
        Case 3  '## Termianator
...
Private Sub SetPatInfo(ByVal pBarNo As String, Optional ByVal pRno As String, Optional ByVal pPno As String)
    ...
    Call GetSampleInfoW_HALLA(intRow)
...
'            End If
            ...
            If strResult <> "" And strIntBase <> "" Then
                SQL = ""
