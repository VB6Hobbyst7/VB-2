...
Public Const colCHARTNO = 6     '챠트번호
Public Const colPID = 7         '병록번호(내원번호)
Public Const colINOUT = 8       '입원/외래 (응급여부)
Public Const colDISKNO = 9
Public Const colPOSNO = 10
Public Const colPNAME = 11      '환자명
Public Const colPSEX = 12       '성별
Public Const colPAGE = 13       '나이
Public Const colOCNT = 14
Public Const colRCNT = 15
Public Const colKEY1 = 16
Public Const colKEY2 = 17
Public Const colKEY3 = 18
Public Const colState = 19
...
'argSQL의 내용을 파일로 저장
    ...
    sFileName = strName & Format(CDate(frmInterface.dtpToday), "yyyy-mm-dd")
