...
'
        ...
        With Test_Property
            ...
            .Add "AMRLIMIT20", txtAMRLimit(19).Text
            ...
            .Add "AMRRESULT20", txtAMRResult(19).Text
...
'        End If
        ...
        txtAMRLimit(19).Text = mGetP(GetText(spdTest, Row, colRESTYPE + 6), 1, "|")
        txtAMRResult(19).Text = mGetP(GetText(spdTest, Row, colRESTYPE + 6), 2, "|")
    
    
        txtAMRLimit(5).Text = mGetP(GetText(spdTest, Row, colRESTYPE + 7), 1, "|")
        txtAMRResult(5).Text = mGetP(GetText(spdTest, Row, colRESTYPE + 7), 2, "|")
    
        txtAMRLimit(6).Text = mGetP(GetText(spdTest, Row, colRESTYPE + 8), 1, "|")
        txtAMRResult(6).Text = mGetP(GetText(spdTest, Row, colRESTYPE + 8), 2, "|")
    
        If GetText(spdTest, Row, colRESTYPE + 9) = "" Then
            optINQuant(0).Value = True
        ElseIf GetText(spdTest, Row, colRESTYPE + 9) = "변환없음" Then
            optINQuant(0).Value = True
        ElseIf GetText(spdTest, Row, colRESTYPE + 9) = "판정(수치)" Then
            optINQuant(1).Value = True
        ElseIf GetText(spdTest, Row, colRESTYPE + 9) = "수치(판정)" Then
            optINQuant(2).Value = True
        ElseIf GetText(spdTest, Row, colRESTYPE + 9) = "판정 수치" Then
            optINQuant(3).Value = True
        ElseIf GetText(spdTest, Row, colRESTYPE + 9) = "수치 판정" Then
        ...
        If GetText(spdTest, Row, colRESTYPE + 10) = "" Or GetText(spdTest, Row, colRESTYPE + 10) = "0" Then
            chkCalTest.Value = "0"
        Else
            chkCalTest.Value = "1"
        End If
