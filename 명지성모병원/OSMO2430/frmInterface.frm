...
Private Sub cmdSearch_Click()
    ...
    If gDBTYPE <> "99" Then
        ...
        Else
            Call GetWorkList(Format(dtpFrom.Value, "yyyy-mm-dd"), Format(dtpTo.Value, "yyyy-mm-dd"), spdWork, Format(txtFrNo.Text, "0000"), Format(txtToNo.Text, "0000"), IIf(chkSave.Value = "1", True, False))
        End If
    Else
        Dim i As Integer
...
Private Sub ReceiveProcess()
    ...
    If gComm.COMTYPE = "1" Then
        ...
        Select Case UCase(gHOSP.MACHNM)
            Case "OSMO2430":        Call Phase_Serial_OSMO2430
...
Private Sub SerialRcvData_OSMO2430()
    Dim RS_L            As ADODB.Recordset
...
On Error GoTo RST
    ...
    With frmInterface
        ...
        strBarno = Trim(Mid(strRcvBuf, 1, 5))
        ...
        strIntBase = "OSMO"
        strResult = Trim(Mid(strRcvBuf, 6))
        strIntResult = strResult
        ...
        If gHOSP.SAVEAUTO = "Y" And strState = "R" Then
            If IsNumeric(strResult) Then
                ...
                strState = ""
            Else
                Call SetUpdateStatus(spdOrder, gRow, -1)
                strState = ""
            End If
        End If
...
RST:
    strErrMsg = ""
    strErrMsg = strErrMsg & "위    치 : " & gHOSP.MACHNM & "_SerialRcvData_OSMO2430" & vbNewLine & vbNewLine
    strErrMsg = strErrMsg & "오류번호 : " & Err.Number & vbNewLine & vbNewLine
    strErrMsg = strErrMsg & "오류내용 : " & Err.Description & vbNewLine
    frmErrMsg.txtErr = vbNewLine & strErrMsg
    frmErrMsg.Show
...
Private Sub Phase_Serial_OSMO2430()
    Dim Buffer      As Variant
    Dim BufChar     As String
    Dim lngBufLen   As Long
    Dim i           As Long
