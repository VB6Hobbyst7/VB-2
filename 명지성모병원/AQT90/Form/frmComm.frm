...
Begin VB.Form frmComm 
   ...
   Begin TabDlg.SSTab tabWork 
      ...
      Tab(0).Control(27)=   "tmrOrder"
      Tab(0).Control(27).Enabled=   0   'False
      Tab(0).Control(28)=   "cmdWorkList"
      Tab(0).Control(28).Enabled=   0   'False
      Tab(0).Control(29)=   "cmdSel(2)"
      Tab(0).Control(29).Enabled=   0   'False
      Tab(0).Control(30)=   "cmdSel(3)"
      ...
      Tab(1).Control(2)=   "SSPanel"
      Tab(1).Control(3)=   "cmdRstQuery"
      Tab(1).Control(4)=   "cmdExcel"
      ...
      Begin BHButton.BHImageButton cmdNext 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         TransparentPicture=   "frmComm.frx":9CC1
         ForeColor       =   16711680
         BackColor       =   255
         AlphaColor      =   255
         ImgOutLineSize  =   3
      ...
      Begin VB.ListBox List1 
         Height          =   2220
         ItemData        =   "frmComm.frx":AA23
         Left            =   7950
         List            =   "frmComm.frx":AA25
         TabIndex        =   43
         Top             =   6000
         Width           =   7215
      End
      ...
      Begin FPSpread.vaSpread spdRstview 
         ...
         SpreadDesigner  =   "frmComm.frx":AA27
         UserResize      =   0
      End
      ...
      Begin FPSpread.vaSpread spdWorklist 
         ...
         ScrollBarMaxAlign=   0   'False
         ShadowColor     =   14735310
         SpreadDesigner  =   "frmComm.frx":B2A8
         UserResize      =   2
      End
      ...
      Begin Threed.SSPanel SSPanel1 
         ...
         Begin VB.ComboBox cboChk 
            Height          =   300
            ItemData        =   "frmComm.frx":B7E5
            Left            =   5160
            List            =   "frmComm.frx":B7EF
            TabIndex        =   61
            Top             =   90
            Width           =   1095
         End
         Begin VB.ComboBox cboComNm 
            Height          =   300
            ItemData        =   "frmComm.frx":B803
            Left            =   4590
            List            =   "frmComm.frx":B805
            TabIndex        =   60
            Top             =   480
            Visible         =   0   'False
            Width           =   1725
      ...
      Begin Threed.SSPanel SSPanel 
         ...
         Begin VB.ComboBox cboOrdDt 
            Height          =   300
            ItemData        =   "frmComm.frx":B807
            Left            =   4590
            List            =   "frmComm.frx":B809
            TabIndex        =   88
            Top             =   90
            Visible         =   0   'False
            Width           =   1185
         ...
         Begin VB.ComboBox cboChk1 
            Height          =   300
            ItemData        =   "frmComm.frx":B80B
            Left            =   2610
            List            =   "frmComm.frx":B815
            TabIndex        =   87
            Top             =   90
            Visible         =   0   'False
            Width           =   1905
         ...
         Begin VB.ComboBox cboRstgbn 
            Height          =   300
            Index           =   1
            ItemData        =   "frmComm.frx":B829
            Left            =   5850
            List            =   "frmComm.frx":B836
            Style           =   2  '드롭다운 목록
            TabIndex        =   74
            Top             =   75
            Visible         =   0   'False
         ...
         Begin VB.ComboBox Combo2 
            Height          =   300
            ItemData        =   "frmComm.frx":B860
            Left            =   4590
            List            =   "frmComm.frx":B862
            TabIndex        =   73
            Top             =   480
            Visible         =   0   'False
            Width           =   1725
      ...
      Begin FPSpread.vaSpread tblexcel 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmComm.frx":B864
      End
      ...
      Begin FPSpread.vaSpread spdResult2 
         ...
         ScrollBarMaxAlign=   0   'False
         ShadowColor     =   14735309
         SpreadDesigner  =   "frmComm.frx":BA0F
         UserResize      =   0
      End
      Begin VB.Line Line1 
...
On Error GoTo ErrorTrap
    CallForm = "clsCommon - Public Function f_subSet_WorkList() As ADODB.Recordset"
        ...
        Set AdoRs_SQL = New ADODB.Recordset
'■ 검사항목을 가져오는 Sql
'SELECT MASTERCODE, CHANNEL, EXAMFNAME
'  From TW_HSP_OCS.TWEXAM_MASTER
' WHERE EQUCODE1='C01'       :장비코드
'   AND CHANNEL IS NOT NULL
' ORDER BY TO_NUMBER(CSORT) ASC
'
        
''   ■ 환자정보를 가져오는 Sql
''SELECT  DISTINCT C.SPECNO , C.SNAME, C.DEPTCODE,
''         DECODE(C.GBIO,'I','입 원 ','O','외 래 '), B.EXAMNAME
''  FROM TW_HSP_OCS.TWEXAM_RESULTC A
''       , TW_HSP_OCS.TWEXAM_MASTER  B
''       , TW_HSP_OCS.TWEXAM_SPECMST C
'' WHERE C.SPECNO = 'C041061223           :검체번호
''   AND B.EQUCODE1='C01'             :장비코드
''   AND C.STATUS='3'                 :검사상태
''   AND (C.SPECNO = A.SPECNO)
''   AND (A.MASTERCODE = B.MASTERCODE)
         
            
                 sqlDoc = "Select C.SPECNO , C.SNAME, C.DEPTCODE, DECODE(C.GBIO,'I','입 원 ','O','외 래 ') as GBIO, B.EXAMNAME,  B.MASTERCODE, B.CHANNEL "
        sqlDoc = sqlDoc & "  From TW_HSP_OCS.TWEXAM_RESULTC A,"
        sqlDoc = sqlDoc & "       TW_HSP_OCS.TWEXAM_MASTER  B,"
        sqlDoc = sqlDoc & "       TW_HSP_OCS.TWEXAM_SPECMST C"
        sqlDoc = sqlDoc & " Where C.SPECNO   = '" & strBarno & "'"  ' 검체번호
        sqlDoc = sqlDoc & "   And B.EQUCODE1 = '" & INS_CODE & "'"  ' 장비코드
        sqlDoc = sqlDoc & "   AND C.STATUS   = '3' "                ' 검사상태
        sqlDoc = sqlDoc & "   And (C.SPECNO  = A.SPECNO) "
        sqlDoc = sqlDoc & "   And (A.MASTERCODE = B.MASTERCODE)"
'        sqlDoc = sqlDoc & "   And CHANNEL IS NOT NULL "
'        Print #1, sqlDoc;
...
''■ 검사결과를 저장하는 Sql
''Update TW_HSP_OCS.TWEXAM_RESULTC
''   SET STATUS = 'Y'             ‘검사상태
''     ,  RESULT = '145'              ‘검사결과
''     ,  RESULTDATE = TRUNC(SYSDATE) ‘검사전송시간
'' WHERE SPECNO = 'C038061223'        '검체번호
''   AND MASTERCODE = 'CR41'      ‘검사코드
''
'' Update TW_HSP_OCS.TWEXAM_SPECMST
''      SET STATUS = '4'              ‘검사상태
''        ,  RESULTDATE = TRUNC(SYSDATE)
''    WHERE SPECNO = 'C038061223'         ‘검체번호
...
On Error GoTo ErrorRoutine
    ...
    With objSpd
        For intRow = 1 To .maxrows
            ...
            Else
                .GetText 3, intRow, varTmp:    strBarno = Trim$(varTmp)      '-- 검체번호
            End If
                    ...
                    If Trim$(strResult) <> "" Then         '-- 결과값이 있으면
                        ...
                        If Not itemX Is Nothing Then
                           ...
                           If Index = 0 Then
                               If strTestCd <> "" Then
                                    '-- 검사상태를 먼저 확인한다.
                                             sqlDoc = "Select STATUS "
                                    sqlDoc = sqlDoc & "  From TW_HSP_OCS.TWEXAM_SPECMST "
                                    sqlDoc = sqlDoc & " Where SPECNO = '" & strBarno & "'"
                                    sqlDoc = sqlDoc & "   And STATUS = '3'"
                                    ...
                                    Else
                                        ...
                                        blnUpdate = True
                                        '--결과업데이트
                                                 sqlDoc = "Update TW_HSP_OCS.TWEXAM_RESULTC "
                                        sqlDoc = sqlDoc & "   Set STATUS     = 'Y',"                    '검사상태
                                        sqlDoc = sqlDoc & "       RESULT     = '" & strResult & "',"    '검사결과
                                        sqlDoc = sqlDoc & "       RESULTDATE = TRUNC(SYSDATE) "         '검사전송시간
                                        sqlDoc = sqlDoc & " Where SPECNO     = '" & strBarno & "'"      '검체번호
                                        sqlDoc = sqlDoc & "   And MASTERCODE = '" & strTestCd & "'"     '검사코드
                                        
                                        AdoCn_ORACLE.Execute sqlDoc
                                                                            
'                                                 sqlDoc = "Update TW_HSP_OCS.TWEXAM_SPECMST "
'                                        sqlDoc = sqlDoc & "   Set STATUS     = '4',"                    '검사상태(=결과등록(부분전송)
'                                        sqlDoc = sqlDoc & "       RESULTDATE = TRUNC(SYSDATE) "
'                                        sqlDoc = sqlDoc & " Where SPECNO     = '" & strBarno & "'"      '검체번호
'                                        sqlDoc = sqlDoc & "   And STATUS     = '3' "                    '검사상태(=검체접수)
'
'                                        AdoCn_ORACLE.Execute sqlDoc
                                    End If
                                End If
...
'                                        AdoCn_ORACLE.Execute sqlDoc
                            ...
                            If strTestCd <> "" Then
                                ...
                                Else
                                    ...
                                    .Row = intRow
                                    .Col = 2: .BackColor = vbMagenta
                                    .Col = 3: .BackColor = vbMagenta
                                    .Col = 4: .BackColor = vbMagenta
                                    .Col = 5: .BackColor = vbMagenta
                                    .Col = 6: .BackColor = vbMagenta
                                    .Col = 7: .BackColor = vbMagenta
                                    .Col = 1: .Value = 0
...
Private Sub cmdRstQuery_Click()
    ...
    sqlDoc = "Select SPCNO, TESTCD, EQUIPCD, TRANSDT, RSTVAL, REFVAL, TRANSDT, EQPNUM, PATID, PNM, SEX " & _
             "  From INTERFACE003" & _
             " Where TRANSDT = '" & Format(dtpRsltDay.Value, "yyyymmdd") & "'" & _
             "   And EQUIPCD = '" & INS_CODE & "'"
...
'    End If
    ...
    Do While Not adoRS.EOF
        ...
        If strSpcno <> Trim$(adoRS("TRANSDT") & "") + Trim$(adoRS("SPCNO") & "") Then
                ...
                .SetText 6, intRow, Trim$(adoRS("SEX") & "")
        ...
        For intCnt = 1 To .bufcnt
            ...
            Select Case strType
                ...
                Case "P"    '## Patient
                    ...
                    pGrid_Point = SeqSearch(spdResult1, strBarno, 2)

                    If pGrid_Point = 0 Then
                        pGrid_Point = SeqNullSearch(spdResult1, strBarno, 2)
                        If pGrid_Point = 0 Then
                            'Exit Sub
                    ...
                    'DISTINCT R.RESULTDATE, P.PATID, P.PATNAME, R.SPCMNO
                    If RecordChk = True Then
                        Do Until mAdoRs.EOF
                            spdResult1.SetText 2, pGrid_Point, strBarno
                            spdResult1.SetText 3, pGrid_Point, Trim(mAdoRs.Fields("SNAME"))     '이름
                            spdResult1.SetText 4, pGrid_Point, Trim(mAdoRs.Fields("DEPTCODE"))  '진료과
                            spdResult1.SetText 5, pGrid_Point, Trim(mAdoRs.Fields("GBIO"))      '입/외
                            mAdoRs.MoveNext
                        Loop
                    Else
                        spdResult1.SetText 2, pGrid_Point, strBarno
                        spdResult1.SetText 3, pGrid_Point, "오더없음"
                        'spdResult1.SetText 4, pGrid_Point, Trim(mAdoRs.Fields("DEPTCODE"))  '진료과
                        'spdResult1.SetText 5, pGrid_Point, Trim(mAdoRs.Fields("GBIO"))      '입/외
                    End If
                    Set mAdoRs = Nothing
...
'                    '## 오더 전송준비 완료
                ...
                Case "R"    '## Result
                    ...
                    If IsNumeric(strResult) And strIntBase = "Hct" Then
                        strResult = strResult * 100
                    Else
                        If strIntBase = "Myo" And IsNumeric(strResult) Then
                            strResult = Round(strResult)
                        ElseIf strIntBase = "NT-proBNP" And IsNumeric(strResult) Then
                            strResult = Round(strResult)
                        ElseIf strIntBase = "D-dimer" And IsNumeric(strResult) Then
                            'strResult = Round(strResult)
                            'strResult = Format(strResult, "0.00")
                            strResult = Round(strResult)
                        ElseIf strIntBase = "CKMB" And IsNumeric(strResult) Then
                            strResult = Format(strResult, "0.0")
                        ElseIf strIntBase = "TnI" And IsNumeric(strResult) Then
                            'strResult = strResult * 1000
                            strResult = Format(strResult, "0#")
                            If strResult < 10 Then
                                strResult = "<10"
                            End If
'                        ElseIf strIntBase = "TnI" Then
...
'                                spdResult1.Col = 3: spdResult1.Row = pGrid_Point: strBarno = spdResult1.text
                                spdResult1.GetText 3, pGrid_Point, strName
                                spdResult1.GetText 4, pGrid_Point, strKey1  'PATID ==> 진료과
                                spdResult1.GetText 5, pGrid_Point, strKey2  '성별/나이 ==> '입/외
                                ...
                                sqlDoc = "insert into INTERFACE003(" & _
                                         ...
                                         "    values( '" & strBarno & "', '" & strKey1 & "', '" & itemX.tag & "','" & itemX.tag & "', " & _
...
''    End If
    ...
    If KeyAscii = vbKeyReturn Then
        With spdResult1
            ...
            If aCOL = 2 And Len(varBar) = 10 Then
                '바코드번호로 오더찾아오기
                ...
                If RecordChk = True Then
                    Do Until mAdoRs.EOF
                        .SetText 1, aRow, "1"
                        .SetText 2, aRow, varBar
                        .SetText 3, aRow, Trim(mAdoRs.Fields("SNAME"))     '이름
                        .SetText 4, aRow, Trim(mAdoRs.Fields("DEPTCODE"))  '진료과
                        .SetText 5, aRow, Trim(mAdoRs.Fields("GBIO"))      '입/외
                        mAdoRs.MoveNext
                    Loop
                Else
                    .SetText 1, aRow, "0"
