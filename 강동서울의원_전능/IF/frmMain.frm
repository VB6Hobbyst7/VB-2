...
Begin VB.Form frmMain 
      ...
      Begin MSComctlLib.ImageList imlStatus 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMain.frx":2121
               Key             =   "NOT"
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMain.frx":26BB
               Key             =   "STOP"
            EndProperty
            ...
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMain.frx":34E7
               Key             =   "ITM"
            EndProperty
            BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMain.frx":3641
               Key             =   "ERR"
            EndProperty
            BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMain.frx":379B
               Key             =   "NOF"
            EndProperty
            BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMain.frx":38F5
               Key             =   "ON"
               Object.Tag             =   "OFF"
            EndProperty
            BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMain.frx":41CF
               Key             =   ""
            EndProperty
         EndProperty
      End
   ...
   Begin FPSpread.vaSpread spdOrder 
      ...
      ScrollBarExtMode=   -1  'True
      ShadowColor     =   16777215
      SpreadDesigner  =   "frmMain.frx":70B9
      ScrollBarTrack  =   3
      ShowScrollTips  =   3
   End
   Begin FPSpread.vaSpread spdWork 
      ...
      ScrollBarExtMode=   -1  'True
      ShadowColor     =   16777215
      SpreadDesigner  =   "frmMain.frx":9067
      ScrollBarTrack  =   3
      ShowScrollTips  =   3
   End
...
Private Sub cmdAll_Click()
    ...
    With spdWork
        For intWRow = 1 To .MaxRows
            ...
            If .Value = "1" Then
                blnSame = False
                strBarno = GetText(spdWork, intWRow, colCHARTNO)
                For intORow = 1 To spdOrder.MaxRows
                    spdOrder.Row = intORow
                    spdOrder.Col = colCHARTNO
                    If strBarno = GetText(spdOrder, intORow, colCHARTNO) Then
                        blnSame = True
                    End If
                Next
...
Private Sub GetOrder_CA270W(ByVal pBarNo As String, ByVal pType As String)
...
On Error GoTo RST
    ...
    With frmMain
        ...
        If InStr(RcvBuffer, "Sample: QC") > 0 Then
            strOldBarno = Trim(mGetP(RcvBuffer, 2, ":"))
        End If
        ...
        For intCnt = 1 To UBound(strRData)
            ...
            Select Case strType
                ...
                Case "Q"    '## Request Information
                    ...
                    Call GetOrder_CA270W(strBarno, gHOSP.RSTTYPE)
...
RST:
    strErrMsg = ""
    strErrMsg = strErrMsg & "위    치 : " & gHOSP.MACHNM & "_SerialRcvData_CA270" & vbNewLine & vbNewLine
    strErrMsg = strErrMsg & "오류번호 : " & Err.Number & vbNewLine & vbNewLine
    strErrMsg = strErrMsg & "오류내용 : " & Err.Description & vbNewLine
    frmErrMsg.txtErr = vbNewLine & strErrMsg
    frmErrMsg.Show
...
Private Sub SendOrder_CA270()
    ...
    Select Case intSndPhase
        ...
        Case 3  '## Order
            Call GetOrder_CA270W(mOrder.BarNo, gHOSP.RSTTYPE)
