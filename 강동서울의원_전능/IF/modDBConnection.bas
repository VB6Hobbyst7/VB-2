...
'MSSQLPWD=int_!jj1m
    ...
    If ServerName = "" Then
        Select Case gEMR
            ...
            Case "JUNNUNG":     ServerName = "175.208.193.148,22030" '강동서울의원
        End Select
    End If
    ...
    If DatabaseName = "" Then
        Select Case gEMR
            ...
            Case "JUNNUNG":     DatabaseName = "almighty" '강동서울의원
        End Select
    End If
    ...
    If UserName = "" Then
        Select Case gEMR
            ...
            Case "JUNNUNG":     UserName = "almighty" '강동서울의원
        End Select
    End If
    ...
    If Password = "" Then
        Select Case gEMR
            ...
            Case "JUNNUNG":     Password = "almighty" '강동서울의원
        End Select
    End If
