...
Begin VB.Form frmMain 
   ...
   Begin VB.Frame FraHidden 
      ...
      Begin FPSpread.vaSpread spdQcResult 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmMain.frx":734E
      End
      ...
      Begin MSComctlLib.ImageList imlMenu 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            NumListImages   =   4
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMain.frx":7595
               Key             =   "INTERFACE"
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMain.frx":7E6F
               Key             =   "SEARCH"
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMain.frx":8189
               Key             =   "TESTSET"
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMain.frx":8A41
               Key             =   "COMMSET"
            EndProperty
         EndProperty
      End
   ...
   Begin VB.PictureBox Picture2 
      ...
      Begin VB.Frame fraResult 
         ...
         Begin VB.ComboBox cboRstType 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmMain.frx":DB36
            Left            =   420
            List            =   "frmMain.frx":DB38
            TabIndex        =   91
            Top             =   180
            Width           =   1245
         End
         Begin VB.ComboBox cboState 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmMain.frx":DB3A
            Left            =   4890
            List            =   "frmMain.frx":DB3C
            TabIndex        =   90
            Top             =   180
            Width           =   1245
         End
   ...
   Begin VB.Frame frame1 
      ...
      Begin FPSpread.vaSpread spdWork 
         ...
         SpreadDesigner  =   "frmMain.frx":DF28
         UserResize      =   2
      End
      ...
      Begin FPSpread.vaSpread spdResult 
         ...
         SelectBlockOptions=   0
         ShadowColor     =   16777215
         SpreadDesigner  =   "frmMain.frx":125A1
         TextTip         =   2
      End
      Begin FPSpread.vaSpread spdOrder 
         ...
         ShadowColor     =   16777215
         ShadowDark      =   16777215
         SpreadDesigner  =   "frmMain.frx":12D71
         UserResize      =   2
      End
   End
   Begin VB.Frame frame4 
      ...
      Begin VB.Frame frameCom 
         ...
         Begin VB.ComboBox cboPort 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmMain.frx":17E85
            Left            =   2190
            List            =   "frmMain.frx":17E87
            TabIndex        =   35
            Top             =   390
            Width           =   2205
         End
         Begin VB.ComboBox cboBaudrate 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmMain.frx":17E89
            Left            =   2190
            List            =   "frmMain.frx":17E8B
            TabIndex        =   34
            Top             =   780
            Width           =   2205
         End
         Begin VB.ComboBox cboDatabit 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmMain.frx":17E8D
            Left            =   2190
            List            =   "frmMain.frx":17E8F
            TabIndex        =   33
            Top             =   1170
            Width           =   2205
         End
         ...
         Begin VB.ComboBox cboParity 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmMain.frx":17E91
            Left            =   2190
            List            =   "frmMain.frx":17E93
            TabIndex        =   30
            Top             =   2520
            Width           =   2205
         End
   ...
   Begin VB.Frame frame2 
      ...
      Begin FPSpread.vaSpread spdRResult 
         ...
         SelectBlockOptions=   0
         ShadowColor     =   16777215
         SpreadDesigner  =   "frmMain.frx":19DE5
         TextTip         =   2
      End
      Begin FPSpread.vaSpread spdROrder 
         ...
         SelectBlockOptions=   0
         ShadowColor     =   16777215
         SpreadDesigner  =   "frmMain.frx":1A5BF
         UserResize      =   2
      End
   ...
   Begin VB.Frame frame3 
      ...
      Begin VB.Frame frameTestSet 
         ...
         Begin VB.Frame frameOrder 
            ...
            Begin FPSpread.vaSpread spdOrdMst 
               ...
               SpreadDesigner  =   "frmMain.frx":1EBAA
               TextTip         =   2
            End
         End
      ...
      Begin FPSpread.vaSpread spdTest 
         ...
         SelectBlockOptions=   0
         ShadowColor     =   16777215
         SpreadDesigner  =   "frmMain.frx":25170
      End
   End
   Begin VB.Label Label1 
      Appearance      =   0  '평면
    ...
    With frmMain
        For intCnt = 1 To UBound(strRecvData)
            ...
            Select Case strType
                ...
                Case "R"
                    '4R|1|^^^HIVco^1 |0.39^Non-React. |S/CO||N||F||||20170306160408|501112
                    '4R|1|^^^HBAb3^1 |>821.0^Reactive |mIU/mL||>||F||||20170306160520|50111246
                    '4R|1|^^^TSH^1   |0.75            |uIU/mL||N||F||||20170306155656|501112FD
                    ...
                    'If Trim(strResult) = "Non-React." Then
                    '    strResult = "Negative(" & strIntResult & ")"
                    'ElseIf Trim(strResult) = "Reactive" Then
...
'    Dim SpecNo      As String
    ...
    If Not AdoRs_Local.EOF = True And Not AdoRs_Local.BOF = True Then
        Do Until AdoRs_Local.EOF
            ...
            '2019.07.04 : ## Glycoalbumin 이면 7, 8 오더를 준다.
            If lngIntBase = 93 Then
                Mid$(strItems, 7, 1) = "1"     'FE
                Mid$(strItems, 8, 1) = "1"     'UIBC
            End If
...
Private Function Check_SNO(stSampleNo As String, stGuboon As String, ByVal stNow As String, stLevel As String, Optional ByVal stItem As String) As String
...
On Error GoTo ErrHandler
    ...
    Check_SNO = stSampleNo
    
    Select Case stGuboon
        Case "C"
            stchkMent = GetQcNO(gHOSP.MACHCD, stLevel, stSampleNo, False, stItem)  'Q1:low label 또는 Q3:high label
            
            If Len(stchkMent) <> 10 Then
                stSampleNo = "C" & stNow
                stchkMent = "QC검체검색실패"
            End If
        Case Else
            ...
            ElseIf IsNumeric(stSampleNo) Then
                If Len(stSampleNo) = 10 Then
                    stGuboon = "W"
                    If Mid(stSampleNo, 5, 2) = "99" Then
                        stGuboon = "C"  '1905991448
                    End If
                Else
                    stchkMent = "부적합검체"
                End If
...
Private Sub SerialRcvData_HITACHI7180()
    ...
    Dim strRcvBuf       As String   '수신한 Data
    Dim strType         As String   '수신한 Record Type
    Dim strDilution     As String   '수신한 Dilution
    Dim strBarno        As String   '수신한 바코드번호
    Dim strSeq          As String   '수신한 Sequence
    Dim strRackNo       As String   '수신한 Rack Or Disk No
    Dim strTubePos      As String   '수신한 Tube Position
    ...
    Dim strQCGubun      As String
    Dim strQCDate       As String
    ...
    For i = 1 To UBound(strRecvData)
        ...
        If Len(strRcvBuf) > 10 Then
            Call SetLogData(strQCFileName, STX & strRcvBuf & ETX, "A")
        End If
    Next
            ...
            Select Case strType
                ...
                Case ":"    '## End
                    ...
                    If UCase(strFunc) = "F" Then
                        '=========================================================
                        strQCGubun = "C"
                        strQCDate = Format(Now, "yyyymmdd")
                        If Right(strBarno, 1) = "L" Then
                            strQCLevel = "Q1"
                        ElseIf Right(strBarno, 1) = "H" Then
                            strQCLevel = "Q3"
                        End If
                        
                        strItems = ""
                        For i = 51 To Len(strRcvBuf) Step 10
                            strItems = strItems & "'" & Trim(Mid(strRcvBuf, i, 3)) & "',"
                        Next
                        ...
                        strBarno = Check_SNO(strBarno, strQCGubun, strQCDate, strQCLevel, strItems)
                        '=========================================================
                    End If
                    ...
                    For i = 51 To Len(strRcvBuf) Step 10
                        ...
                        'Dilution 결과(B)
                        ':B1     0  71   2008132788    00814200945        1  1501.01
                                                
                        '2021-05-17 : Dilution 에 상관없이 AMR 처리한다.
                        'Dilution 하지않은 결과(A)만 연산처리함
                        '2021-05-18 원복
                        If strDilution = "A" Then
                            '2020-08-13 AMR 적용
                            If IsNumeric(strResult) And strResult <> "" Then
                                Select Case Val(strIntBase)
                                Case 3   'ASO
                                        If strResult < 3 Then
                                            strResult = "<3"
                                        ...
                                        End If
                                Case 1   'RA Factor
                                        If strResult < 1.4 Then
                                            strResult = "<1.4"
                                        ElseIf strResult > 200 Then
                                            strResult = ">200"
                                        End If
                                Case 4   'LP(a)
                                        If strResult < 1 Then
                                            strResult = "<1"
                                        ElseIf strResult > 100 Then
                                            strResult = ">100"
                                        End If
                                Case 5   'ApoA
                                        If strResult < 1 Then
                                ...
                                Case 13  'IgG
                                        If strResult < 3 Then
                                            strResult = "<3"
                                        ElseIf strResult > 5500 Then
                                            strResult = ">5500"
                                        End If
                                Case 14  'IgA
                                        If strResult < 3 Then
                                            strResult = "<3"
                                        ElseIf strResult > 1035 Then
                                            strResult = ">1035"
                                        End If
                                Case 15  'IgM
                                        If strResult < 8 Then
                                            strResult = "<8"
                                        ElseIf strResult > 680 Then
                                            strResult = ">680"
                                        End If
                                Case 16  'C3
                                        If strResult < 0.3 Then
                                            strResult = "<0.3"
                                        ElseIf strResult > 510 Then
                                            strResult = ">510"
                                        End If
                                Case 17  'C4
                                        If strResult < 0.5 Then
                                            strResult = "<0.5"
                                        ElseIf strResult > 110 Then
                                            strResult = ">110"
                                        End If
                                Case 12  'Transferrin
                                        If strResult < 0.04 Then
                                            strResult = "<0.04"
                                        ElseIf strResult > 5.94 Then
                                            strResult = ">5.94"
                                        End If
                                Case 11  'Haptoglobulin
                                        If strResult < 0 Then
                                            strResult = "<0"
                                        ElseIf strResult > 2.7 Then
                                            strResult = ">2.7"
                                        End If
                                Case 18  'Microalbumin
                                        If strResult < 0.2 Then
                                            strResult = "<0.20"
                                        ElseIf strResult > 30 Then
                                            strResult = ">30"
                                        End If
                                Case 93  'Glycoalbumin
                                        If strResult < 3.2 Then
                                            strResult = "<3.2"
                                        ElseIf strResult > 68.1 Then
                                            strResult = ">68.1"
                                        End If
                                Case 29  'IgE
                                        If strResult < 2 Then
...
'                                '-- 2020-08-14 : AMR 참고치를 기준으로 판정추가
'                                If IsNumeric(strResult) And strResult <> "" Then
'                                    If RS_L.Fields("REFLOW") <> "" And IsNumeric(RS_L.Fields("REFLOW")) Then
'                                        If CCur(strResult) < CCur(RS_L.Fields("REFLOW")) Then
'                                            strResult = "<" & RS_L.Fields("REFLOW")
'                                        End If
'                                    End If
'
'                                    If RS_L.Fields("REFHIGH") <> "" And IsNumeric(RS_L.Fields("REFHIGH")) Then
'                                        If CCur(strResult) > CCur(RS_L.Fields("REFHIGH")) Then
'                                            strResult = ">" & RS_L.Fields("REFHIGH")
'                                        End If
'                                    End If
'                                End If
