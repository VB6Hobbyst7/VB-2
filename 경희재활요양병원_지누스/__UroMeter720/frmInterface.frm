...
'
            ...
            Case 4 To 13    '## Result
                ...
                strIntBase = Mid(strTemp1, 1, 4)
                strIntBase = Trim(strIntBase)
                
                strResult = Mid(strTemp1, 8, 4) '-- Á¤¼º
                ...
                If strIntBase = "p.H" Or strIntBase = "S.G" Then
                    strResult = Trim(Mid(strTemp1, 4))  '-- Á¤·®
