...
Begin VB.Form frmInterface 
   ...
   Begin VB.Frame FrmHideControl 
      ...
      Begin VB.ComboBox cboChk 
         ...
         EndProperty
         Height          =   300
         ItemData        =   "frmInterface.frx":4224
         Left            =   6120
         List            =   "frmInterface.frx":422E
         TabIndex        =   77
         Top             =   5970
         Visible         =   0   'False
         Width           =   765
      ...
      Begin FPSpread.vaSpread vasCode 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":423E
      End
      Begin FPSpread.vaSpread vasTemp1 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":4456
      End
         ...
         Begin MSComctlLib.ImageList imlStatus 
            ...
            BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
               ...
               BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":4BF8
                  Key             =   "RUN"
               EndProperty
               BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":5192
                  Key             =   "NOT"
               EndProperty
               BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":572C
                  Key             =   "STOP"
               EndProperty
               BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":5CC6
                  Key             =   "LST"
               EndProperty
               BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":6558
                  Key             =   "ITM"
               EndProperty
               BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":66B2
                  Key             =   "ERR"
               EndProperty
               BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":680C
                  Key             =   "NOF"
               EndProperty
            EndProperty
         End
      ...
      Begin FPSpread.vaSpread vasList 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":6966
      End
      Begin FPSpread.vaSpread vasResTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":6B7E
      End
      Begin FPSpread.vaSpread vasTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":6D96
      End
   ...
   Begin TabDlg.SSTab stInterface 
      ...
      TabPicture(0)   =   "frmInterface.frx":6FAE
      Tab(0).ControlEnabled=   -1  'True
      Tab(0).Control(0)=   "Frame1"
      Tab(0).Control(0).Enabled=   0   'False
      Tab(0).ControlCount=   1
      TabCaption(1)   =   "ÀÌÀü°á°ú"
      TabPicture(1)   =   "frmInterface.frx":6FCA
      ...
      Begin VB.Frame Frame3 
         ...
         Begin FPSpread.vaSpread vasRRes 
            ...
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":6FE6
         End
         ...
         Begin FPSpread.vaSpread vasRID 
            ...
            RetainSelBlock  =   0   'False
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":ACE8
            UserResize      =   2
         End
      ...
      Begin VB.Frame Frame1 
         ...
         Begin FPSpread.vaSpread vasWorkList 
            ...
            RetainSelBlock  =   0   'False
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":B7EB
            UserResize      =   2
         End
         ...
         Begin FPSpread.vaSpread vasRes 
            ...
            RetainSelBlock  =   0   'False
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":C3A1
         End
         ...
         Begin FPSpread.vaSpread vasID 
            ...
            RetainSelBlock  =   0   'False
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":100A3
            UserResize      =   2
         End
         Begin VB.Label Label1 
            Appearance      =   0  'Æò¸é
    ...
    With vasWorkList
        For intRow = 1 To .DataRowCnt
            ...
            If .Value = 1 Then
                ...
                SetText vasID, Trim(GetText(vasWorkList, intRow, colInfo)), vasID.MaxRows, colInfo
...
Private Sub cmdOrder_Click()
    ...
    With vasWorkList
        For intRow = 1 To .MaxRows
            ...
            .Col = colCheckBox
            If .Value = "1" Then
                strBarno = GetText(vasWorkList, intRow, colBarcode)
                strRack = GetText(vasWorkList, intRow, colRack)
                strPos = GetText(vasWorkList, intRow, colPos)
    
                             strRequest = "jobs" + vbTab + "Q" + vbTab
                strRequest = strRequest & "hos_org_no" + vbTab + gGINUS_Parm.HCD + vbTab
                strRequest = strRequest & "smp_no" + vbTab + strBarno + vbTab
                ...
                For i = 0 To UBound(varResponse) - 1
                    strExamCode = strExamCode & "'" & mGetP(varResponse(i), 6, vbTab) & "',"
                Next
                ...
                SQL = SQL & "   AND EXAMCODE in (" & strExamCode & ") "
                
                Res = GetDBSelectRow(gLocal, SQL)
                
                strExamCode = ""
                
                '-- ÇØ´ç Àåºñ¿¡ ¸Â°Ô ¿À´õÃ¤³Î °¡°øÇÏ±â [ASTM Format >> Architect]
                ...
                ssTemp2 = ""
                ssTemp2 = STX
                ssTemp2 = ssTemp2 & ";N" & Space(1)
                ssTemp2 = ssTemp2 & Space(5 - Len(Format(strRack, "#####"))) & Format(strRack, "#####")
                ssTemp2 = ssTemp2 & Space(1)
                ssTemp2 = ssTemp2 & Space(3 - Len(Format(strPos, "###"))) & Format(strPos, "###")
                ssTemp2 = ssTemp2 & Format(strBarno, "00000000")
                ssTemp2 = ssTemp2 & Space(5)
                ssTemp2 = ssTemp2 & Space(16)
                ssTemp2 = ssTemp2 & ETX
                ssTemp2 = ssTemp2 & vbCrLf
                
                comEqp.Output = ssTemp2
                ...
                For i = 0 To UBound(varExamCode)
                    TestStatus(Val(varExamCode(i))) = "1"
                Next
                
                For j = 1 To 37
                    ssTemp3 = ssTemp3 & TestStatus(j)
                Next

                ssTemp3 = "37" & ssTemp3 & "00000" 'Comment
...
Private Sub cmdRSch_Click()
    ...
    'SELECT Ã³À½ '' ´Â Ã¼Å©¹Ú½º
          SQL = " SELECT '', '','',BARCODE, SAMPLETYPE, DISKNO, POSNO, PID, PNAME, PSEX, PAGE, COUNT(*), COUNT(*), SENDFLAG " & vbCrLf
    ...
    End If
    SQL = SQL & "  GROUP BY BARCODE, SAMPLETYPE, DISKNO, POSNO, PID, PNAME, PSEX, PAGE, SENDFLAG "
    ...
    For iRow = 1 To vasRID.DataRowCnt
        Select Case Trim(GetText(vasRID, iRow, colInfo))
            Case "O": SetText vasRID, "¿Ü·¡", iRow, colInfo
            Case "E": SetText vasRID, "ÀÀ±Þ", iRow, colInfo
            Case "I": SetText vasRID, "ÀÔ¿ø", iRow, colInfo
        End Select
...
'    strResponse = W2ACALL2("SCC0191A", strRequest, "https://121.78.172.70") '-- ¹ÙÄÚµå·Î °Ë»ç´ë»ó Á¶È¸
    strResponse = W2ACALL2("SCC0191A", strRequest, gGINUS_Parm.URL) '-- ¹ÙÄÚµå·Î °Ë»ç´ë»ó Á¶È¸(https://211.172.17.66)
    
'                  strResponse = "03" & vbTab & "10-0001425-1" & vbTab & "0" & vbTab & "0" & vbTab & "201003220925" & vbTab & "00030617" & vbTab & "½Âº´¼ø1" & vbTab & "540324" & vbTab & "1010911" & vbTab & "5W" & vbTab & "507" & vbTab & "FM" & vbTab & "O" & vbTab & vbCr
'    strResponse = strResponse & "03" & vbTab & "10-0001425-2" & vbTab & "0" & vbTab & "0" & vbTab & "201003220926" & vbTab & "00030618" & vbTab & "½Âº´¼ø2" & vbTab & "540325" & vbTab & "1010912" & vbTab & "5W" & vbTab & "507" & vbTab & "FM" & vbTab & "I" & vbTab & vbCr
'    strResponse = strResponse & "03" & vbTab & "10-0001425-3" & vbTab & "0" & vbTab & "0" & vbTab & "201003220927" & vbTab & "00030619" & vbTab & "½Âº´¼ø3" & vbTab & "540326" & vbTab & "1010913" & vbTab & "5W" & vbTab & "507" & vbTab & "FM" & vbTab & "E" & vbTab & vbCr
'
'
'                  strResponse = Space(90) & "03" & vbTab & "10-0001425-4" & vbTab & "0" & vbTab & "0" & vbTab & "201003220925" & vbTab & "00030617" & vbTab & "½Âº´¼ø1" & vbTab & "540324" & vbTab & "1010911" & vbTab & "5W" & vbTab & "507" & vbTab & "FM" & vbTab & "O" & vbTab & vbLf
'    strResponse = strResponse & "03" & vbTab & "10-0001425-2" & vbTab & "0" & vbTab & "0" & vbTab & "201003220926" & vbTab & "00030618" & vbTab & "½Âº´¼ø2" & vbTab & "540325" & vbTab & "1010912" & vbTab & "5W" & vbTab & "507" & vbTab & "FM" & vbTab & "I" & vbTab & vbLf
'    strResponse = strResponse & "03" & vbTab & "10-0001425-6" & vbTab & "0" & vbTab & "0" & vbTab & "201003220927" & vbTab & "00030619" & vbTab & "½Âº´¼ø3" & vbTab & "540326" & vbTab & "1010913" & vbTab & "5W" & vbTab & "507" & vbTab & "FM" & vbTab & "E" & vbTab & vbLf
    ...
    If UBound(varResponse) = 0 Then
        MsgBox "ÇØ´ç±â°£¿¡´Â Á¶È¸´ë»óÀÚ°¡ ¾ø½À´Ï´Ù.", vbOKOnly + vbInformation, "¼ö°ËÀÚ Á¶È¸"
    ...
    For i = 0 To UBound(varResponse) - 1
        If vasWorkList.DataRowCnt = 0 Then
            ...
            Select Case mGetP(varResponse(i), 13, vbTab)
                Case "O": SetText vasWorkList, "¿Ü·¡", intRow, colInfo
                Case "E": SetText vasWorkList, "ÀÀ±Þ", intRow, colInfo
                Case "I": SetText vasWorkList, "ÀÔ¿ø", intRow, colInfo
            End Select
...
'                strPosNum = txtPos.Text + 1
'                If (strPosNum Mod 31) = 0 Then
'                    strPosNum = 1
'                End If
'                SetText vasWorkList, strPosNum, intRow, colPos
'
'                If strPosNum <> "" Then
'                    txtPos.Text = strPosNum
'                End If
                
                'strPosNum = txtPos.Text + 1
                If (txtNum Mod 31) = 0 Then
                    txtNum = "1"
                End If
    ...
    ElseIf gCOMFormat = "2" Then
        Select Case intSndPhase
            ...
            Case 1  '## Header
                ...
                Else
                    '## Á¢¼öÁ¤º¸°¡ ¾ø´Â°æ¿ì: °Ë»çÇ×¸ñ Á¤º¸¸¦ º¸³»Áö ¾ÊÀ½!
...
Private Sub GetOrder(ByVal pBarNo As String)
    ...
    gOrderExam = GetOrderExamCode_GINUSDLL(gEquip, pBarNo)
...
Private Sub EditRcvDataASTM()
    ...
    Dim varIntBase(20)      As Variant
    Dim varResult(20)       As Variant

On Error Resume Next

    strBarno = Mid(Trim(strBuffer), 15, 8)
    strSeq = Trim(Mid(strBuffer, 18, 6))

    varIntBase(1) = 1:        varResult(1) = Mid(strBuffer, 36, 4)   ' WBC
    varIntBase(2) = 2:        varResult(2) = Mid(strBuffer, 40, 4)   ' Lymph#
    varIntBase(3) = 3:        varResult(3) = Mid(strBuffer, 44, 4)   ' MID#
    varIntBase(4) = 4:        varResult(4) = Mid(strBuffer, 48, 4)   ' Gran#
    varIntBase(5) = 5:        varResult(5) = Mid(strBuffer, 52, 4)   ' Lymph%
    varIntBase(6) = 6:        varResult(6) = Mid(strBuffer, 56, 2)   ' MID%
    varIntBase(7) = 7:        varResult(7) = Mid(strBuffer, 58, 3)   ' Gran%
    varIntBase(8) = 8:        varResult(8) = Mid(strBuffer, 61, 3)   ' RBC
    varIntBase(9) = 9:        varResult(9) = Mid(strBuffer, 64, 3)   ' HGB
    varIntBase(10) = 10:      varResult(10) = Mid(strBuffer, 67, 4)  ' MCHC
    varIntBase(11) = 11:      varResult(11) = Mid(strBuffer, 71, 4)  ' MCV
    varIntBase(12) = 12:      varResult(12) = Mid(strBuffer, 75, 4)  ' MCH
    varIntBase(13) = 13:      varResult(13) = Mid(strBuffer, 79, 3)  ' RDW
    varIntBase(14) = 14:      varResult(14) = Mid(strBuffer, 82, 3)  ' HCT
    varIntBase(15) = 15:      varResult(15) = Mid(strBuffer, 85, 4)  ' PLT
    varIntBase(16) = 16:      varResult(16) = Mid(strBuffer, 89, 3)  ' MPV
    varIntBase(17) = 17:      varResult(17) = Mid(strBuffer, 92, 3)  ' PDW
    varIntBase(18) = 18:      varResult(18) = Mid(strBuffer, 95, 3)  ' PCT
    varIntBase(19) = 19:      varResult(19) = Mid(strBuffer, 98, 4)  ' RDW
                
    For intCnt = 0 To UBound(varIntBase)
        Select Case intCnt
            Case 0    '## Order
                '-- ¹«Á¶°Ç Á¦ÀÏ À§¿¡°Í¿¡ »Ñ¸°´Ù.
                strBarno = ""
                ...
                '-- ¹ÙÄÚµå¹øÈ£¿¡ Á¸ÀçÇÏ´Â °Ë»çÄÚµå °¡Á®¿À±â(ÀÎ¼ö : ÀåºñÄÚµå,¹ÙÄÚµå¹øÈ£)
                gOrderExam = GetOrderExamCode_GINUSDLL(gEquip, Trim(strBarno))
                
                strState = "O"
                
            Case 1 To 19    '## Result
                '## Àåºñ±âÁØ °Ë»ç¸í, °á°ú, Abnormal Flag
                strIntBase = varIntBase(intCnt)
                strResult = varResult(intCnt)
...
Function SetLocalDB(ByVal asRow1 As Long, ByVal asRow2 As Long, asSend As String, Optional asEquipResult As String = "")
    ...
    Select Case Trim(GetText(vasWorkList, asRow1, colInfo))
        Case "¿Ü·¡": SQL = SQL & "'O', "
        Case "ÀÀ±Þ": SQL = SQL & "'E', "
        Case "ÀÔ¿ø": SQL = SQL & "'I', "
    End Select
...
Private Sub vasWorkList_DblClick(ByVal Col As Long, ByVal Row As Long)
    ...
    If vasWorkList.Text <> "" Then
        ...
        With vasWorkList
            ...
            SetText vasID, Trim(GetText(vasWorkList, Row, colInfo)), vasID.MaxRows, colInfo
            ...
            SetText vasID, Trim(GetText(vasWorkList, Row, colSex)), vasID.MaxRows, colSex
            SetText vasID, Trim(GetText(vasWorkList, Row, colAge)), vasID.MaxRows, colAge
            .Col = colCheckBox
            .Value = "0"
        End With
