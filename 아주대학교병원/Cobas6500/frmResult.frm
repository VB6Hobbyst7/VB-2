...
Begin VB.Form frmResult 
   ...
   Begin VB.Frame Frame4 
      ...
      Begin MSComCtl2.DTPicker dtpReceDate 
         ...
         CurrentDate     =   40122
      End
      Begin Threed.SSCommand cmdQCWorkList 
         Height          =   375
         Left            =   2700
         TabIndex        =   29
         Top             =   240
   ...
   Begin VB.Frame Frame1 
      ...
      Begin FPSpread.vaSpread vasTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmResult.frx":3C2D
      End
      Begin FPSpread.vaSpread vasResTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmResult.frx":3E92
      End
      ...
      Begin FPSpread.vaSpread vasID 
         ...
         RetainSelBlock  =   0   'False
         ScrollBars      =   2
         SpreadDesigner  =   "frmResult.frx":40F7
      End
      ...
      Begin FPSpread.vaSpread vasRes 
         ...
         RetainSelBlock  =   0   'False
         ScrollBars      =   2
         SpreadDesigner  =   "frmResult.frx":6084
      End
   ...
   Begin VB.Frame Frame5 
      ...
      Begin Threed.SSCommand cmdExit 
         ...
         ButtonStyle     =   2
      End
      Begin Threed.SSCommand sscBatchRes 
         Height          =   405
         Left            =   330
         TabIndex        =   31
         Top             =   1080
...
Private Sub cmdQCWorkList_Click()
...
'         End If
        ...
        If sResMach = False Then
            SetForeColor vasID, lsRow, lsRow, 255, 0, 0
            Exit Sub
        End If
...
Private Sub Form_Load()
    ...
    dtpExamDate.Value = frmInterface.dtpToday.Value
    dtpReceDate.Value = frmInterface.dtpToday.Value
End Sub
...
Private Sub sscBatchRes_Click()
    ...
    For lRow = 1 To vasID.DataRowCnt
        ...
        If vasID.Value = 1 Then
            For lRow1 = 1 To vasWorkList.DataRowCnt
                If Trim(GetText(vasID, lRow, 2)) = Trim(GetText(vasWorkList, lRow1, 4)) Then
                    vasID_Click 2, lRow
                    
                    sResMach = False
                    
                    lsBarcode = Trim(GetText(vasWorkList, lRow1, 1))
                    
                    sLotNo = Trim(GetText(vasWorkList, lRow1, 3))
                    ...
                    If sResMach = False Then
                        SetForeColor vasID, lRow, lRow, 255, 0, 0
                        Exit Sub
                    End If
...
Private Sub vasID_Click(ByVal Col As Long, ByVal Row As Long)
    ...
    SQL = "select '', barcode, equipcode,  examcode, examname, resvalue, result, seqno, result ,'','','','','',refflag " & vbCrLf & _
          "FROM pat_res " & vbCrLf & _
          "WHERE examdate = '" & Format(CDate(dtpExamDate), "yyyymmdd") & "' " & vbCrLf & _
          "  AND equipno = '" & gEquip & "' " & vbCrLf & _
