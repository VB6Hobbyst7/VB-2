...
''    SQL = SQL & "     , a.blood_no                                                "
''    SQL = SQL & "     , c.name                                                   "
'    SQL = SQL & "  FROM TB_JUPSU a                                               "
'    SQL = SQL & "     , TB_JUPSU_ITEM b                                          "
'    SQL = SQL & "     , BAG_CODEVALUE c                                          "
'    SQL = SQL & " WHERE a.com_code = '2'                                         "
'    SQL = SQL & "   AND a.per_gumjin_date BETWEEN '" & pFrom & "' AND '" & pTo & "' " & vbCr
'    SQL = SQL & "   AND a.per_jupsu_date        = b.per_jupsu_date                  " & vbCr
'    SQL = SQL & "   AND a.per_ssn               = b.per_ssn                         " & vbCr
'    SQL = SQL & "   AND a.per_gumjin_date       = b.per_gumjin_date                 " & vbCr
...
'    SQL = SQL & "   AND 'P00' || a.jupsu_gubun  = c.gumsacode                       " & vbCr
'    SQL = SQL & "   AND c.codegubun = 'P00'                                         " & vbCr
'    'SQL = SQL & "       AND b.RESULT = ''                                          " & vbCr
'    SQL = SQL & " GROUP BY a.per_gumjin_date, a.per_name, a.per_jikbun, a.per_jupsu_date, a.per_jupsu_time " & vbCr
'    SQL = SQL & " ORDER BY a.per_jupsu_date, a.per_jupsu_time                       " & vbCr
'
            
            SQL = ""
            SQL = SQL & "SELECT MEDITEM      AS ITEM                    " & vbCr
            SQL = SQL & "  FROM TB_JUPSU_ITEM                           " & vbCr
            SQL = SQL & " WHERE PER_GUMJIN_DATE = '" & strRegDate & "'  " & vbCr
            SQL = SQL & "   AND PER_JUPSU_DATE = '" & strRegDate & "'  " & vbCr
            SQL = SQL & "   AND per_jikbun      = '" & strBarcode & "'  " & vbCr
            SQL = SQL & "   AND MEDITEM IN (" & gAllTestCd & ")         " & vbCr
            'SQL = SQL & "   AND (RESULT = ''  OR RESULT IS NULL)  " & vbCr
...
'    SQL = ""
'    SQL = SQL & "SELECT DISTINCT"
'    SQL = SQL & "       a.per_gumjin_date                                       "
'    SQL = SQL & "     , a.per_name                                               "
'    SQL = SQL & "     , a.per_jikbun                                             "
'    SQL = SQL & "     , a.jupsu_gubun                                            "
'    SQL = SQL & "     , a.per_ssn                                                "
'    SQL = SQL & "     , a.blood_no                                                "
'    SQL = SQL & "     , c.name                                                   "
'    SQL = SQL & "     , a.per_jupsu_date                                         "
'    SQL = SQL & "     , a.per_jupsu_time                                         "
'    SQL = SQL & "     , b.meditem                                                "
'    SQL = SQL & "  FROM TB_JUPSU a                                               "
'    SQL = SQL & "       TB_JUPSU_ITEM b                                          "
'    SQL = SQL & "       BAG_CODEVALUE c                                          "
'    SQL = SQL & " WHERE a.com_code = '2'                                         "
'    SQL = SQL & "       AND a.per_gumjin_date = '" & strRegDate & "' "
'    SQL = SQL & "       AND a.per_jupsu_date = b.per_jupsu_date                  "
'    SQL = SQL & "       AND a.per_ssn = b.per_ssn                                "
'    SQL = SQL & "       AND a.per_gumjin_date = b.per_gumjin_date                "
'    SQL = SQL & "       AND 'P00' || a.jupsu_gubun = c.gumsacode                 "
'    SQL = SQL & "       AND b.meditem IN ( " & strTestCd & ")                    "
'    SQL = SQL & "       AND c.codegubun = 'P00'                                  "
'    'SQL = SQL & "       AND b.RESULT = ''                                        "
'    SQL = SQL & " ORDER BY a.per_jupsu_date, a.per_jupsu_time                    "
'
    
    SQL = ""
    SQL = SQL & "SELECT a.per_name          AS PNAME                                " & vbCr
    SQL = SQL & "     , a.per_jikbun        AS BARCODE                              " & vbCr
'    SQL = SQL & "     , a.per_jupsu_date                                            " & vbCr
'    SQL = SQL & "     , a.per_jupsu_time                                            " & vbCr
    SQL = SQL & "     , b.meditem           AS ITEM                                 " & vbCr
'    SQL = SQL & "     , a.jupsu_gubun                                            "
'    SQL = SQL & "     , a.per_ssn                                                "
'    SQL = SQL & "     , a.blood_no                                                "
'    SQL = SQL & "     , c.name                                                   "
    SQL = SQL & "     , MAX(a.per_gumjin_date)   AS HOSPDATE                             " & vbCr
    SQL = SQL & "  FROM TB_JUPSU a                                                  " & vbCr
    SQL = SQL & "     , TB_JUPSU_ITEM b                                             " & vbCr
    SQL = SQL & "     , BAG_CODEVALUE c                                             " & vbCr
    SQL = SQL & " WHERE a.com_code = '1'                                            " & vbCr
    'SQL = SQL & "   AND a.per_gumjin_date       = '" & strRegDate & "'              " & vbCr
    SQL = SQL & "   AND a.per_jikbun            = '" & strBarcode & "'              " & vbCr
    SQL = SQL & "   AND a.per_ssn               = b.per_ssn                         " & vbCr
    SQL = SQL & "   AND a.per_jupsu_date        = b.per_jupsu_date                  " & vbCr
    SQL = SQL & "   AND a.per_ssn               = b.per_ssn                         " & vbCr
    SQL = SQL & "   AND a.per_gumjin_date       = b.per_gumjin_date                 " & vbCr
    ...
    SQL = SQL & "   AND c.codegubun = 'P00'                                         " & vbCr
    'SQL = SQL & "       AND b.RESULT = ''                                          " & vbCr
    SQL = SQL & " GROUP BY a.per_name,  a.per_jikbun, b.meditem   "
'    SQL = SQL & " ORDER BY a.per_gumjin_date DESC,  b.meditem                                                " & vbCr
