...
Public gArrEQP_Title()    As String
...
'    gCENXPCD = Trim(strSetUp1)
    ...
    '-- ACK 장비코드
'    strSetup = "":    strSetUp1 = ""
'    Call GetPrivateProfileString("HOSP", "ACKMACH", "", strSetup, 100, App.PATH & "\INI\" & gMACH & ".ini")
'    strSetUp1 = Trim(strSetup)
'    strSetUp1 = Mid(strSetUp1, 1, Len(strSetUp1) - 1)
'    gHOSP.ACKMACHCD = Trim(strSetUp1)
'    'gHOSP.ACKMACHCD = Mid(gHOSP.ACKMACHCD, 2, 1)
'    gHOSP.ACKMACHCD = Chr(gHOSP.ACKMACHCD)
...
'    gArrEQP(intRow, 15) = AdoRs_Local.Fields("COHOUT").Value & ""
    ...
    With frmMain.spdReport(0)
        .MaxRows = UBound(gArrEQP_Title) - 1
        For i = 0 To UBound(gArrEQP_Title) - 3
            .Row = i + 1
            .Col = 2
            ...
            .TypeVAlign = TypeVAlignCenter
            Call SetText(frmMain.spdReport(0), Trim(gArrEQP_Title(i + 1, 5)), i + 1, 2)  '-- 5 : 약어명
            
            Select Case Trim(gArrEQP_Title(i + 1, 5))
                Case "PFT", "FVC", "FEV1", "PEF", "ExtrapV%", "FIVC"
                    .Row = i + 1
                    .Row2 = i + 1
                    .Col = 2
                    .Col2 = .MaxCols
                    .BlockMode = True
                    .BackColor = RGB(204, 230, 255)
                    .BlockMode = False
                Case "PEF TIME", "FET"
                    .Row = i + 1
                    .Row2 = i + 1
                    ...
                    .Col2 = .MaxCols
                    .BlockMode = True
                    .BackColor = RGB(223, 255, 239)
                    .BlockMode = False
            End Select
            
'&H00FFC0C0& '블루 204 230 255
'12648384    '그린 223 255 239
'12640511    '레드 255 208 232
            
            '.ColWidth(colSTATE + (i + 1)) = gCOLWIDTH
            .RowHeight(-1) = 20
        Next
        .Row = .MaxRows
        Call SetText(frmMain.spdReport(0), "선택", .MaxRows, 2)
        For i = 6 To .MaxCols
            .Col = i
        ...
        .MaxRows = .MaxRows + 1
        .Row = .MaxRows
        Call SetText(frmMain.spdReport(0), "그래프선택", .MaxRows, 2)
        For i = 6 To .MaxCols
            .Col = i
            .CellType = CellTypeCheckBox
            .TypeHAlign = TypeHAlignCenter
    ...
    With frmMain.spdReport(1)
        ...
        For i = 0 To UBound(gArrEQP_Title) - 3
            ...
            .TypeHAlign = TypeHAlignLeft 'TypeHAlignCenter
            .TypeVAlign = TypeVAlignCenter
            Call SetText(frmMain.spdReport(1), Trim(gArrEQP_Title(i + 1, 5)), i + 1, 2)  '-- 5 : 약어명
        ...
        Next
        .Row = .MaxRows
        Call SetText(frmMain.spdReport(1), "선택", .MaxRows, 2)
        For i = 6 To .MaxCols
            .Col = i
            .CellType = CellTypeCheckBox
            .TypeHAlign = TypeHAlignCenter
        ...
        .MaxRows = .MaxRows + 1
        .Row = .MaxRows
        Call SetText(frmMain.spdReport(1), "그래프선택", .MaxRows, 2)
        For i = 6 To .MaxCols
            .Col = i
            .CellType = CellTypeCheckBox
            .TypeHAlign = TypeHAlignCenter
