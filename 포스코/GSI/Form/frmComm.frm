...
Begin VB.Form frmComm 
   ...
   Begin VB.Frame Frame2 
      ...
      Begin FPSpread.vaSpread spdResult1 
         ...
         SpreadDesigner  =   "frmComm.frx":0004
         UserResize      =   0
      End
   ...
   Begin TabDlg.SSTab tabWork 
      ...
      TabPicture(0)   =   "frmComm.frx":05D8
      Tab(0).ControlEnabled=   -1  'True
      Tab(0).Control(0)=   "Label11"
      Tab(0).Control(0).Enabled=   0   'False
      Tab(0).Control(1)=   "SSPanel3"
      Tab(0).Control(1).Enabled=   0   'False
      Tab(0).Control(2)=   "spdResultlist"
      Tab(0).Control(2).Enabled=   0   'False
      Tab(0).Control(3)=   "cmdAppend(2)"
      ...
      Tab(0).Control(17)=   "cmdOrder"
      Tab(0).Control(17).Enabled=   0   'False
      Tab(0).Control(18)=   "cmdPosNo"
      Tab(0).Control(18).Enabled=   0   'False
      Tab(0).Control(19)=   "cmdNext"
      Tab(0).Control(19).Enabled=   0   'False
      Tab(0).Control(20)=   "cmdPrevious"
      Tab(0).Control(20).Enabled=   0   'False
      Tab(0).Control(21)=   "Command2"
      Tab(0).Control(21).Enabled=   0   'False
      Tab(0).Control(22)=   "txtSeqNo"
      Tab(0).Control(22).Enabled=   0   'False
      Tab(0).Control(23)=   "spdWorklist"
      Tab(0).Control(23).Enabled=   0   'False
      Tab(0).Control(24)=   "SSPanel4"
      Tab(0).Control(24).Enabled=   0   'False
      Tab(0).Control(25)=   "spdView"
      Tab(0).Control(25).Enabled=   0   'False
      Tab(0).ControlCount=   26
      TabCaption(1)   =   " ▒   받은 결과     "
      TabPicture(1)   =   "frmComm.frx":05F4
      Tab(1).ControlEnabled=   0   'False
      Tab(1).Control(0)=   "Label4"
      Tab(1).Control(1)=   "cmdSel(2)"
      Tab(1).Control(2)=   "cmdSel(3)"
      ...
      Begin FPSpread.vaSpread spdView 
         ...
         ScrollBars      =   0
         ShadowColor     =   14735309
         SpreadDesigner  =   "frmComm.frx":0610
         UserResize      =   0
      End
      Begin Threed.SSPanel SSPanel4 
         ...
         Begin VB.ComboBox Combo2 
            Height          =   300
            ItemData        =   "frmComm.frx":1848
            Left            =   4590
            List            =   "frmComm.frx":184A
            TabIndex        =   89
            Top             =   480
            Visible         =   0   'False
            Width           =   1725
         End
         Begin MSMask.MaskEdBox mskResultDate 
            Height          =   300
            Left            =   1170
            TabIndex        =   87
            Top             =   90
         ...
         Begin MSMask.MaskEdBox MaskEdBox3 
            ...
            PromptChar      =   "_"
         End
         Begin BHButton.BHImageButton cmdLocal 
            Height          =   360
            Left            =   3510
            TabIndex        =   92
            Top             =   60
      ...
      Begin FPSpread.vaSpread spdWorklist 
         ...
         SpreadDesigner  =   "frmComm.frx":184C
         UserResize      =   2
      End
      ...
      Begin BHButton.BHImageButton cmdNext 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         TransparentPicture=   "frmComm.frx":1E12
         ForeColor       =   16711680
         BackColor       =   255
         AlphaColor      =   255
         ImgOutLineSize  =   3
      ...
      Begin FPSpread.vaSpread spdResult2 
         ...
         ScrollBarMaxAlign=   0   'False
         ShadowColor     =   14735310
         SpreadDesigner  =   "frmComm.frx":2B74
         UserResize      =   0
      End
      Begin Threed.SSPanel SSPanel1 
         ...
         Begin VB.ComboBox cboChk 
            Height          =   300
            ItemData        =   "frmComm.frx":30D1
            Left            =   4950
            List            =   "frmComm.frx":30DB
            TabIndex        =   41
            Top             =   90
            Visible         =   0   'False
            Width           =   1095
         ...
         Begin VB.ComboBox cboComNm 
            Height          =   300
            ItemData        =   "frmComm.frx":30EB
            Left            =   4590
            List            =   "frmComm.frx":30ED
            TabIndex        =   40
            Top             =   480
            Visible         =   0   'False
            Width           =   1725
      ...
      Begin VB.ComboBox cboRstgbn 
         Height          =   300
         Index           =   1
         ItemData        =   "frmComm.frx":30EF
         Left            =   -72570
         List            =   "frmComm.frx":30FC
         Style           =   2  '드롭다운 목록
         TabIndex        =   8
         Top             =   495
         Width           =   1770
      ...
      Begin FPSpread.vaSpread spdRstview 
         ...
         ScrollBars      =   0
         ShadowColor     =   14735310
         SpreadDesigner  =   "frmComm.frx":3A16
         UserResize      =   0
      End
      Begin BHButton.BHImageButton cmdAppend 
         Height          =   420
         ...
         ImgOutLineSize  =   3
      End
      Begin FPSpread.vaSpread spdResultlist 
         Height          =   3915
         Left            =   60
         TabIndex        =   93
         Top             =   5070
         ...
         ScrollBarMaxAlign=   0   'False
         ShadowColor     =   14735310
         SpreadDesigner  =   "frmComm.frx":45C0
         UserResize      =   2
      End
   ...
   Begin MSComctlLib.ImageList imlList 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmComm.frx":4A79
            Key             =   "ITM"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmComm.frx":5013
            Key             =   "ERR"
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmComm.frx":55AD
            Key             =   "NOF"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmComm.frx":5B47
            Key             =   "LST"
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmComm.frx":60E1
            Key             =   "LSE"
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmComm.frx":667B
            Key             =   "LSN"
         EndProperty
      EndProperty
   End
   Begin MSComctlLib.ImageList imlStatus 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmComm.frx":7749
            Key             =   "STOP"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmComm.frx":7CE3
            Key             =   "LST"
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmComm.frx":8575
            Key             =   "ITM"
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
   ...
   Begin VB.Frame fraCmdBar 
      ...
      Begin BHButton.BHImageButton cmdAction 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         TransparentPicture=   "frmComm.frx":8983
         ImgOutLineSize  =   3
      End
...
' 검사항목 일괄 처리 하기 위해 처리
        ...
        If cboChk.ListIndex = 1 Then
            ...
            sqlDoc = sqlDoc + vbCrLf + " WHERE a.com_code = '1'                                         "
            ...
            sqlDoc = sqlDoc + vbCrLf + "       AND 'P00' || a.jupsu_gubun = c.gumsacode                 " 'C1/D1 제외
            'sqlDoc = sqlDoc + vbCrLf + "       AND b.meditem IN ( " & strTestCd & ")                    " '3052아이템이 있음
            sqlDoc = sqlDoc + vbCrLf + "       AND a.jupsu_gubun NOT in ('C1','D1')"
            sqlDoc = sqlDoc + vbCrLf + "       AND b.meditem = '03052'"
            sqlDoc = sqlDoc + vbCrLf + "       AND a.per_chasu = '2'"
...
'    CaptionBar1.Caption = INS_NAME & " Communication"
    ...
    mskResultDate.text = Format$(Now, "YYYYMMDD")
