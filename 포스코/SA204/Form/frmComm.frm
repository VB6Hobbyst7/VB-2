...
Begin VB.Form frmComm 
   ...
   Begin TabDlg.SSTab tabWork 
      ...
      Begin VB.Frame Frame4 
         ...
         Begin Threed.SSPanel SSPanel3 
            ...
            Begin VB.ComboBox Combo2 
               Height          =   300
               ItemData        =   "frmComm.frx":04FE
               Left            =   4590
               List            =   "frmComm.frx":0500
               TabIndex        =   86
               Top             =   480
               Visible         =   0   'False
               Width           =   1725
         ...
         Begin FPSpread.vaSpread spdView 
            ...
            SpreadDesigner  =   "frmComm.frx":0502
            UserResize      =   0
         End
      End
      ...
      Begin BHButton.BHImageButton cmdNext 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         TransparentPicture=   "frmComm.frx":0AA1
         ForeColor       =   16711680
         BackColor       =   255
         AlphaColor      =   255
         ImgOutLineSize  =   3
      ...
      Begin FPSpread.vaSpread spdResult1 
         ...
         ScrollBarMaxAlign=   0   'False
         ShadowColor     =   14735309
         SpreadDesigner  =   "frmComm.frx":1803
         UserResize      =   0
      End
      Begin VB.ListBox List1 
         Height          =   2220
         ItemData        =   "frmComm.frx":1D1D
         Left            =   7950
         List            =   "frmComm.frx":1D1F
         TabIndex        =   64
         Top             =   6060
         Visible         =   0   'False
         Width           =   7215
      ...
      Begin FPSpread.vaSpread spdResult2 
         ...
         ScrollBarMaxAlign=   0   'False
         ShadowColor     =   14735310
         SpreadDesigner  =   "frmComm.frx":1D21
         UserResize      =   0
      End
      ...
      Begin Threed.SSPanel SSPanel1 
         ...
         Begin VB.ComboBox cboChk 
            Height          =   300
            ItemData        =   "frmComm.frx":21B8
            Left            =   4950
            List            =   "frmComm.frx":21C2
            TabIndex        =   58
            Top             =   90
            Visible         =   0   'False
            Width           =   1095
         ...
         Begin VB.ComboBox cboComNm 
            Height          =   300
            ItemData        =   "frmComm.frx":21D2
            Left            =   4590
            List            =   "frmComm.frx":21D4
            TabIndex        =   57
            Top             =   480
            Visible         =   0   'False
            Width           =   1725
      ...
      Begin VB.ComboBox cboRstgbn 
         Height          =   300
         Index           =   1
         ItemData        =   "frmComm.frx":21D6
         Left            =   -72570
         List            =   "frmComm.frx":21E3
         Style           =   2  '드롭다운 목록
         TabIndex        =   9
         Top             =   495
         Width           =   1770
      ...
      Begin FPSpread.vaSpread spdRstview 
         ...
         ScrollBars      =   0
         ShadowColor     =   14735310
         SpreadDesigner  =   "frmComm.frx":2AFD
         UserResize      =   0
      End
   ...
   Begin MSComctlLib.ImageList imlList 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmComm.frx":35F9
            Key             =   "ITM"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmComm.frx":3B93
            Key             =   "ERR"
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmComm.frx":412D
            Key             =   "NOF"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmComm.frx":46C7
            Key             =   "LST"
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmComm.frx":4C61
            Key             =   "LSE"
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmComm.frx":51FB
            Key             =   "LSN"
         EndProperty
      EndProperty
   End
   Begin MSComctlLib.ImageList imlStatus 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         NumListImages   =   7
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmComm.frx":5795
            Key             =   "RUN"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmComm.frx":5D2F
            Key             =   "NOT"
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmComm.frx":62C9
            Key             =   "STOP"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmComm.frx":6863
            Key             =   "LST"
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmComm.frx":70F5
            Key             =   "ITM"
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmComm.frx":724F
            Key             =   "ERR"
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmComm.frx":73A9
            Key             =   "NOF"
         EndProperty
      EndProperty
   End
   Begin VB.Frame fraCmdBar 
      ...
      Begin BHButton.BHImageButton cmdAction 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         TransparentPicture=   "frmComm.frx":7503
         ImgOutLineSize  =   3
      End
      Begin MSCommLib.MSComm comEQP1 
         Left            =   1485
         Top             =   0
         _ExtentX        =   1005
         _ExtentY        =   1005
        ...
        With spdWorklist
            If cboChk.ListIndex = 1 Then
                For intCnt = 0 To mAdoRs.RecordCount - 1
                    If strBarno <> mAdoRs.Fields("PER_JIKBUN") Then
                        optBar.Value = True
                        pGrid_Point = SeqSearch(spdWorklist, mAdoRs.Fields("PER_JIKBUN"), 2)
    
                        If pGrid_Point = 0 Then
                            pGrid_Point = SeqNullSearch(spdWorklist, mAdoRs.Fields("PER_JIKBUN"), 2)
                        ...
                        .SetText 6, pGrid_Point, Trim(mAdoRs("PER_SSN") & "")
                    ...
                    If Not itemX Is Nothing Then
                        ...
                        blt = True
                    End If
                    strBarno = mAdoRs.Fields("PER_JIKBUN") & ""
                    mAdoRs.MoveNext
                Next
            End If
            If blt = False Then
...
'        Timer1.Enabled = True
    ...
    If Not comEQP1.PortOpen Then comEQP1.PortOpen = True
    If comEQP1.PortOpen Then
        Call ShowMessage("연결 되었습니다.")
        imgPort.Picture = imlStatus.ListImages("RUN").ExtractIcon
        imgSend.Picture = imlStatus.ListImages("STOP").ExtractIcon
        imgReceive.Picture = imlStatus.ListImages("STOP").ExtractIcon
...
'        Timer1.Enabled = True
    ...
    If Not comEQP2.PortOpen Then comEQP2.PortOpen = True
    If comEQP2.PortOpen Then
        Call ShowMessage("연결 되었습니다.")
        imgPort.Picture = imlStatus.ListImages("RUN").ExtractIcon
        imgSend.Picture = imlStatus.ListImages("STOP").ExtractIcon
        imgReceive.Picture = imlStatus.ListImages("STOP").ExtractIcon
...
On Error GoTo ErrRoutine
    ...
    If comEQP1.PortOpen Then comEQP1.PortOpen = False
    If comEQP1.PortOpen Then
        Call ShowMessage("중지 되지 않았습니다.")
        imgPort.Picture = imlStatus.ListImages("RUN").ExtractIcon
        imgSend.Picture = imlStatus.ListImages("STOP").ExtractIcon
    ...
    If comEQP2.PortOpen Then comEQP2.PortOpen = False
    If comEQP2.PortOpen Then
        Call ShowMessage("중지 되지 않았습니다.")
        imgPort.Picture = imlStatus.ListImages("RUN").ExtractIcon
        imgSend.Picture = imlStatus.ListImages("STOP").ExtractIcon
...
'                                 sqlDoc = sqlDoc + "       STATUS = '1'"
    ...
    With spdView
        ...
        ssRow = 1:   ssCol = 1
        For iCnt = 7 To spdResult1.MaxCols
            spdResult1.GetText iCnt, 1, varTmp
            .SetText ssCol, ssRow, varTmp
            
            ssRow = ssRow + 1
            If (ssRow Mod 2) = 1 Then
                ssRow = 1: ssCol = ssCol + 1
            End If
        Next iCnt
    End With
