...
Begin VB.Form frmComm 
   ...
   Begin TabDlg.SSTab tabWork 
      ...
      Tab(0).Control(10)=   "cmdStartNo"
      Tab(0).Control(10).Enabled=   0   'False
      Tab(0).Control(11)=   "cmdWordQuery"
      Tab(0).Control(11).Enabled=   0   'False
      Tab(0).Control(12)=   "cmdEot"
      Tab(0).Control(12).Enabled=   0   'False
      Tab(0).Control(13)=   "cmdSearch"
      Tab(0).Control(13).Enabled=   0   'False
      Tab(0).Control(14)=   "cmdAppend(0)"
      Tab(0).Control(14).Enabled=   0   'False
      Tab(0).Control(15)=   "FrameResult"
      Tab(0).Control(15).Enabled=   0   'False
      Tab(0).Control(16)=   "SSPanel1"
      Tab(0).Control(16).Enabled=   0   'False
      Tab(0).Control(17)=   "SSPanel2"
      Tab(0).Control(17).Enabled=   0   'False
      Tab(0).Control(18)=   "cmdWorkList"
      ...
      Tab(0).Control(22)=   "cmdNext"
      Tab(0).Control(22).Enabled=   0   'False
      Tab(0).Control(23)=   "cmdPrevious"
      Tab(0).Control(23).Enabled=   0   'False
      Tab(0).Control(24)=   "spdWorklist"
      Tab(0).Control(24).Enabled=   0   'False
      Tab(0).Control(25)=   "Frame4"
      Tab(0).Control(25).Enabled=   0   'False
      Tab(0).Control(26)=   "txtSeqNo"
      Tab(0).Control(26).Enabled=   0   'False
      Tab(0).Control(27)=   "Command2"
      Tab(0).Control(27).Enabled=   0   'False
      Tab(0).Control(28)=   "Frame3"
      Tab(0).Control(28).Enabled=   0   'False
      Tab(0).Control(29)=   "List1"
      Tab(0).Control(29).Enabled=   0   'False
      Tab(0).Control(30)=   "Command1"
      Tab(0).Control(30).Enabled=   0   'False
      Tab(0).Control(31)=   "txtBarCode"
      Tab(0).Control(31).Enabled=   0   'False
      Tab(0).Control(32)=   "txtResult"
      Tab(0).Control(32).Enabled=   0   'False
      Tab(0).Control(33)=   "chkAuto"
      ...
      Begin VB.ComboBox cboRstgbn 
         Height          =   300
         Index           =   1
         ItemData        =   "frmComm.frx":686A
         Left            =   -72570
         List            =   "frmComm.frx":6877
         Style           =   2  '드롭다운 목록
         TabIndex        =   53
         Top             =   495
         Width           =   1770
      ...
      Begin VB.ListBox List1 
         Height          =   2220
         ItemData        =   "frmComm.frx":68A1
         Left            =   7950
         List            =   "frmComm.frx":68A3
         TabIndex        =   36
         Top             =   6060
         Visible         =   0   'False
         Width           =   7215
      ...
      Begin VB.Frame Frame4 
         ...
         Begin Threed.SSPanel SSPanel3 
            ...
            Begin VB.ComboBox Combo2 
               Height          =   300
               ItemData        =   "frmComm.frx":7195
               Left            =   8100
               List            =   "frmComm.frx":7197
               TabIndex        =   20
               Top             =   705
               Visible         =   0   'False
               Width           =   1725
         ...
         Begin FPSpread.vaSpread spdView 
            ...
            SpreadDesigner  =   "frmComm.frx":7199
            UserResize      =   0
         End
      End
      Begin FPSpread.vaSpread spdWorklist 
         ...
         SpreadDesigner  =   "frmComm.frx":76CB
         UserResize      =   2
      End
      ...
      Begin BHButton.BHImageButton cmdNext 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         TransparentPicture=   "frmComm.frx":7BFA
         ForeColor       =   16711680
         BackColor       =   255
         AlphaColor      =   255
         ImgOutLineSize  =   3
      ...
      Begin FPSpread.vaSpread spdResult1 
         ...
         ScrollBarMaxAlign=   0   'False
         ShadowColor     =   14735309
         SpreadDesigner  =   "frmComm.frx":806C
         UserResize      =   0
      End
      ...
      Begin FPSpread.vaSpread spdResult2 
         ...
         ScrollBarMaxAlign=   0   'False
         ShadowColor     =   14735310
         SpreadDesigner  =   "frmComm.frx":85A9
         UserResize      =   0
      End
      ...
      Begin Threed.SSPanel SSPanel1 
         ...
         Begin VB.ComboBox cboComNm 
            Height          =   300
            ItemData        =   "frmComm.frx":8A63
            Left            =   4590
            List            =   "frmComm.frx":8A65
            TabIndex        =   48
            Top             =   480
            Visible         =   0   'False
            Width           =   1725
         ...
         Begin VB.ComboBox cboChk 
            Height          =   300
            ItemData        =   "frmComm.frx":8A67
            Left            =   4950
            List            =   "frmComm.frx":8A71
            TabIndex        =   44
            Top             =   90
            Visible         =   0   'False
            Width           =   1095
      ...
      Begin FPSpread.vaSpread spdRstview 
         ...
         ScrollBars      =   0
         ShadowColor     =   14735310
         SpreadDesigner  =   "frmComm.frx":9371
         UserResize      =   0
      End
