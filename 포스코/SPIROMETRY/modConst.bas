...
Public Const colRACKNO = 7      '신장   렉번호
Public Const colPOSNO = 8       '체중   포지션
Public Const colINOUT = 9       '온도   입원/외래
Public Const colCHARTNO = 10    '습도   챠트번호
Public Const colPID = 11        '기압   환자번호,병록번호,내원번호
Public Const colPNAME = 12      '이름
Public Const colPSEX = 13       '성별
Public Const colPAGE = 14       '나이
Public Const colPJUMIN = 15     'Race   주민
