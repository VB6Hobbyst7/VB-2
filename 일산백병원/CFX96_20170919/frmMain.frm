...
Begin VB.Form frmMain 
   ...
   Begin VB.Frame FraHidden 
      ...
      Begin FPSpread.vaSpread vasPrint 
         ...
         EndProperty
         RetainSelBlock  =   0   'False
         SpreadDesigner  =   "frmMain.frx":A05D
      End
   ...
   Begin VB.Frame frame2 
      ...
      Begin FPSpread.vaSpread spdROrder 
         ...
         SpreadDesigner  =   "frmMain.frx":E76E
         UserResize      =   2
         ScrollBarTrack  =   1
         ShowScrollTips  =   3
      End
      ...
      Begin FPSpread.vaSpread spdRResult 
         ...
         SpreadDesigner  =   "frmMain.frx":12F92
         TextTip         =   2
      End
   ...
   Begin VB.Frame frame1 
      ...
      Begin FPSpread.vaSpread spdOrder 
         ...
         ScrollBarShowMax=   0   'False
         ShadowColor     =   14548991
         SpreadDesigner  =   "frmMain.frx":1398C
         ScrollBarTrack  =   1
         ShowScrollTips  =   3
      End
      ...
      Begin FPSpread.vaSpread spdResult 
         ...
         SelectBlockOptions=   0
         ShadowColor     =   13697023
         SpreadDesigner  =   "frmMain.frx":182EC
         TextTip         =   2
      End
   End
   ...
   Begin VB.PictureBox Picture2 
      ...
      Begin VB.Frame fraResult 
         ...
         Begin VB.ComboBox cboRstType 
            ...
            EndProperty
            Height          =   300
            ItemData        =   "frmMain.frx":18D6C
            Left            =   420
            List            =   "frmMain.frx":18D6E
            TabIndex        =   127
            Top             =   180
            Width           =   1245
         End
         Begin VB.ComboBox cboState 
            ...
            EndProperty
            Height          =   300
            ItemData        =   "frmMain.frx":18D70
            Left            =   4710
            List            =   "frmMain.frx":18D72
            TabIndex        =   126
            Top             =   180
            Width           =   1395
         End
   ...
   Begin VB.Frame frame4 
      ...
      Begin VB.Frame frameCom 
         ...
         Begin VB.ComboBox cboPort 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmMain.frx":1D0BB
            Left            =   2190
            List            =   "frmMain.frx":1D0BD
            TabIndex        =   62
            Top             =   390
            Width           =   2205
         End
         Begin VB.ComboBox cboBaudrate 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmMain.frx":1D0BF
            Left            =   2190
            List            =   "frmMain.frx":1D0C1
            TabIndex        =   61
            Top             =   780
            Width           =   2205
         End
         Begin VB.ComboBox cboDatabit 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmMain.frx":1D0C3
            Left            =   2190
            List            =   "frmMain.frx":1D0C5
            TabIndex        =   60
            Top             =   1170
            Width           =   2205
         End
         ...
         Begin VB.ComboBox cboParity 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmMain.frx":1D0C7
            Left            =   2190
            List            =   "frmMain.frx":1D0C9
            TabIndex        =   57
            Top             =   2520
            Width           =   2205
         End
   ...
   Begin VB.Frame frame3 
      ...
      Begin VB.Frame frameTestSet 
         ...
         Begin VB.Frame frameOrder 
            ...
            Begin FPSpread.vaSpread spdOrdMst 
               ...
               SelectBlockOptions=   0
               ShadowColor     =   13697023
               SpreadDesigner  =   "frmMain.frx":1E847
               TextTip         =   2
            End
         End
         Begin VB.ComboBox cboResultType 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmMain.frx":1EDBE
            Left            =   1650
            List            =   "frmMain.frx":1EDC0
            TabIndex        =   42
            Top             =   4470
            Width           =   1575
         End
         ...
         Begin VB.Frame frameCutOff 
            ...
            Begin VB.ComboBox cboCOH 
               ...
               EndProperty
               Height          =   315
               ItemData        =   "frmMain.frx":1EDC2
               Left            =   2730
               List            =   "frmMain.frx":1EDC4
               TabIndex        =   38
               Top             =   1020
               Width           =   735
            End
            ...
            Begin VB.ComboBox cboCOL 
               ...
               EndProperty
               Height          =   315
               ItemData        =   "frmMain.frx":1EDC6
               Left            =   2730
               List            =   "frmMain.frx":1EDC8
               TabIndex        =   29
               Top             =   300
               Width           =   735
            End
      ...
      Begin FPSpread.vaSpread spdTest 
         ...
         RetainSelBlock  =   0   'False
         SelectBlockOptions=   0
         SpreadDesigner  =   "frmMain.frx":25FF9
      End
   End
    ...
    With spdOrder
        For iRow = 1 To .MaxRows
            ...
            If iRow = 1 Then
                ...
                SetText vasPrint, Trim(GetText(spdOrder, 0, colTESTDATE)), 0, j:    vasPrint.ColWidth(j) = 6:  j = j + 1
                SetText vasPrint, Trim(GetText(spdOrder, 0, colSPCPART)), 0, j:     vasPrint.ColWidth(j) = 6:  j = j + 1
                SetText vasPrint, Trim(GetText(spdOrder, 0, colBARCODE)), 0, j:     vasPrint.ColWidth(j) = 10:  j = j + 1
                SetText vasPrint, Trim(GetText(spdOrder, 0, colRELTEST)), 0, j:     vasPrint.ColWidth(j) = 10:  j = j + 1
                ...
                SetText vasPrint, "HPV", 0, j:       vasPrint.ColWidth(j) = 20:  j = j + 1
    ...
    With spdROrder
        For iRow = 1 To .MaxRows
            If iRow = 1 Then
                ...
                SetText vasPrint, Trim(GetText(spdROrder, 0, colTESTNM)), 0, j:      vasPrint.ColWidth(j) = 6:  j = j + 1
                SetText vasPrint, Trim(GetText(spdROrder, 0, colTESTDATE)), 0, j:    vasPrint.ColWidth(j) = 8:  j = j + 1
                SetText vasPrint, Trim(GetText(spdROrder, 0, colSPCPART)), 0, j:     vasPrint.ColWidth(j) = 6:  j = j + 1
                SetText vasPrint, Trim(GetText(spdROrder, 0, colBARCODE)), 0, j:     vasPrint.ColWidth(j) = 10:  j = j + 1
                SetText vasPrint, Trim(GetText(spdROrder, 0, colRELTEST)), 0, j:     vasPrint.ColWidth(j) = 10:  j = j + 1
