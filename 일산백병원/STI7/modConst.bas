...
Public Const colSPCNUM = 18     '검체번호(입력용)

Public Const colRELTEST = 19    '상관성결과

Public Const colSPCCD = 20      '검체코드
Public Const colSPCNM = 21      '검체명
Public Const colRESULT = 22     '검사결과

Public Const colHPVIC = 23      'IC
Public Const colSTI7 = 23      'IC
Public Const colPRERESULT = 24  '이전결과
Public Const colMETHOD = 25     'Method
Public Const colREMARK = 26     'Remakr


Public Const colRSTDATE = 27    '검사보고일
Public Const colDOCTOR = 28     '판독의사
Public Const colPRINT = 29      '보고서출력
Public Const colSTATE = 30      '검사상태
'-- 워크리스트 용
Public Const colITEMS = 31
