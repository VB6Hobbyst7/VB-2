...
'                    Set prm(89) = .CreateParameter("@M502", adSmallInt, adParamInput, 1, intINData)     '--DNA-Chip Negative
                    ...
                    '----------- STI값 비움 ----------------------------------------------------
                    Set prm(101) = .CreateParameter("@M521", adSmallInt, adParamInput, 1, 0)
                    Set prm(102) = .CreateParameter("@M522", adSmallInt, adParamInput, 1, 0)
                    Set prm(103) = .CreateParameter("@M523", adSmallInt, adParamInput, 1, 0)
                    Set prm(104) = .CreateParameter("@M524", adSmallInt, adParamInput, 1, 0)
                    
                    Set prm(105) = .CreateParameter("@M530T", adChar, adParamInput, 10, "")      '--STI - UU
                    Set prm(106) = .CreateParameter("@M531T", adChar, adParamInput, 10, "")      '--STI - UP
                    Set prm(107) = .CreateParameter("@M527T", adChar, adParamInput, 10, "")      '--STI - MG
                    Set prm(108) = .CreateParameter("@M528T", adChar, adParamInput, 10, "")      '--STI - MH
                    Set prm(109) = .CreateParameter("@M526T", adChar, adParamInput, 10, "")      '--STI - NG
                    Set prm(110) = .CreateParameter("@M525T", adChar, adParamInput, 10, "")      '--STI - CT
                    Set prm(111) = .CreateParameter("@M529T", adChar, adParamInput, 10, "")      '--STI - TV
