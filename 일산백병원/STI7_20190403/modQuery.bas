    ...
    If Not RS.EOF = True And Not RS.BOF = True Then
        ...
        Do Until RS.EOF
            ...
            With frmWorkList.spdWork
                ...
                SetText frmWorkList.spdWork, "STI7", intRow, colTESTNM        '검사항목
        ...
        Do Until RS.EOF
            ...
            With frmMain.spdROrder
                ...
                If strSaveSeq <> Trim(RS.Fields("SAVESEQ")) & "" Or strExamDate <> Trim(RS.Fields("EXAMDATE")) & "" Then
                    ...
                    SetText frmMain.spdROrder, Trim(RS.Fields("TEMP1")) & "", intRow, colSPCNUM
    ...
    With frmMain.spdOrder
        If Not RS.EOF = True And Not RS.BOF = True Then
            ...
            Do Until RS.EOF
                ...
                SetText frmMain.spdOrder, "STI7", intRow, colTESTNM        '검사항목
...
Function SetLocalDB(ByVal asRow1 As Long, ByVal asRow2 As Long, asSend As String, Optional asEquipResult As String = "")
    ...
    With frmMain
        ...
        If DBExec(AdoCn_Local, SQL) Then
            ...
            SQL = SQL & ",'" & Trim(GetText(.spdOrder, asRow1, colSPCNUM)) & "'"
            SQL = SQL & ",''"
            SQL = SQL & ",''" & vbCr
            
            SQL = SQL & ",'0'"                                                  '전송구분(0:미전송,1:전송)
            SQL = SQL & ",''"
            SQL = SQL & ",'" & Trim(GetText(.spdOrder, asRow1, colSTI7)) & "'"
...
Function SetLocalDB_Update(ByVal asRow1 As Long)
    ...
    With frmMain
        ...
        SQL = SQL & ", TEMP1     = '" & Trim(GetText(.spdOrder, asRow1, colSPCNUM)) & "'" & vbCr
        
        
        '-- 추가 : 판정결과, 검사결과
        SQL = SQL & ", EQUIPRESULT = '" & Trim(GetText(.spdOrder, asRow1, colRESULT)) & "'" & vbCr
        For intTestCnt = colITEMS + 1 To .spdOrder.MaxCols
            If Trim(GetText(.spdOrder, asRow1, intTestCnt)) <> "" Then
                SQL = SQL & ", RESULT      = '" & Trim(GetText(.spdOrder, asRow1, intTestCnt)) & "'" & vbCr
                Exit For
            End If
        Next
        SQL = SQL & " WHERE SAVESEQ     = " & Trim(GetText(.spdOrder, asRow1, colSAVESEQ)) & vbCr
