...
Begin VB.Form frmMain 
   ...
   Begin VB.Frame FraHidden 
      ...
      Begin FPSpread.vaSpread vasHPVReport 
         ...
         SpreadDesigner  =   "frmMain.frx":A17D
         UserResize      =   0
      End
      Begin FPSpread.vaSpread vasSTI7Report 
         ...
         ScrollBars      =   0
         ScrollBarShowMax=   0   'False
         SpreadDesigner  =   "frmMain.frx":10243
         UserResize      =   0
      End
   ...
   Begin VB.Frame frame2 
      ...
      Begin FPSpread.vaSpread spdROrder 
         ...
         SpreadDesigner  =   "frmMain.frx":15830
         UserResize      =   2
         ScrollBarTrack  =   1
         ShowScrollTips  =   3
      End
      ...
      Begin FPSpread.vaSpread spdRResult 
         ...
         SpreadDesigner  =   "frmMain.frx":1A1FC
         TextTip         =   2
      End
   ...
   Begin FPSpread.vaSpread vasPrint 
      ...
      EndProperty
      RetainSelBlock  =   0   'False
      SpreadDesigner  =   "frmMain.frx":1AD16
   End
   ...
   Begin VB.Frame frame4 
      ...
      Begin VB.Frame frameCom 
         ...
         Begin VB.ComboBox cboPort 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmMain.frx":234A4
            Left            =   2190
            List            =   "frmMain.frx":234A6
            TabIndex        =   62
            Top             =   390
            Width           =   2205
         End
         Begin VB.ComboBox cboBaudrate 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmMain.frx":234A8
            Left            =   2190
            List            =   "frmMain.frx":234AA
            TabIndex        =   61
            Top             =   780
            Width           =   2205
         End
         Begin VB.ComboBox cboDatabit 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmMain.frx":234AC
            Left            =   2190
            List            =   "frmMain.frx":234AE
            TabIndex        =   60
            Top             =   1170
            Width           =   2205
         End
         ...
         Begin VB.ComboBox cboParity 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmMain.frx":234B0
            Left            =   2190
            List            =   "frmMain.frx":234B2
            TabIndex        =   57
            Top             =   2520
            Width           =   2205
         End
   ...
   Begin VB.PictureBox Picture2 
      ...
      Begin VB.Frame fraResult 
         ...
         Begin VB.ComboBox cboRstType 
            ...
            EndProperty
            Height          =   300
            ItemData        =   "frmMain.frx":24C30
            Left            =   420
            List            =   "frmMain.frx":24C32
            TabIndex        =   127
            Top             =   180
            Width           =   1245
         End
         Begin VB.ComboBox cboState 
            ...
            EndProperty
            Height          =   300
            ItemData        =   "frmMain.frx":24C34
            Left            =   4710
            List            =   "frmMain.frx":24C36
            TabIndex        =   126
            Top             =   180
            Width           =   1395
         End
   ...
   Begin VB.Frame frame1 
      ...
      Begin FPSpread.vaSpread spdOrder 
         ...
         ScrollBarShowMax=   0   'False
         ShadowColor     =   14548991
         SpreadDesigner  =   "frmMain.frx":25022
         ScrollBarTrack  =   1
         ShowScrollTips  =   3
      End
      ...
      Begin FPSpread.vaSpread spdResult 
         ...
         SelectBlockOptions=   0
         ShadowColor     =   13697023
         SpreadDesigner  =   "frmMain.frx":29B37
         TextTip         =   2
      End
   End
   Begin VB.Frame frame3 
      ...
      Begin VB.Frame frameTestSet 
         ...
         Begin VB.Frame frameOrder 
            ...
            Begin FPSpread.vaSpread spdOrdMst 
               ...
               SelectBlockOptions=   0
               ShadowColor     =   13697023
               SpreadDesigner  =   "frmMain.frx":2A6D7
               TextTip         =   2
            End
         End
         Begin VB.ComboBox cboResultType 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmMain.frx":2AD6E
            Left            =   1650
            List            =   "frmMain.frx":2AD70
            TabIndex        =   42
            Top             =   4470
            Width           =   1575
         End
         ...
         Begin VB.Frame frameCutOff 
            ...
            Begin VB.ComboBox cboCOH 
               ...
               EndProperty
               Height          =   315
               ItemData        =   "frmMain.frx":2AD72
               Left            =   2730
               List            =   "frmMain.frx":2AD74
               TabIndex        =   38
               Top             =   1020
               Width           =   735
            End
            ...
            Begin VB.ComboBox cboCOL 
               ...
               EndProperty
               Height          =   315
               ItemData        =   "frmMain.frx":2AD76
               Left            =   2730
               List            =   "frmMain.frx":2AD78
               TabIndex        =   29
               Top             =   300
               Width           =   735
            End
      ...
      Begin FPSpread.vaSpread spdTest 
         ...
         RetainSelBlock  =   0   'False
         SelectBlockOptions=   0
         SpreadDesigner  =   "frmMain.frx":31FA9
      End
   End
...
Private Sub cmdAllPrint_Click()
    ...
    With spdROrder
        For iRow = 1 To .DataRowCnt
            If GetText(spdROrder, iRow, colCHECKBOX) = "1" Then
...
'                vasHPVReport.Visible = True
'                vasHPVReport.ZOrder 0
                ...
                'Exit Sub
            Else
                'MsgBox "환자정보가 없습니다", vbOKOnly + vbCritical, Me.Caption
            End If
        Next
    End With
...
'    spdOrder.PrintOrientation = PrintOrientationLandscape '가로출력
'    spdOrder.Action = 13
    vasPrint.MaxRows = 0
    vasPrint.MaxCols = 30
    ...
    With spdOrder
        For iRow = 1 To .MaxRows
            ...
            If iRow = 1 Then
                ...
                SetText vasPrint, "접수 번호", 0, j:       vasPrint.ColWidth(j) = 5:  j = j + 1
...
'                SetText vasPrint, Trim(GetText(spdOrder, 0, colTESTNM)), 0, j:      vasPrint.ColWidth(j) = 8:  j = j + 1
                SetText vasPrint, Trim(GetText(spdOrder, 0, colTESTDATE)), 0, j:    vasPrint.ColWidth(j) = 4:  j = j + 1
...
'                SetText vasPrint, Trim(GetText(spdOrder, 0, colBARCODE)), 0, j:     vasPrint.ColWidth(j) = 10:  j = j + 1
                SetText vasPrint, Trim(GetText(spdOrder, 0, colRELTEST)), 0, j:     vasPrint.ColWidth(j) = 15:  j = j + 1
                ...
                SetText vasPrint, Trim(GetText(spdOrder, 0, colSPCNUM)), 0, j:      vasPrint.ColWidth(j) = 7:  j = j + 1
                
                SetText vasPrint, Trim(GetText(spdOrder, 0, colSTI7)), 0, j:        vasPrint.ColWidth(j) = 4:  j = j + 1
                SetText vasPrint, Trim(GetText(spdOrder, 0, colPRERESULT)), 0, j:   vasPrint.ColWidth(j) = 10:  j = j + 1
                SetText vasPrint, Trim(GetText(spdOrder, 0, colMETHOD)), 0, j:      vasPrint.ColWidth(j) = 7:  j = j + 1
                SetText vasPrint, Trim(GetText(spdOrder, 0, colREMARK)), 0, j:      vasPrint.ColWidth(j) = 7:  j = j + 1
                ...
                SetText vasPrint, "STI7", 0, j:       vasPrint.ColWidth(j) = 32:  j = j + 1
...
'                SetText vasPrint, Trim(GetText(spdOrder, iRow, colBARCODE)), iRow, j: j = j + 1
                ...
                SetText vasPrint, Trim(GetText(spdOrder, iRow, colSPCNUM)), iRow, j: j = j + 1
                
                SetText vasPrint, Trim(GetText(spdOrder, iRow, colSTI7)), iRow, j: j = j + 1
                ...
                ElseIf Trim(GetText(spdOrder, iRow, colITEMS + 3)) <> "" Then
                    SetText vasPrint, Trim(GetText(spdOrder, iRow, colITEMS + 3)), iRow, j: j = j + 1
                End If
            End If
        Next iRow
...
On Error GoTo ErrRoutine
    ...
    'SetRawData "[RCV]" & strBuffer
    
    varTmp = Split(strBuffer, vbLf)
    
    'SetRawData "[varTmp]" & UBound(varTmp)
    ...
    With spdROrder
        For iRow = 1 To .MaxRows
            If iRow = 1 Then
                ...
                SetText vasPrint, Trim(GetText(spdROrder, 0, colTESTDATE)), 0, j:    vasPrint.ColWidth(j) = 4:  j = j + 1
...
'                SetText vasPrint, Trim(GetText(spdROrder, 0, colBARCODE)), 0, j:     vasPrint.ColWidth(j) = 10:  j = j + 1
                SetText vasPrint, Trim(GetText(spdROrder, 0, colRELTEST)), 0, j:     vasPrint.ColWidth(j) = 15:  j = j + 1
                ...
                SetText vasPrint, Trim(GetText(spdROrder, 0, colSPCNUM)), 0, j:      vasPrint.ColWidth(j) = 7:  j = j + 1
                
                SetText vasPrint, Trim(GetText(spdROrder, 0, colHPVIC)), 0, j:       vasPrint.ColWidth(j) = 4:  j = j + 1
                SetText vasPrint, Trim(GetText(spdROrder, 0, colPRERESULT)), 0, j:   vasPrint.ColWidth(j) = 10:  j = j + 1
                SetText vasPrint, Trim(GetText(spdROrder, 0, colMETHOD)), 0, j:      vasPrint.ColWidth(j) = 7:  j = j + 1
                SetText vasPrint, Trim(GetText(spdROrder, 0, colREMARK)), 0, j:      vasPrint.ColWidth(j) = 7:  j = j + 1
...
'                SetText vasPrint, Trim(GetText(spdROrder, iRow, colBARCODE)), iRow, j: j = j + 1
                ...
                SetText vasPrint, Trim(GetText(spdROrder, iRow, colSPCNUM)), iRow, j: j = j + 1
                ...
                ElseIf Trim(GetText(spdROrder, iRow, colITEMS + 3)) <> "" Then
                    SetText vasPrint, Trim(GetText(spdROrder, iRow, colITEMS + 3)), iRow, j: j = j + 1
                End If
            End If
        Next iRow
...
Private Sub cmdRSave_Click()
    ...
    If MsgBox("검사결과를 병원서버로 저장하시겠습니까?", vbYesNo + vbDefaultButton1 + vbInformation, Me.Caption) = vbNo Then
        Exit Sub
    End If
...
Private Sub spdOrder_KeyDown(KeyCode As Integer, Shift As Integer)
    ...
    If KeyCode = vbKeyDelete Then
        If sRow < 1 Or sRow > spdOrder.DataRowCnt Then
            Exit Sub
        End If
        ...
        lsSeq = Trim(GetText(spdOrder, sRow, colSAVESEQ))
        strExamDate = Trim(GetText(spdOrder, sRow, colEXAMDATE))
        strBarno = Trim(GetText(spdOrder, sRow, colJUBNO))
        ...
        If MsgBox(strBarno & " 의 결과를 삭제하시겠습니까?", vbInformation + vbYesNo, "알림") = vbNo Then
            Exit Sub
        End If
...
Private Sub spdROrder_KeyDown(KeyCode As Integer, Shift As Integer)
    ...
    If KeyCode = vbKeyDelete Then
        ...
        strBarno = Trim(GetText(spdROrder, sRow, colJUBNO))
...
Private Sub tmrConn_Timer()
    ...
    Set RS = AdoCn.Execute("Exec p_inter_k2t03Query '2','','','',''", sqlRet)
    RS.Close
...
Private Sub SetPrint_STI7()
    ...
    With vasSTI7Report
        ...
        .Row = 37: .Col = 2:   .Text = varClipData(colREMARK)
...
'    blnPos = False
    ...
    With vasHPVReport
        ...
        '.Row = 13: .Col = 14: .Text = " " & varClipData(colRESULT)
...
'''        End If
        ...
        If blnHPos = True Or blnLPos = True Then
            .Row = 24: .Col = 15: .Text = " □ "        'Negative 여부
        Else
            '-- 2018.12.10 수정 : Insufficient sample 결과가 Invalid 일 경우  Negative의 결과가 체크되는 현상 수정
