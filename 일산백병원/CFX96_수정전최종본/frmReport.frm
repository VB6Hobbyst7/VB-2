...
Begin VB.Form frmReport 
   ...
   Begin FPSpread.vaSpread vaSpread1 
      ...
      ScrollBars      =   0
      ScrollBarShowMax=   0   'False
      SpreadDesigner  =   "frmReport.frx":60C3
      UserResize      =   0
   End
End
...
Private Sub SetPrint()
    ...
    With vasHPVReport
'        For i = 1 To 25
'            Debug.Print i & " : " & varClipData(i)
'        Next
        
'        .Row = 5: .Col = 12: .Text = " " & varClipData(6)           '분자병리 접수번호
'        .Row = 8: .Col = 14: .Text = " " & varClipData(5)           '의뢰일자
'        .Row = 10: .Col = 4: .Text = " " & varClipData(7)           '등록번호
'        .Row = 11: .Col = 4: .Text = " " & varClipData(8)           '성     명
'        .Row = 12: .Col = 4: .Text = " " & varClipData(9) & "/" & varClipData(10)   '성별/나이
'        .Row = 13: .Col = 4: .Text = " " & varClipData(11) & "/" & varClipData(12)  '과/병실
'
'        .Row = 10: .Col = 14: .Text = " " & "Real-time PCR"     '검사 방법
'        .Row = 11: .Col = 14: .Text = " " & varClipData(16)  '검체 종류
'        .Row = 12: .Col = 14: .Text = " " & varClipData(17)  '검체 번호
'        .Row = 13: .Col = 14: .Text = " " & varClipData(15)  '검사 일자
        
        .Row = 5: .Col = 12: .Text = " " & varClipData(colJUBNO)           '분자병리 접수번호
        .Row = 8: .Col = 14: .Text = " " & varClipData(colRCPDATE)            '의뢰일자
        ...
        .Row = 12: .Col = 14: .Text = " " & varClipData(colBARCODE)   '검체 번호
        .Row = 13: .Col = 14: .Text = " " & varClipData(colTESTDATE)   '검사시행일
            ...
            If varTmp(i) <> "" Then
                ...
                ElseIf Mid(varTmp(i), 1, 2) = "IC" Then
                    ...
                    If InStr(strICData, "/") > 0 Then
                        ...
                        End If
                    End If
                    .Row = 24: .Col = 16: .Text = strICData            'IC Value
...
'        Erase varTemp2
        ...
        .Row = 19: .Col = 17: .Text = "IC " & varICData(0)
        .Row = 21: .Col = 17: .Text = "IC " & varICData(1)
        ...
        .Row = 42: .Col = 15:   .Text = varClipData(colDOCTOR)  '판독의사
