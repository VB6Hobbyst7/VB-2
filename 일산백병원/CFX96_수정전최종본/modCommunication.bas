...
Public Sub FileRcvData_CFX96()
    ...
    With frmMain
        ...
        For intCnt = 1 To UBound(strRecvData)
            ...
            'If strTarget = "6" Or strTarget = "11" Or strTarget = "40" Or strTarget = "42" Or strTarget = "43" Or strTarget = "44" Or strTarget = "54" Or strTarget = "61" Then
        ...
        Else
            ...
            ElseIf strTotFlag = "Positive" Then
                ...
                End If
            End If
            'strFlag = strFlag & vbNewLine & "IC " & strICVal
...
'                      SQL = "Exec p_inter_k2a03Add " & intBarno
'                SQL = SQL & "," & strTestCd
'                SQL = SQL & "," & sResult
'                SQL = SQL & "," & gHOSP.MACHCD
                ...
                With AdoCmd
                    ...
                    .Parameters.Append prm(1)
                    Set prm(2) = .CreateParameter("@JUB_NO", adChar, adParamInput, 11, strJubNo)         '접수번호
                    .Parameters.Append prm(2)
                    Set prm(3) = .CreateParameter("@CHART_NO", adChar, adParamInput, 7, strChartNo)       '등록번호
                    .Parameters.Append prm(3)
                    Set prm(4) = .CreateParameter("@RESULT_RESID", adChar, adParamInput, 5, strDoctor)
                    .Parameters.Append prm(4)
                    Set prm(5) = .CreateParameter("@RESULT_STAFF", adChar, adParamInput, 5, "")
                    .Parameters.Append prm(5)
                    Set prm(6) = .CreateParameter("@RESULT_STAFF2", adChar, adParamInput, 5, "")
                    .Parameters.Append prm(6)
                    Set prm(7) = .CreateParameter("@RESULT_DATE", adChar, adParamInput, 8, strRstDate)
                    .Parameters.Append prm(7)
                    

                    'Set prm(74) = .CreateParameter("@M501", adBinary, adParamInput, 30, "")
                    Set prm(11) = .CreateParameter("@M5011", adBinary, adParamInput, 30, "")    '--DNA-Chip - High-Risk Positive
                    .Parameters.Append prm(11)
                    Set prm(12) = .CreateParameter("@M5012", adBinary, adParamInput, 30, "")    '--DNA-Chip - Low-Risk Positive
                    .Parameters.Append prm(12)
                    Set prm(13) = .CreateParameter("@M5013", adBinary, adParamInput, 30, "")    '--DNA-Chip - Multiple Infection
                    .Parameters.Append prm(13)
                    Set prm(14) = .CreateParameter("@M5014", adBinary, adParamInput, 30, "")    '--DNA-Chip - Other Type Positive
                    .Parameters.Append prm(14)
                    Set prm(15) = .CreateParameter("@M501T", adVarChar, adParamInput, 100, "")    '-- HPV type - (1행,1열)
                    .Parameters.Append prm(15)
                    Set prm(16) = .CreateParameter("@M502T", adVarChar, adParamInput, 100, "")    '-- HPV type - (1행,2열)
                    .Parameters.Append prm(16)
                    Set prm(17) = .CreateParameter("@M503T", adVarChar, adParamInput, 100, "")    '-- HPV type - (1행,3열)
                    .Parameters.Append prm(17)
                    Set prm(18) = .CreateParameter("@M504T", adVarChar, adParamInput, 100, "")    '-- HPV type - (1행,4열)
                    .Parameters.Append prm(18)
                    Set prm(19) = .CreateParameter("@M505T", adVarChar, adParamInput, 100, "")    '-- HPV type - (1행,2열)
                    .Parameters.Append prm(19)
                    Set prm(20) = .CreateParameter("@M506T", adVarChar, adParamInput, 100, "")    '-- HPV type - (2행,1열)
                    .Parameters.Append prm(20)
                    Set prm(21) = .CreateParameter("@M507T", adVarChar, adParamInput, 100, "")    '-- HPV type - (2행,2열)
                    .Parameters.Append prm(21)
                    Set prm(22) = .CreateParameter("@M508T", adVarChar, adParamInput, 100, "")    '-- HPV type - (2행,3열)
                    .Parameters.Append prm(22)
                    Set prm(23) = .CreateParameter("@M509T", adVarChar, adParamInput, 100, "")    '-- HPV type - (2행,4열)
                    .Parameters.Append prm(23)
                    Set prm(24) = .CreateParameter("@M510T", adVarChar, adParamInput, 100, "")    '-- HPV type - (2행,5열)
                    .Parameters.Append prm(24)
...
'''                    End If
'''
'''                    Set prm(8) = .CreateParameter("@M501", adSmallInt, adParamInput, 1, 0)
'''                    .Parameters.Append prm(8)
'''
'''                    Set prm(9) = .CreateParameter("@M5011", adSmallInt, adParamInput, 1, intINData)    '--DNA-Chip - High-Risk Positive
'''                    .Parameters.Append prm(9)
'''
...
'''                    End If
'''
'''                    Set prm(12) = .CreateParameter("@M5012", adSmallInt, adParamInput, 1, intINData)    '--DNA-Chip - Low-Risk Positive
'''                    .Parameters.Append prm(12)
'''
...
'''                    End If
'''
'''                    Set prm(13) = .CreateParameter("@M5013", adSmallInt, adParamInput, 1, intINData)    '--DNA-Chip - Multiple Infection
'''                    .Parameters.Append prm(13)
'''
''''                    Set prm(14) = .CreateParameter("@M5014", adSmallInt, adParamInput, 30, "")    '--DNA-Chip - Other Type Positive
''''                    .Parameters.Append prm(14)
'''
'''                    Set prm(15) = .CreateParameter("@M501T", adVarChar, adParamInput, 100, mGetP(strData, 1, "/"))  '-- HPV type - (1행,1열)
'''                    .Parameters.Append prm(15)
'''                    Set prm(16) = .CreateParameter("@M502T", adVarChar, adParamInput, 100, mGetP(strData, 2, "/"))    '-- HPV type - (1행,2열)
'''                    .Parameters.Append prm(16)
'''                    Set prm(17) = .CreateParameter("@M503T", adVarChar, adParamInput, 100, mGetP(strData, 3, "/"))    '-- HPV type - (1행,3열)
'''                    .Parameters.Append prm(17)
'''                    Set prm(18) = .CreateParameter("@M504T", adVarChar, adParamInput, 100, mGetP(strData, 4, "/"))    '-- HPV type - (1행,4열)
'''                    .Parameters.Append prm(18)
'''                    Set prm(19) = .CreateParameter("@M505T", adVarChar, adParamInput, 100, mGetP(strData, 5, "/"))    '-- HPV type - (1행,2열)
'''                    .Parameters.Append prm(19)
'''                    Set prm(20) = .CreateParameter("@M506T", adVarChar, adParamInput, 100, mGetP(strData, 6, "/"))    '-- HPV type - (2행,1열)
'''                    .Parameters.Append prm(20)
'''                    Set prm(21) = .CreateParameter("@M507T", adVarChar, adParamInput, 100, mGetP(strData, 7, "/"))    '-- HPV type - (2행,2열)
'''                    .Parameters.Append prm(21)
'''                    Set prm(22) = .CreateParameter("@M508T", adVarChar, adParamInput, 100, mGetP(strData, 8, "/"))    '-- HPV type - (2행,3열)
'''                    .Parameters.Append prm(22)
'''                    Set prm(23) = .CreateParameter("@M509T", adVarChar, adParamInput, 100, mGetP(strData, 9, "/"))    '-- HPV type - (2행,4열)
'''                    .Parameters.Append prm(23)
'''                    Set prm(24) = .CreateParameter("@M510T", adVarChar, adParamInput, 100, mGetP(strData, 10, "/"))    '-- HPV type - (2행,5열)
'''                    .Parameters.Append prm(24)
'''
...
'''                    End If
'''
'''                    Set prm(25) = .CreateParameter("@M502", adSmallInt, adParamInput, 1, intINData)    '--DNA-Chip Negative
'''                    .Parameters.Append prm(25)
'''
'''                    Set prm(26) = .CreateParameter("@M503", adSmallInt, adParamInput, 1, 0)    '--DNA-Chip Insufficient Sample
'''                    .Parameters.Append prm(26)
'''
'''                    Set prm(27) = .CreateParameter("@M134P", adSmallInt, adParamInput, 1, 0)    '--HPV 31 - Positive
'''                    .Parameters.Append prm(27)
'''                    Set prm(28) = .CreateParameter("@M134N", adSmallInt, adParamInput, 1, 0)    '--HPV 31
'''                    .Parameters.Append prm(28)
'''
'''                    Set prm(29) = .CreateParameter("@M135", adSmallInt, adParamInput, 1, 0)
'''                    Set prm(30) = .CreateParameter("@M135P", adSmallInt, adParamInput, 1, 0)
'''                    Set prm(31) = .CreateParameter("@M135N", adSmallInt, adParamInput, 1, 0)
'''                    Set prm(32) = .CreateParameter("@M136", adSmallInt, adParamInput, 1, 0)
'''                    Set prm(33) = .CreateParameter("@M136P", adSmallInt, adParamInput, 1, 0)
'''                    Set prm(34) = .CreateParameter("@M136N", adSmallInt, adParamInput, 1, 0)
'''                    Set prm(35) = .CreateParameter("@M137", adSmallInt, adParamInput, 1, 0)
'''                    Set prm(36) = .CreateParameter("@M137P", adSmallInt, adParamInput, 1, 0)
'''                    Set prm(37) = .CreateParameter("@M137N", adSmallInt, adParamInput, 1, 0)
'''                    Set prm(38) = .CreateParameter("@M138", adSmallInt, adParamInput, 1, 0)
'''                    Set prm(39) = .CreateParameter("@M138P", adSmallInt, adParamInput, 1, 0)
'''                    Set prm(40) = .CreateParameter("@M138N", adSmallInt, adParamInput, 1, 0)
'''
'''                    Set prm(41) = .CreateParameter("@M161", adSmallInt, adParamInput, 1, 0)
'''                    Set prm(42) = .CreateParameter("@M171", adSmallInt, adParamInput, 1, 0)
'''                    Set prm(43) = .CreateParameter("@M172", adSmallInt, adParamInput, 1, 0)
'''                    Set prm(44) = .CreateParameter("@M173", adSmallInt, adParamInput, 1, 0)
'''                    Set prm(45) = .CreateParameter("@M174", adSmallInt, adParamInput, 1, 0)
'''                    Set prm(46) = .CreateParameter("@M175", adSmallInt, adParamInput, 1, 0)
'''                    Set prm(47) = .CreateParameter("@M176", adSmallInt, adParamInput, 1, 0)
'''                    Set prm(48) = .CreateParameter("@M177", adSmallInt, adParamInput, 1, 0)
'''                    Set prm(49) = .CreateParameter("@M178", adSmallInt, adParamInput, 1, 0)
'''                    Set prm(50) = .CreateParameter("@M179", adSmallInt, adParamInput, 1, 0)
'''                    Set prm(51) = .CreateParameter("@M180", adSmallInt, adParamInput, 1, 0)
'''                    Set prm(52) = .CreateParameter("@M181", adSmallInt, adParamInput, 1, 0)
'''                    Set prm(53) = .CreateParameter("@M182", adSmallInt, adParamInput, 1, 0)
'''                    Set prm(54) = .CreateParameter("@M183", adSmallInt, adParamInput, 1, 0)
'''                    Set prm(55) = .CreateParameter("@M184", adSmallInt, adParamInput, 1, 0)
'''                    Set prm(56) = .CreateParameter("@M185", adSmallInt, adParamInput, 1, 0)
'''                    Set prm(57) = .CreateParameter("@M186", adSmallInt, adParamInput, 1, 0)
'''                    Set prm(58) = .CreateParameter("@M187", adSmallInt, adParamInput, 1, 0)
'''                    Set prm(59) = .CreateParameter("@M188", adSmallInt, adParamInput, 1, 0)
'''                    Set prm(60) = .CreateParameter("@M189", adSmallInt, adParamInput, 1, 0)
'''                    Set prm(61) = .CreateParameter("@M190", adSmallInt, adParamInput, 1, 0)
'''                    Set prm(62) = .CreateParameter("@M201", adSmallInt, adParamInput, 1, 0)
'''                    Set prm(63) = .CreateParameter("@M202", adSmallInt, adParamInput, 1, 0)
'''                    Set prm(64) = .CreateParameter("@M203", adSmallInt, adParamInput, 1, 0)
'''                    Set prm(65) = .CreateParameter("@M204", adSmallInt, adParamInput, 1, 0)
'''                    Set prm(66) = .CreateParameter("@M301", adSmallInt, adParamInput, 1, 0)
'''                    Set prm(67) = .CreateParameter("@M302", adSmallInt, adParamInput, 1, 0)
'''                    Set prm(68) = .CreateParameter("@M303", adSmallInt, adParamInput, 1, 0)
'''                    Set prm(69) = .CreateParameter("@M304", adSmallInt, adParamInput, 1, 0)
'''                    Set prm(70) = .CreateParameter("@M401", adSmallInt, adParamInput, 1, 0)
'''                    Set prm(71) = .CreateParameter("@M402", adSmallInt, adParamInput, 1, 0)
'''                    Set prm(72) = .CreateParameter("@M403", adSmallInt, adParamInput, 1, 0)
'''                    Set prm(73) = .CreateParameter("@M404", adSmallInt, adParamInput, 1, 0)
'''                    Set prm(74) = .CreateParameter("@M405", adSmallInt, adParamInput, 1, 0)
'''                    Set prm(75) = .CreateParameter("@M406", adSmallInt, adParamInput, 1, 0)
'''                    Set prm(76) = .CreateParameter("@M407", adSmallInt, adParamInput, 1, 0)
'''                    Set prm(77) = .CreateParameter("@MNOTE", adSmallInt, adParamInput, 1, 0)
'''
'''
'''
'''                    For k = 29 To 77
...
'                SQL = SQL & "," & gHOSP.MACHCD
                ...
                With AdoCmd
                    ...
                    Set prm(3) = .CreateParameter("@CHART_NO", adChar, adParamInput, 7, strChartNo)       '등록번호
                    Set prm(4) = .CreateParameter("@RESULT_RESID", adChar, adParamInput, 5, strDoctor)
                    Set prm(5) = .CreateParameter("@RESULT_STAFF", adChar, adParamInput, 5, strDoctor)
                    Set prm(6) = .CreateParameter("@RESULT_STAFF2", adChar, adParamInput, 5, "")
                    Set prm(7) = .CreateParameter("@RESULT_DATE", adChar, adParamInput, 8, Format(strRstDate, "yyyymmdd"))
                    ...
                    Set prm(73) = .CreateParameter("@MNOTE", adSmallInt, adParamInput, 1, 0)
