...
Begin VB.Form frmInterface 
   ...
   Begin VB.Frame FrmHideControl 
      ...
      Begin VB.Frame Frame4 
         ...
         Begin FPSpread.vaSpread vasPrintBuf 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            SpreadDesigner  =   "frmInterface.frx":528D
         End
      End
      ...
      Begin FPSpread.vaSpread vasCode 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":54A5
      End
      Begin FPSpread.vaSpread vasTemp1 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":56BD
      End
   ...
   Begin VB.Frame Frame1 
      ...
      Begin FPSpread.vaSpread vasID 
         ...
         SpreadDesigner  =   "frmInterface.frx":6FBB
      End
      ...
      Begin FPSpread.vaSpread vasExcel 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":7BCA
      End
      Begin FPSpread.vaSpread vasRes 
         ...
         RetainSelBlock  =   0   'False
         ScrollBars      =   2
         SpreadDesigner  =   "frmInterface.frx":7DE2
      End
   End
...
Private Sub EditRcvDataASTM()
    ...
    Dim strCtResult    As String   'Ct 결과
    ...
    For intCnt = 1 To UBound(strRecvData)
        ...
        Select Case strType
            ...
            Case "R"
                ...
                lsEquipRes
                If strIntBase = "^MTBRIF^^MTB^Xpert MTB-RIF Assay G4^5^MTB^" Then
                    strMTB = strResult
                    blnMTB = True
                ElseIf strIntBase = "^MTBRIF^^RIF^Xpert MTB-RIF Assay G4^5^Rif Resistance^" Then
                    strRIF = strResult
                    blnRIF = True
                End If
                
                'MTB : ^MTBRIF^^MTB^Xpert MTB-RIF Assay G4^5^MTB^
                'RIF : ^MTBRIF^^RIF^Xpert MTB-RIF Assay G4^5^Rif Resistance^
                
                If strResult = "" Then
                    strResult = "NA"
                ElseIf InStr(strResult, "LOW") > 0 Then
                    strResult = "DETECTED"
                ElseIf InStr(strResult, "HIGH") > 0 Then
                    strResult = "DETECTED"
                ElseIf InStr(strResult, "NOT") > 0 Then
                    strResult = "NOT DETECTED"
                ElseIf InStr(strResult, "DETECTED") > 0 Then
                    strResult = "DETECTED"
                End If
...
Rst:
                ...
                If blnMTB = True And blnRIF = True Then
                    strIntBase = "MTBRIF"
                    strResult = CheckGenExpert_MTB_Result(strMTB, strRIF)
                    blnMTB = False
                    blnRIF = False
                    GoTo Rst
                End If
            ...
            Case "L"
'                SetSQLData "바코드조회", "strState:" & strState
...
Function CheckGenExpert_MTB_Result(MTB As String, RIF As String) As String
    
    Const M1 = "MTB 양성(Very LOW),"
    Const M2 = "MTB 양성(LOW),"
    Const M3 = "MTB 양성(MEDIUM),"
    Const M4 = "MTB 양성(HIGH),"
    Const R1 = "RIF Indeterminate; "
    Const R2 = "RIF Susceptible; "
    Const R3 = "RIF Resistance; "
    ...
    CheckGenExpert_MTB_Result = ""
    
    RESULT = MTB

    If MTB = "NOT DETECTED" Then
        RESULT = "Negative"
    Else
      '//RES1:= 'MTB Detected';
        RES1 = "MTB " + MTB

        If InStr(UCase(RIF), "INDETERMINATE") > 0 Then
            RES2 = R1
        ElseIf InStr(UCase(RIF), "NOT DETECTED") > 0 Then
            RES2 = R2
        ElseIf InStr(UCase(RIF), "DETECTED") > 0 Then
            RES2 = R3
        End If
    ...
    CheckGenExpert_MTB_Result = RESULT
...
'        End If
    ...
    ElseIf KeyCode = vbKeyReturn Then
        If iCol = colBARCODE Then
            ...
            '-- 바뀐 바코드로 환자정보 불러오기
            Call GetSampleInfoW_SUNGMO(iRow)
