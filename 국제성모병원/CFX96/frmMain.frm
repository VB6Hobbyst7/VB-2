...
Begin VB.Form frmMain 
   ...
   Begin FPSpread.vaSpread spdResult 
      ...
      SpreadDesigner  =   "frmMain.frx":5777
      ScrollBarTrack  =   3
      ShowScrollTips  =   3
   End
      ...
      Begin MSComctlLib.ImageList imlStatus 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMain.frx":6E90
               Key             =   "STOP"
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMain.frx":742A
               Key             =   "LST"
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMain.frx":7CBC
               Key             =   "ITM"
            EndProperty
            ...
            BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMain.frx":7F70
               Key             =   "NOF"
            EndProperty
            BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMain.frx":80CA
               Key             =   "ON"
               Object.Tag             =   "OFF"
            EndProperty
            BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMain.frx":89A4
               Key             =   ""
            EndProperty
         EndProperty
      End
   ...
   Begin FPSpread.vaSpread spdOrder 
      ...
      ShadowColor     =   16777215
      SpreadDesigner  =   "frmMain.frx":B88E
      ScrollBarTrack  =   3
      ShowScrollTips  =   3
   End
   Begin FPSpread.vaSpread spdWork 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   16777215
      SpreadDesigner  =   "frmMain.frx":D56F
      ScrollBarTrack  =   3
      ShowScrollTips  =   3
   End
...
'    Else
'        Call FileRcvData_CFX96_forViewer
'    End If
...
'            End If
            ...
            Call GetSampleInfo_SUNGMO(intRow, spdOrder)
            ...
            For intCol = colITEMS To spdOrder.MaxCols
                ...
                End If
                If GetText(spdOrder, 0, intCol) = "IC" Then
            ...
            If strResult = "" Then
                If strRdRP <> "" And IsNumeric(strRdRP) Then
                    If CCur(strRdRP) <= 36 Then
                        strRdRP_NP = "Indetermined"
                    End If
                End If
                
                If strEVal <> "" And IsNumeric(strEVal) Then
                    If CCur(strEVal) > 36 Then
                        strEVal_NP = "Indetermined"
                    End If
                Else
                    strEVal_NP = "Indetermined"
                End If
                ...
                If strICA <> "" And IsNumeric(strICA) Then
                    If CCur(strICA) <= 32 Then
                        strICA_NP = "Indetermined"
                    End If
                End If
                
                If strRdRP_NP = "Indetermined" And strEVal_NP = "Indetermined" And strICA_NP = "Indetermined" Then
                    strResult = "Indetermined"
                End If
            End If
...
Private Sub FileRcvData_CFX96_forViewer()
    Dim RS_L            As ADODB.Recordset
...
'            End If
            ...
            'If IsNumeric(strBarno) Then
                ...
                For i = 1 To 5
                    intRCnt = intRCnt + 1
                    strIntBase = GetText(spdExcel, 1, 6 + i)
'                    If UCase(strIntBase) = "RESULT" Then
'                        strIntBase = "Covid19"
'                    End If
                    strResult = GetText(spdExcel, intRow, 6 + i)
                    strIntResult = strResult
