...
'    SQL = SQL & " ORDER BY JUBSU_DATE,BUNHO       "
    ...
    SQL = ""
    SQL = SQL & "SELECT DISTINCT "
    SQL = SQL & "  ORDER_DATE           AS HOSPDATE         " & vbCrLf
    SQL = SQL & ", SPECIMEN_SER         AS BARCODE          " & vbCrLf
    SQL = SQL & ", BUNHO                AS PID              " & vbCrLf
    SQL = SQL & ", SUNAME               AS PNAME            " & vbCrLf
    SQL = SQL & ", AGE                  AS AGE              " & vbCrLf
    ...
    SQL = SQL & " GROUP BY ORDER_DATE, SPECIMEN_SER,BUNHO,SUNAME,AGE,SEX,ORDER_INPUT  " & vbCrLf
    SQL = SQL & " ORDER BY ORDER_DATE, BUNHO       "
