...
Begin VB.Form frmMain 
   ...
   Begin FPSpread.vaSpread spdResult 
      ...
      SpreadDesigner  =   "frmMain.frx":0239
      ScrollBarTrack  =   3
      ShowScrollTips  =   3
   End
   ...
   Begin FPSpread.vaSpread spdOrder 
      ...
      ShadowColor     =   16777215
      SpreadDesigner  =   "frmMain.frx":6350
      ScrollBarTrack  =   3
      ShowScrollTips  =   3
   End
   Begin FPSpread.vaSpread spdWork 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   16777215
      SpreadDesigner  =   "frmMain.frx":8031
      ScrollBarTrack  =   3
      ShowScrollTips  =   3
   End
...
'    SQL = SQL & "   AND EQPMASTER.TESTCODE in ('LPD116','LPD228') "
