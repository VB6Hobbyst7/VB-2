   ...
   Begin TabDlg.SSTab stInterface 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin FPSpread.vaSpread vasID 
            ...
            RetainSelBlock  =   0   'False
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":8982
            UserResize      =   2
         End
         Begin FPSpread.vaSpread vasRes 
            ...
            RetainSelBlock  =   0   'False
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":938D
         End
...
'HOST->1O 0101009N0100000029738                                            U   20130704 1.0114  M6  M2  M3  M11 M5  M1  M8  M7  M AC
      '4O 0101037N0100000029738                                            U   20140526 1.0111  M10 M11 M12 M13 M14 M15 M16 M17 M18 M19 M2  M20 M21 M22 M23 M24 M25 M26 M27 M28 M29 M3  M30 M31 M32 M33 M34 M4  M5  M6  M7  M8  M9  M97 M98 M99 M DA
    ...
    With vasID
        ...
        If intRow = vasID.DataRowCnt Then
            strState = "E"
            intFrameNo = 1
        End If
...
'    Call SetText(vasID, mOrder.TubePos, intRow, colPos)     '4
    ...
    '-- intRow 추가
    strItems = GetGetEquipExamCode_BM6010(gEquip, pBarNo, intRow)

    If Trim(strItems) = "" Then
        mOrder.NoOrder = True
        mOrder.Order = ""
        'HOST->1O 0101009N0100000029738                                            U   20130704 1.0114  M6  M2  M3  M11 M5  M1  M8  M7  M AC
        Call SetText(vasID, "0", intRow, colCheckBox)         '1
        Call SetText(vasID, strItems, intRow, colRack)
        Call SetText(vasID, Len(strItems) / 4, intRow, colPos)
    Else
