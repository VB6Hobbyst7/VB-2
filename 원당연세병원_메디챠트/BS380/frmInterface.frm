   ...
   Begin TabDlg.SSTab stInterface 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin FPSpread.vaSpread vasID 
            ...
            RetainSelBlock  =   0   'False
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":C270
            UserResize      =   2
         End
         Begin FPSpread.vaSpread vasRes 
            ...
            RetainSelBlock  =   0   'False
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":CD7E
         End
         Begin VB.Label Label1 
            Appearance      =   0  '평면
            AutoSize        =   -1  'True
...
Private Sub EditRcvDataASTM()
    ...
    fLCBS200E = Split(strBuffer, vbCr)
 
    For intCnt = 0 To UBound(fLCBS200E)
        strTemp1 = fLCBS200E(intCnt)
        Debug.Print fLCBS200E(intCnt)
        ...
        Select Case Mid(strTemp1, 1, 3)
            ...
            Case "OBR"
                '-- 인터페이스 응답
                               strSndBuffer = SB & "MSH|^~\&|Mindray|BS-380|||" & Format(Now, "yyyymmddhhmmss") & "||ACK^R01|" & strSampleID & "|P|2.3.1||||0||ASCII|||" & vbCr
