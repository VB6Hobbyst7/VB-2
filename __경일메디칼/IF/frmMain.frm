...
Begin VB.Form frmMain 
   ...
   ScaleWidth      =   28560
   WindowState     =   2  '최대화
   Begin ChartfxLibCtl.ChartFX cfxTOSOH 
      Height          =   3495
      Left            =   16110
      TabIndex        =   73
      TabStop         =   0   'False
      ...
      MarkerSize      =   2
      BorderWidth     =   2
      BorderColor     =   16777257
      AxesStyle       =   0
      Axis(0).Min     =   -1
      Axis(0).Max     =   11
      Axis(0).Style   =   14440
      Axis(0).TickMark=   2
      Axis(0).MinorTickMark=   0
      Axis(1).Min     =   0
      Axis(1).Max     =   100
      Axis(1).Decimals=   0
      Axis(1).Style   =   10344
      Axis(1).MinorTickMark=   0
      Axis(1).GridColor=   0
      Axis(2).MinorStep=   1
      Axis(2).Style   =   14432
      Axis(2).MinorTickMark=   0
      Axis(2).PixPerUnit=   19
      RGBBk           =   16777215
      RGB2DBk         =   16777216
      RGB3DBk         =   16777215
      nColors         =   1
      Colors          =   "frmMain.frx":0E42
      ...
      NumPoint        =   300
      NumSer          =   1
      _Data_          =   "frmMain.frx":0E6A
   End
   Begin ChartfxLibCtl.ChartFX cfxTOSOH1 
      Height          =   4515
      Left            =   15810
      TabIndex        =   72
      Top             =   1860
   ...
   Begin FPSpread.vaSpread spdResult 
      ...
      SpreadDesigner  =   "frmMain.frx":124F
      ScrollBarTrack  =   3
      ShowScrollTips  =   3
   End
      ...
      Begin MSComctlLib.ImageList imlStatus 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMain.frx":23A1
               Key             =   "NOT"
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMain.frx":293B
               Key             =   "STOP"
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMain.frx":2ED5
               Key             =   "LST"
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMain.frx":3767
               Key             =   "ITM"
            EndProperty
            BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMain.frx":38C1
               Key             =   "ERR"
            EndProperty
            BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMain.frx":3A1B
               Key             =   "NOF"
            EndProperty
            BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMain.frx":3B75
               Key             =   "ON"
               Object.Tag             =   "OFF"
            EndProperty
            BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMain.frx":444F
               Key             =   ""
            EndProperty
         EndProperty
      End
   ...
   Begin FPSpread.vaSpread spdOrder 
      ...
      ScrollBarExtMode=   -1  'True
      ShadowColor     =   16777215
      SpreadDesigner  =   "frmMain.frx":7339
      ScrollBarTrack  =   3
      ShowScrollTips  =   3
   End
   Begin FPSpread.vaSpread spdWork 
      ...
      ScrollBarExtMode=   -1  'True
      ShadowColor     =   16777215
      SpreadDesigner  =   "frmMain.frx":8FDD
      ScrollBarTrack  =   3
      ShowScrollTips  =   3
   End
...
'    End If
    ...
    Select Case UCase(gHOSP.MACHNM)
        Case "G7":              Call Phase_Serial_G7
        Case "A1C22":           Call Phase_Serial_A1C22
        Case "G8":              Call Phase_Serial_G8
        Case "G8PC":            Call Phase_Serial_G8PC
...
Private Sub SerialRcvData_A1C22()
    Dim RS_L            As ADODB.Recordset
...
On Error GoTo RST
    ...
    With frmMain
        ...
        intPos = 1
        strSeq = Mid(strRcvBuf, intPos, 8)
        
        If Mid(strSeq, 1, 1) = "?" Then
            intPos = intPos + 7
        Else
            intPos = intPos + 8
        End If
        ...
        For i = 1 To 5
            strA1cData(i) = Trim(Mid(strRcvBuf, intPos, 5))
            intPos = intPos + 5
        Next
        
        strBarno = Trim(Mid(strRcvBuf, intPos, gHOSP.BARLEN))
        ...
        For i = 1 To 5
            strIntBase = CStr(i)
            strResult = Trim(strA1cData(i))
            
            If i = 3 Then
                strResult = "A1c(" & strResult & ")"
            End If
...
RST:
    strErrMsg = ""
    strErrMsg = strErrMsg & "위    치 : " & gHOSP.MACHNM & "SerialRcvData_A1C22" & vbNewLine & vbNewLine
    strErrMsg = strErrMsg & "오류번호 : " & Err.Number & vbNewLine & vbNewLine
    strErrMsg = strErrMsg & "오류내용 : " & Err.Description & vbNewLine
    frmErrMsg.txtErr = vbNewLine & strErrMsg
    frmErrMsg.Show
...
'0209160006  0.0  0.9  1.0  1.0  2.9  8.2 87.2  0.0  0.0 10.000Q0309240161
'0209160007  0.0  0.7  0.7  1.1  2.4  8.5 87.8  0.0  0.0  9.9000001 - 05
'0209160008  0.0  0.7  0.8  1.0  3.2 10.4 85.3  0.0  0.0 11.9000001 - 06
'
...
'                fGseven(6) = Mid(sRstText, 31, 5) '-- HbA1C (1)
'                fGseven(7) = Mid(sRstText, 36, 5) '-- HbA1C (0)
...
'[Operation mode]   1   0 = STD mode,  1 = VAR mode, 2 = b-thalassemia mode
'[Sample position]  1   0 = STAT, 1 = transport (LA), 2 = loader
'[Sample number]    3, 5, 8 Sample number (See note)
'[1st component]    5   0.0 ~ 100.0 (aligned right) (See note)
'[2nd component]    5   0.0 ~ 100.0 (aligned right) (See note)
'[3rd component]    5   0.0 ~ 100.0 (aligned right) (See note)
'[4th component]    5   0.0 ~ 100.0 (aligned right) (See note)
'[5th component]    5   0.0 ~ 100.0 (aligned right) (See note)
'[6th component]    5   0.0 ~ 100.0 (aligned right) (See note)
'[7th component]    5   0.0 ~ 100.0 (aligned right) (See note)
'[8th component]    5   0.0 ~ 100.0 (aligned right) (See note)
'[9th component]    5   0.0 ~ 100.0 (aligned right) (See note)
'[10th component]   5   0.0 ~ 100.0 (aligned right) (See note)
'[Flag judgement]   2   00 ~ 20 (00 = normal)
'[Sample ID] 0, 13, 18, 20   Aligned left; characters to the right are filled with spaces when 20 characters are not used. No zero suppression (See note)
    ...
    With frmMain
        ...
        '0 = STD mode,  1 = VAR mode, 2 = b-thalassemia mode
        strType = Mid(strRcvBuf, intPos, 1)
...
RST:
    strErrMsg = ""
    strErrMsg = strErrMsg & "위    치 : " & gHOSP.MACHNM & "SerialRcvData_G7" & vbNewLine & vbNewLine
    strErrMsg = strErrMsg & "오류번호 : " & Err.Number & vbNewLine & vbNewLine
    strErrMsg = strErrMsg & "오류내용 : " & Err.Description & vbNewLine
    frmErrMsg.txtErr = vbNewLine & strErrMsg
    frmErrMsg.Show
...
Private Sub subChart(ByVal intCnt As Integer, ByVal strGrpData As Variant)
    ...
    If intCnt = 1 Then
        cfxTOSOH.OpenDataEx COD_VALUES, 0, 1
        cfxTOSOH.CloseData COD_REMOVE
        cfxTOSOH.CloseData COD_VALUES
        
        cfxTOSOH.Title(CHART_TOPTIT) = strTestNM
        
        cfxTOSOH.OpenDataEx COD_VALUES, 1, 100
    End If
    ...
    'With spdCap
        For i = 1 To 10
            If strGrpData(i) <> "" Then
                cfxTOSOH.ValueEx(0, J) = strGrpData(i) 'Trim(Replace(varTmp, "%", ""))
            End If
            J = J + 1
        Next i
    'End With
    ...
    'sFile = App.Path & "\ChartImg\" & Format(dtpResult.Value, "yyyymmdd") & "_" & strBarNo & "_" & strTestNm & ".bmp"
    
'''    '-- 수정
'''    If Dir(GetCapConfig("IMGPATH") & pAccDt, vbDirectory) <> pAccDt Then
'''        MkDir (GetCapConfig("IMGPATH") & pAccDt)
'''    End If
'''
'''    sFile = GetCapConfig("IMGPATH") & pAccDt & "\" & strBarNo & "_" & strTestNm & ".bmp"
'''
'''    cfxtosoh.Export CHART_BITMAP, sFile
'''    txtImgNm.Text = sFile
'''
'''    imgCap.Picture = LoadPicture(sFile)
    
    DoEvents
    
End Sub

Private Sub subChartPeak(ByVal intCnt As Integer, ByVal strGrpData As Variant)
    Dim strTestNM   As String
    Dim strBarno    As String
    Dim pAccDt  As String
...
Private Sub SerialRcvData_G8()
    ...
    Dim strA1cGrp(10)   As String
    
    Dim strA1cData(11)  As String
...
On Error GoTo RST
    ...
    With frmMain
        ...
        Select Case strType
            Case "1"    'sample information
                        '1020004 - 01           8
                        'Information        Number of characters    Content
                        '1                  1                       Header (Fixed as number 1)
                        '[Operation mode]   1                       0 =STD mode, 1 = VAR mode, 2 = β-thalassemia mode
                        '[Sample position]  1                       0 = STAT, 1 = transport (LA), 2 = loader
                        '[Sample ID]        0, 13, 18, 20           Aligned left; characters to the right are filled
                        '                                           with spaces. No zero suppression (See note)
                        
                        intPos = intPos + 2
                        strSeq = Mid(strRcvBuf, intPos, 8)
            
            Case "2"    'sample number
                        '2070100236
                        'Information        Number of characters    Content
                        '2                  1                       Header (Fixed as number 2)
                        '[Sample number]    3, 5, 8                 Sample number (See note)
                        
            Case "3"    'measurement value
                        '307  7.1  0.0  0.6  0.5  1.1  1.2  6.0 91.7  0.0  0.0   42  1861
                        '               STD mode    VAR mode        β-thalassemia mode
                        '1st component  FP%         A1a%        (HbF%)
                        '2nd component  A1a%        A1b%        (A0%)
                        '3rd component  A1b%        F%          (HbA2%)
                        '4th component  F%          LA1c%       (HbD+%)
                        '5th component  LA1c%       SA1c%       (HbS+%)
                        '6th component  SA1c%       A0%         (HbC+%)
                        '7th component  A0%         H-V0%       (Reserved)
                        '8th component  (Reserved)  H-V1%       (Reserved)
                        '9th component  (Reserved)  H-V2%       (Reserved)
                        '10th component (Reserved)  (Reserved)  (Reserved)

            Case "4"    'Data collection parameters
                        '4   01 6 600
                        'Information                Number of characters    Content
                        '4                          1                       Header (Fixed as number 4)
                        '[Collection start time]    4                       0 ~ 9999 (X10mS, aligned right)
                        '[Collection pitch]         1                       0 ~ 9 (X100mS)
                        '[Number of peaks]          2                       0 ~ 20 (Aligned right)
                        '[Number of raw data sets]  4                       0 ~ 1000 (Aligned right)

            Case "5"    'Peak data
                        '5 1A1A  B  30 599  30 155 168    7.47  0.6}
                        '5 2A1B  V  30 599 168 180 204    5.69  0.5y
                        '5 3F    V  30 599 204 238 261   12.64  1.1
                        '5 4LA1C+V  30 599 261 299 314   14.59  1.2
                        '5 5SA1C V  30 599 314 363 438   57.38  6.0
                        '5 6A0   V  30 599 438 480 599 1086.17 91.7
                        'Information        Number of characters    Content
                        '5                  1                       Header (Fixed as number 5)
                        '[Peak number]      2                       1 ~ 20 (Aligned right)
                        '[Peak name]        5                       (Aligned left, remaining characters filled with spaces) (See note)
                        '[Peak shape]       1                       B = Base peak, V = Valley peak, S=Skimming peak (See note)
                        '[Base start point] 4                       0 ~ 1000 (Aligned right) (See note)
                        '[Base end point]   4                       0 ~ 1000 (Aligned right) (See note)
                        '[Peak start point] 4                       0 ~ 1000 (Aligned right) (See note)
                        '[Peak top]         4                       0 ~ 1000 (Aligned right) (See note)
                        '[Peak end point]   4                       0 ~ 1000 (Aligned right) (See note)
                        '[Peak area]        8                       0.00 ~ 99999.99 (mV·sec, aligned right)
                        '[Peak area %]      5, 6                    0.0 ~ 100.0 or 0.00 ~ 100.00 (%, aligned right)

                        '                           STD mode    VAR mode    β-thalassemia mode
                        '1st identified component   FP          FP          F
                        '2nd identified component   A1A         A1A         A0
                        '3rd identified component   A1B         A1B         A2
                        '4th identified component   F           F           D+
                        '5th identified component   LA1C+       LA1C+       S+
                        '6th identified component   SA1C        SA1C        C+
                        '7th identified component   A0          A0
                        '8th identified component               H-V0
                        '9th identified component               H-V1
                        '10th identified component              H-V2
            
                        intGrpCnt = 1
                        strA1cGrp(1) = Mid(strRcvBuf, 10, 4)
                        strA1cGrp(2) = Mid(strRcvBuf, 14, 4)
                        strA1cGrp(3) = Mid(strRcvBuf, 18, 4)
                        strA1cGrp(4) = Mid(strRcvBuf, 22, 4)
                        strA1cGrp(5) = Mid(strRcvBuf, 26, 4)
                        strA1cGrp(6) = Mid(strRcvBuf, 30, 8)
                        strA1cGrp(7) = Mid(strRcvBuf, 38, 5)
                        
                        Call subChartPeak(intGrpCnt, strA1cGrp)
            
            Case "6"    'peak data end
                        '65
            
            Case "7"    'Raw data
                    
                        intGrpCnt = Mid(strRcvBuf, 2, 3)
                        strA1cGrp(1) = Mid(strRcvBuf, 5, 9)
                        strA1cGrp(2) = Mid(strRcvBuf, 14, 9)
                        strA1cGrp(3) = Mid(strRcvBuf, 23, 9)
                        strA1cGrp(4) = Mid(strRcvBuf, 32, 9)
                        strA1cGrp(5) = Mid(strRcvBuf, 41, 9)
                        strA1cGrp(6) = Mid(strRcvBuf, 50, 9)
                        strA1cGrp(7) = Mid(strRcvBuf, 59, 9)
                        strA1cGrp(8) = Mid(strRcvBuf, 68, 9)
                        strA1cGrp(9) = Mid(strRcvBuf, 77, 9)
                        strA1cGrp(10) = Mid(strRcvBuf, 86, 9)
                        
                        Call subChart(intGrpCnt, strA1cGrp)

            Case "8"    'calibration information
        End Select
...
RST:
    strErrMsg = ""
    strErrMsg = strErrMsg & "위    치 : " & gHOSP.MACHNM & "SerialRcvData_G8" & vbNewLine & vbNewLine
    strErrMsg = strErrMsg & "오류번호 : " & Err.Number & vbNewLine & vbNewLine
    strErrMsg = strErrMsg & "오류내용 : " & Err.Description & vbNewLine
    frmErrMsg.txtErr = vbNewLine & strErrMsg
    frmErrMsg.Show
...
Private Sub SerialRcvData_G8PC()
    Dim RS_L            As ADODB.Recordset
...
On Error GoTo RST
    ...
    With frmMain
        ...
        Select Case strType
        Case "A"
            'RA0304420357029         09180014PatientID LastName FirstName 012009/08/01Comment1 Comment2 
            blnRstFlag = False
            
            intPos = 5
            strBarno = Trim(Mid(strRcvBuf, intPos, 20))
        
        Case "B"
            'RB10209180014  0.0  0.7  0.8  0.4  2.1  5.8 90.9  0.0  0.0   43  1.0000  0.0000  1.0000  0.0000    123    123    123    123    123    1230        004420357029         
            ...
            '[No.4 Component] F%
            '[No.5 Component] LA1c%
            '[No.6 Component] SA1c% - HbA1c
            '[No.7 Component] A0%
            '[No.8 Component] (Reserve)
            '[No.9 Component] (Reserve)
            '[No.10 Component] T-A1 Or IFCC
            
            intPos = 14
            
            For i = 1 To 10
                strResult = Trim(Mid(strRcvBuf, intPos, 5))
                strA1cData(i) = strResult
                intPos = intPos + 5
            Next
            
            intPos = intPos + 74
            
            strFlag = Trim(Mid(strRcvBuf, intPos, 2))
            
            If strFlag <> "00" Then
                strComm = ""
                For i = 1 To 10
                    strComm = strComm & strFlag & Chr(124)
                Next
            End If
        ...
        Case "C"
            ...
            strIntBase = "GLU" 'Trim(Mid(strRcvBuf, intPos, 4))
            
            intPos = intPos + 4
            
            strResult = Trim(Mid(strRcvBuf, intPos, 10))
        ...
        '## DB에 결과저장
        If gHOSP.SAVEAUTO = "Y" And strState = "R" And blnRstFlag = True Then
            Res = SaveTransData(gRow, spdOrder)
...
RST:
    strErrMsg = ""
    strErrMsg = strErrMsg & "위    치 : " & gHOSP.MACHNM & "SerialRcvData_G8PC" & vbNewLine & vbNewLine
    strErrMsg = strErrMsg & "오류번호 : " & Err.Number & vbNewLine & vbNewLine
    strErrMsg = strErrMsg & "오류내용 : " & Err.Description & vbNewLine
    frmErrMsg.txtErr = vbNewLine & strErrMsg
    frmErrMsg.Show
...
Private Sub Phase_Serial_A1C22()
    Dim Buffer      As Variant
    Dim BufChar     As String
    Dim lngBufLen   As Long
    Dim i           As Long
