...
Function GetSampleInfoW_NTL(ByVal asRow As Long) As Integer
    ...
    If IsDate(strRegDate) = False Then
        Exit Function
    End If
    ...
    With frmInterface
        If Not RS.EOF = True And Not RS.BOF = True Then
            Do Until RS.EOF
                ...
                Debug.Print Trim(RS.Fields("PatientChartNo")) & ":" & Trim(RS.Fields("PatientName")) & ":" & Trim(RS.Fields("LabRegNo")) & ":" & Trim(RS.Fields("OrderCode")) & ""
