...
'''    Dim i As Integer
'''    Dim j As Integer
'''    Dim tArrEquip() As String
'''    Dim strTestNM  As String
'''
'''    '-- 같은 검사명은 빼기
'''    For i = 0 To UBound(gArrEquip) - 1
'''        If gArrEquip(i + 1, 4) <> strTestNM Then
'''            ReDim Preserve tArrEquip(j)
'''            tArrEquip(j) = gArrEquip(i + 1, 4)
'''            j = j + 1
'''        End If
'''
'''        strTestNM = gArrEquip(i + 1, 4)
'''    Next
'''
'''    ReDim Preserve tArrEquip(j + 1)
'''
'''    With vasID
'''        .MaxCols = colState + UBound(tArrEquip)
'''
'''        For i = 0 To UBound(tArrEquip) - 1
'''            .Col = colState + (i + 1)
'''            .Row = -1
...
'''            Call SetText(vasID, tArrEquip(i), 0, colState + (i + 1))
'''            .ColWidth(colState + (i + 1)) = 6
'''
''''            cboTest.AddItem tArrEquip(i + 1) & Space(20) & "|" & tArrEquip(i + 1, 3)
'''        Next
'''
''''        cboTest.ListIndex = 0
'''    End With
