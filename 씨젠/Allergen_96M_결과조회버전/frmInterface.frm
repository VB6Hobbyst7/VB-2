...
Begin VB.Form frmInterface 
   ...
   Begin VB.Frame FrmHideControl 
      ...
      Begin VB.Frame Frame4 
         ...
         Begin FPSpread.vaSpread vasPrintBuf 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            SpreadDesigner  =   "frmInterface.frx":2FD7
         End
      End
      ...
      Begin FPSpread.vaSpread vasCode 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":3233
      End
      Begin FPSpread.vaSpread vasTemp1 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":348F
      End
         ...
         Begin MSComctlLib.ImageList imlStatus 
            ...
            BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
               ...
               BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":3C75
                  Key             =   "RUN"
               EndProperty
               BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":420F
                  Key             =   "NOT"
               EndProperty
               BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":47A9
                  Key             =   "STOP"
               EndProperty
               BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":4D43
                  Key             =   "LST"
               EndProperty
               BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":55D5
                  Key             =   "ITM"
               EndProperty
               BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":572F
                  Key             =   "ERR"
               EndProperty
               BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":5889
                  Key             =   "NOF"
               EndProperty
            EndProperty
         End
      ...
      Begin FPSpread.vaSpread vasList 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":59E3
      End
      Begin FPSpread.vaSpread vasResTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":5C3F
      End
      Begin FPSpread.vaSpread vasTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":5E9B
      End
   ...
   Begin VB.Frame Frame1 
      ...
      Begin FPSpread.vaSpread vasID 
         ...
         SpreadDesigner  =   "frmInterface.frx":7195
      End
      Begin FPSpread.vaSpread vasRes 
         ...
         SpreadDesigner  =   "frmInterface.frx":7E23
      End
   End
...
Private Sub cmdDel_Click()
    ...
    If MsgBox("선택한 결과를 모두 삭제하시겠습니까?", vbInformation + vbYesNo, "알림") = vbNo Then
        Exit Sub
    End If

    With vasID
        For intRow = 1 To .MaxRows
            If GetText(vasID, intRow, colCheckBox) = "1" Then
                      SQL = "DELETE FROM PATRESULT " & vbCrLf
                SQL = SQL & " WHERE EQUIPNO = '" & gEquip & "' " & vbCrLf
                SQL = SQL & "   AND BARCODE = '" & GetText(vasID, intRow, colBARCODE) & "' " & vbCrLf
                SQL = SQL & "   AND SAVESEQ = " & GetText(vasID, intRow, colSAVESEQ) & vbCrLf
                SQL = SQL & "   AND MID(EXAMDATE,1,8) = '" & Mid(Trim(GetText(vasID, intRow, colEXAMDATE)), 1, 8) & "' "
...
Private Sub cmdOrder_Click()
    ...
    strHeader = strHeader & "<GROUP ID=""HostOut"">"
    strHeader = strHeader & vbTab & "<GROUP ID=""SoftwareInfo"">"
    strHeader = strHeader & vbTab & vbTab & "<PARAM TYPE=""String"" ID=""Name"">APEX</PARAM>"
    strHeader = strHeader & vbTab & vbTab & "<PARAM TYPE=""String"" ID=""Version"">2.31.3</PARAM>"
    strHeader = strHeader & vbTab & "</GROUP>"
    
    strHeader = strHeader & vbTab & "<GROUP ID=""SessionInfo"" ORDER="""" FILTER=""txxxr"">"
    strHeader = strHeader & vbTab & vbTab & "<PARAM TYPE=""String"" ID=""ID"" FILTER=""-wwwr"">---</PARAM>"
    strHeader = strHeader & vbTab & vbTab & "<PARAM TYPE=""String"" ID=""User"" FILTER=""-rrrr"">admin</PARAM>"
    strHeader = strHeader & vbTab & vbTab & "<PARAM TYPE=""DateTime"" ID=""LastChangeDateTime"" FILTER=""-rrrr"">" & Format(Now, "yyyy-mm-dd hh:mm:ss") & "</PARAM>"
    strHeader = strHeader & vbTab & vbTab & "<PARAM TYPE=""DateTime"" ID=""Execution"" FILTER=""-rrrr"">" & Format(Now, "yyyy-mm-dd hh:mm:ss") & "</PARAM>"
    strHeader = strHeader & vbTab & vbTab & "<PARAM TYPE=""String"" ID=""PhaseSelection"" FILTER=""-----"">FullSession</PARAM>"
    strHeader = strHeader & vbTab & vbTab & "<PARAM TYPE=""String"" ID=""DoctorHeader""></PARAM>"
    strHeader = strHeader & vbTab & vbTab & "<PARAM TYPE=""String"" ID=""LaboratoryHeader""></PARAM>"
        ...
        For intRow = 1 To .MaxRows
            ...
            If .Value = 1 Then
                If Trim(GetText(vasID, intRow, colBARCODE)) <> "" Then
                    ...
                    '-- 성공한 XML
                    '<PARAM TYPE="String[32]" ID="Group" FILTER="-wwwr">내과</PARAM>
                    '<PARAM TYPE="String[32]" ID="Name" FILTER="-ooor">한</PARAM>
                    '<PARAM TYPE="String[32]" ID="Surname" FILTER="-ooor">국</PARAM>
                    '<PARAM TYPE="Date" ID="BirthDate" FILTER="-ooor">2016-03-08 오전 10:57:52</PARAM>
                    ...
                    Select Case Trim(GetText(vasID, intRow, colINOUT))
                        ...
                        Case "COMMON":      strAssayNm = gAssayNM.COMMON
                    End Select
...
Private Sub cmdXMLSave_Click()
    ...
    For i = 1 To vasID.MaxRows
        ...
        With vasRes
            For intRow = 1 To .MaxRows
                lngLastNum = CCur(GetText(vasRes, intRow, colFLAG))
                    ...
                    For j = 0 To UBound(varEditData)
                        If varEditData(j) <> "" Then
                            If InStr(varEditData(j), "QntResult") > 0 Then
                                ...
                                strEditData = strEditData & GetText(vasRes, intRow, colRESULT)
                ...
                Else
                    strBody = strBody & varXMLData(CCur(GetText(vasRes, intRow, colFLAG))) & "</GROUP>"
                End If
        ...
        If InStr(varTmp(i), """Blot""") > 0 Then 'blnAppend1 = True And blnAppend2 = True And
            ...
            For k = 0 To UBound(varTmp1)
                ...
                If strTest <> "" And InStr(varTmp1(k), """QntResult""") > 0 Then
                    ...
                    strResult = Replace(strResult, "&gt;", ">")
                    ReDim Preserve strRecvData(j)
                    strRecvData(j) = strRecvData(j) & "R|" & strTest & "^" & strResult & "^" & CStr(i)
                    j = j + 1
                    strTest = ""
                    strResult = ""
                End If
...
Private Sub cmdRsltSearch_Click()
    ...
    Else
        StatusBar1.Panels(3).Text = "조회 결과가 없습니다."
    End If
                ...
                If blnSame = False Then
                    ...
                    Select Case Trim(RS.Fields("OrderCode")) & ""
                        Case "63100":   SetText vasID, "INHALANT", .MaxRows, colINOUT
                                        SetBackColor vasID, .MaxRows, .MaxRows, colINOUT, colINOUT, 255, 255, 153
                        Case "63200":   SetText vasID, "FOOD", .MaxRows, colINOUT
                                        SetBackColor vasID, .MaxRows, .MaxRows, colINOUT, colINOUT, 153, 255, 153
                        Case "63300":   SetText vasID, "ATOPY", .MaxRows, colINOUT
                                        SetBackColor vasID, .MaxRows, .MaxRows, colINOUT, colINOUT, 204, 255, 255
                        Case "63400":   SetText vasID, "COMMON", .MaxRows, colINOUT
                                        SetBackColor vasID, .MaxRows, .MaxRows, colINOUT, colINOUT, 0, 153, 204
...
Private Sub SetPatInfo(ByVal pBarNo As String)
    ...
    For i = 1 To vasID.DataRowCnt
        'If Trim(GetText(vasID, i, colBARCODE)) = pBarNo And Trim(GetText(vasID, i, colINOUT)) = mResult.MnmNm Then
...
'    Select Case mResult.MnmCd
'        Case "INHALANT":    strGumNum = gAssayNM.INHALANT
'        Case "FOOD":        strGumNum = gAssayNM.FOOD
'        Case "ATOPY":       strGumNum = gAssayNM.ATOPY
'    End Select
    ...
    For intCnt = 0 To UBound(strRecvData)
        ...
        Select Case strType
            ...
            Case "R"    '## Result
                ...
                strSNO = Trim(mGetP(mGetP(strRcvBuf, 2, "|"), 3, "^"))
                ...
                If strResult <> "" And Len(strIntBase) > 0 Then
                    ...
                    If Res > 0 Then
                        ...
                        SetText vasRes, strResult, lsResRow, colRESULT          '결과
                        SetText vasRes, lsSeqNo, lsResRow, colSeq               '순번
                        SetText vasRes, strSNO, lsResRow, colFLAG                    'Flag
                        '-- 로컬 저장
                        SetLocalDB gRow, lsResRow, "1", lsEquipRes
...
'''
'''                '-- 환자정보를 찾으면 바뀜
'''                strGubun = GetText(vasID, gRow, colINOUT)
'''
'''
'''            Case "R"    '## Result
'''                strFIntBase = ""
...
'''                If strBarNo <> "" And strIntBase = "fx1" And strResult <> "" And (mResult.MnmNm = "FOOD" Or mResult.MnmNm = "COMMON") Then
'''                    For i = 1 To 3
...
'''                                SetText vasRes, lsEquipRes, lsResRow, colMachResult     '장비결과
'''                                SetText vasRes, strResult, lsResRow, colRESULT          '결과
'''                                SetText vasRes, strSeq, lsResRow, colSeq               '순번
'''                                SetText vasRes, strSNO, lsResRow, colFLAG                    'Flag
'''                                '-- 로컬 저장
'''                                SetLocalDB gRow, lsResRow, "1", lsEquipRes
'''
...
'''                If strBarNo <> "" And strIntBase = "fx4" And strResult <> "" And (mResult.MnmNm = "FOOD" Or mResult.MnmNm = "COMMON") Then
'''                    For i = 1 To 3
'''                        If IsNumeric(strResult) Then
'''                            If i = 1 Then
'''                                strIntBase = "f20"
...
'''                If strBarNo <> "" And strIntBase = "e71/e73" And strResult <> "" And (mResult.MnmNm = "INHALANT" Or mResult.MnmNm = "COMMON") Then
'''                    For i = 1 To 2
'''                        If IsNumeric(strResult) Then
'''                            If i = 1 Then
'''                                strIntBase = "e71"
...
'''                If strBarNo <> "" And strIntBase = "gx1" And strResult <> "" And (mResult.MnmNm = "INHALANT" Or mResult.MnmNm = "COMMON") Then
'''                    For i = 1 To 4
'''                        If IsNumeric(strResult) Then
'''                            If i = 1 Then
'''                                strIntBase = "g1"
...
'                Exit For
'            End If
'            '-- 만약 같은 결과가 있으면 그결과와 지금결과를 더해서 나누기 결과갯수만큼 하여 각각 저장한다.
'            '-- Update
...
'Private Sub vasRes_EditChange(ByVal Col As Long, ByVal Row As Long)
...
'        .GetText Col, Row, varGet
'        .SetText Col, Row, varGet
...
Private Sub vasRes_KeyPress(KeyAscii As Integer)
    ...
    With vasRes
        ...
        If KeyAscii = 13 And .ActiveCol = colRESULT Then
            ...
            strActiveNum = GetText(vasRes, .ActiveRow, colFLAG)
            
            SQL = ""
            SQL = SQL & "UPDATE PATRESULT " & vbCrLf
            SQL = SQL & "   SET RESULT      ='" & strResult & "'" & vbCrLf
            SQL = SQL & " WHERE BARCODE     = '" & Trim(txtBarcode.Text) & "' " & vbCrLf
            SQL = SQL & "   AND MID(EXAMDATE,1,8)  = '" & Trim(txtExamDate.Text) & "' " & vbCrLf
            SQL = SQL & "   AND SAVESEQ   = " & Trim(txtSN.Text) & vbCrLf
            SQL = SQL & "   AND EQUIPNO   = '" & gEquip & "' " & vbCrLf
