   ...
   Begin TabDlg.SSTab stInterface 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin FPSpread.vaSpread vasWorkList 
            ...
            RetainSelBlock  =   0   'False
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":FE5B
            UserResize      =   2
         End
         ...
         Begin FPSpread.vaSpread vasRes 
            ...
            RetainSelBlock  =   0   'False
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":10969
         End
...
'           sRet = "20190425|20190425|I0301|201904250039|WMD0900089|정미화|2008082513078565|830522|2A|2|S2" & ETX
'    sRet = sRet & "20190425|20190425|I0301|201904250039|WMD0900473|정미화|2008082513078565|830522|2A|2|S2" & ETX
    ...
    Do While i > 0
        ...
        If InStr(1, strTestCode, mGetP(sSeg, 5, Chr(124))) > 0 Then
            If Format(dtpStartDt.Value, "yyyymmdd") <= mGetP(sSeg, 1, Chr(124)) And Format(dtpStopDt.Value, "yyyymmdd") >= mGetP(sSeg, 2, Chr(124)) Then
                ...
                If mGetP(sSeg, 4, Chr(124)) <> GetText(vasID, asRow, colBarcode) Then
                    asRow = asRow + 1
                    vasID.MaxRows = asRow
                    vasID.SetText colCheckBox, asRow, "1"
                    vasID.SetText colPName, asRow, mGetP(sSeg, 6, Chr(124))
                    vasID.SetText colPID, asRow, mGetP(sSeg, 7, Chr(124))
