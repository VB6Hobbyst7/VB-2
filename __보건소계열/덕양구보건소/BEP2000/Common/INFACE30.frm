...
Begin VB.Form INTtname30 
   ...
   Begin FPSpread.vaSpread spdcode 
      ...
      SpreadDesigner  =   "INFACE30.frx":0000
      UserResize      =   0
      VisibleCols     =   4
      VisibleRows     =   50
   End
   ...
   Begin Threed.SSCommand cmdenrole 
      ...
      BevelWidth      =   3
      Font3D          =   2
      MouseIcon       =   "INFACE30.frx":1F52
      Picture         =   "INFACE30.frx":23A4
   End
...
Private Sub cmdenrole_Click()
   ...
   Dim maxrow%, i%, seqno$, sName$, sCode$, sMname$
   ...
   Dim vTmp     As Variant
    ...
    For i = 1 To maxrow
        ...
        spdcode.GetText 4, i, vTmp: sMname = Trim$(vTmp)
...
Private Sub Form_Load()
    ...
    Do Until tbcode.EOF
        ...
        Call spdsettext(spdcode, 4, i, tbcode!Mname)
        
        tbcode.MoveNext
    Loop
    
    txtImport.Text = ImportPath
    txtExport.Text = ExportPath
