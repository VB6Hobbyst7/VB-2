...
'Public Const D0COM_SERVER01 = "DSN=DJLAB;DATABASES=;UID=sa;PWD=;"    '임상병리과 서버
Public Const D0COM_SERVER01 = "DSN=DJLAB;DATABASES=;UID=phs_01;PWD=phs_01;"    '임상병리과 서버
Public Const p_adoCnStr_1 = "PROVIDER=MSDASQL;dsn=DJLAB;uid=PHS_01;pwd=PHS_01;database=BAS_DB;"

'Public AdoCn_SQL            As ADODB.Connection


Public D0COM_SERVER As String
Public D0COM_CODEHELP As comCLSCHlp
