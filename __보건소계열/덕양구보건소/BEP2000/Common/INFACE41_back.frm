...
Begin VB.Form INTface41_back 
   ...
   Begin Threed.SSFrame fraWork 
      ...
      Begin FPSpread.vaSpread spdList 
         ...
         SpreadDesigner  =   "INFACE41_back.frx":0000
         UserResize      =   0
         VisibleCols     =   500
         VisibleRows     =   500
      End
      Begin FPSpread.vaSpread spdWorkList 
         ...
         SpreadDesigner  =   "INFACE41_back.frx":10D9
         UserResize      =   0
         VisibleCols     =   500
         VisibleRows     =   500
      End
      Begin Threed.SSPanel SSPanel9 
         ...
         Begin Threed.SSPanel SSPanel5 
            ...
            BevelWidth      =   2
            RoundedCorners  =   0   'False
            MouseIcon       =   "INFACE41_back.frx":14F1
         End
         Begin MSMask.MaskEdBox mskDate 
            Height          =   345
            Index           =   1
      ...
      Begin Threed.SSCommand cmdAdd 
         ...
         Font3D          =   2
         RoundedCorners  =   0   'False
         Picture         =   "INFACE41_back.frx":1DCB
      End
      Begin Threed.SSCommand cmdOrder 
         ...
         BevelWidth      =   3
         Font3D          =   2
         Picture         =   "INFACE41_back.frx":1DE7
      End
      Begin Threed.SSCommand cmdQuery 
         ...
         Font3D          =   2
         RoundedCorners  =   0   'False
         Picture         =   "INFACE41_back.frx":2239
      End
   ...
   Begin Threed.SSCommand cmdDelete 
      ...
      BevelWidth      =   3
      Font3D          =   2
      Picture         =   "INFACE41_back.frx":2B13
   End
   Begin Threed.SSCommand cmdclose 
      ...
      BevelWidth      =   3
      Font3D          =   2
      Picture         =   "INFACE41_back.frx":44B5
   End
   ...
   Begin Threed.SSCommand cmdInitial 
      ...
      BevelWidth      =   3
      Font3D          =   2
      Picture         =   "INFACE41_back.frx":5E57
   End
   ...
   Begin FPSpread.vaSpread spdface 
      ...
      SpreadDesigner  =   "INFACE41_back.frx":62A9
      UserResize      =   0
      VisibleCols     =   500
      VisibleRows     =   500
   End
End
Attribute VB_Name = "INTface41_back"
