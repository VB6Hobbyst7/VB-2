   ...
   Begin TabDlg.SSTab stInterface 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin FPSpread.vaSpread vasWorkList 
            ...
            RetainSelBlock  =   0   'False
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":FEE2
            UserResize      =   2
         End
         ...
         Begin VB.ComboBox cboChk 
            ...
            EndProperty
            Height          =   300
            ItemData        =   "frmInterface.frx":10A0A
            Left            =   2340
            List            =   "frmInterface.frx":10A14
            TabIndex        =   44
            Top             =   -90
            Visible         =   0   'False
            Width           =   765
         ...
         Begin FPSpread.vaSpread vasRes 
            ...
            RetainSelBlock  =   0   'False
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":10A24
         End
...
'
'    strBuffer = "R,NORMAL ,2018-02-12,11:29,5            ,             ,             ,03,0,000,02,02,GOT-PS  ,=,144      U/l   ,01,8    ,38   ,H          ,GPT-PS  ,=,266      U/l   ,01,4    ,44   ,H          "
'
'
...
Private Sub GetOrder(ByVal pBarNo As String)
    ...
    Call SetText(vasID, mResult.RackNo, intRow, colSeqNo)     '2  Seq
    Call SetText(vasID, mResult.TubePos, intRow, colOrdDate)     '3  검사일자
    
'    Call SetText(vasID, "9876543210", intRow, colPID)     '3  검사일자
'    Call SetText(vasID, "홍길동", intRow, colPName)     '3  검사일자
        ...
        Case "PID"
            ...
            Do While j > 0
                ...
                Case 6
                    ...
                    vasID.SetText colOrdDate, asRow, lsOrdDate
...
''
''                Do
''                    tmpIFCd = Trim(Mid(sTestInfo, iPos, 7))
''                    iPos = iPos + 7
''
''                    If tmpIFCd = "" Then Exit Do
''
''                    tmpFlag = Trim(Mid(sTestInfo, iPos, 1))
''                    iPos = iPos + 1
''
''                    tmpRst = Trim(Mid(sTestInfo, iPos, 9))
''                    iPos = iPos + 9
''
''                    tmpUnit = Trim(Mid(sTestInfo, iPos, 6))
''                    iPos = iPos + 6
''
''                    With pResultInfo
''                        .RSTCNT = .RSTCNT + 1
...
''                Loop
    ...
    'strBuffer = strBuffer & "TG-PS   ,=,107      mg/dl ,01,50   ,149  ,           ,"
                ...
                For i = 13 To Len(strRcvBuf) Step 7
                    ...
                    'strAbNormal = mGetP(strRcvBuf, i + 1, ",")
                    'strResult = mGetP(strRcvBuf, i + 2, ",")
                    
                    'If strAbNormal <> "=" Then
                    '    strResult = strAbNormal & strResult
                    'End If
...
Private Sub vasID_Click(ByVal Col As Long, ByVal Row As Long)
    ...
    strExamDate = GetText(vasID, Row, colOrdDate)
...
Dim strBarNo    As String
    ...
    If KeyAscii = 13 Then
        If sCol = colBarcode Then
            strBarNo = GetText(vasID, sRow, sCol)
            
            Call GetOrder(strBarNo)
            'Call Get_Sample_Info(sRow)
...
'    SQL = SQL & "'" & Trim(GetText(vasID, asRow1, colAge)) & "', "
            ...
            SQL = SQL & " EXAMDATE = '" & GetText(vasID, sRow, colOrdDate) & "' " & vbCrLf
            SQL = SQL & ",BARCODE = '" & strBarNo & "' " & vbCrLf
            SQL = SQL & ",PID = '" & Trim(GetText(vasID, sRow, colPID)) & "' " & vbCrLf
            SQL = SQL & ",PNAME = '" & Trim(GetText(vasID, sRow, colPName)) & "' " & vbCrLf
            SQL = SQL & ",PSEX = '" & Trim(GetText(vasID, sRow, colSex)) & "' " & vbCrLf
            SQL = SQL & ",PAGE = '" & Trim(GetText(vasID, sRow, colAge)) & "' " & vbCrLf
