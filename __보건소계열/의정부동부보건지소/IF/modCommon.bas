...
ConErr:
    ...
    End If
                ...
                strErrMsg = "위    치 : " & gHOSP.MACHNM & "_mAIN" & vbNewLine & vbNewLine
...
'    gCENXPCD = Trim(strSetUp1)
    ...
    strSetup = "":    strSetUp1 = ""
    Call GetPrivateProfileString("HOSP", "URL", "", strSetup, 100, App.PATH & "\INI\" & gHOSP.APPNM & ".ini")
    strSetUp1 = Trim(strSetup)
    strSetUp1 = Mid(strSetUp1, 1, Len(strSetUp1) - 1)
    gHOSP.URL = Trim(strSetUp1)
