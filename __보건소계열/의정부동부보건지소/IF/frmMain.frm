...
Begin VB.Form frmMain 
   ...
   Begin VB.Frame frame1 
      ...
      Begin FPSpread.vaSpread spdResult 
         ...
         SpreadDesigner  =   "frmMain.frx":113DF
         TextTip         =   2
      End
   End
   Begin VB.Frame frame3 
      ...
      Begin VB.Frame frameTestSet 
         ...
         Begin VB.Frame frameOrder 
            ...
            Begin FPSpread.vaSpread spdOrdMst 
               ...
               SelectBlockOptions=   0
               ShadowColor     =   13697023
               SpreadDesigner  =   "frmMain.frx":11E5F
               TextTip         =   2
            End
         End
         Begin VB.ComboBox cboResultType 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmMain.frx":123D6
            Left            =   1650
            List            =   "frmMain.frx":123D8
            TabIndex        =   32
            Top             =   5220
            Visible         =   0   'False
            Width           =   1575
      ...
      Begin FPSpread.vaSpread spdTest 
         ...
         RetainSelBlock  =   0   'False
         SelectBlockOptions=   0
         SpreadDesigner  =   "frmMain.frx":152D2
      End
   End
   Begin VB.Frame frame4 
      ...
      Begin VB.Frame frameCom 
         ...
         Begin VB.ComboBox cboPort 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmMain.frx":16DB7
            Left            =   2190
            List            =   "frmMain.frx":16DB9
            TabIndex        =   52
            Top             =   390
            Width           =   2205
         End
         Begin VB.ComboBox cboBaudrate 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmMain.frx":16DBB
            Left            =   2190
            List            =   "frmMain.frx":16DBD
            TabIndex        =   51
            Top             =   780
            Width           =   2205
         End
         Begin VB.ComboBox cboDatabit 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmMain.frx":16DBF
            Left            =   2190
            List            =   "frmMain.frx":16DC1
            TabIndex        =   50
            Top             =   1170
            Width           =   2205
         End
         ...
         Begin VB.ComboBox cboParity 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmMain.frx":16DC3
            Left            =   2190
            List            =   "frmMain.frx":16DC5
            TabIndex        =   47
            Top             =   2520
            Width           =   2205
         End
   ...
   Begin VB.Frame frame2 
      ...
      Begin FPSpread.vaSpread spdRResult 
         ...
         SelectBlockOptions=   0
         ShadowColor     =   13697023
         SpreadDesigner  =   "frmMain.frx":18543
         TextTip         =   2
      End
      Begin FPSpread.vaSpread spdROrder 
         ...
         SelectBlockOptions=   0
         ShadowColor     =   14548991
         SpreadDesigner  =   "frmMain.frx":18F3D
         UserResize      =   2
      End
    ...
    Select Case intSndPhase
        ...
        Case 3  '## Order
            If mOrder.NoOrder = True Then
                ...
                strOutput = intFrameNo & "O|1|" & mOrder.RackNo & "^" & mOrder.TubePos & "^" & Right(Space(15) & mOrder.OrgBarNo, 15) & "^B||" & mOrder.Order & "|||||||N||||||||||||||Q"
                intSndPhase = 4
            Else
                '## 최초 보낼때
                If mOrder.IsSending = False Then
                    ...
                    If Len(strOutput) > 230 Then
                        ...
                        mOrder.SampleData = Mid$(strOutput, 231)
        ...
        For intCnt = 1 To UBound(strRecvData)
            ...
            Select Case strType
                ...
                Case "Q"    '## Request Information
                    ...
                    If Len(strOrgBarno) = 10 Then
                        strBarno = "20" & strOrgBarno
                    Else
                ...
                Case "O"
                    ...
                    If IsNumeric(strRackNo) Then
                        strRackNo = Val(strRackNo)
                    End If
