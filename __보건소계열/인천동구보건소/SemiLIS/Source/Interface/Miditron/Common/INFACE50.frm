...
Begin VB.Form INTsearch50 
   ...
   Begin Threed.SSCommand cmdResultReg 
      ...
      BevelWidth      =   5
      Font3D          =   2
      Picture         =   "INFACE50.frx":5DE6
   End
   Begin VB.Image imgbox 
      Height          =   480
      Index           =   5
      Left            =   -60
      Picture         =   "INFACE50.frx":68B0
      Top             =   3600
      Visible         =   0   'False
      Width           =   480
   End
