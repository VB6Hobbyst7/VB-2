...
'*                                                          *
'*----------------------------------------------------------*
Sub D0SUB_SpreadClear(spd As vaSpread, DispRow As Integer _
                      , Optional Col As Variant _
                      , Optional Col2 As Variant _
                      , Optional Row As Variant _
                      , Optional Row2 As Variant _
                      , Optional foreC As Variant _
                      , Optional backC As Variant)
    ...
    With spd
        ...
        If IsMissing(Col2) Then Col2 = .MaxCols
        If IsMissing(Row2) Then Row2 = .MaxRows
        
        If IsMissing(foreC) Then foreC = vbBlack
        ...
        .ForeColor = foreC
        If IsMissing(backC) = False Then .BackColor = backC
        .BlockMode = False
