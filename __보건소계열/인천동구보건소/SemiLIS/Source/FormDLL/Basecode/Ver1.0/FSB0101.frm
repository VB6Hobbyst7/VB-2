...
Begin VB.Form FSB0101 
   ...
   Begin Threed.SSPanel pnlmain 
      ...
      Begin FPSpread.vaSpread SpdCode 
         Height          =   3000
         Left            =   90
         OleObjectBlob   =   "FSB0101.frx":0000
         TabIndex        =   5
         Top             =   90
         Width           =   3990
      End
    ...
    For i = 1 To giCodeHlpCnt
        For j = 1 To giCodeHlpCnt
            If Format$(i, "00000") = gCodeHlpTable(j).sSeq Then
                ...
                Call SpdCode.SetText(1, i, gCodeHlpTable(j).sCodeNm & "")
                Call SpdCode.SetText(2, i, gCodeHlpTable(j).sCode & "")
            End If
        Next
    Next
End Sub
