...
'    End If
    ...
    iTotal = DCT0101.Print_ResultCnt(txtPart, sSearchUnit, sSLabDate, sELabDate, sPartGbn, sSearchGbn)
...
' 화면 표시
    ...
    Case "M"
        ...
        For iCnt = 1 To spdMonth.MaxRows
            lRCnt = 0
            For RCnt = 0 To 11
                If spdMonth.ColWidth(RCnt + 3) = 9 Then
