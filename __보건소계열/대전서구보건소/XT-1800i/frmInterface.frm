...
Begin VB.Form frmInterface 
   BorderStyle     =   1  '단일 고정
   Caption         =   " Sysmex XT-1800i Interface Program"
   ClientHeight    =   10635
   ClientLeft      =   150
   ClientTop       =   435
   ClientWidth     =   15225
   ...
   Begin Threed.SSPanel sspRes 
      ...
      Begin FPSpread.vaSpread vasRes 
         ...
         MaxCols         =   16
         ScrollBars      =   2
         SpreadDesigner  =   "frmInterface.frx":4081
      End
   End
   ...
   Begin FPSpread.vaSpread vasID 
      ...
      GridColor       =   16777215
      MaxCols         =   30
      SpreadDesigner  =   "frmInterface.frx":80EF
   End
   ...
   Begin FPSpread.vaSpread vasCode 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      SpreadDesigner  =   "frmInterface.frx":CFB2
   End
   ...
   Begin FPSpread.vaSpread vasTemp 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      SpreadDesigner  =   "frmInterface.frx":D218
   End
   ...
   Begin FPSpread.vaSpread vasResTemp 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      SpreadDesigner  =   "frmInterface.frx":11764
   End
   Begin FPSpread.vaSpread vasPrint 
      ...
      RowHeaderDisplay=   0
      ScrollBars      =   2
      SpreadDesigner  =   "frmInterface.frx":119CA
   End
   Begin FPSpread.vaSpread vasOrderTemp 
      ...
      EndProperty
      MaxCols         =   2
      SpreadDesigner  =   "frmInterface.frx":126C2
   End
   ...
   Begin FPSpread.vaSpread vasOrderBuf 
      ...
      EndProperty
      MaxCols         =   2
      SpreadDesigner  =   "frmInterface.frx":1623E
   End
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox cboGubun 
         Height          =   315
         ItemData        =   "frmInterface.frx":19DBA
         Left            =   1380
         List            =   "frmInterface.frx":19DBC
         TabIndex        =   33
         Top             =   810
         Visible         =   0   'False
         Width           =   1905
...
Private Sub cmdConfig_Click()
    frmConfig.SSPanel_machine.Caption = "XT-1800i"
    frmConfig.Show 1
End Sub
...
Private Sub cmdSetup_Click()
    frmEquipExam.SSPanel1.Caption = "  XT-1800i 장비 코드 설정"
    frmEquipExam.Show 1
    GetExamCode
End Sub
