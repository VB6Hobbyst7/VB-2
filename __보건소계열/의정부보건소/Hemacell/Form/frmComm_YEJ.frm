...
Dim fHemacell(100) As String
Dim fHemacellFlag  As String
Dim fHemacellFlagUse(100) As String
Dim fHemacellFlagStr(100) As String
Dim fHemacellCfg(100) As Integer
Dim fHemacellSize(100, 1) As Integer
Dim fRcvString As String
Dim fChannel() As String

Dim fHemacellOrder(100) As String
...
Dim strTmp, varTmp, strBarno, strDate, strTime As String
    ...
    sTemp = strdata
    Erase fHemacell
    '------------------------------<<< fHemacell() 배열 Clear 한다.         >>>----------
    For Loop_Count = 1 To 100: fHemacell(Loop_Count) = "": Next Loop_Count
    '------------------------------<<< fHemacell() 배열에 구분하여 넣는다.  >>>----------
    
    If Mid$(sTemp, 1, 1) = Chr(2) And Mid$(sTemp, 14, 7) <> "DILUENT" Then
        fHemacell(0) = Mid(sTemp, 5, 9) '-- Sample Sequence number
        fHemacell(1) = Mid(sTemp, 121, 4) '-- WBC
        fHemacell(2) = Mid(sTemp, 149, 4) '-- RBC
        fHemacell(3) = Mid(sTemp, 153, 4) '-- HGB
        fHemacell(4) = Mid(sTemp, 157, 4) '-- HCT
        fHemacell(5) = Mid(sTemp, 161, 4) '-- MCV
        fHemacell(6) = Mid(sTemp, 165, 4) '-- MCH
        fHemacell(7) = Mid(sTemp, 169, 4) '-- MCHC
        fHemacell(8) = Mid(sTemp, 173, 4) '-- RDW
        fHemacell(9) = Mid(sTemp, 177, 4) '-- PLT
        fHemacell(10) = Mid(sTemp, 181, 4) '-- MPV
        fHemacell(11) = Mid(sTemp, 185, 4) '-- THT(2)
        fHemacell(12) = Mid(sTemp, 189, 4) '-- PDW
        fHemacell(13) = Mid(sTemp, 193, 4) '-- Lymph#
        fHemacell(14) = Mid(sTemp, 197, 4) '-- Mids#
        fHemacell(15) = Mid(sTemp, 201, 4) '-- Gran#
        fHemacell(16) = Mid(sTemp, 213, 4) '-- Lymph%
        fHemacell(17) = Mid(sTemp, 217, 4) '-- Mids%
        fHemacell(18) = Mid(sTemp, 221, 4) '-- Gran%
        fHemacell(19) = Mid(sTemp, 225, 4) '-- Eos%
        fHemacell(20) = Mid(sTemp, 229, 4) '-- Bas%
     End If
        ...
        With spdResult1
            sSeq = Trim(fHemacell(0)) '-- Sample Sequence number
            sCol = 2
            ...
            If pGrid_Point > 0 Then
                For intCol = 5 To .MaxCols
                    ...
                    Set itemX = lvwCuData.FindItem(Trim$(varTmp), lvwSubItem, , lvwWhole)
                    If Not itemX Is Nothing Then
                        For intIdx = 1 To Max_Arary_Cnt + 11
                            Channel_No = Val(intIdx)                                            ' channel
                               FunStr = fHemacell(intIdx)                                       ' result
                        
                            If Len(Channel_No) > 0 Then
                                If Channel_No = itemX.tag Then
                                    If Channel_No = 1 Then
                                        FunStr = fHemacell(Channel_No) * 1000
                                    ElseIf Channel_No = 2 Then
                                        FunStr = fHemacell(Channel_No) * 100
                                    Else
            '                            If Trim(fHemacell(Channel_No)) = ".0" Then fHemacell(Channel_No) = ""
                                        FunStr = fHemacell(Channel_No)
                                    End If
...
'                    If Len(fHemacell(Channel_No)) > 0 Then
'                        If Channel_No = 1 Then
'                            FunStr = fHemacell(Channel_No) * 1000
'                        ElseIf Channel_No = 2 Then
'                            FunStr = fHemacell(Channel_No) * 100
...
'    Dim strData(1 To 5)         As Byte
   ...
   '-- 일반
  '  strTmp = "D1U   XE-2100^A24070000000007000     3011302598200308051349000000050142                000000000000000001000000000000000100000000000000010000000000000001000000000000000100000000000000010000000000000000000000000000000000000000000000XE-2100^98313519^A2407D2U   XE-2100^A24070000000007000     3011302598006840041800123003530084420294003480034300424000670046800037000040002900000460003200000250000030012500381001050009900228000660027600007009930000700000000340            0000000000000000XE-2100^98313519^A2407"
    '-- 응급
'    strTmp = "D1U   XE-2100^A24070000000007000     3080903013200308051349000000050142                000000000000000001000000000000000100000000000000010000000000000001000000000000000100000000000000010000000000000000000000000000000000000000000000XE-2100^98313519^A2407D2U   XE-2100^A24070000000007000     3080903013006840041800123003530084420294003480034300424000670046800037000040002900000460003200000250000030012500381001050009900228000660027600007009930000700000000340            0000000000000000XE-2100^98313519^A2407"
             strTmp = "513        1                                                                           8 0 1 1 0 1RA         0827031036 8.820032708                3.5211.833.6 95.33.334.911.9162. 8.9 .1454.0 1.8 1.2 5.7  .0  .021.014.065.0  .0  .0WG        @9"
    strTmp = strTmp & "511        2                                                                           8 0 1 1 0 1RA         0827031036 8.920032708                3.5211.833.6 95.33.334.911.9162. 9.0 .1554.0 1.8 1.2 5.7  .0  .021.014.065.0  .0  .0WG        @9"
    strTmp = strTmp & "510        3                                                                           8 0 1 1 0 1RA         0827031036 8.720032708                3.5211.833.6 95.33.334.911.9162. 9.1 .1654.0 1.8 1.2 5.7  .0  .021.014.065.0  .0  .0WG        @9"
    strTmp = strTmp & "512        4                                                                           8 0 1 1 0 1RA         0827031036 8.620032708                3.5211.833.6 95.33.334.911.9162. 9.2 .1754.0 1.8 1.2 5.7  .0  .021.014.065.0  .0  .0WG        @9"
    strTmp = strTmp & "509        5                                                                           8 0 1 1 0 1RA         0827031036 8.520032708                3.5211.833.6 95.33.334.911.9162. 7.3 .1854.0 1.8 1.2 5.7  .0  .021.014.065.0  .0  .0WG        @9"
