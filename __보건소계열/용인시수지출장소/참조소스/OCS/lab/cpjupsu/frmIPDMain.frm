...
Begin VB.Form frmIPDMain 
   ...
   Begin Threed.SSPanel panelOpd 
      ...
      Begin FPSpreadADO.fpSpread ssOrder 
         ...
         ShadowDark      =   8421504
         ShadowText      =   0
         SpreadDesigner  =   "frmIPDMain.frx":0BC2
         Appearance      =   1
         TextTip         =   1
         ScrollBarTrack  =   1
      End
   ...
   Begin Threed.SSPanel panelSub 
      ...
      Begin FPSpreadADO.fpSpread sprLabno 
         ...
         MaxRows         =   20
         ScrollBars      =   0
         SpreadDesigner  =   "frmIPDMain.frx":8CAF
         Appearance      =   1
      End
      ...
      Begin FPSpreadADO.fpSpread ssEnrol 
         ...
         ScrollBars      =   2
         ShadowColor     =   12632256
         SpreadDesigner  =   "frmIPDMain.frx":915F
         Appearance      =   1
         ScrollBarTrack  =   1
      End
   End
...
Private Sub cmdLabel_Click()
 'h 사용하지 않으므로 주석처리
 'h Exe 파일만드는데 Error발생
 'h    frmIpdLabel.Show vbModal
...
'C    strSql = strSql & " AND    a.SLipno1   < 52                                             " & vbLf
...
Private Sub Form_Load()
    ...
    frmIPDMain.Caption = "검체도착확인(접수)" & GstrPassName
