...
'O  GstrPassRank = adoSet.Fields("Rank").Value & ""                   'COLUMN 없음
    GstrPassClass = adoSet.Fields("Class").Value & ""
'O  GstrSubClass = adoSet.Fields("SubCLass").Value & ""               'COLUMN 없음
    GstrPassGrade = adoSet.Fields("Grade").Value & ""
    GstrPassPart = adoSet.Fields("Part").Value & ""
'O  GstrSubPart = adoSet.Fields("SubPart").Value & ""                 'COLUMN 없음
'O  GstrPassDept = adoSet.Fields("DeptCode").Value & ""
    ...
    mdiMain.stbMain.Panels(3).Text = GstrPassName
