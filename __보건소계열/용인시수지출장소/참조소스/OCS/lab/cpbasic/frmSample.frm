...
Begin VB.Form frmSample 
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin VB.ComboBox cmbClass1 
         Height          =   300
         ItemData        =   "frmSample.frx":31CB
         Left            =   1380
         List            =   "frmSample.frx":31CD
         TabIndex        =   5
         Top             =   180
         Width           =   2295
      End
