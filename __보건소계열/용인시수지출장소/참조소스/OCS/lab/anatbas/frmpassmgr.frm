...
Begin VB.Form frmPassmgr 
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin VB.ComboBox cmbRank 
         Height          =   300
         ItemData        =   "frmPassmgr.frx":3F35
         Left            =   1230
         List            =   "frmPassmgr.frx":3F4E
         Style           =   2  '드롭다운 목록
         TabIndex        =   20
         Top             =   2475
         Width           =   1695
      ...
      Begin VB.ComboBox cmbGrade 
         Height          =   300
         ItemData        =   "frmPassmgr.frx":3F67
         Left            =   1230
         List            =   "frmPassmgr.frx":3F77
         Style           =   2  '드롭다운 목록
         TabIndex        =   18
         Top             =   2160
         Width           =   1695
      ...
      Begin VB.ComboBox cmbClass 
         Height          =   300
         ItemData        =   "frmPassmgr.frx":3F98
         Left            =   1230
         List            =   "frmPassmgr.frx":3FA2
         Style           =   2  '드롭다운 목록
         TabIndex        =   17
         Top             =   1845
         Width           =   1695
