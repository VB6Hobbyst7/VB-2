...
Begin VB.Form frmRoutine 
   ...
   Begin FPSpreadADO.fpSpread ssItem 
      ...
      ScrollBars      =   2
      SpreadDesigner  =   "frmRoutine.frx":49E2
      UserResize      =   1
      VisibleCols     =   500
      VisibleRows     =   500
      Appearance      =   2
   ...
   Begin FPSpreadADO.fpSpread ssRoutine 
      ...
      MaxRows         =   50
      ScrollBars      =   2
      SpreadDesigner  =   "frmRoutine.frx":4CC1
      UserResize      =   1
      VisibleCols     =   4
      VisibleRows     =   50
      Appearance      =   2
   ...
   Begin Threed.SSPanel panelPrint 
      ...
      Begin FPSpreadADO.fpSpread ssPrRoutine 
         ...
         MaxCols         =   6
         ScrollBars      =   2
         SpreadDesigner  =   "frmRoutine.frx":5FDB
         Appearance      =   1
      End
...
Insert_Routine_Sub:
    ...
    strSql = strSql & "        '" & Quot_Conv(sItemName) & "',"
...
Private Sub CommandButton1_Click()
    ...
    strSql = strSql & "   AND  Codeky >= '850001' "
    strSql = strSql & " ORDER  BY Codeky"
