...
Begin VB.Form frmSpec12 
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin Threed.SSCommand cmdDel 
         ...
         BevelWidth      =   1
         Outline         =   0   'False
         MouseIcon       =   "frmSpec12.frx":17AE
         Picture         =   "frmSpec12.frx":17CA
      End
      Begin Threed.SSCommand cmdInsert 
         ...
         BevelWidth      =   1
         Outline         =   0   'False
         MouseIcon       =   "frmSpec12.frx":20A4
         Picture         =   "frmSpec12.frx":20C0
      End
   ...
   Begin FPSpreadADO.fpSpread ssSpec12 
      ...
      ScrollBars      =   2
      SpreadDesigner  =   "frmSpec12.frx":4A36
      UserResize      =   1
      VisibleCols     =   10
      VisibleRows     =   100
      Appearance      =   1
