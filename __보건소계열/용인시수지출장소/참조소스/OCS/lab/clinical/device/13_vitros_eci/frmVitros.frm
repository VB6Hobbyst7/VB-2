...
'                         Call Ack_Send
               ...
               Case "R"
                      ...
                      If RCheckSumD = Mid(RBufferSum, Len(RBufferSum) - 3, 2) Then
                          ...
                          RResult = Mid(RBufferSum, 19, 3)    '검사 코드
                          ...
                          Dim SPCounterS     As Integer    ' error code 시작위치 check용
                          Dim SPCounterE     As Integer    ' error code 종료위치 check
...
'                AAA = S_itemcd(RResult)    'test후 move
