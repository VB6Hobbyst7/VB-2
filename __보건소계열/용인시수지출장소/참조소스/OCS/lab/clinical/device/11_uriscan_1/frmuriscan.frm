...
Option Explicit
    ...
    Dim Temp_K(50, 3)       As String           ' item table data 입력용 buffer
...
'**************************************************************
    ...
    CommonDialog1.FileName = "U" & Format$(lblDate, "yyyymmdd") & Ser
...
Private Sub DataReceive()
    ...
    Select Case RBufferSum
            ...
            Case ETX
                    'dadaReceive = True
                    SSPan.ForeColor = &H0&                          ' black  &H00000000&
                    SSPan = "Patient Result Data 수신 대기중입니다..........."
                    Order_Data_Seq = 0
                    R_Check = True
    End Select
