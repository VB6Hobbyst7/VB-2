...
Begin VB.Form Selectra 
   BorderStyle     =   1  '단일 고정
   Caption         =   "녹십자 Selectra"
   ClientHeight    =   8250
   ClientLeft      =   2655
   ClientTop       =   1905
   ClientWidth     =   11850
   ...
   Begin VB.PictureBox picResult 
      ...
      Begin FPSpread.vaSpread SSR 
         ...
         MaxCols         =   4
         MaxRows         =   50
         SpreadDesigner  =   "Selectra.frx":0000
      End
   End
   ...
   Begin FPSpread.vaSpread SS 
      ...
      EndProperty
      MaxCols         =   5
      SpreadDesigner  =   "Selectra.frx":0C04
      UserResize      =   1
      VisibleCols     =   5
      VisibleRows     =   120
   End
   ...
   Begin ComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {0713E8C2-850A-101B-AFC0-4210102A8DA7} 
         ...
         BeginProperty ListImage1 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "Selectra.frx":2A3C
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "Selectra.frx":2D56
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "Selectra.frx":3070
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "Selectra.frx":338A
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "Selectra.frx":36A4
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "Selectra.frx":39BE
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "Selectra.frx":3CD8
            Key             =   ""
         EndProperty
      EndProperty
   End
...
Option Explicit
    ...
    Dim InHallymchk             As String       '얘는 STX를 안날려 준다... 아프당 그래서... "HALLYM"을 데이타 시작으로 체크할려구 한다.
...
Private Function Data_Analyze() As String
    Dim i                           As Integer
...
'/Data_Analyze:
    ...
    For i = 4 To UBound(InputLineData)
        With nReciveData(i - 4)
'            If UCase(Trim(Mid(InputLineData(i), 1, InStr(1, InputLineData(i), TSPACE)))) = UCase(.StrFullName) Then
'                .strRecord = Val(Mid(InStr(1, InputLineData(i), TSPACE), InputLineData(i), 16, 6))
'            End If
            If UCase(Trim(Mid(InputLineData(i), 1, 15))) = UCase(.StrFullName) Then
                .strRecord = Val(Mid(InputLineData(i), 16, 6))
            End If
        End With
    Next i
...
'//RETURN BARCODENO'/============================================================================
    ...
    Data_Analyze = Mid(InputLineData(2), 1, 12)
...
Sub CodeKy_Search()
    ...
    'code key data 검색
    '/ 먼저 ItemMl Table 의 GEOMJAN2 필드와 장비에서 내보내는 일정한 이름들(Full Name으로 배설터군)과 테이블을 일치시켜야함..
    '/ 물론 필드를 하나 더 만들어서 정렬순서를 정하면 좋겠지요...(요건 GEOMJAN3)상황에 따라서...
    ...
    ReDim InputLineData(ArrCnt + 4)             '데이타들어오는거 포함..위에 몇줄더있으니까...
...
'WHERE GEOMJAN1 = '14'
'
'SELECT UNIQUE SLIPNO1, SLIPNO2
'From TWEXAM_GENERAL_SUB
'WHERE ITEMCD IN (SELECT CODEKY
'                From TWEXAM_ITEMML
'                WHERE GEOMJAN1 = '14')
'    AND JEOBSUDT = TRUNC(SYSDATE)
'ORDER BY  SLIPNO1, SLIPNO2
'
'
'SELECT SUGACD, CODEKY, ITEMNM, ITEMKO, YAGEO
'From TWEXAM_ITEMML
'WHERE GEOMJAN1 = '14'
'ORDER BY YAGEO
'--ORDER BY SUGACD
