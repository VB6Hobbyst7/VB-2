...
Begin VB.Form frmhba1c 
   Caption         =   "HbA1C"
   ClientHeight    =   8490
   ClientLeft      =   105
   ClientTop       =   1800
   ClientWidth     =   11880
   Icon            =   "frmhba1c.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   ScaleHeight     =   8490
   ...
   Begin FPSpread.vaSpread SS 
      ...
      EndProperty
      MaxCols         =   30
      SpreadDesigner  =   "frmhba1c.frx":030A
      UserResize      =   1
      VisibleCols     =   23
      VisibleRows     =   120
   End
   ...
   Begin ComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {0713E8C2-850A-101B-AFC0-4210102A8DA7} 
         ...
         BeginProperty ListImage1 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "frmhba1c.frx":25FC
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "frmhba1c.frx":2916
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "frmhba1c.frx":2C30
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "frmhba1c.frx":2F4A
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "frmhba1c.frx":3264
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "frmhba1c.frx":357E
            Key             =   ""
         EndProperty
      EndProperty
   End
...
Private Sub MSComm1_OnComm() ' DATA 수신 처리
    ...
    Select Case RBuffer                                 ' Message Block 단위로 편집 출력
           ...
           Case EOT:    EOTBuffer = True                ' ETX [] Check용
    End Select
    
    RBufferSum = RBufferSum & RBuffer                   ' comm port 에서 입력한 data 누적
    
    If ETX_Check = True Then                            'ETX Check
        ETX_Check = False
        Call Ack_Send
    End If
    ...
    If EOTBuffer = True Then                            'ETX Check
        If FileClose = False Then
            Print #hSaveFile, "[ Rx " & Format(Time, "hh:mm:ss") & " ] " & RBufferSum   ' write omitting cr lf
        End If
...
'    If Len(strPrmData) <> 335 Then Exit Function
    ...
    Ritemcd1 = Temp_K(RSequence, 0)                                 'ITEM CODE
    
    RResultU = Trim(Mid(RBufferSum, 22, 5))                 '결과
    
    CPoint = 11                                             'col 위치 지정용
...
'        SSPan = "DATABASE에 저장 되었습니다. ( " & RecordCountSum & " 건)"
    ...
    Else
        ...
        If FileClose = False Then
            Print #hSaveFile, "[Update Error] " & JeobsuPT & "  " & itemcd1 & "  " & resultu
        End If
