...
Begin VB.Form Chiron 
   Caption         =   "Chiron Diagnostics"
   ClientHeight    =   8250
   ClientLeft      =   60
   ClientTop       =   630
   ClientWidth     =   11850
   ...
   Begin FPSpread.vaSpread SS 
      ...
      EndProperty
      MaxCols         =   5
      SpreadDesigner  =   "Chiron.frx":0000
      UserResize      =   1
      VisibleCols     =   5
      VisibleRows     =   120
   End
   ...
   Begin VB.PictureBox picResult 
      ...
      Begin FPSpread.vaSpread SSR 
         ...
         MaxCols         =   4
         MaxRows         =   50
         SpreadDesigner  =   "Chiron.frx":1E38
      End
   End
   ...
   Begin ComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {0713E8C2-850A-101B-AFC0-4210102A8DA7} 
         ...
         BeginProperty ListImage1 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "Chiron.frx":2D46
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "Chiron.frx":3060
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "Chiron.frx":337A
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "Chiron.frx":3694
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "Chiron.frx":39AE
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "Chiron.frx":3CC8
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "Chiron.frx":3FE2
            Key             =   ""
         EndProperty
      EndProperty
   End
...
'**************************************************************
    ...
    'Call DataReceive("CAL_NEW_DATAaMOD348iIID2768rTYPE1-POINTrSEQ4090rDATE17Jan01rTIME13:20aCmpH7.379aCapH7.382CdpH-0.003aCmPCO235.0mmHgaCaPCO236.1mmHgaCdPCO2-1.1mmHgaCmPO285.9mmHgaCaPO286.6mmHgaCdPO2-0.7mmHgaCmNa+140mmol/LaCaNa+140mmol/LaCdNa+0mmol/LaCmK+4.01mmol/LaCaK+4.00mmol/LaCdK+0.01mmol/LaCmCl-100mmol/LaCaCl-100mmol/LaCdCl-0mmol/LaCmHct0%aCaHct0%aCdHct0%mBP768mmHgE3")
...
'**************************************************************
    ...
    CommonDialog1.FileName = "R" & Format$(lblDate, "yyyymmdd") '& Ser
...
'/Data_Analyze:
    ...
    For i = 1 To UBound(nReciveData)
        For j = 1 To UBound(InputLineData)
            With nReciveData(i)
                TempName = Mid(InputLineData(j), 1, InStr(1, InputLineData(j), SGS) - 1)
                
                If UCase(Mid(TempName, 1, 2)) = "AC" Then TempName = Mid(TempName, 3)
                
                If UCase(Trim(TempName)) = UCase(Trim(.StrFullName)) Then
                    .strRecord = Val(Mid(InputLineData(j), InStr(1, InputLineData(j), SGS) + 1))
                    Exit For
                End If
            End With
        Next j
...
Private Function DataReceive(strPrmData As String) As Boolean
    ...
    NCount = UBound(Split(strPrmData, SFS))     ' SFS의숫자를 반환 데이타의 라인데이타의 배열을 구한다.
    
    Erase InputLineData
    ReDim InputLineData(NCount)
    ...
    For i = InStr(1, strPrmData, SRS) To Len(strPrmData)
        If Mid(strPrmData, i, 1) = SFS Then
            Debug.Print InputLineData(NLine)
            If UCase(Mid(InputLineData(NLine), 1, 4)) = "IPID" Then
                StrIdNumber = Val(Mid(InputLineData(NLine), 6, 12))
            End If
            If UCase(Mid(InputLineData(NLine), 1, 4)) = "rSEQ" Then
                NSeqNo = Mid(InputLineData(NLine), 6, 4)
            End If
            NLine = NLine + 1
        Else
