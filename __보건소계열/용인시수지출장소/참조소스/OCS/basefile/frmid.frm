   ...
   Begin Threed.SSPanel Panel 
      ...
      Begin Threed.SSPanel Panel 
         ...
         Begin Threed.SSCommand cmdPCancel 
            ...
            EndProperty
            Font3D          =   3
            MouseIcon       =   "frmid.frx":0442
            Picture         =   "frmid.frx":0894
         End
...
Private Sub cmdPOk_Click()
    ...
    If txtNewPass.Text = "" Then
        MsgBox "새로운 PassWord를 입력해 주십시요!", vbExclamation, "알림"
        txtNewPass.SetFocus
        Exit Sub
    End If
    
    If txtNewOK.Text = "" Then
        MsgBox "확인 PassWord를 입력해 주십시요!", vbExclamation, "알림"
        txtNewOK.SetFocus
        Exit Sub
    End If
    ...
    strSqlDef = "UPDATE TW_MIS_PMPA.TWBAS_PASS "
...
Read_Part:
    ...
    strSqlDef = strSqlDef & "  FROM TW_MIS_PMPA.TWBAS_PASS "
...
Read_Grade:
    ...
    If Result = -1 Or rowindicator = 0 Then strConnect = "NO3"
...
Private Sub txtPassword_LostFocus()
    ...
    Select Case Trim(strConnect)
        Case "NO1": cmdReplace.Enabled = False: Exit Sub
        Case "NO2": cmdReplace.Enabled = False: Exit Sub
    End Select
