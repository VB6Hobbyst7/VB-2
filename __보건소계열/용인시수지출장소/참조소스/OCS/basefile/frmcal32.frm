...
Begin VB.Form FrmCalendar 
   ...
   Begin Threed.SSPanel Panel 
      ...
      Begin FPSpread.vaSpread SScal 
         Height          =   1980
         Left            =   60
         OleObjectBlob   =   "FrmCal32.frx":0442
         TabIndex        =   3
         Top             =   750
         Width           =   3165
      End
...
Public Sub Calendar_Show(ArgControl As Object)
    ...
    If TypeOf ArgControl Is vaSpread Then
        ...
        GstrCalendarDate = ArgControl.Text
    Else
        GstrCalendarDate = ArgControl.Text          '해당 TextBox에서 날자형식 Move
    End If
    ...
    If GstrCalendarDate > "" Then                   '날자를 선택했을경우
        If TypeOf ArgControl Is vaSpread Then
            ...
            ArgControl.Text = GstrCalendarDate
        Else
            ArgControl.Text = GstrCalendarDate      '해당 TextBox에 Move
        End If
    End If
