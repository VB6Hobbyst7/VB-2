...
PassWordCheck:
    ...
    strSQL = ""
    strSQL = strSQL & " SELECT  Name, PassWord, Grade, Part, ProgramID,         " & vbLf
    strSQL = strSQL & "        TO_CHAR(SYSDATE, 'YYYY-MM-DD') SDate,           " & vbLf
    strSQL = strSQL & "        TO_CHAR(SYSDATE, 'HH24:MI:SS') STime            " & vbLf
    strSQL = strSQL & " FROM   TW_MIS_PMPA.TWBAS_PASS                         " & vbLf
    strSQL = strSQL & " Where  ProgramID = ' '                                  " & vbLf
