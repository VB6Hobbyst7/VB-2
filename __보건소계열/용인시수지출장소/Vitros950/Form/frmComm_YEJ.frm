...
Begin VB.Form frmComm 
   ...
   Begin TabDlg.SSTab tabWork 
      ...
      Begin Threed.SSCommand cmdSel 
         ...
         _StockProps     =   78
         BevelWidth      =   1
         Picture         =   "frmComm_YEJ.frx":5418
      End
      Begin VB.ComboBox cboRstgbn 
         Height          =   300
         Index           =   1
         ItemData        =   "frmComm_YEJ.frx":589A
         Left            =   -72570
         List            =   "frmComm_YEJ.frx":58A7
         Style           =   2  '드롭다운 목록
         TabIndex        =   15
         Top             =   495
         Width           =   1680
      ...
      Begin VB.ComboBox cboRstgbn 
         Height          =   300
         Index           =   0
         ItemData        =   "frmComm_YEJ.frx":58D1
         Left            =   3930
         List            =   "frmComm_YEJ.frx":58DE
         Style           =   2  '드롭다운 목록
         TabIndex        =   12
         Top             =   495
         Visible         =   0   'False
      ...
      Begin FPSpread.vaSpread spdWorkList 
         ...
         MaxRows         =   1
         ScrollBarMaxAlign=   0   'False
         SpreadDesigner  =   "frmComm_YEJ.frx":5D76
         UserResize      =   0
      End
      Begin Threed.SSCommand cmdSel 
         Height          =   360
      ...
      Begin FPSpread.vaSpread spdResult2 
         ...
         RetainSelBlock  =   0   'False
         ScrollBarMaxAlign=   0   'False
         SpreadDesigner  =   "frmComm_YEJ.frx":69BE
      End
...
Dim fVitors(100) As String
Dim fVitorsFlag  As String
Dim fVitorsFlagUse(100) As String
Dim fVitorsFlagStr(100) As String
Dim fVitorsCfg(100) As Integer
Dim fVitorsSize(100, 1) As Integer
Dim fRcvString As String
Dim fChannel() As String

Dim fVitorsOrder(100) As String
...
On Error GoTo ErrorTrap
    ...
    gSql = "select a.RE_RCID,b.JU_NAME,b.JU_PERID from EXAM_TOC A,JUMN_TMA B,RECE_TJU C" _
            ...
            & " And b.HE_UNID = 'HS-44906' And a.IN_CODE like 'BC%' And a.EX_INST < '2' " _
...
Private Sub psDataDefine(ByVal strdata As String, ByRef brChannel() As String, ByVal brspread As Object) ', ByVal brOst As String) ' ByRef brItemdeci() As String)
    ...
    sDecnt = (Len(sTemp) - 72) / 29                                     ' 총 검사항목 갯수를 찿는다.
    fVitors(0) = Str$(sDecnt)                                           ' 총 검사항목 갯수를 넣는다. 나중에 사용한다.
    fVitors(1) = Val(Mid$(sTemp, 25, 15))                               ' 항목 2 "1"   일련번호
   
    Dim ssTemp1 As Integer
    Dim ssTemp2 As String
    sTemp = Text_Change(sTemp, vbCr, "")
    sTemp = Text_Change(sTemp, vbLf, "")
    
    For pDoCount = 1 To sDecnt
        ssTemp1 = (pDoCount - 1) * 29 + 72                             ' 첫번째 Channel 및 검사결과 위치 확인
        ssTemp2 = Mid$(sTemp, ssTemp1, 29)
        fVitors(((pDoCount - 1) * 2) + 4 + 1) = Mid$(ssTemp2, 6, 5)    ' channel
        fVitors(((pDoCount - 1) * 2) + 4 + 2) = Mid$(ssTemp2, 10, 8)   ' result
    Next pDoCount
                        ...
                        For intIdx = 1 To Max_Arary_Cnt
                            If Len(fVitors(((intIdx - 1) * 2) + 4 + 1)) > 0 Then
                                If Trim(fVitors(((intIdx - 1) * 2) + 4 + 1)) = itemX.tag Then
                                    ...
                                    If strRstval = 9999.99 Then
                                        strRstval = ""
                                    End If
                                    If strRstval <> "" And Mid$(strRstval, 1, 1) = "." Then strRstval = "0" + strRstval
                                    If strRstval <> "" And Right$(strRstval, 1) = "." Then strRstval = strRstval + "0"
...
'-------Order sample---------------------
'!000a020002984   13431003102420             1310               FF01.000  23----------Head
'
             ...
             strTmp = "!000a020002984   13431003102420             1310               FF01.000  23"
'                      a020063984   1509280310311              13 1               FF01.000  14
'                      a020076984   140500031110               13 1               FF01.000  F6

    strTmp = strTmp & "!001fGLU   111.0 mg/dL   12D7"
    strTmp = strTmp & "!002fAST    21.  U/L     0022"
    strTmp = strTmp & "!003fTRIG   56.  mg/dL   00FC"
    strTmp = strTmp & "!004fBUN    12.  mg/dL   00C4"
    strTmp = strTmp & "!005fALT    28.  U/L     0025"
    strTmp = strTmp & "!006fCHOL  171.  mg/dL   00FD"
    strTmp = strTmp & "!007fCREA    .7  mg/dL   22D5"
    strTmp = strTmp & "!008h0002E3"
    
    strTmp = strTmp & "!000a020003984   13435103102421             14 1               FF01.000  1B"
    strTmp = strTmp & "!001fGLU   122.  mg/dL   12D9"
    strTmp = strTmp & "!002fAST    23.  U/L     0024"
    strTmp = strTmp & "!003fTRIG   99.  mg/dL   0003"
    strTmp = strTmp & "!004fBUN    13.  mg/dL   00C5"
    strTmp = strTmp & "!005fALT    31.  U/L     001F"
    strTmp = strTmp & "!006fCHOL  179.  mg/dL   0005"
    strTmp = strTmp & "!007fCREA     .8 mg/dL   00D2"
    strTmp = strTmp & "!008h0003E4"
    strTmp = strTmp & "!000a020004984   13443703102422             14 2               FF01.000  23"
    strTmp = strTmp & "!001fGLU    92.  mg/dL   00CC"
    strTmp = strTmp & "!002fAST    25.  U/L     0026"
    strTmp = strTmp & "!003fTRIG  246.  mg/dL   1210"
    strTmp = strTmp & "!004fBUN    17.  mg/dL   00C9"
    strTmp = strTmp & "!005fALT    37.  U/L     0025"
    strTmp = strTmp & "!006fCHOL  162.  mg/dL   00FD"
    strTmp = strTmp & "!007fCREA    1.1 mg/dL   00DC"
    strTmp = strTmp & "!008h0004E5"
    strTmp = strTmp & "!000a020005984   13451503102423             14 3               FF01.000  23"
    strTmp = strTmp & "!001fGLU    78.  mg/dL   00D0"
    strTmp = strTmp & "!002fAST    25.  U/L     0026"
    strTmp = strTmp & "!003fTRIG  103.  mg/dL   0005"
    strTmp = strTmp & "!004fBUN    12.  mg/dL   00C4"
    strTmp = strTmp & "!005fALT    18.  U/L     0024"
    strTmp = strTmp & "!006fCHOL  176.  mg/dL   0002"
    strTmp = strTmp & "!007fCREA     .8 mg/dL   00D2"
    strTmp = strTmp & "!008h0005E6"
...
'    Me.Show
    ...
    Open App.Path + "\" + "Vitros950.log" For Append As #1
            ...
            If aCOL = 5 Then
                ...
                If Trim(varChk) = "1" And Trim(varBar) <> "" Then
                    For iRow = aROW To .maxrows
                        ...
                        .SetText aCOL + 1, iRow, (iCnt Mod 5) + 1
                        iCnt = iCnt + 1
                        If (iCnt Mod 5) = 0 Then varNum = varNum + 1
                    Next
                End If
            End If
        End With
