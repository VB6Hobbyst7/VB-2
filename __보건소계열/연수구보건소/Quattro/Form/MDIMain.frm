...
On Error GoTo ErrorRouten
    ...
    ImportPath = "\\Computer\Human\Import"
    ExportPath = "\\Computer\Human\Export"
    'ExportPath = "d:\quattro\Export"
    
'    Call Load_From(frmComm) '검사화면
    Call Load_From(frmLogin) '로긴화면
