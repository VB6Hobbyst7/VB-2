...
Begin VB.Form frmInterface 
   ...
   Begin VB.Frame FrmHideControl 
      ...
      Begin FPSpread.vaSpread vasCode 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":7E2F
      End
      Begin FPSpread.vaSpread vasTemp1 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":8047
      End
         ...
         Begin MSComctlLib.ImageList imlStatus 
            ...
            BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
               ...
               BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":87E9
                  Key             =   "RUN"
               EndProperty
               BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":8D83
                  Key             =   "NOT"
               EndProperty
               BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":931D
                  Key             =   "STOP"
               EndProperty
               BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":98B7
                  Key             =   "LST"
               EndProperty
               BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":A149
                  Key             =   "ITM"
               EndProperty
               BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":A2A3
                  Key             =   "ERR"
               EndProperty
               BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":A3FD
                  Key             =   "NOF"
               EndProperty
            EndProperty
         End
      ...
      Begin FPSpread.vaSpread vasList 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":A557
      End
      Begin FPSpread.vaSpread vasResTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":A76F
      End
      Begin FPSpread.vaSpread vasTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":A987
      End
   ...
   Begin TabDlg.SSTab stInterface 
      ...
      TabPicture(0)   =   "frmInterface.frx":AB9F
      ...
      TabCaption(1)   =   "이전결과"
      TabPicture(1)   =   "frmInterface.frx":ABBB
      ...
      Begin VB.Frame Frame3 
         ...
         Begin FPSpread.vaSpread vasRRes 
            ...
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":ABD7
         End
         ...
         Begin FPSpread.vaSpread vasRID 
            ...
            RetainSelBlock  =   0   'False
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":E8D9
            UserResize      =   2
         End
      ...
      Begin VB.Frame Frame1 
         ...
         Begin FPSpread.vaSpread vasRes 
            ...
            RetainSelBlock  =   0   'False
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":F338
         End
         ...
         Begin FPSpread.vaSpread vasID 
            ...
            RetainSelBlock  =   0   'False
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":1309F
            UserResize      =   2
         End
         Begin FPSpread.vaSpread vasWorkList 
            ...
            RetainSelBlock  =   0   'False
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":13BC2
            UserResize      =   2
         End
...
'    End If
    ...
    Do While i > 0
        ...
        If InStr(1, strTestCode, mGetP(sSeg, 5, Chr(124))) > 0 Then
            If Format(dtpStartDt.Value, "yyyymmdd") <= mGetP(sSeg, 1, Chr(124)) And Format(dtpStopDt.Value, "yyyymmdd") >= mGetP(sSeg, 2, Chr(124)) And strBarcode <> mGetP(sSeg, 4, Chr(124)) Then
                ...
                strBarcode = mGetP(sSeg, 4, Chr(124))
            End If
...
Private Sub SetPatInfo(ByVal pBarNo As String)
    ...
    'Call SetText(vasID, mResult.TestDate, intRow, colOrdDate)         'colOrdDate
...
Private Sub EditRcvDataASTM()
    ...
    For intCnt = 1 To UBound(strRData)
        ...
        Select Case strType
            ...
            Case "R"    '## Result
                    strIntBase = Trim(mGetP(mGetP(strRcvBuf, 14, "|"), 8, "^"))
                    strResult = Trim(mGetP(mGetP(strRcvBuf, 4, "|"), 2, "_"))
...
Private Sub vasID_KeyDown(KeyCode As Integer, Shift As Integer)
    ...
    ElseIf KeyCode = 13 Then
        ...
        If lsID <> lblChangeBar.Caption Then
            ...
            SQL = SQL & vbCrLf & "   SET BARCODE =' " & lsID & "' "
            SQL = SQL & vbCrLf & " WHERE BARCODE = '" & lblBarcode(0).Caption & "' "
            Res = SendQuery(gLocal, SQL)
        End If
        SetText vasID, "Result", gRow, colState
