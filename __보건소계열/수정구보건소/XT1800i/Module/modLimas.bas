...
Global Const REG_POSITION   As String = "Software\성원IT\한신\" & REG_INSNAME
...
Public HOS_CODE             As String       '병원코드
Public HOS_NAME             As String       '병원명
...
Sub Main()
    ...
    HOS_CODE = GetString(HKEY_CURRENT_USER, REG_POSITION, REG_HOSPCODE)
    HOS_NAME = GetString(HKEY_CURRENT_USER, REG_POSITION, REG_HOSPNAME)
    
    frmLogin.lblSite.Caption = HOS_NAME & " [" & HOS_CODE & "]"
