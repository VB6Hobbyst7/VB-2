...
Public cn_Ser As ADODB.Connection       '검진
Public cn_Ser_1 As ADODB.Connection     '진료
Public rs As ADODB.Recordset
Public cmdSQL As New ADODB.Command

Public Const gServer = 1                '검진
Public Const gLocal = 2
Public Const gServer_1 = 3              '진료

Public cn_Local_Flag As Boolean
Public cn_Server_Flag As Boolean
Public cn_Server_Flag_1 As Boolean
...
'    SQL = "select convert(char(10),getdate(),111) + ' ' + convert(char(10),getdate(),108) "
    ...
    If IsDate(GetDateFull) Then
        GetDateFull = Format(GetDateFull, "yyyy/mm/dd hh:mm:ss")
    Else
...
'Public Function Connect_Server_1() As Boolean
'    '진료********************
'
'    Connect_Server_1 = False
'
'On Error GoTo errFind
'    '먼저 전역 Connection 개체를 엽니다.
'    Set cn_Ser_1 = New ADODB.Connection
'
'    ' ConnectionString에는 데이터베이스의 경로가 들어 있습니다.
'    With cn_Ser_1
'        .ConnectionString = "driver=" & gDB_Parm.Driver & ";" & _
...
'    End With
'
'    Connect_Server_1 = True
'    Exit Function
'
'errFind:
'    If Err = -2147467259 Then
'        Set cn_Ser_1 = Nothing
'        Set cn_Ser_1 = New ADODB.Connection
'
'    With cn_Ser_1
'        .ConnectionString = "driver=" & gDB_Parm.Driver & ";" & _
...
'                            "User ID=;" & _
'                            "Password=;" & _
'                            "Data Source=" & gDB_Parm.LocalDB & ";" & _
'                            "Persist Security Info=True"
        .Open
    End With
...
On Error GoTo ErrHandle
    ...
    Case gServer_1
        Set cmdSQL.ActiveConnection = cn_Ser_1
    Case gLocal
...
Public Sub DisConnect_Server_1()
...
ErrHandle:
     Save_Raw_Data SQL & vbCrLf & Err.Number & " : " & Error(Err.Number)
     SendQuery = -1
