...
Begin VB.Form frmInterface 
   ...
   Begin FPSpread.vaSpread spdResult 
      ...
      ScrollBarExtMode=   -1  'True
      ShadowColor     =   16777215
      SpreadDesigner  =   "frmInterface.frx":9FCD
      ScrollBarTrack  =   3
      ShowScrollTips  =   3
   End
   ...
   Begin FPSpread.vaSpread spdWork 
      ...
      ScrollBarExtMode=   -1  'True
      ShadowColor     =   16777215
      SpreadDesigner  =   "frmInterface.frx":F216
      ScrollBarTrack  =   3
      ShowScrollTips  =   3
   End
End
...
Private Sub ReceiveProcess()
    ...
    If gComm.COMTYPE = "1" Then
        ...
        Select Case UCase(gHOSP.MACHNM)
            Case "KX21N":           Call Phase_Serial_KX21N
...
RST:
    strErrMsg = ""
    strErrMsg = strErrMsg & "위    치 : " & gHOSP.MACHNM & "_SerialRcvData_INDIKO" & vbNewLine & vbNewLine
    strErrMsg = strErrMsg & "오류번호 : " & Err.Number & vbNewLine & vbNewLine
    strErrMsg = strErrMsg & "오류내용 : " & Err.Description & vbNewLine
    frmErrMsg.txtErr = vbNewLine & strErrMsg
    frmErrMsg.Show
...
Private Sub SerialRcvData_KX21N()
    '장비 수신 변수
    Dim strRcvBuf       As String   '수신한 Data
    Dim strType         As String   '수신한 Record Type
    Dim strBarno        As String   '수신한 바코드번호
...
On Error GoTo RST
    ...
    With frmInterface
        ...
        If strDisCode <> "U" Then
            Exit Sub
        End If
        
        If Len(strRcvBuf) > 243 Then
            Exit Sub
        End If
        
        'D1U20130607 0000000000000041 0000000 00730 04730 01520 04520095600321003360029000362000800055800026000060004100483001350008820079201042
        'D1U20130607 0000000000034263 0000000 00630 04140 01220 03540085520295003450025900325000940058100020000060003700416001260011900097002250
        'D1U20130607 0000000000034263 0000000 00630 04140 01220 03540085520295003450025900325000940058100020000060003700416001260011900097002250
        'D1U20130607 0000000000003115 0000000 00630 04140 01220 03540085520295003450025900325000940058100020000060003700416001260011900097002250
        
        strBarno = Mid$(strRcvBuf, 10, 13)
        ...
        For intIdx = 30 To Len(strRcvBuf) Step 5
            ii = ii + 1
            strIntBase = CStr(ii)
...
RST:
    strErrMsg = ""
    strErrMsg = strErrMsg & "위    치 : " & gHOSP.MACHNM & "_SerialRcvData_KX21N" & vbNewLine & vbNewLine
    strErrMsg = strErrMsg & "오류번호 : " & Err.Number & vbNewLine & vbNewLine
    strErrMsg = strErrMsg & "오류내용 : " & Err.Description & vbNewLine
    frmErrMsg.txtErr = vbNewLine & strErrMsg
    frmErrMsg.Show
...
Private Sub Phase_Serial_KX21N()
    Dim Buffer      As Variant
    Dim BufChar     As String
    Dim lngBufLen   As Long
    Dim i           As Long
