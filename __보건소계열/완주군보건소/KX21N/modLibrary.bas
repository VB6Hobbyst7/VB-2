...
'argSQL = argSQL & vbNewLine
'argSQL = argSQL & "intPhase >>" & intPhase & vbNewLine
'argSQL = argSQL & "intSndPhase >>" & intSndPhase & vbNewLine
'argSQL = argSQL & "intFrameNo >>" & intFrameNo & vbNewLine
'argSQL = argSQL & "strState >>" & strState & vbNewLine
