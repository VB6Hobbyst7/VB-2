...
Public Function Get_OrderList(asSID As String) As String
    ...
    'MsgBox gAddr
    oSOAP.MSSoapInit gAddr
    '[oSOAP.MSSoapInit2 gAddr
    
    
' Set client = CreateObject("MSSoap.SoapClient30")
''Client.ClientProperty("ServerHTTPRequest") = True
'client.MSSoapInit "http://localhost/docsample1/docsample1.wsdl", "DocSample1", "Sample1SoapPort"
'
'MsgBox Err.Number
'MsgBox client.echostring("a")
'
'[ÃâÃ³] [Æß]SOAP|ÀÛ¼ºÀÚ ´Ü¼ø´ë¿Õ
...
ErrHandle:
    'MsgBox oSOAP.FaultString & vbCrLf & oSOAP.Detail & vbCrLf
    If oSOAP.FaultString <> "" Then
        Debug.Print Format(Time, "hh:nn:ss") & "[SOAP]" & oSOAP.FaultString & vbCrLf & oSOAP.Detail & vbCrLf
