...
Function SaveTransDataW(ByVal argSpcRow As Integer) As Integer
    ...
    'SQL = " Select b.equipcode, a.INTER_CODE, a.INTER_RESULT, a.INTER_RSCODE, a.INTER_MEMO " & vbCrLf
        ...
        'MSH|^~\&|HL7|MMS|||20081230103245||ORU^R01|1a082e2:10e59b48c04:-2cf9:27695009|P|2.3||||||8859/1
        'PID|||2008123000001^C1^A130100001^^^DefaultDomain^PI
        'PV1||E|A1301
        'OBR|1||||||20081230103245
        'OBX|1|ST|WC1010||0.12||||||R
        'OBX|2|ST|WC2010||양성|P5|||||R

'        strHL7Msg = "MSH|^~\&|HL7|MMS|||" & Trim(strDateTime) & "||ORU^R01|1a082e2:10e59b48c04:-2cf9:27695009|P|2.3||||||8859/1" & vbCr
'        strHL7Msg = strHL7Msg & "PID|||" & Trim(strSpecCode) & "^" & Trim(strMachCode) & "^" & Trim(strKigwanCode) & "00001" & "^^^DefaultDomain^PI" & vbCr
'        strHL7Msg = strHL7Msg & "PV1||E|" & Trim(strKigwanCode) & vbCr
'        strHL7Msg = strHL7Msg & "OBR|1||||||" & Trim(strDateTime) & vbCr
        
        sParam = "MSH|^~\&|HL7|MMS|||" & Format(Now, "yyyymmddhhmmss") & "||ORU^R01|1a082e2:10e59b48c04:-2cf9:27695009|P|2.3||||||8859/1 " & Chr(13)
        sParam = sParam & "PID|||" & lsID & "^" & gHPEquip & "^" & gUID & "^^^DefaultDomain^PI" & Chr(13)
        sParam = sParam & "PV1||E|" & gHPID & Chr(13)
        sParam = sParam & "OBR|1||||||" & Format(Now, "yyyymmddhhmmss") & Chr(13)
        
        sParam1 = sParam
        sParam = ""
        
        SetRawData "[Para1]" & sParam1
        
        
'MSH|^~\&|HL7|MMS|||yyyymmddhhmmss||ORU^R01|1a082e2:10e59b48c04:-2cf9:27695009|P|2.3||||||8859/1
'PID|||201404250131^C1^H291100006^^^DefaultDomain^PI
'PV1||E|H2911
'OBR|1||||||yyyymmddhhmmss
'OBX|1|ST|WMD0900707||101||||||R
'OBX|2|ST|WC2210||4.7||||||R
'OBX|3|ST|WC2200||7.3||||||R
'OBX|4|ST|WB2602||279||||||R
'OBX|5|ST|WC3721||0.3||||||R
'OBX|6|ST|WC3720||0.6||||||R
'OBX|7|ST|WC3730||16.8||||||R
'OBX|8|ST|WC3780||5.8||||||R
'OBX|9|ST|WC3750||0.8||||||R
'OBX|10|ST|WC2443||64||||||R
'OBX|11|ST|WC2411||161||||||R
'OBX|12|ST|WB2710||33||||||R
'OBX|13|ST|WB2580||9||||||R
'OBX|14|ST|WB2570||17||||||R
        
        For i = 1 To .vasTemp.DataRowCnt
            lsExamCode = Trim(GetText(.vasTemp, i, 2))
            lsRsCode = Trim(GetText(.vasTemp, i, 4))
            lsRet = Trim(GetText(.vasTemp, i, 3))
            lsSpcCode = Trim(GetText(.vasTemp, i, 5))
            lsDecision = ""
...
Function GetGetEquipExamCode_AU480(argEquipCode As String, argPID As String, Optional intRow As Long) As String
    ...
    For i = 0 To UBound(gReadBuf)
        If gReadBuf(i) <> "" Then
            ...
            '-- [BUN(020)처방 : 계산식]은 Urea(004)로 전송
            If Trim(gReadBuf(i)) = "20" Then
                strExamCode = strExamCode & "0040"
            Else
