...
Begin VB.Form frmInterface 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin FPSpread.vaSpread vasRes 
         ...
         RetainSelBlock  =   0   'False
         ScrollBars      =   2
         SpreadDesigner  =   "frmInterface.frx":2128
      End
   End
    ...
    Select Case strType
        ...
        Case ";"                'SPE  전송(오더요청)
            ...
            For i = 1 To vasID.DataRowCnt
                If Trim(GetText(vasID, i, colPOSNO)) = Val(strTubePos) Then
                    strBarNo = Trim(GetText(vasID, i, colCHARTNO))
                    gRow = i
                    Exit For
                End If
            Next
        ...
        Case "1", "2", "3", "4", "5", "6", "7", "8", "9"
            ...
            If strFunc <> "@" And strFunc <> "M" Then
                ...
                '123456789012345678901234567890123456789012345678901234567890
                ':n     8   8                             13  1   6.5   2   4.3   3    83   4    18   5    10   6   105   7   172   8   167   9  12.3  10  0.67  11  0.59  12   8.5  13 -0.03 
                ':N     3   3                             13
                '  1   6.2
                '  2   4.2   3    96   4    27   5    32   6   142   7   187   8   169
                '  9  11.3
                ' 10  0.50  11  0.33  12   8.4
                ' 13 -0.07 
        ...
        ' 결과 END
        Case ":"
            ':N     1   1                              7  1   7.6   2   4.9   3   119   4    39   5    68   6   245   9  16.3 
            strFunc = Mid(strRcvBuf, 2, 1)
            ...
            If strFunc <> "@" And strFunc <> "M" Then
                ...
                ':n     8   8                             13  1   6.5   2   4.3   3    83   4    18   5    10   6   105   7   172   8   167   9  12.3  10  0.67  11  0.59  12   8.5  13 -0.03 
                For i = 44 To Len(strRcvBuf) Step 10
                'For i = 43 To Len(strRcvBuf) Step 10
                    strIntBase = Trim(Mid(strRcvBuf, i, 3))
                    strIntBase = Format(strIntBase, "00")
                    strResult = Trim(Mid(strRcvBuf, i + 3, 6))
...
'    lblDate.Caption = Trim(GetText(vasID, Row, colHOSPDATE))
    ...
    SQL = SQL & "   AND HOSPDATE = '" & Trim(GetText(vasID, Row, colHOSPDATE)) & "' " & vbCrLf
