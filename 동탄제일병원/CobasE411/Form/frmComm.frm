...
Begin VB.Form frmComm 
   ...
   Begin TabDlg.SSTab tabWork 
      ...
      Tab(0).Control(25)=   "cmdOrder"
      Tab(0).Control(25).Enabled=   0   'False
      Tab(0).Control(26)=   "cmdPosNo"
      ...
      Begin BHButton.BHImageButton cmdNext 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         TransparentPicture=   "frmComm.frx":85C7
         ForeColor       =   16711680
         BackColor       =   255
         AlphaColor      =   255
         ImgOutLineSize  =   3
      ...
      Begin VB.ListBox List1 
         Height          =   2220
         ItemData        =   "frmComm.frx":9329
         Left            =   7950
         List            =   "frmComm.frx":932B
         TabIndex        =   49
         Top             =   6060
         Width           =   7215
      End
      ...
      Begin FPSpread.vaSpread spdResult2 
         ...
         SpreadDesigner  =   "frmComm.frx":932D
         UserResize      =   0
      End
      ...
      Begin FPSpread.vaSpread spdRstview 
         ...
         ScrollBars      =   0
         ShadowColor     =   14735310
         SpreadDesigner  =   "frmComm.frx":97A1
         UserResize      =   0
      End
      ...
      Begin FPSpread.vaSpread spdWorklist 
         ...
         ScrollBarMaxAlign=   0   'False
         ShadowColor     =   14735310
         SpreadDesigner  =   "frmComm.frx":A022
         UserResize      =   2
      End
      Begin Threed.SSCommand cmdSel 
         Height          =   360
      ...
      Begin Threed.SSPanel SSPanel1 
         ...
         Begin VB.ComboBox cboChk 
            Height          =   300
            ItemData        =   "frmComm.frx":AE7B
            Left            =   3870
            List            =   "frmComm.frx":AE85
            TabIndex        =   66
            Top             =   90
            Width           =   1095
         End
         Begin VB.ComboBox cboComNm 
            Height          =   300
            ItemData        =   "frmComm.frx":AE95
            Left            =   4590
            List            =   "frmComm.frx":AE97
            TabIndex        =   65
            Top             =   480
            Visible         =   0   'False
            Width           =   1725
      ...
      Begin Threed.SSPanel SSPanel 
         ...
         Begin VB.ComboBox cboRstgbn 
            Height          =   300
            Index           =   1
            ItemData        =   "frmComm.frx":AE99
            Left            =   2640
            List            =   "frmComm.frx":AEA6
            Style           =   2  '드롭다운 목록
            TabIndex        =   79
            Top             =   105
            Width           =   1770
         ...
         Begin VB.ComboBox Combo2 
            Height          =   300
            ItemData        =   "frmComm.frx":AED0
            Left            =   4590
            List            =   "frmComm.frx":AED2
            TabIndex        =   78
            Top             =   480
            Visible         =   0   'False
            Width           =   1725
      ...
      Begin FPSpread.vaSpread tblexcel 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmComm.frx":AED4
      End
      Begin FPSpread.vaSpread spdResult1 
         ...
         SpreadDesigner  =   "frmComm.frx":B07F
         UserResize      =   0
      End
...
' 검사항목 일괄 처리 하기 위해 처리
        ...
        Else
            ...
            sqlDoc = sqlDoc & "    AND d.labno in (6) " & vbLf
...
Private Sub comEQP_OnComm()
    ...
    Select Case comEQP.CommEvent
        Case comEvReceive
            ...
            If left$(brStr, 1) = ENQ Or Mid(brStr, 2) = ENQ Then '광주추가(Mid(brStr, 2) = ENQ)
                ...
                If left$(brStr, 1) = ACK Then
                    ...
                    Select Case SendCount
                        ...
                        Case 1      'patient information
                            spdResult1.Col = 6: oIdNo = spdResult1.text
'                            pInfo = "2P|1||" & oIdNo & "|||||||||||||||||||||||||||||||" & vbCr & ETX
                        ...
                        Case 2      'Test Order
                            ...
                            spdResult1.Col = 6: oIdNo = spdResult1.text
                            spdResult1.Col = 8: oRackNo = spdResult1.text
                            spdResult1.Col = 9: oPosNo = spdResult1.text
...
'                            Orderoutput = "3O|1|" + oIdNo + "|" + oIdNo + "^" + oRackNo + "^" + oPosNo + "^^SAMPLE^NORMAL|" + Orderoutput + "|R||||||N||||||||||||||O|||||" & vbCr & ETX
...
'                            comEQP.Output = STX & "4L|1|N" & vbCr & ETX & MakeCS("4L|1|N" & vbCr & ETX) & vbCr & vbLf
'                    Debug.Print "[HOST] " & STX & "4L|1|N" & vbCr & ETX & MakeCS("4L|1|N" & vbCr & ETX) & vbCr & vbLf
                        Case Else
'                            Sleep (1000)
                            comEQP.Output = EOT
