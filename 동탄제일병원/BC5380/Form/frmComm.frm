...
'    Set itemX = lvwCuData.ListItems
    ...
    For iRow1 = 1 To spdResult1.maxrows
        ...
        spdResult1.GetText 6, iRow1, vTmp:  sKeyno = Trim$(vTmp) '-- 등록번호
        spdResult1.GetText 4, iRow1, vTmp:  sPatnm = Trim$(vTmp) '-- 이름
                             ...
                             If Trim(H7060.TestId(intIdx)) = itemX.tag Then
                                 ...
                                 If Not itemX Is Nothing Then
                                     ...
                                     Do Until mAdoRs.EOF
                                         ...
                                         If InStr(itemX.text, Trim(mAdoRs.Fields("처방코드"))) > 0 Then
                                             strEqpCd = Trim(mAdoRs.Fields("처방코드"))
                                             Exit Do
                                         End If
...
'
'                                                                sqlDoc = " Update  TB_검사항목 " & _
'                                                                         "    Set     검사결과 = '" & strRstval & "' ," & _
'                                                                         "        진료지원상태 = 5 " & _
'                                                                         "  Where       진료년 = '" & stryy & "' " & _
'                                                                         "    and       진료월 = '" & strmm & "' " & _
'                                                                         "    and       진료일 = '" & strdd & "' " & _
...
'                    sDeCnt = (Len(sTemp) - 31) / 10                     ' 총 검사항목 갯수를 찿는다.
'                    fTBA40FR(0) = Str$(sDeCnt)                            ' 총 검사항목 갯수를 넣는다. 나중에 사용한다.
'                    fTBA40FR(1) = Mid$(sTemp, 2, 1)                       ' 항목 1 "D"            결과타입
'                    fTBA40FR(2) = Mid$(sTemp, 15, 11)                     ' 항목 2 "0200000001"   환자번호
'                    fTBA40FR(3) = Mid$(sTemp, 11, 4)                      ' 항목 3 "0000"         NO
'                    For pDoCount = 1 To sDeCnt
'                        ssTemp1 = (pDoCount - 1) * 10 + 31              ' 첫번째 Channel 및 검사결과 위치 확인
...
'                    Next pDoCount
'                Else
'                    sDeCnt = (Len(sTemp) - 37) / 10                     ' 총 검사항목 갯수를 찿는다.
'                    fTBA40FR(0) = Str$(sDeCnt)                            ' 총 검사항목 갯수를 넣는다. 나중에 사용한다.
'                    fTBA40FR(1) = Mid$(sTemp, 2, 1)                       ' 항목 1 "D"            결과타입
'                    fTBA40FR(2) = Mid$(sTemp, 15, 11)                     ' 항목 2 "0200000001"   환자번호
'                    fTBA40FR(3) = Mid$(sTemp, 11, 4)                      ' 항목 3 "0000"         NO
'                    For pDoCount = 1 To sDeCnt
'                        ssTemp1 = (pDoCount - 1) * 10 + 37              ' 첫번째 Channel 및 검사결과 위치 확인
'                        ssTemp2 = Mid$(sTemp, ssTemp1, 10)
'                        FunStr1 = Mid$(ssTemp2, 3, 7)
'                        fTBA40FR(((pDoCount - 1) * 2) + 4 + 1) = Mid$(ssTemp2, 1, 2)   ' channel
'                        fTBA40FR(((pDoCount - 1) * 2) + 4 + 2) = Mid$(ssTemp2, 3, 6)   ' result
...
'                sDeCnt = (Len(sTemp) - 46) / 10                     ' 총 검사항목 갯수를 찿는다.
'                fTBA40FR(0) = Str$(sDeCnt)                            ' 총 검사항목 갯수를 넣는다. 나중에 사용한다.
'                fTBA40FR(1) = Mid$(sTemp, 2, 1)                       ' 항목 1 "D"            결과타입
'                fTBA40FR(2) = Mid$(sTemp, 15, 12)                     ' 항목 2 "0200000001"   환자번호
'                fTBA40FR(3) = Mid$(sTemp, 11, 4)                      ' 항목 3 "0000"         NO
'
'                For pDoCount = 1 To sDeCnt
'                    ssTemp1 = (pDoCount - 1) * 10 + 46              ' 첫번째 Channel 및 검사결과 위치 확인
