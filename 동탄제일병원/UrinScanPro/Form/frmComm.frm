...
Begin VB.Form frmComm 
   ...
   Begin TabDlg.SSTab tabWork 
      ...
      Tab(0).Control(9)=   "spdWorklist"
      Tab(0).Control(9).Enabled=   0   'False
      Tab(0).Control(10)=   "txtBarCode"
      Tab(0).Control(10).Enabled=   0   'False
      Tab(0).Control(11)=   "pnlCom2"
      Tab(0).Control(11).Enabled=   0   'False
      Tab(0).Control(12)=   "cmdRequist(2)"
      Tab(0).Control(12).Enabled=   0   'False
      Tab(0).Control(13)=   "chkAuto"
      Tab(0).Control(13).Enabled=   0   'False
      Tab(0).Control(14)=   "txtResult"
      Tab(0).Control(14).Enabled=   0   'False
      Tab(0).Control(15)=   "spdRstview"
      Tab(0).Control(15).Enabled=   0   'False
      Tab(0).Control(16)=   "cmdRackNo"
      Tab(0).Control(16).Enabled=   0   'False
      Tab(0).Control(17)=   "cmdWordQuery"
      Tab(0).Control(17).Enabled=   0   'False
      Tab(0).Control(18)=   "cmdEot"
      ...
      Tab(0).Control(30)=   "cmdPosNo"
      Tab(0).Control(30).Enabled=   0   'False
      Tab(0).Control(31)=   "optBarcode(0)"
      Tab(0).Control(31).Enabled=   0   'False
      Tab(0).Control(32)=   "optBarcode(1)"
      ...
      Begin BHButton.BHImageButton cmdNext 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         TransparentPicture=   "frmComm.frx":8B58
         ForeColor       =   16711680
         BackColor       =   255
         AlphaColor      =   255
         ImgOutLineSize  =   3
      ...
      Begin VB.ListBox List1 
         Height          =   2220
         ItemData        =   "frmComm.frx":98BA
         Left            =   7950
         List            =   "frmComm.frx":98BC
         TabIndex        =   48
         Top             =   6060
         Width           =   7215
      End
      ...
      Begin FPSpread.vaSpread spdResult2 
         ...
         SpreadDesigner  =   "frmComm.frx":98BE
         UserResize      =   0
      End
      ...
      Begin Threed.SSPanel SSPanel1 
         ...
         Begin VB.ComboBox cboChk 
            Height          =   300
            ItemData        =   "frmComm.frx":B41E
            Left            =   2850
            List            =   "frmComm.frx":B428
            TabIndex        =   85
            Top             =   90
            Width           =   855
         End
      ...
      Begin Threed.SSPanel SSPanel 
         ...
         Begin VB.ComboBox cboRstgbn 
            Height          =   300
            Index           =   1
            ItemData        =   "frmComm.frx":B43C
            Left            =   2640
            List            =   "frmComm.frx":B449
            Style           =   2  '드롭다운 목록
            TabIndex        =   77
            Top             =   105
            Width           =   1770
         ...
         Begin VB.ComboBox Combo2 
            Height          =   300
            ItemData        =   "frmComm.frx":B473
            Left            =   4590
            List            =   "frmComm.frx":B475
            TabIndex        =   76
            Top             =   480
            Visible         =   0   'False
            Width           =   1725
      ...
      Begin FPSpread.vaSpread tblexcel 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmComm.frx":B477
      End
...
Dim fUrinscan_CH(100) As String
Dim fUrinscan_RS(100) As String
...
On Error GoTo ErrorTrap
    CallForm = "clsCommon - Public Function f_subSet_WorkList() As ADODB.Recordset"
        ...
        If Len(strDate) > 6 Then
            ...
            sqlDoc = sqlDoc + vbLf + "  FROM ONIT..GUMJIN_INTERFACE                                                    "
            sqlDoc = sqlDoc + vbLf + " WHERE PER_GUMJIN_DATE = '" & Mid(strDate, 1, 8) & "' "
            sqlDoc = sqlDoc + vbLf + "   AND PER_GUM_NUM = '" & Mid(strDate, 9) & "' "
            sqlDoc = sqlDoc + vbLf + "   AND meditem IN (" & Mid(strTestCd, 1, Len(strTestCd) - 1) & ")                  "
            sqlDoc = sqlDoc + vbLf + "   AND STATUS = '0'                                                              "
            sqlDoc = sqlDoc + vbLf + "   AND RESULT = ''  OR RESULT IS NULL"
        ...
        Else
            ...
            'If Trim(strName) = "" Then
                sqlDoc = sqlDoc & " AND B.Result = '' "
            'End If
            
            '-- UA 10종 제외(제목임)
            sqlDoc = sqlDoc & " AND b.map2seqno <> '1286'" & _
                     " ORDER BY a.chartno "

        End If
        
        Print #1, vbNewLine & "[SQL]" & sqlDoc;
...
'                                End If
                                ...
                                Print #1, vbNewLine & "[RecordChk]" & RecordChk;
                                ...
                                If RecordChk = True Then
                                   ...
                                   strEqpCd = ""
                                    ...
                                    If strEqpCd <> "" Then
                                        ...
                                        Print #1, vbNewLine & "[Update]" & sqlDoc;
...
Private Sub RequestDefine(ByVal strdata As String, ByRef brChannel() As String, ByVal brspread As Object) ', ByVal brOst As String) ' ByRef brItemdeci() As String)
    ...
    'sDeCnt = Len("1Q 0101210000000040244 000000040354 000000040311 000000040303 000000040219 000000040271 000000040217 000000040243 000000040290 000000040263 000000040339 000000040286 000000040296 000000040253 000000040234 000000040285 000000040270 000000040298 000000040274 000000040213 000000040251  ") - 12

    
'    sDeCnt = (Len(sETBTemp) - 12) / 13
    sDeCnt = (Len(sETBTemp) - 11) / 13
'    Debug.Print sDeCnt
        ...
        For pDoCount = 1 To sDeCnt
            ...
            If RecordChk = True Then
                If Not mAdoRs.EOF Then
                    ...
                    'If cboChk.ListIndex = 0 Then
                        intRow = SeqSearch(spdResult1, mAdoRs.Fields("PER_GUM_NUM"), 5)
                
                        If intRow = 0 Then
                            intRow = SeqNullSearch(spdResult1, mAdoRs.Fields("PER_GUM_NUM"), 5)
                        ...
                        Do Until mAdoRs.EOF
                            strEqpCd = f_funGet_CODE(mAdoRs("INTERFACECODE"))
                            Set itemX = lvwCuData.FindItem(strEqpCd, lvwTag, , lvwWhole)
                            If Not itemX Is Nothing Then
                                spdResult1.Row = intRow
                                spdResult1.Col = itemX.Index + 9
...
'    On Error GoTo ErrRoutine
    ...
    Pos = InStr(strdata, "ID_NO")

    Print #1, vbNewLine & "[Pos]" & Pos;
    
    If Pos > 0 Then
        If optBarcode(0).Value = True Then
            strBarno = CStr(Val(Trim$(Mid$(strdata, Pos + 11, 12))))
            'strBarno = Format(strBarno, "#")
        Else
            strBarno = CStr(Val(Trim$(Mid$(strdata, Pos + 6, 4))))
            'strBarno = Format(strBarno, "#")
        End If
        
        Print #1, vbNewLine & "[strBarno]" & strBarno;
    ...
    varTemp = Split(strdata, vbCrLf) 'strdata
    sDeCnt = UBound(varTemp)                        ' 총 검사항목 갯수를 찿는다.
    
    If Len(strBarno) = 1 Then
        Exit Sub
    End If
    
    strBarVal = strBarno

    For pDoCount = 4 To 15
        fUrinscan_CH(pDoCount - 3) = Trim(Mid$(varTemp(pDoCount), 1, 3))  ' channel
        Select Case fUrinscan_CH(pDoCount - 3)
            Case "p.H", "S.G"
                fUrinscan_RS(pDoCount - 3) = Trim(Mid$(varTemp(pDoCount), 4))  ' result
'            Case "LEU"  'WBC
'                'ReceiveData = ReceiveData & "LEU    +-    10   WBC/ul " & vbCrLf
'                fUrinscan_RS(pDoCount - 3) = Trim(Mid$(varTemp(pDoCount), 11, 5)) ' result
'                'LEU -neg
'                If IsNumeric(fUrinscan_RS(pDoCount - 3)) Then
'                    If fUrinscan_RS(pDoCount - 3) < 3 Then
'                        fUrinscan_RS(pDoCount - 3) = "-"
'                    ElseIf fUrinscan_RS(pDoCount - 3) < 5 Then
'                        fUrinscan_RS(pDoCount - 3) = "+-"
'                    ElseIf fUrinscan_RS(pDoCount - 3) < 10 Then
'                        fUrinscan_RS(pDoCount - 3) = "1+"
'                    ElseIf fUrinscan_RS(pDoCount - 3) < 20 Then
'                        fUrinscan_RS(pDoCount - 3) = "2+"
'                    Else
'                        fUrinscan_RS(pDoCount - 3) = "3+"
'                    End If
'                Else
'                    fUrinscan_RS(pDoCount - 3) = Trim(Mid$(varTemp(pDoCount), 4, 7))  ' result
'                End If
            Case "COL"
                fUrinscan_RS(pDoCount - 3) = Trim(Mid$(varTemp(pDoCount), 4))  ' result
                If fUrinscan_RS(pDoCount - 3) = "LT.Yellow" Then
                    fUrinscan_RS(pDoCount - 3) = "Straw"
                End If
                '--
                If fUrinscan_RS(pDoCount - 3) = "Yellow" Then
                    fUrinscan_RS(pDoCount - 3) = "Straw"
                End If
                
            Case "CLA"
                'ReceiveData = ReceiveData & "CLA Clear      " & vbCrLf
                fUrinscan_RS(pDoCount - 3) = Trim(Mid$(varTemp(pDoCount), 4))  ' result
            Case Else
                fUrinscan_RS(pDoCount - 3) = Trim(Mid$(varTemp(pDoCount), 4, 7))  ' result
        End Select
        Debug.Print fUrinscan_CH(pDoCount - 3) & "," & fUrinscan_RS(pDoCount - 3)
        
        Print #1, vbNewLine & "[Ch,Rt]" & fUrinscan_CH(pDoCount - 3) & "," & fUrinscan_RS(pDoCount - 3);
    Next pDoCount
            ...
            If pGrid_Point = 0 Then
                ...
                If RecordChk = True Then
                    If Not mAdoRs.EOF Then
                        'If cboChk.ListIndex = 0 Then
                        If Len(strBarVal) > 6 Then
                            pGrid_Point = SeqSearch(spdResult1, mAdoRs.Fields("PER_GUM_NUM"), 5)
                    
                            If pGrid_Point = 0 Then
                                pGrid_Point = SeqNullSearch(spdResult1, mAdoRs.Fields("PER_GUM_NUM"), 5)
                                If pGrid_Point = 0 Then .maxrows = .maxrows + 1: pGrid_Point = .maxrows
                            End If
...
'                                    End If
                                    ...
                                    If Trim(fUrinscan_CH(intChNum)) <> "" Then
                                        Channel = Trim(fUrinscan_CH(intChNum))
                                    End If
                                    If UCase(Channel) = UCase(itemX.tag) Then
                                        'strRstval = Trim(fAdvia1650(intChNum + 1))
                                        strRstval = Trim(fUrinscan_RS(intChNum))
    ...
    With brspread
        ...
        Else
            For sCnt = 1 To .maxrows
                .Row = sCnt
                .Col = brCol
                If brSeq <> "" And Val(.text) = Val(brSeq) Then
...
'    Call ComReceive(strTmp)
    ...
    ReceiveData = "1R 010100720120723120211I0000000040101                                        M  020120723 1.011  5M     0.5    bay  9M      27    bay 10M      42    bay 11M      28    bay 78M       -    bay 79M       -    bay 80M       -    bay "


    ReceiveData = "1R 010100720120724122520I0000000040181                                        M  020120724 1.011  3M      15    bay  4M     0.8    bay  9M      25    bay 10M      17    bay 78M       -    bay 79M       +    bay 80M       -    bay "

    ReceiveData = ""
    ReceiveData = ReceiveData & "~OCT/25/2012 10:07:47     " & vbCrLf
    ReceiveData = ReceiveData & "Name:             Sex:    " & vbCrLf
    ReceiveData = ReceiveData & "Ward:             Age:    " & vbCrLf
    ReceiveData = ReceiveData & "SD (10)      (1891)       " & vbCrLf
    ReceiveData = ReceiveData & "BLD       +    10RBC/ul   " & vbCrLf
    ReceiveData = ReceiveData & "BIL       -        neg    " & vbCrLf
    ReceiveData = ReceiveData & "URO       +    1.0mg/dl   " & vbCrLf
    ReceiveData = ReceiveData & "KET       -        neg    " & vbCrLf
    ReceiveData = ReceiveData & "PRO       -        neg    " & vbCrLf
    ReceiveData = ReceiveData & "NIT     pos    0.1mg/dl   " & vbCrLf
    ReceiveData = ReceiveData & "GLU       -        neg    " & vbCrLf
    ReceiveData = ReceiveData & "pH                 6.0    " & vbCrLf
    ReceiveData = ReceiveData & "S.G             >1.025    " & vbCrLf
    ReceiveData = ReceiveData & "LEU       +    25WBC/ul   " & vbCrLf
    ReceiveData = ReceiveData & "(SN=60158726)             " & vbCrLf
    ReceiveData = ReceiveData & "ID(             )         " & vbCrLf
    ReceiveData = ReceiveData & "OP(00000000) LOT(000000) ~" & vbCrLf
 
    ReceiveData = ""
    ReceiveData = ReceiveData & "Date :Feb-11-2014 18:03:20" & vbCrLf
    ReceiveData = ReceiveData & "ID_NO:0001-                " & vbCrLf
    ReceiveData = ReceiveData & "Ward: " & vbCrLf
    ReceiveData = ReceiveData & "Name: " & vbCrLf
    ReceiveData = ReceiveData & "BLD    -    neg          " & vbCrLf
    ReceiveData = ReceiveData & "BIL    -    neg          " & vbCrLf
    ReceiveData = ReceiveData & "URO    +-  norm          " & vbCrLf
    ReceiveData = ReceiveData & "KET    -    neg          " & vbCrLf
    ReceiveData = ReceiveData & "PRO    -    neg          " & vbCrLf
    ReceiveData = ReceiveData & "NIT    -    neg          " & vbCrLf
    ReceiveData = ReceiveData & "GLU    -    neg          " & vbCrLf
    ReceiveData = ReceiveData & "p.H         8.0          " & vbCrLf
    ReceiveData = ReceiveData & "S.G       1.015          " & vbCrLf
    ReceiveData = ReceiveData & "LEU    +-    10   WBC/ul " & vbCrLf
    ReceiveData = ReceiveData & "COL LT.Yellow  " & vbCrLf
    ReceiveData = ReceiveData & "CLA Clear      " & vbCrLf
    ReceiveData = ReceiveData & ""
