   ...
   Begin VB.Frame Frame1 
      ...
      Begin FPSpread.vaSpread vasExcel 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":150F
      End
      ...
      Begin FPSpread.vaSpread vasID 
         ...
         SpreadDesigner  =   "frmInterface.frx":1735
      End
      ...
      Begin FPSpread.vaSpread vasRes 
         ...
         RetainSelBlock  =   0   'False
         ScrollBars      =   2
         SpreadDesigner  =   "frmInterface.frx":2352
      End
   End
   ...
   Begin VB.Frame FrmHideControl 
      ...
      Begin VB.Frame Frame5 
         ...
         Begin VB.ComboBox cboTest 
            ...
            ForeColor       =   &H00FF0000&
            Height          =   300
            ItemData        =   "frmInterface.frx":3A6B
            Left            =   600
            List            =   "frmInterface.frx":3A6D
            Style           =   2  '드롭다운 목록
            TabIndex        =   70
            Top             =   1650
            Visible         =   0   'False
      ...
      Begin VB.Frame Frame4 
         ...
         Begin FPSpread.vaSpread vasPrintBuf 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            SpreadDesigner  =   "frmInterface.frx":54F6
         End
      End
      ...
      Begin FPSpread.vaSpread vasCode 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":571C
      End
      Begin FPSpread.vaSpread vasTemp1 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":5942
      End
         ...
         Begin MSComctlLib.ImageList imlStatus 
            ...
            BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
               ...
               BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":60F2
                  Key             =   "RUN"
               EndProperty
               BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":668C
                  Key             =   "NOT"
               EndProperty
               BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":6C26
                  Key             =   "STOP"
               EndProperty
               BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":71C0
                  Key             =   "LST"
               EndProperty
               BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":7A52
                  Key             =   "ITM"
               EndProperty
               BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":7BAC
                  Key             =   "ERR"
               EndProperty
               BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":7D06
                  Key             =   "NOF"
               EndProperty
            EndProperty
         End
      ...
      Begin FPSpread.vaSpread vasList 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":7E60
      End
      Begin FPSpread.vaSpread vasResTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":8086
      End
      Begin FPSpread.vaSpread vasTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":82AC
      End
...
'    If Len(sBarcode) > 6 Then
'        SQL = ""
'        SQL = SQL & "SELECT PER_GUMJIN_DATE as 접수일자, PER_SSN, PER_NAME as 이름, CHARTNO as 챠트번호, PER_GUM_NUM, SEQNO, meditem AS ITEM, INTERFACECODE " & vbCr
'        SQL = SQL & "  FROM ONIT..GUMJIN_INTERFACE " & vbCr
'        SQL = SQL & " WHERE PER_GUMJIN_DATE = '" & Mid(sBarcode, 1, 8) & "' " & vbCr
'        SQL = SQL & "   AND PER_GUM_NUM = '" & Mid(sBarcode, 9) & "' " & vbCr
'        SQL = SQL & "   AND MEDITEM IN (" & gAllExam & ")" & vbCr
'        SQL = SQL & "   AND STATUS = '0' " & vbCr
'        SQL = SQL & "   AND RESULT = ''  OR RESULT IS NULL" & vbCr
'    Else
''        SQL = SQL & "SELECT a.EnterDate as 접수일자, b.Status, b.waitseqno, b.MAP2SEQNO, b.DispDesc, b.RVALUEKIND, b.NORMLOW, b.NORMHIGH, b.NORMALVALUE, b.RVALUEKIND , " & vbCr
''        SQL = SQL & " a.ChartNo as 챠트번호, b.GumsaKind, c.sujinname as 이름, b.status " & vbCr
'
'        SQL = ""
'        SQL = SQL & "SELECT a.EnterDate as 접수일자, b.Status, b.waitseqno, b.MAP2SEQNO as ITEM, a.ChartNo as 챠트번호, c.sujinname as 이름 " & vbCr
'        SQL = SQL & " FROM onit_out..WaitPrsnp a, onit_out..jun370_resulttb b, onit_out..pewprsnp c, onit_out..BAGMAP2PREF d " & vbCr
'        SQL = SQL & " WHERE a.WaitSeqNo = '" & Val(strDate) & "' " & vbCr
'        SQL = SQL & " AND a.WaitSeqNo = b.WaitSeqNo " & vbCr
'        SQL = SQL & " AND d.labno in (2) " & vbCr
'        SQL = SQL & " AND b.map2seqno = d.map2seqno " & vbCr
'        SQL = SQL & " AND a.chartno = c.chartno " & vbCr
'        SQL = SQL & " AND B.Result = '' " & vbCr
'
'        '-- UA 10종 제외(제목임)
'        'SQL = SQL & " AND b.map2seqno <> '1286'" & vbCr
...
'    End If
    ...
    If cboChk.ListIndex = 0 Then
        SQL = ""
        SQL = SQL & "SELECT PER_GUMJIN_DATE as 접수일자, PER_SSN, PER_NAME, CHARTNO, PER_GUM_NUM, SEQNO, meditem "
        SQL = SQL & "  FROM ONIT..GUMJIN_INTERFACE "
        SQL = SQL & " WHERE PER_GUMJIN_DATE BETWEEN '" & pFrDt & "' AND '" & pToDt & "'" & vbCr
        SQL = SQL & "   AND meditem IN (" & gAllExam & ")" & vbCr
        SQL = SQL & "   AND STATUS = '0'" & vbCr
    ...
    Else
        SQL = ""
        SQL = SQL & " SELECT a.EnterDate as 접수일자, b.Status, b.waitseqno, b.MAP2SEQNO, b.DispDesc, b.RVALUEKIND, b.NORMLOW, b.NORMHIGH, b.NORMALVALUE, b.RVALUEKIND , " & vbCr
        SQL = SQL & " a.ChartNo, b.GumsaKind, c.sujinname, b.status, c.PassNo " & vbCr
        SQL = SQL & "   FROM onit_out..WaitPrsnp a, onit_out..jun370_resulttb b, onit_out..pewprsnp c, onit_out..BAGMAP2PREF d " & vbCr
        SQL = SQL & "  WHERE a.EnterDate BETWEEN  '" & pFrDt & "' AND '" & pToDt & "' " & vbLf
        SQL = SQL & "    AND a.WaitSeqNo = b.WaitSeqNo " & vbCr
        SQL = SQL & "    AND d.labno in (6) " & vbCr
        SQL = SQL & "    AND b.map2seqno=d.map2seqno " & vbCr
        SQL = SQL & "    AND b.Result= '' " & vbLf
        SQL = SQL & "    AND a.chartno=c.chartno " & vbLf
        'sql = sql & "    AND Substring(a.EnterDate,1,8) + b.rinputtime1 <= '" & strTime & "' " & vbLf
        SQL = SQL & "    AND (substring(a.sujinpart,1,2) <> '62') " & vbLf
        
        SQL = SQL & "  ORDER BY  a.EnterDate,a.entertime "
    End If
...
Private Sub GetOrder(ByVal pBarNo As String)
    ...
    strItems = GetGetEquipExamCode_E411(gEquip, pBarNo, intRow)
                    ...
                    Select Case strIntBase
                        Case "900" 'HbsAg
                            If IsNumeric(strResult) Then
                                If strResult < 0.9 Then
                                    strResult = "Neg(" & strResult & ")"
                                ElseIf strResult >= 1 Then
                                    strResult = "Pos(" & strResult & ")"
                                Else
                                    strResult = "Bord(" & strResult & ")"
                                End If
                            End If
                        Case "410", "170" 'HbsAb
                            If IsNumeric(strResult) Then
