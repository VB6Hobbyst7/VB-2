   ...
   Begin MSComctlLib.ImageList imlSubList 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "MDIIF.frx":C094
            Key             =   "LIS1101"
            Object.Tag             =   "Menu"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "MDIIF.frx":D0E6
            Key             =   "LIS1102"
            Object.Tag             =   "SubMenus"
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "MDIIF.frx":E138
            Key             =   "LIS1104"
            Object.Tag             =   "SubMenus"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "MDIIF.frx":F18A
            Key             =   "LIS1103"
            Object.Tag             =   "SubMenu"
         EndProperty
      EndProperty
...
Private Sub MDIForm_Load()
    ...
    lblMenuInfo.Caption = gHOSP.MACHNM & "-" & "체중" '"인터페이스"
...
Private Sub txtBarNum_KeyDown(KeyCode As Integer, Shift As Integer)
    ...
    If KeyCode = vbKeyReturn Then
        ...
        With frmInterface.spdOrder
            ...
            '-- 결과환자정보
            If SetPatInfo_ONIT(strChartData, gHOSP.RSTTYPE) = -1 Then
            'If GetSampleInfo(.Row, frmInterface.spdOrder) = -1 Then
                MsgBox "입력한 바코드에서 환자정보를 찾지 못했습니다." & vbNewLine & "바코드 번호를 확인하세요", vbOKOnly + vbCritical, Me.Caption
                txtBarNum.SelStart = 0
                txtBarNum.SelLength = Len(txtBarNum.Text)
                Exit Sub
            Else
                ...
                Call SetText(frmInterface.spdOrder, mGetP(strScanData, 1, "^"), sRow, colCHARTNO)
                Call SetText(frmInterface.spdOrder, mGetP(strScanData, 2, "^"), sRow, colHOSPDATE)
                Call SetText(frmInterface.spdOrder, mGetP(strScanData, 3, "^"), sRow, colDEPT)
            End If
        ...
        frmInterface.spdOrder.RowHeight(-1) = gROWHEIGHT
