...
Begin VB.Form frmComm 
   ...
   Begin TabDlg.SSTab tabWork 
      ...
      Tab(0).Control(8)=   "txtBarCode"
      Tab(0).Control(8).Enabled=   0   'False
      Tab(0).Control(9)=   "pnlCom2"
      Tab(0).Control(9).Enabled=   0   'False
      Tab(0).Control(10)=   "cmdRequist(2)"
      ...
      Tab(0).Control(22)=   "cmdOrder"
      Tab(0).Control(22).Enabled=   0   'False
      Tab(0).Control(23)=   "cmdPosNo"
      Tab(0).Control(23).Enabled=   0   'False
      Tab(0).Control(24)=   "Command2"
      Tab(0).Control(24).Enabled=   0   'False
      Tab(0).Control(25)=   "cmdNext"
      Tab(0).Control(25).Enabled=   0   'False
      Tab(0).Control(26)=   "cmdPrevious"
      Tab(0).Control(26).Enabled=   0   'False
      Tab(0).Control(27)=   "txtSeqNo"
      Tab(0).Control(27).Enabled=   0   'False
      Tab(0).Control(28)=   "spdResult1"
      Tab(0).Control(28).Enabled=   0   'False
      Tab(0).Control(29)=   "Frame3"
      Tab(0).Control(29).Enabled=   0   'False
      Tab(0).Control(30)=   "spdWorklist"
      ...
      Begin FPSpread.vaSpread spdResult1 
         ...
         SpreadDesigner  =   "frmComm.frx":9420
         UserResize      =   0
      End
      ...
      Begin BHButton.BHImageButton cmdNext 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         TransparentPicture=   "frmComm.frx":99B1
         ForeColor       =   16711680
         BackColor       =   255
         AlphaColor      =   255
         ImgOutLineSize  =   3
      ...
      Begin VB.ListBox List1 
         Height          =   2220
         ItemData        =   "frmComm.frx":9E23
         Left            =   7950
         List            =   "frmComm.frx":9E25
         TabIndex        =   49
         Top             =   6060
         Width           =   7215
      End
      ...
      Begin FPSpread.vaSpread spdResult2 
         ...
         ScrollBarMaxAlign=   0   'False
         ShadowColor     =   14735310
         SpreadDesigner  =   "frmComm.frx":9E27
         UserResize      =   0
      End
      ...
      Begin FPSpread.vaSpread spdRstview 
         ...
         ScrollBars      =   0
         ShadowColor     =   14735310
         SpreadDesigner  =   "frmComm.frx":A29B
         UserResize      =   0
      End
      ...
      Begin Threed.SSPanel SSPanel1 
         ...
         Begin VB.ComboBox cboChk 
            Height          =   300
            ItemData        =   "frmComm.frx":B40C
            Left            =   2850
            List            =   "frmComm.frx":B416
            TabIndex        =   85
            Top             =   90
            Width           =   855
         End
      ...
      Begin Threed.SSPanel SSPanel 
         ...
         Begin VB.ComboBox cboRstgbn 
            Height          =   300
            Index           =   1
            ItemData        =   "frmComm.frx":B42A
            Left            =   2640
            List            =   "frmComm.frx":B437
            Style           =   2  '드롭다운 목록
            TabIndex        =   77
            Top             =   105
            Width           =   1770
         ...
         Begin VB.ComboBox Combo2 
            Height          =   300
            ItemData        =   "frmComm.frx":B461
            Left            =   4590
            List            =   "frmComm.frx":B463
            TabIndex        =   76
            Top             =   480
            Visible         =   0   'False
            Width           =   1725
      ...
      Begin FPSpread.vaSpread tblexcel 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmComm.frx":B465
      End
...
On Error GoTo ErrorTrap
    CallForm = "clsCommon - Public Function f_subSet_WorkList() As ADODB.Recordset"
        ...
        Else
            ...
            '-- LFT 제외(제목임)
            sqlDoc = sqlDoc & " AND b.map2seqno <> '1285'" & _
                     " ORDER BY a.chartno "
...
'''
'''            sqlDoc = ""
'''            sqlDoc = "         SELECT meditem,INTERFACECODE"
...
'''        End If
'''
''''        Print #1, vbNewLine & [sqlDoc] & sqlDoc;
'''
'''        Set AdoRs_SQL = New ADODB.Recordset
'''        AdoRs_SQL.CursorLocation = adUseClient
'''        AdoRs_SQL.Open sqlDoc, AdoCn_SQL
                            ...
                            If Not itemX Is Nothing Then
                                ...
                                If RecordChk = True Then
                                   ...
                                   strEqpCd = ""
                                    ...
                                    Do Until mAdoRs.EOF
                                        If cboChk.ListIndex = 0 Then
                                            If InStr(itemX.text, Trim(mAdoRs.Fields("INTERFACECODE") & ",")) > 0 Then
        ...
        For intRow1 = 1 To .maxrows
            ...
            If Trim$(varTmp) = "1" Then
                ...
                If intRow2 < 1 Then
                    ...
                    If Len(strSPid) > 0 And RecordChk = True Then
                        Do Until mAdoRs.EOF
                        
                            If cboChk.ListIndex = 0 Then
                                'strEqpCd = f_funGet_CODE(Trim(mAdoRs("meditem")))
                                strEqpCd = f_funGet_CODE(Trim(mAdoRs("INTERFACECODE")))
                            Else
...
Private Sub ComReceive(ByRef RecData As String)
    ...
    For intIdx1 = 1 To Len(strRec)
        ...
        Select Case strbuff
            Case ACK
                If SndCount > 0 Then
                    If Trim(strOrdLst(SndCount)) <> "" And Len(strOrdLst(SndCount)) > 20 Then
                    
                        Call COM_OUTPUT(strOrdLst(SndCount))
                        Print #1, vbNewLine & "[PC-Order]" & strOrdLst(SndCount)
...
'                    Debug.Print "asDeCnt>>" & sDeCnt
                    ...
                    If sDeCnt = 1 Then
                        Call COM_OUTPUT(EOT)
                        Print #1, vbNewLine & "[PC De=1]" & EOT
                        
                    End If
                ElseIf SndCount > sDeCnt Then
                    Call COM_OUTPUT(EOT)
                    Print #1, vbNewLine & "[PC else]" & EOT
            ...
            Case ETB:
                    ...
                    comEQP.Output = ACK
                    Print #1, vbNewLine & "[PC etb]" & ACK
            Case EOT
                    If f_strOR_FLAG = "Q" Then
                        comEQP.Output = ENQ
                        Print #1, vbNewLine & "[PC EOT_Q]" & ENQ
                    Else
                        comEQP.Output = ACK
                        Print #1, vbNewLine & "[PC EOT]" & ACK
                    End If
                    f_strBuffer = ""
                    Exit Sub
            Case ENQ
                    comEQP.Output = ACK
                    Print #1, vbNewLine & "[PC ENQ]" & ACK
                    f_strBuffer = ""
                    Exit Sub
            Case NAK
                    comEQP.Output = ACK
                    Print #1, vbNewLine & "[PC NAK]" & ACK
                    f_strBuffer = ""
                    Exit Sub
            Case STX
                    f_strBuffer = ""
...
'    sDeCnt = (Len(sTemp) - 155) / 19                         ' 총 검사항목 갯수를 찿는다.
    sDeCnt = (Len(sTemp) - 98) / 19                         ' 총 검사항목 갯수를 찿는다.
    fAdvia1650(0) = Str$(sDeCnt)                            ' 총 검사항목 갯수를 넣는다. 나중에 사용한다.
    fAdvia1650(1) = Trim(Mid$(sTemp, 27, 13))
...
'        FunStr1 = Mid$(ssTemp2, 3, 7)
        ...
        'Debug.Print ((pDoCount - 1) * 2) + 9 + 1
        'Debug.Print fAdvia1650(((pDoCount - 1) * 2) + 9 + 1)
        
        fAdvia1650(((pDoCount - 1) * 2) + 9 + 2) = Trim(Mid$(ssTemp2, 5, 11))  ' result
        'Debug.Print ((pDoCount - 1) * 2) + 9 + 2
        'Debug.Print fAdvia1650(((pDoCount - 1) * 2) + 9 + 2)
    
        fAdvia1200_CH(pDoCount) = Mid$(ssTemp2, 1, 3)    ' channel
        fAdvia1200_RS(pDoCount) = Trim(Mid$(ssTemp2, 5, 11))  ' result
        Debug.Print pDoCount & ">>" & fAdvia1200_CH(pDoCount) & "," & fAdvia1200_RS(pDoCount)
    Next pDoCount
