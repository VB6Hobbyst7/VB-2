    ...
    If KeyCode = vbKeyReturn Then
        ...
        With frmInterface.spdOrder
            ...
            'If GetSampleInfo(.Row, frmInterface.spdOrder) = -1 Then
                ...
                Exit Sub
            Else
                Call SetText(frmInterface.spdOrder, mGetP(strScanData, 1, "^"), gRow, colCHARTNO)
                Call SetText(frmInterface.spdOrder, mGetP(strScanData, 2, "^"), gRow, colHOSPDATE)
                Call SetText(frmInterface.spdOrder, mGetP(strScanData, 3, "^"), gRow, colDEPT)
            End If
