...
Function SaveTransData_ONIT(ByVal argSpcRow As Integer, ByVal SPD As Object) As Integer
    ...
    Dim strTEST         As String   '최고혈압
    Dim strBP1          As String   '최저혈압
    Dim strBT           As String   '신장
    Dim strPR           As String   '체중
    Dim i               As Integer
...
On Error GoTo ErrHandle
    ...
    With frmInterface
        ...
        For i = colSTATE + 1 To SPD.MaxCols
            Select Case GetText(SPD, 0, i)
                Case "최고혈압":    strTEST = GetText(SPD, argSpcRow, i)
                Case "최저혈압":    strBP1 = GetText(SPD, argSpcRow, i)
                Case "신장":        strBT = GetText(SPD, argSpcRow, i)
                Case "체중":        strPR = GetText(SPD, argSpcRow, i)
            End Select
        Next
        ...
        '--혈압 저장
        If strChartNo <> "" And strHospDate <> "" Then
...
'                   3 : 체크된것중 제일 위에 것
'-----------------------------------------------------------------------------'
Public Function SetPatInfo_ONIT(ByVal pBarno As String, ByVal pType As String) As Integer
