...
Begin VB.Form frmMain 
   ...
   Begin VB.Frame FraHidden 
      ...
      Begin FPSpread.vaSpread spdQcResult 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmMain.frx":512D
      End
   ...
   Begin VB.PictureBox Picture2 
      ...
      Begin VB.Frame fraResult 
         ...
         Begin VB.ComboBox cboRstType 
            Appearance      =   0  '평면
            Height          =   300
            ItemData        =   "frmMain.frx":8ED3
            Left            =   420
            List            =   "frmMain.frx":8ED5
            TabIndex        =   129
            Top             =   180
            Width           =   1245
         End
         Begin VB.ComboBox cboState 
            Height          =   300
            ItemData        =   "frmMain.frx":8ED7
            Left            =   4710
            List            =   "frmMain.frx":8ED9
            TabIndex        =   128
            Top             =   180
            Width           =   1395
         End
   ...
   Begin VB.Frame frame2 
      ...
      Begin FPSpread.vaSpread spdRResult 
         ...
         SpreadDesigner  =   "frmMain.frx":C27A
         TextTip         =   2
      End
      Begin FPSpread.vaSpread spdROrder 
         ...
         SpreadDesigner  =   "frmMain.frx":C9B8
         UserResize      =   2
      End
   ...
   Begin VB.Frame frame4 
      ...
      Begin VB.Frame frameCom 
         ...
         Begin VB.ComboBox cboPort 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmMain.frx":10465
            Left            =   2190
            List            =   "frmMain.frx":10467
            TabIndex        =   63
            Top             =   390
            Width           =   2205
         End
         Begin VB.ComboBox cboBaudrate 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmMain.frx":10469
            Left            =   2190
            List            =   "frmMain.frx":1046B
            TabIndex        =   62
            Top             =   780
            Width           =   2205
         End
         Begin VB.ComboBox cboDatabit 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmMain.frx":1046D
            Left            =   2190
            List            =   "frmMain.frx":1046F
            TabIndex        =   61
            Top             =   1170
            Width           =   2205
         End
         ...
         Begin VB.ComboBox cboParity 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmMain.frx":10471
            Left            =   2190
            List            =   "frmMain.frx":10473
            TabIndex        =   58
            Top             =   2520
            Width           =   2205
         End
   ...
   Begin VB.Frame frame3 
      ...
      Begin VB.Frame frameTestSet 
         ...
         Begin VB.Frame frameOrder 
            ...
            Begin FPSpread.vaSpread spdOrdMst 
               ...
               SelectBlockOptions=   0
               ShadowColor     =   13697023
               SpreadDesigner  =   "frmMain.frx":11BF1
               TextTip         =   2
            End
         End
         Begin VB.ComboBox cboResultType 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmMain.frx":11F14
            Left            =   1650
            List            =   "frmMain.frx":11F16
            TabIndex        =   43
            Top             =   5220
            Visible         =   0   'False
            Width           =   1575
         ...
         Begin VB.Frame frameCutOff 
            ...
            Begin VB.ComboBox cboCOH 
               ...
               EndProperty
               Height          =   315
               ItemData        =   "frmMain.frx":11F18
               Left            =   2730
               List            =   "frmMain.frx":11F1A
               TabIndex        =   39
               Top             =   1020
               Width           =   735
            End
            ...
            Begin VB.ComboBox cboCOL 
               ...
               EndProperty
               Height          =   315
               ItemData        =   "frmMain.frx":11F1C
               Left            =   2730
               List            =   "frmMain.frx":11F1E
               TabIndex        =   30
               Top             =   300
               Width           =   735
            End
      ...
      Begin FPSpread.vaSpread spdTest 
         ...
         RetainSelBlock  =   0   'False
         SelectBlockOptions=   0
         SpreadDesigner  =   "frmMain.frx":159D6
      End
   End
   Begin VB.Frame frame1 
      ...
      Begin FPSpread.vaSpread spdOrder 
         ...
         SelectBlockOptions=   0
         ShadowColor     =   14548991
         SpreadDesigner  =   "frmMain.frx":16751
         UserResize      =   2
      End
      Begin FPSpread.vaSpread spdResult 
         ...
         SelectBlockOptions=   0
         ShadowColor     =   13697023
         SpreadDesigner  =   "frmMain.frx":195AD
         TextTip         =   2
      End
   End
...
Private Sub cmdExcel_Click()
    ...
    Call spdROrder.ExportToExcel(App.PATH & "\" & Format(Now, "yyyymmdd") & "_결과대장.xls", "sheet1", "1.txt")
    
    MsgBox App.PATH & "\" & Format(Now, "yyyymmdd") & "_결과대장.xls" & " 엑셀저장완료", vbOKOnly + vbInformation, Me.Caption
...
Private Sub SerialRcvData_TEST1()
    ...
    With frmMain
        ...
        'R01953164         0102010003~

        strBarno = Trim(Mid(RcvBuffer, 4, 15))
        strRackNo = Trim(Mid(RcvBuffer, 19, 2))
        strTubePos = Trim(Mid(RcvBuffer, 21, 2))
        
        strIntBase = "ESR"
        strResult = Trim$(Mid$(RcvBuffer, 25, 4))
            ...
            Else
                If intCnt > 2 Then
                    ...
                    If Len(mResult.BarNo) <= 5 Then
                        ...
                        strResult = Replace(strResult, ">", "")
                        strResult = Replace(strResult, "=", "")
                        If mResult.BarNo = "1" Then
                            strLevel = "1"
                        Else
                            strLevel = "2"
                        End If
                        strResult = GetBioradQCVal(strIntBase, strResult, strLevel)
                    End If
...
'110 C2200-1 TP(단회뇨)
                        ...
                        'UIBC
                        If strIntBase = "120" Then
                            strUIBC = strResult
                        End If
                        'FE
                        If strIntBase = "101" Then
                            strFE = strResult
                        End If
                        
                        
                        'RPR
                        If strIntBase = "121" Then
...
RST1:
                    ...
                    'TIBC
                    If strUIBC <> "" And strFE <> "" And IsNumeric(strUIBC) And IsNumeric(strFE) Then
                        strIntBase = "31"
                        strResult = CCur(strUIBC) + CCur(strFE)
                        'strResult = Format(strResult, "#,##0.00")
                        strResult = Format(strResult, "#,##0")
                        strUIBC = ""
                        strFE = ""
