...
Begin VB.Form frmIISCentaur2 
   ...
   Begin FPSpread.vaSpread tblReady 
      ...
      SpreadDesigner  =   "frmIISCentaur2.frx":0000
   End
   Begin FPSpread.vaSpread tblComplete 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   16773087
      SpreadDesigner  =   "frmIISCentaur2.frx":04EF
   End
   ...
   Begin FPSpread.vaSpread tblResult 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   16773087
      SpreadDesigner  =   "frmIISCentaur2.frx":0D31
      TextTip         =   2
   End
End
Attribute VB_Name = "frmIISCentaur2"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
'-----------------------------------------------------------------------------'
'   파일명  : frmIISCentaur.frm
'   작성자  : 오세원
'   내  용  : Centaur XP 장비폼
'   작성일  : 2015-10-30
'   버  전  : 1.0.0
...
Private Sub EditRcvData()
    ...
    Dim strSamplePos As String   '수신한 Sample Position
    ...
    For Each objBuffer In mIntLib.Buffers
        ...
        Select Case strType
            ...
            Case "O"    '## Order
                ...
                strBarNo = Format$(mGetP(strTemp, 1, "^"), String$(SPCLEN, "#"))
                'osw add
                'strBarNo = Format(strBarNo, "#")
                strRackNo = Format$(mGetP(strTemp, 2, "^"), "####")
...
'                        End Select
'                        blnSave = True
'                    Case "INDX"     '## INDEX Value
'                        strIntBase = strIntBase & "I"
'                        strResult = strIntResult
'                        blnSave = True
'                    Case "COFF"     '## COFF Value
'                        strIntBase = strIntBase & "F"
'                        strResult = strIntResult
'                        blnSave = True
'                    Case Else
'                        blnSave = False
    ...
    Select Case mIntLib.SndPhase
        ...
        Case 0      '## 최초 오더 전송인 경우
            ...
            If mOrder.NoOrder = False Then
                strOutput = strOutput & "O|1|" & mOrder.BarNo & "||" & mOrder.GetOrder & _
                            "|R||||||N||||||||||||||Q" & vbCr
            Else
                '## 접수정보가 없는경우
