...
Begin VB.Form frmIISHitachi7600 
   BackColor       =   &H00FFFFFF&
   ...
   Begin FPSpread.vaSpread tblReady 
      ...
      SpreadDesigner  =   "frmIISHitachi7600.frx":0000
   End
   Begin FPSpread.vaSpread tblComplete 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   16773087
      SpreadDesigner  =   "frmIISHitachi7600.frx":04EF
   End
   ...
   Begin FPSpread.vaSpread tblResult 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   16773087
      SpreadDesigner  =   "frmIISHitachi7600.frx":0D31
      TextTip         =   2
   End
End
Attribute VB_Name = "frmIISHitachi7600"
    ...
    For Each objBuffer In mIntLib.Buffers
        ...
        Select Case strType
            ...
            Case "Q"    '## Request Information
                ...
                strOrgBarNo = Trim$(mGetP(strTemp, 2, "/"))
                strBarNo = Mid(strBarNo, 1, 10)
                strRackNo = Trim$(mGetP(strTemp, 4, "/"))
                strPos = Trim$(mGetP(strTemp, 5, "/"))
                
                If strOrgBarNo = "" Then
                    strOrgBarNo = mIntLib.GetBarcodeNo("RFM", strRackNo, strPos)
            ...
            Case "R"    '## Result
                strIntBase = Format$(Replace$(Replace$(mGetP(strRcvBuf, 3, "|"), "^^^", ""), "/", ""), "00")
...
Private Sub SetReady(ByVal pAccInfo As clsIISAccInfo)
    ...
    With tblReady
        ...
        .Col = TReadyEnum.ccNo:     .Text = mOrder.Pos & "/" & mOrder.RackNo 'Mid$(mOrder.RackNo, 2)
