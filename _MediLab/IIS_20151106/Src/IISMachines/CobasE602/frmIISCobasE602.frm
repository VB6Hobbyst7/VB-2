...
Begin VB.Form frmIISCobasE602 
   ...
   Begin FPSpread.vaSpread tblReady 
      ...
      SpreadDesigner  =   "frmIISCobasE602.frx":0000
   End
   Begin FPSpread.vaSpread tblComplete 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   16773087
      SpreadDesigner  =   "frmIISCobasE602.frx":04EF
   End
   ...
   Begin FPSpread.vaSpread tblResult 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   16773087
      SpreadDesigner  =   "frmIISCobasE602.frx":0D31
      TextTip         =   2
   End
End
Attribute VB_Name = "frmIISCobasE602"
...
Private Sub tblComplete_Click(ByVal Col As Long, ByVal Row As Long)
    ...
    With tblComplete
        ...
        If strQcFg = "0" Then
            ...
            .Col = TCompleteEnum.ccPtId:    lblAreaNm.Caption = .Text
    ...
    For Each objBuffer In mIntLib.Buffers
        ...
        Select Case strType
            ...
            Case "Q"    '## Request Information
                ...
                strSeq = mGetP(strTemp1, 4, "^")
                strRackNo = mGetP(strTemp1, 5, "^")
                strTubePos = mGetP(strTemp1, 6, "^")
                
                'Call mIntLib.GetBarcodeNo("RFM", strRack, strPos)
            ...
            Case "R"    '## Result
                ...
                Else
                    ...
                    If Trim(strResult) <> "" Then
                        If objIntNms.ExistIntBase(strIntBase) Then
                            Call objIntInfo.IntResults.Add(strIntBase, objIntNms.GetIntNm(strIntBase), _
                                 strResult, strResult, strTubePos & "/" & strRackNo)
                        End If
                        mIntLib.State = "R"
                    End If
                End If
