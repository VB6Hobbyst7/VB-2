...
Begin VB.Form frmInterface 
   ...
   Begin VB.PictureBox picBottom 
      ...
      Begin VB.Image imgNet1 
         Height          =   240
         Left            =   390
         Picture         =   "frmInterface.frx":10488
         Top             =   180
         Width           =   240
      End
      Begin VB.Image imgNet2 
         Height          =   240
         Left            =   390
         Picture         =   "frmInterface.frx":105D2
         Top             =   180
         Width           =   240
      End
      Begin VB.Image imgNet3 
         Height          =   240
         Left            =   390
         Picture         =   "frmInterface.frx":1071C
         Top             =   180
         Width           =   240
      End
   ...
   Begin FPSpread.vaSpread spdWork 
      ...
      ScrollBarExtMode=   -1  'True
      ShadowColor     =   16777215
      SpreadDesigner  =   "frmInterface.frx":10866
      ScrollBarTrack  =   3
      ShowScrollTips  =   3
   End
End
            ...
            Select Case strType
                ...
                Case ":"    '## End
                    ...
                    For ii = 45 To Len(strRcvBuf) Step 10
                        strIntBase = Trim(Mid(strRcvBuf, ii, 3))
                        strIntBase = Val(Format(strIntBase, "00"))
