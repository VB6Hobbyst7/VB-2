...
Public Sub SetLogData(ByVal strName As String, ByVal argSQL As String, Optional ByVal argMode As String)
    Dim FilNum
    Dim sFileName As String
    ...
    If Dir(App.PATH & "\QC", vbDirectory) <> "QC" Then
        MkDir (App.PATH & "\QC")
    End If
    ...
    If argMode = "A" Then
        Open App.PATH & "\QC\" & strName & ".txt" For Append As FilNum
    Else
        Open App.PATH & "\QC\" & strName & ".txt" For Output As FilNum
    End If
    Print #FilNum, argSQL
    Close FilNum
