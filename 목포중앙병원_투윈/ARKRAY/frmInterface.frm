...
Begin VB.Form frmInterface 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin FPSpread.vaSpread vasRes 
         ...
         RetainSelBlock  =   0   'False
         ScrollBars      =   2
         SpreadDesigner  =   "frmInterface.frx":6DA8
      End
   End
...
Private Sub SetPatInfo(ByVal pBarNo As String, Optional ByVal pRno As String, Optional ByVal pPno As String)
    ...
    Call GetSampleInfoW_TWIN(intRow)
        ...
        Select Case strType
            ...
            Case "O"    '## Order
                ...
                If sQcCheck = "C" Then
                    ...
                    strBarNo = "QC" & strRackNo & strTubePos
                Else
