...
Begin VB.Form frmInterface 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin FPSpread.vaSpread vasRes 
         ...
         RetainSelBlock  =   0   'False
         ScrollBars      =   2
         SpreadDesigner  =   "frmInterface.frx":21AC
      End
   End
   ...
   Begin VB.Frame FrmHideControl 
      ...
      Begin VB.Frame Frame4 
         ...
         Begin FPSpread.vaSpread vasPrintBuf 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            SpreadDesigner  =   "frmInterface.frx":53C8
         End
      End
      ...
      Begin FPSpread.vaSpread vasCode 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":562D
      End
      Begin FPSpread.vaSpread vasTemp1 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":5892
      End
         ...
         Begin MSComctlLib.ImageList imlStatus 
            ...
            BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
               ...
               BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":6081
                  Key             =   "RUN"
               EndProperty
               BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":661B
                  Key             =   "NOT"
               EndProperty
               BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":6BB5
                  Key             =   "STOP"
               EndProperty
               BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":714F
                  Key             =   "LST"
               EndProperty
               ...
               BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":7B3B
                  Key             =   "ERR"
               EndProperty
               BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":7C95
                  Key             =   "NOF"
               EndProperty
            EndProperty
         End
      ...
      Begin FPSpread.vaSpread vasList 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":7DEF
      End
      Begin FPSpread.vaSpread vasResTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":8054
      End
      Begin FPSpread.vaSpread vasTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":82B9
      End
      Begin FPSpread.vaSpread vasExcel 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":851E
      End
...
Private Sub SetPatInfo(ByVal pBarNo As String, Optional ByVal pRno As String, Optional ByVal pPno As String)
    ...
    Call GetSampleInfoW_SWMC(intRow)
...
Private Sub EditRcvDataASTM()
    ...
    Dim strMTBResult    As String   '수신한 결과(정성)
    Dim strResult    As String   '수신한 결과(정성)
    Dim strMachResult    As String   '수신한 결과(정성)
    ...
    Dim strKPC      As String
    Dim strNDM      As String
    Dim strVIM      As String
    Dim strOXA48    As String
    Dim strIMP1     As String
    Dim strSPC      As String
    
    Dim strCtResult  As String
   ...
   ' On Error Resume Next
    ...
    For intCnt = 1 To UBound(strRecvData)
        ...
        strTemp1 = strRecvData(intCnt)
        
        SetRawData "[ED]" & strTemp1
        
        
        strType = Mid(strTemp1, 1, 1)
        If IsNumeric(strType) Then
            strType = Mid(strTemp1, 2, 1)
        End If
...
'                strTemp1 = mGetP(mGetP(strRcvBuf, 3, "|"), 4, "^")  '숫자채널
'                strTemp3 = mGetP(mGetP(strRcvBuf, 3, "|"), 7, "^")  '검사명
'                strTemp2 = ""
                ...
                'strIntName = mGetP(mGetP(strTemp1, 3, "|"), 7, "^")
                
                strIntBase = mGetP(strTemp1, 3, "|")
                strResult = mGetP(mGetP(strTemp1, 4, "|"), 1, "^")
                strMachResult = strResult
                
                'SetRawData "[채널|결과]" & strIntBase & ":" & strResult
'Binary Toxin
'Toxigenic C

                If strIntBase = "^001^^003^^^Toxin B^" Then
                ...
                '-- Toxigenic C
                If strIntBase = "^001^^002^^^TcdC^" Then
                    strIntBase = "004"
                    If InStr(strResult, "POS") > 0 Then
                        strResult = "Positive"
                    ElseIf InStr(strResult, "NEG") > 0 Then
                ...
                If strIntBase = "^001^^002^^^Binary Toxin^" Then
                    If InStr(strResult, "POS") > 0 Then
                        strResult = "Positive"
                    ElseIf InStr(strResult, "NEG") > 0 Then
                        strResult = "Negative"
                ...
                'MTB
                If strIntBase = "^010^^020^Xpert MTB-RIF Assay G4^5^MTB^" Then
                    strMTBResult = ""
                    If InStr(strResult, "NOT") > 0 Then
                        strResult = "Negative"
                    Else
                        strResult = "Positive"
                    End If
                    strMTBResult = strResult
                    blnRIF = True
                End If
                
                'RIF
                If strIntBase = "^010^^040^Xpert MTB-RIF Assay G4^5^Rif Resistance^" Then
                    If strMTBResult = "Negative" Then
                        strResult = "검출불능"
                    ElseIf strMTBResult = "Positive" Then
                        If InStr(strResult, "NOT") > 0 Then
                            strResult = "감수성"    '"Negative"
                        Else
                            strResult = "내성"      '"Positive"
                        End If
                    End If
                    blnRIF = True
                End If
                ...
                End If
                'SPC
                If strIntBase = "^Carba-R^^SPC^Xpert Carba-R^2^SPC^" Then
                    If InStr(strResult, "NOT") > 0 Then
                        strResult = "Negative"
                    Else
                        strResult = "Positive"
...
'''                If strIntBase = "003" And UCase(strIntName) = "TOXIN B" Then
'''                    strResult = mGetP(mGetP(strTemp1, 4, "|"), 1, "^")
'''                    If InStr(strResult, "POS") > 0 Then
'''                        strResult = "Positive"
'''                    ElseIf InStr(strResult, "NEG") > 0 Then
...
'''
'''                '-- Toxigenic C
'''                If InStr(UCase(strIntName), "TCDC") > 0 Then
'''                    strIntBase = "004"
'''                    strResult = mGetP(mGetP(strTemp1, 4, "|"), 1, "^")
'''                    If InStr(strResult, "POS") > 0 Then
'''                        strResult = "Positive"
...
'''                End If
'''
'''                If strIntBase = "002" And InStr(UCase(strIntName), "BINARY TOXIN") > 0 Then
'''                    strResult = mGetP(mGetP(strTemp1, 4, "|"), 1, "^")
'''                    strResult = mGetP(mGetP(strTemp1, 4, "|"), 1, "^")
'''                    If InStr(strResult, "POS") > 0 Then
'''                        strResult = "Positive"
...
'''
'''                'MTB
'''                'If strIntBase = "020" Then
'''                '^010^^020^Xpert MTB-RIF Assay G4^5^MTB^
'''                If strIntBase = "020" And InStr(UCase(strIntName), "MTB") > 0 Then
'''                    strMTBResult = ""
'''                    strResult = mGetP(mGetP(strTemp1, 4, "|"), 1, "^")
'''                    'strResult = mGetP(mGetP(strTemp1, 4, "|"), 1, "^")
'''                    If InStr(strResult, "NOT") > 0 Then
...
'''
'''                'RIF
'''                '^010^^040^Xpert MTB-RIF Assay G4^5^Rif Resistance^
'''                If strIntBase = "040" And InStr(UCase(strIntName), "RIF") > 0 Then
'''                    strResult = mGetP(mGetP(strTemp1, 4, "|"), 1, "^")
'''                    If strMTBResult = "Negative" Then
'''                        strResult = "검출불능"
'''                    ElseIf strMTBResult = "Positive" Then
...
'''                End If
                ...
                '-- Ct값 찾기
'''                If strIntBase = "^Carba-R^^IMP1^^^IMP1^Ct" Then
'''                    strCtResult = mGetP(mGetP(strRcvBuf, 4, "|"), 2, "^")
'''                    '유효범위 : 3-38
'''                    If IsNumeric(strCtResult) Then
'''                        If CCur(strCtResult) >= 3 And CCur(strCtResult) <= 38 Then
'''                            strResult = "Positive"
'''                        Else
'''                            strResult = "Negative"
'''                        End If
...
'''                    End If
'''                End If
'''                If strIntBase = "^Carba-R^^VIM^^^VIM^Ct" Then
'''                    strCtResult = mGetP(mGetP(strRcvBuf, 4, "|"), 2, "^")
'''                    '유효범위 : 3-38
'''                    If IsNumeric(strCtResult) Then
'''                        If CCur(strCtResult) >= 3 And CCur(strCtResult) <= 38 Then
...
'''                    End If
'''                End If
'''                If strIntBase = "^Carba-R^^NDM^^^NDM^Ct" Then
'''                    strCtResult = mGetP(mGetP(strRcvBuf, 4, "|"), 2, "^")
'''                    '유효범위 : 3-38
'''                    If IsNumeric(strCtResult) Then
'''                        If CCur(strCtResult) >= 3 And CCur(strCtResult) <= 38 Then
...
'''                    End If
'''                End If
'''                If strIntBase = "^Carba-R^^KPC^^^KPC^Ct" Then
'''                    strCtResult = mGetP(mGetP(strRcvBuf, 4, "|"), 2, "^")
'''                    '유효범위 : 3-38
'''                    If IsNumeric(strCtResult) Then
'''                        If CCur(strCtResult) >= 3 And CCur(strCtResult) <= 38 Then
...
'''                    End If
'''                End If
'''                If strIntBase = "^Carba-R^^OXA48^^^OXA48^Ct" Then
'''                    strCtResult = mGetP(mGetP(strRcvBuf, 4, "|"), 2, "^")
'''                    '유효범위 : 3-38
'''                    If IsNumeric(strCtResult) Then
'''                        If CCur(strCtResult) >= 3 And CCur(strCtResult) <= 38 Then
...
'''                    End If
'''                End If
'''                If strIntBase = "^Carba-R^^SPC^^^SPC^Ct" Then
'''                    strCtResult = mGetP(mGetP(strRcvBuf, 4, "|"), 2, "^")
'''                    '유효범위 : 3-40
'''                    If IsNumeric(strCtResult) Then
'''                        If CCur(strCtResult) >= 3 And CCur(strCtResult) <= 40 Then
'''                            strResult = "Positive"
'''                        Else
'''                            strResult = "Negative"
'''                        End If
...
'                If IsNumeric(strCtResult) Then
'                    If strCtResult >= 34 Then
'                        Call SetText(vasID, "0", gRow, colCHECKBOX)
'                        Call SetText(vasID, "보류", gRow, colState)
'                        strState = ""
'                    End If
'                End If
                                
                                
                '확인검사 중: KPC, NDM, VIM, OXA-48, IMP-1 모두 NOT DETECTION으로 측정되고 SPC의 결과도 NOT DETECTION으로 측정될 경우
                ...
                If strResult <> "" Then
                    ...
                    If Res > 0 Then
                        ...
                        SetText vasRes, lsExamCode, lsResRow, colEXAMCODE       '검사코드
                        SetText vasRes, lsExamName, lsResRow, colEXAMNAME       '검사명
                        SetText vasRes, strMachResult, lsResRow, colMachResult     '장비결과
    ...
    If strKPC = "Negative" And strNDM = "Negative" And strVIM = "Negative" And strOXA48 = "Negative" And strIMP1 = "Negative" And strSPC = "Negative" Then
        Call SetText(vasID, "확인검사중", gRow, colState)
        strState = ""
    End If
