...
Begin VB.Form frmInterface 
   ...
   Begin VB.Frame FrmHideControl 
      ...
      Begin VB.Frame Frame4 
         ...
         Begin FPSpread.vaSpread vasPrintBuf 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            SpreadDesigner  =   "frmInterface.frx":1A23
         End
      End
      ...
      Begin FPSpread.vaSpread vasCode 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":1C49
      End
      Begin FPSpread.vaSpread vasTemp1 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":1E6F
      End
         ...
         Begin MSComctlLib.ImageList imlStatus 
            ...
            BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
               ...
               BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":261F
                  Key             =   "RUN"
               EndProperty
               BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":2BB9
                  Key             =   "NOT"
               EndProperty
               BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":3153
                  Key             =   "STOP"
               EndProperty
               BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":36ED
                  Key             =   "LST"
               EndProperty
               BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":3F7F
                  Key             =   "ITM"
               EndProperty
               BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":40D9
                  Key             =   "ERR"
               EndProperty
               BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":4233
                  Key             =   "NOF"
               EndProperty
            EndProperty
         End
      ...
      Begin FPSpread.vaSpread vasList 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":438D
      End
      Begin FPSpread.vaSpread vasResTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":45B3
      End
      Begin FPSpread.vaSpread vasTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":47D9
      End
      Begin FPSpread.vaSpread vasExcel 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":49FF
      End
   ...
   Begin VB.Frame Frame1 
      ...
      Begin FPSpread.vaSpread vasID 
         ...
         SpreadDesigner  =   "frmInterface.frx":4C25
      End
      ...
      Begin FPSpread.vaSpread vasRes 
         ...
         RetainSelBlock  =   0   'False
         ScrollBars      =   2
         SpreadDesigner  =   "frmInterface.frx":57CF
      End
   End
...
'        cboTest.ListIndex = 0
        ...
        .ColWidth(colPSEX) = 3
        .ColWidth(colPAGE) = 3
        .ColWidth(colHOSPDATE) = 9
        .ColWidth(colHOSPDATE) = 9
        .ColWidth(colBARCODE) = 9
        .ColWidth(colPNAME) = 6
        .ColWidth(colState) = 4
    End With
...
On Error GoTo ErrHandle
    cn_Ser.CursorLocation = adUseClient
    Set RS = cn_Ser.Execute("Select sysdate From DUAL", sqlRet)
    RS.Close
...
ErrHandle:
    SetRawData "[Conn]" & "Select sysdate From DUAL"
...
Private Sub EditRcvDataASTM()
    ...
    Dim strN2Val    As String
    Dim strCovVal   As String
    ...
    For intCnt = 1 To UBound(strRecvData)
        ...
        Select Case strType
            ...
            Case "R"   '## Result
                ...
                'COVID-19
                '^^^CoV^Xpert Xpress SARS-CoV-2^2^^
                If strIntBase = "^^^CoV^Xpert Xpress SARS-CoV-2^2^^" Then
                ...
                If strIntBase = "^^^CoV^^^SPC^Ct" Then
                    strResult = mGetP(mGetP(strTemp1, 4, "|"), 2, "^")
                    'If InStr(strResult, "POS") > 0 Then
                    '    strResult = "Positive"
                    'ElseIf InStr(strResult, "NEG") > 0 Then
                    '    strResult = "Negative"
...
RST:
                ...
                '^^^CoV^Xpert Xpress SARS-CoV-2^2^^ 를 사용하지 않고 strN2Val, strEVal 결과로 판정함
                If strN2Val <> "" And strEVal <> "" And strCovVal <> "" Then
                    strIntBase = "^^^CoV^Xpert Xpress SARS-CoV-2^2^^"
                    If strN2Val <> strEVal Then
                        strResult = "확인검사중"
                    Else
                        strResult = strCovVal
                    End If
