...
Begin VB.Form frmInterface 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin FPSpread.vaSpread vasRes 
         ...
         RetainSelBlock  =   0   'False
         ScrollBars      =   2
         SpreadDesigner  =   "frmInterface.frx":214F
      End
   End
   ...
   Begin VB.Frame FrmHideControl 
      ...
      Begin VB.ComboBox cboChk 
         ...
         EndProperty
         Height          =   315
         ItemData        =   "frmInterface.frx":3856
         Left            =   3690
         List            =   "frmInterface.frx":3863
         TabIndex        =   69
         Top             =   7410
         Visible         =   0   'False
         Width           =   975
      ...
      Begin VB.ComboBox cboTest 
         ...
         ForeColor       =   &H00FF0000&
         Height          =   300
         ItemData        =   "frmInterface.frx":387B
         Left            =   1830
         List            =   "frmInterface.frx":387D
      ...
      Begin VB.Frame Frame4 
         ...
         Begin FPSpread.vaSpread vasPrint 
            ...
            EndProperty
            MaxCols         =   9
            SpreadDesigner  =   "frmInterface.frx":387F
         End
         Begin FPSpread.vaSpread vasPrintBuf 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            SpreadDesigner  =   "frmInterface.frx":5306
         End
      End
      ...
      Begin FPSpread.vaSpread vasCode 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":552C
      End
      Begin FPSpread.vaSpread vasTemp1 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":5752
      End
      ...
      Begin FPSpread.vaSpread vasList 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":5F02
      End
      Begin FPSpread.vaSpread vasResTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":6128
      End
      Begin FPSpread.vaSpread vasTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":634E
      End
      Begin FPSpread.vaSpread vasExcel 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":6574
      End
...
'Dim tot_row_count As Long
    ...
    '-- ÀüÃ¼ ¿öÅ©½ÃÆ® ºÒ·¯¿À±â¿Í¼­ 'ÀÓ½Ã.txt' ÆÄÀÏ·Î ÀúÀå
    For i = 1 To lngSCnt
        ...
        '''xlApp.ActiveWorkbook.SaveAs App.Path & "\" & Trim(i) & ".txt", xlText, "", "", False, False '==>2000 + 2003 °ø¿ë
        xlApp.ActiveWorkbook.SaveAs "C:\CFX_EXCEL\" & Trim(i) & ".txt", xlText, "", "", False, False '==>2000 + 2003 °ø¿ë
        
        
        'XLappWS.SaveAs App.Path & "\temp\temp" & Trim(i) & ".txt", xlText, "", "", False, False ==>¿¢¼¿ 2000¿ë
        'ActiveWorkbook.SaveAs App.Path & "\temp\temp" & Trim(i) & ".txt", xlText, "", "", False, False  ===>¿¢¼¿ 2003¿ë
    Next i
                ...
                If strIntBase = "FAM" Then
                    ...
                    If strLisResult <> "" Then
                        ...
                        If Res > 0 Then
                            ...
                            SetText vasRes, strLisResult, lsResRow, colRESULT          '°á°ú
...
Private Sub cmdRsltSearch_Click()
    ...
    vasRes.MaxRows = 0
          ...
          SQL = " SELECT '', SAVESEQ, MID(EXAMDATE,1,8) AS EXAMDATE, HOSPDATE AS Á¢¼öÀÏÀÚ, BARCODE AS ¹ÙÄÚµå¹øÈ£, CHARTNO AS Â÷Æ®¹øÈ£, PID AS ³»¿ø¹øÈ£, PNAME AS ÀÌ¸§,PSEX AS ¼ºº°, PAGE AS ³ªÀÌ, DISKNO, POSNO, EXAMCODE, RESULT, REFFLAG, SENDFLAG,INOUT " & vbCrLf
            ...
            With vasID
                ...
                If blnSame = False Then
                    ...
                    Select Case Trim(RS.Fields("SENDFLAG")) & ""
                        ...
                        Case "1": SetText vasID, "°á°ú", .MaxRows, colState
                        Case "2": SetText vasID, "¿Ï·á", .MaxRows, colState
                                  SetBackColor vasID, .MaxRows, .MaxRows, 1, colState, 202, 255, 112
                        Case "3": SetText vasID, "¼öÁ¤", .MaxRows, colState
...
Private Sub GetWorkList(ByVal pFrDt As String, ByVal pToDt As String, Optional pBarNo As String)
    ...
    vasID.ReDraw = False
          ...
          SQL = " SELECT DISTINCT '1', '' AS SN ,'' AS °á°úÀÏ½Ã, REQ_DT AS Á¢¼öÀÏÀÚ" & vbCrLf
    SQL = SQL & ", QC_BAR_NO AS ¹ÙÄÚµå¹øÈ£, LOT_NO AS Â÷Æ®¹øÈ£, REQ_SEQ AS ³»¿ø¹øÈ£, 'ÀÔ¿ø' AS ÀÔ¿Ü" & vbCrLf
    SQL = SQL & ", '' AS R, '' AS P, REQ_SEQ AS ÀÌ¸§, '³²ÀÚ' AS ¼ºº°, REQ_SEQ AS ³ªÀÌ, ITEM_CD AS ITEM " & vbCrLf
...
'    End If
    ...
    If Not RS.EOF = True And Not RS.BOF = True Then
        ...
        chkWAll.Value = "1"
    Else
        StatusBar1.Panels(3).Text = "Á¶È¸ ´ë»óÀÚ°¡ ¾ø½À´Ï´Ù."
        chkWAll.Value = "0"
    End If
...
'''          SQL = " SELECT DISTINCT '1', '' AS SN ,'' AS °á°úÀÏ½Ã, '' AS Á¢¼öÀÏÀÚ" & vbCrLf
'''    SQL = SQL & ", '' AS ¹ÙÄÚµå¹øÈ£, '' AS Â÷Æ®¹øÈ£, '' AS ³»¿ø¹øÈ£, '' AS ÀÔ¿Ü" & vbCrLf
'''    SQL = SQL & ", '' AS R, '' AS P, '' AS ÀÌ¸§, '' AS ¼ºº°, '' AS ³ªÀÌ, '' AS ITEM " & vbCrLf
'''    SQL = SQL & "  FROM S2QCS101 " & vbCrLf
'''    SQL = SQL & " WHERE 1=1 " & vbCrLf
'''    If pBarNo <> "" Then
'''        SQL = SQL & "   AND QC_BAR_NO = '" & pBarNo & "'" & vbCrLf
...
'''    SQL = SQL & " ORDER BY Á¢¼öÀÏÀÚ, ¹ÙÄÚµå¹øÈ£, Â÷Æ®¹øÈ£, ³»¿ø¹øÈ£"
          ...
          SQL = " SELECT DISTINCT '1', '' AS SN, '' AS °á°úÀÏ½Ã, J.Á¢¼öÀÏÀÚ AS Á¢¼öÀÏÀÚ," & vbCrLf
    SQL = SQL & "        L.°ËÃ¼¹øÈ£ AS ¹ÙÄÚµå¹øÈ£, A.Ã­Æ®¹øÈ£ AS Â÷Æ®¹øÈ£, J.Á¢¼ö¹øÈ£ AS ³»¿ø¹øÈ£,'ÀÔ¿ø' AS ÀÔ¿Ü, " & vbCrLf
    SQL = SQL & "        J.Áø·á°Ë»çID AS R, L.Áø·áÁö¿øID AS P,  A.È¯ÀÚÀÌ¸§ AS ÀÌ¸§, A.È¯ÀÚ¼ºº° AS ¼ºº°, A.È¯ÀÚ³ªÀÌ  AS ³ªÀÌ, L.Ã³¹æÄÚµå + L.¼­ºêÄÚµå AS ITEM " & vbCrLf
    SQL = SQL & "   FROM TB_Áø·á°Ë»ç L " & vbCrLf
    SQL = SQL & "  INNER JOIN TB_Áø·áÁö¿ø J ON (L.Áø·áÁö¿øID=J.Áø·áÁö¿øID) " & vbCrLf
    SQL = SQL & "  INNER JOIN TB_Áø·áÀÏ¹Ý A ON (J.Áø·áÀÏÀÚ=A.Áø·áÀÏÀÚ AND J.Ã­Æ®¹øÈ£=A.Ã­Æ®¹øÈ£ AND J.Áø·á¹øÈ£=A.Áø·á¹øÈ£) " & vbCrLf
    SQL = SQL & "  Where 1 = 1 " & vbCrLf
    SQL = SQL & "    AND J.Á¢¼öÀÏÀÚ Between '" & pFrDt & "' and '" & pToDt & "'" & vbCrLf
    SQL = SQL & "    AND L.°Ë»çÁ¾·ù = '" & gDept_Code & "'" & vbCrLf
    SQL = SQL & "    AND L.°Ë»ç»óÅÂ < 5 " & vbCrLf
    If chkSaveAll.Value = "0" Then
        SQL = SQL & "  AND (L.°Ë»ç°á°ú = '' OR L.°Ë»ç°á°ú IS NULL)"
    End If
    SQL = SQL & "  ORDER BY J.Á¢¼öÀÏÀÚ, J.Á¢¼ö¹øÈ£"
    
    
'          SQL = " SELECT DISTINCT '1', '' AS SN, '' AS °á°úÀÏ½Ã, L.Á¢¼öÀÏÀÚ AS Á¢¼öÀÏÀÚ," & vbCrLf
'    SQL = SQL & "        L.°ËÃ¼¹øÈ£ AS ¹ÙÄÚµå¹øÈ£, L.Ã­Æ®¹øÈ£ AS Â÷Æ®¹øÈ£, '55555' AS ³»¿ø¹øÈ£,'ÀÔ¿ø' AS ÀÔ¿Ü, " & vbCrLf
'    SQL = SQL & "        L.Áø·á°Ë»çID AS R, L.Áø·áÁö¿øID AS P,  'È«±æµ¿' AS ÀÌ¸§, '³²ÀÚ' AS ¼ºº°, '35'  AS ³ªÀÌ, L.Ã³¹æÄÚµå + L.¼­ºêÄÚµå AS ITEM " & vbCrLf
'    SQL = SQL & "   FROM TB_Áø·á°Ë»ç L " & vbCrLf
'    SQL = SQL & "  Where 1 = 1 " & vbCrLf
'    SQL = SQL & "    AND L.Á¢¼öÀÏÀÚ Between convert(datetime,'" & pFrDt & "') and convert(datetime,'" & pToDt & "')" & vbCrLf
'    SQL = SQL & "    AND L.°Ë»çÁ¾·ù = '" & gDept_Code & "'" & vbCrLf
'    SQL = SQL & "    AND L.°Ë»ç»óÅÂ < 5 " & vbCrLf
'    If chkSaveAll.Value = "0" Then
'        SQL = SQL & "  AND (°Ë»ç°á°ú = '' OR °Ë»ç°á°ú IS NULL)"
'    End If
'    SQL = SQL & "  ORDER BY L.Á¢¼öÀÏÀÚ"
...
'             SQL = "Select C.SPECNO , C.SNAME, C.DEPTCODE, DECODE(C.GBIO,'I','ÀÔ ¿ø ','O','¿Ü ·¡ ') as GBIO, B.EXAMNAME,  B.MASTERCODE, B.CHANNEL "
          SQL = " SELECT DISTINCT '1', '' AS SN ,'' AS °á°úÀÏ½Ã, B.JOBDATE AS Á¢¼öÀÏÀÚ" & vbCrLf
    SQL = SQL & ",       C.SPECNO AS ¹ÙÄÚµå¹øÈ£, C.PTNO AS Â÷Æ®¹øÈ£, C.JOBNO AS ³»¿ø¹øÈ£, DECODE(C.GBIO,'I','ÀÔ¿ø','O','¿Ü·¡') AS ÀÔ¿Ü" & vbCrLf
    SQL = SQL & ", '' AS R, '' AS P, C.SNAME AS ÀÌ¸§, C.SEX AS ¼ºº°, C.AGE AS ³ªÀÌ, A.MASTERCODE AS ITEM " & vbCrLf
    SQL = SQL & "  From TW_HSP_OCS.TWEXAM_RESULTC A,"
    SQL = SQL & "       TW_HSP_OCS.TWEXAM_MASTER  B,"
    SQL = SQL & "       TW_HSP_OCS.TWEXAM_SPECMST C"
    SQL = SQL & " Where B.JOBDATE BETWEEN '" & pFrDt & "' AND '" & pToDt & "'" & vbCrLf 'ÀÛ¾÷ÀÏÀÚ
    SQL = SQL & "   And B.EQUCODE1 = '" & gEquipCode & "'" & vbCrLf                     ' ÀåºñÄÚµå
    SQL = SQL & "   AND C.STATUS   = '3' " & vbCrLf                                     ' °Ë»ç»óÅÂ
...
Private Sub GetWorkList_BIT(ByVal pFrDt As String, ByVal pToDt As String, Optional pBarNo As String)
    ...
    '-- BIT
'''          SQL = " SELECT DISTINCT '1', '' AS SN ,'' AS °á°úÀÏ½Ã, SUBSTRING(O.OCMACPDTM,1,8) AS Á¢¼öÀÏÀÚ," & vbCrLf
'''    SQL = SQL & "        R.RESSPMNUM AS ¹ÙÄÚµå¹øÈ£, O.OCMCHTNUM AS Â÷Æ®¹øÈ£,R.RESOCMNUM AS ³»¿ø¹øÈ£, '' AS ÀÔ¿Ü," & vbCrLf
'''    SQL = SQL & "        '' AS R, '' AS P, P.PBSPATNAM AS ÀÌ¸§, P.PBSSEXTYP AS ¼ºº°,'' AS ³ªÀÌ, '' AS ITEM" & vbCrLf
...
'''    '-- ÀúÀå¹ÌÆ÷ÇÔ
'''    If chkSaveAll.Value = "0" Then
'''        SQL = SQL & "   AND (R.RESREPTYP IS NULL OR R.RESREPTYP <> 'F') " & vbCrLf         '--  'I':Áß°£ 'F' ¿Ï·á"
'''        SQL = SQL & "   AND W.ODRDELFLG = 'N'" & vbCrLf
'''        SQL = SQL & "   AND (R.RESRLTVAL = ''  OR R.RESRLTVAL IS NULL)" & vbCrLf
'''    End If
'''    SQL = SQL & " ORDER BY Á¢¼öÀÏ½Ã, Â÷Æ®¹øÈ£, ³»¿ø¹øÈ£"


          SQL = " SELECT DISTINCT '1', a.LABODRDTE AS Á¢¼öÀÏÀÚ, a.LABCHTNUM AS Â÷Æ®¹øÈ£, a.LABATTEND AS ³»¿ø¹øÈ£, a.LABKEYNUM, '','','', b.MANPATNAM AS È¯ÀÚ¸í, '' AS ¼ºº°" & vbCrLf
    SQL = SQL & "   FROM HIB70..ME_LABDAT AS a, HIB70..ME_MAN AS b" & vbCrLf
    SQL = SQL & " WHERE a.LABODRDTE BETWEEN '" & pFrDt & "' AND '" & pToDt & "'" & vbCrLf
    SQL = SQL & "   AND a.LABATTEND = b.MANATTEND " & vbCrLf
    SQL = SQL & "   AND a.LABCHTNUM = b.MANCHTNUM " & vbCrLf
    SQL = SQL & "   AND a.LABODRCOD IN (" & gAllExam & ")" & vbCrLf
    SQL = SQL & "   AND a.LABENDDEP = '2' " & vbCrLf         '--  '2':Á¢¼ö '3' °á°úÀÔ·Â"
    SQL = SQL & " ORDER BY Á¢¼öÀÏÀÚ, Â÷Æ®¹øÈ£, ³»¿ø¹øÈ£"

    Call SetSQLData("¿öÅ©Á¶È¸", SQL)
        ...
        Do Until RS.EOF
            ...
            With vasID
                ...
                For i = 1 To .DataRowCnt
                    ...
                    If Trim(RS("Á¢¼öÀÏÀÚ")) = strDate And Trim(RS("Â÷Æ®¹øÈ£")) = strChart Then
                        blnSame = True
                    End If
'                    For intCol = colState + 1 To vasID.MaxCols
'                        If Trim(RS.Fields("ITEM")) = gArrEquip(intCol - colState, 3) Then
...
'                    Next
                ...
                If blnSame = False Then
                    ...
                    SetText vasID, Trim(RS.Fields("Â÷Æ®¹øÈ£")) & "", .MaxRows, colCHARTNO
                    SetText vasID, Trim(RS.Fields("³»¿ø¹øÈ£")) & "", .MaxRows, colPID
                    SetText vasID, Trim(RS.Fields("È¯ÀÚ¸í")) & "", .MaxRows, colPNAME
                    'SetText vasID, Trim(RS.Fields("¼ºº°")) & "", .MaxRows, colPSEX
                    'SetText vasID, Trim(RS.Fields("³ªÀÌ")) & "", .MaxRows, colPAGE
'                    For intCol = colState + 1 To vasID.MaxCols
'                        If Trim(RS.Fields("ITEM")) = gArrEquip(intCol - colState, 3) Then
...
Private Sub GetWorkList_GINUSDLL(ByVal pFrDt As String, ByVal pToDt As String, Optional pBarNo As String)
    ...
    strResponse = W2ACALL2("SCC0191A", strRequest, gGINUS_Parm.URL) '-- ¹ÙÄÚµå·Î °Ë»ç´ë»ó Á¶È¸(https://211.172.17.66)
    ...
    For i = 0 To UBound(varResponse) - 1
        ...
        With vasID
            If .MaxRows = 0 Then
                ...
                SetText vasID, Mid(mGetP(varResponse(i), 5, vbTab), 1, 8), intRow, colHOSPDATE  '-- Á¢¼öÀÏÀÚ
                SetText vasID, mGetP(varResponse(i), 2, vbTab), intRow, colBARCODE              '-- ¹ÙÄÚµå¹øÈ£
                SetText vasID, mGetP(varResponse(i), 6, vbTab), intRow, colPID                  '-- ³»¿ø¹øÈ£
                SetText vasID, mGetP(varResponse(i), 7, vbTab), intRow, colPNAME                '-- ÀÌ¸§
                Select Case mGetP(varResponse(i), 13, vbTab)                                    '-- ÀÔ/¿Ü
                    Case "O": SetText vasID, "¿Ü·¡", intRow, colINOUT
                    Case "E": SetText vasID, "ÀÀ±Þ", intRow, colINOUT
                    Case "I": SetText vasID, "ÀÔ¿ø", intRow, colINOUT
                End Select
                Call SetOrderColor(mGetP(varResponse(i), 2, vbTab), intRow)
            Else
                '-- °°Àº ¹ÙÄÚµå ¹øÈ£°¡ ÀÖ´ÂÁö Ã¼Å©..
...
Private Sub cmdSearch_Click()
    ...
    Select Case gOCS
        Case "BIT":         Call GetWorkList_BIT(dtpStartDt.Value, dtpStopDt.Value)
...
Private Sub GetWorkList_JBUNIV(ByVal pFrDt As String, ByVal pToDt As String, Optional pBarNo As String)
    ...
    '-- ÀüºÏ´ëº´¿ø  r010m.SPCCD
    SQL = ""
    SQL = SQL & " SELECT '1', '' AS SN ,'' AS °á°úÀÏ½Ã, j011m.colldt AS Á¢¼öÀÏÀÚ, j011m.bcno AS ¹ÙÄÚµå¹øÈ£, j010m.bcprtno AS Â÷Æ®¹øÈ£" & vbCr
    SQL = SQL & "       , r010m.WKYMD||r010m.WKGRPCD||r010m.WKNO FLWKNO " & vbCr
    SQL = SQL & "       , r010m.WKNO AS Á¢¼ö¹øÈ£ " & vbCr
    SQL = SQL & "       , j011m.regno AS ³»¿ø¹øÈ£ " & vbCr
    SQL = SQL & "       , j010m.patnm AS ÀÌ¸§ " & vbCr
    SQL = SQL & "       , j010m.age AS ³ªÀÌ " & vbCr
    SQL = SQL & "       , j010m.sex AS ¼ºº° " & vbCr
...
Private Sub GetWorkList_MSINFOTEC(ByVal pFrDt As String, ByVal pToDt As String, Optional pBarNo As String)
    ...
    txtRCnt.Text = "0"
                ...
                '-- Ã³¹æÀÏÀÚ,Ã³¹æÀÏ·Ã¹øÈ£,È¯ÀÚ¸í,°ËÃ¼¹øÈ£,ÀÔ¿Ü±¸ºÐ,ÀÏ·Ã¹øÈ£,¼ºº°,³ªÀÌ,³»¿ø¹øÈ£,Ã³¹æÄÚµå
    SQL = ""
    SQL = SQL & "Select DISTINCT a.ORDT as Á¢¼öÀÏÀÚ,'0',b.PANM as ÀÌ¸§,a.SPNO as ¹ÙÄÚµå¹øÈ£,a.PAID as Ã­Æ®¹øÈ£, a.OIFL,'0',b.SEXS as ¼ºº°,b.AGES as ³ªÀÌ,a.NWNO as ³»¿ø¹øÈ£,a.ORCD as ITEM " & vbCr
        ...
        Do Until RS.EOF
            ...
            With vasID
                ...
                If blnSame = False Then
                    ...
                    SetText vasID, Trim(RS.Fields("Á¢¼öÀÏÀÚ")) & "", .MaxRows, colHOSPDATE
                    SetText vasID, Trim(RS.Fields("¹ÙÄÚµå¹øÈ£")) & "", .MaxRows, colBARCODE
                    SetText vasID, Trim(RS.Fields("Ã­Æ®¹øÈ£")) & "", .MaxRows, colCHARTNO
                    SetText vasID, Trim(RS.Fields("³»¿ø¹øÈ£")) & "", .MaxRows, colPID
                    SetText vasID, Trim(RS.Fields("ÀÌ¸§")) & "", .MaxRows, colPNAME
                    SetText vasID, Trim(RS.Fields("¼ºº°")) & "", .MaxRows, colPSEX
                    SetText vasID, Trim(RS.Fields("³ªÀÌ")) & "", .MaxRows, colPAGE
...
Dim sFoot As String
    ...
    For iRow = 1 To vasID.DataRowCnt
        ...
        If vasID.Value = 1 Then
            SetText vasPrint, Trim(GetText(vasID, iRow, colBARCODE)), j, 1     '°ËÃ¼¹øÈ£
            SetText vasPrint, Trim(GetText(vasID, iRow, colCHARTNO)), j, 2     'È¯ÀÚ¹øÈ£
            SetText vasPrint, Trim(GetText(vasID, iRow, colPNAME)), j, 3     'È¯ÀÚÀÌ¸§

            SetText vasPrint, Trim(GetText(vasID, iRow, colPSEX)), j, 4     '¼ºº°
            SetText vasPrint, Trim(GetText(vasID, iRow, colPAGE)), j, 5     '³ªÀÌ
            SetText vasPrint, Trim(GetText(vasID, iRow, colHOSPDATE)), j, 7     'Ã³¹æÀÏÀÚ
            SetText vasPrint, Trim(GetText(vasID, iRow, colHOSPDATE)), j, 8     'Ã³¹æÀÏÀÚ
    ...
    vasPrint.PrintAbortMsg = "ÀÎ¼âÁß ÀÔ´Ï´Ù ..."
    vasPrint.PrintJobName = "WorkList Ãâ·Â"
    

    sHead = "/fn""±Ã¼­Ã¼"" /fz""12"" /fb1 /fi0 /fu0 " & "/c" & "¢Ã WorkList ¢Ã" & "/n/n " & _
            "/fn""±¼¸²Ã¼"" /fz""10"" /fb0 /fi0 /fu0 " & "/c" & "Ã³¹æÀÏÀÚ : " & dtpStartDt & " ~ " & dtpStopDt

    sFoot = "/fn""±¼¸²Ã¼"" /fz""10"" /fb1 /fi0 /fu0 " & "/l" & sCurDate & "/fn""±Ã¼­Ã¼"" /fz""11"" /fb1 /fi0 /fu0 /r" & " °Ë»ç½Ç"
...
'        frmInterface.StatusBar1.Panels(2).Text = "COM" & comEqp.CommPort & " Æ÷Æ®¿¡ ¿¬°á µÇ¾ú½À´Ï´Ù"
'        imgPort.Picture = imlStatus.ListImages("RUN").ExtractIcon
'        imgSend.Picture = imlStatus.ListImages("STOP").ExtractIcon
'        imgReceive.Picture = imlStatus.ListImages("STOP").ExtractIcon
'    Else
'        frmInterface.StatusBar1.Panels(2).Text = "Åë½ÅÆ÷Æ®¿¡ ¿¬°á µÇÁö ¾Ê¾Ò½À´Ï´Ù"
...
'    vasID.MaxRows = 10
    ...
    gComName = Winsock1.LocalHostName
...
'    1   RESULTS 90  1
'
'16:52:40 [Tx]1  GET 89  891
'
'16:52:40 [Rx]1  ACK
'2   RESULT  89  VA0201  2017-02-16T09:42:04Z    5   ê¹€ë¯?30.3  9   8   21.875  23.4375 True    False
'
'16:59:00 [Rx]3  RESULTS 91  1
'
'16:59:00 [Tx]3
    For i = 0 To UBound(varBuffers)
        strBuffer = varBuffers(i)
...
Private Function GetSeqNo(ByVal TCnt As Integer, ByRef NS As Integer, ByRef NE As Integer) As String
'Private Function GetSeqNo(ByVal TCnt As Integer) As String ', NS As Integer, NE As Integer) As String
    'Dim i As Integer
    'Dim a, b As Integer
    Dim RCnt As Integer
'    Dim NS As Integer
'    Dim NE As Integer
    ...
    RCnt = CInt(txtRCnt.Text)

    If RCnt < 0 Then
        MsgBox "¼ö½ÅÇÒ °Ë»ç°á°ú °¹¼ö¸¦ ÀÔ·ÂÇÏ¼¼¿ä!'"
        Exit Function
    End If
...
Private Sub MnPrintLand_Click()
    ...
    vasID.PrintOrientation = PrintOrientationLandscape '°¡·ÎÃâ·Â
    vasID.Action = 13
...
Private Sub MnPrintPort_Click()
    ...
    vasID.PrintOrientation = PrintOrientationPortrait '¼¼·ÎÃâ·Â
    vasID.Action = 13
...
Private Sub comEqp_OnComm()
    ...
    Select Case comEqp.CommEvent
        Case comEvReceive
            ...
            'Buffer = "06 001 000000000000000001 37" & vbCr & vbLf ' //Hole No. Sequence No. Serial No. Result"
            '           1  1                     1.3  0.0
...
Private Sub GetOrder(ByVal pBarNo As String)
    ...
    '-- ¹ÙÄÚµå¹øÈ£¿¡ ÇØ´çÇÏ´Â °Ë»çÄÚµå °¡Á®¿À±â
...
Private Sub SetPatInfo(ByVal pBarNo As String, Optional ByVal pRno As String, Optional ByVal pPno As String)
    ...
    Call SetText(vasID, mResult.BarNo, intRow, colCHARTNO)
    ...
    'Call GetSampleInfoW_BIT(intRow)
...
Private Sub EditRcvDataASTM()
    ...
    '3   RESULT  0   VB0203  2016-08-26T06:14:45Z    3   1608260063  18.5    51  40  26  26.3125 True    False
            
    '2   RESULT  76  VA0201  2017-02-16T09:42:04Z    5   ê¹€ë¯?30.3  9   8   21.875  23.4375 True    False

'2   RESULT  167 VA0201  2017-04-06T07:17:55Z    1   1   31.3    10  7   26.625  27  False   False
'3   RESULT  168 VA0201  2017-04-06T07:17:55Z    2   2   29.0    21  15  26.625  27  False   False
'4   RESULT  169 VA0201  2017-04-06T07:17:55Z    3   3   25.3    3   2   26.625  27  False   False
'5   RESULT  170 VA0201  2017-04-06T07:17:55Z    4   4   29.5    5   4   26.625  27  False   False
'6   RESULT  171 VA0201  2017-04-06T07:17:55Z    5   5   28.3    7   5   26.625  27  False   False
            
    varRcvBuf = Split(strBuffer, vbLf)
    
    For intRow = 0 To UBound(varRcvBuf)
        ...
        If Len(strRcvBuf) > 20 Then
            ...
            For i = 1 To vasID.DataRowCnt
                ...
                If vasID.Value = "1" Then
                    gRow = i
                    strBarNo = GetText(vasID, i, colCHARTNO)
                    Exit For
                End If
            Next i
...
'                            SetText vasRes, mGetP(varORQN(i), 2, ","), lsResRow, colSUBCODE                '¼ø¹ø
'                            Exit For
'                        End If
'                    Next
...
Function SetLocalDB(ByVal asRow1 As Long, ByVal asRow2 As Long, asSend As String, Optional asEquipResult As String = "")
    ...
    SQL = "DELETE FROM PATRESULT " & vbCrLf & _
          ...
          "   AND BARCODE = '" & Trim(GetText(vasID, asRow1, colCHARTNO)) & "' " & vbCrLf & _
...
Private Sub txtBarNum_KeyPress(KeyAscii As Integer)
    ...
    If KeyAscii = 13 Then
        If Not IsNumeric(txtBarNum) Then
            StatusBar1.Panels(3).Text = "¹ÙÄÚµå¹øÈ£´Â ¼ýÀÚ¸¸ ÀÔ·ÂÀÌ °¡´ÉÇÕ´Ï´Ù."
            txtBarNum = ""
            Exit Sub
        End If
        
        If Len(txtBarNum) <> 12 Then
            StatusBar1.Panels(3).Text = "¹ÙÄÚµå ÀÚ¸´¼ö¸¦ È®ÀÎÇÏ¼¼¿ä"
            txtBarNum = ""
            Exit Sub
        End If
...
'        End If
    ...
    ElseIf KeyCode = vbKeyReturn Then
        If iCol = colBARCODE Then
            ...
            '-- ¹Ù²ï ¹ÙÄÚµå·Î È¯ÀÚÁ¤º¸ ºÒ·¯¿À±â
            Call GetSampleInfoW_BIT(iRow)
            
            lsID = Trim(GetText(vasID, iRow, colBARCODE))
            
            
            '-- ¹ÙÄÚµå ¹øÈ£°¡ ÀÌÀü°ú Æ²¸®´Ù¸é ¾÷µ¥ÀÌÆ®
            ...
            With vasID
                ...
                If IsNumeric(strSeq) Then
                    For i = .ActiveRow To .DataRowCnt
                        Call SetText(vasID, Format(strSeq, "#0"), i, colDISKNO)
                        strSeq = Val(strSeq) + 1
                    Next
                Else
        ...
        Else
            ...
            '-- °á°ú¸¸ ¼öÁ¤ÇßÀ» °æ¿ìÀÇ ¾÷µ¥ÀÌÆ®´Â Delete >> Insert ¼øÀ¸·Î ÇÑ´Ù.
            '-- Delete
