...
Begin VB.Form frmMain 
   ...
   Begin VB.Frame frame1 
      ...
      Begin FPSpread.vaSpread spdOrder 
         ...
         SpreadDesigner  =   "frmMain.frx":41E9
         UserResize      =   2
      End
      Begin FPSpread.vaSpread spdResult 
         ...
         SpreadDesigner  =   "frmMain.frx":8761
         TextTip         =   2
      End
   End
   Begin VB.Frame FraHidden 
      ...
      Begin VB.Frame frameCutOff 
         ...
         Begin VB.ComboBox cboCOL 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmMain.frx":91C7
            Left            =   2730
            List            =   "frmMain.frx":91C9
            TabIndex        =   175
            Top             =   300
            Width           =   735
         End
         ...
         Begin VB.ComboBox cboCOH 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmMain.frx":91CB
            Left            =   2730
            List            =   "frmMain.frx":91CD
            TabIndex        =   171
            Top             =   1020
            Width           =   735
         End
      ...
      Begin MSComctlLib.ImageList imlStatus 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMain.frx":C0C7
               Key             =   "RUN"
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMain.frx":C661
               Key             =   "NOT"
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMain.frx":CBFB
               Key             =   "STOP"
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMain.frx":D195
               Key             =   "LST"
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMain.frx":DA27
               Key             =   "ITM"
            EndProperty
            BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMain.frx":DB81
               Key             =   "ERR"
            EndProperty
            BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMain.frx":DCDB
               Key             =   "NOF"
            EndProperty
         EndProperty
      End
      Begin FPSpread.vaSpread vasTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmMain.frx":DE35
      End
      ...
      Begin FPSpread.vaSpread spdQcResult 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmMain.frx":E06E
      End
   ...
   Begin VB.Frame frame3 
      ...
      Begin VB.Frame frameTestSet 
         ...
         Begin VB.Frame frameOrder 
            ...
            Begin FPSpread.vaSpread spdOrdMst 
               ...
               SelectBlockOptions=   0
               ShadowColor     =   13697023
               SpreadDesigner  =   "frmMain.frx":11E0A
               TextTip         =   2
            End
         End
         Begin VB.ComboBox cboResultType 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmMain.frx":12367
            Left            =   1650
            List            =   "frmMain.frx":12369
            TabIndex        =   32
            Top             =   5220
            Visible         =   0   'False
            Width           =   1575
      ...
      Begin FPSpread.vaSpread spdTest 
         ...
         RetainSelBlock  =   0   'False
         SelectBlockOptions=   0
         SpreadDesigner  =   "frmMain.frx":15263
      End
   End
   Begin VB.Frame frame4 
      ...
      Begin VB.Frame frameCom 
         ...
         Begin VB.ComboBox cboDatabit 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmMain.frx":16D36
            Left            =   2190
            List            =   "frmMain.frx":16D38
            TabIndex        =   50
            Top             =   1170
            Width           =   2205
         End
         ...
         Begin VB.ComboBox cboParity 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmMain.frx":16D3A
            Left            =   2190
            List            =   "frmMain.frx":16D3C
            TabIndex        =   47
            Top             =   2520
            Width           =   2205
         End
   ...
   Begin VB.Frame frame2 
      ...
      Begin FPSpread.vaSpread spdRResult 
         ...
         SelectBlockOptions=   0
         ShadowColor     =   13697023
         SpreadDesigner  =   "frmMain.frx":184BA
         TextTip         =   2
      End
      Begin FPSpread.vaSpread spdROrder 
         ...
         SelectBlockOptions=   0
         ShadowColor     =   14548991
         SpreadDesigner  =   "frmMain.frx":18E9A
         UserResize      =   2
      End
...
Private Sub SerialRcvData_CA620()
    Dim RS_L            As ADODB.Recordset
    Dim strRcvBuf       As String   '수신한 Data
    Dim strType         As String   '수신한 Record Type
    Dim strBarno        As String   '수신한 바코드번호
    ...
    With frmMain
        ...
        Select Case sBC
            Case "R1", "R2"
                ...
                'R2210101U1807031528000201      180121380B           040      050      
...
Private Sub SerialRcvData_NSPrime()
    Dim RS_L            As ADODB.Recordset
    Dim strRcvBuf       As String   '수신한 Data
    Dim strType         As String   '수신한 Record Type
    Dim strBarno        As String   '수신한 바코드번호
    ...
    With frmMain
        ...
        'DU   3003 11180004688     0.015    21    (-)08/01/201815:41:24C1  1 10C5B

        If Mid$(RcvBuffer, 2, 1) <> "U" Then '"U" = 검체 "C" = 컨트롤
            Exit Sub
        End If
    
        strSeq = Trim(Mid(RcvBuffer, 3, 4))
        strRackNo = Trim(Mid(RcvBuffer, 8, 2))
        strTubePos = Trim(Mid(RcvBuffer, 10, 2))
        strBarno = Trim(Mid(RcvBuffer, 13, 12))
        
        strBarno = Mid(strBarno, 1, 2) & "-" & Mid(Trim(strBarno), 3) & "-" & "1"
        
        strIntResult = Trim$(Mid$(RcvBuffer, 32, 6))   '정량
        strResult = Trim$(Mid$(RcvBuffer, 43, 1))   '정성
...
'''        End If
        ...
        'If gRow > 0 Then
            '-- HD2 (성인병검진) 은 정량만 나간다.
            strPart = GetText(spdOrder, gRow, colINOUT)
            If strPart = "HD2" Then
