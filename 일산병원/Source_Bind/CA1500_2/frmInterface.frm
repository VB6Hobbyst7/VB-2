...
strBuffer = "D1210101U110727103200001501     1572200060B               041  123 042  697 044  120 046  262 047   69 051  335 056  466 057   60 "
    ...
    strBuffer = "D1210101U111024152000000202     9903000111M               041  330 042  177 044  337 046   90 047  140 051  480 056  142 057  113 "
        
    strBuffer = "D1210101U111103080300000101     9903100111M               041  109 042  901 044  105 046   56 047  133 051  264 056  146 057  112 "

strBuffer = "D1210101U111202111800006401     1120855951B               041  104 042 1003 044  100 046  124 047   71 051  265 056  228 057   45 "
...
'            Buffer = strBuffer
            ...
            txtRcv.Text = txtRcv.Text & "[Rx]" & Buffer
                        ...
                        Select Case BufChar
                            Case ETX
                                ...
                                Save_Raw_Data "[Tx]" & ACK
                                 txtRcv.Text = txtRcv.Text & "[Tx]" & ACK
                                Call EditRcvData
