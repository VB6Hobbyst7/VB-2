...
'Public Const colCheckBox = 2
'Public Const colSpecNo = 3
...
'Public Const colIFCC = 16
'Public Const coleAg = 18
...
'    gQCEquip = Trim(frmlogin.txtTemp)
    ...
    '-- Beeblot Export Path
    db_tmp = ""
    Call GetPrivateProfileString("CONFIG", "ExportPath", "", db_tmp, 100, App.Path & "\Interface.ini")
    frmLogin.txtTemp = Trim(db_tmp)
    gDRDB_Parm.ExportPath = Trim(frmLogin.txtTemp)
