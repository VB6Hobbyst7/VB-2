...
Begin VB.Form frmOrderCode 
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.TextBox txtRefHighF 
         ...
         Width           =   555
      End
      Begin VB.ComboBox cboDeltaGubun 
         Height          =   300
         ItemData        =   "frmOrderCode.frx":0000
         Left            =   2655
         List            =   "frmOrderCode.frx":0016
         TabIndex        =   36
         Top             =   1080
         Width           =   510
      End
      Begin VB.ComboBox cboPanicGubun 
         Height          =   300
         ItemData        =   "frmOrderCode.frx":002C
         Left            =   2655
         List            =   "frmOrderCode.frx":0042
         TabIndex        =   35
         Top             =   1890
         Width           =   510
      End
      Begin VB.TextBox txtDeltaDate 
         BeginProperty Font 
            Name            =   "굴림체"
            Size            =   9
            Charset         =   129
   ...
   Begin FPSpread.vaSpread vasList 
      ...
      SpreadDesigner  =   "frmOrderCode.frx":0058
   End
...
Private Sub picEquip_Click()
    ...
    Call Exam_Ref(Trim(txtCode))
    
    txtName = gExamName
    If txtName = "" Then: MsgBox "존재하지 않는 검사코드입니다.": Exit Sub
        
    'gRFVL_DVSN
    txtRefHigh = gMALE_HIGH
    txtRefLow = gMALE_LOW
    txtRefHighF = gFEML_HIGH
    txtRefLowF = gFEML_LOW
    
    'gDELT_DVSN
    
    txtDeltaHigh = gDELT_HIGH
    txtDeltaLow = gDELT_LOW
    txtDeltaDate = gDELT_DD
    
    'gPANC_DVSN
    txtPanicHigh = gPANC_HIGH
    txtPanicLow = gPANC_LOW
