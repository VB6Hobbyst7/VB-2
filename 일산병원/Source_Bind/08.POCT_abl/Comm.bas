...
Public gAllExam_CBC         As String
Public gAllExam_Diff        As String
Public gAllExam_Reti        As String
Public gAllExam_CBC_Diff    As String



Public gLowExam As String
Public gLowExam_DXC1 As String
Public gLowExam_DXC2 As String
Public gLowExam_ELE As String
Public gLowExam_IML As String
Public gLowExam_VAD As String
