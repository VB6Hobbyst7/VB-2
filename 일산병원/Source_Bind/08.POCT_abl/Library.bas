...
'¹ÙÀÌÆ®¼ö Ã¤Å©ÇÏ´Â ÇÔ¼ö·Î ¹Ù²Þ (20110805 Á¤È¿ÁØ)
    Dim sTmp As String
    Dim i As Integer
...
Public Function SetSpace_1(asStr As String, asLen As Integer, Optional asPos As Integer = 1) As String
'asPos = 1 : Left °ø¹é
'asPos = 2 : Right °ø¹é Ã¤¿ì±â
'¹ÙÀÌÆ®¼ö Ã¤Å©ÇÏ´Â ÇÔ¼ö·Î ¹Ù²Þ (20110805 Á¤È¿ÁØ)
    Dim sTmp As String
    ...
    sTmp = ""
    If LenB(asStr) >= asLen Then
        SetSpace_1 = Left(asStr, asLen)
        Exit Function
    End If
    
    sTmp = asStr
    For i = 1 To asLen - LenB(asStr)
        If asPos = 1 Then
            sTmp = " " & sTmp
        Else
            sTmp = sTmp & " "
