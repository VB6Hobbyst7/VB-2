...
Private Sub cmdConfirm_Click()
    ...
    Else
        ...
        Call WritePrivateProfileString("config", "ServerIP", txtServerIP.Text, App.Path & "\Interface.ini")
        Call WritePrivateProfileString("config", "ServerPort", txtServerPort.Text, App.Path & "\Interface.ini")
...
'        frmInterface.MSComm1.PortOpen = True
        ...
        frmInterface.Winsock1.Protocol = sckTCPProtocol
        frmInterface.Winsock1.RemoteHost = txtServerIP.Text
        frmInterface.Winsock1.RemotePort = txtServerPort.Text
        frmInterface.Winsock1.Connect
...
'    Combo_Port.ListIndex = 0
    ...
    txtServerIP.Text = gDRDB_Parm.ServerIP
    txtServerPort.Text = gDRDB_Parm.ServerPort
