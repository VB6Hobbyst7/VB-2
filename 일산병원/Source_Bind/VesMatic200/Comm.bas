...
'VesMatic 20============================
Public giExamCnt As Integer    '검사갯수
Public giCR As Integer         'CR 이후 Count
Public gsData As String        '결과데이타
Public gsDateTime As String    '마지막결과시간

Public gsBuff As String
Public gsBuffCnt As Integer
Public gsDataCnt As Integer
Public gsBuffB()
Public gsDataB()
'=======================================
