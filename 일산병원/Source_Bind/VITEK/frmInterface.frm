...
Begin VB.Form frmInterface 
   ...
   Begin VB.Frame FrmHideControl 
      ...
      Begin VB.Frame Frame4 
         ...
         Begin FPSpread.vaSpread vasPrint 
            ...
            EndProperty
            MaxCols         =   9
            SpreadDesigner  =   "frmInterface.frx":44C1
         End
         Begin FPSpread.vaSpread vasPrintBuf 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            SpreadDesigner  =   "frmInterface.frx":5F69
         End
      End
      Begin FPSpread.vaSpread vasTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":61B0
      End
      Begin FPSpread.vaSpread vasCode 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":AE2D
      End
      ...
      Begin FPSpread.vaSpread vasTemp1 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":B074
      End
      Begin FPSpread.vaSpread vasList 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":B2BB
      End
      Begin FPSpread.vaSpread vasResTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":B502
      End
      Begin FPSpread.vaSpread spdResult2 
         ...
         SpreadDesigner  =   "frmInterface.frx":B749
         UserResize      =   0
      End
   ...
   Begin TabDlg.SSTab stInterface 
      ...
      EndProperty
      TabCaption(0)   =   "진행상태"
      TabPicture(0)   =   "frmInterface.frx":BC8F
      Tab(0).ControlEnabled=   -1  'True
      Tab(0).Control(0)=   "Frame1"
      Tab(0).Control(0).Enabled=   0   'False
      Tab(0).ControlCount=   1
      TabCaption(1)   =   "결과확인"
      TabPicture(1)   =   "frmInterface.frx":BCAB
      ...
      Begin VB.Frame Frame3 
         ...
         Begin FPSpread.vaSpread vasRID 
            ...
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":BCC7
            UserResize      =   2
         End
         Begin FPSpread.vaSpread vasRRes 
            ...
            MaxCols         =   7
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":C76A
         End
      End
      Begin VB.Frame Frame1 
         ...
         Begin FPSpread.vaSpread spdResult3 
            ...
            MaxRows         =   25
            ScrollBars      =   0
            SpreadDesigner  =   "frmInterface.frx":10534
            UserResize      =   2
         End
         ...
         Begin FPSpread.vaSpread vasResult 
            ...
            MoveActiveOnFocus=   0   'False
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":10B48
            UserResize      =   2
         End
         ...
         Begin FPSpread.vaSpread vasID 
            ...
            MoveActiveOnFocus=   0   'False
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":116CA
            UserResize      =   2
         End
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin VB.PictureBox picLogin 
         ...
         Height          =   285
         Left            =   4785
         Picture         =   "frmInterface.frx":121FF
         ScaleHeight     =   255
         ScaleWidth      =   255
         TabIndex        =   3
         Top             =   195
...
'                SetText vasResult, strSpcmNo, .MaxRows, 3             '3 바코드번호
        ...
        Else
            '-- 검체번호 가져오기
                  SQL = "SELECT DISTINCT SPCM_NO, EXMN_CD  FROM SPSLHRRST"
...
'            SQL = SQL & "    AND SUBSTR(WORK_NO,15,4) = '" & Mid(Trim(strSpcmNo), 12, 4) & "'"
            ...
            '-- 병록번호 가져오기
                  SQL = "SELECT DISTINCT PID  FROM SPSLHRRST"
            SQL = SQL & "  Where SPCM_NO = '" & Trim(mResult.BarNo) & "'"
            
            Set rs1 = cn_Ser.Execute(SQL, , 1)

            Do Until rs1.EOF
                mResult.PatNo = Trim(rs1.Fields(0))
                rs1.MoveNext
            Loop
            Set rs1 = Nothing
            End If
...
'Exit Sub
    ...
    Open App.Path & "\log\1115.log" For Input As #3
    ...
    With vasID
        For intCnt = 1 To .DataRowCnt
            ...
            If .Value = "1" Then
                ...
                strOrdDate = Mid(GetText(vasID, intCnt, 2), 1, 8)
                strOrdDate = Format(strOrdDate, "##/##/##")
                
                '## 2.오더문자열 전송
                            strOutput = rs & "mtmpr" & FS
                strOutput = strOutput & "pi" & GetText(vasID, intCnt, 7) & FS
                strOutput = strOutput & "pnInterface" & FS
                strOutput = strOutput & "pb" & FS
                strOutput = strOutput & "psa" & FS
                strOutput = strOutput & "pa" & strOrdDate & FS
                strOutput = strOutput & "po" & FS   '6자리번호 ??
                strOutput = strOutput & "pl" & FS   '병동
                strOutput = strOutput & "px" & FS   '과
                strOutput = strOutput & "si" & FS
                strOutput = strOutput & "ss" & FS   '검체
                strOutput = strOutput & "s1" & Format(Now, "yymmdd") & FS
                strOutput = strOutput & "s2" & Format(Now, "hh:mm") & FS
                ...
                strOutput = strOutput & "ci" & GetText(vasID, intCnt, 2) & FS
...
'                For intOrdCnt = intCnt + 1 To .DataRowCnt
'                    .Col = 1
'                    .Row = intOrdCnt
'                    If .Value = "1" Then
'                        intSndPhase = 1
...
'                strState = "M"
'
'                strDrug = Trim(UCase(ReplaceVal(mGetP(strRcvBuf, 3, ","))))     '항생제코드
'                strIntBase = strDrug
'                strSensi = Trim(ReplaceVal(mGetP(strRcvBuf, 8, ",")))           '감수성결과
'                strResult = strSensi
'                strVol = Trim(ReplaceVal(mGetP(strRcvBuf, 5, ",")))             '투여량
'
'                'If strSensi <> "" Then
'                    If UCase(strSensi) = "ESBL" And UCase(strESBLVal) = "POS" Then
'                        strSensi = "R"
...
'''                        For i = 1 To .DataRowCnt
'''                            .Row = i: .Col = 1
'''                            strState = ""   '-- 체크된 항목이 없으면 보낼 오더도 없다.
'''                            If .Value = "1" Then
'''                                ' <STX>P,"L","10881529","20110808L4B0039",,,,,,,"GIM",,,"MICU",,,,,,,,,,,<CR><LF><ETX>
'''                                             strSndData = STX & "P,"
'''                                strSndData = strSndData & """" & "L" & ""","  '-- 환자번호
'''                                strSndData = strSndData & """" & GetText(vasID, 1, 5) & ""","  '-- 환자번호
'''                                strSndData = strSndData & """" & GetText(vasID, 1, 2) & """,,,,,,,"  '-- 검체번호
'''                                strSndData = strSndData & """" & "GIM" & """,,,,,,,,,,,,,,"
'''                                strSndData = strSndData & vbCr & vbLf & ETX
'''
'''                                MSComm1.Output = strSndData
'''                                Save_Raw_Data "[Tx]" & strSndData
'''                                strState = "Q"
'''                                intSndPhase = 2
'''                                Exit For
'''                            End If
...
'    SQL = SQL & "  AND BARCODE   = '" & Trim(GetText(vasResult, asRow1, colBarcode)) & "' " & vbCrLf
    ...
    SQL = SQL & "(EQUIPNO, BARCODE, DISKNO,   POSNO,    PID,     PNAME,       PSEX,   PAGE,      EXAMDATE, EQUIPCODE, EXAMCODE, " & vbCrLf & _
                " SEQNO,   RESULT,  EXAMNAME, SENDFLAG, REFFLAG, EQUIPRESULT, RECENO, SAMPLESEQ, isocd, isonm, antcnt, antcd, antsize, antrslt,exmncd) " & vbCrLf
    SQL = SQL & "VALUES("
    SQL = SQL & "'" & gEquip & "', "
...
Private Sub vasResult_Click(ByVal Col As Long, ByVal Row As Long)
    ...
    '장비코드, 검사코드, 검사명, 결과, 순번
          SQL = "SELECT EQUIPCODE, EXAMCODE, EXAMNAME, RESULT, SEQNO, SENDFLAG,'',isocd, isonm, antcnt, antcd, antsize, antrslt, exmncd " & vbCrLf
...
'    SQL = SQL & "  AND BARCODE = '" & lsID & "' " & vbCrLf
    ...
    SQL = SQL & "GROUP BY SEQNO, EQUIPCODE, EXAMCODE, EXAMNAME, RESULT, SENDFLAG,isocd, isonm, antcnt, antcd, antsize, antrslt, exmncd "
