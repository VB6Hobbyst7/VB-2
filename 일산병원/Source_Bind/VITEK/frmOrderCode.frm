...
Begin VB.Form frmOrderCode 
   ...
   Begin FPSpread.vaSpread vasSlip 
      ...
      RetainSelBlock  =   0   'False
      ScrollBars      =   2
      SpreadDesigner  =   "frmOrderCode.frx":08EF
   End
   Begin FPSpread.vaSpread vasAnti 
      ...
      RetainSelBlock  =   0   'False
      ScrollBars      =   2
      SpreadDesigner  =   "frmOrderCode.frx":0FB3
   End
   Begin FPSpread.vaSpread vasOrg 
      ...
      RetainSelBlock  =   0   'False
      ScrollBars      =   2
      SpreadDesigner  =   "frmOrderCode.frx":188E
   End
   ...
   Begin FPSpread.vaSpread vasList 
      ...
      SpreadDesigner  =   "frmOrderCode.frx":4795
   End
