...
strBuffer = strBuffer & "4R|1|^^^420^^0|-1^0.114|COI|^|N||F|||20110715150046|20110715151905|" & vbCrLf
...
strBuffer = strBuffer & "3O|1|11200167811|629^00016^4^^SAMPLE^NORMAL|ALL|R|20111104131938|||||X||||||||||||||O|||||39" & vbCrLf
strBuffer = strBuffer & "4R|1|^^^321^^0|1.80|ng/ml|0.000^4.00|N||F|||20111104132338|20111104134158|73" & vbCrLf
strBuffer = strBuffer & "5R|2|^^^391^^0|0.487|ng/ml|^|N||F|||20111104132420|20111104134240|F6" & vbCrLf
strBuffer = strBuffer & "6L|13F" & vbCrLf
strBuffer = strBuffer & "" & vbCrLf
...
strBuffer = strBuffer & "1H|\^&||||||||||P||05" & vbCrLf
strBuffer = strBuffer & "2P|1|||||||||||||||||||||||||||||||||3B" & vbCrLf
strBuffer = strBuffer & "3O|1|9905300221|622^00021^1^^SAMPLE^NORMAL|ALL|R|20111107085518|||||X||||||||||||||O|||||03" & vbCrLf
strBuffer = strBuffer & "4R|1|^^^420^^0|1^3.39|COI|^|N||F|||20111107085553|20111107091413|5E" & vbCrLf
strBuffer = strBuffer & "5L|13E" & vbCrLf
strBuffer = strBuffer & "" & vbCrLf

strBuffer = ""
strBuffer = strBuffer & "1H|\^&||||||||||P||05" & vbCrLf
strBuffer = strBuffer & "2P|1|||||||||||||||||||||||||||||||||3B" & vbCrLf
strBuffer = strBuffer & "3O|1|9905300521|2^00017^1^^SAMPLE^NORMAL|ALL|R|20111108172429|||||X||||||||||||||O|||||A2" & vbCrLf
strBuffer = strBuffer & "4R|1|^^^430^^0||COI|^|A||X|||20111108172504|20111108173818|0D" & vbCrLf
strBuffer = strBuffer & "5C|1|I|3^STOP Cancel|I78" & vbCrLf
strBuffer = strBuffer & "6L|13F" & vbCrLf
strBuffer = strBuffer & "" & vbCrLf
...
strBuffer = strBuffer & "1H|\^&||||||||||P||05" & vbCrLf
strBuffer = strBuffer & "2P|1|||||||||||||||||||||||||||||||||3B" & vbCrLf
strBuffer = strBuffer & "3O|1|11213648911|318^00020^5^^SAMPLE^NORMAL|ALL|R|20111114102618|||||X||||||||||||||O|||||FB" & vbCrLf
strBuffer = strBuffer & "4R|1|^^^560^^0||COI|^|A||X|||00000000000000|20111114102958|EA" & vbCrLf
strBuffer = strBuffer & "5C|1|I|8^Assay Reagent Short|IE8" & vbCrLf
strBuffer = strBuffer & "6L|13F" & vbCrLf
strBuffer = strBuffer & "" & vbCrLf


strBuffer = ""
strBuffer = strBuffer & "1H|\^&||||||||||P|1BA" & vbCrLf
strBuffer = strBuffer & "2P|13F" & vbCrLf
strBuffer = strBuffer & "3O|1|9905300211|313^@14^1^^SAMPLE^NORMAL|ALL|R||||||C||||||||||||||Q6A" & vbCrLf
strBuffer = strBuffer & "4L|13D" & vbCrLf
strBuffer = strBuffer & "" & vbCrLf

strBuffer = ""
strBuffer = strBuffer & "1H|\^&||||||||||P||05" & vbCrLf
strBuffer = strBuffer & "2Q|1|^9905300111^313^@14^1^^SAMPLE^NORMAL||ALL||||||||A36" & vbCrLf
strBuffer = strBuffer & "3L|13C" & vbCrLf
strBuffer = strBuffer & "" & vbCrLf

'strBuffer = ""
'strBuffer = strBuffer & "1H|\^&||||||||||P||05" & vbCrLf
'strBuffer = strBuffer & "2Q|1|^9905300521^313^@14^1^^SAMPLE^NORMAL||ALL||||||||A36" & vbCrLf
'strBuffer = strBuffer & "3L|13C" & vbCrLf
'strBuffer = strBuffer & "" & vbCrLf
...
strBuffer = strBuffer & "1H|\^&||||||||||P||05" & vbCrLf
strBuffer = strBuffer & "2P|1|||||||||||||||||||||||||||||||||3B" & vbCrLf
strBuffer = strBuffer & "3O|1|1221845431|956^00016^1^^SAMPLE^NORMAL|ALL|R|20120103094335|||||X||||||||||||||O|||||0A" & vbCrLf
strBuffer = strBuffer & "4R|1|^^^420^^0|-1^0.171|COI|^|N||F|||20120103094410|20120103100230|99" & vbCrLf
strBuffer = strBuffer & "5R|2|^^^810^^0||U/ml|7.00^17.00|A||X|||00000000000000|20120103100230|12" & vbCrLf
strBuffer = strBuffer & "6C|1|I|8^AssayReagentShort|IE9" & vbCrLf
        ...
        Select Case strType
            ...
            Case "R"    '## Result
                ...
                Case "420"  'HCV
                    ...
                    If strResult <> "" Then
                        If (CCur(strResult) >= "0" And CCur(strResult) <= "0.999") Then
                            strResult = "Negative(" & strResult & ")"
                        ElseIf (CCur(strResult) >= "1.000" And CCur(strResult) <= "1.100") Then
                            'strResult = "Boderline(" & strResult & ")"
                            strResult = "Equivocal(" & strResult & ")"
                        ElseIf CCur(strResult) >= "1.101" Then
                ...
                Case "440"  'HBeAg
                    ...
                    strQCResult = strResult
                    If strResult <> "" Then
                        If (CCur(strResult) >= "0" And CCur(strResult) <= "5.000") Then
                            strResult = "Negative(" & strResult & ")"
                        ElseIf CCur(strResult) >= "5.001" Then
                            strResult = "Positive(" & strResult & ")"
                        End If
                    End If
                Case "430"  'Anti-Hbe
                    ...
                    strQCResult = strResult
                    If strResult <> "" Then
                        If CCur(strResult) < "0.800" Then
                            strResult = "Positive(" & strResult & ")"
                        Else 'If ccur(strResult) >= "0.800" Then
                            strResult = "Negative(" & strResult & ")"
                        End If
                    End If
                Case "560", "880" 'HIV
...
'                    If (ccur(strResult) > "200") Then
'                        strResult = ">200"
'                    End If
                
                    If InStr(1, strTemp2, ">") > 0 Then
                        strResult = Replace(strTemp2, ">", "")
                    ElseIf InStr(1, strTemp2, "<") > 0 Then
                        strResult = Replace(strTemp2, "<", "")
                    Else
                        strResult = strTemp2
                    End If
                    ...
                    If strResult <> "" Then
                        If (CCur(strResult) > "200") Then
                            strResult = "Positive(>200)"
                        ElseIf (CCur(strResult) <= "7.00") Then
                            strResult = "Negative(<7.00)"
                        ElseIf (CCur(strResult) <= "16.99") Then
                            strResult = "Negative(" & strResult & ")"
                        Else 'If ccur(strResult) >= "0.800" Then
                            strResult = "Positive(" & strResult & ")"
                        End If
                ...
                If strResult <> "" Then
                    ...
                    If res > 0 Then
                        ...
                        If blnPSA = True And blnfPSA = True And strPSA <> "" And strfPSA <> "" And IsNumeric(strfPSA) And IsNumeric(strfPSA) Then
'                        If blnPSA = True And blnfPSA = True And strPSA <> "" And strfPSA <> "" Then 'And IsNumeric(strfPSA) And IsNumeric(strfPSA) Then
                            strIntBase = "990"
                            strResult = Round((strfPSA / strPSA) * 100, 1)
                            strQCResult = strResult
                            ...
                            '소수점 처리, 결과 형태 처리
                            If Mid(mResult.BarNo, 1, 2) = "99" Then
                                lsEquipRes = strQCResult
                                strQCResult = SetResult(strQCResult, strIntBase)
                                lsResult_Buff = strQCResult
                            Else
                                lsEquipRes = strResult
                                strResult = SetResult(strResult, strIntBase)
                                lsResult_Buff = strResult
...
'                            lsResult_Buff = strResult
                    ...
                    Else
                        ...
                        If res > 0 Then
                            ...
                            If Mid(mResult.BarNo, 1, 2) = "99" Then
                                ...
                                strQCResult = SetResult(strQCResult, strIntBase)
                                lsResult_Buff = strQCResult
                                SetText vasID, strQCResult, gRow, colA1c                   '결과
                            Else
                                lsEquipRes = strResult
                                strResult = SetResult(strResult, strIntBase)
                                lsResult_Buff = strResult
            ...
            Case "L"    '## Terminator
                '## DB에 결과저장"
                '2012.01.09 수정 3개중 한개의 결과가 없더라도 저장하러간다.
'                If strState = "R" And strResult <> "" Then
                If strState = "R" Then
                    gOrderExam = ""
                    If MnTransAuto.Checked = True Then
                        If Mid(mResult.BarNo, 1, 2) = "99" Then
