...
'    '-- QC바코드 관련
'    db_tmp = ""
'    Call GetPrivateProfileString("QCBARCODE", "basic1", "", db_tmp, 100, App.Path & "\Interface.ini")
'    frmInterface.txtTemp = Trim(db_tmp)
'    gQCCode.Basic1 = Trim(frmInterface.txtTemp)
'
'    db_tmp = ""
'    Call GetPrivateProfileString("QCBARCODE", "basic2", "", db_tmp, 100, App.Path & "\Interface.ini")
'    frmInterface.txtTemp = Trim(db_tmp)
'    gQCCode.Basic2 = Trim(frmInterface.txtTemp)
'
'    db_tmp = ""
'    Call GetPrivateProfileString("QCBARCODE", "basic3", "", db_tmp, 100, App.Path & "\Interface.ini")
'    frmInterface.txtTemp = Trim(db_tmp)
'    gQCCode.Basic3 = Trim(frmInterface.txtTemp)
'
'    db_tmp = ""
'    Call GetPrivateProfileString("QCBARCODE", "basic4", "", db_tmp, 100, App.Path & "\Interface.ini")
'    frmInterface.txtTemp = Trim(db_tmp)
'    gQCCode.Basic4 = Trim(frmInterface.txtTemp)
'
'    db_tmp = ""
'    Call GetPrivateProfileString("QCBARCODE", "basic5", "", db_tmp, 100, App.Path & "\Interface.ini")
'    frmInterface.txtTemp = Trim(db_tmp)
'    gQCCode.Basic5 = Trim(frmInterface.txtTemp)
'
'    db_tmp = ""
'    Call GetPrivateProfileString("QCBARCODE", "flex1", "", db_tmp, 100, App.Path & "\Interface.ini")
'    frmInterface.txtTemp = Trim(db_tmp)
'    gQCCode.Flex1 = Trim(frmInterface.txtTemp)
'
'    db_tmp = ""
'    Call GetPrivateProfileString("QCBARCODE", "flex2", "", db_tmp, 100, App.Path & "\Interface.ini")
'    frmInterface.txtTemp = Trim(db_tmp)
'    gQCCode.Flex2 = Trim(frmInterface.txtTemp)
'
'    db_tmp = ""
'    Call GetPrivateProfileString("QCBARCODE", "flex3", "", db_tmp, 100, App.Path & "\Interface.ini")
'    frmInterface.txtTemp = Trim(db_tmp)
'    gQCCode.Flex3 = Trim(frmInterface.txtTemp)
'
'    db_tmp = ""
'    Call GetPrivateProfileString("QCBARCODE", "flex4", "", db_tmp, 100, App.Path & "\Interface.ini")
'    frmInterface.txtTemp = Trim(db_tmp)
'    gQCCode.Flex4 = Trim(frmInterface.txtTemp)
'
'    db_tmp = ""
'    Call GetPrivateProfileString("QCBARCODE", "flex5", "", db_tmp, 100, App.Path & "\Interface.ini")
'    frmInterface.txtTemp = Trim(db_tmp)
'    gQCCode.Flex5 = Trim(frmInterface.txtTemp)
'
'    GetSetup = True
'
'End Function
...
'    gQCEquip = Trim(frmlogin.txtTemp)
    ...
    Call GetPrivateProfileString("QCBARCODE", "basic1", "", db_tmp, 100, App.Path & "\Interface.ini")
    frmLogin.txtTemp = Trim(db_tmp)
    gQCCode.Basic1 = Trim(frmLogin.txtTemp)
    
    db_tmp = ""
    Call GetPrivateProfileString("QCBARCODE", "basic2", "", db_tmp, 100, App.Path & "\Interface.ini")
    frmLogin.txtTemp = Trim(db_tmp)
    gQCCode.Basic2 = Trim(frmLogin.txtTemp)
    
    db_tmp = ""
    Call GetPrivateProfileString("QCBARCODE", "basic3", "", db_tmp, 100, App.Path & "\Interface.ini")
    frmLogin.txtTemp = Trim(db_tmp)
    gQCCode.Basic3 = Trim(frmLogin.txtTemp)
    
    db_tmp = ""
    Call GetPrivateProfileString("QCBARCODE", "basic4", "", db_tmp, 100, App.Path & "\Interface.ini")
    frmLogin.txtTemp = Trim(db_tmp)
    gQCCode.Basic4 = Trim(frmLogin.txtTemp)
    
    db_tmp = ""
    Call GetPrivateProfileString("QCBARCODE", "basic5", "", db_tmp, 100, App.Path & "\Interface.ini")
    frmLogin.txtTemp = Trim(db_tmp)
    gQCCode.Basic5 = Trim(frmLogin.txtTemp)
    
    db_tmp = ""
    Call GetPrivateProfileString("QCBARCODE", "flex1", "", db_tmp, 100, App.Path & "\Interface.ini")
    frmLogin.txtTemp = Trim(db_tmp)
    gQCCode.Flex1 = Trim(frmLogin.txtTemp)
    
    db_tmp = ""
    Call GetPrivateProfileString("QCBARCODE", "flex2", "", db_tmp, 100, App.Path & "\Interface.ini")
    frmLogin.txtTemp = Trim(db_tmp)
    gQCCode.Flex2 = Trim(frmLogin.txtTemp)
    
    db_tmp = ""
    Call GetPrivateProfileString("QCBARCODE", "flex3", "", db_tmp, 100, App.Path & "\Interface.ini")
    frmLogin.txtTemp = Trim(db_tmp)
    gQCCode.Flex3 = Trim(frmLogin.txtTemp)
    
    db_tmp = ""
    Call GetPrivateProfileString("QCBARCODE", "flex4", "", db_tmp, 100, App.Path & "\Interface.ini")
    frmLogin.txtTemp = Trim(db_tmp)
    gQCCode.Flex4 = Trim(frmLogin.txtTemp)

    db_tmp = ""
    Call GetPrivateProfileString("QCBARCODE", "flex5", "", db_tmp, 100, App.Path & "\Interface.ini")
    frmLogin.txtTemp = Trim(db_tmp)
    gQCCode.Flex5 = Trim(frmLogin.txtTemp)
    ...
    db_tmp = ""
    Call GetPrivateProfileString("SERVER", "HL7Path", "", db_tmp, 100, App.Path & "\Interface.ini")
    frmLogin.txtTemp = Trim(db_tmp)
    gHL7Path = Trim(frmLogin.txtTemp)
