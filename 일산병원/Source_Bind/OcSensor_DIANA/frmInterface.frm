...
strBuffer = "N   2011/07/2713:1801101000011     1572400020                  6 -   "
    
strBuffer = "A   2011/08/0916:0708101000011     1585400010                    + 05"
...
Private Sub EditRcvData()
    ...
    'R   2011/07/0615:5800903000801     1115778381                  5 -   
    'N   2011/07/2713:1801101000011     1572400020                  6 -   
    'A   2011/08/0916:0708101000011     1585400010                    + 05
    
    strBarno = Trim$(Mid$(strRcvBuf, 36, 15))
    mResult.BarNo = strBarno
    strIntBase = "OB"
    strResult = Trim$(Mid$(strRcvBuf, 60, 5))
    strValue = Trim$(Mid$(strRcvBuf, 66, 1))
    
'    If strBarno = "1223502641" Then
'        blnDebug = True
'    End If
'
'    If blnDebug = True Then
'        MsgBox "1:" & strResult & ":" & strBarno
'    End If
...
'    End If
    ...
    If IsNumeric(strResult) Then
        Select Case CInt(strResult)
            Case Is < 50:   strResult = "<50 ng/mL (Negative)"
            Case Is > 100:  strResult = strResult & " ng/mL (Positive)"
            Case Is > 1000: strResult = ">1000 ng/mL (Positive)"
            Case Else:      strResult = strResult & " ng/mL (Negative)"
        End Select
    Else
        If Trim(strValue) = "+" Then
            strResult = ">1000 ng/mL (Positive)"
        Else
            Exit Sub
        End If
    End If
...
'    res = db_select_Col(gLocal, SQL)
    If Trim(GetText(vasID, asRow1, colBarcode)) = "" Then
        Exit Function
    End If
