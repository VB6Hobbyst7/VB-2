...
Begin VB.Form frmInterface 
   BorderStyle     =   0  '없음
   Caption         =   " Sysmex CA1500 Interface "
   ClientHeight    =   10680
   ClientLeft      =   330
   ClientTop       =   825
   ClientWidth     =   15165
...
'    Open App.Path & "\log\long.log" For Input As #3
    ...
    strBuffer = "D1210101U111121095300002205     1120475571B               041   98 042 1206 044   92 046  219 047   49 051  278 056  336 057   49 R221010"
...
Private Sub EditRcvData()
    ...
    Select Case strType
        ...
        Case "D"    '## Result
            ...
            '-- 2012.06.18 바코드 자리수 체크
            If Len(mResult.BarNo) < 10 Then
                '## ACK 전송
                MSComm1.Output = ACK
                Save_Raw_Data "[Tx]" & ACK
