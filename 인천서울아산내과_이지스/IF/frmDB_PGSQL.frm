...
Private Sub cmdSave_Click()
    ...
    Else
        ...
        Call SaveString(HKEY_CURRENT_USER, REG_MACH & "\" & "DATABASE", "PGSQLIP", txtIP.Text)
        Call SaveString(HKEY_CURRENT_USER, REG_MACH & "\" & "DATABASE", "PGSQLDB", txtDB.Text)
        Call SaveString(HKEY_CURRENT_USER, REG_MACH & "\" & "DATABASE", "PGSQLUID", txtUID.Text)
        Call SaveString(HKEY_CURRENT_USER, REG_MACH & "\" & "DATABASE", "PGSQLPWD", txtPWD.Text)
