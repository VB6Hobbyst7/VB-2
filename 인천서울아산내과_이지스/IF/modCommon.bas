...
Public Sub GetRegSetup()
    ...
    'gEMR = Trim(strSetUp1)             '-- OCS/EMR
    'gDBTYPE = Trim(strSetUp1)          '-- DB TYPE GET
    
    'gUrinMic.WBCM = GetString(HKEY_CURRENT_USER, REG_MACH & "\" & "URINEMICRO", "COLWIDTH")
    'gUrinMic.RBCM = GetString(HKEY_CURRENT_USER, REG_MACH & "\" & "URINEMICRO", "COLWIDTH")
    'gUrinMic.EPIC = GetString(HKEY_CURRENT_USER, REG_MACH & "\" & "URINEMICRO", "COLWIDTH")
    'gUrinMic.BACT = GetString(HKEY_CURRENT_USER, REG_MACH & "\" & "URINEMICRO", "COLWIDTH")
