   ...
   Begin VB.PictureBox picHeader 
      ...
      Begin HSCotrol.CButton cmdClear 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "MDIIF.frx":456B
         MaskColor       =   0
         PicCapAlign     =   2
         BorderStyle     =   1
         BorderColor     =   4210752
         HoverColor      =   16711680
         HoverPicture    =   "MDIIF.frx":5245
      End
      Begin HSCotrol.CButton cmdSave 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "MDIIF.frx":62CC
         MaskColor       =   0
         PicCapAlign     =   2
         BorderStyle     =   1
         BorderColor     =   4210752
         HoverColor      =   16711680
         HoverPicture    =   "MDIIF.frx":6BA6
      End
      Begin HSCotrol.CButton cmdView 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "MDIIF.frx":7480
         MaskColor       =   0
         PicCapAlign     =   2
         BorderStyle     =   1
         BorderColor     =   4210752
         HoverColor      =   16711680
         HoverPicture    =   "MDIIF.frx":8107
      End
   ...
   Begin MSComctlLib.ImageList imlSubList 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "MDIIF.frx":A968
            Key             =   "LIS1101"
            Object.Tag             =   "Menu"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "MDIIF.frx":B9BA
            Key             =   "LIS1102"
            Object.Tag             =   "SubMenus"
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "MDIIF.frx":CA0C
            Key             =   "LIS1104"
            Object.Tag             =   "SubMenus"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "MDIIF.frx":DA5E
            Key             =   "LIS1103"
            Object.Tag             =   "SubMenu"
         EndProperty
      EndProperty
    ...
    If MsgBox("선택한 결과를 전송하시겠습니까?", vbYesNo + vbCritical, "결과전송") = vbYes Then
        With frmInterface.spdOrder
            For lRow = 1 To .DataRowCnt
                ...
                .Col = colCHECKBOX
                If .Value = 1 Then
                    Res = SaveTransData(lRow, frmInterface.spdOrder)
                    
                    If Res = -1 Then
                        SetForeColor frmInterface.spdOrder, lRow, lRow, 1, colSTATE, 255, 0, 0
                        SetText frmInterface.spdOrder, "저장실패", lRow, colSTATE
                    
                              SQL = " UPDATE PATRESULT SET " & vbCrLf
                        SQL = SQL & "     SENDFLAG  = '1' " & vbCrLf
                        SQL = SQL & "   , SENDDATE  = '" & Format(Now, "yyyy-mm-dd") & "' " & vbCrLf
                        SQL = SQL & " WHERE EQUIPNO = '" & gHOSP.MACHCD & "' " & vbCrLf
                        SQL = SQL & "   AND BARCODE = '" & Trim(GetText(frmInterface.spdOrder, lRow, colBARCODE)) & "' "
                    ...
                    Else
                        SetBackColor frmInterface.spdOrder, lRow, lRow, 1, colSTATE, 202, 255, 112
                        SetText frmInterface.spdOrder, "저장완료", lRow, colSTATE
                    ...
                    End If
                    frmInterface.spdOrder.Row = lRow
                    frmInterface.spdOrder.Col = colCHECKBOX
                    frmInterface.spdOrder.Value = 0
                End If
...
Private Sub cmdTestNmSave_Click()
    ...
    If txtTestNm.Text <> "" Then
        ...
        Call SaveString(HKEY_CURRENT_USER, REG_MACH & "\" & "HOSP", "USERID", txtTestNm.Text)
