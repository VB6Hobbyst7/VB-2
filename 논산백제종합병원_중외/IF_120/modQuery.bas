        ...
        Do Until RS.EOF
            With SPD
                ...
                If blnSame = False Then
                    ...
                    If Trim(RS.Fields("GUBUN")) & "" = "L-5372" Then
                        SetText SPD, "FOOD", intRow, colRACKNO
                    ElseIf Trim(RS.Fields("GUBUN")) & "" = "L-5371" Then
...
'            SQL = SQL & "   AND i.IntLabCod IN (" & gAllTestCd & ")" & vbCr
        ...
        Case "JWINFO"
            ...
            If strGubun = "FOOD" Then
                SQL = SQL & "   AND ORDERCODE = 'L-5372'  " & vbCr
            ElseIf strGubun = "INHALANT" Then
                SQL = SQL & "   AND ORDERCODE = 'L-5371'  " & vbCr
            Else
...
On Error GoTo DBErr
    ...
    If mResult.MnmCd = "FD" Then
        SQL = SQL & "   AND a.ORDERCODE = 'L-5372'" & vbCr
    ElseIf mResult.MnmCd = "IN" Then
        SQL = SQL & "   AND a.ORDERCODE = 'L-5371'" & vbCr
