...
Begin VB.Form frmInterface 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin FPSpread.vaSpread vasRes 
         ...
         RetainSelBlock  =   0   'False
         ScrollBars      =   2
         SpreadDesigner  =   "frmInterface.frx":212C
      End
   ...
   Begin VB.Frame FrmHideControl 
      ...
      Begin VB.Frame Frame5 
         ...
         Begin VB.ComboBox cboChk 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmInterface.frx":382B
            Left            =   2460
         ...
         Begin VB.ComboBox cboTest 
            ...
            ForeColor       =   &H00FF0000&
            Height          =   300
            ItemData        =   "frmInterface.frx":3850
            Left            =   600
            List            =   "frmInterface.frx":3852
            Style           =   2  '드롭다운 목록
            TabIndex        =   68
            Top             =   1650
            Visible         =   0   'False
      ...
      Begin VB.Frame Frame4 
         ...
         Begin FPSpread.vaSpread vasPrint 
            ...
            EndProperty
            MaxCols         =   9
            SpreadDesigner  =   "frmInterface.frx":3854
         End
         Begin FPSpread.vaSpread vasPrintBuf 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            SpreadDesigner  =   "frmInterface.frx":52CD
         End
      End
      ...
      Begin FPSpread.vaSpread vasCode 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":54E5
      End
         ...
         Begin MSComctlLib.ImageList imlStatus 
            ...
            BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
               ...
               BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":5E9F
                  Key             =   "RUN"
               EndProperty
               BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":6439
                  Key             =   "NOT"
               EndProperty
               BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":69D3
                  Key             =   "STOP"
               EndProperty
               BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":6F6D
                  Key             =   "LST"
               EndProperty
               BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":77FF
                  Key             =   "ITM"
               EndProperty
               BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":7959
                  Key             =   "ERR"
               EndProperty
               BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":7AB3
                  Key             =   "NOF"
               EndProperty
            EndProperty
         End
      ...
      Begin FPSpread.vaSpread vasList 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":7C0D
      End
      Begin FPSpread.vaSpread vasResTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":7E25
      End
      Begin FPSpread.vaSpread vasTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":803D
      End
      Begin FPSpread.vaSpread vasExcel 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":8255
      End
...
'    SQL = SQL & vbCrLf & "   AND JSTATUS < '3'" & vbLf
          ...
          SQL = "SELECT DISTINCT a.RECEIPTDATE as 접수일자, a.RECEIPTTIME,a.SPECIMENNUM as 바코드번호, a.RECEIPTNO as 챠트번호, a.IPDOPD, a.PTNO as 내원번호, a.SNAME as 이름, a.LABCODE as ITEM, a.ORDERCODE"
...
'    SQL = SQL & vbCrLf & "   AND a.LABCODE IN (" & gAllExam & ") " & vbLf
    SQL = SQL & vbCrLf & "   AND b.LABCODE IN (" & gAllExam_JW & ") "
    SQL = SQL & vbCrLf & "   AND a.JSTATUS < '3'"
    If chkSaveAll.Value = "0" Then
        SQL = SQL & vbCrLf & "   AND (b.RESULT = '" & Space(50) & "' OR b.RESULT IS NULL) "
    End If
...
Function GetExamCode_JW() As Integer
    Dim i, j As Long
    ...
    SQL = "Select equipcode, examcode, examname, resprec, seqno " & vbCrLf & _
          ...
          "   and not equipcode in ('97','98','99') " & vbCrLf & _
          " Order by  seqno * 10 "
    ...
    For i = 1 To vasCode.DataRowCnt
        If i = 1 Then
            gAllExam_JW = "'" & Trim(GetText(vasCode, i, 2)) & "'"
        Else
            gAllExam_JW = gAllExam_JW & ",'" & Trim(GetText(vasCode, i, 2)) & "'"
        End If
...
'''    strItems = GetEquipExamCode_H7020(gEquip, pBarNo, intRow)
'''
'''    '-- 검사채널로 장비오더 만들기
...
Function GetEquipExamCode_H7020(argEquipCode As String, argPID As String, Optional intRow As Long) As String
    Dim i As Integer
    Dim strExamCode As String
    Dim sBarcode     As String
    
    GetEquipExamCode_H7020 = ""
    ...
    GetEquipExamCode_H7020 = Mid(strExamCode, 2)
    ...
    If KeyAscii = 13 Then
        With vasID
            For intRow = .ActiveRow To .DataRowCnt
                SetText vasID, txtNum, intRow, colPOSNO
    ...
    ElseIf KeyCode = vbKeyReturn Then
        ...
        ElseIf iCol = colPOSNO Then
            ...
            For intRow = vasID.ActiveRow + 1 To vasID.DataRowCnt
                ...
                lngNum = lngNum + 1
                Call vasID.SetText(colPOSNO, intRow, lngNum)
