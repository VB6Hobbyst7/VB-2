...
Private Sub PhaseCfg_Protocol()
    ...
    Select Case UCase(m_EqName)
        Case "EVOLIS", "ETIMAX3000"
            If m_bUseBarcode = True Then
                Call PhaseCfg_Protocol_Evolis
            Else
                Call PhaseCfg_Protocol_Evolis_NoBarcode
            End If
...
End Sub
Private Sub PhaseCfg_Protocol_Evolis_NoBarcode()
    ...
    For ix1 = 1 To Len(wkBuf)
        ...
        Select Case m_iPhase
            ...
            Case 3
                Select Case Asc(wkDat)
                    Case 6      'ACK
                        Call SendOrder_Evolis_NoBarcode
...
ErrRtn:
    ...
    End If
End Sub
Private Sub PhaseCfg_Protocol_Evolis()
    On Error GoTo ErrRtn
    ...
    For ix1 = 1 To Len(wkBuf)
        ...
        Select Case m_iPhase
            ...
            Case 3
                Select Case Asc(wkDat)
                    Case 6      'ACK
                        If sState = "Q" Then    'Or m_p_sRerunGbn = "R" Then
...
' *               Data편집 & 응답처리                   *
' *=====================================================*
Private Sub DataEditResponse_Evolis()
    On Error GoTo ErrRtn
    ...
    Select Case RecType
        ...
        Case "P"        'Patient Record
            ...
            tmpOther1 = Trim(tmpField(2))
            tmpBarCd = Trim(tmpField(3))
            
            pSampleInfo.ID = UCase(tmpBarCd)
            pSampleInfo.OTHER = UCase(tmpOther1)
...
Private Sub SendOrder_Evolis_NoBarcode()
    ...
    Select Case m_iSendPhase
        Case 1
            ...
            'Patient Record                 '바코드 안쓰는 경우 사용...
            sSendBuff = sSendBuff & "P|1|" & pSampleInfo.CMT1 & "|" & pSampleInfo.ID & vbCr
                                
            'Order Record
            sSendBuff = sSendBuff & "O|1|||"
            ...
            If pSampleInfo.ORDCNT = 0 Then
                sSendBuff = sSendBuff & "^^^NOTEST"
            End If
            

            sSendBuff = sSendBuff & "||" & Format(Now, "YYYYMMDD") & "|||||||||S||||||||||X" & vbCr
...
Private Sub SendOrder_Evolis()
    ...
    Select Case m_iSendPhase
        Case 1
            ...
            'Patient Record
            sSendBuff = sSendBuff & "P|1|" & pSampleInfo.ID & "|" & pSampleInfo.ID & vbCr
