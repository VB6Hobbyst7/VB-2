...
' *               Data편집 & 응답처리                   *
' *=====================================================*
Private Sub DataEditResponse_Immulite2000_영동세브란스()
'
...
'                End If
'            Next i
'            If Trim(Trim(TempTBL(0))) <> "" Then    'BarCode ID가 잘 넘어왔는지 검사
'                State = "Q"
...
'
''            'SCL의 경우 원하는 HCG 단위가 장비에 존재하지 않아 단위변경 처리 추가...2001/5/7 YK
...
Private Sub SendOrder_Immulite2000_영동세브란스()
'
'    Dim Tmp   As String
'    Dim ChkS  As String
'    Dim TestDat As String
...
''                pnlComm.Caption = "인터페이스 오더 항목이 존재하지 않습니다!!"
'                '2001-05-21 KHS modified : Order없어도 O,L 패킷 주어야함
'                'Exit Sub
'            End If
'
'            For i = 1 To gOrderTable.iOrdCnt
'                'HCG(Triple Mark?)일경우 20배희석을 해준다.
'                If TestDat = "" Then
