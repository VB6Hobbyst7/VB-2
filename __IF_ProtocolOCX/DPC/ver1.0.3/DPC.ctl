...
'이벤트 선언:
Event AppendData(sID$, sSeq$, sRack$, sPos$, iRstCnt%, sTIFCd$, sTRst1$, sTRst2$, sTUnit$, sTFlag$, sTRstDT$)
    ...
    Select Case RecType
        ...
        Case "R"        'Result Record
            ...
            With pResultInfo
                ...
                .RSTDT = tmpRstDT & Chr(124)    '결과일시(2005/12/6)
            End With
...
Private Sub SendOrder_DPC1000()
    ...
    Select Case m_iSendPhase
        ...
        Case 2      'Patient Record
            ...
            '2003/8/22 바코드 정보외에 병록번호 등의 다른 정보를 전송할 수 있도록 수정
...
Private Sub PhaseCfg_Protocol()
    ...
    Select Case UCase(m_EqName)
        Case "DPC2000", "DPC2500"
            If m_bUseBarcode = True Then
                Call PhaseCfg_Protocol_DPC2000          '바코드 사용
            Else
        ...
        Select Case m_iPhase
            ...
            Case 2      '<LF> 대기
                Select Case Asc(wkDat)
                    ...
                    Case 10     '<LF>
                        Call DataEditResponse_DPC1000       'Data 편집
