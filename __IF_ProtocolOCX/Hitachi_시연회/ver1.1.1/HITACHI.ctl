    ...
    For ix1 = 1 To Len(wkBuf)
        ...
        Select Case m_iPhase
            ...
            Case 3
                Select Case Asc(wkDat)
                    Case 6      'ACK
                        If m_sState = "Q" Or m_sState = "R" Then
...
'    m_sRerun = PropBag.ReadProperty("sRerun", m_def_sRerun)
    m_sState = PropBag.ReadProperty("sState", m_def_sState)
End Sub
...
'    Call PropBag.WriteProperty("sRerun", m_sRerun, m_def_sRerun)
    Call PropBag.WriteProperty("sState", m_sState, m_def_sState)
End Sub
...
'    m_sRerun = m_def_sRerun
    m_sState = m_def_sState
End Sub
...
''경고! 주석으로 되어 있는 다음 줄은 제거하거나 수정하지 마십시오!
''MemberInfo=13,0,0,0
'Public Property Get sRerun() As String
'    sRerun = m_sRerun
'End Property
'
'Public Property Let sRerun(ByVal New_sRerun As String)
'    m_sRerun = New_sRerun
'    PropertyChanged "sRerun"
'End Property
'
'경고! 주석으로 되어 있는 다음 줄은 제거하거나 수정하지 마십시오!
'MemberInfo=13,0,0,0
...
Public Property Let sState(ByVal New_sState As String)
    m_sState = New_sState
    PropertyChanged "sState"
End Property
