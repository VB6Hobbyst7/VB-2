...
Public Function RcvRstData(sDBPath$) As Variant
    ...
    '결과조회
    Call GetResultData_AlloScan(sDBPath)
    
End Function

Private Sub GetResultData_AlloScan(ByVal sPath As String)
...
Public Function SendWorkList(sDBPath$, sWorkList$) As Variant
    ...
    With ADOCN
        ...
        .ConnectionString = fGetCurConn(sDBPath)
        .Open
    End With
...
Private Function fGetCurConn(ByVal sPath As String) As String

    fGetCurConn = "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=" & sPath & ";User ID=admin;Jet OLEDB:Database Password=reader_admin;"
...
Private Sub GetPanelCodeINFO(ByVal sTmpPath As String)
    ...
    tmpADORS.Open tmpStr, fGetCurConn(sTmpPath), adOpenForwardOnly
