...
Private Sub PhaseCfg_Protocol_AM4290()
...
Private Sub DataEdit_UriScan_AM4290()
    ...
    Dim sFlag       As String
    Dim sKind       As String
    Dim sRstDate    As String
    Dim iPos        As Integer

    Dim aRowData()  As String
    Dim aField() As String
    
    'D2010-06-08,T03:43,N10002,Temp30 10EA
    'GLU , 4, 1000, mg / dl, H
    'PRO ,+-    ,10   ,mg/dl ,
    'BIL ,-     ,     ,mg/dl ,
    'URO ,NORMAL,     ,mg/dl ,
    ...
    aRowData = Split(RcvBuffer, vbCrLf)
    
    For ii = 0 To UBound(aRowData) - 1
        aField = Split(aRowData(ii), ",")
        
        If ii = 0 Then
            sRstDate = Trim(Mid(aField(0), 2, Len(aField(0)) - 1)) & " " & Trim(Mid(aField(1), 2, Len(aField(1)) - 1))
            tmpSeqNo = Trim(Mid(aField(2), 2, Len(aField(2)) - 1))
