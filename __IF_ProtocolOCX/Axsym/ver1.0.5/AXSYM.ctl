        ...
        Select Case m_iPhase
            ...
            Case 2      '<LF> 대기
                Select Case Asc(wkDat)
                    ...
                    Case 10     '<LF>
                        If UCase(m_EqName) = "AXSYM_MULTI" Then
...
Private Sub DataEditResponse_AxSym_Multi()
    ...
    Select Case RecType
        ...
        Case "O"        'Order Record
            ...
            tmpKind = Trim(tmpField(11))    'QC 구분...2005/8/1 yk
        ...
        Case "R"        'Result Record
            ...
            Select Case sResType
                ...
                Case "F"
                    ...
                    'Date/Time Test Complete(14자리)
                    tmpData() = Split(Trim(tmpField(12)), Chr(13))
