...
Private Sub PhaseCfg_Protocol_AxSym()
        ...
        Select Case m_iPhase
            ...
            Case 2      '<LF> 대기
                Select Case Asc(wkDat)
                    ...
                    Case 10     '<LF>
                        Call DataEditResponse_AxSym     'Data 편집
...
' *               Data편집 & 응답처리                   *
' *=====================================================*
Private Sub DataEditResponse_AxSym()
    ...
    Select Case RecType
        ...
        Case "R"        'Result Record
            ...
            sResType = Trim(tmpData(7))
            
            '결과타입에 따라 결과표시 변경...
            If sResType = "P" Then
                Exit Sub
            ElseIf sResType = "F" Then
                tmpRst = sResData
                If Left$(tmpRst, 1) = "." Then
                    tmpRst = "0" & tmpRst
                End If
            ElseIf sResType = "I" Then
'                Select Case UCase(Left(sResData, 3))
'                    Case "NON", "NEG"
'                        tmpRst = "Negative"
'                    Case Else
'                        tmpRst = "Positive"
...
Private Sub SendOrder_AxSym()
    ...
    Select Case m_iSendPhase
        ...
        Case 3      'Order Record
            ...
            Else
                'Order 없는 경우...(2002/9/30 yk)
                sTmp = m_iFrameN & "O|1|" & Trim(pSampleInfo.ID) & "||" & TestDat & "|R||||||C||||||||||||||Q" & Chr(13) & Chr(3)
            End If
            m_iSendPhase = 4
