...
Private Sub DataEditResponse_Elecsys1010()
    ...
    Select Case RecType
        ...
        Case "R"        'Result Record
            ...
            '단위가 'COI'인 경우 결과 편집
'            If tmpUnit = "COI" Then
            If tmpUnit = "COI" Or InStr(tmpRst, "^") > 0 Then   '2006/5/16 yk
                i = InStr(tmpRst, "^")
                If i <> 0 Then
...
'
'   ELECSYS1010 바코드 사용 안하는 버전
'
Private Sub PhaseCfg_Protocol_Elecsys1010()
...
Private Sub DataEditResponse_Elecsys2010()
    ...
    Select Case RecType
        ...
        Case "R"        'Result Record
            ...
            tmpFlag = Trim(tmpData(6))
            If tmpFlag = "N" Then       '2006/8/16 yk
                tmpFlag = ""
            End If
            ...
            With pResultInfo
                ...
                .ALARMCD = Replace(.ALARMCD, "####", "")        '2007/6/26 yk
