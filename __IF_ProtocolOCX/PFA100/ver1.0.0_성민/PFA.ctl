...
'        tmpRst = Trim(Mid(RcvBuffer, 11, 6))
'        tmpRst = Replace(tmpRst, "SEC", "")
'        tmpRst = Replace(tmpRst, "A", "")
'        tmpRst = Replace(tmpRst, " ", "")
'        tmpRst = Trim(tmpRst)
        '<S--- 결과자릿수관련 오류 수정...2008/8/29 yk
        tmpRst = Trim(Mid(RcvBuffer, 11))   ', 6))
        tmpRst = Replace(tmpRst, "SEC", "")
        tmpRst = Replace(tmpRst, "A", "")
        tmpRst = Replace(tmpRst, vbCr, "")
        tmpRst = Replace(tmpRst, vbLf, "")
        tmpRst = Trim(tmpRst)
        'E>----------------------------
        
        tmpFlag = Trim(Mid(RcvBuffer, 17, 1))
