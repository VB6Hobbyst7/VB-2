...
Private Sub Timer1_Timer()
    ...
    If FSO.FolderExists(sUplFilePath) Then
        For Each objFile In FSO.GetFolder(sUplFilePath).Files
            If Right(objFile.Name, 3) = "que" Then
                sRtnVal = ""
                    ...
                    Select Case sRecType
                        ...
                        Case "Q"
                            ...
                            If m_p_iOrdCnt > 0 Then
                                ...
                                sOrderFile = sOrderFile & "P|" & CStr(iPatientCnt) & "|||||||||||||||||||||||||||||||||" & vbCrLf
    ...
    On Error GoTo ErrRtn
        ...
        If FSO.FolderExists(sRstFilePath) Then
            For Each objFile In FSO.GetFolder(sRstFilePath).Files
                ...
                If Right(objFile.Name, 3) = "upl" Then
                    ...
                    For i = 0 To UBound(sOneRow) - 1
                        ...
                        Select Case sRecType
                            ...
                            Case "M"
                                If tmpBarcd <> "" And tmpIFCd <> "" And tmpRst <> "" Then
                                    '결과값 등록/화면 표시 처리...
                                    With pResultInfo
                                        If .RSTCNT > 0 Then
...
'경고! 주석으로 되어 있는 다음 줄은 제거하거나 수정하지 마십시오!
'MemberInfo=14
Public Function Start_Timer() As Variant
    Timer1.Enabled = True
End Function
