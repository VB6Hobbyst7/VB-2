...
'            tmpBarCd = Trim(tmpField(2))
            ...
            If tmpSpcDesc = "I" Or tmpSpcDesc = "Q" Then
                tmpKind = "QC"
                                
                sLotNo = Trim(Split(tmpField(15), "^")(1))
                sCtrl_Cmt = Trim(Split(tmpField(15), "^")(2))
                sLevel = Trim(Split(tmpField(15), "^")(3))

                pSampleInfo.ID = sLotNo + sLevel
            Else
