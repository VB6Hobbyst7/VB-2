...
Private Sub DataEditResponse_XEAlpha()
    ...
    Dim i%, iRealCnt%, ix1%
    Dim sRxData$, sBarCd$, sSeqNo$, sRack$, sPos$, sRstDT$, sErrCd$
    Dim sBC$, sLC$
    Dim s_aResult$(32)
    ...
    Select Case sBC
        Case "D1"
            ...
            'Error(Func./Result) 추가...2006/1/30 yk
            sErrCd = ""
            tmpErrCd = Trim(Mid(sRxData, 93, 1))
            If tmpErrCd = "1" Then
                sErrCd = "F"
            End If
            tmpErrCd = Trim(Mid(sRxData, 94, 1))
            If tmpErrCd = "1" Then
                sErrCd = sErrCd & "R"
            End If
...
'            sTRst2 = sTRst2 & msFlagTot2
            ...
            With pResultInfo
                ...
                .POS = pSampleInfo.POS
                .ALARMCD = pSampleInfo.CMT1     'Error(Func./Result)
