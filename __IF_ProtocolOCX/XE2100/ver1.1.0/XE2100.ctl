...
Private Sub PhaseCfg_Protocol_XE2100_Old()      'Sleep 적용 전...2007/5/9 yk
'
'    Dim wkDat   As String
'    Dim ix1     As Integer
'
...
Send_Terminate:
        ...
        Case 8      'EOT
            ...
            Else
                ...
                If bTransBCErr <> True Then
                    RaiseEvent SendOrderOK("", "", "", "")
                Else
                    '오더 없어도 인터페이스 화면에 Row 추가...2007/9/16 yk
                    RaiseEvent SendOrderOK(pSampleInfo.ID, "", pSampleInfo.RACK, pSampleInfo.POS)
                End If
...
Private Sub UserControl_ReadProperties(PropBag As PropertyBag)
    ...
    m_bTransBCErr = PropBag.ReadProperty("bTransBCErr", m_def_bTransBCErr)
End Sub
...
Private Sub UserControl_WriteProperties(PropBag As PropertyBag)
    ...
    Call PropBag.WriteProperty("bTransBCErr", m_bTransBCErr, m_def_bTransBCErr)
End Sub
...
Private Sub UserControl_InitProperties()
    ...
    m_bTransBCErr = m_def_bTransBCErr
End Sub
...
'경고! 주석으로 되어 있는 다음 줄은 제거하거나 수정하지 마십시오!
'MemberInfo=0,0,0,0
Public Property Get bTransBCErr() As Boolean
    bTransBCErr = m_bTransBCErr
End Property

Public Property Let bTransBCErr(ByVal New_bTransBCErr As Boolean)
    m_bTransBCErr = New_bTransBCErr
    PropertyChanged "bTransBCErr"
End Property
