...
Dim msResultDateTime As String
...
Private Sub PhaseCfg_Protocol()
    ...
    Select Case UCase(m_EqName)
        Case "TENDEMMASS"
            Call PhaseCfg_Protocol_TENDEMMASS
...
Public Sub PhaseCfg_Protocol_TENDEMMASS()
...
''            Case 10     '<LF>
''                If bEndChk = True Then
''                    Call DataEditResponse_TENDEMMASS
''                    RcvBuffer = ""
''                End If
''                msComm.Output = Chr(6)
''
...
' *               Data편집 & 응답처리                   *
' *=====================================================*
Public Sub DataEditResponse_TENDEMMASS(ByVal sFileName As String)
    On Error GoTo ErrRtn
    ...
    Dim tmpIFCd$, tmpRst$, tmpRst2$, tmpUnit$, tmpFlag$, tmpAlarmCd$, tmpInstID$
...
''        Name    Sample Text Type    Std. Conc   RT  Area    IS Area Response    Detection Flags ng/mL   %Dev    Acq.Date    Acq.Time    S/N
''    1   110315_1    CALB    Blank               376.622                 15-Mar-11   10:51:26
''    2   110315_2    CAL1    Standard    1.1 0.97    101.395 489.302 0.207   bb  1   -12.6   15-Mar-11   10:57:08    26.674
''    3   110315_3    CAL2    Standard    3.2 0.96    289.279 457.843 0.632   bb  3.3 2.4 15-Mar-11   11:00:11    504.868
''    4   110315_4    CAL3    Standard    6.7 0.96    612.33  451.944 1.355   bb  7.2 7.8 15-Mar-11   11:03:16    246.964
''    5   110315_5    CAL4    Standard    13.6    0.96    1202.255    443.397 2.711   bb  14.6    7.5 15-Mar-11   11:06:20    1145.147
''    6   110315_6    CAL5    Standard    23  0.96    2048.102    492.037 4.162   bb  22.5    -2.1    15-Mar-11   11:09:24    1000.038
''    7   110315_7    CAL6    Standard    33.6    0.97    2885.522    480.182 6.009   bb  32.6    -3  15-Mar-11   11:12:28    1980.59
''    8   110315_8    CON1    QC  2.3 0.96    189.177 459.656 0.412   bb  2.1 -9.8    15-Mar-11   11:15:32    199.276
''    9   110315_9    CON2    QC  9.1 0.96    758.745 478.813 1.585   bb  8.5 -6.9    15-Mar-11   11:18:36    834.614
''    10  110315_10   CON3    QC  24.5    0.96    2061.338    479.75  4.297   bb  23.3    -5.1    15-Mar-11   11:21:40    2202.132
''    11  110315_11   12264004170 Analyte     0.96    63.196  394.778 0.16    bb  0.7     15-Mar-11   11:24:44    39.628
''    12  110315_12   12264000100 Analyte             439.614                 15-Mar-11   11:27:48
''    13  110315_13   12264001100 Analyte             388.699                 15-Mar-11   11:30:52
    ...
    Do While Not EOF(iFile)
        ...
        Select Case Asc(wkDat)
            Case 13     'CR
                tmpData = Split(RcvBuffer & vbTab, vbTab)
                
                tmpData(0) = Trim(tmpData(0))
                
                If tmpData(0) <> "" Then
                    If tmpData(0) = "Quantify Compound Summary Report" Then
                    
                    ElseIf UCase(Left(tmpData(0), 7)) = "PRINTED" Then
                        ''tmpRstDT = tmpData(0)
                        
                    ElseIf UCase(Left(tmpData(0), 8)) = "COMPOUND" Then
                        ''tmpIFCd = UCase(Trim(Mid(tmpData(0), InStr(tmpData(0), ":") + 1)))
                        tmpIFCd = Trim(Mid(tmpData(0), InStr(tmpData(0), ":") + 1))
                    
                    Else
                        tmpBarCd = Trim(tmpData(2))
                        tmpSeqNo = Trim(tmpData(1))
                        tmpRst = Trim(tmpData(10))   'ng/mL
                        tmpRst2 = ""
                        
                        'QC 결과는 구분해서 저장
                        If UCase(Trim(tmpData(3))) = "QC" Then
                            tmpKind = "Q"
                        ElseIf UCase(Trim(tmpData(3))) = "STANDARD" Then
                            tmpKind = "C"
                        ElseIf UCase(Trim(tmpData(3))) = "BLANK" Then
                            tmpKind = "B"
                        Else
                            tmpKind = ""
                        End If
                        
                        tmpRstDT = Trim(tmpData(12)) & " " & Trim(tmpData(13))
