...
Private Sub DataEdit_NovaStatProfileM()
    ...
    Select Case sRecType
        ...
        Case "O"
            ...
            'Opertor ID 추가...2006/2/9 yk
            tmpOPID = Trim(tmpField(13))
'            If tmpOPID <> "" Then
'                pSampleInfo.OTHER = pSampleInfo.OTHER & "^" & tmpOPID
'            End If
...
'            'Opertor ID 추가...2006/1/9 yk
'            tmpOPID = ""
'            If InStr(Trim(tmpField(10)), "^") > 0 Then
'                tmpData() = Split(tmpField(10), "^")
'                tmpOPID = Trim(tmpData(0))
'                If tmpOPID = "novaservice" Or tmpOPID = "" Then
'                    tmpOPID = ""
'                End If
'            End If
            ...
            With pResultInfo
                ...
                .OTHER = pSampleInfo.OTHER      '건대병원 POCT 적용...2005/12/8 yk
                
                '2006/1/16 yk...잠시 보류...
'                If .RSTCNT = 0 And tmpOPID <> "" Then
'                    .OTHER = pSampleInfo.OTHER & "^" & tmpOPID
'                Else
