...
Private Sub PhaseCfg_Protocol()
    ...
    Select Case UCase(m_EqName)
        Case "EASYA1C"
                Call PhaseCfg_Protocol_EasyA1C
...
Private Sub PhaseCfg_Protocol_EasyA1C()
...
' *               Data편집 & 응답처리                   *
' *=====================================================*
Private Sub DataEditResponse_EasyA1C()
    On Error GoTo ErrRtn
...
'    SH003
'    100312084805500000000000000
'    100501124005000000000000000
'    100507110906300000000000000
    ...
    If RecType = "SH" Then
        ...
        Exit Sub
    Else
        tmpRstDT = "20" & Mid$(RcvBuffer, 1, 10)
        pSampleInfo.RSTDT = tmpRstDT
    End If
    
    tmpIFCd = "HBA1C"
    tmpRst = CStr(Val(Mid$(RcvBuffer, 11, 3)))
...
'   환자 Order 전송
'
Public Sub RcvResult(ByVal sBuf As String)
    On Error GoTo Err_Rtn
