...
End Sub
Private Sub SendOrder_Hitachi7080_Old(ByVal sFunc As String, ByVal sSeqNo As String)
'    Serum Index 적용전...2007/11/22 yk
'    On Error GoTo ErrRtn
'
...
Private Sub SendOrder_Hitachi7080(ByVal sFunc As String, ByVal sSeqNo As String)
    ...
    '<S--- Serum Index...2007/11/22 yk
    If pSampleInfo.SINDEX = True Then
        Mid$(sTestDat, 48, 1) = "1"
    End If
    '>E---------------
