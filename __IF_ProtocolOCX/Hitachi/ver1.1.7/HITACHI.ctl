...
Private Sub SendOrder_Hitachi7180(ByVal sFunc As String, ByVal sSeqNo As String)
    ...
    sSendBuff = sSendBuff & " 88"
    sSendBuff = sSendBuff & Mid(sTestDat, 1, 88)
    sSendBuff = sSendBuff & "100000"
    sSendBuff = sSendBuff & Left(pSampleInfo.CMT1 & Space(30), 30)
...
Private Sub Send_MOR()
    ...
    If m_sTestMode = 77 Then
        RaiseEvent PrintSendLog(Chr(2) & ">" & Chr(3) & "3E" & vbCr)
    End If
End Sub
'
...
'    m_iStartSampleNo = PropBag.ReadProperty("iStartSampleNo", m_def_iStartSampleNo)
    m_p_sCmt = PropBag.ReadProperty("p_sCmt", m_def_p_sCmt)
End Sub
...
Private Sub UserControl_WriteProperties(PropBag As PropertyBag)
    ...
    Call PropBag.WriteProperty("p_sCmt", m_p_sCmt, m_def_p_sCmt)
...
Public Property Get p_sCmt() As String
    p_sCmt = m_p_sCmt
End Property

Public Property Let p_sCmt(ByVal New_p_sCmt As String)
    m_p_sCmt = New_p_sCmt
    PropertyChanged "p_sCmt"
End Property
