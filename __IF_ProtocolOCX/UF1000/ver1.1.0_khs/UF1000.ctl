...
Dim msUnit$, msFlag$, msReview$, msCMatch$, msRBCInfo$
        ...
        Case "D"
            Select Case sLC
                Case "S4401"    'Sample Information Block
                    ...
                    'FLAG
                    If Mid(RcvBuffer, 140, 1) = "+" Then
                        msCMatch = msCMatch & "/RBC"
                    End If
                    If Mid(RcvBuffer, 141, 1) = "+" Then
                        msCMatch = msCMatch & "/WBC"
                    End If
                    If Mid(RcvBuffer, 142, 1) = "+" Then
                        msCMatch = msCMatch & "/EC"
                    End If
                    If Mid(RcvBuffer, 143, 1) = "+" Then
                        msCMatch = msCMatch & "/CAST"
                    End If
                    If Mid(RcvBuffer, 144, 1) = "+" Then
                        msCMatch = msCMatch & "/BACT"
                    End If
                    If Mid(RcvBuffer, 145, 1) = "+" Then
                        msCMatch = msCMatch & "/Cond"
                    End If
                    
                    msReview = ""
                    
                    'ERROR
                    If Mid(RcvBuffer, 89, 1) = "1" Then
                        msReview = msReview & "ERROR"
                    End If
                    
                    'REVIEW
                    If Mid(RcvBuffer, 88, 1) = "1" Then
                        If msReview = "" Then
                            msReview = msReview & "REVIEW"
                        Else
                            msReview = msReview & "/REVIEW"
                        End If
                    End If
                    
                    msReview = msReview & msCMatch
                ...
                Case "C4403"    'Comment Block 1
                    ...
                    If IsNumeric(iCnt) Then
                        For ii = 1 To Val(iCnt)
                            ...
                            miRstCnt = miRstCnt + 1
                            msTotIFRstCd = msTotIFRstCd & sIFRstCd & "F" & Chr(124)
