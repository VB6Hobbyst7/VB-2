...
End Sub
Private Sub PhaseCfg_Protocol_BT2100()
        ...
        Select Case m_iPhase
            ...
            Case 4
                Select Case Asc(wkDat)
                    ...
                    Case 4      'EOT
                        If Len(RcvBuffer) > 21 Then
                            Call DataEditResponse_BT2100
                            RcvBuffer = ""
                            m_iPhase = 3
                        Else
...
' *               Data편집 & 응답처리                   *
' *=====================================================*
Private Sub DataEditResponse_BT2100()
    On Error GoTo ErrRtn
    ...
    With pResultInfo
        .ID = Trim(Mid(RcvBuffer, 1, 15))
        .RSTCNT = Val(Mid(RcvBuffer, 18, 3))
        
        For i = 1 To .RSTCNT
            tmpIFCd = Trim(Mid(RcvBuffer, 21 + (11 * (i - 1)), 4))
            tmpRst = Trim(Mid(RcvBuffer, 25 + (11 * (i - 1)), 7))
