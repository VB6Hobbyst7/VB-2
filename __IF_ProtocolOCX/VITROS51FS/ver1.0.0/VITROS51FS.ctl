...
Begin VB.UserControl VITROS51FS 
   ClientHeight    =   3150
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   3330
    ...
    Select Case UCase(m_EqName)
        Case "VITROS51FS"
            If m_bUseBarcode = True Then
                Call PhaseCfg_Protocol_VITROS51FS
            Else
                Call PhaseCfg_Protocol_VITROS51FS_Batch
            End If
...
End Sub
Private Sub PhaseCfg_Protocol_VITROS51FS_Batch()
        ...
        Select Case m_iPhase
            ...
            Case 2
                Select Case Asc(wkDat)
                    ...
                    Case 10     '<LF>
                        Call DataEditResponse_VITROS51FS
            ...
            Case 3
                Select Case Asc(wkDat)
                    Case 6      'ACK
                        Call SendOrder_VITROS51FS       'Order 전송
...
' *               Data편집 & 응답처리                   *
' *=====================================================*
Private Sub DataEditResponse_VITROS51FS()
...
ErrRtn:
    ...
    End If
End Sub
Private Sub PhaseCfg_Protocol_VITROS51FS()
...
Private Sub SendOrder_VITROS51FS()
    On Error GoTo ErrRtn
