...
Private Sub PhaseCfg_Protocol_TMETER()
    ...
    For ix1 = 1 To Len(wkBuf)
        ...
        Select Case m_iPhase
            ...
            Case 3
                Select Case Asc(wkDat)
                    Case 6      'ACK
                        Call RequestResult_TMETER       'Result 요청
...
ErrComm:
    ...
    End If
End Function
Private Sub RequestResult_TMETER()
    On Error GoTo ErrRtn
    ...
    Select Case m_iSendPhase
        ...
        Case 1      'H
            sTmp = m_iFrameN & "H|\^&|||1234567890|||||||P||" & Format(Now, "YYYYMMDDhhmmss") & Chr(13) & Chr(3)
            m_iSendPhase = 2

        Case 2      'Q
            sTmp = m_iFrameN & "Q|1|All||||" & Format(Now, "YYYYMMDDhhmmss") & "|" & Format(Now, "YYYYMMDDhhmmss") _
                            & "|||D||F" & vbCr & Chr(3)
            m_iSendPhase = 3
        ...
        Case 4      'EOT
            ...
            RaiseEvent DispMsg("RequestResult OK...")
...
ErrRtn:
    If Err <> 0 Then
        RaiseEvent DispMsg("RequestResult 에러 - " & Err.Description)
    End If
End Sub
