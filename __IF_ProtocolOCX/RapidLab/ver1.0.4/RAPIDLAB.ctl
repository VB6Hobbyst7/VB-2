...
Private Sub DispData_340(ByVal MsgBuf As String)
    ...
    MsgBuf = Mid(MsgBuf, 2, Len(MsgBuf) - 1)
    aData = Split(MsgBuf, FS)
    
    For i = 0 To UBound(aData) - 1
        aField = Split(aData(i), GS)
...
Public Sub SendMessage_340(ByVal MsgHead As String, Optional ByVal sSerialNo As String, Optional ByVal sID As String, _
                            Optional ByVal sHB As String, Optional ByVal sTemp As String)
    On Error GoTo SendMessage_Error
...
'                                            & FS & ETX
            ...
            Buffer = STX & "SMP_ORD" & FS & RS & "aMOD" & GS & "348" & GS & GS & GS _
                               & FS & "iIID" & GS & sSerialNo & GS & GS & GS _
                               & FS & "iPID" & GS & sID & GS & GS & GS _
                               & FS & "itHb" & GS & sHB & GS & "g/dL" & GS & GS _
                               & FS & "iTEMP" & GS & sTemp & GS & "C" & GS & GS _
                               & FS & RS & ETX
    ...
    If sTestMode = "77" Then
        RaiseEvent PrintSendLog(Buffer & Right("0" & Hex(chksum Mod 256), 2) & EOT)
    End If
