...
Dim msSndH  As String
Dim msSndP  As String
Dim msSndO  As String
Dim msSndL  As String
...
' *               Data편집 & 응답처리                   *
' *=====================================================*
Private Sub DataEditResponse_BIOLIS_()
    On Error GoTo ErrRtn
...
'            End If
        ...
        Case "C"        'Comment Record
            'Data Alarm 편집
            tmpData() = Split(msRcvBuffer, Chr(124))
