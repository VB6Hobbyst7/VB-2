...
ErrRtn:
    ...
    End If
End Sub
Private Sub PhaseCfg_Protocol_OmniC_old()
...
End Sub
Private Sub PhaseCfg_Protocol_OmniC()
...
Private Sub PhaseCfg_Protocol_D10()
...
Private Sub DataEdit_D10()
    ...
    Select Case sRecType
        ...
        Case "O"
            Erase tmpField()
            tmpField() = Split(RcvBuffer, Chr(124))
            pSampleInfo.ID = tmpField(2)
            tmpData() = Split(tmpField(3) & "----", "-")
            pSampleInfo.SEQNO = tmpData(1) & "-" & tmpData(2)
