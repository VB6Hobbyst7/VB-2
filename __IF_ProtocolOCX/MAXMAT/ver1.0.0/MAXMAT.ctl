    ...
    Select Case UCase(m_EqName)
        Case "MAXMAT"
            If m_bUseBarcode = True Then
                'Call PhaseCfg_Protocol_MAXMAT
            Else
                Call PhaseCfg_Protocol_MAXMAT_Batcd
            End If
...
End Sub
'
'   MAXMAT 바코드 사용 안하는 버전
'
Private Sub PhaseCfg_Protocol_MAXMAT_Batcd()
        ...
        Select Case m_iPhase
            ...
            Case 2
                Select Case Asc(wkDat)
                    ...
                    Case 10     '<LF>
                        Call DataEditResponse_MAXMAT_Batcd
            ...
            Case 3
                Select Case Asc(wkDat)
                    Case 6      'ACK
                        Call SendOrder_MAXMAT_Batcd      'Order 전송
...
' *               Data편집 & 응답처리                   *
' *=====================================================*
Private Sub DataEditResponse_MAXMAT_Batcd()
    ...
    Select Case RecType
        ...
        Case "R"        'Result Record
            '4R|1|^^^288025|167.6727019138|mg / dL|125 to 250|||||||20080312133748||
            '--- 결과데이타 편집
            'tmpData(2): TESTCD
            '    "  (3): RESULT
            '    "  (4): UNIT
...
Private Sub SendOrder_MAXMAT_Batcd()
    On Error GoTo ErrRtn
    ...
    Select Case m_iSendPhase
        ...
        Case 3      'O
            ...
            sTmp = m_iFrameN & "O|" & m_iOrdCount & "|" & Trim(pSampleInfo.ID) & "||^^^" & Trim(pSampleInfo.IFCD(m_iOrdCount)) & "|||||||||||" & Chr(13) & Chr(3)
                                   
            If m_iOrdCount < pSampleInfo.ORDCNT Then
                m_iSendPhase = 3
            Else
                m_iSendPhase = 4
            End If
            
            m_iOrdCount = m_iOrdCount + 1
        ...
        Case 5      'EOT
            ...
            m_iFrameN = 1: m_iSendPhase = 1: m_iOrdCount = 1
            sState = ""
