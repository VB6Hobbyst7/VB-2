...
End Sub
Private Sub PhaseCfg_Protocol_ACCESS2()
...
ErrRtn:
    ...
    End If
End Sub
Private Sub DataEditResponse_Access2()
    On Error GoTo ErrRtn
...
ErrRtn:
    ...
    End If
End Sub
Private Sub SendOrder_ACCESS2_Old()
'    On Error GoTo ErrRtn
'
'    Dim sTmp    As String
'    Dim ChkS    As String
...
'    Dim sSpcCd$
'
'    If m_iFrameN > 7 Then m_iFrameN = 0
'
'    Select Case m_iSendPhase
'        Case 1      'Header Record
'            sTmp = m_iFrameN & "H|\^&|||Host LIS|||||ACCESS||P|1" & Chr(13) & Chr(3)
...
'
'            'BarCode 사용모드
'            sTmp = m_iFrameN & "O|1|" & Trim(pSampleInfo.ID) & "||" & TestDat & "|R||||||N||||" & sSpcCd & Chr(13) & Chr(3)
'            m_iSendPhase = 4
'
'        Case 4      'Terminator Record
'            sTmp = m_iFrameN & "L|1" & Chr(13) & Chr(3)
...
Private Sub PhaseCfg_Protocol()
    ...
    Select Case UCase(m_EqName)
        ...
        Case "ACCESS2"
            '바코드 사용
            Call PhaseCfg_Protocol_ACCESS2
