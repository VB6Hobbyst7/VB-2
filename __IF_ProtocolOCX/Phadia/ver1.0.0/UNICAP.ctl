...
End Sub
Private Sub PhaseCfg_Protocol_UniCap()
    ...
    For ix1 = 1 To Len(wkBuf)
        ...
        Select Case m_iPhase
            ...
            Case 3
                Select Case Asc(wkDat)
                    Case 6      'ACK
                        Call SendOrder_UniCap   'Order 전송
...
' *               Data편집 & 응답처리                   *
' *=====================================================*
Private Sub DataEditResponse_UniCap()
...
''                & sActionCd & "||1||||||||||||" & sReportType & vbCr & Chr(3)

            '< pSampleInfo.RACK : Pre-Dilution
            sTmp = m_iFrameN & "O|1|" & Trim(pSampleInfo.ID) & "||" _
                & TestDat & "|||" & Format(Now, "YYYYMMDDHHNNSS") & "||||" _
