...
Private Sub PhaseCfg_Protocol()
    ...
    Select Case UCase(m_EqName)
        Case "PHOENIX"
            Call PhaseCfg_Protocol_PHOENIX
...
End Sub
Private Sub PhaseCfg_Protocol_PHOENIX()
...
Private Sub SendRstQuery()
    ...
    sSend = ""
    sSend = sSend & "1H|\^&" & vbCr
    sSend = sSend & "Q|1|||ALL|||" & vbCr
    sSend = sSend & "L|1|N" & vbCr & Chr(3)
                
    msComm.Output = Chr(2) & sSend & ChkSum_ASTM(sSend) & vbCrLf
...
' *               Data편집 & 응답처리                   *
' *=====================================================*
Private Sub DataEditResponse_PHOENIX()
            ...
            Select Case Mid(strRecord(intIdx), 1, 1)
                ...
                Case "P"        'Patient Record
                    ...
                    If UBound(strData1) >= 12 Then
                        ...
                        'f_subTestCode = Trim(strData1(12))          '-- 검사코드
                        f_subTestCode = f_subTestCode & Trim(strData1(12)) & Chr(124)
                        'f_typResultInfo.IFCD = Trim(strData1(12)) & Chr(124)          '-- 검사코드
                    Else
                        f_typSampleInfo.ID = ""
                        f_typResultInfo.ID = ""
                        f_subTestCode = f_subTestCode & "PHOENIX" & Chr(124)
                        'f_typResultInfo.IFCD = "" & Chr(124)
                    End If
                ...
                Case "O"
                    'O|1|2007120301^1^UNIORG||^^^NID^420070328931|R
                    f_strState = ""
                    strData1() = Split(strRecord(intIdx), "|")
                    ...
                    If UBound(strData1) > 6 Then
                        f_subStartDte = Trim(strData1(7))
                    End If
                    
                    If UBound(strData1) > 13 Then
                        strDate2 = Trim(strData1(14))
                    End If:
                    
                Case "R"
                    'R|1|^^^ID^420070328931|INST_IN_ATTN_IGNORED^UNIORG|||||F|||20071203101248|20071203112826\20071203112826|PHOENIX^^^1^B1
...
'                                                .POS = ""
                        ...
                        Case "GEN_MGIT"     '-- BACTEC MGIT 960 균동정
'                                            strData2 = Split(strData1(3), "^")
'
'                                            strRst1 = Trim(strData2(0))
'                                            strRst2 = ""
...
'                                            End If
    ...
    '                                                .POS =""
                        ...
                        Case "ID"           '-- 균이름
                                            strData2 = Split(strData1(3), "^")
                                            f_strOrganism = f_strOrganism & Trim(strData2(1)) & Chr(124)
                                            f_typResultInfo.IFCD = f_typResultInfo.IFCD & "PHOENIX" & Chr(124)
