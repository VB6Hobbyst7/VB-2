...
Private Sub PhaseCfg_Protocol_PROBETEC()
        ...
        Select Case m_iPhase
            ...
            Case 2
                Select Case Asc(wkDat)
                    ...
                    Case 10     '<LF>
                        If bEndChk = True Then
                            Call DataEditResponse_PROBETEC
                            RcvBuffer = ""
                        End If
                        msComm.Output = Chr(6)
...
' *               Data편집 & 응답처리                   *
' *=====================================================*
Private Sub DataEditResponse_PROBETEC()
...
'            pSampleInfo.SPCCD = Trim(tmpSampType)   'SAMPLE TYPE
        ...
        Case "R"        'Result Record
            ...
            If Len(tmpField(4)) = 3 Then
                tmpRack = Left(tmpField(4), 1)
                tmpPos = Mid(tmpField(4), 2, 1)
            ElseIf Len(tmpField(4)) = 4 Then
                tmpRack = Left(tmpField(4), 2)
                tmpPos = Mid(tmpField(4), 3, 1)
            End If
...
Private Sub PhaseCfg_Protocol()
    ...
    Select Case UCase(m_EqName)
        Case "PROBETEC"
            Call PhaseCfg_Protocol_PROBETEC
