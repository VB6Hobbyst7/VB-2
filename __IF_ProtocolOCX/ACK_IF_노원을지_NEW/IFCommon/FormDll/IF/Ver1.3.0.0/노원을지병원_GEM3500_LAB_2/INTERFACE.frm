...
Object = "{C18CEAD9-D3FD-405A-A3D5-D568D75420F8}#1.1#0"; "ACKGEM350110.ocx"
Begin VB.Form frmInterface 
   ...
   Begin VB.ListBox listNoOrd 
      ...
      BackColor       =   &H00E0E0E0&
      Height          =   2550
      ItemData        =   "INTERFACE.frx":2EAA
      Left            =   3030
      List            =   "INTERFACE.frx":2EAC
      TabIndex        =   25
      Top             =   6750
      Width           =   4965
   End
   ...
   Begin FPSpread.vaSpread spdRst2 
      ...
      ProcessTab      =   -1  'True
      ScrollBars      =   2
      SpreadDesigner  =   "INTERFACE.frx":2EAE
      UserResize      =   0
      VisibleCols     =   4
      VisibleRows     =   85
      TextTip         =   1
   ...
   Begin FPSpread.vaSpread spdRst 
      ...
      ProcessTab      =   -1  'True
      ScrollBars      =   0
      SpreadDesigner  =   "INTERFACE.frx":33D0
      UserResize      =   0
      VisibleCols     =   4
      VisibleRows     =   15
      TextTip         =   1
...
Private Sub GEM351_AppendData(sID As String, sSeq As String, sRack As String, sPos As String, iRstCnt As Integer, sTIFCd As String, sTRst1 As String, sTRst2 As String, sTUnit As String, sTFlag As String, sTRstDT As String, sTAlarmCd As String, sKind As String, sSpcDesc As String, sOperID As String, sTInstID As String, sTInstNm As String, sOther1 As String)
...
Private Sub GEM351_DispMsg(sMsg As String)
    ViewMsg sMsg
End Sub

Private Sub GEM351_PrintRcvLog(sLog As String)
    Print #1, sLog;
End Sub

Private Sub GEM351_PrintSendLog(sLog As String)
    Print #2, sLog;
End Sub

Private Sub GEM351_RaiseError(sError As String)
...
'    Call PortOpen
    ...
    If giTestMode = 77 Then
        GEM351.Visible = True
    Else
        GEM351.Visible = False: GEM351.TabStop = False
    End If
