Attribute VB_Name = "modDBregistry"
Option Explicit
...
'---------------------------------------------------------------
' 레지스트리 데이터 형식...
Public Const REG_SZ = 1                          ' Unicode null 종료 문자열
Public Const REG_EXPAND_SZ = 2                  ' Unicode null 종료 문자열
Public Const REG_DWORD = 4                      ' 32비트 숫자

' 레지스트리는 형식 값을 작성합니다...
Public Const REG_OPTION_NON_VOLATILE = 0       ' 시스템이 재부팅되어도 키는 보존됩니다.
