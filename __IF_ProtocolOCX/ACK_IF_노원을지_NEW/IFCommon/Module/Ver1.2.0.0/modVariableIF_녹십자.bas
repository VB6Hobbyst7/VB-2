...
'            '<S--- for 녹십자 Hiatchi7180
'            If Right(gsMachineCd, 3) = "004" Then
'                If ConvertIFItemInfo(11, sIFSeq) = "1" Then     'ifseq -> ifspccd
'                    Call frmInterface.SpecificProcessResult("", sCRst1, sCRst2, sIFSeq, "M")
'                End If
'            End If
'            '>E--------------------------
