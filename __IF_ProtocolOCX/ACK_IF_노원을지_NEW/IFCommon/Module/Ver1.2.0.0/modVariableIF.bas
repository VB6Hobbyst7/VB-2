Attribute VB_Name = "modVariableIF"
Option Explicit
...
Public Sub ClearAllList()
    ...
    With gfIFDisplayForm
        If MsgBox("Interface List를 삭제하면 해당 List의 결과를 받지 못합니다." & vbCrLf & vbCrLf & _
            ...
            "Interface List를 정말 삭제하시겠습니까?", vbQuestion + vbYesNo, "전체리스트 화면 삭제 확인") = vbYes Then
...
Public Function ChkCalResult(ByVal iCRow As Integer, iRstCnt As Integer, sIFRstCd As String, sRst1 As String, sRst2 As String, _
                            sIFSpcCd As String, sFlag As String) As String
        ...
        With .spdIntList
            ...
            For i = 1 To iRstCnt
                ...
                Else
                    ...
                    Call .SetText(16 + Val(vCRstCnt) + 1, .MaxRows, sCIFSeq & "|" & sCRst1 & "|" & sCRst2 & "|" & sCFlag & "|")
                End If
            Next
...
Public Function NewIFListBySex_Old(ByVal sWDate As String, ByVal sWSeq As String, _
                                ByVal sJDate As String, ByVal sJGbn As String, ByVal sJNo As String, _
                                ByVal sRack As String, ByVal sPos As String, _
                                ByVal sRegNo As String, ByVal sName As String, _
                                ByVal sSex As String, ByVal sEmer As String, ByVal sReRun As String, ByVal sOther As String, _
...
Public Function NewIFListBySex(ByVal sWDate As String, ByVal sWSeq As String, _
                                ...
                                ByVal sRegNo As String, ByVal sName As String, _
                                ByVal sSex As String, ByVal sEmer As String, ByVal sReRun As String, ByVal sOther As String, _
                                iRstCnt As Integer, sIFRstCd As String, sRst1 As String, sRst2 As String, _
                                ByVal sIFSpcCd As String, ByVal sCurRow As String) As String
    Dim i%
    Dim vWSeq, vCRstCnt, vSex
    Dim sCIFSeq$, sCIFRstCd$, sCRst1$, sCRst2$
    Dim sNRst1$, sNRst2$, sNRstCd$
        ...
        With .spdIntList
            ...
            For i = 1 To iRstCnt
                ...
                Else
                    ...
                    sNRstCd = sNRstCd & sCIFRstCd & Chr(124)    '2004/12/23 yk
                    sNRst1 = sNRst1 & sCRst1 & Chr(124)
                    sNRst2 = sNRst2 & sCRst2 & Chr(124)
                End If
            Next
...
Public Function OldIFList(ByVal iCRow%, ByVal iRstCnt%, _
    ...
    Dim sPIFSeq$, sPRst1$, sPRst2$, sPFlag$, sTIFRstCd$, sTRst1$, sTRst2$, sTFlag$
...
Public Function OldIFListBySex_Old(ByVal iCRow%, ByVal iRstCnt%, _
...
Public Function OldIFListBySex(ByVal iCRow%, iRstCnt%, _
            sIFRstCd$, sRst1$, sRst2$, ByVal sIFSpcCd$, _
            ByVal sRack$, ByVal sPos$, ByVal sRegNo$, ByVal sName$, _
            ByVal sSex$, ByVal sEmer$, ByVal sReRun$, ByVal sOther$) As String
    On Error GoTo ErrHandler
        ...
        With .spdIntList
            ...
            For i = 1 To iRstCnt
                ...
                Else
                    ...
                    sNRstCd = sNRstCd & sCIFRstCd & Chr(124)    '2004/12/27 yk
                    sNRst1 = sNRst1 & sCRst1 & Chr(124)
                    sNRst2 = sNRst2 & sCRst2 & Chr(124)
                End If
            Next
    ...
    'rstcd, rstcnt 변경...2004/12/27 yk
    Call gfIFDisplayForm.spdIntList.GetText(15, iCRow, vCRstCnt)
    iRstCnt = Val(vCRstCnt)
    sIFRstCd = sNRstCd
...
'APMode에 따른 결과 Display
    ...
    '2007/5/30 yk
    Call ViewMsgLog("ver : " & App.Major & "." & App.Minor & "." & App.Revision)
...
'        gfIFDisplayForm.lblCSelList = "결과조회 : " & CStr(vJDate) & CStr(vJGbn) & CStr(vJNo)
        gfIFDisplayForm.lblCSelList = "결과조회 : " & CStr(vJNo)
        ...
        For i = 1 To CInt(vIFCnt)
            ...
            If i > 15 Then
                ...
                If Trim(sCFlag) <> "" Then
                    Call SpdForeBack(gfIFDisplayForm.spdRst2, 1, 5, i - 15, i - 15, RGB(0, 0, 0), RGB(255, 200, 200))
                Else
                    Select Case sCRst2
                        Case "High", "Positive"
                            Call SpdForeBack(gfIFDisplayForm.spdRst2, 1, 5, i - 15, i - 15, RGB(0, 0, 0), RGB(255, 220, 220))
                        Case "Low"
                            Call SpdForeBack(gfIFDisplayForm.spdRst2, 1, 5, i - 15, i - 15, RGB(0, 0, 0), RGB(220, 220, 255))
                        Case "H", "P"
                            Call SpdForeBack(gfIFDisplayForm.spdRst2, 1, 5, i - 15, i - 15, RGB(0, 0, 0), RGB(255, 220, 220))
                        Case "L"
                            Call SpdForeBack(gfIFDisplayForm.spdRst2, 1, 5, i - 15, i - 15, RGB(0, 0, 0), RGB(220, 220, 255))
                        ...
                        Case Else
                            If sCRst2 <> "" Then
                                Call SpdForeBack(gfIFDisplayForm.spdRst2, 1, 5, i - 15, i - 15, RGB(0, 0, 0), RGB(230, 230, 230))
                            End If
                    End Select
                End If
            Else
                ...
                If Trim(sCFlag) <> "" Then
                    Call SpdForeBack(gfIFDisplayForm.spdRst, 1, 5, i, i, RGB(0, 0, 0), RGB(255, 200, 200))
                Else
                    Select Case sCRst2
                        Case "High", "Positive"
                            Call SpdForeBack(gfIFDisplayForm.spdRst, 1, 5, i, i, RGB(0, 0, 0), RGB(255, 220, 220))
                        Case "Low"
                            Call SpdForeBack(gfIFDisplayForm.spdRst, 1, 5, i, i, RGB(0, 0, 0), RGB(220, 220, 255))
                        Case "H", "P"
                            Call SpdForeBack(gfIFDisplayForm.spdRst, 1, 5, i, i, RGB(0, 0, 0), RGB(255, 220, 220))
                        Case "L"
                            Call SpdForeBack(gfIFDisplayForm.spdRst, 1, 5, i, i, RGB(0, 0, 0), RGB(220, 220, 255))
                        ...
                        Case Else
                            If sCRst2 <> "" Then
                                Call SpdForeBack(gfIFDisplayForm.spdRst, 1, 5, i, i, RGB(0, 0, 0), RGB(230, 230, 230))
                            End If
                    End Select
                End If
            End If
...
Public Sub GetTestItem_Flag()
    On Error GoTo ErrHandler
    
    Dim objDB As Object
    Dim sRetVal1$, sRetVal2$, sRetVal3$
    Dim iItemCnt%
...
'
'   검체구분 추가...(서버코드/검체코드 형식)
'
Public Function RegServerOK_Integra(ByVal iCRow%, ByVal iRstCnt%, ByVal sIFRstCd$, ByVal sRst1$, ByVal sRst2$) As String
    ...
    'QC 추가...2006/7/4 yk
    If Left(vJNo, 1) = "Q" Then
        'QC
        sRetVal = objRst.RegServerQC(1, Format(gfIFDisplayForm.dtpLabDate.Value, "YYYYMMDD"), CStr(vWSeq) & Chr(124), _
                                ...
                                CStr(iTRstCnt) & Chr(124), sTIFSeq & Chr(3), sTSvrCd & Chr(3), sTRst1 & Chr(3), sTRst2 & Chr(3))
    Else
        '일반샘플
...
End Function
Public Function RegServerOK(ByVal iCRow%, ByVal iRstCnt%, ByVal sIFRstCd$, ByVal sRst1$, ByVal sRst2$, ByVal sFlag$) As String

    Dim sBuf$, sCRst1$, sCRst2$, sCFlag$, sCRstCd$, sCSvrCd$, sTIFSeq$, sTSvrCd$, sTRst1$, sTRst2$, sTFlag$, sRetVal$, sTmp$, sIFSeq$
    Dim iTRstCnt%, i%, j%
    Dim vWSeq, vJDate, vJGbn, vJNo, vRack, vPos, vRegNo, vPtNm, vSex, vEmer, vRerun, vOther, vTmp, vIFItemCnt
    Dim objRst As Object
    ...
    sRetVal = objRst.RegServer(1, Format(gfIFDisplayForm.dtpLabDate.Value, "YYYYMMDD"), CStr(vWSeq) & Chr(124), _
                            ...
                            CStr(vRegNo) & Chr(124), CStr(vPtNm) & Chr(124), CStr(vSex) & Chr(124), _
                            CStr(vEmer) & Chr(124), CStr(vRerun) & Chr(124), CStr(vOther) & Chr(124), _
                            CStr(iTRstCnt) & Chr(124), sTIFSeq & Chr(3), sTSvrCd & Chr(3), sTRst1 & Chr(3), sTRst2 & Chr(3), sTFlag & Chr(3))
...
Public Sub DisplayOrderInfo(ByVal sWSeq$, ByVal sRow$, Optional ByVal sState$)
    On Error GoTo ErrHandler
...
'    End With
    ...
    With frmInterface.spdIntList
        ...
        '작업일련번호를 구함
        gOrderTable.sWSeq = sWSeq
        
        '해당바코드의 오더정보를 넘김
        gOrderTable.iCRow = Val(sRow)
...
'        Call .SetText(7, gOrderTable.iCRow, gOrderTable.sPos & "")
        ...
        Call .SetText(14, gOrderTable.iCRow, CStr(gOrderTable.iOrdCnt) & "")    'Order Count
...
Private Sub UpdatePatInfo()
    On Error GoTo ErrRtn
    
    Dim objAIF  As Object
    
    Set objAIF = CreateObject("AIFLD" & Left(fCurVerObject("LocalDB", gsMachineCd), 2) & ".DCIFLD" & fCurVerObject("LocalDB", gsMachineCd))
    
    Call objAIF.Update_PatInfo(gsMachineCd, gOrderTable.sWDate, gOrderTable.sWSeq, _
                            gOrderTable.sJDate, gOrderTable.sJGbn, gOrderTable.sJNo, _
                            gOrderTable.sRegNo, gOrderTable.sName, gOrderTable.sSex, _
                            gOrderTable.sEmer, gOrderTable.sReRun, gOrderTable.sOther)
    Set objAIF = Nothing
    
    Exit Sub
ErrRtn:
    ViewMsg "Update_PatInfo - " & Err.Description
End Sub
Public Function RegResult(ByVal iMode As Integer, ByVal sCRow As String, ByVal iRstCnt As Integer, _
                        ByVal sIFRstCd As String, ByVal sRst1 As String, ByVal sRst2 As String, ByVal sIFSpcCd As String, ByVal sFlag As String, _
                        Optional ByVal iCnt As Integer) As String
    On Error GoTo ErrHandler
    ...
    With gfIFDisplayForm.spdIntList
        Select Case iMode
            Case 0, 1
                ...
                If sWSeq = "" Then
                    sWSeq = Format(Val(GetCurLastWSeq) + 1, "0000")
                    Call .SetText(1, CInt(sCRow), Trim(sWSeq))
                End If
                '---------------
                ...
                If iMode = 0 Then
                    ...
                    If iExist = 1 Then
                        sRtnVal = objld.Add_IFResult(gsMachineCd, 0, sWDate, sWSeq, _
                                                    ...
                                                    sOther, sCRst1, sCRst2, sCFlag, "0", iRstCnt)
                    End If
                    ...
                    If IsNumeric(sRtnVal) = False Then
                        ...
                        Call SpdForeBack(gfIFDisplayForm.spdIntList, 3, 15, CInt(sCRow), CInt(sCRow), RGB(0, 0, 0), 연초록)
            ...
            'iMode = 1 ---> 한 샘플씩 LOCAL 등록
                If iMode = 1 Then
                    ...
                    sRtnVal = objld.Add_IFResult(gsMachineCd, 1, sWDate, sWSeq, _
                                                ...
                                                sOther, sTRst1, sTRst2, sTFlag, "0", CInt(Val(vIFItemCnt)))
...
Public Function ViewIFResult2(ByVal iCRow As Integer, ByVal iRstCnt As Integer, _
                            ByVal sIFRstCd As String, ByVal sRst1 As String, ByVal sRst2 As String, ByVal sIFSpcCd As String, ByVal sTFlag As String) As String
                ...
                For j = 1 To CInt(Val(vIFCnt))
                    ...
                    If Left(gResultTable(1).sTestCd(j), 1) = "C" Then
                        If gResultTable(1).sTestCd(j) = sCIFRstCd Then
                            Select Case sCRst2
                                ...
                                Case "High", "H", "Positive", "P"
                                    Call CurRstDisplay(iCRow, ConvertIFItemInfo(4, gResultTable(1).sTestCd(j)), sCRst1, "", _
                                                    RGB(0, 0, 0), RGB(255, 220, 220))
                                Case Else
                                    If sCRst2 <> "" Then
                                        If sCRst2 = "N" Or sCRst2 = "Negative" Then
                                            Call CurRstDisplay(iCRow, ConvertIFItemInfo(4, gResultTable(1).sTestCd(j)), sCRst1, "", _
                    ...
                    '일반항목일 때
                        If ConvertIFItemInfo(8, gResultTable(1).sTestCd(j)) = sCIFRstCd Then
                            If Trim(sCFlag) <> "" Then
                                Call CurRstDisplay(iCRow, ConvertIFItemInfo(4, gResultTable(1).sTestCd(j)), sCRst1, "", _
                                                RGB(0, 0, 0), RGB(255, 200, 200))
                                '<S--- Flag인 경우 Col1 색상변경...2007/5/30 yk
                                .Col = 1: .Row = iCRow
                                If .BackColor = vbWhite Then
                                    .BackColor = COLOR_FLAG
                                End If
                                '>E-----------------------------
                            Else
                                Select Case sCRst2
                                    ...
                                    Case "High", "H", "P"
                                        Call CurRstDisplay(iCRow, ConvertIFItemInfo(4, gResultTable(1).sTestCd(j)), sCRst1, "", _
                                                        RGB(0, 0, 0), RGB(255, 220, 220))
                                    Case Left(sCRst2, 3) = "Pos"
                                        Call CurRstDisplay(iCRow, ConvertIFItemInfo(4, gResultTable(1).sTestCd(j)), sCRst1, "", _
                                                        RGB(0, 0, 0), RGB(255, 220, 220))
                                    Case Else
                                        If sCRst2 <> "" Then
                                            If sCRst2 = "N" Or Left(sCRst2, 3) = "Neg" Then
                                                Call CurRstDisplay(iCRow, ConvertIFItemInfo(4, gResultTable(1).sTestCd(j)), sCRst1, "", _
                                                                RGB(0, 0, 0), RGB(255, 255, 255))
                                            Else
                                                Call CurRstDisplay(iCRow, ConvertIFItemInfo(4, gResultTable(1).sTestCd(j)), sCRst1, "", _
...
Public Sub DisplayResultOK(ByVal iMode As Integer, ByVal sWDate As String, ByVal sWSeq As String, _
                        ...
                        ByVal sSex As String, ByVal sEmer As String, ByVal sReRun As String, ByVal sOther As String, _
                        ByVal iRstCnt As Integer, ByVal sIFRstCd As String, ByVal sRst1 As String, ByVal sRst2 As String, _
                        ByVal sIFSpcCd As String, ByVal sCurRow As String, _
    ...
    With gfIFDisplayForm
                ...
                If .spdIntList.MaxRows >= CInt(sCurRow) Then
                    ...
                    If Len(vJNo) > 0 Then
                        If Trim(vJDate) & Trim(vJGbn) <> "" Then
                            ...
                            Else
                                .lblResult = CStr(vJDate) & "-" & CStr(vJNo)
                            End If
                        Else
                            .lblResult = CStr(vJNo)
                        End If
        ...
        sChkVal = ChkCalResult(gResultTable(1).iCRow, iRstCnt, sIFRstCd, sRst1, sRst2, sIFSpcCd, sFlag)
        
        'Low, High 등을 판정하여 색상을 나타냄
        sRetVal = ViewIFResult2(gResultTable(1).iCRow, iRstCnt, sIFRstCd, sRst1, sRst2, sIFSpcCd, sFlag)
...
'            End If
    ...
    'gsTxMode="0" => Batch, gsTxMode="1" => RealTime(한 항목씩), gsTxMode="2" => RealTime(한 환자씩)
        ...
        ElseIf gsTXMode = "1" Then
            ...
            ElseIf sRetVal = "MORE" Or sRetVal = "DONE" Then
                ...
                If sRetVal = "DONE" Then
                    Call SpdForeBack(.spdIntList, 3, 15, gResultTable(1).iCRow, gResultTable(1).iCRow, RGB(0, 0, 0), 연초록)
                End If
            End If
        ElseIf gsTXMode = "2" Then
        '원하는 결과등록방식대로 수정 가능함.
        ...
        If gfIFDisplayForm.optRegOpt(0).Value = True Then
            Call RegServerOK(gResultTable(1).iCRow, iRstCnt, sIFRstCd, sRst1, sRst2, sFlag)
        End If
