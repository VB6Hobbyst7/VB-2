Attribute VB_Name = "modVariableIF_KAHP"
Option Explicit
...
Type ORDTBL
    ...
    sServerCd() As String
    sIFRstCd() As String
    sSampleVol() As String      'For Hitachi7600 AutoRerun
    bSIndex As Boolean          '        "       Serum Index
    'IFRESULT
    sWDate As String
    sWSeq As String
    sJDate As String
...
Type RERUNORDTBL
    ...
    sPos As String
End Type
Public gRerunOrderTable As RERUNORDTBL
...
Public Function NewIFList(ByVal sWDate As String, ByVal sWSeq As String, _
                                ...
                                ByVal iRstCnt As Integer, ByVal sIFRstCd As String, ByVal sRst1 As String, ByVal sRst2 As String, _
                                ByVal sIFSpcCd As String, ByVal sCurRow As String, ByVal sFlag As String, _
                                Optional ByVal sPanic As String) As String
    ...
    With gfIFDisplayForm
        ...
        With .spdIntList
            ...
            For i = 1 To iRstCnt
                ...
                sCPanic = GetByOne(sPanic, sPanic)
                ...
                Else
                    ...
                    Call .SetText(16 + Val(vCRstCnt) + 1, .MaxRows, _
                                sCIFSeq & "|" & sCRst1 & "|" & sCRst2 & "|" & sCFlag & "|" & sCPanic)
                End If
            Next
...
Public Function OldIFList(ByVal iCRow%, ByVal iRstCnt%, _
            ...
            ByVal sSex$, ByVal sEmer$, ByVal sReRun$, ByVal sOther$, ByVal sFlag$, _
            Optional ByVal sPanic$) As String
    On Error GoTo ErrHandler
                    ...
                    If iAdd = True Then
                        If iCCol = 0 Then
                            ...
                            Call .SetText(16 + Val(vIFCnt) + 1, iCRow, _
                                    sCIFSeq & Chr(124) & sCRst1 & Chr(124) & sCRst2 & Chr(124) & sCFlag & Chr(124) & sCPanic & "")
                        Else
...
'
'   Alarm Code 존재할 경우 색상변경 추가
'
Public Sub CurRstDisplay2(ByVal iRow As Integer, ByVal sTestNm As String, ByVal sRst1 As String, ByVal sRst2 As String, _
                        ByVal sFcolor As String, ByVal sBcolor As String, ByVal sAlarm As String, ByVal sPanic As String)
    Dim i%
    Dim vTestNm
...
Public Sub DisplayResult2(ByVal iRow As Integer)
    ...
    Dim i%, j%, k%
    Dim sTmp$, sTestCd$, sCRst1$, sTestNm$, sCRst2$, sCFlag$, sCPanic$
    ...
    With gfIFDisplayForm.spdIntList
        ...
        For i = 1 To CInt(vIFCnt)
            ...
            If i > 15 Then
                ...
                ElseIf sCFlag <> "" Then
                    Call SpdForeBack(gfIFDisplayForm.spdRst2, 1, 4, i - 15, i - 15, RGB(0, 0, 0), RGB(180, 180, 180))
                ElseIf sCPanic = "P" Then
                    Call SpdForeBack(gfIFDisplayForm.spdRst2, 1, 4, i - 15, i - 15, RGB(0, 0, 0), RGB(255, 100, 100))
                End If
            Else
                ...
                ElseIf sCFlag <> "" Then
                    Call SpdForeBack(gfIFDisplayForm.spdRst, 1, 4, i, i, RGB(0, 0, 0), RGB(180, 180, 180))
                ElseIf sCPanic = "P" Then
                    Call SpdForeBack(gfIFDisplayForm.spdRst, 1, 4, i, i, RGB(0, 0, 0), RGB(255, 100, 100))
                End If
            End If
        Next
    End With
...
'-------------------
'RegServer(ByVal iPersonCnt As Integer, ByVal sWDate As String, ByVal sTWSeq As String, _
...
'                        ByVal sTRst1 As String, ByVal sTRst2 As String, Optional ByVal iMode As Integer) As String
'-------------------
...
Public Function RegResult_Temp(ByVal iMode As Integer, ByVal sCRow As String, ByVal iRstCnt As Integer, _
                        ByVal sIFRstCd As String, ByVal sRst1 As String, ByVal sRst2 As String, _
                        ByVal sIFSpcCd As String, ByVal sFlag As String, Optional ByVal iCnt As Integer, _
                        Optional ByVal sPanic As String) As String
    On Error GoTo ErrHandler
    ...
    Dim vIFItemCnt, vTmp, vChk
    Dim i%, j%, k%, iExist%
    Dim sTmp$, sCIFRstCd$, sCRst1$, sCRst2$, sCFlag$, sCPanic$
    Dim sWDate$, sWSeq$, sJDate$, sJGbn$, sJNo$, sRack$, sPos$, sRegNo$, sName$, sSex$, sEmer$, sReRun$, sOther$
    Dim sTIFSeq$, sTRst1$, sTRst2$, sTFlag$, sTPanic$
    Dim sIFSeq$, sRtnVal$
    Dim objld   As Object
...
Public Function RegResult(ByVal iMode As Integer, ByVal sCRow As String, ByVal iRstCnt As Integer, _
                        ByVal sIFRstCd As String, ByVal sRst1 As String, ByVal sRst2 As String, _
                        ByVal sIFSpcCd As String, ByVal sFlag As String, ByVal sChkPanic As String, _
...
Public Function ViewIFResult2(ByVal iCRow As Integer, ByVal iRstCnt As Integer, _
        ByVal sIFRstCd As String, ByVal sRst1 As String, ByVal sRst2 As String, ByVal sIFSpcCd As String, _
        Optional ByVal sAlarm As String, Optional ByVal sPanic As String) As String
    
    Dim i%, j%
    Dim sCIFRstCd$, sCRst1$, sCRst2$, sCIFSeq$, sCAlarm$, sCPanic$, sTmp$
    ...
    With gfIFDisplayForm
        With .spdIntList
            ...
            For i = 1 To iRstCnt
                ...
                sCRst1 = GetByOne(sRst1, sRst1)
                sCRst2 = GetByOne(sRst2, sRst2)
                sCAlarm = GetByOne(sAlarm, sAlarm)
                sCPanic = GetByOne(sPanic, sPanic)
                ...
                For j = 1 To CInt(Val(vIFCnt))
                    ...
                    If Left(gResultTable(1).sTestCd(j), 1) = "C" Then
                        If gResultTable(1).sTestCd(j) = sCIFRstCd Then
                            If sCRst2 = "Low" Then
                                Call CurRstDisplay2(iCRow, ConvertIFItemInfo(4, gResultTable(1).sTestCd(j)), sCRst1, "", _
                                         RGB(0, 0, 0), RGB(220, 220, 255), sCAlarm, sCPanic)
                            ElseIf sCRst2 = "High" Or sCRst2 = "Positive" Then
                                Call CurRstDisplay2(iCRow, ConvertIFItemInfo(4, gResultTable(1).sTestCd(j)), sCRst1, "", _
                                         RGB(0, 0, 0), RGB(255, 220, 220), sCAlarm, sCPanic)
                            ElseIf sCRst2 = "L" Then
                                Call CurRstDisplay2(iCRow, ConvertIFItemInfo(4, gResultTable(1).sTestCd(j)), sCRst1, "", _
                                         RGB(0, 0, 0), RGB(220, 220, 255), sCAlarm, sCPanic)
                            ElseIf sCRst2 = "H" Then
                            ...
                            ElseIf sCRst2 <> "" Then
                                Call CurRstDisplay2(iCRow, ConvertIFItemInfo(4, gResultTable(1).sTestCd(j)), sCRst1, "", _
                                         RGB(0, 0, 0), RGB(230, 230, 230), sCAlarm, sCPanic)
                            Else
                                Call CurRstDisplay2(iCRow, ConvertIFItemInfo(4, gResultTable(1).sTestCd(j)), sCRst1, "", _
                                        RGB(0, 0, 0), RGB(255, 255, 255), sCAlarm, sCPanic)
                            End If
...
Public Sub DisplayResultOK(ByVal iMode As Integer, ByVal sWDate As String, ByVal sWSeq As String, _
                ...
                ByVal sSex As String, ByVal sEmer As String, ByVal sReRun As String, ByVal sOther As String, _
                ByVal iRstCnt As Integer, ByVal sIFRstCd As String, ByVal sRst1 As String, ByVal sRst2 As String, _
                ByVal sIFSpcCd As String, ByVal sCurRow As String, ByVal sFlag As String, ByVal sPanic As String, _
                ByVal sChkPanic As String, ByVal sChkAlarm As String)
    On Error GoTo ErrHandler
    ...
    With gfIFDisplayForm
        Select Case iMode
            ...
            Case 3  'JNo를 넘기는 경우
                ...
                '재검인 경우 새로운 Row 발생(For 영동세브란스 H-7600)
                If sReRun = "R" Then
                    iCRow = 0
                Else
                ...
                If iCRow > 0 Then
                    Call OldIFList(iCRow, iRstCnt, sIFRstCd, sRst1, sRst2, sIFSpcCd, sRack, sPos, _
                            sRegNo, sName, sSex, sEmer, sReRun, sOther, sFlag, sPanic)
        ...
        sRetVal = ViewIFResult2(gResultTable(1).iCRow, iRstCnt, sIFRstCd, sRst1, sRst2, sIFSpcCd, sFlag, sPanic)
    ...
    'gsTxMode="0" => Batch, gsTxMode="1" => RealTime(한 항목씩), gsTxMode="2" => RealTime(한 환자씩)
        ...
        ElseIf gsTXMode = "1" Then
            ...
            ElseIf sRetVal = "MORE" Or sRetVal = "DONE" Then
                If sChkVal = "1" Then
                    Call RegResult(1, CStr(gResultTable(1).iCRow), iRstCnt, sIFRstCd, sRst1, sRst2, sIFSpcCd, sFlag, sChkPanic)
                Else
                    Call RegResult(0, CStr(gResultTable(1).iCRow), iRstCnt, sIFRstCd, sRst1, sRst2, sIFSpcCd, sFlag, sChkPanic)
                End If
        ...
        If gfIFDisplayForm.optRegOpt(0).Value = True Then
            If Left(gsMachineCd, 2) = "충북" Then
                Call RegServerOK(gResultTable(1).iCRow, iRstCnt, sIFRstCd, sRst1, sRst2)
            Else
    '            'Alarm/Panic 이 아닌 결과만 서버 등록
    '            If Trim(sChkPanic) <> "" Or Trim(sChkAlarm) <> "" Then
    '            Else
