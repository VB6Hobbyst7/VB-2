...
Public Const ¿¬ÇÏ´Ã = &HDFFFDF
Public Const ¿¬³ë¶û = &HE0FFFF
Public Const ¿¬ÃÊ·Ï = &HCCFFCC
Public Const ¿¬»¡°­ = &HEAEAFF
Public Const Èå¸°»¡°­ = &HC0C0FF
Public Const Èå¸°ÆÄ¶û = &HFFC0C0

Public Const MAXIFITEM = 150    '100    '2004/2/2 yk
Public Const MAXCALITEM = 10
Public Const MAXORDERFIELD = 10
Public Const MAXRESULTFIELD = 12
Public Const OTHERFIELD = 9     '±âÅ¸¶õÀÌ ¸î¹øÂ°ÀÎÁö
Public Const IFTESTFIELD = 11
'----------------------------------------------------------
'
' File: SSOCX.BAS
'
