...
Private Sub PhaseCfg_Protocol()
    ...
    Select Case UCase(m_EqName)
        Case "I-SMART30"
                Call PhaseCfg_Protocol_ISMART30
...
Private Sub PhaseCfg_Protocol_ISMART30()
        ...
        Select Case m_iPhase
            ...
            Case 2
                Select Case Asc(wkDat)
                    ...
                    Case 10     '<LF>
                        If bEndChk = True Then
                            Call DataEditResponse_ISMART30
                            RcvBuffer = ""
                        End If
                        msComm.Output = Chr(6)
...
' *               Data편집 & 응답처리                   *
' *=====================================================*
Private Sub DataEditResponse_ISMART30()
    On Error GoTo ErrRtn
...
''            If InStr(UCase(tmpKind), "CAL") > 0 Then    'Calibration
''                tmpKind = "C"
''            End If
            ...
            pSampleInfo.RSTDT = ""          '결과일시
            pSampleInfo.CMT1 = ""           'Comment1

        Case "R"        'Result Record
            '--- 결과데이타 편집
            'R|1|^^^Na+^M|50|mmol/L||N||||oID1234||20100413112121|
            tmpData() = Split(RcvBuffer, "|")
            
            tmpField = Split(tmpData(2), "^")
            tmpIFCd = Trim(tmpField(3))
            tmpState = Trim(tmpField(4))
