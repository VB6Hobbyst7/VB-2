...
'이벤트 선언:
Event RequestNextOrder(sID$, sFlag$)
...
Private Sub PhaseCfg_Protocol()
    ...
    Select Case UCase(m_EqName)
        Case "VITROSECI"
            '바코드 사용
            Call PhaseCfg_Protocol_VitrosECi
...
Private Sub PhaseCfg_Protocol_VitrosECi()
        ...
        Select Case m_iPhase
            ...
            Case 2
                Select Case Asc(wkDat)
                    ...
                    Case 10     '<LF>
                        Call DataEditResponse_VitrosECi
...
' *               Data편집 & 응답처리                   *
' *=====================================================*
Private Sub DataEditResponse_VitrosECi()
    ...
    Select Case RecType
        ...
        Case "O"
            ...
            tmpPos = Trim(Val(tmpData(2)) + 1)      '장비에선 0~9 까지 넘어옴
...
Private Sub SendOrder_VitrosECi()
    On Error GoTo ErrRtn
    ...
    Select Case m_iSendPhase
        ...
        Case 3      'O
            ...
            For i = 1 To pSampleInfo.ORDCNT
                TestDat = TestDat & pSampleInfo.IFCD(i) & "+1\"
            Next i
        ...
        Case 5      'EOT
            ...
            '다음 오더 조회
            RaiseEvent RequestNextOrder(Trim(pSampleInfo.ID), "OK")
