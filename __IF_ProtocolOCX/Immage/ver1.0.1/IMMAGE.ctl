...
'기본 속성 값:
Const m_def_p_sSpcType = "0"
'Const m_def_p_sTSpcCd = "0"
...
'속성 변수:
Dim m_p_sSpcType As String
'Dim m_p_sTSpcCd As String
...
'Event RequestCurOrder(sID$, sRack$, sPos$, sControlName$)
...
' *               Data편집 & 응답처리                   *
' *=====================================================*
Private Sub DataEditResponse_IMMAGE()
    ...
    Dim tmpBarCd$, tmpSeqNo$, tmpRack$, tmpPos$, tmpControlName$
    ...
    Select Case RecType
        ...
        Case "R"        'Result Record
            ...
            With pResultInfo
                ...
                .OTHER = pSampleInfo.CONTROLNAME       '2006/01/17 control name
...
'   IMMAGE 바코드 사용
'
Private Sub PhaseCfg_Protocol_IMMAGE()
        ...
        Select Case m_iPhase
            ...
            Case 3
                Select Case Asc(wkDat)
                    Case 6      'ACK
                        If sState = "Q" Then
                            Call SendOrder_IMMAGE       'Order 전송
                        End If
...
Private Sub SendOrder_IMMAGE()
    ...
    Select Case m_iSendPhase
        ...
        Case 1      'H
            sTmp = m_iFrameN & "H|\^&" & Chr(13) & Chr(3)
            m_iSendPhase = 2

        Case 2      'P
            sTmp = m_iFrameN & "P|1||" & Trim(pSampleInfo.ID) & "|||U" & Chr(13) & Chr(3)
            m_iSendPhase = 3
        ...
        Case 3      'O
            ...
            For i = 1 To pSampleInfo.ORDCNT
                TestDat = TestDat & "^^^" & Trim(pSampleInfo.IFCD(i)) & "\"
            Next i
            If pSampleInfo.ORDCNT > 0 Then
            ...
            sTmp = m_iFrameN & "O|1|" & Trim(pSampleInfo.ID) & "||" _
                        & TestDat & "|R||||||" & sActionCd & "||||" _
                        & sSpcType & "||||||||||" _
                        & sReportType & vbCr & Chr(3)
            m_iSendPhase = 4
...
Private Sub Get_OrderString()
    ...
    With pSampleInfo
        ...
        '검체 종류
        Select Case UCase(m_p_sSpcType)
            Case "S", "U", "F", "P", "T"
                sSpcType = Trim(m_p_sSpcType)
            Case Else
                sSpcType = ""
        End Select
    End With
...
'    m_p_sTSpcCd = PropBag.ReadProperty("p_sTSpcCd", m_def_p_sTSpcCd)
    m_p_sSpcType = PropBag.ReadProperty("p_sSpcType", m_def_p_sSpcType)
End Sub
...
'    Call PropBag.WriteProperty("p_sTSpcCd", m_p_sTSpcCd, m_def_p_sTSpcCd)
    Call PropBag.WriteProperty("p_sSpcType", m_p_sSpcType, m_def_p_sSpcType)
End Sub
...
'    m_p_sTSpcCd = m_def_p_sTSpcCd
    m_p_sSpcType = m_def_p_sSpcType
End Sub
...
''경고! 주석으로 되어 있는 다음 줄은 제거하거나 수정하지 마십시오!
''MemberInfo=13,0,0,0
'Public Property Get p_sTSpcCd() As String
'    p_sTSpcCd = m_p_sTSpcCd
'End Property
'
'Public Property Let p_sTSpcCd(ByVal New_p_sTSpcCd As String)
'    m_p_sTSpcCd = New_p_sTSpcCd
'    PropertyChanged "p_sTSpcCd"
'End Property
'
'경고! 주석으로 되어 있는 다음 줄은 제거하거나 수정하지 마십시오!
'MemberInfo=13,0,0,0
Public Property Get p_sSpcType() As String
    p_sSpcType = m_p_sSpcType
End Property

Public Property Let p_sSpcType(ByVal New_p_sSpcType As String)
    m_p_sSpcType = New_p_sSpcType
    PropertyChanged "p_sSpcType"
End Property
