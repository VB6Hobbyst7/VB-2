...
Event AppendData(sID$, sISol$, sSpcCd$, sSpcNm$, sKitCd$, sKitNm$, sOrgCd$, sOrgNm$, iAntiCnt$, sAntiCd$, sAntiNm$, sSRI$, sMIC$, sUrine$, sStatus$)
...
''            End If
        ...
        Case "R"
            ...
            If Trim(tmpField(3)) <> "" Then
                pResultInfo.ID = Trim(Mid(Trim(tmpField(3)), 2, Len(Trim(tmpField(3))) - 2))
            End If
            ...
            If pResultInfo.ORGCD <> "" Then
                pResultInfo.ORGCNT = pResultInfo.ORGCNT + 1
                pResultInfo.TISOL = pResultInfo.TISOL & pResultInfo.ISOL & Chr(3)
                pResultInfo.TKITCD = pResultInfo.TKITCD & pResultInfo.KITCD & Chr(3)
                pResultInfo.TKITNM = pResultInfo.TKITNM & pResultInfo.KITNM & Chr(3)
                pResultInfo.TORGCD = pResultInfo.TORGCD & pResultInfo.ORGCD & Chr(3)
                pResultInfo.TORGNM = pResultInfo.TORGNM & pResultInfo.ORGNM & Chr(3)
                pResultInfo.TSTATUS = pResultInfo.TSTATUS & pResultInfo.STATUS & Chr(3)
...
''                    End If
            ...
            If IsNumeric(tmpAntiSeq) = False Then   '마지막 항생제 SEQ
                pResultInfo.TANTIRST = pResultInfo.TANTIRST & CStr(pResultInfo.ANTIRST) & Chr(3)
                pResultInfo.TANTICD = pResultInfo.TANTICD & pResultInfo.ANTICD & Chr(3)
                pResultInfo.TANTINM = pResultInfo.TANTINM & pResultInfo.ANTINM & Chr(3)
                pResultInfo.TSRI = pResultInfo.TSRI & pResultInfo.SRI & Chr(3)
                pResultInfo.TMIC = pResultInfo.TMIC & pResultInfo.MIC & Chr(3)
                
                pResultInfo.ANTIRST = 0
                pResultInfo.ANTICD = ""
                pResultInfo.ANTINM = ""
                pResultInfo.SRI = ""
                pResultInfo.MIC = ""
                
                If pResultInfo.TORGCD <> "" Then
                    With pResultInfo
                        RaiseEvent AppendData(.ID, .TISOL, .SPCCD, .SPCNM, .TKITCD, .TKITNM, .TORGCD, .TORGNM, .TANTIRST, .TANTICD, .TANTINM, .TSRI, .TMIC, .URINE, .TSTATUS)
                    End With
...
Public Sub SendOrder_Microscan()
    ...
    Dim sSex        As String
    Dim sPenal      As String
    Dim sMenual     As String
    Dim sHemo       As String
    ...
    Select Case m_iSendPhase
        Case 1
            ...
            If pSampleInfo.ORDCNT > 0 Then
                If InStr(pSampleInfo.CMT1, "^") > 0 Then
                    ...
                    ''sSendBuff = "P,""L"",""" & sPatNo & """,,""" & sPatNm & """,," & sSex & ",,,,,,,,,,,,,,,,,,"
                    sSendBuff = "P,""L"",""" & sPatNo & """,""" & sLastNm & """,""" & sFirstNm & """,," & sSex & ",,,,,,,,,,,,, ,,,, ,"
                Else
                    sSendBuff = "P,""L"",""" & pSampleInfo.CMT1 & """,,""" & "" & """,," & sSex & ",,,,,,,,,,,,,,,,,,"
                End If
        ...
        Case 2
            If InStr(pSampleInfo.CMT1, "^") > 0 Then
                ...
                sSendBuff = "B,""L"",""" & pSampleInfo.ID & """,""" & sPatNo & """,,,""" & pSampleInfo.SPCCD & """,,," & Format(Now, "yyyyMMdd") & ",,,,,,,,,,""" & pSampleInfo.RACK & """,,,,"
            Else
                sSendBuff = "B,""L"",""" & pSampleInfo.ID & """,""" & pSampleInfo.CMT1 & """,,,""" & pSampleInfo.SPCCD & """,,," & Format(Now, "yyyyMMdd") & ",,,,,,,,,,""" & pSampleInfo.RACK & """,,,,"
            End If
        ...
        Case 3
            ...
            sPenal = Trim(Split(pSampleInfo.CONTAINER, "^")(0))
            sMenual = Trim(Split(pSampleInfo.CONTAINER, "^")(1))
            sHemo = Trim(Split(pSampleInfo.CONTAINER, "^")(2))
...
''            For ix1 = 1 To UBound(mMenual)
''                If sPenal = mMenual(ix1).Penal And sMenual = mMenual(ix1).Manual Then
''                    If mMenual(ix1).Kind = "N" Then
''
''                    ElseIf mMenual(ix1).Kind = "P" Then
''                        If mMenual(ix1).Value = "2" Then
''                            'R,"L","05","123123","PBC28","Pos Breakpoint Combo 28",20120920,,N,,,,,,,,,,,,,,,,N,,,,,0,,N,,2,,,0,P,,
''                            sSendBuff = "R,""L"",""" & pSampleInfo.SEQNO & """,""" & pSampleInfo.ID & """,""" & sPenal & """,," & sJDate & ",,N,,,,,,,,,,,,,,,,N,,,,,0,,N,,2,,,0,P,,"
''
''                        ElseIf mMenual(ix1).Value = "Y" Then
''                            'R,"3","03","123123","PBC28","Pos Breakpoint Combo 28",20120920,,N,,,,,,,,,,,,,Y,,,N,,,,,0,,N,,1,,,0,P,,
''                            sSendBuff = "R,""L"",""" & pSampleInfo.SEQNO & """,""" & pSampleInfo.ID & """,""" & sPenal & """,," & sJDate & ",,N,,,,,,,,,,,,,Y,,,N,,,,,0,,N,,1,,,0,P,,"
''
''                        ElseIf mMenual(ix1).Value = "N" Then
''                            'R,"4","04","123123","PBC28","Pos Breakpoint Combo 28",20120920,,N,,,,,,,,,,,,,N,,,N,,,,,0,,N,,1,,,0,P,,
''                            sSendBuff = "R,""L"",""" & pSampleInfo.SEQNO & """,""" & pSampleInfo.ID & """,""" & sPenal & """,," & sJDate & ",,N,,,,,,,,,,,,,N,,,N,,,,,0,,N,,1,,,0,P,,"
''
''                        Else
''                            sSendBuff = "R,""L"",""" & pSampleInfo.SEQNO & """,""" & pSampleInfo.ID & """,""" & sPenal & """,," & sJDate & ",,,,,,,,,,,,,,,,,,,,,,,,,,,1,,,,,,"
''
''                        End If
''                    Else
''                        sSendBuff = "R,""L"",""" & pSampleInfo.SEQNO & """,""" & pSampleInfo.ID & """,""" & sPenal & """,," & sJDate & ",,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,"
''
''                    End If
''                End If
''            Next ix1
            
            If sPenal = "NBC44" Then
                If sMenual = "OXI-" Then
                    'R,"1","01","123123","NBC44","Neg Breakpoint Combo 44",20120920,,N,,,,,,,N,,,,,,,,,N,,,,,0,,N,,,,,0,P,,
                    sSendBuff = "R,""L"",""" & pSampleInfo.SEQNO & """,""" & pSampleInfo.ID & """,""" & sPenal & """,," & sJDate & ",,,,,,,,," & "N" & ",,,,,,,,,,,,,,,,,,,,,,,,"
                    
                ElseIf sMenual = "OXI+" Then
                    'R,"2","02","123123","NBC44","Neg Breakpoint Combo 44",20120920,,N,,,,,,,P,,,,,,,,,N,,,,,0,,N,,,,,0,P,,
                    sSendBuff = "R,""L"",""" & pSampleInfo.SEQNO & """,""" & pSampleInfo.ID & """,""" & sPenal & """,," & sJDate & ",,,,,,,,," & "P" & ",,,,,,,,,,,,,,,,,,,,,,,,"
                    
                End If
                
            ElseIf sPenal = "PBC28" Then
                If sMenual = "Staph" Then
                    'R,"L","05","123123","PBC28","Pos Breakpoint Combo 28",20120920,,N,,,,,,,,,,,,,,,,N,,,,,0,,N,,2,,,0,P,,
                    sSendBuff = "R,""L"",""" & pSampleInfo.SEQNO & """,""" & pSampleInfo.ID & """,""" & sPenal & """,," & sJDate & ",,N,,,,,,,,,,,,,,,,N,,,,,0,,N,,2,,,0,P,,"
                    
                ElseIf InStr(sMenual, "Strep/beta") > 0 Then
                    If Right(sMenual, 1) = "+" Then
                        'R,"3","03","123123","PBC28","Pos Breakpoint Combo 28",20120920,,N,,,,,,,,,,,,,Y,,,N,,,,,0,,N,,1,,,0,P,,
                        sSendBuff = "R,""L"",""" & pSampleInfo.SEQNO & """,""" & pSampleInfo.ID & """,""" & sPenal & """,," & sJDate & ",,N,,,,,,,,,,,,,Y,,,N,,,,,0,,N,,1,,,0,P,,"
                        
                    ElseIf Right(sMenual, 1) = "-" Then
                        'R,"4","04","123123","PBC28","Pos Breakpoint Combo 28",20120920,,N,,,,,,,,,,,,,N,,,N,,,,,0,,N,,1,,,0,P,,
                        sSendBuff = "R,""L"",""" & pSampleInfo.SEQNO & """,""" & pSampleInfo.ID & """,""" & sPenal & """,," & sJDate & ",,N,,,,,,,,,,,,,N,,,N,,,,,0,,N,,1,,,0,P,,"
...
Public Sub SetPenalInfo(ByVal Menual As Variant)
''    Dim i As Integer
''    Dim aMenaul() As String
''
''    aMenaul = Menual
''    ReDim mMenual(UBound(aMenaul))
''
''    For i = 1 To UBound(aMenaul)
''        mMenual(i).Key = Split(aMenaul(i), "^")(0)
''        mMenual(i).Panel = Split(aMenaul(i), "^")(1)
''        mMenual(i).Manual = Split(aMenaul(i), "^")(2)
''        mMenual(i).MKind = Split(aMenaul(i), "^")(3)
''        mMenual(i).Value = Split(aMenaul(i), "^")(4)
''    Next
