...
Begin VB.UserControl CELLAVISION 
   ClientHeight    =   3150
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   3330
...
Private Sub PhaseCfg_Protocol()
    ...
    Select Case UCase(m_EqName)
        Case "CELLAVISION"
            Call PhaseCfg_Protocol_CellaVision
...
' *               Data편집 & 응답처리                   *
' *=====================================================*
Private Sub DataEditResponse_CellaVision()
...
'            pSampleInfo.POS = tmpPos
        ...
        Case "O"
            'O|1|12345678||^WBC^^\^RBC^^\^PLT^^|R||20040618125654||||A|||||DrJones||||200^\^\^|5.73^2.5||||F<CR>
        ...
        Case "R"        'Result Record
            'WBC
            'R|1|^WBC^^SNE/#|76||0 to 148|N||F||^Carl||20040621134906<CR>
            'R|2|^WBC^^SNE/%|51.4|%|0 to 100|N||F||^Carl||20040621134906<CR>
            'Non -WBC
            'R|19|^WBC^^GT/#|1||0 to 148|N||F||^Carl||20040621134906<CR>
            'R|20|^WBC^^GT/%|0.7|%|0 to 100|N||F||^Carl||20040621134906<CR>
            'RBC
            'R|27|^RBC^^ZMIC/|2|||||F||^Carl||20040621134906<CR>
            ...
            tmpIFCd = Trim(tmpData(1)) & "^" & Trim(tmpData(3))
...
Private Sub PhaseCfg_Protocol_CellaVision()
        ...
        Select Case m_iPhase
            ...
            Case 2
                Select Case Asc(wkDat)
                    ...
                    Case 10     '<LF>
                        Call DataEditResponse_CellaVision
