...
Private Sub DataEditResponse_URISYS2400()
    ...
    Dim tmpIFCd$, tmpRst$, tmpUnit$, tmpFlag$, tmpAlarmCd$, tmpRstDT$
    Dim tmpCtlNm    As String
    ...
    Select Case RecType
        ...
        Case "O"
            ...
            If UBound(tmpField) >= 14 Then
                tmpRstDT = Trim(tmpField(14))
            Else
                tmpRstDT = ""
            End If
            ...
            If ii <> 0 Then
                ...
                If tmpType = "CONTROL" Then     '2008/1/8 yk
                    tmpType = "QC"
                Else
                    tmpType = ""
                End If
        ...
        Case "M"        'M-RC Record
            'M|1|RC|5261412|20000609112530|CONTROL-LOW|1|LOTNO00101|(CR)
            tmpField() = Split(RcvBuffer, Chr(124))
            
            If pSampleInfo.KIND = "QC" And tmpField(2) = "RC" Then
                tmpCtlNm = Trim(tmpField(5))
                If Trim(tmpCtlNm) <> "" Then
                    pResultInfo.ID = tmpCtlNm
                End If
            End If
