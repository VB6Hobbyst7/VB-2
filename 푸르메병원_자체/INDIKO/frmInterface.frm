...
Begin VB.Form frmInterface 
   ...
   Begin VB.Frame FrmHideControl 
      ...
      Begin VB.ComboBox cboChk 
         Height          =   315
         ItemData        =   "frmInterface.frx":2593
         Left            =   4140
         List            =   "frmInterface.frx":25A0
         TabIndex        =   71
         Top             =   6210
         Visible         =   0   'False
         Width           =   825
      ...
      Begin VB.Frame Frame4 
         ...
         Begin FPSpread.vaSpread vasPrint 
            ...
            EndProperty
            MaxCols         =   9
            SpreadDesigner  =   "frmInterface.frx":25B6
         End
         Begin FPSpread.vaSpread vasPrintBuf 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            SpreadDesigner  =   "frmInterface.frx":402F
         End
      End
      Begin FPSpread.vaSpread vasCode 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":4247
      End
      Begin FPSpread.vaSpread vasTemp1 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":445F
      End
         ...
         Begin MSComctlLib.ImageList imlStatus 
            ...
            BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
               ...
               BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":4C01
                  Key             =   "RUN"
               EndProperty
               BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":519B
                  Key             =   "NOT"
               EndProperty
               BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":5735
                  Key             =   "STOP"
               EndProperty
               BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":5CCF
                  Key             =   "LST"
               EndProperty
               BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":6561
                  Key             =   "ITM"
               EndProperty
               BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":66BB
                  Key             =   "ERR"
               EndProperty
               BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":6815
                  Key             =   "NOF"
               EndProperty
            EndProperty
         End
      ...
      Begin FPSpread.vaSpread vasList 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":696F
      End
      Begin FPSpread.vaSpread vasResTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":6B87
      End
      Begin FPSpread.vaSpread vasTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":6D9F
      End
      ...
      Begin FPSpread.vaSpread vasWorkList 
         ...
         ScrollBars      =   2
         SpreadDesigner  =   "frmInterface.frx":6FB7
         UserResize      =   2
      End
      Begin VB.Label Label1 
         Appearance      =   0  'Æò¸é
   ...
   Begin TabDlg.SSTab stInterface 
      ...
      TabPicture(0)   =   "frmInterface.frx":7A2D
      ...
      TabPicture(1)   =   "frmInterface.frx":7A49
      ...
      Begin VB.Frame Frame3 
         ...
         Begin FPSpread.vaSpread vasRRes 
            ...
            RetainSelBlock  =   0   'False
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":7A65
         End
         ...
         Begin FPSpread.vaSpread vasRID 
            ...
            RetainSelBlock  =   0   'False
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":B767
            UserResize      =   2
         End
      ...
      Begin VB.Frame Frame1 
         ...
         Top             =   360
         Width           =   14625
         Begin VB.OptionButton optRstType 
            Caption         =   "Áß°£"
            BeginProperty Font 
               Name            =   "±¼¸²Ã¼"
               Size            =   9
         ...
         Begin FPSpread.vaSpread vasID 
            ...
            RetainSelBlock  =   0   'False
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":C1D7
            UserResize      =   2
         End
         Begin FPSpread.vaSpread vasRes 
            ...
            RetainSelBlock  =   0   'False
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":CC51
         End
...
Const colOrdDate = 2    '°Ë»çÀÇ·ÚÀÏ
Const colBarcode = 3    '¹ÙÄÚµå
Const colChtNum = 4     'Ã­Æ®¹øÈ£
Const colIO = 5         'ÀÔ/¿Ü
Const colInNum = 6      '³»¿ø¹øÈ£
Const colRack = 7       'Rack
Const colPos = 8        'Pos
Const colPName = 9      'È¯ÀÚ¸í
Const colPSex = 10      '¼ºº°
...
Private Sub cmdRSch_Click()
    ...
    'SELECT Ã³À½ '' ´Â Ã¼Å©¹Ú½º
          SQL = " SELECT DISTINCT '', BARCODE, DISKNO, POSNO, PID, PNAME,PSEX, PAGE, COUNT(*), COUNT(*),  SENDFLAG " & vbCrLf
    ...
    For iRow = 1 To vasRID.DataRowCnt
        Select Case Trim(GetText(vasRID, iRow, 11))
    ...
    Select Case intSndPhase
        ...
        Case 4  '## Order
            If mOrder.NoOrder = True Then
                '## Á¢¼öÁ¤º¸°¡ ¾øÀ»°æ¿ì
                strOutput = intFrameNo & "O|1|" & mOrder.BarNo & "||" & "|S|" & Format(Now, "yyyymmddhhmmss") & "||||||||||||||||||" & vbCr & ETX
                intSndPhase = 5
            
            Else
                If mOrder.IsSending = False Then   '## ÃÖÃÊ º¸³¾¶§
                    strOutput = "O|1|" & mOrder.BarNo & "||" & mOrder.Order & "|S|" & Format(Now, "yyyymmddhhmmss") & "||||||||||||||||||"
...
Private Sub GetOrder(ByVal pBarNo As String)
    ...
    strItems = GetEquipExamCode_INDIKO(gEquip, pBarNo, intRow)
...
Function GetEquipExamCode_INDIKO(argEquipCode As String, argPID As String, Optional intRow As Long) As String
    Dim i As Integer
    Dim strExamCode As String
    ...
    GetEquipExamCode_INDIKO = strExamCode
...
Private Sub SetPatInfo(ByVal pBarNo As String)
    ...
    '-- È¯ÀÚÁ¤º¸°¡ ¾øÀ» °æ¿ì¿¡ ´ëºñÇØ ³»¿ø¹øÈ£¿¡ yyyymmddhhmmss¸¦ ÀúÀå
    Call SetText(vasID, mResult.SpcmNo, intRow, colInNum)
    ...
    For intCnt = 1 To UBound(strRecvData)
        ...
        Select Case strType
            ...
            Case "O"    '## Order
                ...
                'strRackNo = mGetP(strTemp1, 3, "^")
                'strTubePos = mGetP(strTemp1, 4, "^")
                ...
                With mResult
                    ...
                    '.RackNo = strRackNo
                    '.TubePos = strTubePos
                    '.SpcmNo = Format(Now, "yyyymmddhhmmss")
                End With
...
Function SetLocalDB(ByVal asRow1 As Long, ByVal asRow2 As Long, asSend As String, Optional asEquipResult As String = "")
    ...
    SQL = SQL & " EXAMDATE,EQUIPNO,BARCODE,DISKNO,POSNO," & vbCrLf & _
                " PID,PNAME,EQUIPCODE,EXAMCODE,SEQNO," & vbCrLf & _
    ...
    If KeyAscii = 13 Then
        With vasID
            ...
            If .ActiveCol = colBarcode Then
                ...
                If Not IsNumeric(strNewBC) Then
                    MsgBox "¼ýÀÚ¸¸ ÀÔ·ÂÇÏ¼¼¿ä", vbOKOnly + vbInformation, Me.Caption
                    Exit Sub
                End If
                
                If Len(strNewBC) <> 10 Then
                    MsgBox "À¯È¿ÇÑ ¹ÙÄÚµå°¡ ¾Æ´Õ´Ï´Ù", vbOKOnly + vbInformation, Me.Caption
                    Exit Sub
                End If
                                
                '-- ·ÎÄÃ ÀúÀå
                If SetLocalUpdate(strNewBC, intRow) = True Then
                    '-- È¯ÀÚÁ¤º¸ ºÒ·¯¿À±â
                    Call GetSampleInfoW(intRow)
                End If
...
Function SetLocalUpdate(ByVal strNewBC As String, ByVal iRow As Long) As Boolean
    ...
    strRack = Trim(GetText(vasID, iRow, colRack))
    strPos = Trim(GetText(vasID, iRow, colPos))
    strInNum = Trim(GetText(vasID, iRow, colInNum))
    
    If strRack = "" And strPos = "" Then
        If strInNum = "" Then
            SetLocalUpdate = False
            Exit Function
        Else
                  SQL = "UPDATE PATRESULT "
            SQL = SQL & "   SET BARCODE = '" & strNewBC & "' " & vbCrLf
            SQL = SQL & " WHERE EQUIPNO = '" & gEquip & "' " & vbCrLf
            SQL = SQL & "   AND PID = '" & strInNum & "' "
    ...
    Else
        ...
        SQL = SQL & "   SET BARCODE = '" & strNewBC & "' " & vbCrLf
        SQL = SQL & " WHERE EQUIPNO = '" & gEquip & "' " & vbCrLf
        SQL = SQL & "   AND DISKNO = '" & strRack & "' " & vbCrLf
        SQL = SQL & "   AND POSNO = '" & strPos & "' "
...
'Private Function GetWorkList_Barcode(ByVal pBunNo As String, ByVal pintRow As Long) As Boolean
'    Dim intRow      As Long
'    Dim RS As ADODB.Recordset
...
'On Error GoTo Rst
'
'    GetWorkList_Barcode = False
'    blnSave = False
'
'          'SQL = "SELECT r.resultitemcode ,p.patid ,p.patname ,p.sex  ,p.prsnidpre||prsnidpost prsnid  ,r.resultflag  ,w.resultstate  ,w.rsvacptstate  ,r.ORDERCODE"
'          SQL = "SELECT distinct p.patid ,p.patname ,p.sex  "
'    SQL = SQL & "  FROM resultofnum r  , registinfos w  , patmst p"
'    SQL = SQL & " Where r.patid = p.patid"
'    SQL = SQL & " and r.spcmno = w.spcmno"
'    SQL = SQL & " and r.OrderCode = w.OrderCode"
'    SQL = SQL & " and r.spcmno = '" & Trim(pBunNo) & "'"
...
'        SetText vasID, pBunNo, intRow, colSeqno
'        SetText vasID, pBunNo, intRow, colBarcode
'        SetText vasID, Trim(RS.Fields("patid")), intRow, colBarcode
'        SetText vasID, Trim(RS.Fields("patname")), intRow, colPName
'        SetText vasID, Trim(RS.Fields("sex")), intRow, colSex
'        RS.MoveNext
'
'        GetWorkList_Barcode = True
'
'    Loop
'
'    Set RS = Nothing
'
'    If GetWorkList_Barcode = False Then
'        intRow = pintRow
'
'        SetText vasID, "0", intRow, colCheckBox
'        SetText vasID, pBunNo, intRow, colSeqno
'        SetText vasID, pBunNo, intRow, colBarcode
'        SetText vasID, "", intRow, colPID
'        SetText vasID, "", intRow, colPName
'        SetText vasID, "", intRow, colSex
'    End If
'
'    vasID.RowHeight(-1) = 12
'
...
'        SetText vasID, pBunNo, intRow, colSeqno
'        SetText vasID, pBunNo, intRow, colBarcode
'        SetText vasID, "", intRow, colBarcode
'        SetText vasID, "", intRow, colPName
'        SetText vasID, "", intRow, colSex
'    End If
'
