   ...
   Begin TabDlg.SSTab stInterface 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin FPSpread.vaSpread vasWorkList 
            ...
            RetainSelBlock  =   0   'False
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":F3EE
            UserResize      =   2
         End
         Begin FPSpread.vaSpread vasID 
            ...
            RetainSelBlock  =   0   'False
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":FEC9
            UserResize      =   2
         End
         Begin VB.Label Label1 
            Appearance      =   0  '평면
            ...
            Case "R"    '## Result
                ...
                Select Case strIntBase
                    ...
                    Case "880" 'HIV
                        ...
                        End If
                End Select
'                If strIntBase = "430" Or strIntBase = "440" Or strIntBase = "410" Or strIntBase = "900" Or strIntBase = "880" Then
'                    If UCase(Trim(mGetP(strRcvBuf, 7, "|"))) = "N" Then
'                        strResult = "Neg(" & strResult & ")"
'                    ElseIf UCase(Trim(mGetP(strRcvBuf, 7, "|"))) = "P" Then
'                        strResult = "Neg(" & strResult & ")"
'                    End If
'                End If
