...
Begin VB.Form frmMain 
   ...
   Begin VB.Frame fraHidden 
      ...
      Begin MSComDlg.CommonDialog CFXFile 
         ...
         _Version        =   393216
      End
      Begin FPSpread.vaSpread spdOrder_PRT 
         Height          =   795
         Left            =   240
         TabIndex        =   79
         Top             =   4080
         ...
         SpreadDesigner  =   "frmMain.frx":618C
         ScrollBarTrack  =   3
         ShowScrollTips  =   3
      End
   ...
   Begin VB.PictureBox picComm 
      ...
      Begin FPSpread.vaSpread spdExcel 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmMain.frx":7E6D
      End
   ...
   Begin FPSpread.vaSpread spdResult 
      ...
      ScrollBarExtMode=   -1  'True
      ShadowColor     =   16777215
      SpreadDesigner  =   "frmMain.frx":809A
      ScrollBarTrack  =   3
      ShowScrollTips  =   3
   End
      ...
      Begin MSComctlLib.ImageList imlStatus 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMain.frx":8C7F
               Key             =   "RUN"
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMain.frx":9219
               Key             =   "NOT"
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMain.frx":97B3
               Key             =   "STOP"
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMain.frx":9D4D
               Key             =   "LST"
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMain.frx":A5DF
               Key             =   "ITM"
            EndProperty
            BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMain.frx":A739
               Key             =   "ERR"
            EndProperty
            BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMain.frx":A893
               Key             =   "NOF"
            EndProperty
            BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMain.frx":A9ED
               Key             =   "ON"
               Object.Tag             =   "OFF"
            EndProperty
            BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMain.frx":B2C7
               Key             =   ""
            EndProperty
         EndProperty
      End
   ...
   Begin FPSpread.vaSpread spdOrder 
      ...
      ScrollBarExtMode=   -1  'True
      ShadowColor     =   16777215
      SpreadDesigner  =   "frmMain.frx":E1B1
      ScrollBarTrack  =   3
      ShowScrollTips  =   3
   End
   Begin FPSpread.vaSpread spdWork 
      ...
      ScrollBarExtMode=   -1  'True
      ShadowColor     =   16777215
      SpreadDesigner  =   "frmMain.frx":FE82
      ScrollBarTrack  =   3
      ShowScrollTips  =   3
   End
...
Private Sub cmdPrint_Click()
    ...
    spdOrder_PRT.MaxRows = 0
    'spdOrder_PRT.MaxRows = 2
    With spdOrder
        For intRow = 1 To .MaxRows
            If GetText(spdOrder, intRow, colCHECKBOX) = "1" Then
                spdOrder_PRT.MaxRows = spdOrder_PRT.MaxRows + 1
                iRow = spdOrder_PRT.MaxRows
                For intCol = 1 To .MaxCols
                    Call SetText(spdOrder_PRT, GetText(spdOrder, intRow, intCol), iRow, intCol)
                Next
            End If
        Next
    End With
    ...
    spdOrder_PRT.PrintHeader = strHeader
    spdOrder_PRT.PrintOrientation = PrintOrientationLandscape 'PrintOrientationPortrait '세로출력   '

    spdOrder_PRT.Action = 13
...
Private Sub Excel_Open()
    ...
    '엑셀 열기
    With CFXFile
        .InitDir = gCFXCmnt.PATH  'App.PATH
        .Filename = "*.*"
        '.Filter = "Resource CSV (*.CSV)|*.CSV|All File (*.*)|*.*|"
        .Filter = "Excel(*.xlsx)|*.csv|Excel(*.xls)|*.xls|Excel(*.xlsx)|*.xlsx"
...
'        For i = 1 To .MaxRows
'            Call SetText(spdWork, "1", i, colCHECKBOX)
'            Call SetText(spdWork, CStr(i + 100), i, colBARCODE)
'        Next
'    End With
...
Private Sub FileRcvData_CFX96()
    ...
    Dim intSmpNo        As Integer
    Dim intIntNo        As Integer
    Dim intRstNo        As Integer
...
'On Error GoTo ErrHandle
    ...
    With frmMain
        For intRow = 2 To spdExcel.MaxRows
            ...
            intIntNo = 0
            intRstNo = 0
            For intCol = 1 To spdExcel.MaxCols
                If UCase(GetText(spdExcel, 1, intCol)) = "SAMPLE" Then
                    intSmpNo = intCol
                End If
                If UCase(GetText(spdExcel, 1, intCol)) = "TARGET" Then
                    intIntNo = intCol
                End If
                If UCase(GetText(spdExcel, 1, intCol)) = "CQ" Then
                    intRstNo = intCol
                End If
            Next
            
            strBarno = GetText(spdExcel, intRow, intSmpNo)
            ...
            'If IsNumeric(strBarno) Then
                ...
                intRcnt = intRcnt + 1
                strIntBase = GetText(spdExcel, intRow, intIntNo)
                strResult = GetText(spdExcel, intRow, intRstNo)
                strIntResult = strResult
...
'            End If
            ...
            For intCol = colITEMS To spdOrder.MaxCols
                ...
                End If
                If GetText(spdOrder, 0, intCol) = "RdRP/S" Then
                    strRdRP = GetText(spdOrder, intRow, intCol)
                End If
...
Private Sub FileRcvData_CFX96_SG()
    Dim RS_L            As ADODB.Recordset
...
'On Error GoTo ErrHandle
    ...
    With frmMain
        For intRow = 3 To spdExcel.MaxRows 'Step 4
            
            intSmpNo = 0
            intIntNo = 0
            intRstNo = 0
            For intCol = 1 To spdExcel.MaxCols
                If UCase(GetText(spdExcel, 1, intCol)) = "이름" Then
                    intSmpNo = intCol
                End If
                'If UCase(GetText(spdExcel, 1, intCol)) = "타겟" Then
                '    intIntNo = intCol
                'End If
                If UCase(GetText(spdExcel, 1, intCol)) = "WELL" Then
                    intWellNo = intCol
                End If
                If InStr(GetText(spdExcel, 1, intCol), "해석") > 0 Then
                    intRstNo = intCol
                End If
            Next
            
            strBarno = GetText(spdExcel, intRow, intSmpNo)
            strRackNo = GetText(spdExcel, intRow, intWellNo) 'Well
            ...
            'If IsNumeric(strBarno) Then
                ...
                For intCol = 6 To spdExcel.MaxCols Step 2
                    intRcnt = intRcnt + 1
                    strIntBase = GetText(spdExcel, 2, intCol)
                    If InStr(strIntBase, "해석") > 0 Then
                        strIntBase = "COVID19"
                        strResult = GetText(spdExcel, intRow, intCol)
                    Else
                        strResult = GetText(spdExcel, intRow, intCol + 1)
                        strIntResult = strResult
                    End If
...
ErrHandle:
    strErrMsg = ""
    strErrMsg = strErrMsg & "위    치 : " & gHOSP.MACHNM & "_FileRcvData_CFX96_SG" & vbNewLine & vbNewLine
    strErrMsg = strErrMsg & "오류번호 : " & Err.Number & vbNewLine & vbNewLine
    strErrMsg = strErrMsg & "오류내용 : " & Err.Description & vbNewLine
    frmErrMsg.txtErr = vbNewLine & strErrMsg
    frmErrMsg.Show
...
Private Sub FileRcvData_CFX96_OSANG()
    Dim RS_L            As ADODB.Recordset
...
On Error GoTo ErrHandle
    ...
    With frmMain
        If UCase(GetText(spdExcel, 6, 1)) <> "COVID-19" Then
            Exit Sub
        End If
        
        For intRow = 7 To 8
            For intCol = 1 To spdExcel.MaxCols
                Debug.Print UCase(GetText(spdExcel, intRow, intCol))
                If UCase(GetText(spdExcel, intRow, intCol)) = "NO." Then
                    intNo = intCol
                End If
                If UCase(GetText(spdExcel, intRow, intCol)) = "SAMPLE" Then
                    intSmpNo = intCol
                End If
                If UCase(GetText(spdExcel, intRow, intCol)) = "WELL" Then
                    intWellNo = intCol
                End If
                If UCase(GetText(spdExcel, intRow, intCol)) = "RDRP" Then
                    intRdrp = intCol
                End If
                If UCase(GetText(spdExcel, intRow, intCol)) = "N" Then
                    intN = intCol
                End If
                If UCase(GetText(spdExcel, intRow, intCol)) = "E" Then
                    intE = intCol
                End If
                If UCase(GetText(spdExcel, intRow, intCol)) = "IC" Then
                    intIC = intCol
                End If
                If UCase(GetText(spdExcel, intRow, intCol)) = "RESULT" Then
                    intRstNo = intCol
                End If
                If UCase(GetText(spdExcel, intRow, intCol)) = "CHECK" Then
                    intCheck = intCol
                End If
            Next
        Next
        
        For intRow = 9 To spdExcel.MaxRows
            strRackNo = GetText(spdExcel, intRow, intWellNo)
            strBarno = GetText(spdExcel, intRow, intNo)
            If strBarno = "" Then
                strBarno = GetText(spdExcel, intRow, intSmpNo)
            End If
...
'                End If
            ...
            For intCol = 4 To spdExcel.MaxCols
                strIntBase = ""
                strResult = GetText(spdExcel, intRow, intCol)
                strIntResult = strResult
                Select Case intCol
                    Case 4:     strIntBase = "RdRp"
                                strRdRpVal = strResult
                    ...
                    Case 7:     strIntBase = "IC"
                                strICVal = strResult
                    
                    Case 9:
                                strIntBase = "Check"
                                strCovResult = strResult
                    Case 10:
                                strIntBase = "Comment"
                                If strCovResult = "Positive" Then
                                    strResult = ""
                                    strResult = strResult & "Comment Ct값 : "
                                    strResult = strResult & "E gene = " & strEVal
                                    strResult = strResult & " RdRp gene = " & strRdRpVal
                                    strResult = strResult & " N gene = " & strNVal
                                    strResult = strResult & " (Cut off:40 Ct)" & vbCrLf
                                ElseIf strCovResult = "미결정" Or strCovResult = "Inconclusive" Then
                                    strResult = ""
                                    strResult = strResult & "Comment Ct값 : "
                                    strResult = strResult & "E gene = " & strEVal
                                    strResult = strResult & " RdRp gene = " & strRdRpVal
                                    ...
                                    strResult = strResult & "본 환자의 경우 미결정 유형입니다. 상기 검사 대상자는 검체를 재채취하여 재검사를 하는 것을 권장합니다." & vbCrLf
                                Else
                                    strResult = ""
                                End If
                                strIntResult = strResult
...
ErrHandle:
    strErrMsg = ""
    strErrMsg = strErrMsg & "위    치 : " & gHOSP.MACHNM & "_FileRcvData_CFX96_OSANG" & vbNewLine & vbNewLine
    strErrMsg = strErrMsg & "오류번호 : " & Err.Number & vbNewLine & vbNewLine
    strErrMsg = strErrMsg & "오류내용 : " & Err.Description & vbNewLine
    frmErrMsg.txtErr = vbNewLine & strErrMsg
    frmErrMsg.Show
...
Private Sub FileRcvData_CFX96_SD()
    Dim RS_L            As ADODB.Recordset
...
'On Error GoTo ErrHandle
    ...
    With frmMain
        For intRow = 2 To spdExcel.MaxRows Step 4
            ...
            For intCol = 1 To spdExcel.MaxCols
                ...
                If UCase(GetText(spdExcel, 1, intCol)) = "WELL" Then
                    intWellNo = intCol
                End If
                If UCase(GetText(spdExcel, 1, intCol)) = "자동 해석" Then
                    intRstNo = intCol
                End If
            Next
...
ErrHandle:
    strErrMsg = ""
    strErrMsg = strErrMsg & "위    치 : " & gHOSP.MACHNM & "_FileRcvData_CFX96_SD" & vbNewLine & vbNewLine
    strErrMsg = strErrMsg & "오류번호 : " & Err.Number & vbNewLine & vbNewLine
    strErrMsg = strErrMsg & "오류내용 : " & Err.Description & vbNewLine
    frmErrMsg.txtErr = vbNewLine & strErrMsg
    frmErrMsg.Show
...
Private Sub FileRcvData_CFX96_RV16()
    Dim RS_L            As ADODB.Recordset
...
'On Error GoTo ErrHandle
    ...
    With frmMain
        For intRow = 2 To spdExcel.MaxRows Step 2
            ...
            'If IsNumeric(strBarno) Then
                ...
                For intCol = intSmpNo + 2 To spdExcel.MaxCols Step 2
                    strIntBase = GetText(spdExcel, intRow, intCol)
                    strResult = GetText(spdExcel, intRow + 1, intCol)
                    ...
                    If UCase(strIntBase) = "FLU A" Then
                        strFluA = strResult
                    End If
                    
                    If UCase(strIntBase) = "PDM09" Then
                        strPdm09 = strResult
                    End If
                    
                    If UCase(strIntBase) = "H1" Then
                        strH1 = strResult
                    End If
                    
                    If UCase(strIntBase) = "H3" Then
                        strH3 = strResult
                    End If
                ...
                If intRowcnt = 3 Then
                    ...
                    strPosVal = ""
                    'If strFluA = "Positive" Then
                        If strPdm09 = "Positive" Then
                            strPosVal = "H1pdm09"
                        End If
                        If strH1 = "Positive" Then
                            If strPosVal <> "" Then
                                strPosVal = strPosVal & ",H1"
                            Else
                                strPosVal = "H1"
                            End If
                        End If
                        If strH3 = "Positive" Then
                            If strPosVal <> "" Then
                                strPosVal = strPosVal & ",H3"
                            Else
                                strPosVal = "H3"
                            End If
                        End If
...
ErrHandle:
    strErrMsg = ""
    strErrMsg = strErrMsg & "위    치 : " & gHOSP.MACHNM & "_FileRcvData_CFX96_RV16" & vbNewLine & vbNewLine
    strErrMsg = strErrMsg & "오류번호 : " & Err.Number & vbNewLine & vbNewLine
    strErrMsg = strErrMsg & "오류내용 : " & Err.Description & vbNewLine
    frmErrMsg.txtErr = vbNewLine & strErrMsg
    frmErrMsg.Show
...
Private Sub FileRcvData_CFX96_RP5()
    Dim RS_L            As ADODB.Recordset
...
'On Error GoTo ErrHandle
    ...
    With frmMain
        For intRow = 3 To spdExcel.MaxRows 'Step 6
            ...
            'If IsNumeric(strBarno) Then
                ...
                For intCol = 6 To spdExcel.MaxCols
                    strIntBase = GetText(spdExcel, 2, intCol)
                    strResult = GetText(spdExcel, intRow, intCol)
                    If strResult = "-" Then
                        strResult = "Negative"
...
ErrHandle:
    strErrMsg = ""
    strErrMsg = strErrMsg & "위    치 : " & gHOSP.MACHNM & "_FileRcvData_CFX96_RP5" & vbNewLine & vbNewLine
    strErrMsg = strErrMsg & "오류번호 : " & Err.Number & vbNewLine & vbNewLine
    strErrMsg = strErrMsg & "오류내용 : " & Err.Description & vbNewLine
    frmErrMsg.txtErr = vbNewLine & strErrMsg
    frmErrMsg.Show
...
Private Function ResultProcess(ByVal pBarNo As String, ByVal pIntBase As String, ByVal pResult As String, ByVal pIntResult As String) As Boolean
    ...
    Dim strAbbrName     As String   '검사코드
    Dim strSeqNo        As String   '검사순번
    Dim strSendChannel  As String   '검사코드
    Dim strTestCode     As String   '검사코드
    Dim strTestCodeSub  As String   '검사코드SUB
    Dim strCheck        As String   '검사오더체크
    Dim intResPrecUse   As Integer  '소수점변환여부
    ...
    SQL = ""
    SQL = SQL & "SELECT EQPMASTER.SENDCHANNEL, EQPMASTER.TESTCODE,TESTNAME,ABBRNAME,EQPMASTER.SEQNO,REFMLOW,REFMHIGH,REFFLOW,REFFHIGH,RESPRECUSE,RESPREC,RESTYPE   " & vbCrLf
    ...
    If Not RS_L.EOF = True And Not RS_L.BOF = True Then
        ...
        strSendChannel = Trim(RS_L.Fields("SENDCHANNEL")) & ""
        ...
        '--COVID19
        If Mid(UCase(pResult), 1, 3) = "POS" Then
            strJudge = "H"
        End If
        ...
        With frmMain
            ...
            SetText .spdResult, strSeqNo, intRstRow, colRSEQNO                  '순번
            'SetText .spdResult, strOrderCode, intRstRow, colRORDERCD            '처방코드
            SetText .spdResult, strSendChannel, intRstRow, colRORDERCD            '처방코드
            SetText .spdResult, strTestCode, intRstRow, colRTESTCD          '검사코드
            SetText .spdResult, strTestCodeSub, intRstRow, colRSUBCD        '검사코드SUB
            SetText .spdResult, strTestName, intRstRow, colRTESTNM              '검사명
...
'    Me.Height = 12585
    ...
    With spdOrder
        '16
        'Call SetText(spdOrder, "등록번호", 0, colPID)
        '17
        'Call SetText(spdOrder, "특수번호", 0, colCHARTNO)
    End With
...
'    Call SetColumnHeader(spdOrder)
    ...
    Call SetColumnView(spdOrder_PRT)
    ...
    With spdOrder
        ...
        If Index = 0 Then
            ...
            For i = colSTATE + 1 To .MaxCols
                ...
                'Debug.Print GetText(spdOrder, 0, i)
                
                If Mid(UCase(GetText(spdOrder, 0, i)), 1, 8) = "COVID-19" Then
                    .ColHidden = False
                Else
                    If UCase(GetText(spdOrder, 0, i)) = "E" Or UCase(GetText(spdOrder, 0, i)) = "RDRP" Or UCase(GetText(spdOrder, 0, i)) = "RDRP/S" Or UCase(GetText(spdOrder, 0, i)) = "N" Or UCase(GetText(spdOrder, 0, i)) = "ICA" Then
                    'If UCase(GetText(spdOrder, 0, i)) = "E" Or UCase(GetText(spdOrder, 0, i)) = "RDRP" Or UCase(GetText(spdOrder, 0, i)) = "N" Or UCase(GetText(spdOrder, 0, i)) = "ICA" Then
                        .ColHidden = False
                    Else
                        .ColHidden = True
                    End If
        ...
        ElseIf Index = 1 Then
            For i = colSTATE + 1 To .MaxCols
                ...
                If Len(GetText(spdOrder, 0, i)) > 3 Then
                    .ColHidden = False
    ...
    With spdOrder_PRT
        ...
        If Index = 0 Then
            ...
            For i = colSTATE + 1 To .MaxCols
                ...
                'Debug.Print GetText(spdOrder_PRT, 0, i)
                
                If Mid(UCase(GetText(spdOrder_PRT, 0, i)), 1, 8) = "COVID-19" Then
                    .ColHidden = False
                Else
                    If UCase(GetText(spdOrder_PRT, 0, i)) = "E" Or UCase(GetText(spdOrder_PRT, 0, i)) = "RDRP" Or UCase(GetText(spdOrder_PRT, 0, i)) = "RDRP/S" Or UCase(GetText(spdOrder_PRT, 0, i)) = "N" Or UCase(GetText(spdOrder_PRT, 0, i)) = "ICA" Then
                        .ColHidden = False
                    Else
                        .ColHidden = True
                    End If
        ...
        ElseIf Index = 1 Then
            For i = colSTATE + 1 To .MaxCols
                ...
                If Len(GetText(spdOrder_PRT, 0, i)) > 3 Then
                    .ColHidden = False
