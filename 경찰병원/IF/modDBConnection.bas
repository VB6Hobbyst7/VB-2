...
On Error GoTo ConnectError
    ...
    If ServerName = "" Then
        Select Case gEMR
            ...
            Case "HCMS":        ServerName = "LIME_SEOUL"
            Case "NPH":         ServerName = "NPHHISP"  '경찰병원
        End Select
    End If
    ...
    If UserName = "" Then
        Select Case gEMR
            ...
            Case "HCMS":        UserName = "hcms"
            Case "NPH":         UserName = "lis_inf"    '경찰병원
        End Select
    End If
    ...
    If Password = "" Then
        Select Case gEMR
            ...
            Case "HCMS":        Password = "iamhcms"
            Case "NPH":         Password = "lisprod"  '경찰병원
        End Select
    End If
