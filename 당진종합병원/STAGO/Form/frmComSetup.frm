...
Begin VB.Form frmComSetup 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.TextBox txtURL 
         ...
         Width           =   8295
      End
      Begin BHButton.BHImageButton cmdURLEdit 
         Height          =   300
         Left            =   9960
         TabIndex        =   85
         Top             =   480
         ...
         ImgOutLineSize  =   3
      End
      Begin BHButton.BHImageButton cmdInstEdit 
         Height          =   300
         Left            =   3030
         TabIndex        =   86
         Top             =   930
...
Private Sub cmdInstEdit_Click()

    Call WritePrivateProfileString("CONFIG", "INSTCD", txtInstCd.text, App.Path & "\Interface.ini")
...
Private Sub cmdURLEdit_Click()

    Call WritePrivateProfileString("CONFIG", "URL", txtURL.text, App.Path & "\Interface.ini")
