   ...
   Begin TabDlg.SSTab stInterface 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin FPSpread.vaSpread vasRes 
            ...
            RetainSelBlock  =   0   'False
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":935D
         End
...
Private Sub SendOrder()
    ...
    With vasID
        .Row = mOrder.Row
        .Col = colCount:                  lngTotCnt = CLng(.Text)
        .Col = colSndCnt:                 lngSndCnt = CLng(.Text)
        .Col = colIntBase + lngSndCnt:    strIntBase = CStr(.Text)
        ...
        .Col = colSndCnt: .Text = CStr(lngSndCnt)
...
Private Sub vasID_Click(ByVal Col As Long, ByVal Row As Long)
    ...
    '장비코드, 검사코드, 검사명, 결과, 순번
          SQL = "SELECT DISTINCT a.COMEXAMID, a.EXAMID, b.EXAMNAME, a.RESULT, a.EXAMNO, a.TRANSYN " & vbCrLf
    ...
    SQL = SQL & "   AND a.EXAMTYPE = 'I' " & vbCrLf
