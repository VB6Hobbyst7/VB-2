...
Begin VB.Form frmInterface 
   ...
   Begin TabDlg.SSTab stInterface 
      ...
      EndProperty
      TabCaption(0)   =   "Ãâ·Â"
      TabPicture(0)   =   "frmInterface.frx":09CC
      ...
      TabCaption(1)   =   "ÀçÃâ·Â"
      TabPicture(1)   =   "frmInterface.frx":09E8
      ...
      TabCaption(2)   =   "¿öÅ©¸®½ºÆ®"
      TabPicture(2)   =   "frmInterface.frx":0A04
      ...
      Begin VB.Frame Frame7 
         ...
         Begin VB.ComboBox cboPart 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmInterface.frx":0A20
            Left            =   3720
            List            =   "frmInterface.frx":0A22
            TabIndex        =   103
            Top             =   210
            Width           =   2025
         End
         ...
         Begin FPSpread.vaSpread vasWorkPrint 
            ...
            SpreadDesigner  =   "frmInterface.frx":0A24
         End
      ...
      Begin VB.Frame Frame6 
         ...
         Begin VB.ComboBox cboWorkList 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmInterface.frx":155C
            Left            =   5130
            List            =   "frmInterface.frx":155E
            TabIndex        =   84
            Top             =   210
            Width           =   2025
         End
         ...
         Begin FPSpread.vaSpread vasRePrint 
            ...
            Protect         =   0   'False
            RetainSelBlock  =   0   'False
            SpreadDesigner  =   "frmInterface.frx":1560
         End
      ...
      Begin VB.Frame Frame4 
         ...
         Begin FPSpread.vaSpread vasPrint 
            ...
            Protect         =   0   'False
            RetainSelBlock  =   0   'False
            SpreadDesigner  =   "frmInterface.frx":1FFE
         End
      ...
      Begin VB.Frame Frame2 
         ...
         Begin FPSpread.vaSpread vasRRes 
            ...
            RetainSelBlock  =   0   'False
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":2A9C
         End
         ...
         Begin FPSpread.vaSpread vasRID 
            ...
            RetainSelBlock  =   0   'False
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":6805
            UserResize      =   2
         End
      ...
      Begin VB.Frame Frame8 
         ...
         Begin VB.ComboBox Combo1 
            Height          =   315
            ItemData        =   "frmInterface.frx":7325
            Left            =   5160
            List            =   "frmInterface.frx":7327
            TabIndex        =   29
            Top             =   900
            Visible         =   0   'False
            Width           =   1395
   ...
   Begin VB.Frame Frame1 
      ...
      Begin FPSpread.vaSpread vasWork 
         ...
         ShadowDark      =   13815180
         SpreadDesigner  =   "frmInterface.frx":7329
      End
      ...
      Begin FPSpread.vaSpread vasList 
         ...
         ShadowDark      =   13815180
         SpreadDesigner  =   "frmInterface.frx":A2AC
      End
      ...
      Begin FPSpread.vaSpread vasTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":BA4E
      End
      Begin FPSpread.vaSpread vasResTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":FFA7
      End
...
'                Case 7: '-- ³ªÀÌ
        ...
        If strPart = "Immuno" Then
            .Output = "P1," & txtCnt2.Text & vbCrLf
        Else
