...
Begin VB.Form frmInterface 
   ...
   Begin VB.Frame Frame4 
      ...
      Begin FPSpread.vaSpread vasPrintBuf 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":1A00
      End
   End
   Begin VB.Frame FrmHideControl 
      ...
      Begin FPSpread.vaSpread vasCode 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":21B0
      End
      ...
      Begin FPSpread.vaSpread vasTemp1 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":23D6
      End
      Begin FPSpread.vaSpread vasList 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":25FC
      End
      Begin FPSpread.vaSpread vasResTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":2822
      End
      Begin FPSpread.vaSpread vasTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":2A48
      End
   ...
   Begin TabDlg.SSTab stInterface 
      ...
      TabPicture(0)   =   "frmInterface.frx":2C6E
      Tab(0).ControlEnabled=   -1  'True
      Tab(0).Control(0)=   "Frame1"
      Tab(0).Control(0).Enabled=   0   'False
      Tab(0).ControlCount=   1
      TabCaption(1)   =   "받은결과"
      TabPicture(1)   =   "frmInterface.frx":2C8A
      ...
      Begin VB.Frame Frame3 
         ...
         Begin FPSpread.vaSpread vasRRes 
            ...
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":2CA6
         End
         Begin FPSpread.vaSpread vasRID 
            ...
            RetainSelBlock  =   0   'False
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":69E9
            UserResize      =   2
         End
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.Frame FrmUseControl 
            ...
            Begin VB.Timer tmrAck 
               ...
               Top             =   1320
            End
            Begin MSWinsockLib.Winsock wSckResult 
               Left            =   1950
               Top             =   870
               _ExtentX        =   741
               _ExtentY        =   741
            ...
            Begin HAN2ENGOCXLib.Han2EngOCX Han2Eng 
               ...
               _StockProps     =   0
            End
            Begin MSWinsockLib.Winsock wSckOrder 
               Left            =   1380
               Top             =   870
               _ExtentX        =   741
               _ExtentY        =   741
         ...
         Begin FPSpread.vaSpread vasID 
            ...
            RetainSelBlock  =   0   'False
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":7428
            UserResize      =   2
         End
         Begin FPSpread.vaSpread vasRes 
            ...
            RetainSelBlock  =   0   'False
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":7EE1
         End
...
Private Sub cmdOrder_Click()
    ...
    Dim strOrderCont    As String
    
    strSendData = ""
    strNow = Format(Now, "yyyymmddhhmmss")
    
    strOrderCont = "NW" 'New order
    
    '재검
    If chkRerun.Value = "1" Then
        strOrderCont = "RF"
    End If
    ...
    With vasID
        ...
        For i = 1 To .DataRowCnt
            If GetText(vasID, i, colCheckBox) = "1" And GetText(vasID, i, colState) = "" Then
                
                With mOrder
                    .BarNo = GetText(vasID, i, colBarcode)
                    .PID = GetText(vasID, i, colPID)
                    .PName = GetText(vasID, i, colPName)
                    .PDOB = GetText(vasID, i, colPos)
                    .PSex = GetText(vasID, i, colSex)
                    .PAge = GetText(vasID, i, colAge)
                End With
'
''20:39:48 [Tx]MSH|^~\&|LIS|LIS|YP8K|YP8K|20210816203948||OML^O33^OML_O33|1111941012|P|2.5|||||||
''PID|||^^^LIS^PI||^^^||||||^^^^^^|||||||^^LIS|||||||||||||N|AL
''PV1||N|^^||||^||||||||||^||^|||||||||||||||||||||||||20210816203948|20210816203948
''SPM|1|||EDTA||||MAIN LAB|||||||||20210816203948|20210816203948|||||
''ORC|NW|||||||20210816203948||||||||||||
''TQ1|||||||20210816203948||R
''OBR|1|||CBC^CBC profile^YP8K|||||||||||||||||||||P
''ORC|NW||||||||20210816203948||||||||||||
''TQ1|||||||20210816203948||R
''OBR|1|||DIF^DIF profile^YP8K|||||||||||||||||||||P
'
'
''20:39:49 [Rx]MSH|^~\&|HALIA|^^|^^|^^|20210816203848||ORL^O34^ORL_O34|HALIA20210816203848|P|2.5|||||||
''MSA|AR|1111941012
''ERR||||E|||Generic error during sample update|application error
''
'
'
'
               ' mOrder.BarNo = Mid(mOrder.BarNo, 1, 11)
                
                strSendData = ""
                strSendData = strSendData & SB & "MSH|^~\&|LIS|LIS|YP8K|YP8K|" & strNow & "||OML^O33^OML_O33|1111941012|P|2.5|||||||" & vbCr
                strSendData = strSendData & "PID|||" & mOrder.PID & "^^^LIS^PI||^" & Han2Eng.HanToEng(mOrder.PName) & "^^||" & mOrder.PDOB & "|" & mOrder.PSex & "|||^^^^^^|||||||^^LIS|||||||||||||N|AL" & vbCr
                strSendData = strSendData & "PV1||N|^^||||^||||||||||^||^|||||||||||||||||||||||||" & strNow & "|" & strNow & vbCr
                strSendData = strSendData & "SPM|1|" & mOrder.BarNo & "||EDTA||||MAIN LAB|||||||||" & strNow & "|" & strNow & "|||||" & vbCr
                If GetText(vasID, i, colRack) = "CD" Then
                    strSendData = strSendData & "ORC|" & strOrderCont & "|" & mOrder.BarNo & "|" & mOrder.BarNo & "|||||" & strNow & "||||||||||||" & vbCr
                    strSendData = strSendData & "TQ1|||||||" & strNow & "||R" & vbCr
                    strSendData = strSendData & "OBR|1|" & mOrder.BarNo & "|" & mOrder.BarNo & "|CBC^CBC profile^YP8K|||||||||||||||||||||P" & vbCr
                    strSendData = strSendData & "ORC|" & strOrderCont & "|" & mOrder.BarNo & "|" & mOrder.BarNo & "|" & mOrder.BarNo & "|||||" & strNow & "||||||||||||" & vbCr
                    strSendData = strSendData & "TQ1|||||||" & strNow & "||R" & vbCr
                    strSendData = strSendData & "OBR|1|" & mOrder.BarNo & "|" & mOrder.BarNo & "|DIF^DIF profile^YP8K|||||||||||||||||||||P" & vbCr
                ElseIf GetText(vasID, i, colRack) = "C" Then
                    strSendData = strSendData & "ORC|" & strOrderCont & "|" & mOrder.BarNo & "|" & mOrder.BarNo & "|||||" & strNow & "||||||||||||" & vbCr
                    strSendData = strSendData & "TQ1|||||||" & strNow & "||R" & vbCr
                    strSendData = strSendData & "OBR|1|" & mOrder.BarNo & "|" & mOrder.BarNo & "|CBC^CBC profile^YP8K|||||||||||||||||||||P" & vbCr
                Else
                    '오더를 안줄지 cbc 만찍을건지 확인할 것.
                    'strSendData = strSendData & "ORC|NW|" & mOrder.BarNo & "|" & mOrder.BarNo & "|||||" & strNow & "||||||||||||" & vbCr
                    'strSendData = strSendData & "TQ1|||||||" & strNow & "||R" & vbCr
                    'strSendData = strSendData & "OBR|1|" & mOrder.BarNo & "|" & mOrder.BarNo & "|CBC^CBC profile^YP8K|||||||||||||||||||||P" & vbCr
                End If
                strSendData = strSendData & EB & vbCr
                
                wSckOrder.SendData strSendData
                Call SetRawData("[Tx]" & strSendData)
                Call Sleep(200)
                
                Call SetText(vasID, "0", i, colCheckBox)
                Call SetText(vasID, "오더전송", i, colState)
...
'    vasRID.MaxRows = 100
'    For iRow = 1 To 100
'        SetText vasRID, iRow + 12000000, iRow, colBarcode
'        SetText vasRID, "홍길동" & iRow, iRow, colPName
'        SetText vasRID, 12.5 & iRow, iRow, colState + 1
'        SetText vasRID, 568 & iRow, iRow, vasRID.MaxCols
'    Next
'    Exit Sub
'
...
'''    Next iRow
          ...
          SQL = "SELECT DiSTINCT a.BARCODE, a.CHARTNO, a.PATNAME, a.PATSEX, a.PATAGE, a.COMEXAMID, a.EXAMID, b.EXAMNAME, a.RESULT, a.EXAMNO,  a.TRANSYN " & vbCrLf
    ...
    SQL = SQL & "   AND a.COMMDATE = '" & Format(dtpExamDate.Value, "yyyymmdd") & "'" & vbCrLf
    'SQL = SQL & "   AND a.BARCODE = '" & lsID & "' " & vbCrLf
'    SQL = SQL & "   AND b.EQUIPCODE = '" & gEquip & "' " & vbCrLf
    SQL = SQL & "   AND a.EXAMTYPE = 'H' " & vbCrLf
    SQL = SQL & " ORDER BY  a.BARCODE    "
    
    Set rs_svr = cn.Execute(SQL)
    If Not rs_svr.EOF = True And Not rs_svr.BOF = True Then
        Do Until rs_svr.EOF
            strBarcode = GetText(vasRID, intRow, colBarcode)
            If strBarcode <> Trim(rs_svr.Fields("BARCODE")) & "" Then
                vasRID.MaxRows = vasRID.MaxRows + 1
                intRow = vasRID.MaxRows

                SetText vasRID, "1", intRow, colCheckBox
                SetText vasRID, Trim(rs_svr.Fields("BARCODE")) & "", intRow, colBarcode
                SetText vasRID, Trim(rs_svr.Fields("PATNAME")) & "", intRow, colPName
                SetText vasRID, Trim(rs_svr.Fields("CHARTNO")) & "", intRow, colPID
                SetText vasRID, Trim(rs_svr.Fields("PATSEX")) & "", intRow, colSex
                SetText vasRID, Trim(rs_svr.Fields("PATAGE")) & "", intRow, colAge
                
            End If
            
            For intCol = colState + 1 To vasRID.MaxCols
                vasRID.Row = 0
                vasRID.Col = intCol
                If Trim(rs_svr.Fields("EXAMNAME")) & "" = Trim(vasRID.Text) Then
                    SetText vasRID, Trim(rs_svr.Fields("RESULT")) & "", intRow, intCol
                    Exit For
                End If
            Next
            rs_svr.MoveNext
...
'    End If
    ...
    wSckOrder.Close
    wSckOrder.Connect "192.168.10.101", CInt(10001)
                
    wSckResult.LocalPort = CInt(10002)
    wSckResult.Listen
...
Private Sub EditRcvData()
    ...
    Dim strBaso     As String
    Dim strSndBuffer    As String
    Dim strOBRNum   As String
    ...
    For intCnt = 0 To UBound(strRecvData)
        ...
        Call SetSQLData(strRcvBuf & vbCrLf)
        
        
        strType = mGetP(strRcvBuf, 1, "|")
'PID|||2000193989^^^LIS^PI||^HWANG A LEUM ^^^^^|||M|||^^^^^^||||||||||||||||||||Y
'PV1||N|^^||||^||||||||||^|||||||||||||||||||||||||||20210816205722|20210816205722
'SPM|1|08162000193989||EDTA||||MAIN LAB
'OBX|1|NM|NEU#^NEU#||5.14|10\S\3/mm3|||||F|||20210816124443||||H1500
'
'
'
        Select Case strType
            Case "MSH"
                '21:28:57 [Rx]MSH|^~\&|HALIA|^^|^^|^^|20210816212756||OUL^R22^OUL_R22|HALIA20210816212756|P|2.5|||||||
                mOrder.MsgCtrlID = mGetP(strRcvBuf, 10, "|")
                
''                strSndBuffer = ""
''                strSndBuffer = strSndBuffer & SB
''                '메뉴얼
''                                              'MSH|^~\&|^|^|YP8K|^|20160705120956||ACK|YP8K20160705100955|P|2.5||||||<CR>
''                strSndBuffer = strSndBuffer & "MSH|^~\&|^|^|YP8K|^|" & Format(Now, "yyyymmddhhmmss") & "|||" & mOrder.MsgCtrlID & "|P|2.5||||||" & vbCr
''                strSndBuffer = strSndBuffer & "MSA|AA|" & mOrder.MsgCtrlID & vbCr
''
''                'strSndBuffer = strSndBuffer & "MSH|^~\&|^|^|YP8K|^|" & Format(Now, "yyyymmddhhmmss") & "||ACK|YP8K20160705100955|P|2.5||||||" & vbCr
''                'strSndBuffer = strSndBuffer & "MSA|AA|YP8K20160705100955" & vbCr
''
''
'''                strSndBuffer = strSndBuffer & "MSH|^~\&|^|^|YP8K|^|20160705120956||ACK|YP8K20160705100955|P|2.5||||||" & vbCr
'''                strSndBuffer = strSndBuffer & "MSA|AA|YP8K20160705100955" & vbCr
''
''
''                strSndBuffer = strSndBuffer & EB & vbCr
''
''                Call SetRawData(vbCrLf & vbCrLf & "[Tx]" & strSndBuffer & vbCrLf & vbCrLf)
''                wSckResult.SendData strSndBuffer
                
            Case "PID"          'PID|||1909000^^^LIS^PI||^go gwang su^^^^^||19720120|M|||^^^^^^||||||||||||||||||||Y
            
            Case "PV1"          'PV1||N|^^||||^||||||||||^|||||||||||||||||||||||||||20190614074613|20190614074613
            Case "SPM"          'SPM|1|1111941024||EDTA||||MAIN LAB
                
                'mOrder.MsgCtrlID = mGetP(strRcvBuf, 10, "|")
                
                
                'MsgBox mOrder.MsgCtrlID
'MSH|^~\&|^|^|YP8K|^|20190626042802||ACK|HALIA20190625192833|P|2.5||||||
'MSA|AA|HALIA20190625192833
''
'
'
                ...
                If IsNumeric(strBarno) Then
                    '## 바코드번호 조회
                    strBarno = Format$(strBarno, "00000000000000")
                End If
                With mResult
                    .BarNo = strBarno
                End With
            ...
            Case "OBR"          'OBR|1|||PCT^PCT^HALIA|||20190614074600||||||||||||||||||F|||||||ruleResult
                strOBRNum = Trim(mGetP(strRcvBuf, 2, "|"))
                
            Case "ORC"          'ORC|SC||||A||||20190613225047||||||||||||^^^^^^^^^
            Case "TQ1"          'TQ1|||||||20190614074613||R
            Case "OBX"          'OBX|1|NM|PCT^PCT||0.107|%|0.15 - 0.5|L|||F|||20190614074847||||YH2500-SPS
                
                'OBX|1|NM|WBC^WBC||8.81|10\S\3/mm3|||||F|||20210816124443||||H1500

                '## 장비기준 검사명, 결과, Abnormal Flag
                strIntBase = Trim(mGetP(mGetP(strRcvBuf, 4, "|"), 1, "^"))
                strResult = Trim(mGetP(strRcvBuf, 6, "|"))
                strFlag = Trim(mGetP(strRcvBuf, 3, "|"))
                ...
                If strFlag = "NM" Then
                    ...
                    If strIntBase = "MON%" Then
                        strMono = strResult
                    ElseIf strIntBase = "EOS%" Then
                        strEos = strResult
                    ElseIf strIntBase = "BAS%" Then
                        strBaso = strResult
                    End If
   ...
   ' Call SetSQLData("strOBRNum >" & strOBRNum & vbCrLf)


    If MnTransAuto.Checked = True And strState = "R" Then
                    '-- DIFF 세개 결과중 하나라도 수치가 장=ㄹ못 나오면 저장하지 않는다.
'                    If Not IsNumeric(strMono) Or Not IsNumeric(strEos) Or Not IsNumeric(strBaso) Then
'                        Exit Sub
'                    End If
        'MsgBox "1"
        Res = SaveTransDataW(gRow)
...
'    SQL = SQL & "'" & gIFUser & "')"
    ...
    SQL = SQL & " COMEXAMID = '" & Trim(GetText(vasRes, asRow2, colEquipCode)) & "' " & vbCrLf
...
Private Sub tmrAck_Timer()
    ...
    '메뉴얼
                                  'MSH|^~\&|^|^|YP8K|^|20160705120956||ACK|YP8K20160705100955|P|2.5||||||<CR>
    strSndBuffer = strSndBuffer & "MSH|^~\&|^|^|YP8K|^|" & Format(Now, "yyyymmddhhmmss") & "||ACK|" & mOrder.MsgCtrlID & "|P|2.5||||||" & vbCr
    strSndBuffer = strSndBuffer & "MSA|AA|" & mOrder.MsgCtrlID & vbCr
...
Private Sub tmrRcv_Timer()
    tmrRcv.Enabled = False
   
    strRecvData = Split(strBuffer, vbCr)
         
    If UBound(strRecvData) > 0 Then
    
        Call SetSQLData("UBound(strRecvData) >" & UBound(strRecvData) & vbCrLf)

        Call EditRcvData
        tmrAck.Interval = 1000
        tmrAck.Enabled = True
    End If
...
Private Sub wSckOrder_Close()
        
    'If gComm.TCPTYPE = "SERVER" Then
        wSckOrder.Close
        wSckOrder.LocalPort = CInt(5150)
        wSckOrder.Listen
...
Private Sub wSckOrder_ConnectionRequest(ByVal requestID As Long)
            
    If wSckOrder.State <> sckClosed Then
        wSckOrder.Close

        wSckOrder.Accept requestID
'        imgPort.Picture = imlStatus.ListImages("RUN").ExtractIcon
'        If gComm.TCPTYPE = "SERVER" Then
'            lblComStatus.Caption = "TCP " & gComm.TCPPORT & " 포트 연결성공"
'            imgOn.ZOrder 0
...
Private Sub wSckOrder_DataArrival(ByVal bytesTotal As Long)
    Dim strText     As String
    Dim varBuffers  As Variant
    
    wSckOrder.GetData strText
    
    SetRawData "[Rx]" & strText
    
    strRecvData = Split(strText, vbCr)
    Call Sleep(200)
...
Private Sub wSckResult_Close()
        
    'If gComm.TCPTYPE = "SERVER" Then
        wSckResult.Close
        wSckResult.LocalPort = CInt(5151)
        wSckResult.Listen
...
Private Sub wSckResult_Connect()
...
Private Sub wSckResult_ConnectionRequest(ByVal requestID As Long)
            
    If wSckResult.State <> sckClosed Then
        wSckResult.Close

        wSckResult.Accept requestID
'        imgPort.Picture = imlStatus.ListImages("RUN").ExtractIcon
'        If gComm.TCPTYPE = "SERVER" Then
'            lblComStatus.Caption = "TCP " & gComm.TCPPORT & " 포트 연결성공"
'            imgOn.ZOrder 0
...
Private Sub wSckResult_DataArrival(ByVal bytesTotal As Long)
    Dim strText     As String
    Dim varBuffers  As Variant
    
    wSckResult.GetData strText
...
'    strRecvData = Split(strText, vbCr)
    ...
    tmrRcv.Interval = 1000
    tmrRcv.Enabled = True
    
    'If InStr(strBuffer, SB) > 0 And InStr(strBuffer, EB) > 0 Then
