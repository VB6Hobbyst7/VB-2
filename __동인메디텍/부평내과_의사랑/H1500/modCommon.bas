...
Public Sub SetSQLData(argSQL As String)
'argSQL의 내용을 파일로 저장
    Dim FilNum
    Dim sFileName As String
    ...
    sFileName = Format(CDate(frmInterface.dtpToday), "yyyy-mm-dd") & "_RCV"
