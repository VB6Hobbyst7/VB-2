...
Function GetSampleList(ByVal pFrDT As String, ByVal pToDT As String) As Integer
    ...
    Do While Not RS.EOF
        ...
        SetText frmInterface.vasID, Trim(RS.Fields(12).Value & ""), asRow, colBarcode '2
        
        i = GetOrderExamCode_New(gEquip, Trim(RS.Fields(12).Value & ""))
        If i = 1 Then
...
Function GetOrderCBCDIFF(argEquipCode As String, argPID As String) As Integer
    ...
    Set rs_svr = cn.Execute(SQL)
    Do Until rs_svr.EOF
        If Trim(rs_svr.Fields(0)) = "WBC" Or Trim(rs_svr.Fields(0)) = "PLT" Or Trim(rs_svr.Fields(0)) = "HGB" Then
            GetOrderCBC = "CBC"
        End If
        
        If Trim(rs_svr.Fields(0)) = "NEUT" Or Trim(rs_svr.Fields(0)) = "BASO" Or Trim(rs_svr.Fields(0)) = "MONO" Then
            GetOrderDIF = "DIF"
        End If
