   ...
   Begin TabDlg.SSTab stInterface 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin FPSpread.vaSpread vasID 
            ...
            RetainSelBlock  =   0   'False
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":89B7
            UserResize      =   2
         End
         Begin FPSpread.vaSpread vasRes 
            ...
            RetainSelBlock  =   0   'False
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":9490
         End
...
'''    Next iRow
    ...
    SQL = SQL & "   AND a.EXAMDATE = '" & dtpExamDate.Value & "'" & vbCrLf
...
'    End If
    ...
    wSckOrder.LocalPort = CInt(5050)
    wSckOrder.Listen
            
    wSckResult.LocalPort = CInt(5051)
    wSckResult.Listen
    ...
    For intCnt = 1 To UBound(strRecvData)
        ...
        Select Case strType
            ...
            Case "OBX"          'OBX|1|NM|PCT^PCT||0.107|%|0.15 - 0.5|L|||F|||20190614074847||||YH2500-SPS
                ...
                strResult = Trim(mGetP(strRcvBuf, 5, "|"))
