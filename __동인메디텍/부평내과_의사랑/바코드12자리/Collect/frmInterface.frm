...
Begin VB.Form frmInterface 
   ...
   Begin TabDlg.SSTab stInterface 
      ...
      Begin VB.Frame Frame6 
         ...
         Begin VB.ComboBox cboWorkList 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmInterface.frx":32DC
            Left            =   5130
            List            =   "frmInterface.frx":32DE
            TabIndex        =   84
            Top             =   210
            Width           =   2025
         End
         ...
         Begin FPSpread.vaSpread vasRePrint 
            ...
            Protect         =   0   'False
            RetainSelBlock  =   0   'False
            SpreadDesigner  =   "frmInterface.frx":32E0
         End
      ...
      Begin VB.Frame Frame4 
         ...
         Begin FPSpread.vaSpread vasPrint 
            ...
            Protect         =   0   'False
            RetainSelBlock  =   0   'False
            SpreadDesigner  =   "frmInterface.frx":3D7E
         End
      ...
      Begin VB.Frame Frame2 
         ...
         Begin FPSpread.vaSpread vasRRes 
            ...
            RetainSelBlock  =   0   'False
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":481C
         End
         ...
         Begin FPSpread.vaSpread vasRID 
            ...
            RetainSelBlock  =   0   'False
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":8585
            UserResize      =   2
         End
      ...
      Begin VB.Frame Frame8 
         ...
         Begin VB.ComboBox Combo1 
            Height          =   315
            ItemData        =   "frmInterface.frx":90A5
            Left            =   5160
            List            =   "frmInterface.frx":90A7
            TabIndex        =   29
            Top             =   900
            Visible         =   0   'False
            Width           =   1395
   ...
   Begin VB.Frame Frame1 
      ...
      Begin FPSpread.vaSpread vasWork 
         ...
         ShadowDark      =   13815180
         SpreadDesigner  =   "frmInterface.frx":90A9
      End
      ...
      Begin FPSpread.vaSpread vasID 
         ...
         ShadowDark      =   13815180
         SpreadDesigner  =   "frmInterface.frx":A84B
      End
      Begin FPSpread.vaSpread vasList 
         ...
         ShadowDark      =   13815180
         SpreadDesigner  =   "frmInterface.frx":C02C
      End
      ...
      Begin FPSpread.vaSpread vasTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":D7CE
      End
      Begin FPSpread.vaSpread vasResTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":11D27
      End
...
'            .SetText 19, pGrid_Point, adoRS.Fields(17).Value & ""
            ...
            strBarNum = Format(Trim(adoRS.Fields("ChartNo").Value & ""), "0000000000")
...
''                        .Output = strPosition & ArgoxIntermecString(strBarNum)
                Case 3: '-- 바코드 라벨
                        'strFont = "3"
                        strBarFor = "3"
                        strPosition = "B" & gBar_Parm.BarCodeX & "," & gBar_Parm.BarCodeY & ",0," & strBarFor & ",2,4," & gBar_Parm.BarCodeH & ",B,"    '-- 바코드번호 출력
    ...
    Else
        ...
        With vasPrint
            ...
            For intCnt = 0 To UBound(varXML) - 1
                ...
                SQL = SQL & "  WHERE EXAMCODE = '" & Trim(varTmp(8)) & "' " '<검사ID>b1050</검사ID>
                ...
                XMLInData.HospCode = varTmp(1)      '<요양기관번호>31334521</요양기관번호>
                XMLInData.ChartNo = varTmp(2)       '<차트번호>2000174624</차트번호>
                XMLInData.PatName = varTmp(3)       '<수진자명>이성순</수진자명>
                XMLInData.PatJumin = varTmp(4)      '<주민등록번호>650516-2811011</주민등록번호>
                XMLInData.PatNo = varTmp(5)
                XMLInData.CommDate = varTmp(6)
                XMLInData.ExamNo = varTmp(7)
                XMLInData.ExamID = varTmp(8)        '<검사ID>b1050</검사ID>
                ...
                '-- 검사코드로 찾아오기
                      SQL = "select equipno, equipcode, examname, examtype "
                SQL = SQL & "  from equipexam "
                ...
                If res > 0 Then
                    ...
                    '-- pEqipType = 검사파트
                    If strChartNo <> XMLInData.ChartNo Or pEqipType <> gReadBuf(3) Or XMLInData.ExamID = "pbun" Then
                        pEqipType = gReadBuf(3)
                        
                        If XMLInData.ExamID <> "pbun" Then
                        ...
                        '-- 바코드번호 12자리
                        If XMLInData.ExamID = "pbun" Then
                            strBarNum = Format(XMLInData.ChartNo, "0000000000") & "01"
                        Else
                            strBarNum = Format(XMLInData.ChartNo, "0000000000") & "00"
                        End If
...
Private Sub cmdWorkSearch_Click()
    ...
    SQL = SQL & "  order by a.BarCode, a.ExamID "
    ...
    With vasWorkPrint
        '.MaxRows = adoRS.RecordCount
        Do While Not adoRS.EOF
            If strBarNum <> Format(Trim(adoRS.Fields("ChartNo").Value & ""), "0000000000") Then
                pGrid_Point = pGrid_Point + 1
                .MaxRows = pGrid_Point
                .SetText 1, pGrid_Point, "1"
                .SetText 2, pGrid_Point, Format(adoRS.Fields("CommDate").Value & "", "####-##-##")
