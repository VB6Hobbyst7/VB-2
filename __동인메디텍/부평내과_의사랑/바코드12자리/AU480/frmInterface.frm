...
Private Sub Command16_Click()
    ...
    strBuffer = "D 000103 00060000034263    0001   7.8  002   4.9  003   2.9  004   1.7  005  1.25  006  0.28  007  0.97  008   117  009    87  010    71  011   250  012   123  013  11.6  014  1.04  015  11.2  016   128  017    84  018    17  019    57  020   257  097    54  "
...
'                            If strTGResult <> "" Then
'                                If strTGResult > 200 Then
'                                    If Val(strIntBase) = 20 Then
'                                        '-- 로컬 저장
'                                        SetLocalDB_New gRow, lsResRow, "1", lsEquipRes
'                                    End If
'                                Else
'                                    If Val(strIntBase) = 11 Then
'                                        '-- 로컬 저장
'                                        SetLocalDB_New gRow, lsResRow, "1", lsEquipRes
'                                    Else
'                                        SetLocalDB_New gRow, lsResRow, "1", lsEquipRes
