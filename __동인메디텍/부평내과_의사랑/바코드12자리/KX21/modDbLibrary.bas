...
Function GetSampleList(ByVal pFrDT As String, ByVal pToDT As String) As Integer
    ...
    Do While Not RS.EOF
        ...
        'SetText frmInterface.vasID, Trim(RS.Fields(8).Value & ""), asRow, 16
        'SetText frmInterface.vasID, Trim(RS.Fields(9).Value & ""), asRow, 17
        'SetText frmInterface.vasID, Trim(RS.Fields(10).Value & ""), asRow, 18
        'SetText frmInterface.vasID, Trim(RS.Fields(11).Value & ""), asRow, 19
