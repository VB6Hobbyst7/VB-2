...
Begin VB.Form frmMain 
   ...
   Begin VB.Frame frame1 
      ...
      Begin FPSpread.vaSpread spdOrder 
         ...
         SpreadDesigner  =   "frmMain.frx":92A9
         UserResize      =   2
      End
      Begin FPSpread.vaSpread spdResult 
         ...
         SpreadDesigner  =   "frmMain.frx":D7DF
         TextTip         =   2
      End
   End
   Begin VB.PictureBox Picture2 
      ...
      Begin VB.Frame fraResult 
         ...
         Begin VB.ComboBox cboRstType 
            Appearance      =   0  '평면
            Height          =   300
            ItemData        =   "frmMain.frx":E233
            Left            =   420
            List            =   "frmMain.frx":E235
            TabIndex        =   129
            Top             =   180
            Width           =   1245
         End
         Begin VB.ComboBox cboState 
            Height          =   300
            ItemData        =   "frmMain.frx":E237
            Left            =   4710
            List            =   "frmMain.frx":E239
            TabIndex        =   128
            Top             =   180
            Width           =   1395
         End
   ...
   Begin VB.Frame frame2 
      ...
      Begin FPSpread.vaSpread spdRResult 
         ...
         SelectBlockOptions=   0
         ShadowColor     =   13697023
         SpreadDesigner  =   "frmMain.frx":111F0
         TextTip         =   2
      End
      Begin FPSpread.vaSpread spdROrder 
         ...
         SelectBlockOptions=   0
         ShadowColor     =   14548991
         SpreadDesigner  =   "frmMain.frx":11BC1
         UserResize      =   2
      End
   ...
   Begin VB.Frame frame4 
      ...
      Begin VB.Frame frameCom 
         ...
         Begin VB.ComboBox cboPort 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmMain.frx":16C90
            Left            =   2190
            List            =   "frmMain.frx":16C92
            TabIndex        =   63
            Top             =   390
            Width           =   2205
         End
         Begin VB.ComboBox cboBaudrate 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmMain.frx":16C94
            Left            =   2190
            List            =   "frmMain.frx":16C96
            TabIndex        =   62
            Top             =   780
            Width           =   2205
         End
         Begin VB.ComboBox cboDatabit 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmMain.frx":16C98
            Left            =   2190
            List            =   "frmMain.frx":16C9A
            TabIndex        =   61
            Top             =   1170
            Width           =   2205
         End
         ...
         Begin VB.ComboBox cboParity 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmMain.frx":16C9C
            Left            =   2190
            List            =   "frmMain.frx":16C9E
            TabIndex        =   58
            Top             =   2520
            Width           =   2205
         End
   ...
   Begin VB.Frame frame3 
      ...
      Begin VB.Frame frameTestSet 
         ...
         Begin VB.Frame frameOrder 
            ...
            Begin FPSpread.vaSpread spdOrdMst 
               ...
               SelectBlockOptions=   0
               ShadowColor     =   13697023
               SpreadDesigner  =   "frmMain.frx":1841C
               TextTip         =   2
            End
         End
         Begin VB.ComboBox cboResultType 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmMain.frx":18979
            Left            =   1650
            List            =   "frmMain.frx":1897B
            TabIndex        =   43
            Top             =   5220
            Visible         =   0   'False
            Width           =   1575
         ...
         Begin VB.Frame frameCutOff 
            ...
            Begin VB.ComboBox cboCOH 
               ...
               EndProperty
               Height          =   315
               ItemData        =   "frmMain.frx":1897D
               Left            =   2730
               List            =   "frmMain.frx":1897F
               TabIndex        =   39
               Top             =   1020
               Width           =   735
            End
            ...
            Begin VB.ComboBox cboCOL 
               ...
               EndProperty
               Height          =   315
               ItemData        =   "frmMain.frx":18981
               Left            =   2730
               List            =   "frmMain.frx":18983
               TabIndex        =   30
               Top             =   300
               Width           =   735
            End
      ...
      Begin FPSpread.vaSpread spdTest 
         ...
         RetainSelBlock  =   0   'False
         SelectBlockOptions=   0
         SpreadDesigner  =   "frmMain.frx":1C43B
      End
   End
...
'    Call SetSQLData("RCV", RcvBuffer, "A")
        ...
        For intCnt = 1 To UBound(strRecvData)
            ...
            Select Case intCnt
                ...
                Case 4 To 13
                    ...
                    strResult = Trim(Mid(strRcvBuf, 7, 5)) '-- 정성
                    If strIntBase = "BLD" Or strIntBase = "LEU" Then
                        strIntResult = Trim(Mid(strRcvBuf, 12, 6)) '-- 정량
                    Else
                        strIntResult = Trim(Mid(strRcvBuf, 12, 7)) '-- 정량
                    End If
    ...
    '                '-- NIT
                    ...
                    Select Case Trim(strResult)
                        Case "+":       strResult = "1+" & "(" & strIntResult & ")"
                        Case "++":      strResult = "2+" & "(" & strIntResult & ")"
                        Case "+++":     strResult = "3+" & "(" & strIntResult & ")"
                        Case "++++":    strResult = "4+" & "(" & strIntResult & ")"
