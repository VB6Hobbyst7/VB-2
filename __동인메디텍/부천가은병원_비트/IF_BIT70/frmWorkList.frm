...
Begin VB.Form frmWorkList 
   ...
   Begin FPSpread.vaSpread spdWork 
      ...
      SpreadDesigner  =   "frmWorkList.frx":73EA
      UserResize      =   2
      ScrollBarTrack  =   1
      ShowScrollTips  =   3
   End
...
Private Sub cmdSend_Click()
    ...
    With spdWork
        For intWRow = 1 To .MaxRows
            ...
            If .Value = "1" Then
                blnSame = False
                strChartNo = GetText(spdWork, intWRow, colCHARTNO)
