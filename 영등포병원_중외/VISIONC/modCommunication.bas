...
On Error GoTo ErrHandle
    ...
    With frmMain
        ...
        .vasTemp.MaxRows = 0
              ...
              SQL = "SELECT EQUIPCODE,ORDERCODE,EXAMCODE,EXAMSUBCODE,EQUIPRESULT,RESULT,PSEX " & vbCr
        ...
        If Not RS_L.EOF = True And Not RS_L.BOF = True Then
            ...
            Do Until RS_L.EOF
                ...
                Call SetText(.vasTemp, RS_L.Fields("PSEX").Value & "", intRow, 7)
                RS_L.MoveNext
            Loop
        End If
        ...
        For intRow = 1 To .vasTemp.DataRowCnt
            ...
            strOrdCd = Trim(GetText(.vasTemp, intRow, 7))       '
