...
Begin VB.Form frmMain 
   ...
   Begin VB.PictureBox picBottom 
      ...
      Begin MSComctlLib.ImageList imlStatus 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMain.frx":33E5
               Key             =   "NOT"
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMain.frx":397F
               Key             =   "STOP"
            EndProperty
            ...
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMain.frx":47AB
               Key             =   "ITM"
            EndProperty
            BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMain.frx":4905
               Key             =   "ERR"
            EndProperty
            BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMain.frx":4A5F
               Key             =   "NOF"
            EndProperty
         EndProperty
      End
      Begin FPSpread.vaSpread spdComStatus 
         ...
         ShadowColor     =   16777215
         SpreadDesigner  =   "frmMain.frx":4BB9
         UserResize      =   0
         TextTip         =   2
         ScrollBarTrack  =   3
         ShowScrollTips  =   3
   ...
   Begin FPSpread.vaSpread spdResult 
      ...
      ScrollBarExtMode=   -1  'True
      ShadowColor     =   16777215
      SpreadDesigner  =   "frmMain.frx":64A0
      ScrollBarTrack  =   3
      ShowScrollTips  =   3
   End
   ...
   Begin FPSpread.vaSpread spdWork 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   16777215
      SpreadDesigner  =   "frmMain.frx":7230
      ScrollBarTrack  =   3
      ShowScrollTips  =   3
   End
   Begin FPSpread.vaSpread spdExcel 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      SpreadDesigner  =   "frmMain.frx":9578
   End
        ...
        For intR = 3 To spdExcel.MaxRows
            For intC = 1 To .spdExcel.MaxCols
                ...
                If intC = 1 Then
                    ...
                    strRackNo = GetText(.spdExcel, intR, 3)
                    ...
                    If Len(strBarno) = 11 And IsNumeric(strBarno) Then
                        strHospGbn = Mid(strBarno, 1, 2)
                        If CCur(strHospGbn) > 12 Then
                            strHospSite = "02"      '이대목동병원
                        Else
                            strHospSite = "01"      '이대서울병원
                        End If
                    End If
                    
                    gHospCode = strHospSite
...
'                    End If
                ...
                ElseIf intC = 8 Or intC = 12 Or intC = 14 Or intC = 16 Or intC = 18 Then
                'Else
