...
'    gCmnt.MPNCmnt = Replace(gCmnt.MPNCmnt, "CHR(10)CHR(13)", vbCrLf)
    ...
    strSetupC = "":    strSetUp1 = ""
    Call GetPrivateProfileString("COMMENT", "NEG", "", strSetupC, 1000, App.PATH & "\INI\" & gMACH & ".ini")
    strSetUp1 = Trim(strSetupC)
    strSetUp1 = Mid(strSetUp1, 1, Len(strSetUp1) - 1)
    gCmnt.NEG = Trim(strSetUp1)
    
    strSetupC = "":    strSetUp1 = ""
    Call GetPrivateProfileString("COMMENT", "EQV", "", strSetupC, 1000, App.PATH & "\INI\" & gMACH & ".ini")
    strSetUp1 = Trim(strSetupC)
    strSetUp1 = Mid(strSetUp1, 1, Len(strSetUp1) - 1)
    gCmnt.EQV = Trim(strSetUp1)
    
    strSetupC = "":    strSetUp1 = ""
    Call GetPrivateProfileString("COMMENT", "POS", "", strSetupC, 1000, App.PATH & "\INI\" & gMACH & ".ini")
    strSetUp1 = Trim(strSetupC)
    strSetUp1 = Mid(strSetUp1, 1, Len(strSetUp1) - 1)
    gCmnt.POS = Trim(strSetUp1)
    
    strSetupC = "":    strSetUp1 = ""
    Call GetPrivateProfileString("COMMENT", "POS2", "", strSetupC, 1000, App.PATH & "\INI\" & gMACH & ".ini")
    strSetUp1 = Trim(strSetupC)
    strSetUp1 = Mid(strSetUp1, 1, Len(strSetUp1) - 1)
    gCmnt.POS2 = Trim(strSetUp1)
    
    strSetupC = "":    strSetUp1 = ""
    Call GetPrivateProfileString("COMMENT", "POS3", "", strSetupC, 1000, App.PATH & "\INI\" & gMACH & ".ini")
    strSetUp1 = Trim(strSetupC)
    strSetUp1 = Mid(strSetUp1, 1, Len(strSetUp1) - 1)
    gCmnt.POS3 = Trim(strSetUp1)
    
    strSetupC = "":    strSetUp1 = ""
    Call GetPrivateProfileString("COMMENT", "POS4", "", strSetupC, 1000, App.PATH & "\INI\" & gMACH & ".ini")
    strSetUp1 = Trim(strSetupC)
    strSetUp1 = Mid(strSetUp1, 1, Len(strSetUp1) - 1)
    gCmnt.POS4 = Trim(strSetUp1)
    
    strSetupC = "":    strSetUp1 = ""
    Call GetPrivateProfileString("COMMENT", "POS5", "", strSetupC, 1000, App.PATH & "\INI\" & gMACH & ".ini")
    strSetUp1 = Trim(strSetupC)
    strSetUp1 = Mid(strSetUp1, 1, Len(strSetUp1) - 1)
    gCmnt.POS5 = Trim(strSetUp1)
