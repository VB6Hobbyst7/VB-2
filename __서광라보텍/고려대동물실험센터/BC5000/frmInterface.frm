...
Begin VB.Form frmInterface 
   ...
   Begin VB.Frame FrmHideControl 
      ...
      Begin VB.ComboBox cboTest 
         ...
         ForeColor       =   &H00FF0000&
         Height          =   300
         ItemData        =   "frmInterface.frx":1717
         Left            =   4980
         List            =   "frmInterface.frx":1719
         Style           =   2  '드롭다운 목록
         TabIndex        =   63
         Top             =   4200
         Visible         =   0   'False
         ...
         Begin MSComctlLib.ImageList imlStatus 
            ...
            BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
               ...
               BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":173E
                  Key             =   "RUN"
               EndProperty
               BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":1CD8
                  Key             =   "NOT"
               EndProperty
               BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":2272
                  Key             =   "STOP"
               EndProperty
               BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":280C
                  Key             =   "LST"
               EndProperty
               BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":309E
                  Key             =   "ITM"
               EndProperty
               BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":31F8
                  Key             =   "ERR"
               EndProperty
               BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":3352
                  Key             =   "NOF"
               EndProperty
            EndProperty
         End
      ...
      Begin VB.Frame Frame4 
         ...
         Begin FPSpread.vaSpread vasPrint 
            ...
            EndProperty
            MaxCols         =   9
            SpreadDesigner  =   "frmInterface.frx":3A36
         End
         Begin FPSpread.vaSpread vasPrintBuf 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            SpreadDesigner  =   "frmInterface.frx":3E6E
         End
      End
      ...
      Begin FPSpread.vaSpread vasCode 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":4090
      End
      Begin FPSpread.vaSpread vasTemp1 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":42B2
      End
      Begin FPSpread.vaSpread vasList 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":44D4
      End
      Begin FPSpread.vaSpread vasResTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":46F6
      End
      Begin FPSpread.vaSpread vasTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":4918
      End
   ...
   Begin VB.Frame Frame1 
      ...
      Begin FPSpread.vaSpread vasID 
         ...
         SpreadDesigner  =   "frmInterface.frx":5BD8
      End
      Begin FPSpread.vaSpread vasRes 
         ...
         RetainSelBlock  =   0   'False
         ScrollBars      =   2
         SpreadDesigner  =   "frmInterface.frx":66C5
      End
   End
        ...
        Select Case BufChar
            ...
            Case ETX
                ...
                ElseIf gMach = "NX500i" Then
                    Call EditRcvData_NX500
                    strBuffer = ""
                ElseIf gMach = "NX700i" Then
                    Call EditRcvData_NX700i
                    strBuffer = ""
                Else
...
'    wSck.LocalPort = CInt(5050)
'    wSck.Listen
    
    
    wSck.Close
    wSck.Connect "10.1.1.3", 5100
    
    imgPort.Picture = imlStatus.ListImages("STOP").ExtractIcon
    
    frmInterface.StatusBar1.Panels(2).Text = "TCP 10.1.1.3 5100 포트 연결중.."
    ...
    intSaveDt = gSaveDt
    sDate = Format(DateAdd("y", CDate(dtpToday.Value), intSaveDt), "yyyymmdd")
...
'   기능 : 장비로부 수신한 데이터 편집
'-----------------------------------------------------------------------------'
Private Sub EditRcvData_NX700i()
     Dim strRcvBuf    As String   '수신한 Data
    Dim strType      As String   '수신한 Record Type
    Dim strBarNo     As String   '수신한 바코드번호
    Dim strSeq       As String   '수신한 Sequence
    ...
    ElseIf UCase(strType) = "N" Then
        ...
        strBarNo = Trim(Mid(strRcvBuf, 30, 16))
        'strSeq = Trim(Mid(strRcvBuf, 23, 1))
        strSeq = Trim(Mid(strRcvBuf, 49, 2))
        ...
        For i = 51 To Len(strRcvBuf) Step 36
            ...
            If strResult <> "" Then
                ...
                If Res > 0 Then
                    ...
                    SetText vasRes, strResult, lsResRow, colRESULT          '결과
                    SetText vasRes, lsSeqNo, lsResRow, colSeq               '순번
                    SetText vasRes, strLow & "~" & strHigh, lsResRow, colFLAG 'Flag
...
'   기능 : 장비로부 수신한 데이터 편집
'-----------------------------------------------------------------------------'
Private Sub EditRcvData_BC5800()
    Dim strRcvBuf    As String   '수신한 Data
    Dim strType      As String   '수신한 Record Type
    Dim strBarNo     As String   '수신한 바코드번호
    Dim strSeq       As String   '수신한 Sequence
    ...
    For intCnt = 0 To UBound(strRData)
        ...
        Select Case strType
            ...
            Case "PID"
                strBarNo = Trim(mGetP(strRcvBuf, 2, "|"))
                strTestDt = Format(Now, "yyyymmdd")
                
            Case "OBR"
                '-- 인터페이스 응답
                               strSndBuffer = SB & "MSH|^~\&|Mindray|BC-5000|||" & Format(Now, "yyyymmddhhmmss") & "||ACK^R01|" & strBarNo & "|P|2.3.1||||0||ASCII|||" & vbCr
...
'    wSck.Listen
    ...
    frmInterface.StatusBar1.Panels(2).Text = "10.1.1.3 TCP 5050 포트 연결성공"
...
Private Sub wSCK_ConnectionRequest(ByVal requestID As Long)
    ...
    If wSck.State <> sckClosed Then
        ...
        imgPort.Picture = imlStatus.ListImages("RUN").ExtractIcon
        frmInterface.StatusBar1.Panels(2).Text = "TCP 5050 포트 연결성공"
    End If
