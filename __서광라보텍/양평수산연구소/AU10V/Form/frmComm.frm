...
Begin VB.Form frmComm 
   ...
   Begin TabDlg.SSTab tabWork 
      ...
      Begin FPSpread.vaSpread spdRstview 
         ...
         SpreadDesigner  =   "frmComm.frx":8CBB
         UserResize      =   0
      End
      ...
      Begin BHButton.BHImageButton cmdNext 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         TransparentPicture=   "frmComm.frx":A6BB
         ForeColor       =   16711680
         BackColor       =   255
         AlphaColor      =   255
         ImgOutLineSize  =   3
      ...
      Begin FPSpread.vaSpread spdWorklist 
         ...
         ScrollBarMaxAlign=   0   'False
         ShadowColor     =   14735310
         SpreadDesigner  =   "frmComm.frx":B41D
         UserResize      =   2
      End
      ...
      Begin Threed.SSPanel SSPanel1 
         ...
         Begin VB.ComboBox cboChk 
            Height          =   300
            ItemData        =   "frmComm.frx":B95A
            Left            =   5160
            List            =   "frmComm.frx":B964
            TabIndex        =   60
            Top             =   90
            Width           =   1095
         End
         Begin VB.ComboBox cboComNm 
            Height          =   300
            ItemData        =   "frmComm.frx":B978
            Left            =   4590
            List            =   "frmComm.frx":B97A
            TabIndex        =   59
            Top             =   480
            Visible         =   0   'False
            Width           =   1725
      ...
      Begin Threed.SSPanel SSPanel 
         ...
         Begin VB.ComboBox cboOrdDt 
            Height          =   300
            ItemData        =   "frmComm.frx":B97C
            Left            =   4590
            List            =   "frmComm.frx":B97E
            TabIndex        =   87
            Top             =   90
            Visible         =   0   'False
            Width           =   1185
         ...
         Begin VB.ComboBox cboChk1 
            Height          =   300
            ItemData        =   "frmComm.frx":B980
            Left            =   2610
            List            =   "frmComm.frx":B98A
            TabIndex        =   86
            Top             =   90
            Visible         =   0   'False
            Width           =   1905
         ...
         Begin VB.ComboBox cboRstgbn 
            Height          =   300
            Index           =   1
            ItemData        =   "frmComm.frx":B99E
            Left            =   5850
            List            =   "frmComm.frx":B9AB
            Style           =   2  '드롭다운 목록
            TabIndex        =   73
            Top             =   75
            Visible         =   0   'False
         ...
         Begin VB.ComboBox Combo2 
            Height          =   300
            ItemData        =   "frmComm.frx":B9D5
            Left            =   4590
            List            =   "frmComm.frx":B9D7
            TabIndex        =   72
            Top             =   480
            Visible         =   0   'False
            Width           =   1725
      ...
      Begin FPSpread.vaSpread tblexcel 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmComm.frx":B9D9
      End
      ...
      Begin FPSpread.vaSpread spdResult2 
         ...
         ScrollBarMaxAlign=   0   'False
         ShadowColor     =   14735309
         SpreadDesigner  =   "frmComm.frx":BB84
         UserResize      =   0
      End
      Begin VB.Line Line1 
...
Private Sub cmdRstQuery_Click()
    ...
    sqlDoc = sqlDoc & " Order By TMP1,SPCNO, PATID, TRANSTM"
    ...
    With cInterface
        ...
        Select Case strType
            Case "N"    '## Normal result
                ...
                'pGrid_Point = SeqSearch(spdResult1, strTestNo, 3)

                'If pGrid_Point = 0 Then
                '    pGrid_Point = SeqNullSearch(spdResult1, strTestNo, 3)
                '    If pGrid_Point = 0 Then
                '        spdResult1.maxrows = spdResult1.maxrows + 1: pGrid_Point = spdResult1.maxrows
                '    End If
                'End If
...
Private Function SeqSearch2(ByVal brspread As Object, ByVal brSeq As String, ByVal brCol As Integer, ByVal brSeq2 As String, ByVal brCol2 As Integer) As Long
Dim sCnt As Long
