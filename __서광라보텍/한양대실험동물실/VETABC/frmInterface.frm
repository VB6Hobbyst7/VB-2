...
Private Sub Form_Resize()
    ...
    cmdIFClear.Left = Frame1.Width - cmdIFClear.Width - 100
...
'''    End If
    ...
    If txtTest.Visible = True Then
        ...
        cmdCommTest.Visible = False
    Else
        txtTest.Visible = True
        cmdCommTest.Visible = True
    End If
                ...
                Select Case BufChar
                    ...
                    Case ETX
                        ...
                        ElseIf gMach = "NX500i" Then
                            Call EditRcvData_NX500
                            strBuffer = ""
                        ElseIf gMach = "VetABC" Then
                            Call EditRcvData_VetABC
                            strBuffer = ""
                        Else
...
'   기능 : 장비로부 수신한 데이터 편집
'-----------------------------------------------------------------------------'
Private Sub EditRcvData_VetABC()
    Dim strRcvBuf    As String   '수신한 Data
    Dim strType      As String   '수신한 Record Type
    Dim strBarNo     As String   '수신한 바코드번호
    Dim strSeq       As String   '수신한 Sequence
...
'    k. Monkey
    ...
    For i = 0 To UBound(varRcvBuf)
        ...
        Select Case i
            Case 3
                strTestDt = Format(Mid(strRcvBuf, 3, 8), "yyyy-mm-dd")
                'strTestDt = Format(strTestDt, "yyyy-mm-dd")
...
Private Sub txtBarcode_KeyDown(KeyCode As Integer, Shift As Integer)
    ...
    If Trim(txtBarcode) <> "" And KeyCode = vbKeyReturn Then
        ...
        For i = 1 To vasID.DataRowCnt
            If GetText(vasID, i, colBARCODE) = txtBarcode.Text Then
        ...
        Call SetText(vasID, "1", vasID.MaxRows, colCheckBox)
        Call SetText(vasID, txtBarcode.Text, vasID.MaxRows, colBARCODE)
...
Private Sub vasID_KeyDown(KeyCode As Integer, Shift As Integer)
    ...
    If KeyCode = vbKeyDelete Then
        ...
        strDate = Trim(GetText(vasID, iRow, colEXAMDATE))
...
'        End If
        ...
        SQL = SQL & "   AND MID(EXAMDATE,1,8) = '" & Mid(strDate, 1, 8) & "' "
        Res = SendQuery(gLocal, SQL)
    ...
    ElseIf KeyCode = vbKeyReturn Then
        If iCol = colBARCODE Then
            ...
            'If lsID <> lblBarcode(0).Caption Then
                ...
                MsgBox "수정되었습니다.", vbOKOnly + vbInformation, Me.Caption
                blnModify = True
