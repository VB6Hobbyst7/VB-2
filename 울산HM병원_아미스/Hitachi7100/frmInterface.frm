...
Begin VB.Form frmInterface 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin FPSpread.vaSpread vasRes 
         ...
         RetainSelBlock  =   0   'False
         ScrollBars      =   2
         SpreadDesigner  =   "frmInterface.frx":2139
      End
      Begin FPSpread.vaSpread vasWorkList 
         ...
         MoveActiveOnFocus=   0   'False
         RetainSelBlock  =   0   'False
         SpreadDesigner  =   "frmInterface.frx":279A
      End
   End
   ...
   Begin VB.Frame FrmHideControl 
      ...
      Begin VB.ComboBox cboChk 
         ...
         EndProperty
         Height          =   315
         ItemData        =   "frmInterface.frx":4497
         Left            =   4500
         List            =   "frmInterface.frx":44A4
         TabIndex        =   64
         Top             =   300
         Width           =   975
      End
      ...
      Begin VB.ComboBox cboTest 
         ...
         ForeColor       =   &H00FF0000&
         Height          =   300
         ItemData        =   "frmInterface.frx":44BA
         Left            =   3720
         List            =   "frmInterface.frx":44BC
         Style           =   2  '드롭다운 목록
         TabIndex        =   54
         Top             =   4260
         Visible         =   0   'False
      ...
      Begin VB.Frame Frame4 
         ...
         Begin FPSpread.vaSpread vasPrint 
            ...
            EndProperty
            MaxCols         =   9
            SpreadDesigner  =   "frmInterface.frx":44BE
         End
         Begin FPSpread.vaSpread vasPrintBuf 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            SpreadDesigner  =   "frmInterface.frx":5F37
         End
      End
      ...
      Begin FPSpread.vaSpread vasCode 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":614F
      End
      Begin FPSpread.vaSpread vasTemp1 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":6367
      End
         ...
         Begin MSComctlLib.ImageList imlStatus 
            ...
            BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
               ...
               BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":6B09
                  Key             =   "RUN"
               EndProperty
               BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":70A3
                  Key             =   "NOT"
               EndProperty
               BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":763D
                  Key             =   "STOP"
               EndProperty
               BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":7BD7
                  Key             =   "LST"
               EndProperty
               BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":8469
                  Key             =   "ITM"
               EndProperty
               BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":85C3
                  Key             =   "ERR"
               EndProperty
               BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":871D
                  Key             =   "NOF"
               EndProperty
            EndProperty
         End
      ...
      Begin FPSpread.vaSpread vasList 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":8877
      End
      Begin FPSpread.vaSpread vasResTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":8A8F
      End
      Begin FPSpread.vaSpread vasTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":8CA7
      End
      Begin FPSpread.vaSpread vasExcel 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":8EBF
      End
    ...
    With vasWorkList
        For intRow = 1 To .MaxRows
            ...
            If .Value = 1 Then
                ...
                Call SetText(vasID, GetText(vasWorkList, intRow, colSpecNo), intVasRow, colSpecNo)
                Call SetText(vasID, GetText(vasWorkList, intRow, colCheckBox), intVasRow, colCheckBox)
                Call SetText(vasID, GetText(vasWorkList, intRow, colHOSPDATE), intVasRow, colHOSPDATE)
                Call SetText(vasID, GetText(vasWorkList, intRow, colBARCODE), intVasRow, colBARCODE)
                Call SetText(vasID, GetText(vasWorkList, intRow, colCHARTNO), intVasRow, colCHARTNO)
                Call SetText(vasID, GetText(vasWorkList, intRow, colPID), intVasRow, colPID)
                Call SetText(vasID, GetText(vasWorkList, intRow, colINOUT), intVasRow, colINOUT)
                Call SetText(vasID, txtSeq, intVasRow, colPOSNO)
                Call SetText(vasID, GetText(vasWorkList, intRow, colPNAME), intVasRow, colPNAME)
                Call SetText(vasID, GetText(vasWorkList, intRow, colPSEX), intVasRow, colPSEX)
                Call SetText(vasID, GetText(vasWorkList, intRow, colPAGE), intVasRow, colPAGE)
                ...
                For intCol = colState + 1 To .MaxCols
                    ...
                    If .BackColor = vbYellow Then
                        Call SetBackColor(vasID, intVasRow, intVasRow, intCol, intCol, 255, 255, 0)
                    End If
                Next
...
Private Sub cmdRsltSearch_Click()
    ...
    SQL = SQL & " ORDER BY EXAMDATE,SAVESEQ,DISKNO "
...
'    frmWorkList.dtpStartDt.Value = dtpStartDt.Value
'    frmWorkList.dtpStopDt.Value = dtpStopDt.Value
'
...
'    End If
    SQL = SQL & "  ORDER BY O.ACPTDATE, P.PATNAME"
...
'    Call SetText(vasID, mResult.RackNo, intRow, colDISKNO)
    Call SetText(vasID, mResult.SpcPos, intRow, colPOSNO)
...
'       - pBarNo : 바코드번호
'-----------------------------------------------------------------------------'
Private Sub SetPatInfo_New(ByVal pChart As String, Optional ByVal pRno As String, Optional ByVal pPno As String)
    Dim i           As Integer
    Dim intRow      As Long
    Dim strItems    As String
    Dim strTestDt   As String
    ...
    If pChart <> "" Then
        For i = 1 To vasID.DataRowCnt
            If Trim(GetText(vasID, i, colCHARTNO)) = pChart Then
                intRow = i
                Exit For
            End If
        Next i
    ...
    Call SetText(vasID, "1", intRow, colCheckBox)
    'Call SetText(vasID, mResult.BarNo, intRow, colBARCODE)
    Call SetText(vasID, pChart, intRow, colCHARTNO)
    Call SetText(vasID, mResult.SpcPos, intRow, colPOSNO)
    Call SetText(vasID, mResult.RsltDate, intRow, colEXAMDATE)
    Call SetText(vasID, mResult.RsltSeq, intRow, colSAVESEQ)
    ...
    '-- 검사자 정보 서버테이블에서 가져와 표시(for 워크리스트)  '6,7,8,9
    Call GetSampleInfoW_AMIS_New(intRow, pChart, Format(dtpStartDt.Value, "yyyymmdd"), Format(dtpStopDt.Value, "yyyymmdd"))
...
'            '-- 포지션 번호로 챠트 번호 찾기
'            For i = 1 To vasID.DataRowCnt
'                If Trim(GetText(vasID, i, colSpecNo)) = Val(strTubePos) Then
...
'
'            strFunction = Replace(strFunction, String(13, "#"), Left(mOrder.Seq & Space(13), 13))
'
...
'            strSndMsg = strSndMsg & " 88"
'            strSndMsg = strSndMsg & Mid(strSendData, 1, 88)
...
'            SetRawData "[Tx]" & STX & strSndMsg & ETX & GetChkSum(strSndMsg) & vbCr
        ...
        Case ":"    '받은 결과 데이터 편집
            ...
            If strFunc <> "@" And strFunc <> "M" Then
                ...
                '바코드를 사용하지 않으며 오더를 strSeq(챠트번호) 주어서 결과도 strSeq를 사용하여 찾는다.
                strChart = Trim(Mid(strRcvBuf, 14, 13))
                strChart = Format(strChart, "00000000")
                strBarNo = Trim(Mid(strRcvBuf, 14, 13))
                DoEvents
                ...
                If strBarNo <> "" Then
                    For i = 1 To vasID.DataRowCnt
                        If Val(Trim(GetText(vasID, i, colCHARTNO))) = Val(strChart) Then
                            strBarNo = Trim(GetText(vasID, i, colBARCODE))
                            strSeq = Trim(GetText(vasID, i, colPID))
                            gRow = i
                            Exit For
...
'                    '-- 챠트 번호로 찾기
'                    For i = 1 To vasID.DataRowCnt
'                        If Val(Trim(GetText(vasID, i, colCHARTNO))) = Val(strBarNo) Then
'                            strBarNo = Trim(GetText(vasID, i, colBARCODE))
'                            strSeq = Trim(GetText(vasID, i, colPID))
'                            gRow = i
'                            Exit For
...
'                End If
                ...
                intCnt = Val(Trim(Mid(strRcvBuf, 49, 2)))
...
'                End If
                ...
                With mResult
                    ...
                    .TubePos = strTubePos
                    .RsltDate = Format(Now, "yyyymmddhhmmss")
                    .RsltSeq = getMaxTestNum(Format(Now, "yyyymmdd"))
                    .SpcPos = txtSeq.Text
                End With
                
                'Call SetPatInfo(strBarNo)
                Call SetPatInfo_New(strChart)
            
                strState = "O"
            
                strTmp = Mid(strRcvBuf, 52)
                    ...
                    If strResult <> "" Then
                        ...
                        Else
                            ...
                            If Res > 0 Then
                                ...
                                SetText vasRes, strResult, lsResRow, colRESULT          '결과
                                SetText vasRes, lsSeqNo, lsResRow, colSeq               '순번
                                SetText vasRes, gsFlag, lsResRow, colFLAG              'Flag
                                '-- 로컬 저장
                                SetLocalDB gRow, lsResRow, "1", lsEquipRes
...
Function SetLocalDB(ByVal asRow1 As Long, ByVal asRow2 As Long, asSend As String, Optional asEquipResult As String = "")
    ...
    sExamDate = Format(Now, "yyyymmddhhmmss")
    ...
    SQL = "DELETE FROM PATRESULT " & vbCrLf & _
          " WHERE mid(EXAMDATE,1,8) = '" & Mid(sExamDate, 1, 8) & "' " & vbCrLf & _
...
'
'        For intRow = vasID.ActiveRow To vasID.MaxRows
'            Call SetText(vasID, Val(txtSeq.Text), intRow, colSpecNo)
'            txtSeq.Text = txtSeq.Text + 1
'        Next
'
...
Dim pGrid_Point As Integer
    ...
    Dim lsID     As String
    Dim lsOldID     As String
    Dim i       As Integer
    
    If Row = 0 Then Exit Sub
    
    With vasWorkList
        'pGrid_Point = SeqSearch(vasID, GetText(vasWorkList, Row, colBARCODE), colBARCODE)
        pGrid_Point = SeqSearch(vasID, txtSeq.Text, colPOSNO)

        If pGrid_Point = 0 Then
            Exit Sub
        Else
            lsOldID = GetText(vasWorkList, Row, colBARCODE)
            sChartNo = ""
            
            '-- 이전 챠트번호 갖고 있기
            For i = 1 To vasID.MaxRows
                If Val(txtSeq.Text) = Val(GetText(vasID, i, colPOSNO)) Then
                    sChartNo = GetText(vasID, i, colCHARTNO)
                    Exit For
                End If
            Next
            
            '-- 바뀐 바코드로 환자정보 불러오기
            'If GetSampleInfoW_AMIS(pGrid_Point) = -1 Then
                Call SetText(vasID, GetText(vasWorkList, Row, colSpecNo), pGrid_Point, colSpecNo)
                Call SetText(vasID, GetText(vasWorkList, Row, colCheckBox), pGrid_Point, colCheckBox)
                Call SetText(vasID, GetText(vasWorkList, Row, colHOSPDATE), pGrid_Point, colHOSPDATE)
                Call SetText(vasID, GetText(vasWorkList, Row, colBARCODE), pGrid_Point, colBARCODE)
                Call SetText(vasID, GetText(vasWorkList, Row, colPID), pGrid_Point, colPID)
                Call SetText(vasID, GetText(vasWorkList, Row, colCHARTNO), pGrid_Point, colCHARTNO)
                Call SetText(vasID, GetText(vasWorkList, Row, colPNAME), pGrid_Point, colPNAME)
                Call SetText(vasID, GetText(vasWorkList, Row, colPSEX), pGrid_Point, colPSEX)
                Call SetText(vasID, GetText(vasWorkList, Row, colPAGE), pGrid_Point, colPAGE)
            'End If
            
            DoEvents
            
            lsID = Trim(GetText(vasID, pGrid_Point, colBARCODE))
            
            
            '-- 바코드 번호가 이전과 틀리다면 업데이트
                  SQL = "UPDATE PATRESULT SET"
            SQL = SQL & " HOSPDATE = '" & Trim(GetText(vasID, pGrid_Point, colHOSPDATE)) & "' " & vbCrLf
            SQL = SQL & ",BARCODE = '" & lsID & "' " & vbCrLf
            SQL = SQL & ",CHARTNO = '" & Trim(GetText(vasID, pGrid_Point, colCHARTNO)) & "' " & vbCrLf
            SQL = SQL & ",PID = '" & Trim(GetText(vasID, pGrid_Point, colPID)) & "' " & vbCrLf
            SQL = SQL & ",PNAME = '" & Trim(GetText(vasID, pGrid_Point, colPNAME)) & "' " & vbCrLf
            SQL = SQL & ",INOUT = '" & Trim(GetText(vasID, pGrid_Point, colINOUT)) & "' " & vbCrLf
            SQL = SQL & ",PSEX = '" & Trim(GetText(vasID, pGrid_Point, colPSEX)) & "' " & vbCrLf
            SQL = SQL & ",PAGE = '" & Trim(GetText(vasID, pGrid_Point, colPAGE)) & "' " & vbCrLf
            SQL = SQL & " WHERE EQUIPNO = '" & gEquip & "' " & vbCrLf
            SQL = SQL & "   AND SAVESEQ = " & Trim(GetText(vasID, pGrid_Point, colSAVESEQ)) & vbCrLf
'            SQL = SQL & "   AND BARCODE = '" & lsOldID & "' "
            SQL = SQL & "   AND CHARTNO = '" & sChartNo & "' "
            'SQL = SQL & "   AND HOSPDATE Between '" & Format(dtpStartDt.Value, "yyyymmdd") & "' and '" & Format(dtpStopDt.Value, "yyyymmdd") & "'"
            ...
            If InStr(gOrderExam, "'XC00301'") > 0 Then
                      SQL = "UPDATE PATRESULT SET"
                SQL = SQL & "  EXAMCODE = 'XC00301' "
                SQL = SQL & " WHERE EQUIPNO = '" & gEquip & "' " & vbCrLf
                SQL = SQL & "   AND SAVESEQ = " & Trim(GetText(vasID, pGrid_Point, colSAVESEQ)) & vbCrLf
                SQL = SQL & "   AND EXAMCODE = 'XC0030' "
            ...
            If InStr(gOrderExam, "'XC0030'") > 0 Then
                      SQL = "UPDATE PATRESULT SET"
                SQL = SQL & "  EXAMCODE = 'XC0030' "
                SQL = SQL & " WHERE EQUIPNO = '" & gEquip & "' " & vbCrLf
                SQL = SQL & "   AND SAVESEQ = " & Trim(GetText(vasID, pGrid_Point, colSAVESEQ)) & vbCrLf
                SQL = SQL & "   AND EXAMCODE = 'XC00301' "
            ...
            If InStr(gOrderExam, "'XC1008'") > 0 Then
                      SQL = "UPDATE PATRESULT SET"
                SQL = SQL & "  EXAMCODE = 'XC1008' "
                SQL = SQL & " WHERE EQUIPNO = '" & gEquip & "' " & vbCrLf
                SQL = SQL & "   AND SAVESEQ = " & Trim(GetText(vasID, pGrid_Point, colSAVESEQ)) & vbCrLf
                SQL = SQL & "   AND EXAMCODE = 'XC100801' "
            ...
            If InStr(gOrderExam, "'XC100801'") > 0 Then
                      SQL = "UPDATE PATRESULT SET"
                SQL = SQL & "  EXAMCODE = 'XC100801' "
                SQL = SQL & " WHERE EQUIPNO = '" & gEquip & "' " & vbCrLf
                SQL = SQL & "   AND SAVESEQ = " & Trim(GetText(vasID, pGrid_Point, colSAVESEQ)) & vbCrLf
                SQL = SQL & "   AND EXAMCODE = 'XC1008' "
