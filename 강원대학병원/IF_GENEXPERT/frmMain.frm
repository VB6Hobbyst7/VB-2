...
Begin VB.Form frmMain 
      ...
      Begin MSComctlLib.ImageList imlStatus 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMain.frx":1F97
               Key             =   "NOT"
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMain.frx":2531
               Key             =   "STOP"
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMain.frx":2ACB
               Key             =   "LST"
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMain.frx":335D
               Key             =   "ITM"
            EndProperty
            BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMain.frx":34B7
               Key             =   "ERR"
            EndProperty
            BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMain.frx":3611
               Key             =   "NOF"
            EndProperty
            BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMain.frx":376B
               Key             =   "ON"
               Object.Tag             =   "OFF"
            EndProperty
            BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMain.frx":4045
               Key             =   ""
            EndProperty
         EndProperty
      End
   ...
   Begin FPSpread.vaSpread spdOrder 
      ...
      ShadowColor     =   16777215
      SpreadDesigner  =   "frmMain.frx":6F2F
      ScrollBarTrack  =   3
      ShowScrollTips  =   3
   End
   Begin FPSpread.vaSpread spdWork 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   16777215
      SpreadDesigner  =   "frmMain.frx":8BE6
      ScrollBarTrack  =   3
      ShowScrollTips  =   3
   End
...
Private Sub TCPRcvData_GENEXPERT()
    ...
    Dim strCovN         As String
    Dim strCovE         As String
    
    Dim strIMP1Ct       As String
    Dim strKPCCt        As String
    Dim strNDMCt        As String
    Dim strOXA48Ct      As String
    Dim strVIMCt        As String
    Dim strCovCt        As String
    Dim strCovECt       As String
    Dim strCovNCt       As String
            ...
            Select Case strType
                ...
                Case "R"
                    ...
                    strIntResult = "" 'mGetP(mGetP(strRcvBuf, 4, "|"), 2, "^")
                                    ...
                                    '^MTB-RIF^^MTB^^^SPC^Ct|^25.0|||
                    '-- MTB Ct값 찾기
                    If strIntBase = "^MTB-RIF^^MTB^^^SPC^Ct" Then
                        strIntResult = mGetP(mGetP(strRcvBuf, 4, "|"), 2, "^")
                    ...
                    'R|5|^^^CoV^^^N2^|POS^|||
                    'R|6|^^^CoV^^^N2^Ct|^13.7|||
                    If strIntBase = "^^^CoV^^^E^Ct" Then
                        strIntBase = "^^^CoV^^^E^"
                        If Mid(strCovE, 1, 3) = "POS" Then
                            strIntResult = mGetP(mGetP(strRcvBuf, 4, "|"), 2, "^")
                            strResult = "Positive" & " (Ct : " & strIntResult & ")"
                        Else
                            strResult = "Negative"
                        End If
                    End If
                    
                    If strIntBase = "^^^CoV^^^N2^Ct" Then
                        strIntBase = "^^^CoV^^^N2^"
                        If Mid(strCovN, 1, 3) = "POS" Then
                            strIntResult = mGetP(mGetP(strRcvBuf, 4, "|"), 2, "^")
                            strResult = "Positive" & " (Ct : " & strIntResult & ")"
                        Else
                            strResult = "Negative"
                    ...
                    If strIntBase <> "" And strResult <> "" Then
                        ...
                        End If
                        'strCDIF
                        If strIntBase = "^G3^^Toxi^Xpert C.difficile G3^4^Toxigenic C^diff" Then
                            strCDIF = strResult
                        End If
                        '027
                        If strIntBase = "^G3^^027^Xpert C.difficile G3^4^027^" Then
                            str027 = strResult
                        End If
                        ...
                        If strIntBase = "^Carba-R^^IMP1^Xpert Carba-R^2^IMP1^" Then
                            If strResult = "DETECTED" Or strResult = "POS" Then
                                strIMP1Ct = mGetP(mGetP(strRData(intCnt + 2), 4, "|"), 2, "^")
                                strIntResult = strIMP1Ct
                                strCarbaRPos = strCarbaRPos & "IMP1" & ":" & strIMP1Ct & "/"
                            Else
                        ...
                        If strIntBase = "^Carba-R^^VIM^Xpert Carba-R^2^VIM^" Then
                            If strResult = "DETECTED" Or strResult = "POS" Then
                                strVIMCt = mGetP(mGetP(strRData(intCnt + 2), 4, "|"), 2, "^")
                                strIntResult = strVIMCt
                                strCarbaRPos = strCarbaRPos & "VIM" & ":" & strVIMCt & "/"
                            Else
                        ...
                        If strIntBase = "^Carba-R^^NDM^Xpert Carba-R^2^NDM^" Then
                            If strResult = "DETECTED" Or strResult = "POS" Then
                                strNDMCt = mGetP(mGetP(strRData(intCnt + 2), 4, "|"), 2, "^")
                                strIntResult = strNDMCt
                                strCarbaRPos = strCarbaRPos & "NDM" & ":" & strNDMCt & "/"
                            Else
                        ...
                        If strIntBase = "^Carba-R^^KPC^Xpert Carba-R^2^KPC^" Then
                            If strResult = "DETECTED" Or strResult = "POS" Then
                                strKPCCt = mGetP(mGetP(strRData(intCnt + 2), 4, "|"), 2, "^")
                                strIntResult = strKPCCt
                                strCarbaRPos = strCarbaRPos & "KPC" & ":" & strKPCCt & "/"
                            Else
                        ...
                        If strIntBase = "^Carba-R^^OXA48^Xpert Carba-R^2^OXA48^" Then
                            If strResult = "DETECTED" Or strResult = "POS" Then
                                strOXA48Ct = mGetP(mGetP(strRData(intCnt + 2), 4, "|"), 2, "^")
                                strIntResult = strOXA48Ct
                                strCarbaRPos = strCarbaRPos & "OXA48" & ":" & strOXA48Ct & "/"
                            Else
                        ...
                        '2020-06-23 : Rif 가 INDETERMINATE 인 결과는 저장하지 않는다.
                        If strResult = "INDETERMINATE" Then
                            strResult = ""
                        End If
                ...
                Case "L"
                    If strMTB = "NOT DETECTED" Or strMTB = "Negative" Then
                        'RIF 를 Negative 로 저장
                    ...
                    If strMTB <> "" And strRIF = "" Then
                        strIntBase = "MTBRIF"
                        strResult = "MTB Negative"
                        If ResultProcess(mResult.BarNo, strIntBase, strResult, strIntResult) = True Then
                            strState = "R"
                        Else
                            If strState = "" Then
                    ...
                    ElseIf strMTB <> "" And strRIF <> "" Then
                        strIntBase = "MTBRIF"
                        If InStr(strRIF, "NOT") > 0 Then
                            strRIF = "감수성"   '음성
                        Else
                            '2020-06-23 : Rif 가 INDETERMINATE 인 결과일 경우 적용
                            If UCase(strRIF) = "INDETERMINATE" Then
                                strRIF = "INDETERMINATE"
                            Else
                                strRIF = "내성"     '양성
                            End If
                        End If
                        
                        strResult = "MTB Positive" & "(" & strMTB & ")" & ", " & "Rifampin " & strRIF
                        If ResultProcess(mResult.BarNo, strIntBase, strResult, strIntResult) = True Then
                            strState = "R"
                        Else
                            If strState = "" Then
                    ...
                    If strCDIF <> "" And str027 = "" Then
                        ...
                        strCDIF = ""
                        str027 = ""
                    ElseIf strCDIF <> "" And str027 <> "" Then
                        strIntBase = "CDiff027"
                        If InStr(str027, "NEG") > 0 Then
                            str027 = "Negative"   '음성
                        Else
                            str027 = "Positive"   '양성
                        End If
                        
                        If UCase(strCDIF) = "NEGATIVE" And UCase(str027) = "NEGATIVE" Then
                            strResult = "Toxigenic C.diff Negative ; 027 Presumptive Negative"
                        ElseIf UCase(strCDIF) = "POSITIVE" And UCase(str027) = "NEGATIVE" Then
                            strResult = "Toxigenic C.diff Positive ; 027 Presumptive Negative"
                        ElseIf UCase(strCDIF) = "POSITIVE" And UCase(str027) = "POSITIVE" Then
                            strResult = "Toxigenic C.diff Positive ; 027 Presumptive Positive"
                        End If
...
'Private Function GetCarbaRCt(ByVal pChannel As String, ByVal pRcvData As String) As String
'
'    GetCarbaRCt = ""
'    GetCarbaRCt = mGetP(mGetP(pRcvData, 4, "|"), 2, "^")
'
'End Function
