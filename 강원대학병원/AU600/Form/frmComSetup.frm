...
'        .EndColor = vbWhite
    ...
    With Eqp_Property
        ...
        .Add "BARCODE", IIf(chkBarCode.Value = vbChecked, "Y", "")
        INS_BARCODE = IIf(chkBarCode.Value = vbChecked, "Y", "")
    End With
...
'            txtTmp_H = strTmp_LH(1)
            ...
            chkBarCode.Value = IIf(Trim$(mAdoRs("BARCODE") & "") = "Y", vbChecked, vbUnchecked)
            INS_BARCODE = IIf(Trim$(mAdoRs("BARCODE") & "") = "Y", vbChecked, vbUnchecked)
        End If
    End If
    Set mAdoRs = Nothing
End Sub
