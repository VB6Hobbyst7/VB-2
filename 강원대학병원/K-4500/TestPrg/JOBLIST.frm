...
Private Sub cmdSend_Click()
    ...
    f_intCnt = 1
    f_strDta(1) = Chr(2) + "S " + "0001" + "01" + " " + "0001" + Space(20) + Space(4) + "1" + _
                  "0" + "   " + "  " + "2003071800001" + "010203" + Chr(23)
    f_strDta(1) = f_strDta(1) + p_funGet_CheckSum(f_strDta(1))
    
    f_strDta(2) = Chr(2) + "SH" + "0001" + "01" + " " + "0001" + Space(20) + "0001" + "1" + _
                 "010020" + Chr(23)
    f_strDta(2) = f_strDta(2) + p_funGet_CheckSum(f_strDta(2))
    
    f_strDta(3) = Chr(3) + "SH" + "0001" + "02" + " " + "0002" + Space(20) + "0002" + "1" + _
                 "010030" + Chr(3)
    f_strDta(3) = f_strDta(3) + p_funGet_CheckSum(f_strDta(3))
    
    MSComm1.Output = f_strDta(1)
    txtRecve.Text = ""
...
Private Sub Form_Load()
    ...
    lblFilename.Caption = "au600_job.dat"
    ...
    sPath = App.Path
    Open sPath + "\" + "au600_job.log" For Append As #1
...
Private Sub tmrSample_Timer()
    ...
    If f_intIdx > f_intCnt Then tmrSample.Enabled = False:  Exit Sub
