...
Begin VB.Form frmComm 
   ...
   Begin TabDlg.SSTab tabWork 
      ...
      Begin VB.ComboBox cboTest 
         Height          =   300
         ItemData        =   "frmComm_2.frx":6B52
         Left            =   5460
         List            =   "frmComm_2.frx":6B5F
         Style           =   2  '드롭다운 목록
         TabIndex        =   56
         Top             =   480
         Visible         =   0   'False
      ...
      Begin Threed.SSCommand cmdSel 
         ...
         _StockProps     =   78
         BevelWidth      =   1
         Picture         =   "frmComm_2.frx":6B7F
      End
      Begin VB.ComboBox cboRstgbn 
         Height          =   300
         Index           =   1
         ItemData        =   "frmComm_2.frx":7001
         Left            =   -72570
         List            =   "frmComm_2.frx":700E
         Style           =   2  '드롭다운 목록
         TabIndex        =   16
         Top             =   495
         Visible         =   0   'False
      ...
      Begin VB.ComboBox cboRstgbn 
         Height          =   300
         Index           =   0
         ItemData        =   "frmComm_2.frx":7038
         Left            =   3900
         List            =   "frmComm_2.frx":7045
         Style           =   2  '드롭다운 목록
         TabIndex        =   12
         Top             =   480
         Visible         =   0   'False
      ...
      Begin FPSpread.vaSpread spdResult1 
         ...
         SpreadDesigner  =   "frmComm_2.frx":706F
      End
      ...
      Begin FPSpread.vaSpread spdWorkList 
         ...
         MaxRows         =   14
         ScrollBars      =   2
         SpreadDesigner  =   "frmComm_2.frx":7ADA
      End
      ...
      Begin FPSpread.vaSpread spdResult2 
         ...
         ScrollBarMaxAlign=   0   'False
         SelectBlockOptions=   0
         SpreadDesigner  =   "frmComm_2.frx":881F
      End
...
Private Sub cmdRstQuery_Click()
    ...
    Do While Not adoRS.EOF
        With spdResult2
            ...
            For jj = 1 To spdResult1.MaxCols - 4
...
'                            SendCount = SendCount + 1
                        ...
                        ElseIf Mid(fRcvString, 1, 8) = STX + "M 0001" + ETX And SendCount > 0 And SendCount <= spdResult1.maxrows Then
                            ...
                            spdResult1.Col = 1
                            If spdResult1.Value = "0" Then
                                Exit Sub
                            End If
                            Orderoutput = STX + "O "
                            spdResult1.Col = 2  '-- Sample No
                            Orderoutput = Orderoutput + Trim(spdResult1.Text) + Space$(20 - Len(Trim(spdResult1.Text)))
                            spdResult1.Col = 3  '-- Rack No
                            Orderoutput = Orderoutput + "  " + Format(spdResult1.Text, "00")
                            spdResult1.Col = 4  '-- Pos No
                            Orderoutput = Orderoutput + Format(spdResult1.Text, "00")
                            '-- Manual Dil
                            ...
                            If optSeq.Value = True Then
                                spdResult1.Col = 2
                                Rev = sl_spcid_tstcd_select(Trim(spdResult1.Text), Test_Cd)
                                ...
                                For jj = 0 To Rev - 1
                                    If Len(Test_Cd(jj)) > 0 Then
                                        ...
                                        If Not itemX Is Nothing Then
                                            spdResult1.Col = itemX.Index + 4
                                            If spdResult1.BackColor = &HC6FEFF Then
                                                Testoutput = Testoutput + Space$(4 - Len(strEqpCd1)) + strEqpCd1 + "1"
                                                If strEqpCd1 = "50" Then
                                                    Testoutput = Testoutput + "  291  301"
                                                End If
                                            End If
                                            DoEvents
                            ...
                            If chkMan.Value = 1 And Testoutput = "" Then
                                Testoutput = ""
                                For jj = 1 To spdResult1.MaxCols - 4
                                    If Len(Channel(jj).MachCode) > 0 Then
                                        spdResult1.Col = jj + 4
                            ...
                            If Val(Len(Testoutput)) > 0 Then
                                Orderoutput = Orderoutput + Testoutput + ETB
                            Else
                            ...
                            'Call cmdOrder_Click
                            If OrderCnt - 1 = spdResult1.maxrows Then
                            ...
                            spdResult1.Col = 1
                            For kk = 1 To spdResult1.maxrows
                                If spdResult1.Value = "1" Then
                                    lblStatus.Caption = "오더전송중.."
                                    Exit Sub
                                End If
                            Next
...
'                    Timer3.Enabled = False
    ...
    If Patiant_Recevid = True Then
        ...
        For ii = 1 To pDoCount
            ...
            For jj = 1 To spdResult1.MaxCols - 4 '37 '100 UBOUND(brChannel)
            With brSpread
                '----<<<<<<<<<,  세부검사항목을 찿는다.  >>>>>>>----------
                '.Col = pDoCount + 4
...
'                            On Error GoTo 0
                            intCol = itemX.Index
                            'spdResult1.SetText intCol + 4, iRow, FunStr 'strRstval(pDoCount)
                            .Col = intCol + 2
                            .Row = iRow
...
Private Sub Timer3_Timer()
    ...
    '    Debug.Print "[HOST] " & STX & ACK & ETX
    '    Order Request
    '    comEQP.Output = STX + "T " + "                   1" + "  20" + " 1" + ETX
    '    Debug.Print "[HOST] " & STX + "T " + "                   1" + "  20" + " 1" + ETX
