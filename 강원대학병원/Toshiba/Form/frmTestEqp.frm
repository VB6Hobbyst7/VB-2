    ...
    Else
        ...
        For Each itemX In lvwTestListLab.ListItems
            ...
            With SaveList
                ...
                .Add "OUT_SEQ", Trim(itemX.SubItems(5))
...
Private Sub lvwTstListEqp_Click()
    ...
    Else
        ...
        txtOutseq = Trim(itemX.SubItems(1))
        txtTestCD = ""
        txtRefL = ""
        txtRefH = ""
    End If
...
'                    .SubItems(1) = Trim(mAdoRs("TESTNM_EQP") & "")
                    ...
                    .SubItems(5) = Trim(mAdoRs("OUT_SEQ") & "")
                End With
                mAdoRs.MoveNext
            Loop
        End If
...
Private Sub Set_ListView()
    ...
    With lvwTstListEqp
        ...
        With .ColumnHeaders
            .Clear
            Call .Add(1, "Code", "장비코드(채널)", lvwWidth * 0.4)
    ...
    With lvwTestListLab
        ...
        With .ColumnHeaders
            ...
            Call .Add(6, "OutSeq", "구분", lvwWidth * 0.22, lvwColumnCenter)
        End With
    End With
