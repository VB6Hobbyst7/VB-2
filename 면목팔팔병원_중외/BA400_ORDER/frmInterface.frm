...
Begin VB.Form frmInterface 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin FPSpread.vaSpread vasID 
         ...
         MoveActiveOnFocus=   0   'False
         RetainSelBlock  =   0   'False
         SpreadDesigner  =   "frmInterface.frx":2185
      End
      ...
      Begin FPSpread.vaSpread vasRes 
         ...
         RetainSelBlock  =   0   'False
         ScrollBars      =   2
         SpreadDesigner  =   "frmInterface.frx":2DD4
      End
   End
   ...
   Begin VB.Frame FrmHideControl 
      ...
      Begin VB.ComboBox cboChk 
         ...
         EndProperty
         Height          =   315
         ItemData        =   "frmInterface.frx":44D3
         Left            =   4320
         List            =   "frmInterface.frx":44E0
         TabIndex        =   74
         Top             =   3390
         Width           =   975
      End
      ...
      Begin VB.ComboBox cboTest 
         ...
         ForeColor       =   &H00FF0000&
         Height          =   300
         ItemData        =   "frmInterface.frx":44F6
         Left            =   7170
         List            =   "frmInterface.frx":44F8
         Style           =   2  '드롭다운 목록
         TabIndex        =   71
         Top             =   3090
         Visible         =   0   'False
      ...
      Begin VB.Frame Frame4 
         ...
         Begin FPSpread.vaSpread vasPrint 
            ...
            EndProperty
            MaxCols         =   9
            SpreadDesigner  =   "frmInterface.frx":44FA
         End
         Begin FPSpread.vaSpread vasPrintBuf 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            SpreadDesigner  =   "frmInterface.frx":5F73
         End
      End
      ...
      Begin FPSpread.vaSpread vasCode 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":618B
      End
      Begin FPSpread.vaSpread vasTemp1 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":63A3
      End
         ...
         Begin MSComctlLib.ImageList imlStatus 
            ...
            BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
               ...
               BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":6B45
                  Key             =   "RUN"
               EndProperty
               BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":70DF
                  Key             =   "NOT"
               EndProperty
               BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":7679
                  Key             =   "STOP"
               EndProperty
               BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":7C13
                  Key             =   "LST"
               EndProperty
               BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":84A5
                  Key             =   "ITM"
               EndProperty
               BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":85FF
                  Key             =   "ERR"
               EndProperty
               BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":8759
                  Key             =   "NOF"
               EndProperty
            EndProperty
         End
      ...
      Begin FPSpread.vaSpread vasList 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":88B3
      End
      Begin FPSpread.vaSpread vasResTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":8ACB
      End
      Begin FPSpread.vaSpread vasTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":8CE3
      End
      Begin FPSpread.vaSpread vasExcel 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":8EFB
      End
...
Private Sub cmdOrder_Click()
    ...
    If vasWork.Visible = True Then
        vasWork.Visible = False
    Else
        vasWork.Visible = True
    End If
...
Private Sub GetWorkList_JWINFO(ByVal pFrDt As String, ByVal pToDt As String, Optional pBarNo As String)
    ...
    'If chkBarUse.Value = "1" Then
        '--바코드 사용
              SQL = "SELECT DISTINCT RECEIPTDATE as 접수일자, SPECIMENNUM as 바코드번호,  IPDOPD, PTNO as 내원번호, SNAME as 이름, LABCODE as ITEM,ORDERCODE, SEX"
        ...
        SQL = SQL & "  ORDER BY RECEIPTDATE,RECEIPTDATE "
'    Else
'              SQL = "SELECT DISTINCT RECEIPTDATE as 접수일자, RECEIPTNO as 챠트번호, IPDOPD, PTNO as 내원번호, SNAME as 이름, LABCODE as ITEM,ORDERCODE"
'        SQL = SQL & vbCrLf & "  FROM SLA_LabMaster "
'        SQL = SQL & vbCrLf & " WHERE RECEIPTDATE between '" & Format(pFrDt, "####-##-##") & "' and '" & Format(pToDt, "####-##-##") & "'"
'        SQL = SQL & vbCrLf & "   AND LABCODE IN (" & gAllExam & ") "
'        SQL = SQL & vbCrLf & "   AND JSTATUS < '3'" & vbLf
...
'    Winsock1.Listen
    ...
    ipAdd = "192.168.1.162"
    Winsock1.Close
    Winsock1.Connect ipAdd, CInt(5000) '5150
...
'H|\^&|69F2746D24014F21AD7139756F64CAD8||Modulab|||||BA400||P|LIS2A|2013012
'9102030
'P|1||PID01||Campeny^Ricard||19850819|M
'O|1|SPM01||^^^Test1|R|20130129101530|20130129092030||||A||||SER||||||||||O
'O|2|SPM01||^^^Test2|R|20130129101530|20130129092030||||A||||SER||||||||||O
'O|3|SPM02||^^^Test3|R|20130129101730|20130129092031||||A||||SER||||||||||O
'L|1|N
...
'Recv: <ACK>
'Send:
'<STX>H|\^&|20150728095716636IDP3OZHZLHIKYNOVRGGV2PI0F1MD||BA400|||||Modulab||P|L
'IS2A|20130419064309<CR>
'Q|1|0010079||O<CR>
'L|1|N<CR><ETX>84<CR><LF>
'Recv: <ACK>
'Send: <EOT>
...
'Send: <ACK>
'Recv:
'<STX>H|\^&|20150728095716636IDP3OZHZLHIKYNOVRGGV2PI0F1MD||Modulab|||||BA400||
'P|LIS2A|20130129102030<CR>
'P|1||PID01||Campeny^Ricard||19850819|M<CR>
'O|1|0010079||^^^ASO|R|20130129101530|20130129092030||||A||||SER||||||||||O<CR>
'L|1|N<CR><ETX>OB<CR><LF>
'Send: <ACK>
'Recv: <EOT>


'H|\^&|69F2746D24014F21AD7139756F64CAD8||Modulab|||||BA400||P|LIS2A|2013012912030
'P|1||PID01||Campeny^Ricard||19850819|M
'O|1|SPM01||^^^Test1|R|20130129101530|20130129092030||||A||||SER||||||||||O\Q
'O|2|SPM02||^^^|||20130129092530||||||||SER||||||||||Y\Q
'L|1|F

'12.11 LIS2-A2 Query (Windows 8.1)
'<STX>H|\^&|04caf708-2599-438c-bd8e-a40b42241925||Modulab|||||BA400||P|LIS
'2A|20150825110301<CR><LF>
'P|1||AJ001||APELLIDO_1 APELLIDO_2^NOMBRE_1||19700717|U<CR><LF>
'O|1|2400003001||^^^ALBUMIN|R||||||A||||SER||||||||||O<CR><LF>
'P|2||AJ001||APELLIDO_1 APELLIDO_2^NOMBRE_1||19700717|U<CR><LF>
'O|1|4800003001||^^^ALBUMIN-MAU|R||||||A||||URI||||||||||O<CR><LF>
'O|2|4800003001||^^^A1-MICROGLOBULIN|R||||||A||||URI||||||||||O<CR><LF>
'L|1|F<CR><ETX>84<LF>
...
'    Call SetText(vasID, mOrder.SendCnt, intRow, colRCNT)
'    Call SetText(vasID, strItems, intRow, colOCNT)
    ...
    Select Case intSndPhase
        Case 1
                intCnt = 1
                strOutput = ""
                'strOutput = strOutput & "1H|\^&|" & mOrder.HEADER & "||Host|||||BA400||P|LIS2A|" & strDate & vbCr
                strOutput = strOutput & "H|\^&|" & mOrder.HEADER & "||Host|||||BA400||P|LIS2A|" & strDate & vbCr
                
               '      Call SetText(vasWork, strBarNo, vasWork.MaxRows, colBARCODE)
               '     Call SetText(vasWork, GetText(vasID, gRow, colOCNT), vasWork.MaxRows, colOCNT)
               
                
                For i = 1 To vasWork.MaxRows
                    strBarNo = GetText(vasWork, i, colBARCODE)
                    strSex = GetText(vasWork, i, colPSEX)
                    If strBarNo <> "" And IsNumeric(strBarNo) Then
                        
                        'strOutput = strOutput & "P|" & CStr(intCnt) & "||" & Format(strBarNo, "00000000") & "||^|||" & vbCr
                        strOutput = strOutput & "P|" & CStr(intCnt) & "||" & Format(strBarNo, "00000000") & "|||||" & strSex & vbCr
                        
                        varItems = GetText(vasWork, i, colOCNT)
                        varItems = Split(varItems, "\")
                        For j = 0 To UBound(varItems)
                            strOutput = strOutput & "O|" & CStr(j + 1) & "|" & Format(strBarNo, "00000000") & "||" & varItems(j) & "|R||||||A||||SER||||||||||O" & vbCr
                        Next
                        
                        For k = vasID.MaxRows To 1 Step -1
                            vasID.Row = k
                            vasID.Col = colBARCODE
                            If IsNumeric(vasID.Text) Then
                                If Val(strBarNo) = Val(vasID.Text) Then
                                    Call SetText(vasID, "Order", i, colState)
                                    Exit For
                                End If
                            End If
                        Next
...
Private Sub GetOrder(ByVal pBarNo As String)
    ...
    'If GetSampleInfoW_JWINFO(intRow) = 1 Then
        'vasWork.MaxRows = vasWork.MaxRows + 1
        'Call SetText(vasWork, pBarNo, vasWork.MaxRows, colBARCODE)
        'Call SetText(vasWork, GetText(vasID, intRow, colOCNT), vasWork.MaxRows, colOCNT)
        'Call SetText(vasWork, GetText(vasID, intRow, colPSEX), vasWork.MaxRows, colPSEX)
    'End If
    ...
    With mOrder
        ...
        .PNM = GetText(vasID, intRow, colPNAME)
    End With
    ...
    strItems = GetEquipExamCode_BA400(gEquip, pBarNo, intRow)
...
'    End If
    ...
    '-- 진행상태(Order) 표시
    Call SetText(vasID, "", intRow, colState)
...
'       - pBarNo : 바코드번호
'-----------------------------------------------------------------------------'
Private Sub GetWork(ByVal pBarNo As String)
    ...
    For i = vasWork.DataRowCnt To 1 Step 1
        If Trim(GetText(vasWork, i, colBARCODE)) = pBarNo Then
            intRow = i
            Exit For
        End If
    Next i
    ...
    If intRow < 0 Then
        intRow = vasWork.DataRowCnt + 1
        If vasWork.MaxRows < intRow Then
            vasWork.MaxRows = intRow
        End If
    End If
    
    '-- 장비수신정보 표시
    Call SetText(vasWork, pBarNo, intRow, colBARCODE)             '-- 바코드
    
    '-- 환자정보 표시
    Call vasActiveCell(vasWork, intRow, colBARCODE)
    
    '-- 결과스프레드 지우기
    Call ClearSpread(vasRes)
    
    '-- 검사자 정보 가져오기
    Call GetSampleInfoW_JWINFO_Work(intRow)
    
    With mOrder
        .BarNo = pBarNo
        .PID = GetText(vasWork, intRow, colPID)
        .PNM = GetText(vasWork, intRow, colPNAME)
    End With
    
    strItems = ""
    mOrder.Order = ""
    
    strItems = GetEquipExamCode_BA400_Work(gEquip, pBarNo, intRow)
    
    '-- 진행상태(Order) 표시
    Call SetText(vasWork, "", intRow, colState)
    
    '-- 오더저장
    Call SetText(vasWork, strItems, intRow, colOCNT)
...
'-- 로컬테이블에서 검사항목에 해당하는 검사채널 찾아오기
Function GetEquipExamCode_BA400(argEquipCode As String, argPID As String, Optional intRow As Long) As String
    Dim i As Integer
    Dim strExamCode As String
    Dim sBarcode     As String
    Dim strCBC As String
    ...
    GetEquipExamCode_BA400 = strExamCode
    
End Function

'-- 로컬테이블에서 검사항목에 해당하는 검사채널 찾아오기
Function GetEquipExamCode_BA400_Work(argEquipCode As String, argPID As String, Optional intRow As Long) As String
    Dim i As Integer
    Dim strExamCode As String
    Dim sBarcode     As String
    Dim strCBC As String
    ...
    sBarcode = Trim(GetText(vasWork, intRow, colBARCODE))   '2 샘플 바코드 번호
    ...
    GetEquipExamCode_BA400_Work = strExamCode
...
Private Sub SetPatInfo(ByVal pBarNo As String, Optional ByVal pRno As String, Optional ByVal pPno As String)
    ...
    For i = 1 To vasID.DataRowCnt
        If Val(Trim(GetText(vasID, i, colBARCODE))) = Val(pBarNo) Then
            intRow = i
            Exit For
        End If
    Next i
    ...
    For i = 1 To vasWork.DataRowCnt
        If Val(Trim(GetText(vasWork, i, colBARCODE))) = Val(mResult.BarNo) Then
            vasWork.Row = i
            vasWork.Col = colBARCODE
            vasWork.Action = ActionDeleteRow
            vasWork.MaxRows = vasWork.MaxRows - 1
            Exit For
        End If
    Next
...
'    Dim strSend  As String
    ...
    For intCnt = 1 To UBound(strRecvData)
        ...
        Select Case strType
            Case "H"
                strHeader = Trim(mGetP(strRcvBuf, 3, "|"))
            Case "Q"
                varBarNo = Trim(mGetP(strRcvBuf, 3, "|"))
                If varBarNo = "" Then Exit Sub
                varBarNo = Split(varBarNo, "\")
                
                For i = 0 To UBound(varBarNo)
                    strBarNo = varBarNo(i)
                    mOrder.BarNo = strBarNo
                    mOrder.HEADER = strHeader
                    
                    If strBarNo <> "" Then
                        Call GetWork(strBarNo)
                    End If
                Next
...
'                    strBarNo = Trim$(mGetP(strRcvBuf, 3, "|"))
            ...
            Case "P"
                ...
                If strBarNo = "" Then
                    strBarNo = "오더없음" & Format(Now, "yymmddhhmmss")
                End If
