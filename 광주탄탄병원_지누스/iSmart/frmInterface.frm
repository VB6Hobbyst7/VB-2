   ...
   Begin TabDlg.SSTab stInterface 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.ComboBox cboChk 
            ...
            EndProperty
            Height          =   300
            ItemData        =   "frmInterface.frx":C1AF
            Left            =   2340
            List            =   "frmInterface.frx":C1B9
            TabIndex        =   45
            Top             =   -90
            Visible         =   0   'False
            Width           =   765
         ...
         Begin FPSpread.vaSpread vasID 
            ...
            RetainSelBlock  =   0   'False
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":C1C9
            UserResize      =   2
         End
         Begin FPSpread.vaSpread vasRes 
            ...
            RetainSelBlock  =   0   'False
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":CCCF
         End
...
Private Sub GetWorkList_Bar(ByVal pFrDt As String, ByVal pToDt As String, ByVal pBarNo As String)
    Dim i           As Integer
    Dim intRow      As Long
    Dim strItems    As String
    Dim strExamCode As String
...
'                Next
                ...
                strBarNo = Mid(strBarNo, 1, 2) & "-" & Mid(strBarNo, 3) & "-1"
                'If strBarNo = "" Then Exit Sub
                
                'Call SetPatInfo(strBarNo)
                Call GetWorkList_Bar(Format(dtpStartDt.Value, "yyyymmdd"), Format(dtpStopDt.Value, "yyyymmdd"), strBarNo)
                ...
                If strResult <> "" Then
                    ...
                    Else
                        ...
                        If Res > 0 Then
                            ...
                            '-- Work List
                            SetText vasWorkList, "Result", gRow, colState                 '진행상태
