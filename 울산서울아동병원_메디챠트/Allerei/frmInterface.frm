...
Begin VB.Form frmInterface 
   ...
   Begin VB.Frame FrmHideControl 
      ...
      Begin VB.ComboBox cboChk 
         ...
         EndProperty
         Height          =   315
         ItemData        =   "frmInterface.frx":3827
         Left            =   5580
         List            =   "frmInterface.frx":3834
         TabIndex        =   65
         Top             =   5280
         Visible         =   0   'False
         Width           =   975
      ...
      Begin VB.ComboBox cboTest 
         ...
         ForeColor       =   &H00FF0000&
         Height          =   300
         ItemData        =   "frmInterface.frx":384C
         Left            =   5460
         List            =   "frmInterface.frx":384E
         Style           =   2  '드롭다운 목록
         TabIndex        =   59
         Top             =   3690
         Width           =   1545
      ...
      Begin VB.Frame Frame4 
         ...
         Begin FPSpread.vaSpread vasPrint 
            ...
            EndProperty
            MaxCols         =   9
            SpreadDesigner  =   "frmInterface.frx":3850
         End
         Begin FPSpread.vaSpread vasPrintBuf 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            SpreadDesigner  =   "frmInterface.frx":52C9
         End
      End
      ...
      Begin FPSpread.vaSpread vasCode 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":54E1
      End
      Begin FPSpread.vaSpread vasTemp1 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":56F9
      End
         ...
         Begin MSComctlLib.ImageList imlStatus 
            ...
            BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
               ...
               BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":5E9B
                  Key             =   "RUN"
               EndProperty
               BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":6435
                  Key             =   "NOT"
               EndProperty
               BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":69CF
                  Key             =   "STOP"
               EndProperty
               BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":6F69
                  Key             =   "LST"
               EndProperty
               BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":77FB
                  Key             =   "ITM"
               EndProperty
               BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":7955
                  Key             =   "ERR"
               EndProperty
               BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":7AAF
                  Key             =   "NOF"
               EndProperty
            EndProperty
         End
      ...
      Begin FPSpread.vaSpread vasList 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":7C09
      End
      Begin FPSpread.vaSpread vasResTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":7E21
      End
      Begin FPSpread.vaSpread vasTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":8039
      End
      Begin FPSpread.vaSpread vasExcel 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":8251
      End
...
Private Sub cmdReadJSON_Click()
    ...
    For i = 0 To UBound(varLink)
        If Mid(varLink(i), 1, 7) = "http://" And Right(varLink(i), 4) = "json" Then
            ...
            '-- 테스트용 : 컴파일시 제외할것 !!!!!!!!!!
            'strFilePath = "C:\프로젝트\강안병원_자인컴\Test\Alerei_Patient_02_34507017_16-12-03_09-25-01_b222b707-afbe-4151-af67-31fea613c3ba.json"
            '-- 테스트용 : 컴파일시 제외할것 !!!!!!!!!!
...
Private Sub GetWorkList_JAINCOM(ByVal pFrDt As String, ByVal pToDt As String, Optional pBarNo As String)
    Dim RS          As ADODB.Recordset
    Dim i           As Integer
    Dim iCnt        As Long
    Dim intRow      As Long
...
'      -- 테이블 사용
          SQL = "SELECT DiSTINCT b.SCP42JDATE as 접수일자, a.SCP41SPMNO2 as 바코드번호, b.SCP42IDNOA as 내원번호, a.SCP41NAME as 이름, a.SCP41SEX as 성별, a.SCP41BIRTH as 나이"
    ...
    SQL = SQL & vbCrLf & "   AND b.SCP42JDATE BETWEEN '" & pFrDt & "' AND '" & pToDt & "'" & vbCrLf '작업일자
    SQL = SQL & vbCrLf & "   AND b.SCP42SUGACD  IN (" & gAllExam & ")" & vbCrLf
...
Private Sub GetWorkList_MEDICHART(ByVal pFrDt As String, ByVal pToDt As String, Optional pBarNo As String)
    Dim RS          As ADODB.Recordset
    Dim i           As Integer
    Dim iCnt        As Long
    Dim intRow      As Long
...
'    strTDay = Mid(pToDt, 7, 2)
    ...
    vasID.ReDraw = False
          ...
          SQL = "Select Distinct a.챠트번호, (a.진료년 + a.진료월 + a.진료일) as 접수일자, c.진료상태, b.수진자명, b.주민등록번호" & vbCr
    SQL = SQL & "  From TB_검사항목 a, TB_인적사항 b, tb_진료기본 c " & vbCr
    SQL = SQL & " Where a.진료년 + a.진료월 + a.진료일" & " >= '" & pFrDt & "'" & vbCr
    SQL = SQL & "   And a.진료년 + a.진료월 + a.진료일" & " <= '" & pToDt & "'" & vbCr
...
'                If blnSame = False Then
                    ...
                    'SetText vasID, Trim(rs.Fields("차트번호")) & "", .MaxRows, colCHARTNO
                    'SetText vasID, Trim(RS.Fields("내원번호")) & "", .MaxRows, colPID
                    SetText vasID, Trim(RS.Fields("수진자명")) & "", .MaxRows, colPNAME
                    'SetText vasID, Trim(RS.Fields("성별")) & "", .MaxRows, colPSEX
                    'SetText vasID, Trim(RS.Fields("나이")) & "", .MaxRows, colPAGE
                'End If
                'blnSame = False
...
Private Sub cmdSearch_Click()
    ...
    Select Case gOCS
        ...
        Case "MEDICHART":   Call GetWorkList_MEDICHART(Format(dtpStartDt.Value, "yyyymmdd"), Format(dtpStopDt.Value, "yyyymmdd"))
        Case "JBUNIV":      Call GetWorkList_JBUNIV(Format(dtpStartDt.Value, "yyyymmdd"), Format(dtpStopDt.Value, "yyyymmdd"))
        Case "JAINCOM":     Call GetWorkList_JAINCOM(Format(dtpStartDt.Value, "yyyymmdd"), Format(dtpStopDt.Value, "yyyymmdd"))
    End Select
...
'    Next i
    ...
    Call GetSampleInfoW_JAINCOM(intRow)
...
'        End If
    ...
    ElseIf KeyCode = vbKeyReturn Then
        If iCol = colBARCODE Then
            ...
            '-- 바뀐 바코드로 환자정보 불러오기
            Call GetSampleInfoW_JAINCOM(iRow)
