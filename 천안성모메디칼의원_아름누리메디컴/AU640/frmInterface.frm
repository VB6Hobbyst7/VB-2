...
Begin VB.Form frmInterface 
   Caption         =   " OLYMPUS AU640 Interface "
   ClientHeight    =   10680
   ClientLeft      =   345
   ClientTop       =   840
   ClientWidth     =   25560
...
Private Sub GetOrder(ByVal pBarNo As String)
    ...
    Else
        ...
        comEqp.Output = STX & "S " & mOrder.RackNo & mOrder.TubePos & Space(1) & mOrder.Seq & Space(26 - Len(mOrder.BarNo)) & mOrder.BarNo & Space(4) & "E" & strItems & ETX
        SetRawData "[Tx]" & STX & "S " & mOrder.RackNo & mOrder.TubePos & Space(1) & mOrder.Seq & Space(26 - Len(mOrder.BarNo)) & mOrder.BarNo & Space(4) & "E" & strItems & ETX
    End If
