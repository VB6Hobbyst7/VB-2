...
Private Sub spdROrder_KeyPress(KeyAscii As Integer)
    ...
    sRow = spdROrder.ActiveRow
    sCol = spdROrder.ActiveCol
    strNewBarNo = GetText(spdROrder, sRow, sCol)
...
Private Sub wsck_ConnectionRequest(ByVal requestID As Long)
    ...
    'Debug.Print "wsck_ConnectionRequest"
    If wSck.State <> sckClosed Then
        'Debug.Print "CLOSE"
        wSck.Close
            ...
            Case 4      '## Termination Phase
                Select Case BufChar
                    Case STX
                        intPhase = 2
                    Case EOT
                        Call frmMain.TCPRcvData_ASPECT
                        intPhase = 1
                End Select
        End Select
    Next i
