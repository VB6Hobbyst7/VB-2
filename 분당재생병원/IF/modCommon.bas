...
'    gCENXPCD = Trim(strSetUp1)
    ...
    '-- ALLEREI PATH
    strSetup = "":    strSetUp1 = ""
    Call GetPrivateProfileString("HOSP", "ALLEREIPATH", "", strSetup, 100, App.PATH & "\INI\" & gHOSP.APPNM & ".ini")
    strSetUp1 = Trim(strSetup)
    strSetUp1 = Mid(strSetUp1, 1, Len(strSetUp1) - 1)
    gHOSP.ALLEREIPATH = Trim(strSetUp1)
