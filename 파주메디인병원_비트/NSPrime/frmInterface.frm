...
Begin VB.Form frmInterface 
   ...
   Begin VB.PictureBox Picture2 
      ...
      Begin VB.Frame Frame3 
         ...
         Begin VB.TextBox txtSeq 
            ...
            Width           =   435
         End
         Begin VB.CommandButton cmdWorkClear 
            Caption         =   "워크Clear"
            BeginProperty Font 
               Name            =   "굴림체"
               Size            =   9
   ...
   Begin VB.Frame Frame1 
      ...
      End
      Begin VB.CommandButton cmdWorkSet 
         Caption         =   "워크맞춤"
         BeginProperty Font 
            Name            =   "굴림체"
            Size            =   9
      ...
      Begin FPSpread.vaSpread vasWorklist 
         ...
         MoveActiveOnFocus=   0   'False
         RetainSelBlock  =   0   'False
         SpreadDesigner  =   "frmInterface.frx":20FF
      End
      ...
      Begin FPSpread.vaSpread vasRes 
         ...
         RetainSelBlock  =   0   'False
         ScrollBars      =   2
         SpreadDesigner  =   "frmInterface.frx":2D08
      End
   ...
   Begin VB.Frame FrmHideControl 
      ...
      Begin VB.Frame Frame5 
         ...
         Begin VB.ComboBox cboChk 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmInterface.frx":4421
            Left            =   2460
            List            =   "frmInterface.frx":442E
            TabIndex        =   68
            Top             =   1680
            Visible         =   0   'False
            Width           =   975
         ...
         Begin VB.ComboBox cboTest 
            ...
            ForeColor       =   &H00FF0000&
            Height          =   300
            ItemData        =   "frmInterface.frx":4446
            Left            =   600
            List            =   "frmInterface.frx":4448
            Style           =   2  '드롭다운 목록
            TabIndex        =   67
            Top             =   1650
            Visible         =   0   'False
      ...
      Begin VB.Frame Frame4 
         ...
         Begin FPSpread.vaSpread vasPrint 
            ...
            EndProperty
            MaxCols         =   9
            SpreadDesigner  =   "frmInterface.frx":444A
         End
         Begin FPSpread.vaSpread vasPrintBuf 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            SpreadDesigner  =   "frmInterface.frx":5ED1
         End
      End
      ...
      Begin FPSpread.vaSpread vasCode 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":60F7
      End
      Begin FPSpread.vaSpread vasTemp1 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":631D
      End
         ...
         Begin MSComctlLib.ImageList imlStatus 
            ...
            BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
               ...
               BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":6ACD
                  Key             =   "RUN"
               EndProperty
               BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":7067
                  Key             =   "NOT"
               EndProperty
               BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":7601
                  Key             =   "STOP"
               EndProperty
               BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":7B9B
                  Key             =   "LST"
               EndProperty
               BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":842D
                  Key             =   "ITM"
               EndProperty
               BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":8587
                  Key             =   "ERR"
               EndProperty
               BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":86E1
                  Key             =   "NOF"
               EndProperty
            EndProperty
         End
      ...
      Begin FPSpread.vaSpread vasList 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":883B
      End
      Begin FPSpread.vaSpread vasResTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":8A61
      End
      Begin FPSpread.vaSpread vasTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":8C87
      End
      Begin FPSpread.vaSpread vasExcel 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":8EAD
      End
...
Private Sub chkWAlla_Click()
    Dim iRow As Long
    
    With vasWorklist
        If chkWAlla.Value = 1 Then
            For iRow = 1 To .DataRowCnt
                .Row = iRow
                .Col = colCheckBox
                .Value = 1
            Next iRow
        ElseIf chkWAlla.Value = 0 Then
            For iRow = 1 To .DataRowCnt
                .Row = iRow
                .Col = colCheckBox
                .Value = 0
    ...
    With vasWorklist
        For intRow = 1 To .DataRowCnt
            ...
            If .Value = 1 Then
                ...
                SetText vasID, Trim(GetText(vasWorklist, intRow, colHOSPDATE)), vasID.MaxRows, colHOSPDATE
                SetText vasID, Trim(GetText(vasWorklist, intRow, colBARCODE)), vasID.MaxRows, colBARCODE
                SetText vasID, Trim(GetText(vasWorklist, intRow, colCHARTNO)), vasID.MaxRows, colCHARTNO
                ...
                SetText vasID, Trim(GetText(vasWorklist, intRow, colINOUT)), vasID.MaxRows, colINOUT
                SetText vasID, Trim(GetText(vasWorklist, intRow, colSPCNM)), vasID.MaxRows, colSPCNM
...
'    End If
    ...
    SQL = ""
    SQL = SQL & "SELECT L.LABSERIAL, L.LABATTEND as 내원번호, L.LABCHTNUM as 챠트번호, L.LABODRDTE as 접수일자, M.MANADMFOR as 입외,L.LABODRSTP," & vbCrLf
    SQL = SQL & "       M.MANRESNUM as 주민번호, M.MANPATNAM as 이름, L.LABINSNUM as 처방순서,L.LABSMPNAM as 검체명, L.LABBARCOD as 바코드번호, L.LABODRCOD as ITEM, L.LABODRSTP as SEQ " & vbCrLf
    SQL = SQL & "  FROM ME_LABDAT L, ME_DAT D, ME_MAN M" & vbCrLf
    SQL = SQL & " WHERE L.LABODRDTE between  '" & pFrDt & "' AND '" & pToDt & "'" & vbCrLf
    SQL = SQL & "   AND L.LABKEYNUM = D.DATKEYNUM " & vbCrLf                    '-- 테이블연결키값
        ...
        Do Until RS.EOF
            ...
            With vasWorklist
                ...
                For i = 1 To .DataRowCnt
                    ...
                    strChart = GetText(vasWorklist, i, colCHARTNO)
                    If Trim(RS("접수일자")) = strDate And Trim(RS("챠트번호")) = strChart Then
                        blnSame = True
                    End If
                ...
                If blnSame = False Then
                    ...
                    SetText vasWorklist, Trim(RS.Fields("내원번호")) & "", .MaxRows, colPID
                    SetText vasWorklist, Trim(RS.Fields("이름")) & "", .MaxRows, colPNAME
                    SetText vasWorklist, Trim(RS.Fields("검체명")) & "", .MaxRows, colSPCNM
                    SetText vasWorklist, Trim(RS.Fields("SEQ")) & "", .MaxRows, colPAGE
                    
                    SetText vasWorklist, Trim(RS.Fields("LABODRSTP")) & "", .MaxRows, colSPCNM
                    
                    Select Case Trim(Trim(RS.Fields("입외")) & "")
                        Case "A":   SetText vasWorklist, "입원", .MaxRows, colINOUT
                        Case "F":   SetText vasWorklist, "외래", .MaxRows, colINOUT
                        Case Else:  SetText vasWorklist, "", .MaxRows, colINOUT
                    End Select
                    
                    SetText vasWorklist, CStr(.MaxRows), .MaxRows, colSN
                    
'                    If optBW(1).Value = True Then
'                        SetText vasworklist, txtRack.Text, .MaxRows, colDISKNO
'                        SetText vasworklist, txtPos.Text, .MaxRows, colPOSNO
'
'                        txtPos.Text = Format(Val(txtPos.Text) + 1, "00")
'                        If txtPos.Text = "11" Then
'                            txtPos.Text = "01"
...
Private Sub cmdWorkClear_Click()
    Dim i As Integer
...
Private Sub cmdWorkSet_Click()
    ...
    For i = 1 To vasWorklist.MaxRows
        ...
        If vasWorklist.Value = "1" Then
            For j = 1 To vasID.MaxRows
                vasID.Row = j
                vasID.Col = colCheckBox
                If vasID.Value = "1" Then
                    '-- 바뀐 바코드로 환자정보 불러오기
                    Call GetSampleInfoW_SSHWORK(i, j)
                    
                    lsID = Trim(GetText(vasID, j, colCHARTNO))
                    
                    
                          SQL = "UPDATE PATRESULT SET"
                    SQL = SQL & " HOSPDATE = '" & Format(Mid(Trim(GetText(vasID, j, colHOSPDATE)), 1, 10), "yyyymmdd") & "' " & vbCrLf
                    SQL = SQL & ",BARCODE = '" & lsID & "' " & vbCrLf
                    SQL = SQL & ",CHARTNO = '" & Trim(GetText(vasID, j, colCHARTNO)) & "' " & vbCrLf
                    SQL = SQL & ",PID = '" & Trim(GetText(vasID, j, colPID)) & "' " & vbCrLf
                    SQL = SQL & ",PNAME = '" & Trim(GetText(vasID, j, colPNAME)) & "' " & vbCrLf
                    SQL = SQL & ",PSEX = '" & Trim(GetText(vasID, j, colPSEX)) & "' " & vbCrLf
                    SQL = SQL & ",PAGE = '" & Trim(GetText(vasID, j, colPAGE)) & "' " & vbCrLf
                    SQL = SQL & " WHERE EQUIPNO = '" & gEquip & "' " & vbCrLf
                    SQL = SQL & "   AND SAVESEQ = " & Trim(GetText(vasID, j, colSAVESEQ)) & vbCrLf
                    SQL = SQL & "   AND MID(EXAMDATE,1,8) = '" & Mid(Trim(GetText(vasID, j, colEXAMDATE)), 1, 8) & "' " & vbCrLf
                    'SQL = SQL & "   AND BARCODE = '" & lblBarcode(0).Caption & "' "
        
                    Call SetSQLData("바코드조회_로컬UP", SQL)
                    Res = SendQuery(gLocal, SQL)
...
Private Sub Form_Resize()
    ...
    Else
        ...
        vasWorklist.Width = frmInterface.ScaleWidth - 300
...
Private Sub Label1_DblClick(Index As Integer)
    If chkSaveAll.Visible = "1" Then
        chkSaveAll.Visible = "0"
    Else
        chkSaveAll.Visible = "1"
    End If
...
Private Sub SetPatInfo(ByVal pBarNo As String, Optional ByVal pRno As String, Optional ByVal pPno As String)
    ...
    If Mid(mResult.BarNo, 1, 7) = "NoOrder" Then
...
Private Sub EditRcvDataASTM()
    ...
    If Mid$(strTemp1, 2, 1) <> "U" Then '"U" = 검체 "C" = 컨트롤
        Exit Sub
    End If
    ...
    If strBarNo = "" Then
        For i = 1 To vasID.DataRowCnt
            vasID.Row = i
            vasID.Col = colCheckBox
            If Trim(vasID.Text) = "1" And GetText(vasID, i, colState) = "" Then
    ...
    Else
        For i = 1 To vasID.DataRowCnt
            vasID.Row = i
            vasID.Col = colCHARTNO
            If Trim(vasID.Text) = strBarNo Then
                vasID.Col = colCHARTNO
                strBarNo = vasID.Text
                Exit For
            End If
    ...
    If strBarNo = "" Then
        strBarNo = "NoOrder_" & strRackNo & "-" & strTubePos
    End If
            ...
            For i = .ActiveRow To .MaxRows
                ...
                If .Value = "1" Then
                    ...
                    For j = 1 To vasID.MaxRows
                        ...
                        If vasID.Value = "1" Then
                            vasID.Col = colSN
                            If strNum <> vasID.Text Then
                                vasID.Row = j
                                vasID.Col = colSN
                                vasID.Text = txtSeq.Text
                                Exit For
                            End If
                        End If
                    Next
...
Private Sub vasWorklist_DblClick(ByVal Col As Long, ByVal Row As Long)
    ...
    With vasWorklist
        ...
        SetText vasID, Trim(GetText(vasWorklist, Row, colHOSPDATE)), vasID.MaxRows, colHOSPDATE
        SetText vasID, Trim(GetText(vasWorklist, Row, colCHARTNO)), vasID.MaxRows, colCHARTNO
        ...
        SetText vasID, Trim(GetText(vasWorklist, Row, colPAGE)), vasID.MaxRows, colPAGE
        SetText vasID, Trim(GetText(vasWorklist, Row, colINOUT)), vasID.MaxRows, colINOUT
        SetText vasID, Trim(GetText(vasWorklist, Row, colSPCNM)), vasID.MaxRows, colSPCNM
