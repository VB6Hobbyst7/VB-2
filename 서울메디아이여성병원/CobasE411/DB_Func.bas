...
'SQL Server, Sybase (yyyy/mm/dd hh:nn:ss)
    ...
    res = db_select_Var(gServer, SQL, GetDateFull)
    
    If res = -1 Then
        GetDateFull = Format(Date, "yyyy-mm-dd") & " " & Format(Time, "hh:mm:ss")
    End If
...
On Error GoTo errFind
    ...
    With cn_Ser
'''        .ConnectionString = "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=C:\RS232\;" & _
'''                            "Extended Properties=Paradox 5.x;"
        .ConnectionString = "Driver={Microsoft Paradox Driver (*.db )};DriverID=538;Fil=Paradox 5.X;" & _
                            "DefaultDir=C:\RS232\;Dbq=C:\RS232\;CollatingSequence=ASCII;"

'''        .ConnectionString = "DSN=" & gDB_Parm.Server & ";Uid=;Pwd=;"
...
'''                            "uid=" & gDB_Parm.User & ";" & _
'''                            "pwd=" & gDB_Parm.Password & ";" & _
'''                            "database=" & gDB_Parm.Database

''            strPath = "C:\RS232\"
''
'''            .ConnectionString = "Provider=MSDASQL;"
''            .ConnectionString = "Driver={Microsoft Paradox Driver (*.db )};"
''            .ConnectionString = .ConnectionString & "DriverID=538;" '538
''            .ConnectionString = .ConnectionString & "Fil=Paradox 5.X;"
''            .ConnectionString = .ConnectionString & "DefaultDir=" & strPath & ";"
''            .ConnectionString = .ConnectionString & "Dbq=" & strPath & ";"
''            .ConnectionString = .ConnectionString & "CollatingSequence=ASCII;" 'ASCII 'Swedish-Finnish
''            .ConnectionString = .ConnectionString & "DataCodePage=ANSI;" 'ANSI  OEM
'''            .ConnectionString = .ConnectionString & "ReadOnly=0;"
'''            .ConnectionString = .ConnectionString & "ParadoxNetPath=C:\WINDOWS\SYSTEM32;" 'ANSI  OEM
''            .ConnectionString = .ConnectionString & "ParadoxNetPath=" & strPath & ";" 'ANSI  OEM
