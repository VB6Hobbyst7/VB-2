...
'---------------------------------------------------------------------------------------------------------------------
    ...
    db_tmp = ""
    Call GetPrivateProfileString("Server", "Driver", "", db_tmp, 100, App.Path & "\Interface.ini")
    frmInterface.txtTemp = Trim(db_tmp)
    gDB_Parm.Driver = Trim(frmInterface.txtTemp)
    
    db_tmp = ""
    Call GetPrivateProfileString("Server", "Server", "", db_tmp, 100, App.Path & "\Interface.ini")
    frmInterface.txtTemp = Trim(db_tmp)
    gDB_Parm.Server = Trim(frmInterface.txtTemp)
    
    db_tmp = ""
    Call GetPrivateProfileString("Server", "User", "", db_tmp, 100, App.Path & "\Interface.ini")
    frmInterface.txtTemp = Trim(db_tmp)
    gDB_Parm.User = Trim(frmInterface.txtTemp)
    
    db_tmp = ""
    Call GetPrivateProfileString("Server", "Password", "", db_tmp, 100, App.Path & "\Interface.ini")
    frmInterface.txtTemp = Trim(db_tmp)
    gDB_Parm.Password = Trim(frmInterface.txtTemp)
    
    db_tmp = ""
    Call GetPrivateProfileString("Server", "Database", "", db_tmp, 100, App.Path & "\Interface.ini")
    frmInterface.txtTemp = Trim(db_tmp)
...
'---------------------------------------------------------------------------------------------------------------------
    ...
    Call GetPrivateProfileString("CONFIG", "EquipName", "", db_tmp, 20, App.Path & "\Interface.ini")
    frmLogin.txtTemp = Trim(db_tmp)
    gEquipName = Trim(frmLogin.txtTemp)
    ...
    Call GetPrivateProfileString("config", "UID", "", db_tmp, 20, App.Path & "\Interface.ini")
    frmLogin.txtTemp = Trim(db_tmp)
    gExamUID = Trim(frmLogin.txtTemp)
    
    db_tmp = ""
    Call GetPrivateProfileString("config", "DeleteDate", "", db_tmp, 20, App.Path & "\Interface.ini")
    frmLogin.txtTemp = Trim(db_tmp)
    gLocalExpDate = Trim(frmLogin.txtTemp)

    db_tmp = ""
    Call GetPrivateProfileString("Server", "Driver", "", db_tmp, 100, App.Path & "\Interface.ini")
    frmLogin.txtTemp = Trim(db_tmp)
    gDB_Parm.Driver = Trim(frmLogin.txtTemp)
    ...
    Call GetPrivateProfileString("Server", "Password", "", db_tmp, 100, App.Path & "\Interface.ini")
    frmLogin.txtTemp = Trim(db_tmp)
    gDB_Parm.Password = Trim(frmLogin.txtTemp)
    
    db_tmp = ""
    Call GetPrivateProfileString("Server", "Database", "", db_tmp, 100, App.Path & "\Interface.ini")
    frmLogin.txtTemp = Trim(db_tmp)
    gDB_Parm.Database = Trim(frmLogin.txtTemp)
