...
'Sample Information Block
    ...
    lsID = Trim(Right(Mid(ls_data, 71, 15), 11))

    gRow = -1
    
    For iRow = 1 To vasID.DataRowCnt
        If Trim(GetText(vasID, iRow, colReceno)) = "" Then
            gRow = iRow
            Exit For
        End If
    Next iRow
...
Sub Res_Match_Proc(ByVal asEquipCode As String, ByVal asResult As String, Optional ByVal asEqRes As String = "", Optional ByVal asFlag As String)
    ...
    If k > 0 Then
        ...
        vasRes.SetText colExamName, lResRow, Trim(gArrEquip(k, 3))
...
Private Sub MSComm1_OnComm()
    ...
    Case chrETX
        ...
        If Mid(txtData.Text, 1, 1) = "R" Then  '오더요구 데이터 입니다
            is_UF_Ord1 = chrSTX + "S1441" + String(Date, "yyyymmdd") + Mid(txtData.Text, 6, 23) + Mid(txtData.Text, 5, 1) + "1" + Space(56) + String(Date, "yyyymmdd") + String(Date, "hh:mm") + "***" + Space(143) + chrETX
            is_UF_Ord2 = chrSTX + "S2441" + String(Date, "yyyymmdd") + Mid(txtData.Text, 6, 23) + Mid(txtData.Text, 5, 1) + Space(226) + chrETX
