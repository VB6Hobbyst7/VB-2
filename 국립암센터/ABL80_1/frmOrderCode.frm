...
Begin VB.Form frmOrderCode 
   ...
   Begin FPSpread.vaSpread vasList 
      ...
      ScrollBars      =   2
      SpreadDesigner  =   "frmOrderCode.frx":18F9
   End
   Begin VB.Frame Frame1 
      ...
      Top             =   630
      Width           =   4275
      Begin IF_ABL80.MDButton cmdClose 
         Height          =   585
         Left            =   3150
         TabIndex        =   37
         Top             =   4140
         ...
         Caption         =   "종료"
      End
      Begin IF_ABL80.MDButton cmdCancel 
         Height          =   585
         Left            =   2130
         TabIndex        =   36
         Top             =   4140
         ...
         Caption         =   "Clear"
      End
      Begin IF_ABL80.MDButton cmdDelete 
         Height          =   585
         Left            =   1110
         TabIndex        =   35
         Top             =   4140
         ...
         Caption         =   "삭제"
      End
      Begin IF_ABL80.MDButton cmdSave 
         Height          =   585
         Left            =   90
         TabIndex        =   34
         Top             =   4140
      ...
      Begin VB.ComboBox cmbType 
         ...
         EndProperty
         Height          =   345
         ItemData        =   "frmOrderCode.frx":34B5
         Left            =   1860
         List            =   "frmOrderCode.frx":34B7
         TabIndex        =   31
         Top             =   4500
         Visible         =   0   'False
         Width           =   2655
...
'          " Order by seqno, EquipCode "
    ...
    SQL = "SELECT equipcode, examcode, examname, resprec, reflow, refhigh, paniclow, panichigh, deltavalue, seqno " & CR & _
          "  From equipexam " & CR & _
          " WHERE equipno = '" & gEquip & "' " & CR & _
          " Order by examcode "
...
'    End If
    ...
    ElseIf res = 0 Then
        SQL = "Insert Into equipexam (equipno,equipcode, examcode, examname, resprec, reflow, refhigh, paniclow, panichigh, deltavalue, examflag, seqno, examtype ) " & CR & _
              "Values ('" & gEquip & "', '" & Trim(txtEquipCode) & "', '" & Trim(txtCode) & "', '" & Trim(txtName.Text) & "', '" & Trim(txtDec) & "', '" & Trim(txtRefLow) & "', '" & Trim(txtRefHigh) & "', '" & Trim(txtPLow) & "', '" & Trim(txtPHigh) & "', '" & Trim(txtDelta) & "', " & lsFlag & ", " & liSeqNo & ", '" & Trim(cmbType) & "' ) "
    End If
