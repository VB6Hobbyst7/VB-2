...
'
'    'SaveXMLFile sRetStr
'    Save_Xml_Data sRetStr, "patinfo"
'
'    Dim xDoc As MSXML.DOMDocument
'
'    Set xDoc = New MSXML.DOMDocument
'
'    If xDoc.Load(App.Path & "\Res" & "\patinfo.xml") Then
'        ' 문서가 성공적으로 로드되었습니다.
'        ' 이제 재미있는 작업을 수행합니다.
...
'
'    'SaveXMLFile sRetStr
'    Save_Xml_Data sRetStr, "result"
'
'    Dim xDoc As MSXML.DOMDocument
'
'    Set xDoc = New MSXML.DOMDocument
'
'    If xDoc.Load(App.Path & "\Res" & "\result.xml") Then
