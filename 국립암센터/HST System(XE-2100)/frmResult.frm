...
Begin VB.Form frmResult 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin FPSpread.vaSpread vasTemp 
         ...
         EndProperty
         RetainSelBlock  =   0   'False
         SpreadDesigner  =   "frmResult.frx":3BF4
      End
      Begin FPSpread.vaSpread vasResTemp 
         ...
         EndProperty
         RetainSelBlock  =   0   'False
         SpreadDesigner  =   "frmResult.frx":3E00
      End
      ...
      Begin FPSpread.vaSpread vasID 
         ...
         RetainSelBlock  =   0   'False
         ScrollBars      =   2
         SpreadDesigner  =   "frmResult.frx":400C
      End
      ...
      Begin FPSpread.vaSpread vasRes 
         ...
         RetainSelBlock  =   0   'False
         ScrollBars      =   2
         SpreadDesigner  =   "frmResult.frx":5E89
      End
...
'    End If
    ...
    If lsQCGubun = True Then
        ...
        Get_QCWorkList Format(dtpReceDate, "yyyymmdd"), IPU1.EQUIP_CD
        ...
        For i = 0 To giIndex
            ...
            Else
                ...
                vasWorkList.SetText 5, lsRow, IPU1.EQUIP_CD
            End If
            
        Next
        'vasWorkList.MaxRows = vasWorkList.DataRowCnt
        
        Get_QCWorkList Format(dtpReceDate, "yyyymmdd"), IPU2.EQUIP_CD
        ...
        For i = 0 To giIndex
            ...
            Else
                ...
                vasWorkList.SetText 3, lsRow, gQC_Info(i).LOT_NO
                vasWorkList.SetText 4, lsRow, gQC_Info(i).CTRL_CD
                vasWorkList.SetText 5, lsRow, IPU2.EQUIP_CD
            End If
            
        Next
        vasWorkList.MaxRows = vasWorkList.DataRowCnt
        
        vasSort vasWorkList, 4
    Else
...
'    Dim j As Integer
    ...
    If lsQCGubun = True Then
        ...
        sEquip = Trim(GetText(vasWorkList, lsReceRow, 5))
...
Private Sub Form_Load()
    dtpExamDate.Value = frmInterface.dtpExamDate.Value
    dtpReceDate.Value = frmInterface.dtpExamDate.Value
End Sub
