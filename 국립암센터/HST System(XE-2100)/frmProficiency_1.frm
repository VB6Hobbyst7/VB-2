...
Begin VB.Form frmProficiency 
   ...
   Begin FPSpread.vaSpread vasTemp1 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      SpreadDesigner  =   "frmProficiency_1.frx":0000
   End
   Begin ChartfxLibCtl.ChartFX ChartFX1 
      ...
      RGB2DBk         =   16777216
      nColors         =   16
      Colors          =   "frmProficiency_1.frx":9C56
      Multi           =   "frmProficiency_1.frx":9CF6
      MMask           =   8197
      _Data_          =   "frmProficiency_1.frx":9D5E
   End
   ...
   Begin FPSpread.vaSpread vasTemp 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      SpreadDesigner  =   "frmProficiency_1.frx":A03C
   End
   ...
   Begin FPSpread.vaSpread vasTest 
      ...
      RowHeaderDisplay=   0
      RowsFrozen      =   1
      SpreadDesigner  =   "frmProficiency_1.frx":A233
   End
   Begin VB.ComboBox cboEquip 
      Height          =   315
      ItemData        =   "frmProficiency_1.frx":109FE
      Left            =   3780
      List            =   "frmProficiency_1.frx":10A08
      TabIndex        =   4
      Top             =   690
      Width           =   1635
   End
   ...
   Begin FPSpread.vaSpread vasExam 
      ...
      MaxRows         =   35
      ScrollBars      =   2
      SpreadDesigner  =   "frmProficiency_1.frx":10A20
   End
   ...
   Begin FPSpread.vaSpread vasList 
      ...
      Protect         =   0   'False
      ScrollBars      =   2
      SpreadDesigner  =   "frmProficiency_1.frx":13DF0
      UserResize      =   2
      ScrollBarTrack  =   1
      ShowScrollTips  =   1
   End
   ...
   End
End
Attribute VB_Name = "frmProficiency"
