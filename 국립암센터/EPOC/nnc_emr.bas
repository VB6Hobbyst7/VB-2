...
Public gDoctorID      As String
Public gDepartment  As String
Public gHostSN      As String
...
'<P1><![CDATA[]]></P1></Table>
        ...
        Case gXml_S28
                ...
                sParam = sParam & "<QID><![CDATA[PG_SRL.SLP91_S28]]></QID>"
                sParam = sParam & "<QTYPE><![CDATA[Package]]></QTYPE>"
                sParam = sParam & "<USERID><![CDATA[SUA]]></USERID>"
                sParam = sParam & "<EXECTYPE><![CDATA[FILL]]></EXECTYPE>"
                sParam = sParam & "<TABLENAME><![CDATA[]]></TABLENAME>"
                sParam = sParam & "<P0><![CDATA[" & asSpcno & "]]></P0>"
                sParam = sParam & "<P1><![CDATA[]]></P1>"
                sParam = sParam & "</Table>"
        ...
        Case gXml_U06
                ...
                sParam = ""
                sParam = sParam & "<Table>"
                sParam = sParam & "<QID><![CDATA[PG_SRL.SLP91_U06]]></QID>"
                sParam = sParam & "<QTYPE><![CDATA[Package]]></QTYPE>"
                sParam = sParam & "<USERID><![CDATA[SUA]]></USERID>"
                sParam = sParam & "<EXECTYPE><![CDATA[FILL]]></EXECTYPE>"
                sParam = sParam & "<TABLENAME><![CDATA[]]></TABLENAME>"
                sParam = sParam & "<P0><![CDATA[" & gEquipCode & "]]></P0>"
                sParam = sParam & "<P1><![CDATA[" & asSpcno & "]]></P1>"
                sParam = sParam & "<P2><![CDATA[" & strDate & "]]></P2>"
                sParam = sParam & "<P3><![CDATA[" & "" & "]]></P3>"     'strRcpR
                'sParam = sParam  & "<P3><![CDATA[NICU]]></P3>"
                sParam = sParam & "<P4><![CDATA[" & gDoctorID & "]]></P4>"
                sParam = sParam & "<P5><![CDATA[" & gPanel & "]]></P5>"
                sParam = sParam & "<P6><![CDATA[" & gIFUser & "]]></P6>"
...
Public Sub display_online_parsing_poctInfo(ByRef Nodes As MSXML.IXMLDOMNodeList, ByVal Indent As Integer)
...
'Call SetSQLData("NODE", xNode.nodeValue & "")
            ...
            Select Case xNode.parentNode.nodeName
            Case "Value"    '검체번호
                Call SetSQLData("XML조회", "검체번호1:" & xNode.nodeValue)
                If Len(xNode.nodeValue & "") = 11 Then
                    gPat_Info_Select.BARCODE = xNode.nodeValue
                    Call SetSQLData("XML조회", "검체번호2:" & xNode.nodeValue)
                End If
            'Case "IO_ACPTNO"    '접수번호
...
Public Sub display_online_parsing_doctInfo(ByRef Nodes As MSXML.IXMLDOMNodeList, ByVal Indent As Integer)
...
'Call SetSQLData("NODE", xNode.nodeValue & "")
            ...
            Case "MEDDEPT"
                ...
                Call SetSQLData("XML조회", "MEDDEPT:" & gPat_Info_Select.MEDDEPT)

            Case "GENDR"
                gPat_Info_Select.GENDR = xNode.nodeValue
                gDoctorID = gPat_Info_Select.GENDR
                Call SetSQLData("XML조회", "GENDR:" & gPat_Info_Select.GENDR)
