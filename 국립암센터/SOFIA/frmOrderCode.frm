...
Begin VB.Form frmOrderCode 
   ...
   Begin FPSpread.vaSpread vasList 
      ...
      ScrollBars      =   2
      SpreadDesigner  =   "frmOrderCode.frx":191A
   End
   ...
   Begin VB.Frame Frame1 
      ...
      Top             =   630
      Width           =   4275
      Begin IF_SOFIA.MDButton cmdClose 
         Height          =   585
         Left            =   3150
         TabIndex        =   38
         Top             =   4770
         ...
         _extentx        =   1773
         _extenty        =   1032
         font            =   "frmOrderCode.frx":34B5
         caption         =   "종료"
      End
      Begin IF_SOFIA.MDButton cmdCancel 
         Height          =   585
         Left            =   2130
         TabIndex        =   37
         Top             =   4770
         ...
         _extentx        =   1773
         _extenty        =   1032
         font            =   "frmOrderCode.frx":34D9
         caption         =   "Clear"
      End
      Begin IF_SOFIA.MDButton cmdDelete 
         Height          =   585
         Left            =   1110
         TabIndex        =   36
         Top             =   4770
         ...
         _extentx        =   1773
         _extenty        =   1032
         font            =   "frmOrderCode.frx":34FD
         caption         =   "삭제"
      End
      Begin IF_SOFIA.MDButton cmdSave 
         Height          =   585
         Left            =   90
         TabIndex        =   35
         Top             =   4770
      ...
      Begin VB.ComboBox cmbType 
         ...
         EndProperty
         Height          =   345
         ItemData        =   "frmOrderCode.frx":3545
         Left            =   1380
         List            =   "frmOrderCode.frx":3547
         TabIndex        =   32
         Top             =   3630
         Visible         =   0   'False
         Width           =   2655
