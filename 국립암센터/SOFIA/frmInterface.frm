...
Begin VB.Form frmInterface 
   ...
   Begin IF_SOFIA.MDButton cmdSend 
      Height          =   585
      Left            =   12540
      TabIndex        =   65
      Top             =   180
      ...
      Caption         =   "선택전송"
   End
   Begin IF_SOFIA.MDButton cmdReset 
      Height          =   585
      Left            =   11340
      TabIndex        =   64
      Top             =   180
      ...
      Caption         =   "화면정리"
   End
   Begin IF_SOFIA.MDButton cmdCall 
      Height          =   585
      Left            =   10140
      TabIndex        =   63
      Top             =   180
   ...
   Begin VB.Frame Frame1 
      ...
      Begin FPSpread.vaSpread vasID 
         ...
         SpreadDesigner  =   "frmInterface.frx":0B17
         UserResize      =   2
      End
      Begin FPSpread.vaSpread vasRes 
         ...
         MaxCols         =   8
         ScrollBars      =   2
         SpreadDesigner  =   "frmInterface.frx":4DAE
      End
      ...
      End
   End
   Begin IF_SOFIA.MDButton cmdExit 
      Height          =   585
      Left            =   13740
      TabIndex        =   66
      Top             =   180
   ...
   Begin VB.Frame FrmHideControl 
      ...
      Begin FPSpread.vaSpread vasTemp1 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":8DD7
      End
      Begin FPSpread.vaSpread vasTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":D25C
      End
      Begin FPSpread.vaSpread vaSpread1 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":D45F
      End
      Begin FPSpread.vaSpread vasList 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":D662
      End
      Begin FPSpread.vaSpread vasResTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":D865
      End
...
'    End If
    ...
    sDate = Format(DateAdd("y", CDate(Text_Today.Text), -50), "yyyymmdd")
    ...
    lblStatus.Caption = "TCP " & "5150" & " 포트로 연결합니다"
...
Sub SOFIA()
    ...
    For intCnt = 1 To UBound(strRecvData)
        Save_Raw_Data "[intCnt]" & intCnt & ":" & strRecvData(intCnt)
    Next
    
'12:10:12 [intCnt]1:1H|\^&|||Sofia^27847|||||||P|02.03.00|20190122120810
'12:10:12 [intCnt]2:2P|1||||||||||||||||||||||||
'12:10:12 [intCnt]3:3O|1|||Flu A+B||||||Supervisor|||||P
'12:10:12 [intCnt]4:4C|1||Read-Now Mode
'12:10:12 [intCnt]5:5R|1|^^^Flu A|positive|||||R||||20190122114518
'12:10:12 [intCnt]6:6R|2|^^^Flu B|positive|||||R||||20190122114518
'12:10:12 [intCnt]7:7L|1|N
    ...
    For intCnt = 1 To UBound(strRecvData)
        ...
        Case "P"
            ...
            If optGBN(0).Value = True Then
                ...
                lsBarcode = mGetP(strRecvData(intCnt), 3, "|")
                ...
                Save_Raw_Data "[gRow]" & gRow
            
                '**************************************************
                res = Online_XML(gXml_S07, Trim(lsBarcode))
                
                Save_Raw_Data "[Trim(lsBarcode)]" & Trim(lsBarcode)
        ...
        Case "R"
            ...
            'Positive : Influenza A and B
            
            'R|1|^^^Flu A|negative|||||F||||20110414064534<CR>
            'R|2|^^^Flu B|negative|||||F||||20110414064534<CR>
            Save_Raw_Data "[R]" & intCnt & ":" & strRecvData(intCnt)
            
            lsResRow = lsResRow + 1
            lsEquipCode = Trim(mGetP(mGetP(strRecvData(intCnt), 3, "|"), 4, "^"))
            lsResult = Trim(mGetP(strRecvData(intCnt), 4, "|"))
            
            If lsEquipCode = "Flu A" Then
                strFluA = lsResult
            ElseIf lsEquipCode = "Flu B" Then
                strFluB = lsResult
            End If
...
RST:
            ...
            lsResult = ""
            If strFluA <> "" And strFluB <> "" Then
                lsEquipCode = "Flu A/B"
                
                If UCase(strFluA) = "NEGATIVE" Then
                    If UCase(strFluB) = "NEGATIVE" Then
                        lsResult = "Negative"
                    ElseIf UCase(strFluB) = "POSITIVE" Then
                        lsResult = "Positive : Influenza B"
                    End If
                ElseIf UCase(strFluA) = "POSITIVE" Then
                    If UCase(strFluB) = "NEGATIVE" Then
                        lsResult = "Positive : Influenza A"
                    ElseIf UCase(strFluB) = "POSITIVE" Then
                        lsResult = "Positive : Influenza A and B"
                    End If
                End If
                strFluA = ""
                strFluB = ""
...
'          "  and sendflag <> 'C' "
    ...
    SQL = "Update pat_res set sendflag = 'C' " & vbCrLf & _
          "where equipno = '" & gEquip & "' " & vbCrLf & _
          "  and barcode = '" & lsID & "' and examcode in (" & lsTransCode & ")"
    res = SendQuery(gLocal, SQL)
    If res = -1 Then
        SaveQuery SQL
        Exit Function
