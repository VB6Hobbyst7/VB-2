...
Begin VB.Form frmConfig 
   ...
   Begin IF_SOFIA.MDButton cmdExit 
      ...
      caption         =   "종료"
   End
   Begin IF_SOFIA.MDButton cmdConfirm 
      Height          =   465
      Left            =   600
      TabIndex        =   15
      Top             =   4560
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin VB.ComboBox Combo_Parity 
         Height          =   315
         ItemData        =   "frmConfig.frx":0050
         Left            =   1785
         List            =   "frmConfig.frx":0052
         TabIndex        =   7
         Top             =   2580
         Width           =   1695
      End
      ...
      Begin VB.ComboBox Combo_BPS 
         Height          =   315
         ItemData        =   "frmConfig.frx":0058
         Left            =   1785
         List            =   "frmConfig.frx":005A
         TabIndex        =   3
         Top             =   750
         Width           =   1695
      End
      Begin VB.ComboBox Combo_Port 
         Height          =   315
         ItemData        =   "frmConfig.frx":005C
         Left            =   1785
         List            =   "frmConfig.frx":005E
         TabIndex        =   2
         Top             =   300
         Width           =   1695
      End
