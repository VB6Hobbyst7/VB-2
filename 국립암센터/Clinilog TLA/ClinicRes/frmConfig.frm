...
Begin VB.Form frmConfig 
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin VB.ComboBox txtGubun 
         Height          =   315
         ItemData        =   "frmConfig.frx":1875
         Left            =   2310
         List            =   "frmConfig.frx":1882
         TabIndex        =   22
         Top             =   780
         Width           =   2115
      End
      ...
      Begin VB.ComboBox Combo_Parity 
         Height          =   315
         ItemData        =   "frmConfig.frx":1898
         Left            =   2325
         List            =   "frmConfig.frx":189A
         TabIndex        =   17
         Top             =   1980
         Width           =   1695
      End
      Begin VB.ComboBox Combo_Databit 
         Height          =   315
         ItemData        =   "frmConfig.frx":189C
         Left            =   2325
         List            =   "frmConfig.frx":189E
         TabIndex        =   16
         Top             =   2370
         Width           =   1695
      End
      Begin VB.ComboBox Combo_BPS 
         Height          =   315
         ItemData        =   "frmConfig.frx":18A0
         Left            =   2325
         List            =   "frmConfig.frx":18A2
         TabIndex        =   15
         Top             =   1590
         Width           =   1695
      End
      Begin VB.ComboBox Combo_Port 
         Height          =   315
         ItemData        =   "frmConfig.frx":18A4
         Left            =   2325
         List            =   "frmConfig.frx":18A6
         TabIndex        =   14
         Top             =   1200
         Width           =   1695
      End
...
Private Sub cmdOK_Click()
    ...
    Else
        ...
        Call WritePrivateProfileString("COM " & CStr(Combo_Port.Text), "Use", CStr(chkUse.Value), App.Path & "\interface.ini")
        Call WritePrivateProfileString("COM " & CStr(Combo_Port.Text), "Gubun", txtGubun.Text, App.Path & "\interface.ini")
        Call WritePrivateProfileString("COM " & CStr(Combo_Port.Text), "Speed", Combo_BPS.Text, App.Path & "\interface.ini")
        Call WritePrivateProfileString("COM " & CStr(Combo_Port.Text), "Parity", Combo_Parity.Text, App.Path & "\interface.ini")
        Call WritePrivateProfileString("COM " & CStr(Combo_Port.Text), "DataBit", Combo_Databit.Text, App.Path & "\interface.ini")
        Call WritePrivateProfileString("COM " & CStr(Combo_Port.Text), "StopBit", Combo_Stopbit.Text, App.Path & "\interface.ini")
        Call WritePrivateProfileString("COM " & CStr(Combo_Port.Text), "RTSEnable", CStr(chkRTS.Value), App.Path & "\interface.ini")
        Call WritePrivateProfileString("COM " & CStr(Combo_Port.Text), "DTREnable", CStr(chkDTR.Value), App.Path & "\interface.ini")
