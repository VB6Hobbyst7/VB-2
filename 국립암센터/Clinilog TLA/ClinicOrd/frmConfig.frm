...
Private Sub Command1_Click()
    ...
    Else
        ...
        gSetup.Port = Combo_Port.Text
        gSetup.Speed = Combo_BPS.Text
        gSetup.DataBit = Combo_Databit.Text
        gSetup.StartBit = Combo_Startbit.Text
        gSetup.StopBit = Combo_Stopbit.Text
        ...
        Call WritePrivateProfileString("config", "gPort", gSetup.Port, App.Path & "\Interface.ini")
        Call WritePrivateProfileString("config", "gSpeed", gSetup.Speed, App.Path & "\Interface.ini")
        Call WritePrivateProfileString("config", "gParity", gSetup.Parity, App.Path & "\Interface.ini")
        Call WritePrivateProfileString("config", "gDataBit", gSetup.DataBit, App.Path & "\Interface.ini")
        Call WritePrivateProfileString("config", "gStopBit", gSetup.StopBit, App.Path & "\Interface.ini")
        Call WritePrivateProfileString("config", "gStartBit", gSetup.StartBit, App.Path & "\Interface.ini")
        
        If frmWorklist.MSComm1.PortOpen = True Then
            frmWorklist.MSComm1.PortOpen = False
        End If
        frmWorklist.MSComm1.CommPort = gSetup.Port
        frmWorklist.MSComm1.Settings = gSetup.Speed & "," & gSetup.Parity & "," & gSetup.DataBit & "," & gSetup.StopBit
        
        frmWorklist.MSComm1.PortOpen = True
...
'    Combo_Port.ListIndex = 0
    ...
    For i = 0 To Combo_Port.ListCount - 1
        If gSetup.Port = Trim(Combo_Port.List(i)) Then
    ...
    For i = 0 To Combo_BPS.ListCount - 1
        If gSetup.Speed = Trim(Combo_BPS.List(i)) Then
    ...
    For i = 0 To Combo_Databit.ListCount - 1
        If gSetup.DataBit = Trim(Combo_Databit.List(i)) Then
    ...
    For i = 0 To Combo_Startbit.ListCount - 1
        If gSetup.StartBit = Trim(Combo_Startbit.List(i)) Then
    ...
    For i = 0 To Combo_Stopbit.ListCount - 1
        If gSetup.StopBit = Trim(Combo_Stopbit.List(i)) Then
    ...
    For i = 0 To Combo_Parity.ListCount - 1
        If gSetup.Parity = Trim(Combo_Parity.List(i)) Then
