...
Global Ado323               As ADODB.Recordset
...
' ODBC(PostgreSQL)
'    With AdoCn_SQL
'    .ConnectionString = "Driver={PostgreSQL Unicode};Server=" & ServerName & ";Port=5432;UID=" & UserName & ";PWD=" & Password & ";Database=" & DatabaseName
'    .Open
'    End With
