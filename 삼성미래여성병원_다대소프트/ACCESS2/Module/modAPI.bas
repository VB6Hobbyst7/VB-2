...
'-------------------------------------*
'Declare Function GetPrivateProfileString Lib "Kernel" (ByVal lpApplicationName As String, ByVal lpKeyName As String, ByVal lpDefault As String, ByVal lpReturnedString As String, ByVal nSize As Integer, ByVal lpFnMaxLename As String) As Integer
...
'Declare Function WritePrivateProfileString Lib "Kernel" (ByVal lpApplicationName As String, ByVal lpKeyName As String, ByVal lpString As String, ByVal lplFnMaxLename As String) As Integer
...
'*****************************************
'*** Logging Data Parameter
'*** (user_id+wk_station+date+time)
'*****************************************
Global D0COM_SYSDATE    As String   'SYSTEM DATE
Global D0COM_SYSTIME    As String   'SYSTEM TIME
Global D0COM_TERMID     As String   'TERMINAL ID
Global D0COM_LOGONID    As String   'LOGIN ID

Global D0COM_PATH       As String   'CURRENT DIRECTORY
Global D0COM_CENTERCOD  As String   '총국 코드
Global D0COM_INTERFACE  As String   '검사기계 명

Global D0COM_RETDATE    As String   '검사날짜
Global D0COM_GUBUN      As String   '접수구분
Global D0COM_DELETEOK   As Integer  '과거 INTERFACE DATA 삭제여부 TRUE, FALSE
