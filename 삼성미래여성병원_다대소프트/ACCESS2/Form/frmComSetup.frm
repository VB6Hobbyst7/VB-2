...
Private Sub cmdSave_Click()
    ...
    MainForm.Caption = "m2iSoft_IIS(" & INS_NAME & ")"
    ...
    If Not mAdoRs Is Nothing Then
        If Not mAdoRs.EOF Then
            ...
            Select Case Trim(mAdoRs("COM_PARITYBIT") & "")
                Case "e":                    cboParity.ListIndex = 0
                Case "m":                    cboParity.ListIndex = 1
                Case "n":                    cboParity.ListIndex = 2
                Case "o":                    cboParity.ListIndex = 3
                Case "s":                    cboParity.ListIndex = 4
                Case Else:                   cboParity.ListIndex = 2
            End Select
