...
Begin VB.Form frmMain 
   ...
   Begin FPSpread.vaSpread spdOrder 
      ...
      ShadowColor     =   16777215
      SpreadDesigner  =   "frmMain.frx":6F06
      ScrollBarTrack  =   3
      ShowScrollTips  =   3
   End
   Begin FPSpread.vaSpread spdWork 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   16777215
      SpreadDesigner  =   "frmMain.frx":8B94
      ScrollBarTrack  =   3
      ShowScrollTips  =   3
   End
...
Private Sub GetOrder_PPC300N(ByVal pBarNo As String, ByVal pType As String)
    ...
    With frmMain
        ...
        mOrder.QRDQryTime = Format(Now, "yyyymmddhhmmss")
...
'            strSend = ""
'            strSend = strSend & SB & "MSH|^~\&|||||" & mOrder.QRDQryTime & "||DSR^Q03|" & mOrder.ChartNo & "|P|2.3.1||||0||ASCII|||" & vbCr
'            strSend = strSend & "MSA|AA|" & mOrder.MSHSysDateTime & "|Message accepted|||0|" & vbCr
'            strSend = strSend & "ERR|0|" & vbCr
'            strSend = strSend & "QAK|SR|OK|" & vbCr
'            strSend = strSend & "QRD|" & mOrder.QRDQryTime & "|R|D|3|||RD|" & mOrder.QRDSampleBarcode & "|OTH|||T|" & vbCr
'            strSend = strSend & "QRF|" & mOrder.QRFProduct & "|||||RCT|COR|ALL||" & vbCr
'            strSend = strSend & "DSP|1||" & mOrder.QRDNum & "|||" & vbCr     '-- Patient ID
'            strSend = strSend & "DSP|2||" & mOrder.QRDSampleBarcode & "|||" & vbCr
'            strSend = strSend & "DSP|3||serum|||" & vbCr
'            strSend = strSend & "DSP|4|||||" & vbCr
'            strSend = strSend & "DSP|5|||||" & vbCr
'            strSend = strSend & "DSP|6||0|||" & vbCr
'            strSend = strSend & "DSP|7||0|||" & vbCr
...
'            strSend = strSend & "DSP|15||0|||" & vbCr
'            strSend = strSend & "DSP|16||" & mOrder.QRDQryTime & "|||" & vbCr
'            strSend = strSend & "DSP|17||N|||" & vbCr
...
'            strSend = strSend & EB & vbCr
            ...
            strSend = strSend & "QRD|" & mOrder.QRDQryTime & "|R|D|3|||RD|" & mOrder.QRDSampleBarcode & "|OTH|||T|" & vbCr
            strSend = strSend & "QRF|" & mOrder.QRFProduct & "|||||RCT|COR|ALL||" & vbCr
            strSend = strSend & "DSP|1||" & intSndPhase & "|||" & vbCr
            strSend = strSend & "DSP|2||" & mOrder.QRDSampleBarcode & "|||" & vbCr
            strSend = strSend & "DSP|3||serum|||" & vbCr
            strSend = strSend & "DSP|4|||||" & vbCr
            strSend = strSend & "DSP|5|||||" & vbCr
            ...
            strSend = strSend & "DSP|13|||||" & vbCr
            strSend = strSend & "DSP|14|||||" & vbCr
            strSend = strSend & "DSP|15||" & CStr(mOrder.SendCnt) & "|||" & vbCr
            strSend = strSend & "DSP|16||" & mOrder.QRDQryTime & "|||" & vbCr
            strSend = strSend & "DSP|17||N|||" & vbCr
            strSend = strSend & strItems
            strSend = strSend & "DSC|-1|" & vbCr
...
'            2019-11-29 10:11:57
'            INST->
'            MSH|^~\&|PKL|PKL PPC 300N|||20191129091545||QRY^Q02|20191129091545|p|2.3.1||||||ASCII|||
'            QRD|20191129091545|R|D|1|||RD|6789012345|OTH|||T|
'            QRF|PKL PPC 300N|||||RCT|COR|ALL||
'            
'            strSend = ""
'            strSend = strSend & "MSH|^~\&|||||20191129101157||DSR^Q03|ID201911291011570005|P|2.3.1||||0||ASCII|||"
'            strSend = strSend & "MSA|AA|20191129091545|Message accepted|||0|"
'            strSend = strSend & "ERR|0|"
'            strSend = strSend & "QAK|SR|OK|"
'            strSend = strSend & "QRD|20191129101157|R|D|3|||RD|6789012345|OTH|||T|"
'            strSend = strSend & "QRF|PKL PPC 300N|||||RCT|COR|ALL||"
'            strSend = strSend & "DSP|1||3|||"
'            strSend = strSend & "DSP|2||6789012345|||"
'            strSend = strSend & "DSP|3||serum|||"
'            strSend = strSend & "DSP|4|||||"
'            strSend = strSend & "DSP|5|||||"
'            strSend = strSend & "DSP|6||0|||"
'            strSend = strSend & "DSP|7||0|||"
'            strSend = strSend & "DSP|8|||||"
'            strSend = strSend & "DSP|9|||||"
'            strSend = strSend & "DSP|10|||||"
'            strSend = strSend & "DSP|11|||||"
'            strSend = strSend & "DSP|12|||||"
'            strSend = strSend & "DSP|13|||||"
'            strSend = strSend & "DSP|14|||||"
'            strSend = strSend & "DSP|15||1|||"
'            strSend = strSend & "DSP|16||20191129101157|||"
'            strSend = strSend & "DSP|17||N|||"
'            strSend = strSend & "DSP|18||1^ALP^^^^|||"
'            strSend = strSend & "DSC|-1|"

'            2019-11-29 10:11:56
'            MSH|^~\&|||PKL|PKL PPC 300N|20191129101156||QCK^Q02|20191129091545|P|2.3.1||||||UNICODE|||
'            MSA|AA|20191129091545|Message accepted|||0|
'            ERR|0|
'            QAK|SR|OK|
