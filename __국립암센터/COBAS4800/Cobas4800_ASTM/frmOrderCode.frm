...
Begin VB.Form frmOrderCode 
   ...
   Begin VB.Frame Frame1 
      ...
      Top             =   690
      Width           =   4275
      Begin IF_Cobas4800국립암센터.MDButton cmdClose 
         Height          =   585
         Left            =   3120
         TabIndex        =   38
         Top             =   6150
         ...
         Caption         =   "종료"
      End
      Begin IF_Cobas4800국립암센터.MDButton cmdCancel 
         Height          =   585
         Left            =   2100
         TabIndex        =   37
         Top             =   6150
         ...
         Caption         =   "Clear"
      End
      Begin IF_Cobas4800국립암센터.MDButton cmdDelete 
         Height          =   585
         Left            =   1080
         TabIndex        =   36
         Top             =   6150
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VB.ComboBox cboArr 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmOrderCode.frx":1DA0
            Left            =   690
            List            =   "frmOrderCode.frx":1DAD
            TabIndex        =   44
            Top             =   210
            Width           =   1215
         End
      ...
      Begin VB.ComboBox cboGubun 
         ...
         EndProperty
         Height          =   345
         ItemData        =   "frmOrderCode.frx":1DC3
         Left            =   1410
         List            =   "frmOrderCode.frx":1DD3
         TabIndex        =   40
         Top             =   6150
         Visible         =   0   'False
         Width           =   2565
      ...
      Begin VB.ComboBox cmbType 
         ...
         EndProperty
         Height          =   345
         ItemData        =   "frmOrderCode.frx":444B
         Left            =   1410
         List            =   "frmOrderCode.frx":444D
         TabIndex        =   32
         Top             =   1980
         Visible         =   0   'False
         Width           =   2655
   ...
   Begin Threed.SSFrame ssfrmExam 
      ...
      Begin FPSpread.vaSpread vasExam 
         ...
         RowHeaderDisplay=   0
         ScrollBars      =   2
         SpreadDesigner  =   "frmOrderCode.frx":444F
      End
   End
End
