...
Begin VB.Form frmOrderCode 
   ...
   Begin VB.Frame Frame1 
      ...
      Top             =   5340
      Width           =   11505
      Begin IF_GENEXPERT.MDButton cmdClose 
         Height          =   585
         Left            =   10170
         TabIndex        =   35
         Top             =   1770
         ...
         Caption         =   "종료"
      End
      Begin IF_GENEXPERT.MDButton cmdCancel 
         Height          =   585
         Left            =   9150
         TabIndex        =   34
         Top             =   1770
         ...
         Caption         =   "Clear"
      End
      Begin IF_GENEXPERT.MDButton cmdDelete 
         Height          =   585
         Left            =   8130
         TabIndex        =   33
         Top             =   1770
         ...
         Caption         =   "삭제"
      End
      Begin IF_GENEXPERT.MDButton cmdSave 
         Height          =   585
         Left            =   7110
         TabIndex        =   32
         Top             =   1770
      ...
      Begin VB.ComboBox cmbType 
         ...
         EndProperty
         Height          =   345
         ItemData        =   "frmOrderCode.frx":1A00
         Left            =   1380
         List            =   "frmOrderCode.frx":1A02
         TabIndex        =   29
         Top             =   3630
         Visible         =   0   'False
         Width           =   2655
   ...
   Begin VB.Frame ssfrmExam 
      ...
      Begin FPSpread.vaSpread vasExam 
         ...
         RowHeaderDisplay=   0
         ScrollBars      =   2
         SpreadDesigner  =   "frmOrderCode.frx":4032
      End
   End
End
