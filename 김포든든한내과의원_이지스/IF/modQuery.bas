...
'Public Function getMSINFOTECJudge(ByVal strORCD As String, Optional ByVal strRSLT As String, Optional ByVal strSex As String, Optional ByVal strAge As String) As String
...
'            Call GetWorkList_neosoft(pFrom, pTo, SPD)
'        Case "DADE" 'K챠트
'            Call GetWorkList_dade(pFrom, pTo, SPD)
'        Case "MSINFOTEC"
'            Call GetWorkList_MSINFOTEC(pFrom, pTo, SPD)
'        Case "TWIN"
'            Call GetWorkList_twin(pFrom, pTo, SPD)
...
'        Case "NEO"
'            Call GetWorkList_neo(pFrom, pTo, SPD)
'        Case "MOD"
'            Call GetWorkList_mod(pFrom, pTo, SPD)
'        Case "NTL"
'            Call GetWorkList_ntl(pFrom, pTo, SPD)
        Case Else
...
'
'        Case "NAVY"
'                Call GetSampleInfo_navy(asRow, SPD)
...
On Error GoTo DBErr
    ...
    'SQL = SQL & "     , a.SPC_CD    AS SPCCD    " & vbCr
    SQL = ""
    SQL = SQL & "SELECT DISTINCT "
    SQL = SQL & "       a.ACC_YMD   AS HOSPDATE " & vbCr
    SQL = SQL & "     , a.RECEPT_NO AS BARCODE  " & vbCr
    ...
    If Not RS.EOF = True And Not RS.BOF = True Then
        Do Until RS.EOF
            With SPD
                ...
                SetText SPD, Trim(RS.Fields("PNAME")) & "", asRow, colPNAME
                SetText SPD, strJumin, asRow, colPAGE
                SetText SPD, Trim(RS.Fields("SEX")) & "", asRow, colPSEX
                ...
                With mOrder
                    ...
                    If strJumin <> "" And Len(strJumin) = 8 Then
                        mOrder.AGE = CalAge(strJumin, Format(Date, "yyyy/mm/dd"))
                    End If
                    mOrder.SEX = Trim(RS.Fields("SEX")) & ""
