...
'            SaveTransData = SaveTransData_neosoft(argSpcRow)
'        Case "DADE" 'K챠트
'            SaveTransData = SaveTransData_dade(argSpcRow)
'        Case "TWIN"
'            SaveTransData = SaveTransData_twin(argSpcRow)
'        Case "SY"
...
'            SaveTransData = SaveTransData_medichart(argSpcRow)
'        Case "ONIT"
'            SaveTransData = SaveTransData_onit(argSpcRow)
'        Case "PLIS"
'            SaveTransData = SaveTransData_PLIS(argSpcRow)
'        Case "BIGUBCARE"
'            SaveTransData = SaveTransData_BIGUBCARE(argSpcRow)
'        Case "EMEDI"
'            SaveTransData = SaveTransData_emedi(argSpcRow)
'        Case "EHEALTH"
'            SaveTransData = SaveTransData_ehealth(argSpcRow)
'        Case "NEO"
'            SaveTransData = SaveTransData_neo(argSpcRow)
'        Case "MOD"
'            SaveTransData = SaveTransData_mod(argSpcRow)
...
On Error GoTo ErrorTrap
    ...
    Do Until rs_svr.EOF
        If IsNumeric(asResult) And IsNumeric(rs_svr.Fields("MAX")) And IsNumeric(rs_svr.Fields("MIN")) Then
            If Val(asResult) > Val(rs_svr.Fields("MAX")) Then
                SetJudge_MSINFOTEC = "H"
            ElseIf Val(asResult) < Val(rs_svr.Fields("MIN")) Then
