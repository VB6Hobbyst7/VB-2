...
On Error GoTo RST
    ...
    SQL = SQL & "      , R.RESSHTNAM                AS ITEM                    " & vbCr
    ...
    SQL = SQL & " ORDER BY R.RESACPDTM,R.RESCHTNUM ASC"
        ...
        Do Until RS.EOF
            With SPD
                ...
                If blnSame = False Then
                    ...
                    End If
                    SetText SPD, strTests, intRow, colITEMS
                ...
                strTests = strTests & Trim(RS.Fields("ITEM")) & "/"
            End With
...
On Error GoTo DBErr
    ...
    SQL = SQL & "      , R.RESCHTNUM    AS CHARTNO  " & vbCr
    SQL = SQL & "      , P.PBSPATNAM    AS PNAME    " & vbCr
    SQL = SQL & "      , P.PBSRESNUM    AS PID      " & vbCr
