...
Function SaveTransData(ByVal argSpcRow As Integer, ByVal SPD As Object) As Integer
    ...
    Select Case gEMR
        Case "VHS"
            SaveTransData = SaveTransData_VHS(argSpcRow, SPD)
        
        Case "SWMC"
            SaveTransData = SaveTransData_SWMC(argSpcRow, SPD)
        
'        Case "HDINFO"
'            SaveTransData = SaveTransData_HDINFO(argSpcRow, SPD)
...
'
        Case "EHWA"
            SaveTransData = SaveTransData_EHWA(argSpcRow, SPD)
