    ...
    With frmMain
        ...
        If Not RsLocal.EOF = True And Not RsLocal.BOF = True Then
            Do Until RsLocal.EOF
                ...
                strFooter = ""
                strFooter = "검사자:" & frmMain.txtTestNm.Text & " M.T./보고자:배은신 M.D (tel.3943) "
                ...
                If sResult <> "" Then
                    ...
                    With AdoCmd
                        ...
                        'SetRawData "[결과저장]" & strBarcode & "," & strTestCd & "," & sResult & "," & frmMain.txtTestID.Text & "D" & "," & gHOSP.MACHCD & "," & "" & 0 & "," & 0 & "," & 0
...
'    SQL = SQL & "   and TO_CHAR(A.ORD_DATE,'YYYY-MM-DD') BETWEEN  '" & pFrom & "' AND '" & pTo & "'" & vbCrLf
    ...
    SQL = SQL & "   and A.EXAM_CD IN ('L5300I','L5300J','L5300M','L9084','L9085')" & vbCrLf
...
'    SQL = SQL & "     , COUNT(EXAM_CD)          AS CNT      " & vbCrLf
    ...
    'SQL = SQL & "   and A.EXAM_CD IN (" & gAllTestCd & ")" & vbCrLf
    SQL = SQL & "   and A.EXAM_CD IN ('L1202','L1203')" & vbCrLf
