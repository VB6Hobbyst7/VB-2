...
Begin VB.Form frmInterface 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin FPSpread.vaSpread vasRes 
         ...
         RetainSelBlock  =   0   'False
         ScrollBars      =   2
         SpreadDesigner  =   "frmInterface.frx":2162
      End
   End
   ...
   Begin VB.Frame FrmHideControl 
      ...
      Begin VB.Frame Frame5 
         ...
         Begin VB.ComboBox cboTest 
            ...
            ForeColor       =   &H00FF0000&
            Height          =   300
            ItemData        =   "frmInterface.frx":38A0
            Left            =   600
            List            =   "frmInterface.frx":38A2
            Style           =   2  '드롭다운 목록
            TabIndex        =   69
            Top             =   1650
            Visible         =   0   'False
      ...
      Begin VB.Frame Frame4 
         ...
         Begin FPSpread.vaSpread vasPrint 
            ...
            EndProperty
            MaxCols         =   9
            SpreadDesigner  =   "frmInterface.frx":38A4
         End
         Begin FPSpread.vaSpread vasPrintBuf 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            SpreadDesigner  =   "frmInterface.frx":532B
         End
      End
      ...
      Begin FPSpread.vaSpread vasCode 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":5551
      End
      Begin FPSpread.vaSpread vasTemp1 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":5777
      End
         ...
         Begin MSComctlLib.ImageList imlStatus 
            ...
            BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
               ...
               BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":5F27
                  Key             =   "RUN"
               EndProperty
               BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":64C1
                  Key             =   "NOT"
               EndProperty
               BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":6A5B
                  Key             =   "STOP"
               EndProperty
               BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":6FF5
                  Key             =   "LST"
               EndProperty
               BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":7887
                  Key             =   "ITM"
               EndProperty
      ...
      Begin FPSpread.vaSpread vasList 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":7C95
      End
      Begin FPSpread.vaSpread vasResTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":7EBB
      End
      Begin FPSpread.vaSpread vasTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":80E1
      End
      Begin FPSpread.vaSpread vasExcel 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":8307
      End
...
Private Sub GetWorkList_KAHP(ByVal pFrDt As String, ByVal pToDt As String, Optional pBarNo As String)
    Dim RS          As ADODB.Recordset
    Dim i           As Integer
    Dim iCnt        As Long
    Dim intRow      As Long
    ...
    SQL = ""
'    SQL = SQL & "Select DISTINCT R.SEQNO,  R.ITEMCODE as ITEM,  R.JUMIN as 주민번호,  R.SAMPLENO as 바코드번호,  R.JDATE as 접수일자,  J.Name as 이름,  J.AGE as 나이,  J.SEX as 성별" & vbCr
    SQL = SQL & "Select  R.ITEMCODE as ITEM,  R.JUMIN as 주민번호,  R.SAMPLENO as 바코드번호,  R.JDATE as 접수일자,   J.AGE as 나이,  J.SEX as 성별" & vbCr
    SQL = SQL & "  From TWMED_RESULT1 R, TWMED_KEYTBL  J" & vbCr
  '  SQL = SQL & " WHERE R.SampleNo = '" & & "
 '   SQL = SQL & "    and R.JDATE    = J.JDATE " & vbCr
    SQL = SQL & "    and R.CORPCODE = J.CORPCODE " & vbCr
    SQL = SQL & "    and R.SEQNO    = J.SEQNO " & vbCr
    SQL = SQL & "    and R.JUMIN    = J.JUMIN " & vbCr
'    SQL = SQL & "    and R.SampleNo = '" & sBarcode & "'" & vbCr
    SQL = SQL & "    and R.ITEMCODE in (" & gAllExam & ")" & vbCr
    
    
    SQL = " select * from TWMED_RESULT1 "
    SQL = SQL & " "
        ...
        Do Until RS.EOF
            ...
            With vasID
                ...
                If blnSame = False Then
                    ...
                    SetText vasID, Trim(RS.Fields("이름")) & "", .MaxRows, colPNAME
                    'SetText vasID, Trim(RS.Fields("검체명")) & "", .MaxRows, colSPCNM
                    SetText vasID, Trim(RS.Fields("SEQNO")) & "", .MaxRows, colPAGE
...
Private Sub cmdSearch_Click()
    ...
    Select Case gOCS
        ...
        Case "KAHP":        Call GetWorkList_KAHP(Format(dtpStartDt.Value, "yyyymmdd"), Format(dtpStopDt.Value, "yyyymmdd"))
    End Select
...
Private Sub SendOrder()
    ...
    Select Case intSndPhase
        ...
        Case 2  '## Patient
            strOutput = intFrameNo & "P|1||" & mOrder.PatId & "|||||||||||||||||||||||||||||||" & vbCr & ETX
...
Private Sub GetOrder(ByVal pBarNo As String)
    ...
    '-- 검사자 정보 가져오기
    Call GetSampleInfoW_KAHP(intRow)
    ...
    strItems = GetGetEquipExamCode_ACL(gEquip, pBarNo, intRow)
    ...
    Else
        ...
        mOrder.PatId = GetText(vasID, intRow, colCHARTNO)
        'Call SetSQLData("mOrder.PatId ", mOrder.PatId)
    End If
...
'-- 로컬테이블에서 검사항목에 해당하는 검사채널 찾아오기
Function GetGetEquipExamCode_ACL(argEquipCode As String, argPID As String, Optional intRow As Long) As String
    Dim i As Integer
    Dim strExamCode As String
    Dim sBarcode     As String
    ...
    For i = 0 To UBound(gReadBuf)
        If gReadBuf(i) <> "" Then
            strIntBase = Mid(Trim(gReadBuf(i)), 1, 4)
    ...
    GetGetEquipExamCode_ACL = strTemp
    
    'Call SetSQLData("strTemp", strTemp)
...
'                    4R|1|^^^0013|12.200|s||||F||||20160827152838|A2
'                    5R|2|^^^0013|1.151|R||||F||||20160827152838|56
'                    6R|3|^^^0013|1.161|INR||||F||||20160827152838|F0
'                    7R|4|^^^0013|77.601|%||||F||||20160827152838|
