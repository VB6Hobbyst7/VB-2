...
On Error GoTo ErrHandle
    ...
    With frmMain
        ...
        For intRow = 1 To .vasTemp.DataRowCnt
            ...
            'If strBarcode <> "" And strTestCd <> "" And sResult <> "" And strSubCode <> "" Then
            If strBarcode <> "" And strTestCd <> "" And sResult <> "" Then 'And strSubCode <> "" Then
                '-- 결과저장
                SQL = ""
                ...
                SQL = SQL & " WHERE LABBARCOD = '" & strBarcode & "'" & vbCr  '바코드
...
Function SaveTransData_AMIS_JWINFO(ByVal argSpcRow As Integer) As Integer
    Dim RS_L            As ADODB.Recordset
    Dim intRow          As Integer
    Dim strDate         As String
    Dim strTime         As String
...
Function SaveTransData_JWINFO_JWINFO(ByVal argSpcRow As Integer) As Integer
    Dim RS_L            As ADODB.Recordset
    Dim intRow          As Integer
    Dim strDate         As String
    Dim strTime         As String
        ...
        For intRow = 1 To .vasTemp.DataRowCnt
            ...
            If strBarcode <> "" And strTestCd <> "" And sResult <> "" Then
                If strIO = "OL" Then
                    ...
                    SQL = SQL & "      ,ResultTime  = '" & Trim(Format(Time, "HH:MM:SS")) & "'" & vbCr
                    SQL = SQL & " Where SPECIMENNUM = '" & strBarcode & "'  " & vbCr
                    SQL = SQL & "   AND PTNO          = '" & strPatID & "'" & vbCr
                    SQL = SQL & "   AND RECEIPTNO     = '" & strChartNo & "'" & vbCr
                    SQL = SQL & "   AND OrderCode   = '" & strOrdCd & "'      " & vbCr
                    SQL = SQL & "   And LabCode     = '" & strTestCd & "'       " & vbCr
                    SQL = SQL & "   And TRANSFLAG < '2'                     " & vbCr
...
Function SaveTransData_AMIS_AMIS(ByVal argSpcRow As Integer) As Integer
    Dim RS_L            As ADODB.Recordset
    Dim intRow          As Integer
    Dim strDate         As String
    Dim strTime         As String
...
Function SaveTransDataR_AMIS_JWINFO(ByVal argSpcRow As Integer) As Integer
    Dim RS_L            As ADODB.Recordset
    Dim intRow          As Integer
    Dim strDate         As String
    Dim strTime         As String
...
Function SaveTransData(ByVal argSpcRow As Integer) As Integer
   ...
   '     SaveTransData = SaveTransData_AMIS_JWINFO(argSpcRow)
    
    Select Case gEMR
        Case "AMIS"
            SaveTransData = SaveTransData_AMIS_AMIS(argSpcRow)
        Case "JWINFO"
            SaveTransData = SaveTransData_JWINFO_JWINFO(argSpcRow)
    End Select
...
'    If gEMR2 <> "" Then
'        SaveTransDataR = SaveTransData_AMIS_JWINFO(argSpcRow)
'        Exit Function
'    End If
