...
Err:
    strErrMsg = ""
    strErrMsg = strErrMsg & "위    치 : " & gHOSP.MACHNM & "SerialRcvData_URISCAN" & vbNewLine & vbNewLine
                                            ...
                                            For intTestCdCnt = 1 To UBound(gArrEQP)
                                                ...
                                                If strIntBase = gArrEQP(intTestCdCnt, 3) Then
                                                    ...
                                                    If gPatTest(intOrdCnt) = gArrEQP(intTestCdCnt, 2) Then
                                                        ...
                                                        strTestCodeSub = gArrEQP(intTestCdCnt, 16)
                                                        'strTestCodeSub = gArrEQP(intTestCdCnt, 17)
        ...
        For intCnt = 1 To UBound(strRData)
            ...
            Select Case strType
                ...
                Case "OBR"
                    '-- 인터페이스 응답
                    strSend = ""
                    strSend = strSend & SB & "MSH|^~\&|Mindray|BS-490E|||" & Format(Now, "yyyymmddhhmmss") & "||ACK^R01|" & strBarno & "|P|2.3.1||||0||ASCII|||" & vbCr
