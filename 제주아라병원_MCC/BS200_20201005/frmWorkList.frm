    ...
    With vasWorkList
        For intRow = 1 To .MaxRows
            ...
            If .Value = 1 Then
                ...
                If GetText(vasWorkList, intRow, colCHARTNO) = "" Then
                    frmInterface.vasID.MaxRows = frmInterface.vasID.MaxRows - 1
                    Exit Sub
                End If
...
'          SQL = "SELECT DISTINCT ORD_YMD as 접수일자, BCODE_NO as 바코드번호, RECEPT_NO as 챠트번호, PTNT_NO as 내원번호,PTNT_NM as 이름, AGE as 나이,SEX as 성별,ORD_CD as ITEM"
    ...
    If chkType(0).Value = "1" Then
        If chkType(1).Value = "1" Then
            SQL = SQL & "   AND RESULT_TYPE IN ('20','30') " & vbCr   '10:접수, 20:진행, 30:완료, 50:취소
        Else
            SQL = SQL & "   AND RESULT_TYPE = '20'" & vbCr   '10:접수, 20:진행, 30:완료, 50:취소
        End If
    Else
        If chkType(1).Value = "1" Then
            SQL = SQL & "   AND RESULT_TYPE = '30'" & vbCr   '10:접수, 20:진행, 30:완료, 50:취소
        End If
    End If
        ...
        Do Until RS.EOF
            ...
            With vasWorkList
                ...
                For i = 1 To .DataRowCnt
                    ...
                    If Trim(RS("ORD_YMD")) = strDate And Trim(RS("RECEPT_NO")) = strChart Then
                        blnSame = True
                    End If
...
Private Sub vasWorkList_DblClick(ByVal Col As Long, ByVal Row As Long)
    ...
    With vasWorkList
        ...
        pGrid_Point = SeqSearch(frmInterface.vasID, GetText(vasWorkList, Row, colCHARTNO), colCHARTNO)
