...
Begin VB.Form mainFrm 
   ...
   Begin VB.Frame Frame6 
      ...
      Begin FPSpreadADO.fpSpread fpSpread_Tot_Ag 
         ...
         MaxRows         =   1
         SpreadDesigner  =   "mainFrm.frx":058A
      End
      Begin FPSpreadADO.fpSpread fpSpread_Tot_Usn 
         ...
         GrayAreaBackColor=   16777215
         MaxRows         =   1
         SpreadDesigner  =   "mainFrm.frx":077A
      End
   End
   ...
   Begin TabDlg.SSTab mntTab 
      ...
      Tab(0).Control(5)=   "fpSpread_Tot_DtVPN"
      Tab(0).Control(5).Enabled=   0   'False
      Tab(0).Control(6)=   "fpSpread_Tot_DtCDMA"
      Tab(0).Control(6).Enabled=   0   'False
      Tab(0).Control(7)=   "fpSpread_Tot_Tw"
      Tab(0).Control(7).Enabled=   0   'False
      Tab(0).Control(8)=   "fpSpread_Tot_Rt"
      Tab(0).Control(8).Enabled=   0   'False
      Tab(0).Control(9)=   "Frm_Time"
      Tab(0).Control(9).Enabled=   0   'False
      Tab(0).Control(10)=   "Frame7"
      Tab(0).Control(10).Enabled=   0   'False
      Tab(0).ControlCount=   11
      TabCaption(1)   =   "조위관측소"
      TabPicture(1)   =   "mainFrm.frx":0986
      ...
      Begin VB.Frame Frame7 
         ...
         Top             =   840
         Width           =   10545
         Begin FPSpreadADO.fpSpread sprRDCP 
            Height          =   1485
            Left            =   120
            TabIndex        =   128
            Top             =   600
            ...
            MaxRows         =   4
            ScrollBars      =   0
            SpreadDesigner  =   "mainFrm.frx":0A4A
         End
         Begin FPSpreadADO.fpSpread spdWeather 
            Height          =   2145
            Left            =   120
            TabIndex        =   130
            Top             =   3480
            ...
            MaxRows         =   6
            ScrollBars      =   0
            SpreadDesigner  =   "mainFrm.frx":0D7F
         End
         Begin FPSpreadADO.fpSpread spdTidal 
            Height          =   915
            Left            =   120
            TabIndex        =   131
            Top             =   6360
            ...
            MaxRows         =   2
            ScrollBars      =   0
            SpreadDesigner  =   "mainFrm.frx":10B4
         End
         Begin FPSpreadADO.fpSpread spdWQ 
            Height          =   2145
            Left            =   5220
            TabIndex        =   132
            Top             =   600
            ...
            MaxRows         =   6
            ScrollBars      =   0
            SpreadDesigner  =   "mainFrm.frx":13C5
         End
         Begin FPSpreadADO.fpSpread spdWQA 
            Height          =   915
            Left            =   5220
            TabIndex        =   133
            Top             =   3480
            ...
            MaxRows         =   2
            ScrollBars      =   0
            SpreadDesigner  =   "mainFrm.frx":16FA
         End
         Begin FPSpreadADO.fpSpread spdCT 
            Height          =   915
            Left            =   5190
            TabIndex        =   134
            Top             =   6360
            ...
            MaxRows         =   2
            ScrollBars      =   0
            SpreadDesigner  =   "mainFrm.frx":1A0B
         End
         Begin VB.Line Line2 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.ComboBox cmbxSechDTID 
            Height          =   300
            ItemData        =   "mainFrm.frx":1D1C
            Left            =   1155
            List            =   "mainFrm.frx":1D1E
            Style           =   2  '드롭다운 목록
            TabIndex        =   82
            Top             =   285
            Width           =   1575
      ...
      Begin VB.Frame Fm_Tw 
         ...
         Begin VB.ComboBox CboTw_NM 
            Height          =   300
            ItemData        =   "mainFrm.frx":1D20
            Left            =   1155
            List            =   "mainFrm.frx":1D22
            Style           =   2  '드롭다운 목록
            TabIndex        =   14
            Top             =   285
            Width           =   1575
         ...
         Begin VB.ComboBox CboTw_ID 
            Height          =   300
            ItemData        =   "mainFrm.frx":1D24
            Left            =   1800
            List            =   "mainFrm.frx":1D26
            Style           =   2  '드롭다운 목록
            TabIndex        =   15
            Top             =   270
            Visible         =   0   'False
      ...
      Begin VB.Frame Fm_RTID 
         ...
         Begin VB.ComboBox CboRTID_ID 
            Height          =   300
            ItemData        =   "mainFrm.frx":1D28
            Left            =   1650
            List            =   "mainFrm.frx":1D2A
            Style           =   2  '드롭다운 목록
            TabIndex        =   4
            Top             =   270
            Visible         =   0   'False
         ...
         Begin VB.ComboBox CboRTID_NM 
            Height          =   300
            ItemData        =   "mainFrm.frx":1D2C
            Left            =   1155
            List            =   "mainFrm.frx":1D2E
            Style           =   2  '드롭다운 목록
            TabIndex        =   3
            Top             =   285
            Width           =   1575
      ...
      Begin FPSpreadADO.fpSpread fpSpread_Tot_Rt 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "mainFrm.frx":1D30
      End
      Begin FPSpreadADO.fpSpread fpSpread_Tot_Tw 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "mainFrm.frx":1F28
      End
      Begin FPSpreadADO.fpSpread fpSpread_DtLog 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "mainFrm.frx":2132
      End
      Begin FPSpreadADO.fpSpread fpSpread_Tot_DtCDMA 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "mainFrm.frx":2306
      End
      Begin FPSpreadADO.fpSpread fpSpread_Tot_DtVPN 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "mainFrm.frx":24DA
      End
      Begin Threed.SSPanel SSPanel6 
         Height          =   375
         Index           =   0
      ...
      Begin FPSpreadADO.fpSpread fpSpread_TwLog 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "mainFrm.frx":26D2
      End
      Begin Threed.SSPanel SSPanel6 
         Height          =   375
         Index           =   1
      ...
      Begin FPSpreadADO.fpSpread fpSpread_RtLog 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "mainFrm.frx":28A6
      End
      Begin Threed.SSPanel SSPanel6 
         Height          =   375
         Index           =   2
      ...
      Begin FPSpreadADO.fpSpread fpSpread_AgLog 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "mainFrm.frx":2A7A
      End
      Begin Threed.SSPanel SSPanel6 
         Height          =   375
         Index           =   3
      ...
      Begin FPSpreadADO.fpSpread fpSpread_UsnLog 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "mainFrm.frx":2C4E
      End
      Begin Threed.SSPanel SSPanel6 
         Height          =   375
         Index           =   4
      ...
      Begin FPSpreadADO.fpSpread fpSpread2 
         ...
         EndProperty
         MaxRows         =   3
         SpreadDesigner  =   "mainFrm.frx":2E22
         Appearance      =   1
      End
      Begin FPSpreadADO.fpSpread ss_Tw 
         ...
         ShadowDark      =   12632319
         SpreadDesigner  =   "mainFrm.frx":3004
         Appearance      =   1
      End
      Begin VB.Label Label1 
         AutoSize        =   -1  'True
         Caption         =   "USN 자료수집 모니터링"
         BeginProperty Font 
            Name            =   "굴림"
            Size            =   9.75
            Charset         =   129
...
'CCY On Error GoTo ErrorHandler
    ...
    '-- RDCP부이자료 표시
    Call subRDCPDisplay(sprRDCP, "TK_BUOY_OBSERVATION")
    '-- 기상자료 표시
    Call subRDCPDisplay(spdWeather, "TK_WEATHER_OBSERVATION")
    '-- 조위자료 표시
    Call subRDCPDisplay(spdTidal, "TK_TIDAL_OBSERVATION")
    '-- 수질모니터링자료 표시
    Call subRDCPDisplay(spdWQ, "TK_WQ_OBSERVATION")
    '-- 수질분석자료 표시
    Call subRDCPDisplay(spdWQA, "TK_WQA_OBSERVATION")
    '-- CT String자료 표시
    Call subRDCPDisplay(spdCT, "TK_BUOY_CTD")
...
Private Sub fpSpread_Tot_DtVPN_DblClick(ByVal Col As Long, ByVal Row As Long)
    
    With fpSpread_Tot_DtVPN
        .Row = Row: .Col = Col
        If Trim(.Text) <> "" Then
            frmDetail.Show , mainFrm
        End If
    End With
