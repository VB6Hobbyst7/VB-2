...
Begin VB.Form mainFrm 
   ...
   Begin TabDlg.SSTab mntTab 
      ...
      Tab(1).Control(1)=   "DT_Timer"
      Tab(1).Control(2)=   "fpSpread_DtLog"
      Tab(1).Control(3)=   "SSPanel6(0)"
      Tab(1).Control(4)=   "Panel_Time_Dt"
      Tab(1).ControlCount=   5
      TabCaption(2)   =   "종합해양관측부이"
      TabPicture(2)   =   "mainFrm.frx":05C2
      Tab(2).ControlEnabled=   0   'False
      Tab(2).Control(0)=   "TW_Timer"
      Tab(2).Control(1)=   "Frame2"
      Tab(2).Control(2)=   "fpSpread_TwLog"
      Tab(2).Control(3)=   "SSPanel6(1)"
      Tab(2).Control(4)=   "Panel_Time_Tw"
      Tab(2).ControlCount=   5
      TabCaption(3)   =   "해양관측소"
      TabPicture(3)   =   "mainFrm.frx":05DE
      Tab(3).ControlEnabled=   0   'False
      Tab(3).Control(0)=   "RT_Timer"
      Tab(3).Control(1)=   "Frame3"
      Tab(3).Control(2)=   "fpSpread_RtLog"
      Tab(3).Control(3)=   "SSPanel6(2)"
      Tab(3).Control(4)=   "Panel_Time_Rt"
      Tab(3).ControlCount=   5
      TabCaption(4)   =   "해수유동부이"
      TabPicture(4)   =   "mainFrm.frx":05FA
      Tab(4).ControlEnabled=   0   'False
      Tab(4).Control(0)=   "AG_Timer"
      Tab(4).Control(1)=   "Frame4"
      Tab(4).Control(2)=   "fpSpread_AgLog"
      Tab(4).Control(3)=   "SSPanel6(3)"
      Tab(4).Control(4)=   "Panel_Time_Ag"
      Tab(4).ControlCount=   5
      TabCaption(5)   =   "USN"
      TabPicture(5)   =   "mainFrm.frx":0616
      Tab(5).ControlEnabled=   0   'False
      Tab(5).Control(0)=   "Frame5"
      Tab(5).Control(1)=   "USN_Timer"
      Tab(5).Control(2)=   "fpSpread_UsnLog"
      Tab(5).Control(3)=   "SSPanel6(4)"
      Tab(5).Control(4)=   "Panel_Time_Usn"
      ...
      Tab(7).Control(0)=   "fpSpread2"
      Tab(7).Control(1)=   "Fm_RTID"
