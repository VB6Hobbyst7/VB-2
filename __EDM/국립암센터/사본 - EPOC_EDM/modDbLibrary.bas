...
'<NewDataSet>
'<Table>
'<QID><![CDATA[PG_SRL.SLP91_P03]]></QID>
'<QTYPE><![CDATA[Package]]></QTYPE>
'<USERID><![CDATA[SUA]]></USERID>
...
'</NewDataSet>
                ...
                Call Online_Result_Qry(sParam, "PG_SRL.SLP91_P03")
...
'<NewDataSet>
'<Table>
'<QID><![CDATA[PG_SRL.SLP91_U07]]></QID>
'<QTYPE><![CDATA[Package]]></QTYPE>
'<USERID><![CDATA[SUA]]></USERID>
'<EXECTYPE><![CDATA[NONQUERY]]></EXECTYPE>
'<TABLENAME><![CDATA[]]></TABLENAME>
...
'</NewDataSet>
            ...
            Call Online_Result_Qry(sParam, "PG_SRL.SLP91_U07")
...
Function GetSampleInfoW_NCC(ByVal asRow As Long) As Integer
    ...
    If Len(strDate) = 8 Then
        strDate = Format(strDate, "yyyymmddhhmmss")
    End If
    ...
    '==> 검체번호,접수번호 가져오기
    Call Online_XML(gXml_U06, sChartNo, strDate)
...
'    Call Online_XML(gXml_P03, sBarcode)
'
'
'    Select Case Mid(sBarcode, 1, 1)
'        Case "1", "2", "3", "4", "5"
