...
Begin VB.Form frmInterface 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin FPSpread.vaSpread vasRes 
         ...
         RetainSelBlock  =   0   'False
         ScrollBars      =   2
         SpreadDesigner  =   "frmInterface.frx":1FF9
      End
   End
   ...
   Begin VB.Frame FrmHideControl 
      ...
      Begin VB.Frame Frame4 
         ...
         Begin FPSpread.vaSpread vasPrint 
            ...
            EndProperty
            MaxCols         =   9
            SpreadDesigner  =   "frmInterface.frx":3693
         End
         Begin FPSpread.vaSpread vasPrintBuf 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            SpreadDesigner  =   "frmInterface.frx":3B46
         End
      End
      ...
      Begin FPSpread.vaSpread vasCode 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":3DB5
      End
      Begin FPSpread.vaSpread vasTemp1 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":4024
      End
         ...
         Begin MSComctlLib.ImageList imlStatus 
            ...
            BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
               ...
               BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":481D
                  Key             =   "RUN"
               EndProperty
               BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":4DB7
                  Key             =   "NOT"
               EndProperty
               BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":5351
                  Key             =   "STOP"
               EndProperty
               BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":58EB
                  Key             =   "LST"
               EndProperty
               BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":617D
                  Key             =   "ITM"
               EndProperty
               BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":62D7
                  Key             =   "ERR"
               EndProperty
               BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":6431
                  Key             =   "NOF"
               EndProperty
            EndProperty
         End
      ...
      Begin FPSpread.vaSpread vasList 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":658B
      End
      Begin FPSpread.vaSpread vasResTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":67FA
      End
      Begin FPSpread.vaSpread vasTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":6A69
      End
      Begin FPSpread.vaSpread vasExcel 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":6CD8
      End
            ...
            If lsID <> "" And strWorkNum <> "" Then
                ...
                For iRow = 1 To vasTemp.DataRowCnt
                    ...
                    If sResult <> "" Then
                        ...
                        SQL = SQL & ",'00'" & vbCr
                        SQL = SQL & ",'A'" & vbCr
                        SQL = SQL & ",'" & strWorkNum & "'" & vbCr
                        SQL = SQL & ",'" & strEqpCd & "'" & vbCr
                        SQL = SQL & ",'004'" & vbCr
                        SQL = SQL & ",'998'" & vbCr
                        SQL = SQL & ",'99'" & vbCr
                        ...
                        SQL = SQL & ",''" & vbCr
                        SQL = SQL & ",'" & Mid(lsPid, 1, 2) & "'" & vbCr
                        '7자리로변경
                        'SQL = SQL & ",'" & Mid(lsPid, 3, 6) & "'" & vbCr
                        SQL = SQL & ",'" & Mid(lsPid, 3, 7) & "'" & vbCr
                ...
                If Res >= 0 Then
                    '-- Update
                          SQL = "Update ocsipslh Set " & vbCr
                    SQL = SQL & " IPSLSTAT = '7' " & vbCr
                    SQL = SQL & ",IPSLMTCD = '004' " & vbCr
                    SQL = SQL & ",IPSLACDP = 'LA'  " & vbCr
                    SQL = SQL & ",IPSLSMDT = '" & Format(Now, "yyyymmddhhmm") & "'" & vbCr
                    SQL = SQL & ",IPSLSMYR = '" & Mid(lsPid, 1, 2) & "'" & vbCr
                    '7자리로변경
                    'SQL = SQL & ",IPSLSMSN = '" & Mid(lsPid, 3, 6) & "'" & vbCr
                    SQL = SQL & ",IPSLSMSN = '" & Mid(lsPid, 3, 7) & "'" & vbCr
...
'''                End If
                ...
                If Len(pBarNo) >= 8 And IsNumeric(pBarNo) Then
                    ...
                    SetText vasID, mOCS.FWorkNo, intRow, colPID    '
                    SetText vasID, mOCS.FBarCode, intRow, colCHARTNO            '
    ...
    ElseIf KeyCode = vbKeyReturn Then
        If iCol = colBARCODE Then
            ...
            'If lsID <> lblBarcode(0).Caption Then
                ...
                SQL = SQL & ",CHARTNO = '" & Trim(GetText(vasID, iRow, colPID)) & "' " & vbCrLf
