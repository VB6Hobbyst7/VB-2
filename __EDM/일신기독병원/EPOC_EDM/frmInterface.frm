...
Begin VB.Form frmInterface 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin FPSpread.vaSpread vasRes 
         ...
         RetainSelBlock  =   0   'False
         ScrollBars      =   2
         SpreadDesigner  =   "frmInterface.frx":1FAC
      End
   End
   ...
   Begin VB.Frame FrmHideControl 
      ...
      Begin VB.Frame Frame4 
         ...
         Begin FPSpread.vaSpread vasPrint 
            ...
            EndProperty
            MaxCols         =   9
            SpreadDesigner  =   "frmInterface.frx":35F9
         End
         Begin FPSpread.vaSpread vasPrintBuf 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            SpreadDesigner  =   "frmInterface.frx":3A5F
         End
      End
      ...
      Begin FPSpread.vaSpread vasCode 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":3C81
      End
      Begin FPSpread.vaSpread vasTemp1 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":3EA3
      End
         ...
         Begin MSComctlLib.ImageList imlStatus 
            ...
            BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
               ...
               BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":464F
                  Key             =   "RUN"
               EndProperty
               BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":4BE9
                  Key             =   "NOT"
               EndProperty
               BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":5183
                  Key             =   "STOP"
               EndProperty
               BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":571D
                  Key             =   "LST"
               EndProperty
               BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":5FAF
                  Key             =   "ITM"
               EndProperty
               BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":6109
                  Key             =   "ERR"
               EndProperty
               BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":6263
                  Key             =   "NOF"
               EndProperty
            EndProperty
         End
      ...
      Begin FPSpread.vaSpread vasList 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":63BD
      End
      Begin FPSpread.vaSpread vasResTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":65DF
      End
      Begin FPSpread.vaSpread vasTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":6801
      End
      Begin FPSpread.vaSpread vasExcel 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":6A23
      End
...
'    Dim iRow            As Integer
    ...
    For lRow = 1 To vasID.DataRowCnt
        ...
        If vasID.Value = 1 Then
            ...
            lsPid = Trim(GetText(vasID, lRow, colCHARTNO))
            strWorkNum = Trim(GetText(vasID, lRow, colPID))
            strDocID = Trim(GetText(vasID, lRow, colINOUT))
            ...
            If mOCS.FAcDt = "" Or mOCS.FAcTm = "" Or mOCS.FRqDt = "" Or mOCS.FRqTm = "" Then
                Call GetSampleInfoW_ILSIN(lRow)
            End If
                        
            If mOCS.FAcDt = "" Then
                mOCS.FAcDt = Trim(GetText(vasID, lRow, colDISKNO))
            End If
            
            If mOCS.FAcTm = "" Then
                mOCS.FAcTm = Trim(GetText(vasID, lRow, colPOSNO))
            End If
            ...
            If lsID <> "" And strWorkNum <> "" Then
                ...
                For iRow = 1 To vasTemp.DataRowCnt
                    ...
                    If sResult <> "" Then
                        '-- 검사결과저장
                              SQL = "Insert Into acrcpnwh                                       " & vbCrLf
                        SQL = SQL & "( CPNWDPCD, CPNWHPNO, CPNWDATE, CPNWSLIP, CPNWITEM         " & vbCrLf
                        SQL = SQL & " , CPNWOITP, CPNWWKNO, CPNWCODE, CPNWSMPL, CPNWMACH        " & vbCrLf
                        SQL = SQL & " , CPNWDISP, CPNWIDNO, CPNWDLTF, CPNWPNCF, CPNWSTAT        " & vbCrLf
                        SQL = SQL & " , CPNWSPCL, CPNWRCLF, CPNWRTCD, CPNWNVAL, CPNWSIGN        " & vbCrLf
                        SQL = SQL & " , CPNWRSLT, CPNWPRNT, CPNWUPDT, CPNWUSER, CPNWUSR2        " & vbCrLf
                        SQL = SQL & " , CPNWSMYR, CPNWSMSN, CPNWSMS1, CPNWSMS2                  " & vbCrLf
                        SQL = SQL & " , CPNWDESC, CPNWTATD, CPNWTATF, CPNWPANL)                 " & vbCrLf
                        ...
                        SQL = SQL & " , '00'                                                    " & vbCrLf
                        SQL = SQL & " , 'A'                                                     " & vbCrLf
                        SQL = SQL & " , '" & strWorkNum & "'                                    " & vbCrLf
                        SQL = SQL & " , '" & strEqpCd & "'                                      " & vbCrLf
                        SQL = SQL & " , '004'                                                   " & vbCrLf
                        SQL = SQL & " , '998'                                                   " & vbCrLf
                        SQL = SQL & " , '99'                                                    " & vbCrLf
                        ...
                        SQL = SQL & " , ''                                                      " & vbCrLf
                        SQL = SQL & " , '" & Format(Now, "yyyymmddhhmm") & "'                   " & vbCrLf
                        SQL = SQL & " , '" & mOCS.FDocID & "'                                   " & vbCrLf
                        SQL = SQL & " , ''                                                      " & vbCrLf
                        SQL = SQL & " , '" & Mid(lsPid, 1, 2) & "'                              " & vbCrLf
                        '7자리로변경
                        'SQL = SQL & ",'" & Mid(lsPid, 3, 6) & "'" & vbCrlf
                        SQL = SQL & " , '" & Mid(lsPid, 3, 7) & "'                              " & vbCrLf
                        SQL = SQL & " , 1                                                       " & vbCrLf
                        SQL = SQL & " , 1                                                       " & vbCrLf
                        SQL = SQL & " , ''                                                      " & vbCrLf
                        SQL = SQL & " , ''                                                      " & vbCrLf
                        ...
                        Call SetSQLData("4_결과저장", SQL)
                        Call SetRawData("4_결과저장 : " & SQL & vbCrLf)
                        'Call SetRawData(SQL)
                ...
                If Res >= 0 Then
                    '-- Update
                          SQL = "Update ocsipslh Set                                " & vbCrLf
                    SQL = SQL & "   IPSLSTAT = '7'                                  " & vbCrLf
                    SQL = SQL & " , IPSLMTCD = '004'                                " & vbCrLf
                    SQL = SQL & " , IPSLACDP = 'LA'                                 " & vbCrLf
                    SQL = SQL & " , IPSLSMDT = '" & Format(Now, "yyyymmddhhmm") & "'" & vbCrLf
                    SQL = SQL & " , IPSLSMYR = '" & Mid(lsPid, 1, 2) & "'           " & vbCrLf
                    '7자리로변경
                    'SQL = SQL & ",IPSLSMSN = '" & Mid(lsPid, 3, 6) & "'" & vbCrlf
                    SQL = SQL & " , IPSLSMSN = '" & Mid(lsPid, 3, 7) & "'           " & vbCrLf
                    SQL = SQL & " , IPSLSMS1 = 1                                    " & vbCrLf
                    SQL = SQL & " , IPSLSMS2 = 1                                    " & vbCrLf
                    SQL = SQL & " , IPSLWORK = '" & mOCS.FWorkNo & "'               " & vbCrLf
                    If mOCS.FAcDt <> "" Then
                        SQL = SQL & " , IPSLACDT = '" & mOCS.FAcDt & "'             " & vbCrLf
                        SQL = SQL & " , IPSLHPDT = '" & mOCS.FAcDt & "'             " & vbCrLf
                    Else
                        SQL = SQL & " , IPSLACDT = '" & Format(Now, "yyyymmdd") & "'" & vbCrLf
                        SQL = SQL & " , IPSLHPDT = '" & Format(Now, "yyyymmdd") & "'" & vbCrLf
                    End If
                    If mOCS.FAcTm <> "" Then
                        SQL = SQL & " , IPSLACTM = '" & mOCS.FAcTm & "'             " & vbCrLf
                        SQL = SQL & " , IPSLHPTM = '" & mOCS.FAcTm & "'             " & vbCrLf
                    Else
                        SQL = SQL & " , IPSLACTM = '" & Format(Now, "hhmm") & "'    " & vbCrLf
                        SQL = SQL & " , IPSLHPTM = '" & Format(Now, "hhmm") & "'    " & vbCrLf
                    End If
                    SQL = SQL & " Where ipslidno = '" & mOCS.FPID & "'              " & vbCrLf
                    SQL = SQL & "   And ipslhpno = '01'                             " & vbCrLf
                    SQL = SQL & "   And ipslmddt = '" & mOCS.FMdDt & "'             " & vbCrLf
                    SQL = SQL & "   And ipslcode = '" & mOCS.FOrdCd & "'            " & vbCrLf
                    SQL = SQL & "   And ipslflag = 'O'                              " & vbCrLf
                    SQL = SQL & "   And ipslstat = '0'                              " & vbCrLf
                    
                    Call SetSQLData("5_상태저장", SQL)
                    Call SetRawData("5_상태저장 : " & SQL & vbCrLf)
                    ...
                    '2019-11-01 acawnifh 보고일자 업데이트
                    'acawnifh의 primary키는 wnifdpcd, wnifhpno, wnifdate, wnifslip, wnifsmpl, wnifitem, wnifoitp,wnifwkno 입니다.
                          SQL = "Update acawnifh Set                                " & vbCrLf
                    SQL = SQL & "       WNIFRPDT = '" & Format(Now, "yyyymmdd") & "'" & vbCrLf
                    SQL = SQL & "     , WNIFRPTM = '" & Format(Now, "hhmm") & "'    " & vbCrLf
                    SQL = SQL & "     , WNIFACDT = '" & mOCS.FAcDt & "'             " & vbCrLf
                    SQL = SQL & "     , WNIFACTM = '" & mOCS.FAcTm & "'             " & vbCrLf
                    SQL = SQL & " Where WNIFDPCD = 'LA'                             " & vbCrLf
                    SQL = SQL & "   And WNIFHPNO = '01'                             " & vbCrLf
                    SQL = SQL & "   And WNIFDATE = '" & Format(Now, "yyyymmdd") & "'" & vbCrLf
                    SQL = SQL & "   And WNIFSLIP = 'LAE'                            " & vbCrLf
                    SQL = SQL & "   And WNIFSMPL = '004'                            " & vbCrLf
                    SQL = SQL & "   And WNIFITEM = '00'                             " & vbCrLf
                    SQL = SQL & "   And WNIFOITP = 'A'                              " & vbCrLf
                    SQL = SQL & "   And WNIFWKNO = '" & mOCS.FWorkNo & "'           " & vbCrLf
                
                    Call SetSQLData("6_보고일자업데이트", SQL)
                    Call SetRawData("6_보고일자업데이트 : " & SQL & vbCrLf)
...
Private Sub cmdRsltSearch_Click()
    ...
    vasRes.MaxRows = 0
          ...
          SQL = " SELECT '', SAVESEQ, MID(EXAMDATE,1,8) AS EXAMDATE, HOSPDATE AS 접수일자, BARCODE AS 바코드번호, PID AS 내원번호, CHARTNO AS 차트번호 , PNAME AS 이름,PSEX AS 성별, PAGE AS 나이, DISKNO, POSNO, EXAMCODE, RESULT, REFFLAG, SENDFLAG,INOUT " & vbCrLf
    SQL = SQL & "   FROM PATRESULT " & vbCrLf
...
Function GetExamCode() As Integer
    ...
    For i = 1 To vasCode.DataRowCnt
        If i = 1 Then
            ...
            gAllExamCD = Trim(GetText(vasCode, i, 2)) & Space(12 - Len(Trim(GetText(vasCode, i, 2))))
        Else
            gAllExam = gAllExam & ",'" & Trim(GetText(vasCode, i, 2)) & "'"
            gAllExamCD = gAllExamCD & Trim(GetText(vasCode, i, 2)) & Space(12 - Len(Trim(GetText(vasCode, i, 2))))
        End If
    ...
    If txtTimer.Text = "0" Then
        ...
        If Not RSH.EOF = True And Not RSH.BOF = True Then
            Do Until RSH.EOF
                ...
                pBarNo = Trim(RSH.Fields("PatientOrLotID")) & ""    '병록번호
...
'''                End If
                ...
                SetText vasID, pBarNo, intRow, colBARCODE
                '-- 스프레드 표시 -------------------------------------------
                
                '-- 환자정보 표시 -------------------------------------------
                If Len(pBarNo) >= 8 And IsNumeric(pBarNo) Then
                    'blnRcp = False
                    '-- 검사자 정보 서버테이블에서 가져와 표시
                    If GetSampleInfoW_ILSIN(intRow) = 1 Then
                        If blnRcp = False Then
                            '-- 접수 마스터 저장
                    ...
                    If blnRcp = True Then
                        SetText vasID, "1", intRow, colCHECKBOX
                        SetText vasID, Trim(mOCS.FMdDt), intRow, colHOSPDATE
                        SetText vasID, pBarNo, intRow, colBARCODE               '병록번호   (장비에서 병록번호로 검사한다.)
                        SetText vasID, mOCS.FPNM, intRow, colPNAME
                        SetText vasID, mOCS.FWorkNo, intRow, colPID             '워크번호   (오늘날짜 MAX+1)
                        SetText vasID, mOCS.FBarCode, intRow, colCHARTNO        '바코드번호 (병록번호로 찾아온..)
                        SetText vasID, mOCS.FDocID, intRow, colINOUT             'DocID
                        
                        SetText vasID, mOCS.FAcDt, intRow, colDISKNO
                        SetText vasID, mOCS.FAcTm, intRow, colPOSNO
                    End If
'                Else
'                    Exit Sub
                End If
               ...
               If Not RSD.EOF = True And Not RSD.BOF = True Then
                    ...
                    '-- 서버저장
                    'If MnTransAuto.Checked = True And strState = "R" And blnRcp = True Then
                    If strState = "R" And blnRcp = True Then
...
'    SQL = SQL & strSaveSeq
    ...
    SQL = SQL & "','" & gEquip
    SQL = SQL & "','" & Trim(GetText(vasID, asRow1, colBARCODE))    'Public Const colBARCODE = 5     '병록
    ...
    SQL = SQL & "',''"
    SQL = SQL & ",'" & Trim(GetText(vasID, asRow1, colCHARTNO)) 'Public Const colCHARTNO = 6     '바코드
    SQL = SQL & "','" & Trim(GetText(vasID, asRow1, colPID))    'Public Const colPID = 7         '워크
...
'        End If
    ...
    ElseIf KeyCode = vbKeyReturn Then
        If iCol = colBARCODE Then
            ...
            '-- 바뀐 바코드로 환자정보 불러오기
            If GetSampleInfoW_ILSIN(iRow) = 1 Then
                '-- 접수 마스터 저장
                Call Reg_acawnifh_ILSIN
            End If
            
            SetText vasID, "1", iRow, colCHECKBOX
            SetText vasID, Trim(mOCS.FMdDt), iRow, colHOSPDATE
            
            SetText vasID, Trim(GetText(vasID, iRow, colBARCODE)), iRow, colBARCODE

            SetText vasID, mOCS.FPNM, iRow, colPNAME
            SetText vasID, mOCS.FWorkNo, iRow, colPID       'colCHARTNO   '
            SetText vasID, mOCS.FBarCode, iRow, colCHARTNO  'colPID      '
            SetText vasID, mOCS.FDocID, iRow, colINOUT             'DocID
