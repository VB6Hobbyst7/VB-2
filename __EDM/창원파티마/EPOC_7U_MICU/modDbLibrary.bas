        ...
        For iRow = 1 To .vasTemp.DataRowCnt
            ...
            If sResult <> "" Then
                ...
                If IsNumeric(sResult) Then
                    strRsltType = "1"
                    'cn_Ser.Execute "Exec SP_INTERFACE_INSERT '7S','" & lsID & "','" & sResult & "','" & strChannel & "','1','','" & strReturn & "'"
                Else
                    strRsltType = "0"
                    'cn_Ser.Execute "Exec SP_INTERFACE_INSERT '7S','" & lsID & "','" & sResult & "','" & strChannel & "','0','','" & strReturn & "'"
                End If
                ...
                With cmdSQL
                    .CommandTimeout = 15
                    .CommandText = "SP_INTERFACE_INSERT"
                    .CommandType = adCmdStoredProc
                    
                    Set prm1 = .CreateParameter("I_JANGBI_NAME", adVarChar, adParamInput, 40, "7U")
                    .Parameters.Append prm1
                    Set prm2 = .CreateParameter("I_SAMPLE_ID", adVarChar, adParamInput, 20, lsID)
                    .Parameters.Append prm2
                    Set prm3 = .CreateParameter("I_HANGMOG_CODE", adVarChar, adParamInput, 20, sResult)
                    .Parameters.Append prm3
                    Set prm4 = .CreateParameter("I_CPL_RESULT", adVarChar, adParamInput, 50, strChannel)
                    .Parameters.Append prm4
                    Set prm5 = .CreateParameter("I_CHK_FLAG", adVarChar, adParamInput, 1, strRsltType)
                    .Parameters.Append prm5
                    Set prm6 = .CreateParameter("I_CONFIRM_YN", adVarChar, adParamInput, 1, "")
                    .Parameters.Append prm6
                     
                    SetRawData "[결과저장]" & "7S" & "," & lsID & "," & sResult & "," & strChannel & "," & strRsltType
