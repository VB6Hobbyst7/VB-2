   ...
   Begin VB.Frame Frame1 
      ...
      Begin FPSpread.vaSpread vasExcel 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":151E
      End
      ...
      Begin FPSpread.vaSpread vasID 
         ...
         SpreadDesigner  =   "frmInterface.frx":1740
      End
      ...
      Begin FPSpread.vaSpread vasRes 
         ...
         RetainSelBlock  =   0   'False
         ScrollBars      =   2
         SpreadDesigner  =   "frmInterface.frx":2201
      End
   End
   ...
   Begin VB.Frame FrmHideControl 
      ...
      Begin VB.Frame Frame4 
         ...
         Begin FPSpread.vaSpread vasPrint 
            ...
            EndProperty
            MaxCols         =   9
            SpreadDesigner  =   "frmInterface.frx":384D
         End
         Begin FPSpread.vaSpread vasPrintBuf 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            SpreadDesigner  =   "frmInterface.frx":3CB3
         End
      End
      ...
      Begin FPSpread.vaSpread vasCode 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":3ED5
      End
      Begin FPSpread.vaSpread vasTemp1 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":40F7
      End
         ...
         Begin MSComctlLib.ImageList imlStatus 
            ...
            BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
               ...
               BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":48A3
                  Key             =   "RUN"
               EndProperty
               BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":4E3D
                  Key             =   "NOT"
               EndProperty
               BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":53D7
                  Key             =   "STOP"
               EndProperty
               BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":5971
                  Key             =   "LST"
               EndProperty
               BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":6203
                  Key             =   "ITM"
               EndProperty
               BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":635D
                  Key             =   "ERR"
               EndProperty
               BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":64B7
                  Key             =   "NOF"
               EndProperty
            EndProperty
         End
      ...
      Begin FPSpread.vaSpread vasList 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":6611
      End
      Begin FPSpread.vaSpread vasResTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":6833
      End
      Begin FPSpread.vaSpread vasTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":6A55
      End
...
'Const VerifyID           As String = "101987"  ''' 대구진단검사의학 전문의
            ...
            For iRow = 1 To vasTemp.DataRowCnt
                ...
                If sResult <> "" Then
                    ...
                    With cmdSQL
                        ...
                        Set prm9 = .CreateParameter("io_erryn", adVarChar, adParamInputOutput, 100, 0)
                        .Parameters.Append prm9
                        Set prm10 = .CreateParameter("io_errmsg", adVarChar, adParamInputOutput, 100, 0)
                        ...
                        'DB 트리거에서 검사결과저장 과 진료의 처방상태 변경 프로시저를 같은 시간에 처리하면 에러가 나온다하여 1초 이상의 Delay Time을 주고 저장한다.
                        'Call Sleep(1200)
                        '2019-12-23 09:20:46
                        '2019-12-23 09:20:50
                        '2019-12-23 09:20:53
...
'                                                  , io_errmsg
                    ...
                    With cmdSQL
                        ...
                        Set prm13 = .CreateParameter("io_erryn", adVarChar, adParamInputOutput, 100, 0)
                        .Parameters.Append prm13
                        Set prm14 = .CreateParameter("io_errmsg", adVarChar, adParamInputOutput, 100, 0)
...
'                                                        , io_errmsg      in out  varchar2
                    ...
                    With cmdSQL
                        ...
                        .Parameters.Append prm2
                        Set prm3 = .CreateParameter("in_rptprsnid", adVarChar, adParamInput, 100, VerifyID)
                        .Parameters.Append prm3
                        Set prm4 = .CreateParameter("io_erryn", adVarChar, adParamInputOutput, 100, 0)
                        .Parameters.Append prm4
                        Set prm5 = .CreateParameter("io_errmsg", adVarChar, adParamInputOutput, 100, 0)
                        .Parameters.Append prm5
...
''''    SetRawData "[FTP OPEN]" & CStr(okConn)
''''    MsgBox "okConn >>" & okConn
'''
'''    '-- WRITE
'''    Dim okFTrans As Boolean
'''    okFTrans = mmftp.RenameFTPFile("/usr/tmp/" & gEquip & ".dat", "/usr/tmp/" & gEquip & ".bak")
'''    'SetRawData "[FTP File ReName]" & "FTP FILE Rename : " & okFTrans
''''    MsgBox "okFTrans1 >>" & okFTrans
'''
'''    '-- SEND
'''    okFTrans = mmftp.FTPUploadFile(App.Path & "\" & gEquip & ".dat", "/usr/tmp/" & gEquip & ".dat")
'''    'SetRawData "[FTP Send]" & "FTP FILE Rename : " & CStr(okFTrans)
''''    MsgBox "okFTrans2 >>" & okFTrans
'''
'''
'''    '-- CLOSE
...
'''    'MsgBox "Res >>" & Res
'''
''''    Res = Shell("rsh " & gWebServer.IP & " -l " & gWebServer.ID & " ./exp_interface.sh clbdvt02m3 " & gEquip & " " & gExamUID & " u_stat=R", 0)
''''    MsgBox "Res >>" & Res
'''
''''    Res = Shell("rsh " & gWebServer.IP & " -l " & gWebServer.ID & " ./expect_test/exp_interface_java.sh clbdvt02m3 " & gEquip & " " & gExamUID, 0)
''''    MsgBox "Res >>" & Res
'''
'''    Res = Shell("rsh " & gWebServer.IP & " -l " & gWebServer.ID & " ./expect_test/exp_interface_java.sh clbdvt02m3 " & gEquip & " " & gExamUID & " u_stat=R", 0)
'''
''''    Res = Shell("rsh " & gWebServer.IP & " -l " & gWebServer.ID & " ./exp_interface.sh clbdvt02m3 " & gEquip & " " & gExamUID, 0)
'''
'''
''''    Res = Shell("rsh lab -l ias ./expect_test/exp_interface_java.sh clbdvt02m3 " & gEquip & " " & gExamUID & " u_stat=R", 0)
'''
''''    MsgBox "Res >>" & Res
'''
'''
...
'''    'SetRawData "[Proc]" & CStr(Res) & "rsh " & gWebServer.IP & " -l " & gWebServer.ID & " ./exp_interface.sh clbdvt02m3 " & gEquip & " " & gExamUID & ", 0"
'''    '=========================================================================
...
Private Sub GetWorkList_MSINFOTEC(ByVal pFrDt As String, ByVal pToDt As String, Optional pBarNo As String)
    ...
    SQL = ""
    SQL = SQL & "Select DISTINCT a.ORDT as 접수일자,'0',b.PANM as 이름,a.SPNO as 바코드번호,a.OIFL,'0',b.SEXS as 성별,b.AGES as 나이,a.NWNO as 내원번호,a.ORCD as ITEM " & vbCr
...
'    vasID.MaxRows = 10
    ...
    'Call WinExec("C:\IF_EPOC\COM\EPOC.exe 3 C:\IF_EPOC\LOG", 0)
    '-- 델파이 EPOC쓸 경우   =========================================

    'FileEPOC.Path = "C:\IF_EPOC\LOG"
    
    'Text1.Text = "rsh " & gWebServer.IP & " -l " & gWebServer.ID & " ./expect_test/exp_interface_java.sh clbdvt02m3 " & gEquip & " " & gExamUID & " u_stat=R"
...
'''On Error GoTo Err
'''
'''    tmrEPOC.Enabled = False
'''
''''    Ret = WinExec("C:\IF_EPOC\COM\EPOC.exe 3 C:\IF_EPOC\LOG", 0)
'''
''''    Ret = WinExec("C:\RS232\execbde.exe C:\update.sql c:\err.txt", 2)
'''
'''     Res = Shell("C:\IF_EPOC\COM\EPOC.exe 3 C:\IF_EPOC\LOG", 0)
'''
'''    Open (App.Path & "\COM\EPOC.txt") For Input As #1
'''    While Not EOF(1)
'''        Line Input #1, dummy
'''        SetRawData "[Rx]" & dummy
'''        StatusBar1.Panels(3).Text = dummy
'''    Wend
'''    Close #1
'''
'''
''''    tmrEPOC.Interval = 5000
'''
''''''    Res = Shell("taskkill.exe /im C:\IF_EPOC\COM\EPOC.exe", 0)
''''''
''''''    If comEqp.PortOpen = False Then
''''''        comEqp.PortOpen = True
''''''    End If
...
'    Call GetSampleInfoW_MEDIOUS(intRow)
...
'    Dim strPrsnId        As String
    ...
    SetRawData "[접수번호조회A]" & strPtNo & "," & strOrdDate & "," & strSpcCd & "," & strSpcNo & "," & strExamDate & "," & strPrsnId & "," & strColYN & "," & strColDate & "," & FRCTCD
...
'   2.접수번호 가져오기
    ...
    SetRawData "[접수번호가져오기A]" & strAcptNo
...
Private Sub EditRcvDataASTM()
    ...
    'SetRawData "[UBCL]" & UBound(varRcvBuf)
    
    varRcvBuf = Split(strRcvBuf, vbCr)
    
    SetRawData "[UBC]" & UBound(varRcvBuf)
    
    For intCnt = 0 To UBound(varRcvBuf)
        varRcvBuf(intCnt) = Replace(varRcvBuf(intCnt), vbLf, "")
        Select Case intCnt
        Case gSN
            SetRawData "[7]" & varRcvBuf(intCnt)
            If InStr(varRcvBuf(intCnt), "Patient ID") > 0 Then
                strBarNo = Trim(mGetP(varRcvBuf(intCnt), 2, ":"))
            ...
            SetRawData "[strBarNo]" & strBarNo
                ...
                ' 접수 Process
                If GetSLA1COLMT(strBarNo) = True Then
            ...
            End If
        Case 7 To gEN
            'Debug.Print intCnt & ">>" & varRcvBuf(intCnt)
            '10
            strIntBase = Trim(Mid(varRcvBuf(intCnt), 1, 9))
            strResult = Trim(Mid(varRcvBuf(intCnt), 10, 7))
            ...
            If strResult <> "" And Len(strIntBase) < 7 Then
               ...
               '    lsExamCode = Trim(RS.Fields(0).Value & "")
               '    lsExamName = Trim(RS.Fields(1).Value & "")
               '    lsSeqNo = Trim(RS.Fields(2).Value & "")
                    ...
                    For i = 0 To UBound(varORQN)
                        If lsExamCode = mGetP(varORQN(i), 1, ",") Then
                            SetText vasRes, mGetP(varORQN(i), 2, ","), lsResRow, colSUBCODE                '순번
                            Exit For
                        End If
                    Next
