    ...
    With frmInterface
        If Not RS.EOF = True And Not RS.BOF = True Then
            Do Until RS.EOF
                ...
                SetText .vasID, "1", asRow, colCHECKBOX
                SetText .vasID, Format(Trim(RS.Fields("bld_col_date")) & "", "yyyymmdd"), asRow, colHOSPDATE
                SetText .vasID, sBarcode, asRow, colBARCODE
                SetText .vasID, Trim(RS.Fields("acpno_1")) & "", asRow, colCHARTNO
                SetText .vasID, Trim(RS.Fields("pt_no")) & "", asRow, colPID
                SetText .vasID, Trim(RS.Fields("pt_name")) & "", asRow, colPNAME
