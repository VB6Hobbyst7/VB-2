...
Begin VB.Form frmInterface 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin FPSpread.vaSpread vasRes 
         ...
         RetainSelBlock  =   0   'False
         ScrollBars      =   2
         SpreadDesigner  =   "frmInterface.frx":202A
      End
   End
   ...
   Begin VB.Frame FrmHideControl 
      ...
      Begin VB.Frame Frame4 
         ...
         Begin FPSpread.vaSpread vasPrint 
            ...
            EndProperty
            MaxCols         =   9
            SpreadDesigner  =   "frmInterface.frx":36C4
         End
         Begin FPSpread.vaSpread vasPrintBuf 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            SpreadDesigner  =   "frmInterface.frx":3B77
         End
      End
      ...
      Begin FPSpread.vaSpread vasCode 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":3DE6
      End
      Begin FPSpread.vaSpread vasTemp1 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":4055
      End
         ...
         Begin MSComctlLib.ImageList imlStatus 
            ...
            BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
               ...
               BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":484E
                  Key             =   "RUN"
               EndProperty
               BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":4DE8
                  Key             =   "NOT"
               EndProperty
               BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":5382
                  Key             =   "STOP"
               EndProperty
               BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":591C
                  Key             =   "LST"
               EndProperty
               BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":61AE
                  Key             =   "ITM"
               EndProperty
               BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":6308
                  Key             =   "ERR"
               EndProperty
               BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":6462
                  Key             =   "NOF"
               EndProperty
            EndProperty
         End
      ...
      Begin FPSpread.vaSpread vasList 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":65BC
      End
      Begin FPSpread.vaSpread vasResTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":682B
      End
      Begin FPSpread.vaSpread vasTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":6A9A
      End
      Begin FPSpread.vaSpread vasExcel 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":6D09
      End
...
Private strPrsnId        As String
'Const VerifyID           As String = "101987"  ''' 대전진단검사의학 전문의
Dim FRCTCD As String
...
'    Dim strAllStr   As String
    ...
    Dim strFrctCd   As String
    
    Dim strErr      As String
    Dim strErrCD    As String
    Dim strErrNM    As String
    ...
    For lRow = 1 To vasID.DataRowCnt
        ...
        If vasID.Value = 1 Then
            ...
            'strChtNum = Trim(GetText(vasID, lRow, colCHARTNO))
            strExamDate = Trim(GetText(vasID, lRow, colEXAMDATE))
            strSaveSeq = Trim(GetText(vasID, lRow, colSAVESEQ))
            ...
            For iRow = 1 To vasTemp.DataRowCnt
                ...
                strExamSeq = Trim(GetText(vasTemp, iRow, 9))
                
                strUserId = Trim(GetText(vasTemp, iRow, 12)) 'in_userid
                strFrctCd = Trim(GetText(vasTemp, iRow, 13)) 'in_frctcd
                ...
                If sResult <> "" Then
                    ...
                    With cmdSQL
                        ...
                        Set prm1 = .CreateParameter("in_spcno", adVarChar, adParamInput, 20, lsID)
                        .Parameters.Append prm1
                        'MsgBox lsID
                        
                        Set prm2 = .CreateParameter("in_examcd", adVarChar, adParamInput, 20, strEqpCd)
                        .Parameters.Append prm2
                        'MsgBox strEqpCd
                        
                        Set prm3 = .CreateParameter("in_result", adVarChar, adParamInput, 100, sResult)
                        .Parameters.Append prm3
                        
                        'MsgBox sResult
                        
                        Set prm4 = .CreateParameter("in_userid", adVarChar, adParamInput, 100, strUserId)
                        .Parameters.Append prm4
                        'MsgBox strUserId
                        
                        Set prm5 = .CreateParameter("in_rflag", adVarChar, adParamInput, 50, "N")   'N -> D ; 검사자땜시
                        .Parameters.Append prm5
                        'MsgBox "N"
                        
                        Set prm6 = .CreateParameter("in_eqpcd", adVarChar, adParamInput, 100, gEquipCode)
                        .Parameters.Append prm6
                        'MsgBox gEquipCode
                        
                        Set prm7 = .CreateParameter("in_imgpath", adVarChar, adParamInput, 100, "")
                        .Parameters.Append prm7
                       ' MsgBox
                        
                        Set prm8 = .CreateParameter("io_acpno", adVarChar, adParamInputOutput, 10, 0)
                        .Parameters.Append prm8
                        'MsgBox
                        
                        Set prm9 = .CreateParameter("io_erryn", adVarChar, adParamInputOutput, 100, strErrCD)
                        .Parameters.Append prm9
                        
                        'MsgBox
                        Set prm10 = .CreateParameter("io_errmsg", adVarChar, adParamInputOutput, 100, strErrNM)
                        .Parameters.Append prm10
                        'MsgBox "10"
                        
                        ',2019-10-22 추가
'                        Set prm11 = .CreateParameter("in_rslt_add", adVarChar, adParamInput, 1, "1")
'                        .Parameters.Append prm11
                        
                        .Execute
                        
                        strRet = .Parameters("IO_ERRYN").Value & ""
                        If strRet = "" Then
                            '-- 저장성공
                            Set cmdSQL = Nothing
                            
                            strErr = "검사결과저장" & vbNewLine
                            strErr = strErr & "SP명 : PG_SLA_INTERFACEMGT.SP_SLA_INTERFACEMGT_U02" & vbNewLine
                            strErr = strErr & "in_spcno : " & lsID & vbNewLine
                            strErr = strErr & "in_examcd : " & strEqpCd & vbNewLine
                            strErr = strErr & "in_result : " & sResult & vbNewLine
                            strErr = strErr & "in_userid : " & strUserId & vbNewLine
                            strErr = strErr & "in_rflag : " & "N" & vbNewLine
                            strErr = strErr & "in_eqpcd : " & gEquipCode & vbNewLine
                            strErr = strErr & "in_imgpath : " & "" & vbNewLine
                            strErr = strErr & "io_acpno : " & "0" & vbNewLine
                            strErr = strErr & "io_erryn : " & strErrCD & vbNewLine
                            strErr = strErr & "io_errmsg : " & strErrNM & vbNewLine
                            strErr = strErr & "strRet : " & strRet & vbNewLine
                        
                            Call SetSQLData("저장성공1", strErr)
                        ...
                        Else
                            ...
                            Call SetSQLData("저장실패1", strErr)
                            
                            MsgBox "검사결과 저장오류 " & .Parameters("io_errmsg").Value, vbInformation + vbOKOnly
                            Set cmdSQL = Nothing
                            'strPrsnId = ""
                            Exit Sub
                        End If
                    ...
                    '-- 진료의 처방상태 변경 = SP_SLA_P_03_MAIN2
'                                                    IN_SPCNO        IN      VARCHAR2    --검체번호
'                                                  , in_frctcd       in      varchar2    --검사분류(exam_grpcd)
'                                                  , in_tstcd        in      varchar2    --검사코드(exam_cd)
'                                                  , in_wkuntcd      in      varchar2    --작업분류
'                                                  , in_rslt         in      varchar2    --검사결과**
'                                                  , in_stat         in      varchar2    --싱태??
'                                                  , in_ptno         in      varchar2    --환자번호
'                                                  , in_remk         in      varchar2    --remark
'                                                  , in_qcremk       in      varchar2    --정도관리비고
'                                                  , in_delta        in      varchar2
'                                                  , in_panic        in      varchar2
'                                                  , in_userid       in      varchar2    --입력자ID
...
'                                                  , io_errmsg
                    ...
                    With cmdSQL
                        .CommandTimeout = 15
                        .CommandText = "SP_SLA_P_03_MAIN2"
                        .CommandType = adCmdStoredProc
                        
                        Set prm1 = .CreateParameter("in_spcno", adVarChar, adParamInput, 20, lsID)
                        .Parameters.Append prm1
                        Set prm2 = .CreateParameter("in_frctcd", adVarChar, adParamInput, 20, strFrctCd)
                        .Parameters.Append prm2
                        Set prm3 = .CreateParameter("in_tstcd", adVarChar, adParamInput, 100, strEqpCd)
                        .Parameters.Append prm3
                        Set prm4 = .CreateParameter("in_wkuntcd", adVarChar, adParamInput, 100, "")
                        .Parameters.Append prm4
                        Set prm5 = .CreateParameter("in_rslt", adVarChar, adParamInput, 50, sResult)
                        .Parameters.Append prm5
                        Set prm6 = .CreateParameter("in_stat", adVarChar, adParamInput, 100, "D")
                        .Parameters.Append prm6
                        Set prm7 = .CreateParameter("in_ptno", adVarChar, adParamInput, 100, lsPid)
                        .Parameters.Append prm7
                        Set prm8 = .CreateParameter("in_remk", adVarChar, adParamInput, 10, "")
                        .Parameters.Append prm8
                        Set prm9 = .CreateParameter("in_qcremk", adVarChar, adParamInput, 10, "")
                        .Parameters.Append prm9
                        Set prm10 = .CreateParameter("in_delta", adVarChar, adParamInput, 10, "")
                        .Parameters.Append prm10
                        Set prm11 = .CreateParameter("in_panic", adVarChar, adParamInput, 10, "")
                        .Parameters.Append prm11
                        Set prm12 = .CreateParameter("in_userid", adVarChar, adParamInput, 10, strUserId)
                        .Parameters.Append prm12
                        Set prm13 = .CreateParameter("io_erryn", adVarChar, adParamInputOutput, 100, strErrCD)
                        .Parameters.Append prm13
                        Set prm14 = .CreateParameter("io_errmsg", adVarChar, adParamInputOutput, 100, strErrNM)
                        .Parameters.Append prm14
                        
                        ',2019-10-22 추가
                        Set prm15 = .CreateParameter("in_rslt_add", adVarChar, adParamInput, 1, "1")
                        ...
                        If strRet = "" Then
                            ...
                            strErr = "진료의 처방상태 변경" & vbNewLine
                            strErr = strErr & "SP명 : SP_SLA_P_03_MAIN2" & vbNewLine
                            strErr = strErr & "in_spcno : " & lsID & vbNewLine
                            strErr = strErr & "in_frctcd : " & strFrctCd & vbNewLine
                            strErr = strErr & "in_tstcd : " & strEqpCd & vbNewLine
                            strErr = strErr & "in_wkuntcd : " & vbNewLine
                            strErr = strErr & "in_rslt : " & sResult & vbNewLine
                            strErr = strErr & "in_stat : " & "D" & vbNewLine
                            strErr = strErr & "in_ptno : " & lsPid & vbNewLine
                            strErr = strErr & "in_remk : " & "" & vbNewLine
                            strErr = strErr & "in_qcremk : " & "" & vbNewLine
                            strErr = strErr & "in_delta : " & "" & vbNewLine
                            strErr = strErr & "in_panic : " & "" & vbNewLine
                            strErr = strErr & "in_userid : " & strUserId & vbNewLine
                            strErr = strErr & "io_erryn : " & strErrCD & vbNewLine
                            strErr = strErr & "io_errmsg : " & strErrNM & vbNewLine
                            strErr = strErr & "strRet : " & strRet & vbNewLine
                            
                            Call SetSQLData("저장성공2", strErr)
                        Else
                            '-- 저장실패
                            strErr = "진료의 처방상태 변경" & vbNewLine
                            strErr = strErr & "SP명 : SP_SLA_P_03_MAIN2" & vbNewLine
                            ...
                            Call SetSQLData("저장실패2", strErr)
                            
                            MsgBox "처방상태 변경오류 " & .Parameters("io_errmsg").Value, vbInformation + vbOKOnly
                            Set cmdSQL = Nothing
                            'strPrsnId = ""
                            Exit Sub
                        End If
                    ...
                    '-- 검사결과 검증 = SP_SLA_UPDATE_STATUS2
'                                                        IN_SPCNO         IN     VARCHAR2
'                                                        , in_status      in      varchar2
'                                                        , in_rptprsnid   in      varchar2
'                                                        , io_erryn       in out  varchar2
'                                                        , io_errmsg      in out  varchar2
                    ...
                    With cmdSQL
                        .CommandTimeout = 15
                        .CommandText = "SP_SLA_UPDATE_STATUS2"
                        .CommandType = adCmdStoredProc
                        
                        Set prm1 = .CreateParameter("in_spcno", adVarChar, adParamInput, 20, lsID)
                        .Parameters.Append prm1
                        Set prm2 = .CreateParameter("in_status", adVarChar, adParamInput, 11, "N")
                        .Parameters.Append prm2
                        Set prm3 = .CreateParameter("in_rptprsnid", adVarChar, adParamInput, 100, gVerifyID)
                        .Parameters.Append prm3
                        Set prm4 = .CreateParameter("io_erryn", adVarChar, adParamInputOutput, 100, strErrCD)
                        .Parameters.Append prm4
                        Set prm5 = .CreateParameter("io_errmsg", adVarChar, adParamInputOutput, 100, strErrNM)
                        .Parameters.Append prm5
                        
                        ',2019-10-22 추가
'                        Set prm6 = .CreateParameter("in_rslt_add", adVarChar, adParamInput, 1, "1")
'                        .Parameters.Append prm6
                        ...
                        If strRet = "" Then
                            ...
                            strErr = "검사결과 검증" & vbNewLine
                            strErr = strErr & "SP명 : SP_SLA_UPDATE_STATUS2" & vbNewLine
                            strErr = strErr & "in_spcno : " & lsID & vbNewLine
                            strErr = strErr & "in_status : " & "N" & vbNewLine
                            strErr = strErr & "in_rptprsnid : " & gVerifyID & vbNewLine
                            strErr = strErr & "io_erryn : " & strErrCD & vbNewLine
                            strErr = strErr & "io_errmsg : " & strErrNM & vbNewLine
                            strErr = strErr & "strRet : " & strRet & vbNewLine
                            
                            Call SetSQLData("저장성공3", strErr)
                        Else
                            '-- 저장실패
                            strErr = "검사결과 검증" & vbNewLine
                            strErr = strErr & "SP명 : SP_SLA_UPDATE_STATUS2" & vbNewLine
                            ...
                            Call SetSQLData("저장실패3", strErr)
                            
                            MsgBox "검사결과 검증 오류 " & .Parameters("io_errmsg").Value, vbInformation + vbOKOnly
                            Set cmdSQL = Nothing
                            'strPrsnId = ""
                            Exit Sub
                        End If
...
Private Sub cmdRsltSearch_Click()
    ...
    vasRes.MaxRows = 0
          ...
          SQL = " SELECT '', SAVESEQ, MID(EXAMDATE,1,8) AS EXAMDATE, HOSPDATE AS 접수일자, BARCODE AS 바코드번호, PID AS 차트번호, PID AS 내원번호, PNAME AS 이름,PSEX AS 성별, PAGE AS 나이, DISKNO, POSNO, EXAMCODE, RESULT, REFFLAG, SENDFLAG,INOUT " & vbCrLf
    SQL = SQL & "   FROM PATRESULT " & vbCrLf
...
Private Sub cmdSL_Click()
    If cmdSL.Caption = "▶" Then
        cmdSL.Caption = "◀"
        vasID.Width = Frame1.Width - 200 'vasRes.Left - 100 ' 18285 '18075 '15225
    Else
        cmdSL.Caption = "▶"
        vasID.Width = vasRes.Left - 200 '11535 '11355 '8475
    End If
...
'    End If
    ...
    For i = 1 To 1
        If Not Connect_DRServer Then
            MsgBox "EDM Server No Connection"
    ...
    For i = 1 To 1
        If Not Connect_PRServer Then
            MsgBox "Hospital Server No Connection"
            cn_Server_Flag = False
            Exit Sub
        Else
            cn_Server_Flag = True
...
Private Sub tmrResult_Timer()
    ...
    Dim strCSO2     As String
    Dim strcHgb     As String
    Dim strpO2      As String
    
    Dim strAcpDate  As String
    ...
    If txtTimer.Text = "0" Then
        ...
        SQL = ""
        SQL = SQL & "Select M.TEST_ID, M.PatientOrLotID, CONVERT(CHAR(19), M.TESTDT, 20) AS EDTM, M.EDMUploadDT, M.OperatorID, M.HostSerialNumber, M.HostAlias, S.LISStatus, S.SendResultMessage " & vbNewLine
        ...
        End If
        'SQL = SQL & "   And M.PatientOrLotID = '" + BARCODE + "' "
        ...
        If Not RSH.EOF = True And Not RSH.BOF = True Then
            ...
            Do Until RSH.EOF
                ...
                pBarNo = Trim(RSH.Fields("PatientOrLotID")) & ""
                'pBarNo = pPtID
                
                strChartID = Trim(RSH.Fields("PatientOrLotID")) & ""
                strQCID = ""
                
                '-- 2017.01.03 수정 QC 번호 체계 변경됨 ---------------------
                'AS-IS :    179-3-B622
                'TO-BE : L1:179-3-B622
...
'''                If Len(strChartID) = 13 And InStr(strChartID, "-") > 0 Then
...
'''                End If
                ...
                '-- 챠트번호로 바코드번호 찾아오기
                'SQL = "SELECT MEGADB1.F_LAB_HOSPNO_SAMPLE_CHANGE('" & Format(strChartID, "000000000") & "','" & Format(strEDTM, "yyyymmdd") & "','75','7S','" & strSpcCd & "') FROM DUAL "
                'Call SetSQLData("바코드찾기", SQL)

'                Res = GetDBSelectColumn(gServer, SQL)
'                If gReadBuf(0) <> "" Then
'                    pBarNo = Trim(gReadBuf(0))
'                Else
'                    If strQCID = "" Then
''                        pBarNo = strChartID
'                        pBarNo = "오더없음" & strMaxSeq
'                    Else
'                        pBarNo = strQCID
'
'                        SetText vasID, Format(strEDTM, "yyyymmdd"), vasID.MaxRows, colHOSPDATE
'                        SetText vasID, "QC", vasID.MaxRows, colCHARTNO
'
'                    End If
'                End If
                ...
                If Len(pBarNo) >= 11 And IsNumeric(pBarNo) Then
                    
                    If GetSLA1COLMT(pBarNo) = True Then
                        'Call SetPatInfo(strBarNo)
                        Call GetSampleInfoW_SLALAB(intRow)
                        
                        strState = "R"
                    End If
                    
                    '-- 검사자 정보 서버테이블에서 가져와 표시
                    'Call GetSampleInfoW_MEDINOL(intRow)
                    'Call GetSampleInfoW_SLALAB(intRow)
               ...
               If Not RSD.EOF = True And Not RSD.BOF = True Then
                    Do Until RSD.EOF
                        ...
                        If strIntBase = "CSO2" Then
                            strCSO2 = strResult
                        End If
                        
                        If strIntBase = "cHgb" Then
                            strcHgb = strResult
                        End If
                        
                        If strIntBase = "pO2" Then
                            strpO2 = strResult
                        End If
                    ...
                    '-- O2CT 저장
                    If strCSO2 <> "" And strcHgb <> "" And strpO2 <> "" And IsNumeric(strCSO2) And IsNumeric(strcHgb) And IsNumeric(strpO2) Then
                        strIntBase = "O2CT"
                        
                        strResult = CCur(strCSO2) * 1.39 * CCur(strcHgb) + 0.00314 * CCur(strpO2)
                        strComm = ""
...
'''                        '부산보훈병원
'''                        '
'''                        'select acp_date FROM SLA1COLMT
'''                        ' where spc_no = '" & SpcNo & "'"
'''                        ' ==> 없을 경우  acp_date EPOC 검사일자로 업데이트 함
'''                        '
'''
'''                        ' 접수일자 조회
'''                        '
'''                                 strSql = " Select acp_date "
'''                        strSql = strSql & "   From SLA1COLMT "
'''                        strSql = strSql & "  Where spc_no = '" & pBarNo & "'"
'''
'''                        'Call SetSQLData("처방의", strSql)
'''
'''                        RS.CursorLocation = adUseClient
'''                        RS.Open strSql, cn_Ser
'''                        If RS.EOF = False Then
'''                            Do While Not RS.EOF
'''                                strAcpDate = RS.Fields("acp_date") '
'''                                RS.MoveNext
'''                            Loop
'''                        End If
'''
...
'''                            ' LIS 접수일자 업데이트
'''                            SQL = ""
'''                            SQL = SQL & "UPDATE SLA1COLMT SET acp_date = '" & strEDTM & "'"
'''                            SQL = SQL & " WHERE spc_no = '" & pPtID & "'"
'''
    ...
    ElseIf KeyCode = vbKeyReturn Then
        If iCol = colBARCODE Then
            ...
            'If lsID <> lblBarcode(0).Caption Then
                ...
                SQL = SQL & ",DISKNO = '" & strPrsnId & "' " & vbCrLf
                SQL = SQL & ",POSNO = '" & FRCTCD & "' " & vbCrLf
...
' 검체접수
'
Private Function GetSLA1COLMT(SpcNo As String) As Boolean
    ...
    Dim strAcptNo        As Variant
    Dim strExamDate      As String
'    Dim strPrsnId        As String
    Dim strColYN         As String
...
On Error GoTo Rst:
    ...
    ' 처방의 조회
    '
             strSql = " Select Work_prsnid "
    strSql = strSql & "   From modeexamst "
    strSql = strSql & "  Where spc_no = '" & SpcNo & "'"
    ...
    If RS.EOF = False Then
        Do While Not RS.EOF
            strPrsnId = RS.Fields("Work_prsnid") '
            RS.MoveNext
        Loop
    End If
    ...
    ' 접수번호 조회
             strSql = "SELECT pt_no, ord_date, spc_cd_1, bld_col_prsnid, spc_no, exam_date, BLD_COL_PRSNID, BLD_COL_YN, EXAM_GRPCD,BLD_COL_DATE "
    strSql = strSql + "  FROM SLA1COLMT                "
    strSql = strSql + " WHERE spc_no = '" & SpcNo & "' "
    
    Call SetSQLData("접수번호", strSql)
    
    RS.CursorLocation = adUseClient
    RS.Open strSql, cn_Ser
    If RS.EOF = False Then
        Do While Not RS.EOF
            strPtNo = RS.Fields("pt_no") & ""
            strOrdDate = RS.Fields("ord_date") & ""
            strSpcCd = RS.Fields("spc_cd_1") & ""
            strSpcNo = RS.Fields("spc_no") & ""
            strExamDate = RS.Fields("exam_date") & ""
            strPrsnId = RS.Fields("BLD_COL_PRSNID") & ""
            strColYN = RS.Fields("BLD_COL_YN") & ""
            strColDate = RS.Fields("BLD_COL_DATE") & ""
            FRCTCD = RS.Fields("EXAM_GRPCD") & ""
            RS.MoveNext
        Loop
    End If
 ...
 '  1.채혈확인
    If strColYN = "N" Then
        strAcptNo = GetACPT_YN(strSpcNo, strPrsnId, strColDate)
        Call SetSQLData("채혈확인", strAcptNo)
    End If
    
'   2.접수번호 가져오기
    strAcptNo = GetACPT_NO(strSpcNo, strOrdDate)
    Call SetSQLData("접수번호2", strAcptNo)
       
'   3.검체접수
    If strSpcNo <> "" Then
        If SetACPT_Lab_ACP(strSpcNo, strPtNo, strOrdDate, strSpcCd, strPrsnId, strAcptNo) = True Then
            '-- 성공
            GetSLA1COLMT = True
        Else
            '-- 실패
...
' 채혈확인
'
Private Function GetACPT_YN(ByVal SpcNo As Variant, ByVal IN_Bld_Prsnid As String, ByVal in_bld_date As String) As String
    Dim prm1 As New ADODB.Parameter
    Dim prm2 As New ADODB.Parameter
    Dim prm3 As New ADODB.Parameter
    Dim strRet          As String
    Dim strAcpNo        As String
    ...
    strTestDate = Format(in_bld_date, "YYYY-MM-DD")
    
'    procedure SP_SLA_SamAcp_U01 ( in_spc_no         in  varchar2
'                                , in_bld_date       in  varchar2
'                                , in_bld_prsnid     in  varchar2)
    
    With cmdSQL
        .CommandTimeout = 15
        .CommandText = "PG_SLA_SpecimenOrderAccept.SP_SLA_SamAcp_U01"
        .CommandType = adCmdStoredProc
        
        Set prm1 = .CreateParameter("in_spc_no", adVarChar, adParamInput, 11, SpcNo)                    '검체번호 ex)10032633492
        .Parameters.Append prm1
        Set prm2 = .CreateParameter("in_bld_date", adVarChar, adParamInput, 30, strTestDate)            '채혈일자 ex)2004-10-01
        .Parameters.Append prm2
        Set prm3 = .CreateParameter("in_bld_prsnid", adVarChar, adParamInput, 10, IN_Bld_Prsnid)        '채혈자
        .Parameters.Append prm3
...
' 검체접수
'
Private Function GetACPT_NO(ByVal SpcNo As Variant, ByVal IN_TESTDATE As String) As String
    Dim prm1 As New ADODB.Parameter
    Dim prm2 As New ADODB.Parameter
    Dim prm3 As New ADODB.Parameter
    Dim prm4 As New ADODB.Parameter
    ...
    'strTestDate = Format(Now, "YYYY-MM-DD")
    
    With cmdSQL
        .CommandTimeout = 15
        .CommandText = "SP_SLA_P_02_RANGE"
        .CommandType = adCmdStoredProc
        
        Set prm1 = .CreateParameter("in_spcno", adVarChar, adParamInput, 11, SpcNo)        '검체번호 ex)10032633492
        .Parameters.Append prm1
        Set prm2 = .CreateParameter("in_tstdte", adVarChar, adParamInput, 10, IN_TESTDATE) '검사일자 ex)2004-10-01
        .Parameters.Append prm2
        Set prm3 = .CreateParameter("in_hspcl", adVarChar, adParamInput, 100, "")          'X SP_SLA_P_02_RANGE 프로시저에서 사용 안됨
        .Parameters.Append prm3
        Set prm4 = .CreateParameter("in_frct_cd", adVarChar, adParamInput, 10, FRCTCD)      'SLIP CD ex)L80
        .Parameters.Append prm4
        Set prm5 = .CreateParameter("in_micro", adVarChar, adParamInput, 50, "D")          '마이크로 검사?? ex) 'Y'
        .Parameters.Append prm5
        Set prm6 = .CreateParameter("io_acpno", adNumeric, adParamOutput, 22, 0)           'SLAXWORKT.acpno_반환 ex)36
        .Parameters.Append prm6
        Set prm7 = .CreateParameter("io_erryn", adVarChar, adParamInputOutput, 10, 0)
        .Parameters.Append prm7
        Set prm8 = .CreateParameter("io_errmsg", adVarChar, adParamInputOutput, 100, 0)
        .Parameters.Append prm8
        
        .Execute
        
        strAcptNo = .Parameters("io_acpno").Value & ""
        strRet = .Parameters("IO_ERRYN").Value
        If strRet = "0" Then
            GetACPT_NO = strAcptNo
        Else
            '이미 접수된 검체??
            GetACPT_NO = ""
            'Debug.Print .Parameters("io_errmsg").Value
            Set cmdSQL = Nothing
            Exit Function
        End If
    End With
...
' 검체접수
'
Private Function SetACPT_Lab_ACP(ByVal IN_SPCNO As String, ByVal IN_PTNO As String, ByVal IN_TESTDATE As String, _
                                 ByVal IN_SPCCD As String, ByVal IN_PRSNID As String, ByVal IN_ACPTNO As Variant) As Boolean
...
'CREATE OR REPLACE PROCEDURE  KVSUP.SP_SLA_P_02_ACPT_CP ( IN_SPCNO  IN   VARCHAR2
'                                           , in_tstdte       in          varchar2
'                                           , in_hspcl        in          varchar2
'                                           , in_frct_cd      in          varchar2
'                                           , in_spccd        in          varchar2
'                                           , in_ptno         in          varchar2
'                                           , in_time         in          varchar2
'                                           , in_vol          in          varchar2
'                                           , in_userid       in          varchar2
'                                           , in_micro        in          varchar2
'                                           , in_remk         in          varchar2
'                                           , in_acptnoyn     in          varchar2
'                                           , in_acptno       in          number
'                                           , io_erryn        in out      varchar2
'                                           , io_errmsg       in out      varchar2 )
    ...
    cmdSQL.CommandText = "SP_SLA_P_02_ACPT_CP"
    cmdSQL.CommandType = adCmdStoredProc
                                                       
    Set prm1 = cmdSQL.CreateParameter("in_spcno", adVarChar, adParamInput, 11, IN_SPCNO)            '검체번호 ex)04000003313
    cmdSQL.Parameters.Append prm1
    Set prm2 = cmdSQL.CreateParameter("in_tstdte", adVarChar, adParamInput, 10, IN_TESTDATE)        '검사일자 ex)2004-10-01
    cmdSQL.Parameters.Append prm2
    Set prm3 = cmdSQL.CreateParameter("in_hspcl", adVarChar, adParamInput, 10, "")                   'X SP_SLA_P_02_RANGE 프로시저에서 사용 안됨
    cmdSQL.Parameters.Append prm3
    Set prm4 = cmdSQL.CreateParameter("in_frct_cd", adVarChar, adParamInput, 10, FRCTCD)      'SLIP CD ex)L80
    cmdSQL.Parameters.Append prm4
    Set prm5 = cmdSQL.CreateParameter("in_spccd", adVarChar, adParamInput, 10, IN_SPCCD)    'X
    cmdSQL.Parameters.Append prm5
    Set prm6 = cmdSQL.CreateParameter("in_ptno", adVarChar, adParamInput, 11, IN_PTNO)
    cmdSQL.Parameters.Append prm6
    Set prm7 = cmdSQL.CreateParameter("in_time", adVarChar, adParamInput, 10, "24")
    cmdSQL.Parameters.Append prm7
    Set prm8 = cmdSQL.CreateParameter("in_vol", adVarChar, adParamInput, 10, "0")
    cmdSQL.Parameters.Append prm8
    Set prm9 = cmdSQL.CreateParameter("in_userid", adVarChar, adParamInput, 10, IN_PRSNID) '102237
    cmdSQL.Parameters.Append prm9
    Set prm10 = cmdSQL.CreateParameter("in_micro", adVarChar, adParamInput, 10, "") 'X
    cmdSQL.Parameters.Append prm10
    Set prm11 = cmdSQL.CreateParameter("in_remk", adVarChar, adParamInput, 100, "")
    cmdSQL.Parameters.Append prm11
    Set prm12 = cmdSQL.CreateParameter("in_acptnoyn", adVarChar, adParamInput, 1, "Y")    '오더변경 ?? ex) 'Y'
    cmdSQL.Parameters.Append prm12
    Set prm13 = cmdSQL.CreateParameter("in_acptno", adVarChar, adParamInput, 20, IN_ACPTNO)
    cmdSQL.Parameters.Append prm13
    Set prm14 = cmdSQL.CreateParameter("io_erryn", adVarChar, adParamInputOutput, 10, 0)
    cmdSQL.Parameters.Append prm14
    Set prm15 = cmdSQL.CreateParameter("io_errmsg", adVarChar, adParamInputOutput, 100, 0)
    cmdSQL.Parameters.Append prm15
    
    Set RS = New ADODB.Recordset
    cmdSQL.Execute
    
    strRet = cmdSQL.Parameters("IO_ERRYN").Value
    If strRet = "0" Then
        SetACPT_Lab_ACP = True
    Else
        'If chkACCEPT.Value = "1" Then
            '이미 접수된 검체??
            SetACPT_Lab_ACP = False
            'MsgBox "환자번호 """ & IN_PTNO & """ 는" & vbNewLine & cmdSQL.Parameters("io_errmsg").Value, vbInformation + vbOKOnly
            Set cmdSQL = Nothing
            Exit Function
        'Else
        '    SetACPT_Lab_ACP = True
