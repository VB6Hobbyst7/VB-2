   ...
   Begin TabDlg.SSTab stInterface 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin FPSpread.vaSpread vasWorkList 
            ...
            RetainSelBlock  =   0   'False
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":B7B1
            UserResize      =   2
         End
         ...
         Begin VB.ComboBox cboChk 
            ...
            EndProperty
            Height          =   300
            ItemData        =   "frmInterface.frx":C2C4
            Left            =   2340
            List            =   "frmInterface.frx":C2CE
            TabIndex        =   45
            Top             =   -90
            Visible         =   0   'False
            Width           =   765
         ...
         Begin FPSpread.vaSpread vasID 
            ...
            RetainSelBlock  =   0   'False
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":C2DE
            UserResize      =   2
         End
         Begin FPSpread.vaSpread vasRes 
            ...
            RetainSelBlock  =   0   'False
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":CDFE
         End
...
'    gSql = "SELECT SUBSTR(GUMSA013.G13_GMLABNO + 10000,2,4) LABNO " _
    ...
    'SQL = SQL & "   AND GUMSA013.G13_HELGBN LIKE '3'  " & vbCr
    '-- 보고여부(부분통보B,전체통보Y)
...
Private Sub EditRcvDataASTM()
   ...
   ' On Error Resume Next
    ...
    For intCnt = 3 To UBound(fLCURO)
        strTemp1 = fLCURO(intCnt)
                
        strType = Trim(Mid$(strTemp1, 1, 3))
        
'        vasWorkList.MaxRows = 1
'        vasWorkList.SetText colSeqNo, 1, "64"
'        vasWorkList.SetText colBarcode, 1, "1212121"
        ...
        Select Case strType
            ...
            Case "BLD", "BIL", "URO", "KET", "PRO", "NIT", "GLU", "pH", "S.G", "LEU"
                strIntBase = Mid(strTemp1, 1, 4)
                strIntBase = Trim(strIntBase)
