...
Begin VB.Form frmMain 
   ...
   Begin VB.Frame fraHidden 
      ...
      Begin FPSpread.vaSpread spdOrder_PRT 
         ...
         SpreadDesigner  =   "frmMain.frx":000C
         ScrollBarTrack  =   3
         ShowScrollTips  =   3
      End
   ...
   Begin VB.PictureBox picComm 
      ...
      Begin FPSpread.vaSpread spdExcel 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmMain.frx":1F16
      End
   ...
   Begin FPSpread.vaSpread spdResult 
      ...
      ScrollBarExtMode=   -1  'True
      ShadowColor     =   16777215
      SpreadDesigner  =   "frmMain.frx":2147
      ScrollBarTrack  =   3
      ShowScrollTips  =   3
   End
      ...
      Begin MSComctlLib.ImageList imlStatus 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMain.frx":333C
               Key             =   "NOT"
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMain.frx":38D6
               Key             =   "STOP"
            EndProperty
            ...
            BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMain.frx":485C
               Key             =   "ERR"
            EndProperty
            BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMain.frx":49B6
               Key             =   "NOF"
            EndProperty
   ...
   Begin FPSpread.vaSpread spdWork 
      ...
      ScrollBarExtMode=   -1  'True
      ShadowColor     =   16777215
      SpreadDesigner  =   "frmMain.frx":82D4
      ScrollBarTrack  =   3
      ShowScrollTips  =   3
   End
   Begin FPSpread.vaSpread spdOrder 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   16777215
      SpreadDesigner  =   "frmMain.frx":A50D
      ScrollBarTrack  =   3
      ShowScrollTips  =   3
   End
...
On Error GoTo ErrRoutine
    ...
    Call FileRcvData_CFX96_SD
    
'    If optTest(0).Value = True Then
'        Call FileRcvData_CFX96_SG
'    ElseIf optTest(1).Value = True Then
'        Call FileRcvData_CFX96_RV16
'    ElseIf optTest(2).Value = True Then
'        Call FileRcvData_CFX96_RP5
'    End If
        ...
        With spdOrder
            If optTest(0).Value = True Then
                ...
                For lRow = 1 To .DataRowCnt
                    ...
                    .Col = colCHECKBOX
                    If .Value = 1 Then
                        For lCol = colSTATE + 4 To .MaxCols
                            If GetText(spdOrder, lRow, lCol) <> "Negative" And GetText(spdOrder, lRow, lCol) <> "" Then
                                strAbResult = strAbResult & GetText(spdOrder, lRow, lCol) & vbCrLf
                            End If
                        Next

                        'If GetText(spdOrder, lRow, spdOrder.MaxCols) <> "" Then
                        '    If GetText(spdOrder, lRow, spdOrder.MaxCols) <> "Negative" And GetText(spdOrder, lRow, spdOrder.MaxCols) <> "" Then
                        '        strAbResult = strAbResult & GetText(spdOrder, lRow, spdOrder.MaxCols) & vbCrLf
                        '    End If
                        'Else
                        '    If GetText(spdOrder, lRow, spdOrder.MaxCols - 1) <> "Negative" And GetText(spdOrder, lRow, spdOrder.MaxCols - 1) <> "" Then
                        '        strAbResult = strAbResult & GetText(spdOrder, lRow, spdOrder.MaxCols - 1) & vbCrLf
                        '    End If
                        'End If
                    End If
                Next
            ...
            If strAbResult <> "" Then
                If MsgBox("이상결과가 있습니다." & vbCrLf & strAbResult & vbCrLf & "저장하시겠습니까?", vbCritical + vbYesNo, Me.Caption) = vbNo Then
                    Exit Sub
                End If
            End If
...
'On Error GoTo ErrHandle
    ...
    With frmMain
        For intRow = 2 To spdExcel.MaxRows
            strWell = GetText(spdExcel, intRow, 2)
            intSmpNo = 0
            intIntNo = 0
            intRstNo = 0
            For intCol = 1 To spdExcel.MaxCols
                ...
                If UCase(GetText(spdExcel, 1, intCol)) = "TARGET" Then
                    intIntNo = intCol
                End If
                If UCase(GetText(spdExcel, 1, intCol)) = "FLUOR" Then
                    intIntNo = intCol
                End If
                If UCase(GetText(spdExcel, 1, intCol)) = "WELL" Then
                    intWellNo = intCol
                End If
                If UCase(GetText(spdExcel, 1, intCol)) = "C(T)" Then
                    intRstNo = intCol
                End If
                If UCase(GetText(spdExcel, 1, intCol)) = "CQ" Then
                    intRstNo = intCol
            ...
            If Trim(strBarno) <> Trim(strOldBarno) Then
                ...
                If blnSame1 = False Then
                    ...
                    With mResult
                        '.BarNo = strBarno
                        .Seq = strBarno
                        .RackNo = Mid(strWell, 1, 1)
                        .TubePos = Mid(strWell, 2)
                        .RsltDate = Format(Now, "yyyy-mm-dd")
                        .RsltTime = Format(Now, "hh:mm:ss")
                        .RsltSeq = getMaxTestNum(Format(Now, "yyyy-mm-dd"))
                    End With
            ...
            intRCnt = intRCnt + 1
            strIntBase = GetText(spdExcel, intRow, intIntNo)
            If UCase(strIntBase) = "CY5" Or UCase(strIntBase) = "ICA" Then
                strIntBase = "ICA"
            ElseIf UCase(strIntBase) = "FAM" Or UCase(strIntBase) = "RDRP" Then
                strIntBase = "RdRP"
            ElseIf UCase(strIntBase) = "HEX" Or UCase(strIntBase) = "E" Then
                strIntBase = "E"
            End If
            
            strResult = GetText(spdExcel, intRow, intRstNo)
            If strIntBase = "E" Or strIntBase = "RdRP" Then
                If strResult = "" Then
                    strResult = "N/A"
                End If
            End If
            ...
            For J = 1 To spdOrder.MaxRows
                spdOrder.Row = J
                spdOrder.Col = colRACKNO
                If GetText(spdOrder, J, colRACKNO) = mResult.RackNo And GetText(spdOrder, J, colPOSNO) = mResult.TubePos Then
                    If blnPosData = True Or GetText(spdOrder, J, colSTATE) = "" Then
                        strBarno = GetText(spdOrder, J, colBARCODE)
                        '-- 결과정보
                        With mResult
                            .BarNo = strTmp
                            .Seq = strBarno
                        ...
                        '-- 결과환자정보
                        'Call SetPatInfo(strBarno, gHOSP.RSTTYPE, J)
...
'       CASE                RdRp (FAM) Ct   E (HEX) Ct  IC (CY5) Ct     RESULT      Comment
'       CASE 01             ≤36            ≤36        No_Requirements Positive
'       CASE 02             N/A, >36        N/A, >36    ≤32            Negative
'       CASE 03             ≤36            N/A, >36    ≤32            Inconclusive    Near or below the LoD - Retest
'       CASE 04             N/A, >36        ≤36        ≤32            Inconclusive    Sarbecovirus Positive / Near or below the LoD - Retest
'       CASE 05             N/A, >36        N/A, >36    N/A, >32        Invalid Retest
'       CASE 06             ≤36            N/A, >36    N/A, >32        Invalid Retest
'       CASE 07             N/A, >36        ≤36        N/A, >32        Invalid Retest
'       NC                  N/A, >36        N/A, >36    ≤32            Valid
'       PC                  ≤36            ≤36        ≤32            Valid
        ...
        For intRow = 1 To spdOrder.MaxRows
            ...
            Call GetSampleInfo_KHNMC(intRow, spdOrder)
            ...
            strIntBase = "COVID19"
            strResult = ""
            If mResult.Seq = "NC" Then
                strResult = "Negative Control(-)"
            ElseIf mResult.Seq = "PC" Then
                strResult = "Positive Control(+)"
            Else
                'Sample 01          ≤36            ≤36        기준 X      Positive
                If strResult = "" Then
                    If strRdRP <> "" And IsNumeric(strRdRP) Then
                ...
                'Sample 03          ≤36            N/A, >36    ≤32        Inconclusive
                If strResult = "" Then
                    If strRdRP <> "" And IsNumeric(strRdRP) Then
                        If CCur(strRdRP) <= 36 Then
                            strRdRP_NP = "Inconclusive"
                        End If
                    End If
                    
                    If strEVal <> "" And IsNumeric(strEVal) Then
                        If CCur(strEVal) > 36 Then
                            strEVal_NP = "Inconclusive"
                        End If
                    Else
                        strEVal_NP = "Inconclusive"
                    End If
                    ...
                    If strICA <> "" And IsNumeric(strICA) Then
                        If CCur(strICA) <= 32 Then
                            strICA_NP = "Inconclusive"
                        End If
                    End If
                    
                    If strRdRP_NP = "Inconclusive" And strEVal_NP = "Inconclusive" And strICA_NP = "Inconclusive" Then
                        'strResult = "Inconclusive"
                        strResult = "Inconclusive Result"
                    End If
                End If
                ...
                'Sample 04          N/A, >36        ≤36        ≤32        Inconclusive   Retest
                If strResult = "" Then
                    If strRdRP <> "" And IsNumeric(strRdRP) Then
                        If CCur(strRdRP) > 36 Then
                            strRdRP_NP = "Inconclusive"
                ...
                'CASE 06             ≤36            N/A, >36    N/A, >32        Invalid
                If strResult = "" Then
                    If strRdRP <> "" And IsNumeric(strRdRP) Then
                        If CCur(strRdRP) <= 36 Then
                            strRdRP_NP = "Invalid"
                ...
                'CASE 07             N/A, >36        ≤36        N/A, >32        Invalid
                If strResult = "" Then
                    If strRdRP <> "" And IsNumeric(strRdRP) Then
                        If CCur(strRdRP) > 36 Then
                            strRdRP_NP = "Invalid"
        ...
        ElseIf Index = 1 Then
            For i = colSTATE + 1 To .MaxCols
                ...
                If Len(GetText(spdOrder, 0, i)) > 3 Then
                    ...
                    If UCase(GetText(spdOrder, 0, i)) = "COVID-19" Then
                        .ColHidden = True
                    Else
                        .ColHidden = False
                    End If
...
'    End If
    ...
    For i = 2 To spdExcel.MaxRows
        If txtBarcode.Text = GetText(spdExcel, i, 6) Then
            spdExcel.Row = i
            spdExcel.Row2 = i
            spdExcel.Col = 2
            spdExcel.Col2 = 7
            spdExcel.BlockMode = True
            spdExcel.BackColor = vbYellow
            spdExcel.BlockMode = False
        Else
            spdExcel.Row = i
            spdExcel.Row2 = i
            spdExcel.Col = 2
