...
'sRecData = sRecData & "               <kornm>서유리B</kornm>" & vbCrLf
...
'sRecData = sRecData & "               <kornm>서유리B</kornm>"
'sRecData = sRecData & "               <gsno>RV16-20-00001</gsno>"
'sRecData = sRecData & "               <bcno>253430060</bcno>              "
...
'sRecData = sRecData & "               <kornm>김상천</kornm>"
'sRecData = sRecData & "               <gsno>신종corona-20-14397</gsno>"
...
'sRecData = sRecData & "               <kornm>표경자</kornm>"
'sRecData = sRecData & "               <gsno>신종corona-20-14398</gsno>"
...
'sRecData = sRecData & "               <kornm>신현주</kornm>"
'sRecData = sRecData & "               <gsno>신종corona-20-14399</gsno>"
...
'sRecData = sRecData & "               <kornm>박점례</kornm>"
'sRecData = sRecData & "               <gsno>신종corona-20-14400</gsno>"
...
'sRecData = sRecData & "               <kornm>임유신</kornm>"
'sRecData = sRecData & "               <gsno>신종corona-20-14401</gsno>"
...
'sRecData = sRecData & "               <kornm>최혜진</kornm>"
'sRecData = sRecData & "               <gsno>신종corona-20-14402</gsno>"
...
'sRecData = sRecData & "               <kornm>박은자</kornm>"
'sRecData = sRecData & "               <gsno>신종corona-20-14403</gsno>"
...
'sRecData = sRecData & "               <kornm>김술례</kornm>"
'sRecData = sRecData & "               <gsno>신종corona-20-14404</gsno>"
...
'sRecData = sRecData & "               <kornm>신익균</kornm>"
'sRecData = sRecData & "               <gsno>신종corona-20-14405</gsno>"
...
Public Sub SetPatInfo(ByVal pBarNo As String, ByVal pType As String)
    ...
    With frmMain
        Select Case pType
            ...
            Case "2"
                For i = 1 To .spdOrder.DataRowCnt
                    If Trim(GetText(frmMain.spdOrder, i, colRACKNO)) = mResult.RackNo And Trim(GetText(frmMain.spdOrder, i, colPOSNO)) = mResult.TubePos And GetText(frmMain.spdOrder, i, colSTATE) = "" Then
                        intRow = i
                        Exit For
                    End If
                Next i
