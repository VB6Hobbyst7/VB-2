...
'sRecData = sRecData & "               <pid>01111001</pid>" & vbCrLf
'sRecData = sRecData & "               <kornm>신익균</kornm>" & vbCrLf
'sRecData = sRecData & "               <gsno>신종corona-20-14405</gsno>" & vbCrLf
'sRecData = sRecData & "               <bcno>153430040</bcno>              " & vbCrLf
'sRecData = sRecData & "               <ifcode>COVID19</ifcode>                " & vbCrLf
'sRecData = sRecData & "               <rstflag>-</rstflag>     " & vbCrLf
'sRecData = sRecData & "           </List>" & vbCrLf
'sRecData = sRecData & "        " & vbCrLf
'sRecData = sRecData & "           <List>" & vbCrLf
'sRecData = sRecData & "               <pid>01111001</pid>" & vbCrLf
...
'sRecData = sRecData & "               <gsno>신종corona-20-14405</gsno>" & vbCrLf
'sRecData = sRecData & "               <bcno>153430040</bcno>              " & vbCrLf
'sRecData = sRecData & "               <rstflag>1</rstflag>     " & vbCrLf
'sRecData = sRecData & "               <ifcode>COVID19</ifcode>                " & vbCrLf
'sRecData = sRecData & "           </List>" & vbCrLf
'sRecData = sRecData & "        " & vbCrLf
'sRecData = sRecData & "           <List>" & vbCrLf
'sRecData = sRecData & "               <rstflag>2</rstflag>     " & vbCrLf
'sRecData = sRecData & "               <pid>01111001</pid>" & vbCrLf
'sRecData = sRecData & "               <kornm>신익균</kornm>" & vbCrLf
'sRecData = sRecData & "               <gsno>신종corona-20-14405</gsno>" & vbCrLf
'sRecData = sRecData & "               <bcno>153430040</bcno>              " & vbCrLf
...
'sRcvData = sRecData
    ...
    'Call DisplayNode_InfoS_Worklist_KHNMC("D:\VB\강동경희대병원\IF\XML\worklist.xml", 10)

'    Kill App.PATH & "\Xml\" & strXmlName
    
'    <pid>08686896</pid>
'    <kornm>서유리B</kornm>
'    <gsno>RV16-20-00001</gsno>
'    <bcno>253430060</bcno>
'    <ifcode>Adeno</ifcode>
'    <rstflag>-</rstflag>   미검
'    <rstflag>1</rstflag>   결과저장
'    <rstflag>2</rstflag>   중간보고
