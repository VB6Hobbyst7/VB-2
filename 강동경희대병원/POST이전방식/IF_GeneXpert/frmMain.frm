...
Begin VB.Form frmMain 
   ...
   Begin VB.Frame fraHidden 
      ...
      Begin FPSpread.vaSpread spdExcel 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmMain.frx":6DE7
      End
   ...
   Begin VB.PictureBox picComm 
      ...
      Begin FPSpread.vaSpread spdOrder_PRT 
         ...
         ShadowColor     =   16777215
         SpreadDesigner  =   "frmMain.frx":7018
         ScrollBarTrack  =   3
         ShowScrollTips  =   3
      End
   End
      ...
      Begin MSComctlLib.ImageList imlStatus 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMain.frx":94BC
               Key             =   "NOT"
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMain.frx":9A56
               Key             =   "STOP"
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMain.frx":9FF0
               Key             =   "LST"
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMain.frx":A882
               Key             =   "ITM"
            EndProperty
            BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMain.frx":A9DC
               Key             =   "ERR"
            EndProperty
            ...
            BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMain.frx":AC90
               Key             =   "ON"
               Object.Tag             =   "OFF"
            EndProperty
            BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMain.frx":B56A
               Key             =   ""
            EndProperty
         EndProperty
      End
   ...
   Begin FPSpread.vaSpread spdOrder 
      ...
      ScrollBarExtMode=   -1  'True
      ShadowColor     =   16777215
      SpreadDesigner  =   "frmMain.frx":E454
      ScrollBarTrack  =   3
      ShowScrollTips  =   3
   End
   Begin FPSpread.vaSpread spdWork 
      ...
      ScrollBarExtMode=   -1  'True
      ShadowColor     =   16777215
      SpreadDesigner  =   "frmMain.frx":1034E
      ScrollBarTrack  =   3
      ShowScrollTips  =   3
   End
        ...
        With spdOrder
            If optTest(0).Value = True Then
                ...
                For lRow = 1 To .DataRowCnt
                    ...
                    .Col = colCHECKBOX
                    If .Value = 1 Then
                        For lCol = colSTATE + 5 To .MaxCols
                            If InStr(UCase(GetText(spdOrder, 0, lCol)), "COVID") > 0 Or InStr(UCase(GetText(spdOrder, 0, lCol)), "CORONA") > 0 Then
...
'                            If GetText(spdOrder, lRow, spdOrder.MaxCols) <> "Negative" Then
'                                strAbResult = strAbResult & GetText(spdOrder, lRow, spdOrder.MaxCols) & vbCrLf
'                            End If
'                        Else
'                            If GetText(spdOrder, lRow, spdOrder.MaxCols - 1) <> "Negative" Then
        ...
        For intCnt = 1 To UBound(strRData)
            ...
            Select Case strType
                ...
                Case "R"
                    ...
                    If strIntBase = "^^^CoV^^^SPC^Ct" Then
                        strResult = mGetP(mGetP(strRcvBuf, 4, "|"), 2, "^")
                    End If
                    strIntResult = strResult 'mGetP(mGetP(strRcvBuf, 4, "|"), 2, "^")
...
'''                    End If
                    ...
                    If strIntBase <> "" And strResult <> "" Then
                        'MTB
                        If strIntBase = "^MTBRIF^^MTB^Xpert MTB-RIF Assay G4^6^MTB^" Then
                            strMTB = strResult
                        End If
                        'RIF
                        If strIntBase = "^MTBRIF^^RIF^Xpert MTB-RIF Assay G4^6^Rif Resistance^" Then
                            strRIF = strResult
                        End If
...
'''                    End If
                    ...
                    'MTB결과가 Negative(=NOT DETECTED) 일 경우 RIF에도 같은 값(NOT DETECTED)을 넣어준다
                    If strMTB = "NOT DETECTED" And strRIF = "" Then
                        strIntBase = "^MTBRIF^^RIF^Xpert MTB-RIF Assay G4^6^Rif Resistance^"
...
Private Sub Form_Resize()
    ...
    spdOrder_PRT.WIDTH = spdOrder.WIDTH
...
'                    .ColHidden = True
'                Else
'                    If UCase(GetText(spdOrder, 0, i)) = "MTB" Or UCase(GetText(spdOrder, 0, i)) = "RIF" Then
'                        .ColHidden = False
'                    Else
'                        .ColHidden = True
'                    End If
        ...
        If Index = 0 Then
            For i = colSTATE + 1 To .MaxCols
                ...
                If Mid(UCase(GetText(spdOrder_PRT, 0, i)), 1, 8) = "COVID-19" Then
                    .ColHidden = False
                ElseIf Mid(UCase(GetText(spdOrder_PRT, 0, i)), 1, 8) = "E" Then
                    .ColHidden = False
                ElseIf Mid(UCase(GetText(spdOrder_PRT, 0, i)), 1, 8) = "N2" Then
                    .ColHidden = False
                ElseIf Mid(UCase(GetText(spdOrder_PRT, 0, i)), 1, 8) = "SPC" Then
                    .ColHidden = False
                Else
                    .ColHidden = True
                End If
        ...
        ElseIf Index = 1 Then
            For i = colSTATE + 1 To .MaxCols
                ...
                ElseIf Mid(UCase(GetText(spdOrder_PRT, 0, i)), 1, 8) = "SPC" Then
                    .ColHidden = True
                Else
                    If UCase(GetText(spdOrder_PRT, 0, i)) = "MTB" Or UCase(GetText(spdOrder_PRT, 0, i)) = "RIF" Then
                        .ColHidden = False
                    Else
                        .ColHidden = True
                    End If
...
Private Sub spdOrder_KeyDown(KeyCode As Integer, Shift As Integer)
    ...
    If KeyCode = vbKeyReturn Then
        If colBARCODE = sCol Then
            If GetSampleInfo(sRow, spdOrder, True) = -1 Then
