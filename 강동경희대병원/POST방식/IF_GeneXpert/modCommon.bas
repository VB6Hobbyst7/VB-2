...
Public Sub GetExeVersion()
    ...
    strSetup = "":    strSetUp1 = ""
    Call GetPrivateProfileString("EXE", "MACHCOUNT", "", strSetup, 100, App.PATH & "\OKSOFT.ini")
    strSetUp1 = Trim(strSetup)
    strSetUp1 = Mid(strSetUp1, 1, Len(strSetUp1) - 1)
    ...
    If IsNumeric(gMACHCOUNT) Then
        ...
        For i = 1 To gMACHCOUNT
            strSetup = "":    strSetUp1 = ""
            Call GetPrivateProfileString("EXE", "MACH" & CStr(i), "", strSetup, 100, App.PATH & "\OKSOFT.ini")
            strSetUp1 = Trim(strSetup)
            strSetUp1 = Mid(strSetUp1, 1, Len(strSetUp1) - 1)
...
'    gCENXPCD = Trim(strSetUp1)
    ...
    '-- USE URL
    strSetup = "":    strSetUp1 = ""
    Call GetPrivateProfileString("HOSP", "USEURL", "", strSetup, 100, App.PATH & "\INI\" & gMACH & ".ini")
    strSetUp1 = Trim(strSetup)
    strSetUp1 = Mid(strSetUp1, 1, Len(strSetUp1) - 1)
    gHOSP.USEURL = Trim(strSetUp1)
    ...
    '-- DEV URL
    strSetup = "":    strSetUp1 = ""
    Call GetPrivateProfileString("HOSP", "DEVURL", "", strSetup, 100, App.PATH & "\INI\" & gMACH & ".ini")
    strSetUp1 = Trim(strSetup)
    strSetUp1 = Mid(strSetUp1, 1, Len(strSetUp1) - 1)
    gHOSP.DEVURL = Trim(strSetUp1)
    
    
    '-- ORDER CODE
    strSetup = "":    strSetUp1 = ""
    Call GetPrivateProfileString("HOSP", "ORDCODE", "", strSetup, 100, App.PATH & "\INI\" & gMACH & ".ini")
    strSetUp1 = Trim(strSetup)
    strSetUp1 = Mid(strSetUp1, 1, Len(strSetUp1) - 1)
    gHOSP.ORDCODE = Trim(strSetUp1)
...
'    gDBTYPE = Trim(strSetUp1)
    ...
    strSetup = "":    strSetUp1 = ""
    Call GetPrivateProfileString("COMM", "BARPOS", "", strSetup, 100, App.PATH & "\INI\" & gMACH & ".ini")
    strSetUp1 = Trim(strSetup)
    strSetUp1 = Mid(strSetUp1, 1, Len(strSetUp1) - 1)
    gComm.BARPOS = Trim(strSetUp1)
    ...
    '-- CFX96 COMMMENT Get
    strSetup = "":    strSetUp1 = ""
    Call GetPrivateProfileString("COMMENT", "SGCOVID", "", strSetup, 1000, App.PATH & "\INI\" & gMACH & ".ini")
    strSetUp1 = Trim(strSetup)
    strSetUp1 = Mid(strSetUp1, 1, Len(strSetUp1) - 1)
    gCFXCmnt.SGCOVID = Trim(strSetUp1)
    
    strSetup = "":    strSetUp1 = ""
    Call GetPrivateProfileString("COMMENT", "SDCOVID", "", strSetup, 1000, App.PATH & "\INI\" & gMACH & ".ini")
    strSetUp1 = Trim(strSetup)
    strSetUp1 = Mid(strSetUp1, 1, Len(strSetUp1) - 1)
    gCFXCmnt.SDCOVID = Trim(strSetUp1)
    
    strSetup = "":    strSetUp1 = ""
    Call GetPrivateProfileString("COMMENT", "MTBRIF", "", strSetup, 1000, App.PATH & "\INI\" & gMACH & ".ini")
    strSetUp1 = Trim(strSetup)
    strSetUp1 = Mid(strSetUp1, 1, Len(strSetUp1) - 1)
    gCFXCmnt.MTBRIF = Trim(strSetUp1)
    
    strSetup = "":    strSetUp1 = ""
    Call GetPrivateProfileString("COMMENT", "CARBAR", "", strSetup, 1000, App.PATH & "\INI\" & gMACH & ".ini")
    strSetUp1 = Trim(strSetup)
    strSetUp1 = Mid(strSetUp1, 1, Len(strSetUp1) - 1)
    gCFXCmnt.CARBAR = Trim(strSetUp1)
    
    strSetup = "":    strSetUp1 = ""
    Call GetPrivateProfileString("COMMENT", "PATH", "", strSetup, 1000, App.PATH & "\INI\" & gMACH & ".ini")
    strSetUp1 = Trim(strSetup)
    strSetUp1 = Mid(strSetUp1, 1, Len(strSetUp1) - 1)
    gCFXCmnt.PATH = Trim(strSetUp1)
...
'    End With
    ...
    With SPD
        ...
        For i = 0 To UBound(gArrEQPNm) - 1
            ...
            If UCase(Trim(gArrEQPNm(i + 1, 6))) = "E" Then
                .ColWidth(colSTATE + (i + 1)) = 5
            ElseIf UCase(Trim(gArrEQPNm(i + 1, 6))) = "N2" Then
                .ColWidth(colSTATE + (i + 1)) = 5
            ElseIf UCase(Trim(gArrEQPNm(i + 1, 6))) = "SPC" Then
                .ColWidth(colSTATE + (i + 1)) = 5
            Else
                .ColWidth(colSTATE + (i + 1)) = gCOLWIDTH
            End If
...
Public Function OpenURLWithIE2(ByVal URL As String, ByRef Inet As Inet) As String
     ...
     With Inet
          ...
          .URL = URL
          '.Execute , "GET", inputhdrs:="User-agent: Mozilla/4.0 (compatible; MSIE 7.0; Windows NT 6.0; SLCC1; .NET CLR 2.0.50727; Media Center PC 5.0; .NET CLR 3.0.04506)" & vbCrLf
          .Execute , "POST", inputhdrs:="User-agent: Mozilla/4.0 (compatible; MSIE 7.0; Windows NT 6.0; SLCC1; .NET CLR 2.0.50727; Media Center PC 5.0; .NET CLR 3.0.04506)" & vbCrLf
