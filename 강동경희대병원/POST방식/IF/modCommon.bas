...
'    gDBTYPE = Trim(strSetUp1)
    ...
    '-- CFX96 COMMMENT Get
    strSetup = "":    strSetUp1 = ""
    Call GetPrivateProfileString("COMMENT", "SGCOVID", "", strSetup, 100, App.PATH & "\INI\" & gMACH & ".ini")
    strSetUp1 = Trim(strSetup)
    strSetUp1 = Mid(strSetUp1, 1, Len(strSetUp1) - 1)
    gCFXCmnt.SGCOVID = Trim(strSetUp1)
    
    strSetup = "":    strSetUp1 = ""
    Call GetPrivateProfileString("COMMENT", "SDCOVID", "", strSetup, 100, App.PATH & "\INI\" & gMACH & ".ini")
    strSetUp1 = Trim(strSetup)
    strSetUp1 = Mid(strSetUp1, 1, Len(strSetUp1) - 1)
    gCFXCmnt.SDCOVID = Trim(strSetUp1)
    
    strSetup = "":    strSetUp1 = ""
    Call GetPrivateProfileString("COMMENT", "RV16", "", strSetup, 100, App.PATH & "\INI\" & gMACH & ".ini")
    strSetUp1 = Trim(strSetup)
    strSetUp1 = Mid(strSetUp1, 1, Len(strSetUp1) - 1)
    gCFXCmnt.RV16 = Trim(strSetUp1)
    
    strSetup = "":    strSetUp1 = ""
    Call GetPrivateProfileString("COMMENT", "PB5", "", strSetup, 100, App.PATH & "\INI\" & gMACH & ".ini")
    strSetUp1 = Trim(strSetup)
    strSetUp1 = Mid(strSetUp1, 1, Len(strSetUp1) - 1)
    gCFXCmnt.PB5 = Trim(strSetUp1)
    
    strSetup = "":    strSetUp1 = ""
    Call GetPrivateProfileString("COMMENT", "PATH", "", strSetup, 100, App.PATH & "\INI\" & gMACH & ".ini")
    strSetUp1 = Trim(strSetup)
    strSetUp1 = Mid(strSetUp1, 1, Len(strSetUp1) - 1)
...
'    End With
    ...
    With SPD
        ...
        For i = 0 To UBound(gArrEQPNm) - 1
            ...
            If InStr(UCase(Trim(gArrEQPNm(i + 1, 6))), "COVID") > 0 Then
                .ColWidth(colSTATE + (i + 1)) = gCOLWIDTH
            ElseIf InStr(UCase(Trim(gArrEQPNm(i + 1, 6))), "RDRP/S") > 0 Then
