...
Function SaveTransData_KHNMC(ByVal argSpcRow As Integer, ByVal SPD As Object) As Integer
    ...
    Dim strCovid        As String
    Dim strECt          As String
    Dim strNCt          As String
    Dim strRdrpCt       As String
...
' = %17
                If strBarcode <> "" And strTestCd <> "" And sResult <> "" Then
                    ...
                    If InStr(UCase(strOrdCd), "COV") > 0 Then
                        strCovid = sResult
                    End If
                    
                    If strOrdCd = "E" Then
                        strECt = sResult
                    ElseIf strOrdCd = "RdRP" Then
                        strRdrpCt = sResult
                    ElseIf strOrdCd = "N" Then
                        strNCt = sResult
                    End If
                End If
                
                'Param>>http://medhis.khnmc.or.kr/lis/jindangeomsaweb/GyeolGwaIF.live?Mode=reqGetIFGyeolGwaDR
                '&Data1=356780130%03
                'E      %17 21.02    %17 %17 20210719110346  %03
                'RdRP   %17 22.94    %17 %17 20210719110346  %03
                'N      %17 21.04    %17 %17 20210719110346  %03
                'IC     %17 31.68    %17 %17 20210719110346  %03
                'COVID19%17 Positive%17%1720210719110346%03
                '&Data2=R04
        ...
        If strAllResult <> "" Then
            ...
            If frmMain.optTest(0).Value = True Then
                ...
                If UCase(strCovid) = "POSITIVE" Then
                    sParam = sParam & "%0D"
                    sParam = sParam & "%0D"
                    sParam = sParam & "E gene : " & strECt & " ct" & "%0D"
                    sParam = sParam & "RdRp/S gene : " & strRdrpCt & " ct" & "%0D"
                    sParam = sParam & "N gene : " & strNCt & " ct" & "%0D"
                End If
        

'* Primer 정보(target gene)
'E gene, RdRp/S gene, N gene
'
'E gene : 21.02 ct
'RdRp/S gene : 22.94 ct
'N gene : 21.04 ct
