...
Private Sub cmdSend_Click()
    ...
    For intIdx = 1 To f_intCnt
        f_strDta(intIdx) = Chr(2) + "J" + Format$(intIdx, "00000") + String(24, " ")
        f_strDta(intIdx) = f_strDta(intIdx) + p_funGet_Bn2BCC_1(Mid$(f_strDta(intIdx), 2)) + Chr(13) + Chr(3)
    Next
...
Private Sub Form_Load()
    ...
    sPath = App.Path
    Open sPath + "\" + "bn2_job.log" For Append As #1
