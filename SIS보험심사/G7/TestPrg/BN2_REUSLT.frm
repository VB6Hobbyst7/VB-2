...
Private Sub cmdSend_Click()
    ...
    Dim f_strDta(1 To 5)    As String
    Dim intIdx1 As Integer, intIdx2 As Integer
    
    f_intCnt = 5:   f_intIdx = 1
    
    For intIdx1 = 1 To f_intCnt
        For intIdx2 = 1 To 6
            Randomize

            f_strDta(intIdx1) = Chr(2) + "D" + Format$(intIdx1, "00000") + String(24, " ") + Format$(intIdx2, "00") + "  00" + _
                                Format$(Int((100 * Rnd) + 1), "@@@@@@@@@@@@@@@") + "mg/dl" + String(4, " ") + _
                                "1 0 0 0BNII" + Format$(Now, "DDMMYY") + Format$(Now, "HHMMSS")
                                
            f_strDta(intIdx1) = f_strDta(intIdx1) + p_funGet_Bn2BCC_1(Mid$(f_strDta(intIdx1), 2)) + Chr(13) + Chr(3)
        Next
    Next
...
Private Sub Form_Load()
    ...
    sPath = App.Path
    Open sPath + "\" + "bn2_rst.log" For Append As #1
