...
Private Sub cmdEQP_Click()
    ...
    If Not mAdoRs Is Nothing Then
        Do Until mAdoRs.EOF
            Set itemX = PopUp_List.ListItems.Add(, , Trim(mAdoRs("INSTRUMENTCODE") & ""))
            itemX.SubItems(1) = Trim(mAdoRs("INSTRUMENTNAME") & "")
            mAdoRs.MoveNext
        Loop
...
Private Sub cmdWS_CD_Click()
    ...
    If Not mAdoRs Is Nothing Then
        Do Until mAdoRs.EOF
            Set itemX = PopUp_List.ListItems.Add(, , Trim(mAdoRs("WORKSTATIONCODE") & ""))
            itemX.SubItems(1) = Trim(mAdoRs("WORKSTATIONNAME") & "")
            mAdoRs.MoveNext
        Loop
