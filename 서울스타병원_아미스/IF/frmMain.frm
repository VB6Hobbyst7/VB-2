...
'    'Call SetCommStatus("Q", pBarNo, frmMain.lstComStatus)
    ...
    With frmMain
        ...
        If gHOSP.BARUSE <> "Y" Then
            'mOrder.Func = Replace(mOrder.Func, String(13, "#"), LEFT(mOrder.BarNo & Space(13), 13))
            Mid(mOrder.Func, 17, 8) = mOrder.PID
        End If
        ...
        If Trim(strItems) = "" Or mOrder.SendCnt = 0 Then
            ...
            GetOrder = STX & ";" & mOrder.Func & "48" & Mid(mOrder.Order, 1, 48) & "000000" & ETX
    ...
    With frmMain
        For intCnt = 1 To UBound(strRData)
            ...
            Select Case strType
                ...
                Case ":"    '## End
                    ':N     1   1 16-008507                    9  1    17   2    10   3    15   6    98   7    16   8   0.3   9   6.9  10   4.7  12   0.7
...
'                    Else
'                        '바코드 미사용
'                        sFunc = Mid(strRcvBuf, 2, 12) & String(8, "#") & Mid(strRcvBuf, 27, 15)
'                    End If
                ...
                Case ":"    '## End
                    ':Q1    10511                 00801190919       114  0.05 
                    ':Q1    30531                 00801191121       8 1    26  2    27  4    21  5   121  6   196  7   370  9  1.09 13    38 
                    ':N1    30 31     00115392    00801191201       5 1    26  2    36  4    35  5   120  6   241
                    ...
                    strBarno = Trim$(Mid$(strRcvBuf, 13, gHOSP.BARLEN)) '13
                    ...
                    ':n1   240241     24143143    00707181042      13 1    23  2    10  3   172  5    88  6   171  7    48  8   9.3  9  0.74T11   8.2!12  1.17!13    81 14  0.49 16   4.5!
                    ':n1   240241     24143143    00707181042      13
                    ' 1    23
                    ' 2    10
                    ' 3   172  5    88  6   171  7    48  8   9.3  9  0.74T11   8.2!12  1.17!13    81 14  0.49 16   4.5!

                    For ii = 49 To Len(strRcvBuf) Step 9
                        strIntBase = Trim(Mid(strRcvBuf, ii, 2))
                        strResult = Trim(Mid(strRcvBuf, ii + 2, 6))
                        strFlag = Trim(Mid(strRcvBuf, ii + 8, 1))
