        ...
        If strAMRResult <> "" Then
            If pIntResult <> "" Then
                ...
                ElseIf Trim(RS_L.Fields("AMRINResult") & "") = "2" Then
                    pResult = strIntResult & "(" & strAMRResult & ")"
        ...
        For intCnt = 0 To UBound(strRecvData)
            ...
            Select Case strType
                ...
                Case "OBX"
                    ...
                    If InStr(strRcvBuf, "Influenza") > 0 Then
                    ...
                    Else
                        ...
                        strResult = mGetP(strRcvBuf, 6, "|")
                        strResult = Replace(strResult, "Below", "<")
                ...
                Case "NTE"  'Device Information
                    ...
                    If InStr(strIntBase, "Influenza") > 0 Then
...
On Error GoTo ErrHandle
    If DbConnect_ORACLE = True Then
        ...
        'SetRawData "[DBCon]" & RS.Fields("sysdate") & ""
...
Private Sub wSck_Error(ByVal Number As Integer, Description As String, ByVal Scode As Long, ByVal Source As String, ByVal HelpFile As String, ByVal HelpContext As Long, CancelDisplay As Boolean)
    ...
    SetRawData "[wSck_Error]" & Number & "," & Description & "," & Source
