...
Begin VB.Form frmMain 
   ...
   Begin VB.Frame frame1 
      ...
      Begin FPSpread.vaSpread spdResult 
         ...
         SpreadDesigner  =   "frmMain.frx":113C4
         TextTip         =   2
      End
   End
   Begin VB.Frame frame4 
      ...
      Begin VB.Frame frameCom 
         ...
         Begin VB.ComboBox cboPort 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmMain.frx":12A02
            Left            =   2190
            List            =   "frmMain.frx":12A04
            TabIndex        =   52
            Top             =   390
            Width           =   2205
         End
         Begin VB.ComboBox cboBaudrate 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmMain.frx":12A06
            Left            =   2190
            List            =   "frmMain.frx":12A08
            TabIndex        =   51
            Top             =   780
            Width           =   2205
         End
         Begin VB.ComboBox cboDatabit 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmMain.frx":12A0A
            Left            =   2190
            List            =   "frmMain.frx":12A0C
            TabIndex        =   50
            Top             =   1170
            Width           =   2205
         End
         ...
         Begin VB.ComboBox cboParity 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmMain.frx":12A0E
            Left            =   2190
            List            =   "frmMain.frx":12A10
            TabIndex        =   47
            Top             =   2520
            Width           =   2205
         End
   ...
   Begin VB.Frame frame2 
      ...
      Begin FPSpread.vaSpread spdRResult 
         ...
         SelectBlockOptions=   0
         ShadowColor     =   13697023
         SpreadDesigner  =   "frmMain.frx":1418E
         TextTip         =   2
      End
      Begin FPSpread.vaSpread spdROrder 
         ...
         SelectBlockOptions=   0
         ShadowColor     =   14548991
         SpreadDesigner  =   "frmMain.frx":14B88
         UserResize      =   2
      End
   ...
   Begin VB.Frame frame3 
      ...
      Begin VB.Frame frameTestSet 
         ...
         Begin VB.Frame frameOrder 
            ...
            Begin FPSpread.vaSpread spdOrdMst 
               ...
               SelectBlockOptions=   0
               ShadowColor     =   13697023
               SpreadDesigner  =   "frmMain.frx":19111
               TextTip         =   2
            End
         End
         Begin VB.ComboBox cboResultType 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmMain.frx":19688
            Left            =   1650
            List            =   "frmMain.frx":1968A
            TabIndex        =   32
            Top             =   5220
            Visible         =   0   'False
            Width           =   1575
      ...
      Begin FPSpread.vaSpread spdTest 
         ...
         RetainSelBlock  =   0   'False
         SelectBlockOptions=   0
         SpreadDesigner  =   "frmMain.frx":1C584
      End
   End
...
'검체번호에 존재하는 장비번호 해당하는 수가코드 가져오기
'한 장비 번호에 검사코드가 1개이상 존재
Private Function GetEquipExamCode_BS200E(argEquipCode As String, argPID As String, Optional intRow As Long) As String
    Dim lngIntBase  As Long
    Dim strItems    As String           '전송할 검사항목
    Dim blnISE      As Boolean          'Na, K, Cl 검사여부
    ...
    With frmMain
        For intCnt = 1 To UBound(strRecvData)
            ...
            Select Case strType
                ...
                Case "OBR"
                    '-- 인터페이스 응답
                                   strSndBuffer = SB & "MSH|^~\&|Mindray|BS-220E|||" & Format(Now, "yyyymmddhhmmss") & "||ACK^R01|" & mOrder.BS_MType & "|P|2.3.1||||0||ASCII|||" & vbCr
...
Private Function GetEquipExamCode_THUNDERBOLT(argEquipCode As String, argPID As String, Optional intRow As Long) As String
    ...
    'strExamCode = "@^^^ADENO@^^^CDAB@^^^MONO"
    'strExamCode = "@^^^ADENO@^^^CDAB"
    'strExamCode = "@^^^ADENO"
    AdoRs_Local.Close
