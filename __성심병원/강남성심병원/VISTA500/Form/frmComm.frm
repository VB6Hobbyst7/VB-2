...
Begin VB.Form frmComm 
   ...
   Begin TabDlg.SSTab tabWork 
      ...
      Tab(0).Control(25)=   "spdResult1"
      Tab(0).Control(25).Enabled=   0   'False
      Tab(0).Control(26)=   "cmdWorkList"
      Tab(0).Control(26).Enabled=   0   'False
      Tab(0).Control(27)=   "cmdSel(2)"
      Tab(0).Control(27).Enabled=   0   'False
      Tab(0).Control(28)=   "cmdSel(3)"
      Tab(0).Control(28).Enabled=   0   'False
      Tab(0).Control(29)=   "txtDump"
      Tab(0).Control(29).Enabled=   0   'False
      Tab(0).Control(30)=   "spdRstview"
      ...
      Begin FPSpread.vaSpread spdResult1 
         ...
         SpreadDesigner  =   "frmComm.frx":9FC7
         UserResize      =   0
      End
      ...
      Begin BHButton.BHImageButton cmdNext 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         TransparentPicture=   "frmComm.frx":A6F9
         ForeColor       =   16711680
         BackColor       =   255
         AlphaColor      =   255
         ImgOutLineSize  =   3
      ...
      Begin FPSpread.vaSpread spdResult2 
         ...
         ScrollBarMaxAlign=   0   'False
         ShadowColor     =   14735310
         SpreadDesigner  =   "frmComm.frx":B45B
         UserResize      =   0
      End
      ...
      Begin FPSpread.vaSpread spdWorklist 
         ...
         ScrollBarMaxAlign=   0   'False
         ShadowColor     =   14735310
         SpreadDesigner  =   "frmComm.frx":B8AE
         UserResize      =   2
      End
      ...
      Begin Threed.SSPanel SSPanel1 
         ...
         Begin VB.ComboBox cboChk 
            Height          =   300
            ItemData        =   "frmComm.frx":BDEB
            Left            =   5160
            List            =   "frmComm.frx":BDF5
            TabIndex        =   62
            Top             =   90
            Width           =   1095
         End
         Begin VB.ComboBox cboComNm 
            Height          =   300
            ItemData        =   "frmComm.frx":BE09
            Left            =   4590
            List            =   "frmComm.frx":BE0B
            TabIndex        =   61
            Top             =   480
            Visible         =   0   'False
            Width           =   1725
      ...
      Begin Threed.SSPanel SSPanel 
         ...
         Begin VB.ComboBox cboOrdDt 
            Height          =   300
            ItemData        =   "frmComm.frx":BE0D
            Left            =   4590
            List            =   "frmComm.frx":BE0F
            TabIndex        =   89
            Top             =   90
            Visible         =   0   'False
            Width           =   1185
         ...
         Begin VB.ComboBox cboChk1 
            Height          =   300
            ItemData        =   "frmComm.frx":BE11
            Left            =   2610
            List            =   "frmComm.frx":BE1B
            TabIndex        =   88
            Top             =   90
            Visible         =   0   'False
            Width           =   1905
         ...
         Begin VB.ComboBox cboRstgbn 
            Height          =   300
            Index           =   1
            ItemData        =   "frmComm.frx":BE2F
            Left            =   5850
            List            =   "frmComm.frx":BE3C
            Style           =   2  '드롭다운 목록
            TabIndex        =   75
            Top             =   75
            Visible         =   0   'False
         ...
         Begin VB.ComboBox Combo2 
            Height          =   300
            ItemData        =   "frmComm.frx":BE66
            Left            =   4590
            List            =   "frmComm.frx":BE68
            TabIndex        =   74
            Top             =   480
            Visible         =   0   'False
            Width           =   1725
      ...
      Begin FPSpread.vaSpread tblexcel 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmComm.frx":BE6A
      End
...
'                                                         sqlDoc = "select EQPNUM from INTERFACE003"
'                                                sqlDoc = sqlDoc & " where SPCNO = '" & strBarno & "' "
'                                                sqlDoc = sqlDoc & "   and TESTCD = '" & strTestCd & "'"
...
'                                                    adoRS2.MoveFirst
'                                                    Do While Not adoRS2.EOF
'                                                        strPNo = Trim(adoRS.Fields("EQPNUM"))
'                                                        adoRS2.MoveNext
'                                                    Loop
'                                                End If
'                                                Set adoRS2 = Nothing
                                                For i = 0 To 100
                                                    If strTestCd = Mid(strSNOCode(i), 6) Then
                                                        strPNo = Mid(strSNOCode(i), 1, 4)
                                                        Exit For
                                                    End If
            ...
            Select Case strType
                ...
                Case "Q"    '## Request Information
                    ...
                    For i = 0 To UBound(varSvcData) - 1 Step 2
                        ...
                        ElseIf varSvcData(i + 1) = "X" Then
                            lblStatus.Caption = strBarno & " 검체는 검사할수 없습니다."
                                       strAlarm = "VISTA 500" & vbNewLine
                            strAlarm = strAlarm & strBarno & " 검체는 검사할수 없습니다." & vbNewLine
                        
                        Else
                            strTstCD = strTstCD & "'" & varSvcData(i) & "',"
                    ...
                    'If Trim(strAlarm) = "" Then
                        strItems = ""
                        Set adoRS2 = New ADODB.Recordset
                        
                                 sqlDoc = "select TESTCD_EQP, TESTNO "
                        sqlDoc = sqlDoc & "  from INTERFACE002 "
                        sqlDoc = sqlDoc & " where (EQP_CD = " & STS(INS_CODE) & ") AND (TESTCD <> '" & varSvcData(i) & "')"
                        ...
                        Do While Not adoRS2.EOF
                            ...
                            If Trim(adoRS2.Fields("TESTNO").Value & "") <> "" And Trim(adoRS2.Fields("TESTCD_EQP").Value & "") <> "" Then
                                strChannel = Trim(adoRS2.Fields("TESTNO").Value & "") & "^^" & Trim(adoRS2.Fields("TESTCD_EQP").Value & "")
                    ...
                    If Trim(strItems) <> "" Then
                        ...
                        If strSvrcData = "" Then
                            ...
                            spdResult1.SetText 5, pGrid_Point, "No Order"   '-- No
                        ...
                        If strSvrcData <> "" Then
                            ...
                            spdResult1.SetText 2, pGrid_Point, pGrid_Point                                          '-- 일련번호 No
                            ...
                            spdResult1.SetText 9, pGrid_Point, CStr(varSvcData(6))                                  '-- 검체종류
                            spdResult1.SetText 10, pGrid_Point, CStr(varSvcData(12)) '& ":" & CStr(varSvcData(14))   '-- 직전결과,보고일
                            ...
                            '-- 검체종류
                            'S (Serum), C (CSF), P (plasma),U (Urine), W (Whole Blood),A (Amniotic Fluid),O ( other)
                            Select Case UCase(Trim(CStr(varSvcData(6))))
                            Case "SERUM"
                                mOrder.TubePos = "S"
                            Case "CSF"
                                mOrder.TubePos = "C"
                            ...
                            Case Else
                                mOrder.TubePos = "O"
                            End Select
                            '검체코드 = CStr(varSvcData(5)
                            '검체명 = CStr(varSvcData(6)
                            DoEvents
                        End If
                    End If
'                    .state = "Q"
                ...
                Case "O"    '## Order
                    ...
                    'strTemp2 = mGetP(mGetP(strRcvBuf, 5, "|"), 4, "^")
                    ...
                    If strSvrcData = "" Then
                        ...
                        spdResult1.SetText 2, pGrid_Point, pGrid_Point   '-- No
                        spdResult1.SetText 4, pGrid_Point, strBarno   '-- 검체번호
                        'spdResult1.SetText 5, pGrid_Point, "보고완료"
                    End If
                    
                    Erase varSvcData
                    varSvcData = Split(strSvrcData, "|")
                    
'                    For i = 11 To spdResult1.MaxCols
'                        spdResult1.GetText i, 0, varTmp
'                        Set itemX = lvwCuData.FindItem(Trim$(varTmp), lvwSubItem, , lvwWhole)
'                        If Not itemX Is Nothing Then
'                            If strTemp2 = itemX.text Then           ' 검사결과가 있으면...
'                                 strTemp3 = strTemp3 & itemX.SubItems(1) & "|"
'                                 'Exit For
'                            End If
'                        End If
'                    Next
                    
                    'varTemp3 = Split(strTemp3, "|")
                    k = 0
                    For i = 0 To 100
                        strSNOCode(i) = ""
                    Next
                    For i = 0 To UBound(varSvcData) - 1 Step 15
                        'For j = 0 To UBound(varTemp3) - 1
                         '   If varTemp3(j) = CStr(varSvcData(3 + i)) Then
                                ...
                                'spdResult1.SetText 1, pGrid_Point, "1"
                                spdResult1.SetText 2, pGrid_Point, pGrid_Point   '-- No
                                spdResult1.SetText 3, pGrid_Point, CStr(varSvcData(2 + i)) '-- W/N [ANo]
                                
                                strSNOCode(k) = CStr(varSvcData(2 + i)) & "," & CStr(varSvcData(3 + i))
'                                Debug.Print strSNOCode(k)
                                spdResult1.SetText 4, pGrid_Point, strBarno   '-- 검체번호
                                spdResult1.SetText 5, pGrid_Point, CStr(varSvcData(7 + i)) '-- 등록번호
                                spdResult1.SetText 6, pGrid_Point, CStr(varSvcData(8 + i)) '-- 이름
                                strPatInfo = "환자명 : " & CStr(varSvcData(8 + i)) & " [" & CStr(varSvcData(7 + i)) & "]"
                                
                                spdResult1.SetText 7, pGrid_Point, CStr(varSvcData(9 + i)) & "/" & CStr(varSvcData(10 + i)) '-- 성별/나이
                                spdResult1.SetText 8, pGrid_Point, CStr(varSvcData(11 + i)) '-- 진료과
                                strSex = CStr(varSvcData(9 + i))
                                strAGE = CStr(varSvcData(10 + i))
                               '' spdResult1.SetText 9, pGrid_Point, CStr(varSvcData(12 + i)) '-- 직전결과
                              '  spdResult1.SetText 10, pGrid_Point, CStr(varSvcData(14 + i)) '-- 직전결과보고일
                                DoEvents
                                k = k + 1
                                'Exit For
                        '    End If
                ...
                Case "R"    '## Result
                    ...
                    strIntBase = Mid(strIntBase, 1, 4)
                    'If strIntBase = "21301" Then strIntBase = "2101"
                ...
                Case "C"
                    ...
                    If strState = "R" Then
                        ...
                        If strResult = "" And strTemp2 = "E" Then
                            ...
                            If strComm = "E143" Or strComm = "E145" Or strComm = "E317" Then
                                '.state = ""
                                strState = ""
                            End If
                        End If
...
Private Sub Form_Load()
    ...
    Open App.Path + "\" + REG_INSNAME + "_" + Format(Now, "YYYYMMDD") + ".log" For Append As #1
