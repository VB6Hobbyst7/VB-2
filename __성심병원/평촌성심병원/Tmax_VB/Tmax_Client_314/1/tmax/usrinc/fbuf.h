...
int __cdecl fbgetc(FBUF *fbuf, FLDKEY fldkey, char *loc, FLDLEN *len, int *pos, int totype);
...
int __cdecl fbextread(FBUF *fbuf, FILE *iop);

char *__cdecl  _tmget_compat_strFerror(int err_no);
int *__cdecl  _tmget_compat_Ferror_addr(void);
