...
#ifndef _TMAX_ATMI_H	/* Jul/19/2003 DIKIM Ref. TIGGER */
struct clid_t {
    long clientdata[4];
};
...
#ifndef _TMAXAPI_H	/* Jul/19/2003 DIKIM Ref. TIGGER */
struct tpevctl_t {
	long flags;
...
int __cdecl tpinit(TPINIT *tpinfo);
int __cdecl tpterm(void);
int __cdecl tpbegin(unsigned long timeout, long flags);
int __cdecl tpcommit(long flags);
int __cdecl tpabort(long flags);
int __cdecl tpopen(void);
int __cdecl tpclose(void);
int __cdecl tpscmt(long flags);
int __cdecl tpgetlev(void);
...
char *__cdecl  _tmget_compat_strerror(int err_no);
int __cdecl tpgetrply(int *cd, char **data, long *len, long flags);
int __cdecl tpcancel(int cd);
int *__cdecl  _tmget_compat_errno_addr(void);
int __cdecl _tmget_compat_errno(void);
#if !defined(_TMAX_KERNEL) && !defined(_TMAX_UTIL)
#ifndef _TMAX_ATMI_H	/* Jul/19/2003 DIKIM Ref. TIGGER */
...
int __cdecl tpenqueue (char *qspace, char *qname, TPQCTL *ctl, char *data, 
	   long len, long flags);
int __cdecl tpdequeue (char *qspace, char *qname, TPQCTL *ctl, char **data, 
	   long *len, long flags);

/* ----- etc API ------------- */
int __cdecl tperrordetail(int);
int __cdecl tpchkauth(void);
int __cdecl tpgprio(void);
int __cdecl tpsprio(int prio, long flags);
char *__cdecl tuxgetenv(char *);
int __cdecl tuxputenv(char *);
int __cdecl tuxreadenv(char *, char *);

/* ----- multithread/multicontext API ----- */
int __cdecl tpsetctxt(int ctxtid, long flags);
int __cdecl tpgetctxt(int *ctxtid, long flags);
