...
#if defined(_WIN32) || defined(_TMAX_MTLIB)
...
int __cdecl tpadvertise(char *svcname, void (* func) (TPSVCINFO *));
int __cdecl tpunadvertise(char *svcname);

/* ----- etc API ----- */
int __cdecl tpnotify(CLIENTID *id, char *data, long len, long flags);
