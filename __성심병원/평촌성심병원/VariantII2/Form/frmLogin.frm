...
Begin VB.Form frmLogin 
   ...
   Begin VB.Label Label1 
      AutoSize        =   -1  'True
      BackStyle       =   0  '투명
      Caption         =   "디딤정보(www.didiminfo.co.kr) Tel. 02-6012-7844"
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   9
         Charset         =   0
...
'    strSvrcData = getSvrcInfo("AP_PATBA_S7", "030480287", "", "", "", "", "", "", "", "")
    ...
    ' 평촌
'   strSvrcData = getSvrcInfo("SL_INTFC_L2", "2114508817")
    
    ' 개발
'    strSvrcData = getSvrcInfo("SL_INTFC_L2", "2110000983", "", "", "", "", "", "", "", "")


'    strSvrcData = getSvrcInfo("SL_SPCMD_L12", "SPC", "2114478947", "", "", "", "", "", "", "")
    ...
    If ActiveControl.Name = "cmdCancel" Then Exit Sub
        ...
        Else
            ...
            With CurrUser
                ...
                .CuUserNM = varSvcData(0)
                .CuUserPW = varSvcData(1)
