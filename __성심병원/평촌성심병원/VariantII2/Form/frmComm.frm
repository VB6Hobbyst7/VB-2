...
Begin VB.Form frmComm 
   ...
   Begin TabDlg.SSTab tabWork 
      ...
      Tab(0).Control(1)=   "cmdCLR"
      Tab(0).Control(2)=   "cmdSel(3)"
      Tab(0).Control(3)=   "cmdSel(2)"
      ...
      Tab(0).Control(9)=   "cmdPosNo"
      Tab(0).Control(10)=   "cmdOrder"
      Tab(0).Control(11)=   "Frame3"
      Tab(0).Control(12)=   "SSPanel2"
      Tab(0).Control(13)=   "Command1"
      Tab(0).Control(14)=   "cmdEot"
      Tab(0).Control(15)=   "cmdWordQuery"
      Tab(0).Control(16)=   "cmdRackNo"
      Tab(0).Control(17)=   "spdRstview"
      Tab(0).Control(18)=   "txtResult"
      Tab(0).Control(19)=   "chkAuto"
      Tab(0).Control(20)=   "cmdRequist(2)"
      Tab(0).Control(21)=   "pnlCom2"
      Tab(0).Control(22)=   "txtBarCode"
      Tab(0).Control(23)=   "spdWorklist"
      Tab(0).Control(24)=   "cmdSearch"
      Tab(0).Control(25)=   "cmdStartNo"
      Tab(0).Control(26)=   "cmdPrint"
      Tab(0).Control(27)=   "SSPanel1"
      Tab(0).Control(28)=   "pnlCom"
      Tab(0).Control(29)=   "Line1"
      ...
      Tab(1).Control(9)=   "cmdSel(4)"
      Tab(1).Control(9).Enabled=   0   'False
      Tab(1).Control(10)=   "cmdSel(5)"
      ...
      Begin VB.TextBox txtDump 
         ...
         Width           =   3375
      End
      Begin BHButton.BHImageButton cmdCLR 
         Height          =   420
         Left            =   -63060
         TabIndex        =   92
         Top             =   7860
      ...
      Begin FPSpread.vaSpread spdResult1 
         ...
         SpreadDesigner  =   "frmComm.frx":97A7
         UserResize      =   0
      End
      ...
      Begin BHButton.BHImageButton cmdNext 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         TransparentPicture=   "frmComm.frx":9D29
         ForeColor       =   16711680
         BackColor       =   255
         AlphaColor      =   255
         ImgOutLineSize  =   3
      ...
      Begin FPSpread.vaSpread spdResult2 
         ...
         SpreadDesigner  =   "frmComm.frx":AA8B
         UserResize      =   0
      End
      ...
      Begin FPSpread.vaSpread spdRstview 
         ...
         ScrollBars      =   0
         ShadowColor     =   14735310
         SpreadDesigner  =   "frmComm.frx":AEDE
         UserResize      =   0
      End
      ...
      Begin FPSpread.vaSpread spdWorklist 
         ...
         ScrollBarMaxAlign=   0   'False
         ShadowColor     =   14735310
         SpreadDesigner  =   "frmComm.frx":B5E9
         UserResize      =   2
      End
      ...
      Begin Threed.SSPanel SSPanel1 
         ...
         Begin VB.ComboBox cboChk 
            Height          =   300
            ItemData        =   "frmComm.frx":BB26
            Left            =   5160
            List            =   "frmComm.frx":BB30
            TabIndex        =   62
            Top             =   90
            Width           =   1095
         End
         Begin VB.ComboBox cboComNm 
            Height          =   300
            ItemData        =   "frmComm.frx":BB44
            Left            =   4590
            List            =   "frmComm.frx":BB46
            TabIndex        =   61
            Top             =   480
            Visible         =   0   'False
            Width           =   1725
      ...
      Begin Threed.SSPanel SSPanel 
         ...
         Begin VB.ComboBox cboOrdDt 
            Height          =   300
            ItemData        =   "frmComm.frx":BB48
            Left            =   4590
            List            =   "frmComm.frx":BB4A
            TabIndex        =   89
            Top             =   90
            Visible         =   0   'False
            Width           =   1185
         ...
         Begin VB.ComboBox cboChk1 
            Height          =   300
            ItemData        =   "frmComm.frx":BB4C
            Left            =   2610
            List            =   "frmComm.frx":BB56
            TabIndex        =   88
            Top             =   90
            Visible         =   0   'False
            Width           =   1905
         ...
         Begin VB.ComboBox cboRstgbn 
            Height          =   300
            Index           =   1
            ItemData        =   "frmComm.frx":BB6A
            Left            =   5850
            List            =   "frmComm.frx":BB77
            Style           =   2  '드롭다운 목록
            TabIndex        =   75
            Top             =   75
            Visible         =   0   'False
         ...
         Begin VB.ComboBox Combo2 
            Height          =   300
            ItemData        =   "frmComm.frx":BBA1
            Left            =   4590
            List            =   "frmComm.frx":BBA3
            TabIndex        =   74
            Top             =   480
            Visible         =   0   'False
            Width           =   1725
      ...
      Begin FPSpread.vaSpread tblexcel 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmComm.frx":BBA5
      End
...
On Error GoTo ErrorRoutine
    ...
    With objSpd
        For intRow = 1 To .maxrows
            .GetText 4, intRow, varTmp:    strBarno = Trim$(varTmp)      '-- 검체번호
                        ...
                        If Not itemX Is Nothing Then
                           ...
                           If Index = 0 Then
                               If strTestCd <> "" Then
                                    ...
                                    strSvrcData = getSvrcInfo("SL_RSLTUP_M1", INS_CODE, strBarno, strTestCd, strPNo, strResult, CurrUser.CuUserID, Winsock1.LocalIP)
                                    ' 개발

                                    
'                                    3. upload
'   - service : SL_RSLTUP_M1
...
'     output  : N/A
                                             ...
                                             sqlDoc = " Select RSLTPROGSTUS From HISS.SL_GNLRSLT "
                                    sqlDoc = sqlDoc & " Where SPCNO = '" & strBarno & "'"
                                    sqlDoc = sqlDoc & "   And ORDCD = '" & strTestCd & "'"
                                     
                                    Set adoRS = New ADODB.Recordset
                                    
'                                    If GetRecordset(AdoCn_ORACLE, sqlDoc, adoRS, CallForm) Then
'                                        If adoRS.RecordCount > 0 Then
'                                            lngRSLTPROGSTUS = adoRS.Fields("RSLTPROGSTUS") & ""
'                                        Else
'                                            lngRSLTPROGSTUS = 0
'                                        End If
'                                    Else
...
'                                    End If
                                    ...
                                    If lngRSLTPROGSTUS <> 0 And lngRSLTPROGSTUS >= 31 And lngRSLTPROGSTUS < 51 Then
        
                                                 sqlDoc = " INSERT INTO HISS.SL_EQUPRSLT " & vbCrLf
                                        sqlDoc = sqlDoc & "    (SEQ,        SPCNO,      ORDCD,      EXAMEQUPCD,  RETEQUPEXAMCD," & vbCrLf
                                        sqlDoc = sqlDoc & "     EQUPRSLT,   FLAGCDLST,  ERRCDLST,   RACKNO,      POSNO," & vbCrLf
                                        sqlDoc = sqlDoc & "     EQUPSEQ,    RMK,        COMMCDYN,   COMMYN,      EXAMSTRYMD," & vbCrLf
                                        sqlDoc = sqlDoc & "     EXAMSTRHMS, RSLTINSYMD, RSLTINSHMS, RSLTCOMMYMD, RSLTCOMMHMS, " & vbCrLf
                                        sqlDoc = sqlDoc & "     EXAMID,     LSTUPDID,   LSTUPDDT)" & vbCrLf
                                        sqlDoc = sqlDoc & "  Values ( " & vbCrLf
                                        sqlDoc = sqlDoc & "     HISS.S_SL_EQUPRSLT.NEXTVAL, '" & strBarno & "','" & strTestCd & "','" & INS_CODE & "','" & itemX.tag & "'," & vbCrLf
                                        sqlDoc = sqlDoc & "     '" & strResult & "','','','',''," & vbCrLf
                                        sqlDoc = sqlDoc & "     0,'','N','N','" & Format(Now, "yyyymmdd") & "'," & vbCrLf
                                        sqlDoc = sqlDoc & "     '" & Format(Now, "hhmmss") & "','" & Format(Now, "yyyymmdd") & "','" & Format(Now, "hhmmss") & "','',''," & vbCrLf
                                        sqlDoc = sqlDoc & "     '" & CurrUser.CuUserID & "','" & CurrUser.CuUserID & "', sysdate ) "
...
Private Sub cmdRstQuery_Click()
    ...
    sqlDoc = "Select SPCNO, TESTCD, EQUIPCD, EQPNUM, TRANSDT, RSTVAL, REFVAL, TRANSDT, EQPNUM, PATID, PNM, SEX " & _
             "  From INTERFACE003" & _
             " Where TRANSDT = '" & Format(dtpRsltDay.Value, "yyyymmdd") & "'" & _
             "   And EQUIPCD = '" & INS_CODE & "'"
    
'    If cboOrdDt.text <> "" Then
'        sqlDoc = sqlDoc & "   And mid(SPCNO,2,6) = '" & Mid(cboOrdDt.text, 3) & "' "
'    End If
...
'    End If
    ...
    Do While Not adoRS.EOF
        ...
        If strSpcno <> Trim$(adoRS("TRANSDT") & "") + Trim$(adoRS("SPCNO") & "") Then
                ...
                .SetText 7, intRow, Trim$(adoRS("SEX") & "")
'                .SetText 7, intRow, Trim$(adoRS("KEY3") & "")
            End If
...
Private Sub GetOrder(ByVal pBarNo As String)
    ...
    Else
        i = 0
        '-- 바코드번호로 환자정보 가져오기
        Set mAdoRs = f_subSet_WorkList(pBarNo, pBarNo, pBarNo)
        If Not mAdoRs.EOF Then
            With spdResult1
                intRow = f_funGet_SpreadRow(spdResult1, 3, pBarNo)
                If intRow < 1 Then
                    intRow = f_funGet_SpreadRow(spdResult1, 3, "")
                    spdResult1.maxrows = spdResult1.maxrows + 1
                    spdResult1.RowHeight(spdResult1.maxrows) = 13
                    intRow = spdResult1.maxrows
                    
                    If mAdoRs.Fields(4) = "M" Then
                        strSexAge = "남/" & mAdoRs.Fields(5)
                    ElseIf AdoRs_ORACLE.Fields(2) = "F" Then
                        strSexAge = "여/" & mAdoRs.Fields(5)
                    Else
                        strSexAge = "-/" & mAdoRs.Fields(5)
                    End If
                    
                    spdResult1.SetText 1, intRow, "1"
                    spdResult1.SetText 2, intRow, mAdoRs.Fields(0)    '-- 처방일자(Hidden)
                    spdResult1.SetText 3, intRow, mAdoRs.Fields(1)    '-- 검체번호
                    spdResult1.SetText 4, intRow, mAdoRs.Fields(2)    '-- 등록번호
                    spdResult1.SetText 5, intRow, mAdoRs.Fields(3)    '-- 이름
                    spdResult1.SetText 6, intRow, strSexAge           '-- 성별/나이
                    spdResult1.SetText 7, intRow, mAdoRs.Fields(6)    '-- 접수정보(Hidden)
                
                    '-- 바코드번호로 검사정보 가져오기
                    Set mAdoRs1 = f_subSet_WorkList(pBarNo, pBarNo, pBarNo)
                
                    '-- 해당 검사에 대한 장비채널을 획득(오더채널 배열에 담아둠)
                    Do Until mAdoRs1.EOF
                        ReDim Preserve fChannel(mAdoRs1.RecordCount)
            ...
            End With
        Else
            '"해당 바코드의 환자정보가 존재하지 않습니다."', vbInformation, App.Title
        End If
...
'    Dim objBuffer    As clsIISBuffer     '버퍼클래스
        ...
        For intCnt = 1 To .bufcnt
            ...
            Select Case strType
                ...
                Case "O"    '## Order
                    ...
                    pGrid_Point = SeqSearch(spdResult1, strBarno, 4)

                    If pGrid_Point = 0 Then
                        pGrid_Point = SeqNullSearch(spdResult1, strBarno, 4)
                        If pGrid_Point = 0 Then
                    ...
                    '-- 검사진행상태 조회
                    strSvrcData = getSvrcInfo("SL_SPCMD_L12", "SPC", strBarno, "", "", "", "", "", "", "")
                    varSvcData = Split(strSvrcData, "|")
                    
                    blnSameCode = False
                    
                    For i = 0 To UBound(varSvcData) Step 2
                        If varSvcData(i) = "C3825" Then
                            blnSameCode = True
                            If varSvcData(i + 1) = "B" Then
                                lblStatus.Caption = strBarno & " 검체는 채취/접수 상태입니다."
                                           
                                           strAlarm = "Varian II - 2" & vbNewLine
                                strAlarm = strAlarm & strBarno & " 검체는 채취/접수 상태입니다." & vbNewLine
                            ElseIf varSvcData(i + 1) = "N" Then
                                lblStatus.Caption = strBarno & " 검체는 결과보고 상태입니다."
                    ...
                    ' 평촌
                    strSvrcData = getSvrcInfo("SL_INTFC_L2", strBarno)
                    If strSvrcData = "" Then
                        spdResult1.SetText 2, pGrid_Point, pGrid_Point   '-- No
                        spdResult1.SetText 4, pGrid_Point, strBarno   '-- 검체번호
                    End If
                    ...
                    If strSvrcData <> "" Then
                        spdResult1.SetText 2, pGrid_Point, pGrid_Point   '-- No
                        spdResult1.SetText 3, pGrid_Point, CStr(varSvcData(2))   '-- W/N [ANo]
                        spdResult1.SetText 4, pGrid_Point, strBarno   '-- 검체번호
                        spdResult1.SetText 5, pGrid_Point, CStr(varSvcData(7))   '-- 등록번호
                        spdResult1.SetText 6, pGrid_Point, CStr(varSvcData(8))   '-- 이름
                        strPatInfo = "환자명 : " & CStr(varSvcData(8)) & " [" & CStr(varSvcData(7)) & "]"
                        
                        spdResult1.SetText 7, pGrid_Point, CStr(varSvcData(9)) & "/" & CStr(varSvcData(10))   '-- 성별/나이
                        spdResult1.SetText 8, pGrid_Point, CStr(varSvcData(11))   '-- 진료과
                        spdResult1.SetText 9, pGrid_Point, CStr(varSvcData(12))   '-- 직전결과
                        spdResult1.SetText 10, pGrid_Point, CStr(varSvcData(14))   '-- 직전결과보고일
                        DoEvents
                    End If
                ...
                Case "R"    '## Result
                    If strSvrcData <> "" Then
                        If CStr(varSvcData(3)) <> "C3825" Then
                            lblStatus.Caption = strBarno & " 검체는 HbA1C 검사가 없습니다."
                                       
                                       strAlarm = "Varian II - 2" & vbNewLine
                            strAlarm = strAlarm & strPatInfo & vbNewLine
                            strAlarm = strAlarm & strBarno & " 검체는 HbA1C 검사가 없습니다." & vbNewLine
                        End If
                    End If
                    ...
                    '## 결과유형중 AREA만 HBA1C의 결과!
                    If strFlag = "AREA" Then
                        spdResult1.Col = pDocount + 12
                        For intCol = 11 To spdResult1.MaxCols
                            ...
                            Set itemX = lvwCuData.FindItem(Trim$(varTmp), lvwSubItem, , lvwWhole)
                            If Not itemX Is Nothing Then
                                If strIntBase <> "" And strIntBase = itemX.tag Then          ' 검사결과가 있으면...
    
                                    spdResult1.Row = pGrid_Point
                                    spdResult1.Col = intCol: spdResult1.text = strResult
                                    If strSvrcData <> "" Then
                                    ...
                                    Case "F"
                                        If strResult > 25 Then
                                                       strAlarm = "Varian II - 2" & vbNewLine
                                            strAlarm = strAlarm & strPatInfo & vbNewLine
                                            strAlarm = strAlarm & strBarno & " 검체는 HbF 가 25%가 넘는 검사결과입니다." & vbNewLine
                                        End If
                                    Case "TOTAL"
                                        If strResult < 1 Then
                                                       strAlarm = "Varian II - 2" & vbNewLine
                                            strAlarm = strAlarm & strPatInfo & vbNewLine
                                            strAlarm = strAlarm & strBarno & " 검체는 Total Area 가 1백만이 안되는 검사결과입니다." & vbNewLine
                                        End If
                                        If strResult > 3.5 Then
                                                       strAlarm = "Varian II - 2" & vbNewLine
                                            strAlarm = strAlarm & strPatInfo & vbNewLine
                                            strAlarm = strAlarm & strBarno & " 검체는 Total Area 가 3.5백만이 넘는 검사결과입니다." & vbNewLine
                                        End If
                                    Case "P3"
                                        If strResult > 10 Then
                                                       strAlarm = "Varian II - 2" & vbNewLine
                                            strAlarm = strAlarm & strPatInfo & vbNewLine
                                            strAlarm = strAlarm & strBarno & " 검체는 P3 가 10%가 넘는 검사결과입니다." & vbNewLine
                                        End If
                                    Case "P4"
                                        If strResult > 10 Then
                                                       strAlarm = "Varian II - 2" & vbNewLine
                                            strAlarm = strAlarm & strPatInfo & vbNewLine
                                            strAlarm = strAlarm & strBarno & " 검체는 P4 가 10%가 넘는 검사결과입니다." & vbNewLine
                                        End If
                                    Case "Variant Window"
                                                   strAlarm = "Varian II - 2" & vbNewLine
                                        strAlarm = strAlarm & strPatInfo & vbNewLine
                                        strAlarm = strAlarm & strBarno & " 검체는 Variant Window 나온 결과입니다." & vbNewLine
                                        .state = ""
                                    End Select
                                    
                                    If Mid(strBarno, 1, 2) = "LC" And strIntBase = "A1c" Then
                                        ...
                                        'Point|201106091200|1|2|418761|33790|289|22|0900|0006|93|6|sa|||9.7|
                                                         ...
                                                         strQC_LCResult = "Point" & "|"
                                        strQC_LCResult = strQC_LCResult & Format(Now, "yyyymmddhhmm") & "|" '-- Date Time
                                        strQC_LCResult = strQC_LCResult & "1" & "|"                         ' run
                                        strQC_LCResult = strQC_LCResult & "1" & "|"                         ' level
                                        strQC_LCResult = strQC_LCResult & "418758" & "|"                    ' lab
                                        strQC_LCResult = strQC_LCResult & Right(strBarno, 5) & "|"          '-- Sample No
                                        strQC_LCResult = strQC_LCResult & "289" & "|"
                                        strQC_LCResult = strQC_LCResult & "22" & "|"
                                        strQC_LCResult = strQC_LCResult & "0900" & "|"
                                        strQC_LCResult = strQC_LCResult & "0006" & "|"
                                        strQC_LCResult = strQC_LCResult & "93" & "|"
                                        strQC_LCResult = strQC_LCResult & "6" & "|"
                                        strQC_LCResult = strQC_LCResult & "sa" & "|"
                                        strQC_LCResult = strQC_LCResult & "" & "|"
                                        strQC_LCResult = strQC_LCResult & "" & "|"
                                        strQC_LCResult = strQC_LCResult & strResult & "|"
                
                                    End If
                                    
                                    If Mid(strBarno, 1, 2) = "HC" And strIntBase = "A1c" Then
                                                         strQC_HCResult = "Point" & "|"
                                        strQC_HCResult = strQC_HCResult & Format(Now, "yyyymmddhhmm") & "|" '-- Date Time
                                        strQC_HCResult = strQC_HCResult & "1" & "|"
                                        strQC_HCResult = strQC_HCResult & "2" & "|"
                                        strQC_HCResult = strQC_HCResult & "418758" & "|"
                                        strQC_HCResult = strQC_HCResult & Right(strBarno, 5) & "|" '-- Sample No
                                        strQC_HCResult = strQC_HCResult & "289" & "|"
                                        strQC_HCResult = strQC_HCResult & "22" & "|"
                                        strQC_HCResult = strQC_HCResult & "0900" & "|"
                                        strQC_HCResult = strQC_HCResult & "0006" & "|"
                                        strQC_HCResult = strQC_HCResult & "93" & "|"
                                        strQC_HCResult = strQC_HCResult & "6" & "|"
                                        strQC_HCResult = strQC_HCResult & "sa" & "|"
                                        strQC_HCResult = strQC_HCResult & "" & "|"
                                        strQC_HCResult = strQC_HCResult & "" & "|"
                                        strQC_HCResult = strQC_HCResult & strResult & "|"
                                        
                                        strQCResult = strQC_LCResult & vbCrLf & strQC_HCResult & vbCrLf
                                    End If
    ...
    '                                spdResult1.Col = 3: spdResult1.Row = pGrid_Point: strBarno = spdResult1.text
                                    spdResult1.GetText 6, pGrid_Point, strName
                                    '-- 키 추가 받은결과에서 서버저장용
                                    spdResult1.GetText 5, pGrid_Point, strKey1  '등록번호
                                    spdResult1.GetText 3, pGrid_Point, strKey3  'W/N
                                    spdResult1.GetText 7, pGrid_Point, strKey2  '성별/나이
                                    
                                    
                                    'On Error Resume Next
                                    
                                    sqlDoc = "insert into INTERFACE003(" & _
                                             "            SPCNO, PATID, TESTCD, EQPNUM, TRANSDT, TRANSTM, RSTVAL, REFVAL, EQUIPCD, SERVERGBN, PNM, SEX)" & _
                                             "    values( '" & strBarno & "', '" & strKey1 & "', '" & itemX.tag & "','" & strKey3 & "', " & _
                                             "            '" & Format$(Now, "YYYYMMDD") & "', '" & Format$(Now, "HHMMSS") & "'," & _
                                             "            '" & strResult & "', ''," & _
                                             "            '" & INS_CODE & "', '','" & strName & "','" & strKey2 & "')"
    
                                    AdoCn_Jet.Execute sqlDoc
                                    'On Error GoTo 0
                                    If strQCResult <> "" Then
                                        Open "C:\RMX\EXE\VariantII\QC2\" & Format(Now, "yyyymmdd") & ".DAT" For Append As #6
                                        Print #6, strQCResult;
                                        Close #6
                                        strQCResult = ""
                                    End If
        ...
        For intRow = 1 To .maxrows
            ...
            If .Value = "1" Then
                ...
                Select Case cInterface.Snd_Phase
                    ...
                    Case 0      '## 최초 오더 전송인 경우
                        '## Header
                        strOutput = "H|\^&|||SEO^1|||||SOOK|RSUPL^BATCH|P|1" & vbCr
                        
                        '## Patient
                        strOutput = strOutput & "P|1" & vbCr
                        .Col = 2: strYear = Trim(.text)
                        .Col = 3: strWorkNo = Trim(.text)
                        
                        For pDocount = 8 To .MaxCols
                            .Row = intRow
                            .Col = pDocount
                            .GetText 2, intRow, varTmp:    strYear = Trim$(varTmp)
                            .GetText 3, intRow, varTmp:    strWorkNo = Trim$(varTmp)
                            .GetText 4, intRow, varTmp:    strSPnm = Trim$(varTmp)
                            .GetText 5, intRow, varTmp:    strRack = Trim$(varTmp)
                            .GetText 6, intRow, varTmp:    strPos = Trim$(varTmp)
                            .Row = intRow
                            .Col = pDocount
                            If .BackColor = &HC6FEFF Then
                                .GetText pDocount, 0, varTmp
                                Set itemX = lvwCuData.FindItem(Trim$(varTmp), lvwSubItem, , lvwWhole)
                                ReDim Preserve fChannel(intChannel)
                                fChannel(intChannel) = itemX.tag
                                intChannel = intChannel + 1
                            End If
                        Next
                        
                        strOrder = objOrder.GetOrder(fChannel)
                        
                        strWorkNo1 = Mid(strWorkNo, 8)
                        If strOrder <> "" Then
                            '## 접수정보가 있는경우: 검체유형, 응급유무는 수신한것을 따름!
                            strOutput = strOutput & "O|1|0" & Format$(strWorkNo1, "0000") & "^A" & Format(strYear, "yymmdd") & Val(strWorkNo1) & Space(12 - Len(Format(strYear, "yymmdd") & Val(strWorkNo1))) & _
                                        "^1^^|R1|" & strOrder & "|R||" & _
                                        Format(Now, "yyyymmddhhmmss") & "||||N||^^||||||A" & Format(Now, "yyyy") & Format(strYear, "yyyymmdd") & Val(strWorkNo1) & "^^^^||||||O" & vbCr
                        Else
                    ...
                    Case 1      '## 오더 전송후 남은 문자열이 있는 경우
                        strOutput = "2" & objOrder.Order
                        cInterface.Snd_Phase = 0
                End Select
            
                If Len(strOutput) >= 230 Then
                    objOrder.Order = Mid$(strOutput, 231)
