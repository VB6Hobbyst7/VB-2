...
Global Const REG_POSITION   As String = "Software\디딤정보\평촌성심병원\" & REG_INSNAME
...
Public Function getSvrcInfo(ByVal strSrcNm As String, ByVal strArg1 As String, _
    ...
    Select Case strSvrNm
        ...
        Case "CC_SYSDATE_S"
            intRow = 1
            If fbput(ByVal sendBuf.bufptr, fbget_fldkey("GW_LOCATE"), ByVal "7", 0) = -1 Then
                ErrMsg = tmaxerrdesc(gettperrno())
...
'        Case "AP_PATBA_S7"
'            intRow = 14
'            If fbput(ByVal sendBuf.bufptr, fbget_fldkey("S_STRING1"), ByVal strText1, 0) = -1 Then
'                errMsg = tmaxerrdesc(gettperrno())
'                MsgBox "Tmax Error Number : " & gettperrno() & vbNewLine & errMsg, vbOKOnly + vbCritical, "TMAX 에러"
'                GoTo memoryfree
'            End If
'
'            If strText2 <> "" Then
'                If fbput(ByVal sendBuf.bufptr, fbget_fldkey("S_STRING2"), ByVal strText2, 0) = -1 Then
'                    errMsg = tmaxerrdesc(gettperrno())
'                    MsgBox "Tmax Error Number : " & gettperrno() & vbNewLine & errMsg, vbOKOnly + vbCritical, "TMAX 에러"
'                    GoTo memoryfree
'                End If
...
'
'            If strText3 <> "" Then
'                If fbput(ByVal sendBuf.bufptr, fbget_fldkey("S_STRING3"), ByVal strText3, 0) = -1 Then
'                    errMsg = tmaxerrdesc(gettperrno())
'                    MsgBox "Tmax Error Number : " & gettperrno() & vbNewLine & errMsg, vbOKOnly + vbCritical, "TMAX 에러"
'                    GoTo memoryfree
'                End If
...
'
'            If strText4 <> "" Then
'                If fbput(ByVal sendBuf.bufptr, fbget_fldkey("S_STRING4"), ByVal strText4, 0) = -1 Then
'                    errMsg = tmaxerrdesc(gettperrno())
'                    MsgBox "Tmax Error Number : " & gettperrno() & vbNewLine & errMsg, vbOKOnly + vbCritical, "TMAX 에러"
'                    GoTo memoryfree
'                End If
...
'
'            If strText5 <> "" Then
'                If fbput(ByVal sendBuf.bufptr, fbget_fldkey("S_STRING5"), ByVal strText5, 0) = -1 Then
'                    errMsg = tmaxerrdesc(gettperrno())
'                    MsgBox "Tmax Error Number : " & gettperrno() & vbNewLine & errMsg, vbOKOnly + vbCritical, "TMAX 에러"
'                    GoTo memoryfree
'                End If
...
'
'            If strText6 <> "" Then
'                If fbput(ByVal sendBuf.bufptr, fbget_fldkey("S_STRING6"), ByVal strText6, 0) = -1 Then
'                    errMsg = tmaxerrdesc(gettperrno())
'                    MsgBox "Tmax Error Number : " & gettperrno() & vbNewLine & errMsg, vbOKOnly + vbCritical, "TMAX 에러"
'                    GoTo memoryfree
'                End If
...
'
'            If strText7 <> "" Then
'                If fbput(ByVal sendBuf.bufptr, fbget_fldkey("S_STRING7"), ByVal strText7, 0) = -1 Then
'                    errMsg = tmaxerrdesc(gettperrno())
'                    MsgBox "Tmax Error Number : " & gettperrno() & vbNewLine & errMsg, vbOKOnly + vbCritical, "TMAX 에러"
'                    GoTo memoryfree
'                End If
...
'
'            If strText8 <> "" Then
'                If fbput(ByVal sendBuf.bufptr, fbget_fldkey("S_STRING8"), ByVal strText8, 0) = -1 Then
'                    errMsg = tmaxerrdesc(gettperrno())
'                    MsgBox "Tmax Error Number : " & gettperrno() & vbNewLine & errMsg, vbOKOnly + vbCritical, "TMAX 에러"
'                    GoTo memoryfree
'                End If
...
'
'            If strText9 <> "" Then
'                If fbput(ByVal sendBuf.bufptr, fbget_fldkey("S_STRING9"), ByVal strText9, 0) = -1 Then
'                    errMsg = tmaxerrdesc(gettperrno())
'                    MsgBox "Tmax Error Number : " & gettperrno() & vbNewLine & errMsg, vbOKOnly + vbCritical, "TMAX 에러"
'                    GoTo memoryfree
'                End If
...
'    ElseIf strSvrNm = "AP_PATBA_S7" Then
...
'            For intCnt = 1 To intRow
'                strGet(intCnt) = String$(1024, Chr$(0))
'                iRet = fbget(ByVal rcvbuf.bufptr, ByVal fbget_fldkey("S_STRING" & intCnt), ByVal strGet(intCnt), 0)
'                If iRet > 0 And Trim(strGet(intCnt)) <> "" Then
'                    getSvrcInfo = getSvrcInfo & Mid(strGet(intCnt), 1, InStr(strGet(intCnt), Chr(0)) - 1) & "|"
'                End If
'            Next
...
'    frmComm.List1.AddItem getSvrcInfo
...
'    If tmaxreadenv("C:\RMX\ENV\RMX.env", "190.65") = -1 Then
''    If tmaxreadenv("C:\RMX\ENV\RMX.env", "DEV") = -1 Then
'        ErrMsg = tmaxerrdesc(gettperrno())
'        MsgBox "Tmax Error Number : " & gettperrno() & vbNewLine & ErrMsg, vbOKOnly + vbCritical, "TMAX 에러"
'        Exit Sub
'    End If
...
'    End If
''
''    '-- tmaxreadenv(Address, Port Information)
'    strPtr = tpgetenv(ByVal "TMAX_HOST_ADDR")
'    retVal = Space$(100)
'    lret = lstrcpy(ByVal retVal, ByVal strPtr&)
''    frmLogin.lblAddr.Caption = retVal
'
'   strPtr = tpgetenv(ByVal "TMAX_HOST_PORT")
'    retVal = Space$(100)
'    lret = lstrcpy(ByVal retVal, ByVal strPtr&)
''    frmLogin.lblPort.Caption = retVal
'
        initcheck = True
    End If
'    Call Sleep(15000)
