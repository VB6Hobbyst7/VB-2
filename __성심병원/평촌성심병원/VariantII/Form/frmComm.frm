...
Begin VB.Form frmComm 
   ...
   Begin TabDlg.SSTab tabWork 
      ...
      Tab(0).Control(22)=   "cmdPosNo"
      Tab(0).Control(22).Enabled=   0   'False
      Tab(0).Control(23)=   "Command2"
      Tab(0).Control(23).Enabled=   0   'False
      Tab(0).Control(24)=   "cmdNext"
      Tab(0).Control(24).Enabled=   0   'False
      Tab(0).Control(25)=   "cmdPrevious"
      Tab(0).Control(25).Enabled=   0   'False
      Tab(0).Control(26)=   "spdResult1"
      Tab(0).Control(26).Enabled=   0   'False
      Tab(0).Control(27)=   "cmdWorkList"
      Tab(0).Control(27).Enabled=   0   'False
      Tab(0).Control(28)=   "cmdSel(2)"
      Tab(0).Control(28).Enabled=   0   'False
      Tab(0).Control(29)=   "cmdSel(3)"
      Tab(0).Control(29).Enabled=   0   'False
      Tab(0).Control(30)=   "cmdCLR"
      Tab(0).Control(30).Enabled=   0   'False
      Tab(0).Control(31)=   "txtDump"
...
'    Dim objBuffer    As clsIISBuffer     '버퍼클래스
                        ...
                        If varSvcData(i) = "C3825" Then
                            ...
                            If varSvcData(i + 1) = "B" Then
                                lblStatus.Caption = strBarno & " 검체는 채취/접수 상태입니다."
                                           ...
                                           strAlarm = "Varian II - 1" & vbNewLine
                            ...
                            ElseIf varSvcData(i + 1) = "N" Then
                                lblStatus.Caption = strBarno & " 검체는 결과보고 상태입니다."
                                           strAlarm = "Varian II - 1" & vbNewLine
                                strAlarm = strAlarm & strBarno & " 검체는 결과보고 상태입니다." & vbNewLine
                            End If
                        End If
                    Next
                            ...
                            If Not itemX Is Nothing Then
                                If strIntBase <> "" And strIntBase = itemX.tag Then          ' 검사결과가 있으면...
                                    ...
                                    If Mid(strBarno, 1, 2) = "LC" And strIntBase = "A1c" Then
                                        ...
                                        strQC_LCResult = strQC_LCResult & "418761" & "|"                    ' lab
                                    ...
                                    If Mid(strBarno, 1, 2) = "HC" And strIntBase = "A1c" Then
                                        ...
                                        strQC_HCResult = strQC_HCResult & "418761" & "|"
    ...
    '                                spdResult1.Col = 3: spdResult1.Row = pGrid_Point: strBarno = spdResult1.text
                                    ...
                                    'On Error GoTo 0
                                    If strQCResult <> "" Then
                                        Open "C:\RMX\EXE\VariantII\QC1\" & Format(Now, "yyyymmdd") & ".DAT" For Append As #6
                                        Print #6, strQCResult;
                                        Close #6
                                        strQCResult = ""
                                    End If
