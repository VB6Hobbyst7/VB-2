...
Begin VB.Form frmComm 
   ...
   Begin TabDlg.SSTab tabWork 
      ...
      Tab(1).Control(7)=   "chkExcel"
      Tab(1).Control(7).Enabled=   0   'False
      Tab(1).Control(8)=   "cmdSel(4)"
      Tab(1).Control(8).Enabled=   0   'False
      Tab(1).Control(9)=   "cmdSel(5)"
      ...
      Begin BHButton.BHImageButton cmdNext 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         TransparentPicture=   "frmComm.frx":A70B
         ForeColor       =   16711680
         BackColor       =   255
         AlphaColor      =   255
         ImgOutLineSize  =   3
      ...
      Begin FPSpread.vaSpread spdResult2 
         ...
         ScrollBarMaxAlign=   0   'False
         ShadowColor     =   14735310
         SpreadDesigner  =   "frmComm.frx":B46D
         UserResize      =   0
      End
      ...
      Begin FPSpread.vaSpread spdWorklist 
         ...
         ScrollBarMaxAlign=   0   'False
         ShadowColor     =   14735310
         SpreadDesigner  =   "frmComm.frx":B8C0
         UserResize      =   2
      End
      ...
      Begin Threed.SSPanel SSPanel1 
         ...
         Begin VB.ComboBox cboChk 
            Height          =   300
            ItemData        =   "frmComm.frx":BDFD
            Left            =   5160
            List            =   "frmComm.frx":BE07
            TabIndex        =   61
            Top             =   90
            Width           =   1095
         End
         Begin VB.ComboBox cboComNm 
            Height          =   300
            ItemData        =   "frmComm.frx":BE1B
            Left            =   4590
            List            =   "frmComm.frx":BE1D
            TabIndex        =   60
            Top             =   480
            Visible         =   0   'False
            Width           =   1725
      ...
      Begin Threed.SSPanel SSPanel 
         ...
         Begin VB.ComboBox cboOrdDt 
            Height          =   300
            ItemData        =   "frmComm.frx":BE1F
            Left            =   4590
            List            =   "frmComm.frx":BE21
            TabIndex        =   88
            Top             =   90
            Visible         =   0   'False
            Width           =   1185
         ...
         Begin VB.ComboBox cboChk1 
            Height          =   300
            ItemData        =   "frmComm.frx":BE23
            Left            =   2610
            List            =   "frmComm.frx":BE2D
            TabIndex        =   87
            Top             =   90
            Visible         =   0   'False
            Width           =   1905
         ...
         Begin VB.ComboBox cboRstgbn 
            Height          =   300
            Index           =   1
            ItemData        =   "frmComm.frx":BE41
            Left            =   5850
            List            =   "frmComm.frx":BE4E
            Style           =   2  '드롭다운 목록
            TabIndex        =   74
            Top             =   75
            Visible         =   0   'False
         ...
         Begin VB.ComboBox Combo2 
            Height          =   300
            ItemData        =   "frmComm.frx":BE78
            Left            =   4590
            List            =   "frmComm.frx":BE7A
            TabIndex        =   73
            Top             =   480
            Visible         =   0   'False
            Width           =   1725
      ...
      Begin FPSpread.vaSpread tblexcel 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmComm.frx":BE7C
      End
                ...
                Case "R"    '## Result
                    ...
                    Select Case strIntBase
                        Case "351": 'CA 19-9
                            ...
                            Else
                                strResult = Mid(strResult, 1, InStr(strResult, ".") + 2)
                            End If
...
'                                    End If
                                    ...
                                    'Analyte set
                                    Select Case strIntBase
                                        Case "370": strAnalyte = "222" 'Cyfra 21-1
                                                    strUnit = "2"      'ng/mL
                                        Case "250": strAnalyte = "447"  'Myoglobin
                                                    strUnit = "36"      'U/mL
                                        Case "351": strAnalyte = "230"  'CA 19-9
                                                    strUnit = "36"      'U/mL
                                        Case "341": strAnalyte = "231"  'CA 125
                                                    strUnit = "36"      'U/mL
                                        Case "321": strAnalyte = "343"  'PSA, Total
                                                    strUnit = "2"      'ng/mL
                                        Case "332": strAnalyte = "229"  'CA 15-3
                                                    strUnit = "36"      'U/mL
                                        Case "391": strAnalyte = "223"  'PSA, Free
                                                    strUnit = "2"       'ng/mL
                                        Case "650": strAnalyte = "103"  'Insulin
                                                    strUnit = "33"      'U/mL
                                        
                                    End Select
                                    
                                    If Mid(strBarno, 1, 2) = "PC" Then
...
''                                        '-- Insulin
''                                        If strIntBase = "650" Then
''                                            strQCResult = strQCResult & "157697" & "|"                    ' lot
''                                        Else
''                                            strQCResult = strQCResult & "159792" & "|"                    ' lot
''                                        End If
                                        ...
                                        'strQCResult = strQCResult & "1180" & "|"                      ' instrument //Roche Cobas e 411
...
'                                    End If
                                    ...
                                    If strQCResult <> "" Then
                                        Open "C:\RMX\EXE\E411\QC\" & Format(Now, "yyyymmdd") & ".DAT" For Append As #6
                                        Print #6, strQCResult;
                                        Close #6
                                        strQCResult = ""
                                    End If
