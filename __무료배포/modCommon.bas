...
On Error GoTo onError
    ...
    '-- 레지스트리 백업
    If UpLoad("C:\OKSOFT.REG", "/san/interface/" & gHOSP.HOSPNM & "/" & gHOSP.MACHNM & "/" & "OKSOFT.REG", ASCII) Then
        'success
    Else
...
Public Sub GetExeVersion()
    ...
    '-- HOSPITAl INFO GET
    strSetup = "":    strSetUp1 = ""
    Call GetPrivateProfileString("EXE", "HOSP", "", strSetup, 100, App.PATH & "\OKSOFT.ini")
