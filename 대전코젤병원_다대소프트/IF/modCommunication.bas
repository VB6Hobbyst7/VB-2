...
'                End If
                ...
                '알러지용
                If Trim(GetText(frmMain.spdOrder, i, colBARCODE)) = Trim(pBarno) And Trim(GetText(frmMain.spdOrder, i, colRACKNO)) = Trim(mResult.Kind) Then
                    mResult.BarNo = Trim(GetText(frmMain.spdOrder, i, colBARCODE))
                    mResult.PatNo = Trim(GetText(frmMain.spdOrder, i, colPID))
                    intRow = i
                    Exit For
...
'                            mOrder.BarNo = pBarno
        ...
        Call SetText(.spdOrder, mResult.MnmCd, intRow, colRACKNO)
