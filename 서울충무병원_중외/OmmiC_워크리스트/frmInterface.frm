...
Begin VB.Form frmInterface 
   ...
   Begin VB.Frame FrmHideControl 
      ...
      Begin VB.Frame Frame3 
         ...
         Begin FPSpread.vaSpread vasRID 
            ...
            RetainSelBlock  =   0   'False
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":7F5C
            UserResize      =   2
         End
      ...
      Begin FPSpread.vaSpread vasCode 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":898D
      End
      Begin FPSpread.vaSpread vasTemp1 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":8BB3
      End
         ...
         Begin MSComctlLib.ImageList imlStatus 
            ...
            BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
               ...
               BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":9E97
                  Key             =   "STOP"
               EndProperty
               BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":A431
                  Key             =   "LST"
               EndProperty
               BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":ACC3
                  Key             =   "ITM"
               EndProperty
               BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":AE1D
                  Key             =   "ERR"
               EndProperty
               BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":AF77
                  Key             =   "NOF"
               EndProperty
            EndProperty
         End
      ...
      Begin FPSpread.vaSpread vasList 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":B0D1
      End
      Begin FPSpread.vaSpread vasResTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":B2F7
      End
      Begin FPSpread.vaSpread vasTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":B51D
      End
   ...
   Begin TabDlg.SSTab stInterface 
      ...
      TabPicture(0)   =   "frmInterface.frx":B743
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.ComboBox cboChk 
            Height          =   315
            ItemData        =   "frmInterface.frx":B75F
            Left            =   3720
            List            =   "frmInterface.frx":B76C
            TabIndex        =   72
            Top             =   300
            Width           =   825
         End
         ...
         Begin FPSpread.vaSpread vasRes 
            ...
            RetainSelBlock  =   0   'False
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":B782
         End
         ...
         Begin FPSpread.vaSpread vasWorkList 
            ...
            RetainSelBlock  =   0   'False
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":F49E
            UserResize      =   2
         End
         Begin FPSpread.vaSpread vasID 
            ...
            RetainSelBlock  =   0   'False
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":FEF1
            UserResize      =   2
         End
         Begin VB.Label Label1 
            Appearance      =   0  '평면
...
Private Sub cmdExcel_Click()
    ...
    For iRow = 1 To vasRID.DataRowCnt
        ...
        If vasRID.Value = 1 Then
            ...
            SetText vasPrint, Trim(GetText(vasRID, iRow, colAge)), j, 4
...
'    Debug.Print gAllExam
    ...
    '-- 검사대상자 가져오기
'''    SQL = ""
'''    SQL = SQL & " SELECT Distinct a.ENTERDATE, b.WAITSEQNO, c.SUJINNAME, a.CHARTNO, a.SUJINPART " & vbLf
'''    SQL = SQL & "   FROM " & gDB_Parm.DB & "..WAITPRSNP a, " & gDB_Parm.DB & "..JUN370_RESULTTB b, " & gDB_Parm.DB & "..PEWPRSNP c, " & gDB_Parm.DB & "..BAGMAP2PREF d " & vbLf
'''    SQL = SQL & "  WHERE a.ENTERDATE BETWEEN  '" & pFrDt & "' AND '" & pToDt & "' " & vbLf
...
'''        SQL = SQL & "    AND a.SUJINPART = '62' " & vbLf
'''    ElseIf cboChk.ListIndex = 2 Then
'''        SQL = SQL & "    AND a.SUJINPART <> '62' " & vbLf
'''    End If
'''
'''    SQL = SQL & "  ORDER BY a.ENTERDATE "
        
          SQL = "SELECT RECEIPTNO, RECEIPTDATE, PTNO, SPECIMENNUM, SNAME,IPDOPD, AGE, ORDERCODE, LABCODE " & vbLf
    SQL = SQL & vbCrLf & "  FROM SLA_LabMaster " & vbLf
    SQL = SQL & vbCrLf & " WHERE RECEIPTDATE between '" & Format(pFrDt, "####-##-##") & "' and '" & Format(pToDt, "####-##-##") & "'" & vbLf
    SQL = SQL & vbCrLf & "   AND LABCODE = 'C3815'" & vbLf
    SQL = SQL & vbCrLf & "   AND JSTATUS < '3'" & vbLf
    '입원
    If cboChk.ListIndex = 1 Then
        SQL = SQL & "    AND IpdOpd = 1 " & vbLf
    '외래
    ElseIf cboChk.ListIndex = 2 Then
        SQL = SQL & "    AND IpdOpd = 0 " & vbLf
    End If
    ...
    Do Until RS.EOF
        ...
        SetText vasWorkList, Trim(RS.Fields("RECEIPTNO")), intRow, colOrdDate
        SetText vasWorkList, Trim(RS.Fields("RECEIPTDATE")) & "", intRow, colBarcode
        SetText vasWorkList, Trim(RS.Fields("PTNO")), intRow, colPID
        SetText vasWorkList, Trim(RS.Fields("SPECIMENNUM")), intRow, colPName
        SetText vasWorkList, Trim(RS.Fields("SNAME")), intRow, colPName
        SetText vasWorkList, IIf(Trim(RS.Fields("IPDOPD")) = 1, "입원", "외래"), intRow, colPName
        SetText vasWorkList, Trim(RS.Fields("AGE")), intRow, colPName
...
Private Sub Command16_Click()
    ...
    strBuffer = "R 000101 00012012144928"
    
'    strBuffer = "D 000101 00011013002042    E012    18  017   129  018    26  "
    strBuffer = "D 001001 00012012144928    0001   7.5r 002   4.7r 003   2.8r 004   1.7r 005  0.41r 006  0.08r 007  0.33r 008    24r 009    25r 010    38r 011   186r 012    17r 013   8.9r 014  0.88r 015  10.1r 016   195r 017   162r 018    32r 022   107r 023   8.4r "
    
    
    strBuffer = "SMP_NEW_DATAaMOD855iIID04390rTYPESAMPLErSEQ27025rDATE21J" & _
...
strBuffer = ""
    strBuffer = strBuffer & "1H|\^&||||||||||P||" & vbCr & "05" & vbCrLf

    strBuffer = strBuffer & "2P|1|||||||||||||||||||||||||||||||||" & vbCr & "3B" & vbCrLf

    strBuffer = strBuffer & "3O|1|@3|3^0^3^^SAMPLE^NORMAL|ALL|R|20140228143513|||||X||||||||||||||O|||||" & vbCr & "4B" & vbCrLf

    strBuffer = strBuffer & "4R|1|^^^430^^0|1^0.024|COI|^|N||F|||20140228144222|20140228150042|" & vbCr & "81" & vbCrLf

    strBuffer = strBuffer & "5R|2|^^^440^^0|-1^0.110|COI|^|N||F|||20140228144304|20140228150124|" & vbCr & "AF" & vbCrLf

    strBuffer = strBuffer & "6L|1" & vbCr & "3F" & vbCrLf
...
Private Sub GetOrder(ByVal pBarNo As String)
    ...
    Call SetText(vasID, mOrder.RackNo, intRow, colOrdDate)     '4  Rack번호
    Call SetText(vasID, mOrder.TubePos, intRow, colPID)     '5  Pos번호
...
Private Sub SetPatInfo(ByVal pBarNo As String)
    ...
    Call SetText(vasID, mResult.RackNo, intRow, colOrdDate)        '3 Rack
    Call SetText(vasID, mResult.TubePos, intRow, colPID)        '4 Pos
    Call vasActiveCell(vasID, intRow, colBarcode)
    ...
    For intCnt = 1 To UBound(strRecvData)
        ...
        Select Case strType
            ...
            Case "O"    '## Order
                ...
                strBarno = Trim(mGetP(mGetP(strRcvBuf, 4, "|"), 2, "^"))
                For i = 1 To vasID.DataRowCnt
                    vasID.Row = i
                    vasID.Col = colSeqNo
                    If vasID.Text = strBarno Then
...
'Const colState = 12
    ...
    SQL = SQL & "EXAMDATE,EQUIPNO,BARCODE,DISKNO,POSNO," & vbCrLf & _
                "PID,PNAME,PAGE,EQUIPCODE,EXAMCODE,SEQNO," & vbCrLf & _
    ...
    SQL = SQL & "'" & Trim(GetText(vasID, asRow1, colSpcNo)) & "', "
    SQL = SQL & "'" & Trim(GetText(vasID, asRow1, colIpdOpd)) & "', " & vbCrLf
