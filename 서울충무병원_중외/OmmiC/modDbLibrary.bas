...
'                    SQL = "Update onit_out..jun370_resulttb" & _
                ...
                SQL = SQL & vbCrLf & "   And OrderCode in ('E','ELE','C3815') " 'LABCODE = 'BLOODGAS'
'                SQL = SQL & vbCrLf & "   And OrderCode = '" & strEqpCd & "' "
'                SQL = SQL & vbCrLf & "   And LabCode in ('E','ELE','C3815') " 'LABCODE = 'BLOODGAS'
...
'    End If
    ...
    'sBarcode = "445082"
          ...
          SQL = "SELECT RECEIPTNO, RECEIPTDATE, PTNO, SPECIMENNUM, SNAME,IPDOPD, AGE, ORDERCODE, LABCODE "
    SQL = SQL & " FROM SLA_LabMaster "
'    SQL = SQL & vbCrLf & " WHERE RECEIPTNO = '" & sBarcode & "' "
    SQL = SQL & vbCrLf & " WHERE SPECIMENNUM = '" & sBarcode & "' "
    SQL = SQL & vbCrLf & "   AND OrderCode in ('E','ELE','C3815') "
...
Function GetOrderExamCode(argEquipCode As String, argPID As String) As String
    ...
    SQL = SQL & vbCrLf & "   AND a.OrderCode in ('E','ELE','C3815') "
