...
Private Sub cmdConfirm_Click()
    ...
    Else
        ...
        Call WritePrivateProfileString("config", "gPort", gSetup.gPort, App.Path & "\didim.ini")
        Call WritePrivateProfileString("config", "gSpeed", gSetup.gSpeed, App.Path & "\didim.ini")
        Call WritePrivateProfileString("config", "gParity", gSetup.gParity, App.Path & "\didim.ini")
        Call WritePrivateProfileString("config", "gDataBit", gSetup.gDataBit, App.Path & "\didim.ini")
        Call WritePrivateProfileString("config", "gStopBit", gSetup.gStopBit, App.Path & "\didim.ini")
        Call WritePrivateProfileString("config", "gStartBit", gSetup.gStartBit, App.Path & "\didim.ini")
        Call WritePrivateProfileString("config", "ACKUse", gSetup.ACKUse, App.Path & "\didim.ini")
