...
Public cn_Ser2 As ADODB.Connection
...
Public Function Connect_Server2() As Boolean

    Connect_Server2 = False
...
On Error GoTo errFind
    ...
    With cn
        .ConnectionString = "Provider=Microsoft.Jet.OLEDB.4.0;" & _
                            "User ID=;" & _
                            "Password=;" & _
                            "Data Source=" & App.Path & "\didim.mdb;" & _
                            "Persist Security Info=True"
        .Open
    End With
...
Public Function GetDBSelectVas(argServer As Integer, argSQL As String, ByVal argSpread As fpSpread, Optional argRow As Long = 1, Optional argCol As Long = 1) As Integer
...
On Error GoTo ErrHandle
    ...
    Case gLocal
        Set cmdSQL.ActiveConnection = cn
    Case gLocal_1
        Set cmdSQL.ActiveConnection = cn2
    Case Else
        Exit Function
    End Select
    cmdSQL.CommandText = argSQL
...
Public Function db_select_HVas(argServer As Integer, argSQL As String, argSpread As fpSpread, Optional argRow As Long = 1, Optional argCol As Long = 1) As Integer
    Dim i, j As Integer
