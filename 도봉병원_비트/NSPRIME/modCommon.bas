...
Public Const colSN = 13         'Serial No
...
'    gQCEquip = Trim(frmInterface.txtTemp)
    ...
    db_tmp = ""
    Call GetPrivateProfileString("config", "CTYPE", "", db_tmp, 100, App.Path & "\Interface.ini")
    frmInterface.txtTemp = Trim(db_tmp)
    gCTYPE = Trim(frmInterface.txtTemp)
