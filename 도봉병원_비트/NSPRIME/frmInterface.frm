...
Begin VB.Form frmInterface 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin FPSpread.vaSpread vasRes 
         ...
         RetainSelBlock  =   0   'False
         ScrollBars      =   2
         SpreadDesigner  =   "frmInterface.frx":1F83
      End
   End
   ...
   Begin VB.Frame FrmHideControl 
      ...
      Begin VB.Frame Frame5 
         ...
         Begin VB.ComboBox cboChk 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmInterface.frx":35DB
            Left            =   2460
            List            =   "frmInterface.frx":35E8
            TabIndex        =   68
            Top             =   1680
            Visible         =   0   'False
            Width           =   975
         ...
         Begin VB.ComboBox cboTest 
            ...
            ForeColor       =   &H00FF0000&
            Height          =   300
            ItemData        =   "frmInterface.frx":3600
            Left            =   600
            List            =   "frmInterface.frx":3602
            Style           =   2  '드롭다운 목록
            TabIndex        =   67
            Top             =   1650
            Visible         =   0   'False
      ...
      Begin VB.Frame Frame4 
         ...
         Begin FPSpread.vaSpread vasPrint 
            ...
            EndProperty
            MaxCols         =   9
            SpreadDesigner  =   "frmInterface.frx":3604
         End
         Begin FPSpread.vaSpread vasPrintBuf 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            SpreadDesigner  =   "frmInterface.frx":3A6A
         End
      End
      ...
      Begin FPSpread.vaSpread vasCode 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":3C8C
      End
      Begin FPSpread.vaSpread vasTemp1 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":3EAE
      End
         ...
         Begin MSComctlLib.ImageList imlStatus 
            ...
            BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
               ...
               BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":465A
                  Key             =   "RUN"
               EndProperty
               BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":4BF4
                  Key             =   "NOT"
               EndProperty
               BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":518E
                  Key             =   "STOP"
               EndProperty
               BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":5728
                  Key             =   "LST"
               EndProperty
               BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":5FBA
                  Key             =   "ITM"
               EndProperty
               BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":6114
                  Key             =   "ERR"
               EndProperty
               BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":626E
                  Key             =   "NOF"
               EndProperty
            EndProperty
         End
      ...
      Begin FPSpread.vaSpread vasList 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":63C8
      End
      Begin FPSpread.vaSpread vasResTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":65EA
      End
      Begin FPSpread.vaSpread vasTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":680C
      End
      Begin FPSpread.vaSpread vasExcel 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":6A2E
      End
...
''    Exit Sub
    ...
    vasRes.MaxRows = 0
          ...
          SQL = " SELECT '', SAVESEQ, EXAMDATE AS TESTDATE , MID(EXAMDATE,1,8) AS EXAMDATE, HOSPDATE AS 접수일자, BARCODE AS 바코드번호, CHARTNO AS 차트번호, PID AS 내원번호, PNAME AS 이름,PSEX AS 성별, PAGE AS 나이, DISKNO, POSNO, EXAMCODE, RESULT, REFFLAG, SAMPLETYPE, SENDFLAG,INOUT " & vbCrLf
        ...
        Do Until RS.EOF
            With vasID
                ...
                If blnSame = False Then
                    ...
                    SetText vasID, Trim(RS.Fields("TESTDATE")) & "", .MaxRows, colEXAMDATE
...
'    stInterface.Tab = 0
    ...
    If gCTYPE = "1" Then
        optTest(0).Value = False
        optTest(1).Value = True
    Else
        optTest(0).Value = True
        optTest(1).Value = False
    End If
...
Private Sub optTest_Click(Index As Integer)
    ...
    If optTest(0).Value = True Then
        Call WritePrivateProfileString("config", "CTYPE", "0", App.Path & "\Interface.ini")
    Else
        Call WritePrivateProfileString("config", "CTYPE", "1", App.Path & "\Interface.ini")
    End If
...
Private Sub EditRcvDataASTM()
    ...
    'DC9001S01 41Low           0.211    90       06/01/202014:36:3000  1 1
    'DU  12001 212006010218    0.090    54    (-)06/01/202016:14:4900  1 1[Tx]0C5F[Tx]DU  13001 312006010217    0.004     3    (-)06/01/202016:15:0100  1 1[Tx]0C3A
    'DC9002S01 51High          0.719   251       06/02/202015:01:4600  1 1
...
'    strSeqNo = Trim(Mid(strRcvBuf, 3, 4))
    ...
    '06/01/202014:36:30
    strTestTime = Trim(Mid(strRcvBuf, 45, 18))
    
    strTestTime = Mid(strTestTime, 7, 4) & Mid(strTestTime, 1, 2) & Mid(strTestTime, 4, 2) & Mid(strTestTime, 11, 8)
    ...
    If Trim(strBarNo) <> "" Then
        ...
        With mResult
            .BarNo = strBarNo
            .RsltDate = strTestTime 'Format(Now, "yyyymmddhhmmss")
            .RsltSeq = getMaxTestNum(Format(dtpToday, "yyyymmdd"))
        End With
        
        If gCTYPE = 0 And strBarNo = "" Then
            Exit Sub
        End If
...
'''            If CCur(strResult) > 100 Then
'''                '2020.06.15
'''                'strResult = "Positive(>100)"
