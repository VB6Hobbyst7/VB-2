   ...
   Begin TabDlg.SSTab stInterface 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin FPSpread.vaSpread vasWorkList 
            ...
            RetainSelBlock  =   0   'False
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":B6C9
            UserResize      =   2
         End
         ...
         Begin VB.ComboBox cboChk 
            ...
            EndProperty
            Height          =   300
            ItemData        =   "frmInterface.frx":C19D
            Left            =   2340
            List            =   "frmInterface.frx":C1A7
            TabIndex        =   45
            Top             =   -90
            Visible         =   0   'False
            Width           =   765
         ...
         Begin FPSpread.vaSpread vasID 
            ...
            RetainSelBlock  =   0   'False
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":C1B7
            UserResize      =   2
         End
         Begin FPSpread.vaSpread vasRes 
            ...
            RetainSelBlock  =   0   'False
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":CCBD
         End
...
Private Sub GetWorkList_Bar(ByVal pBarNo As String)
    Dim i           As Integer
    Dim intRow      As Long
    ...
    strRequest = strRequest & "mach_cd" + vbTab + "09" + vbTab + vbCr
...
'  OrdStr:='jobs'       + TAB + 'Q' + TAB +
    ...
    If UBound(varResponse) > 0 Then
        For i = 0 To UBound(varResponse) - 1
            If vasWorkList.DataRowCnt = 0 Then
                ...
                SetText vasWorkList, Mid(mGetP(varResponse(i), 25, vbTab), 1, 8), intRow, colOrdDate
                SetText vasWorkList, mGetP(varResponse(i), 0, vbTab), intRow, colBarcode
                SetText vasWorkList, mGetP(varResponse(i), 7, vbTab), intRow, colPID
                SetText vasWorkList, mGetP(varResponse(i), 26, vbTab), intRow, colPName
            ...
            Else
                '-- Same Check
                intRow = getSameRowNum(Trim(mGetP(varResponse(i), 0, vbTab)))
                If intRow = 0 Then
    ...
    Else
        ...
        SetText vasWorkList, CStr(txtNum), gRow, colSeqNo
        'SetText vasWorkList, Mid(mGetP(varResponse(i), 25, vbTab), 1, 8), intRow, colOrdDate
        SetText vasWorkList, pBarNo, gRow, colBarcode
        SetText vasWorkList, "오더없음", gRow, colPName
    End If
    ...
    With vasWorkList
        For intRow = 1 To .MaxRows
            ...
            If .Value = "1" Then
                ...
                '-- Pos
                '2O 0101018N0150210-01-28 01-28      00077694        김덕안          U   20150210 1.01122 M11 M1  M2  M3  M7  M4  M5  M16 M17 M12 M30 M31 M32 M6  M13 M14 M15 M 07
...
'    End If
    ...
    If chkBarcode.Value = "1" Then
        strItems = GetOrderExamCode(gEquip, pBarNo)
        SetText vasWorkList, strItems, intRow, colPos
        SetText vasWorkList, Len(strItems) / 4, intRow, colOCnt
    End If
    ...
    Call SetText(vasWorkList, "Order", intRow, colState)         '12 진행상태
...
'                For intQ = 1 To Len(strRcvBuf) Step 13
'                    strBarno = mid(strrcvbuf,intQ
'
'                Next
                
                For intQ = 0 To UBound(varRcvBuf) - 1
                    If Trim(varRcvBuf(intQ)) = "" Then
                        Exit For
                    Else
                        strBarno = varRcvBuf(intQ)
                        Call GetOrder(strBarno)
                        strState = "Q"
                    End If
                Next
                    ...
                    If strResult <> "" Then
                        ...
                        Else
                            ...
                            If Res > 0 Then
                                ...
                                SetText vasRes, lsExamCode, lsResRow, colExamCode       '검사코드
                                SetText vasRes, lsExamName, lsResRow, colExamName       '검사명
                                SetText vasRes, lsEquipRes, lsResRow, colMachResult          '결과
                                SetText vasRes, strResult, lsResRow, colResult          '결과
                                SetText vasRes, lsSeqNo, lsResRow, colSeq               '순번
                                SetText vasRes, strComm, lsResRow, colFLAG              'Flag
                                '-- 로컬 저장
