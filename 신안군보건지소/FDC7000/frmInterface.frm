...
Begin VB.Form frmInterface 
   ...
   Begin VB.Frame FrmHideControl 
      ...
      Begin VB.Frame Frame7 
         ...
         Begin FPSpread.vaSpread vasWorkList 
            ...
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":25AD
            UserResize      =   2
         End
      ...
      Begin VB.Frame Frame4 
         ...
         Begin FPSpread.vaSpread vasPrint 
            ...
            EndProperty
            MaxCols         =   9
            SpreadDesigner  =   "frmInterface.frx":30BB
         End
         Begin FPSpread.vaSpread vasPrintBuf 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            SpreadDesigner  =   "frmInterface.frx":4B34
         End
      End
      Begin FPSpread.vaSpread vasOrder 
         ...
         EndProperty
         MaxCols         =   10
         SpreadDesigner  =   "frmInterface.frx":4D4C
      End
         ...
         Begin MSComctlLib.ImageList imlStatus 
            ...
            BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
               ...
               BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":92F7
                  Key             =   "RUN"
               EndProperty
               BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":9891
                  Key             =   "NOT"
               EndProperty
               BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":9E2B
                  Key             =   "STOP"
               EndProperty
               BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":A3C5
                  Key             =   "LST"
               EndProperty
               BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":AC57
                  Key             =   "ITM"
               EndProperty
               BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":ADB1
                  Key             =   "ERR"
               EndProperty
               BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":AF0B
                  Key             =   "NOF"
               EndProperty
            EndProperty
         End
      ...
      Begin FPSpread.vaSpread vasList 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":B065
      End
      Begin FPSpread.vaSpread vasResTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":B27D
      End
      Begin FPSpread.vaSpread vasTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":B495
      End
   ...
   Begin TabDlg.SSTab stInterface 
      ...
      TabPicture(0)   =   "frmInterface.frx":B6AD
      Tab(0).ControlEnabled=   -1  'True
      Tab(0).Control(0)=   "Frame1"
      Tab(0).Control(0).Enabled=   0   'False
      Tab(0).ControlCount=   1
      TabCaption(1)   =   "이전결과"
      TabPicture(1)   =   "frmInterface.frx":B6C9
      ...
      Begin VB.Frame Frame3 
         ...
         Begin FPSpread.vaSpread vasRID 
            ...
            RetainSelBlock  =   0   'False
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":F3E7
            UserResize      =   2
         End
      ...
      Begin VB.Frame Frame1 
         ...
         Begin FPSpread.vaSpread vasID 
            ...
            RetainSelBlock  =   0   'False
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":FE46
            UserResize      =   2
         End
         ...
         Begin FPSpread.vaSpread vasRes 
            ...
            RetainSelBlock  =   0   'False
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":1093A
         End
...
Function Get_Work_Info() As Long
    ...
    '20160620|20160620|N1701|201606200014|WB2570|00028319|유영숙|2008092218025794|660205|2AAEH5AzCa/Nbahrnjg+CfnvC|2|C1|
    '20160620|20160620|N1701|201606200014|WB2580|00028319|유영숙|2008092218025794|660205|2AAEH5AzCa/Nbahrnjg+CfnvC|2|C1|
    
'    vasID.MaxRows = 0
    intRow = 0
    
    For i = 0 To UBound(varSend) - 1
        If InStr(gAllExam, mGetP(varSend(i), 5, "|")) > 0 Then
            If lsPID <> mGetP(varSend(i), 4, "|") Then
                intRow = intRow + 1
                vasID.MaxRows = intRow
                
                vasID.SetText colOrdDate, intRow, mGetP(varSend(i), 1, "|")
                vasID.SetText colBarcode, intRow, mGetP(varSend(i), 4, "|")
                vasID.SetText colPName, intRow, mGetP(varSend(i), 7, "|")
                vasID.SetText colPID, intRow, mGetP(varSend(i), 6, "|")
            End If
            lsPID = mGetP(varSend(i), 4, "|")
        End If
    Next
...
Private Sub Form_Resize()
    ...
    If cmdSL.Caption = "▶" Then
        Frame1.Height = frmInterface.ScaleHeight - 1400
        vasID.Height = Frame1.Height - 800
        Frame1.Width = frmInterface.ScaleWidth - 300
        vasID.Width = frmInterface.ScaleWidth - 7400
        Frame6.Left = vasID.Width + 200
        vasRes.Height = vasID.Height - 700
        vasRes.Left = Frame6.Left
                
        Frame3.Height = frmInterface.ScaleHeight - 1400
        vasRID.Height = Frame3.Height - 800
        Frame3.Width = frmInterface.ScaleWidth - 300
        vasRID.Width = frmInterface.ScaleWidth - 7400
        Frame5.Left = vasRID.Width + 200
        vasRRes.Height = vasRID.Height - 700
        vasRRes.Left = Frame5.Left
        
    Else
        Frame1.Height = frmInterface.ScaleHeight - 1400
        vasID.Height = Frame1.Height - 800
        Frame1.Width = frmInterface.ScaleWidth - 400
        vasID.Width = frmInterface.ScaleWidth - 650
    
        Frame3.Height = frmInterface.ScaleHeight - 1400
        vasID.Height = Frame3.Height - 800
        Frame3.Width = frmInterface.ScaleWidth - 400
        vasRID.Width = frmInterface.ScaleWidth - 650
    End If
    
    StatusBar1.Panels(3).Width = Frame1.Width - 8500
    
    stInterface.Width = Frame1.Width + 200
    stInterface.Height = Frame1.Height + 500
...
'''
'''    'R,NORMAL ,2012-12-[Rx]21,16:01,3            ,             ,             ,49,0,000,01,01,GOT-PS  ,=,21       U/l   ,03,0    ,0    , @         x
'''    'R,NORMAL ,[Rx]2012-12-21,15:57,2            ,             ,             ,49,0,000,01,06,Na-PS   ,=,****     mEq/l ,  ,0    ,0    ,        E 8,K-PS    ,=,****     mEq/l ,  ,0.0  ,0.0  ,        E 8,Cl-PS   ,<,-OR      mEq/l ,  ,0    ,0    ,        E 3,GOT-PS  ,=,7        U/l   ,01,0    ,0    , @         ,GOT-PS  ,=,7        U/l   ,01,0    ,0    , @         ,GOT-PS  ,=,7        U/l   ,01,0    ,0    , @         A
'''
'''    strRcvBuf = strBuffer
'''
...
'''            End If
'''            strTestNo = Trim(mGetP(strRcvBuf, 5, ","))
'''
'''            For i = 1 To vasWorkList.DataRowCnt
'''                vasWorkList.Row = i
'''                vasWorkList.Col = 1
...
'''
'''                strResult = Trim(Mid(strResult, 1, 9))
'''                strResult = Replace(strResult, "=", "")
'''                strResult = Replace(strResult, "  ", " ")
'''                strResult = Replace(strResult, "  ", " ")
'''                strResult = Replace(strResult, "  ", " ")
'''
'''                If strIntBase = "TCHO-PS" Then
'''                    strTC = strResult
'''                End If
'''
'''                If strIntBase = "TG-PS" Then
'''                    strTG = strResult
'''                End If
'''
'''                If strIntBase = "HDLC-PS" Then
'''                    strHDL = strResult
'''                End If
'''
'''                If strResult <> "" Then
...
'''            Next
'''
''''                If blnLDLCal = True And strTC <> "" And strTG <> "" And strHDL <> "" And IsNumeric(strTC) And IsNumeric(strTG) And IsNumeric(strHDL) Then
...
Private Sub EditRcvDataASTM()
    ...
    'R,NORMAL ,2012-12-21,16:01,3            ,             ,             ,49,0,000,01,01,GOT-PS  ,=,21       U/l   ,03,0    ,0    , @         x
    'R,NORMAL ,2012-12-21,15:57,2            ,             ,             ,49,0,000,01,06,Na-PS   ,=,****     mEq/l ,  ,0    ,0    ,        E 8,K-PS    ,=,****     mEq/l ,  ,0.0  ,0.0  ,        E 8,Cl-PS   ,<,-OR      mEq/l ,  ,0    ,0    ,        E 3,GOT-PS  ,=,7        U/l   ,01,0    ,0    , @         ,GOT-PS  ,=,7        U/l   ,01,0    ,0    , @         ,GOT-PS  ,=,7        U/l   ,01,0    ,0    , @         A
    
    ' 1234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890
    'NORMAL 2015-12-1511:041            1512150001  01GPT-P  =22       U/l   1            GOT-P  =21       U/l   1            DBIL-P =0.8      mg/dl 1 H #        
    'NORMAL 2015-12-1511:041            1512150001  01GPT-P  =22       U/l   1            GOT-P  =21       U/l   1            DBIL-P =0.8      mg/dl 1 H #        
    ...
    'For intCnt = 1 To UBound(strRecvData)
        ...
        Select Case strType
            ...
            Case "N"    '## Result
                ...
                strTestNo = Trim(Mid(strRcvBuf, 23, 1))
                ...
                'GPT-P  =22       U/l   1            GOT-P  =21       U/l   1            DBIL-P =0.8      mg/dl 1 H #        
