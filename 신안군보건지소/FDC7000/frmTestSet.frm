...
Begin VB.Form frmTestSet 
   ...
   Begin FPSpread.vaSpread vasList 
      ...
      SpreadDesigner  =   "frmTestSet.frx":13BC
   End
...
Private Sub ClearText()
    ...
    txtSiteID.Text = gHPID
    txtUserID.Text = gUID
    txtEqCd.Text = gHPEquip
...
Private Sub DisplayList()
    ...
    SQL = "SELECT EQUIPCODE, EXAMCODE, EXAMNAME, RESPREC, SEQNO, REFLOW, REFHIGH " & vbCrLf & _
          ...
          " GROUP BY EXAMCODE, EQUIPCODE, EXAMNAME, RESPREC, SEQNO, REFLOW, REFHIGH " & vbCrLf
...
Private Sub cmdSave_Click()
    ...
    If Res = 1 Then
        SQL = "UPDATE EQPMASTER " & vbCrLf & _
              ...
              "  AND EXAMCODE = '" & Trim(txtCode) & "' "
    ElseIf Res = 0 Then
        SQL = "INSERT INTO EQPMASTER (EQUIPNO,EQUIPCODE, EXAMCODE, EXAMNAME, RESPREC, SEQNO , REFLOW, REFHIGH) " & vbCrLf & _
...
Private Sub txtEqCd_KeyPress(KeyAscii As Integer)

    If KeyAscii = vbKeyReturn And Trim(txtEqCd.Text) <> "" Then
        Call WritePrivateProfileString("DATABASE", "EquipCode", CStr(txtEqCd.Text), App.Path & "\Interface.ini")
    End If
...
Private Sub txtSiteID_KeyPress(KeyAscii As Integer)

    If KeyAscii = vbKeyReturn And Trim(txtSiteID.Text) <> "" Then
        
        Call WritePrivateProfileString("DATABASE", "SiteID", CStr(txtSiteID.Text), App.Path & "\Interface.ini")
...
Private Sub txtUserID_KeyPress(KeyAscii As Integer)
    ...
    If KeyAscii = vbKeyReturn And Trim(txtUserID.Text) <> "" Then
        Call WritePrivateProfileString("DATABASE", "UserID", CStr(txtUserID.Text), App.Path & "\Interface.ini")
    End If
