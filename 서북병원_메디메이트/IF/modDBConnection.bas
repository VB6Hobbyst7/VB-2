...
'          FServerIP:= ReadString('HOSP', 'IP', 'LIS_ADMIN');
'          FServerSvc:= ReadString('HOSP', 'SVC', '');
'          FServerID:= ReadString('HOSP', 'ID', 'sblisdb');
'          FServerPwd:= DecryptPassword(ReadString('HOSP', 'PWD', ''));    //SBHS
    ...
    If UserName = "" Then
        Select Case gEMR
            ...
            Case "MEDIMATE":    UserName = "LIS_ADMIN"
        End Select
    End If
    ...
    If Password = "" Then
        Select Case gEMR
            ...
            Case "MEDIMATE":    Password = "sblisdb"
        End Select
    End If
...
'PWD=bit
    ...
    If ServerName = "" Then
        Select Case gEMR
            ...
            Case "BIT70":       ServerName = "192.168.0.10" '부천가은
            Case "EONM":        ServerName = "EES"
            ...
            Case "BITU":        ServerName = "58.145.11.2" '스마일내과
        End Select
    End If
    ...
    If DatabaseName = "" Then
        Select Case gEMR
            ...
            Case "BITU":        DatabaseName = "drbitpack"
        End Select
    End If
    ...
    If UserName = "" Then
        Select Case gEMR
            ...
            Case "BITU":        UserName = "interface_base"
        End Select
    End If
