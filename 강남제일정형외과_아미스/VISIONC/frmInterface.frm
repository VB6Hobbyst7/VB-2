...
Begin VB.Form frmInterface 
   ...
   Begin VB.Frame FrmHideControl 
      ...
      End
      Begin FPSpread.vaSpread vasIDPrint 
         Height          =   1305
         Left            =   5220
         TabIndex        =   80
         Top             =   5280
   ...
   Begin VB.Frame Frame1 
      ...
      Begin FPSpread.vaSpread vasRes 
         ...
         RetainSelBlock  =   0   'False
         ScrollBars      =   2
         SpreadDesigner  =   "frmInterface.frx":8A7F
      End
   End
...
Private Sub cmdPrint_Click()
    ...
    vasIDPrint.MaxRows = 0
    With vasID
        For i = 1 To .MaxRows
            .Row = i
            .Col = 1
            If .Value = "1" Then
                vasIDPrint.MaxRows = vasIDPrint.MaxRows + 1
                For j = 1 To vasIDPrint.MaxCols
                    Call SetText(vasIDPrint, GetText(vasID, i, j), vasIDPrint.MaxRows, j)
                Next
            End If
        Next
    End With
    
    vasIDPrint.PrintOrientation = PrintOrientationPortrait '세로출력
    vasIDPrint.Action = 13
...
'    SQL = SQL & "  ORDER BY a.RECEIPTDATE, a.RECEIPTTIME "
    ...
    SQL = SQL & "   AND O.ORDERCODE IN (" & gOrderCD & ") "
    If chkSaveAll.Value = "0" Then
...
'''                            If Val(strResult) < 9 Then
'''                                strResult = "NEGATIVE:" & strResult
'''                            ElseIf Val(strResult) > 11 Then
...
'''                            blnSave = False
'''                        Else
'''                            If UCase(Trim(strResult)) = "NEG" Then
'''                                strResult = "NEGATIVE:" & strIntResult
'''                            ElseIf UCase(Trim(strResult)) = "POS" Then
...
'''                End Select
'''
'''                If blnSave = True And strResult <> "" Then
'''                    SQL = ""
