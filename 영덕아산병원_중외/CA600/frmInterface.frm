...
Begin VB.Form frmInterface 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin FPSpread.vaSpread vasRes 
         ...
         RetainSelBlock  =   0   'False
         ScrollBars      =   2
         SpreadDesigner  =   "frmInterface.frx":2127
      End
   End
   ...
   Begin VB.Frame FrmHideControl 
      ...
      Begin VB.ComboBox cboChk 
         ...
         EndProperty
         Height          =   315
         ItemData        =   "frmInterface.frx":3826
         Left            =   4320
         List            =   "frmInterface.frx":3833
         TabIndex        =   74
         Top             =   3390
         Width           =   975
      End
      ...
      Begin VB.ComboBox cboTest 
         ...
         ForeColor       =   &H00FF0000&
         Height          =   300
         ItemData        =   "frmInterface.frx":3849
         Left            =   7170
         List            =   "frmInterface.frx":384B
         Style           =   2  '드롭다운 목록
         TabIndex        =   71
         Top             =   3090
         Visible         =   0   'False
      ...
      Begin VB.Frame Frame4 
         ...
         Begin FPSpread.vaSpread vasPrintBuf 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            SpreadDesigner  =   "frmInterface.frx":52C6
         End
      End
      ...
      Begin FPSpread.vaSpread vasCode 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":54DE
      End
      Begin FPSpread.vaSpread vasTemp1 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":56F6
      End
         ...
         Begin MSComctlLib.ImageList imlStatus 
            ...
            BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
               ...
               BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":5E98
                  Key             =   "RUN"
               EndProperty
               BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":6432
                  Key             =   "NOT"
               EndProperty
               BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":69CC
                  Key             =   "STOP"
               EndProperty
               BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":6F66
                  Key             =   "LST"
               EndProperty
               BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":77F8
                  Key             =   "ITM"
               EndProperty
               BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":7952
                  Key             =   "ERR"
               EndProperty
               BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":7AAC
                  Key             =   "NOF"
               EndProperty
            EndProperty
         End
      ...
      Begin FPSpread.vaSpread vasList 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":7C06
      End
      Begin FPSpread.vaSpread vasResTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":7E1E
      End
      ...
      Begin FPSpread.vaSpread vasExcel 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":824E
      End
...
Private Sub GetWorkList_JWINFO(ByVal pFrDt As String, ByVal pToDt As String, Optional pBarNo As String)
    ...
    vasID.ReDraw = False
          ...
          SQL = "SELECT DISTINCT RECEIPTDATE, SPECIMENNUM, RECEIPTNO, IPDOPD, PTNO, SNAME, LABCODE, ORDERCODE"
        ...
        Do Until RS.EOF
            ...
            With vasID
                ...
                For i = 1 To .DataRowCnt
                    ...
                    If Trim(RS("RECEIPTDATE")) = strDate And Trim(RS("SPECIMENNUM")) = strBarcode Then
                        blnSame = True
                    End If
                    
                    For intCol = colState + 1 To vasID.MaxCols
                        If Trim(RS.Fields("LABCODE")) = gArrEquip(intCol - colState, 3) Then
                            vasID.Row = .MaxRows
                            vasID.Col = intCol
                            vasID.BackColor = vbYellow
                            Exit For
                ...
                If blnSame = False Then
                    .MaxRows = .MaxRows + 1
                    SetText vasID, "1", .MaxRows, colCheckBox
                    SetText vasID, Trim(RS.Fields("RECEIPTDATE")) & "", .MaxRows, colHOSPDATE
                    SetText vasID, Trim(RS.Fields("SPECIMENNUM")) & "", .MaxRows, colBARCODE
                    SetText vasID, Trim(RS.Fields("RECEIPTNO")) & "", .MaxRows, colCHARTNO
                    SetText vasID, Trim(RS.Fields("PTNO")) & "", .MaxRows, colPID
                    SetText vasID, Trim(RS.Fields("SNAME")) & "", .MaxRows, colPNAME
...
Private Sub GetOrder(ByVal pBarNo As String)
    ...
    strItems = GetEquipExamCode_CA620(gEquip, pBarNo, intRow)
...
Function GetEquipExamCode_CA620(argEquipCode As String, argPID As String, argRow As Long) As String
    ...
    For i = 0 To UBound(gReadBuf)
        If gReadBuf(i) <> "" Then
            ...
            If strIntBase <> strTemp Then
                If Mid(Trim(gReadBuf(i)), 1, 2) <> "99" Then
...
Private Sub EditRcvDataASTM()
    ...
    Select Case sBC
        ...
        'R2210101U1610261059000101       00152806B           040      050      
        Case "R2"
        ...
        '        10        20        30        40        50
        '123456789012345678901234567890123456789012345678901234567890
        'D1210101U1610251556000103       00152632B           041  178 042  409 043  159 044  155 051  354 052 ---- 054  --- 055 ---- 
        'D1210101U1611071056000301       00154008B           041  165 042  450 043  147 044  144 
        Case "D1"
            strBarNo = Trim(Mid(strRcvBuf, 26, 15))
