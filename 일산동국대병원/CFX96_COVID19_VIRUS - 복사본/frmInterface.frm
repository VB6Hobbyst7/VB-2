...
Begin VB.Form frmInterface 
   ...
   Begin VB.Frame FrmHideControl 
      ...
      Begin FPSpread.vaSpread vasResult 
         ...
         ScrollBars      =   2
         SpreadDesigner  =   "frmInterface.frx":1271
         UserResize      =   2
      End
   ...
   Begin VB.Frame Frame4 
      ...
      Begin FPSpread.vaSpread vasPrint 
         ...
         EndProperty
         MaxCols         =   9
         SpreadDesigner  =   "frmInterface.frx":1D1F
      End
      Begin FPSpread.vaSpread vasPrintBuf 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":222A
      End
   End
   Begin TabDlg.SSTab stInterface 
      ...
      EndProperty
      TabCaption(0)   =   "진행상태"
      TabPicture(0)   =   "frmInterface.frx":2450
      Tab(0).ControlEnabled=   -1  'True
      Tab(0).Control(0)=   "Frame1"
      Tab(0).Control(0).Enabled=   0   'False
      Tab(0).ControlCount=   1
      TabCaption(1)   =   "결과확인"
      TabPicture(1)   =   "frmInterface.frx":246C
      ...
      Begin VB.Frame Frame1 
         ...
         Begin FPSpread.vaSpread vasID 
            ...
            MoveActiveOnFocus=   0   'False
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":2488
            UserResize      =   2
         End
         ...
         Begin FPSpread.vaSpread vasRes 
            ...
            MaxCols         =   7
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":2F22
         End
      ...
      Begin VB.Frame Frame3 
         ...
         Begin FPSpread.vaSpread vasRID 
            ...
            MoveActiveOnFocus=   0   'False
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":6C52
            UserResize      =   2
         End
         Begin FPSpread.vaSpread vasRRes 
            ...
            MaxCols         =   7
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":766F
         End
      End
   End
                    ...
                    For intCol = 1 To .MaxCols
                        ...
                        'If varTmp <> "" Then
                            ...
                            Case Is > 5
                                ...
                                If sEquipCode = "C(t)" Then
                                
                                ElseIf sEquipCode <> "" Then
                                    .GetText intCol, intRow + 1, varTmp
                                    
                                    If sEquipCode = "E gene" Then
                                        strEval = varTmp
                                        varTmp = ""
                                    ElseIf sEquipCode = "RdRP/S gene" Then
                                        strRdRPval = varTmp
                                        varTmp = ""
                                    ElseIf sEquipCode = "N gene" Then
                                        strNval = varTmp
                                        varTmp = ""
                                    End If
