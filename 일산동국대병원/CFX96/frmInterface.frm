...
Begin VB.Form frmInterface 
   ...
   Begin VB.Frame Frame4 
      ...
      Begin FPSpread.vaSpread vasPrint 
         ...
         EndProperty
         MaxCols         =   9
         SpreadDesigner  =   "frmInterface.frx":1D49
      End
   ...
   Begin TabDlg.SSTab stInterface 
      ...
      EndProperty
      TabCaption(0)   =   "진행상태"
      TabPicture(0)   =   "frmInterface.frx":39F6
      Tab(0).ControlEnabled=   0   'False
      Tab(0).Control(0)=   "Frame1"
      Tab(0).ControlCount=   1
      TabCaption(1)   =   "결과확인"
      TabPicture(1)   =   "frmInterface.frx":3A12
      ...
      Begin VB.Frame Frame1 
         ...
         Begin FPSpread.vaSpread vasID 
            ...
            MoveActiveOnFocus=   0   'False
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":3A2E
            UserResize      =   2
         End
         ...
         Begin FPSpread.vaSpread vasRes 
            ...
            MaxCols         =   7
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":44C9
         End
      ...
      Begin VB.Frame Frame3 
         ...
         Begin FPSpread.vaSpread vasRRes 
            ...
            MaxCols         =   7
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":8C64
         End
      End
   End
...
'If varTmp <> "17042553485" Then Stop
                                'If varTmp = "17042655782" Then Stop
                                If varTmp <> "" Then
                                    ispcno$ = varTmp '"12020356983" '"12020152330" ' "12020356983" ''varTmp
                                    rv = sl_d_60_sel_spcno&(ispcno$, pt_no$(), patname$(), sex$(), age$(), gnl_item_cd$(), bl_gth_dte$(), dept$(), wd_no$(), tst_cd$())
                                   ' rv = 1
...
'                                                res = db_select_Col(gLocal, SQL)
                                                ...
                                                '-- Row = 3,4 채널
'                                                .GetText intCol, intRow1 + 2, varTmp: sEquipCode = varTmp
'
'                                                Debug.Print varTmp
'
'                                                sExamCode = Get_ExamCode(sEquipCode)
...
''                                                res = db_select_Col(gLocal, SQL)
'                                                '-- 결과
'                                                .GetText intCol, intRow1 + 3, varTmp: strTmp = varTmp
'
'                                                Debug.Print varTmp
'
'                                                If strTmp = "-" Then
