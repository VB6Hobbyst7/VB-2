...
Begin VB.Form frmInterface 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin FPSpread.vaSpread vasRes 
         ...
         RetainSelBlock  =   0   'False
         ScrollBars      =   2
         SpreadDesigner  =   "frmInterface.frx":7E6A
      End
   End
   Begin VB.PictureBox Picture2 
      ...
      Begin VB.Frame Frame3 
         ...
         Begin VB.CommandButton cmdIFTrans 
            ...
            Width           =   1155
         End
         Begin MSComCtl2.DTPicker dtpRstDt 
            Height          =   345
            Left            =   1200
            TabIndex        =   73
            Top             =   210
                        ...
                        For intCol = colState + 1 To vasID.MaxCols
                            If Trim(RS.Fields("EXAMCODE")) = gArrEquip(intCol - colState, 3) Then
                                ...
                                ElseIf Trim(RS.Fields("REFFLAG")) = "L" Then
                                    ...
                                    .ForeColor = vbBlue
                                End If
                                If UCase(Trim(RS.Fields("RESULT")) & "") = "POSITIVE" Then
                                    vasID.Row = i
                                    vasID.Col = intCol
                                    vasID.BackColor = vbRed
                                    vasID.ForeColor = vbWhite
                                Else
                                    vasID.Row = i
                                    vasID.Col = intCol
                                    vasID.BackColor = vbWhite
...
'''    SetRawData "[Tx]" & strOutput
    ...
    Select Case intSndPhase
        Case 1  '## Header
            strOutput = intFrameNo & "H|\^&|||1234567890|||||||P||" & Format(Now, "yyyymmddhhmmdd") & vbCr & ETX
            intSndPhase = 2
            intFrameNo = intFrameNo + 1
        Case 2  '## Q 결과요청
            'sQuery:= '2Q|1|'+sBarCode+'||||'+sFrom+'|'+sTo+'|||S||F'+CR+ETX;
            strOutput = intFrameNo & "Q|1|" & Trim(txtRstNum.Text) & "||||" & Format(dtpStartDt.Value, "yyyymmdd000000") & "|" & Format(dtpStopDt.Value, "yyyymmdd235959") & "|||S||F" & vbCr & ETX
            intSndPhase = 3
            intFrameNo = intFrameNo + 1
        Case 3  '## Termianator
...
Private Sub SetPatInfo(ByVal pBarNo As String, Optional ByVal pRno As String, Optional ByVal pPno As String)
    ...
    Call GetSampleInfoW_DONGGUK(intRow)
...
'                    Case "TNI"
'                        If CDbl(strResult) < 0.01 Then
'                            strResult = "<0.01"
'                        ElseIf CDbl(strResult) > 10 Then
'                            strResult = ">10"
'                        End If
'                    Case "BNP"
'                        If CDbl(strResult) < 5 Then
'                            strResult = "<5"
'                        ElseIf CDbl(strResult) > 5000 Then
'                            strResult = ">5000"
'                        End If
'                    Case "CKMB"
'                        If CDbl(strResult) < 1 Then
'                            strResult = "<1.0"
'                        ElseIf CDbl(strResult) > 80 Then
'                            strResult = ">80"
'                        End If
'                    End Select
'                End If
            ...
            Case "L"
                ...
                If MnTransAuto.Checked = True And strState = "R" Then
                    ...
                    Else
                        ...
                        SetText vasID, "전송", gRow, colState
...
'        End If
    ...
    ElseIf KeyCode = vbKeyReturn Then
        If iCol = colBARCODE Then
            ...
            '-- 바뀐 바코드로 환자정보 불러오기
            Call GetSampleInfoW_DONGGUK(iRow)
