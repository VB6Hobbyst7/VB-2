...
'''
'''                                    If strTmp = "Positive Control(+)" Then
'''                                        strTmp = "Positive"
'''                                    End If
'''
'''                                    If strTmp = "Negative Control(-)" Then
'''                                        strTmp = "Negative"
'''                                    End If
'''
'''                                    If strTmp = "2019-nCoV Detected" Then
'''                                        strTmp = "Positive"
'''                                    End If
'''
'''                                    If InStr(strTmp, " Detected") > 0 Then
'''                                        strTmp = "Positive"
'''                                    End If
'''
'''
...
'''                                    Exit For
                                End If
                            Case 14
                                    'For intRow2 = intRow To intRow + 3 Step 2
...
'                                        Else
'                                            '-- 채널
'                                            .GetText intCol, intRow2, varTmp
'                                            sEquipCode = varTmp
'
'
'                                            .GetText intCol, intRow2 + 1, varTmp
'                                            strTmp = varTmp
'
'                                            sExamCode = Get_ExamCode(sEquipCode)
'                                            sExamName = Get_ExamName(sExamCode)
