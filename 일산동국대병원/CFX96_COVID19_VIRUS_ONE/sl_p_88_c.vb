...
Function sl_online_result_poct& (oerrmsg$,ispcid$(),iexamcode$(),iresult$(),ierrflag$(),iequipcd$(),iuser$())
	dim dce_table as long, Socket as integer
	...
	If (Socket > -1) Then
		...
		rv% = dce_push_array(Socket,"ierrflag",ierrflag())
		rv% = dce_push_array(Socket,"iequipcd",iequipcd())
		rv% = dce_push_array(Socket,"iuser",iuser())
		dce_table = dce_submit("sl_p_88","sl_online_result_poct",Socket)
	End If
	sl_online_result_poct = dce_pop_long(dce_table,"dce_result")
	rv% = dce_pop_string(dce_table,"oerrmsg",oerrmsg)
	Call dce_table_destroy(dce_table)
End function
...
Function sl_online_result_qcrslt& (oerrmsg$,ispcid$(),iexamcode$(),iresult$(),ierrflag$(),iequipcd$(),iuser$(),igubun$())
	dim dce_table as long, Socket as integer
	...
	If (Socket > -1) Then
		...
		rv% = dce_push_array(Socket,"iequipcd",iequipcd())
		rv% = dce_push_array(Socket,"iuser",iuser())
		rv% = dce_push_array(Socket,"igubun",igubun())
		dce_table = dce_submit("sl_p_88","sl_online_result_qcrslt",Socket)
	End If
	sl_online_result_qcrslt = dce_pop_long(dce_table,"dce_result")
	rv% = dce_pop_string(dce_table,"oerrmsg",oerrmsg)
	Call dce_table_destroy(dce_table)
End function
