...
Begin VB.Form frmInterface 
   BorderStyle     =   0  '없음
   Caption         =   " CFX96 STD-12 Interface "
   ClientHeight    =   10680
   ClientLeft      =   330
   ClientTop       =   825
   ClientWidth     =   15210
...
On Error Resume Next
    ...
    If intIDX = 0 Then
        ...
        If sFile <> "" Then
            ...
            With vasExcel
                For intRow = 2 To .DataRowCnt 'Step 13
                    For intCol = 1 To 5
    ...
    '                                Debug.Print SQL
                            ...
                            Case "5"
                                    '-- 2017.01.31 추가 검사
                                    'BPP    L25341 Bordetella parapertussis
                                    'BP     L25342 Bordetella pertussis
                                    'CP     L25343 Chlamydia pneumoniae
                                    'LP     L25344 Legionella pneumophilla
                                    'MP     L25345 Mycoplasma pneumoniae
                                    
                                    'For intCol2 = intCol To .MaxCols
                                        '-- 채널
