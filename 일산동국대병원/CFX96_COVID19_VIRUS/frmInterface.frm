...
Begin VB.Form frmInterface 
   BorderStyle     =   0  '없음
   Caption         =   " CFX96 COVID19-VIRUS Interface "
   ClientHeight    =   10680
   ClientLeft      =   330
   ClientTop       =   825
   ClientWidth     =   15210
   ...
   Begin VB.Frame FrmHideControl 
      ...
      Begin FPSpread.vaSpread vasTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":07AF
      End
      Begin FPSpread.vaSpread vasCode 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":09D1
      End
      ...
      Begin FPSpread.vaSpread vasTemp1 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":0BF3
      End
      Begin FPSpread.vaSpread vasList 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":0E15
      End
      Begin FPSpread.vaSpread vasResTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":1037
      End
      Begin FPSpread.vaSpread vasResult 
         ...
         ScrollBars      =   2
         SpreadDesigner  =   "frmInterface.frx":1259
         UserResize      =   2
      End
   ...
   Begin VB.Frame Frame4 
      ...
      Begin FPSpread.vaSpread vasPrint 
         ...
         EndProperty
         MaxCols         =   9
         SpreadDesigner  =   "frmInterface.frx":1B37
      End
      Begin FPSpread.vaSpread vasPrintBuf 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":1F9D
      End
   End
   Begin TabDlg.SSTab stInterface 
      ...
      EndProperty
      TabCaption(0)   =   "진행상태"
      TabPicture(0)   =   "frmInterface.frx":21BF
      Tab(0).ControlEnabled=   -1  'True
      Tab(0).Control(0)=   "Frame1"
      Tab(0).Control(0).Enabled=   0   'False
      Tab(0).ControlCount=   1
      TabCaption(1)   =   "결과확인"
      TabPicture(1)   =   "frmInterface.frx":21DB
      ...
      Begin VB.Frame Frame1 
         ...
         Begin FPSpread.vaSpread vasID 
            ...
            MoveActiveOnFocus=   0   'False
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":21F7
            UserResize      =   2
         End
         ...
         Begin FPSpread.vaSpread vasRes 
            ...
            MaxCols         =   7
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":2AD7
         End
      ...
      Begin VB.Frame Frame3 
         ...
         Begin FPSpread.vaSpread vasRID 
            ...
            MoveActiveOnFocus=   0   'False
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":5250
            UserResize      =   2
         End
         Begin FPSpread.vaSpread vasRRes 
            ...
            MaxCols         =   7
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":5A9B
         End
      End
   End
...
On Error Resume Next
    ...
    If intIDX = 0 Then
        ...
        If sFile <> "" Then
            ...
            With vasExcel
                For intRow = 2 To .DataRowCnt Step 2
                    For intCol = 1 To .MaxCols
                        ...
                        'If varTmp <> "" Then
                            Select Case intCol
                            Case 1
                                If oldspcno <> varTmp Then
                                    ispcno$ = varTmp '"12020356983" '"12020152330" ' "12020356983" ''varTmp
                                    rv = sl_d_60_sel_spcno&(ispcno$, pt_no$(), patname$(), sex$(), age$(), gnl_item_cd$(), bl_gth_dte$(), dept$(), wd_no$(), tst_cd$())
                                    
'                                    If varTmp = "21011450095" Or varTmp = "21011450206" Then
'                                        ReDim Preserve tst_cd(6)
'
'                                        tst_cd(0) = "L25381"
'                                        tst_cd(1) = "L25382"
'                                        tst_cd(2) = "L25383"
...
'                                    End If
                                    ...
                                    If rv >= 1 Then
                                        blnCovid19 = False
                                        For i = 0 To UBound(tst_cd)
                                            Save_Raw_Data "[tst_cd] " & CStr(varTmp) & ":" & tst_cd(i)
                                            If tst_cd(i) = "L905740" Or tst_cd(i) = "L9057391" Or tst_cd(i) = "L905739" Or tst_cd(i) = "L25387" Then
                                                covid_cd = tst_cd(i)
                                                blnCovid19 = True
                                                Exit For
                                            End If
                                        ...
                                        If blnCovid19 = False Then
                                            sExamName = Get_ExamName(covid_cd)
                                            sEquipCode = Get_EquipCode(covid_cd)
                                            sExamCode = covid_cd
                                        Else
                            ...
                            Case Is > 5
                                .GetText intCol, intRow, varTmp
                                sEquipCode = varTmp '"COVID19"
                                strTmp = ""
                                Select Case sEquipCode
                                Case "E gene":
                                                .GetText intCol, intRow + 1, varTmp
                                                strEval = varTmp
                                ...
                                Case "MPV", "RSV", "PIV", "Flu B", "AdV", "Flu A", "HRV":
                                                .GetText intCol, intRow + 1, varTmp
                                                strTmp = varTmp
                                ...
                                'COVID19 판정
                                If strEval <> "" And strRdRPval <> "" And strNval <> "" Then
                                    sEquipCode = "COVID19"
                                    If covid_cd = "" Then
                                        sExamCode = Get_ExamCode(sEquipCode)
                                        sExamName = Get_ExamName(sExamCode)
                                    ...
                                    If strEval = "+" And strRdRPval = "+" And strNval = "+" Then
                                        strTmp = "Positive"
                                    ElseIf strEval = "-" And strRdRPval = "-" And strNval = "-" Then
                                        strTmp = "Negative"
                                    Else
                                        strTmp = "Inconclusive"
                                    End If
                                ...
                                ElseIf strTmp = "+" Then
                                    strTmp = "Positive"
                                ElseIf InStr(UCase(strTmp), "INCONCLUSIVE") > 0 Then
                                    strTmp = "Inconclusive"
                                ElseIf strTmp = "Positive Control(+)" Then
                                    strTmp = "Positive"
                                ElseIf strTmp = "Negative Control(-)" Then
                                    strTmp = "Negative"
                                ElseIf strTmp = "Negative" Then
                                    strTmp = "Negative"
                                ElseIf strTmp = "Positive" Then
                                    strTmp = "Positive"
                                Else
                                    strTmp = ""
                                End If
