...
Public Sub SetExamCode()
    ...
    With frmMain.spdOrder
        ...
        For i = 0 To UBound(gArrEQP) - 1
            ...
            Call SetText(frmMain.spdOrder, gArrEQP(i + 1, 5), 0, colSTATE + (i + 1))    '-- 5 : 검사명
    ...
    With frmMain.spdROrder
        ...
        For i = 0 To UBound(gArrEQP) - 1
            ...
            .TypeHAlign = TypeHAlignCenter
            .TypeVAlign = TypeVAlignCenter
            Call SetText(frmMain.spdROrder, gArrEQP(i + 1, 5), 0, colSTATE + (i + 1))    '-- 5 : 검사명
            .ColWidth(colSTATE + (i + 1)) = 6
        Next
    End With
