...
Public Const colCheckBox = 1
Public Const colOrdDate = 2    '검사의뢰일
Public Const colBarcode = 3    '바코드ㅇㄹㅇㄹㅇㄹㅇㄹㅇ
Public Const colChtNum = 4     '챠트번호
Public Const colIO = 5         '입/외
Public Const colInNum = 6      '내원번호
...
Public Const colSeqno = 98
Public Const colGumNum = 99
