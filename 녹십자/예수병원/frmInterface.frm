...
Begin VB.Form frmInterface 
   ...
   Begin VB.Frame FrmHideControl 
      ...
      Begin FPSpread.vaSpread vasRRes 
         ...
         ScrollBars      =   2
         SpreadDesigner  =   "frmInterface.frx":477C
      End
   ...
   Begin TabDlg.SSTab stInterface 
      ...
      EndProperty
      TabCaption(0)   =   "검사의뢰"
      TabPicture(0)   =   "frmInterface.frx":849F
      ...
      TabCaption(1)   =   "결과수신"
      TabPicture(1)   =   "frmInterface.frx":84BB
      ...
      Begin VB.Frame Frame3 
         ...
         Begin FPSpread.vaSpread vasRID 
            ...
            RetainSelBlock  =   0   'False
            SpreadDesigner  =   "frmInterface.frx":84D7
            UserResize      =   2
         End
      ...
      Begin VB.Frame Frame1 
         ...
         Begin FPSpread.vaSpread vasWorkList 
            ...
            MoveActiveOnFocus=   0   'False
            RetainSelBlock  =   0   'False
            SpreadDesigner  =   "frmInterface.frx":9094
            UserResize      =   2
         End
         ...
         Begin FPSpread.vaSpread vasID 
            ...
            RetainSelBlock  =   0   'False
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":99FB
            UserResize      =   2
         End
         Begin FPSpread.vaSpread vasRes 
            ...
            MaxCols         =   14
            RetainSelBlock  =   0   'False
            SpreadDesigner  =   "frmInterface.frx":A522
         End
         ...
         Begin FPSpread.vaSpread tblErrors 
            ...
            SpreadDesigner  =   "frmInterface.frx":E462
         End
...
Private Sub GetWorkList(ByVal pFrDt As String, ByVal pToDt As String)
    ...
    '-- 검사대상자 가져오기
          SQL = "SELECT a.workarea||'-'||substr(a.accdt,3,6)||'-'|| to_char(a.accseq) AS LabNo,a.rcvdt,a.ptid,c.testnm,d.field3 AS SpcNm, "
    SQL = SQL + "       e.spccd,a.stscd,a.workarea,a.accdt,a.accseq,a.testcd ,a.senddt,a.chargedt,'' AS Gubun ,e.wardid,e.deptcd,e.rcvtm, e.sex "
    SQL = SQL + "  FROM s2lab205 a,s2lab001 c,s2lab032 d,s2lab201 e "
    SQL = SQL + " WHERE a.outlabcd ='GCL' "
    SQL = SQL + "   AND a.rcvdt >= '" & pFrDt & "' "
    SQL = SQL + "   AND a.rcvdt <= '" & pToDt & "' "
    SQL = SQL + "   AND c.testcd = a.testcd "
    SQL = SQL + "   AND c.applydt = (SELECT max(applydt) From s2lab001 Where TESTCD = c.TESTCD) "
    SQL = SQL + "   AND cdindex ='C215' "
    SQL = SQL + "   AND d.cdval1 = a.spccd "
    SQL = SQL + "   AND a.workarea = e.workarea "
    SQL = SQL + "   AND a.accdt = e.accdt "
    SQL = SQL + "   AND a.accseq = e.accseq "
    SQL = SQL + " ORDER BY a.workarea, a.accdt,a.accseq  "
    ...
    Do Until RS.EOF
        ...
        SetText vasWorkList, Trim(RS.Fields("LabNo").Value) & "", intRow, colBarcode
        'SetText vasWorkList, Trim(RS.Fields("LabNo").Value) & "", intRow, colPName
        SetText vasWorkList, Trim(RS.Fields("ptid").Value) & "", intRow, colPID
        SetText vasWorkList, Trim(RS.Fields("testcd").Value) & "", intRow, colTestCd
        SetText vasWorkList, Trim(RS.Fields("testnm").Value) & "", intRow, colTestNm
        SetText vasWorkList, Trim(RS.Fields("spccd").Value) & "", intRow, colSpcCd
        SetText vasWorkList, Trim(RS.Fields("SpcNm").Value) & "", intRow, colSpcNm
        'SetText vasWorkList, Trim(RS.Fields("LabNo").Value) & "", intRow, colDOB
        SetText vasWorkList, Trim(RS.Fields("sex").Value) & "", intRow, colSex
        'SetText vasWorkList, Trim(RS.Fields("LabNo").Value) & "", intRow, colColDt
        'SetText vasWorkList, Trim(RS.Fields("LabNo").Value) & "", intRow, colDoctNm
        'SetText vasWorkList, Trim(RS.Fields("LabNo").Value) & "", intRow, colSpcYN
        SetText vasWorkList, Trim(RS.Fields("deptcd").Value) & "", intRow, colRcpDept
