...
Begin VB.Form frmInterface 
   ...
   Begin VB.Frame Frame4 
      ...
      Begin FPSpread.vaSpread vasPrintBuf 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":2F9D
      End
   End
   Begin VB.Frame FrmHideControl 
      ...
      Begin VB.Frame Frame3 
         ...
         Begin FPSpread.vaSpread vasRRes 
            ...
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":31E4
         End
         ...
         Begin FPSpread.vaSpread vasRID 
            ...
            RetainSelBlock  =   0   'False
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":6F21
            UserResize      =   2
         End
      ...
      Begin FPSpread.vaSpread vasCode 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":7973
      End
      Begin FPSpread.vaSpread vasTemp1 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":7BBA
      End
         ...
         Begin MSComctlLib.ImageList imlStatus 
            ...
            BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
               ...
               BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":838B
                  Key             =   "RUN"
               EndProperty
               BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":8925
                  Key             =   "NOT"
               EndProperty
               BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":8EBF
                  Key             =   "STOP"
               EndProperty
               BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":9459
                  Key             =   "LST"
               EndProperty
               BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":9CEB
                  Key             =   "ITM"
               EndProperty
               BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":9E45
                  Key             =   "ERR"
               EndProperty
               BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":9F9F
                  Key             =   "NOF"
               EndProperty
            EndProperty
         End
      ...
      Begin FPSpread.vaSpread vasList 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":A0F9
      End
      Begin FPSpread.vaSpread vasResTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":A340
      End
      Begin FPSpread.vaSpread vasTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":A587
      End
   ...
   Begin TabDlg.SSTab stInterface 
      ...
      TabPicture(0)   =   "frmInterface.frx":A7CE
      ...
      Begin VB.Frame Frame1 
         ...
         Begin FPSpread.vaSpread vasWorkList 
            ...
            MoveActiveOnFocus=   0   'False
            RetainSelBlock  =   0   'False
            SpreadDesigner  =   "frmInterface.frx":A7EA
            UserResize      =   2
         End
         ...
         Begin VB.ComboBox cboChk 
            ...
            EndProperty
            Height          =   300
            ItemData        =   "frmInterface.frx":B437
            Left            =   2340
            List            =   "frmInterface.frx":B441
            TabIndex        =   31
            Top             =   -90
            Visible         =   0   'False
            Width           =   765
         ...
         Begin FPSpread.vaSpread vasID 
            ...
            RetainSelBlock  =   0   'False
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":B451
            UserResize      =   2
         End
         Begin FPSpread.vaSpread vasRes 
            ...
            MaxCols         =   14
            RetainSelBlock  =   0   'False
            SpreadDesigner  =   "frmInterface.frx":BF92
         End
         ...
         Begin FPSpread.vaSpread tblErrors 
            ...
            SpreadDesigner  =   "frmInterface.frx":FEEC
         End
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.Image imgPort 
         Height          =   240
         Left            =   12180
         Picture         =   "frmInterface.frx":103A9
         Top             =   90
         Width           =   240
      End
      Begin VB.Image imgSend 
         Height          =   240
         Left            =   13380
         Picture         =   "frmInterface.frx":10933
         Top             =   90
         Width           =   240
      End
      Begin VB.Image imgReceive 
         Height          =   240
         Left            =   14670
         Picture         =   "frmInterface.frx":10EBD
         Top             =   90
         Width           =   240
      End
      Begin VB.Label Label1 
...
'    Debug.Print gAllExam
    ...
    SQL = SQL & "   FROM VW_MCHORDER " & vbLf
'    SQL = SQL & "  WHERE WRKDTE BETWEEN  '" & pFrDt & "' AND '" & pToDt & "' " & vbLf
    SQL = SQL & "  WHERE WRKDTE =  '" & pFrDt & "' " & vbLf
    ...
    Do Until Rs.EOF
        ...
        SetText vasWorkList, Trim(Rs.Fields("REQNO").Value) & "", intRow, colBarcode
...
'        If Trim(RS.Fields(4)) = "62" Then
'            SetText vasWorkList, "검진", intRow, colSex
'        Else
'            SetText vasWorkList, "진료", intRow, colSex
'        End If
        Rs.MoveNext
    Loop
...
Private Sub cmdSearch_Click()
    ...
    Call GetWorkList(Format(dtpWorkDt.Value, "yyyymmdd"), Format(dtpWorkDt.Value, "yyyymmdd"))
...
strBuffer = "D1N  10     1315411715136            00011S           111    1205        19                          120121112201108291625247f"
...
'        lblStatus = "작업 대기중.."
    ...
    dtpStartDt = Date
    dtpStopDt = Date
    dtpWorkDt = "2013-06-04"
    
    sDate = Format(DateAdd("y", CDate(dtpToday.Value), -30), "yyyy-mm-dd")
    
          SQL = "DELETE FROM TB_LIS_IF_RST "
    SQL = SQL & " WHERE INST_DS < " & sDate
    Res = SendQuery(gLocal, SQL)
...
Function GetExamCode() As Integer
    ...
    'equipcode, examcode, examname, resprec, seqno
          SQL = "SELECT EQP_CD, ITEM_CD " & vbCrLf
    SQL = SQL & "  FROM TB_LIS_EQP_ITEM " & vbCrLf
    SQL = SQL & " WHERE EQP_CD = '" & gEquip & "' " & vbCrLf
    SQL = SQL & " ORDER BY ITEM_CD "
...
Private Sub GetOrder(ByVal pBarNo As String)
    ...
    Call SetText(vasID, mOrder.RackNo, intRow, colCST)     '4  Rack번호
    Call SetText(vasID, mOrder.TubePos, intRow, colSPC)     '5  Pos번호
...
Private Sub SetPatInfo(ByVal pBarNo As String)
    ...
    For i = 1 To vasWorkList.DataRowCnt
        If Trim(GetText(vasWorkList, i, colBarcode)) = pBarNo Then
            ...
            'SetText vasWorkList, mGetP(gOrderExam, 2, "@"), intRow, colSPC
...
Private Sub EditRcvDataASTM()
    ...
    For intCnt = 1 To UBound(strRecvData)
        ...
        Select Case strType
            Case "D"    '-- 결과
                strBarNo = Trim(Mid(strRcvBuf, 12, 26))
                strRackNo = Mid(strRcvBuf, 38, 4)
                strTubePos = Mid(strRcvBuf, 42, 1)
                For i = 1 To vasWorkList.DataRowCnt
                    vasWorkList.Row = i
                ...
                strIntBase = Trim(Mid(strRcvBuf, 62, 2))
                strResult = Trim(Mid(strRcvBuf, 72, 10))
                ...
                If strResult <> "" Then
                    SQL = ""
                    SQL = SQL & "SELECT ITEM_CD, ITEM_DP_NM, SCREEN_DP_SEQ " & vbCr
                    SQL = SQL & "  FROM TB_LIS_EQP_ITEM" & vbCr
                    SQL = SQL & " WHERE EQP_CD = '" & gEquip & "' " & vbCr
                    SQL = SQL & "   AND EQP_SEQ = " & gEquipSeq & vbCr
                    SQL = SQL & "   AND IF_RST_CD = '" & strIntBase & "' " & vbCr
                    SQL = SQL & "   AND ITEM_CD in (" & gOrderExam & ") "
...
''                        SQL = ""
''                        SQL = SQL & "SELECT ITEM_CD, ITEM_DP_NM, SCREEN_DP_SEQ " & vbCr
''                        SQL = SQL & "  FROM TB_LIS_ITEM_REF" & vbCr
''                        SQL = SQL & " WHERE EQP_CD = '" & gEquip & "' " & vbCr
''                        SQL = SQL & "   AND EQP_SEQ = " & gEquipSeq & vbCr
''                        SQL = SQL & "   AND IF_RST_CD = '" & strIntBase & "' " & vbCr
''                        SQL = SQL & "   AND ITEM_CD = '" & lsExamCode & "' "
''
''                        Res = GetDBSelectColumn(gLocal, SQL)
                        ...
                        SetText vasRes, "", lsResRow, colHL               '판정 High/Low
                        SetText vasRes, "", lsResRow, colPanic               '판정 Panic
                        SetText vasRes, "", lsResRow, colDelta               '판정 Delta
                        SetText vasRes, "", lsResRow, colOldRslt               '이전 결과
                        SetText vasRes, "", lsResRow, colOldBarcode               '이전 의뢰번호
                        SetText vasRes, "", lsResRow, colLowLimit               '참고치 하한
                        SetText vasRes, "", lsResRow, colHighLimit               '참고치 상한
                    ...
                    Else
                        ...
                        SQL = ""
                        SQL = SQL & "SELECT ITEM_CD, ITEM_DP_NM, SCREEN_DP_SEQ "
                        SQL = SQL & "  FROM TB_LIS_EQP_ITEM"
                        SQL = SQL & " WHERE EQP_CD = '" & gEquip & "' "
                        SQL = SQL & "   AND EQP_SEQ = '" & gEquipSeq & "' "
                        SQL = SQL & "   AND IF_RST_CD = '" & strIntBase & "' "
...
Function SetLocalDB(ByVal asRow1 As Long, ByVal asRow2 As Long, asSend As String, Optional asEquipResult As String = "")
    ...
    '-- Max SEQ 찾아오기 SQL = ""
          SQL = ""
    SQL = SQL & "SELECT MAX(SEQ) as MAXSEQ " & vbLf
    SQL = SQL & "  FROM TB_LIS_IF_RST " & vbCrLf
    SQL = SQL & " WHERE REQ_NO = '" & Trim(GetText(vasWorkList, asRow1, colBarcode)) & "' " & vbCrLf
    SQL = SQL & "   AND ITEM_CD = '" & Trim(GetText(vasRes, asRow2, colExamCode)) & "'"
    SQL = SQL & "   AND WRK_KEY = '" & Trim(GetText(vasWorkList, asRow1, colWK)) & "' " & vbCrLf
    ...
    If Res > 0 Then
        If IsNull(Trim(gReadBuf(0))) Or Trim(gReadBuf(0)) = "" Then
            intSeq = 1
        Else
            intSeq = Trim(gReadBuf(0)) + 1
        End If
    End If
    
          SQL = ""
    SQL = SQL & "INSERT INTO TB_LIS_IF_RST ("
    SQL = SQL & "REQ_NO,ITEM_CD,WRK_KEY,SEQ,TEST_MGMT_ID,WRK_DT,WRK_NO,INP_TM,INP_DT,IF_RST_CD,"
    SQL = SQL & "QUAL_RST,DOSE_RST,EQP_COMMT,EQP_FLAG,EQP_UNIT,REF_LOW_VAL,REF_HIGH_VAL,CHAR_REF,JUDGE_MARK,DTA_MARK,"
    SQL = SQL & "PNC_MARK,CRITC_MARK,ALERT_MARK,AMR_MARK,CRR_MARK,SPCM_STATE,MGMT_EMP_NO,EQP_CD,EQP_NM,EQP_REG_SEQ,"
    SQL = SQL & "IP_ADDR,RST_SND_YN,SND_DT,SND_ID,DEL_YN,USE_YN,INST_ID,INST_DS,UPDT_ID,UPDT_DS)"
    SQL = SQL & "VALUES("
...
'                SQL = SQL & "'" & Trim(GetText(vasRID, iRow, colSPC)) & "', " & vbCrLf
...
'            SQL = SQL & "   AND DISKNO   = '" & Trim(GetText(vasRID, iRow, colCST)) & "' " & vbCrLf
'            SQL = SQL & "   AND POSNO    = '" & Trim(GetText(vasRID, iRow, colSPC)) & "' " & vbCrLf
...
Private Sub vasWorkList_Click(ByVal Col As Long, ByVal Row As Long)
    ...
    lblPtId.Caption = lsID
    lblChangePID.Caption = Trim(GetText(vasWorkList, Row, colPID))
    lblCustNm.Caption = Trim(GetText(vasWorkList, Row, colCST))
    lblPatNm.Caption = Trim(GetText(vasWorkList, Row, colPName))
    ...
    '장비코드, 검사코드, 검사명, 결과, 순번
          SQL = ""
    SQL = SQL & "SELECT IF_RST_CD,ITEM_CD,'',QUAL_RST,DOSE_RST,SEQ"
'    SQL = SQL & "SELECT REQ_NO,ITEM_CD,WRK_KEY,SEQ,TEST_MGMT_ID,WRK_DT,WRK_NO,INP_TM,INP_DT,IF_RST_CD,"
'    SQL = SQL & "QUAL_RST,DOSE_RST,EQP_COMMT,EQP_FLAG,EQP_UNIT,REF_LOW_VAL,REF_HIGH_VAL,CHAR_REF,JUDGE_MARK,DTA_MARK,"
'    SQL = SQL & "PNC_MARK,CRITC_MARK,ALERT_MARK,AMR_MARK,CRR_MARK,SPCM_STATE,MGMT_EMP_NO,EQP_CD,EQP_NM,EQP_REG_SEQ,"
'    SQL = SQL & "IP_ADDR,RST_SND_YN,SND_DT,SND_ID,DEL_YN,USE_YN,INST_ID,INST_DS,UPDT_ID,UPDT_DS "
    SQL = SQL & "  FROM TB_LIS_IF_RST " & vbCrLf
    SQL = SQL & " WHERE REQ_NO = '" & lsID & "' " & vbCrLf
    'SQL = SQL & "   AND INST_DS = '" & Trim(Format(dtpToday.Value, "yyyymmdd")) & "' " & vbCrLf
