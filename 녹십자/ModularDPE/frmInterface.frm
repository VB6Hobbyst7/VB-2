   ...
   Begin TabDlg.SSTab stInterface 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin FPSpread.vaSpread vasRes 
            ...
            RetainSelBlock  =   0   'False
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":C222
         End
...
Private Sub Command16_Click()
    ...
    '-- 오더
    strBuffer = ""
    strBuffer = strBuffer & "1H|\^&|||H7600^1|||||host|TSREQ^REAL|P|1" & vbCrLf
    strBuffer = strBuffer & "P|1" & vbCrLf
    strBuffer = strBuffer & "Q|1|^^0/1315411110032/2/5100/2/R1/R||||||||||O" & vbCrLf
    strBuffer = strBuffer & "L|1|N" & vbCrLf
    strBuffer = strBuffer & "26" & vbCrLf
    strBuffer = strBuffer & "" & vbCrLf
    '1315411110032


'1H|\^&|||HOST^2|||||H7600^1|TSDWN^REPLY|P|1
'P|1
'O|1|0^17000522453^2^5100^1|R1|^^^78/\^^^690/|R||||||N||^^||||||^^^^||||||O
'L|1|N
'C9

    '-- 결과
''    strBuffer = ""
''    strBuffer = strBuffer & "1H|\^&|||H7600^1|||||host|RSUPL^REAL|P|1" & vbCrLf
''    strBuffer = strBuffer & "P|1" & vbCrLf
''    strBuffer = strBuffer & "O|1|0^1315411110032^2^5100^1|R1|^^^78/\^^^690/|R||||||N||||SC|||942465|^^^^|||20070807093454|||F" & vbCrLf
''    strBuffer = strBuffer & "R|1|^^^78/|222.4|mg/dl||HH||F|||||P1" & vbCrLf
''    strBuffer = strBuffer & "C|1|I|26|I" & vbCrLf
''    strBuffer = strBuffer & "R|2|^^^690/|110.52|mg/dl||N||F|||||P1" & vbCrLf
''    strBuffer = strBuffer & "C|1|I|0|I" & vbCrLf
''    strBuffer = strBuffer & "L|1DC" & vbCrLf
''    strBuffer = strBuffer & "2|N" & vbCrLf
    ...
    For intCnt = 1 To UBound(strRecvData)
        ...
        Select Case strType
            ...
            Case "R"    '## Result
                ...
                strFlag = mGetP(mGetP(strRcvBuf, 3, "|"), 8, "^")
                strIntBase = strTemp1
                
                Select Case strIntBase
                Case "T3", "TSH3UL", "AFP", "FT4"
                    If strFlag = "DOSE" Then
                        strResult = strTemp2
                    Else
                        strResult = ""
                    End If
                ...
                Case "HBs"
                    If strFlag = "INDX" Then
                        strIntBase = strIntBase & "_N"
                        strResult = strTemp2
                    ElseIf strFlag = "INTR" Then
                        strIntBase = strIntBase & "_C"
                        strResult = strTemp2
                    Else
                        strResult = ""
                    End If
