...
'Public Const colSeqNo = 2
'Public Const colOrdDate = 3
'Public Const colWN = 4
'Public Const colWK = 5
'Public Const colBarcode = 6
'Public Const colRack = 7
'Public Const colPos = 8
'Public Const colSale = 9
'Public Const colCST = 10
'Public Const colSPC = 11
'Public Const colPID = 12
'Public Const colPName = 13
'Public Const colSex = 14
'Public Const colAge = 15
...
Public Const colRCnt = 17
Public Const colState = 18
Public Const colrRslt = 19
Public Const colrDil = 20
Public Const colrQC = 21
Public Const colrHL = 22
Public Const colrOldResult = 23
Public Const colrOldBar = 24
Public Const colrLow = 25
Public Const colrHigh = 26
...
'---------------------------------------------------------------------------------------------------------------------
    ...
    db_tmp = ""
    Call GetPrivateProfileString("config", "EquipSeq", "", db_tmp, 100, App.Path & "\Interface.ini")
    frmInterface.txtTemp = Trim(db_tmp)
    gEquipSeq = Trim(frmInterface.txtTemp)
