...
'            Else
'                '-- Update
'                      SQL = " Update MCHRES Set " & vbCr
'                SQL = SQL & "  LABRES = '" & sResult & "'," & vbCr
'                SQL = SQL & "  INPDTE = to_char(sysdate, 'YYYYMMDD'), " & vbCr
'                SQL = SQL & "  INPTME = to_char(sysdate, 'HH24miss'), " & vbCr
'                SQL = SQL & "  IPADDR = '" & strLocalIP & "', " & vbCr
'                SQL = SQL & "  LABEMP = '" & gIFUser & "', " & vbCr
'                SQL = SQL & "  TRANSCYN = 'N'," & vbCr
'                SQL = SQL & "  DEL = 'N' " & vbCr
'                SQL = SQL & " Where REQNO  = '" & lsID & "'"
'                SQL = SQL & "   And ITEMCD = '" & strEqpCd & "'"
'
