...
Public Const REG_SRV_FTP    As String = REG_POSITION & "\FTPServer"
Public Const REG_Machine    As String = REG_POSITION & "\Machine"
...
Public Const KEY_HOSTIP     As String = "HOSTIP"
Public Const KEY_PORT       As String = "PORT"
Public Const KEY_FPORT      As String = "FPORT"
Public Const KEY_FID        As String = "FID"
Public Const KEY_FPW        As String = "FPW"
Public Const KEY_FDIR       As String = "FDIR"
Public Const KEY_FTIME      As String = "TIME"

Public Const REG_Date       As String = "검사일자"
Public Const REG_Code        As String = "CODE"




'=========================== 실행 위치
Public ExePATH              As String               '실행위치

'=========================== 파일 경로
Public Const Temp      As String = "TEMP\" 'temp folder
Public Const BACK      As String = "DATA\" 'temp folder
'===========================DATABASE CONECTION
'MS JetDB
...
Public Sub Connect_FTP()
  ...
  If Not (fHostIP = "" Or fPort = "" Or fID = "" Or fPW = "") Then
    Set objFtp = New clsFTP
    
    With objFtp ' FTP Connect
      If .OpenConnection(fHostIP, fPort, fID, fPW) Then
        isConn = True
  ...
  If Not isConn Then
    strMsg = "FTP Server Not found! Do you want server search it?   "
...
'        .Provider = "SQLOLEDB"                ' Oracle "MSDAORA.1"
'        '------------------------------------------------------------
'        .Properties("Data Source").Value = ServerName
'        .Properties("Initial Catalog").Value = DatabaseName
...
On Error GoTo ConnectError
     ...
     ServerName = GetString(HKEY_CURRENT_USER, REG_ORACLEDB, REG_SERVICE)
