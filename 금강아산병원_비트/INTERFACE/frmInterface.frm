...
Private Sub SendOrder_THUNDERBOLT()
    ...
    With spdOrder
        If intSndPhase <= 3 Then
            For intRow = 1 To .DataRowCnt
                If GetText(spdOrder, intRow, colCHECKBOX) = "1" And (GetText(spdOrder, intRow, colSTATE) = "오더준비" Or GetText(spdOrder, intRow, colSTATE) = "오더없음") Then
    ...
    Select Case intSndPhase
        ...
        Case 2  '## Patient
            strOutput = intFrameNo & "P|" & mPNo & "||" & mOrder.BarNo & vbCr & ETX
            intSndPhase = 3
            intFrameNo = intFrameNo + 1
            mPNo = mPNo + 1
        
        Case 3  '## Order
            strOutput = intFrameNo & "O|" & mOCnt & "|" & mOrder.BarNo & "||" & strItems & "|R" & vbCr & ETX
