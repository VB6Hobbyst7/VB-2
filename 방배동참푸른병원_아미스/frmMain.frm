        ...
        For intCnt = 1 To UBound(strRData)
            ...
            Select Case strType
                ...
                Case "O"
                    ...
                    If InStr(strBarno, "_") > 0 Then
                        strBarno = Replace(strBarno, "_", Mid(Format(Now, "yymm"), 1, 3))
                    Else
                        'strBarno = Mid(Format(Now, "yymm"), 1, 3) & strBarno
                        strBarno = Format(Now, "yymm") & strBarno
                    End If
