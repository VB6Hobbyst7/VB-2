...
Begin VB.Form frmMain 
   ...
   Begin VB.PictureBox Picture2 
      ...
      Begin VB.Frame fraResult 
         ...
         Begin VB.ComboBox cboRstType 
            Appearance      =   0  '평면
            Height          =   300
            ItemData        =   "frmMain.frx":9A99
            Left            =   420
            List            =   "frmMain.frx":9A9B
            TabIndex        =   111
            Top             =   180
            Width           =   1245
         End
         Begin VB.ComboBox cboState 
            Height          =   300
            ItemData        =   "frmMain.frx":9A9D
            Left            =   4710
            List            =   "frmMain.frx":9A9F
            TabIndex        =   110
            Top             =   180
            Width           =   1395
         End
   ...
   Begin VB.Frame frame2 
      ...
      Begin FPSpread.vaSpread spdRResult 
         ...
         SpreadDesigner  =   "frmMain.frx":CE40
         TextTip         =   2
      End
      Begin FPSpread.vaSpread spdROrder 
         ...
         SpreadDesigner  =   "frmMain.frx":D557
         UserResize      =   2
      End
   ...
   Begin VB.Frame frame1 
      ...
      Begin VB.Frame fraDUREADER720 
         ...
         Begin VB.ComboBox cboWbcM 
            ...
            EndProperty
            Height          =   300
            ItemData        =   "frmMain.frx":10494
            Left            =   1020
            List            =   "frmMain.frx":104A4
            TabIndex        =   176
            Text            =   "Combo3"
            Top             =   360
            Width           =   1695
      ...
      Begin FPSpread.vaSpread spdOrder 
         ...
         SelectBlockOptions=   0
         ShadowColor     =   14548991
         SpreadDesigner  =   "frmMain.frx":104B4
         UserResize      =   2
      End
      Begin FPSpread.vaSpread spdResult 
         ...
         SelectBlockOptions=   0
         ShadowColor     =   13697023
         SpreadDesigner  =   "frmMain.frx":13402
         TextTip         =   2
      End
   End
   Begin VB.Frame frame3 
      ...
      Begin VB.Frame frameTestSet 
         ...
         Begin VB.Frame frameOrder 
            ...
            Begin FPSpread.vaSpread spdOrdMst 
               ...
               SelectBlockOptions=   0
               ShadowColor     =   13697023
               SpreadDesigner  =   "frmMain.frx":13C22
               TextTip         =   2
            End
         End
         Begin VB.ComboBox cboResultType 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmMain.frx":13F45
            Left            =   1650
            List            =   "frmMain.frx":13F47
            TabIndex        =   32
            Top             =   5220
            Visible         =   0   'False
            Width           =   1575
      ...
      Begin FPSpread.vaSpread spdTest 
         ...
         RetainSelBlock  =   0   'False
         SelectBlockOptions=   0
         SpreadDesigner  =   "frmMain.frx":16E41
      End
   End
   Begin VB.Frame frame4 
      ...
      Begin VB.Frame frameCom 
         ...
         Begin VB.ComboBox cboPort 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmMain.frx":18F4E
            Left            =   2190
            List            =   "frmMain.frx":18F50
            TabIndex        =   52
            Top             =   390
            Width           =   2205
         End
         Begin VB.ComboBox cboBaudrate 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmMain.frx":18F52
            Left            =   2190
            List            =   "frmMain.frx":18F54
            TabIndex        =   51
            Top             =   780
            Width           =   2205
         End
         Begin VB.ComboBox cboDatabit 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmMain.frx":18F56
            Left            =   2190
            List            =   "frmMain.frx":18F58
            TabIndex        =   50
            Top             =   1170
            Width           =   2205
         End
         ...
         Begin VB.ComboBox cboParity 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmMain.frx":18F5A
            Left            =   2190
            List            =   "frmMain.frx":18F5C
            TabIndex        =   47
            Top             =   2520
            Width           =   2205
         End
...
Private Sub lblFileSave_Click()
    ...
    Call WritePrivateProfileString("COMM", "ORDERPATH", txtOrderPath.Text, App.PATH & "\INI\" & gHOSP.APPNM & ".ini")
    Call WritePrivateProfileString("COMM", "RESULTPATH", txtResultPath.Text, App.PATH & "\INI\" & gHOSP.APPNM & ".ini")
    
    GetSetup
    
    GetCommList

    MsgBox "파일정보가 변경되었습니다.", vbInformation + vbOKCancel, Me.Caption
...
On Error GoTo ErrRoutine
    ...
    With CommonDialog1
        ...
        .InitDir = "C:\Program Files\A25\Export\"
    ...
    RcvBuffer = ""
    Do While Not EOF(3)
        RcvBuffer = RcvBuffer & Input(1, #3)
    Loop

    Close #3
    
    Call SerialRcvData_A25
...
Private Sub lblReceive_MouseMove(Button As Integer, Shift As Integer, X As Single, Y As Single)
    ...
    lblReceive.ForeColor = vbBlack
    
    shpW.BorderColor = &H808080
    shpS.BorderColor = &H808080
    shpC.BorderColor = &H808080
    shpSND.BorderColor = &H808080
    shpRCV.BorderColor = &H808080
    
    lblReceive.ForeColor = vbBlue
    shpRCV.BorderColor = vbCyan
...
Private Sub lblSend_Click()
        ...
        For intRow = 1 To .DataRowCnt
            ...
            If .Value = "1" Then
                For intCol = colSTATE + 1 To .MaxCols
                    .Col = intCol
                    If Trim(.Text) = "◆" Then
                        strEqpcd = gArrEQP(intCol - colSTATE, 3)
                        'N SER 12345678901234 GLUCOSE T13
                        strImport = strImport & "N" & vbTab & "SER" & vbTab & GetText(spdOrder, intRow, colBARCODE) & "-" & GetText(spdOrder, intRow, colPNAME) & vbTab & strEqpcd & vbTab & "T13" & vbCrLf
    ...
    If strImport <> "" Then
        'Open gFILE.ORDPATH & "import.txt" For Append As #9
        Open gFILE.ORDPATH & "import.txt" For Output As #9
        Print #9, strImport
        Close #9
        lblStatus.Caption = "오더생성이 완료되었습니다."
    End If
End Sub
...
Private Sub lblSend_MouseMove(Button As Integer, Shift As Integer, X As Single, Y As Single)
    ...
    lblSend.ForeColor = vbBlue
    shpSND.BorderColor = vbCyan
                ...
                If strIntBase <> "" And strResult <> "" Then
                        ...
                        If Not RS_L.EOF = True And Not RS_L.BOF = True Then
                            ...
                            For intCol = colSTATE + 1 To .spdOrder.MaxCols
                                If lsTestCode = gArrEQP(intCol - colSTATE, 2) Then
                                    ...
                                    '-- 검체코드
                                    strSpcCd = gArrEQP(intCol - colSTATE, 17)
                                    Exit For
                                End If
                            Next
                            ...
                            SetText .spdResult, lsOrderCode, lsRstRow, colRORDERCD          '처방코드
                            SetText .spdResult, lsTestCode, lsRstRow, colRTESTCD            '검사코드
                            SetText .spdResult, strSpcCd, lsRstRow, colRSUBCD               '검체코드
                            SetText .spdResult, lsTestName, lsRstRow, colRTESTNM            '검사명
                            SetText .spdResult, strIntBase, lsRstRow, colRCHANNEL           '장비채널
                            SetText .spdResult, strMachResult, lsRstRow, colRMACHRESULT     '장비결과
                            SetText .spdResult, strResult, lsRstRow, colRLISRESULT          'LIS결과
                    ...
                    Else
                        ...
                        If Not RS_L.EOF = True And Not RS_L.BOF = True Then
                            ...
                            '-- 결과 List
                            SetText .spdResult, lsSeqNo, lsRstRow, colRSEQNO                '순번
                            SetText .spdResult, lsTestCode, lsRstRow, colRORDERCD          '처방코드
                            SetText .spdResult, lsTestCode, lsRstRow, colRTESTCD            '검사코드
                            SetText .spdResult, "026", lsRstRow, colRSUBCD               '검체코드
                            SetText .spdResult, lsTestName, lsRstRow, colRTESTNM            '검사명
                            SetText .spdResult, strIntBase, lsRstRow, colRCHANNEL           '장비채널
                            SetText .spdResult, strMachResult, lsRstRow, colRMACHRESULT     '장비결과
                            SetText .spdResult, strResult, lsRstRow, colRLISRESULT          'LIS결과
...
Private Sub SerialRcvData_OPTIMA()
    Dim RS_L            As ADODB.Recordset
    Dim strRcvBuf       As String   '수신한 Data
    Dim strType         As String   '수신한 Record Type
    Dim strBarno        As String   '수신한 바코드번호
...
Private Sub SerialRcvData_A25()
    ...
    Dim Pos As Integer
    Dim strSpcCd        As String
    Dim strTabData As Variant
        
    With frmMain
        strRecvData = Split(RcvBuffer, vbCrLf)
        For intCnt = 0 To UBound(strRecvData)
            strTabData = Split(strRecvData(intCnt), vbTab)
            
            '-- 바코드 번호 찾기
            strBarno = Trim(strTabData(0))      '바코드
            strBarno = mGetP(strBarno, 1, "-")
            strIntBase = Trim(strTabData(1))    '채널
            strResult = Trim(strTabData(3))     '결과
...
On Error GoTo RST
    ...
    GetIp = GetIpAddrTable
    gHOSP.LOCALIP = GetIp(0)
    ...
    ElseIf gComm.COMTYPE = "3" Then
        ...
        lblPath.Caption = "오더경로:" & gFILE.ORDPATH & vbCr & "결과경로:" & gFILE.RSTPATH
...
'    End If
    ...
    txtOrderPath.Text = gFILE.ORDPATH
    txtResultPath.Text = gFILE.RSTPATH
...
On Error GoTo RST
    ...
    SQL = ""
    SQL = SQL & "SELECT DISTINCT SEQNO,ORDERCODE,EXAMCODE,EXAMSUBCODE,EQUIPCODE,EXAMNAME,EQUIPRESULT,RESULT,REFJUDGE" & vbCr
    SQL = SQL & "  FROM PATRESULT " & vbCr
    SQL = SQL & " WHERE SAVESEQ = " & intSeq & vbCr
    SQL = SQL & "   AND EXAMDATE = '" & strExamDate & "'" & vbCr
'    SQL = SQL & " ORDER BY SEQNO "
    ...
    If Not AdoRs_Local.EOF = True And Not AdoRs_Local.BOF = True Then
        With frmMain.spdRResult
            ...
            Do Until AdoRs_Local.EOF
                ...
                Call SetText(frmMain.spdRResult, AdoRs_Local.Fields("ORDERCODE").Value & "", intRow, colRORDERCD)
                Call SetText(frmMain.spdRResult, AdoRs_Local.Fields("EXAMCODE").Value & "", intRow, colRTESTCD)
                Call SetText(frmMain.spdRResult, AdoRs_Local.Fields("EXAMSUBCODE").Value & "", intRow, colRSUBCD)
