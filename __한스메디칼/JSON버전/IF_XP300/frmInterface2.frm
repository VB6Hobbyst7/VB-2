...
Begin VB.Form frmInterface2 
   ...
   Begin VB.Frame fraHidden 
      ...
      Begin MSComctlLib.ImageList imlStatus 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmInterface2.frx":0000
               Key             =   "RUN"
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmInterface2.frx":059A
               Key             =   "NOT"
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmInterface2.frx":0B34
               Key             =   "STOP"
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmInterface2.frx":10CE
               Key             =   "LST"
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmInterface2.frx":1960
               Key             =   "ITM"
            EndProperty
            BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmInterface2.frx":1ABA
               Key             =   "ERR"
            EndProperty
            BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmInterface2.frx":1C14
               Key             =   "NOF"
            EndProperty
            BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmInterface2.frx":1D6E
               Key             =   "ON"
               Object.Tag             =   "OFF"
            EndProperty
            BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmInterface2.frx":2648
               Key             =   ""
            EndProperty
         EndProperty
      End
      ...
      Begin HSCotrol.CButton cmdRsltPrint 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "frmInterface2.frx":2F22
         MaskColor       =   0
         PicCapAlign     =   2
         BorderStyle     =   1
         BorderColor     =   16777215
      ...
      Begin HSCotrol.CButton cmdDelete 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "frmInterface2.frx":307C
         MaskColor       =   0
         PicCapAlign     =   2
         BorderStyle     =   1
         BorderColor     =   16777215
      ...
      Begin HSCotrol.CButton CButton1 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "frmInterface2.frx":31D6
         MaskColor       =   0
         PicCapAlign     =   2
         BorderStyle     =   1
         BorderColor     =   16777215
      ...
      Begin VB.Image imgOff 
         Height          =   480
         Left            =   150
         Picture         =   "frmInterface2.frx":4458
         Top             =   1440
         Width           =   480
      End
      Begin VB.Image imgOn 
         Height          =   480
         Left            =   690
         Picture         =   "frmInterface2.frx":4D22
         Top             =   1440
         Width           =   480
      End
   End
   ...
   Begin FPSpreadADO.fpSpread spdWork 
      ...
      ShadowDark      =   12632256
      SpreadDesigner  =   "frmInterface2.frx":55EC
      VisibleCols     =   3
      VisibleRows     =   10
   ...
   Begin FPSpreadADO.fpSpread spdOrder 
      ...
      ShadowColor     =   14737632
      ShadowDark      =   12632256
      SpreadDesigner  =   "frmInterface2.frx":62E6
      UnitType        =   0
      VisibleCols     =   3
      VisibleRows     =   10
   ...
   Begin FPSpreadADO.fpSpread spdResult 
      ...
      ShadowColor     =   14737632
      ShadowDark      =   12632256
      SpreadDesigner  =   "frmInterface2.frx":6F6A
      VisibleCols     =   3
      VisibleRows     =   10
      CellNoteIndicatorColor=   16576
   ...
   End
End
Attribute VB_Name = "frmInterface2"
...
Private Sub cmdMatch_Click()
    ...
    If blnSame = True Then
        ...
        varItems = Split(varItems, "/")
        For intItems = 0 To UBound(varItems)
            For intOCol = colSTATE + 1 To frmInterface2.spdOrder.MaxCols
                spdOrder.Row = 0
                spdOrder.Col = intOCol
                If varItems(intItems) = Trim(spdOrder.Text) Then
...
Private Sub cmdSearch_Click()
    ...
    With spdWork
        ...
        For i = 1 To 10
            ...
            Call SetText(spdWork, "8379127851" & CStr(i), i, colBARCODE)
...
Private Sub GetOrder_HITACHI7180(ByVal pBarno As String, ByVal pType As String)
    ...
    ''Call SetCommStatus("Q", pBarNo, frmInterface2.spdComStatus)
    ''Call SetCommStatus("Q", pBarNo, frmInterface2.lstComStatus)
    ...
    With frmInterface2
        Select Case pType
            ...
            Case "0"
                For i = 1 To .spdOrder.DataRowCnt
                    If Trim(GetText(frmInterface2.spdOrder, i, colBARCODE)) = pBarno Then
                        intRow = i
                        Exit For
                    End If
                Next i
            ...
            Case "1"
                For i = 1 To .spdOrder.DataRowCnt
                    If Val(Trim(GetText(frmInterface2.spdOrder, i, colSEQNO))) = Val(mOrder.Seq) Then
                        pBarno = Trim(GetText(frmInterface2.spdOrder, i, colBARCODE))
                        mOrder.BarNo = pBarno
                        intRow = i
                        Exit For
                    End If
            ...
            Case "2"
                For i = 1 To .spdOrder.DataRowCnt
                    If Trim(GetText(frmInterface2.spdOrder, i, colRACKNO)) = mOrder.RackNo And Trim(GetText(frmInterface2.spdOrder, i, colPOSNO)) = mOrder.TubePos Then
                        pBarno = Trim(GetText(frmInterface2.spdOrder, i, colBARCODE))
                        intRow = i
                        Exit For
                    End If
            ...
            Case "3"
                For i = 1 To .spdOrder.DataRowCnt
                    If GetText(frmInterface2.spdOrder, i, colCHECKBOX) = "1" Then
                        pBarno = Trim(GetText(frmInterface2.spdOrder, i, colBARCODE))
                        mOrder.BarNo = pBarno
                        intRow = i
                        Exit For
        ...
        If Trim(strItems) = "" Or mOrder.SendCnt = 0 Then
            ...
            '-- 진행상태(Order) 표시
            Call SetText(frmInterface2.spdOrder, "오더없음", intRow, colSTATE)
        Else
            ...
            '-- 진행상태(Order) 표시
            Call SetText(frmInterface2.spdOrder, "오더전송", intRow, colSTATE)
        End If
...
'OBX|10|ST|01011^Custom patient info 3^99MRC||Nothing||||||F
            ...
            '-- 진행상태(Order) 표시
            Call SetText(frmInterface2.spdOrder, "0", intRow, colCHECKBOX)
            Call SetText(frmInterface2.spdOrder, "오더전송", intRow, colSTATE)
...
'''
'''            '-- 진행상태(Order) 표시
'''            Call SetText(frmInterface2.spdOrder, "", intRow, colCHECKBOX)
'''            Call SetText(frmInterface2.spdOrder, "오더전송", intRow, colSTATE)
'''            Call SendWSckData(strSend)
...
Private Sub SendOrder_CA800_ASTM()
    ...
    Select Case intSndPhase
        ...
        Case 5  '## EOT
            strState = ""
            frmInterface2.comEqp.Output = EOT
            SetRawData "[Tx]" & EOT
            intFrameNo = 1
...
On Error GoTo ErrHandle
    ...
    If Not AdoRs_Local.EOF = True And Not AdoRs_Local.BOF = True Then
        With frmInterface2.spdResult
            .MaxRows = 0
            .MaxRows = AdoRs_Local.RecordCount
            Do Until AdoRs_Local.EOF
                intRow = intRow + 1
                If AdoRs_Local.Fields("EXAMCODE").Value & "" = "" Then
                    Call SetText(frmInterface2.spdResult, "0", intRow, colCHECKBOX)
                Else
                    Call SetText(frmInterface2.spdResult, "1", intRow, colCHECKBOX)
                End If
                Call SetText(frmInterface2.spdResult, AdoRs_Local.Fields("EQUIPCODE").Value & "", intRow, colRCHANNEL)
                Call SetText(frmInterface2.spdResult, AdoRs_Local.Fields("EXAMCODE").Value & "", intRow, colRTESTCD)
                Call SetText(frmInterface2.spdResult, AdoRs_Local.Fields("EXAMNAME").Value & "", intRow, colRTESTNM)
                Call SetText(frmInterface2.spdResult, AdoRs_Local.Fields("EQUIPRESULT").Value & "", intRow, colRMACHRESULT)
                Call SetText(frmInterface2.spdResult, AdoRs_Local.Fields("RESULT").Value & "", intRow, colRLISRESULT)
                ...
                Else
                    ...
                    .FontBold = False
                End If
                Call SetText(frmInterface2.spdResult, AdoRs_Local.Fields("PREVRESULT").Value & "", intRow, colRPREVRESULT)
...
On Error GoTo ErrHandle
    If DbConnect_ORACLE = True Then
        ...
        RS.Close
        ''Call SetCommStatus("R", Format(Now, "yyyy-mm-dd"), frmInterface2.lstComStatus)
    End If
