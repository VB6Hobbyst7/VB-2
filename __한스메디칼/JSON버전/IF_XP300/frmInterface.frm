...
Begin VB.Form frmInterface 
   ...
   Begin VB.Frame fraHidden 
      ...
      Begin FPSpreadADO.fpSpread spdPatOrder 
         ...
         MaxCols         =   2
         MaxRows         =   1
         SpreadDesigner  =   "frmInterface.frx":9CE4
      End
      Begin VB.Image imgOn 
         Height          =   480
         Left            =   690
         Picture         =   "frmInterface.frx":A140
         Top             =   1440
         Width           =   480
      End
   ...
   Begin FPSpreadADO.fpSpread spdWork 
      ...
      ShadowDark      =   12632256
      SpreadDesigner  =   "frmInterface.frx":B2D4
      VisibleCols     =   3
      VisibleRows     =   10
      ScrollBarTrack  =   1
      ShowScrollTips  =   1
   ...
   Begin FPSpreadADO.fpSpread spdOrder 
      ...
      ShadowColor     =   14737632
      ShadowDark      =   12632256
      SpreadDesigner  =   "frmInterface.frx":BFCE
      UnitType        =   0
      VisibleCols     =   3
      VisibleRows     =   10
      ScrollBarTrack  =   3
   ...
   Begin FPSpreadADO.fpSpread spdResult 
      ...
      ShadowColor     =   14737632
      ShadowDark      =   12632256
      SpreadDesigner  =   "frmInterface.frx":CC70
      VisibleCols     =   3
      VisibleRows     =   10
      CellNoteIndicatorColor=   16576
...
Private Sub cmdSearch_Click()
    ...
    Else
        Call GetWorkList(Format(dtpFrom.Value, "yyyymmdd"), Format(dtpTo.Value, "yyyymmdd"), spdWork, "", "", IIf(chkSave.Value = "1", True, False), IIf(chkG.Value = "1", "G", ""))
    End If
