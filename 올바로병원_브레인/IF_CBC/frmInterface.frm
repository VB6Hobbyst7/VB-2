...
Begin VB.Form frmInterface 
   ...
   Begin FPSpread.vaSpread spdResult 
      ...
      ScrollBarExtMode=   -1  'True
      ShadowColor     =   16777215
      SpreadDesigner  =   "frmInterface.frx":B5C5
      ScrollBarTrack  =   3
      ShowScrollTips  =   3
   End
   ...
   Begin VB.PictureBox picBottom 
      ...
      Begin VB.Image imgReceive 
         Height          =   240
         Left            =   8730
         Picture         =   "frmInterface.frx":10296
         Top             =   180
         Width           =   240
      End
      ...
      Begin VB.Image imgNet1 
         Height          =   240
         Left            =   390
         Picture         =   "frmInterface.frx":10820
         Top             =   180
         Width           =   240
      End
      Begin VB.Image imgNet2 
         Height          =   240
         Left            =   390
         Picture         =   "frmInterface.frx":1096A
         Top             =   180
         Width           =   240
      End
      Begin VB.Image imgNet3 
         Height          =   240
         Left            =   390
         Picture         =   "frmInterface.frx":10AB4
         Top             =   180
         Width           =   240
      End
   ...
   Begin FPSpread.vaSpread spdWork 
      ...
      ScrollBarExtMode=   -1  'True
      ShadowColor     =   16777215
      SpreadDesigner  =   "frmInterface.frx":10BFE
      ScrollBarTrack  =   3
      ShowScrollTips  =   3
   End
End
    ...
    If Not RS_L.EOF = True And Not RS_L.BOF = True Then
        ...
        With frmInterface
            ...
            For intCol = colSTATE + 1 To .spdOrder.MaxCols
                ...
                'If GetTestNm(strAbbrName, False) = gArrEQP(intCol - colSTATE, 6) Then
                    ...
                    'MsgBox strOrderCode & "," & strTestCodeSub
                    Exit For
                End If
            Next
...
'                End If
            ...
            ElseIf mGetP(strRcvBuf, 1, vbTab) = "patientNo" Then
                strBarno = mGetP(strRcvBuf, 2, vbTab)
                strBarno = mGetP(strBarno, 1, Space(1))
                '-- 결과정보
                With mResult
                    .BarNo = strBarno
'                    .RackNo = strRackNo
        ...
        For intCnt = 1 To UBound(strRData)
            ...
            Select Case strType
                ...
                Case "D "    '## Result
                    ...
                    'D 000306 0016                        E001  3.87r 002 44.14r 003  9.06r 004 16.49r 006  0.51r 007  5.68r 010  0.89r 012  0.97r 013 18.94r DE
                    strBarno = Trim$(Mid$(strRcvBuf, 14, 20))
                    mResult.BarNo = strBarno
                    ...
                    If strBarno = "" Then
                        strBarno = mResult.RackNo & "/" & mResult.TubePos
        ...
        If colBARCODE = sCol Then
            ...
            Else
                ...
                If gHOSP.MACHNM = "VISIONB" Then
                    SQL = SQL & " ,EXAMCODESUB = '" & Trim(GetText(spdOrder, sRow, colPID)) & "'" & vbCrLf
                End If
