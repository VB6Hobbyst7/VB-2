...
Private Sub imgMenuInsert_Click()
    ...
    Else
        ...
        Call WritePrivateProfileString("DATABASE", "ORACLESID", strSID, App.PATH & "\OKSOFT.ini")
        Call WritePrivateProfileString("DATABASE", "ORACLEUID", strUID, App.PATH & "\OKSOFT.ini")
        Call WritePrivateProfileString("DATABASE", "ORACLEPWD", strPWD, App.PATH & "\OKSOFT.ini")
