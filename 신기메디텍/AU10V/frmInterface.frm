   ...
   Begin TabDlg.SSTab stInterface 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin FPSpread.vaSpread vasRes 
            ...
            RetainSelBlock  =   0   'False
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":92A7
         End
...
'    Next
    ...
    GetExamCode
    dtpToday = Date
    sDate = Format(DateAdd("y", CDate(dtpToday.Value), -99), "yyyymmdd")
...
Private Sub EditRcvData()
    ...
    For intCnt = 1 To UBound(strRecvData)
        ...
        Select Case strType
            'NORMAL 2015-10-0814:211                         01v-T4   =1.68     ug/dL 01           
