...
Begin VB.Form frmInterface 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin FPSpread.vaSpread vasID 
         ...
         SpreadDesigner  =   "frmInterface.frx":170D
      End
      ...
      Begin FPSpread.vaSpread vasRes 
         ...
         RetainSelBlock  =   0   'False
         ScrollBars      =   2
         SpreadDesigner  =   "frmInterface.frx":2348
      End
   End
   ...
   Begin VB.Frame FrmHideControl 
      ...
      Visible         =   0   'False
      Width           =   6465
      Begin VB.FileListBox FileOrder 
         Height          =   285
         Left            =   5160
         TabIndex        =   77
         Top             =   3450
      ...
      Begin VB.Frame Frame5 
         ...
         Begin VB.ComboBox cboChk 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmInterface.frx":3A47
            Left            =   2460
            List            =   "frmInterface.frx":3A54
            TabIndex        =   69
            Top             =   1680
            Visible         =   0   'False
            Width           =   975
         ...
         Begin VB.ComboBox cboTest 
            ...
            ForeColor       =   &H00FF0000&
            Height          =   300
            ItemData        =   "frmInterface.frx":3A6C
            Left            =   600
            List            =   "frmInterface.frx":3A6E
            Style           =   2  '드롭다운 목록
            TabIndex        =   68
            Top             =   1650
            Visible         =   0   'False
      ...
      Begin VB.Frame Frame4 
         ...
         Begin FPSpread.vaSpread vasPrint 
            ...
            EndProperty
            MaxCols         =   9
            SpreadDesigner  =   "frmInterface.frx":3A70
         End
         Begin FPSpread.vaSpread vasPrintBuf 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            SpreadDesigner  =   "frmInterface.frx":54E9
         End
      End
      ...
      Begin FPSpread.vaSpread vasCode 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":5701
      End
      Begin FPSpread.vaSpread vasTemp1 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":5919
      End
         ...
         Begin MSComctlLib.ImageList imlStatus 
            ...
            BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
               ...
               BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":60BB
                  Key             =   "RUN"
               EndProperty
               BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":6655
                  Key             =   "NOT"
               EndProperty
               BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":6BEF
                  Key             =   "STOP"
               EndProperty
               BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":7189
                  Key             =   "LST"
               EndProperty
               BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":7A1B
                  Key             =   "ITM"
               EndProperty
               BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":7B75
                  Key             =   "ERR"
               EndProperty
               BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":7CCF
                  Key             =   "NOF"
               EndProperty
            EndProperty
         End
      ...
      Begin FPSpread.vaSpread vasList 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":7E29
      End
      Begin FPSpread.vaSpread vasResTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":8041
      End
      Begin FPSpread.vaSpread vasTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":8259
      End
...
'    Me.WindowState = 2
    ...
    tmrORDER.Interval = 1000
    tmrORDER.Enabled = True
    
    FileOrder.Path = gORDERPATH
...
Private Sub tmrORDER_Timer()
    Dim i, j            As Integer
    Dim strOrderFile    As String
    Dim strOrderBuff    As String
    'Dim strIntBase      As String
    ...
    For i = 0 To FileOrder.ListCount
        If mGetP(FileOrder.List(i), 2, ".") = "ORD" Then
            strOrderFile = FileOrder.Path & "\" & FileOrder.List(i)
            SetRawData "[ORD]" & strOrderFile
            strOrderBuff = getOrderList(strOrderFile)
            mResult.BarNo = mGetP(mGetP(FileOrder.List(i), 2, "_"), 1, ".")
            
            If strOrderBuff <> "" Then
                strRecvData = Split(strOrderBuff, vbCrLf)
                
                For j = 0 To UBound(strRecvData)
                    If j = 0 Then
                        mResult.SaveSeq = getMaxTestNum(Format(dtpToday, "yyyymmdd"))
                        mResult.OrdDate = Mid(strRecvData(j), 1, 14)
                        mResult.MCnt = Trim(Mid(strRecvData(j), 15))
                    Else
                        mResult.TestCd = Trim(Mid(strRecvData(j), 1, 10))
                        mResult.TestNm = Trim(Mid(strRecvData(j), 11))
                        If mResult.TestCd = "" Then
                            Exit For
                        End If
                        '-- 가져온 검사코드의 채널 찾기
                        SQL = ""
                        ...
                        SQL = SQL & "   AND EXAMCODE = '" & mResult.TestCd & "'"
                        Res = GetDBSelectColumn(gLocal, SQL)
                        ...
                        If Res > 0 Then
                            mResult.Channel = Trim(gReadBuf(0))
                            mResult.Seq = Trim(gReadBuf(1))
                        End If
                        
                        '-- 바코드와 검사코드로 조회
                        SQL = ""
                        SQL = SQL & "SELECT Distinct COUNT(*)  "
                        SQL = SQL & "  FROM PATRESULT "
                        SQL = SQL & " WHERE HOSPDATE = '" & mResult.OrdDate & "' "
                        SQL = SQL & "   AND BARCODE  = '" & mResult.BarNo & "'"
                        SQL = SQL & "   AND EXAMCODE = '" & mResult.TestCd & "'"
                        Res = GetDBSelectColumn(gLocal, SQL)
                        
                        If Res > 0 And mResult.Channel <> "" Then
                            If Trim(gReadBuf(0)) = "0" Then
                                'insert
                                SQL = ""
                                SQL = SQL & "INSERT INTO PATRESULT (" & vbCrLf
                                SQL = SQL & " SAVESEQ "                         '장비코드"
                                SQL = SQL & ", EXAMDATE"                        '장비검사일자"
                                ...
                                SQL = SQL & mResult.SaveSeq
                                SQL = SQL & ", '" & Format(dtpToday, "yyyymmdd") & "'"
                                SQL = SQL & ", '" & mResult.OrdDate & "'"
                                SQL = SQL & ", '" & gEquip & "'"
                                SQL = SQL & ", '" & mResult.BarNo & "'"
                                SQL = SQL & ", '" & mResult.Channel & "'"
                                SQL = SQL & ", '" & mResult.TestCd & "'"
                                SQL = SQL & ", '" & mResult.TestNm & "'"
                                SQL = SQL & ", '" & mResult.Seq & "'"
                                SQL = SQL & ",'0'"
                                SQL = SQL & ",''"
                                SQL = SQL & ",'" & gIFUser
    ...
    tmrORDER.Interval = gREADINTERVAL
    tmrORDER.Enabled = True
    
End Sub


Private Function getOrderList(ByVal strPath As String) As String
    Dim strBuffer   As String
    Dim TextLine
...
On Error GoTo ErrorTrap
    ...
    Do While Not EOF(1) ' 파일의 끝을 만날 때까지 반복합니다.
        ...
        strBuffer = strBuffer & TextLine & vbCrLf
    Loop
    
    Close #1 ' 파일을 닫습니다
    
    getOrderList = strBuffer
    
    strDestFile = App.Path & "\Log\" & Format(Now, "yyyymmddhhmmss") & ".ORD"
    '원본을 대상에 복사
...
'        Next i
    ...
    Call GetSampleInfoW_MEDILAB(intRow)
...
Private Sub EditRcvDataASTM()
    ...
    For intCnt = 1 To UBound(strRecvData)
        ...
        Select Case strType
            ...
            Case "D "    '## Result
                    'D 001001 00011013002077    E024   3.2r 025   4.2r 026    58r 027  0.11r 028   381r 029  24.2r 097      / 098      / 099      / 
                    'D 000102 0002                              E017  0.15r
                    '
                    ...
                    strType = Trim(Mid(strRcvBuf, 9, 1))
                    ...
                    '응급검체
                    If Mid(strSeq, 1, 1) = "E" Then
                        strBarNo = "E" & Format(Now, "yyyymmddhhmmss")
                    End If
...
Function SetLocalDB(ByVal asRow1 As Long, ByVal asRow2 As Long, asSend As String, Optional asEquipResult As String = "")
    ...
    If Mid(Trim(GetText(vasID, asRow1, colBARCODE)), 1, 1) = "E" Then
        '응급검체 처리
        SQL = ""
        SQL = SQL & "INSERT INTO PATRESULT (" & vbCrLf
        ...
        SQL = SQL & "','" & gEquip
        SQL = SQL & "','" & Mid(Trim(GetText(vasID, asRow1, colBARCODE)), 1, 20)
        ...
        SQL = SQL & "','" & Mid(Trim(GetText(vasRes, asRow2, colMachResult)), 1, 20)
        SQL = SQL & "','" & Mid(Trim(GetText(vasRes, asRow2, colRESULT)), 1, 20)
        SQL = SQL & "','0'"
        SQL = SQL & ",''"
        SQL = SQL & ",'')"
        ...
        End If
'
'            Call SetPatInfo(Trim(GetText(vasID, asRow1, colBARCODE)))
    ...
    Else
        ...
        SQL = SQL & ", DISKNO       = '" & Trim(GetText(vasID, asRow1, colDISKNO)) & "'" & vbCr
        SQL = SQL & ", POSNO        = '" & Trim(GetText(vasID, asRow1, colPOSNO)) & "'" & vbCr
        SQL = SQL & ", EQUIPRESULT  = '" & Trim(GetText(vasRes, asRow2, colMachResult)) & "'" & vbCr
        SQL = SQL & ", RESULT       = '" & Trim(GetText(vasRes, asRow2, colRESULT)) & "'" & vbCr
        SQL = SQL & " WHERE EQUIPNO   = '" & gEquip & "' " & vbCr
        SQL = SQL & "   AND SAVESEQ   = " & Trim(GetText(vasID, asRow1, colSAVESEQ)) & vbCr
        SQL = SQL & "   AND BARCODE   = '" & Trim(GetText(vasID, asRow1, colBARCODE)) & "' " & vbCr
        SQL = SQL & "   AND EQUIPCODE = '" & Trim(GetText(vasRes, asRow2, colEQUIPCODE)) & "'" & vbCr
            ...
            With vasID
                ...
                If IsNumeric(strSeq) Then
                    For i = .ActiveRow To .DataRowCnt
                        Call SetText(vasID, Format(strSeq, "0000"), i, colSN)
                        strSeq = Val(strSeq) + 1
                    Next
                Else
