...
Begin VB.Form frmInterface 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin FPSpread.vaSpread vasRes 
         ...
         RetainSelBlock  =   0   'False
         ScrollBars      =   2
         SpreadDesigner  =   "frmInterface.frx":1FE0
      End
   End
   ...
   Begin VB.Frame FrmHideControl 
      ...
      Begin VB.Frame Frame5 
         ...
         Begin VB.ComboBox cboChk 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmInterface.frx":3638
            Left            =   2460
            List            =   "frmInterface.frx":3645
            TabIndex        =   70
            Top             =   1680
            Visible         =   0   'False
            Width           =   975
         ...
         Begin VB.ComboBox cboTest 
            ...
            ForeColor       =   &H00FF0000&
            Height          =   300
            ItemData        =   "frmInterface.frx":365D
            Left            =   600
            List            =   "frmInterface.frx":365F
            Style           =   2  '드롭다운 목록
            TabIndex        =   69
            Top             =   1650
            Visible         =   0   'False
      ...
      Begin VB.Frame Frame4 
         ...
         Begin FPSpread.vaSpread vasPrint 
            ...
            EndProperty
            MaxCols         =   9
            SpreadDesigner  =   "frmInterface.frx":3661
         End
         Begin FPSpread.vaSpread vasPrintBuf 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            SpreadDesigner  =   "frmInterface.frx":3AC7
         End
      End
      ...
      Begin FPSpread.vaSpread vasCode 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":3CE9
      End
      Begin FPSpread.vaSpread vasTemp1 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":3F0B
      End
         ...
         Begin MSComctlLib.ImageList imlStatus 
            ...
            BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
               ...
               BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":4C51
                  Key             =   "NOT"
               EndProperty
               BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":51EB
                  Key             =   "STOP"
               EndProperty
               BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":5785
                  Key             =   "LST"
               EndProperty
               BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":6017
                  Key             =   "ITM"
               EndProperty
               BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":6171
                  Key             =   "ERR"
               EndProperty
               BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":62CB
                  Key             =   "NOF"
               EndProperty
            EndProperty
         End
      ...
      Begin FPSpread.vaSpread vasList 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":6425
      End
      Begin FPSpread.vaSpread vasResTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":6647
      End
      Begin FPSpread.vaSpread vasTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":6869
      End
      Begin FPSpread.vaSpread vasExcel 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":6A8B
      End
...
'    SQL = SQL & "   AND L.LABSUBYON = 'Y' " & vbCrLf                           '-- 서브코드여부 (결과입력용 서브코드이면 Y)
    ...
    ElseIf chkSaveAll.Value = "1" Then
        SQL = SQL & "   AND L.LABENDDEP <= '3' " & vbCrLf                       '-- 처리상태 (2:접수, 3:결과입력)
    End If
    SQL = SQL & " ORDER BY L.LABODRDTE, L.LABCHTNUM,L.LABBARCOD, L.LABINSNUM, L.LABODRCOD "
...
Private Sub cmdSearch_Click()
    ...
    Select Case gOCS
        ...
        Case "EMEDI":       Call GetWorkList_EMEDI(Format(dtpStartDt.Value, "yyyymmdd"), Format(dtpStopDt.Value, "yyyymmdd"))
    End Select
...
Private Sub GetWorkList_EMEDI(ByVal pFrDt As String, ByVal pToDt As String, Optional pBarNo As String)
    Dim RS          As ADODB.Recordset
    Dim i           As Integer
    Dim iCnt        As Long
    Dim intRow      As Long
    ...
    SQL = ""
    SQL = SQL & "Select DISTINCT R.RESULTDATE as 접수일자, P.PATID as 내원번호, P.PATNAME as 이름, R.SPCMNO as 바코드번호, R.RESULTITEMCODE as ITEM" & vbCrLf
    SQL = SQL & "  From RESULTOFNUM R, REGISTINFOS L, PATMST P " & vbCrLf
    SQL = SQL & " Where R.RESULTDATE BETWEEN '" & pFrDt & "' AND '" & pToDt & "'" & vbCrLf
    'SQL = SQL & "   And R.SPCMNO = '" & pBarNo & "'" & vbCrLf
    SQL = SQL & "   And R.RESULTITEMCODE IN (" & gAllExam & ")" & vbCrLf
    SQL = SQL & "   And R.ACPTDATE = L.ACPTDATE" & vbCrLf
    SQL = SQL & "   And R.ACPTSEQ = L.ACPTSEQ" & vbCrLf
    SQL = SQL & "   And R.PATID = P.PATID"
    SQL = SQL & "   And (R.TEXTRESULTVAL = '' OR R.TEXTRESULTVAL IS NULL)"
    SQL = SQL & " ORDER BY R.RESULTDATE,P.PATID"
        ...
        Do Until RS.EOF
            ...
            With vasID
                ...
                For i = 1 To .DataRowCnt
                    ...
                    If Trim(RS("접수일자")) = strDate And Trim(RS("내원번호")) = strChart Then
                        blnSame = True
                    End If
...
Private Sub SendOrder()
    ...
    Select Case intSndPhase
        ...
        Case 2  '## Patient
            ...
            strOutput = intFrameNo & "P|1|||" & mOrder.PatNo & "|^^||||||||^||||||||||||^^^" & vbCr & ETX
...
Private Sub GetOrder(ByVal pBarNo As String)
    ...
    Else
        ...
        mOrder.PatNo = GetText(vasID, intRow, colCHARTNO)
    End If
...
'    Next i
    ...
    Call GetSampleInfoW_EMEDI(intRow)
...
Private Sub EditRcvDataASTM()
    ...
    For intCnt = 1 To UBound(strRecvData)
        ...
        If Mid(strRcvBuf, 1, 1) = "2" Then
            ...
            strBarNo = "2" & Mid(strRcvBuf, 3, 11)
            strBarNo = Format$(strBarNo, String$(SPCLEN, "#"))
            blnSameBar = True
        Else
            strBarNo = "2" & Mid(strRcvBuf, 4, 11)
            strBarNo = Format$(strBarNo, String$(SPCLEN, "#"))
            blnSameBar = True
        End If
