   ...
   Begin VB.Frame FrmHideControl 
      ...
      Begin VB.Frame Frame4 
         ...
         Begin FPSpread.vaSpread vasPrint 
            ...
            EndProperty
            MaxCols         =   9
            SpreadDesigner  =   "frmInterface.frx":3ADD
         End
         Begin FPSpread.vaSpread vasPrintBuf 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            SpreadDesigner  =   "frmInterface.frx":5556
         End
      End
      ...
      Begin FPSpread.vaSpread vasCode 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":576E
      End
      Begin FPSpread.vaSpread vasTemp1 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":5986
      End
         ...
         Begin MSComctlLib.ImageList imlStatus 
            ...
            BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
               ...
               BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":6128
                  Key             =   "RUN"
               EndProperty
               BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":66C2
                  Key             =   "NOT"
               EndProperty
               BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":6C5C
                  Key             =   "STOP"
               EndProperty
               ...
               BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":7A88
                  Key             =   "ITM"
               EndProperty
               BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":7BE2
                  Key             =   "ERR"
               EndProperty
               BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":7D3C
                  Key             =   "NOF"
               EndProperty
            EndProperty
         End
      ...
      Begin FPSpread.vaSpread vasList 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":7E96
      End
      Begin FPSpread.vaSpread vasResTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":80AE
      End
      Begin FPSpread.vaSpread vasTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":82C6
      End
...
'    db_tmp = ""
'    Call GetPrivateProfileString("config", "LASTSEQ", "", db_tmp, 100, App.Path & "\Interface.ini")
'    frmInterface.txtTemp = Trim(db_tmp)
'    strLastSeq = Trim(frmInterface.txtTemp)
...
'    strSendData = txtRCnt & vbTab & "LIST"

    
'    strSendData = Text1 & vbTab & "GET" & vbTab & txtLastSeq & vbTab & Trim(txtRCnt.Text) - 1
...
Private Sub cmdSearch_Click()
    ...
    Select Case gOCS
        ...
        Case "HWASAN":      Call GetWorkList_HWASAN(Format(dtpStartDt.Value, "yyyymmdd"), Format(dtpStopDt.Value, "yyyymmdd"))
        Case "UJIN":        Call GetWorkList_UJIN(Format(dtpStartDt.Value, "yyyymmdd"), Format(dtpStopDt.Value, "yyyymmdd"))
    End Select
...
Private Sub GetWorkList_HWASAN(ByVal pFrDt As String, ByVal pToDt As String, Optional pBarNo As String)
    Dim RS          As ADODB.Recordset
    Dim i           As Integer
    Dim iCnt        As Long
    Dim intRow      As Long
    ...
    ' O.AllTestNm   모든 검사명
    SQL = ""
    SQL = SQL & "SELECT O.PtID, O.PtNm, O.Sex, O.Age, O.SpcCd, O.SpcNm, O.AllTestNm, O.StatFg, T.TESTCD " & vbCr
    SQL = SQL & "  FROM TC201 O, TC301 T " & vbCr
    SQL = SQL & " WHERE O.SPCNO = T.SPCNO " & vbCr
    'SQL = SQL & "   AND O.SPCNO = '" & sBarcode & "'"
    SQL = SQL & "   And T.TESTCD in (" & gAllExam & ")" & vbCr
...
Private Sub GetWorkList_UJIN(ByVal pFrDt As String, ByVal pToDt As String, Optional pBarNo As String)
    Dim RS          As ADODB.Recordset
    Dim i           As Integer
    Dim iCnt        As Long
    Dim intRow      As Long
...
'    SQL = SQL & "Select DISTINCT a.ORDT as 접수일자,'0',b.PANM as 이름,a.SPNO as 바코드번호,a.PAID as 챠트번호, a.OIFL,'0',b.SEXS as 성별,b.AGES as 나이,a.NWNO as 내원번호,a.ORCD as ITEM " & vbCr
          ...
          SQL = "SELECT DISTINCT GUMSA013.G13_GMDATE as 접수일자, GUMSA013.G13_SAMPLE as 바코드번호, GUMSA013.G13_CHTNO as 내원번호, GUMSA013.G13_SJJNAM as 이름, GUMSA015.G15_SHOWNM as ITEM" & vbCr
    SQL = SQL & "  FROM polly.GUMSA013, polly.GUMSA011 " & vbCr
    SQL = SQL & " WHERE GUMSA013.G13_SAMPLE = GUMSA011.G11_SAMPLE(+) " & vbCr
    '-- 검사파트
    SQL = SQL & "   AND GUMSA013.G13_GMPART = '17' " & vbCr
    '-- 검사일자(=진료일자)
    SQL = SQL & "   AND GUMSA013.G13_GMDATE Between '" & pFrDt & "' AND '" & pToDt & "'" & vbCr
    '-- 진료과목(종합검진 = 90)
    SQL = SQL & "   AND SUBSTR(GUMSA013.G13_JINKWA,1,1) <> '9' " & vbCr
    SQL = SQL & "   AND G13_JINKUL <= '5' " & vbCr
...
''13:17:39 [Tx]0  GET 0   2
''
''13:17:39 [Rx]0  ACK
''1   RESULT  0   VB0119  2016-07-07T02:42:44Z    6   201607070069    45.0    2   2   26.9375 27.625  True    False
''2   RESULT  1   VB0119  2016-07-07T02:42:34Z    5   201607070120    23.8    11  7   26.9375 27.625  True    False
''3   RESULT  2   VB0119  2016-07-07T02:42:24Z    4   201607070118    35.3    92  74  26.9375 27.625  True    False
''
''13:18:14 [Tx]0  GET 0   2
''
''13:18:14 [Rx]0  ACK
''4   RESULT  0   VB0119  2016-07-07T02:42:44Z    6   201607070069    45.0    2   2   26.9375 27.625  True    False
''5   RESULT  1   VB0119  2016-07-07T02:42:34Z    5   201607070120    23.8    11  7   26.9375 27.625  True    False
''6   RESULT  2   VB0119  2016-07-07T02:42:24Z    4   201607070118    35.3    92  74  26.9375 27.625  True    False
...
'''    'strSendData = "0" & vbTab & "GET" & vbTab & "0" & vbTab & Trim(txtRCnt.Text) - 1
'''
'''                    strLastSeq = (strLastSeq - 1) - (txtRCnt.Text - 1)
'''
'''
'''
'''                    strSendData = Text1 & vbTab & "GET" & vbTab & txtLastSeq & vbTab & Trim(txtRCnt.Text) - 1
...
'''                End If
            ...
            Case "RESULTS"
'13:51:29 [Rx]13 RESULTS 122 1
'13:51:29 [Tx]13 GET 121   121
                    
                    
'13:51:29 [Rx]13 RESULTS 122 3
'13:51:29 [Tx]13 GET 121   121
                    '결과요청
                    ...
                    'AckMsg:= TGlobal.FESR_LastSEQ + TAB + 'GET'+ TAB + IntToStr(NS) + TAB + IntToStr(NE);
        End Select
    Next
...
Private Sub SetPatInfo(ByVal pBarNo As String, Optional ByVal pRno As String, Optional ByVal pPno As String)
    ...
    Call GetSampleInfoW_UJIN(intRow)
...
'            End If
            ...
            If strResult <> "" Then
                ...
                If Res > 0 Then
                    ...
                    '판정
                    strFlag = ""
                    If IsNumeric(strResult) And strLow <> "" And strHigh <> "" Then
                        If CDbl(strResult) < CDbl(strLow) Then
                            strFlag = "L"
                        End If
                        
                        If CDbl(strResult) > CDbl(strHigh) Then
                            strFlag = "H"
                        End If
                    End If
...
'                        Next
                        ...
                        SetText vasRes, strResult, lsResRow, colRESULT          '결과
                        SetText vasRes, lsSeqNo, lsResRow, colSeq               '순번
                        SetText vasRes, strLow, lsResRow, colLow                'Low
                        SetText vasRes, strHigh, lsResRow, colHigh              'High
...
Function SetLocalDB(ByVal asRow1 As Long, ByVal asRow2 As Long, asSend As String, Optional asEquipResult As String = "")
    ...
    '-- REFVALUE, REFFLAG
    strRefValue = Trim(GetText(vasRes, asRow2, colLow)) & "|" & Trim(GetText(vasRes, asRow2, colHigh))
