...
Public Sub CtlInitializing()
    ...
    cboEMR.AddItem "브레인              " & Space(100) & "_BRAIN"
    ...
    cboEMR.AddItem "부산대병원          " & Space(100) & "_BUSANUNIV"
    cboEMR.AddItem "NU                  " & Space(100) & "_NU"
    ...
    cboMach.AddItem "CA270B"    '바코드양방향
    cboMach.AddItem "CA270W"    '워크리스트 양방향
