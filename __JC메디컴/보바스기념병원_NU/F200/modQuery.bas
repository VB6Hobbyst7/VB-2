        ...
        For i = 1 To UBound(varRcvData) Step 19
            With SPD
                ...
                For J = 1 To SPD.DataRowCnt
                    ...
                    If varRcvData(i + 1) & "" = strHospDate And varRcvData(i + 0) = strBarcode Then
                        blnSame = True
                    End If
                Next
                ...
                If blnSame = False Then
                    ...
                    SetText SPD, "1", intRow, colCHECKBOX
                    SetText SPD, varRcvData(i + 15) & "", intRow, colHOSPDATE
                    'SetText SPD, varRcvData(i + 1) & "", intRow, colINOUT
                    SetText SPD, varRcvData(i + 0) & "", intRow, colBARCODE
                    SetText SPD, varRcvData(i + 3) & "", intRow, colPID
                    SetText SPD, varRcvData(i + 1) & "", intRow, colPNAME
                    SetText SPD, varRcvData(i + 4) & "", intRow, colPSEX
                    SetText SPD, varRcvData(i + 5) & "", intRow, colPAGE
...
'sRcvData = sRcvData & "</root>"
    ...
    If UBound(varRcvData) >= 0 Then
        ...
        For i = 1 To UBound(varRcvData) 'Step 19
            With SPD
                SetText SPD, "1", asRow, colCHECKBOX
                SetText SPD, Mid(varRcvData(12), 1, 8), asRow, colHOSPDATE
                SetText SPD, varRcvData(1) & "", asRow, colBARCODE
                SetText SPD, varRcvData(4) & "", asRow, colPID
                SetText SPD, varRcvData(2) & "", asRow, colPNAME
                SetText SPD, varRcvData(5) & "", asRow, colPSEX
                SetText SPD, varRcvData(6) & "", asRow, colPAGE
                ...
                If Trim(varRcvData(9) & "") <> "" Then
                    gPatOrdCd = "'" & varRcvData(9) & "',"
                End If
'                    If Trim(varRcvData(9) & "") = "-" Then
'                        gPatOrdCd = gPatOrdCd & "'" & "VB6012A" & "',"
'                    Else
'                        varTstCode = Split(varRcvData(9), "▦")
