...
Private Sub txtBarcode_KeyPress(KeyAscii As Integer)
    ...
    If KeyAscii = vbKeyReturn Then
        ...
        For intCnt = 1 To vasWorkList.MaxRows
            vasWorkList.Row = intCnt
            vasWorkList.Col = colCheckBox
            If vasWorkList.Value = "0" Then
                'vasWorkList.Col = colPName
        ...
        If intRow > 0 Then
            '-- 로컬 저장
            Call SetLocalUpdate(Trim(txtBarcode.Text), intRow)
        ...
        'If blnSave = True And intRow <> vasWorkList.MaxRows Then
