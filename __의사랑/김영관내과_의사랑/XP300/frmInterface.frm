   ...
   Begin TabDlg.SSTab stInterface 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin FPSpread.vaSpread vasWorkList 
            ...
            Protect         =   0   'False
            RetainSelBlock  =   0   'False
            SpreadDesigner  =   "frmInterface.frx":C672
         End
         ...
         Begin FPSpread.vaSpread vasID 
            ...
            RetainSelBlock  =   0   'False
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":D0ED
            UserResize      =   2
         End
...
'        vasID.MaxRows = vasWorkList.MaxRows
    ...
    '                Debug.Print XMLInData.ExamID
                    If Res > 0 Then
                        ...
                        If strBarNo <> XMLInData.ChartNo Or pEqipType <> gReadBuf(3) And gReadBuf(3) = "C" Then
...
'    Winsock1.LocalPort = CInt(gSvrPort) 'CInt(5150)
'    Winsock1.Listen
...
Rst:
    If Err.Number = "8002" Then
        ...
        End If
    Else
        If (MsgBox(Err.Description & vbNewLine & vbNewLine & "   °è¼Ó ÁøÇàÇÏ½Ã°Ú½À´Ï±î?", vbYesNo + vbCritical, Me.Caption)) = vbYes Then
            Resume Next
        Else
            End
        End If
...
Private Sub GetOrder(ByVal pBarNo As String)
    ...
    Call SetText(vasID, mOrder.RackNo, intRow, colDISK)       '-- Rack
    ...
    strItems = GetGetEquipExamCode_XN1000(gEquip, strBarNo, intRow)
