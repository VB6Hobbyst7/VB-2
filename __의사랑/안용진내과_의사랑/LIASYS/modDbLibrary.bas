...
Function GetSampleInfoW(ByVal asRow As Long) As Integer
    ...
    '바코드번호로 환자정보 불러오기
          SQL = "SELECT DiSTINCT CHARTNO, PATNAME, PATSEX, PATAGE,COMPANY,HOSPCODE,PATJUMIN,PATNO,COMMDATE,EXAMNO,EXAMID,IOFLAG,COMMDATE  "
    ...
    If Res = 1 Then
        SetText frmInterface.vasID, "C", asRow, 3
        ...
        SetText frmInterface.vasID, Format(Trim(gReadBuf(12)), "####-##-##"), asRow, 2
...
Function GetEquipExamCode_BS220(argEquipCode As String, argPID As String, Optional intRow As Long) As String
    Dim i As Integer
    ...
    Res = GetDBSelectVas(gLocal, SQL, frmInterface.vasTemp)
    ...
    For i = 1 To frmInterface.vasTemp.DataRowCnt
        strName = Trim(GetText(frmInterface.vasTemp, i, 1))
    ...
    GetEquipExamCode_BS220 = strExamCode
...
Function GetEquipExamCode_LIASYS(argEquipCode As String, argPID As String, Optional intRow As Long) As String
    Dim i As Integer
    Dim strExamCode As String
    Dim sBarcode     As String
    
    GetEquipExamCode_LIASYS = ""
    
    If Trim(argEquipCode) = "" Then
        Exit Function
    End If
    
    sBarcode = argPID 'Trim(GetText(frmInterface.vasID, intRow, colBarcode))   '2 샘플 바코드 번호
    ...
    End If
    '-- 첫자리 "\" 자르기
    GetEquipExamCode_LIASYS = strExamCode
