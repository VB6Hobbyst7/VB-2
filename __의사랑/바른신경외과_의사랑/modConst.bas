...
''-- QC
'Public Const colLQCLab = 20
'Public Const colLQCLot = 21
'Public Const colLQCAnalyte = 22
'Public Const colLQCMethod = 23
'Public Const colLQCInstrument = 24
'Public Const colLQCReagent = 25
'Public Const colLQCUnit = 26
'Public Const colLQCTemp = 27
'
'Public Const colLUseResSpec = 28
...
Public Const DLE As String = ""      'Chr(16), ""

Public Const RECSEP As String = ""     'Record Separator

'for FREND
Public Const BEGIN    As String = ""       'Chr(24)
Public Const FINIS    As String = ""       'Chr(07)
Public Const READY    As String = "("       'Chr(40)
Public Const RSDTA    As String = "("       'Chr(20)
Public Const ERDTA    As String = ""       'Chr(30)
Public Const QCDTA    As String = "2"       'Chr(50)

Public RcvBuffer        As String
Public strRecvData()    As String
Public strRecv(0)       As String
