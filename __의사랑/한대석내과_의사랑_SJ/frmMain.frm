...
Begin VB.Form frmMain 
   ...
   Begin VB.Frame FraHidden 
      ...
      Begin FPSpread.vaSpread spdQcResult 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmMain.frx":5D21
      End
      Begin FPSpread.vaSpread vasPrintBuf 
         ...
         SpreadDesigner  =   "frmMain.frx":5F92
      End
      Begin VB.Label Label1 
         Appearance      =   0  '평면
         AutoSize        =   -1  'True
   ...
   Begin VB.PictureBox Picture2 
      ...
      Begin VB.Frame fraResult 
         ...
         Begin VB.ComboBox cboRstType 
            Appearance      =   0  '평면
            Height          =   300
            ItemData        =   "frmMain.frx":E55C
            Left            =   420
            List            =   "frmMain.frx":E55E
            TabIndex        =   118
            Top             =   180
            Width           =   1245
         End
         Begin VB.ComboBox cboState 
            Height          =   300
            ItemData        =   "frmMain.frx":E560
            Left            =   4710
            List            =   "frmMain.frx":E562
            TabIndex        =   117
            Top             =   180
            Width           =   1395
         End
   ...
   Begin VB.Frame frame2 
      ...
      Begin FPSpread.vaSpread spdRResult 
         ...
         SpreadDesigner  =   "frmMain.frx":11519
         TextTip         =   2
      End
      Begin FPSpread.vaSpread spdROrder 
         ...
         SpreadDesigner  =   "frmMain.frx":11F3D
         UserResize      =   2
      End
   ...
   Begin VB.Frame frame1 
      ...
      Begin VB.Frame fraDUREADER720 
         ...
         Begin VB.ComboBox cboWbcM 
            ...
            EndProperty
            Height          =   300
            ItemData        =   "frmMain.frx":164F0
            Left            =   1020
            List            =   "frmMain.frx":16500
            TabIndex        =   183
            Text            =   "Combo3"
            Top             =   360
            Width           =   1695
      ...
      Begin FPSpread.vaSpread spdOrder 
         ...
         SelectBlockOptions=   0
         ShadowColor     =   14548991
         SpreadDesigner  =   "frmMain.frx":16510
         UserResize      =   2
      End
      Begin FPSpread.vaSpread spdResult 
         ...
         SelectBlockOptions=   0
         ShadowColor     =   13697023
         SpreadDesigner  =   "frmMain.frx":1AA91
         TextTip         =   2
      End
   End
   Begin VB.Frame frame3 
      ...
      Begin VB.Frame frameTestSet 
         ...
         Begin VB.Frame frameOrder 
            ...
            Begin FPSpread.vaSpread spdOrdMst 
               ...
               SelectBlockOptions=   0
               ShadowColor     =   13697023
               SpreadDesigner  =   "frmMain.frx":1B53B
               TextTip         =   2
            End
         End
         Begin VB.ComboBox cboResultType 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmMain.frx":1BADC
            Left            =   1650
            List            =   "frmMain.frx":1BADE
            TabIndex        =   32
            Top             =   5220
            Visible         =   0   'False
            Width           =   1575
      ...
      Begin FPSpread.vaSpread spdTest 
         ...
         RetainSelBlock  =   0   'False
         SelectBlockOptions=   0
         SpreadDesigner  =   "frmMain.frx":1E9D8
      End
   End
   Begin VB.Frame frame4 
      ...
      Begin VB.Frame frameCom 
         ...
         Begin VB.ComboBox cboPort 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmMain.frx":204E7
            Left            =   2190
            List            =   "frmMain.frx":204E9
            TabIndex        =   52
            Top             =   390
            Width           =   2205
         End
         Begin VB.ComboBox cboBaudrate 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmMain.frx":204EB
            Left            =   2190
            List            =   "frmMain.frx":204ED
            TabIndex        =   51
            Top             =   780
            Width           =   2205
         End
         Begin VB.ComboBox cboDatabit 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmMain.frx":204EF
            Left            =   2190
            List            =   "frmMain.frx":204F1
            TabIndex        =   50
            Top             =   1170
            Width           =   2205
         End
         ...
         Begin VB.ComboBox cboParity 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmMain.frx":204F3
            Left            =   2190
            List            =   "frmMain.frx":204F5
            TabIndex        =   47
            Top             =   2520
            Width           =   2205
         End
...
Private Sub lblRPrint_Click()

    spdROrder.PrintOrientation = PrintOrientationLandscape
'    spdROrder.PrintOrientation = PrintOrientationPortrait
    spdROrder.Action = 13
    
End Sub

Private Sub lblRPrint_MouseMove(Button As Integer, Shift As Integer, X As Single, Y As Single)
    ...
    lblRPrint.ForeColor = vbBlue
    shpRP.BorderColor = vbCyan
...
Private Sub lblRSave_Click()
    ...
    For lRow = 1 To spdROrder.DataRowCnt
        ...
        If spdROrder.Value = 1 Then
            ...
            Res = SaveTransDataR_UBCARE(lRow)
        ...
        For intCnt = 1 To UBound(strRecvData)
            ...
            Select Case strType
                ...
                Case "O"
                    ...
                    strSeq = Trim(mGetP(mGetP(strRcvBuf, 4, "|"), 3, "^"))
                    mOrder.Seq = strSeq
                    With mResult
                        '.BarNo = strBarno
                        .Seq = strSeq
