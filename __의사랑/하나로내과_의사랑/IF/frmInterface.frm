...
Begin VB.Form frmInterface 
   ...
   Begin VB.Frame fraHidden 
      ...
      Begin MSComctlLib.ImageList imlStatus 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmInterface.frx":000C
               Key             =   "RUN"
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmInterface.frx":05A6
               Key             =   "NOT"
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmInterface.frx":0B40
               Key             =   "STOP"
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmInterface.frx":10DA
               Key             =   "LST"
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmInterface.frx":196C
               Key             =   "ITM"
            EndProperty
            BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmInterface.frx":1AC6
               Key             =   "ERR"
            EndProperty
            BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmInterface.frx":1C20
               Key             =   "NOF"
            EndProperty
            BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmInterface.frx":1D7A
               Key             =   "ON"
               Object.Tag             =   "OFF"
            EndProperty
            BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmInterface.frx":2654
               Key             =   ""
            EndProperty
         EndProperty
      End
      ...
      Begin HSCotrol.CButton cmdOrderSend 
         ...
         HoverColor      =   0
      End
      Begin HSCotrol.CButton cmdResultRequest 
         Height          =   495
         Left            =   6030
         TabIndex        =   75
         Top             =   1320
   ...
   Begin FPSpread.vaSpread spdOrder 
      ...
      SpreadDesigner  =   "frmInterface.frx":457A
      ScrollBarTrack  =   3
      ShowScrollTips  =   3
   End
   Begin FPSpread.vaSpread spdResult 
      ...
      ScrollBarExtMode=   -1  'True
      ShadowColor     =   16777215
      SpreadDesigner  =   "frmInterface.frx":645D
      ScrollBarTrack  =   3
      ShowScrollTips  =   3
   End
   ...
   Begin FPSpread.vaSpread spdWork 
      ...
      ScrollBarExtMode=   -1  'True
      ShadowColor     =   16777215
      SpreadDesigner  =   "frmInterface.frx":C347
      ScrollBarTrack  =   3
      ShowScrollTips  =   3
   End
End
...
Dim mYN_Flag    As Boolean      'for BT-3000
Dim mY_Flag     As Boolean      'for BT-3000
...
Private Sub cmdReceive_Click()
    ...
    If cmdReceive.Caption = "결과수신" Then
        cmdReceive.Caption = "수신중.."
...
'        intPhase = 3
        ...
        tmrBT1500.Interval = 3000
        tmrBT1500.Enabled = True
        
        cmdOrder.Enabled = False
    Else
        tmrBT1500.Enabled = False
        cmdReceive.Caption = "결과수신"
...
Private Sub cmdResultRequest_Click()
    Dim strSndData  As String

    If spdOrder.MaxRows < 1 Then
        MsgBox "검사대상자가 없습니다.", vbOKOnly + vbCritical, Me.Caption
    Else
        tmrSelexOn.Enabled = False
        strState = "ST"
        strSndData = "ST" & vbCr & vbLf
    ...
    If MsgBox("선택한 결과를 전송하시겠습니까?", vbYesNo + vbCritical, "결과전송") = vbYes Then
        With spdOrder
            ...
            For lngRow = .MaxRows To 1 Step -1
                ...
                .Col = colSTATE
                If .Text = "저장완료" Then
                    Call DeleteRow(spdOrder, lngRow, lngRow)
                    .MaxRows = .MaxRows - 1
                End If
            Next
...
'        .MaxRows = .MaxRows + 100
'        For i = 1 To .MaxRows
'            Call SetText(spdWork, CStr(i), i, colBARCODE)
...
Private Sub ReceiveProcess()
    ...
    If gComm.COMTYPE = "1" Then
        ...
        Select Case UCase(gHOSP.MACHNM)
            ...
            Case "MYTHIC18":        Call Phase_Serial_MYTHIC18
            Case "BT1500":          Call Phase_Serial_BT1500
            Case "BC1800":          Call Phase_Serial_BC1800
            Case "XP300":           Call Phase_Serial_XP300
            Case "UROMETER720":     Call Phase_Serial_UROMETER720
            Case "D10":             Call Phase_Serial_D10
            Case "XL200":           Call Phase_Serial_XL200
...
Private Sub cmdXML_Click()
    ...
    If FindFile <> "" Then
        If MsgBox("XML 오더파일을 삭제하시겠습니까?.", vbYesNo + vbCritical, Me.Caption) = vbYes Then
            Kill "C:\UBCare\SINAI\IF\ExamIF_In.xml"
            MsgBox "XML 오더파일이 정리되었습니다.", vbOKOnly + vbInformation, Me.Caption
        End If
    End If
...
Private Sub GetOrder_BT1500(ByVal pBarNo As String, ByVal pType As String)
...
'            Case "3"
                For i = 1 To .spdOrder.DataRowCnt
                    If GetText(frmInterface.spdOrder, i, colCHECKBOX) = "1" And GetText(frmInterface.spdOrder, i, colSTATE) = "" Then
                        pBarNo = Trim(GetText(frmInterface.spdOrder, i, colBARCODE))
                        mOrder.BarNo = pBarNo
                        mOrder.Seq = Trim(GetText(frmInterface.spdOrder, i, colSEQNO))
                        intRow = i
                        blnOrder = True
                        Exit For
                    End If
...
'        End Select
        ...
        '-- 로컬테이블에서 검사항목에 해당하는 검사채널 찾아오기 (intRow = 기존 검사했던 바코드가 다시 올라올 경우 위치를 못찾는다.)
        strItems = GetEquipExamCode_BT1500(gHOSP.MACHCD, pBarNo, intRow)
        ...
        If Trim(strItems) = "" Then
            ...
            GetOrder = LEFT(mOrder.BarNo & Space(15), 15) & "T" & "S" & "N" & Format(mOrder.Seq, "00") & Format(CStr(mOrder.SendCnt), "00") & mOrder.Order
            GetOrder = GetOrder & BT3000_CheckSum(GetOrder) & EOT
        ...
        Else
            ...
            GetOrder = LEFT(mOrder.BarNo & Space(15), 15) & "T" & "S" & "N" & Format(mOrder.Seq, "00") & Format(CStr(mOrder.SendCnt), "00") & mOrder.Order
            'GetOrder = LEFT(mOrder.BarNo & Space(15), 15) & "T" & "S" & "N" & Format(mOrder.Seq, "00") & "01" & mOrder.Order
            GetOrder = GetOrder & BT3000_CheckSum(GetOrder) & EOT
...
Private Sub SendData(ByVal pSendData As Variant)
    ...
    '-- 로그기록
    Call SetRawData("[Tx]" & pSendData & vbCrLf)
...
'                    End If
            ...
            Case "L"
                ...
                For i = colSTATE + 1 To spdOrder.MaxCols
                    spdOrder.Row = 0
                    spdOrder.Col = i
                    If spdOrder.FontBold = True Then                            '-- 계산항목은 굵은글자로 표시됨
                        strCalChannel = GetChannel(spdOrder.Text)               '-- 계산항목의 채널찾기
                        ...
                        For j = 1 To UBound(varCalCulate) Step 2                '-- 한개의 검사에 "%"가 2개 이므로.. Step 2
                            For k = colSTATE + 1 To spdOrder.MaxCols
                                spdOrder.Row = 0
                                spdOrder.Col = k
                                If spdOrder.Text = varCalCulate(j) Then         '-- 검사 약어가 같으면
                                    strCalNm(m) = varCalCulate(j)               '-- 검사 약어 저장
                                    strCalCon(m) = GetText(spdOrder, gRow, k)   '-- 검사 결과 저장
                                    '-- 검사결과값
                                    If strCalCon(m) = "" Then                   '-- 대상결과값이 하나라도 없으면 연산하지 않는다.
                                        m = 0
                                        GoTo NextCal
                                    Else                                        '-- 대상항목을 결과값으로 바꾼다
...
Private Sub SerialRcvData_BC1800()
    '장비 수신 변수
    Dim strRcvBuf       As String   '수신한 Data
    Dim strType         As String   '수신한 Record Type
    Dim strBarno        As String   '수신한 바코드번호
...
On Error GoTo RST
    ...
    With frmInterface
        ...
        '1234567890
        'AAAI10P190000000371500070520181209
        '0052   wbc(01)     5.2
        '0008   ly#(02)     0.8
        '0005   mi#(03)     0.5
        '0039   gr#(04)     3.9
        ...
        '168    pct(18)     0.168
        '   0526   rdw-sd(19)  52.6
        '00000000000010110000011038051255027179016236000000
        
        strBarno = Trim(Mid(strRcvBuf, 12, 10))     '0000037150
        'strIFDate = CStr(Mid(strRcvBuf, 23, 4))             '0705 (time)
        'strIFDate = strIFDate & CStr(Mid(strRcvBuf, 27, 8)) '20181209 (date)
        ...
        For ii = 1 To 19
            strIntBase = ii
            Select Case ii
                Case 1, 2, 3, 4, 10, 11, 12, 19                 '###.#  : WBC, Lymph#, Mid#, Gran#, MCHC, MCV, MCH, RDW-SD
                        strResult = Mid(strRcvBuf, intIdx, 4)
                        strResult = Mid(strResult, 1, 3) & "." & Mid(strResult, 4, 1)
                        intIdx = intIdx + 4
                Case 5, 6, 7, 9, 13, 14, 16, 17                 '##.#   : Lymph%, Mid%, Gran%, HGB,RDW-CV,HCT,MPV, PDW
                        strResult = Mid(strRcvBuf, intIdx, 3)
                        strResult = Mid(strResult, 1, 2) & "." & Mid(strResult, 3, 1)
                        intIdx = intIdx + 3
                Case 8                                          '#.##   : RBC
                        strResult = Mid(strRcvBuf, intIdx, 3)
                        strResult = Mid(strResult, 1, 1) & "." & Mid(strResult, 2, 2)
                        intIdx = intIdx + 3
                Case 15                                         '####   : PLT
                        strResult = Mid(strRcvBuf, intIdx, 4)
                        intIdx = intIdx + 4
...
RST:
    strErrMsg = ""
    strErrMsg = strErrMsg & "위    치 : " & gHOSP.MACHNM & "_SerialRcvData_BC1800" & vbNewLine & vbNewLine
    strErrMsg = strErrMsg & "오류번호 : " & Err.Number & vbNewLine & vbNewLine
    strErrMsg = strErrMsg & "오류내용 : " & Err.Description & vbNewLine
    frmErrMsg.txtErr = vbNewLine & strErrMsg
    frmErrMsg.Show
...
Private Sub SerialRcvData_MYTHIC18()
    '장비 수신 변수
    Dim strRcvBuf       As String   '수신한 Data
    Dim strType         As String   '수신한 Record Type
    Dim strBarno        As String   '수신한 바코드번호
...
On Error GoTo RST
    ...
    With frmInterface
        ...
        For ii = 0 To UBound(strRecvData)
            strRcvBuf = strRecvData(ii) 'RcvBuffer
            strRcvBuf = Replace(strRcvBuf, vbLf, "")
            Call SetSQLData("RCV", strRcvBuf, "A")
            
            tmpData = Split(strRcvBuf, ";")
            
            If UBound(tmpData) > 1 Then
                If UCase(Trim(tmpData(2))) = "RESULT_READY" Then
                    Call SendData("ACK_RESULT_READY" & Chr(13))
                    Exit Sub
                ElseIf UCase(Trim(tmpData(2))) = "RESULT" Then
                    strState = "R"
                End If
            End If
            
            If strState = "R" Then
                Select Case UCase(Trim(tmpData(0)))
                    Case "DATE"
                    Case "TIME"
                    Case "MODE"
                    Case "UNIT"
                    Case "SEQ"
                        mResult.Seq = Trim(tmpData(1))
                        If blnResult = False Then
                            ...
                            End With
                            '-- 결과환자정보
                            Call SetPatInfo(mResult.BarNo, gHOSP.RSTTYPE)
                            If gRow <= 0 Then
                                Exit Sub
                            End If
                            strState = "O"
                    ...
                    Case "SID"
                        mResult.BarNo = Trim(tmpData(1))
                    Case "PID"
                    Case "ID"
                    Case "TYPE"
                    Case "TEST"
                    Case "END_RESULT"
                        Call SendData("ACK_RESULT" & Chr(13))
                    ...
                    Case Else
                        ...
                        If UBound(tmpData) > 1 Then
                            strIntBase = UCase(Trim(tmpData(0)))
                            strResult = Trim(tmpData(1))
                            strIntResult = strResult
...
RST:
    strErrMsg = ""
    strErrMsg = strErrMsg & "위    치 : " & gHOSP.MACHNM & "_SerialRcvData_MYTHIC18" & vbNewLine & vbNewLine
    strErrMsg = strErrMsg & "오류번호 : " & Err.Number & vbNewLine & vbNewLine
    strErrMsg = strErrMsg & "오류내용 : " & Err.Description & vbNewLine
    frmErrMsg.txtErr = vbNewLine & strErrMsg
    frmErrMsg.Show
...
Private Sub SerialRcvData_BT1500()
    '장비 수신 변수
    Dim strRcvBuf       As String   '수신한 Data
    Dim strType         As String   '수신한 Record Type
    Dim strBarno        As String   '수신한 바코드번호
...
'09220000043395 TS014 T-P6.71400 GOT11.1740 ALB4.37800 GPT6.24000 GGT22.1970 ALP48.7110 CRE0.91900 LDH143.863 CHO215.227 T-G100.949 BUN9.69900 T-B0.89300 GLU99.4990 HDL81.0010062
'strRcvBuf = "09220000043395TS014 T-P6.71400 ALB4.37800 GOT11.1740 GPT6.24000 GGT22.1970 T-B0.89300 ALP48.7110 GLU99.4990 LDH143.863 CHO215.227 T-G100.949 HDL81.0010 CRE0.91900 BUN9.69900062"
        
        If Len(strRcvBuf) < 21 Then
            Exit Sub
        End If
 '       strRcvBuf = "          46646TS005 GOT15.0920 GPT9.98200 GGT13.6320 GLU89.1730 CRE1000000128"
        strBarno = Trim(Mid(strRcvBuf, 1, 15))
        strBarno = Trim(strBarno)
        strCnt = Mid(strRcvBuf, 18, 3)
        strCnt = Val(strCnt)
        mResult.RSTCNT = strCnt
        ...
        strTemp1 = Mid(strRcvBuf, 21)
        miRealCnt = 0
        
        For i = 0 To strCnt - 1
            strIntBase = Trim(Mid(strTemp1, (i * 11) + 1, 4))
            strIntResult = Trim(Mid(strTemp1, (i * 11) + 5, 7))
...
RST:
    strErrMsg = ""
    strErrMsg = strErrMsg & "위    치 : " & gHOSP.MACHNM & "_SerialRcvData_BT1500" & vbNewLine & vbNewLine
    strErrMsg = strErrMsg & "오류번호 : " & Err.Number & vbNewLine & vbNewLine
    strErrMsg = strErrMsg & "오류내용 : " & Err.Description & vbNewLine
    frmErrMsg.txtErr = vbNewLine & strErrMsg
    frmErrMsg.Show
                    ...
                    Else
                        ...
                        If Not RS_L.EOF = True And Not RS_L.BOF = True Then
                            ...
                            With frmInterface
                                ...
                                SetText .spdResult, strTestName, intRstRow, colRTESTNM              '검사명
                                SetText .spdResult, strIntBase, intRstRow, colRCHANNEL              '장비채널
                                SetText .spdResult, strResult, intRstRow, colRMACHRESULT        '장비결과
                                SetText .spdResult, strResult, intRstRow, colRLISRESULT             'LIS결과
...
On Error GoTo RST
    ...
    With frmInterface
        ...
        Select Case strType
            Case "H"    '## Header
                '1H|\^&|||cobas-e411^1|||||host|RSUPL^REAL|P|1
                strState = "H"
            Case "Q"    '## Request Information
                strState = "Q"
                strQState = "Q"
            ...
            Case "O"
                'O|1|190422-204503|1^0^1^^S1^SC|^^^900^1\^^^410^1\^^^630^1|R||20200203084154||||N||||1|||||||20200203090634|||F
                'O|1|191705-204506|2^0^2^^S1^SC|^^^630^1|R||20200203084155||||N||||1|||||||20200203090716|||F
                strState = "O"
            ...
            Case "R"
                'R|2|^^^410/1/not|>1000|IU/l||HH||F|||||E1
                'R|1|^^^630/1/not|58.07|IU/ml||N||F|||||E1
                'R|1|^^^900/1/not|-1^0.450|COI||N||F|||||E1
                '1  : positive
                '0  : border line
                '-1 : nagative
        ...
        For intCnt = 1 To UBound(strRData)
            ...
            Select Case intCnt
                ...
                Case 9 To 27
                    ...
                    strResult = Replace(strResult, "L", "")
                    strResult = Replace(strResult, "z", "")
                    strResult = Replace(strResult, "Z", "")
                    strResult = Replace(strResult, " ", "")
                    
                    strResult = Replace(strResult, "S", "")
                    strResult = Replace(strResult, "s", "")
                    strResult = Replace(strResult, "R", "")
                    strResult = Replace(strResult, "r", "")
                    strIntResult = strResult
...
Private Sub Phase_Serial_BT1500()
    Dim Buffer      As Variant
    Dim BufChar     As String
    Dim lngBufLen   As Long
    Dim i           As Long
...
'                        intPhase = 2
'                        txtPhase.Text = 2
'                        Call GetOrder_BT1500(strBarno, gHOSP.RSTTYPE)
'                    Case STX
'                        If mYN_Flag = False Then
'                            Call SendData(ACK)
'                            intPhase = 4
'                            txtPhase.Text = 4
'                        End If
...
'                        blnOrder = False
'                        mYN_Flag = False
'                        For j = 1 To spdOrder.DataRowCnt
'                            spdOrder.Row = j
'                            spdOrder.Col = colCHECKBOX
'                            If spdOrder.Value = "1" And GetText(spdOrder, j, colSTATE) = "" Then
'                                blnOrder = True
'                                Exit For
'                            End If
'                        Next j
...
'                            RcvBuffer = RcvBuffer & BufChar
'                            MDIIF.lblTestDate.Caption = Format(Now, "yyyy-mm-dd")
'                            Call SerialRcvData_BT1500
'
'                            SetRawData "" & "mResult.RSTCNT = " & mResult.RSTCNT & vbCrLf
'                            SetRawData "" & "miRealCnt      = " & miRealCnt & vbCrLf
'
'                            If mResult.RSTCNT = miRealCnt Then
'                                RcvBuffer = ""
'                                intPhase = 3
'                                txtPhase.Text = 3
'                                lblPhase = intPhase
...
Private Sub Phase_Serial_MYTHIC18()
    Dim Buffer      As Variant
    Dim BufChar     As String
    Dim lngBufLen   As Long
    Dim i           As Long
    ...
    For i = 1 To lngBufLen
        ...
        Select Case BufChar
            ...
            Case vbCr
                    ...
                    strRecvData(intBufCnt) = RcvBuffer
                    
                    If InStr(RcvBuffer, "END_RESULT") > 0 Then
                        Call SerialRcvData_MYTHIC18
                        Erase strRecvData
                        intBufCnt = 0
                    End If
...
'    If blnLast = False And blnOrder = False Then
'
'    End If
...
'''    End If
    ...
    For intCol = 1 To colSTATE
        ...
        'If intCol = colHOSPDATE Or intCol = colBARCODE Or intCol = colPNAME Or intCol = colCHARTNO Or intCol = colCHECKBOX Then
...
'''    Next
    ...
    '-- 검사마스터정보 gArrEQP(,) 에 담기
    Call GetTestList

    '-- 검사코드 gAllTestCd 에 담기
    Call GetTestCodeList

    '-- 검사마스터명 gArrEQPNm 에 담기
    ...
    If gHOSP.BATCHORDER = "Y" Then
        cmdOrderSend.Visible = True
    Else
        cmdOrderSend.Visible = False
    End If

    If gHOSP.REQRESULT = "Y" Then
        cmdResultRequest.Visible = True
    Else
        cmdResultRequest.Visible = False
    End If

    If gHOSP.MACHNM = "BT1500" Then
...
'                End If
'                For intRow = .ActiveRow + 1 To .MaxRows
'                    Call SetText(spdOrder, strSeq + 1, intRow, colRACKNO)
'                    strSeq = strSeq + 1
'                Next
'            End With
        
        ElseIf sCol = colPOSNO Then
            With spdOrder
                strSeq = GetText(spdOrder, .ActiveRow, .ActiveCol)
                If Not IsNumeric(strSeq) Then
                    MsgBox "숫자만 입력이 가능합니다"
                ...
                For intRow = .ActiveRow + 1 To .MaxRows
                    ...
                    Call SetText(spdOrder, strSeq + 1, intRow, colPOSNO)
...
'    strBarno_Work = Trim(spdWork.Text)
    ...
    With spdOrder
        ...
        If blnSame = False Then
            ...
            For i = colCHECKBOX To colSTATE
                Call SetText(spdOrder, GetText(spdWork, intWRow, i), intRow, i)
'                If i = colSPECIMEN Then
'                    MsgBox GetText(spdWork, intWRow, i)
'                End If
            Next
...
On Error GoTo ErrHandle
    ...
    If DbConnect_PostGres = True Then
        AdoCn.CursorLocation = adUseClient
...
Private Sub tmrSelexOn_Timer()
    Dim strSndData As String

    If strState = "ST" Then
        tmrSelexOn.Enabled = False
        strSndData = "SI" & vbCr & vbLf
        Call SendData(strSndData)
        strState = "SI"
        Exit Sub
    End If
