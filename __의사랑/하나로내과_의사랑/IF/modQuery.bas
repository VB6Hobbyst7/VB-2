...
Public Function GetEquipExamCode_BT1500(argEquipCode As String, argPID As String, Optional intRow As Long) As String
    Dim strExamCode     As String
    Dim strSendCH       As String
    Dim iAffected       As Integer
...
'    SQL = SQL & "   and TESTCODE IN (" & Trim(gPatOrdCd) & ")"
    ...
    If Not AdoRs_Local.EOF = True And Not AdoRs_Local.BOF = True Then
        Do Until AdoRs_Local.EOF
            strSendCH = Trim(AdoRs_Local.Fields("SENDCHANNEL").Value & "")
            If strSendCH <> "" Then
                strExamCode = strExamCode & LEFT(strSendCH & Space(4), 4)
                mOrder.SendCnt = mOrder.SendCnt + 1
            End If
            AdoRs_Local.MoveNext
        Loop
    ...
    GetEquipExamCode_BT1500 = strExamCode
            ...
            For i = 0 To UBound(varXML) - 1
                ...
                If Not RS_L.EOF = True And Not RS_L.BOF = True Then
                    ...
                    If Not RS_C.EOF = True And Not RS_C.BOF = True Then
                        ...
                        '2020-10-19 결과를 지운다.
                        SQL = SQL & "     , RESULT      = ''   " & vbCrLf
                        SQL = SQL & "     , EQUIPRESULT = ''   " & vbCrLf
                        SQL = SQL & "     , SENDFLAG    = '0'  " & vbCrLf
