...
Public Sub SetPatInfo_A1CCARE(ByVal pBarno As String, ByVal pType As String)
    ...
    With frmMain
        For i = 1 To .spdOrder.DataRowCnt
            If Trim(GetText(frmMain.spdOrder, i, colCHECKBOX)) = "1" And Trim(GetText(frmMain.spdOrder, i, colSTATE)) = "" Then
                intRow = i
                Exit For
            End If
        Next i
...
''            .spdOrder.Row = argSpcRow
''            .spdOrder.Col = i
''            If .spdOrder.Text <> "◇" And .spdOrder.Text <> "" Then
''                .spdOrder.Row = 0
''
''                If UCase(.spdOrder.Text) = "HBA1C" Then
''
''                Else
''
''                End If
