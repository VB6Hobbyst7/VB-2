...
Begin VB.Form frmInterface 
   ...
   Begin TabDlg.SSTab stInterface 
      ...
      TabPicture(0)   =   "frmInterface.frx":43A0
      Tab(0).ControlEnabled=   -1  'True
      Tab(0).Control(0)=   "Frame1"
      Tab(0).Control(0).Enabled=   0   'False
      Tab(0).ControlCount=   1
      TabCaption(1)   =   "¹ÞÀº°á°ú"
      TabPicture(1)   =   "frmInterface.frx":43BC
      ...
      Begin VB.Frame Frame3 
         ...
         Begin FPSpread.vaSpread vasRRes 
            ...
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":43D8
         End
         Begin FPSpread.vaSpread vasRID 
            ...
            RetainSelBlock  =   0   'False
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":814D
            UserResize      =   2
         End
      ...
      Begin VB.Frame Frame1 
         ...
         Begin FPSpread.vaSpread vasRes 
            ...
            RetainSelBlock  =   0   'False
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":896A
         End
         ...
         Begin FPSpread.vaSpread vasWorkList 
            ...
            Protect         =   0   'False
            RetainSelBlock  =   0   'False
            SpreadDesigner  =   "frmInterface.frx":C664
         End
         ...
         Begin FPSpread.vaSpread vasID 
            ...
            RetainSelBlock  =   0   'False
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":D0C5
            UserResize      =   2
         End
...
Private Sub cmdRSch_Click()
    ...
    'Res = GetDBSelectVas(gLocal, SQL, vasRID)
          ...
          SQL = "SELECT RSLTDATE, CHARTNO, PATNAME, PATSEX, PATAGE, EXAMID, RESULT " & vbCrLf
    SQL = SQL & "  FROM PAT_RES " & vbCrLf
    SQL = SQL & " WHERE RSLTDATE BETWEEN '" & Format(dtpExamDate, "YYYYMMDD") & "' AND '" & Format(dtpExamDate1, "YYYYMMDD") & "' " & vbCrLf
    'SQL = SQL & "   AND RESULT <> '' "
    SQL = SQL & "   AND EXAMTYPE = 'C' "
    'SQL = SQL & " GROUP BY RSLTDATE, CHARTNO, PATNAME, PATSEX, PATAGE, TRANSYN"
    ...
    With vasRID
        While Not RS1.EOF
            ...
            If blnSame = False Then
                ...
                .SetText 3, iRow, Trim(RS1.Fields("CHARTNO").Value) & ""
                .SetText 4, iRow, Trim(RS1.Fields("PATNAME").Value) & ""
                .SetText 5, iRow, Trim(RS1.Fields("PATSEX").Value) & ""
                .SetText 6, iRow, Trim(RS1.Fields("PATAGE").Value) & ""
        ...
        Case ";"                'SPE  Àü¼Û(¿À´õ¿äÃ»)
            ...
            For i = 1 To vasID.DataRowCnt
                If Trim(GetText(vasID, i, colSpecNo)) = Val(strTubePos) Then
                    strBarNo = Trim(GetText(vasID, i, colBarNo))
    ...
    If KeyAscii = 13 Then
        With vasID
            For intRow = .ActiveRow To .DataRowCnt
                SetText vasID, txtNum, intRow, colSpecNo
