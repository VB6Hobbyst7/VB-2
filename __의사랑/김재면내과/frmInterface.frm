...
Begin VB.Form frmInterface 
   BorderStyle     =   1  '단일 고정
   Caption         =   " URIT8021A Interface Program"
   ClientHeight    =   10530
   ClientLeft      =   150
   ClientTop       =   435
   ClientWidth     =   14925
   ...
   Begin VB.Frame Frame2 
      ...
      Begin FPSpread.vaSpread vasOrderTemp 
         ...
         EndProperty
         MaxCols         =   2
         SpreadDesigner  =   "frmInterface.frx":41D0
      End
      Begin FPSpread.vaSpread vasOrderBuf 
         ...
         EndProperty
         MaxCols         =   2
         SpreadDesigner  =   "frmInterface.frx":7D15
      End
      Begin FPSpread.vaSpread vasResTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":B85A
      End
      ...
      Begin FPSpread.vaSpread vasTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":BA89
      End
   ...
   Begin VB.Frame Frame1 
      ...
      Begin FPSpread.vaSpread vasID 
         ...
         ShadowDark      =   12632256
         SpreadDesigner  =   "frmInterface.frx":FF9E
      End
      Begin FPSpread.vaSpread vasRes 
         ...
         SelectBlockOptions=   0
         ShadowDark      =   12632256
         SpreadDesigner  =   "frmInterface.frx":12513
      End
   End
...
Rst:
    ...
    If Err.Number = "76" Then
        If (MsgBox(gMachPath & vbCr & "경로를 찾을수 없습니다." & vbNewLine & vbNewLine & "   계속 진행하시겠습니까?", vbYesNo + vbCritical, Me.Caption)) = vbYes Then
