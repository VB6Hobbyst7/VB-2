...
Begin VB.Form frmInterface 
   ...
   Begin FPSpread.vaSpread spdOrder 
      ...
      SpreadDesigner  =   "frmInterface.frx":40C2
      ScrollBarTrack  =   3
      ShowScrollTips  =   3
   End
   Begin FPSpread.vaSpread spdResult 
      ...
      ScrollBarExtMode=   -1  'True
      ShadowColor     =   16777215
      SpreadDesigner  =   "frmInterface.frx":5D52
      ScrollBarTrack  =   3
      ShowScrollTips  =   3
   End
   ...
   Begin FPSpread.vaSpread spdWork 
      ...
      ScrollBarExtMode=   -1  'True
      ShadowColor     =   16777215
      SpreadDesigner  =   "frmInterface.frx":B1CE
      ScrollBarTrack  =   3
      ShowScrollTips  =   3
   End
End
...
Private Sub cmdXML_Click()
    ...
    FindFile = Dir(gHOSP.XMLPATH & "\ExamIF_In.xml")


    If FindFile <> "" Then
        'Kill "C:\UBCare\SINAI\IF\ExamIF_In.xml"
        Kill gHOSP.XMLPATH & "\ExamIF_In.xml"
...
On Error GoTo RST
    ...
    With frmInterface
        ...
        Select Case strType
            ...
            Case "R"
                strTmp = mGetP(strRcvBuf, 3, "|")
                'A1c^AREA
                strIntBase = mGetP(strTmp, 4, "^") & "^" & mGetP(strTmp, 5, "^")
