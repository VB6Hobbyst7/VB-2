...
Begin VB.Form frmWorkList 
   ...
   Begin VB.PictureBox picHeader 
      ...
      Begin HSCotrol.CButton cmdSend 
         ...
         HoverColor      =   65535
         HoverPicture    =   "frmWorkList.frx":21CC
      End
      Begin HSCotrol.CButton cmdClose 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "frmWorkList.frx":2326
         MaskColor       =   0
         PicCapAlign     =   2
         BorderStyle     =   1
         BorderColor     =   16777215
         HoverColor      =   65535
         HoverPicture    =   "frmWorkList.frx":38B8
      End
      Begin HSCotrol.CButton cmdSearch 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "frmWorkList.frx":3E52
         MaskColor       =   0
         PicCapAlign     =   2
         BorderStyle     =   1
         BorderColor     =   16777215
         HoverColor      =   65535
         HoverPicture    =   "frmWorkList.frx":595C
      End
      Begin HSCotrol.CButton cmdSendClose 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "frmWorkList.frx":5AB6
         MaskColor       =   0
         PicCapAlign     =   2
         BorderStyle     =   1
         BorderColor     =   16777215
         HoverColor      =   65535
         HoverPicture    =   "frmWorkList.frx":75C0
      End
      Begin HSCotrol.CButton cmdWorkPrint 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "frmWorkList.frx":771A
         MaskColor       =   0
         PicCapAlign     =   2
         BorderStyle     =   1
         BorderColor     =   16777215
         HoverColor      =   65535
         HoverPicture    =   "frmWorkList.frx":9224
      End
   ...
   Begin FPSpread.vaSpread spdWork 
      ...
      SpreadDesigner  =   "frmWorkList.frx":937E
      ScrollBarTrack  =   3
      ShowScrollTips  =   3
   End
End
