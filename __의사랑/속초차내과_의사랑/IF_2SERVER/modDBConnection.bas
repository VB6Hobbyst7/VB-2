...
'로컬데이터베이스
Type LocalDBParameter2
    PATH    As String
    UID     As String
    PWD     As String
End Type

Public gLocalDB2     As LocalDBParameter2
...
'병원데이터베이스(MSSQL2)
Type MSSQLDBParameter2
    IP      As String
    DB      As String
    UID     As String
    PWD     As String
End Type
Public gSQLDB2        As MSSQLDBParameter2

'병원데이터베이스(Postgres SQL2)
Type PGSQLDBParameter2
    IP      As String
    DB      As String
    UID     As String
    PWD     As String
End Type
Public gPGSQLDB2      As PGSQLDBParameter2
...
Global AdoCn_Local2         As ADODB.Connection
...
Public cn_Server_Flag2      As Boolean
...
On Error GoTo ConnectError
    ...
    DB_Name = frmMain.Text3.Text '"D:\프로젝트\VB\__의사랑\속초차내과_의사랑\Interface.mdb" 'gLocalDB.PATH
...
'-- MDB 연결
Public Function DbConnect_Local2() As Boolean
    Dim DB_Name         As String
    Dim UserName        As String
    Dim Password        As String
    Dim blnWinNTAuth    As Boolean

    Set AdoCn_Local2 = New ADODB.Connection

On Error GoTo ConnectError

    DB_Name = frmMain.Text4.Text '"D:\프로젝트\VB\__의사랑\속초차내과_의사랑\H7020.mdb" 'gLocalDB2.PATH
    UserName = gLocalDB.UID
    Password = gLocalDB.PWD

    If (DB_Name = "") Then
        DbConnect_Local2 = False
        Set AdoCn_Local2 = Nothing
        Exit Function
    End If
    Dim i As Integer
...
ConnectError:
    ...
    If AdoCn_Local2.State <> adStateOpen Then
        DbConnect_Local2 = False
        Set AdoCn_Local2 = Nothing
    End If
...
ConnectError:
    ...
    If AdoCn2.State <> adStateOpen Then
        DbConnect_ORACLE2 = False
        Set AdoCn2 = Nothing
    End If
