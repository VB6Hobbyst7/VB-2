            ...
            For i = 0 To UBound(varXML) - 1
                ...
                If Not RS_L.EOF = True And Not RS_L.BOF = True Then
                    ...
                    If Not RS_C.EOF = True And Not RS_C.BOF = True Then
                        ...
                        '2018.12.03 추가 : 기존 환자인 경우 나머지 정보도 업데이트 한다.
'                        SQL = ""
...
'                        SQL = SQL & "   and EXAMCODE = '" & XMLInData.ExamID & "'   " & vbCr
                        ...
                        SQL = SQL & "     , PSEX     = '" & mPatient.SEX & "'       " & vbCr
                        SQL = SQL & "     , Page     = '" & mPatient.AGE & "'       " & vbCr
                        SQL = SQL & "     , EXAMNO   ='" & XMLInData.ExamNo & "'    " & vbCr    '=XML의 검사번호
                        SQL = SQL & " Where EXAMTYPE = '" & gHOSP.PARTCD & "'       " & vbCr
                        SQL = SQL & "   and HOSPDATE = '" & XMLInData.CommDate & "' " & vbCr
                        SQL = SQL & "   and CHARTNO  = '" & XMLInData.ChartNo & "'  " & vbCr
                        SQL = SQL & "   and BARCODE  = '" & strBarNum & "'          " & vbCr
                    ...
                    Else
                        ...
                        SQL = SQL & " VALUES (              " & vbCr
                        SQL = SQL & 0                                                           '저장순번
                        SQL = SQL & ",'" & Format(Now, "yyyymmddhhmmss") & "'"                  '검사일자
                        SQL = SQL & ",'" & XMLInData.CommDate & "'"                             '병원접수일자
                        SQL = SQL & ",'" & gHOSP.MACHCD & "'"                                   '장비코드
                        SQL = SQL & ",'" & strBarNum & "'                           " & vbCr    '검체번호
                        SQL = SQL & ",'" & XMLInData.ComExamID & "'"                            '검사채널
                        SQL = SQL & ",''"                                                       '병원처방코드
                        SQL = SQL & ",'" & XMLInData.ExamID & "'"                               '병원검사코드
                        SQL = SQL & ",''"
                        ...
                        SQL = SQL & ",'" & gHOSP.PARTCD & "'"
                        SQL = SQL & ",'" & XMLInData.ExamNo & "'"                               '=XML의 검사번호
                        SQL = SQL & ",'" & XMLInData.HospCode & "')                 " & vbCr
                        
                            
                        If XMLInData.ComExamID = "9" Then
                            blnTC = True
                        ElseIf XMLInData.ComExamID = "10" Then
                            blnHDL = True
                        ElseIf XMLInData.ComExamID = "11" Then
                            blnTG = True
                        End If
                    End If
