...
Public Function PedLeftSpace(ByVal pData As String, ByVal pLen As Integer)
    Dim intLen  As Integer
    
    PedLeftSpace = ""
    intLen = pLen - Len(pData)
    
    PedLeftSpace = Space(intLen)
'    PedLeftSpace = Replace(PedLeftSpace, " ", pVal)
    PedLeftSpace = PedLeftSpace & pData
    
End Function


Public Function PedRighttSpace(ByVal pData As String, ByVal pLen As Integer)
    Dim intLen  As Integer
    
    PedRighttSpace = ""
    intLen = pLen - Len(pData)
    
    PedRighttSpace = Space(intLen)
    PedRighttSpace = pData & PedRighttSpace
...
Public Sub SetXmlData(argSQL As String)
    Dim FilNum
    Dim sFileName As String
    ...
    Open App.PATH & "\Xml\" & sFileName & ".Xml" For Output As FilNum
    Print #FilNum, argSQL;
    Close FilNum
