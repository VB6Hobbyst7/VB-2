...
Begin VB.Form frmMain 
   ...
   Begin VB.Frame frame1 
      ...
      Begin FPSpread.vaSpread spdResult 
         ...
         SelectBlockOptions=   0
         ShadowColor     =   13697023
         SpreadDesigner  =   "frmMain.frx":156C4
         TextTip         =   2
      End
   End
   Begin VB.Frame frame4 
      ...
      Begin VB.Frame frameCom 
         ...
         Begin VB.ComboBox cboPort 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmMain.frx":16CF0
            Left            =   2190
            List            =   "frmMain.frx":16CF2
            TabIndex        =   63
            Top             =   390
            Width           =   2205
         End
         Begin VB.ComboBox cboBaudrate 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmMain.frx":16CF4
            Left            =   2190
            List            =   "frmMain.frx":16CF6
            TabIndex        =   62
            Top             =   780
            Width           =   2205
         End
         Begin VB.ComboBox cboDatabit 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmMain.frx":16CF8
            Left            =   2190
            List            =   "frmMain.frx":16CFA
            TabIndex        =   61
            Top             =   1170
            Width           =   2205
         End
         ...
         Begin VB.ComboBox cboParity 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmMain.frx":16CFC
            Left            =   2190
            List            =   "frmMain.frx":16CFE
            TabIndex        =   58
            Top             =   2520
            Width           =   2205
         End
   ...
   Begin VB.Frame frame3 
      ...
      Begin VB.Frame frameTestSet 
         ...
         Begin VB.Frame frameOrder 
            ...
            Begin FPSpread.vaSpread spdOrdMst 
               ...
               SelectBlockOptions=   0
               ShadowColor     =   13697023
               SpreadDesigner  =   "frmMain.frx":1847C
               TextTip         =   2
            End
         End
         Begin VB.ComboBox cboResultType 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmMain.frx":189F3
            Left            =   1650
            List            =   "frmMain.frx":189F5
            TabIndex        =   43
            Top             =   5220
            Visible         =   0   'False
            Width           =   1575
         ...
         Begin VB.Frame frameCutOff 
            ...
            Begin VB.ComboBox cboCOH 
               ...
               EndProperty
               Height          =   315
               ItemData        =   "frmMain.frx":189F7
               Left            =   2730
               List            =   "frmMain.frx":189F9
               TabIndex        =   39
               Top             =   1020
               Width           =   735
            End
            ...
            Begin VB.ComboBox cboCOL 
               ...
               EndProperty
               Height          =   315
               ItemData        =   "frmMain.frx":189FB
               Left            =   2730
               List            =   "frmMain.frx":189FD
               TabIndex        =   30
               Top             =   300
               Width           =   735
            End
      ...
      Begin FPSpread.vaSpread spdTest 
         ...
         RetainSelBlock  =   0   'False
         SelectBlockOptions=   0
         SpreadDesigner  =   "frmMain.frx":1C4B5
      End
   End
...
Private Sub SerialRcvData_CELLTAC()
    Dim RS_L            As ADODB.Recordset
    Dim strRcvBuf       As String   '수신한 Data
    Dim strType         As String   '수신한 Record Type
    'Dim strOldBarno        As String   '수신한 바코드번호
...
Private Sub Phase_Serial_CELLTAC()
    Dim Buffer      As Variant
    Dim BufChar     As String
    Dim lngBufLen   As Long
    Dim i           As Long
...
Private Function GetEquipExamCode_BS200E(argEquipCode As String, argPID As String, Optional intRow As Long) As String
    ...
    GetEquipExamCode_BS200E = strExamCode
...
Private Sub SendOrder_BS200E()
    ...
    With frmMain.spdOrder
        For intRow = 1 To .DataRowCnt
            If GetText(frmMain.spdOrder, intRow, colCHECKBOX) = "1" And GetText(frmMain.spdOrder, intRow, colSTATE) = "오더준비" Then
                strBarno = Trim(GetText(frmMain.spdOrder, intRow, colBARCODE))
                strPtNm = Trim(GetText(frmMain.spdOrder, intRow, colPNAME))
                strPTID = Trim(GetText(frmMain.spdOrder, intRow, colCHARTNO))
                strItems = Trim(GetText(frmMain.spdOrder, intRow, colKEY1))
    ...
    '-- 오더문자열만들기
              strSend = SB & "MSH|^~\&|||" & mOrder.Maker & "|" & mOrder.MchNm & "|" & strDtTM & "||DSR^Q03|1|P|2.3.1||||0||ASCII|||" & vbCr
    strSend = strSend & "MSA|AA|" & CStr(intSndPhase) & "|Message accepted|||0|" & vbCr
    strSend = strSend & "ERR|0|" & vbCr
    strSend = strSend & "QAK|SR|OK|" & vbCr
    strSend = strSend & "QRD|" & strDtTM & "|R|D|" & mOrder.QryID & "|||RD|" & strBarno & "|OTH|||T|" & vbCr
    strSend = strSend & "QRF|" & mOrder.Model & "|" & mOrder.STime & "|" & mOrder.ETime & "|||RCT|COR|ALL||" & vbCr
    ...
    frmMain.wSck.SendData strOutput
    SetRawData "[Tx]" & strOutput
            ...
            Select Case strType
                Case "MSH"
                    ...
                    Select Case strMType
                        Case "ORU^R01"
 '                                          strSndBuffer = SB & "MSH|^~\&|" & strMaker & "|" & strMchNm & "|||" & strDtTM & "||ACK^R01|" & strMType & "|P|2.3.1||||0||ASCII|||" & vbCr
