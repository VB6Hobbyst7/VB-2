...
Begin VB.Form frmInterface 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin FPSpread.vaSpread vasRes 
         ...
         RetainSelBlock  =   0   'False
         ScrollBars      =   2
         SpreadDesigner  =   "frmInterface.frx":23A0
      End
   End
   ...
   Begin VB.Frame FrmHideControl 
      ...
      Begin VB.Frame Frame4 
         ...
         Begin FPSpread.vaSpread vasPrint 
            ...
            EndProperty
            MaxCols         =   9
            SpreadDesigner  =   "frmInterface.frx":3AB9
         End
      ...
      Begin FPSpread.vaSpread vasTemp1 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":598C
      End
         ...
         Begin MSComctlLib.ImageList imlStatus 
            ...
            BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
               ...
               BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":613C
                  Key             =   "RUN"
               EndProperty
               BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":66D6
                  Key             =   "NOT"
               EndProperty
               BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":6C70
                  Key             =   "STOP"
               EndProperty
               BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":720A
                  Key             =   "LST"
               EndProperty
               BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":7A9C
                  Key             =   "ITM"
               EndProperty
               BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":7BF6
                  Key             =   "ERR"
               EndProperty
               BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":7D50
                  Key             =   "NOF"
               EndProperty
            EndProperty
         End
...
'Buffer = "Date :May-28-2010 14:21:46" & vbCr
'Buffer = Buffer & "ID_NO:0069-                " & vbCr
'Buffer = Buffer & "Ward: " & vbCr
'Buffer = Buffer & "Name: " & vbCr
'Buffer = Buffer & "BLD    ++    50   RBC/ul " & vbCr
'Buffer = Buffer & "BIL    -    neg          " & vbCr
'Buffer = Buffer & "URO    -    neg          " & vbCr
'Buffer = Buffer & "KET    -    neg          " & vbCr
'Buffer = Buffer & "PRO    -    neg          " & vbCr
'Buffer = Buffer & "NIT    +    pos          " & vbCr
'Buffer = Buffer & "GLU    ++++2000   mg/dL  " & vbCr
'Buffer = Buffer & "p.H         5.5          " & vbCr
'Buffer = Buffer & "S.G       1.025          " & vbCr
'Buffer = Buffer & "LEU    +     25   WBC/ul " & vbCr
'Buffer = Buffer & "COL LT.Yellow  " & vbCr
'Buffer = Buffer & "CLA Clear      " & vbCr
'Buffer = Buffer & "" & vbCr
...
'    vasID.MaxRows = 10
    ...
    Winsock1.LocalPort = CInt(gDRDB_Parm.ServerPort)
    Winsock1.Listen
