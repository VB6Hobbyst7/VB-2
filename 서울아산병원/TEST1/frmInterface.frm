...
Begin VB.Form frmInterface 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame5 
         ...
         Begin VB.TextBox Text2 
            ...
            Width           =   4545
         End
         Begin VB.CommandButton cmdBarTest 
            Caption         =   "전송"
            Height          =   405
            Left            =   5940
            TabIndex        =   62
   ...
   Begin VB.PictureBox Picture1 
      ...
      Top             =   0
      Width           =   21135
      Begin VB.CommandButton cmdRsltSearch1 
         Appearance      =   0  '평면
         BackColor       =   &H00C0E0FF&
         Caption         =   "결과조회"
         BeginProperty Font 
...
Private Sub cmdRsltSearch1_Click()
...
Dim adoRS2      As ADODB.Recordset
    ...
    Text1.Text = Text1.Text & Format(dtpFromDt.Value, "yyyymmdd") & gEquipCode & Val(txtFromWN.Text) & Val(txtToWN.Text)
    ...
    If Not adoRS2.EOF Then
        ...
        With adoRS2
            Do While Not .EOF
                For intRow = 0 To .Fields.Count
                    If intCnt = 0 Then
                        Text1.Text = Text1.Text & .Fields(intRow).Name & "|"
                    End If
                    
                    Text1.Text = Text1.Text & .Fields(intRow).Value & "|"
...
Private Sub Form_Resize()
    ...
    If cmdSL.Caption = "▶" Then
        Frame1.Height = frmInterface.ScaleHeight - (Frame1.Top) - 1200
    ...
    Else
        Frame1.Height = frmInterface.ScaleHeight - (Frame1.Top) - 500
        vasID.Height = Frame1.Height - 300
        
        Frame1.Width = frmInterface.ScaleWidth - 200
        vasID.Width = frmInterface.ScaleWidth - 400
...
'    stInterface.Tab = 0
    ...
    If gUseSvr = "D" Then
        frmInterface.Caption = "[장비명:TEST-1, 서버:개발계]"
    ElseIf gUseSvr = "D" Then
        frmInterface.Caption = "[장비명:TEST-1, 서버:운영계]"
    Else
        frmInterface.Caption = "[장비명:TEST-1, 서버:테스트계]"
    End If
