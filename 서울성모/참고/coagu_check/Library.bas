...
'argSQL의 내용을 파일로 저장
    ...
    Open App.Path & "\Log\" & sFileName & ".tp" For Append As FilNum
...
'argSQL의 내용을 파일로 저장
    ...
    Open App.Path & "\Log\" & SeperatorCls(frmInterface.dtpToday) & ".txt" For Append As FilNum
    Print #FilNum, argSQL
    Close FilNum
End Sub
