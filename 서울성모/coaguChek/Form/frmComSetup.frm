...
Begin VB.Form frmComSetup 
   ...
   Begin VB.Frame Frame5 
      ...
      Begin VB.ComboBox cboDataBits 
         ...
         Width           =   1740
      End
      Begin FPSpread.vaSpread spdMachine 
         Height          =   3000
         Left            =   300
         TabIndex        =   92
         Top             =   630
         ...
         SpreadDesigner  =   "frmComSetup.frx":02F9
         UserResize      =   2
      End
      Begin BHButton.BHImageButton cmdDel 
         ...
         ImgOutLineSize  =   3
      End
      Begin BHButton.BHImageButton cmdSet 
         Height          =   300
         Left            =   9060
         TabIndex        =   96
         Top             =   2130
   ...
   Begin VB.Frame Frame4 
      ...
      Begin BHButton.BHImageButton cmdWS_CD 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "frmComSetup.frx":06A1
         ImgOutLineSize  =   3
      End
      Begin BHButton.BHImageButton cmdStation 
         Height          =   285
         Left            =   4230
         TabIndex        =   79
         Top             =   225
...
Private Sub cmdDel_Click()
    ...
    If Trim(txtMachCode.text) <> "" Then
        AdoCn_Jet.Execute "Delete From LIMAS032 Where CDVAL1 = " & STS(txtMachCode)
        
        Call f_subSet_MachList
    End If
...
Private Sub cmdSet_Click()
    ...
    If Trim(txtMachCode.text) <> "" Then
                  strSql = "Delete From LIMAS032 "
        strSql = strSql & " Where CDVAL1 = " & STS(txtMachCode)
        strSql = strSql & "   And FIELD1 = " & STS(txtDeptNm)
        strSql = strSql & "   And CDDIV  = " & STS(txtGbn)
        AdoCn_Jet.Execute strSql
        
        strSql = "Insert into LIMAS032 (CDVAL1, CDVAL2, FIELD1, CDDIV) Values (" & STS(txtMachCode) & "," & STS(txtMachNm) & "," & STS(txtDeptNm) & "," & STS(txtGbn) & ")"
        AdoCn_Jet.Execute strSql
...
'    CallForm = "frmInterface - Private Sub f_subSet_MachList()"
    ...
    sqlDoc = "select CDVAL1, CDVAL2, FIELD1, CDDIV" & _
             "  from LIMAS032" & _
             " where CDVAL1 IS NOT NULL " & _
             " order by CDVAL1 "
    ...
    Do While Not AdoRs.EOF
        With spdMachine
            .MaxRows = intRow
            .SetText 1, intRow, Trim$(AdoRs("CDVAL1") & "")
            .SetText 2, intRow, Trim$(AdoRs("CDVAL2") & "")
            .SetText 3, intRow, Trim$(AdoRs("FIELD1") & "")
            .SetText 4, intRow, Trim$(AdoRs("CDDIV") & "")
            AdoRs.MoveNext
            intRow = intRow + 1
        End With
    Loop
...
'            txtTmp_H = strTmp_LH(1)
            ...
            txtDMSIP.text = Trim(mAdoRs("LAN_IP") & "")
            txtDMSPort.text = Trim(mAdoRs("LAN_PORT") & "")
        End If
    End If
    Set mAdoRs = Nothing
End Sub
...
Private Sub spdMachine_Click(ByVal Col As Long, ByVal Row As Long)
    
    With spdMachine
        .Row = Row
        .Col = 1: txtMachCode.text = Trim(.text)
        .Col = 2: txtMachNm.text = Trim(.text)
        .Col = 3: txtDeptNm.text = Trim(.text)
        .Col = 4: txtGbn.text = Trim(.text)
    End With
