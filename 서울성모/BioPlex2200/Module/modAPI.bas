...
'Public Declare Function AS400DOWNF Lib "SRLDEVC" (sDEVC As Variant, sFROMDATE As Variant, sTODATE As Variant)
'Public Declare Function AS400DOWNF Lib "SRLDEVC" (ByVal sDEVC As String, ByVal sFROMDATE As String, ByVal sTODATE As String) As String
'Public Declare Function AS400DOWNF Lib "SRLDEVC" (sDEVC As String, sFROMDATE As String, sTODATE As String) As String
'Public Declare Function AS400DOWNF Lib "SRLDEVC" (ByRef sDEVC As String, ByRef sFROMDATE As String, ByRef sTODATE As String) As String
'Public Declare Function AS400DOWNF Lib "SRLDEVC" (ByRef sDEVC As String, ByRef sFROMDATE As String, ByRef sTODATE As String)
'Public Declare Function AS400DOWNF Lib "SRLDEVC" (ByRef sDEVC As String, ByRef sFROMDATE As String, ByRef sTODATE As String) As Variant
'Public Declare Function AS400DOWNF Lib "SRLDEVC" (sDEVC&, sFROMDATE&, sTODATE&) As String
'Public Declare Function AS400DOWNF Lib "SRLDEVC" (sDEVC&, sFROMDATE&, sTODATE&) As String

'Public Declare Function AS400DOWNF Lib "SRLDEVC" (sDEVC As Variant, sFROMDATE As Variant, sTODATE As Variant) As String

'Public Declare Function AS400DOWNF Lib "SRLDEVC.DLL" Alias "SRLDEVCA" (sDEVC As String, sFromDate As String, sToDate As String) As String
'Public Declare Function AS400DOWNF Lib "SRLDEVC" (sDEVC As String, sFromDate As String, sToDate As String) As String

'-- reg등록
'Public Declare Function AS400DOWNF Lib "srldevc" (sDEVC, sFromDate, sToDate) As String
'Public Declare Function AS400DOWNF Lib "SRLDEVC" (sDEVC, sFromDate, sToDate) As String
'Public Declare Function AS400DOWNF Lib "srldevc.dll" (sDEVC&, sFromDate&, sToDate&) As String
'Public Declare Function AS400DOWNF Lib "c:\windows\system32\srldevc.dll" (sDEVC, sFromDate, sToDate) As String

'Public Declare Function AS400DOWNF Lib "SRLDEVC" (ByVal sDEVC As String, ByVal sFROMDATE As String, ByVal sTODATE As String) As Byte
