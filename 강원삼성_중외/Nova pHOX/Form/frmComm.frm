...
Begin VB.Form frmComm 
   ...
   Begin TabDlg.SSTab tabWork 
      ...
      Tab(0).Control(0)=   "UserPanel1"
      Tab(0).Control(1)=   "cmdSel(1)"
      Tab(0).Control(2)=   "cmdSel(0)"
      Tab(0).Control(3)=   "spdWorklist"
      Tab(0).Control(4)=   "cmdWorkList"
      Tab(0).Control(5)=   "spdResult1"
      Tab(0).Control(6)=   "SSPanel2"
      Tab(0).Control(7)=   "fraError"
      Tab(0).Control(8)=   "SSFrame1"
      Tab(0).Control(9)=   "SSPanel1"
      Tab(0).Control(10)=   "chkReTest"
      Tab(0).Control(11)=   "chkAuto"
      Tab(0).Control(12)=   "Command1"
      Tab(0).Control(13)=   "txtBarCode"
      Tab(0).Control(14)=   "FrameResult"
      Tab(0).Control(15)=   "cmdAppend(0)"
      Tab(0).Control(16)=   "cmdSearch"
      Tab(0).Control(17)=   "cmdOrder"
      Tab(0).Control(18)=   "cmdEot"
      Tab(0).Control(19)=   "cmdWordQuery"
      Tab(0).Control(20)=   "cmdRackNo"
      Tab(0).Control(21)=   "cmdPosNo"
      Tab(0).Control(22)=   "cmdStartNo"
      Tab(0).Control(23)=   "pnlCom"
      Tab(0).Control(24)=   "pnlCom2"
      ...
      Begin FPSpread.vaSpread spdResult1 
         ...
         MaxRows         =   1
         ScrollBarMaxAlign=   0   'False
         SpreadDesigner  =   "frmComm.frx":765B
         UserResize      =   0
      End
      ...
      Begin Threed.SSFrame SSFrame1 
         ...
         Begin FPSpread.vaSpread spdRstview 
            ...
            SpreadDesigner  =   "frmComm.frx":7BCC
            UserResize      =   0
         End
      End
      Begin Threed.SSPanel SSPanel1 
         ...
         Begin VB.ComboBox cboChk 
            Enabled         =   0   'False
            Height          =   300
            ItemData        =   "frmComm.frx":820B
            Left            =   3630
            List            =   "frmComm.frx":8215
            TabIndex        =   62
            Top             =   90
            Visible         =   0   'False
            Width           =   1095
         ...
         Begin VB.ComboBox cboComNm 
            Height          =   300
            ItemData        =   "frmComm.frx":8225
            Left            =   4755
            List            =   "frmComm.frx":8227
            TabIndex        =   61
            Top             =   90
            Visible         =   0   'False
            Width           =   1545
      ...
      Begin Threed.SSPanel SSPanel3 
         ...
         Begin VB.ComboBox cboRstgbn 
            Height          =   300
            Index           =   1
            ItemData        =   "frmComm.frx":8B19
            Left            =   2475
            List            =   "frmComm.frx":8B26
            Style           =   2  '드롭다운 목록
            TabIndex        =   71
            Top             =   90
            Width           =   1770
      ...
      Begin FPSpread.vaSpread spdResult2 
         ...
         MaxRows         =   1
         ScrollBarMaxAlign=   0   'False
         SpreadDesigner  =   "frmComm.frx":8B50
         UserResize      =   0
      End
...
On Error GoTo ErrorTrap
    CallForm = "clsCommon - Public Function f_subSet_WorkList() As ADODB.Recordset"
        ...
        sqlDoc = sqlDoc & vbCrLf & "   AND LabCode = 'BLOODGAS'"
...
Private Function f_subSet_WorkList_Barcode(ByVal strPid As String, ByVal strWdate As String, ByVal strBarno As String)
    Dim sqlRet      As Integer
    Dim sqlDoc      As String
...
On Error GoTo ErrorTrap
    CallForm = "clsCommon - Public Function f_subSet_WorkList() As ADODB.Recordset"
        ...
        Set AdoRs_SQL = New ADODB.Recordset
                 ...
                 sqlDoc = "SELECT ORDERCODE "
        sqlDoc = sqlDoc & vbCrLf & "  FROM SLA_LabMaster "
        sqlDoc = sqlDoc & vbCrLf & " WHERE PTNO = '" & strPid & "'"
        sqlDoc = sqlDoc & vbCrLf & "   AND RECEIPTDATE = '" & strWdate & "'"
        sqlDoc = sqlDoc & vbCrLf & "   AND SPECIMENNUM = '" & strBarno & "'"
        sqlDoc = sqlDoc & vbCrLf & "   AND JStatus < '3'"
                    ...
                    If Trim$(varTmp) <> "" Then
                        ...
                        If Not itemX Is Nothing Then
                            ...
                            If intPos > 0 Then
                               ...
                               sqlDoc = sqlDoc & vbCrLf & "   And OrderCode = '" & tmpTestcd(0) & "' "
                               sqlDoc = sqlDoc & vbCrLf & "   And LabCode = '" & tmpTestcd(1) & "' "
        ...
        For introw1 = 1 To .maxrows
            ...
            If Trim$(varTmp) = "1" Then
                ...
                If intRow2 < 1 Then
                    ...
                    Set mAdoRs = f_subSet_WorkList_Barcode(strSPid, strWdate, strSPNo)
                                    ...
                                    If Len(fNOVApHOX_1(3)) > 0 Then
                                        If UCase(Channel_No) = Trim(itemX.tag) Then
                                            ...
                                            sqlDoc = "insert into INTERFACE003(" & _
                                                     ...
                                                     "    values( '" & strBarno & "', '" & tmpTestcd(1) & "', '" & itemX.tag & "'," & _
                                                     "            '" & strDate & "', '" & strTime & "'," & _
