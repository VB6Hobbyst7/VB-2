...
Begin VB.Form frmInterface 
   ...
   Begin VB.Frame FrmHideControl 
      ...
      Begin VB.Frame Frame4 
         ...
         Begin FPSpread.vaSpread vasPrintBuf 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            SpreadDesigner  =   "frmInterface.frx":2F95
         End
      End
      ...
      Begin FPSpread.vaSpread vasCode 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":31AD
      End
      Begin FPSpread.vaSpread vasTemp1 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":33C5
      End
         ...
         Begin MSComctlLib.ImageList imlStatus 
            ...
            BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
               ...
               BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":3B67
                  Key             =   "RUN"
               EndProperty
               BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":4101
                  Key             =   "NOT"
               EndProperty
               BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":469B
                  Key             =   "STOP"
               EndProperty
               BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":4C35
                  Key             =   "LST"
               EndProperty
               BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":54C7
                  Key             =   "ITM"
               EndProperty
               BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":5621
                  Key             =   "ERR"
               EndProperty
               BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":577B
                  Key             =   "NOF"
               EndProperty
            EndProperty
         End
      ...
      Begin FPSpread.vaSpread vasList 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":58D5
      End
      Begin FPSpread.vaSpread vasResTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":5AED
      End
      Begin FPSpread.vaSpread vasTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":5D05
      End
      Begin FPSpread.vaSpread vasExcel 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":5F1D
      End
   ...
   Begin VB.PictureBox Picture2 
      ...
      Begin VB.Frame Frame3 
         ...
         Begin VB.CommandButton cmdWUp 
            ...
            Width           =   375
         End
         Begin VB.CommandButton cmdRslt 
            Caption         =   "결과받기"
            BeginProperty Font 
               Name            =   "굴림체"
               Size            =   9
   ...
   Begin VB.Frame Frame1 
      ...
      Begin FPSpread.vaSpread vasID 
         ...
         SpreadDesigner  =   "frmInterface.frx":6135
      End
      ...
      Begin FPSpread.vaSpread vasRes 
         ...
         RetainSelBlock  =   0   'False
         ScrollBars      =   2
         SpreadDesigner  =   "frmInterface.frx":6D66
      End
   End
...
Private Sub GetWorkList_TWIN(ByVal pFrDt As String, ByVal pToDt As String, Optional pBarNo As String)
    ...
    vasID.ReDraw = False
          ...
          SQL = "SELECT DISTINCT B.JOBDATE AS 접수일자" & vbCrLf
    SQL = SQL & ", C.SPECNO AS 바코드번호, C.PTNO AS 차트번호, C.JOBNO AS 내원번호, DECODE(C.GBIO,'I','입원','O','외래') AS 입외" & vbCrLf
    SQL = SQL & ", C.SNAME AS 이름, C.SEX AS 성별, C.AGE AS 나이, A.MASTERCODE AS ITEM " & vbCrLf
...
Private Sub cmdSearch_Click()
    ...
    Select Case gOCS
        ...
        Case "NEOSOFT":     Call GetWorkList_NEOSOFT(Format(dtpStartDt.Value, "yyyymmdd"), Format(dtpStopDt.Value, "yyyymmdd"))
    End Select
...
Private Sub GetWorkList_NEOSOFT(ByVal pFrDt As String, ByVal pToDt As String, Optional pBarNo As String)
    Dim RS          As ADODB.Recordset
    Dim i           As Integer
    Dim iCnt        As Long
    Dim intRow      As Long
...
'    SQL = SQL & "  ORDER BY ORD_YMD,RECEPT_NO,BCODE_NO "
    ...
    SQL = SQL & " Where a.WORK_DATE between '" & pFrDt & "' AND '" & pToDt & "'" & vbCr
    SQL = SQL & "   And a.CHAM_INDEX = b.CHAM_INDEX " & vbCr
    SQL = SQL & "   AND a.CODE IN (" & gAllExam & ")" & vbCr
        ...
        Do Until RS.EOF
            ...
            With vasID
                ...
                For i = 1 To .DataRowCnt
                    strDate = GetText(vasID, i, colHOSPDATE)
                    strBarcode = GetText(vasID, i, colBARCODE)
                    If Trim(RS("WORK_DATE")) = strDate And Trim(RS("CHAM_INDEX")) = strBarcode Then
                        blnSame = True
                    End If
                ...
                If blnSame = False Then
                    ...
                    SetText vasID, Trim(RS.Fields("CHAM_INDEX")) & "", .MaxRows, colBARCODE
...
'    Call SetText(vasID, mResult.TubePos, intRow, colPOSNO)
    ...
    Call GetSampleInfoW_NEOSOFT(intRow)
...
Private Sub EditRcvData()
    ...
    For intCnt = 0 To UBound(strRecvData) - 1
        ...
        strSeq = Trim(Mid(strRcvBuf, 1, 12))
        If Trim(Mid(strRcvBuf, 1, 12)) <> "" Then
...
RST:
                If strResult <> "" Then
                    ...
                    If Res > 0 Then
                        ...
                        strOrderExam = Replace(strOrderExam, "'" & lsExamCode & "'", "")
                        ...
                        SQL = SQL & " WHERE EQUIPNO = '" & gEquip & "' "
                        SQL = SQL & "   AND EQUIPCODE = '" & strIntBase & "' "
                        SQL = SQL & "   AND EXAMCODE in (" & strOrderExam & ") "
                        ...
                        If Res > 0 Then
                            ...
                            For intCol = colState + 1 To vasID.MaxCols
                                If lsExamCode = gArrEquip(intCol - colState, 3) Then
                                    vasID.Row = gRow
                                    vasID.Col = intCol
                                    If vasID.BackColor = vbYellow And GetText(vasID, gRow, intCol) = "" Then
                                        SetText vasID, strResult, gRow, intCol
                                        Exit For
                                    End If
                                End If
...
Private Sub EditRcvDataASTM()
    ...
    '## 바코드번호 조회
'    strBarNo = Format$(Mid$(strRcvBuf, 12, 16), "00000000000000")
'
'    If strBarNo = "" Then Exit Sub
    ...
    Call vasActiveCell(vasID, gRow, colBARCODE)
...
'    lblDate.Caption = Trim(GetText(vasID, Row, colHOSPDATE))
    ...
    If lblSaveSeq.Caption = "" Then
        ...
        For i = colState + 1 To vasID.MaxCols
            vasID.Row = Row
            vasID.Col = i
            If vasID.BackColor = vbYellow Then
                vasID.Row = 0
                strExamName = vasID.Text
                With vasRes
                    .MaxRows = .MaxRows + 1
                    SetText vasRes, strExamName, .MaxRows, colEXAMNAME
                    .RowHeight(-1) = 12
                End With
            End If
        Next
...
'        End If
    ...
    ElseIf KeyCode = vbKeyReturn Then
        If iCol = colBARCODE Then
            ...
            '-- 바뀐 바코드로 환자정보 불러오기
            Call GetSampleInfoW_NEOSOFT(iRow)
