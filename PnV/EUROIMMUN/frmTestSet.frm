...
Private Sub DisplayList()
    ...
    ElseIf optGubun(2).Value = True Then
        SQL = SQL & "  AND GUBUN = 'PREMIUM_I' "
    ElseIf optGubun(3).Value = True Then
        SQL = SQL & "  AND GUBUN = 'BASIC' "
