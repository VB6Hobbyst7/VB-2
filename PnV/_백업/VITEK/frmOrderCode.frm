...
Begin VB.Form frmOrderCode 
   ...
   Begin FPSpread.vaSpread vasAnti 
      ...
      RetainSelBlock  =   0   'False
      ScrollBars      =   2
      SpreadDesigner  =   "frmOrderCode.frx":1A0E
   End
   ...
   Begin FPSpread.vaSpread vasKit 
      ...
      RetainSelBlock  =   0   'False
      ScrollBars      =   2
      SpreadDesigner  =   "frmOrderCode.frx":21AC
   End
   Begin FPSpread.vaSpread vasSlip 
      ...
      RetainSelBlock  =   0   'False
      ScrollBars      =   2
      SpreadDesigner  =   "frmOrderCode.frx":2411
   End
   ...
   Begin FPSpread.vaSpread vasList 
      ...
      SpreadDesigner  =   "frmOrderCode.frx":2676
   End
End
...
'균코드 조회
    ...
    SQL = "SELECT seq, orgnm, morgcd, horgcd " & vbCrLf & _
          "  From orgtable " & vbCrLf & _
          " order by seq "
...
'항생제코드 조회
    ...
    SQL = "SELECT seq, antinm, manticd, hanticd " & vbCrLf & _
          "  From antitable " & vbCrLf & _
          " order by seq "
...
'SLIP코드 조회
    ...
    SQL = "SELECT seq, slipcd " & vbCrLf & _
          "  From sliptable " & vbCrLf & _
          " order by seq "
...
'KIT(Other)코드 조회
    ...
    SQL = "SELECT seq, kit, other, state, kitseq " & vbCrLf & _
          "  From othertable " & vbCrLf & _
          " order by seq "
