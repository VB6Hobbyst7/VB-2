...
Begin VB.Form frmInterface 
   ...
   WindowState     =   2  '최대화
   Begin FPSpread.vaSpread vasAnt 
      Height          =   8055
      Left            =   13470
      TabIndex        =   73
      Top             =   2160
   ...
   Begin VB.Frame FrmHideControl 
      ...
      Begin FPSpread.vaSpread vasExcel 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":2384
      End
      ...
      Begin VB.Frame Frame4 
         ...
         Begin FPSpread.vaSpread vasPrint 
            ...
            EndProperty
            MaxCols         =   9
            SpreadDesigner  =   "frmInterface.frx":259C
         End
         Begin FPSpread.vaSpread vasPrintBuf 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            SpreadDesigner  =   "frmInterface.frx":4015
         End
      End
      ...
      Begin FPSpread.vaSpread vasCode 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":422D
      End
      Begin FPSpread.vaSpread vasTemp1 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":4445
      End
         ...
         Begin MSComctlLib.ImageList imlStatus 
            ...
            BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
               ...
               BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":4BE7
                  Key             =   "RUN"
               EndProperty
               BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":5181
                  Key             =   "NOT"
               EndProperty
               BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":571B
                  Key             =   "STOP"
               EndProperty
               BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":5CB5
                  Key             =   "LST"
               EndProperty
               BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":6547
                  Key             =   "ITM"
               EndProperty
               BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":66A1
                  Key             =   "ERR"
               EndProperty
               BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":67FB
                  Key             =   "NOF"
               EndProperty
            EndProperty
         End
      ...
      Begin FPSpread.vaSpread vasList 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":6955
      End
      Begin FPSpread.vaSpread vasResTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":6B6D
      End
      Begin FPSpread.vaSpread vasTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":6D85
      End
      ...
      Begin FPSpread.vaSpread vasRes 
         ...
         ScrollBars      =   2
         ShadowColor     =   16777215
         SpreadDesigner  =   "frmInterface.frx":6F9D
      End
   ...
   Begin FPSpread.vaSpread vasID 
      ...
      RetainSelBlock  =   0   'False
      ShadowColor     =   16777215
      SpreadDesigner  =   "frmInterface.frx":760B
   End
        ...
        With vasID
            For intRow = 1 To vasID.DataRowCnt
                ...
                If .Value = "1" Then
                    ...
                    If strTestNm = "POBALL™ Premium Test" Then
                        If txtSeq.Text = "1" Then
                            strInFo = strInFo & gAssayNM.FD1 & "," & strBarNo & vbCrLf
                        End If
                    ElseIf strTestNm = "POBALL™ Premium Intensive Test" Then
                        If txtSeq.Text = "1" Then
                            strInFo = strInFo & gAssayNM.FD1 & "," & strBarNo & vbCrLf
                        ElseIf txtSeq.Text = "2" Then
                            strInFo = strInFo & gAssayNM.IN1 & "," & strBarNo & vbCrLf
                        End If
                    ElseIf strTestNm = "POBALL™ Food Intensive Test" Then
                        If txtSeq.Text = "1" Then
                            strInFo = strInFo & gAssayNM.FD1 & "," & strBarNo & vbCrLf
                        ElseIf txtSeq.Text = "2" Then
                            strInFo = strInFo & gAssayNM.IN1 & "," & strBarNo & vbCrLf
    ...
    For iCnt = 2 To UBound(varRcvData)
        ...
        For i = 0 To UBound(varPetData)
            ...
            With mOrder
                ...
                Case "PETBREED":        .petBreed = strValue
                Case "PETNUMBER":       .petNumber = strValue
        ...
        With vasID
            ...
            If blnSame = False Then
                ...
                SetText vasID, mOrder.petBreed, .MaxRows, colBREED        '-- 품종
                SetText vasID, mOrder.petBirthDay, .MaxRows, colDOB          '-- 생년월일
                SetText vasID, mOrder.petTestname, .MaxRows, colASSAYNM                              '-- 검사구분(명)

                Select Case mOrder.petGender
...
Private Sub GetSensiList_PNV(ByVal pAnt As String)
    Dim RS          As ADODB.Recordset
    Dim i           As Integer
    Dim iCnt        As Long
    Dim intRow      As Long
...
On Error Resume Next
    ...
    'sURL = PnVAPI.APIURL & PnVAPI.APIOrdPath
    sURL = "https://dev.pnv.co.kr/PnV_Lab/api/selectLabAntiList"
...
'    For iCnt = 0 To UBound(varRcvData)
'        Debug.Print iCnt & ":" & varRcvData(iCnt)
'    Next
    
    For iCnt = 2 To UBound(varRcvData)
        
        If UCase(mGetP(varRcvData(iCnt), 1, ":")) = "NAME" Then
            strLName = mGetP(mGetP(varRcvData(iCnt), 1, ","), 2, ":")
            strLID = mGetP(mGetP(varRcvData(iCnt), 3, ","), 2, ":")
        End If
        
        If UCase(mGetP(varRcvData(iCnt), 1, ":")) = "ITEMID" Then
            strSName = mGetP(mGetP(varRcvData(iCnt), 2, ","), 2, ":")
            strSID = mGetP(mGetP(varRcvData(iCnt), 1, ","), 2, ":")
            If mGetP(mGetP(varRcvData(iCnt), 3, ","), 1, ":") <> "" Then
                strMName = mGetP(mGetP(varRcvData(iCnt), 3, ","), 2, ":")
            End If
        End If
        
        
        If strLName <> "" And strSName <> "" Then
            With vasAnt
                .ReDraw = False
                .MaxRows = .MaxRows + 1
                SetText vasAnt, strLID, .MaxRows, 1
                SetText vasAnt, strLName, .MaxRows, 2
                SetText vasAnt, strMName, .MaxRows, 3
                SetText vasAnt, strSID, .MaxRows, 4
                SetText vasAnt, strSName, .MaxRows, 5
                ...
                If strMName <> "" Then
                    ...
                    For i = .MaxRows - 1 To 1 Step -1
                        If GetText(vasAnt, i, 3) <> "" Then
                            Exit For
                        Else
                            SetText vasAnt, strMName, i, 3
                            
                            If i = .MaxRows - 1 Then
                                If intTRow = 0 Then
                                    SetBackColor vasAnt, .MaxRows, .MaxRows, 1, 7, 255, 255, 100
                                Else
                                    SetBackColor vasAnt, .MaxRows, .MaxRows, 1, 7, 255, 255, 255
                                End If
                            End If
                            If intTRow = 0 Then
                                SetBackColor vasAnt, i, i, 1, 7, 255, 255, 100
                            Else
                                SetBackColor vasAnt, i, i, 1, 7, 255, 255, 255
                            End If
                        End If
                    Next
                End If
...
'    fraPatInfo.Height = Me.ScaleHeight - picHeader.Height - vasRes.Height - 300
    ...
    vasID.Width = Me.ScaleWidth - vasAnt.Width - 200
    vasID.Height = Me.ScaleHeight - picHeader.Height - 300
    vasAnt.Left = vasID.Left + vasID.Width + 50
    vasAnt.Height = Me.ScaleHeight - picHeader.Height - fraPatInfo.Height - 300

    fraPatInfo.Left = vasID.Left + vasID.Width + 50
    fraPatInfo.Height = Me.ScaleHeight - picHeader.Height - vasAnt.Height - 300
...
'    lblDate.Caption = Trim(GetText(vasID, Row, colHOSPDATE))
    ...
    Call GetSensiList_PNV(Trim(GetText(vasID, Row, colPID)))
