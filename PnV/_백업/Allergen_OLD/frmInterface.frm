...
Begin VB.Form frmInterface 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin FPSpread.vaSpread vasRes 
         ...
         RetainSelBlock  =   0   'False
         ScrollBars      =   2
         SpreadDesigner  =   "frmInterface.frx":20B0
      End
   End
   Begin VB.PictureBox Picture1 
      ...
      Begin FPSpread.vaSpread vasExcel 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":272E
      End
   ...
   Begin VB.Frame FrmHideControl 
      ...
      Begin VB.Frame Frame4 
         ...
         Begin FPSpread.vaSpread vasPrint 
            ...
            EndProperty
            MaxCols         =   9
            SpreadDesigner  =   "frmInterface.frx":39E4
         End
         Begin FPSpread.vaSpread vasPrintBuf 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            SpreadDesigner  =   "frmInterface.frx":545D
         End
      End
      ...
      Begin FPSpread.vaSpread vasCode 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":5675
      End
      Begin FPSpread.vaSpread vasTemp1 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":588D
      End
         ...
         Begin MSComctlLib.ImageList imlStatus 
            ...
            BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
               ...
               BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":602F
                  Key             =   "RUN"
               EndProperty
               BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":65C9
                  Key             =   "NOT"
               EndProperty
               BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":6B63
                  Key             =   "STOP"
               EndProperty
               BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":70FD
                  Key             =   "LST"
               EndProperty
               ...
               BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":7AE9
                  Key             =   "ERR"
               EndProperty
               BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":7C43
                  Key             =   "NOF"
               EndProperty
            EndProperty
         End
      ...
      Begin FPSpread.vaSpread vasList 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":7D9D
      End
      Begin FPSpread.vaSpread vasResTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":7FB5
      End
      Begin FPSpread.vaSpread vasTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":81CD
      End
...
'                    End If
                    ...
                    If UCase(varTmp) = "POBALL PRENIUM" Then
                        strInFo = strInFo & CStr(intCnt) & "," & gAssayNM.PR1 & "," & strBarNo & "," & strLabNo & "," & strLNm & "," & strFNm & ",," & strSex & "," & strAge & vbCr
                        strInFo = strInFo & CStr(intCnt + 1) & "," & gAssayNM.PR2 & "," & strBarNo & "," & strLabNo & "," & strLNm & "," & strFNm & ",," & strSex & "," & strAge & vbCr
                    ElseIf UCase(varTmp) = "POBALL FOOD" Then
                    ...
                    ElseIf UCase(varTmp) = "POBALL FOOD_ADVANCED" Then
                        strInFo = strInFo & CStr(intCnt) & "," & gAssayNM.FA1 & "," & strBarNo & "," & strLabNo & "," & strLNm & "," & strFNm & ",," & strSex & "," & strAge & vbCr
                        strInFo = strInFo & CStr(intCnt + 1) & "," & gAssayNM.FA2 & "," & strBarNo & "," & strLabNo & "," & strLNm & "," & strFNm & ",," & strSex & "," & strAge & vbCr
                    ElseIf UCase(varTmp) = "POBALL FOOD_INTENSIVE" Then
                        strInFo = strInFo & CStr(intCnt) & "," & gAssayNM.FI1 & "," & strBarNo & "," & strLabNo & "," & strLNm & "," & strFNm & ",," & strSex & "," & strAge & vbCr
                        strInFo = strInFo & CStr(intCnt + 1) & "," & gAssayNM.FI2 & "," & strBarNo & "," & strLabNo & "," & strLNm & "," & strFNm & ",," & strSex & "," & strAge & vbCr
                    ElseIf UCase(varTmp) = "POBALL INHALANT" Then
                    ...
                    ElseIf UCase(varTmp) = "POBALL INHALANT_ADVANCED" Then
                        strInFo = strInFo & CStr(intCnt) & "," & gAssayNM.IA1 & "," & strBarNo & "," & strLabNo & "," & strLNm & "," & strFNm & ",," & strSex & "," & strAge & vbCr
                        strInFo = strInFo & CStr(intCnt + 1) & "," & gAssayNM.IA2 & "," & strBarNo & "," & strLabNo & "," & strLNm & "," & strFNm & ",," & strSex & "," & strAge & vbCr
                    End If
                    
                    intCnt = intCnt + 2
                End If
                .SetText colCheckBox, intRow, "0"
                .SetText colState, intRow, "Order"
            Next
        End With
        ...
        For intRow = 1 To .MaxRows
            ...
            If .Value = 1 Then
                If Trim(GetText(vasID, intRow, colBARCODE)) <> "" Then
                    ...
                    '-- Group
                    strBody = strBody & vbTab & vbTab & vbTab & "<PARAM TYPE=""String[32]"" ID=""Group"" FILTER=""-wwwr"">" & Trim(GetText(vasID, intRow, colDOB)) & "</PARAM>" & vbCrLf
                    '-- Name
                    ...
                    '-- BirthDate
                    'strBody = strBody & vbTab & vbTab & vbTab & "<PARAM TYPE=""Date"" ID=""BirthDate"" FILTER=""-ooor"">" & Format(Trim(GetText(vasID, intRow, colASSAYNM)), "yyyy-mm-dd") & "</PARAM>" & vbCrLf
                    ...
                    '-- Note
                    'strBody = strBody & vbTab & vbTab & vbTab & "<PARAM TYPE=""String[50]"" ID=""Note"" FILTER=""-wwwr"">" & Trim(GetText(vasID, intRow, colBREED)) & "</PARAM>" & vbCrLf
                    ...
                    Select Case Trim(GetText(vasID, intRow, colDOB))
                        Case "PR1":    strAssayNm = gAssayNM.PR1
                        Case "PR2":    strAssayNm = gAssayNM.PR2
                        Case "FD1":    strAssayNm = gAssayNM.FD1
                        Case "FD2":    strAssayNm = gAssayNM.FD2
                        Case "FA1":    strAssayNm = gAssayNM.FA1
                        Case "FA2":    strAssayNm = gAssayNM.FA2
                        Case "FI1":    strAssayNm = gAssayNM.FI1
                        Case "FI2":    strAssayNm = gAssayNM.FI2
                        Case "IN1":    strAssayNm = gAssayNM.IN1
                        Case "IN2":    strAssayNm = gAssayNM.IN2
                        Case "IA1":    strAssayNm = gAssayNM.IA1
                        Case "IA2":    strAssayNm = gAssayNM.IA2
                    End Select
...
Private Sub cmdResult_Click()
    ...
    'Call mIntLib.ClearBuffer
        ...
        For intRow = 2 To .DataRowCnt
            ...
            For intCol = 1 To .DataColCnt
                Call .GetText(intCol, intRow, varTmp): strTmp = varTmp
                strtmpBuf = strtmpBuf & strTmp & "|"
            Next
            strRecvData(iCnt) = strtmpBuf
            strtmpBuf = ""
        Next
    
    End With
    
    Call EditRcvDataINPROVE
        ...
        Do Until RS.EOF
            With vasID
                ...
                If blnSame = False Then
                    ...
                    'SetText vasID, Trim(RS.Fields("POSNO")) & "", .MaxRows, colASSAYNM
    ...
    StatusBar1.Panels(3).Text = ""
        ...
        For iCnt = 2 To UBound(varRcvData)
            ...
            If UBound(varPetData) < 8 Then
                Exit Sub
            End If
            'If InStr(UCase(Trim(mGetP(varPetData(4), 2, ":"))), "FOOD") > 0 Or InStr(UCase(Trim(mGetP(varPetData(4), 2, ":"))), "INHALANT") Then
                With vasID
                    .ReDraw = False
                    For i = 1 To .DataRowCnt
                        strDate = GetText(vasID, i, colHOSPDATE)
                    ...
                    If blnSame = False Then
                        ...
                        SetText vasID, Trim(mGetP(varPetData(4), 2, ":")), .MaxRows, colASSAYNM   '-- 검사구분(명)
                                        
                        Select Case Trim(mGetP(varPetData(1), 2, ":"))
                            Case "0": SetText vasID, "F", .MaxRows, colPSEX
                            Case "1": SetText vasID, "NF", .MaxRows, colPSEX
                            Case "2": SetText vasID, "M", .MaxRows, colPSEX
                            Case "3": SetText vasID, "NM", .MaxRows, colPSEX
                            Case "4": SetText vasID, "모름", .MaxRows, colPSEX
                        End Select
                        
                        Select Case Trim(mGetP(varPetData(3), 2, ":")) & ""
                            Case "0":   SetText vasID, "개", .MaxRows, colPAGE
                            Case "1":   SetText vasID, "고양이", .MaxRows, colPAGE
                            Case "2":   SetText vasID, "모름", .MaxRows, colPAGE
                        End Select
                    End If
                    blnSame = False
                End With
...
Private Sub SetPatInfo(ByVal pBarNo As String)
    ...
    For i = 1 To vasID.DataRowCnt
        If Trim(GetText(vasID, i, colBARCODE)) = pBarNo Then
        'If Trim(GetText(vasID, i, colBARCODE)) = pBarNo And UCase(GetText(vasID, i, colASSAYNM)) = UCase(mResult.MnmNm) Then
        'If Trim(GetText(vasID, i, colBARCODE)) = pBarNo And Trim(GetText(vasID, i, colDOB)) = mResult.MnmNm And Trim(GetText(vasID, i, colSAVESEQ)) = mResult.RsltSeq Then
            intRow = i
            Exit For
        End If
    Next i
...
'    End Select
    Call SetText(vasID, mResult.MnmNm, intRow, colASSAYNM)
