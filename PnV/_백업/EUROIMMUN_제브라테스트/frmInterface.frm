...
Begin VB.Form frmInterface 
   ...
   Begin FPSpread.vaSpread vasRes 
      ...
      ScrollBars      =   2
      ShadowColor     =   16777215
      SpreadDesigner  =   "frmInterface.frx":4BD9
   End
...
'    sHeader = sHeader & "X-LAB-MACHINE: TEST002" & vbCrLf
    sHeader = sHeader & "Accept: application/pdf" ' omit this line to get PNG images back
    ...
    sBody = "^xa^cfa,50^fo100,100^fdSmaller Label^fs^xz"
    
    'GET http://api.labelary.com/v1/printers/{dpmm}/labels/{width}x{height}/{index}/{zpl}
    sURL = "http://api.labelary.com/"

    sURL = "http://api.labelary.com/v1/printers/12dpmm/labels/3.5x1.5/0/"
...
Private Sub Form_Resize()
    ...
    vasID.Height = Me.ScaleHeight - picHeader.Height - 300
    vasRes.Left = vasID.Left + vasID.Width + 50
    vasRes.Height = Me.ScaleHeight - picHeader.Height - fraPatInfo.Height - 300

    fraPatInfo.Left = vasID.Left + vasID.Width + 50
    fraPatInfo.Height = Me.ScaleHeight - picHeader.Height - vasRes.Height - 300
