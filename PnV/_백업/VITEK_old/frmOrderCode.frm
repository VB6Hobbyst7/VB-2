...
Begin VB.Form frmOrderCode 
   ...
   Begin FPSpread.vaSpread vasKit 
      ...
      ScrollBars      =   2
      SpreadDesigner  =   "frmOrderCode.frx":08CA
   End
   Begin FPSpread.vaSpread vasSlip 
      ...
      RetainSelBlock  =   0   'False
      ScrollBars      =   2
      SpreadDesigner  =   "frmOrderCode.frx":11DC
   End
   Begin FPSpread.vaSpread vasAnti 
      ...
      RetainSelBlock  =   0   'False
      ScrollBars      =   2
      SpreadDesigner  =   "frmOrderCode.frx":18C3
   End
   Begin FPSpread.vaSpread vasOrg 
      ...
      RetainSelBlock  =   0   'False
      ScrollBars      =   2
      SpreadDesigner  =   "frmOrderCode.frx":2082
   End
   ...
   Begin FPSpread.vaSpread vasList 
      ...
      SpreadDesigner  =   "frmOrderCode.frx":4E6D
   End
