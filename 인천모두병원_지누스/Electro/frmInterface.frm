   ...
   Begin TabDlg.SSTab stInterface 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin FPSpread.vaSpread vasWorkList 
            ...
            RetainSelBlock  =   0   'False
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":B77B
            UserResize      =   2
         End
         ...
         Begin VB.ComboBox cboChk 
            ...
            EndProperty
            Height          =   300
            ItemData        =   "frmInterface.frx":C295
            Left            =   2340
            List            =   "frmInterface.frx":C29F
            TabIndex        =   45
            Top             =   -90
            Visible         =   0   'False
            Width           =   765
         ...
         Begin FPSpread.vaSpread vasID 
            ...
            RetainSelBlock  =   0   'False
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":C2AF
            UserResize      =   2
         End
         Begin FPSpread.vaSpread vasRes 
            ...
            RetainSelBlock  =   0   'False
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":CDCF
         End
...
'            txtData = txtData & Buffer
            ...
            For i = 1 To lngBufLen
                Select Case Mid(Buffer, i, 1)
                    Case "="
                        strBuffer = ""
                        strBuffer = strBuffer + Mid(Buffer, i, 1)
                    Case ";"
                        strBuffer = strBuffer + Mid(Buffer, i, 1)
                        iSTX = InStr(strBuffer, "=")
                        iETX = InStr(strBuffer, ";")
                        If iSTX <> 0 And iETX <> 0 Then
                            Call EditRcvDataElectro
                        End If
