...
Private Sub GetWorkList(ByVal pFrDt As String, ByVal pToDt As String)
    ...
    'strResponse = W2ACALL2("SCC0191A", strRequest, "https://121.78.172.80") '-- 바코드로 검사대상 조회
    strResponse = W2ACALL2("SCC0191A", strRequest, gGINUS_Parm.URL) '-- 바코드로 검사대상 조회
