   ...
   Begin TabDlg.SSTab stInterface 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.ComboBox cboChk 
            ...
            EndProperty
            Height          =   300
            ItemData        =   "frmInterface.frx":C2B1
            Left            =   2340
            List            =   "frmInterface.frx":C2BB
            TabIndex        =   45
            Top             =   -90
            Visible         =   0   'False
            Width           =   765
         ...
         Begin FPSpread.vaSpread vasID 
            ...
            RetainSelBlock  =   0   'False
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":C2CB
            UserResize      =   2
         End
         Begin FPSpread.vaSpread vasRes 
            ...
            RetainSelBlock  =   0   'False
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":CDEB
         End
...
Private Sub GetWorkList(ByVal pFrDt As String, ByVal pToDt As String)
    ...
    strRequest = strRequest & "mach_cd" + vbTab + gGINUS_Parm.MCD + vbTab
...
Private Sub GetOrder(ByVal pBarNo As String)
    ...
    'Call SetText(vasWorkList, mOrder.RackNo, intRow, colRack)     '4  Rack번호
    'Call SetText(vasWorkList, mOrder.TubePos, intRow, colPos)     '5  Pos번호
