...
Begin VB.Form frmConfig 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ListBox lstDefault 
         ...
         Width           =   4215
      End
      Begin VB.TextBox txtAllergyPrinter 
         BeginProperty Font 
            Name            =   "±¼¸²Ã¼"
            Size            =   9
            Charset         =   129
...
Private Sub cmdConfirm_Click()
    ...
    Else
        If optUse(0).Value = True Then
            Call SaveString(HKEY_CURRENT_USER, REG_MACH & "\" & "COMM", "COMTYPE", "1")
        ElseIf optUse(1).Value = True Then
            Call SaveString(HKEY_CURRENT_USER, REG_MACH & "\" & "COMM", "COMTYPE", "2")
        ElseIf optUse(2).Value = True Then
            Call SaveString(HKEY_CURRENT_USER, REG_MACH & "\" & "COMM", "COMTYPE", "3")
        End If
        ...
        If optUse(0).Value = True Then
            ...
            Call SaveString(HKEY_CURRENT_USER, REG_MACH & "\" & "COMM", "COMPORT", gComm.COMPORT)
            Call SaveString(HKEY_CURRENT_USER, REG_MACH & "\" & "COMM", "SPEED", gComm.SPEED)
            Call SaveString(HKEY_CURRENT_USER, REG_MACH & "\" & "COMM", "PARITY", gComm.Parity)
            Call SaveString(HKEY_CURRENT_USER, REG_MACH & "\" & "COMM", "DATABIT", gComm.DATABIT)
            Call SaveString(HKEY_CURRENT_USER, REG_MACH & "\" & "COMM", "STOPBIT", gComm.STOPBIT)
            Call SaveString(HKEY_CURRENT_USER, REG_MACH & "\" & "COMM", "STARTBIT", gComm.STARTBIT)
            
            If chkRTS.Value = "1" Then
                'Call WritePrivateProfileString("COMM", "RTSEnable", "True", App.PATH & "\INI\" & gMACH & ".ini")
                Call SaveString(HKEY_CURRENT_USER, REG_MACH & "\" & "COMM", "RTSEnable", "True")
            Else
                'Call WritePrivateProfileString("COMM", "RTSEnable", "False", App.PATH & "\INI\" & gMACH & ".ini")
                Call SaveString(HKEY_CURRENT_USER, REG_MACH & "\" & "COMM", "RTSEnable", "False")
            End If
            If chkDTR.Value = "1" Then
                'Call WritePrivateProfileString("COMM", "DTREnable", "True", App.PATH & "\INI\" & gMACH & ".ini")
                Call SaveString(HKEY_CURRENT_USER, REG_MACH & "\" & "COMM", "DTREnable", "True")
            Else
                'Call WritePrivateProfileString("COMM", "DTREnable", "False", App.PATH & "\INI\" & gMACH & ".ini")
                Call SaveString(HKEY_CURRENT_USER, REG_MACH & "\" & "COMM", "DTREnable", "False")
            End If
        ...
        ElseIf optUse(1).Value = True Then
            ...
            Call SaveString(HKEY_CURRENT_USER, REG_MACH & "\" & "COMM", "TCPTYPE", gComm.TCPTYPE)
            Call SaveString(HKEY_CURRENT_USER, REG_MACH & "\" & "COMM", "TCPIP", gComm.TCPIP)
            Call SaveString(HKEY_CURRENT_USER, REG_MACH & "\" & "COMM", "TCPPORT", gComm.TCPPORT)
        
        ElseIf optUse(2).Value = True Then
            Call SaveString(HKEY_CURRENT_USER, REG_MACH & "\" & "PATH", "EXPORT", txtRstPath.Text)
            Call SaveString(HKEY_CURRENT_USER, REG_MACH & "\" & "PATH", "IMPORT", txtOrdPath.Text)
            Call SaveString(HKEY_CURRENT_USER, REG_MACH & "\" & "PATH", "IMAGE", txtImgPath.Text)
        ...
        Call SaveString(HKEY_CURRENT_USER, REG_MACH & "\" & "ASSAY", "ORGPRTNM", txtDefaultPrinter.Text)
        Call SaveString(HKEY_CURRENT_USER, REG_MACH & "\" & "ASSAY", "PRTNAME", txtAllergyPrinter.Text)
        
        '¿ø·¡ ÇÁ¸°ÅÍ·Î µÇµ¹¸®±â
        Buffer = Space(1024)
        PrinterName = txtDefaultPrinter.Text
        ...
        If PrinterName <> "" And PrinterPort <> "" Then
...
Private Sub Form_Load()
    ...
    Dim Buffer As String
     ...
     'Get the list of available printers from Registry
     Buffer = Space(8192)
     r = GetProfileString("PrinterPorts", vbNullString, "", Buffer, Len(Buffer))

     'Display the list of printer in the list boxList1
     ParseList lstDefault, Buffer
     ParseList lstAllergy, Buffer

     Buffer = Space(1024)
     r = GetProfileString("Windows", "device", "", Buffer, Len(Buffer))
     'Label2.Caption = Trim(Buffer)
...
On Error Resume Next
    ...
    ElseIf gComm.COMTYPE = "3" Then
        ...
        txtRstPath.Text = gB4C.EXPORT
        txtOrdPath.Text = gB4C.IMPORT
        txtImgPath.Text = gB4C.IMAGE
        
    End If
    
    
    txtDefaultPrinter.Text = gB4C.ORGPRTNAME
    txtAllergyPrinter.Text = gB4C.PRTNAME
    
End Sub

Private Sub lstAllergy_Click()

    txtAllergyPrinter.Text = lstAllergy.Text
    
End Sub

Private Sub lstDefault_Click()

    txtDefaultPrinter.Text = lstDefault.Text
