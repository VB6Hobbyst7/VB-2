...
Begin VB.Form frmTestSet 
   ...
   Begin VB.Frame frameTestSet 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin HSCotrol.CButton cmdRemove 
            ...
            HoverColor      =   -2147483630
         End
         Begin HSCotrol.HSLabel lblGubun 
            Height          =   345
            Left            =   4560
            Top             =   150
            Width           =   1755
            ...
            Alignment       =   2
         End
         Begin HSCotrol.HSLabel HSLabel29 
            Height          =   330
            Left            =   30
            Top             =   3480
            Width           =   1035
            ...
            Alignment       =   2
         End
         Begin HSCotrol.HSLabel HSLabel30 
            Height          =   330
            Left            =   30
            Top             =   3900
            Width           =   1035
   ...
   End
   Begin HSCotrol.HSLabel HSLabel28 
      Height          =   345
      Left            =   60
      Top             =   90
      Width           =   1035
...
Private Sub cmdConfirm_Click(Index As Integer)
    ...
    Call SaveString(HKEY_CURRENT_USER, REG_MACH & "\" & "ASSAY", "96M", txtAssay.Text)
    Call SaveString(HKEY_CURRENT_USER, REG_MACH & "\" & "ASSAY", "ORDCODE", txtOrderCode.Text)
...
Private Sub Form_Load()
    ...
    With spdTest
'        Call SetText(spdTest, "장비구분", 0, 2):
'        Call SetText(spdTest, "검사약어", 0, 8):
'        Call SetText(spdTest, "소수점 변환", 0, 9):
'        Call SetText(spdTest, "변환 자릿수", 0, 10):
'        Call SetText(spdTest, "남성 (하한치)", 0, 11):
'        Call SetText(spdTest, "남성 (상한치)", 0, 12):
'        Call SetText(spdTest, "여성 (하한치)", 0, 13):
'        Call SetText(spdTest, "여성 (상한치)", 0, 14):
'        Call SetText(spdTest, "결과형태", 0, 15):
'        Call SetText(spdTest, "결과표기", 0, 23):
'        Call SetText(spdTest, "계산항목", 0, 24):
    ...
    txtAssay.Text = gB4C.ASSAY96NM
    
    txtOrderCode.Text = gB4C.ORDCODE
...
Private Sub optGubun_Click(Index As Integer)
    ...
    lblGubun.Caption = optGubun(Index).Caption
