...
Private Sub cmdSave_Click()
    ...
    Call SaveString(HKEY_CURRENT_USER, REG_MACH & "\" & "HOSP", "DOCNAME", txtDoctNm.Text)
    ...
    If lblMachNm.Caption <> "" Then
        Call WritePrivateProfileString("EXE", "MACH", lblMachNm.Caption, App.PATH & "\SANSOFT.ini")
    End If
...
Private Sub lblHosp_DblClick()
    ...
    If cboMachs.Visible = False Then
        strPW = InputBox("비밀번호 입력" & Space(5) & "hint:개발자oyh", "상세설정", "")
