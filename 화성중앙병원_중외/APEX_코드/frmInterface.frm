...
Begin VB.Form frmInterface 
   ...
   Begin FPSpreadADO.fpSpread spdWork 
      ...
      ShadowColor     =   14737632
      ShadowDark      =   12632256
      SpreadDesigner  =   "frmInterface.frx":2535D
      VisibleCols     =   3
      VisibleRows     =   10
      ScrollBarTrack  =   1
      ShowScrollTips  =   1
   ...
   Begin FPSpreadADO.fpSpread spdOrder 
      ...
      ShadowColor     =   14737632
      ShadowDark      =   12632256
      SpreadDesigner  =   "frmInterface.frx":26161
      UnitType        =   0
      VisibleCols     =   3
      VisibleRows     =   10
      ScrollBarTrack  =   3
            ...
            Select Case strType
                ...
                Case "R"    '## Result
                    ...
                    If strIntBase <> "" And strResult <> "" Then
                        ...
                        If ResultProcess(mResult.BarNo, strIntBase, strResult, strIntResult, strFlag) = True Then
                            strState = "R"
                        Else
                            If strState = "" Then
                                strState = ""
