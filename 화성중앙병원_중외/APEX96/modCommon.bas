...
Public Const colINOUT = 8       '검사구분
Public Const colDISKNO = 9      '의뢰처
...
Public Const colCLASS = 6
Public Const colSEQ = 7
Public Const colFLAG = 8
Public Const colSUBCODE = 9
...
Type AssayName
    ...
    INHALANT_CD As String
    FOOD_CD     As String
    ATOPY_CD    As String
    APEX96M_CD  As String
    APEX96MR_CD  As String
...
Public ALG_CMNT0 As Variant

Public ALG_CMNT1 As Variant  '= "특별한 알레르기 소견을 보이지 않음." & vbNewLine & _
                                     "(알레르기 검사결과, 음성으로 정상입니다.)"
                                     
Public Const ALG_CMNT2 As Variant = "Total IgE는 정상이나, Specific IgE중 일부 알레르기 유발물질인" & vbNewLine & _
...
Public Const ALG_CMNT3 As Variant = "검사를 시행한 Specific IgE 즉 항원에 대해선 음성 결과를 보이나, 만약" & vbNewLine & _
...
Public Const ALG_CMNT4 As Variant = "Total IgE와 Specific IgE 검사결과 양성을 보이며 환자의 병력, 가족력," & vbNewLine & _
...
'    gQCEquip = Trim(frmInterface.txtTemp)
    ...
    '-- 장비코드
    db_tmp = ""
    Call GetPrivateProfileString("CONFIG", "MACHCD", "", db_tmp, 100, App.Path & "\Interface.ini")
    frmInterface.txtTemp = Trim(db_tmp)
    gMachCD = Trim(frmInterface.txtTemp)
...
'    gGINUS_Parm.MCD = Trim(frmInterface.txtTemp)
    ...
    db_tmp = ""
    Call GetPrivateProfileString("ASSAY", "IN", "", db_tmp, 100, App.Path & "\Interface.ini")
    frmInterface.txtTemp = Trim(db_tmp)
    gAssayNM.INHALANT = Trim(frmInterface.txtTemp)
    
    db_tmp = ""
    Call GetPrivateProfileString("ASSAY", "FD", "", db_tmp, 100, App.Path & "\Interface.ini")
    frmInterface.txtTemp = Trim(db_tmp)
    gAssayNM.FOOD = Trim(frmInterface.txtTemp)
    
    db_tmp = ""
    Call GetPrivateProfileString("ASSAY", "AT", "", db_tmp, 100, App.Path & "\Interface.ini")
    frmInterface.txtTemp = Trim(db_tmp)
    gAssayNM.ATOPY = Trim(frmInterface.txtTemp)
    
    db_tmp = ""
    Call GetPrivateProfileString("ASSAY", "96M", "", db_tmp, 100, App.Path & "\Interface.ini")
    frmInterface.txtTemp = Trim(db_tmp)
    gAssayNM.APEX96M = Trim(frmInterface.txtTemp)
    
    db_tmp = ""
    Call GetPrivateProfileString("ASSAY", "INCD", "", db_tmp, 100, App.Path & "\Interface.ini")
    frmInterface.txtTemp = Trim(db_tmp)
    gAssayNM.INHALANT_CD = Trim(frmInterface.txtTemp)
    
    db_tmp = ""
    Call GetPrivateProfileString("ASSAY", "FDCD", "", db_tmp, 100, App.Path & "\Interface.ini")
    frmInterface.txtTemp = Trim(db_tmp)
    gAssayNM.FOOD_CD = Trim(frmInterface.txtTemp)
    
    db_tmp = ""
    Call GetPrivateProfileString("ASSAY", "ATCD", "", db_tmp, 100, App.Path & "\Interface.ini")
    frmInterface.txtTemp = Trim(db_tmp)
    gAssayNM.ATOPY_CD = Trim(frmInterface.txtTemp)
    
    db_tmp = ""
    Call GetPrivateProfileString("ASSAY", "96MCD", "", db_tmp, 100, App.Path & "\Interface.ini")
    frmInterface.txtTemp = Trim(db_tmp)
    gAssayNM.APEX96M_CD = Trim(frmInterface.txtTemp)
    
    db_tmp = ""
    Call GetPrivateProfileString("ASSAY", "96MRCD", "", db_tmp, 100, App.Path & "\Interface.ini")
    frmInterface.txtTemp = Trim(db_tmp)
    gAssayNM.APEX96MR_CD = Trim(frmInterface.txtTemp)
    ...
    db_tmp = ""
    Call GetPrivateProfileString("ASSAY", "CMTVIEW", "", db_tmp, 100, App.Path & "\Interface.ini")
    frmInterface.txtTemp = Trim(db_tmp)
    gAssayNM.CMTVIEW = Trim(frmInterface.txtTemp)
    
    db_tmp = ""
    Call GetPrivateProfileString("ASSAY", "HIGH", "", db_tmp, 100, App.Path & "\Interface.ini")
    frmInterface.txtTemp = Trim(db_tmp)
    gAssayNM.HIGH = Trim(frmInterface.txtTemp)
    
    db_tmp = ""
    Call GetPrivateProfileString("ASSAY", "IGEHIGH", "", db_tmp, 100, App.Path & "\Interface.ini")
    frmInterface.txtTemp = Trim(db_tmp)
    gAssayNM.IGEHIGH = Trim(frmInterface.txtTemp)
...
'''
'''    db_tmp = ""
'''    Call GetPrivateProfileString("COMMENT", "N", "", db_tmp, 100, App.Path & "\Interface.ini")
'''    frmInterface.txtTemp = Trim(db_tmp)
'''    CMNT.N = Trim(frmInterface.txtTemp)
'''
'''    db_tmp = ""
'''    Call GetPrivateProfileString("COMMENT", "P1", "", db_tmp, 100, App.Path & "\Interface.ini")
'''    frmInterface.txtTemp = Trim(db_tmp)
'''    CMNT.P1 = Trim(frmInterface.txtTemp)
'''
'''    db_tmp = ""
'''    Call GetPrivateProfileString("COMMENT", "P2", "", db_tmp, 100, App.Path & "\Interface.ini")
'''    frmInterface.txtTemp = Trim(db_tmp)
'''    CMNT.P2 = Trim(frmInterface.txtTemp)
'''
'''    db_tmp = ""
'''    Call GetPrivateProfileString("COMMENT", "P3", "", db_tmp, 100, App.Path & "\Interface.ini")
'''    frmInterface.txtTemp = Trim(db_tmp)
'''    CMNT.P3 = Trim(frmInterface.txtTemp)
'''
