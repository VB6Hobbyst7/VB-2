...
Begin VB.Form frmInterface 
   ...
   Begin VB.Frame FrmHideControl 
      ...
      Begin VB.Frame Frame4 
         ...
         Begin FPSpread.vaSpread vasPrintBuf 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            SpreadDesigner  =   "frmInterface.frx":1A25
         End
      End
      ...
      Begin FPSpread.vaSpread vasCode 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":1C4B
      End
      Begin FPSpread.vaSpread vasTemp1 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":1E71
      End
         ...
         Begin MSComctlLib.ImageList imlStatus 
            ...
            BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
               ...
               BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":2621
                  Key             =   "RUN"
               EndProperty
               BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":2BBB
                  Key             =   "NOT"
               EndProperty
               BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":3155
                  Key             =   "STOP"
               EndProperty
               BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":36EF
                  Key             =   "LST"
               EndProperty
               BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":3F81
                  Key             =   "ITM"
               EndProperty
               BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":40DB
                  Key             =   "ERR"
               EndProperty
               BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":4235
                  Key             =   "NOF"
               EndProperty
            EndProperty
         End
      ...
      Begin FPSpread.vaSpread vasList 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":438F
      End
      Begin FPSpread.vaSpread vasResTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":45B5
      End
      Begin FPSpread.vaSpread vasTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":47DB
      End
   ...
   Begin VB.Frame Frame1 
      ...
      Begin FPSpread.vaSpread vasRes 
         ...
         ScrollBars      =   2
         SpreadDesigner  =   "frmInterface.frx":4DB0
      End
      ...
      Begin FPSpread.vaSpread vasID 
         ...
         RetainSelBlock  =   0   'False
         SpreadDesigner  =   "frmInterface.frx":546B
      End
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.Label lblInfo 
         BackColor       =   &H00FFFFFF&
         Caption         =   "미표시검사 : PC, S2, S3, Positive 1, Positive 2"
         BeginProperty Font 
            Name            =   "굴림체"
            Size            =   9
            Charset         =   129
...
Private Sub cmdIFTrans_Click()
    ...
    For lRow = 1 To vasID.DataRowCnt
        ...
        If vasID.Value = 1 Then
            txtResult.Text = ""
            Call vasID_Click(1, lRow)

            Res = SaveTransData_JWINFO(lRow, txtResult.Text)
            ...
            If .Value = 1 Then
                If Trim(GetText(vasID, intRow, colBARCODE)) <> "" Then
                    ...
                    Select Case Trim(GetText(vasID, intRow, colINOUT))
                        ...
                        Case "M96":         strAssayNm = gAssayNM.APEX96M
                    End Select
...
'    blnSameRecord = True
    ...
    For i = 0 To UBound(varTmp)
        ...
        If InStr(varTmp(i), """Assay""") > 0 Then 'blnAppend1 = True And
            ...
            ElseIf gAssayNM.APEX96M = mGetP(strTmp, 1, """") Then
...
'                    Next
                ...
                If blnSame = False Then
                    ...
                    Select Case Trim(RS.Fields("ORDERCODE")) & ""        '처방코드 ??
                        ...
                        Case gAssayNM.FOOD_CD:     SetText vasID, "FOOD", .MaxRows, colINOUT
                        Case gAssayNM.ATOPY_CD:    SetText vasID, "ATOPY", .MaxRows, colINOUT
                        Case gAssayNM.APEX96M_CD:  SetText vasID, "M96", .MaxRows, colINOUT
                        Case Else:
                                                   SetBackColor vasID, .MaxRows, .MaxRows, 1, colState, 202, 255, 112
                                                   SetText vasID, "처방오류", .MaxRows, colINOUT
...
Private Sub Form_Resize()
    ...
    If cmdSL.Caption = "▶" Then
        ...
        vasID.Width = frmInterface.ScaleWidth - vasRes.Width - 500
        
        vasRes.Height = vasID.Height
        vasRes.Left = vasID.Width + 150
            
        txtResult.Visible = True
        txtResult.Top = vasID.Top
        txtResult.Height = vasID.Height
        txtResult.Left = vasID.Width + 150
...
Private Sub Form_Load()
    ...
    '-- 소견 가져오기
          SQL = "Select TITLE, CONTENT  " & vbCrLf
    SQL = SQL & "  From CONFIG          " & vbCrLf
...
'                End If
                ...
                'txtResult.Text = GetResult(blnIgE, intClass)

                                
                '## DB에 결과저장
                If MnTransAuto.Checked = True And strState = "R" Then
                    Call cmdIFTrans_Click
'                    Res = SaveTransDataW(gRow, txtResult.Text)
'
'                    If Res = -1 Then
'                        '-- 저장 실패
'                        SetForeColor vasID, gRow, gRow, 1, colState, 255, 0, 0
...
Private Function GetResult(ByVal blnIgE As Boolean, ByVal intPCnt As Integer) As String
    ...
    With vasRes
        For i = 1 To .MaxRows
            Erase strData
            .Row = i
            .Col = colSEQ:          strData(0) = .Text: strData(0) = strData(0) & Space(4 - LenB(StrConv(strData(0), vbFromUnicode)))
            .Col = colEXAMNAME:     strData(1) = .Text: strData(1) = strData(1) & Space(15 - LenB(StrConv(strData(1), vbFromUnicode)))
            .Col = colEQUIPCODE:    strData(2) = .Text: strData(2) = strData(2) & Space(10 - LenB(StrConv(strData(2), vbFromUnicode)))
            .Col = colRESULT:       strData(3) = .Text: strData(3) = strData(3) & Space(6 - LenB(StrConv(strData(3), vbFromUnicode)))
            .Col = colCLASS:        strData(4) = .Text: strData(4) = strData(4) & Space(3 - LenB(StrConv(strData(4), vbFromUnicode)))
            
            For j = 0 To 4
                strResult = strResult & strData(j)
            Next
    ...
    strResult = strResult & vbCrLf
    strResult = strResult & "참고치 : " & vbCrLf
    strResult = strResult & "IU/mL        Class 알레르겐 특이 항체량" & vbCrLf
    strResult = strResult & "<0.34        0     없음" & vbCrLf
    strResult = strResult & "0.35~0.69    1     낮음" & vbCrLf
    strResult = strResult & "0.70~3.49    2     중간" & vbCrLf
    strResult = strResult & "3.50~17.49   3     중간/높음" & vbCrLf
    strResult = strResult & "17.50~49.99  4     높음" & vbCrLf
    strResult = strResult & "50.00~99.99  5     매우 높음" & vbCrLf
    strResult = strResult & "≥100        6     극히 높음"
    
    GetResult = strResult
    
    StatusBar1.Panels(2).Text = LenB(StrConv(GetResult, vbFromUnicode))
'    Debug.Print LenB(StrConv(GetResult, vbFromUnicode))
    
End Function

Private Function GetResult_2Line(ByVal blnIgE As Boolean, ByVal intPCnt As Integer) As String
    Dim strData(4)  As String
    Dim strResult   As String
    Dim i           As Integer
    Dim j           As Integer
...
'    strResult = "No   " & "Name           " & "Code      " & "IU/mL   " & "Class " & "No   " & "Name           " & "Code      " & "IU/mL   " & "Class " & vbCrLf & strResult
'    strResult = strResult & "-----------------------------------------------------------------------------------" & vbCrLf
'    strResult = strResult & vbCrLf & vbCrLf
    ...
    '-- IgE 증가
'    If blnIgE = True Then
'        strResult = strResult & "" & CMNT.N & vbCrLf
'    End If

    '-- 여러가지( => 10)
'    If intPCnt >= 10 Then
'        strResult = strResult & "" & CMNT.P1 & vbCrLf
'    End If
    ...
    GetResult_2Line = strResult
    'Debug.Print LenB(StrConv(GetResult_2Line, vbFromUnicode))
...
'    lblDate.Caption = Trim(GetText(vasID, Row, colHOSPDATE))
    ...
    SQL = SQL & "   AND EXAMDATE = '" & Mid(Trim(GetText(vasID, Row, colEXAMDATE)), 1, 8) & "' " & vbCrLf
    ...
    If Not RS.EOF = True And Not RS.BOF = True Then
        ...
        Do Until RS.EOF
            With vasRes
                ...
                If Trim(RS.Fields("EQUIPCODE")) = "tIgE" Then
                    If InStr(Trim(RS.Fields("RESULT")), "≤") > 0 Then
                        blnIgE = False
                    ElseIf InStr(Trim(RS.Fields("RESULT")), ">") > 0 Then
                        blnIgE = True
                    End If
                End If
            
                Select Case Trim(RS.Fields("REFVALUE"))
                    Case "1": intClass = intClass + 1
                    Case "2": intClass = intClass + 1
                    Case "3": intClass = intClass + 1
                    Case "4": intClass = intClass + 1
                    Case "5": intClass = intClass + 1
                    Case "6": intClass = intClass + 1
                End Select
