...
Begin VB.MDIForm MDIIF 
   ...
   Begin VB.PictureBox picHeader 
      ...
      Begin HSCotrol.CButton cmdView 
         ...
         BorderColor     =   4210752
         HoverColor      =   16711680
         HoverPicture    =   "MDIIF.frx":3251
      End
      Begin MSComDlg.CommonDialog cDlgApex 
         Left            =   2130
         Top             =   0
         _ExtentX        =   847
         _ExtentY        =   847
      ...
      Begin HSCotrol.CButton cmdPrint 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "MDIIF.frx":42A3
         MaskColor       =   0
         PicCapAlign     =   2
         BorderStyle     =   1
         BorderColor     =   4210752
         HoverColor      =   16711680
         HoverPicture    =   "MDIIF.frx":50F5
      End
      ...
      Begin HSCotrol.CButton cmdClear 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "MDIIF.frx":7970
         MaskColor       =   0
         PicCapAlign     =   2
         BorderStyle     =   1
         BorderColor     =   4210752
         HoverColor      =   16711680
         HoverPicture    =   "MDIIF.frx":864A
      End
      Begin HSCotrol.CButton cmdSave 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "MDIIF.frx":96D1
         MaskColor       =   0
         PicCapAlign     =   2
         BorderStyle     =   1
         BorderColor     =   4210752
         HoverColor      =   16711680
         HoverPicture    =   "MDIIF.frx":9FAB
      End
      Begin HSCotrol.CButton cmdOrderSend 
         ...
         HoverColor      =   0
      End
      Begin HSCotrol.CButton cmdResultReceive 
         Height          =   495
         Left            =   11430
         TabIndex        =   29
         Top             =   60
         ...
         HoverColor      =   0
      End
      Begin HSCotrol.CButton cmdWork 
         Height          =   495
         Left            =   4590
         TabIndex        =   31
         ToolTipText     =   "선택한 검체의 상세결과를 보입니다."
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "MDIIF.frx":AD3D
         MaskColor       =   0
         PicCapAlign     =   2
         BorderStyle     =   1
         BorderColor     =   4210752
         HoverColor      =   16711680
         HoverPicture    =   "MDIIF.frx":B9C4
      End
      Begin HSCotrol.CButton cmdResult 
         Height          =   495
         Left            =   7290
         TabIndex        =   32
         ToolTipText     =   "선택한 검체의 상세결과를 보입니다."
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "MDIIF.frx":CA16
         MaskColor       =   0
         PicCapAlign     =   2
         BorderStyle     =   1
         BorderColor     =   4210752
         HoverColor      =   16711680
         HoverPicture    =   "MDIIF.frx":D69D
      End
   ...
   Begin MSComctlLib.ImageList imlSubList 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "MDIIF.frx":FEFE
            Key             =   "LIS1101"
            Object.Tag             =   "Menu"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "MDIIF.frx":10F50
            Key             =   "LIS1102"
            Object.Tag             =   "SubMenus"
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "MDIIF.frx":11FA2
            Key             =   "LIS1104"
            Object.Tag             =   "SubMenus"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "MDIIF.frx":12FF4
            Key             =   "LIS1103"
            Object.Tag             =   "SubMenu"
         EndProperty
      EndProperty
...
'<?xml version="1.0" encoding="utf-8"?><GROUP NAME="WORKLIST" TYPE="HOST" VERSION="00.00.00.00">
'<GROUP TYPE="Sample">
'<GROUP TYPE="Patient" ID="012040487321"></GROUP><GROUP TYPE="Assays" ID=" ">
'<GROUP TYPE="Assay" ID="PROTIA Allergy-Q Atopy" STATE="Host"/>
'</GROUP>
'</GROUP>
'<GROUP TYPE="Sample">
'<GROUP TYPE="Patient" ID="012054276928"></GROUP><GROUP TYPE="Assays" ID=" ">
'<GROUP TYPE="Assay" ID="PROTIA Allergy-Q 96M" STATE="Host"/>
'</GROUP>
'</GROUP>
'</GROUP>
        ...
        With frmInterface.spdOrder
            For intRow = 1 To .MaxRows
                ...
                .Col = colCHECKBOX
                If .Value = 1 Then
                    If Trim(GetText(frmInterface.spdOrder, intRow, colBARCODE)) <> "" Then
                        blnSendXml = True
                        
                        strBody = strBody & vbTab & "<GROUP TYPE=""Sample"">" & vbCrLf
                        strBody = strBody & vbTab & vbTab & "<GROUP TYPE=""Patient"" ID=""" & Trim(GetText(frmInterface.spdOrder, intRow, colBARCODE)) & """>" & vbCrLf
                        '-- Group
                        strBody = strBody & vbTab & vbTab & vbTab & "<PARAM TYPE=""String[32]"" ID=""Group"" FILTER=""-wwwr"">" & Trim(GetText(frmInterface.spdOrder, intRow, colINOUT)) & "</PARAM>" & vbCrLf
                        '-- Name
                        strBody = strBody & vbTab & vbTab & vbTab & "<PARAM TYPE=""String[32]"" ID=""Name"" FILTER=""-ooor"">" & Trim(GetText(frmInterface.spdOrder, intRow, colPNAME)) & "</PARAM>" & vbCrLf
                        '-- Surname
                        strBody = strBody & vbTab & vbTab & vbTab & "<PARAM TYPE=""String[32]"" ID=""Surname"" FILTER=""-ooor"">" & Trim(GetText(frmInterface.spdOrder, intRow, colPNAME)) & "</PARAM>" & vbCrLf
                        '-- BirthDate
                        strBody = strBody & vbTab & vbTab & vbTab & "<PARAM TYPE=""Date"" ID=""BirthDate"" FILTER=""-ooor"">" & Format(Now, "yyyy-mm-dd") & "</PARAM>" & vbCrLf
                        '-- Sex
                        strBody = strBody & vbTab & vbTab & vbTab & "<PARAM TYPE=""SexType"" ID=""Sex"" FILTER=""-wwwr"">" & IIf(Trim(GetText(frmInterface.spdOrder, intRow, colPSEX)) = "M", "M", "F") & "</PARAM>" & vbCrLf
                        '-- Note
                        strBody = strBody & vbTab & vbTab & vbTab & "<PARAM TYPE=""String[50]"" ID=""Note"" FILTER=""-wwwr"">" & "Note Test" & "</PARAM>" & vbCrLf
                        '-- Code (장비에서 Patient ID)
                        strBody = strBody & vbTab & vbTab & vbTab & "<PARAM TYPE=""String[50]"" ID=""Note"" FILTER=""-wwwr"">" & Trim(GetText(frmInterface.spdOrder, intRow, colPID)) & "</PARAM>" & vbCrLf
                        ...
                        'Select Case Trim(GetText(frmInterface.spdOrder, intRow, colINOUT))
...
' Dim x As Printer
'
'    '프린터 콤보박스의 목록과 실제 프린터 목록을 비교한다.
'    For Each x In Printers
'        If x.DeviceName = "Zan Image Printer(color)" Then  '같은게 있으면
'            Set Printer = x  '프린터방향을 그 프린터로 설정한다.
'        End If
'    Next
''    PrintErrReply = False
...
'        .spdAllergy.Sheet = 1
'        .spdPrv.hWndSpread = .spdAllergy.hwnd
'        .spdAllergy.PrintSheet 0
...
'    .spdAllergy.Row = 1
'
'        .spdAllergy.SavePicture .spdAllergy.TypePictPicture, "c:\test.jpg", PictureTypeJPEG
...
Private Sub cmdResult_Click()
    ...
    frmInterface.spdOrder.MaxRows = 0
    
    Call GetResultList(Format(Now, "yyyy-mm-dd"), Format(Now, "yyyy-mm-dd"), frmInterface.spdOrder)

End Sub

Private Sub cmdResultReceive_Click()
    Dim varXML      As Variant
    Dim strXmlName  As String
'    Dim i As Integer
    
    cDlgApex.Filter = "XML(*.xml)|*.xml"
    cDlgApex.Action = 1
    
    If cDlgApex.FileTitle = "" Then
        Exit Sub
    End If
    
    strXmlName = Trim(cDlgApex.Filename)
    
    Call getXMLList(strXmlName)
    
    Call frmInterface.FileData_APEX
    
End Sub


Private Sub getXMLList(ByVal strXML As String)
    Dim TextLine
...
'    Close #1 ' 파일을 닫습니다
    ...
    STM.Type = adTypeText
    STM.Charset = "utf-8"
    STM.LoadFromFile (strXML)
    strBuffer = STM.ReadText()
    STM.Close
    Set STM = Nothing
    ...
    For i = 0 To UBound(varTmp)
        If InStr(varTmp(i), """Patient""") > 0 Then
            ...
            '추가 : 이미지 찾아오는 있는 파일명
            strRecvData(j) = strRecvData(j) & "|" & mGetP(Mid(varTmp(i), InStr(varTmp(i), """String""") + 29), 1, "<")
            j = j + 1
            'blnAppend1 = True
        End If
        ...
        If InStr(varTmp(i), """Assay""") > 0 Then
            ...
            If gB4C.ASSAYINNM = mGetP(strTmp, 1, """") Then
                strRecvData(j) = strRecvData(j) & "O|INHALANT"
            ElseIf gB4C.ASSAYFDNM = mGetP(strTmp, 1, """") Then
                strRecvData(j) = strRecvData(j) & "O|FOOD"
            ElseIf gB4C.ASSAYATNM = mGetP(strTmp, 1, """") Then
                strRecvData(j) = strRecvData(j) & "O|ATOPY"
            ElseIf gB4C.ASSAY96NM = mGetP(strTmp, 1, """") Then
                strRecvData(j) = strRecvData(j) & "O|96M"
                j = j + 1
                ReDim Preserve strRecvData(j)
                strRecvData(j) = strRecvData(j) & "R|96M^" & gB4C.ORDCODE & "^별지참조^"
            Else
                Exit Sub
            End If
        ...
        If InStr(varTmp(i), """Blot""") > 0 Then
            ...
            For k = 0 To UBound(varTmp1)
                'Debug.Print varTmp1(k)
                
                If InStr(varTmp1(k), """Code""") > 0 Then
                    strTestCd = Mid(varTmp1(k), InStr(varTmp1(k), """Code""") + 7)
                End If
                If InStr(varTmp1(k), """Name""") > 0 Then
                    strTestNm = Mid(varTmp1(k), InStr(varTmp1(k), """Name""") + 7)
                End If
                If strTestCd <> "" And strTestNm <> "" And InStr(varTmp1(k), """QntResult""") > 0 Then
                    ...
                    ReDim Preserve strRecvData(j)
                    strRecvData(j) = strRecvData(j) & "R|" & strTestNm & "^" & strTestCd & "^" & strResult & "^" & strClass
                    j = j + 1
                    strTestCd = ""
                    strTestNm = ""
                    strResult = ""
...
Private Sub cmdWork_Click()
    ...
    Call ShowForm(frmWorkList, frmWorkList.Caption)
...
Private Sub MDIForm_Load()
    ...
    If gEMR = "JWINFO" Then
        frmInterface.fraJWINFO.Visible = True
    Else
        frmInterface.fraJWINFO.Visible = False
    End If
...
'            .Visible = False
            .MaxRows = .MaxRows + 1
            Call SetText(frmInterface.spdOrder, txtBarNum.Text, .MaxRows, colBARCODE)
            If GetSampleInfo(.MaxRows, frmInterface.spdOrder) = -1 Then
