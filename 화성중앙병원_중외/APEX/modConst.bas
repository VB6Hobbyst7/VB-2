...
Public Const colPJUMIN = 18     '주민번호(의사랑에서 필요)
...
Public Const colLGUBUN = 2
Public Const colLSEQNO = 3
...
Public Const colLRESSPECUSE = 9
Public Const colLRESSPEC = 10
Public Const colLMLOW = 11
Public Const colLMHIGH = 12
Public Const colLFLOW = 13
Public Const colLFHIGH = 14
Public Const colRESTYPE = 15
