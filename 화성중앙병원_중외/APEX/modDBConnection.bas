...
On Error GoTo ConnectError
    ...
    If ServerName = "" Then
        Select Case gEMR
            ...
            Case "MSINFOTEC":   ServerName = "msdb"
            Case "BIT":         ServerName = "ORA10.WORLD"
        End Select
    End If
    ...
    If UserName = "" Then
        Select Case gEMR
            ...
            Case "MSINFOTEC":   UserName = "emr"
            Case "BIT":         UserName = "NRCOCS"
        End Select
    End If
    ...
    If Password = "" Then
        Select Case gEMR
            ...
            Case "MSINFOTEC":   Password = "msit0517"
            Case "BIT":         Password = "QAZ123"
        End Select
    End If
...
'MSSQLPWD=int_!jj1m
    ...
    If ServerName = "" Then
        Select Case gEMR
            Case "ONIT":        ServerName = "192.168.10.250"
            Case "EHEALTH":     ServerName = "192.168.1.10,1433"
            Case "SANSOFT":     ServerName = "192.168.0.7\SQLEXPRESS,1433"
            Case "BIT70":       ServerName = "192.168.123.150" '대중병원
            Case "EONM":        ServerName = "EES"
            Case "AMIS":        ServerName = "sgknm"
            Case "LABSPEAR":    ServerName = "222.107.187.101,4433" '필의료재단 이노베스트
            Case "MEDICHART":   ServerName = "bitserver"
            Case "BIT":         ServerName = "192.168.0.240" '독일내과
            Case "MCC":         ServerName = "192.168.0.228" '새움병원
        End Select
    End If
    
    If DatabaseName = "" Then
        Select Case gEMR
            Case "ONIT":        DatabaseName = "onit_out"
            Case "EHEALTH":     DatabaseName = "EHOCSDB1"
    ...
    If UserName = "" Then
        Select Case gEMR
            Case "ONIT":        UserName = "sa"
            Case "EHEALTH":     UserName = "OCS01"
    ...
    If Password = "" Then
        Select Case gEMR
            Case "ONIT":        Password = "korea"
            Case "EHEALTH":     Password = "OCS01"
            Case "SANSOFT":     Password = "1004"
            Case "BIT70":       Password = "bitemr"
            Case "EONM":        Password = "EON_SPP"
...
'    PGSQLPWD = clinic2013!
    ...
    If ServerName = "" Then
        Select Case gEMR
            Case "EASYS":     ServerName = "IF" 'ODBC에서 만드는 이름
        End Select
    End If
...
'Check Database with oracle server-reset
Public Function DBExists_Local(ByVal AdoCn As ADODB.Connection, ByVal strSql As String) As Boolean
On Error GoTo DBOpenRsError
    Dim recAdoRs As New ADODB.Recordset
...
'    Next
'
'    frmErrMsg.txtErr = mDataBaseErrText
'    frmErrMsg.Show
'End Sub
