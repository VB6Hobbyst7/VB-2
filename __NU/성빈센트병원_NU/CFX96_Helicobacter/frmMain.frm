...
Begin VB.Form frmMain 
   ...
   Begin VB.Frame FraHidden 
      ...
      Begin MSComctlLib.ImageList imlStatus 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMain.frx":358C
               Key             =   "NOT"
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMain.frx":3B26
               Key             =   "STOP"
            EndProperty
      ...
      Begin FPSpread.vaSpread vasTemp 
         ...
         EndProperty
         RetainSelBlock  =   0   'False
         SpreadDesigner  =   "frmMain.frx":4D60
      End
      Begin FPSpread.vaSpread vasHPVReport 
         ...
         ScrollBars      =   0
         ScrollBarShowMax=   0   'False
         SpreadDesigner  =   "frmMain.frx":7DA5
         UserResize      =   0
      End
   ...
   Begin VB.Frame frame1 
      ...
      Begin FPSpread.vaSpread spdOrder 
         ...
         SpreadDesigner  =   "frmMain.frx":A334
         UserResize      =   2
         ScrollBarTrack  =   1
         ShowScrollTips  =   3
      End
      ...
      Begin FPSpread.vaSpread spdResult 
         ...
         SpreadDesigner  =   "frmMain.frx":E92A
         TextTip         =   2
      End
   End
   ...
   Begin VB.PictureBox Picture2 
      ...
      Begin VB.Frame fraResult 
         ...
         Begin VB.ComboBox cboRstType 
            ...
            EndProperty
            Height          =   300
            ItemData        =   "frmMain.frx":F1C9
            Left            =   420
            List            =   "frmMain.frx":F1CB
            TabIndex        =   121
            Top             =   180
            Width           =   1245
         End
         Begin VB.ComboBox cboState 
            ...
            EndProperty
            Height          =   300
            ItemData        =   "frmMain.frx":F1CD
            Left            =   4710
            List            =   "frmMain.frx":F1CF
            TabIndex        =   120
            Top             =   180
            Width           =   1395
         End
   ...
   Begin VB.Frame frame4 
      ...
      Begin VB.Frame frameCom 
         ...
         Begin VB.ComboBox cboPort 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmMain.frx":1247A
            Left            =   2190
            List            =   "frmMain.frx":1247C
            TabIndex        =   62
            Top             =   390
            Width           =   2205
         End
         Begin VB.ComboBox cboBaudrate 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmMain.frx":1247E
            Left            =   2190
            List            =   "frmMain.frx":12480
            TabIndex        =   61
            Top             =   780
            Width           =   2205
         End
         Begin VB.ComboBox cboDatabit 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmMain.frx":12482
            Left            =   2190
            List            =   "frmMain.frx":12484
            TabIndex        =   60
            Top             =   1170
            Width           =   2205
         End
         ...
         Begin VB.ComboBox cboParity 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmMain.frx":12486
            Left            =   2190
            List            =   "frmMain.frx":12488
            TabIndex        =   57
            Top             =   2520
            Width           =   2205
         End
   ...
   Begin VB.Frame frame3 
      ...
      Begin VB.Frame frameTestSet 
         ...
         Begin VB.Frame frameOrder 
            ...
            Begin FPSpread.vaSpread spdOrdMst 
               ...
               SelectBlockOptions=   0
               ShadowColor     =   13697023
               SpreadDesigner  =   "frmMain.frx":13C06
               TextTip         =   2
            End
         End
         Begin VB.ComboBox cboResultType 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmMain.frx":13F92
            Left            =   1650
            List            =   "frmMain.frx":13F94
            TabIndex        =   42
            Top             =   4470
            Width           =   1575
         End
         ...
         Begin VB.Frame frameCutOff 
            ...
            Begin VB.ComboBox cboCOH 
               ...
               EndProperty
               Height          =   315
               ItemData        =   "frmMain.frx":13F96
               Left            =   2730
               List            =   "frmMain.frx":13F98
               TabIndex        =   38
               Top             =   1020
               Width           =   735
            End
            ...
            Begin VB.ComboBox cboCOL 
               ...
               EndProperty
               Height          =   315
               ItemData        =   "frmMain.frx":13F9A
               Left            =   2730
               List            =   "frmMain.frx":13F9C
               TabIndex        =   29
               Top             =   300
               Width           =   735
            End
      ...
      Begin FPSpread.vaSpread spdTest 
         ...
         RetainSelBlock  =   0   'False
         SelectBlockOptions=   0
         SpreadDesigner  =   "frmMain.frx":1B1CD
      End
   End
   Begin VB.Frame frame2 
      ...
      Begin FPSpread.vaSpread spdROrder 
         ...
         SelectBlockOptions=   0
         ShadowColor     =   14548991
         SpreadDesigner  =   "frmMain.frx":1BD39
         UserResize      =   2
      End
      ...
      Begin FPSpread.vaSpread spdRResult 
         ...
         SelectBlockOptions=   0
         ShadowColor     =   13697023
         SpreadDesigner  =   "frmMain.frx":20281
         TextTip         =   2
      End
    ...
    With spdROrder
        For iRow = 1 To .MaxRows
            If iRow = 1 Then
                ...
                SetText vasPrint, Space(30) & "H.pylori Result", 2, 13
...
On Error GoTo RST
    ...
    lblServerPath.Caption = IIf(InStr(gORADB.SID, "EDU") > 0, "교육서버에 접속됨", "실서버에 접속됨")
