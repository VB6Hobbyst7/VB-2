...
Private Sub imgMenuInsert_Click()
    ...
    Else
        ...
        Call WritePrivateProfileString("DATABASE", "LOCALPATH", strPath, App.PATH & "\OKSOFT.ini")
        Call WritePrivateProfileString("DATABASE", "LOCALUID", strUID, App.PATH & "\OKSOFT.ini")
        Call WritePrivateProfileString("DATABASE", "LOCALPWD", strPWD, App.PATH & "\OKSOFT.ini")
