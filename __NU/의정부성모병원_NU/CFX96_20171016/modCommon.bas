...
Public varClipData(1000, 1000) As String
Public gRowCnt            As Integer
...
Public Function MidH(str As String, start As Long, length As Long) As String
    
    MidH = StrConv(MidB(StrConv(str, vbFromUnicode), start, length), vbUnicode)
...
'        .TypeVAlign = TypeVAlignCenter
'        Call SetText(frmMain.spdOrder, "검출Target", 0, 22)
'        .ColWidth(22) = 20
'
'        .Col = 23
'        .Row = -1
...
'        .TypeHAlign = TypeHAlignLeft
'        .TypeVAlign = TypeVAlignCenter
'        Call SetText(frmMain.spdOrder, "소견", 0, 23)
'        .ColWidth(23) = 50
'
...
'        .TypeHAlign = TypeHAlignLeft
'        .TypeVAlign = TypeVAlignCenter
'        Call SetText(frmMain.spdROrder, "검출Target", 0, 22)
'        .ColWidth(22) = 20
'
'        .Col = 23
'        .Row = -1
...
'        .TypeHAlign = TypeHAlignLeft
'        .TypeVAlign = TypeVAlignCenter
'        Call SetText(frmMain.spdROrder, "소견", 0, 23)
'        .ColWidth(23) = 50
