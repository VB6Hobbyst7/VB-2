...
Begin VB.Form frmMain 
   ...
   Begin VB.Frame FraHidden 
      ...
      Begin FPSpread.vaSpread vasHPVReport 
         ...
         SpreadDesigner  =   "frmMain.frx":8C7C
         UserResize      =   0
      End
      Begin FPSpread.vaSpread vasPrint 
         ...
         ScrollBars      =   0
         ScrollBarShowMax=   0   'False
         SpreadDesigner  =   "frmMain.frx":B207
         UserResize      =   0
      End
      Begin FPSpread.vaSpread vasExcel 
         ...
         EndProperty
         RetainSelBlock  =   0   'False
         SpreadDesigner  =   "frmMain.frx":BB18
      End
   ...
   Begin VB.Frame frame1 
      ...
      Begin FPSpread.vaSpread spdOrder 
         ...
         SpreadDesigner  =   "frmMain.frx":11410
         UserResize      =   2
         ScrollBarTrack  =   1
         ShowScrollTips  =   3
      End
      ...
      Begin FPSpread.vaSpread spdResult 
         ...
         SpreadDesigner  =   "frmMain.frx":15A35
         TextTip         =   2
      End
   End
   ...
   Begin VB.Frame frame4 
      ...
      Begin VB.Frame frameCom 
         ...
         Begin VB.ComboBox cboPort 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmMain.frx":1A445
            Left            =   2190
            List            =   "frmMain.frx":1A447
            TabIndex        =   62
            Top             =   390
            Width           =   2205
         End
         Begin VB.ComboBox cboBaudrate 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmMain.frx":1A449
            Left            =   2190
            List            =   "frmMain.frx":1A44B
            TabIndex        =   61
            Top             =   780
            Width           =   2205
         End
         Begin VB.ComboBox cboDatabit 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmMain.frx":1A44D
            Left            =   2190
            List            =   "frmMain.frx":1A44F
            TabIndex        =   60
            Top             =   1170
            Width           =   2205
         End
         ...
         Begin VB.ComboBox cboParity 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmMain.frx":1A451
            Left            =   2190
            List            =   "frmMain.frx":1A453
            TabIndex        =   57
            Top             =   2520
            Width           =   2205
         End
   ...
   Begin VB.Frame frame3 
      ...
      Begin VB.Frame frameTestSet 
         ...
         Begin VB.Frame frameOrder 
            ...
            Begin FPSpread.vaSpread spdOrdMst 
               ...
               SelectBlockOptions=   0
               ShadowColor     =   13697023
               SpreadDesigner  =   "frmMain.frx":1BBD1
               TextTip         =   2
            End
         End
         Begin VB.ComboBox cboResultType 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmMain.frx":1C17B
            Left            =   1650
            List            =   "frmMain.frx":1C17D
            TabIndex        =   42
            Top             =   4470
            Width           =   1575
         End
         ...
         Begin VB.Frame frameCutOff 
            ...
            Begin VB.ComboBox cboCOH 
               ...
               EndProperty
               Height          =   315
               ItemData        =   "frmMain.frx":1C17F
               Left            =   2730
               List            =   "frmMain.frx":1C181
               TabIndex        =   38
               Top             =   1020
               Width           =   735
            End
            ...
            Begin VB.ComboBox cboCOL 
               ...
               EndProperty
               Height          =   315
               ItemData        =   "frmMain.frx":1C183
               Left            =   2730
               List            =   "frmMain.frx":1C185
               TabIndex        =   29
               Top             =   300
               Width           =   735
            End
      ...
      Begin FPSpread.vaSpread spdTest 
         ...
         RetainSelBlock  =   0   'False
         SelectBlockOptions=   0
         SpreadDesigner  =   "frmMain.frx":233B6
      End
   End
   Begin VB.Frame frame2 
      ...
      Begin FPSpread.vaSpread spdROrder 
         ...
         SelectBlockOptions=   0
         ShadowColor     =   14548991
         SpreadDesigner  =   "frmMain.frx":23F1A
         UserResize      =   2
      End
      ...
      Begin FPSpread.vaSpread spdRResult 
         ...
         SelectBlockOptions=   0
         ShadowColor     =   13697023
         SpreadDesigner  =   "frmMain.frx":2846D
         TextTip         =   2
      End
   ...
   Begin VB.PictureBox Picture2 
      ...
      Begin VB.Frame fraResult 
         ...
         Begin VB.ComboBox cboRstType 
            ...
            EndProperty
            Height          =   300
            ItemData        =   "frmMain.frx":28E9A
            Left            =   420
            List            =   "frmMain.frx":28E9C
            TabIndex        =   128
            Top             =   180
            Width           =   1245
         End
         Begin VB.ComboBox cboState 
            ...
            EndProperty
            Height          =   300
            ItemData        =   "frmMain.frx":28E9E
            Left            =   4710
            List            =   "frmMain.frx":28EA0
            TabIndex        =   127
            Top             =   180
            Width           =   1395
         End
...
'        varTmp1 = Split(varTmp(i), ",")

        
        strBarno = mGetP(varTmp(i), 1, ",")

        If UBound(varTmp) >= i + 1 Then
...
'        If varTmp1(0) = "" And (varTmp1(0) = "NC" Or varTmp1(0) = "PC") Then
'            Exit For
'        End If
        If mGetP(varTmp(i), 3, ",") = "NC" Or mGetP(varTmp(i), 3, ",") = "PC1" Or mGetP(varTmp(i), 3, ",") = "PC2" Or mGetP(varTmp(i), 3, ",") = "PC3" Then
            Exit For
        End If
    Next i
    ...
    Else
        ...
        With spdROrder
            For iRow = 1 To .MaxRows
                If iRow = 1 Then
                    J = 1
                    SetText vasExcel, "병리번호", 0, J:       vasExcel.ColWidth(J) = 15:  J = J + 1
                    SetText vasExcel, "접수일자", 0, J:       vasExcel.ColWidth(J) = 15:  J = J + 1
                    SetText vasExcel, "등록번호", 0, J:       vasExcel.ColWidth(J) = 10:  J = J + 1
                    SetText vasExcel, "환자명", 0, J:       vasExcel.ColWidth(J) = 10:  J = J + 1
                    SetText vasExcel, "성별/나이", 0, J:       vasExcel.ColWidth(J) = 10:  J = J + 1
                    SetText vasExcel, "처방의", 0, J:       vasExcel.ColWidth(J) = 10:  J = J + 1
                    SetText vasExcel, "HPV 결과", 0, J:       vasExcel.ColWidth(J) = 20:  J = J + 1
                    SetText vasExcel, "적절성", 0, J:       vasExcel.ColWidth(J) = 10:  J = J + 1
                    SetText vasExcel, "세포번호", 0, J:       vasExcel.ColWidth(J) = 10:  J = J + 1
                    SetText vasExcel, "세포결과", 0, J:       vasExcel.ColWidth(J) = 10:  J = J + 1
                ...
                If .Value = "1" Then
                    ...
                    SetText vasExcel, Trim(GetText(spdROrder, iRow, colCHARTNO)), iRow, J: J = J + 1
                    SetText vasExcel, Format(Trim(GetText(spdROrder, iRow, colHOSPDATE)), "####-##-##") & " ", iRow, J: J = J + 1
                    SetText vasExcel, Trim(GetText(spdROrder, iRow, colPID)), iRow, J: J = J + 1
                    SetText vasExcel, Trim(GetText(spdROrder, iRow, colPNAME)), iRow, J: J = J + 1
                    SetText vasExcel, Trim(GetText(spdROrder, iRow, colPSEX)) & "/" & Trim(GetText(spdROrder, iRow, colPAGE)), iRow, J: J = J + 1
                    
                    'SetText vasExcel, "", iRow, J: J = J + 1
                    '처방의 추가
                    SetText vasExcel, Trim(GetText(spdROrder, iRow, colKEY1)), iRow, J: J = J + 1
                    
                    strResult = Trim(GetText(spdROrder, iRow, colITEMS))
                    varResult = Split(strResult, Chr(10))
                    If InStr(strResult, "(") > 0 Then
                        strResult = ""
                        For i = 0 To UBound(varResult)
                            If InStr(varResult(i), "(") > 0 Then
                                If strResult <> "" Then
                                    strResult = strResult & "," & Mid(varResult(i), InStr(varResult(i), "(") + 1)
                                Else
                                    strResult = strResult & Mid(varResult(i), InStr(varResult(i), "(") + 1)
                                End If
                            ...
                            End If
                        Next
                        SetText vasExcel, strResult, iRow, J: J = J + 1
                    Else
                        SetText vasExcel, "-", iRow, J: J = J + 1
                    End If
                    If Trim(GetText(spdROrder, iRow, colOCNT)) = "++" Or Trim(GetText(spdROrder, iRow, colOCNT)) = "+++" Then
                        SetText vasExcel, "IC++이상", iRow, J: J = J + 1
                    Else
                        SetText vasExcel, "", iRow, J: J = J + 1
                    End If
                    SetText vasExcel, " ", iRow, J: J = J + 1
...
'                If iRow = 1 Then
'                    j = 1
'                    SetText vasExcel, "접수 번호", 0, j:       vasExcel.ColWidth(j) = 5:  j = j + 1
'                    SetText vasExcel, Trim(GetText(spdROrder, 0, colCHARTNO)), 0, j:     vasExcel.ColWidth(j) = 7:  j = j + 1
'                    SetText vasExcel, Trim(GetText(spdROrder, 0, colPNAME)), 0, j:       vasExcel.ColWidth(j) = 5:  j = j + 1
'                    SetText vasExcel, Trim(GetText(spdROrder, 0, colPSEX)), 0, j:        vasExcel.ColWidth(j) = 3:   j = j + 1
'                    SetText vasExcel, Trim(GetText(spdROrder, 0, colPAGE)), 0, j:        vasExcel.ColWidth(j) = 3:   j = j + 1
'                    SetText vasExcel, Trim(GetText(spdROrder, 0, colPART)), 0, j:        vasExcel.ColWidth(j) = 6:  j = j + 1
'                    SetText vasExcel, Trim(GetText(spdROrder, 0, colTESTDATE)), 0, j:    vasExcel.ColWidth(j) = 4:  j = j + 1
'                    SetText vasExcel, Trim(GetText(spdROrder, 0, colSPCPART)), 0, j:     vasExcel.ColWidth(j) = 8:  j = j + 1
'                    SetText vasExcel, Trim(GetText(spdROrder, 0, colRELTEST)), 0, j:     vasExcel.ColWidth(j) = 15:  j = j + 1
'                    SetText vasExcel, Trim(GetText(spdROrder, 0, colSPCNUM)), 0, j:      vasExcel.ColWidth(j) = 7:  j = j + 1
'                    SetText vasExcel, Trim(GetText(spdROrder, 0, colHPVIC)), 0, j:       vasExcel.ColWidth(j) = 4:  j = j + 1
'                    SetText vasExcel, Trim(GetText(spdROrder, 0, colPRERESULT)), 0, j:   vasExcel.ColWidth(j) = 10:  j = j + 1
'                    SetText vasExcel, Trim(GetText(spdROrder, 0, colMETHOD)), 0, j:      vasExcel.ColWidth(j) = 7:  j = j + 1
'                    SetText vasExcel, Trim(GetText(spdROrder, 0, colREMARK)), 0, j:      vasExcel.ColWidth(j) = 7:  j = j + 1
'                    SetText vasExcel, "HPV", 0, j:       vasExcel.ColWidth(j) = 32:  j = j + 1
'
'                    vasExcel.MaxCols = j - 1
'                End If
'
...
'                If .Value = "1" Then
'                    vasExcel.MaxRows = vasExcel.MaxRows + 1
'                    SetText vasExcel, Trim(GetText(spdROrder, iRow, colJUBNO)), iRow, j: j = j + 1
'                    SetText vasExcel, Trim(GetText(spdROrder, iRow, colCHARTNO)), iRow, j: j = j + 1
'                    SetText vasExcel, Trim(GetText(spdROrder, iRow, colPNAME)), iRow, j: j = j + 1
'                    SetText vasExcel, Trim(GetText(spdROrder, iRow, colPSEX)), iRow, j: j = j + 1
'                    SetText vasExcel, Trim(GetText(spdROrder, iRow, colPAGE)), iRow, j: j = j + 1
'                    SetText vasExcel, Trim(GetText(spdROrder, iRow, colPART)), iRow, j: j = j + 1
'                    SetText vasExcel, Trim(GetText(spdROrder, iRow, colTESTDATE)), iRow, j: j = j + 1
'                    SetText vasExcel, Trim(GetText(spdROrder, iRow, colSPCPART)), iRow, j: j = j + 1
'                    SetText vasExcel, Trim(GetText(spdROrder, iRow, colRELTEST)), iRow, j: j = j + 1
'                    SetText vasExcel, Trim(GetText(spdROrder, iRow, colSPCNUM)), iRow, j: j = j + 1
'                    SetText vasExcel, Trim(GetText(spdROrder, iRow, colHPVIC)), iRow, j: j = j + 1
'                    SetText vasExcel, Trim(GetText(spdROrder, iRow, colPRERESULT)), iRow, j: j = j + 1
'                    SetText vasExcel, Trim(GetText(spdROrder, iRow, colMETHOD)), iRow, j: j = j + 1
'                    SetText vasExcel, Trim(GetText(spdROrder, iRow, colREMARK)), iRow, j: j = j + 1
'                    If Trim(GetText(spdROrder, iRow, colITEMS)) <> "" Then
'                        SetText vasExcel, Trim(GetText(spdROrder, iRow, colITEMS)), iRow, j: j = j + 1
'                    ElseIf Trim(GetText(spdROrder, iRow, colITEMS + 1)) <> "" Then
'                        SetText vasExcel, Trim(GetText(spdROrder, iRow, colITEMS + 1)), iRow, j: j = j + 1
'                    ElseIf Trim(GetText(spdROrder, iRow, colITEMS + 2)) <> "" Then
'                        SetText vasExcel, Trim(GetText(spdROrder, iRow, colITEMS + 2)), iRow, j: j = j + 1
'                    End If
'                End If
'            Next iRow
'
'            vasExcel.RowHeight(-1) = 40
'
'        End With
'
'        If vasExcel.DataRowCnt < 1 Then
...
'            Exit Sub
'        Else
'            vasExcel.PrintOrientation = PrintOrientationLandscape '가로출력
'            vasExcel.Action = 13
'        End If
'
'        CFXFile.Filter = "Excel Files (*.xls)|*.xls|All Files (*.*)|*.*"
