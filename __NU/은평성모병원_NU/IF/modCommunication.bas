...
Public Sub SetPatInfo_F200_HL7(ByVal pBarno As String, ByVal pType As String)
...
Function SaveTransData_NU(ByVal argSpcRow As Integer) As Integer
    Dim RS_L            As ADODB.Recordset
    Dim intRow          As Integer
    Dim strDate         As String
    Dim strTime         As String
...
'            sParam = sParam & "userid=" & NUAPI.UID & "&"                               '사용자ID
            ...
            '양지
'            http://emr.yjh.com/.live?
'            submit_id = TXLII00101&
'            business_id = li&
'            ex_interface=L1032|204&
'            bcno = E46KY00E0&
'            result=LCAM100017.3320190218LCAM100024920190218LCAM100035420190218LCA104%2D0.920190218LCA10325.820190218LCA10917.020190218LCA1068520190218LCA1101.1220190218LCA1261.920190218LCA107%2D0.120190218LCA13123.820190218LCA10837.020190218LCAM10127.320190218LCAM10213320190218LCAM1033.620190218LCAM1045020190218LCAM10516220190218&
'            INSTCD = 204&
'            eqmtcd = C03&
'            USERID = L1032&
...
'            SaveTransData = SaveTransData_NEOSOFT(argSpcRow)
        ...
        Case "NU"
            SaveTransData = SaveTransData_NU(argSpcRow)
