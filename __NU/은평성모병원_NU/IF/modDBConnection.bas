...
'-- Capillary : Postgres DB Connect
'Public Function DbConnect_Cap() As Boolean
'    Dim DBIP            As String
'    Dim DBNM            As String
'    Dim UserName        As String
'    Dim Password        As String
...
'On Error GoTo ConnectError
'
'    DBIP = GetCapConfig("CAPIP")
'    DBNM = GetCapConfig("DATABASE")
'    UserName = GetCapConfig("USERNAME")    ' postgres
'    Password = GetCapConfig("PASSWORD")    ' 46448630Sebia!
'
'
''DB: 'Provider=MSDASQL.1;Password=46448630Sebia!;Persist Security Info=True;User ID=postgres;Data Source='+TGlobal.FCapIp+';Initial Catalog=Total';
'
'
'    If (DBIP = "") Or (DBNM = "") Then
'        Set_DbConnect_Cap = False
'        Set AdoCn = Nothing
'        Exit Function
'    End If
'
...
'
'
''-- Capillary : Access DB Connect
'Public Function DbConnect_Daily() As Boolean
'    Dim DBNM            As String
'    Dim UserName        As String
'    Dim Password        As String
'    Dim blnWinNTAuth    As Boolean
...
'    Dim strDestFile     As String
'
'    Set AdoCn_D = New ADODB.Connection
'
'On Error GoTo ConnectError
'
'    DBNM = App.PATH & "\daily.mdb"
'    UserName = ""
'    Password = ""
'
'    If (DBNM = "") Then
'        Set_DbConnect_Daily = False
'        Set AdoCn = Nothing
'        Exit Function
'    End If
'
...
'        .Properties("Mode").Value = adModeReadWrite
'        .Properties("Persist Security Info").Value = False
'        .Properties("Data Source").Value = DBNM
'        '.Properties("User ID").Value = UserName
'        '.Properties("Jet OLEDB:Database Password").Value = Password
'        .Properties("Jet OLEDB:Compact Without Replica Repair").Value = True
'        .Open
