...
'        End If
        ...
        If strAllResult <> "" Then
            If gHOSP.BARUSE = "Y" Then
                ...
                If InStr(gHOSP.APIURL, "http://his") > 0 Then
                    sParam = sParam & "business_id=lis&"    '1.0
                Else
                    sParam = sParam & "business_id=lis&"     '2.0
                End If
            ...
            Else
                sParam = ""
                sParam = sParam & "submit_id=TXLII00109&"
                If InStr(gHOSP.APIURL, "http://his") > 0 Then
                    sParam = sParam & "business_id=lis&"    '1.0
                Else
                    sParam = sParam & "business_id=lis&"     '2.0
                ...
                sParam = sParam & "ex_interface=" & frmMain.txtTestID.Text & "|" & gHOSP.HOSPCD & "&"       '사용자ID|기관코드
                sParam = sParam & "bcno=" & strBarcode & "&"                                      '검체번호(바코드)
                sParam = sParam & "deptcd=" & gHOSP.PARTCD & "&"
                sParam = sParam & "drid=" & Trim(mGetP(frmMain.cboDoct, 2, "|")) & "&"
                sParam = sParam & "testdt=" & strDate & "&"
                sParam = sParam & "result=" & strAllResult & "&"                                '결과
                sParam = sParam & "instcd=" & gHOSP.HOSPCD & "&"                                '기관코드
                sParam = sParam & "eqmtcd=" & gHOSP.MACHCD & "&"                                '장비코드
                'sParam = sParam & "userid=" & gHOSP.USERID & "&"                                '사용자ID
...
'submit_id=TXLII00109&
'business_id=lis&
'ex_interface=20800727|012&
'bcno=15397360&
'deptcd=3060100000&
'drid=97015067&
'testdt=20161115165752&
'result=LOS186174817172016111503
'   LOS1821714317172016111503
'   LOS183174.417172016111503LOS179171.1917172016111503LOS161177.43817172016111503LOS1621741.917172016111503LOS1631774.717172016111503LOS1801724717172016111503LOS137171.4717172016111503LOS1701716.317172016111503LOS1641728.317172016111503LOS165173.617172016111503LOS1671795.317172016111503&
'instcd=012&
'eqmtcd=C22&
'userid=20800727&

'2.0
'http://emr012edu.cmcnu.or.kr/cmcnu/.live?
'submit_id=TXLII00109&
'business_id=li&
'ex_interface=20800727|012&
'bcno=3686825&
...
'drid=97015067&
'testdt=20161115165752&
'result=LOS186174817172016111503LOS1821714317172016111503LOS183174.417172016111503LOS179171.1917172016111503LOS161177.43817172016111503LOS1621741.917172016111503LOS1631774.717172016111503LOS1801724717172016111503LOS137171.4717172016111503LOS1701716.317172016111503LOS1641728.317172016111503LOS165173.617172016111503LOS1671795.317172016111503&
'instcd=012&
'eqmtcd=C22&
'userid=20800727&
...
'http://his202.sejongh.co.kr/himed/webapps/com/commonweb/xrw/.live?
'submit_id=TXLII00101&
'business_id=lis&
'ex_interface=20170481|202&
'bcno=I205H06I0&
'result=LCA1007.51520171130
'       LCA10133.720171130
'       LCA10274.120171130
'       LCA10328.220171130
'       LCA1044.320171130
'       LCA10695.820171130LCA10910.320171130LCA1104.7320171130LCA12114920171130LCA1223.720171130LCA12415020171130LCA1120.720171130LCA12731.620171130LCA1261.720171130LCA1054.320171130LCA12810.320171130LCA12994.420171130LCA1300.820171130LCA1320.720171130LOS20233.720171130LOS20374.120171130LOS20428.220171130
'       LOS2054.320171130LOS20695.820171130LOS20710.320171130LOS2084.7320171130LOS20914920171130LOS2103.720171130LOS21115020171130LOS1371.720171130LOS25131.620171130LOS2124.320171130LOS21311220171130LOS21410.320171130LOS21594.420171130LOS2160.820171130LOS2170.720171130
'       LOS2017.51520171130&
'instcd=202&
'eqmtcd=C28&
'userid=20170618
    ...
    '004 = EDTA blood
                ...
                'testdt=20161115165752&
                'result=
                'LOS186174817172016111503
                'LOS1821714317172016111503
                'LOS183174.417172016111503
                'LOS179171.1917172016111503
                'LOS161177.43817172016111503
                'LOS1621741.917172016111503LOS1631774.717172016111503LOS1801724717172016111503LOS137171.4717172016111503LOS1701716.317172016111503LOS1641728.317172016111503LOS165173.617172016111503LOS1671795.317172016111503&
                'instcd=012&
                'eqmtcd=C22&
                'userid=20800727&
...
'sRcvData = sRcvData & "<root><spcworklist><worklist>"
'sRcvData = sRcvData & "<spcacptdt><![CDATA[20200129090835]]></spcacptdt>"
'sRcvData = sRcvData & "<acptflag><![CDATA[외래]]></acptflag>"
'sRcvData = sRcvData & "<bcno><![CDATA[O20T205T0]]></bcno>"
'sRcvData = sRcvData & "<pid><![CDATA[205003428]]></pid>"
'sRcvData = sRcvData & "<patnm><![CDATA[오현석]]></patnm>"
'sRcvData = sRcvData & "<sexage><![CDATA[M/19]]></sexage>"
'sRcvData = sRcvData & "<erprcpflag><![CDATA[N]]></erprcpflag>"
'sRcvData = sRcvData & "<workno><![CDATA[20200129P100001]]></workno>"
'sRcvData = sRcvData & "<tsectnm><![CDATA[분자진단]]></tsectnm>"
'sRcvData = sRcvData & "<ifreqcdlist><![CDATA[▦]]></ifreqcdlist>"
'sRcvData = sRcvData & "<tclscdlist><![CDATA[LPD340▦]]></tclscdlist><urinextrvol><![CDATA[ ]]></urinextrvol><retestyn><![CDATA[N▦]]></retestyn><rsltstat><![CDATA[LPD340-▦]]></rsltstat>"
'sRcvData = sRcvData & "</worklist>"
'sRcvData = sRcvData & "<resultKM error=""no"" type=""status"" clear=""true"" description=""info||정상적으로 처리되었습니다."" updateinstance=""true"" source=""1580257578828""/>"
