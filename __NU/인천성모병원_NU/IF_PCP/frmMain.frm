...
Begin VB.Form frmMain 
   ...
   Begin FPSpread.vaSpread spdResult 
      ...
      SpreadDesigner  =   "frmMain.frx":023D
      ScrollBarTrack  =   3
      ShowScrollTips  =   3
   End
      ...
      Begin MSComctlLib.ImageList imlStatus 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMain.frx":1432
               Key             =   "NOT"
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMain.frx":19CC
               Key             =   "STOP"
            EndProperty
   ...
   Begin FPSpread.vaSpread spdOrder 
      ...
      ShadowColor     =   16777215
      SpreadDesigner  =   "frmMain.frx":63CA
      ScrollBarTrack  =   3
      ShowScrollTips  =   3
   End
    ...
    With frmMain
        For intRow = 2 To spdExcel.MaxRows
            ...
            'If IsNumeric(strBarno) Then
                ...
                If strIntBase = "PCP" Then
                    If Trim(strResult) = "" Then
                        strResult = "Negative"
                    Else
                        If IsNumeric(strResult) Then
                            If 35 > CCur(strResult) Then
                                strResult = "Positive"
                            Else
                                strResult = "Invalid"
                            End If
