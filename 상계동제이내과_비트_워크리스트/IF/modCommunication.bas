...
Public Sub SetPatInfo(ByVal pBarno As String, ByVal pType As String)
    ...
    With frmMain
        ...
        If mResult.BarNo = "검사에러" Then
            Call SetText(.spdOrder, "검사에러", intRow, colPNAME)
        End If
    ...
    With frmMain
        ...
        For intRow = 1 To .vasTemp.DataRowCnt
            ...
            If strBarcode <> "" And strTestCd <> "" And sResult <> "" And strSubCodes <> "" Then
                ...
                'SQL = SQL & "   And ResOdrSeq = '" & mResult.RESODRSEQ & "'" & vbCr
                'SQL = SQL & "   And ResSeq    = '" & mResult.RESSEQ & "'" & vbCr
                'SQL = SQL & "   And ResSubSeq = '" & mResult.RESSUBSEQ & "'" & vbCr
...
'        SQL = SQL & "   And OspOcmNum = '" & Space(10 - Len(strPatID)) & strPatID & "'" & vbCrLf            '10
'        SQL = SQL & "   And OspOdrSeq = '" & mGetP(strSubCodes, 1, "|") & "'" & vbCrLf
'        SQL = SQL & "   And OspSeq    = '" & mGetP(strSubCodes, 2, "|") & "'" & vbCrLf
'        SQL = SQL & "   And OspChtNum = '" & Space(14 - Len(strChartNo)) & strChartNo & "'"                 '14
'
'
'        Call SetSQLData("상태변경", SQL, "A")
'        AdoCn.Execute SQL
