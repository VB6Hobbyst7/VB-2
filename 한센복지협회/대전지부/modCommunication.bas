...
Public Sub SetPatInfo_BS380_HL7(ByVal pBarno As String, ByVal pType As String)
...
Function SaveTransData_HANSEN(ByVal argSpcRow As Integer) As Integer
    Dim RS_L            As ADODB.Recordset
    Dim intRow          As Integer
    Dim strDate         As String
    Dim strTime         As String
...
Function SaveTransData(ByVal argSpcRow As Integer) As Integer
    ...
    Select Case gEMR
        ...
        Case "HANSEN"
            SaveTransData = SaveTransData_HANSEN(argSpcRow)
