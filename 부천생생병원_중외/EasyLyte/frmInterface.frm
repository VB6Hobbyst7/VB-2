...
'________________________
'SAMPLE 5
'Na 140.6 K  4.40 Cl 102.6
'BLOOD  Na,K,Cl mmol/L
'SEP-30-16; 13:49

    
    strRecvData = Split(strBuffer, vbCr)
'2 = Na 140.6 K  4.40 Cl 102.6
'1 = SAMPLE 5

'    If InStr(strRecvData(0), "SAMPLE") <= 0 Then
'        Exit Sub
'    End If
    ...
    For i = 1 To 3
        If i = 1 Then
            strIntBase = Trim(Mid(strRecvData(2), 1, 2))
            strResult = Trim(Mid(strRecvData(2), 3, 6))
        ElseIf i = 2 Then
            strIntBase = Trim(Mid(strRecvData(2), 9, 2))
            strResult = Trim(Mid(strRecvData(2), 11, 6))
        ElseIf i = 3 Then
            strIntBase = Trim(Mid(strRecvData(2), 18, 2))
            strResult = Trim(Mid(strRecvData(2), 20, 6))
        End If
