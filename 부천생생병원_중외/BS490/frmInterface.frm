...
Begin VB.Form frmInterface 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin FPSpread.vaSpread vasRes 
         ...
         RetainSelBlock  =   0   'False
         ScrollBars      =   2
         SpreadDesigner  =   "frmInterface.frx":1FA3
      End
   End
   ...
   Begin VB.Frame FrmHideControl 
      ...
      Begin VB.ComboBox cboChk 
         ...
         EndProperty
         Height          =   315
         ItemData        =   "frmInterface.frx":35FB
         Left            =   4320
         List            =   "frmInterface.frx":3608
         TabIndex        =   74
         Top             =   3390
         Width           =   975
      End
      ...
      Begin VB.ComboBox cboTest 
         ...
         ForeColor       =   &H00FF0000&
         Height          =   300
         ItemData        =   "frmInterface.frx":361E
         Left            =   7170
         List            =   "frmInterface.frx":3620
         Style           =   2  '드롭다운 목록
         TabIndex        =   71
         Top             =   3090
         Visible         =   0   'False
      ...
      Begin VB.Frame Frame4 
         ...
         Begin FPSpread.vaSpread vasPrint 
            ...
            EndProperty
            MaxCols         =   9
            SpreadDesigner  =   "frmInterface.frx":3622
         End
         Begin FPSpread.vaSpread vasPrintBuf 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            SpreadDesigner  =   "frmInterface.frx":3A88
         End
      End
      ...
      Begin FPSpread.vaSpread vasCode 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":3CAA
      End
      Begin FPSpread.vaSpread vasTemp1 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":3ECC
      End
         ...
         Begin MSComctlLib.ImageList imlStatus 
            ...
            BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
               ...
               BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":4678
                  Key             =   "RUN"
               EndProperty
               BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":4C12
                  Key             =   "NOT"
               EndProperty
               BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":51AC
                  Key             =   "STOP"
               EndProperty
               BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":5746
                  Key             =   "LST"
               EndProperty
               BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":5FD8
                  Key             =   "ITM"
               EndProperty
               BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":6132
                  Key             =   "ERR"
               EndProperty
               BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":628C
                  Key             =   "NOF"
               EndProperty
            EndProperty
         End
      ...
      Begin FPSpread.vaSpread vasList 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":63E6
      End
      Begin FPSpread.vaSpread vasResTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":6608
      End
      Begin FPSpread.vaSpread vasTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":682A
      End
      Begin FPSpread.vaSpread vasExcel 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":6A4C
      End
...
'    SQL = SQL & "  a.RECEIPTDATE AS 접수일자"
'    SQL = SQL & ", a.SPECIMENNUM AS 바코드번호"
'    SQL = SQL & ", a.RECEIPTNO AS 챠트번호"
'    SQL = SQL & ", a.IPDOPD AS IPDOPD "
'    SQL = SQL & ", a.PTNO AS 내원번호"
'    SQL = SQL & ", a.SNAME AS 이름"
'    SQL = SQL & ", a.ORDERCODE"
''    SQL = SQL & ", COUNT(a.LABCODE) AS CNT " & vbCr
'    SQL = SQL & "   FROM SLA_LabMaster a, SLA_LabResult b" & vbCr
'    SQL = SQL & " WHERE a.RECEIPTDATE between '" & Format(pFrDt, "####-##-##") & "' and '" & Format(pToDt, "####-##-##") & "'" & vbCr
'   ' SQL = SQL & "   AND a.ORDERCODE IN (" & gAllOrdCd & ") " & vbCr
'    SQL = SQL & "   AND b.LABCODE IN (" & gAllExam & ") " & vbCr
...
'''
'''                    If strER = "1" Then
'''                        SetText vasID, "1", .MaxRows, colER
'''                    Else
'''                        SetText vasID, "0", .MaxRows, colER
'''                    End If
...
'                        dtpToday.Value = Format(strDate, "####-##-##")
                        ...
                        'SetRawData "[Tx >>]" & intBufCnt & "," & strRecvData(intBufCnt)
...
'''
    ...
    Select Case intSndPhase
        ...
        Case 3          'S : 응급
                ...
                If mOrder.STAT = "1" Then
                    strOutput = intFrameNo & "O|1|1^^|" & mOrder.BarNo & "|" & mOrder.Order & "|S|" & strDate & "|" & strDate & "|||||||" & "|||" & "||" & "||||||" & "|||||" & vbCr & ETB
                Else
...
'       - pBarNo : 바코드번호
'-----------------------------------------------------------------------------'
Private Function GetOrder_WorkList(ByVal pBarNo As String) As Boolean
    ...
    GetOrder_WorkList = False
    
    intRow = -1
    
    For i = 1 To frmWorkList.vasID.DataRowCnt
        If IsNumeric(pBarNo) Then
            If Val(Trim(GetText(frmWorkList.vasID, i, colWBARCODE))) = Val(pBarNo) Then
                intRow = i
                Exit For
            End If
        Else
            If Trim(GetText(frmWorkList.vasID, i, colWBARCODE)) = pBarNo Then
                intRow = i
                Exit For
            End If
        End If
    ...
    If intRow < 0 Then
'        intRow = frmWorkList.vasID.DataRowCnt + 1
'        If frmWorkList.vasID.MaxRows < intRow Then
'            frmWorkList.vasID.MaxRows = intRow
'        End If
        Exit Function
    End If
    
    '-- 장비수신정보 표시
    'Call SetText(frmWorkList.vasID, pBarNo, intRow, colBARCODE)             '-- 바코드
    
    '-- 환자정보 표시
    'Call vasActiveCell(frmWorkList.vasID, intRow, colBARCODE)
    
    '-- 결과스프레드 지우기
    'Call ClearSpread(vasRes)
    
    '-- 검사자 정보 가져오기
    If GetSampleInfoWorkList_JWINFO(intRow) = -1 Then
        GetOrder_WorkList = False
        Exit Function
    Else
        GetOrder_WorkList = True
    End If
    
    With mOrder
        .BarNo = pBarNo
        .PID = GetText(frmWorkList.vasID, intRow, colWPID)
        .STAT = GetText(frmWorkList.vasID, intRow, colWER)
    End With
    ...
    strItems = GetEquipExamCodeWorkList_BS490(gEquip, pBarNo, intRow)
    ...
    '-- 진행상태(Order) 표시
    Call SetText(frmWorkList.vasID, "Order", intRow, colWState)
...
Function GetEquipExamCode_BS490(argEquipCode As String, argPID As String, Optional intRow As Long) As String
    ...
    For i = 1 To vasTemp.DataRowCnt
        ...
        If strName = "GA %" Then
            'GA
            strExamCode = strExamCode & "\" & "22" & "^" & "GA" & "^^"
            'ALB-BCP
            strExamCode = strExamCode & "\" & "23" & "^" & "ALB-BCP" & "^^"
        Else
...
'-- 로컬테이블에서 검사항목에 해당하는 검사채널 찾아오기
Function GetEquipExamCodeWorkList_BS490(argEquipCode As String, argPID As String, Optional intRow As Long) As String
    Dim i As Integer
    Dim strExamCode As String
    Dim sBarcode     As String
    Dim strCBC As String
    ...
    GetEquipExamCodeWorkList_BS490 = ""
    intOrdCnt = 1
    ...
    sBarcode = Trim(GetText(frmWorkList.vasID, intRow, colWBARCODE))   '2 샘플 바코드 번호
    ...
    GetEquipExamCodeWorkList_BS490 = strExamCode
...
'E5
    ...
    For intCnt = 1 To UBound(strRecvData)
        ...
        Select Case strType
            ...
            Case "Q"
                'Q|3|^00000381||||||||||O
                If Trim(mGetP(strRcvBuf, 13, "|")) = "A" Then Exit Sub
                ...
                '먼저 워크리스트 화면에서 찾는다.
                If GetOrder_WorkList(strBarNo) = False Then
                    '못찾으면 메인화면에서 처리한다.
            ...
            Case "O"
                ...
                'O|36|5^1^6|00000434|1^GOT^^\2^GPT^^\3^ALP^^\4^TP^^\5^ALB^^\6^BUN^^\7^CREA^^\8^TBIL^^\9^TC^^\10^TG^^\12^GLU^^\14^HDL^^\15^CRP^^\17^GGT^^|R|20161004160242|20161004160242|||||||20161004160236|Other||||||||||F|||||
                'O|29|3^1^3|00000414|1^GOT^^\2^GPT^^\3^ALP^^\8^TBIL^^\17^GGT^^|R|20161001114945|20161001114945|||||||20161001114944|Other||||||||||F|||||
                'O|1|1^1^1|00054527|1^GOT^^\2^GPT^^\15^CRP^^|R|20171229092411|20171229092411|||||||20171229092811|Other||||||||||F|||||
                strBarNo = Trim$(mGetP(strRcvBuf, 4, "|"))
                
                If Trim$(mGetP(strRcvBuf, 2, "|")) = "1" Then
                    blnFirst = True
                    strGA = ""
                    strALBBCP = ""
                Else
            ...
            Case "R"
                'R|1|1^GOT^^F|30.528359^^^^|U/L|^|N||F|30.528359^^^^|0|20171229094015||Mindry^
                'R|2|2^GPT^^F|64.791932^^^^|U/L|^|N||F|64.791932^^^^|0|20171229094024||Mindry^
                'R|3|15^CRP^^F|0.144692^^^^|mg/dL|^|N||F|0.144692^^^^|0|20171229094128||Mindry^
                
                strIntBase = Trim(mGetP(mGetP(strRcvBuf, 3, "|"), 2, "^"))
                strResult = Trim$(mGetP(mGetP(strRcvBuf, 4, "|"), 1, "^"))
                
'                If strIntBase = "GA" Then
'                    strGA = strResult
'                End If
'                If strIntBase = "ALB-BCP" Then
'                    strALBBCP = strResult
'                End If
Rst:
                If strResult <> "" Then
            ...
            Case "L"
                'GA% : GA + ALB-BCP = GA%
'                If strGA <> "" And strALBBCP <> "" And IsNumeric(strGA) And IsNumeric(strALBBCP) Then
'                    strIntBase = "GA%"
'                    strResult = strGA + strALBBCP
'                    strGA = ""
'                    strALBBCP = ""
'                    GoTo Rst
'                End If
