...
Public Const colWSpecNo = 0     '미사용
Public Const colWCheckBox = 1
Public Const colWSAVESEQ = 2    '저장순번(날짜별)
Public Const colWEXAMDATE = 3   '검사일자
Public Const colWER = 4         '응급구분
Public Const colWHOSPDATE = 5   '병원접수일자
Public Const colWBARCODE = 6
Public Const colWCHARTNO = 7
Public Const colWPID = 8        '병록번호(내원번호)
Public Const colWINOUT = 9      '입원/외래
Public Const colWDISKNO = 10
Public Const colWPOSNO = 11
Public Const colWPNAME = 12
Public Const colWPSEX = 13
Public Const colWPAGE = 14
Public Const colWOCNT = 15
Public Const colWRCNT = 16
Public Const colWState = 17
