...
Begin VB.Form frmCounsel_1_1 
   ...
   Begin ChartfxLibCtl.ChartFX Chart 
      ...
      RGB2DBk         =   16777215
      nColors         =   16
      Colors          =   "frmCounsel_1_1.frx":000C
      nSer            =   1
      NumSer          =   1
      _Data_          =   "frmCounsel_1_1.frx":00AC
   End
   Begin FPSpread.vaSpread sprTreat 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      SpreadDesigner  =   "frmCounsel_1_1.frx":01B9
   End
   Begin FPSpread.vaSpread sprPrint 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      SpreadDesigner  =   "frmCounsel_1_1.frx":0341
   End
   Begin VB.Image imgPreTreat 
      Height          =   330
      Left            =   9765
      Picture         =   "frmCounsel_1_1.frx":04C9
      Top             =   1815
      Width           =   1185
   End
   Begin VB.Image imgModifyTreat 
      Height          =   330
      Left            =   11010
      Picture         =   "frmCounsel_1_1.frx":0BCB
      Top             =   1815
      Width           =   1185
   End
   Begin VB.Image imgNew 
      Height          =   795
      Left            =   11370
      Picture         =   "frmCounsel_1_1.frx":126A
      Top             =   4905
      Width           =   795
   End
   ...
   Begin VB.Image imgValuation 
      Height          =   330
      Left            =   9720
      Picture         =   "frmCounsel_1_1.frx":193B
      Top             =   4830
      Width           =   1185
   End
   ...
   Begin VB.Image imgSelectEx 
      Height          =   330
      Left            =   10800
      Picture         =   "frmCounsel_1_1.frx":2C38
      Top             =   4260
      Width           =   1185
   End
   Begin VB.Image TopImage 
      Height          =   960
      Left            =   -30
      Picture         =   "frmCounsel_1_1.frx":376E
      Top             =   50
      Width           =   13140
   End
   ...
   Begin VB.Image imgTreat 
      Height          =   330
      Left            =   6240
      Picture         =   "frmCounsel_1_1.frx":52F4
      Top             =   7860
      Width           =   1170
   End
   ...
   Begin VB.Image imgExCal 
      ...
      Index           =   3
      Left            =   9180
      Picture         =   "frmCounsel_1_1.frx":5F3A
      Top             =   3795
      Width           =   645
   End
   Begin VB.Image imgExCal 
      ...
      Index           =   2
      Left            =   9180
      Picture         =   "frmCounsel_1_1.frx":657A
      Top             =   3480
      Width           =   645
   End
   Begin VB.Image imgExCal 
      ...
      Index           =   1
      Left            =   9180
      Picture         =   "frmCounsel_1_1.frx":6B87
      Top             =   3165
      Width           =   645
   End
   Begin VB.Image imgExCal 
      ...
      Index           =   0
      Left            =   9180
      Picture         =   "frmCounsel_1_1.frx":71C4
      Top             =   2850
      Width           =   645
   End
   Begin VB.Image imgExDay 
      ...
      Index           =   3
      Left            =   8730
      Picture         =   "frmCounsel_1_1.frx":77F6
      Top             =   3795
      Width           =   435
   End
   Begin VB.Image imgExDay 
      ...
      Index           =   2
      Left            =   8730
      Picture         =   "frmCounsel_1_1.frx":7CE5
      Top             =   3480
      Width           =   435
   End
   Begin VB.Image imgExDay 
      ...
      Index           =   1
      Left            =   8730
      Picture         =   "frmCounsel_1_1.frx":81D0
      Top             =   3165
      Width           =   435
   End
   Begin VB.Image imgExDay 
      ...
      Index           =   0
      Left            =   8730
      Picture         =   "frmCounsel_1_1.frx":86C7
      Top             =   2850
      Width           =   435
   End
   ...
   Begin VB.Image imgPrint 
      Height          =   780
      Left            =   11370
      Picture         =   "frmCounsel_1_1.frx":8BBB
      Top             =   7350
      Width           =   750
   End
   Begin VB.Image imgDel 
      Height          =   795
      Left            =   11370
      Picture         =   "frmCounsel_1_1.frx":9C46
      Top             =   6525
      Width           =   795
   End
   Begin VB.Image imgSave 
      Height          =   795
      Left            =   11370
      Picture         =   "frmCounsel_1_1.frx":AB99
      Top             =   5715
      Width           =   795
   End
   Begin VB.Image imgTab 
      ...
      Index           =   2
      Left            =   10230
      Picture         =   "frmCounsel_1_1.frx":BA56
      Top             =   5250
      Width           =   885
   End
   Begin VB.Image imgTab 
      ...
      Index           =   1
      Left            =   9360
      Picture         =   "frmCounsel_1_1.frx":C101
      Top             =   5250
      Width           =   885
   End
   Begin VB.Image imgTab 
      ...
      Index           =   0
      Left            =   7800
      Picture         =   "frmCounsel_1_1.frx":C80F
      Top             =   5250
      Width           =   1560
   End
   Begin VB.Image imgGoReserve 
      Height          =   330
      Left            =   11010
      Picture         =   "frmCounsel_1_1.frx":D63A
      Top             =   1440
      Width           =   1185
   End
   ...
   Begin VB.Image imgUpDown 
      ...
      Index           =   7
      Left            =   2790
      Picture         =   "frmCounsel_1_1.frx":E15E
      Top             =   3975
      Width           =   150
   End
   Begin VB.Image imgUpDown 
      ...
      Index           =   6
      Left            =   2790
      Picture         =   "frmCounsel_1_1.frx":E4C3
      Top             =   3675
      Width           =   150
   End
   Begin VB.Image imgUpDown 
      ...
      Index           =   5
      Left            =   2790
      Picture         =   "frmCounsel_1_1.frx":E828
      Top             =   3375
      Width           =   150
   End
   Begin VB.Image imgUpDown 
      ...
      Index           =   4
      Left            =   2790
      Picture         =   "frmCounsel_1_1.frx":EB8D
      Top             =   3060
      Width           =   150
   End
   Begin VB.Image imgUpDown 
      ...
      Index           =   3
      Left            =   2790
      Picture         =   "frmCounsel_1_1.frx":EEF2
      Top             =   2745
      Width           =   150
   End
   Begin VB.Image imgUpDown 
      ...
      Index           =   2
      Left            =   2790
      Picture         =   "frmCounsel_1_1.frx":F257
      Top             =   2445
      Width           =   150
   End
   Begin VB.Image imgUpDown 
      ...
      Index           =   1
      Left            =   2790
      Picture         =   "frmCounsel_1_1.frx":F5BC
      Top             =   2160
      Width           =   150
   End
   Begin VB.Image imgDietCal 
      ...
      Index           =   5
      Left            =   7800
      Picture         =   "frmCounsel_1_1.frx":F921
      Top             =   3795
      Width           =   900
   End
   Begin VB.Image imgDietCal 
      ...
      Index           =   4
      Left            =   7800
      Picture         =   "frmCounsel_1_1.frx":FFF8
      Top             =   3480
      Width           =   900
   End
   Begin VB.Image imgDietCal 
      ...
      Index           =   3
      Left            =   7800
      Picture         =   "frmCounsel_1_1.frx":10679
      Top             =   3165
      Width           =   900
   End
   Begin VB.Image imgDietCal 
      ...
      Index           =   2
      Left            =   12450
      Picture         =   "frmCounsel_1_1.frx":10D45
      Top             =   2850
      Visible         =   0   'False
      Width           =   900
   End
   Begin VB.Image imgDietCal 
      ...
      Index           =   1
      Left            =   7800
      Picture         =   "frmCounsel_1_1.frx":113DB
      Top             =   2850
      Width           =   900
   End
   Begin VB.Image imgUpDown 
      ...
      Index           =   0
      Left            =   2790
      Picture         =   "frmCounsel_1_1.frx":11A6D
      Top             =   1830
      Width           =   150
   End
   Begin VB.Image imgDietCal 
      ...
      Index           =   0
      Left            =   12450
      Picture         =   "frmCounsel_1_1.frx":11DD2
      Top             =   2490
      Visible         =   0   'False
      Width           =   900
   End
   Begin VB.Image imgViewHistory 
      ...
      Index           =   2
      Left            =   3840
      Picture         =   "frmCounsel_1_1.frx":1245A
      Top             =   4410
      Width           =   1575
   End
   Begin VB.Image imgViewHistory 
      ...
      Index           =   1
      Left            =   2250
      Picture         =   "frmCounsel_1_1.frx":12E02
      Top             =   4410
      Width           =   1575
   End
   Begin VB.Image imgViewHistory 
      ...
      Index           =   0
      Left            =   690
      Picture         =   "frmCounsel_1_1.frx":13839
      Top             =   4410
      Width           =   1575
   End
   Begin VB.Label lblObInfo 
   ...
   End
End
Attribute VB_Name = "frmCounsel_1_1"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
'=======================================================================================
' 모 듈 명  : frmCounsel_1_1
...
'트랜잭션 걸어야겠지
    ...
    If intMode = 0 Then '조회하다가 수정버튼을 클릭한경우 mlngcTreatNum에 있는 데이터를 수정한다.
        If mlngcTreatNum = 0 Then
            ...
            Exit Sub
        Else
            If UpdateTreat(mlngcTreatNum) = True Then
...
Private Function ShowTodayTreat2() As Long
    ...
    qrySelect = "SELECT TOP 2 TreatNum, DietCalory, TreatCalory, UserCalory FROM Treat WHERE CustomerNum=" & glngCustomerNum
    qrySelect = qrySelect & " AND TreatDay='" & Format(gdatUserDay, "YYYYMMDD") & "'"
    qrySelect = qrySelect & " ORDER BY TreatNum DESC "
    Set clsSelect = New clsSelect
    rValue = clsSelect.Query(qrySelect)
...
End Sub
'2005-01-27 류진선 수정
Private Sub InitialDietCalory2()
    Dim i As Integer
...
'처방내역조회 탭의 서브버튼들의 클릭이벤트
Private Sub Bottom22(intIndex As Integer)
    Dim i As Integer
    Dim qrySelect As String, rValue As Variant
