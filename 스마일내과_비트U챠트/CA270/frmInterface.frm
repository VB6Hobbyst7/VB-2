...
Begin VB.Form frmInterface 
   ...
   Begin VB.Frame FrmHideControl 
         ...
         Begin MSComctlLib.ImageList imlStatus 
            ...
            BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
               ...
               BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":151C
                  Key             =   "RUN"
               EndProperty
               BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":1AB6
                  Key             =   "NOT"
               EndProperty
               BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":2050
                  Key             =   "STOP"
               EndProperty
               BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":25EA
                  Key             =   "LST"
               EndProperty
               BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":2E7C
                  Key             =   "ITM"
               EndProperty
               BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":2FD6
                  Key             =   "ERR"
               EndProperty
               BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":3130
                  Key             =   "NOF"
               EndProperty
            EndProperty
         End
      ...
      Begin VB.Frame Frame4 
         ...
         Begin FPSpread.vaSpread vasPrint 
            ...
            EndProperty
            MaxCols         =   9
            SpreadDesigner  =   "frmInterface.frx":3814
         End
         Begin FPSpread.vaSpread vasPrintBuf 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            SpreadDesigner  =   "frmInterface.frx":529B
         End
      End
      ...
      Begin FPSpread.vaSpread vasCode 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":54C1
      End
      Begin FPSpread.vaSpread vasTemp1 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":56E7
      End
   ...
   Begin VB.Frame Frame1 
      ...
      Begin FPSpread.vaSpread vasID 
         ...
         SpreadDesigner  =   "frmInterface.frx":7243
      End
      ...
      Begin FPSpread.vaSpread vasRes 
         ...
         RetainSelBlock  =   0   'False
         ScrollBars      =   2
         SpreadDesigner  =   "frmInterface.frx":7E6B
      End
   End
...
'            Select Case gOCS
'            Case "BIT"
'                Res = SaveTransDataW_BIT(lRow)
'            Case "BITU"
               ' Call GetSampleInfoW_BITUCHART(lRow)

                Res = SaveTransDataW_BITUCHART(lRow)
            'End Select
...
Private Sub GetWorkList_BITUCHART(ByVal pFrDt As String, ByVal pToDt As String, Optional pBarNo As String)
    Dim RS          As ADODB.Recordset
    Dim i           As Integer
    Dim iCnt        As Long
    Dim intRow      As Long
                ...
                If blnSame = False Then
                    ...
                    For intCol = colState + 1 To vasID.MaxCols
                        If Trim(RS.Fields("ITEM")) = gArrEquip(intCol - colState, 3) Then
                            ...
                            '-- 결과저장용 SEQ
                            'gArrEquip(intCol - colState, 7) = Trim(RS.Fields("ResOdrSeq")) & "|" & Trim(RS.Fields("ResSeq")) & "|" & Trim(RS.Fields("ResSubSeq"))   '결과저장용 번호's
                            'MsgBox gArrEquip(intCol - colState, 7)
                            Exit For
                        End If
                    Next
                End If
...
Private Sub cmdSearch_Click()
    ...
    Select Case gOCS
        Case "BITU":        Call GetWorkList_BITUCHART(Format(dtpStartDt.Value, "yyyymmdd"), Format(dtpStopDt.Value, "yyyymmdd"))
...
Private Sub GetWorkList_AMIS(ByVal pFrDt As String, ByVal pToDt As String, Optional pBarNo As String)
    ...
    SQL = SQL & "   AND O.ORDERCODE = '" & gOrderCD & "'" & vbCr
    If chkSaveAll.Value = "0" Then
...
Private Sub SendOrder()
    ...
    Select Case intSndPhase
        ...
        Case 3  '## Order
            Call GetOrder(mOrder.BarNo)
        
            If mOrder.NoOrder = True Then
                '## 접수정보가 없을경우
                'strOutput = intFrameNo & "O|1|" & mOrder.Seq & "||" & mOrder.Order & "||||||||||||01" & vbCr & ETX
                strOutput = intFrameNo & "O|1|" & GetText(vasID, intRow, colPAGE) & "||" & GetText(vasID, intRow, colPAGE) & "||||||||||||01" & vbCr & ETX
                intSndPhase = 4
            
            Else
                If mOrder.IsSending = False Then   '## 최초 보낼때
                              '3O|1|  1702060008        ||^^^01^\^^^02^^      ||||||||||||01
                    'strOutput = "O|1|" & mOrder.Seq & "||" & mOrder.Order & "||||||||||||01"
                    strOutput = "O|1|" & GetText(vasID, intRow, colPAGE) & "||" & mOrder.Order & "||||||||||||01"
...
Private Sub GetOrder(ByVal pBarNo As String)
    ...
    For i = 1 To vasID.DataRowCnt
        If Trim(GetText(vasID, i, colCHARTNO)) = pBarNo Then
            mOrder.Seq = Trim(GetText(vasID, i, colPID))
            intRow = i
            Exit For
        End If
    Next i
    ...
    Select Case gOCS
        Case "BITU"
                Call GetSampleInfoW_BITUCHART(intRow)
        Case "BIT"
    ...
    strItems = GetEquipExamCode_CA270(gEquip, pBarNo, intRow)
...
Function GetEquipExamCode_CA270(argEquipCode As String, argPID As String, Optional intRow As Long) As String
    Dim i As Integer
    ...
    GetEquipExamCode_CA270 = strExamCode
...
'                End If
            ...
            Case "R"
                ...
                If strIntBase = "08" Then       'TCHO
                    strTC = strResult
                End If
                
                If strIntBase = "20" Then       'TG
                    strTG = strResult
                End If
                
                If strIntBase = "09" Then       'HDLC
                    strHDL = strResult
                End If
            ...
            Case "L"
                ...
                If MnTransAuto.Checked = True And strState = "R" Then
                    ...
                    'Select Case gOCS
                    'Case "BIT"
                    '    Res = SaveTransDataW_BIT(gRow)
                    'Case "BITU"
                    
                     '   Call GetSampleInfoW_BITUCHART(gRow)

                        Res = SaveTransDataW_BITUCHART(gRow)
                    'End Select
...
'        If iCol = colBARCODE Then
        If iCol = colCHARTNO Then
            ...
            Select Case gOCS
                ...
                Case "BITU"
                        Call GetSampleInfoW_BITUCHART(iRow)
            End Select
