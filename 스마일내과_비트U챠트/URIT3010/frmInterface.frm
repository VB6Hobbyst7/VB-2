    ...
    Select Case intSndPhase
        ...
        Case 3  '## Order
            If mOrder.NoOrder = True Then
                '## 접수정보가 없을경우
                strOutput = intFrameNo & "O|1|" & mOrder.BarNo & "||" & mOrder.Order & "||||||||||||01" & vbCr & ETX
                intSndPhase = 4
...
'MSH|^~\&|2|3|LIS|PC|20170809154900||ORU^R01|4|P|2.3.1||||||UNICODE

'                '-- 인터페이스 응답
'                               strSndBuffer = SB & "MSH|^~\&|2|3|LIS|PC|" & Format(Now, "yyyymmddhhmmss") & "||ACK^R01|" & strMType & "|P|2.3.1||||||UNICODE" & vbCr
'                strSndBuffer = strSndBuffer & "MSA|AA|1|Message accepted|||0|" & vbCr
'                strSndBuffer = strSndBuffer & EB & vbCr
'
'                SetRawData "[Tx]" & strSndBuffer
'                comEqp.Output = strSndBuffer
