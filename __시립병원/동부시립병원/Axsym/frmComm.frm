...
Begin VB.Form frmComm 
   ...
   Begin MSComctlLib.ImageList imlList 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmComm.frx":09AA
            Key             =   "ITM"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmComm.frx":0A08
            Key             =   "ERR"
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmComm.frx":0A66
            Key             =   "NOF"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmComm.frx":0AC4
            Key             =   "LST"
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmComm.frx":0B22
            Key             =   "LSE"
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmComm.frx":0B80
            Key             =   "LSN"
         EndProperty
      EndProperty
   End
   ...
   Begin MSComctlLib.ImageList imlStatus 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         NumListImages   =   7
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmComm.frx":0BDE
            Key             =   "RUN"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmComm.frx":1178
            Key             =   "NOT"
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmComm.frx":1712
            Key             =   "STOP"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmComm.frx":1CAC
            Key             =   "LST"
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmComm.frx":253E
            Key             =   "ITM"
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmComm.frx":2698
            Key             =   "ERR"
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmComm.frx":27F2
            Key             =   "NOF"
         EndProperty
      EndProperty
   End
   Begin Threed.SSFrame FrameResult 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Begin FPSpread.vaSpread spdRstDetail 
         Height          =   3225
         Left            =   120
         TabIndex        =   6
         Top             =   180
         ...
         SelectBlockOptions=   0
         SpreadDesigner  =   "frmComm.frx":294C
         ScrollBarTrack  =   3
      End
   End
...
'            Debug.Print "----> H"
''            tmp = frameno & "H|\^&|||AxSYM^3.60^1180^H1P1O1R1C1Q1L1M1|||||||P|1|" & Format(DBConn.getSysDate, "yyyyMMddhhMMss") & Chr(13) & Chr(3)
''            tmp = frameno & strHeader & vbCr & Chr(3)
'            tmp = FrameNo & "H|\^&||||||||||P|1|" & vbCr & Chr(3)
'            SndPhase = 2
'
'        Case 2      ' Patient Record
'            Debug.Print "----> P"
''            If lngLen = 9 Then
''                tmp = frameno & "P|1||" & Trim$(objAxsym.SpcYY & objAxsym.SpcNo) & "||" & Chr(13) & Chr(3)
''            ElseIf lngLen = 10 Then
''                tmp = frameno & "P|1||0" & Trim$(objAxsym.SpcYY & objAxsym.SpcNo) & "||" & Chr(13) & Chr(3)
''            ElseIf lngLen = 11 Then
'                tmp = FrameNo & "P|1||" & Trim$(objAxsym.SpcYY & objAxsym.SpcNo) & "||" & vbCr & Chr(3)
''            End If
'            SndPhase = 3
'        Case 3      ' Order Record
'            Debug.Print "----> O"
'            tmp = objAxsym.setWorklist(objInt, objRst)
'            SndPhase = 4
'        Case 4      'Terminator Record
'            Debug.Print "----> L"
'            tmp = FrameNo & "L|1" & vbCr & Chr(3)
'            SndPhase = 5
'
'        Case 5      ' EOT
'            Debug.Print "----> EOT"
'            comint.Output = Chr(4)   'EOT
'            FrameNo = 1
'            objInt.Phase = 1
'            SndPhase = 1
'            objInt.State = ""
...
'    End Select
'
''    lblOrder.Caption = Trim$(objAxsym.SpcYY & objAxsym.SpcNo) & " - Order 전송 중.."
'    ChkS = objAxsym.GetChkSum(tmp)
'    Debug.Print "----> ChkS " & ChkS
'    Debug.Print "----> SndPhase " & SndPhase
'    Debug.Print "----> Tmp " & "'" & tmp & "'"
'    Print #F_NO_AXSYM_ERR, COL_DIV & " Ord Start " & tmp & " Ord End " & COL_DIV
'    comint.Output = Chr(2) & tmp & ChkS & vbCr & vbLf
'    objInt.AddFrameNo
'End Sub
'
'Private Sub EditRcvdata(BufChar As String)
'    Dim ii       As Integer: ii = 1
'    Dim strFrame As String
'    Dim strTmp   As String
'    Dim aryTmp() As String
'    Dim sDevID   As String
'    Dim sRcvseq  As String
'    Dim strBarNo As String
'    Dim pCount   As Long
'    Dim strSndBuf As String
...
'   'Dim ii As Integer
'    'Debug.Print objInt.objDicBuf.GetString
'
''    Call objInt.AddBuffer
''    strTmp = medGetP(objInt.objDicBuf.GetString, 2, COL_DIV)
'
'    strTmp = ""
'
'    'objInt.objDicBuf.MoveFirst
'    'Do Until objInt.objDicBuf.EOF
'    For ii = 1 To Len(BufChar)
'        'strTmp = objInt.objDicBuf.Fields("bufchar")
'        strFrame = Mid(BufChar, ii, 1)
'
'        Select Case strFrame
'            Case "H"
'                'Debug.Print "----> H"
'                'strHeader = Mid(strTmp, 2)
'
'                strRcvbufR = ""
'                strBarNo = ""
'                sDevID = ""
...
'            Case "O"
'                Debug.Print "----> O"
'                'strBarNo = medGetP(strTmp, 3, "|")
''                If Len(strBarNo) <> 0 Then
''                    'sDevID = Trim(Mid(strBarNo, 1, Len(strBarNo) - 1))
''                    ' 선린병원
''                    sDevID = Trim(strBarNo)
''                End If
'                Debug.Print "----> sDevID " & sDevID
'
''                sRcvseq = medGetP(medGetP(strTmp, 4, "|"), 2, "^") & "/" & medGetP(medGetP(strTmp, 4, "|"), 3, "^")
'            Case "Q"
'                Debug.Print "----> Q"
'                strBarNo = ""
''                strBarNo = medGetP(strTmp, 3, "|")
''                strBarNo = medGetP(strBarNo, 2, "^")
'                sDevID = Trim(strBarNo)
'                Debug.Print "----> StrBarNo " & strBarNo
'
'                State = "Q"
''                objAxsym.SpcYY = ""
''                objAxsym.SpcNo = ""
'
''                objAxsym.SpcYY = Mid(Trim(strBarNo), 1, 2)
''                objAxsym.SpcNo = Mid(Trim(strBarNo), 3)
''                objRst.Barno = objAxsym.SpcYY & Mid(objAxsym.SpcNo, 1, 9)
''                Debug.Print "----> objAxsum.SpcYY " & objAxsym.SpcYY
''                Debug.Print "----> objAxsum.SpcNo " & objAxsym.SpcNo
'            Case "R"
'                Debug.Print "----> R "
''                strRcvbufR = strRcvbufR & strTmp & Fld_Div
'                lngRstCnt = lngRstCnt + 1
'                State = "R"
'            Case "L"
'                Debug.Print "----> L"
'                If State = "R" Then
''                    aryRcvBuf = Split(strRcvbufR, Fld_Div)
'
''                    Dim strTestID   As String
'                    Dim strResultDiv As String
'                    For k = LBound(aryRcvBuf) To UBound(aryRcvBuf) - 1
''                        strIntbase = Trim(medGetP(medGetP(aryRcvBuf(k), 3, "|"), 4, "^"))
''                        Print #F_NO_AXSYM_ERR, " aryRcvBuf(k) ----> " & aryRcvBuf(k)
''                        Print #F_NO_AXSYM_ERR, "strIntbase ----> " & strIntbase
''                        strResultDiv = Trim(medGetP(medGetP(aryRcvBuf(k), 3, "|"), 8, "^"))
''                        Print #F_NO_AXSYM_ERR, "strResultDiv ----> " & strResultDiv
''                        Debug.Print "medGetP(strRcvbufR, 4, '|') " & medGetP(aryRcvBuf(k), 4, "|")
'
'                        Dim strRstHead As String
'                        Dim strRealRst As String
'
'                        objTestL.MoveFirst
'                        Do Until objTestL.EOF
'                            Select Case objTestL.Fields("intbase")
'                                Case strIntbase & "F"
'                                    If strResultDiv = "F" Then
'
'                                        strRstHead = Mid(Trim(medGetP(aryRcvBuf(k), 4, "|")), 1, 1)
'
'                                        Select Case strRstHead
'                                            Case "R"
'                                                strRealRst = "+"
'                                            Case "G"
'                                                strRealRst = "G"
...
'                                                strRealRst = "-"
'                                            Case Else
'                                                strRealRst = Trim(medGetP(aryRcvBuf(k), 4, "|"))
'                                        End Select
'
'                                        objTestL.Fields("result") = ""
'                                        objTestL.Fields("result") = strRealRst & vbTab & _
'                                                                    objTestL.Fields("testcd") & vbTab & _
'                                                                    objTestL.Fields("intnm")
'                                        DoEvents
'                                        Print #F_NO_AXSYM_ERR, "objTestL.Fields(" & "result" & ") &  F ----> " & objTestL.Fields("result")
'                                        Exit Do
'                                    End If
'                                Case strIntbase & "P"
'                                    If strResultDiv = "P" Then
'                                        strRstHead = Mid(Trim(medGetP(aryRcvBuf(k), 4, "|")), 1, 1)
'
'                                        Select Case strRstHead
'                                            Case "R"
...
'                                                                    objTestL.Fields("intnm")
'                                        DoEvents
'                                        Print #F_NO_AXSYM_ERR, "objTestL.Fields(" & "result" & ") &  P ----> " & objTestL.Fields("result")
'                                        Exit Do
'                                    End If
'                                Case strIntbase & "I"
'                                    If strResultDiv = "I" Then
'                                        strRstHead = Mid(Trim(medGetP(aryRcvBuf(k), 4, "|")), 1, 1)
'
'                                        Select Case strRstHead
'                                            Case "R"
...
'                                                                    objTestL.Fields("intnm")
'                                        DoEvents
'                                        Print #F_NO_AXSYM_ERR, "objTestL.Fields(" & "result" & ") &  I ----> " & objTestL.Fields("result")
'                                        Exit Do
'                                    End If
'                            End Select
'                            objTestL.MoveNext
'                        Loop
'                    Next k
'                    '결과전송 및 화면 Display------------> 결과확인(선린병원)
'                    Call Result_Send(sDevID, sRcvseq)
'                    Debug.Print "sDevID " & sDevID
'                    Debug.Print "sRcvSeq " & sRcvseq
'                    objInt.Phase = 1
'                    objInt.BufCnt = 0
'                    strRcvbufR = ""
'                End If
    ...
    For iCnt = 1 To Len(ReceiveData)
        Select Case Mid(ReceiveData, iCnt, 1)
            ...
            Case "R" 'Test Result
                ...
                cntRepeat_ = -1
                For ii = 0 To 100
                    If AXSYM.TestId(ii) = TestId Then
                        cntRepeat_ = ii
                        Exit For
                    End If
                Next ii
                If cntRepeat_ <> -1 Then
                    AXSYM.TestId(cntRepeat_) = TestId
                    AXSYM.Result(cntRepeat_) = Result
                    AXSYM.Status(cntRepeat_) = Status
                    AXSYM.Rerun(cntRepeat_) = Rerun
                End If
                Exit For
