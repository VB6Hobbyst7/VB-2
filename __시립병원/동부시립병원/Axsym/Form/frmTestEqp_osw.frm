...
Begin VB.Form frmTestEqp_osw 
   ...
   Begin MSComctlLib.ImageList imlList 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTestEqp_osw.frx":0000
            Key             =   "TST_E"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTestEqp_osw.frx":059A
            Key             =   "TST_M"
         EndProperty
      EndProperty
   End
   ...
   Begin FPSpreadADO.fpSpread spdTestListDt 
      ...
      SpreadDesigner  =   "frmTestEqp_osw.frx":0B34
      ScrollBarTrack  =   1
   End
End
Attribute VB_Name = "frmTestEqp_osw"
    ...
    With spdTestListDt
        ...
        For iRow = 1 To .MaxRows
            ...
            If Trim(.Text) <> "" Then
                ...
                .Col = 14: sqlDoc = sqlDoc + "      REMARK     = '" & Trim$(.Text) & "'"
                ...
                If sqlRet = 0 Then
                                       sqlDoc = "Insert into INTERFACE002(" & _
                                                ...
                                                "            REFLM, REFHM, REFLF, REFHF, PANICL, PANICH, DELTA)" & _
                                                "    values( '" & INS_CODE & "', "
                    ...
                    .Col = 13: sqlDoc = sqlDoc + "           '" & Trim$(.Text) & "',"
                    .Col = 14: sqlDoc = sqlDoc + "           '" & Trim$(.Text) & "')"
    ...
    Do While Not adoRS.EOF
        ...
        With spdTestListDt
            If Trim(adoRS("TESTCD")) <> "" Then
                ...
                .SetText 12, iRow, " " 'Trim(adoRS("MSGLOW"))
                .SetText 13, iRow, " " 'Trim(adoRS("MSGHIGH"))
                .SetText 14, iRow, " " 'Trim(adoRS("REMARK"))
            End If
        End With
