...
Begin VB.Form frmComSetup 
   ...
   Begin VB.Frame Frame5 
      ...
      Begin VB.TextBox txtRThreshold 
         ...
         TabIndex        =   28
         Text            =   "1"
         ToolTipText     =   $"frmComSetup.frx":038A
         Top             =   2265
         Width           =   945
      End
      ...
      Begin VB.TextBox txtSThreshold 
         ...
         TabIndex        =   29
         Text            =   "1"
         ToolTipText     =   $"frmComSetup.frx":0411
         Top             =   2670
         Width           =   945
      End
      Begin VB.CheckBox EOFEnable 
         ...
         Left            =   3930
         TabIndex        =   20
         ToolTipText     =   $"frmComSetup.frx":04AC
         Top             =   1470
         Width           =   2250
      End
      Begin VB.CheckBox DTREnable 
         ...
         Left            =   3930
         TabIndex        =   19
         ToolTipText     =   $"frmComSetup.frx":0567
         Top             =   1065
         Width           =   2250
      End
      ...
      Begin VB.CheckBox RTSEnable 
         ...
         Left            =   3930
         TabIndex        =   22
         ToolTipText     =   $"frmComSetup.frx":05F5
         Top             =   2295
         Width           =   2250
      End
   ...
   Begin VB.Frame Frame4 
      ...
      Begin Threed.SSCommand cmdStation 
         ...
         BevelWidth      =   1
         Outline         =   0   'False
         Picture         =   "frmComSetup.frx":0683
      End
      Begin Threed.SSCommand cmdWS_CD 
         Height          =   285
         Left            =   9000
         TabIndex        =   76
         Top             =   300
   ...
   Begin Threed.SSCommand cmdEQP 
      ...
      BevelWidth      =   1
      Outline         =   0   'False
      Picture         =   "frmComSetup.frx":0937
   End
   Begin Threed.SSPanel pnlPoplist 
      Height          =   3225
      Left            =   5730
      TabIndex        =   78
      Top             =   990
...
Private Sub cmdSave()
    ...
    MainForm.Caption = "LIMAS(" & INS_NAME & ")"
...
Private Sub cmdStation_Click()
    ...
    If Not mAdoRs Is Nothing Then
        Do Until mAdoRs.EOF
            Set itemX = PopUp_List.ListItems.Add(, , Trim(mAdoRs("EQP_CD") & ""))
            itemX.SubItems(1) = Trim(mAdoRs("STATION") & "")
            mAdoRs.MoveNext
        Loop
...
Private Sub cmdWS_CD_Click()
    ...
    If Not mAdoRs Is Nothing Then
        Do Until mAdoRs.EOF
            Set itemX = PopUp_List.ListItems.Add(, , Trim(mAdoRs("EQP_CD") & ""))
            itemX.SubItems(1) = Trim(mAdoRs("WORK_ST") & "")
            mAdoRs.MoveNext
        Loop
