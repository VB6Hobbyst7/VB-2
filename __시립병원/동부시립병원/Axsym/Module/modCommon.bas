...
Option Explicit
Global Gbl_FormName       As String                '폼 이름

Public SpPrint As SpPrint

Public Type SpPrint
    strTitle      As String
    strBaseDate   As String
    strPageCount  As String
    strAreaName   As String
    strPrintDate  As String
    strSpcNo      As String
    strName       As String
    strSex        As String
    strAge        As String
...
Public Function DataRs(ByVal brStr As String) As OraDynaset

    Set DataRs = gDbCn.CreateDynaset(brStr, 0&)
