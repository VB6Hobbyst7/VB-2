...
Begin VB.Form frmResult 
   ...
   Begin Threed.SSFrame FrameResult 
      ...
      Begin FPSpreadADO.fpSpread spdRstDetail 
         ...
         SelectBlockOptions=   0
         SpreadDesigner  =   "frmResult.frx":0F94
         ScrollBarTrack  =   1
      End
   End
   ...
   Begin MSComctlLib.ImageList imlList 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmResult.frx":1511
            Key             =   "ITM"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmResult.frx":156F
            Key             =   "ERR"
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmResult.frx":15CD
            Key             =   "NOF"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmResult.frx":162B
            Key             =   "LST"
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmResult.frx":1689
            Key             =   "LSE"
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmResult.frx":16E7
            Key             =   "LSN"
         EndProperty
      EndProperty
   End
...
'"   and 접수일자 =  '" & Format(dtpRegDate.Value, "yyyy-mm-dd") & "' " & _
                ...
                For intCol = 8 To .MaxCols
                    ...
                    If Trim$(varTmp) <> "" Then
                        ...
                        If Not itemX Is Nothing Then
                            ...
                            Do Until sRs.EOF
                                If sRs("품목코드") = strTestcd Then blnFlag = True: Exit Do
                                sRs.MoveNext
                            Loop
                            Set sRs = Nothing
    ...
    With spdResult1
        For iCnt = intCol1 To .MaxCols
            ...
            If cboReg.ListIndex = 0 Then '-- 접수일
                ...
                sqlDoc = sqlDoc & " where RegDate < '" & Format(dtpRegDate.Value, "yyyy-mm-dd") & "'"
            Else                     '-- 등록일
                sqlDoc = "select TransDt, Result1 from INTERFACE003"
                sqlDoc = sqlDoc & " where TransDt < '" & Format(dtpRegDate.Value, "yyyy-mm-dd") & "'"
            End If
