...
Private Sub Form_Activate()
    ...
    Select Case Gbl_FormName
        Case "frmResult"
            Me.vaSpreadPreview1.hWndSpread = frmResult.spdResult1.hwnd
...
Private Sub Form_Load()
    ...
    Select Case Gbl_FormName
        Case "frmResult" '-- 검사결과
            If frmResult.spdResult1.PrintPageCount = 1 Then
                'Disable Next button if only one page
                DisableButton 2, "LEFT"
            End If
            
            frmResult.spdResult1.PrintOrientation = PrintOrientationLandscape
        ...
        Case "frmTestEqp" '-- 검사항목
            ...
            frmTestEqp.spdTestListDt.PrintOrientation = PrintOrientationPortrait
        ...
        Select Case Col
            Case 2  'Next
                ...
                Select Case Gbl_FormName
                    Case "frmResult"
                        With frmResult
                            If vaSpreadPreview1.PageCurrent < frmResult.spdResult1.PrintPageCount Then
                            ...
                            If vaSpreadPreview1.PageCurrent > frmResult.spdResult1.PrintPageCount - vaSpreadPreview1.PagesPerScreen Then
    ...
    Select Case Gbl_FormName
        Case "frmResult"
            With vaSpread1
                ...
                .Row = 1
                .Col = 14
                .Text = "Page " & vaSpreadPreview1.PageCurrent & " of " & frmResult.spdResult1.PrintPageCount
            End With
