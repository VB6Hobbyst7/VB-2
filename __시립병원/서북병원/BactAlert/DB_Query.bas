...
'            SQL = SQL & vbCrLf & " WHERE PID = '" & lsPid & "' "
...
'                '-- 미생물 세균결과 저장
'                SQL = "INSERT INTO ISO (HID,PID,RECENO,SPECIMENCODE,MICCODE,AMOUNT,INPUT_UID,INPUT_DATETIME,EXAMCODE,REMARK,PRINTCNT,HIGHERFLAG,COUNTGUBUN,ANTIVOL) "
'                SQL = SQL & vbCrLf & " Values ( "
