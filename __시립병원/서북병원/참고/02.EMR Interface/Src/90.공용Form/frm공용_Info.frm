VERSION 5.00
Begin VB.Form frm공용_Info 
   BorderStyle     =   1  '단일 고정
   Caption         =   "Hi Interface EMR 정보"
   ClientHeight    =   4095
   ClientLeft      =   4860
   ClientTop       =   2820
   ClientWidth     =   6540
