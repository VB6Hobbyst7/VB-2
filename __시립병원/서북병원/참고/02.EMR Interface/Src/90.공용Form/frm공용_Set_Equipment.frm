...
Public Function MM_SAVE() As Boolean
    ...
    gtypEQ_INFO.EQIMGFILEPATH = GET_CELL(spr의료장비리스트, 21, spr의료장비리스트.ActiveRow) '/장비결과파일저장경로(Client)
    gtypEQ_INFO.FTPIMGFILEPATH = GET_CELL(spr의료장비리스트, 22, spr의료장비리스트.ActiveRow) '/FTP결과파일저장경로(Client)
