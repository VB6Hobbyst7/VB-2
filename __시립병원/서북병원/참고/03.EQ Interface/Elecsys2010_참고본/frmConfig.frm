...
Private Sub Command1_Click()
    ...
    Else
        ...
        SQL = " Update Equip " & vbCrLf & _
              " Set Port = '" & Trim(gSetup.gPort) & "', " & vbCrLf & _
              "     Baud = " & Trim(gSetup.gSpeed) & ", " & vbCrLf & _
              "     DataBit = '" & Trim(gSetup.gDataBit) & "', " & vbCrLf & _
              "     StartBit = '" & Trim(gSetup.gStartBit) & "', " & vbCrLf & _
              "     StopBit = '" & Trim(gSetup.gStopBit) & "', " & vbCrLf & _
              "     PARITY = '" & Trim(gSetup.gParity) & "', " & vbCrLf & _
              "     RTS = '" & Trim(sRTS) & "', " & vbCrLf & _
              "     DTR = '" & Trim(sDTR) & "' " & vbCrLf & _
