   ...
   Begin VB.Frame fra상세내역 
      ...
      Begin VB.PictureBox picSERIALPORT 
         ...
         Begin VB.ComboBox cboSERIALPORT 
            Height          =   300
            ItemData        =   "frm공용_Set_Equip_Config.frx":0320
            Left            =   1200
            List            =   "frm공용_Set_Equip_Config.frx":0322
            Style           =   2  '드롭다운 목록
            TabIndex        =   8
            Top             =   60
            Width           =   1875
         ...
         Begin VB.ComboBox cboSERIALBAUD 
            Height          =   300
            ItemData        =   "frm공용_Set_Equip_Config.frx":0324
            Left            =   1200
            List            =   "frm공용_Set_Equip_Config.frx":0326
            TabIndex        =   9
            Text            =   "cboSERIALBAUD"
            Top             =   450
            Width           =   1875
         ...
         Begin VB.ComboBox cboSERIALDATABIT 
            Height          =   300
            ItemData        =   "frm공용_Set_Equip_Config.frx":0328
            Left            =   1200
            List            =   "frm공용_Set_Equip_Config.frx":032A
            Style           =   2  '드롭다운 목록
            TabIndex        =   10
            Top             =   840
            Width           =   1875
         ...
         Begin VB.ComboBox cboSERIALPARITY 
            Height          =   300
            ItemData        =   "frm공용_Set_Equip_Config.frx":032C
            Left            =   1200
            List            =   "frm공용_Set_Equip_Config.frx":032E
            Style           =   2  '드롭다운 목록
            TabIndex        =   13
            Top             =   2040
            Width           =   1875
