...
Private Sub cmdWorkList_Click()
    ...
    If frmEQ_Main.MSComm2.PortOpen = False Then frmEQ_Main.MSComm2.PortOpen = True
    For intX = 1 To sprWorkList.MaxRows
        sprWorkList.Col = 1
        sprWorkList.Row = intX
        If sprWorkList.Value = 1 Then
            frmEQ_Main.MSComm2.Output = chrSTX & GET_CELL(sprWorkList, 3, intX) & chrETX
            Call sprWorkList.DeleteRows(intX, 1)
            sprWorkList.MaxRows = sprWorkList.MaxRows - 1
            Exit For
        End If
    Next intX
