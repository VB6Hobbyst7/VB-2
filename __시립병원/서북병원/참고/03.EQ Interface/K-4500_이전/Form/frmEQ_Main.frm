    ...
    For intY = 1 To Len(Text1)
        ...
        Select Case strOneByte
            ...
            Case chrETX
                ...
                If strStart = "Y" And (Mid(strOneLine, 1, 2) <> "DB" And Mid(strOneLine, 1, 2) <> "DE") Then
                    txtBuff = txtBuff & Mid(strOneLine, 1, Len(strOneLine) - 1) & vbCrLf
                ElseIf strStart = "N" Then
                    strBuff = txtBuff
                    txtBuff = ""
                    Call SUB_COMM_PART_AU2700(strBuff)
                End If
...
Public Sub SUB_COMM_PART_AU2700(argCOMM_BF As String)
    Dim strCrlf '/배열변수(CRLF 기준)
    Dim strPart '/배열변수(| 기준)
    ...
    Select Case Mid(strCrlf(intX), 1, 2)
        ...
        Case "D " '/Result
            ...
            Do While Len(strBuff) > 16
                ...
                gtypPAT_RES.EQRESULT = Trim(Mid(strBuff, 4, 10)) '/EQRESULT(장비원시결과)
