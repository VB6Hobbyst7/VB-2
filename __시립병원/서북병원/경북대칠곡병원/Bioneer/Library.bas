...
Public Sub SaveData(argSQL As String, Optional argFlag As Integer = 0)
'argSQLÀÇ ³»¿ëÀ» ÆÄÀÏ·Î ÀúÀå
    ...
    Open App.Path & "\Log\" & SeperatorCls(Form_Main.Text_Today.Text) & ".txt" For Append As FilNum
    Print #FilNum, argSQL
    Close FilNum
End Sub
...
'SpreadSheetdÀÇ Col¿¡ ÀÖ´Â°Í°ú °°Àº Text¸¦ Ã£¾Æ³½´Ù.
'Return : °°Àº Text°¡ Á¸ÀçÇÏ¸é ±× Col,
'                     Á¸ÀçÇÏÁö ¾ÊÀ¸¸é -1 À» ¹ÝÈ¯
    Dim i As Integer
