...
Begin VB.Form Form_config 
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin VB.ComboBox Combo_Port 
         Height          =   315
         ItemData        =   "Form_config.frx":0000
         Left            =   1545
         List            =   "Form_config.frx":0002
         TabIndex        =   14
         Top             =   150
         Width           =   1695
      End
      Begin VB.ComboBox Combo_BPS 
         Height          =   315
         ItemData        =   "Form_config.frx":0004
         Left            =   1545
         List            =   "Form_config.frx":0006
         TabIndex        =   8
         Top             =   540
         Width           =   1695
      End
      Begin VB.ComboBox Combo_Databit 
         Height          =   315
         ItemData        =   "Form_config.frx":0008
         Left            =   1545
         List            =   "Form_config.frx":000A
         TabIndex        =   7
         Top             =   930
         Width           =   1695
      End
      ...
      Begin VB.ComboBox Combo_Parity 
         Height          =   315
         ItemData        =   "Form_config.frx":000C
         Left            =   1545
         List            =   "Form_config.frx":000E
         TabIndex        =   4
         Top             =   2130
         Width           =   1695
      End
...
'        If Form_Main.MSComm1.PortOpen = True Then
'            Form_Main.MSComm1.PortOpen = False
'        End If
'        Form_Main.MSComm1.CommPort = gSetup.gPort
'        Form_Main.MSComm1.Settings = gSetup.gSpeed & "," & gSetup.gParity & "," & gSetup.gDataBit & "," & gSetup.gStopBit
'
'        Form_Main.MSComm1.PortOpen = True
