...
Begin VB.Form frmEQ_HISDB_Config_임시 
   ...
   EndProperty
   Icon            =   "frmEQ_HISDB_Config_임시.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin VB.Frame fra상세내역 
      ...
      Begin VB.TextBox txtREMARK 
         ...
         MultiLine       =   -1  'True
         TabIndex        =   19
         Text            =   "frmEQ_HISDB_Config_임시.frx":000C
         Top             =   5760
         Width           =   6795
      End
      ...
      Begin VB.PictureBox Picture2 
         ...
         Begin FPSpread.vaSpread sprEQORD 
            ...
            MaxCols         =   1
            MaxRows         =   10
            SpreadDesigner  =   "frmEQ_HISDB_Config_임시.frx":0018
         End
      ...
      Begin VB.PictureBox picSERIALPORT 
         ...
         Begin VB.ComboBox cboSERIALPORT 
            Height          =   300
            ItemData        =   "frmEQ_HISDB_Config_임시.frx":0320
            Left            =   1200
            List            =   "frmEQ_HISDB_Config_임시.frx":0322
            Style           =   2  '드롭다운 목록
            TabIndex        =   8
            Top             =   60
            Width           =   1875
         ...
         Begin VB.ComboBox cboSERIALBAUD 
            Height          =   300
            ItemData        =   "frmEQ_HISDB_Config_임시.frx":0324
            Left            =   1200
            List            =   "frmEQ_HISDB_Config_임시.frx":0326
            TabIndex        =   9
            Text            =   "cboSERIALBAUD"
            Top             =   450
            Width           =   1875
         ...
         Begin VB.ComboBox cboSERIALDATABIT 
            Height          =   300
            ItemData        =   "frmEQ_HISDB_Config_임시.frx":0328
            Left            =   1200
            List            =   "frmEQ_HISDB_Config_임시.frx":032A
            Style           =   2  '드롭다운 목록
            TabIndex        =   10
            Top             =   840
            Width           =   1875
         ...
         Begin VB.ComboBox cboSERIALPARITY 
            Height          =   300
            ItemData        =   "frmEQ_HISDB_Config_임시.frx":032C
            Left            =   1200
            List            =   "frmEQ_HISDB_Config_임시.frx":032E
            Style           =   2  '드롭다운 목록
            TabIndex        =   13
            Top             =   2040
            Width           =   1875
   ...
   End
End
Attribute VB_Name = "frmEQ_HISDB_Config_임시"
