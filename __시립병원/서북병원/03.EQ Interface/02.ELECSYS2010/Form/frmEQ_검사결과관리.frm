...
Private Sub sprLResult_DblClick(ByVal Col As Long, ByVal Row As Long)
    ...
    lblDISKNOPOSNO = GET_CELL(sprLResult, 6, Row) & "/" & GET_CELL(sprLResult, 6, Row) '/Rack/Pos
    lblEXDT = GET_CELL(sprLResult, 7, Row)      '/검사처방전송일자
...
On Error GoTo RTN_ERR
    ...
    If Not ADR_LOC Is Nothing Then
        Do Until ADR_LOC.EOF
            ...
            If gtypPAT_RES.Result <> "" And gtypPAT_RES.EXAMCD <> "" Then
