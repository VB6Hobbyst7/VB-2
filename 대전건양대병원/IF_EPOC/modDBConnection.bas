...
Public gEDMDB        As EDMDBParameter_QC
...
'EDM
Global AdoCn_EDM            As ADODB.Connection
...
'-- EDM 연결
Public Function DbConnect_EDM() As Boolean
    ...
    Set AdoCn_EDM = New ADODB.Connection

On Error GoTo ConnectError

    ServerName = gEDMDB.IP
    DatabaseName = gEDMDB.DB
    UserName = gEDMDB.UID
    Password = gEDMDB.PWD
