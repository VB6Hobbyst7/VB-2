...
Public Function GetDBSelectColumn(argSQL As String) As Integer
    Dim i, j As Integer
...
On Error GoTo ErrHandle
    ...
    Set AdoCmd.ActiveConnection = AdoCn_EDM
    AdoCmd.CommandText = argSQL
...
'쿼리 실행 내용을 gReadbuf()의 Array에 저장
Public Function GetDBSelectColumn_Local(argSQL As String) As Integer
    Dim i, j As Integer
    
On Error GoTo ErrHandle
       
    GetDBSelectColumn_Local = -1
    i = 0
    
    Erase gReadBuf
    
    Set AdoCmd.ActiveConnection = AdoCn_Local
    AdoCmd.CommandText = argSQL
    Set RS = AdoCmd.Execute
