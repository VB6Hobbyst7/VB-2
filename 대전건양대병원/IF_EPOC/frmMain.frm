...
Begin VB.Form frmMain 
   ...
   Begin VB.Frame FraHidden 
      ...
      Begin FPSpread.vaSpread spdQcResult 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmMain.frx":5CF3
      End
   ...
   Begin VB.Frame frame1 
      ...
      Begin FPSpread.vaSpread spdResult 
         ...
         SpreadDesigner  =   "frmMain.frx":9A99
         TextTip         =   2
      End
      Begin FPSpread.vaSpread spdOrder 
         ...
         SpreadDesigner  =   "frmMain.frx":A2B9
         UserResize      =   2
      End
      Begin FPSpread.vaSpread vaSpread1 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmMain.frx":D245
      End
      Begin VB.Frame fraDUREADER720 
         ...
         Begin VB.ComboBox cboWbcM 
            ...
            EndProperty
            Height          =   300
            ItemData        =   "frmMain.frx":D488
            Left            =   1020
            List            =   "frmMain.frx":D498
            TabIndex        =   178
            Text            =   "Combo3"
            Top             =   360
            Width           =   1695
   ...
   Begin VB.PictureBox Picture2 
      ...
      Begin VB.Frame fraResult 
         ...
         Begin VB.ComboBox cboRstType 
            Appearance      =   0  '평면
            Height          =   300
            ItemData        =   "frmMain.frx":D4A8
            Left            =   420
            List            =   "frmMain.frx":D4AA
            TabIndex        =   114
            Top             =   180
            Width           =   1245
         End
         Begin VB.ComboBox cboState 
            Height          =   300
            ItemData        =   "frmMain.frx":D4AC
            Left            =   4710
            List            =   "frmMain.frx":D4AE
            TabIndex        =   113
            Top             =   180
            Width           =   1395
         End
   ...
   Begin VB.Frame frame2 
      ...
      Begin FPSpread.vaSpread spdRResult 
         ...
         SelectBlockOptions=   0
         ShadowColor     =   13697023
         SpreadDesigner  =   "frmMain.frx":1084F
         TextTip         =   2
      End
      Begin FPSpread.vaSpread spdROrder 
         ...
         SelectBlockOptions=   0
         ShadowColor     =   14548991
         SpreadDesigner  =   "frmMain.frx":10F8D
         UserResize      =   2
      End
   ...
   Begin VB.Frame frame3 
      ...
      Begin VB.Frame frameTestSet 
         ...
         Begin VB.Frame frameOrder 
            ...
            Begin FPSpread.vaSpread spdOrdMst 
               ...
               SelectBlockOptions=   0
               ShadowColor     =   13697023
               SpreadDesigner  =   "frmMain.frx":13F13
               TextTip         =   2
            End
         End
         Begin VB.ComboBox cboResultType 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmMain.frx":14236
            Left            =   1650
            List            =   "frmMain.frx":14238
            TabIndex        =   31
            Top             =   5220
            Visible         =   0   'False
            Width           =   1575
      ...
      Begin FPSpread.vaSpread spdTest 
         ...
         RetainSelBlock  =   0   'False
         SelectBlockOptions=   0
         SpreadDesigner  =   "frmMain.frx":17132
      End
   End
   Begin VB.Frame frame4 
      ...
      Begin VB.Frame frameCom 
         ...
         Begin VB.ComboBox cboPort 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmMain.frx":18A6B
            Left            =   2190
            List            =   "frmMain.frx":18A6D
            TabIndex        =   51
            Top             =   390
            Width           =   2205
         End
         Begin VB.ComboBox cboBaudrate 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmMain.frx":18A6F
            Left            =   2190
            List            =   "frmMain.frx":18A71
            TabIndex        =   50
            Top             =   780
            Width           =   2205
         End
         Begin VB.ComboBox cboDatabit 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmMain.frx":18A73
            Left            =   2190
            List            =   "frmMain.frx":18A75
            TabIndex        =   49
            Top             =   1170
            Width           =   2205
         End
         ...
         Begin VB.ComboBox cboParity 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmMain.frx":18A77
            Left            =   2190
            List            =   "frmMain.frx":18A79
            TabIndex        =   46
            Top             =   2520
            Width           =   2205
         End
...
Exit Sub
    ...
    If txtTimer.Text = "0" Then
        ...
        strFDT = Format(dtpFrDt.Value, "yyyy-MM-dd HH:mm:00")
        strTDT = Format(dtpToDt.Value, "yyyy-MM-dd 23:59:59")
        ...
        Set RSH = AdoCn_EDM.Execute(SQL, , 1)
        ...
        If Not RSH.EOF = True And Not RSH.BOF = True Then
            Do Until RSH.EOF
                ...
                SetText spdOrder, strMaxSeq, intRow, colSAVESEQ
                SetText spdOrder, Format(strEDTM, "yyyymmddhhmmss"), intRow, colEXAMDATE
                SetText spdOrder, pBarno, intRow, colBARCODE
                '-- 스프레드 표시 -------------------------------------------
                ...
                Set RSD = AdoCn_EDM.Execute(SQL, , 1)
               ...
               If Not RSD.EOF = True And Not RSD.BOF = True Then
                    ...
                    If strTemperature <> "" Then
                        ...
                        If Res > 0 Then
                            ...
                            '-- Work List
                            SetText spdOrder, "Result", gRow, colSTATE                 '11 진행상태
                            
                            
                            '-- 결과저장용 seq
                            For intCol = colSTATE + 1 To spdOrder.MaxCols
                                If lsExamCode = gArrEQP(intCol - colSTATE, 3) Then
                                    SetText spdOrder, strResult, spdOrder.MaxRows, intCol
                                    'SetText spdResult, gArrEquip(intCol - colState, 7), lsResRow, colSUBCODE               'subcode
                                    Exit For
                                End If
                            Next
                            ...
                            '-- 로컬 저장
                            SetLocalDB spdOrder.MaxRows, lsResRow, "1", lsEquipRes
                            
                            SetText spdOrder, "1", spdOrder.MaxRows, colCHECKBOX
                            lsResult_Buff = ""
                    ...
                    If optTrans(0).Value = True And strState = "R" And blnRcp = True Then
...
'
'                '-- 환자정보 표시 -------------------------------------------
'                If Len(strBarno) >= 8 And IsNumeric(strBarno) Then
'
'
'                    '-- 검사자 정보 가져오기
'                    Call GetSampleInfo(intRow, spdOrder)
...
Private Sub SerialRcvData_HITACHI7080()
    ...
    Dim lsOrderCode     As String   '처방코드
    Dim lsTestCode      As String   '검사코드
    Dim lsTestCodeSub   As String   '검사코드SUB
    Dim lsTestName      As String   '검사명
    Dim lsSeqNo         As String   '로컬DB 검사Seq
                                ...
                                If gPatOrdCd <> "" Then
                                    ...
                                    If Not RS_L.EOF = True And Not RS_L.BOF = True Then
                                        ...
                                        For intCol = colSTATE + 1 To .spdOrder.MaxCols
                                            If lsTestCode = gArrEQP(intCol - colSTATE, 2) Then
                                                SetText .spdOrder, strResult, gRow, intCol
                                                lsTestCodeSub = gArrEQP(intCol - colSTATE, 7)
                                                Exit For
                                            End If
                                        Next
                                        ...
                                        SetText .spdResult, lsOrderCode, lsRstRow, colRORDERCD          '처방코드
                                        SetText .spdResult, lsTestCode, lsRstRow, colRTESTCD            '검사코드
                                        SetText .spdResult, lsTestCodeSub, lsRstRow, colRSUBCD          '검사코드SUB
                                        SetText .spdResult, lsTestName, lsRstRow, colRTESTNM            '검사명
                                        SetText .spdResult, strIntBase, lsRstRow, colRCHANNEL           '장비채널
                                        SetText .spdResult, strMachResult, lsRstRow, colRMACHRESULT     '장비결과
                                        SetText .spdResult, strResult, lsRstRow, colRLISRESULT          'LIS결과
...
Private Sub SerialRcvData_UROMETER720()
    ...
    Dim lsOrderCode     As String   '처방코드
    Dim lsTestCode      As String   '검사코드
    Dim lsTestCodeSub   As String   '검사코드
    Dim lsTestName      As String   '검사명
    Dim lsSeqNo         As String   '로컬DB 검사Seq
                    ...
                    If strIntBase <> "" And strResult <> "" Then
                        If gPatOrdCd <> "" Then
                            ...
                            If Not RS_L.EOF = True And Not RS_L.BOF = True Then
                                ...
                                SetText .spdResult, lsOrderCode, lsRstRow, colRORDERCD          '처방코드
                                SetText .spdResult, lsTestCode, lsRstRow, colRTESTCD            '검사코드
                                SetText .spdResult, lsTestCodeSub, lsRstRow, colRSUBCD          '검사코드
                                SetText .spdResult, lsTestName, lsRstRow, colRTESTNM            '검사명
                                SetText .spdResult, strIntBase, lsRstRow, colRCHANNEL           '장비채널
                                SetText .spdResult, strMachResult, lsRstRow, colRMACHRESULT     '장비결과
                                SetText .spdResult, strResult, lsRstRow, colRLISRESULT          'LIS결과
        ...
        For intCnt = 0 To UBound(strRecvData)
            ...
            Select Case intCnt
                Case 4
                    ...
                    '        If Val(GetText(spdOrder, i, colSPECNO)) = Val(strSeq) Then
                    ...
                    If strIntBase <> "" And strResult <> "" Then
                        If gPatOrdCd <> "" Then
                            ...
                            If Not RS_L.EOF = True And Not RS_L.BOF = True Then
                                ...
                                For intCol = colSTATE + 1 To .spdOrder.MaxCols
                                    If lsTestCode = gArrEQP(intCol - colSTATE, 2) Then
                                    'If lsTestName = gArrEQP(intCol - colSTATE, 5) Then
                                        SetText .spdOrder, strResult, gRow, intCol
                                        lsTestCodeSub = gArrEQP(intCol - colSTATE, 7)
                                        Exit For
                                    End If
...
Private Sub lblWork_Click()
    ...
    Else
        Call GetWorkList_Main(Format(dtpFrDt.Value, "yyyymmdd"), Format(dtpToDt.Value, "yyyymmdd"), spdOrder)
    End If
