    ...
    With frmMain
        ...
        If gHOSP.BARUSE = "Y" Then
            For i = 1 To .spdOrder.DataRowCnt
                ...
                '        If Val(Trim(GetText(frmMain.spdOrder, i, colSAVESEQ))) = Val(mResult.RsltSeq) Then
                        '-- 2019.12.03
        ...
        If intRow < 0 Then
            ...
            If .spdOrder.MaxRows < intRow Then
                ...
                'mResult.RsltDate = Format(Now, "yyyymmddhhmmss")
                'mResult.RsltSeq = getMaxTestNum(Format(frmMain.dtpToday, "yyyymmdd"))
                
            End If
'        Else
'            mResult.RsltDate = GetText(.spdOrder, intRow, colEXAMDATE)
'            mResult.RsltSeq = GetText(.spdOrder, intRow, colSAVESEQ)
        End If
...
'        SQL = SQL & " WHERE jeobsudt = '" & strHospDate & "'" & vbCr
    ...
    With frmMain
        ...
        For intRow = 1 To .vasTemp.DataRowCnt
            ...
            If strBarcode <> "" And strTestCd <> "" And sResult <> "" And strSubCodes <> "" Then
                ...
                SQL = SQL & "   And ResLabCod = '" & strTestCd & "'"    '검사코드
