...
Begin VB.Form frmIISVariantII 
   ...
   Begin FPSpread.vaSpread tblReady 
      ...
      SpreadDesigner  =   "frmIISVariantII.frx":0000
   End
   Begin FPSpread.vaSpread tblComplete 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISVariantII.frx":04FA
   End
   ...
   Begin FPSpread.vaSpread tblResult 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISVariantII.frx":0D3C
      TextTip         =   2
   End
End
Attribute VB_Name = "frmIISVariantII"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
'-----------------------------------------------------------------------------'
'   파일명  : frmIISVariantII.frm
'   작성자  : 이상대
'   내  용  : Variant II 장비폼
'   작성일  : 2004-10-14
'   버  전  :
...
'       1. 예수병원
'       2. 단국대병원
'   메  모  : 예수병원의 경우 Variant II 장비가 HbA1 항목뿐이 없어서 오더전송
'             이 필요없었음. 다른병원에서 오더전송 문자열 확인할것!
'-----------------------------------------------------------------------------'
...
Private Sub EditRcvData()
    ...
    Dim strFlag      As String   '수신한 결과구분(AREA일때만 결과저장)
    Dim strTemp      As String
...
On Error GoTo Errors
    ...
    With MSComm
        ...
        If .PortOpen Then
            ...
            Error.SetLog App.EXEName, "frmIISVariantII", "GetEqpComm", strErrMsg, Now
