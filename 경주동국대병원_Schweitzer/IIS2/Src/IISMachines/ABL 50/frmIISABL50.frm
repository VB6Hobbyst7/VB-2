...
Begin VB.Form frmIISABL50 
   ...
   Begin FPSpread.vaSpread tblReady 
      ...
      SpreadDesigner  =   "frmIISABL50.frx":0000
   End
   Begin FPSpread.vaSpread tblComplete 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISABL50.frx":04E4
   End
   ...
   Begin FPSpread.vaSpread tblResult 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISABL50.frx":0D26
   End
...
Private Sub EditRcvData()
    ...
    For Each objBuffer In mIntLib.Buffers
        ...
        Select Case strType
            ...
            Case "O"    '## Order
                '## Cal 데이터는 무시
                strTemp = mGetP(mGetP(strRcvBuf, 4, "|"), 1, "^")
                If InStr(strTemp, "Cal") > 0 Then Exit Sub
