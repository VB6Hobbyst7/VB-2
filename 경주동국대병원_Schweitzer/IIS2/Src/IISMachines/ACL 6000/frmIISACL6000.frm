...
Begin VB.Form frmIISACL6000 
   ...
   Begin FPSpread.vaSpread tblReady 
      ...
      SpreadDesigner  =   "frmIISACL6000.frx":0000
   End
   Begin FPSpread.vaSpread tblComplete 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISACL6000.frx":04E4
   End
   ...
   Begin FPSpread.vaSpread tblResult 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISACL6000.frx":0D26
   End
   ...
   End
End
Attribute VB_Name = "frmIISACL6000"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
'-----------------------------------------------------------------------------'
'   파일명  : frmIISACL6000.frm
'   작성자  : 이상대
'   내  용  : ACL 6000 장비폼
'   작성일  : 2004-08-24
'   버  전  :
...
Private Sub EditRcvData()
    ...
    Dim strUnit      As String   '수신한 결과단위
    ...
    For Each objBuffer In mIntLib.Buffers
        ...
        Select Case strType
            ...
            Case "R"    '## Result
                ...
                strUnit = UCase$(mGetP(strRcvBuf, 5, "|"))
                
                If strUnit = "S" Or strUnit = "R" Or strUnit = "%" Then
                    strIntBase = strIntBase & strUnit
                End If
