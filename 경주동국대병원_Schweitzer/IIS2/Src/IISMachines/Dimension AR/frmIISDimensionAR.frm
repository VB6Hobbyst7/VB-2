...
Begin VB.Form frmIISDimensionAR 
   BackColor       =   &H00DBE6E6&
   Caption         =   "Dimension AR"
   ClientHeight    =   9180
   ClientLeft      =   165
   ClientTop       =   450
   ClientWidth     =   15240
   ...
   Begin FPSpread.vaSpread tblReady 
      ...
      SpreadDesigner  =   "frmIISDimensionAR.frx":0000
   End
   Begin FPSpread.vaSpread tblComplete 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISDimensionAR.frx":04EF
   End
   ...
   Begin FPSpread.vaSpread tblResult 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISDimensionAR.frx":0D31
      TextTip         =   2
   End
End
Attribute VB_Name = "frmIISDimensionAR"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
'-----------------------------------------------------------------------------'
'   파일명  : frmIISDimensionAR.frm
'   작성자  : 이상대
'   내  용  : Dimension AR 장비폼
'   작성일  : 2004-06-21
'   버  전  :
'   병  원  :
'       1. 동국대 경주병원
...
Private Sub EditRcvData()
    ...
    Select Case strType
        ...
        Case "I"    '## Query Message
            ...
            '## 접수정보 조회, 오더전송
            Call GetOrder(Format$(strBarNo, String$(SPCLEN, "#")))
        ...
        Case "R"    '## Result Message
            ...
            strBarNo = Format$(Trim$(mGetP(strRcvBuf, 4, FS)), String$(SPCLEN, "#"))
...
On Error GoTo Errors
    ...
    With MSComm
        ...
        If .PortOpen Then
            ...
            Error.SetLog App.EXEName, "frmIISDimensionAR", "GetEqpComm", strErrMsg, Now
