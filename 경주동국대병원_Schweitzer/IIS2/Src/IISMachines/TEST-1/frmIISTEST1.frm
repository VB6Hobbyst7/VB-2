...
Begin VB.Form frmIISTEST1 
   ...
   Begin FPSpread.vaSpread tblComplete 
      ...
      SpreadDesigner  =   "frmIISTEST1.frx":0000
   End
   ...
   Begin FPSpread.vaSpread tblResult 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISTEST1.frx":07AF
      TextTip         =   2
   End
End
Attribute VB_Name = "frmIISTEST1"
...
Private strResult   As String   '수신한 결과값
...
Private Sub EditRcvData()
    ...
    If strType = "R" Then
        '## 바코드번호 조회
        strBarNo = Mid$(Trim$(Mid$(strRcvBuf, 5, 11)), 1, SPCLEN)
        '-- RackNo/Pos 추가 s.w,oh (2007.03.28)
...
Private Sub SaveServer(ByVal pIntInfo As clsIISIntInfo)
    ...
    Else
        ...
        If strResult = "NF" Or strResult = "NR" Or InStr(strResult, "*") Then
        Else
