...
Private Function GetNumber(ByVal pResult As String) As String
    ...
    Dim sngResult   As Single   '정수부 결과
    Dim lngFlag     As Long     '지수부 결과
    Dim Pos         As Long
...
'-----------------------------------------------------------------------------'
'   기능 : 수신한 Result Status에 대한 상세설명 조회
'-----------------------------------------------------------------------------'
