...
Begin VB.Form frmIISKX21 
   ...
   Begin FPSpread.vaSpread tblReady 
      ...
      SpreadDesigner  =   "frmIISKX21.frx":0000
   End
   Begin FPSpread.vaSpread tblComplete 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISKX21.frx":04CB
   End
   ...
   Begin FPSpread.vaSpread tblResult 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISKX21.frx":0D0D
      TextTip         =   2
   End
...
Private Sub EditRcvData()
    ...
    Dim strDisCode  As String   '수신한 Sample distinction code
    ...
    '## 바코드번호 조회
    strWorkNo = Format$(Mid$(strRcvBuf, 11, 12), "#")
    With tblReady
    ...
    For Each objIntNm In mIntLib.IntNms
        ...
        If strTemp <> strIntBase Then
            ...
            If strResult <> "" Then
                ...
                Call objIntInfo.IntResults.Add(objIntNm.IntBase, objIntNm.IntNm, _
...
On Error GoTo Errors
    ...
    With MSComm
        ...
        If .PortOpen Then
            ...
            Error.SetLog App.EXEName, "frmIISKX21", "GetEqpComm", strErrMsg, Now
...
Private Function GetInfo(ByVal pFlag As String)
    ...
    Select Case pFlag
        Case "0"    '## Normal
        Case "1":   strInfo = "Abnormality judgment is +"
        Case "2":   strInfo = "Abnormality judgment is -"
        Case "3":   strInfo = "Out of linearity limit."
        Case "4":   strInfo = "Reliability is now"
    End Select
