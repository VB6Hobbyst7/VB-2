...
Begin VB.Form frmIISModularDPE 
   BackColor       =   &H00DBE6E6&
   Caption         =   "Modular DPE"
   ClientHeight    =   9180
   ClientLeft      =   165
   ...
   Begin FPSpread.vaSpread tblReady 
      ...
      SpreadDesigner  =   "frmIISModularDPE.frx":0000
   End
   Begin FPSpread.vaSpread tblComplete 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISModularDPE.frx":04FA
   End
   ...
   Begin FPSpread.vaSpread tblResult 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISModularDPE.frx":0D3C
      TextTip         =   2
   End
End
Attribute VB_Name = "frmIISModularDPE"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
'-----------------------------------------------------------------------------'
'   파일명  : frmIISModularDPE.frm
'   작성자  : 이상대
'   내  용  : Modular DPE 장비폼
'   작성일  : 2005-06-27
'   버  전  :
...
On Error GoTo Errors
    ...
    With MSComm
        ...
        If .PortOpen Then
            ...
            Error.SetLog App.EXEName, "frmIISModularDPE", "GetEqpComm", strErrMsg, Now
