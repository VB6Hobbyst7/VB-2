...
Begin VB.Form frmIISABL555 
   ...
   Begin FPSpread.vaSpread tblReady 
      ...
      SpreadDesigner  =   "frmIISABL555.frx":0000
   End
   Begin FPSpread.vaSpread tblComplete 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISABL555.frx":04E4
   End
   ...
   Begin FPSpread.vaSpread tblResult 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISABL555.frx":0D26
   End
   ...
   End
End
Attribute VB_Name = "frmIISABL555"
...
'       2. 1.0.3: 이상대(2005-06-24)
'       3. 1.0.4: 이상대(2005-06-29)
'   병  원  :
'       1. 동국대 경주병원
'       2. 단국대병원
'-----------------------------------------------------------------------------'
