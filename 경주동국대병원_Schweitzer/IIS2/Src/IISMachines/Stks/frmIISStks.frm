...
Begin VB.Form frmIISStks 
   ...
   Begin FPSpread.vaSpread tblComplete 
      ...
      SpreadDesigner  =   "frmIISStks.frx":0000
   End
   ...
   Begin FPSpread.vaSpread tblResult 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISStks.frx":08C6
      TextTip         =   2
   End
End
Attribute VB_Name = "frmIISStks"
...
'   파일명  : frmIISStks.frm
'   작성자  : 이상대
'   내  용  : Coulter Stks 장비폼
'   작성일  : 2004-10-06
'   버  전  :
'       1. 1.0.1: 이상대(2004-12-07)
...
Private mOrder      As clsIISIntOrder           'Stks 장비 클래스
...
Private Sub EditRcvData()
    ...
    Dim strCass     As String   '수신한 Cassette No
    ...
    For Each objIntNm In mIntLib.IntNms
        ...
        If strIntBase <> strTemp Then
            ...
            If Pos1 > 0 Then
                ...
                '   - MCHC결과가 장비에서 전송시 이상하게 표현되어 수정
                If strIntBase = "MCHC" Then
                    strResult = Trim$(Mid$(strRcvBuf, Pos1 + Len(strIntBase), 6))
                Else
                    strResult = Trim$(Mid$(strRcvBuf, Pos1 + Len(strIntBase) + 1, 6))
                End If
                Debug.Print strIntBase & ": " & strResult
                
                '## 결과값에 대해 Numeric만 체크할것!
...
On Error GoTo Errors
    ...
    With MSComm
        ...
        If .PortOpen Then
            ...
            Error.SetLog App.EXEName, "frmIISStks", "GetEqpComm", strErrMsg, Now
