...
'       2. 1.0.2: 이상대(2005-05-27)
'       3. 1.0.3: 이상대(2005-06-29)
'       4. 1.1.0: 이상대(2005-07-01)
'   병  원  :
'       1. 동국대 경주병원
'       2. 단국대병원
'   메  모  : NOTE 확인할것!
...
Private Sub cmdSend_Click()
    ...
    With tblReady
        For i = 1 To .DataRowCnt
            ...
            If Trim$(vOrdChk) = "" Or Trim$(vOrdChk) = "전송중" Then
...
Private Sub SendOrder()
    ...
    With tblReady
        ...
        If lngTotCnt = lngSndCnt Then
            .Col = TReadyEnum.ccOrdChk: .Text = "전송"
            ...
            End If
        Else
            .Col = TReadyEnum.ccOrdChk: .Text = "전송중"
            mIntLib.SndPhase = 1
        End If
...
'-----------------------------------------------------------------------------'
'   기능 : 해당 바코드번호의 모든 항목이 결과수신을 했는지 확인 - 1.1.0: 이상대(2005-07-01)
