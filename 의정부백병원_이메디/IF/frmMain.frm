...
On Error GoTo ErrHandle
    ...
    '002301510119112200662602200834   001000002
    '      51 =결과
    ...
    With frmMain
        ...
        '1 = O4ZU70QN0....  48
        '1 = 199297.......   6
        strRcvBuf = Trim(mGetP(RcvBuffer, 1, ""))
        
        If Mid(strRcvBuf, 7, 2) <> "51" Then
            Exit Sub
        End If
        ...
        If Len(strRcvBuf) < 20 Then
            Exit Sub
        End If
        strBarno = Mid(strRcvBuf, 11, 10)
        strIntBase = "ESR"
        
        strRcvBuf = Trim(mGetP(RcvBuffer, 2, ""))
        strResult = Trim(Mid(strRcvBuf, 11, 4))
        
        'strResult = Replace(strResult, vbCr, "")
        'strResult = Replace(strResult, vbLf, "")
        'strResult = Trim(strResult)
        
        '-- 2019-10-18 AMR적용 : >140
        If IsNumeric(strResult) Then
            If CCur(strResult) > 140 Then
                strResult = ">140"
            End If
        End If
        
        If UCase(Mid(strBarno, 1, 6)) = "SAMPLE" Then
            Exit Sub
        End If
...
ErrHandle:
    strErrMsg = ""
    strErrMsg = strErrMsg & "위    치 : " & gHOSP.MACHNM & "_SerialRcvData_VESCUBE30" & vbNewLine & vbNewLine
    strErrMsg = strErrMsg & "오류번호 : " & Err.Number & vbNewLine & vbNewLine
    strErrMsg = strErrMsg & "오류내용 : " & Err.Description & vbNewLine
    frmErrMsg.txtErr = vbNewLine & strErrMsg
    frmErrMsg.Show
