...
Begin VB.Form frmComSetup 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.TextBox txtLocalPort 
         ...
         Width           =   945
      End
      Begin BHButton.BHImageButton cmdIPEdit 
         Height          =   300
         Left            =   4560
         TabIndex        =   83
         Top             =   390
         ...
         ImgOutLineSize  =   3
      End
      Begin BHButton.BHImageButton cmdPortEdit 
         Height          =   300
         Left            =   3420
         TabIndex        =   84
         Top             =   750
...
Private Sub cmdIPEdit_Click()
    
    Call WritePrivateProfileString("CONFIG", "HUMAIP", txtHumaIP.text, App.Path & "\Interface.ini")

End Sub

Private Sub cmdPortEdit_Click()
    
    Call WritePrivateProfileString("CONFIG", "PORT", txtLocalPort.text, App.Path & "\Interface.ini")
