...
Begin VB.Form frmMain 
   ...
   Begin FPSpread.vaSpread spdWork 
      ...
      ShadowColor     =   16777215
      SpreadDesigner  =   "frmMain.frx":8B84
      ScrollBarTrack  =   3
      ShowScrollTips  =   3
   End
...
RST:
    strErrMsg = ""
    strErrMsg = strErrMsg & "위    치 : " & gHOSP.MACHNM & "_SerialRcvData_PPC125" & vbNewLine & vbNewLine
    strErrMsg = strErrMsg & "오류번호 : " & Err.Number & vbNewLine & vbNewLine
    strErrMsg = strErrMsg & "오류내용 : " & Err.Description & vbNewLine
    frmErrMsg.txtErr = vbNewLine & strErrMsg
    'frmErrMsg.Show
...
Private Sub SendOrder_PPC125()
    ...
    Select Case intSndPhase
        ...
        Case 2  '## Patient
            ...
            'strOutput = intFrameNo & "P|1||" & mOrder.BarNo & "^" & mOrder.BarNo & "||" & "" & "|||||||||^" & vbCr & ETX
