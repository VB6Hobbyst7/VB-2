...
Begin VB.Form frmInterface 
      ...
      Begin MSComctlLib.ImageList imlStatus 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmInterface.frx":5AE4
               Key             =   "NOT"
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmInterface.frx":607E
               Key             =   "STOP"
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmInterface.frx":6618
               Key             =   "LST"
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmInterface.frx":6EAA
               Key             =   "ITM"
            EndProperty
            BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmInterface.frx":7004
               Key             =   "ERR"
            EndProperty
            BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmInterface.frx":715E
               Key             =   "NOF"
            EndProperty
            BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmInterface.frx":72B8
               Key             =   "ON"
               Object.Tag             =   "OFF"
            EndProperty
            BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmInterface.frx":7B92
               Key             =   ""
            EndProperty
         EndProperty
      End
   ...
   Begin FPSpread.vaSpread spdOrder 
      ...
      SpreadDesigner  =   "frmInterface.frx":9600
      ScrollBarTrack  =   3
      ShowScrollTips  =   3
   End
   Begin FPSpread.vaSpread spdResult 
      ...
      ScrollBarExtMode=   -1  'True
      ShadowColor     =   16777215
      SpreadDesigner  =   "frmInterface.frx":B514
      ScrollBarTrack  =   3
      ShowScrollTips  =   3
   End
   ...
   Begin VB.PictureBox picBottom 
      ...
      Begin VB.Image imgReceive 
         Height          =   240
         Left            =   8730
         Picture         =   "frmInterface.frx":101E5
         Top             =   180
         Width           =   240
      End
      ...
      Begin VB.Image imgNet1 
         Height          =   240
         Left            =   390
         Picture         =   "frmInterface.frx":1076F
         Top             =   180
         Width           =   240
      End
      Begin VB.Image imgNet2 
         Height          =   240
         Left            =   390
         Picture         =   "frmInterface.frx":108B9
         Top             =   180
         Width           =   240
      End
      Begin VB.Image imgNet3 
         Height          =   240
         Left            =   390
         Picture         =   "frmInterface.frx":10A03
         Top             =   180
         Width           =   240
      End
   ...
   Begin FPSpread.vaSpread spdWork 
      ...
      ScrollBarExtMode=   -1  'True
      ShadowColor     =   16777215
      SpreadDesigner  =   "frmInterface.frx":10B4D
      ScrollBarTrack  =   3
      ShowScrollTips  =   3
   End
End
...
'        Call SetText(spdWork, "1234" & CStr(i), i, colBARCODE)
'        Next
'    End With
...
Private Sub ReceiveProcess()
    ...
    ElseIf gComm.COMTYPE = "2" Then
        Select Case UCase(gHOSP.MACHNM)
            ...
            'Case "BC6200":          Call Phase_TCP_BC6200
...
On Error GoTo ErrHandle
    ...
    With frmInterface
     ...
     '       strRcvBuf = RcvBuffer
            ...
            Select Case strType
                Case "MSH"
                    '오더요청           : MSH|^~\&||Mindray|||20081120174836||ORM^O01|4|P|2.3.1||||||UNICODE
                    '검사결과(Sample)   : MSH|^~\&||Mindray|||20111124091140||ORU^R01|1|P|2.3.1||||||UNICODE
                    '검사결과(QC)       : MSH|^~\&||Mindray|||20111124091422||ORU^R01|1|Q|2.3.1||||||UNICODE
                    
                    strOldBarno = ""
                    mOrder.MsgType = mGetP(strRcvBuf, 9, "|")       'ORM^O01 or ORU^R01
                    mOrder.MsgCtrlID = mGetP(strRcvBuf, 10, "|")    'HL7 Message Control ID
                    mOrder.TstType = mGetP(strRcvBuf, 11, "|")      'P or Q
                
                    '검사결과일때 Response Message
                ...
                Case "OBR"
                    'QC     :   OBR|1||1|00003^LJ QCR^99MRC|||20201210085221|||||||||||||||||HM||||||||User
                    'Sample :   OBR|1||2012100197|00001^Automated Count^99MRC|||20201210113216|||||||||||||||||HM||||||||User
                    ...
                    Call SetSQLData("RCV", "mResult.BarNo:" & mResult.BarNo & vbCrLf, "A")
                    Call SetSQLData("RCV", "strOldBarno:" & strOldBarno & vbCrLf, "A")
                    
                    If mResult.BarNo <> "" Then
                        If Trim(mResult.BarNo) <> Trim(strOldBarno) Then
                            strOldBarno = mResult.BarNo
                            With mResult
                                .BarNo = Trim(strBarno)
                                .RsltDate = Format(Now, "yyyy-mm-dd")
                                .RsltTime = Format(Now, "hh:mm:ss")
        ...
        If cn_Server_Flag = True And gHOSP.SAVEAUTO = "Y" And strState = "R" Then
            ...
            If Res = -1 Then
                '-- 저장 실패
                Call SetForeColor(.spdOrder, gRow, gRow, 1, colSTATE, 255, 0, 0)
                Call SetText(.spdOrder, "저장실패", gRow, colSTATE)
            Else
                '-- 저장 성공
                Call SetBackColor(.spdOrder, gRow, gRow, 1, colSTATE, 202, 255, 112)
                Call SetText(.spdOrder, "저장완료", gRow, colSTATE)
...
On Error GoTo ErrHandle
    ...
    With frmInterface
        ...
        Else
            ...
            strSend = strSend & "PID|1||" & mOrder.PID & "^^^^MR||^" & mOrder.PID & "|||" & vbCr
    ...
    If KeyCode = vbKeyReturn Then
        ...
        ElseIf sCol > colSTATE And sCol <= spdOrder.MaxCols Then
            If strNewBarNo = "" Then
                Exit Sub
            End If
            strSaveSeq = GetText(spdOrder, sRow, colSAVESEQ)
