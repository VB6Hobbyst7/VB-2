...
Private Sub txtID_KeyPress(KeyAscii As Integer)
    ...
    If KeyAscii = vbKeyReturn Then
        ...
        If Len(txtID.Text) = 8 Then
            frmMain.txtSCLID.Text = txtID.Text
            frmMain.Show
            Unload Me
        End If
    End If
    ...
    If KeyAscii = vbKeyReturn Then
        If UCase(txtID.Text) = "OKSOFT" And UCase(txtPW.Text) = "0810" Then
            ...
            If chkSave.Value = "1" Then
                ...
                Call WritePrivateProfileString("HOSP", "USERID", txtID.Text, App.PATH & "\INI\" & gHOSP.APPNM & ".ini")
                Call WritePrivateProfileString("HOSP", "USERNM", lblUserNm.Caption, App.PATH & "\INI\" & gHOSP.APPNM & ".ini")
                Call WritePrivateProfileString("HOSP", "USERPW", strPW, App.PATH & "\INI\" & gHOSP.APPNM & ".ini")
