...
'공통
Global AdoCn_SCL            As ADODB.Connection
Global AdoRs_SCL            As ADODB.Recordset
Global AdoCmd_SCL           As ADODB.Command
Global AdoParm_SCL          As ADODB.Parameter
...
'-- SCL 연결
Public Function DbConnect_SCL() As Boolean
    ...
    Set AdoCn_SCL = New ADODB.Connection
...
'''    If (ServerName = "") Or (DatabaseName = "") Then
'''       DbConnect_SCL = False
'''       Set AdoCn_SCL = Nothing
'''       Exit Function
'''    End If
    'ID : IFB06_H , PW : b06_hh_60b
    With AdoCn_SCL
        adoConnectionString = "dsn=HanaroLab;" & _
                              "uid=" & "IFB06_H" & ";" & _
                              "pwd=" & "b06_hh_60b" & ";" & _
                              "database=HLISDLIB"
