...
Begin VB.Form frmMain 
   ...
   Begin VB.Frame FraHidden 
      ...
      Begin FPSpread.vaSpread spdQcResult 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmMain.frx":5123
      End
      Begin VB.Image imgDelete 
         Height          =   1260
         Left            =   1710
         Picture         =   "frmMain.frx":535C
         Top             =   9030
         Visible         =   0   'False
         Width           =   1290
      End
   ...
   Begin VB.PictureBox Picture2 
      ...
      Begin VB.Frame fraResult 
         ...
         Begin VB.ComboBox cboRstType 
            Appearance      =   0  '평면
            Height          =   300
            ItemData        =   "frmMain.frx":8EBF
            Left            =   420
            List            =   "frmMain.frx":8EC1
            TabIndex        =   129
            Top             =   180
            Width           =   1245
         End
         Begin VB.ComboBox cboState 
            Height          =   300
            ItemData        =   "frmMain.frx":8EC3
            Left            =   4710
            List            =   "frmMain.frx":8EC5
            TabIndex        =   128
            Top             =   180
            Width           =   1395
         End
   ...
   Begin VB.Frame frame2 
      ...
      Begin FPSpread.vaSpread spdRResult 
         ...
         SpreadDesigner  =   "frmMain.frx":C266
         TextTip         =   2
      End
      Begin FPSpread.vaSpread spdROrder 
         ...
         SpreadDesigner  =   "frmMain.frx":CC46
         UserResize      =   2
      End
   ...
   Begin VB.Frame frame4 
      ...
      Begin VB.Frame frameCom 
         ...
         Begin VB.ComboBox cboPort 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmMain.frx":11D68
            Left            =   2190
            List            =   "frmMain.frx":11D6A
            TabIndex        =   63
            Top             =   390
            Width           =   2205
         End
         Begin VB.ComboBox cboBaudrate 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmMain.frx":11D6C
            Left            =   2190
            List            =   "frmMain.frx":11D6E
            TabIndex        =   62
            Top             =   780
            Width           =   2205
         End
         Begin VB.ComboBox cboDatabit 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmMain.frx":11D70
            Left            =   2190
            List            =   "frmMain.frx":11D72
            TabIndex        =   61
            Top             =   1170
            Width           =   2205
         End
         ...
         Begin VB.ComboBox cboParity 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmMain.frx":11D74
            Left            =   2190
            List            =   "frmMain.frx":11D76
            TabIndex        =   58
            Top             =   2520
            Width           =   2205
         End
   ...
   Begin VB.Frame frame3 
      ...
      Begin VB.Frame frameTestSet 
         ...
         Begin VB.Frame frameOrder 
            ...
            Begin FPSpread.vaSpread spdOrdMst 
               ...
               SelectBlockOptions=   0
               ShadowColor     =   13697023
               SpreadDesigner  =   "frmMain.frx":134F4
               TextTip         =   2
            End
         End
         Begin VB.ComboBox cboResultType 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmMain.frx":13A51
            Left            =   1650
            List            =   "frmMain.frx":13A53
            TabIndex        =   43
            Top             =   5220
            Visible         =   0   'False
            Width           =   1575
         ...
         Begin VB.Frame frameCutOff 
            ...
            Begin VB.ComboBox cboCOH 
               ...
               EndProperty
               Height          =   315
               ItemData        =   "frmMain.frx":13A55
               Left            =   2730
               List            =   "frmMain.frx":13A57
               TabIndex        =   39
               Top             =   1020
               Width           =   735
            End
            ...
            Begin VB.ComboBox cboCOL 
               ...
               EndProperty
               Height          =   315
               ItemData        =   "frmMain.frx":13A59
               Left            =   2730
               List            =   "frmMain.frx":13A5B
               TabIndex        =   30
               Top             =   300
               Width           =   735
            End
      ...
      Begin FPSpread.vaSpread spdTest 
         ...
         RetainSelBlock  =   0   'False
         SelectBlockOptions=   0
         SpreadDesigner  =   "frmMain.frx":17513
      End
   End
   Begin VB.Frame frame1 
      ...
      Begin FPSpread.vaSpread spdOrder 
         ...
         SelectBlockOptions=   0
         ShadowColor     =   14548991
         SpreadDesigner  =   "frmMain.frx":18420
         UserResize      =   2
      End
      Begin FPSpread.vaSpread spdResult 
         ...
         SelectBlockOptions=   0
         ShadowColor     =   13697023
         SpreadDesigner  =   "frmMain.frx":1C98C
         TextTip         =   2
      End
   End
...
Private Sub cmdRSave_Click()
    ...
    For lRow = 1 To spdROrder.DataRowCnt
        ...
        If spdROrder.Value = 1 Then
            strBarcode = GetText(spdROrder, lRow, colBARCODE)
            
            '-- BIORAD QC 저장
            If Mid(strBarcode, 1, 5) = "LATEX" Then
                strIntBase = "ESR"
                strResult = GetText(spdROrder, lRow, colSTATE + 1)
                If strResult = "" Then
                    strResult = GetText(spdROrder, lRow, colSTATE + 2)
                End If
                If strResult = "" Then
                    strResult = GetText(spdROrder, lRow, colSTATE + 3)
                End If
                ...
                strBarcode = Mid(strBarcode, 6)
                strQCData = GetQCResult_Detail_Type2(gHOSP.LABCD, strBarcode, strQCAnalyte, strResult)
                Call SendBioRadQC(strQCData)
                'MsgBox strQCData
            Else
                If Len(strBarcode) = 9 Then
                    Res = SaveTransData_HANARO_ROLLER20_R(lRow)
                ElseIf Len(strBarcode) = 12 Then
                    Res = SaveTransData_SCL(lRow, spdROrder)
                Else
                    '-- BIORAD QC 저장
                    If Mid(strBarcode, 1, 5) = "LATEX" Then
                        strIntBase = "ESR"
                        strResult = GetText(spdOrder, lRow, colSTATE + 1)
                        If strResult = "" Then
                            strResult = GetText(spdOrder, lRow, colSTATE + 2)
                        End If
                        If strResult = "" Then
                            strResult = GetText(spdOrder, lRow, colSTATE + 3)
                        End If
...
Private Sub lblSave_Click()
    ...
    For lRow = 1 To spdOrder.DataRowCnt
        ...
        If spdOrder.Value = 1 Then
            strBarcode = GetText(spdOrder, lRow, colBARCODE)
            
            
            If Len(strBarcode) = 9 Then
                Res = SaveTransData_HANARO_ROLLER20(lRow)
            ElseIf Len(strBarcode) = 12 Then
                Res = SaveTransData_SCL(lRow, spdOrder)
            Else
                '-- BIORAD QC 저장
                If Mid(strBarcode, 1, 5) = "LATEX" Then
                    strIntBase = "ESR"
...
RST:
                ...
                strErrMsg = "위    치 : " & gHOSP.MACHNM & "_SerialRcvData_VERSACELL" & vbNewLine & vbNewLine
...
Private Sub Phase_Serial_ROLLER20()
    Dim Buffer      As Variant
    Dim BufChar     As String
    Dim lngBufLen   As Long
    Dim i           As Long
        ...
        Select Case intPhase
            ...
            Case 2
                Select Case BufChar
                    Case ETX
                        intPhase = 1
                        dtpToday.Value = Format(Now, "yyyy-mm-dd")
                        
                        Call SerialRcvData_ROLLER20
...
RST:
                ...
                strErrMsg = "위    치 : " & gHOSP.MACHNM & "_Phase_Serial_ROLLER20" & vbNewLine & vbNewLine
    strErrMsg = strErrMsg & "오류번호 : " & Err.Number & vbNewLine & vbNewLine
    strErrMsg = strErrMsg & "오류내용 : " & Err.Description & vbNewLine
    strErrMsg = strErrMsg & "ORDER    : " & mOrder.BarNo & vbNewLine
    strErrMsg = strErrMsg & "RESLLT   : " & mResult.BarNo & vbNewLine
...
Private Function GetEquipExamCode_VERSACELL(argEquipCode As String, argPID As String, Optional intRow As Long) As String
    ...
    If Not AdoRs_Local.EOF = True And Not AdoRs_Local.BOF = True Then
        Do Until AdoRs_Local.EOF
            If AdoRs_Local.Fields("SENDCHANNEL").Value & "" <> "990" Or AdoRs_Local.Fields("SENDCHANNEL").Value & "" <> "" Then
...
'                    2R|4|^^^aHCV^^^1^RLU|18780||||N|F||||20170902110124|CENTAURXP
                    ...
                    'If strAspect = "INDX" Or strAspect = "INTR" Or strAspect = "DOSE" Or strAspect = "RLU" Or strAspect = "COFF" Then
                        ...
                        ElseIf strIntBase = "aHCV" Then
                            '-- 2018.03.19 수정 : Reactive를 Positive로, Non-reactive를 Negative로
'                            strIntBase = strIntBase & "_" & strAspect
'                            If strAspect = "INTR" Then
'                                strINTRResult = strIntResult
'                            End If
...
'                            End If
                    ...
                    Else
                        'RPR
                        If strIntBase = "S-RPR" Then
                            If IsNumeric(strIntResult) Then
                                If strIntResult > 1 Then
                                    strResult = "POSITIVE" & "(" & strIntResult & ")"
                                Else
                                    If strIntResult < 0.2 Then
                                        strResult = "NEGATIVE" & "(<0.2)"
                                    Else
                                        strResult = "NEGATIVE" & "(" & strIntResult & ")"
                                    End If
                                End If
...
'CREA_2  C3750N3 CREA(단회)
'UPRO_2  C2200-1 TP(단회뇨)
...
Private Sub SerialRcvData_ROLLER20()
    Dim RS_L            As ADODB.Recordset
    Dim strRcvBuf       As String   '수신한 Data
    Dim strType         As String   '수신한 Record Type
    'Dim strOldBarno        As String   '수신한 바코드번호
...
On Error GoTo RST
    ...
    With frmMain
        For intCnt = 1 To UBound(strRData)
            ...
            If InStr(strRcvBuf, "LATEX") > 0 Then
                mResult.Kind = "QC"
                .spdQcResult.MaxRows = 0
            Else
                mResult.Kind = ""
            ...
            With mResult
                ...
                '.SpcPos = strTubePos & "/" & strRackNo
                '.Seq = strSeq
                .RackNo = strRackNo 'mResult.EqpCd
                .TubePos = strTubePos ' Mid(strEqpNm, 1, 3)
                .RsltDate = Format(Now, "yyyymmddhhmmss")
                .RsltSeq = getMaxTestNum(Format(frmMain.dtpToday, "yyyymmdd"))
            ...
            If strIntBase <> "" And strResult <> "" And strResult <> "ERROR" Then
                If gPatOrdCd <> "" Then
                    SQL = ""
                    SQL = SQL & "SELECT TESTCODE,TESTNAME,SEQNO,REFLOW,REFHIGH " & vbCrLf
                    SQL = SQL & "      ,QCLab, QCLot, QCAnalyte, QCMethod, QCInstrument,QCReagent, QCUnit, QCTemp" & vbCrLf
                    ...
                    If Not RS_L.EOF = True And Not RS_L.BOF = True Then
                        ...
                        'strJudge = SetJudge(strResult, strIntBase)
                        strJudge = SetJudge_Hanaro_Roller20(strResult, strIntBase, mResult.SEX)
...
'                        End If
                        ...
                        For intCol = colSTATE + 1 To .spdOrder.MaxCols
                            If lsTestCode = Trim(gArrEQP(intCol - colSTATE, 2)) Then
                                ...
                                lsTestCodeSub = gArrEQP(intCol - colSTATE, 16)
                        ...
                        '-- BIORAD QC 저장
                        If mResult.Kind = "QC" Then
                            strBarno = Mid(strBarno, 6)
                            strQCData = GetQCResult_Detail_Type2(gHOSP.LABCD, strBarno, strQCAnalyte, strResult)
                            Call SendBioRadQC(strQCData)
                            SetText .spdOrder, "QC저장", gRow, colSTATE
                        End If
...
'                        End If
            ...
            If gHOSP.SAVEAUTO = "Y" And strState = "R" Then
                If Len(mResult.BarNo) = 9 Then
                    Res = SaveTransData_HANARO_ROLLER20(gRow)
                ElseIf Len(mResult.BarNo) = 12 Then
                    Res = SaveTransData_SCL(gRow, spdOrder)
                End If
...
RST:
                ...
                strErrMsg = "위    치 : " & gHOSP.MACHNM & "_SerialRcvData_ROLLER20" & vbNewLine & vbNewLine
    strErrMsg = strErrMsg & "오류번호 : " & Err.Number & vbNewLine & vbNewLine
    strErrMsg = strErrMsg & "오류내용 : " & Err.Description & vbNewLine
    strErrMsg = strErrMsg & "ORDER    : " & mOrder.BarNo & vbNewLine
    strErrMsg = strErrMsg & "RESLLT   : " & mResult.BarNo & vbNewLine
...
Private Sub SerialRcvData_OSMOPRO()
    Dim RS_L            As ADODB.Recordset
    Dim strRcvBuf       As String   '수신한 Data
    Dim strType         As String   '수신한 Record Type
    'Dim strOldBarno        As String   '수신한 바코드번호
