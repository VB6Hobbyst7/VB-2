...
Begin VB.Form frmIISGem5000_OP 
   BackColor       =   &H00DBE6E6&
   Caption         =   "Gem5000"
   ClientHeight    =   9180
   ClientLeft      =   165
   ...
   Begin FPSpread.vaSpread tblReady 
      ...
      SpreadDesigner  =   "frmIISGem5000_OP.frx":0000
   End
   Begin FPSpread.vaSpread tblComplete 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISGem5000_OP.frx":046B
   End
   ...
   Begin FPSpread.vaSpread tblResult 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISGem5000_OP.frx":0C1A
   End
   ...
   End
End
Attribute VB_Name = "frmIISGem5000_OP"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
'-----------------------------------------------------------------------------'
'   파일명  : frmIISGem5000.frm
'   작성자  : 오세원
'   내  용  : Gem 5000 장비폼
'   작성일  : 2019-01-07
'   병  원  : 전주예수병원
...
Private Sub Command1_Click()
    strTransData = ""
'    strTransData = strTransData & "H|\^&|||GEM 3000^V4.0r2^7040^999^123456^1.00|||||||||19980922142358" & vbCrLf
'    strTransData = strTransData & "P|1||1234567812345678||^BLAKE^LINDSEY" & vbCrLf
'    strTransData = strTransData & "O|1|99999|123||||||||||||A" & vbCrLf
'    strTransData = strTransData & "R|1|^^^pH|7.22|||||||123456789||19980922142357" & vbCrLf
'    strTransData = strTransData & "R|2|^^^pCO2|62|mmHg" & vbCrLf
'    strTransData = strTransData & "R|3|^^^pO2| 81|mmHg" & vbCrLf
'    strTransData = strTransData & "R|4|^^^Na+|131.1|mmol/L" & vbCrLf
'    strTransData = strTransData & "R|5|^^^K+|5.14|mmol/L" & vbCrLf
'    strTransData = strTransData & "R|6|^^^Ca++|1.14|mmol/L" & vbCrLf
'    strTransData = strTransData & "R|7|^^^Hct|65|%||>" & vbCrLf
'    strTransData = strTransData & "R|8|^^^Ca++(7.4)|1.14|mmol/L" & vbCrLf
'    strTransData = strTransData & "R|9|^^^HCO3-|25.3|mmol/L" & vbCrLf
'    strTransData = strTransData & "R|10|^^^HCO3std|25.3|mmol/L" & vbCrLf
'    strTransData = strTransData & "R|11|^^^TCO2|27.2|mmol/L" & vbCrLf
'    strTransData = strTransData & "R|12|^^^BEecf||||C" & vbCrLf
'    strTransData = strTransData & "R|13|^^^BE(B)||||C" & vbCrLf
'    strTransData = strTransData & "R|14|^^^SO2c||||C" & vbCrLf
'    strTransData = strTransData & "R|15|^^^%FiO2|100|%" & vbCrLf
'    strTransData = strTransData & "L|1" & vbCrLf
'    strTransData = strTransData & ""

    strTransData = strTransData & "1H|\^&|||GEM 3000^5.6.0     ^19894^^510849^2.4|||||||||20070717113726" & vbCrLf
    'strTransData = strTransData & "P|1||170003880944" & vbCrLf
    strTransData = strTransData & "P|1||100022305429" & vbCrLf
    strTransData = strTransData & "O|1||22||||||||||||A" & vbCrLf
    strTransData = strTransData & "R|1|^^^BE(B)||mmol/L||C||||||20070717113724" & vbCrLf
    strTransData = strTransData & "R|2|^^^Ca++|0.42|mmol/L" & vbCrLf
    strTransData = strTransData & "R|3|^^^Glu|500|mg/dL||>" & vbCrLf
    strTransData = strTransData & "R|4|^^^HCO3-|3.0|mmol/L||<" & vbCrLf
    strTransData = strTransData & "R|5|^^^HCO3st75" & vbCrLf

'    strTransData = strTransData & "[P C] "

    strTransData = strTransData & "2d||mmol/L||C" & vbCrLf
    strTransData = strTransData & "R|6|^^^Hct|25|%" & vbCrLf
    strTransData = strTransData & "R|7|^^^K+|2.7|mmol/L" & vbCrLf
    strTransData = strTransData & "R|8|^^^Lac|4.7|mmol/L" & vbCrLf
    strTransData = strTransData & "R|9|^^^Na+|134|mmol/L" & vbCrLf
    strTransData = strTransData & "R|10|^^^SO2c||%||C" & vbCrLf
    strTransData = strTransData & "R|11|^^^TCO2||mmol/L||C" & vbCrLf
    strTransData = strTransData & "R|12|^^^THbc|8.5|g/dL" & vbCrLf
    strTransData = strTransData & "R|13|^^^pCO2|6|mmHg" & vbCrLf
    strTransData = strTransData & "R|14|^^^pH|7.23" & vbCrLf
    strTransData = strTransData & "R|15|^^^pO2|134|mmHg" & vbCrLf
    strTransData = strTransData & "R|16|^^^Temp|37.0|C" & vbCrLf
    strTransData = strTransData & "L|1" & vbCrLf
    strTransData = strTransData & "AB" & vbCrLf

'    strTransData = strTransData & "[P C] "

    strTransData = strTransData & "336" & vbCrLf

'    strTransData = strTransData & "[P C] "

    strTransData = strTransData & "" & vbCrLf
...
Private Sub EditRcvData()
    ...
    For Each objBuffer In mIntLib.Buffers
        ...
        Select Case strType
            ...
            Case "O"    '## Order
                '## Sample number 조회
                strWorkNo = mGetP(strRcvBuf, 4, "|")
                
                ' WorkNo 입력시(and tblReady에 리스트가 있을경우.. 즉 IF PC에서 바코드로 워크리스트를 만들었을 경우)
                ' 바코드 번호 찾아오기
            ...
            Case "R"    '## Result
                ...
                strFlag = Trim(mGetP(strRcvBuf, 7, "|"))
                
'                If strFlag <> "" Then
'                    strResult = strFlag & strIntResult
'                Else
...
On Error GoTo Errors
    ...
    With MSComm
        ...
        If .PortOpen Then
            ...
            Error.SetLog App.EXEName, "frmIISGem5000", "GetEqpComm", strErrMsg, Now
