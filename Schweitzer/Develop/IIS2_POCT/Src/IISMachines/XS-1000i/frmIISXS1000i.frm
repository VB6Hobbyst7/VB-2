...
Begin VB.Form frmIISXS1000i 
   ...
   Begin FPSpread.vaSpread tblReady 
      ...
      SpreadDesigner  =   "frmIISXS1000i.frx":0000
   End
   Begin FPSpread.vaSpread tblComplete 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISXS1000i.frx":0509
   End
   ...
   Begin FPSpread.vaSpread tblResult 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISXS1000i.frx":0D59
      TextTip         =   2
   End
End
Attribute VB_Name = "frmIISXS1000i"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
'-----------------------------------------------------------------------------'
'   파일명  : frmIISXS1000i.frm
'   작성자  : 오세원
'   내  용  : XS-1000i 장비폼
'   작성일  : 2008-07-08
'   버  전  :
...
On Error GoTo Errors
    ...
    With MSComm
        ...
        If .PortOpen Then
            ...
            Error.SetLog App.EXEName, "frmIISXS1000i", "GetEqpComm", strErrMsg, Now
