...
Begin VB.Form frmIISRapidLab348_4 
   BackColor       =   &H00DBE6E6&
   Caption         =   "RapidLab 348-4"
   ClientHeight    =   9180
   ClientLeft      =   165
   ClientTop       =   450
   ClientWidth     =   15240
   ...
   Begin FPSpread.vaSpread tblReady 
      ...
      SpreadDesigner  =   "frmIISRapidLab348_4.frx":0000
   End
   Begin FPSpread.vaSpread tblComplete 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISRapidLab348_4.frx":04F2
   End
   ...
   Begin FPSpread.vaSpread tblResult 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISRapidLab348_4.frx":0D42
      TextTip         =   2
   End
   ...
   End
End
Attribute VB_Name = "frmIISRapidLab348_4"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
'-----------------------------------------------------------------------------'
'   파일명  : frmIISRapidLab348.frm
'   작성자  : 오세원
'   내  용  : RapidLab 348 장비폼
'   작성일  : 2008-07-08
'   버  전  :
'   병  원  :
'       1. 안동성소병원
...
Private Sub Form_Unload(Cancel As Integer)
    ...
    Set frmIISRapidLab348_4 = Nothing
End Sub
...
On Error GoTo Errors
    ...
    With MSComm
        ...
        If .PortOpen Then
            ...
            Error.SetLog App.EXEName, "frmIISRapidLab348_4", "GetEqpComm", strErrMsg, Now
