...
Begin VB.Form frmIISAdvia120 
   ...
   Begin FPSpread.vaSpread tblComplete 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISAdvia120.frx":04EF
   End
   ...
   Begin FPSpread.vaSpread tblResult 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISAdvia120.frx":0D31
   End
End
...
'
'              'strDump = "LR 00017000339487 008-05           09/07/07 08:46:02   " & vbCrLf
'              strDump = "LR 00017000277935 008-05           09/07/07 08:46:02   " & vbCrLf
'    strDump = strDump & "  15.39   2 3.24   3 10.0   4 28.5   5 88.0   6 31.0   7 35.2   8 15.7  10  279  11  7.4  20 86.2  21  5.3  22  5.2  23  2.4  24  0.3  25  0.7" & vbCrLf
'    strDump = strDump & "2"
        ...
        Case "R"    '## Result
            ...
            For i = 1 To Len(strTemp) Step 9
                ...
                Else
                    strResult = IISERROR
                End If
                '2007.09.11 ANC 검사추가 ==> 인터페이스되지 않는 계산 결과 (WBC * (%NEUT / 100))
