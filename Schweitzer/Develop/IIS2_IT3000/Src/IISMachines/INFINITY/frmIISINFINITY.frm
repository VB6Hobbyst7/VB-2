...
Begin VB.Form frmIISINFINITY 
   ...
   Begin VB.Frame fraHidden 
      ...
      Begin VB.CommandButton Command1 
         ...
         Width           =   1245
      End
      Begin VB.FileListBox FileINFINITY 
         Height          =   270
         Left            =   135
         Pattern         =   "*.dat"
         TabIndex        =   13
      ...
      Begin FPSpread.vaSpread tblResult 
         ...
         SpreadDesigner  =   "frmIISINFINITY.frx":0000
         TextTip         =   2
      End
   ...
   Begin FPSpread.vaSpread tblReady 
      ...
      SpreadDesigner  =   "frmIISINFINITY.frx":06D7
   End
   Begin FPSpread.vaSpread tblComplete 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   16777215
      SpreadDesigner  =   "frmIISINFINITY.frx":0C55
   End
   ...
   End
End
Attribute VB_Name = "frmIISINFINITY"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
'-----------------------------------------------------------------------------'
'   파일명  : frmIISINFINITY.frm
'   작성자  : 오세원
'   내  용  : INFINITY 장비폼
'   작성일  : 2021-07-05
'   버  전  :
...
On Error GoTo ErrRoutine
    ...
    FileINFINITY.Refresh

    DoEvents

    For intIdx = 0 To FileINFINITY.ListCount - 1
        FileINFINITY.ListIndex = intIdx
        strSrcfile = FileINFINITY.Path & FileINFINITY.FileName     ' 원본 파일 이름을 정의합니다.
        ...
        '대상 파일 이름을 정의
        strDestFile = App.Path & "\Log\" & FileINFINITY.FileName
        '원본을 대상에 복사
...
Private Sub Get_SearchList()
    ...
    If blnRS = False Then
        MsgBox "INFINITY 조회 자료가 없습니다.", vbOKOnly + vbInformation, Me.Caption
        Exit Sub
    End If
...
Err:
    If Err.Number = "68" Then
        MsgBox mResultPath & " 는 " & Err.Description, vbOKOnly + vbCritical, "INFINITY"
        Me.MousePointer = vbDefault
...
Private Sub tmrOrder_Timer()
    ...
    If lngOrder = 0 Then
        ...
        '*** 중요 ***
        '2021-07-09 : cmdOrder_Click를 두번하는 이유는 OCS에 접수된 검사코드를 INFINITY에 전송하여는 이유때문이다.
        Call cmdOrder_Click
...
Private Sub EditRcvData()
    ...
    'H|\^&|164852||cobas infinity ^Roche Diagnostics|D4||||||P||20200827105539
    'M|1|EQU^RO^cobas infinity ^2.0|A32|20200827105539|5177
    'M|2|SAC^RO^cobas infinity ^2.0|||O371U0RB0|O371U0RB0|||20200827105516|I|||||5177|2
    'L|1|N
    
    '예수병원
    'H|\^&|1||cobas infinity ^Roche Diagnostics|D4||||||P||20210709084838
    'M|1|EQU^RO^cobas infinity ^2.0|p312|20210709084838
    'M|2|SAC^RO^cobas infinity ^2.0|||11001861754|11001861754||11001861754|20210709084819|I
    'L|1|N
