...
Begin VB.Form frmIISVitek 
   ...
   Begin FPSpread.vaSpread tblSensi 
      ...
      SpreadDesigner  =   "frmIISVitek.frx":0000
   End
   ...
   Begin FPSpread.vaSpread tblTemp 
      ...
      EndProperty
      MaxCols         =   4
      SpreadDesigner  =   "frmIISVitek.frx":045A
   End
   ...
   Begin FPSpread.vaSpread tblReady 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISVitek.frx":1CBC
      TextTip         =   2
   End
   ...
   Begin FPSpread.vaSpread tblComplete 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISVitek.frx":234F
      TextTip         =   2
   End
   ...
   Begin FPSpread.vaSpread tblMnm 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISVitek.frx":29E0
   End
...
'   작성일  : 2004-09-08
'   버  전  :
'       1. 1.1.0: 이상대(2004-12-05)
'          - 접수번호를 이용해 검사대상 리스트 조회기능 추가
'       2. 1.1.1: 이상대(2004-12-10)
'          - 검사대상, 완료 리스트에 조회된 개수를 화면에 표시기능 추가
'       3. 1.1.2: 이상대(2005-02-25)
'   병  원  :
'       1. 동국대 경주병원
'       2. 예수병원
'       3. 단국대병원
...
On Error GoTo Errors
    ...
    With MSComm
        ...
        If .PortOpen Then
            ...
            Error.SetLog App.EXEName, "frmIISVitek", "GetEqpComm", strErrMsg, Now
