...
'-----------------------------------------------------------------------------'
'   파일명  : frmIISACL9000.frm
'   작성자  : 이상대
'   내  용  : ACL 9000 장비폼
'   작성일  : 2005-02-23
'   버  전  :
'       1. 1.0.1: 이상대(2005-06-24)
'       2. 1.0.2: 이상대(2005-08-10)
'   병  원  :
'       1. 동국대 경주병원
'       2. 단국대병원
'-----------------------------------------------------------------------------'
...
Private Sub EditRcvData()
    ...
    Dim strFlag      As String   '수신한 결과구분
...
'                MsgBox strIntBase
                '## 1.0.2: 이상대(2005-08-10)
                '## - 장비가 자동으로 희석시 장비기준 검사명이 변경됨, 원래의 장비기준 검사명으로 변경
