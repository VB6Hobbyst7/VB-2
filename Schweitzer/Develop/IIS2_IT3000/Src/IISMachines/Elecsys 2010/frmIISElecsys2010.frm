...
Begin VB.Form frmIISElecsys2010 
   BackColor       =   &H00DBE6E6&
   Caption         =   "Elecsys 2010"
   ClientHeight    =   9180
   ClientLeft      =   165
   ClientTop       =   450
   ClientWidth     =   15240
   ...
   Begin FPSpread.vaSpread tblReady 
      ...
      SpreadDesigner  =   "frmIISElecsys2010.frx":0000
   End
   Begin FPSpread.vaSpread tblComplete 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISElecsys2010.frx":04EF
   End
   ...
   Begin FPSpread.vaSpread tblResult 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISElecsys2010.frx":0D31
      TextTip         =   2
   End
End
Attribute VB_Name = "frmIISElecsys2010"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
'-----------------------------------------------------------------------------'
'   파일명  : frmIISElecsys2010.frm
'   작성자  : 이상대
'   내  용  : Elecsys 2010 장비폼
'   작성일  : 2004-08-13
'   버  전  :
'       1. 1.0.1: 이상대(2004-12-07)
'       2. 1.0.2: 이상대(2005-06-20)
'       3. 1.0.3: 이상대(2005-08-09)
'   병  원  :
'       1. 동국대 경주병원
'       2. 단국대병원
'-----------------------------------------------------------------------------'
