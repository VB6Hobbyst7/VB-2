...
Private Sub txtBarNo_KeyDown(KeyCode As Integer, Shift As Integer)
    ...
    If KeyCode = vbKeyReturn Then
        Me.MousePointer = vbHourglass
        'osw edit
        Call GetOrder(Mid(Trim(txtBarNo.Text), 2))
        Me.MousePointer = vbDefault
    End If
End Sub
...
'Buffer = "=================" & vbCr
'Buffer = Buffer & "" & vbCr
'Buffer = Buffer & "SAMPLE RESULTS" & vbCr
'Buffer = Buffer & "" & vbCr
'Buffer = Buffer & "PATIENT 'S NAME" & vbCr
'Buffer = Buffer & "" & vbCr
'Buffer = Buffer & "" & vbCr
'Buffer = Buffer & "-----------#0061" & vbCr
'Buffer = Buffer & "" & vbCr
'Buffer = Buffer & "" & vbCr
'Buffer = Buffer & "Na "" 141.4 mmol/L     " & vbCr
'Buffer = Buffer & "K ""   4.88 mmol/L     " & vbCr
'Buffer = Buffer & "Cl^ 105.7 mmol/L" & vbCr
'Buffer = Buffer & "" & vbCr
'Buffer = Buffer & "CORRELATIONS ON" & vbCr
'Buffer = Buffer & "" & vbCr
'Buffer = Buffer & "RGNT MODULE LOW" & vbCr
'Buffer = Buffer & "" & vbCr
'Buffer = Buffer & "MAY-25-10; 10:51" & vbCr
'Buffer = Buffer & "" & vbCr
'Buffer = Buffer & "" & vbCr
'Buffer = Buffer & "" & vbCr
'Buffer = Buffer & "" & vbCr
...
'        Set objAccInfo = New clsIISIntInfo
'        With objAccInfo
'            .SpcPos = strWorkNo
'        End With
