...
Begin VB.Form frmIISCentaur 
   ...
   Begin FPSpread.vaSpread tblComplete 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISCentaur.frx":0509
   End
   ...
   Begin FPSpread.vaSpread tblResult 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISCentaur.frx":0D59
      TextTip         =   2
   End
End
...
'   작성자  : 이상대
'   내  용  : ADVIA Centaur 장비폼
'   작성일  : 2004-08-10
'   버  전  :
'       1. 1.0.1: 이상대 (2004-11-08)
'          - 정성,정량 결과이외의 값도 받을수 있도록 수정
'   병  원  :
'       1. 동국대 경주병원
'       2. 안동성소병원(오세원)
'-----------------------------------------------------------------------------'
