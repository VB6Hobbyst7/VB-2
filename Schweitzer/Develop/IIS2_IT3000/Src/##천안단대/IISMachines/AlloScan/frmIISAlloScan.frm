...
Begin VB.Form frmIISAlloScan 
   ...
   Begin FPSpread.vaSpread tblReady 
      ...
      SpreadDesigner  =   "frmIISAlloScan.frx":0000
   End
   ...
   Begin FPSpread.vaSpread tblComplete 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISAlloScan.frx":046B
   End
   ...
   Begin FPSpread.vaSpread tblResult 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISAlloScan.frx":0C1A
   End
   ...
   Begin FPSpread.vaSpread tblexcel 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      SpreadDesigner  =   "frmIISAlloScan.frx":12D3
   End
   ...
   End
End
Attribute VB_Name = "frmIISAlloScan"
...
'
'            Set objAccInfo = mIntLib.GetAccInfo(varTmp)
'
'            With AlloFile
'                .CancelError = True
'                .FileName = "C:\Program Files\LG Life Sciences\AdvanSure AlloScan 2\AlloScan_" & Format(Now, "yyyy-mm-dd") & ".patlist"
''                .ShowSave
...
'                                   " CONTACT " & vbTab & " BIRTH " & vbTab & " RRN " & vbTab & " CLIENT " & vbTab & " INSPECTOR " & vbTab & " HOSPITAL " & vbTab & " EXAMDATE" & vbNewLine
'
'                For Each objResult In objAccInfo.Results
'                        If InStr(objResult.TestCd, "L5266") > 0 Then
'                            strInFo = "1"
'                        ElseIf InStr(objResult.TestCd, "L5262") > 0 Then
'                            strInFo = "2"
'                        End If
'
'                        If strOldInFo <> strInFo Then
'                            Print #lngFIleNum, objAccInfo.GetBarNo & vbTab & objAccInfo.NAME & vbTab & strInFo & vbTab & "1" & vbTab & "1" & vbTab & Mid(objAccInfo.Age, 1, Len(objAccInfo.Age) - 1) & vbTab & IIf(objAccInfo.Sex = "M", "0", "1") & vbTab & vbTab & _
'                                               vbTab & vbTab & Mid(objAccInfo.Ssn, 1, 6) & "-" & Mid(objAccInfo.Ssn, 7) & vbTab & objAccInfo.DeptNm & vbTab & mLogOn.EmpNm & " " & mLogOn.EmpId & vbTab & vbTab & Format(Now, "yyyy-mm-dd") & vbNewLine
'                        End If
'
'                        strOldInFo = strInFo
'                Next
...
On Error GoTo Errors
    ...
    Set Rs = objAccInfo.GetTargetSpcs("E035", strFromDt, strToDt)
...
On Error GoTo ErrorTrap
    ...
    strSql = strSql & " WHERE EXAMDATE >= '" & Format(dtpFrDate.Value, "########") & "' "
    strSql = strSql & "   AND EXAMDATE <= '" & Format(dtpToDate.Value, "########") & "' "
...
'    If pAccInfo.QcFg = "0" Then         '## 일반검체
            With AlloFile
                .CancelError = True
                .FileName = "C:\Program Files\LG Life Sciences\AdvanSure AlloScan 2\" & Trim(txtFileNm.Text) & ".patlist"
'                .ShowSave
                ...
                For Each objResult In pAccInfo.Results
                        ...
                        If strOldInFo <> strInfo Then
                            Print #lngFIleNum, pAccInfo.GetBarNo & vbTab & pAccInfo.Name & vbTab & strInfo & vbTab & "1" & vbTab & "1" & vbTab & Mid(pAccInfo.Age, 1, Len(pAccInfo.Age) - 1) & vbTab & IIf(pAccInfo.Sex = "M", "0", "1") & vbTab & vbTab & _
                                               vbTab & vbTab & Mid(pAccInfo.Ssn, 1, 6) & "-" & Mid(pAccInfo.Ssn, 7) & vbTab & pAccInfo.DeptNm & vbTab & mLogOn.EMPNM & " " & mLogOn.EMPID & vbTab & vbTab & Format(Now, "yyyy-mm-dd")
                        End If
