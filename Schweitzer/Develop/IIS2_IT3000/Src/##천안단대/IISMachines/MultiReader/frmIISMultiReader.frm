...
Begin VB.Form frmIISMultiReader 
   ...
   Begin FPSpread.vaSpread tblComplete 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISMultiReader.frx":046B
   End
   ...
   Begin FPSpread.vaSpread tblResult 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISMultiReader.frx":0C1A
   End
   ...
   Begin FPSpread.vaSpread tblexcel 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      SpreadDesigner  =   "frmIISMultiReader.frx":12D3
   End
...
Private Sub Form_Load()
    ...
    txtFileNm.Text = "MultiReader_" & Format(Now, "yyyymmdd")
