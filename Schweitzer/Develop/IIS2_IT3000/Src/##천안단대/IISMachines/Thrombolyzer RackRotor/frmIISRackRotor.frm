...
Begin VB.Form frmIISRackRotor 
   BackColor       =   &H00DBE6E6&
   Caption         =   "Thrombolyzer RackRotor"
   ClientHeight    =   9180
   ClientLeft      =   165
   ClientTop       =   450
   ClientWidth     =   15240
   ...
   Begin FPSpread.vaSpread tblReady 
      ...
      SpreadDesigner  =   "frmIISRackRotor.frx":0000
   End
   Begin FPSpread.vaSpread tblComplete 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISRackRotor.frx":04EF
   End
   ...
   Begin FPSpread.vaSpread tblResult 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISRackRotor.frx":0D31
      TextTip         =   2
   End
End
Attribute VB_Name = "frmIISRackRotor"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
'-----------------------------------------------------------------------------'
'   파일명  : frmIISRackRotor.frm
'   작성자  : 이상대
'   내  용  : Thrombolyzer RackRotor 장비폼
'   작성일  : 2005-03-04
'   버  전  :
...
On Error GoTo Errors
    ...
    With MSComm
        ...
        If .PortOpen Then
            ...
            Error.SetLog App.EXEName, "frmIISRackRotor", "GetEqpComm", strErrMsg, Now
