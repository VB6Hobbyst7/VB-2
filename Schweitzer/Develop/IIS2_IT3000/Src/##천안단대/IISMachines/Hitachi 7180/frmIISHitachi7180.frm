...
Begin VB.Form frmIISHitachi7180 
   BackColor       =   &H00DBE6E6&
   ...
   Begin FPSpread.vaSpread tblReady 
      ...
      SpreadDesigner  =   "frmIISHitachi7180.frx":0000
   End
   Begin FPSpread.vaSpread tblComplete 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISHitachi7180.frx":0508
   End
   ...
   Begin FPSpread.vaSpread tblResult 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISHitachi7180.frx":0D58
      TextTip         =   2
   End
End
Attribute VB_Name = "frmIISHitachi7180"
        ...
        Case ":"    '## End
            ...
            For Each objBuffer In mIntLib.Buffers
                ...
                For i = 1 To Len(strTemp) Step 10
                    ...
                    '-- TIBC 결과 저장용(장비에서 TIBC 검사항목이 없고 오더가 나올 경우 계산하여 저장한다)
                    '-- 필요한 경우 아래의 Remark를 풀고 사용
