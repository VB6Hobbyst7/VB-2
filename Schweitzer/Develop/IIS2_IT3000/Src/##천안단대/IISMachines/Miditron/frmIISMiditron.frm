...
Begin VB.Form frmIISMiditron 
   ...
   Begin FPSpread.vaSpread tblReady 
      ...
      SpreadDesigner  =   "frmIISMiditron.frx":0000
   End
   Begin FPSpread.vaSpread tblComplete 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISMiditron.frx":04E4
   End
   ...
   Begin FPSpread.vaSpread tblResult 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISMiditron.frx":0D26
   End
   ...
   End
End
Attribute VB_Name = "frmIISMiditron"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
'-----------------------------------------------------------------------------'
'   파일명  : frmIISMiditron.frm
'   작성자  : 이상대
'   내  용  : Miditron 장비폼
'   작성일  : 2004-06-27
'   버  전  :
            ...
            For i = 1 To lngBufLen
                ...
                Select Case mIntLib.Phase
                    ...
                    Case 3  '## CR 대기
                        Select Case BufChar
                            Case vbCr
                                strOutput = STX & ">C " & ETX & Space(2) & vbCr
                    ...
                    Case 6  '## CR 대기
                        Select Case BufChar
                            Case vbCr
                                Call EditRcvData
                                strOutput = STX & ">" & ETX & Space(2) & vbCr
                                MSComm.Output = strOutput
                                Call mIntLib.WriteLog(strOutput, ccPCLog)
                                mIntLib.Phase = 4
                        End Select
...
Private Sub EditRcvData()
    ...
    If Mid$(strRcvBuf, 1, 1) <> ";" Then Exit Sub
    If Mid$(strRcvBuf, 2, 1) <> "E" And Mid$(strRcvBuf, 2, 1) <> "C" Then Exit Sub

    '## 바코드번호 조회
    strWorkNo = Trim$(Mid$(strRcvBuf, 15, 5))
    With tblReady
        ...
        If strIntBase <> strTemp Then
            ...
            If Pos > 0 Then
                Select Case UCase$(strIntBase)
                    Case "SG"
                        strResult = Trim$(Mid$(strRcvBuf, Pos + 2, 5))
                    Case "PH"
                        strResult = Trim$(Mid$(strRcvBuf, Pos + 2, 3))
                    Case "NIT"
                        strResult = Trim$(Mid$(strRcvBuf, Pos + 7, 4))
                    Case Else
                        strResult = Trim$(Mid$(strRcvBuf, Pos + 15, 4))
                End Select
            End If
...
On Error GoTo Errors
    ...
    With MSComm
        ...
        If .PortOpen Then
            ...
            Error.SetLog App.EXEName, "frmIISMiditron", "GetEqpComm", strErrMsg, Now
