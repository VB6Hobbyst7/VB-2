...
Private Sub Form_Activate()
    ...
    frmIIS600.tvwMenu.Nodes("IIS618").Selected = True
End Sub

Private Sub Form_Unload(Cancel As Integer)
    Set mIntNm = Nothing
    Set frmIIS618 = Nothing
End Sub
...
Private Sub cmdIntNmSave_Click()
    ...
    With mIntNm
        ...
        If itmX Is Nothing Then
            .EqpSeq = lvwIntNms.ListItems.Count + 1
            .PrtOrd = lvwIntNms.ListItems.Count + 1
            ...
            End If
        Else
            .EqpSeq = CLng(itmX.SubItems(5))
            .PrtOrd = CLng(itmX.SubItems(6))
            
            If .ModifyIntNmX Then
...
Private Sub cmdIntNmDelete_Click()
    ...
    Dim lngEqpSeq   As Long     '장비기준 검사명의 순서
    ...
    lngEqpSeq = CLng(itmX.SubItems(5))
    
    Me.MousePointer = vbHourglass

    If mIntNm.DelIntNmX(strEqpCd, lngEqpSeq) Then
...
Private Sub cmdTestCdSave_Click()
    ...
    Dim lngEqpSeq   As Long         '장비기준 검사명 순서
    ...
    Call GetTestCds(strEqpCd, lngEqpSeq)
...
Private Sub lvwIntNms_ItemClick(ByVal Item As MSComctlLib.ListItem)
    ...
    Call GetTestCds(Item.SubItems(4), CLng(Item.SubItems(5)))
    ...
    With lvwIntNms
        ...
        If Not (Rs.BOF Or Rs.EOF) Then
            Do Until Rs.EOF
                ...
                itmX.SubItems(5) = Rs.Fields("EQPSEQ").Value
                itmX.SubItems(6) = Rs.Fields("PRTORD").Value & ""
...
Errors:
    Set Rs = Nothing
    Error.SetLog App.EXEName, "frmIIS618", "GetIntNms", Err.Description, Now
...
'       - pEqpSeq : 장비기준 검사명 순서
'-----------------------------------------------------------------------------'
Private Sub GetTestCds(ByVal pEqpCd As String, ByVal pEqpSeq As Long)
    Dim Rs      As ADODB.Recordset
    Dim itmX    As ListItem
...
On Error GoTo Errors
    ...
    With lvwTestCds
        ...
        Set Rs = mIntNm.GetTestCdsX(pEqpCd, pEqpSeq)
        If Not (Rs.BOF Or Rs.EOF) Then
            Do Until Rs.EOF
