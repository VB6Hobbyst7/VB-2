...
Begin VB.Form frmIISXT2000i 
   ...
   Begin FPSpread.vaSpread tblReady 
      ...
      SpreadDesigner  =   "frmIISXT2000i.frx":0000
   End
   Begin FPSpread.vaSpread tblComplete 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISXT2000i.frx":0509
   End
   ...
   Begin FPSpread.vaSpread tblResult 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISXT2000i.frx":0D59
      TextTip         =   2
   End
End
Attribute VB_Name = "frmIISXT2000i"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
'-----------------------------------------------------------------------------'
'   파일명  : frmIISXT2000i.frm
'   작성자  : 이상대
'   내  용  : XT-2000i 장비폼
'   작성일  : 2005-02-03
'   버  전  :
...
Private Sub EditRcvData()
    ...
    Select Case strDisCode1
        Case "R"    '## Informat Inquiry Format
            ...
            strBarNo = Trim$(Mid$(strRcvBuf, 6, 15))
        ...
        Case "D"    '## Analysis Data Format
            ...
            Select Case strDisCode2
                Case "1"    '## Analysis Data Format1
                    ...
                    strBarNo = Trim$(Mid$(strRcvBuf, 33, 15))
