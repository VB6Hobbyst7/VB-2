...
'   작성일  : 2003-12-10
'   버  전  :
'       1. 1.0.1: 이상대(2004-12-04)
'          - 미생물 일반감수성(IISGENSENSI), MIC(IISMIC) 결과유형 변수추가
'       2. 1.1.3: 이상대(2005-01-11)
'          - PT(%)값의 결과코드(IISPT) 변수추가
'       3. 1.1.4: 이상대(2005-02-03)
'          - CONCAT(FCONCAT) 변수추가
'       4. 1.1.6: 이상대(2005-04-12)
'          - 검사항목별 결과코드(mCRESULTCD) 변수추가
'       5. 1.1.8: 이상대(2005-05-23)
'          - CBC Workarea(mIISCBCWA) 변수추가
'       6. 1.2.2: 이상대(2005-09-20)
'          - 하한값(mIISLMTLOW), 상한값(mIISLMTHIGH) 결과코드 변수추가
'       7. 1.2.3: 이상대(2005-10-11)
'-----------------------------------------------------------------------------'

'   등록상표: Schweitzer (LegalTrademarks)
'   설명    : Interface System
'   저작권  : Copyright 2000 POMIS Co., Ltd. (LegalCopyright)
'   제품이름: Interface System(ProductName)
'   파일설명: IIS (FileDescription)
'   회사이름: POMIS
