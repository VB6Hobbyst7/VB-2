...
Private Sub cmdApply_Click()
    ...
    With ssRst
        ...
        For i = 1 To .DataRowCnt
            ...
            Call ssRst_LeaveCell(2, i, -1, -1, False)
...
'        Screen.MousePointer = vbHourglass
    ...
    strSQL = ""
    strSQL = strSQL & " INSERT INTO S2COM102 (TRANSDT, TRANSID, TELNO, DOCTID, DOCTNM, DEPTNM, TRANSMSG, REMARK)"
...
'    rtfMessage.Text = rtfMessage.Text & strTest & " : " & strResult & vbCrLf
    ...
    Select Case strTestCd
        ...
        Case "CZ396"
            ...
            If RS.RecordCount > 0 Then
                RS.MoveFirst
                rtfComment.Text = rtfComment.Text & vbCrLf & RS.Fields("text1") & ""
            End If
            RS.Close
        Case "CZ394"
