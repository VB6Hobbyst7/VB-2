...
Private Sub cmdCollect_Click()  '채혈
    ...
    strColDt = Format(DBConn.GetSysDate, "yyyyMMdd")
    strColTm = Format(DBConn.GetSysDate, "HHmmss")
...
'    objGetSql.setDbConn DBConn
    ...
    Set DrRS = OpenRecordSet(objGetSql.Get_CollectOrder(searchkey, TF, BBSBUSSDIV.stsBed, strOrdDt))
...
'            Call SexCheck(.Fields("ssn").value)
            ...
            strBlgCd = objCollect.Get_BuildingCd(lblWardId.Caption) '병동 건물 코드
