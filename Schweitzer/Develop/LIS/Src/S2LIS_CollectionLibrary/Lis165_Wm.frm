...
Begin VB.Form frm165OutCol 
   ...
   Begin VB.Frame Frame3 
      ...
      Begin FPSpread.vaSpread slvwPtList 
         ...
         SpreadDesigner  =   "Lis165_Wm.frx":09D8
         UserResize      =   1
         ScrollBarTrack  =   3
      End
   ...
   Begin VB.Frame fraOrder 
      ...
      Begin FPSpread.vaSpread tblOrdSheet 
         ...
         ShadowDark      =   12632256
         ShadowText      =   0
         SpreadDesigner  =   "Lis165_Wm.frx":138A
         StartingColNumber=   2
         VirtualRows     =   24
         VisibleCols     =   6
         VisibleRows     =   5
   ...
   Begin VB.Frame fraContent 
      ...
      Begin VB.PictureBox Picture1 
         ...
         Begin FPSpread.vaSpread tblLabno 
            ...
            ShadowDark      =   12632256
            ShadowText      =   0
            SpreadDesigner  =   "Lis165_Wm.frx":30B1
            StartingColNumber=   2
            VirtualRows     =   24
            VisibleCols     =   5
            VisibleRows     =   500
   ...
   Begin VB.Frame fraPtRmk 
      ...
      Begin FPSpread.vaSpread tblRData 
         ...
         SpreadDesigner  =   "Lis165_Wm.frx":58BF
      End
...
Private Sub cmdFind_Click()
    ...
    If lblWardId.Caption = "" Then
        Call MsgBox("외래과가 없습니다.", vbInformation, "외래과 선택")
        Exit Sub
    End If
    ...
    'tmpFrDt = Format(DateAdd("d", -30, GetSystemDate), "YYYYMMDD")
    tmpFrDt = Format(GetSystemDate, "yyyymmdd")
    tmpToDt = Format(GetSystemDate, "yyyymmdd")
        
    If lblWardId.Caption = "ER" Then
        lblWardId.Caption = "EM"
    End If
    
    If optOption(0).Value = True Then
        Rs.Open objPtInfo.GetSQLCol_Wm1(tmpFrDt, tmpToDt, lblWardId.Caption), DBConn
    End If
    
    If optOption(1).Value = True Then
        Rs.Open objPtInfo.GetSQLCol_Wm2(tmpFrDt, tmpToDt, lblWardId.Caption), DBConn
    End If
...
On Error GoTo NoData
    ...
    If chkWard.Value = 1 Then
        SqlStmt = objSQL.SqlReadWardOrder_New(txtPtId.Text, tmpDate, tmpTime, , enBussDiv.BussDiv_OutPatient, strPayDt, strOrdDiv)
    Else
