...
Private Sub Caution(ByVal strPtid As String)
    Dim SQL As String
    Dim iCnt As Integer
...
'        Screen.MousePointer = vbHourglass
    ...
    SQL = SQL + "       PATNO,                                                         "
    SQL = SQL + "       SEQ,                                                           "
    SQL = SQL + "       TO_CHAR(EDITDATE,'YYYYMMDD'),                                  "
    SQL = SQL + "       EDITID,                                                        "
    SQL = SQL + "       FN_USERNAME_SELECT(EDITID)                                     "
    SQL = SQL + "  FROM MDCAUTNT                                                       "
    SQL = SQL + " WHERE PATNO = '00883460'                                             "
    SQL = SQL + "   AND SEQ = (SELECT MAX(SEQ) FROM MDCAUTNT WHERE PATNO = '00883460') "

    AdoRs_ORACLE.Open strSQL, AdoCn_ORACLE
    
    With AdoRs_ORACLE
        If .RecordCount > 0 Then
            For iCnt = 0 To .RecordCount
