...
Private Sub PrintCrystalAllItem()
    ...
    Do Until Rs.EOF
        ...
        Else
            If Rs.Fields("radiv").Value & "" = "A" Then 'Accept ÀÏ°æ¿ì Remark Clear 2014-06-05 PSK
               Select Case txtCtrlCd.Text
                Case "01_Uri", "02_Uri" '2014-08-13 PSK URI Á¦¿ÜÇÑ´Ù...'À°¾È°á°úÀÏÄ¡' Å¸ÀÌÇÎÇÑ°á°ú Ãâ·ÂµÇ¾î¾ßÇÔ.
...
Private Sub LoadResult()
    ...
    With objQcReview
        ...
        If .TestCount = 0 Then
            MsgBox "Á¶°Ç¿¡ ÇØ´çÇÏ´Â QC°á°ú°¡ ¾ø½À´Ï´Ù", vbInformation + vbOKOnly, "¸Þ¼¼Áö"
            Exit Sub
        End If
...
' 2009.10.06 ¾ç¼ºÇö L,M,H Mean & SD & CV °ª Fixup
' 2010.10.12 ¿Â½ÂÈ£ L,M,H Mean & SD & CV °ª °ø½Ä ¼öÁ¤
    With tblResult
...
'        S3 = Sqr((j * S3 - (M3 * M3)) / (j * (IIf(j - 1 = 0, 1, j))))
        ...
        '20131129 PSK °ªÀÌ 0 ÀÎ°æ¿ì °è»ê½Ã ¿À·ù¹ß»ý
        M1 = M1 / k
        If M2 <> 0 Or l <> 0 Then
            M2 = M2 / l
        End If
