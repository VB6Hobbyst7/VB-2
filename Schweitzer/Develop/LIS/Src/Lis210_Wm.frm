...
Private Sub GetWardID()
    Dim objSQL  As clsLISSqlQc
    Dim RS      As Recordset

    cboWardId.Clear
    cboWardId.AddItem "전 체"
    
On Error GoTo Errors
    Set RS = New Recordset
    RS.Open GetSQLWard, DBConn
    If Not (RS.BOF Or RS.EOF) Then
        Do Until RS.EOF
            cboWardId.AddItem Format(RS.Fields("wardid").Value & "", "!" & String(10, "@")) & COL_DIV & _
    ...
    If cboWardId.ListCount > 0 Then cboWardId.ListIndex = 0
    Exit Sub
...
'    End If
    ...
    Call objRst.LoadUnverifiedList_WM1(tmpWorkArea, tmpRcvDt, ObjSysInfo.BuildingCd, Trim(medGetP(cboWardId.Text, 1, "")), tblLabList)
