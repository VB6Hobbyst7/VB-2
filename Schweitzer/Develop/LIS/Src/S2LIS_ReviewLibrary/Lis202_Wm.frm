...
Begin VB.Form frm202AccDataEntry 
   ...
   Begin VB.PictureBox picRst 
      ...
      Begin FPSpread.vaSpread ssRst 
         ...
         ShadowDark      =   12632256
         SpreadDesigner  =   "Lis202_Wm.frx":12F1
         VisibleCols     =   10
         VisibleRows     =   10
         TextTip         =   2
      End
...
Private Sub ssRst_DblClick(ByVal Col As Long, ByVal Row As Long)
    ...
    Select Case strTestCd
        ...
        Case "CZ394"
            ...
            RS.Close
        Case "X274"
            strSQL = "SELECT text1 FROM S2LAB034 A WHERE CDVAL1 = '0032'"
            RS.Open strSQL, DBConn, adOpenForwardOnly, adLockReadOnly
