VERSION 5.00
Begin VB.Form frmLisReviewinLib 
   BackColor       =   &H00E8EEEE&
   Caption         =   "결과조회"
   ClientHeight    =   9015
   ClientLeft      =   60
   ...
   WindowState     =   2  '최대화
End
Attribute VB_Name = "frmLisReviewinLib"
...
'    Call objReviewForm.ReviewButtonClick(mvarButtonKey, frmLisReview)  'picForm)
    Call objReviewForm.ReviewButtonClick(mvarButtonKey, frmLisReviewinLib, mvarPTid) 'picForm)
End Sub
