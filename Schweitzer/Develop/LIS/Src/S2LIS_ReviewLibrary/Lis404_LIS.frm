...
Begin VB.Form frm404AllResult_LIS 
   BackColor       =   &H00FFFFFF&
   ClientHeight    =   9105
   ClientLeft      =   60
   ClientTop       =   60
   ...
   Begin VB.PictureBox picFootNote 
      ...
      Begin RichTextLib.RichTextBox txtSamCmt 
         ...
         ScrollBars      =   2
         Appearance      =   0
         TextRTF         =   $"Lis404_LIS.frx":0000
         MouseIcon       =   "Lis404_LIS.frx":0304
   ...
   Begin FPSpread.vaSpread tblResult 
      ...
      ShadowDark      =   12632256
      ShadowText      =   0
      SpreadDesigner  =   "Lis404_LIS.frx":0466
      UnitType        =   0
      UserResize      =   0
      VisibleCols     =   8
      VisibleRows     =   22
   ...
   Begin FPSpread.vaSpread tblOrdSheet 
      ...
      ShadowDark      =   14737632
      ShadowText      =   0
      SpreadDesigner  =   "Lis404_LIS.frx":23A1
      TextTip         =   4
   End
   ...
   End
End
Attribute VB_Name = "frm404AllResult_LIS"
