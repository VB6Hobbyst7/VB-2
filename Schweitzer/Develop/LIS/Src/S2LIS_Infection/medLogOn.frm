...
Private F_SQL      As New clsInfectiontSQL
...
Private Sub Form_Load()
    ...
    lblOK.ForeColor = DCM_Grey
    lblCancel.ForeColor = DCM_Grey
    shpOK.FillColor = DCM_LightGrey
    shpCancel.FillColor = DCM_LightGrey

    lblSysName(0).Caption = "Infection System" 'mvarProductName
    lblSysName(1).Caption = "Infection System" 'mvarProductName
    lblSysName(2).Caption = "Infection System" 'mvarProductName

    '-- DB 연결
    If DBOpen(D0COM_SERVER) = False Then
        MsgBox Err.Description
        Set F_SQL = Nothing
        Set mclsMyUser = Nothing
        Unload Me
        'Exit Sub
    End If
...
'        Shape1.BorderColor = DCM_LightGrey
'        Shape2.BorderColor = DCM_LightGrey
'        Shape3.BorderColor = DCM_LightGrey
...
Private Sub txtUSERID_LostFocus()
    ...
    mclsMyUser.ProjectId = "LIS" 'mvarProjectId
...
Private Sub MyLogOn_LoginSuccess()
    ...
    With Me
        mvarLogInID = .LoginId
        mvarLoginPwd = .LoginPwd
        mvarEmpID = .EmpId
        Set mclsMyUser = .MyUser
    End With
    
    Unload Me
    
    Call frm208Infection.Show
