...
Begin VB.Form frm205ItemDataEntry 
   ...
   Begin VB.PictureBox picRst 
      ...
      Begin FPSpread.vaSpread ssRst 
         ...
         SpreadDesigner  =   "Lis205.frx":038A
         VisibleCols     =   10
         VisibleRows     =   13
      End
...
'
    ...
    With objPtInfo
        ...
        If pOption = "WorkSheet" Then
            'strParaInfo = txtTestCd(0).Text & vbTab & txtWorkCd.Text & vbTab & DateStr(dptWorkDt.Value) & _
                            vbTab & Trim(mskFrWorkNo.ClipText) & vbTab & Trim(mskToWorkNo.ClipText)
            '.LoadTable strParaInfo, ObjMyUser.EmpId, "WorkSheet", , ObjSysInfo.BuildingCd
            
            '2014-01-27 병동코드추가
            strParaInfo = txtTestCd(0).Text & vbTab & txtWorkCd.Text & vbTab & DateStr(dptWorkDt.Value) & _
                            vbTab & Trim(mskFrWorkNo.ClipText) & vbTab & Trim(mskToWorkNo.ClipText) & vbTab & cboPoct.ListIndex
            .LoadTable_2014 strParaInfo, ObjMyUser.EmpId, "WorkSheet", , ObjSysInfo.BuildingCd
            
        Else
            strParaInfo = txtTestCd(1).Text & vbTab & mskAccNo(0).FormattedText & _
                            vbTab & mskAccNo(1).FormattedText
            .LoadTable strParaInfo, ObjMyUser.EmpId, "AccNo", , ObjSysInfo.BuildingCd
        End If
        If .TestCount > 0 Then
            CmdTemplete True
