...
Begin VB.Form frmIISOCSensorM 
   ...
   Begin FPSpread.vaSpread tblReady 
      ...
      SpreadDesigner  =   "frmIISOCSensorM.frx":0000
   End
   Begin FPSpread.vaSpread tblComplete 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISOCSensorM.frx":04E4
   End
   ...
   Begin FPSpread.vaSpread tblResult 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISOCSensorM.frx":0D26
      TextTip         =   2
   End
   ...
   End
End
Attribute VB_Name = "frmIISOCSensorM"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
'-----------------------------------------------------------------------------'
'   파일명  : frmIISOCSensorM.frm
'   작성자  : 오세원
'   내  용  : OC-SensorM 장비폼
'   작성일  : 2019-10-24
'   버  전  :
...
Private Sub EditRcvData()
    ...
    Dim strResultN  As String   '수신한 정성검사결과
    ...
    strWorkNo = Format$(Mid$(strRcvBuf, 1, 6), "#")
    ...
    For Each objIntNm In mIntLib.IntNms
        ...
        strIntBase = strTemp1
        strResult = Trim$(Mid$(strRcvBuf, 7))
