...
'                Call GetOrder(strBarNo)
            ...
            Case "DS"    '## Order
                ...
                'osw add
                strBarNo = Format(strBarNo, "#")
                strSeg = Trim(Mid(strRcvBuf, 68, 2))
                strPos = Trim(Mid(strRcvBuf, 70, 4))
...
'            555.6       100    9       >100
                ...
                If CCur(strIntResult) < 1 Then
                     strResult = "<1"
                ElseIf CCur(strIntResult) < 3 Then
                     strResult = "1 - 2"
...
On Error GoTo Errors
    ...
    With MSComm
        ...
        If .PortOpen Then
            ...
            Error.SetLog App.EXEName, "frmIISUF1000i", "GetEqpComm", strErrMsg, Now
