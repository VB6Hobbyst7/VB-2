...
Begin VB.Form frmIISEPOC_1 
   ...
   Begin FPSpread.vaSpread tblReady 
      ...
      SpreadDesigner  =   "frmIISEPOC_1.frx":0000
   End
   Begin FPSpread.vaSpread tblComplete 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISEPOC_1.frx":04E4
   End
   ...
   Begin FPSpread.vaSpread tblResult 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISEPOC_1.frx":0D26
      TextTip         =   2
   End
   ...
   End
End
Attribute VB_Name = "frmIISEPOC_1"
...
'        strSrcfile = FileEPOC.Path & "\" & FileEPOC.FileName    ' 원본 파일 이름을 정의합니다.
        ...
        '대상 파일 이름을 정의
        strDestFile = App.Path & "\Log\" & FileEPOC.FileName
        '원본을 대상에 복사
...
Private Sub EditRcvData()
    ...
    strWorkNo = Trim(Mid(varTmp(7), InStr(varTmp(7), ":") + 1))
    vWorkNo = strWorkNo
    strBarNo = strWorkNo
