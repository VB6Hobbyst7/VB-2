...
Begin VB.Form frmIISNSPRIME 
   ...
   Begin FPSpread.vaSpread tblReady 
      ...
      SpreadDesigner  =   "frmIISNSPRIME.frx":0000
   End
   Begin FPSpread.vaSpread tblComplete 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISNSPRIME.frx":04F2
   End
   ...
   Begin FPSpread.vaSpread tblResult 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISNSPRIME.frx":0D60
   End
   ...
   End
End
Attribute VB_Name = "frmIISNSPRIME"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
'-----------------------------------------------------------------------------'
'   파일명  : frmIISmNSPRIME.frm
'   작성자  : 오세원
'   내  용  : mNSPRIME 장비폼
'   작성일  : 2016-03-10
'   버  전  :
'       1. 1.0.0: 오세원(2016-03-10)
'   병  원  :
'       1. 전주예수병원
'-----------------------------------------------------------------------------'
...
'On Error Resume Next
    ...
    If Pos > 0 Then
        ...
        strSpcPos = Val(strRackNo) & "-" & strPosNo
        '## 바코드번호 조회
        With tblReady
    ...
    For Each objIntNm In mIntLib.IntNms
        ...
        If strIntBase <> strTemp2 Then
            ...
            Call objIntInfo.IntResults.Add(strIntBase, objIntNm.IntNm, strResult, strResult, strSpcPos)
            strTemp2 = strIntBase
            strResult = ""
        End If
    Next
