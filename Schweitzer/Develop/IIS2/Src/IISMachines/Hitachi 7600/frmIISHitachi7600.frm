...
Begin VB.Form frmIISHitachi7600 
   ...
   Begin FPSpread.vaSpread tblComplete 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISHitachi7600.frx":04FA
   End
   ...
   Begin FPSpread.vaSpread tblResult 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISHitachi7600.frx":0D3C
      TextTip         =   2
   End
End
...
Private Sub Command1_Click()
    ...
    strRCV = ""
    strRCV = strRCV & "1H|\^&|||HOST^2|||||H7600^1|TSDWN^REPLY|P|1" & vbCr
    strRCV = strRCV & "P|1" & vbCr
    strRCV = strRCV & "O|1|0^  17001097793^1^5120^1|R1|^^^21/|R||||||N||^^||||||^^^^||||||O" & vbCr
    strRCV = strRCV & "L|1|N" & vbCr
    strRCV = strRCV & "C9" & vbCrLf
    strRCV = strRCV & ""
