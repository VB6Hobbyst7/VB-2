...
Begin VB.Form frmIISGeneXpert 
   ...
   Begin FPSpread.vaSpread tblComplete 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISGeneXpert.frx":04EF
   End
   ...
   Begin FPSpread.vaSpread tblResult 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISGeneXpert.frx":0D31
      TextTip         =   2
   End
End
...
'R|7|^CAREF
    ...
    sBuf = sBuf & "R|1|^RIF^^1^Xpert MTB-RIF Assay G4^5^MTB^|MTB DETECTED HIGH^|||||F||<None>|D8" & vbCrLf
        ...
        '    strRcvBuf = varRcv(intCnt)
            ...
            Select Case strType
                ...
                Case "R"    '## Result
                    ...
                    '-- 2016.12.19 수정
                    strIntBase = mGetP(mGetP(strRcvBuf, 3, "|"), 4, "^") '숫자채널
                    strIntName = mGetP(mGetP(strRcvBuf, 3, "|"), 7, "^") '검사명
                    
                    If UCase(strIntBase) = "DIFF" Then
                        If strIntName = "CDIFF" Or strIntName = "027" Then
