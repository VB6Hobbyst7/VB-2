...
Begin VB.Form frmIISMEDIWISS 
   ...
   Begin FPSpread.vaSpread vasFDPrint 
      ...
      SpreadDesigner  =   "frmIISMEDIWISS.frx":0000
      UserResize      =   0
   End
   Begin FPSpread.vaSpread vasINPrint 
      ...
      ScrollBars      =   0
      ScrollBarShowMax=   0   'False
      SpreadDesigner  =   "frmIISMEDIWISS.frx":B447
      UserResize      =   0
   End
   Begin VB.FileListBox FileMEDIWISS 
      Height          =   870
      Left            =   2250
      Pattern         =   "*.csv"
      TabIndex        =   33
   ...
   Begin FPSpread.vaSpread tblReady 
      ...
      SpreadDesigner  =   "frmIISMEDIWISS.frx":162B2
   End
   ...
   Begin FPSpread.vaSpread tblComplete 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISMEDIWISS.frx":16821
   End
   ...
   Begin FPSpread.vaSpread tblResult 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISMEDIWISS.frx":170C7
   End
   ...
   Begin FPSpread.vaSpread tblexcel 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      SpreadDesigner  =   "frmIISMEDIWISS.frx":177BA
   End
   ...
   Begin FPSpread.vaSpread vasExcel 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      SpreadDesigner  =   "frmIISMEDIWISS.frx":17A03
   End
   ...
   End
End
Attribute VB_Name = "frmIISMEDIWISS"
...
'    Call Get_SearchList
   ...
   ' Dim strBuffer As String
    ...
    strFile = GetMEDIWISSConfig("ExportPath") & "\export.csv"
...
'    Dim strOldInFo  As String
    ...
    With AlloFile
        .CancelError = True
        .FileName = GetMEDIWISSConfig("ImportPath") & "\" & Trim(txtFileNm.Text) & ".csv"
...
'4,MEDIWISS / RIDA Panel 2 KO / Rev. 004,2,5,,,,,,,,,,,,,,,,,,,,,,,,,,,PatientStrip,,IgE,,0,,,,,,,,,,,,,,,,,
        ...
        For iCnt = 1 To tblReady.DataRowCnt
            ...
            If varTmp = "IN" Then
                strInFo = strInFo & "MEDIWISS / Panel 30 KO Inhalant A / Rev. 008;" & strBarNo & ";" & strLabNo & ";" & strLNm & ";" & strFNm & ";" & strSex & ";" & strAge & vbCrLf
                If iCnt = tblReady.DataRowCnt Then
                    strInFo = strInFo & "MEDIWISS / Panel 30 KO Inhalant B / Rev. 008;" & strBarNo & ";" & strLabNo & ";" & strLNm & ";" & strFNm & ";" & strSex & ";" & strAge & vbCrLf
                Else
                    strInFo = strInFo & "MEDIWISS / Panel 30 KO Inhalant B / Rev. 008;" & strBarNo & ";" & strLabNo & ";" & strLNm & ";" & strFNm & ";" & strSex & ";" & strAge & vbCrLf
                End If
            ElseIf varTmp = "FD" Then
                strInFo = strInFo & "MEDIWISS / Panel 30 KO Food  A / Rev. 004;" & strBarNo & ";" & strLabNo & ";" & strLNm & ";" & strFNm & ";" & strSex & ";" & strAge & vbCrLf
                If iCnt = tblReady.DataRowCnt Then
                    strInFo = strInFo & "MEDIWISS / Panel 30 KO Food  B / Rev. 009;" & strBarNo & ";" & strLabNo & ";" & strLNm & ";" & strFNm & ";" & strSex & ";" & strAge & vbCrLf
                Else
                    strInFo = strInFo & "MEDIWISS / Panel 30 KO Food  B / Rev. 009;" & strBarNo & ";" & strLabNo & ";" & strLNm & ";" & strFNm & ";" & strSex & ";" & strAge & vbCrLf
                End If
            End If
...
'    FileMEDIWISS.Path = "C:\RAPID\EXPORT\"
...
'    2015-08-21_11-46-00
    ...
    FileMEDIWISS.Path = GetMEDIWISSConfig("ExportPath") & "\"
