...
Begin VB.Form frmIISABL830 
   ...
   Begin FPSpread.vaSpread tblReady 
      ...
      SpreadDesigner  =   "frmIISABL830.frx":0000
   End
   Begin FPSpread.vaSpread tblComplete 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISABL830.frx":03F8
   End
   ...
   Begin FPSpread.vaSpread tblResult 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISABL830.frx":0B40
   End
   ...
   End
End
Attribute VB_Name = "frmIISABL830"
    ...
    Select Case MSComm.CommEvent
        Case comEvReceive
            ...
            For i = 1 To lngBufLen
                ...
                '-- 2006/11/08 osw edit
                'ASTM 데이터 포맷이나 통짜로 데이터가 전송되는 포맷이 아님
                ' 따라서 각 값이 들어오는 포맷으로 소스 수정
...
On Error GoTo Errors
    ...
    With MSComm
        ...
        If .PortOpen Then
            ...
            Error.SetLog App.EXEName, "frmIISABL830", "GetEqpComm", strErrMsg, Now
