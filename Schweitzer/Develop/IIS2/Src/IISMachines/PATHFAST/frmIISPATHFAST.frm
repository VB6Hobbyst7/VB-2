...
Begin VB.Form frmIISPATHFAST 
   ...
   Begin FPSpread.vaSpread tblReady 
      ...
      SpreadDesigner  =   "frmIISPATHFAST.frx":0000
   End
   Begin FPSpread.vaSpread tblComplete 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISPATHFAST.frx":0508
   End
   ...
   Begin FPSpread.vaSpread tblResult 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISPATHFAST.frx":0D58
      TextTip         =   2
   End
End
Attribute VB_Name = "frmIISPATHFAST"
...
Private Sub Command1_Click()
    ...
    pBuf = ""
    pBuf = pBuf & ""
    pBuf = pBuf & "1H|@^\|||PATHFAST01^1905D3514^04.00.09.00|||||||P|1|20210112145823" & vbCr
    pBuf = pBuf & "7F" & vbCrLf
    pBuf = pBuf & "2P|1|||||||U||||||||||||||||||||||||||" & vbCr
    pBuf = pBuf & "90" & vbCrLf
    pBuf = pBuf & "3O|1|110010940231^1^||^^^20^P-SEP^1202108408|||||||||||2||||||||||F|||||" & vbCr
    pBuf = pBuf & "9D" & vbCrLf
    pBuf = pBuf & "4R|1|^^^20^P-SEP^1202108408|540^F|pg/mL||N||F||Administrator||20210112144219|" & vbCr
    pBuf = pBuf & "59" & vbCrLf
    pBuf = pBuf & "5C|1|I|^^^^20210730131256|I" & vbCr
    pBuf = pBuf & "74" & vbCrLf
    pBuf = pBuf & "6P|2|||||||U||||||||||||||||||||||||||" & vbCr
    pBuf = pBuf & "95" & vbCrLf
    pBuf = pBuf & "7O|1|110010940224^2^||^^^20^P-SEP^1202108408|||||||||||2||||||||||F|||||" & vbCr
    pBuf = pBuf & "A4" & vbCrLf
    pBuf = pBuf & "0R|1|^^^20^P-SEP^1202108408|1735^F|pg/mL||N||F||Administrator||20210112144219|" & vbCr
    pBuf = pBuf & "8C" & vbCrLf
    pBuf = pBuf & "1C|1|I|^^^^20210730131256|I" & vbCr
    pBuf = pBuf & "70" & vbCrLf
    pBuf = pBuf & "2L|1|N" & vbCrLf
    pBuf = pBuf & "05" & vbCrLf
    pBuf = pBuf & "" & vbCr
...
Private Sub EditRcvData()
    ...
    For Each objBuffer In mIntLib.Buffers
        ...
        Call mIntLib.WriteLog("[RCV]" & strRcvBuf, ccEqp)
...
'                mIntLib.State = "Q"
            ...
            Case "O"    '## Order
                '3O|1|110010940231^1^||^^^20^P-SEP^1202108408|||||||||||2||||||||||F|||||
            
                '## 바코드번호, Rack No, Sample Position 조회
                strTemp = mGetP(strRcvBuf, 3, "|")
                'strTemp = mGetP(strRcvBuf, 4, "|")
                
                strBarNo = Trim$(mGetP(strTemp, 1, "^"))
            ...
            Case "R"    '## Result
                '4R|1|^^^20^P-SEP^1202108408|540^F|pg/mL||N||F||Administrator||20210112144219|
                '0R|1|^^^20^P-SEP^1202108408|1735^F|pg/mL||N||F||Administrator||20210112144219|
