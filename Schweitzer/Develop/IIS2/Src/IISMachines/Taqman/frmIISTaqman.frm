        ...
        Select Case strType
            ...
            Case "C"    '## Comment
                ...
                If strFlag <> "N" Then
                    ...
                    '2019-11-27 수정 : s2lab306.transno 에저장됨 (사이즈 : 9)
...
Private Sub SetReady(ByVal pAccInfo As clsIISAccInfo)
    ...
    With tblReady
        ...
        .Col = TReadyEnum.ccNo:     .Text = "오더" 'mOrder.TubePos & "/" & Mid$(mOrder.RackNo, 2)
