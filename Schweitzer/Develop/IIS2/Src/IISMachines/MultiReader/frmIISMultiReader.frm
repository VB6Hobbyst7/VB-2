...
Begin VB.Form frmIISMultiReader 
   ...
   Begin FPSpread.vaSpread tblComplete 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISMultiReader.frx":0519
   End
   ...
   Begin FPSpread.vaSpread tblResult 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISMultiReader.frx":0CBA
   End
   ...
   Begin FPSpread.vaSpread tblexcel 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      SpreadDesigner  =   "frmIISMultiReader.frx":1359
   End
...
'                            Call mIntLib.AddBuffer(Replace(varTmp(7), "=", ";"))
                            Call mIntLib.AddBuffer(Replace(varTmp(1), "=", ";"))
...
'
        Select Case strType
            ...
            Case "NAME"
                '-- 시약 변경으로 자리수 위치 바뀜(2015.08.27) "1KO", "2KO", "3KO", "4KO"
                'strTest = mGetP(mGetP(strRcvBuf, 2, ";"), 2, " ")
                strTest = mGetP(mGetP(strRcvBuf, 2, ";"), 3, " ")
...
'                    ElseIf strIntResult < 100 Then
'                        strClass = "1.0"
'                    ElseIf strIntResult > 100 And strIntResult > 200 Then
'                        strClass = "2.0"
'                    ElseIf strIntResult > 200 Then
'                        strClass = "3.0"
'                    End If
