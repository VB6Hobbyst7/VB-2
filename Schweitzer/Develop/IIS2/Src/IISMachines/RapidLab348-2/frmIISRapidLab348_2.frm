...
Begin VB.Form frmIISRapidLab348_2 
   BackColor       =   &H00DBE6E6&
   Caption         =   "RapidLab 348-2"
   ClientHeight    =   9180
   ClientLeft      =   165
   ClientTop       =   450
   ClientWidth     =   15240
   ...
   Begin FPSpread.vaSpread tblReady 
      ...
      SpreadDesigner  =   "frmIISRapidLab348_2.frx":0000
   End
   Begin FPSpread.vaSpread tblComplete 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISRapidLab348_2.frx":04F2
   End
   ...
   Begin FPSpread.vaSpread tblResult 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISRapidLab348_2.frx":0D42
      TextTip         =   2
   End
   ...
   End
End
Attribute VB_Name = "frmIISRapidLab348_2"
...
Private Sub Form_Unload(Cancel As Integer)
    ...
    Set frmIISRapidLab348_2 = Nothing
End Sub
...
On Error GoTo Errors
    ...
    With MSComm
        ...
        If .PortOpen Then
            ...
            Error.SetLog App.EXEName, "frmIISRapidLab348_2", "GetEqpComm", strErrMsg, Now
