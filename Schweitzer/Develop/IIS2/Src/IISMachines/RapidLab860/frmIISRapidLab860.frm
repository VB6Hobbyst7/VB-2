...
Begin VB.Form frmIISRapidLab860 
   BackColor       =   &H00DBE6E6&
   Caption         =   "RapidLab 860"
   ClientHeight    =   9180
   ClientLeft      =   165
   ClientTop       =   450
   ClientWidth     =   15240
   ...
   Begin FPSpread.vaSpread tblReady 
      ...
      SpreadDesigner  =   "frmIISRapidLab860.frx":0000
   End
   Begin FPSpread.vaSpread tblComplete 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISRapidLab860.frx":04E4
   End
   ...
   Begin FPSpread.vaSpread tblResult 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISRapidLab860.frx":0D26
      TextTip         =   2
   End
   ...
   End
End
Attribute VB_Name = "frmIISRapidLab860"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
'-----------------------------------------------------------------------------'
'   파일명  : frmIISRapidLab860.frm
'   작성자  : 이상대
'   내  용  : RapidLab 860 장비폼
'   작성일  : 2004-11-18
'   버  전  :
...
On Error GoTo Errors
    ...
    With MSComm
        ...
        If .PortOpen Then
            ...
            Error.SetLog App.EXEName, "frmIISRapidLab860", "GetEqpComm", strErrMsg, Now
