...
Begin VB.Form frmIISCA500 
   ...
   Begin FPSpread.vaSpread tblReady 
      ...
      SpreadDesigner  =   "frmIISCA500.frx":0000
   End
   Begin FPSpread.vaSpread tblComplete 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISCA500.frx":04EF
   End
   ...
   Begin FPSpread.vaSpread tblResult 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISCA500.frx":0D31
      TextTip         =   2
   End
End
Attribute VB_Name = "frmIISCA500"
...
Private Sub EditRcvData()
    ...
    Dim strDistCd    As String  '수신한 Text Distinction Code 1
    ...
    Dim strType      As String  '수신한 결과유형
    Dim strFlag      As String  '수신한 Flag
    Dim strInfo      As String  '수신한 추가정보
    ...
    Select Case strDistCd
        Case "R"    '## Order Inquiry Text Format
            ...
            strBarNo = Mid$(strRcvBuf, 26, 13)
            strRackNo = Mid$(strRcvBuf, 20, 4)
            strPos = Mid$(strRcvBuf, 24, 2)
        ...
        Case "D"    '## Analysis Data Format
            ...
            strBarNo = Trim$(Mid$(strRcvBuf, 26, 13))
            strRackNo = Format$(Mid$(strRcvBuf, 20, 4), "#")
            strPos = Format$(Mid$(strRcvBuf, 24, 2), "#")
...
On Error GoTo Errors
    ...
    With MSComm
        ...
        If .PortOpen Then
            ...
            Error.SetLog App.EXEName, "frmIISCA500", "GetEqpComm", strErrMsg, Now
