...
Begin VB.Form frmIISGem3500_1 
   ...
   Begin FPSpread.vaSpread tblReady 
      ...
      SpreadDesigner  =   "frmIISGem3500_1.frx":0000
   End
   Begin FPSpread.vaSpread tblComplete 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISGem3500_1.frx":045D
   End
   ...
   Begin FPSpread.vaSpread tblResult 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISGem3500_1.frx":0BFE
   End
   ...
   End
End
Attribute VB_Name = "frmIISGem3500_1"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
'-----------------------------------------------------------------------------'
'   파일명  : frmIISGem3500_1.frm
'   작성자  : 오세원
'   내  용  : Gem 3500_1 장비폼
'   작성일  : 2014-07-30
'   병  원  : 전주예수병원
...
On Error GoTo Errors
    ...
    With MSComm
        ...
        If .PortOpen Then
            ...
            Error.SetLog App.EXEName, "frmIISGem3500_1", "GetEqpComm", strErrMsg, Now
