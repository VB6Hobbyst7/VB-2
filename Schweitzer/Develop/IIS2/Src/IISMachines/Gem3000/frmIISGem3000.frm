...
Begin VB.Form frmIISGem3000 
   ...
   Begin FPSpread.vaSpread tblReady 
      ...
      SpreadDesigner  =   "frmIISGem3000.frx":0000
   End
   Begin FPSpread.vaSpread tblComplete 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISGem3000.frx":045D
   End
   ...
   Begin FPSpread.vaSpread tblResult 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISGem3000.frx":0BFE
   End
   ...
   End
End
Attribute VB_Name = "frmIISGem3000"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
'-----------------------------------------------------------------------------'
'   파일명  : frmIISGem3000.frm
'   작성자  : 오세원
'   내  용  : Gem 3000 장비폼
'   작성일  : 2007-06-28
'   병  원  : 전주예수병원
...
On Error GoTo Errors
    ...
    With MSComm
        ...
        If .PortOpen Then
            ...
            Error.SetLog App.EXEName, "frmIISGem3000", "GetEqpComm", strErrMsg, Now
