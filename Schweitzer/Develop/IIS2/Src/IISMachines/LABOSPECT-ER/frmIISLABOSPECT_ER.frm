...
Begin VB.Form frmIISLABOSPECT_ER 
   BackColor       =   &H00DBE6E6&
   Caption         =   "LABOSPECT"
   ClientHeight    =   9180
   ClientLeft      =   225
   ...
   Begin FPSpread.vaSpread tblReady 
      ...
      SpreadDesigner  =   "frmIISLABOSPECT_ER.frx":0000
   End
   Begin FPSpread.vaSpread tblComplete 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISLABOSPECT_ER.frx":0508
   End
   ...
   Begin FPSpread.vaSpread tblResult 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISLABOSPECT_ER.frx":0D58
      TextTip         =   2
   End
End
Attribute VB_Name = "frmIISLABOSPECT_ER"
...
Private Sub Form_Unload(Cancel As Integer)
    ...
    Set frmIISLABOSPECT_ER = Nothing
End Sub
