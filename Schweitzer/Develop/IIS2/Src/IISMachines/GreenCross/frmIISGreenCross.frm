...
Begin VB.Form frmIISGreenCross 
   BackColor       =   &H00DBE6E6&
   Caption         =   "녹십자 의뢰결과"
   ClientHeight    =   9180
   ClientLeft      =   225
   ...
   Begin FPSpread.vaSpread tblExcelResult 
      ...
      SpreadDesigner  =   "frmIISGreenCross.frx":0000
   End
   Begin FPSpread.vaSpread tblexcel 
      ...
      EndProperty
      RetainSelBlock  =   0   'False
      SpreadDesigner  =   "frmIISGreenCross.frx":45B3
   End
   ...
   Begin FPSpread.vaSpread tblReady 
      ...
      SpreadDesigner  =   "frmIISGreenCross.frx":8B66
   End
   ...
   Begin FPSpread.vaSpread tblComplete 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISGreenCross.frx":907F
   End
   ...
   Begin FPSpread.vaSpread tblResult 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISGreenCross.frx":9820
   End
   ...
   End
End
Attribute VB_Name = "frmIISGreenCross"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
'-----------------------------------------------------------------------------'
'   파일명  : frmIISGreenCross.frm
'   작성자  : 오세원
'   내  용  : GreenCross 장비폼
'   작성일  : 2015-10-11
'   버  전  : 1.0.0
...
'        lngBufLen = Len(strBuffer)
        ...
        With tblExcelResult
            For i = 2 To .MaxRows
                For j = 1 To 18
                    .GetText j, i, varTmp
                    If j = 1 And varTmp = "" Then
                        Exit For
                    Else
                        strBuffer = strBuffer & Trim(varTmp) & "|"
                    End If
                Next
...
'    End If
    ...
    FileMultiReader.Path = "C:\GreenCross\Result\"
...
Private Sub EditRcvData()
    ...
    For Each objBuffer In mIntLib.Buffers
        ...
        strBarNo = Mid(mGetP(strRcvBuf, 1, "|"), 1)
        
        Call GetOrderX(mGetP(strBarNo, 1, "-"), mGetP(strBarNo, 2, "-"), mGetP(strBarNo, 3, "-"))
