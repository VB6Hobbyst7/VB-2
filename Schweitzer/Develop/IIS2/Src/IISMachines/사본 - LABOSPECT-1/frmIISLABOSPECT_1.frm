...
Begin VB.Form frmIISLABOSPECT_1 
   BackColor       =   &H00DBE6E6&
   Caption         =   "LABOSPECT"
   ClientHeight    =   9180
   ClientLeft      =   225
   ...
   Begin FPSpread.vaSpread tblReady 
      ...
      SpreadDesigner  =   "frmIISLABOSPECT_1.frx":0000
   End
   Begin FPSpread.vaSpread tblComplete 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISLABOSPECT_1.frx":0508
   End
   ...
   Begin FPSpread.vaSpread tblResult 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISLABOSPECT_1.frx":0D58
      TextTip         =   2
   End
End
Attribute VB_Name = "frmIISLABOSPECT_1"
...
Private Sub SendOrder()
    ...
    Select Case mIntLib.SndPhase
        ...
        Case 0      '## 최초 오더 전송인 경우
            '## Header
            strOutput = "H|\^&|||host_COMPUTER|||||LST008AS|TSDWN^REPLY|P|1" & vbCr
            '## Patient
