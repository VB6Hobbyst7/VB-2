...
Begin VB.Form frmIISCoa1 
   ...
   Begin FPSpread.vaSpread tblReady 
      ...
      SpreadDesigner  =   "frmIISCoa1.frx":0000
   End
   Begin FPSpread.vaSpread tblComplete 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISCoa1.frx":04FA
   End
   ...
   Begin FPSpread.vaSpread tblResult 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISCoa1.frx":0D3C
      TextTip         =   2
   End
End
Attribute VB_Name = "frmIISCoa1"
...
'[P C] 
         strBuf = "1H|\^&|||99^2.00|||||||P|1.00|20131212220653" & vbCrLf
strBuf = strBuf & "12" & vbCrLf
strBuf = strBuf & "2Q|1|^130010937938" & vbCrLf
strBuf = strBuf & "7E" & vbCrLf
strBuf = strBuf & "3L|1|N" & vbCrLf
strBuf = strBuf & "06" & vbCrLf
