...
Private Sub cmdGetRslt_Click()
    ...
    If optTest(0).Value = True Then
        ...
        Call EditRcvData
    '-- RB5
    ElseIf optTest(0).Value = True Then
...
On Error GoTo Errors
    ...
    Else
        strTestCd = "'PNBPCR1','PNBPCR2','PNBPCR3','PNBPCR4','PNBPCR7','PNBPCR6'"  'RB6
    End If
            ...
            For intCol = 1 To .MaxCols
                ...
                If intCol = 1 Then
                    ...
                    If strBarNo = "" Then
                        Exit Sub
                    End If
                '-- 채널, 결과 sp(PNBPCR6)  mp(PNBPCR2)  hi(PNBPCR7)  lp(PNBPCR3)  bp(PNBPCR4)  cp(PNBPCR1)
                ElseIf intCol = 10 Then
                    ...
                    If strTemp = "-" Then
                        For intRow2 = 1 To 6
                            Select Case intRow2
                                Case 1: strIntBase = "SP"
                                Case 2: strIntBase = "MP"
                                Case 3: strIntBase = "HI"
                                Case 4: strIntBase = "LP"
                                Case 5: strIntBase = "BP"
                                Case 6: strIntBase = "CP"
                            End Select
                    ...
                    Else
                        ...
                        For intRow2 = 1 To 6
                            ...
                            If InStr(strTemp, strIntBase) > 0 Then
                                strResult = "P"
                            Else
                                strResult = "Negative"
                            End If
