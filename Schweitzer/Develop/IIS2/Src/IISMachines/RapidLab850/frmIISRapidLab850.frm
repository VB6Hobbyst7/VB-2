...
Begin VB.Form frmIISRapidLab850 
   BackColor       =   &H00DBE6E6&
   Caption         =   "RapidLab 850"
   ClientHeight    =   9180
   ClientLeft      =   165
   ClientTop       =   450
   ClientWidth     =   15240
   ...
   Begin FPSpread.vaSpread tblReady 
      ...
      SpreadDesigner  =   "frmIISRapidLab850.frx":0000
   End
   Begin FPSpread.vaSpread tblComplete 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISRapidLab850.frx":04E4
   End
   ...
   Begin FPSpread.vaSpread tblResult 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISRapidLab850.frx":0D26
      TextTip         =   2
   End
   ...
   End
End
Attribute VB_Name = "frmIISRapidLab850"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
'-----------------------------------------------------------------------------'
'   파일명  : frmIISRapidLab850.frm
'   작성자  : 이상대
'   내  용  : RapidLab 850 장비폼
'   작성일  : 2004-06-17
'   버  전  :
...
On Error GoTo Errors
    ...
    With MSComm
        ...
        If .PortOpen Then
            ...
            Error.SetLog App.EXEName, "frmIISRapidLab850", "GetEqpComm", strErrMsg, Now
