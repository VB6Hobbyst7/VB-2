...
Begin VB.Form frmIISXE2100ASTM 
   BackColor       =   &H00DBE6E6&
   Caption         =   "XE2100"
   ClientHeight    =   9180
   ClientLeft      =   165
   ...
   Begin FPSpread.vaSpread tblReady 
      ...
      SpreadDesigner  =   "frmIISXE2100ASTM.frx":0000
   End
   Begin FPSpread.vaSpread tblComplete 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISXE2100ASTM.frx":04FA
   End
   ...
   Begin FPSpread.vaSpread tblResult 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISXE2100ASTM.frx":0D3C
      TextTip         =   2
   End
End
Attribute VB_Name = "frmIISXE2100ASTM"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
'-----------------------------------------------------------------------------'
'   파일명  : frmIISXE2100ASTM.frm
'   작성자  : 오세원
'   내  용  : XE2100ASTM 장비폼
'   작성일  : 2008-02-20
'   버  전  :
...
On Error GoTo Errors
    ...
    With MSComm
        ...
        If .PortOpen Then
            ...
            Error.SetLog App.EXEName, "frmIISXE2100ASTM", "GetEqpComm", strErrMsg, Now
