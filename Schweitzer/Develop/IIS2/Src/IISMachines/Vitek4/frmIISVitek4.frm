...
Begin VB.Form frmIISVitek4 
   ...
   Begin FPSpread.vaSpread tblSensi 
      ...
      SpreadDesigner  =   "frmIISVitek4.frx":0000
   End
   ...
   Begin FPSpread.vaSpread tblTemp 
      ...
      EndProperty
      MaxCols         =   4
      SpreadDesigner  =   "frmIISVitek4.frx":045A
   End
   ...
   Begin FPSpread.vaSpread tblReady 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISVitek4.frx":1CBC
      TextTip         =   2
   End
   ...
   Begin FPSpread.vaSpread tblComplete 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISVitek4.frx":234F
      TextTip         =   2
   End
   ...
   Begin FPSpread.vaSpread tblMnm 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISVitek4.frx":29E0
   End
   ...
   End
End
Attribute VB_Name = "frmIISVitek4"
