...
Begin VB.Form frmIISCobasE411 
   ...
   Begin FPSpread.vaSpread tblReady 
      ...
      SpreadDesigner  =   "frmIISCobasE411.frx":0000
   End
   Begin FPSpread.vaSpread tblComplete 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISCobasE411.frx":0509
   End
   ...
   Begin FPSpread.vaSpread tblResult 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISCobasE411.frx":0D59
      TextTip         =   2
   End
End
Attribute VB_Name = "frmIISCobasE411"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
'-----------------------------------------------------------------------------'
'   파일명  : frmIISCobasE411.frm
'   작성자  : 오세원
'   내  용  : CobasE411 장비폼
'   작성일  : 2014-01-21
'   버  전  :
...
Private Sub Command1_Click()
    ...
    pBuf = pBuf & "2P|1|||||||||||||||||||||||||||||||||" & vbCr
    pBuf = pBuf & "3B" & vbCrLf
    pBuf = pBuf & "3O|1|100022256918|66^00004^4^^SAMPLE^NORMAL|ALL|R|20201109191756|||||X||||||||||||||O|||||" & vbCr
    pBuf = pBuf & "42" & vbCrLf
    pBuf = pBuf & "4R|1|^^^211^^0|1.38|ng/ml|1.39^6.22|L||F|||20201109192157|20201109193152|" & vbCr
    pBuf = pBuf & "63" & vbCrLf
    pBuf = pBuf & "5C|1|I|48^Below normal(expected)range|I" & vbCr
    pBuf = pBuf & "57" & vbCrLf
    pBuf = pBuf & "6R|2|^^^90^^0|0.467|ng/ml|0.000^0.014|H||F|||20201109192115|20201109193110|" & vbCr
    pBuf = pBuf & "AE" & vbCrLf
    pBuf = pBuf & "7C|1|I|49^Above normal(expected)range|I" & vbCr
    pBuf = pBuf & "4E" & vbCrLf
    pBuf = pBuf & "0L|1" & vbCr
    pBuf = pBuf & "39" & vbCrLf
    pBuf = pBuf & "" & vbCrLf
