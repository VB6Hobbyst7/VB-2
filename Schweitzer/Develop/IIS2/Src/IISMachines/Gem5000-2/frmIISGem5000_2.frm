...
Begin VB.Form frmIISGem5000_2 
   ...
   Begin FPSpread.vaSpread tblReady 
      ...
      SpreadDesigner  =   "frmIISGem5000_2.frx":0000
   End
   Begin FPSpread.vaSpread tblComplete 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISGem5000_2.frx":045D
   End
   ...
   Begin FPSpread.vaSpread tblResult 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISGem5000_2.frx":0BFE
   End
   ...
   End
End
Attribute VB_Name = "frmIISGem5000_2"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
'-----------------------------------------------------------------------------'
'   파일명  : frmIISGem5000_2.frm
'   작성자  : 오세원
'   내  용  : Gem 5000 장비폼
'   작성일  : 2019-01-07
'   병  원  : 전주예수병원
...
On Error GoTo Errors
    ...
    With MSComm
        ...
        If .PortOpen Then
            ...
            Error.SetLog App.EXEName, "frmIISGem5000_2", "GetEqpComm", strErrMsg, Now
