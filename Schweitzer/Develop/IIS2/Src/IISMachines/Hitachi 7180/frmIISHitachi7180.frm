...
Begin VB.Form frmIISHitachi7180 
   ...
   Begin FPSpread.vaSpread tblComplete 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISHitachi7180.frx":04FA
   End
   ...
   Begin FPSpread.vaSpread tblResult 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISHitachi7180.frx":0D3C
      TextTip         =   2
   End
End
        ...
        Case ":"    '## End
            ...
            For Each objBuffer In mIntLib.Buffers
                ...
                For i = 1 To Len(strTemp) Step 10
                    ...
                    'TIBC 결과 저장용
                    If Val(strIntBase) = 32 Then strFe = strResult
                    If Val(strIntBase) = 33 Then strUIBC = strResult
