...
Begin VB.Form frmIISSofia2 
   ...
   Begin IISSofia2.sckStringData sck 
      Height          =   300
      Left            =   15420
      TabIndex        =   26
      Top             =   8550
   ...
   Begin FPSpread.vaSpread tblReady 
      ...
      SpreadDesigner  =   "frmIISSofia2.frx":0000
   End
   Begin FPSpread.vaSpread tblComplete 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISSofia2.frx":0509
   End
   ...
   Begin FPSpread.vaSpread tblResult 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISSofia2.frx":0D59
      TextTip         =   2
   End
End
Attribute VB_Name = "frmIISSofia2"
