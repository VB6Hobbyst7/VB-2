...
Begin VB.Form frmIISSofia 
   ...
   Begin IISSofia.sckStringData sck 
      Height          =   300
      Left            =   8940
      TabIndex        =   26
      Top             =   8730
   ...
   Begin FPSpread.vaSpread tblReady 
      ...
      SpreadDesigner  =   "frmIISSofia.frx":0000
   End
   Begin FPSpread.vaSpread tblComplete 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISSofia.frx":04EF
   End
   ...
   Begin FPSpread.vaSpread tblResult 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISSofia.frx":0D31
      TextTip         =   2
   End
End
Attribute VB_Name = "frmIISSofia"
