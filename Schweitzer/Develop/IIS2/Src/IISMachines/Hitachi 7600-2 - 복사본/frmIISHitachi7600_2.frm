...
Begin VB.Form frmIISHitachi7600_2 
   BackColor       =   &H00DBE6E6&
   ...
   Begin FPSpread.vaSpread tblReady 
      ...
      SpreadDesigner  =   "frmIISHitachi7600_2.frx":0000
   End
   Begin FPSpread.vaSpread tblComplete 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISHitachi7600_2.frx":04FA
   End
   ...
   Begin FPSpread.vaSpread tblResult 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISHitachi7600_2.frx":0D3C
      TextTip         =   2
   End
End
Attribute VB_Name = "frmIISHitachi7600_2"
...
Private Sub Command1_Click()
    ...
    STRBUFFER = ""
    STRBUFFER = STRBUFFER & "1H|\^&|||H7600^1|||||host|TSREQ^REAL|P|1" & vbCr
    STRBUFFER = STRBUFFER & "P|1" & vbCr
    'STRBUFFER = STRBUFFER & "Q|1|^^0/           16001577137/1/5054/3/R1/R||||||||||O" & vbCr
    STRBUFFER = STRBUFFER & "Q|1|^^0/           16001665507/1/5054/3/R1/R||||||||||O" & vbCr
    '16 1665507
    STRBUFFER = STRBUFFER & "L|1|N" & vbCr
    STRBUFFER = STRBUFFER & "58" & vbCrLf
    STRBUFFER = STRBUFFER & ""
...
Private Sub Form_Unload(Cancel As Integer)
    ...
    Set frmIISHitachi7600_2 = Nothing
End Sub
    ...
    For Each objBuffer In mIntLib.Buffers
        ...
        Select Case strType
            ...
            Case "Q"    '## Request Information
                ...
                '-- 바코드가 오더를 못 받으면 두번째 넘어올때 "A"로 넘어온다.
                '-- "O" : 정상오더, "A" : 오더취소
            ...
            Case "R"    '## Result
                ...
                If strIntBase = "47" Then
                    ...
                    If objIntNms.ExistIntBase(strTmpBase) Then
                        Call objIntInfo.IntResults.Add(strTmpBase, objIntNms.GetIntNm(strTmpBase), _
                             strResult, strResult)
                    End If
