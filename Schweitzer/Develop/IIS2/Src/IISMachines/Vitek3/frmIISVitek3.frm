...
Begin VB.Form frmIISVitek3 
   ...
   Begin FPSpread.vaSpread tblSensi 
      ...
      SpreadDesigner  =   "frmIISVitek3.frx":0000
   End
   ...
   Begin FPSpread.vaSpread tblTemp 
      ...
      EndProperty
      MaxCols         =   4
      SpreadDesigner  =   "frmIISVitek3.frx":045A
   End
   ...
   Begin FPSpread.vaSpread tblReady 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISVitek3.frx":1CBC
      TextTip         =   2
   End
   ...
   Begin FPSpread.vaSpread tblComplete 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISVitek3.frx":234F
      TextTip         =   2
   End
   ...
   Begin FPSpread.vaSpread tblMnm 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISVitek3.frx":29E0
   End
   ...
   End
End
Attribute VB_Name = "frmIISVitek3"
...
Private Sub Command1_Click()
    ...
    strDump = ""
    strDump = strDump & "mtrsl|iiV2|is0000139C3E78|itID|pi01429100|pn< >|si|s032536|ss10|s510|s309/05/2016|s407:22|ci970002|c032536|ctcs|cncs|ta|rtGP|rr7708268|t11|o1staepi|o2Staphylococcus epidermidis|o3030400072621211|o999|zz|3d"
    strDump = strDump & ""
    
    strDump = ""
    strDump = strDump & "mtrsl|iiV2|is00000B35E19D|itSU|pi01429102|pn< >|pl45|p245|si|s06417|ss5I|s55I|s109/05/2016|s215:28|s309/05/2016|s415:28|ci970002|c06417|ctcs|cncs|ta|rtAST-N211|rr1601929|t11|o1propen|o2Proteus penneri|afQUINOLONES|apPARTIALLY RESISTANT|apWILD|apRESISTANT|afTETRACYCLINES|apWILD|afBETA-LACTAMS|apACQUIRED PENICILLINASE|afAMINOGLYCOSIDES|apWILD|afTRIMETHOPRIM/SULFONAMIDES|apTRIMETHOPRIM RESISTANT|apWILD|ra|a1am|a2Ampicillin|a3>=32|a4R|anR|ra|a1ams|a2Ampicillin/Sulbactam|a3>=32|a4R|anR|ra|a1tzp|a2Piperacillin/Tazobactam|a3<=4|a4S|anS|ra|a1cz|a2Cefazolin|a3>=64|a4R|anR|ra|a1fox|a2Cefoxitin|a3<=4|a4S|anS|ra|a1tax|a2Cefotaxime|a3<=1|a4S|anS|ra|a1taz|a2Ceftazidime|a3<=1|a4S|anS|ra|a1fep|a2Cefepime|a3<=1|a4S|anS|ra|a1azm|a2Aztreonam|a3<=1|a4S|anS|ra|a1etp|a2Ertapenem|a3<=0.5|a4S|anS|ra|a1mem|a2Meropenem|a3<=0.25|a4S|anS|ra|a1an|a2Amikacin|a3<=2|a4S|anS|ra|a1gm|a2Gentamicin|a3<=1|a4S|anS|ra|a1lev|a2Levofloxacin|a3<=0.12|a4S|anS|ra|a1tgc|a2Tigecycline|a32|a4R|anS|ra|a1sxt|a2Trim"
    strDump = strDump & "ethoprim/Sulfamethoxazole|a3<=20|a4S|anS|zz|c7"
...
Private Sub tblComplete_Click(ByVal Col As Long, ByVal Row As Long)
    ...
    With tblMnm
        For i = 1 To tblTemp.DataRowCnt
            ...
            If Val(vVitekNo1) = Val(vVitekNo2) Then
...
Private Sub tblMnm_Click(ByVal Col As Long, ByVal Row As Long)
    ...
    With tblSensi
        For i = 1 To tblTemp.DataRowCnt
            ...
            If Val(vVitekNo1) = Val(vVitekNo2) And vMnmCd1 = vMnmCd2 Then
...
'                    ' 오더[0109999] : 결과[109999] ==>  1월 9999번
'                    objVitek.VitekNo = Format$(Mid$(strTemp, 3), "0000000")
'                Else
'                    ' 오더[1009999] : 결과[1009999] ==> 10월 9999번
'                    objVitek.VitekNo = Format$(Mid$(strTemp, 3), "#000000")
'                End If
                
                '-- 2015.12.08
                objVitek.VitekNo = Format$(Mid$(strTemp, 3), "0000000")
                objVitek.SpcPos = objVitek.VitekNo
                If Mid(objVitek.VitekNo, 1, 1) = "0" Then
                    objVitek.SpcPos = Mid(objVitek.SpcPos, 2)
                End If
            ...
            Case "a4"   '## 결과코드
                If strDrugCd = "BETA" Then
                    strRstCd = "  "
                ElseIf strDrugCd = "ESBL" Then
                    strRstCd = UCase$(Mid$(strTemp, 3))
                    If Trim(strRstCd) = "+" Then
                        strVolumn = "POS"
                    Else
                        strVolumn = "NEG"
                    End If
...
Private Sub SetComplete2(ByVal pAccInfo As clsIISAccInfo, ByVal pVitek As clsIISIntInfo)
    ...
    With tblComplete
        ...
        End If
                                        '-- 2015.12.08
        .Col = TCompleteEnum.ccNo:     .Text = pVitek.SpcPos 'pVitek.VitekNo
...
Private Function GetVitekNo(ByVal pWorkarea As String, ByVal pAccDt As String, _
    ...
    '-- 2014.10.27 포맷수정 :osw
    '## 04-201409-9811 --> 1009811
    '## 04-201409-10002 --> 1010002
    GetVitekNo = Val(Mid$(pAccDt, 5, 2)) & Format$(CStr(pAccSeq), "00000")
End Function
