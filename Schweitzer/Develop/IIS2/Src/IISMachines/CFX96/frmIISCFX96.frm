...
Begin VB.Form frmIISCFX96 
   ...
   Begin FPSpread.vaSpread tblReady 
      ...
      SpreadDesigner  =   "frmIISCFX96.frx":0000
   End
   ...
   Begin FPSpread.vaSpread tblComplete 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISCFX96.frx":056D
   End
   ...
   Begin FPSpread.vaSpread tblResult 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISCFX96.frx":0E13
   End
   Begin FPSpread.vaSpread tblexcel 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      SpreadDesigner  =   "frmIISCFX96.frx":1506
   End
   ...
   Begin FPSpread.vaSpread vasINPrint 
      ...
      SpreadDesigner  =   "frmIISCFX96.frx":174F
      UserResize      =   0
   End
   Begin FPSpread.vaSpread vasFDPrint 
      ...
      ScrollBars      =   0
      ScrollBarShowMax=   0   'False
      SpreadDesigner  =   "frmIISCFX96.frx":C5BA
      UserResize      =   0
   End
   Begin FPSpread.vaSpread vasExcel 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      SpreadDesigner  =   "frmIISCFX96.frx":17A01
   End
...
Dim strReturnedString As String
    ...
    strFileName = App.Path & "\CFX96.ini"
...
'            End If
            ...
            If intCnt = 1 Then
                For i = 1 To tblReady.DataRowCnt
                    ...
                    If Val(tblReady.Text) = Val(varTmp(intCnt)) Then
