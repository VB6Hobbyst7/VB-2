...
Begin VB.Form frmInterface 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin FPSpread.vaSpread vasRes 
         ...
         RetainSelBlock  =   0   'False
         ScrollBars      =   2
         SpreadDesigner  =   "frmInterface.frx":2388
      End
   End
   ...
   Begin VB.Frame FrmHideControl 
      ...
      Begin VB.Frame Frame4 
         ...
         Begin FPSpread.vaSpread vasPrintBuf 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            SpreadDesigner  =   "frmInterface.frx":54D8
         End
      End
      ...
      Begin FPSpread.vaSpread vasCode 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":56F0
      End
      Begin FPSpread.vaSpread vasTemp1 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":5908
      End
         ...
         Begin MSComctlLib.ImageList imlStatus 
            ...
            BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
               ...
               BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":60AA
                  Key             =   "RUN"
               EndProperty
               BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":6644
                  Key             =   "NOT"
               EndProperty
               BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":6BDE
                  Key             =   "STOP"
               EndProperty
               BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":7178
                  Key             =   "LST"
               EndProperty
               BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":7A0A
                  Key             =   "ITM"
               EndProperty
               BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":7B64
                  Key             =   "ERR"
               EndProperty
               BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":7CBE
                  Key             =   "NOF"
               EndProperty
            EndProperty
         End
      ...
      Begin FPSpread.vaSpread vasList 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":7E18
      End
      Begin FPSpread.vaSpread vasResTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":8030
      End
      Begin FPSpread.vaSpread vasTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":8248
      End
...
Private Sub cmdSearch_Click()
    ...
    Select Case gOCS
        ...
        Case "GSEN":        Call GetWorkList_GSEN(Format(dtpStartDt.Value, "yyyymmdd"), Format(dtpStopDt.Value, "yyyymmdd"))
        Case "ONIT":        Call GetWorkList_ONIT(Format(dtpStartDt.Value, "yyyymmdd"), Format(dtpStopDt.Value, "yyyymmdd"))
    End Select
...
Private Sub GetWorkList_GSEN(ByVal pFrDt As String, ByVal pToDt As String, Optional pBarNo As String)
    Dim RS          As ADODB.Recordset
    Dim i           As Integer
    Dim iCnt        As Long
    Dim intRow      As Long
...
'    txtRCnt.Text = "0"
                ...
                '-- 처방일자,처방일련번호,환자명,검체번호,입외구분,일련번호,성별,나이,내원번호,처방코드
    SQL = ""
    SQL = SQL & "Select DISTINCT a.ORDT as 접수일자,'0',b.PANM as 이름,a.SPNO as 바코드번호,a.PAID as 챠트번호, a.OIFL,'0',b.SEXS as 성별,b.AGES as 나이,a.WKNO as 내원번호,a.ORCD as ITEM " & vbCr
    SQL = SQL & "  From emr.LRESULT a, emr.APATINF b" & vbCr
    SQL = SQL & " Where a.ORDT between  '" & pFrDt & "' and '" & pToDt & "'" & vbCr
    SQL = SQL & "   And a.PAID = b.PAID " & vbCr
    SQL = SQL & "   And a.ORCD in (" & gAllExam & ")" & vbCr
    SQL = SQL & "   And a.OKFL <> 'Y' "   '-- 결과확정유무
    SQL = SQL & " ORDER BY 접수일자,챠트번호"
        ...
        Do Until RS.EOF
            ...
            With vasID
                ...
                If blnSame = False Then
                    ...
                    SetText vasID, IIf(Trim(RS.Fields("OIFL")) = "I", "입원", "외래"), .MaxRows, colINOUT
                    SetText vasID, txtRack.Text, .MaxRows, colDISKNO
...
Private Sub GetWorkList_ONIT(ByVal pFrDt As String, ByVal pToDt As String, Optional pBarNo As String)
    Dim RS          As ADODB.Recordset
    Dim i           As Integer
    Dim iCnt        As Long
    Dim intRow      As Long
...
'    SQL = SQL & " ORDER BY 접수일자,챠트번호"
    ...
    SQL = ""
    SQL = SQL + vbLf + "SELECT PER_GUMJIN_DATE as 접수일자, PER_NAME as 이름, PER_GUM_NUM as 바코드번호, EDPSCODE as ITEM "
    SQL = SQL + vbLf + "  FROM ONIT..GUMJIN_INTERFACE "
    SQL = SQL + vbLf + " WHERE PER_GUMJIN_DATE BETWEEN '" & pFrDt & "' AND '" & pToDt & "' "
    'SQL = SQL + vbLf + "   AND PER_GUM_NUM = '" & Mid(strDate1, 9) & "' "
    SQL = SQL + vbLf + "   AND EDPSCODE IN (" & gAllExam & ") "
    SQL = SQL + vbLf + "   AND RESULT = ''  OR RESULT IS NULL "
    SQL = SQL + vbLf + " ORDER BY 접수일자, PER_GUM_NUM * 10"
        ...
        Do Until RS.EOF
            ...
            With vasID
                ...
                For i = 1 To .DataRowCnt
                    strDate = GetText(vasID, i, colHOSPDATE)
                    strChart = GetText(vasID, i, colBARCODE)
                    If Trim(RS("접수일자")) = strDate And Val(Trim(RS("바코드번호"))) = Val(strChart) Then
                        blnSame = True
                    End If
                    For intCol = colState + 1 To vasID.MaxCols
                        If Trim(RS.Fields("ITEM")) = gArrEquip(intCol - colState, 3) Then
                ...
                If blnSame = False Then
                    ...
                    SetText vasID, "1", .MaxRows, colCheckBox
                    SetText vasID, Trim(RS.Fields("접수일자")) & "", .MaxRows, colHOSPDATE
                    SetText vasID, Format(Trim(RS.Fields("바코드번호")), "0000"), .MaxRows, colBARCODE
'                    SetText vasID, Trim(RS.Fields("챠트번호")) & "", .MaxRows, colCHARTNO
                    'SetText vasID, Trim(RS.Fields("내원번호")) & "", .MaxRows, colPID
                    SetText vasID, Trim(RS.Fields("이름")) & "", .MaxRows, colPNAME
                    'SetText vasID, Trim(RS.Fields("성별")) & "", .MaxRows, colPSEX
...
Private Sub cmdSL_Click()
    If cmdSL.Caption = "▶" Then
        cmdSL.Caption = "◀"
        vasID.Width = 21945 '18345 '15225
    Else
        cmdSL.Caption = "▶"
        vasID.Width = 14445 '10845 '8475
    End If
...
Function GetGetEquipExamCode_CA270(argEquipCode As String, argPID As String, Optional intRow As Long) As String

    Dim i As Integer
    Dim strExamCode As String
    Dim sBarcode     As String
    
    GetGetEquipExamCode_CA270 = ""
    ...
    GetGetEquipExamCode_CA270 = strExamCode
...
'    Next i
    ...
    Call GetSampleInfoW_ONIT(intRow)
    ...
    '-- 로컬테이블에서 검사항목에 해당하는 검사채널 찾아오기 (intRow = 기존 검사했던 바코드가 다시 올라올 경우 위치를 못찾는다.)
'    strItems = GetGetEquipExamCode_CA270(gEquip, pBarNo, intRow)
...
'        strRcvBuf = strRecvData(intCnt)
        ...
        Select Case strType
            ...
            Case ";"    'Order  전송
'''''
'''''                '4O|1|2357||^^^01|||20160711000000||0|||||||02
'''''
'''''                'strBarNo = Trim(mGetP(strRcvBuf, 4, "|"))
'''''                'strBarNo = Trim(mGetP(strBarNo, 3, "^"))
'''''
'''''                If strWKNO <> Trim(mGetP(strRcvBuf, 3, "|")) Then
'''''                    strWKNO = Trim(mGetP(strRcvBuf, 3, "|"))
'''''                    'strWKNO = Trim(mGetP(strWKNO, 3, "^"))
'''''
'''''                    gRow = 0
'''''                    strBarNo = ""
'''''                    For i = 1 To vasID.DataRowCnt
'''''                        vasID.Row = i
'''''                        vasID.Col = colPID
'''''                        If Val(Trim(vasID.Text)) = Val(strWKNO) Then
'''''                            gRow = i
...
'''                vasWorkList.MaxRows = vasWorkList.MaxRows - 1
            ...
            Case ":"    '받은 결과 데이터 편집
                ...
                ':n1    11  11 SIN SENG-C 1    00801160858        8  1    17   2    31   3    46  13   1.1  15   102  16   195  17   131  18    39 

                ':n1    11  11 SIN SENG-C 1    00801160858        8  1    17   2    31   3    46  13   1.1  15   102  16   195  17   131  18    39
                '08:59:57 [Rx]
                
                ':n1    21  21          S-1    00801160911        8  1    35   2    44   3
                '   31  13   1.0
                ...
                If strFunc <> "@" And strFunc <> "M" Then
                   ...
                   ' SetRawData "[strSeq]" & strSeq
                   ' SetRawData "[strRackNo]" & strRackNo
                   ' SetRawData "[strTubePos]" & strTubePos
                   ' SetRawData "[strBarNo]" & strBarNo
                   ' SetRawData "[intCnt]" & intCnt
                    ...
                    'SetRawData "[strTmp]" & strTmp
                    
                   ' For intT = 52 To Len(strRcvBuf) Step 9
