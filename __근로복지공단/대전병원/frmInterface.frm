...
RST:
    strErrMsg = ""
    strErrMsg = strErrMsg & "위    치 : " & gHOSP.MACHNM & "_SerialRcvData_ADVIA2120" & vbNewLine & vbNewLine
    strErrMsg = strErrMsg & "오류번호 : " & Err.Number & vbNewLine & vbNewLine
    strErrMsg = strErrMsg & "오류내용 : " & Err.Description & vbNewLine
    frmErrMsg.txtErr = vbNewLine & strErrMsg
    frmErrMsg.Show
            ...
            Case 1                  ' 초기화 확인(MT 대기)
                Select Case BufChar
                    ...
                    Case msMT                           '0(&H30), Initialize Message 직후이므로
                        ...
                        intPhase = 2
                    Case Else
                        Call InitialComm                'MT이외의 경우(즉, NACK)
                        intPhase = 1
                        Exit Sub
                End Select
...
On Error GoTo ErrHandle
    ...
    If gHOSP.MACHNM = "ADVIA2120" Then
