...
Private Sub ReceiveProcess()
    ...
    If gComm.COMTYPE = "1" Then
        ...
        Select Case UCase(gHOSP.MACHNM)
            ...
            Case "H7180":           Call Phase_Serial_HITACHI7180
    ...
    ElseIf gComm.COMTYPE = "2" Then
        Select Case UCase(gHOSP.MACHNM)
            ...
            Case "BC30":            Call TCPRcvData_BC30
...
Private Sub GetOrder_HITACHI7180(ByVal pBarno As String, ByVal pType As String)
    ...
    With frmInterface
        ...
        If intRow < 0 Then
            ...
            strSndMsg = ";" & mOrder.Func & " 88" & Mid(mOrder.Order, 1, 88) & "100000" & LEFT(mOrder.ChartNo & Space(30), 30)
...
'                    ;N1  1010  11                  0517211119
'                    ;N1  1020  21                  0517211119
'                    ;N1  1030  31                  0517211119
...
'                        End If
'
                        If strIntBase = "5" Then    'BUN
                            strBUN = strResult
                        End If
                        If strIntBase = "12" Then    'CREA
                            strCREA = strResult
                        End If
                        
                        
                        
                        If strIntBase = "7" Then    'TCHO
                            strTC = strResult
                        End If

                        If strIntBase = "9" Then   'TG
                            strTG = strResult
                        End If
