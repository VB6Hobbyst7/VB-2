...
Private Sub cmdSave_Click()
    ...
    Else
        ...
        Call SaveString(HKEY_CURRENT_USER, REG_MACH & "\" & "DATABASE", "ORACLESID", strSID)
        Call SaveString(HKEY_CURRENT_USER, REG_MACH & "\" & "DATABASE", "ORACLEUID", strUID)
        Call SaveString(HKEY_CURRENT_USER, REG_MACH & "\" & "DATABASE", "ORACLEPWD", strPWD)
