...
Begin VB.Form frmInterface 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin FPSpread.vaSpread vasRes 
         ...
         RetainSelBlock  =   0   'False
         ScrollBars      =   2
         SpreadDesigner  =   "frmInterface.frx":1F88
      End
   End
   ...
   Begin VB.Frame FrmHideControl 
      ...
      Begin VB.Frame Frame5 
         ...
         Begin VB.ComboBox cboChk 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmInterface.frx":35E0
            Left            =   2460
            List            =   "frmInterface.frx":35ED
            TabIndex        =   68
            Top             =   1680
            Visible         =   0   'False
            Width           =   975
         ...
         Begin VB.ComboBox cboTest 
            ...
            ForeColor       =   &H00FF0000&
            Height          =   300
            ItemData        =   "frmInterface.frx":3605
            Left            =   600
            List            =   "frmInterface.frx":3607
            Style           =   2  '드롭다운 목록
            TabIndex        =   67
            Top             =   1650
            Visible         =   0   'False
      ...
      Begin VB.Frame Frame4 
         ...
         Begin FPSpread.vaSpread vasPrint 
            ...
            EndProperty
            MaxCols         =   9
            SpreadDesigner  =   "frmInterface.frx":3609
         End
         Begin FPSpread.vaSpread vasPrintBuf 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            SpreadDesigner  =   "frmInterface.frx":3A6F
         End
      End
      ...
      Begin FPSpread.vaSpread vasCode 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":3C91
      End
      Begin FPSpread.vaSpread vasTemp1 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":3EB3
      End
         ...
         Begin MSComctlLib.ImageList imlStatus 
            ...
            BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
               ...
               BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":465F
                  Key             =   "RUN"
               EndProperty
               BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":4BF9
                  Key             =   "NOT"
               EndProperty
               BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":5193
                  Key             =   "STOP"
               EndProperty
               BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":572D
                  Key             =   "LST"
               EndProperty
               BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":5FBF
                  Key             =   "ITM"
               EndProperty
               BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":6119
                  Key             =   "ERR"
               EndProperty
               BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":6273
                  Key             =   "NOF"
               EndProperty
            EndProperty
         End
      ...
      Begin FPSpread.vaSpread vasList 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":63CD
      End
      Begin FPSpread.vaSpread vasResTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":65EF
      End
      Begin FPSpread.vaSpread vasTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":6811
      End
      Begin FPSpread.vaSpread vasExcel 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":6A33
      End
...
''    Exit Sub
    ...
    blnSameBC = False
          ...
          SQL = " SELECT '', SAVESEQ, MID(EXAMDATE,1,8) AS EXAMDATE, HOSPDATE AS 접수일자, BARCODE AS 바코드번호, CHARTNO AS 차트번호, PID AS 내원번호, PNAME AS 이름,PSEX AS 성별, PAGE AS SN, DISKNO, POSNO, EXAMCODE, RESULT, REFFLAG, SAMPLETYPE, SENDFLAG,INOUT " & vbCrLf
        ...
        Do Until RS.EOF
            With vasID
                ...
                If blnSame = False Then
                    ...
                    SetText vasID, Trim(RS.Fields("SN")) & "", .MaxRows, colSN
                    ...
                    For i = 1 To vasID.DataRowCnt - 1
                        If Trim(GetText(vasID, i, colBARCODE)) = pBarNo Then
                            'intRow = i
                            SetBackColor vasID, i, i, 1, colState, 255, 255, 0
                            SetBackColor vasID, .MaxRows, .MaxRows, 1, colState, 255, 255, 0
                            Exit For
...
Private Sub GetWorkList_BIT(ByVal pFrDt As String, ByVal pToDt As String, Optional pBarNo As String)
    ...
    SQL = SQL & "       M.MANRESNUM as 주민번호, M.MANPATNAM as 이름, L.LABINSNUM as 처방순서,L.LABSMPNAM as 검체명, L.LABBARCOD as 바코드번호, L.LABODRCOD as ITEM " & vbCrLf
...
Private Sub GetWorkList_ASAN(ByVal pFrDt As String, ByVal pToDt As String, Optional pBarNo As String)
    Dim RS          As ADODB.Recordset
    Dim i           As Integer
    Dim iCnt        As Long
    Dim intRow      As Long
    ...
    SQL = SQL & "SELECT DISTINCT HONM, OKDT , SPNO , WKNO  , PAID  , PANM  , SEXS  , SJDT  , ORCD" & vbCrLf
        ...
        Do Until RS.EOF
            ...
            With vasID
                ...
                For i = 1 To .DataRowCnt
                    strDate = GetText(vasID, i, colHOSPDATE)
                    strChart = GetText(vasID, i, colBARCODE)
                    If Trim(RS("OKDT")) = strDate And Trim(RS("SPNO")) = strChart Then
                        blnSame = True
                    End If
                    For intCol = colState + 1 To vasID.MaxCols
                        If Trim(RS.Fields("ORCD")) = gArrEquip(intCol - colState, 3) Then
                            vasID.Row = .MaxRows
                            vasID.Col = intCol
                            vasID.BackColor = vbYellow
                            Exit For
                ...
                If blnSame = False Then
                    .MaxRows = .MaxRows + 1
                    SetText vasID, "1", .MaxRows, colCheckBox
                    SetText vasID, Trim(RS.Fields("OKDT")) & "", .MaxRows, colHOSPDATE
                    SetText vasID, Trim(RS.Fields("SPNO")) & "", .MaxRows, colBARCODE
                    SetText vasID, Trim(RS.Fields("WKNO")) & "", .MaxRows, colCHARTNO
                    SetText vasID, Trim(RS.Fields("PAID")) & "", .MaxRows, colPID
                    SetText vasID, Trim(RS.Fields("PANM")) & "", .MaxRows, colPNAME
                    SetText vasID, Trim(RS.Fields("SEXS")) & "", .MaxRows, colPSEX
...
Private Sub GetWorkList_SQLLAB(ByVal pFrDt As String, ByVal pToDt As String, Optional pBarNo As String)
    Dim RS          As ADODB.Recordset
    Dim i           As Integer
    Dim iCnt        As Long
    Dim intRow      As Long
...
'    If gIFMode = "Barcode" Then
        Select Case gOCS
            ...
            Case "ASAN":        Call GetWorkList_ASAN(Format(dtpStartDt.Value, "yyyymmdd"), Format(dtpStopDt.Value, "yyyymmdd"))
            Case "SQLLAB":      Call GetWorkList_SQLLAB(Format(dtpStartDt.Value, "yyyymmdd"), Format(dtpStopDt.Value, "yyyymmdd"))
        End Select
'    Else
'
'        'frmWorkList.Left = 0
...
Private Sub SetPatInfo(ByVal pBarNo As String, Optional ByVal pRno As String, Optional ByVal pPno As String)
    ...
    Call GetSampleInfoW_SQLLAB(intRow)
...
Private Sub EditRcvDataASTM()
    ...
    '=======================================================================================================================
    '          10       20        30        40        50        60
    '1234567890123456789012345678901234567890123456789012345678901234567890          랙/pos,검체종류 , 결과,농도   ,흡광도
    'DU2074003 11              0.031    3(-/-/-)2007/ 9/2015:15:32 00AF2     ==> 003/ 1 ,1일별검체,    3,(-/-/-),0.031
    'DU2075003 21              0.032    4(-/-/-)2007/ 9/2015:15:50 00AF6
    'DU2076003 31              0.036    5(-/-/-)2007/ 9/2015:16:08 00B01
    '=======================================================================================================================
    
    
    'DU   1006 111234          0.009     6    (-)07/09/201621:49:0800  1 10

    'DU  23003 11160901300078  0.014    9(-)    2016- 9- 1오후 11: 00D89


    'NS Prime
    'DU   1006 111234          0.009     6    (-)07/09/201621:49:0800  1 1
    
    'SetRawData "[Rcv]" & strRecvData(1)
    SetRawData "[Rcv]" & ReceiveData
    
    'strTemp1 = strRecvData(1) 'strBuffer
    strTemp1 = ReceiveData 'strBuffer
    
    
    'DU   1001 11611321000078  0.004     5    (-)27/09/201609:24:4200  1 1
    If Mid$(strTemp1, 2, 1) <> "U" Then '"U" = 검체 "C" = 컨트롤
        Exit Sub
    End If
    
    'strSeq = Trim(Mid(strTemp1, 4, 4))
'    strRackNo = Trim(Mid(strTemp1, 7, 3))
'    strTubePos = Trim(Mid(strTemp1, 10, 2))
'    strMethode = IIf(Mid(strTemp1, 13, 1) = "1", "1일별검체", "2일별검체")
'    strPatID = Trim(Mid(strTemp1, 13, 14))
'    strResult = Trim(Mid(strTemp1, 33, 13))
    strIntBase = "1"
'    strBarNo = strPatID
    ...
    'DU   1001 11611321000078  0.004     5    (-)27/09/201609:24:4200  1 1
    'DU  20002101611323510107  -0.00     0    (-)27/09/201609:28:3300  1 1
...
'            If Trim(vasID.Text) = strPatID Then
'                vasID.Col = colBARCODE
'                strBarNo = vasID.Text
'                Exit For
'            End If
...
'            vasID.Row = i
'            vasID.Col = colSN
'            If Trim(vasID.Text) = strSeq Then
'                vasID.Col = colBARCODE
'                strBarNo = vasID.Text
'                Exit For
'            End If
...
'    SQL = SQL & strSaveSeq
    ...
    SQL = SQL & "','" & Trim(GetText(vasID, asRow1, colSN))
    SQL = SQL & "',''"
    SQL = SQL & ",''"
    SQL = SQL & ",''"
    SQL = SQL & ",'1'"
...
'        End If
    ...
    ElseIf KeyCode = vbKeyReturn Then
        If iCol = colBARCODE Then
            ...
            '-- 바뀐 바코드로 환자정보 불러오기
            Call GetSampleInfoW_SQLLAB(iRow)
