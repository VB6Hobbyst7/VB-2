...
Begin VB.Form frmInterface 
   Caption         =   "OLYMPUS AU400 Interface "
   ClientHeight    =   12225
   ClientLeft      =   345
   ClientTop       =   840
   ClientWidth     =   25170
   ...
   Begin VB.Frame FrmHideControl 
      ...
      Begin FPSpread.vaSpread vasWorkList 
         ...
         SpreadDesigner  =   "frmInterface.frx":4188
      End
   ...
   Begin TabDlg.SSTab stInterface 
      ...
      TabPicture(0)   =   "frmInterface.frx":4BE9
      Tab(0).ControlEnabled=   0   'False
      Tab(0).Control(0)=   "Frame1"
      Tab(0).ControlCount=   1
      TabCaption(1)   =   "¹ÞÀº°á°ú"
      TabPicture(1)   =   "frmInterface.frx":4C05
      ...
      Begin VB.Frame Frame3 
         ...
         Begin FPSpread.vaSpread vasRID 
            ...
            RetainSelBlock  =   0   'False
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":4C21
            UserResize      =   2
         End
         Begin FPSpread.vaSpread vasRRes 
            ...
            RetainSelBlock  =   0   'False
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":5612
         End
      ...
      Begin VB.Frame Frame1 
         ...
         Begin FPSpread.vaSpread vasRes 
            ...
            RetainSelBlock  =   0   'False
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":9341
         End
         ...
         Begin FPSpread.vaSpread vasID 
            ...
            RetainSelBlock  =   0   'False
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":D058
            UserResize      =   2
         End
    ...
    For iRow = 1 To vasRID.DataRowCnt
        ...
        If vasRID.Value = 1 Then
            ...
            SQL = "SELECT RESULT " & vbCrLf & _
                  ...
                  "  AND PID = '" & Trim(GetText(vasRID, iRow, colPID)) & "' " & vbCrLf & _
                  "ORDER BY SEQNO"
...
Private Sub cmdRSch_Click()
    ...
    With vasRID
        While Not RS1.EOF
            ...
            .MaxRows = iRow
            .SetText 1, iRow, "1"
            .SetText 2, iRow, Trim(RS1.Fields("BARCODE").Value) & ""
            .SetText 3, iRow, ""
            .SetText 4, iRow, ""
            ...
            .SetText 9, iRow, Trim(RS1.Fields("CNT").Value) & ""
            .SetText 10, iRow, getResultCnt(Trim(RS1.Fields("BARCODE").Value) & "")
            
            Select Case Trim(RS1.Fields("TRANSYN").Value) & ""
            Case "0": SetText vasRID, "¿À´õ", iRow, 11
            Case "1": SetText vasRID, "°á°ú", iRow, 11
            Case "2": SetText vasRID, "¿Ï·á", iRow, 11
                      SetBackColor vasRID, iRow, iRow, 1, 11, 202, 255, 112
            End Select
            RS1.MoveNext
        Wend
        .RowHeight(-1) = 12
...
'    ipAdd = "172.168.0.56"
'    Winsock1.Close
'    Winsock1.Connect ipAdd, CInt(5500) '5150
...
Private Sub GetOrder(ByVal pBarNo As String)
    ...
    If optBar(0).Value = False Then
        For i = 1 To vasID.DataRowCnt
            If Trim(GetText(vasID, i, colSpecNo)) = pBarNo Then
    ...
    If IsNumeric(pBarNo) Then
        ...
        '-- intRow Ãß°¡
        strItems = GetEquipExamCode_AU400(gEquip, pBarNo, intRow)
    ...
    Else
        ...
        '                    Rack     Pos          Seq      Àåºñ¼³Á¤µÈ ¹ÙÄÚµå ÀÚ¸®¼ö¸¸Å­
        '                                                   ¿¹¸¦µé¾î Àåºñ¼³Á¤ÀÌ 20ÀÚ¸®°í ¹ÙÄÚµå ÀÚ¸®°¡ 12ÀÚ¸®¸é ¹ÙÄÚµå¹øÈ£¾Õ¿¡ ½ºÆäÀÌ½º 8ÀÚ¸®¸¦ Áà¾ßÇÑ´Ù.
        '                                                                                   °Ë»çÃ¤³Î(Ã¤³Î´ç 2ÀÚ¸®)
    ...
    For intCnt = 1 To UBound(strRecvData)
        ...
        Select Case strType
            ...
            Case "D "
                ...
                strTmp = Mid$(strRcvBuf, InStr(strRcvBuf, "E") + 1)
                ...
                If optBar(0).Value = False Then
                    ...
                    For ii = 1 To vasID.DataRowCnt
                        ...
                        If Trim(vasID.Text) = Trim(strSeq) Then
                            'vasID.Col = 5
                            'strBarNo = vasID.Text
                            strBarNo = Trim(GetText(vasID, ii, colBarcode))
                            Exit For
                        End If
                    Next
                '-- ¹ÙÄÚµå
...
'OBR|1||1052|00001^Automated Count^99MRC|||20160930085659|||||||||||||||||HM||||||||1
'OBX|5|NM|6690-2^WBC^LN||7.79|10*3/uL|4.00-10.00||||F
...
'    SQL = SQL & "'" & gIFUser & "')"
    ...
    SQL = SQL & "   AND EXAMTYPE =  '" & Trim(GetText(vasID, asRow1, colGubun)) & "' " & vbCrLf
...
Private Sub vasID_Click(ByVal Col As Long, ByVal Row As Long)
    ...
    SQL = SQL & "   AND a.EXAMTYPE = '" & gPart & "' " & vbCrLf
