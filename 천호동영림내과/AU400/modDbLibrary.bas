...
Function SaveTransDataW(ByVal argSpcRow As Integer) As Integer
    ...
    With frmInterface
        ...
        strExamType = Trim(GetText(.vasID, argSpcRow, colGubun))
...
Function GetEquipExamCode_AU400(argEquipCode As String, argPID As String, Optional intRow As Long) As String
    Dim i As Integer
    Dim strExamCode As String
    Dim sBarcode     As String
    
    GetEquipExamCode_AU400 = ""
    ...
    GetEquipExamCode_AU400 = strExamCode
