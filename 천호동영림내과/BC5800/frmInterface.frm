   ...
   Begin TabDlg.SSTab stInterface 
      ...
      Begin VB.Frame Frame3 
         ...
         Begin FPSpread.vaSpread vasRID 
            ...
            RetainSelBlock  =   0   'False
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":8950
            UserResize      =   2
         End
    ...
    For intCnt = 0 To UBound(strRecvData)
        ...
        Select Case strType
            ...
            Case "OBR"
                ...
                '-- ÀÎÅÍÆäÀÌ½º ÀÀ´ä
                               strSndBuffer = SB & "MSH|^~\&|Mindray|BS-400E|||" & Format(Now, "yyyymmddhhmmss") & "||ACK^R01|" & strBarNo & "|P|2.3.1||||0||ASCII|||" & vbCr
