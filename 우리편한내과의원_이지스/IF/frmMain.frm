...
Begin VB.Form frmMain 
      ...
      Begin MSComctlLib.ImageList imlStatus 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMain.frx":360E
               Key             =   "NOF"
            EndProperty
            BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMain.frx":3768
               Key             =   "ON"
               Object.Tag             =   "OFF"
            EndProperty
            BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMain.frx":4042
               Key             =   ""
            EndProperty
         EndProperty
      End
   ...
   Begin FPSpread.vaSpread spdOrder 
      ...
      ScrollBarExtMode=   -1  'True
      ShadowColor     =   16777215
      SpreadDesigner  =   "frmMain.frx":6F2C
      ScrollBarTrack  =   3
      ShowScrollTips  =   3
   End
   Begin FPSpread.vaSpread spdWork 
      ...
      ScrollBarExtMode=   -1  'True
      ShadowColor     =   16777215
      SpreadDesigner  =   "frmMain.frx":8BD0
      ScrollBarTrack  =   3
      ShowScrollTips  =   3
   End
...
'    End If
    ...
    Select Case UCase(gHOSP.MACHNM)
        ...
        Case "URIT3100":        Call Phase_Serial_URIT3100
        Case "URIT50":          Call Phase_Serial_URIT50
...
Private Sub comEQP_OnComm()
    ...
    Select Case comEqp.CommEvent
        Case comEvReceive
            ...
            Select Case UCase(gHOSP.MACHNM)
                        Case "H3100":           Call Phase_Serial_H3100
                        Case "HITACHI7020":     Call Phase_Serial_HITACHI7020
                        Case "URIT3100":        Call Phase_Serial_URIT3100
                        Case "URIT50":          Call Phase_Serial_URIT50
            ...
            Select Case strType
                ...
                Case ":"    '## End
                    ...
                    For ii = 45 To Len(strRcvBuf) Step 10
                        ...
                        If strIntBase = "06" Then    'TCHO
                            strTC = strResult
                        End If

                        If strIntBase = "07" Then   'TG
                            strTG = strResult
                        End If

                        If strIntBase = "14" Then    'HDLC
                            strHDL = strResult
                        End If
...
Private Sub SerialRcvData_H3100()
    Dim RS_L            As ADODB.Recordset
...
RST:
    strErrMsg = ""
    strErrMsg = strErrMsg & "위    치 : " & gHOSP.MACHNM & "_SerialRcvData_H3100" & vbNewLine & vbNewLine
    strErrMsg = strErrMsg & "오류번호 : " & Err.Number & vbNewLine & vbNewLine
    strErrMsg = strErrMsg & "오류내용 : " & Err.Description & vbNewLine
    frmErrMsg.txtErr = vbNewLine & strErrMsg
    frmErrMsg.Show
...
Private Sub SerialRcvData_URIT3100()
    Dim RS_L            As ADODB.Recordset
...
RST:
    strErrMsg = ""
    strErrMsg = strErrMsg & "위    치 : " & gHOSP.MACHNM & "_SerialRcvData_URIT3100" & vbNewLine & vbNewLine
    strErrMsg = strErrMsg & "오류번호 : " & Err.Number & vbNewLine & vbNewLine
    strErrMsg = strErrMsg & "오류내용 : " & Err.Description & vbNewLine
    frmErrMsg.txtErr = vbNewLine & strErrMsg
    frmErrMsg.Show
...
Private Sub SerialRcvData_URIT50()
    Dim RS_L            As ADODB.Recordset
    ...
    With frmMain
        For intCnt = 1 To UBound(strRData)
            ...
            Select Case intCnt
                ...
                Case 4 To 13
                    strIntBase = Mid(strRcvBuf, 2, 3)
                    strIntBase = Trim(strIntBase)
                    strResult = ""
                    strIntResult = ""
                    strResult = Mid(strRcvBuf, 5, 6) '-- 정성
                    strResult = Trim(strResult)
                    strIntResult = strResult
                    
                    If strResult = "Norma" Then
                        strResult = "-"
                        strIntResult = "-"
                    End If
...
RST:
    strErrMsg = ""
    strErrMsg = strErrMsg & "위    치 : " & gHOSP.MACHNM & "_SerialRcvData_URIT50" & vbNewLine & vbNewLine
    strErrMsg = strErrMsg & "오류번호 : " & Err.Number & vbNewLine & vbNewLine
    strErrMsg = strErrMsg & "오류내용 : " & Err.Description & vbNewLine
    frmErrMsg.txtErr = vbNewLine & strErrMsg
    frmErrMsg.Show
...
Private Sub Phase_Serial_H3100()
    Dim Buffer      As Variant
    Dim BufChar     As String
    Dim lngBufLen   As Long
    Dim i           As Long
...
Private Sub Phase_Serial_URIT3100()
    Dim Buffer      As Variant
    Dim BufChar     As String
    Dim lngBufLen   As Long
    Dim i           As Long
...
Private Sub Phase_Serial_URIT50()
    Dim Buffer      As Variant
    Dim BufChar     As String
    Dim lngBufLen   As Long
    Dim i           As Long
...
'    varBuffers = Split(strText, vbCr)
    ...
    If strText <> "" Then
        ...
        Select Case UCase(gHOSP.MACHNM)
            Case "BS240E":          Call TCPRcvData_BS240E
