...
Private Sub cmdSave_Click()
    ...
    If InputBox("비밀번호 입력" & Space(5) & "hint:개발자ohj") = "dev0731" Then
        Call WritePrivateProfileString("EXE", "EMR", txtEmr.Text, App.PATH & "\KDBAR.ini")
        
        Call WritePrivateProfileString("EXE", "MACH", txtMach.Text, App.PATH & "\KDBAR.ini")
        ...
        Call WritePrivateProfileString("EXE", "DBTYPE", strDBType, App.PATH & "\KDBAR.ini")
