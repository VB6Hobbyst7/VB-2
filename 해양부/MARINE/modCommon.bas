...
Public gInterGbn    As String
Public gAutoRefresh As String
...
Sub Main()
    ...
    If Now > "2020-12-10 01:01:01" Then
       MsgBox "사용기간 만료", vbExclamation
       End
    End If
    ...
    If Not DbConnect_ORACLE Then    '
        If vbYes = MsgBox("ORACLE 연결정보가 없습니다. 등록하시겠습니까? ", vbCritical + vbYesNo) Then
    ...
    '-- ORACLE DB2 접속
    If Not DbConnect_ORACLE2 Then
        If vbYes = MsgBox("ORACLE2 연결정보가 없습니다. 등록하시겠습니까? ", vbCritical + vbYesNo) Then
            frmDB_Oracle.Show vbModal
        Else
            End
        End If
...
Public Sub GetSetup()
    ...
    '-- ORACLE DB GET
    strSetup = "":    strSetUp1 = ""
    Call GetPrivateProfileString("DB", "ORACLESID", "", strSetup, 100, App.PATH & "\MARINE.ini")
    strSetUp1 = Trim(strSetup)
    strSetUp1 = Mid(strSetUp1, 1, Len(strSetUp1) - 1)
    gORADB.SID = Trim(strSetUp1)

    strSetup = "":    strSetUp1 = ""
    Call GetPrivateProfileString("DB", "ORACLEUID", "", strSetup, 100, App.PATH & "\MARINE.ini")
    strSetUp1 = Trim(strSetup)
    strSetUp1 = Mid(strSetUp1, 1, Len(strSetUp1) - 1)
    gORADB.UID = Trim(strSetUp1)
    
    strSetup = "":    strSetUp1 = ""
    Call GetPrivateProfileString("DB", "ORACLEPWD", "", strSetup, 100, App.PATH & "\MARINE.ini")
    strSetUp1 = Trim(strSetup)
    strSetUp1 = Mid(strSetUp1, 1, Len(strSetUp1) - 1)
    ...
    '-- ORACLE DB2 GET
    strSetup = "":    strSetUp1 = ""
    Call GetPrivateProfileString("DB2", "ORACLESID", "", strSetup, 100, App.PATH & "\MARINE.ini")
    strSetUp1 = Trim(strSetup)
    strSetUp1 = Mid(strSetUp1, 1, Len(strSetUp1) - 1)
    gORADB2.SID = Trim(strSetUp1)

    strSetup = "":    strSetUp1 = ""
    Call GetPrivateProfileString("DB2", "ORACLEUID", "", strSetup, 100, App.PATH & "\MARINE.ini")
    strSetUp1 = Trim(strSetup)
    strSetUp1 = Mid(strSetUp1, 1, Len(strSetUp1) - 1)
    gORADB2.UID = Trim(strSetUp1)
    
    strSetup = "":    strSetUp1 = ""
    Call GetPrivateProfileString("DB2", "ORACLEPWD", "", strSetup, 100, App.PATH & "\MARINE.ini")
    strSetUp1 = Trim(strSetup)
    strSetUp1 = Mid(strSetUp1, 1, Len(strSetUp1) - 1)
    gORADB2.PWD = Trim(strSetUp1)

    '-- Refresh timer GET
    strSetup = "":    strSetUp1 = ""
    Call GetPrivateProfileString("USER", "INTERVAL", "", strSetup, 100, App.PATH & "\MARINE.ini")
    strSetUp1 = Trim(strSetup)
    strSetUp1 = Mid(strSetUp1, 1, Len(strSetUp1) - 1)
    gInterVal = Trim(strSetUp1)

    strSetup = "":    strSetUp1 = ""
    Call GetPrivateProfileString("USER", "INTERGBN", "", strSetup, 100, App.PATH & "\MARINE.ini")
    strSetUp1 = Trim(strSetup)
    strSetUp1 = Mid(strSetUp1, 1, Len(strSetUp1) - 1)
    gInterGbn = Trim(strSetUp1)

    strSetup = "":    strSetUp1 = ""
    Call GetPrivateProfileString("USER", "AUTOREFREH", "", strSetup, 100, App.PATH & "\MARINE.ini")
    strSetUp1 = Trim(strSetup)
    strSetUp1 = Mid(strSetUp1, 1, Len(strSetUp1) - 1)
    gAutoRefresh = Trim(strSetUp1)
