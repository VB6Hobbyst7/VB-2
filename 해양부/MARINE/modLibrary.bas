...
Public Sub gProc_InsertRow(oSpread As Object, Optional Row As Long, Optional Append As Boolean = True)
    oSpread.Row = IIf(Append, oSpread.MaxRows, Row)
    oSpread.Action = ActionInsertRow
End Sub

Public Sub InsertRow(ByVal vasTable As Object, Optional Row As Long, Optional Append As Boolean = True)
    vasTable.Row = IIf(Append, vasTable.MaxRows, Row)
    vasTable.Action = ActionInsertRow
End Sub
