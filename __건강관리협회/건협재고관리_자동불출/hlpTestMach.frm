...
Begin VB.Form hlpTestMach 
   ...
   Begin BHButton.BHImageButton cmdConfirm 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      TransparentPicture=   "hlpTestMach.frx":0000
      BackColor       =   12632319
      ImgOutLineSize  =   3
   End
   Begin BHButton.BHImageButton cmdClose 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      TransparentPicture=   "hlpTestMach.frx":17C2
      BackColor       =   12632319
      ImgOutLineSize  =   3
   End
   Begin FPSpreadADO.fpSpread spList 
      ...
      ShadowDark      =   12632256
      SpreadDesigner  =   "hlpTestMach.frx":2F84
      VisibleCols     =   2
      VisibleRows     =   10
      CellNoteIndicatorColor=   16576
   End
End
Attribute VB_Name = "hlpTestMach"
...
Dim sRow As Long
    ...
    If gWorkArea Then
        gSql = "SELECT EQPCD,EQPNM FROM S2LAB006 ORDER BY EQPCD"
    Else
        gSql = "SELECT MACHCODE AS EQPCD,MACHNAME AS EQPNM FROM " & gKahpUser & "TWMED_MACHINE ORDER BY MACHCODE"
    End If
    With cDb.cfRecordSet(gSql)
        If .State = adStateOpen Then
            If Not .EOF Then
                ...
                While (Not .EOF)
                    sRow = sRow + 1
                    spList.SetText 1, sRow, "" & .Fields("EQPCD").Value
                    spList.SetText 2, sRow, "" & .Fields("EQPNM").Value
