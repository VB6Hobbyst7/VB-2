...
Begin VB.Form PIS304 
   BackColor       =   &H00FFFFFF&
   Caption         =   "Ç°¸ñ¼ö±âÃâ°íÇöÈ²"
   ClientHeight    =   9765
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   14880
   ...
   Begin XLibrary_XGroupBox.XGroupBox grpMain 
      ...
      Begin BHButton.BHImageButton cmdFind 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         TransparentPicture=   "PIS304.frx":0000
         BackColor       =   12632319
         ImgOutLineSize  =   3
      End
      Begin BHButton.BHImageButton cmdExcel 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         TransparentPicture=   "PIS304.frx":17C2
         BackColor       =   12632319
         ImgOutLineSize  =   3
      End
      Begin BHButton.BHImageButton cmdClose 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         TransparentPicture=   "PIS304.frx":2F84
         BackColor       =   12632319
         ImgOutLineSize  =   3
      End
      Begin BHButton.BHImageButton cmdClear 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         TransparentPicture=   "PIS304.frx":4746
         BackColor       =   12632319
         ImgOutLineSize  =   3
      End
      Begin FPSpreadADO.fpSpread spList 
         ...
         ShadowDark      =   12632256
         SpreadDesigner  =   "PIS304.frx":5F08
         VisibleCols     =   3
         VisibleRows     =   10
      ...
      Begin XLibrary_XGroupBox.XGroupBox grpFind 
         ...
         Begin TDBDate6Ctl.TDBDate dtpTodt 
            ...
            _ExtentX        =   2461
            _ExtentY        =   556
            Calendar        =   "PIS304.frx":6686
            Caption         =   "PIS304.frx":676D
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               Name            =   "±¼¸²Ã¼"
               Size            =   9
               Charset         =   129
               ...
               Strikethrough   =   0   'False
            EndProperty
            DropDown        =   "PIS304.frx":67D0
            Keys            =   "PIS304.frx":67EE
            Spin            =   "PIS304.frx":684C
            AlignHorizontal =   0
            AlignVertical   =   2
            Appearance      =   2
         ...
         Begin TDBDate6Ctl.TDBDate dtpFrdt 
            ...
            _ExtentX        =   2461
            _ExtentY        =   556
            Calendar        =   "PIS304.frx":6874
            Caption         =   "PIS304.frx":695B
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               Name            =   "±¼¸²Ã¼"
               Size            =   9
               Charset         =   129
               ...
               Strikethrough   =   0   'False
            EndProperty
            DropDown        =   "PIS304.frx":69BE
            Keys            =   "PIS304.frx":69DC
            Spin            =   "PIS304.frx":6A3A
            AlignHorizontal =   0
            AlignVertical   =   2
            Appearance      =   2
            BackColor       =   -2147483643
         ...
         Begin BHButton.BHImageButton cmdStk 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            TransparentPicture=   "PIS304.frx":6A62
            BackColor       =   14737632
            AlphaColor      =   16777215
            ImgOutLineSize  =   3
         End
...
Dim sRow As Long, sOper() As String, sFrDt As String, sToDt As String
    ...
    If gWorkArea Then
        gSql = "SELECT A.*, X.NM_ITEM AS STKNM, C.REASONNM, D.EMPNM,                                                        " & vbNewLine & _
               " (SELECT DISTINCT Y.LOTNO FROM S2PIS401 Z INNER JOIN S2PIS201 Y ON Z.ENTDT=Y.ENTDT AND Z.ENTSEQ=Y.ENTSEQ    " & vbNewLine & _
               "         WHERE Z.CHULDT=A.CHULDT AND Z.CHULSEQ=A.CHULSEQ) AS LOTNO                                          " & vbNewLine & _
               "  FROM S2PIS303 A                                                                                           " & vbNewLine & _
    ...
    Else
        gSql = "SELECT A.*, X.NM_ITEM AS STKNM, C.REASONNM, D.USER_NM AS EMPNM,                                             " & vbNewLine & _
               " (SELECT DISTINCT Y.LOTNO FROM S2PIS401 Z INNER JOIN S2PIS201 Y ON Z.ENTDT=Y.ENTDT AND Z.ENTSEQ=Y.ENTSEQ    " & vbNewLine & _
               "         WHERE Z.CHULDT=A.CHULDT AND Z.CHULSEQ=A.CHULSEQ) AS LOTNO                                          " & vbNewLine & _
               "  FROM S2PIS303 A                                                                                           " & vbNewLine & _
               "       LEFT JOIN " & gTBLstk & " X ON A.STKCD=X.CD_ITEM" & gERPStkCondition & "                             " & vbNewLine & _
    ...
    If Len(txtStkcd.Text) > 0 Then
        gSql = gSql & "  AND A.STKCD='" & Trim(txtStkcd.Text) & "'"
    End If
    gSql = gSql & " ORDER BY A.STKCD,A.WORKDT,A.SEQ"
        ...
        If .State = adStateOpen Then
            If Not .EOF Then
                ...
                While (Not .EOF)
                    ...
                    spList.SetText 4, sRow, gfQtyOutputStr(Val("" & .Fields("QTY").Value))
                    ...
                    spList.SetText 8, sRow, "" & .Fields("EMPNM").Value
