...
Private Declare Function RegCreateKeyEx Lib "advapi32.dll" Alias "RegCreateKeyExA" _
                (ByVal hKey As Long, ByVal lpSubKey As String, ByVal Reserved As Long, ByVal lpClass As String, _
                 ByVal dwOptions As Long, ByVal samDesired As Long, ByRef lpSecurityAttributes As SECURITY_ATTRIBUTES, _
...
Private Declare Function RegQueryValueEx Lib "advapi32.dll" Alias "RegQueryValueExA" _
                (ByVal hKey As Long, ByVal lpValueName As String, ByVal lpReserved As Long, ByRef lpType As Long, _
...
'-- 레지스트리 설정
Global Const REG_COMPANY    As String = "M2ISoft"
Global Const REG_SYSTEM     As String = "MEDI_LAB"
Global Const REG_POSITION   As String = "Software\" & REG_COMPANY & "\" & REG_SYSTEM
Global Const REG_DBSET      As String = REG_POSITION & "\DATABASE"
Global Const REG_ORACLEDB_G As String = REG_DBSET & "\CONECT_ORACLE_G"               '지부 ORACLE
Global Const REG_ORACLEDB_C As String = REG_DBSET & "\CONECT_ORACLE_C"               '센터 ORACLE
'-- 데이타베이스 사용자
...
'-- 시약재고관리
Global Const REG_PIS        As String = REG_POSITION & "\PIS"
Global Const REG_AREACD     As String = "지부코드"
'Global Const REG_CENTERNM   As String = "CENTER NAME"
'Global Const REG_AUTOUPDATE As String = "AUTO UPDATE"
'Global Const REG_PRJNAME    As String = "PROJECT NAME"
