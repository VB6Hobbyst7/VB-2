   ...
   Begin XLibrary_XGroupBox.XGroupBox grpMain 
      ...
      Begin BHButton.BHImageButton cmdClose 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         TransparentPicture=   "PIS202.frx":0000
         BackColor       =   14737632
         AlphaColor      =   16777215
         ImgOutLineSize  =   3
      End
      Begin BHButton.BHImageButton cmdSave 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         TransparentPicture=   "PIS202.frx":17C2
         BackColor       =   14737632
         AlphaColor      =   16777215
         ImgOutLineSize  =   3
      End
      Begin BHButton.BHImageButton cmdFind 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         TransparentPicture=   "PIS202.frx":2F84
         BackColor       =   14737632
         AlphaColor      =   16777215
         ImgOutLineSize  =   3
      End
      Begin BHButton.BHImageButton cmdClear 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         TransparentPicture=   "PIS202.frx":4746
         BackColor       =   14737632
         AlphaColor      =   16777215
         ImgOutLineSize  =   3
      End
      Begin BHButton.BHImageButton cmdDelete 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         TransparentPicture=   "PIS202.frx":5F08
         BackColor       =   14737632
         AlphaColor      =   16777215
         ImgOutLineSize  =   3
      End
      ...
      Begin XLibrary_XGroupBox.XGroupBox XGroupBox3 
         ...
         Begin TDBDate6Ctl.TDBDate dtpDt 
            ...
            _ExtentX        =   2408
            _ExtentY        =   556
            Calendar        =   "PIS202.frx":76CA
            Caption         =   "PIS202.frx":77B1
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               Name            =   "굴림체"
               Size            =   9
               Charset         =   129
               ...
               Strikethrough   =   0   'False
            EndProperty
            DropDown        =   "PIS202.frx":7814
            Keys            =   "PIS202.frx":7832
            Spin            =   "PIS202.frx":7890
            AlignHorizontal =   0
            AlignVertical   =   2
            Appearance      =   2
      ...
      Begin FPSpreadADO.fpSpread spList 
         ...
         ShadowDark      =   12632256
         SpreadDesigner  =   "PIS202.frx":78B8
         VisibleCols     =   3
         VisibleRows     =   10
...
Dim fReason() As String, cPis301 As clsPis301
...
Dim sRow As Long, sGetVal As Variant, sReturn As Boolean
    ...
    With spList
        For sRow = 1 To .MaxRows
            .GetText 3, sRow, sGetVal:      cPis301.testcd = Trim(sGetVal)
            .GetText 1, sRow, sGetVal
            If Val(sGetVal) > 0 And Len(cPis301.testcd) > 0 Then
                cPis301.workdt = Format(dtpDt.Value, "yyyyMMdd")
                .GetText 2, sRow, sGetVal:      cPis301.seq = Val(sGetVal)
                .GetText 6, sRow, sGetVal:      cPis301.testcnt = Val(sGetVal)
                .GetText 8, sRow, sGetVal:      cPis301.reasoncd = Trim(sGetVal)
                .GetText 9, sRow, sGetVal:      cPis301.remark = Trim(sGetVal)
                cPis301.empid = gUserId
                
                If brSave Then
                    sReturn = cPis301.cfSave
                Else
                    If cPis301.seq > 0 Then
                        sReturn = cPis301.cfDelete
                    End If
                End If
...
Dim cPis006 As clsPis006, sStr As String, sRow As Integer
    ...
    With cPis006.cfList(True, gReasonTest)
...
Dim sRow As Long
    ...
    MousePointer = vbHourglass
    With cPis301.cfList(Format(dtpDt.Value, "yyyyMMdd"))
        If .State = adStateOpen Then
            If Not .EOF Then
                ...
                While (Not .EOF)
                    ...
                    spList.SetText 3, sRow, "" & .Fields("TESTCD").Value
                    spList.SetText 5, sRow, "" & .Fields("TESTNM").Value
                    spList.SetText 6, sRow, "" & .Fields("TESTCNT").Value
...
Private Sub spList_ButtonClicked(ByVal Col As Long, ByVal Row As Long, ByVal ButtonDown As Integer)
    ...
    If Col = 4 Then
        ...
        If Len(gHelpCode) > 0 Then
            ...
            spList.SetText 5, Row, gfTestName(gHelpCode)
...
Dim sGetVal As Variant
    ...
    If Row > 0 And Col > 1 Then
        ...
        If Col = 3 Then
            ...
            spList.SetText 5, Row, gfTestName(Trim(sGetVal))
