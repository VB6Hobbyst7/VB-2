...
Begin VB.Form hlpStkList 
   ...
   Begin BHButton.BHImageButton cmdConfirm 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      TransparentPicture=   "hlpStkList.frx":0000
      BackColor       =   12632319
      ImgOutLineSize  =   3
   End
   Begin BHButton.BHImageButton cmdClose 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      TransparentPicture=   "hlpStkList.frx":17C2
      BackColor       =   12632319
      ImgOutLineSize  =   3
   End
   ...
   Begin FPSpreadADO.fpSpread spList 
      ...
      ShadowDark      =   12632256
      SpreadDesigner  =   "hlpStkList.frx":2F84
      VisibleCols     =   3
      VisibleRows     =   10
      CellNoteIndicatorColor=   16576
   End
End
Attribute VB_Name = "hlpStkList"
...
Dim sRow As Long
    ...
    gSql = "SELECT X.CD_ITEM AS STKCD,X.NM_ITEM AS STKNM FROM " & gTBLstk & " X WHERE X.CD_ITEM>' ' " & gERPStkCondition & vbNewLine
