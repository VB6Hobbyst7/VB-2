...
Begin VB.Form frmInterface 
   ...
   Begin VB.Frame FrmHideControl 
      ...
      Begin VB.ComboBox cboTest 
         ...
         ForeColor       =   &H00FF0000&
         Height          =   300
         ItemData        =   "frmInterface.frx":3836
         Left            =   5220
         List            =   "frmInterface.frx":3838
         Style           =   2  '드롭다운 목록
         TabIndex        =   65
         Top             =   7080
         Visible         =   0   'False
      ...
      Begin VB.ComboBox cboChk 
         ...
         EndProperty
         Height          =   315
         ItemData        =   "frmInterface.frx":383A
         Left            =   5250
         List            =   "frmInterface.frx":3847
         TabIndex        =   64
         Top             =   5250
         Visible         =   0   'False
         Width           =   975
      ...
      Begin VB.Frame Frame4 
         ...
         Begin FPSpread.vaSpread vasPrintBuf 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            SpreadDesigner  =   "frmInterface.frx":52E6
         End
      End
      ...
      Begin FPSpread.vaSpread vasCode 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":550C
      End
      Begin FPSpread.vaSpread vasTemp1 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":5732
      End
         ...
         Begin MSComctlLib.ImageList imlStatus 
            ...
            BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
               ...
               BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":5EE2
                  Key             =   "RUN"
               EndProperty
               BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":647C
                  Key             =   "NOT"
               EndProperty
               BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":6A16
                  Key             =   "STOP"
               EndProperty
               BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":6FB0
                  Key             =   "LST"
               EndProperty
               BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":7842
                  Key             =   "ITM"
               EndProperty
               BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":799C
                  Key             =   "ERR"
               EndProperty
               BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":7AF6
                  Key             =   "NOF"
               EndProperty
            EndProperty
         End
      ...
      Begin FPSpread.vaSpread vasList 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":7C50
      End
      Begin FPSpread.vaSpread vasResTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":7E76
      End
      Begin FPSpread.vaSpread vasTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":809C
      End
      Begin FPSpread.vaSpread vasExcel 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":82C2
      End
        ...
        Do Until RS.EOF
            ...
            With vasID
                ...
                If blnSame = False Then
                    ...
                    SetText vasID, Trim(RS.Fields("내원번호")) & "", .MaxRows, colPID
                    SetText vasID, Trim(RS.Fields("이름")) & "", .MaxRows, colPNAME
                    SetText vasID, IIf(Trim(RS.Fields("IPDOPD")) = "I", "입원", "외래"), .MaxRows, colINOUT
        ...
        Case comEvReceive
            ...
            For i = 1 To lngBufLen
                ...
                Select Case BufChar
                    ...
                    Case EOT
                        If AckOn = False Then
                            comEqp.Output = STX & ACK & ETX & "0B" & EOT        'Ack Message
...
Rst:
    ...
    If MsgID = "SMP_NEW_DATA" Or MsgID = "SMP_EDIT_DATA" Then
        ...
        'MsgBox "strBarNo" & strBarNo
        'MsgBox "strSeqNo" & strSeqNo
...
'        If IsNumeric(strBarNo) And Len(strBarNo) = 8 Then
'            strBarNo = Format(strBarNo, "00000000")
'        End If
    ...
    '-- 2017.05.02
'''    If MsgID = "QC_NEW_DATA" Or MsgID = "QC_EDIT_DATA" Then
'''        'aMod
'''        x1 = 1
'''        x1 = InStr(x1, MsgBuf, "aMod") + 5
'''        If x1 <> 5 Then
...
'''        'iQID
'''        x1 = 1
'''        x1 = InStr(x1, MsgBuf, "iQID") + 5
'''        If x1 <> 5 Then
'''            x2 = InStr(x1, MsgBuf, GS)
'''            iQID = Mid(MsgBuf, x1, x2 - x1)
'''        End If
'''
'''        'iQLEV
'''        x1 = 1
'''        x1 = InStr(x1, MsgBuf, "iQLEV") + 5
'''        If x1 <> 5 Then
'''            x2 = InStr(x1, MsgBuf, GS)
'''            iQLEV = Mid(MsgBuf, x1, x2 - x1)
'''        End If
'''
'''        'iQLOT
'''        x1 = 1
'''        x1 = InStr(x1, MsgBuf, "iQLOT") + 5
'''        If x1 <> 5 Then
'''            x2 = InStr(x1, MsgBuf, GS)
'''            iQLOT = Mid(MsgBuf, x1, x2 - x1)
'''        End If
'''
'''        'rDATE
'''        x1 = 1
...
'''            strResult = Mid(MsgBuf, x2, x1 - x2)
'''
'''            'Point  |Date and Time  |Run    |Level  |Lab number |Lot number |Test|Method    |Instrument |Reagent    |Unit   |Temperature    |ID ||| Data|
''''            Point  |201604261339   |1      |1      |999991     |46570      |104|517        |1524       |6          |13     |6              |sa ||| 23.00|
'''
''''            Point|201604261339|1|3|999991|46570|104|517|1524|6|13|6|sa|||23.00|
''''            Point|201604271507|1|1|999991|46570|104|517|1524|6|13|6|sa|||21.00|
''''            Point|201604271507|1|2|999991|46570|104|517|1524|6|13|6|sa|||22.00|
''''            Point|201604271507|1|3|999991|46570|104|517|1524|6|13|6|sa|||34.00|
''''            Point|201604191342|1|1|999991|46570|106|743|1524|6|13|6|sa|||23.00|
''''            Point|201604191342|1|3|999991|46570|106|743|1524|6|13|6|sa|||67.00|
''''            Point|201606131118|1|1|999991|46570|31|311|1524|6|56|5|sa|||46.36|
''''            Point|201606131118|1|3|999991|46570|31|311|1524|6|56|5|sa|||274.56|
''''            Point|201605010008|1|1|999991|46570|34|138|1524|6|56|5|bmse|||40.00|
''''            Point|201605010008|1|3|999991|46570|34|138|1524|6|56|5|bmse|||237.00|
'''
...
'''
'''            db_tmp = ""
'''            Call GetPrivateProfileString("QC", Mid(UCase(strIntBase), 2), "", db_tmp, 100, App.Path & "\Interface.ini")
'''            frmInterface.txtTemp = Trim(db_tmp)
'''            strAnalyte = Trim(frmInterface.txtTemp)
'''
'''                          strQCResult = "Point" & Chr(124)
'''            strQCResult = strQCResult & Format(Now, "yyyymmddhhmm") & Chr(124) '-- Date Time
'''            strQCResult = strQCResult & "1" & Chr(124)                         ' run
'''            strQCResult = strQCResult & iQLEV & Chr(124)                        ' level
'''            strQCResult = strQCResult & "999991" & Chr(124)                    ' lab
'''            strQCResult = strQCResult & iQLOT & Chr(124)                        ' lot
'''            strQCResult = strQCResult & strAnalyte & Chr(124)                  ' analyte
'''            strQCResult = strQCResult & "619" & Chr(124)                       ' method // Electrochemiluminescence (ECL)
'''            strQCResult = strQCResult & "1142" & Chr(124)                      ' instrument // 1145    Siemens Rapidlab 1200
'''            strQCResult = strQCResult & "0006" & Chr(124)                      ' reagent // Dedicated Reagent
'''            strQCResult = strQCResult & strUnit & Chr(124)                     ' unit
'''            strQCResult = strQCResult & "6" & Chr(124)                         ' temperature ==> 6   No Temperature
'''            strQCResult = strQCResult & "sa" & Chr(124)
'''            strQCResult = strQCResult & "" & Chr(124)
'''            strQCResult = strQCResult & "" & Chr(124)
'''            strQCResult = strQCResult & strResult & Chr(124)
'''            strQCResult = strQCResult & vbCrLf
'''
'''            If strQCResult <> "" Then
'''                Open App.Path & "\Log\" & Format(Now, "yyyymmdd") & ".DAT" For Append As #6
'''                Print #6, strQCResult;
'''                Close #6
'''                strQCResult = ""
'''            End If
