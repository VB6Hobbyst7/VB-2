...
Begin VB.Form frmInterface 
   ...
   Begin VB.Frame FrmHideControl 
      ...
      Begin VB.Frame Frame4 
         ...
         Begin FPSpread.vaSpread vasPrintBuf 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            SpreadDesigner  =   "frmInterface.frx":2FA3
         End
      End
      ...
      Begin FPSpread.vaSpread vasCode 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":31C9
      End
      Begin FPSpread.vaSpread vasTemp1 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":33EF
      End
         ...
         Begin MSComctlLib.ImageList imlStatus 
            ...
            BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
               ...
               BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":3B9F
                  Key             =   "RUN"
               EndProperty
               BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":4139
                  Key             =   "NOT"
               EndProperty
               BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":46D3
                  Key             =   "STOP"
               EndProperty
               BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":4C6D
                  Key             =   "LST"
               EndProperty
               BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":54FF
                  Key             =   "ITM"
               EndProperty
               BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":5659
                  Key             =   "ERR"
               EndProperty
               BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":57B3
                  Key             =   "NOF"
               EndProperty
            EndProperty
         End
      ...
      Begin FPSpread.vaSpread vasList 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":590D
      End
      Begin FPSpread.vaSpread vasResTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":5B33
      End
      Begin FPSpread.vaSpread vasTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":5D59
      End
      Begin FPSpread.vaSpread vasExcel 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":5F7F
      End
   ...
   Begin VB.Frame Frame1 
      ...
      Begin FPSpread.vaSpread vasID 
         ...
         SpreadDesigner  =   "frmInterface.frx":61A5
      End
      ...
      Begin FPSpread.vaSpread vasRes 
         ...
         RetainSelBlock  =   0   'False
         ScrollBars      =   2
         SpreadDesigner  =   "frmInterface.frx":6DA7
      End
   End
...
Private Sub cmdRsltSearch_Click()
    ...
    vasRes.MaxRows = 0
          ...
          SQL = " SELECT '', SAVESEQ, MID(EXAMDATE,1,8) AS EXAMDATE, HOSPDATE AS 접수일자, BARCODE AS 바코드번호, CHARTNO AS 차트번호, PID AS 내원번호, PNAME AS 이름,PSEX AS 성별, PAGE AS 나이, DISKNO, POSNO, EXAMCODE, RESULT, REFFLAG, SENDFLAG,INOUT,EXAMSUBCODE " & vbCrLf
            ...
            With vasID
                For i = 1 To .DataRowCnt
                    ...
                    If blnSame = True Then
                        For intCol = colState + 1 To vasID.MaxCols
                            If Trim(RS.Fields("EXAMCODE")) & "|" & Trim(RS.Fields("EXAMSUBCODE")) = gArrEquip(intCol - colState, 3) Then
...
Rst:
    If Err.Number = "8005" Then
        MsgBox "통신포트가 사용중입니다.", vbOKOnly + vbCritical, Me.Caption
        GoTo RST1
    End If
    ...
    With vasID
        For intRow = 1 To .MaxRows
            ...
            If .Value = "1" Then
                ...
                '-- Pos
                '2O 0101018N0
                ' 150210-01-28 01-28      00077694        김덕안          U   20150210 1.01122 M11 M1  M2  M3  M7  M4  M5  M16 M17 M12 M30 M31 M32 M6  M13 M14 M15 M 07
                '1O 0101000N015-0107453-1 01-01      10014350                        U   20151216 1.01111 M13 M14 M4  M5  M6  M8  M9  M E0

                            strOutput = intFrameNo & "O 0101" & Right("000" & GetText(vasID, intRow, colOCNT), 3) & "N0"
                strOutput = strOutput & Left(GetText(vasID, intRow, colBARCODE) & "-" & Format(Now, "hhmm") & Space$(13), 13) '-- 유일해야함
                strOutput = strOutput & Left(GetText(vasID, intRow, colPOSNO) & Space(11), 11)
                strOutput = strOutput & Left(GetText(vasID, intRow, colCHARTNO) & Space(16), 16)
                'strOutput = strOutput & LeftB(GetText(vasid, intRow, colPName) & Space(16), 16)
                strOutput = strOutput & Space(16)
                strOutput = strOutput & "U" & Space(3) & Format(Now, "yyyymmdd") & " 1.0" & "1" & "1" & GetText(vasID, intRow, colDISKNO) & Space(1) & ETX
                ...
                SetBackColor vasID, intRow, intRow, 1, colState, 202, 255, 212
                'Sleep (100)
        ...
        If intRow = vasID.MaxRows Then
            strState = "E"
            intFrameNo = 1
            Exit Sub
        End If
    
        For intRow = 1 To vasID.MaxRows
            .Row = intRow
            .Col = colCheckBox
            If .Value = "1" Then
                Exit Sub
...
Private Sub GetOrder(ByVal pBarNo As String)
    ...
    Call SetText(vasID, mOrder.TubePos, intRow, colPOSNO)
...
Private Sub SetPatInfo(ByVal pBarNo As String, Optional ByVal pRno As String, Optional ByVal pPno As String)
    ...
    Call GetSampleInfoW_EHEALTH(intRow)
...
Private Sub EditRcvDataASTM()
    ...
    For intCnt = 1 To UBound(strRecvData)
        ...
        Select Case strType
                ...
                For intQ = 1 To Len(strRcvBuf) Step 13
                    ...
                    Else
                        ...
                        For i = 1 To vasID.DataRowCnt
                            ...
                            If vasID.Value = "1" Then
                                vasID.Row = i
                                vasID.Col = colPOSNO 'colBARCODE
                                If Trim(vasID.Text) = Trim(strRP) Then
                                    vasID.Col = colBARCODE
                                    strBarNo = vasID.Text
                                    vasID.Col = colPOSNO
                                    mOrder.TubePos = vasID.Text
                                    gRow = i
                                    Exit For
                                End If
                            End If
            ...
            Case "R"
                    'O|1|1608270009|14^00013^1^^SAMPLE^NORMAL|ALL|R|20160827121513|||||X||||||||||||||O|||||
                    ...
                    For i = 1 To vasID.MaxRows
                        ...
                        If GetText(vasID, i, colBARCODE) = strBarNo Then
                ...
                'Case "R"
                    Do While Len(strTmp) >= 20
                        ...
                        If strResult <> "" Then
                            ...
                            '-- 오더 있을 경우
                            If Res > 0 Then
                                lsExamCode = mGetP(Trim(gReadBuf(0)), 1, "|")
                                lsExamSubCode = mGetP(Trim(gReadBuf(0)), 2, "|")
                                strExamCode = lsExamCode & "|" & lsExamSubCode
                                lsExamName = Trim(gReadBuf(1))
                                lsSeqNo = Trim(gReadBuf(2))
                                ...
                                '-- vasID 에 표시
                                For intCol = colState + 1 To vasID.MaxCols
                                    If strExamCode = gArrEquip(intCol - colState, 3) Then
                                ...
                                SetText vasRes, lsExamSubCode, lsResRow, colSUBCODE     '검사SUB코드
                                '-- 로컬 저장
                                SetLocalDB gRow, lsResRow, "1", lsEquipRes
...
Private Sub txtBarcode_KeyPress(KeyAscii As Integer)
    ...
    If KeyAscii = 13 Then
        ...
        If Trim(txtBarcode) <> "" Then
            Call GetBarcodeList_EHEALTH(Trim(txtBarcode.Text))
        End If
...
Private Sub GetBarcodeList_EHEALTH(ByVal pBarNo As String)
    Dim RS          As ADODB.Recordset
    Dim i           As Integer
    Dim iCnt        As Long
    Dim intRow      As Long
    ...
    SQL = SQL & "   AND RTRIM(LTRIM(c.OBSUCODE)) + '|' + RTRIM(LTRIM(c.OBSUSUBC)) IN (" & gAllExam & ") " & vbCr    '검사코드 + '|' + OBSUSUBC
    SQL = SQL & "   AND b.OBODSTAT = 'AC' " & vbCr                                      '필수 기본 = 'OE', 채혈시 = 'AC'
    SQL = SQL & "   AND a.APATMRNO = '" & pBarNo & "'" & vbCr
    SQL = SQL & " Order by b.OBODORDT,a.APATMRNO,b.OBODORNO,b.OBODORSQ " & vbCr

    Call SetSQLData("바코드조회1", SQL)
    ...
    If Not RS.EOF = True And Not RS.BOF = True Then
        ...
        Do Until RS.EOF
            ...
            With vasID
                ...
                For i = 1 To .DataRowCnt
                    strBarcode = GetText(vasID, i, colBARCODE)
                    If Trim(RS("APATMRNO")) = strBarcode Then
                        blnSame = True
                    End If
                ...
                If blnSame = False Then
                    ...
                    SetText vasID, txtSeq.Text, .MaxRows, colSpecNo
                    SetText vasID, "1", .MaxRows, colCheckBox
                    SetText vasID, Trim(RS.Fields("OBODORDT")) & "", .MaxRows, colHOSPDATE
                    SetText vasID, Trim(RS.Fields("APATMRNO")) & "", .MaxRows, colBARCODE
                    SetText vasID, Trim(RS.Fields("OBODCASE")) & "", .MaxRows, colCHARTNO
                    SetText vasID, Trim(RS.Fields("OBODORNO")) & "", .MaxRows, colPID
                    SetText vasID, IIf(Trim(RS.Fields("OBODIOGB")) & "" = "I", "입원", "외래"), .MaxRows, colINOUT
                    SetText vasID, Trim(RS.Fields("APATNAME")) & "", .MaxRows, colPNAME
                    SetText vasID, Trim(RS.Fields("APATPSEX")) & "", .MaxRows, colPSEX
                    SetText vasID, Trim(RS.Fields("APATJMN1")) & "", .MaxRows, colPAGE
                    SetText vasID, Format(txtRack, "00") & "-" & Format(txtNum, "00"), .MaxRows, colPOSNO
                    
                    strTests = GetOrderExamCode_Test(gEquip, .MaxRows)
                    
                    'MsgBox "strTests:" & strTests
                    
                    SetText vasID, strTests, .MaxRows, colDISKNO
                    ...
                    For intCol = colState + 1 To vasID.MaxCols
                        If Trim(RS.Fields("OBSUCODE")) & "|" & Trim(RS.Fields("OBSUSUBC")) = gArrEquip(intCol - colState, 3) Then
                            ...
                            vasID.Col = intCol
                            vasID.BackColor = vbYellow
                            'Call SetBackColor(vasID, .MaxRows, .MaxRows, intCol, intCol, 255, 255, 0)
...
Private Function GetOrderExamCode_Test(argEquipCode As String, asRow As Long) As String
    Dim RS As ADODB.Recordset
    Dim intCol As Integer
    Dim sBarcode            As String
    ...
    'sChart = Trim(GetText(frmWorkList.vasWorkList, asRow, colCHARTNO))
    'sPID = Trim(GetText(frmWorkList.vasWorkList, asRow, colPID))
    
    
          SQL = "SELECT DISTINCT RTRIM(c.OBSUCODE) + '|' + RTRIM(c.OBSUSUBC) AS ORDCD" & vbCr           '검사코드SUB
    SQL = SQL & "  FROM ABPATMST a"             '환자기본정보
    SQL = SQL & "      ,OBODRMTM b"            '처방내역 Table
    SQL = SQL & "      ,OBSURSTM c " & vbCr     '검사결과(수치결과) Table
    ...
    SQL = SQL & "   AND b.OBODORSQ = c.OBSUORSQ " & vbCr                                'ORDER SEQUENCE
    SQL = SQL & "   AND (c.OBSURSLT IS NULL OR c.OBSURSLT = '')" & vbCr                 '검사결과
    SQL = SQL & "   AND a.APATMRNO = '" & sBarcode & "'"
    'SQL = SQL & "   AND b.OBODCASE = '" & sChart & "'"
    'SQL = SQL & "   AND b.OBODORNO = '" & sPID & "'"
    SQL = SQL & "   AND RTRIM(c.OBSUCODE) + '|' + RTRIM(c.OBSUSUBC) IN (" & gAllExam & ") " & vbCr    '검사코드 + '|' + OBSUSUBC
    SQL = SQL & "   AND b.OBODSTAT = 'AC' " & vbCr                                      '필수 기본 = 'OE', 채혈시 = 'AC'
    SQL = SQL & " Order by ORDCD " & vbCr
    
    Call SetSQLData("바코드조회2", SQL)

    Set RS = cn_Ser.Execute(SQL)
    
    Do Until RS.EOF
        GetOrderExamCode_Test = GetOrderExamCode_Test & "'" & Trim(RS.Fields("ORDCD")) & "',"
    ...
    If GetOrderExamCode_Test <> "" Then
        GetOrderExamCode_Test = Mid(GetOrderExamCode_Test, 1, Len(GetOrderExamCode_Test) - 1)
    End If
    ...
    SQL = SQL & "  FROM EQPMASTER "
    SQL = SQL & " WHERE EQUIPNO  = '" & Trim(gEquip) & "' "
    SQL = SQL & "   AND EXAMCODE in (" & Trim(GetOrderExamCode_Test) & ")"
    ...
    For i = 0 To UBound(gReadBuf)
        If gReadBuf(i) <> "" Then
            'HOST->1O 0101009N0100000029738                                            U   20130704 1.0114  M6  M2  M3  M11 M5  M1  M8  M7  M AC
            '4  M6  M2  M3  M11 M5  M1  M8  M7  M AC
            
            '-- TIBC는 안보냄
            If Trim(gReadBuf(i)) <> "99" Then
            
                'sOList:= sOList + PadRightStr(sO,' ',3)+'M';
                
                strExamCode = strExamCode & Trim(gReadBuf(i)) & Space(3 - Len(Trim(gReadBuf(i)))) & "M"
'                intOrdCnt = intOrdCnt + 1
    ...
    GetOrderExamCode_Test = strExamCode
    ...
    If KeyAscii = 13 Then
        With vasID
            For intRow = .ActiveRow To .DataRowCnt
                ...
                '.Col = colCheckBox
                'If .Value = 1 Then
                    SetText vasID, Format(txtRack, "00") & "-" & Format(txtNum, "00"), intRow, colPOSNO
