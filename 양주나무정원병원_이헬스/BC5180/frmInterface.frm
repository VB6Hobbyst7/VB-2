...
Begin VB.Form frmInterface 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin FPSpread.vaSpread vasRes 
         ...
         RetainSelBlock  =   0   'False
         ScrollBars      =   2
         SpreadDesigner  =   "frmInterface.frx":213C
      End
   End
   ...
   Begin VB.Frame FrmHideControl 
      ...
      Begin VB.ComboBox cboChk 
         ...
         EndProperty
         Height          =   315
         ItemData        =   "frmInterface.frx":3855
         Left            =   4170
         List            =   "frmInterface.frx":3862
         TabIndex        =   71
         Top             =   3720
         Width           =   975
      End
      ...
      Begin VB.ComboBox cboTest 
         ...
         ForeColor       =   &H00FF0000&
         Height          =   300
         ItemData        =   "frmInterface.frx":3878
         Left            =   7170
         List            =   "frmInterface.frx":387A
         Style           =   2  '드롭다운 목록
         TabIndex        =   68
         Top             =   3090
         Visible         =   0   'False
      ...
      Begin VB.Frame Frame4 
         ...
         Begin FPSpread.vaSpread vasPrint 
            ...
            EndProperty
            MaxCols         =   9
            SpreadDesigner  =   "frmInterface.frx":387C
         End
         Begin FPSpread.vaSpread vasPrintBuf 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            SpreadDesigner  =   "frmInterface.frx":5303
         End
      End
      ...
      Begin FPSpread.vaSpread vasCode 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":5529
      End
      Begin FPSpread.vaSpread vasTemp1 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":574F
      End
         ...
         Begin MSComctlLib.ImageList imlStatus 
            ...
            BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
               ...
               BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":5EFF
                  Key             =   "RUN"
               EndProperty
               BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":6499
                  Key             =   "NOT"
               EndProperty
               BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":6A33
                  Key             =   "STOP"
               EndProperty
               BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":6FCD
                  Key             =   "LST"
               EndProperty
               BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":785F
                  Key             =   "ITM"
               EndProperty
               BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":79B9
                  Key             =   "ERR"
               EndProperty
               BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":7B13
                  Key             =   "NOF"
               EndProperty
            EndProperty
         End
      ...
      Begin FPSpread.vaSpread vasList 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":7C6D
      End
      Begin FPSpread.vaSpread vasResTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":7E93
      End
      Begin FPSpread.vaSpread vasTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":80B9
      End
      Begin FPSpread.vaSpread vasExcel 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":82DF
      End
...
'    End If
    ...
    If gSetup.TCPType = "S" Then
        wSck.LocalPort = CInt(gSetup.TCPPort)
        wSck.Listen
        
        StatusBar1.Panels(2).Text = "TCP " & gSetup.TCPPort & " 포트 연결중.."
    Else
        wSck.Close
        wSck.Connect gSetup.TCPIP, CInt(gSetup.TCPPort)
        
        StatusBar1.Panels(2).Text = "TCP " & gSetup.TCPIP & ":" & gSetup.TCPPort & " 포트 연결중.."
    End If
...
Private Sub GetOrder(ByVal pBarno As String)
    ...
    Call SetText(vasID, mOrder.BarNo, intRow, colBARCODE)
        
    frmInterface.vasRes.MaxRows = 0
    
    '-- 검사자 정보 가져오기
    Call GetSampleInfo_EHEALTH(intRow)
    
    
    '-- 로컬테이블에서 검사항목에 해당하는 검사채널 찾아오기 (intRow = 기존 검사했던 바코드가 다시 올라올 경우 위치를 못찾는다.)
    strItems = ""
    mOrder.Order = ""
    strItems = GetEquipExamCode_BC6200(gEquip, strBarNo, intRow)
    ...
    If Trim(strItems) = "" Then
        ...
        '-- 진행상태(Order) 표시
        Call SetText(vasID, "NoOrder", intRow, colState)
    ...
    Else
        ...
        'strSend = strSend & "PID|1||" & mOrder.PID & "^^^^MR||^" & Han2Eng.HanToEng(mOrder.PNAME) & "|||" & vbCr
        strSend = strSend & "PID|1||" & mOrder.PID & "^^^^MR||^" & Han2Eng.HanToEng(mOrder.PNAME) & "|||" & vbCr
...
'-- 로컬테이블에서 검사항목에 해당하는 검사채널 찾아오기
Function GetEquipExamCode_BC6200(argEquipCode As String, argPID As String, Optional intRow As Long) As String
    Dim strExamCode     As String
    Dim strIntBase      As String
    ...
    strExamCode = ""
    For i = 1 To vasTemp.DataRowCnt
        strIntBase = Trim(GetText(vasTemp, i, 1))
...
Private Sub EditRcvDataASTM()
    ...
    varRcvBuf = Split(strBuffer, vbCr)
    ...
    For intCnt = 0 To UBound(varRcvBuf)
        ...
        Case "MSH"
            ...
            If mOrder.MsgType = "ORU^R01" Then
                ...
                Call SetRawData("[Tx]" & strSndBuffer)
            End If
...
Private Sub wSck_Close()
    ...
    StatusBar1.Panels(2).Text = "TCP " & gSetup.TCPIP & ":" & gSetup.TCPPort & " 포트 연결성공"
    imgPort.ZOrder 0
