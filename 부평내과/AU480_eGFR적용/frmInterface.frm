...
Begin VB.Form frmInterface 
   Caption         =   " BECKMAN COULTER AU480 Interface "
   ClientHeight    =   10680
   ClientLeft      =   345
   ClientTop       =   840
   ClientWidth     =   25560
   ...
   Begin VB.Frame Frame4 
      ...
      Begin FPSpread.vaSpread vasPrintBuf 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":195B
      End
   End
   Begin VB.Frame FrmHideControl 
      ...
      Begin FPSpread.vaSpread vasCode 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":2107
      End
      ...
      Begin FPSpread.vaSpread vasTemp1 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":2329
      End
      Begin FPSpread.vaSpread vasList 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":254B
      End
      Begin FPSpread.vaSpread vasResTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":276D
      End
      Begin FPSpread.vaSpread vasTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":298F
      End
   ...
   Begin TabDlg.SSTab stInterface 
      ...
      TabPicture(0)   =   "frmInterface.frx":2BB1
      Tab(0).ControlEnabled=   -1  'True
      Tab(0).Control(0)=   "Frame1"
      Tab(0).Control(0).Enabled=   0   'False
      Tab(0).ControlCount=   1
      TabCaption(1)   =   "받은결과"
      TabPicture(1)   =   "frmInterface.frx":2BCD
      ...
      Begin VB.Frame Frame3 
         ...
         Begin FPSpread.vaSpread vasRRes 
            ...
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":2BE9
         End
         Begin FPSpread.vaSpread vasRID 
            ...
            RetainSelBlock  =   0   'False
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":5374
            UserResize      =   2
         End
      ...
      Begin VB.Frame Frame1 
         ...
         Begin FPSpread.vaSpread vasID 
            ...
            RetainSelBlock  =   0   'False
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":5B7D
            UserResize      =   2
         End
         Begin FPSpread.vaSpread vasRes 
            ...
            RetainSelBlock  =   0   'False
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":6405
         End
...
'            'SetText vasrID, "에러", iRow, colState
'        Case "1"
...
Private Sub cmdRSch_Click()
    ...
    With vasRID
        While Not RS1.EOF
            ...
            Case "0": SetText vasRID, "오더", iRow, colState
...
Private Sub SetPatInfo(ByVal pBarNo As String)
    ...
    Call SetText(vasID, "1", intRow, colCheckBox)             '2 Barcode
...
'    blnfPSA = False
    ...
    For intCnt = 1 To UBound(strRecvData)
        ...
        Select Case strType
            ...
            Case "D "    '## Result
                strBarNo = Trim$(Mid$(strRcvBuf, 14, 14))
                ...
                Do While Len(strTmp) >= 11
                    ...
                    '----- 2019-12-12 추가 GFR 계산
                    If strIntBase = "13" Then    'CREA
                        '186 * (crea)-1.154*(연령)-0.203*(0.742if여성)
                        strGFR = ""
                        strCREA = Trim(strResult)
                        
                        strSex = Trim(mPInfo.Sex)
                        strAge = Trim(mPInfo.Age)
                    ...
                    If strResult <> "" Then
                        ...
                        Else
                            ...
                            If Res > 0 Then
                                ...
                                '-- 참고치 적용
                                If Trim(gReadBuf(3)) <> "" Then
                                    If strResult < Trim(gReadBuf(3)) Then
                                        vasRes.Row = lsResRow
                                        vasRes.Col = colResult
                                        vasRes.FontBold = True
                                ...
                                If Trim(gReadBuf(4)) <> "" Then
                                    If strResult > Trim(gReadBuf(4)) Then
                                        vasRes.Row = lsResRow
                                        vasRes.Col = colResult
                                        vasRes.FontBold = True
                                        vasRes.ForeColor = vbRed
