...
'    End If
    ...
    With frmInterface
        For vasResRow = 1 To .vasTemp.DataRowCnt
            ...
            'MsgBox "vasResRow : " & vasResRow
            
            .vasID.Row = vasIDRow
            .vasID.Col = 1
            If .vasID.Value = 1 Then
                
                MsgBox "vasTemp : " & Trim(GetText(.vasTemp, vasResRow, 3))
                
                .vasTemp.Row = vasResRow
                liRet = -1
                
             '   SetRawData "ZZ" & Trim(GetText(.vasTemp, vasResRow, 3))
...
Dim strRslt As String
    ...
    With frmInterface.vasTemp
        ...
        SetRawData "XMLAllTxt" & XMLAllTxt
...
Function GetSampleInfoW(ByVal asRow As Long) As Integer
    ...
    If Res = 1 Then
        ...
        '-- 2019-12-12 추가
        mPInfo.Sex = Trim(gReadBuf(2))
        mPInfo.Age = Trim(gReadBuf(3))
        '-- 2019-12-12 추가
