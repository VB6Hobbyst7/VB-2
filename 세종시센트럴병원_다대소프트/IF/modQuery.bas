...
Public Sub GetTestList()
    ...
    SQL = ""
    SQL = SQL & "SELECT DISTINCT EQUIPCD,SEQNO,GUBUN,TESTCODE,SENDCHANNEL,RSLTCHANNEL " & vbCr
    ...
    If frmMain.optGubun(1).Value = True Then
        SQL = SQL & "   AND GUBUN = 'FD' " & vbCr
    ElseIf frmMain.optGubun(2).Value = True Then
    ...
    If Not AdoRs_Local.EOF = True And Not AdoRs_Local.BOF = True Then
        With frmMain.spdTest
            ...
            '알러지 구분추가로 처방코드, SUB코드용 변경 17,18
            ...
            Do Until AdoRs_Local.EOF
                ...
                Call SetText(frmMain.spdTest, AdoRs_Local.Fields("GUBUN").Value & "", intRow, colLGUBUN)
