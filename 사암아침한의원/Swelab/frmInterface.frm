...
Begin VB.Form frmInterface 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin FPSpread.vaSpread vasRes 
         ...
         RetainSelBlock  =   0   'False
         ScrollBars      =   2
         SpreadDesigner  =   "frmInterface.frx":3437
      End
   End
   ...
   Begin VB.Frame FrmHideControl 
      ...
      Begin VB.Frame Frame4 
         ...
         Begin FPSpread.vaSpread vasPrint 
            ...
            EndProperty
            MaxCols         =   9
            SpreadDesigner  =   "frmInterface.frx":4AC8
         End
         Begin FPSpread.vaSpread vasPrintBuf 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            SpreadDesigner  =   "frmInterface.frx":6541
         End
      End
      ...
      Begin FPSpread.vaSpread vasCode 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":6759
      End
      Begin FPSpread.vaSpread vasTemp1 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":6971
      End
         ...
         Begin MSComctlLib.ImageList imlStatus 
            ...
            BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
               ...
               BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":7113
                  Key             =   "RUN"
               EndProperty
               BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":76AD
                  Key             =   "NOT"
               EndProperty
               BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":7C47
                  Key             =   "STOP"
               EndProperty
               BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":81E1
                  Key             =   "LST"
               EndProperty
               BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":8A73
                  Key             =   "ITM"
               EndProperty
               BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":8BCD
                  Key             =   "ERR"
               EndProperty
               BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":8D27
                  Key             =   "NOF"
               EndProperty
            EndProperty
         End
      ...
      Begin FPSpread.vaSpread vasList 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":8E81
      End
      Begin FPSpread.vaSpread vasResTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":9099
      End
      Begin FPSpread.vaSpread vasTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":92B1
      End
        ...
        If vasID.Value = 1 Then
            If blnWrite = False Then
                For j = 1 To vasID.MaxCols
                    If j = 2 Or j = 4 Or j = 6 Or j > 16 Then
                        If j = 2 Then k = 1
                        If j = 4 Then k = 2
                        If j = 6 Then k = 3
                        If j > 16 Then
...
'    SQL = SQL & "  WHERE MID(EXAMDATE,1,8) Between '" & Format(dtpStartDt, "YYYYMMDD") & "' AND '" & Format(dtpStopDt, "YYYYMMDD") & "'" & vbCrLf
    SQL = SQL & "  WHERE MID(HOSPDATE,1,10) Between '" & Format(dtpStartDt, "YYYY-MM-DD") & "' AND '" & Format(dtpStopDt, "YYYY-MM-DD") & "'" & vbCrLf
    'SQL = SQL & "  WHERE MID(EXAMDATE,1,8) = '" & Format(dtpToday, "YYYYMMDD") & "'" & vbCrLf
    
    
    SQL = SQL & "    AND EQUIPNO = '" & gEquip & "' " & vbCrLf
    'SQL = SQL & "    AND SENDFLAG IN ('0','1','2','3') " & vbCrLf
    SQL = SQL & " ORDER BY HOSPDATE,EXAMDATE,SAVESEQ,HOSPDATE,BARCODE "
...
Private Sub cmdSearch_Click()
    ...
    Select Case gOCS
        ...
        Case "BIT":         Call GetWorkList(Format(dtpStartDt.Value, "yyyymmdd"), Format(dtpStopDt.Value, "yyyymmdd"))
        Case "BIT":         Call GetWorkList(Format(dtpStartDt.Value, "yyyymmdd"), Format(dtpStopDt.Value, "yyyymmdd"))
    End Select
...
Private Sub SetPatInfo(ByVal pBarNo As String)
    ...
    Call SetText(vasID, mResult.SpcPos, intRow, colHOSPDATE)
...
'''    Swelab Example
'''    Pos = 0
'''    Pos = InStr(strRcvBuf, "&A")
'''    If Pos > 0 Then
'''        sDevSeq = Trim(Mid(strRcvBuf, Pos + 2, 4))
'''    End If
'''
'''    Pos = InStr(strRcvBuf, Trim(.Fields("intbase")))
'''    If Pos > 0 Then
'''        strRst = Trim(Mid(strRcvBuf, Pos + 1, 4))
'''    End If

    strRecvData = Split(strBuffer, vbCrLf)
    
    'For intCnt = 15 To 17
        gRow = 0
        strState = ""
        strBarNo = ""
        strBarNo = Trim(mGetP(mGetP(strRecvData(15), 5, ">"), 1, "<"))
        strSeq = Trim(mGetP(mGetP(strRecvData(16), 5, ">"), 1, "<"))
        strDate = Trim(mGetP(mGetP(strRecvData(17), 5, ">"), 1, "<"))
        ...
        With mResult
            ...
            .PatNo = strSeq
            .SpcPos = strDate 'Mid(strDate, 1, 10)
        End With
   ...
   ' Next
    ...
    For intCnt = 66 To UBound(strRecvData)
        strRecvData(intCnt) = Replace(strRecvData(intCnt), vbLf, "")
        strIntBase = Trim(mGetP(mGetP(strRecvData(intCnt), 3, "<"), 2, ">"))
        strResult = Trim(mGetP(mGetP(strRecvData(intCnt), 5, "<"), 2, ">"))
...
'    lblDate.Caption = Trim(GetText(vasID, Row, colHOSPDATE))
    lsID = Trim(GetText(vasID, Row, colCHARTNO))
   ...
   ' SQL = SQL & "   AND BARCODE = '" & lsID & "' " & vbCrLf
    SQL = SQL & "   AND MID(HOSPDATE,1,10) = '" & Mid(Trim(GetText(vasID, Row, colHOSPDATE)), 1, 10) & "' " & vbCrLf
    SQL = SQL & " GROUP BY SEQNO, EQUIPCODE, EXAMCODE, EXAMNAME, EQUIPRESULT, RESULT, SEQNO, REFFLAG "
