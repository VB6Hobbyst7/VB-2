...
'    gQCEquip = Trim(frmInterface.txtTemp)
    ...
    db_tmp = ""
    Call GetPrivateProfileString("ASSAY", "CM", "", db_tmp, 100, App.Path & "\Interface.ini")
    frmInterface.txtTemp = Trim(db_tmp)
    gAssayNM.COMMON = Trim(frmInterface.txtTemp)
    ...
    db_tmp = ""
    Call GetPrivateProfileString("ASSAY", "CMCD", "", db_tmp, 100, App.Path & "\Interface.ini")
    frmInterface.txtTemp = Trim(db_tmp)
    gAssayNM.COMMON_CD = Trim(frmInterface.txtTemp)
