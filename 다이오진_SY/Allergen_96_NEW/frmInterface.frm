...
Begin VB.Form frmInterface 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin FPSpread.vaSpread vasRes 
         ...
         RetainSelBlock  =   0   'False
         ScrollBars      =   2
         SpreadDesigner  =   "frmInterface.frx":20E9
      End
   End
   ...
   Begin VB.Frame FrmHideControl 
      ...
      Begin VB.Frame Frame4 
         ...
         Begin FPSpread.vaSpread vasPrint 
            ...
            EndProperty
            MaxCols         =   9
            SpreadDesigner  =   "frmInterface.frx":3805
         End
         Begin FPSpread.vaSpread vasPrintBuf 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            SpreadDesigner  =   "frmInterface.frx":527E
         End
      End
      ...
      Begin FPSpread.vaSpread vasCode 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":5496
      End
      Begin FPSpread.vaSpread vasTemp1 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":56AE
      End
         ...
         Begin MSComctlLib.ImageList imlStatus 
            ...
            BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
               ...
               BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":5E50
                  Key             =   "RUN"
               EndProperty
               BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":63EA
                  Key             =   "NOT"
               EndProperty
               BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":6984
                  Key             =   "STOP"
               EndProperty
               BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":6F1E
                  Key             =   "LST"
               EndProperty
               BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":77B0
                  Key             =   "ITM"
               EndProperty
               BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":790A
                  Key             =   "ERR"
               EndProperty
               BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":7A64
                  Key             =   "NOF"
               EndProperty
            EndProperty
         End
      ...
      Begin FPSpread.vaSpread vasList 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":7BBE
      End
      Begin FPSpread.vaSpread vasResTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":7DD6
      End
      Begin FPSpread.vaSpread vasTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":7FEE
      End
...
'    blnSameRecord = True
    ...
    For i = 0 To UBound(varTmp)
        ...
        If InStr(varTmp(i), """Assay""") > 0 Then 'blnAppend1 = True And
            ...
            ElseIf gAssayNM.COMMON = mGetP(strTmp, 1, """") Then
            ...
            With vasID
                ...
                If blnSame = False Then
                    ...
                    Select Case Trim(RS.Fields("OrderCode")) & ""
                        ...
                        Case "C62999":   SetText vasID, "COMMON", .MaxRows, colINOUT
                        Case "C63000":   SetText vasID, "COMMON", .MaxRows, colINOUT
                        ...
                        Case Else:
                                        SetBackColor vasID, .MaxRows, .MaxRows, 1, colState, 202, 255, 112
                                        SetText vasID, "처방오류" & Trim(RS.Fields("OrderCode")) & "", .MaxRows, colINOUT
...
Private Sub cmdSearch_Click()
    ...
    Select Case gOCS
        ...
        Case "SY":          Call GetWorkList_NTL(Format(dtpStartDt.Value, "yyyymmdd"), Format(dtpStopDt.Value, "yyyymmdd"))
    End Select
    ...
    For intCnt = 0 To UBound(strRecvData)
        ...
        Select Case strType
            ...
            Case "R"    '## Result
                ...
                If strBarNo <> "" And (mResult.MnmNm = "FOOD" Or mResult.MnmNm = "COMMON") And strIntBase = "fx1" And strResult <> "" Then
                    For i = 1 To 3
                ...
                If strBarNo <> "" And (mResult.MnmNm = "FOOD" Or mResult.MnmNm = "COMMON") And strIntBase = "fx4" And strResult <> "" Then
                    For i = 1 To 3
                        If IsNumeric(strResult) Then
                            If i = 1 Then
                                strIntBase = "f20"
                ...
                If strBarNo <> "" And (mResult.MnmNm = "INHALANT" Or mResult.MnmNm = "COMMON") And strIntBase = "e71/e73" And strResult <> "" Then
                    For i = 1 To 2
                        If IsNumeric(strResult) Then
                            If i = 1 Then
                                strIntBase = "e71"
                ...
                If strBarNo <> "" And (mResult.MnmNm = "INHALANT" Or mResult.MnmNm = "COMMON") And strIntBase = "gx1" And strResult <> "" Then
                    For i = 1 To 4
                        If IsNumeric(strResult) Then
                            If i = 1 Then
                                strIntBase = "g1"
                ...
                'fx2 -> fx2(홍합)-1.00, fx21(굴)-1.00, fx22(조개)-1.00, fx23(가리비)-1.00
                If strBarNo <> "" And mResult.MnmNm = "COMMON" And strIntBase = "fx2" And strResult <> "" Then
                    For i = 1 To 4
                        If i = 1 Then
                            strIntBase = "fx2"
                        ElseIf i = 2 Then
                ...
                'fx3 -> fx3(키위)-1.00, fx31(망고)-1.00, fx32(바나나)-1.00
                If strBarNo <> "" And mResult.MnmNm = "COMMON" And strIntBase = "fx3" And strResult <> "" Then
                    For i = 1 To 3
                        If i = 1 Then
                            strIntBase = "fx3"
                        ElseIf i = 2 Then
                ...
                'f40/f41 -> f40(참치)-1.00, f41(연어)-1.00
                If strBarNo <> "" And mResult.MnmNm = "COMMON" And strIntBase = "f40/f41" And strResult <> "" Then
                    For i = 1 To 2
                        If i = 1 Then
                            strIntBase = "f40"
                        ElseIf i = 2 Then
                ...
                'f80/f58 -> f80(랍스터)-1.00, f58(오징어)-1.00
                If strBarNo <> "" And mResult.MnmNm = "COMMON" And strIntBase = "f80/f58" And strResult <> "" Then
                    For i = 1 To 2
                        If i = 1 Then
                            strIntBase = "f80"
                        ElseIf i = 2 Then
                ...
                'f47/f48 -> f47(마늘)-1.00, f48(양파)-1.00
                If strBarNo <> "" And mResult.MnmNm = "COMMON" And strIntBase = "f47/f48" And strResult <> "" Then
                    For i = 1 To 2
                        If i = 1 Then
                            strIntBase = "f47"
                        ElseIf i = 2 Then
