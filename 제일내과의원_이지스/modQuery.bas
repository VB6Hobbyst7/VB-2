...
Public Function GetEquipChannel_BA200(ByVal intRow As Long) As String
    Dim i As Integer
    ...
    For i = colSTATE + 1 To frmInterface.spdOrder.MaxCols
        frmInterface.spdOrder.Row = intRow
        frmInterface.spdOrder.Col = i
        If frmInterface.spdOrder.BackColor <> vbWhite And frmInterface.spdOrder.Text = "◇" Then    '12648447   and ◇
            If Trim(gArrEQP(i - colSTATE, 3)) <> "eGFR" Then
                If Trim(gArrEQP(i - colSTATE, 3)) <> "LDLC" Then
                    strExamCode = strExamCode & Trim(gArrEQP(i - colSTATE, 3)) & "|"
    ...
    GetEquipChannel_BA200 = strExamCode
...
Public Function GetEquipExamCode_BS200W(argEquipCode As String, argPID As String, Optional intRow As Long) As String
    Dim i As Integer
    Dim sExamCode As String
    Dim strExamCode As String
    Dim sSpecNo     As String
    ...
    GetEquipExamCode_BS200W = strExamCode

End Function


Public Function GetEquipExamCode_BA200(argEquipCode As String, argPID As String, Optional intRow As Long) As String
    Dim i As Integer
    Dim sExamCode As String
    Dim strExamCode As String
    Dim sSpecNo     As String
    ...
    If Not AdoRs_Local.EOF = True And Not AdoRs_Local.BOF = True Then
        Do Until AdoRs_Local.EOF
            If Trim(AdoRs_Local.Fields("SENDCHANNEL").Value) <> "" Then
                'If Trim(AdoRs_Local.Fields("SENDCHANNEL").Value) <> "LDLC" Then
                    If Trim(AdoRs_Local.Fields("SENDCHANNEL").Value) <> "eGFR" Then
                        strExamCode = strExamCode & Trim(AdoRs_Local.Fields("SENDCHANNEL").Value) & "|"
                        mOrder.SendCnt = mOrder.SendCnt + 1
                    End If
                'End If
    ...
    GetEquipExamCode_BA200 = strExamCode
        ...
        If Not RsLocal.EOF = True And Not RsLocal.BOF = True Then
            Do Until RsLocal.EOF
                ...
                If strBarcode <> "" And strTestCd <> "" And sResult <> "" Then
                    ...
                    SQL = SQL & "   And ORD_YMD    = '" & strHospDate & "'  " & vbCrLf
                    SQL = SQL & "   And PTNT_NO    = '" & strPatID & "'    " & vbCrLf
...
On Error GoTo ErrHandle
    ...
    SQL = ""
    SQL = SQL & "SELECT DISTINCT "
    SQL = SQL & "       a.ORD_YMD       AS HOSPDATE     " & vbCrLf
    ...
    SQL = SQL & " WHERE a.ORD_YMD Between '" & pFrom & "'"
    SQL = SQL & "                     AND '" & pTo & "' " & vbCrLf
        ...
        Do Until RS.EOF
            With SPD
                ...
                If blnSame = False Then
                    ...
                    SetText SPD, Trim(RS.Fields("PID")) & "", intRow, colPID
                    SetText SPD, Trim(RS.Fields("PNAME")) & "", intRow, colPNAME
                    SetText SPD, Trim(RS.Fields("AGE")) & "", intRow, colPJUMIN
        ...
        Do Until RS.EOF
            With SPD
                ...
                Case "F"
                            ...
                            End If
                End Select
                mPatient.Jumin = Trim(RS.Fields("AGE"))
                srJumin = Mid(Trim(RS.Fields("AGE")) & "", 3, 6) & strJuminSex & "000000"
                Call CalAgeSex(srJumin, Format(Now, "yyyy/mm/dd"))
                SetText SPD, mPatient.SEX, asRow, colPSEX
                SetText SPD, mPatient.AGE, asRow, colPAGE
