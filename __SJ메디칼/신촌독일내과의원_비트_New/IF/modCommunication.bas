...
Function SaveTransData_BIT_New(ByVal argSpcRow As Integer) As Integer
    Dim RS_L            As ADODB.Recordset
    Dim intRow          As Integer
    Dim strDate         As String
...
'                SQL = SQL & "  And LABODRDTE = '" & strHospDate & "'"
                ...
                SQL = SQL & " Where LTRIM(ResOcmNum) = '" & strChartNo & "'"
                SQL = SQL & "   And ResLabCod = '" & strTestCd & "'"
