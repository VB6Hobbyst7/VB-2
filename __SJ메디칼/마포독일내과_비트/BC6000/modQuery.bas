            ...
            If Trim(AdoRs_Local.Fields("SENDCHANNEL").Value) <> "" Then
                ...
                If Trim(AdoRs_Local.Fields("SENDCHANNEL").Value) <> "LDLC" Then
                    ...
                    'If InStr(strExamCode, Trim(AdoRs_Local.Fields("SENDCHANNEL").Value) & "") = 0 Then
                        strExamCode = strExamCode & "OBR|" & CStr(i) & "|200|" & Trim(AdoRs_Local.Fields("SENDCHANNEL").Value) & "" & "^|||||||||" & vbCr
                        i = i + 1
                    'End If
                End If
            End If
...
Public Function GetEquipExamCode_AQT90(argEquipCode As String, argPID As String, Optional intRow As Long) As String
    Dim i As Integer
    Dim sExamCode As String
    Dim strExamCode As String
    Dim sSpecNo     As String
    ...
    Dim blnTnI      As Boolean
    Dim blnCKMB     As Boolean
    Dim blnMYO      As Boolean
    Dim blnBNP      As Boolean
    Dim blnDDIM     As Boolean
    ...
    End If
    SQL = SQL & "   And (a.SENDCHANNEL <> '' OR a.SENDCHANNEL IS NOT NULL)" & vbCrLf
    SQL = SQL & " Order By a.SENDCHANNEL "
    ...
    If Not AdoRs_Local.EOF = True And Not AdoRs_Local.BOF = True Then
        Do Until AdoRs_Local.EOF
            If Trim(AdoRs_Local.Fields("SENDCHANNEL").Value) <> "" Then
                strExamCode = strExamCode & Trim(AdoRs_Local.Fields("SENDCHANNEL").Value) & ""
                i = i + 1
'                Select Case Trim(AdoRs_Local.Fields("SENDCHANNEL").Value)
'                    Case "1": blnTnI = True
'                    Case "2": blnCKMB = True
'                    Case "3": blnMYO = True
'                    Case "4": blnBNP = True
...
'                End Select
    ...
    GetEquipExamCode_AQT90 = strExamCode

End Function


Public Function GetEquipExamCode_AQT90_ASTM(argEquipCode As String, argPID As String, Optional intRow As Long) As String
    Dim i As Integer
    Dim sExamCode As String
    Dim strExamCode As String
    Dim sSpecNo     As String
    ...
    If strExamCode <> "" Then
        GetEquipExamCode_AQT90_ASTM = Mid(strExamCode, 2)
    End If
    ...
    With frmInterface
        ...
        If Not RsLocal.EOF = True And Not RsLocal.BOF = True Then
            Do Until RsLocal.EOF
                ...
                If strBarcode <> "" And strTestCd <> "" And sResult <> "" Then
                    SQL = ""
                    SQL = SQL & "Exec UP_LIS_INTERFACE_U$001 " & dblBarno & "," & strTestCd & "," & sResult & "," & gHOSP.MACHCD & "," & gHOSP.USERID
    ...
    If Not AdoRs_Local.EOF = True And Not AdoRs_Local.BOF = True Then
        With SPD
            ...
            Do Until AdoRs_Local.EOF
                ...
                Call SetText(SPD, AdoRs_Local.Fields("AMRLimit20").Value & "|" & AdoRs_Local.Fields("AMRResult20").Value & "", intRow, colRESTYPE + 8)
                If AdoRs_Local.Fields("AMRINResult").Value & "" = "0" Then
                    Call SetText(SPD, "변환없음", intRow, colRESTYPE + 9)
                ElseIf AdoRs_Local.Fields("AMRINResult").Value & "" = "1" Then
                    Call SetText(SPD, "판정(수치)", intRow, colRESTYPE + 9)
                ElseIf AdoRs_Local.Fields("AMRINResult").Value & "" = "2" Then
                    Call SetText(SPD, "수치(판정)", intRow, colRESTYPE + 9)
                ...
                Call SetText(SPD, AdoRs_Local.Fields("CALYN").Value & "", intRow, colRESTYPE + 10)
...
Public Sub GetAMRMaster(ByVal pSeqNo As Integer, ByVal pRCd As String, ByVal pTestCd As String)
    ...
    If Not AdoRs_Local.EOF = True And Not AdoRs_Local.BOF = True Then
        Do Until AdoRs_Local.EOF
            ...
            frmTestSet.txtAMRLimit(19).Text = AdoRs_Local.Fields("AMRLIMIT20").Value & ""
            ...
            frmTestSet.txtAMRResult(19).Text = AdoRs_Local.Fields("AMRRESULT20").Value & ""
