...
Begin VB.Form frmInterface 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin FPSpread.vaSpread vasRes 
         ...
         RetainSelBlock  =   0   'False
         ScrollBars      =   2
         SpreadDesigner  =   "frmInterface.frx":6DA2
      End
   End
...
';N     4   1 4                           37000110000011000000000000000000000000000000F0
            ...
            For i = 1 To vasID.DataRowCnt
                If Trim(GetText(vasID, i, colCheckBox)) = "1" Then
                    If Trim(GetText(vasID, i, colPOSNO)) = Val(strSeq) Then
                        strBarNo = Trim(GetText(vasID, i, colBARCODE))
...
'''                Next
                ...
                If chkSeq.Value = "1" Then
                    '-- 바코드 번호로 바코드 번호 찾기
                    For i = 1 To vasID.DataRowCnt
                        If Trim(GetText(vasID, i, colPOSNO)) = Trim(strBarNo) Then
                            strBarNo = Trim(GetText(vasID, i, colBARCODE))
                            gRow = i
                            Exit For
                        End If
...
'''                Next
                ...
                If chkSeq.Value = "1" Then
                    '-- 바코드 번호로 바코드 번호 찾기
                    For i = 1 To vasID.DataRowCnt
                        If Trim(GetText(vasID, i, colPOSNO)) = Trim(strTubePos) Then
                            strBarNo = Trim(GetText(vasID, i, colBARCODE))
                            gRow = i
                            Exit For
                        End If
