...
Public Const colCheckBox = 1
Public Const colOrdDate = 2    '검사의뢰일
Public Const colBarcode = 3    '챠트번호(=바코드)
Public Const colInNum = 4      '내원번호
Public Const colGumNum = 5     '검진번호
Public Const colSeqno = 6      'SeqNo
Public Const colRack = 7       'Rack
Public Const colPos = 8        'Pos
Public Const colPName = 9      '환자명
Public Const colPSex = 10       '성별
...
'    gQCEquip = Trim(frmInterface.txtTemp)
    ...
    db_tmp = ""
    Call GetPrivateProfileString("DRDATABASE", "db", "", db_tmp, 100, App.Path & "\Interface.ini")
    frmInterface.txtTemp = Trim(db_tmp)
