   ...
   Begin TabDlg.SSTab stInterface 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin FPSpread.vaSpread vasRes 
            ...
            RetainSelBlock  =   0   'False
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":C264
         End
         Begin FPSpread.vaSpread vasID 
            ...
            RetainSelBlock  =   0   'False
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":FFAD
            UserResize      =   2
         End
         Begin VB.Label Label1 
            Appearance      =   0  'Æò¸é
...
'    Else
        stInterface.Width = frmInterface.ScaleWidth - 200
        Frame1.Width = frmInterface.ScaleWidth - 500
        vasID.Width = frmInterface.ScaleWidth - vasWorkList.Width - 800

        stInterface.Height = frmInterface.ScaleHeight - 1000
        Frame1.Height = frmInterface.ScaleHeight - 1500
        vasID.Height = frmInterface.ScaleHeight - 2300
        vasWorkList.Height = frmInterface.ScaleHeight - vasRes.Height - 2400
        vasRes.Top = vasWorkList.Height + 820
