        ...
        Select Case strType
            ...
            Case ";"    'Order  Àü¼Û
                ...
                For ii = 1 To vasWorkList.DataRowCnt
                    ...
                    'If Val(Trim(GetText(vasWorkList, ii, colSeqno))) = Val(strSeq) Then
                        ...
                        'strSeq = Trim(GetText(vasWorkList, ii, colSeqno))
                        Exit For
                    End If
                Next
...
'                comEqp.Output = STX & strSndMsg & ETX & GetChkSum(strSndMsg) & vbCr
            ...
            Case ":"    '¹ÞÀº °á°ú µ¥ÀÌÅÍ ÆíÁý
                ':n1    10 11                 01006140955      16 1    20  2    13  3    62  4  14.1F 5    18  6  0.79  7   1.3  8    73  9    91 10   183 11   4.8 12   6.8!13   4.3!14   119!15    66 16  0.39 
                ':N1    30 31        19636    01007141151       8 1    17  2     4  5    29  6  0.92  8    82  9   104 10   201 14    89 
                ...
                If strFunc <> "@" And strFunc <> "M" Then
                    ...
                    '¹ÙÄÚµå¸¦ »ç¿ëÇÏÁö ¾ÊÀ¸¸ç ¿À´õ¸¦ strSeq(Ã­Æ®¹øÈ£) ÁÖ¾î¼­ °á°úµµ strSeq¸¦ »ç¿ëÇÏ¿© Ã£´Â´Ù.
                    strBarno = Trim(Mid(strRcvBuf, 13, 13))
                    'strBarno = strSeq
            ...
            Case "1", "2", "3", "4", "5", "6", "7", "8", "9"    '<FR1 ~ FR9>
                ...
                If strFunc <> "@" And strFunc <> "M" Then
                    ...
                    strRackNo = Trim(Mid(strRcvBuf, 9, 1))
                    strTubePos = Trim(Mid(strRcvBuf, 10, 2))
                    strBarno = strSeq 'Trim(Mid(strRcvBuf, 13, 13))
                    intCnt = Val(Trim(Mid(strRcvBuf, 47, 2)))
