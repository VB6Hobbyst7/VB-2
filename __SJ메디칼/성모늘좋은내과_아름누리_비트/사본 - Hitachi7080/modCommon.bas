...
'Public Const colCheckBox = 1
'Public Const colSeqNo = 2
'Public Const colPID = 3        '진료번호
'Public Const colOrdDate = 4    '검사의뢰일
'Public Const colBarcode = 5    '바코드
'Public Const colRack = 6       'Rack
'Public Const colPos = 7        'Pos
'Public Const colDept = 8       '진료과
'Public Const colIOFlag = 9     '입원/외래구분
'Public Const colOrdSeq = 10    '순번
'Public Const colReceNo = 11    '접수번호(검사의뢰)
'Public Const colPName = 12     '환자명
'Public Const colOCnt = 13
'Public Const colRCnt = 14
'Public Const colState = 15

Public Const colSpecNo = 0 '미사용
Public Const colCheckBox = 1
Public Const colOrdDate = 2    '검사의뢰일
Public Const colSeqNo = 3
Public Const colBarcode = 4    '바코드
Public Const colPID = 4
Public Const colRack = 5       'Rack
Public Const colPos = 6        'Pos
Public Const colPName = 7     '환자명
Public Const colPSex = 8     '환자명
