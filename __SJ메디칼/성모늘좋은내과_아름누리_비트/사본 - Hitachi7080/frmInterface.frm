   ...
   Begin TabDlg.SSTab stInterface 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin FPSpread.vaSpread vasRes 
            ...
            RetainSelBlock  =   0   'False
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":C1F5
         End
         Begin FPSpread.vaSpread vasID 
            ...
            RetainSelBlock  =   0   'False
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":FF58
            UserResize      =   2
         End
         Begin VB.Label Label1 
            Appearance      =   0  'Æò¸é
...
Const colSeqNo = 3      'Exam_No
Const colBarcode = 4    'Ã­Æ®¹øÈ£(=¹ÙÄÚµå)
Const colRack = 5       'Rack
Const colPos = 6        'Pos
Const colPName = 7     'È¯ÀÚ¸í
Const colPSex = 8     'È¯ÀÚ¸í
Const colOCnt = 9
Const colRCnt = 10
Const colState = 11
...
'    SQL = SQL & "   and R.ResLabCod in (" & gAllExam_Bit & ")"
    SQL = SQL & "   and R.ResLabCod in ('B2570','B2580','B2710','C3750')"
