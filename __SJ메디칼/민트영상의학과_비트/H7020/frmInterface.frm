...
Begin VB.Form frmInterface 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin FPSpread.vaSpread vasRes 
         ...
         RetainSelBlock  =   0   'False
         ScrollBars      =   2
         SpreadDesigner  =   "frmInterface.frx":2151
      End
   End
   ...
   Begin VB.Frame FrmHideControl 
      ...
      Begin VB.Frame Frame5 
         ...
         Begin VB.ComboBox cboChk 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmInterface.frx":386A
            Left            =   2460
            List            =   "frmInterface.frx":3877
            TabIndex        =   68
            Top             =   1680
            Visible         =   0   'False
            Width           =   975
         ...
         Begin VB.ComboBox cboTest 
            ...
            ForeColor       =   &H00FF0000&
            Height          =   300
            ItemData        =   "frmInterface.frx":388F
            Left            =   600
            List            =   "frmInterface.frx":3891
            Style           =   2  '드롭다운 목록
            TabIndex        =   67
            Top             =   1650
            Visible         =   0   'False
      ...
      Begin VB.Frame Frame4 
         ...
         Begin FPSpread.vaSpread vasPrint 
            ...
            EndProperty
            MaxCols         =   9
            SpreadDesigner  =   "frmInterface.frx":3893
         End
         Begin FPSpread.vaSpread vasPrintBuf 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            SpreadDesigner  =   "frmInterface.frx":531A
         End
      End
      ...
      Begin FPSpread.vaSpread vasCode 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":5540
      End
      Begin FPSpread.vaSpread vasTemp1 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":5766
      End
         ...
         Begin MSComctlLib.ImageList imlStatus 
            ...
            BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
               ...
               BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":5F16
                  Key             =   "RUN"
               EndProperty
               BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":64B0
                  Key             =   "NOT"
               EndProperty
               BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":6A4A
                  Key             =   "STOP"
               EndProperty
               BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":6FE4
                  Key             =   "LST"
               EndProperty
               BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":7876
                  Key             =   "ITM"
               EndProperty
               BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":79D0
                  Key             =   "ERR"
               EndProperty
               BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":7B2A
                  Key             =   "NOF"
               EndProperty
            EndProperty
         End
      ...
      Begin FPSpread.vaSpread vasList 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":7C84
      End
      Begin FPSpread.vaSpread vasResTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":7EAA
      End
      Begin FPSpread.vaSpread vasTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":80D0
      End
      Begin FPSpread.vaSpread vasExcel 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":82F6
      End
...
'    End If
    ...
    SQL = ""
    SQL = SQL & "SELECT DISTINCT L.LABSERIAL, L.LABATTEND as 내원번호, L.LABCHTNUM as 챠트번호, L.LABODRDTE as 접수일자, M.MANADMFOR as 입외," & vbCrLf
        ...
        Do Until RS.EOF
            ...
            With vasID
                ...
                If blnSame = False Then
                    .MaxRows = .MaxRows + 1
                    SetText vasID, "1", .MaxRows, colCheckBox
                    SetText vasID, Trim(RS.Fields("접수일자")) & "", .MaxRows, colHOSPDATE:     strLog = strLog & Trim(RS.Fields("접수일자")) & "|"
                    SetText vasID, Trim(RS.Fields("바코드번호")) & "", .MaxRows, colBARCODE:     strLog = strLog & Trim(RS.Fields("바코드번호")) & "|"
                    'SetText vasID, "1702150018", .MaxRows, colBARCODE
                    SetText vasID, Trim(RS.Fields("챠트번호")) & "", .MaxRows, colCHARTNO:     strLog = strLog & Trim(RS.Fields("챠트번호")) & "|"
                    SetText vasID, Trim(RS.Fields("내원번호")) & "", .MaxRows, colPID:     strLog = strLog & Trim(RS.Fields("내원번호")) & "|"
                    SetText vasID, Trim(RS.Fields("이름")) & "", .MaxRows, colPNAME:     strLog = strLog & Trim(RS.Fields("이름")) & "|"
                    ...
                    Call SetSQLData("워크조회_결과", strLog)
                    strLog = ""
...
'''    Next i
    ...
    '-- 바코드
    For i = 1 To vasID.DataRowCnt
        If Val(Trim(GetText(vasID, i, colBARCODE))) = Trim(mOrder.BarNo) Then
            pBarNo = Trim(GetText(vasID, i, colBARCODE))
            mOrder.BarNo = pBarNo
            intRow = i
            Exit For
...
';N     1   1                            
';N     1   1 1                           37000000000000001000000000000000000000000000E7
'
';N     2   2                            
';N     2   2 2                           37111111100000010000000000000000000000000000F1
'
';N     3   3                            
';N     3   3 3                           37000110000011000000000000000000000000000000F0
'
';N     4   1                            
';N     4   1 4                           37000110000011000000000000000000000000000000F0
            ...
            For i = 1 To vasID.DataRowCnt
                If Trim(GetText(vasID, i, colCheckBox)) = "1" Then
                    If Trim(GetText(vasID, i, colSN)) = Val(strTubePos) Then
...
'            SetRawData "[2]" & SQL & vbCr
            ...
            For i = 0 To UBound(gReadBuf)
                ...
                End If
            Next
'            SetRawData "[3]" & strSendData & vbCr
'            SetRawData "[3-1]" & UBound(strExamCode) & vbCr
...
'''                Next
                ...
                '-- 바코드 번호로 바코드 번호 찾기
                For i = 1 To vasID.DataRowCnt
                    If Trim(GetText(vasID, i, colBARCODE)) = Trim(strBarNo) Then
                        strBarNo = Trim(GetText(vasID, i, colBARCODE))
                        gRow = i
                        Exit For
                    End If
            ...
            With vasID
                ...
                If IsNumeric(strSeq) Then
                    For i = .ActiveRow To .DataRowCnt
                        Call SetText(vasID, Format(strSeq, "#0"), i, colSN)
                        strSeq = Val(strSeq) + 1
                    Next
                Else
