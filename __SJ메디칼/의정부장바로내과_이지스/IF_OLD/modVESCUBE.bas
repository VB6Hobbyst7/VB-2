...
Private Sub SerialRcvData_VESCUBE()
    ...
    With frmMain
        ...
        If Trim(strBarno) <> "" And Trim(strResult) <> "" Then
            With mResult
                .BarNo = strBarno
...
Private Sub GetOrder(ByVal pBarno As String, ByVal pType As String)
    ...
    With frmMain
        ...
        strItems = GetEquipExamCode_VESCUBE(gHOSP.MACHCD, pBarno, intRow)
...
Private Function GetEquipExamCode_VESCUBE(argEquipCode As String, argPID As String, Optional intRow As Long) As String
    Dim i As Integer
    ...
    GetEquipExamCode_VESCUBE = Mid(strExamCode, 2)
