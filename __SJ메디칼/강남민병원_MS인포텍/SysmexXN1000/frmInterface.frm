   ...
   Begin TabDlg.SSTab stInterface 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.ComboBox cboChk 
            Height          =   315
            ItemData        =   "frmInterface.frx":B6C9
            Left            =   3720
            List            =   "frmInterface.frx":B6D6
            TabIndex        =   72
            Top             =   -30
            Visible         =   0   'False
            Width           =   825
         ...
         Begin FPSpread.vaSpread vasRes 
            ...
            RetainSelBlock  =   0   'False
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":B6EC
         End
         ...
         Begin FPSpread.vaSpread vasWorkList 
            ...
            RetainSelBlock  =   0   'False
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":F400
            UserResize      =   2
         End
         Begin FPSpread.vaSpread vasID 
            ...
            RetainSelBlock  =   0   'False
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":FF03
            UserResize      =   2
         End
         Begin VB.Label Label1 
            Appearance      =   0  '평면
...
'             SQL = "Select a.ORDT,a.ORQN,b.PANM,a.SPNO,a.OIFL,a.SENO,b.SEXS,b.AGES,a.NWNO,a.ORCD "
          SQL = "Select DISTINCT a.ORDT,'0',b.PANM,a.SPNO,a.OIFL,'0',b.SEXS,b.AGES,a.NWNO "
    SQL = SQL & "  From LRESULT a, APATINF b"
    SQL = SQL & " Where a.ORDT between  '" & pFrDt & "' and '" & pToDt & "'"
    SQL = SQL & "   And a.PAID = b.PAID "
    SQL = SQL & "   And a.ORCD in (" & gAllExam & ")"
    SQL = SQL & "   And a.OKFL <> 'Y' "   '-- 결과확정유무
    'SQL = SQL & " Order By a.ORDT,a.PAID,b.PANM,a.SENO"
...
'    SetRawData "[sql]" & SQL
    ...
    Do Until RS.EOF
        ...
        SetText vasWorkList, Trim(RS.Fields(0)), intRow, colOrdDate
        SetText vasWorkList, RS.Fields(3) & "", intRow, colBarcode
        'SetText vasWorkList, "", intRow, colRack
        'SetText vasWorkList, "", intRow, colPos
        SetText vasWorkList, Trim(RS.Fields(1)), intRow, colPID
        SetText vasWorkList, Trim(RS.Fields(2)), intRow, colPName
...
Private Sub GetOrder(ByVal pBarNo As String)
    ...
    gOrderExam = GetOrderExamCode_Qry(gEquip, pBarNo)
...
'                strTubePos = mGetP(strTemp1, 2, "^")
                ...
                If strTubePos = "" And strTubePos = "" Then
                    For i = 1 To vasID.DataRowCnt
                        vasID.Row = i
                        vasID.Col = colSeqNo
                        If vasID.Text = strBarno Then
                    ...
                    If Res > 0 Then
                        ...
                        For i = 0 To UBound(varORQN)
                            If lsExamCode = mGetP(varORQN(i), 1, ",") Then
                                SetText vasRes, mGetP(varORQN(i), 2, ","), lsResRow, colSeq                '순번
                                Exit For
                            End If
                        Next
