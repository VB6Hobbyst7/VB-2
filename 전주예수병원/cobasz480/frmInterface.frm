...
Begin VB.Form frmInterface 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin FPSpread.vaSpread vasRes 
         ...
         RetainSelBlock  =   0   'False
         ScrollBars      =   2
         SpreadDesigner  =   "frmInterface.frx":215B
      End
   End
   ...
   Begin VB.Frame FrmHideControl 
      ...
      Begin VB.ComboBox cboChk 
         ...
         EndProperty
         Height          =   315
         ItemData        =   "frmInterface.frx":3877
         Left            =   4320
         List            =   "frmInterface.frx":3884
         TabIndex        =   73
         Top             =   3390
         Width           =   975
      End
      ...
      Begin VB.ComboBox cboTest 
         ...
         ForeColor       =   &H00FF0000&
         Height          =   300
         ItemData        =   "frmInterface.frx":389A
         Left            =   7170
         List            =   "frmInterface.frx":389C
         Style           =   2  '드롭다운 목록
         TabIndex        =   70
         Top             =   3090
         Visible         =   0   'False
      ...
      Begin VB.Frame Frame4 
         ...
         Begin FPSpread.vaSpread vasPrint 
            ...
            EndProperty
            MaxCols         =   9
            SpreadDesigner  =   "frmInterface.frx":389E
         End
         Begin FPSpread.vaSpread vasPrintBuf 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            SpreadDesigner  =   "frmInterface.frx":5317
         End
      End
      ...
      Begin FPSpread.vaSpread vasCode 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":552F
      End
      Begin FPSpread.vaSpread vasTemp1 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":5747
      End
         ...
         Begin MSComctlLib.ImageList imlStatus 
            ...
            BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
               ...
               BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":5EE9
                  Key             =   "RUN"
               EndProperty
               BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":6483
                  Key             =   "NOT"
               EndProperty
               BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":6A1D
                  Key             =   "STOP"
               EndProperty
               BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":6FB7
                  Key             =   "LST"
               EndProperty
               BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":7849
                  Key             =   "ITM"
               EndProperty
      ...
      Begin FPSpread.vaSpread vasList 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":7C57
      End
      Begin FPSpread.vaSpread vasResTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":7E6F
      End
      Begin FPSpread.vaSpread vasTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":8087
      End
      Begin FPSpread.vaSpread vasExcel 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":829F
      End
...
Private Sub cmdSearch_Click()
    ...
    Select Case gOCS
        ...
        Case "GESUS":       Call GetWorkList_GESUS(Format(dtpStartDt.Value, "yyyymmdd"), Format(dtpStopDt.Value, "yyyymmdd"))
    End Select
...
Private Sub GetWorkList_GESUS(ByVal pFrDt As String, ByVal pToDt As String, Optional pBarNo As String)
    Dim RS          As ADODB.Recordset
    Dim i           As Integer
    Dim iCnt        As Long
    Dim intRow      As Long
    ...
    vasID.ReDraw = False
          ...
          SQL = "SELECT DISTINCT DIAGDATE as 접수일자, PATHNO as 바코드번호, PATNO as 내원번호, MEDDEPT as ITEM " & vbLf
    SQL = SQL & vbCrLf & "  FROM SPXMSTDT " & vbLf
    SQL = SQL & vbCrLf & " WHERE DIAGDATE between '" & Format(pFrDt, "####-##-##") & "' and '" & Format(pToDt, "####-##-##") & "'" & vbLf
    'SQL = SQL & vbCrLf & "   AND MEDDEPT IN (" & gAllExam & ") " & vbLf
    If chkSaveAll.Value = "0" Then
...
''                '1^CRE^^\2^CHO^^\3^GOT^^\4^GPT^^
''                strExamCode = strExamCode & "\" & intOrdCnt & "^" & Trim(gReadBuf(i)) & "^^"
...
Private Sub SetPatInfo(ByVal pBarNo As String, Optional ByVal pRno As String, Optional ByVal pPno As String)
    ...
    Call GetSampleInfoW_GESUS(intRow)
...
'E5
    ...
    For intCnt = 1 To UBound(strRecvData)
        ...
        Select Case strType
            ...
            Case "O"
                'O|1|8A1T12768AG00FV^HD5003493^A01:A02:A03^^^||^^^08EGFR^^AnD|||20160901153453||||Q||||^MUTCONTROL|LabB4
                strTemp1 = Trim$(mGetP(strRcvBuf, 3, "|"))
                strBarNo = Trim(mGetP(strTemp1, 1, "^"))
                If InStr(strBarNo, "-") > 0 Then
                    strBarNo = Trim(mGetP(strBarNo, 1, "-"))
                End If
                
                strSeq = Trim(mGetP(strTemp1, 3, "^"))
                
                If Len(strBarNo) < 10 And IsNumeric(strBarNo) Then
                    strTemp1 = Trim(Mid(mGetP(strRcvBuf, 8, "|"), 1, 4))
                    strBarNo = "PM" & strTemp1 & Format(strBarNo, "000000")
                End If
                
                If Mid(strBarNo, 1, 2) <> "PM" Then
                    strBarNo = strSeq
                End If
...
'
            ...
            Case "R"
                'R|1|^^^08EGFR|Valid|||||P||Labmanager|20160901153611|20160901170505|52079_34232
                
                strIntBase = Trim(mGetP(mGetP(strRcvBuf, 3, "|"), 4, "^"))
                strResult = Trim$(mGetP(strRcvBuf, 4, "|"))
                
                If Len(strBarNo) = 12 And strResult <> "" Then
                    SQL = ""
...
'        End If
    ...
    ElseIf KeyCode = vbKeyReturn Then
        If iCol = colBARCODE Then
            ...
            '-- 바뀐 바코드로 환자정보 불러오기
            Call GetSampleInfoW_GESUS(iRow)
