...
Public Sub GetWorkList(ByVal pFrom As String, ByVal pTo As String, ByVal SPD As vaSpread)
    ...
    Call GetWorkList_PMC(pFrom, pTo, SPD)
...
Public Sub GetWorkList_PMC(ByVal pFrom As String, ByVal pTo As String, ByVal SPD As vaSpread)
    Dim RS          As ADODB.Recordset
    Dim blnSame     As Boolean
...
'    P_START_DATE        IN VARCHAR2,        /*입력일자(시작일)*/
'    P_END_DATE          IN VARCHAR2,        /*입력일자(종료일)*/
'    P_STSCD             IN VARCHAR2,        /*상태코드*/
'    P_OUT_CSR           OUT SYS_REFCURSOR   /*결과반환커서*/

'''    SQL = "EXEC LIS_KNTA_UPLOAD '" & pFrom & "','" & pTo & "','" & 2 & "'"
'''
'''    '-- Record Count 가져옴
'''    AdoCn.CursorLocation = adUseClient
'''    Set RS = New ADODB.Recordset
...
'    AdoCmd.CommandText = "LIS_KNTA_UPLOAD"
    AdoCmd.CommandText = "LIS_GCRL_UPLOAD"
    
    AdoCmd.CommandType = adCmdStoredProc
    
    Set prm1 = AdoCmd.CreateParameter("P_START_DATE", adVarChar, adParamInput, 200, pFrom)
    AdoCmd.Parameters.Append prm1
    Set prm2 = AdoCmd.CreateParameter("P_END_DATE", adVarChar, adParamInput, 200, pTo)
    AdoCmd.Parameters.Append prm2
    Set prm3 = AdoCmd.CreateParameter("P_STSCD", adVarChar, adParamInput, 200, strSTScd)
...
'                End If
            ...
            For i = 0 To 100
                Debug.Print i & ":" & RS.Fields(i).NAME & ":" & RS.Fields(i)
