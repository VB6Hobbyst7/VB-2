...
Begin VB.Form frmInterface 
   ...
   Caption         =   " AU2700 Interface Program(Ver 1.5)"
   ClientHeight    =   10635
   ClientLeft      =   765
   ClientTop       =   840
   ClientWidth     =   15075
   ...
   Begin FPSpread.vaSpread vasOrder1 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      SpreadDesigner  =   "frmInterface.frx":06A9
   End
   ...
   Begin FPSpread.vaSpread vasRes 
      ...
      MaxCols         =   13
      Protect         =   0   'False
      SpreadDesigner  =   "frmInterface.frx":0910
   End
   ...
   Begin FPSpread.vaSpread vasID 
      ...
      MaxCols         =   21
      Protect         =   0   'False
      SpreadDesigner  =   "frmInterface.frx":556C
   End
   Begin VB.Frame Frame1 
      Height          =   9495
      Index           =   0
   ...
   Begin FPSpread.vaSpread vasTemp1 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      SpreadDesigner  =   "frmInterface.frx":994A
   End
   ...
   Begin FPSpread.vaSpread vasRece 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      SpreadDesigner  =   "frmInterface.frx":9BB1
   End
   Begin FPSpread.vaSpread vasTemp 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      SpreadDesigner  =   "frmInterface.frx":9E18
   End
   Begin FPSpread.vaSpread vasResTemp 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      SpreadDesigner  =   "frmInterface.frx":E365
   End
   Begin FPSpread.vaSpread vasPrint 
      ...
      SpreadDesigner  =   "frmInterface.frx":E5CC
   End
...
Function Insert_Data(argSpcRow As Integer) As Integer
    ...
    For intX = 1 To vasResTemp.DataRowCnt
        ...
        If Mid(sBarcode, 1, 2) <> "04" Then
            'Save_Result_Data Mid(sBarcode, 1, 2) & "20" & Mid(sBarcode, 3, 8) & sEXAMDATE & Mid(sBarcode, 11, 4) & sExamCode & sResult
            Save_Result_Data "04" & "97" & Mid(sBarcode, 3, 8) & Mid(sBarcode, 3, 8) & Mid(sBarcode, 11, 4) & sExamCode & sResult
        Else
            Save_Result_Data Mid(sBarcode, 1, 2) & "97" & Mid(sBarcode, 3, 8) & Mid(sBarcode, 3, 8) & Mid(sBarcode, 11, 4) & sExamCode & sResult
        End If
    Next intX
...
Private Sub Command1_Click()
    ...
    Call AU2700("DQ", "       Q002                      01E1002       35  04       97  06      199  08      1.9  10      4.1  11      1.1  12      0.3  16       54  20      3.3  22       99  24      7.0  ")
End Sub
...
RTN_PROCESS_R:
    ...
    gstrQuy = gstrQuy & vbCrLf & "   AND A.EXAMDATE      = '" & Format(CDate(dtpExamDate.Value), "yyyymmdd") & "'"
...
'    gOrderMessage = chrSTX & _
    ...
    gOrderMessage = chrSTX & _
                    "S " & _
                    Left(asData, 11) & TEXT_RSET(lsSampleID, 20) & Space(4) & "E0     " & _
                    lsData & _
                    chrETX
    Call SendOrder
...
'    End If
    ...
    SQL = "DELETE FROM PAT_RES "
    SQL = SQL & vbCrLf & " WHERE EQUIPNO   = '" & gtypREG_INFO.EQUIPCD & "' "
    SQL = SQL & vbCrLf & "   AND EXAMDATE  = '" & Format(CDate(dtpExamDate.Value), "yyyymmdd") & "' "
