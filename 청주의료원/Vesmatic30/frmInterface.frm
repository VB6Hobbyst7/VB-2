...
Begin VB.Form frmInterface 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Tab(2).Control(0)=   "txtBarNum"
      Tab(2).Control(0).Enabled=   0   'False
      Tab(2).Control(1)=   "cmdReceSch"
      Tab(2).Control(1).Enabled=   0   'False
      Tab(2).Control(2)=   "cmbReceState"
      Tab(2).Control(2).Enabled=   0   'False
      Tab(2).Control(3)=   "dtpReceDate1"
      Tab(2).Control(3).Enabled=   0   'False
      Tab(2).Control(4)=   "vasReceList"
      Tab(2).Control(4).Enabled=   0   'False
      Tab(2).Control(5)=   "dtpReceDate2"
      ...
      Begin VB.Frame Frame3 
         ...
         Begin FPSpread.vaSpread vaSpread3 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            SpreadDesigner  =   "frmInterface.frx":342F
         End
         Begin FPSpread.vaSpread vaSpread2 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            SpreadDesigner  =   "frmInterface.frx":36A4
         End
         ...
         Begin FPSpread.vaSpread vasOrderBuf 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            SpreadDesigner  =   "frmInterface.frx":3919
         End
         ...
         Begin FPSpread.vaSpread vasID 
            ...
            RetainSelBlock  =   0   'False
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":C307
         End
         Begin FPSpread.vaSpread vasRes 
            ...
            Protect         =   0   'False
            RetainSelBlock  =   0   'False
            SpreadDesigner  =   "frmInterface.frx":E26C
         End
      ...
      Begin VB.Frame Frame5 
         ...
         Begin VB.Frame Frame7 
            ...
            Begin FPSpread.vaSpread vasEquipL1 
               ...
               MaxCols         =   3
               ScrollBars      =   2
               SpreadDesigner  =   "frmInterface.frx":ED78
            End
            Begin FPSpread.vaSpread vasEquipH1 
               ...
               MaxCols         =   3
               ScrollBars      =   2
               SpreadDesigner  =   "frmInterface.frx":1070C
            End
         ...
         Begin VB.Frame Frame9 
            ...
            Begin FPSpread.vaSpread vasEquipL2 
               ...
               MaxCols         =   2
               ScrollBars      =   2
               SpreadDesigner  =   "frmInterface.frx":139AE
            End
         ...
         Begin FPSpread.vaSpread vasQCPrint 
            ...
            MaxCols         =   4
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":152BC
         End
         Begin FPSpread.vaSpread vasSumTemp 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            SpreadDesigner  =   "frmInterface.frx":16C6D
         End
         Begin FPSpread.vaSpread vasSum 
            ...
            Protect         =   0   'False
            RetainSelBlock  =   0   'False
            SpreadDesigner  =   "frmInterface.frx":16EE2
         End
      End
      Begin FPSpread.vaSpread vasReceList 
         ...
         RetainSelBlock  =   0   'False
         ScrollBars      =   2
         SpreadDesigner  =   "frmInterface.frx":19EDC
      End
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin VB.PictureBox Picture1 
         ...
         Height          =   285
         Left            =   8640
         Picture         =   "frmInterface.frx":1B9E6
         ScaleHeight     =   255
         ScaleWidth      =   285
         TabIndex        =   14
         Top             =   180
   ...
   Begin VB.Frame Frame2 
      ...
      Begin FPSpread.vaSpread vasTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":1BF70
      End
      Begin FPSpread.vaSpread vasCode 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":204CB
      End
   End
...
'''            SetBackColor vasList, i, i, colBarCode, colRemark, 240, 180, 180
        ...
        If GetText(vasList, i, colResult) <> "" And IsNumeric(GetText(vasList, i, colResult)) Then
...
'    s = sTxt
    ...
    Select Case s
        ...
        Case Chr(27)    '-- 메뉴얼에는 있으나 실제로는 안나옴
            VesMatic txtBuff.Text & s
            txtBuff.Text = ""
...
Private Sub Vesmatic30_Define(asData As String)
    Dim sData As String
    Dim i As Integer
    Dim j As Integer
...
' 30 = 4965812......   6
                ...
                strasData = Trim(mGetP(asData, 1, "."))
                
                strSampleNo = Trim(mGetP(strasData, 2, "="))
                strSeqNum = Trim(mGetP(strasData, 1, "="))
                
                'If Trim(mGetP(strSeqNum, 1, "=")) = "29" Then
                If strSeqNum = "29" Then
            ...
            Case 3
                ...
                If strSampleNo <> "" And IsNumeric(strSampleNo) And strResult <> "" Then
...
Private Sub Timer1_Timer()
    ...
    'MsgBox "2"
    'MsgBox txtBuff
    If txtBuff.Text <> "" And Len(txtBuff) >= 10 Then
    '    MsgBox "3"
        VesMatic txtBuff.Text
        txtBuff.Text = ""
        Timer1.Enabled = False
    End If
...
Private Sub txtBarNum_KeyDown(KeyCode As Integer, Shift As Integer)
    ...
    If KeyCode = 13 Then
        lsBarcode = Trim(txtBarNum.Text)
        
        iRow = -1
        
        For i = 1 To vasReceList.DataRowCnt 'To 1 Step -1
            vasReceList.Row = i
            vasReceList.Col = 1: vasReceList.ForeColor = vbBlack
            vasReceList.Col = 2: vasReceList.ForeColor = vbBlack
            vasReceList.Col = 3: vasReceList.ForeColor = vbBlack
            vasReceList.Col = 4: vasReceList.ForeColor = vbBlack
            vasReceList.Col = 5: vasReceList.ForeColor = vbBlack
            vasReceList.Col = 6: vasReceList.ForeColor = vbBlack
            vasReceList.Col = 7: vasReceList.ForeColor = vbBlack
        Next
        
        For i = 1 To vasReceList.DataRowCnt 'To 1 Step -1
            If Trim(GetText(vasReceList, i, 1)) = lsBarcode Then
                vasReceList.Row = i
                vasReceList.Col = 1: vasReceList.ForeColor = vbRed
                vasReceList.Col = 2: vasReceList.ForeColor = vbRed
                vasReceList.Col = 3: vasReceList.ForeColor = vbRed
                vasReceList.Col = 4: vasReceList.ForeColor = vbRed
                vasReceList.Col = 5: vasReceList.ForeColor = vbRed
                vasReceList.Col = 6: vasReceList.ForeColor = vbRed
                vasReceList.Col = 7: vasReceList.ForeColor = vbRed
                vasReceList.Action = ActionActiveCell
                iRow = i
                Exit For
            End If
        Next
