   ...
   Begin TabDlg.SSTab tabWork 
      ...
      Begin Threed.SSFrame SSFrame1 
         ...
         Begin FPSpread.vaSpread spdRstview 
            ...
            SpreadDesigner  =   "frmComm.frx":7BF6
            UserResize      =   0
         End
      End
      Begin Threed.SSPanel SSPanel1 
         ...
         Begin VB.ComboBox cboChk 
            Enabled         =   0   'False
            Height          =   300
            ItemData        =   "frmComm.frx":8243
            Left            =   3630
            List            =   "frmComm.frx":824D
            TabIndex        =   59
            Top             =   90
            Visible         =   0   'False
            Width           =   1095
         ...
         Begin VB.ComboBox cboComNm 
            Height          =   300
            ItemData        =   "frmComm.frx":825D
            Left            =   4755
            List            =   "frmComm.frx":825F
            TabIndex        =   58
            Top             =   90
            Visible         =   0   'False
            Width           =   1545
      ...
      Begin Threed.SSPanel SSPanel3 
         ...
         Begin VB.ComboBox cboRstgbn 
            Height          =   300
            Index           =   1
            ItemData        =   "frmComm.frx":8B51
            Left            =   2460
            List            =   "frmComm.frx":8B5E
            Style           =   2  '드롭다운 목록
            TabIndex        =   68
            Top             =   90
            Visible         =   0   'False
      ...
      Begin FPSpread.vaSpread spdResult2 
         ...
         RetainSelBlock  =   0   'False
         ScrollBarMaxAlign=   0   'False
         SpreadDesigner  =   "frmComm.frx":8B88
         UserResize      =   0
      End
            ...
            For intIdx = 1 To Len(strDta)
                ...
                Select Case strBuff
                    ...
                    Case vbCr   '-- ETX
                            ...
                            sEtxCheck = 1 'InStr(f_strBuffer, vbCr)
                    ...
                    Case Else
                            ...
                            If sStxCheck <> 0 And sEtxCheck <> 0 Then
                                ...
                                'Print #1, "[TO]" & sEtxtoLen;
                                If sEtxtoLen = 2 Then
                                    Print #1, vbNewLine & "[TX]" & f_strBuffer;
