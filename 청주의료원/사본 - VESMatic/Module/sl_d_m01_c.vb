...
Function sl_spc_axsym_channel&(eqcode$(), examcode$(), examname$(), normal1$())
        Dim dce_table As Long, Socket As Integer

        Call dce_checkver(2, 0)
        Socket = dce_findserver("sl_d_m01")
        If (Socket > -1) Then
                dce_table = dce_submit("sl_d_m01", "sl_spc_axsym_channel", Socket)
        End If
        sl_spc_axsym_channel = dce_pop_long(dce_table, "dce_result")
