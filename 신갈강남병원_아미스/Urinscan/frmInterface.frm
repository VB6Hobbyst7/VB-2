...
Begin VB.Form frmInterface 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin FPSpread.vaSpread vasRes 
         ...
         RetainSelBlock  =   0   'False
         ScrollBars      =   2
         SpreadDesigner  =   "frmInterface.frx":214A
      End
   End
...
'        SQL = SQL & "   AND O.ORDERCODE IN ('LU101','LU00011','LU00015') "
        SQL = SQL & "   AND O.ORDERCODE IN ('LU101','HCHEM004') "
    Else
        ...
        Do Until RS.EOF
            ...
            With vasID
                ...
                If blnSame = False Then
                    ...
                    If chkGum.Value = "1" Then
                        SetText vasID, "검진", .MaxRows, colINOUT
                    Else
                        SetText vasID, "진료", .MaxRows, colINOUT
                    End If
