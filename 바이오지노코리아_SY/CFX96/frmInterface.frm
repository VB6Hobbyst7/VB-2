...
Begin VB.Form frmInterface 
   ...
   Begin VB.Frame fraHidden 
      ...
      Begin FPSpread.vaSpread spdOrder_PRT 
         ...
         SpreadDesigner  =   "frmInterface.frx":3808
         ScrollBarTrack  =   3
         ShowScrollTips  =   3
      End
   ...
   Begin FPSpread.vaSpread spdOrder 
      ...
      ScrollBarExtMode=   -1  'True
      ShadowColor     =   16777215
      SpreadDesigner  =   "frmInterface.frx":6693
      ScrollBarTrack  =   3
      ShowScrollTips  =   3
   End
   Begin FPSpread.vaSpread spdResult 
      ...
      ScrollBarExtMode=   -1  'True
      ShadowColor     =   16777215
      SpreadDesigner  =   "frmInterface.frx":838A
      ScrollBarTrack  =   3
      ShowScrollTips  =   3
   End
   ...
   Begin VB.PictureBox picComm 
      ...
      Begin FPSpread.vaSpread spdExcel 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":CB29
      End
   ...
   Begin VB.Frame fraWorkInfo 
      ...
      Begin VB.ComboBox cboChk 
         ...
         EndProperty
         Height          =   345
         ItemData        =   "frmInterface.frx":CD7C
         Left            =   930
         List            =   "frmInterface.frx":CD89
         TabIndex        =   73
         Top             =   450
         Width           =   1005
      End
   ...
   Begin FPSpread.vaSpread spdWork 
      ...
      ScrollBarExtMode=   -1  'True
      ShadowColor     =   16777215
      SpreadDesigner  =   "frmInterface.frx":E21D
      ScrollBarTrack  =   3
      ShowScrollTips  =   3
   End
End
...
'On Error GoTo ErrHandle
    ...
    With frmInterface
        For intRow = 2 To spdExcel.MaxRows
            ...
            If blnRawData = True Then
                intRCnt = intRCnt + 1
                strIntBase = GetText(spdExcel, intRow, intIntNo)
                If UCase(strIntBase) = "CY5" Then
                    strIntBase = "ICA"
                ElseIf UCase(strIntBase) = "FAM" Then
                    strIntBase = "RdRP"
                ElseIf UCase(strIntBase) = "HEX" Then
                    strIntBase = "E"
                End If
            ...
            Else
                '뷰어데이터
                intRCnt = intRCnt + 1
                For intCol = intSmpNo + 1 To spdExcel.MaxCols
                    strIntBase = GetText(spdExcel, 1, intCol)
                    If UCase(strIntBase) = "IC" Then
                        strIntBase = "ICA"
                    ElseIf UCase(strIntBase) = "RDRP" Then
                        strIntBase = "RdRP"
                    ElseIf UCase(strIntBase) = "E" Then
                        strIntBase = "E"
                    ElseIf UCase(strIntBase) = "RESULT" Then
                        strIntBase = "Covid-19"
                    Else
                        strIntBase = ""
                    End If
...
'       PC                  ≤36            ≤36        ≤32            Valid
        ...
        If blnRawData = True Then
            For intRow = 1 To spdOrder.MaxRows
                ...
                Call GetSampleInfo_SY(intRow, spdOrder)
...
Private Sub cmdSearch_Click()
    ...
    Call GetWorkList(Format(dtpFrom.Value, "yyyy-mm-dd"), Format(dtpTo.Value, "yyyy-mm-dd"), spdWork, txtFrNo.Text, txtToNo.Text)
        ...
        With frmInterface
            ...
            For intCol = colSTATE + 1 To .spdOrder.MaxCols
                If strAbbrName = gArrEQP(intCol - colSTATE, 6) Then
                    ...
                    strOrderCode = gArrEQP(intCol - colSTATE, 16)   'OrderCode
                    strTestCodeSub = gArrEQP(intCol - colSTATE, 17) 'TestSubCode
