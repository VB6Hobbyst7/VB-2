...
'PWD =!dcl33$%%@22ysi49
    ...
    If ServerName = "" Then
        Select Case gEMR
            Case "SY":          ServerName = "115.68.13.133,14032"  '다이오진, 바이오지노코리아
    ...
    If DatabaseName = "" Then
        Select Case gEMR
            'Case "SY":          DatabaseName = "LC33_DCL"   '다이오진
            Case "SY":          DatabaseName = "LC30_BIOGENO"   '바이오지노코리아
    ...
    If UserName = "" Then
        Select Case gEMR
            'Case "SY":          UserName = "interface33"    '다이오진
            Case "SY":          UserName = "interface30"    '바이오지노코리아
    ...
    If Password = "" Then
        Select Case gEMR
            'Case "SY":          Password = "!dcl33$%%@22ysi49"  '다이오진
            Case "SY":          Password = "inter07!$25#"  '바이오지노코리아
