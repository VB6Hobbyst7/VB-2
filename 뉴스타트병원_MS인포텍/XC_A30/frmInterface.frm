...
Begin VB.Form frmInterface 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin FPSpread.vaSpread vasRes 
         ...
         RetainSelBlock  =   0   'False
         ScrollBars      =   2
         SpreadDesigner  =   "frmInterface.frx":2321
      End
   End
   ...
   Begin VB.Frame FrmHideControl 
      ...
      Begin VB.Frame Frame4 
         ...
         Begin FPSpread.vaSpread vasPrint 
            ...
            EndProperty
            MaxCols         =   9
            SpreadDesigner  =   "frmInterface.frx":3A0E
         End
         Begin FPSpread.vaSpread vasPrintBuf 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            SpreadDesigner  =   "frmInterface.frx":5487
         End
      End
      ...
      Begin FPSpread.vaSpread vasCode 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":569F
      End
      Begin FPSpread.vaSpread vasTemp1 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":58B7
      End
         ...
         Begin MSComctlLib.ImageList imlStatus 
            ...
            BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
               ...
               BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":6059
                  Key             =   "RUN"
               EndProperty
               BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":65F3
                  Key             =   "NOT"
               EndProperty
               BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":6B8D
                  Key             =   "STOP"
               EndProperty
               BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":7127
                  Key             =   "LST"
               EndProperty
      ...
      Begin FPSpread.vaSpread vasList 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":7DC7
      End
      Begin FPSpread.vaSpread vasResTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":7FDF
      End
      Begin FPSpread.vaSpread vasTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":81F7
      End
...
Private Sub EditRcvDataASTM()
    ...
    Dim strHoleNo    As String
        ...
        If Len(strRcvBuf) > 20 Then
            ...
            strRackNo = Trim(mGetP(strRcvBuf, 1, " "))  'Hole No
            strSeqNo = Trim(mGetP(strRcvBuf, 2, " "))   'Sequence No
            strBarNo = Trim(mGetP(strRcvBuf, 3, " "))   'Serial No
            strResult = Trim(mGetP(strRcvBuf, 4, " "))  'Result
            
                      '11  17 000000000000000000 24.7  0.0
            'Buffer = "06 001 000000000000000001 37" & vbCr & vbLf ' //Hole No. Sequence No. Serial No. Result"
                      '1  2                     1.7  0.0
                      '10  2                     1.7  0.0
...
'4  8                     8.0  0.0
            ...
            strHoleNo = Trim(Mid(strRcvBuf, 1, 3))  'Hole No
            strSeqNo = Trim(Mid(strRcvBuf, 4, 3))   'Sequence No
            'strSeqNo = Trim(Mid(strRcvBuf, 7, 22))   'Serial No
            'strResult = Trim(Mid(strRcvBuf, 7, 22))  'Result
            strResult = Trim(Mid(strRcvBuf, 26, 5))  'Result
            strIntBase = "1"
            ...
            For i = 1 To vasID.DataRowCnt
                ...
                'vasID.Col = colCheckBox
                vasID.Col = colDISKNO
                If Trim(vasID.Text) = strHoleNo Then
                    vasID.Col = colState
                    If vasID.Text = "" Then
