...
'                    SQL = SQL & "     , DATINSDTE = '" & strDate & "'       " & vbCrLf  '결과입력일자   YYYY-MM-DD
'                    SQL = SQL & "     , DATINSTIM = '" & strTime & "'       " & vbCrLf  '결과입력시간   hh:mm:ss
'                    SQL = SQL & "     , DATINSUID = '" & gHOSP.USERID & "'  " & vbCrLf  '결과입력ID
'                    SQL = SQL & "     , DATINSCOM = '" & gHOSP.MACHNM & "'  " & vbCrLf  '결과입력컴퓨터명
...
Public Sub GetResultList(ByVal pFrom As String, ByVal pTo As String, ByVal SPD As Object)
    ...
    SQL = ""
    SQL = SQL & "SELECT DISTINCT SAVESEQ,EXAMDATE,EXAMTIME,HOSPDATE,BARCODE,CHARTNO,PNAME,SENDFLAG,SENDDATE " & vbCr
    '-- 검사결과
