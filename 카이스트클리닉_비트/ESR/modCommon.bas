...
Dim i       As Integer
    ...
    For iRow = 0 To argSpread.DataRowCnt
        For iCol = 1 To argSpread.DataColCnt
            If iCol = colEXAMDATE Or _
                iCol = colEXAMTIME Or _
                iCol = colSAVESEQ Or _
                iCol = colHOSPDATE Or _
                iCol = colCHARTNO Or _
                iCol = colEXAMDATE Or _
                iCol = colPNAME Or _
                iCol = colBARCODE Or iCol > colSTATE Then
                
                i = i + 1
                argSpread.Row = iRow
                argSpread.Col = iCol
                'xlSheet.Cells(iRow + 1, iCol) = argSpread.Text
                If iCol = colBARCODE Or iCol = colCHARTNO Then
