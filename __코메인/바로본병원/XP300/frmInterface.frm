...
Begin VB.Form frmInterface 
   Caption         =   " Sysmex XP-300 Interface "
   ClientHeight    =   10680
   ClientLeft      =   345
   ClientTop       =   840
   ClientWidth     =   25560
   ...
   Begin TabDlg.SSTab stInterface 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin FPSpread.vaSpread vasID 
            ...
            RetainSelBlock  =   0   'False
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":890F
            UserResize      =   2
         End
         Begin FPSpread.vaSpread vasRes 
            ...
            RetainSelBlock  =   0   'False
            ScrollBars      =   2
            SpreadDesigner  =   "frmInterface.frx":9347
         End
...
'1. 대상환자조회
'AP_INF_Bar_Order    @InstNo varchar(3),     '장비코드(XP300 = '011')
'            @From  varchar(10),     '시작일자(예:'2013-01-02')
'            @To  varchar(10)    '끝일자(예:'2013-01-03')
'
'조회내용
'BCID , HCode, Serial, PtName, Orderdate, ErYN
'검체번호, 병록번호, 원무일련번호, 환자명, 처방일자, 응급여부(0:일반,1:응급)
...
'    vasID.MaxRows = 10
'    vasID.SetText colCheckBox, 1, "1"         '바코드

    Set AdoRs_SQL = New ADODB.Recordset
    AdoRs_SQL.CursorLocation = adUseClient
    AdoRs_SQL.Open cn_Ser.Execute("Exec AP_INF_Bar_Order '" & gEquip & "','" & dtpBegin.Value & "','" & dtpEnd.Value & "'", sqlRet)
    ...
    Else
        With vasID
            ...
            Do Until AdoRs_SQL.EOF
                intRow = intRow + 1
                .MaxRows = intRow
                .SetText colCheckBox, intRow, "1"         '바코드
                .SetText colBarcode, intRow, AdoRs_SQL("BCID") & ""         '바코드
                .SetText colPID, intRow, AdoRs_SQL("HCode") & ""         '환자번호
                .SetText colPName, intRow, AdoRs_SQL("PtName") & ""    '환자명
...
'                            // New Version
'                            strTemp = base.Com_GetP(strRcvData, 3, "|");
'
'                            strReqStatus = base.Com_GetP(strRcvData, 13, "|");
'                            // 바코드번호 추출
'
'                            REQ_NO = base.Com_GetP(strTemp, 3, "^").Trim();
            ...
            Case "O"    '## Order
                ...
                For intRow = 1 To vasID.MaxRows
                    If GetText(vasID, intRow, colCheckBox) = "1" Then
                        strBarno = GetText(vasID, intRow, colBarcode)
                        gRow = intRow
                        Exit For
                    End If
                Next
...
Private Sub GetOrder(ByVal pBarNo As String)
    ...
    strItems = GetGetEQPMASTERCode_Cobas6000(gEquip, pBarNo, intRow)
