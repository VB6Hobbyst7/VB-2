...
Object = "{B25498A2-5592-11D3-8644-DA5FB01D9D37}#1.3#0"; "ExRainButton6.ocx"
Begin VB.Form frmTestEqp 
   ...
   Begin Threed.SSPanel sspOpt 
      ...
      Begin VB.TextBox txtTstnmEqp 
         ...
         Width           =   2040
      End
      Begin ExRainButton.RainButton cmdEqpItm_Add 
         Height          =   705
         Left            =   13320
         TabIndex        =   5
         Top             =   150
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "frmTestEqp.frx":310D
         Appearance      =   1
         Caption         =   "추가"
         PicturePlacement=   2
         MouseTrack      =   -1  'True
      End
      Begin ExRainButton.RainButton cmdEqpItm_Del 
         Height          =   705
         Left            =   14220
         TabIndex        =   6
         Top             =   150
   ...
   Begin HSCotrol.UserPanel pnlTestitem 
      ...
      Begin FPSpread.vaSpread spFind2 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmTestEqp.frx":3801
      End
   End
   Begin MSComctlLib.ImageList imlList 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTestEqp.frx":3A06
            Key             =   "TST_E"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTestEqp.frx":3FA0
            Key             =   "TST_M"
         EndProperty
      EndProperty
   End
   ...
   Begin FPSpread.vaSpread spFind1 
      ...
      ShadowText      =   0
      SpreadDesigner  =   "frmTestEqp.frx":57BC
   End
End
...
Private Sub LAB_Machine_Coda_Update(ByVal tmpCoda As String, ByVal tmpSubCoda As String, ByVal Temp_Testcd As String)
    ...
    Dim strSql   As String
        ...
        Else
            ...
            strSql = "Update " & IIf(gLisVer = "EMRLIS2", "neolis..Lab_Machine_Coda ", "neoemr..Lab_Machine_Coda ") & _
                     " SET Sys_Code = ''," & _
                     "     Coda = '" & Trim(tmpCoda) & "'," & _
        ...
        With spFind3
            Coda_chk = False
             ...
             If Coda_chk = False Then
                 strSql = "Insert " & IIf(gLisVer = "EMRLIS2", "neolis..Lab_Machine_Coda", "neoemr..Lab_Machine_Coda") & "(MachineCode, Coda, SubCoda, Sys_Code)" & _
...
Private Sub LAB_Machine_Coda_DELETE(ByVal tmpCoda As String, ByVal tmpSubCoda As String)
    ...
    Dim strSql   As String
        ...
        strSql = "DELETE FROM " & IIf(gLisVer = "EMRLIS2", "neolis..Lab_Machine_Coda", "neoemr..Lab_Machine_Coda") & _
                 " WHERE MachineCode = '" & INS_CODE & "'" & _
...
Private Sub cmdSearch_Click()
    ...
    If IsNull(vntRs) = False Then
        ...
        With pnlTestitem
            Call .Move(cmdSearch.left + 1300, cmdSearch.Top + 1300)
            .Visible = True
            .ZOrder
        End With
...
Private Sub f_subSet_Eqpitem(ByVal strEqp_Cd As String)
    ...
    On Error GoTo ErrorTrap
        ...
        With spFind3
            ...
            sqlDoc = "SELECT LMCID, Coda, SubCoda "
            sqlDoc = sqlDoc & " FROM " & IIf(gLisVer = "EMRLIS2", "neolis..Lab_Machine_Coda", "neoemr..Lab_Machine_Coda")
            sqlDoc = sqlDoc & " WHERE MachineCode = '" & strEqp_Cd & "'" & " Order by Coda"
