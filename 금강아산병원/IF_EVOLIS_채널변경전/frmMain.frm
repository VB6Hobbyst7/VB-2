...
'                    End If
                    ...
                    If strBarno = "S4" Then
                        ...
                        dblX = GetText(spdCal, 1, 10)
                        dblY = GetText(spdCal, 1, 11)
                        ...
                        For j = intFromRow To intToRow
                            ...
                            If IsNumeric(GetText(spdOrder, j, colSTATE + 6)) Then
                                dblLog10 = GetText(spdOrder, j, colSTATE + 5)
                                dblNil = dblLog10
                                dblLog10 = Log(dblLog10) / Log(10)
                                dblLog10 = 10 ^ (dblX * dblLog10 + dblY)
                                dblLog10 = Round(dblLog10, 2)
                                Call SetText(spdOrder, dblLog10, j, colSTATE + 8)
                            Else
