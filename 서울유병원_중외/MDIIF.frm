   ...
   Begin VB.PictureBox picHeader 
      ...
      Begin HSCotrol.CButton cmdClear 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "MDIIF.frx":5EF3
         MaskColor       =   0
         PicCapAlign     =   2
         BorderStyle     =   1
         BorderColor     =   4210752
         HoverColor      =   16711680
         HoverPicture    =   "MDIIF.frx":6BCD
      End
      Begin HSCotrol.CButton cmdSave 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "MDIIF.frx":7C54
         MaskColor       =   0
         PicCapAlign     =   2
         BorderStyle     =   1
         BorderColor     =   4210752
         HoverColor      =   16711680
         HoverPicture    =   "MDIIF.frx":852E
      End
      Begin HSCotrol.CButton cmdView 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "MDIIF.frx":8E08
         MaskColor       =   0
         PicCapAlign     =   2
         BorderStyle     =   1
         BorderColor     =   4210752
         HoverColor      =   16711680
         HoverPicture    =   "MDIIF.frx":9A8F
      End
      Begin HSCotrol.CButton cmdJobFailView 
         Height          =   495
         Left            =   19590
         TabIndex        =   32
         ToolTipText     =   "선택한 검체결과를 OCS/EMR로 저장합니다."
...
Private Sub cmdJobFailView_Click()

    If frmInterface.spdJobFail.Visible = True Then
        frmInterface.spdJobFail.Visible = False
    Else
        frmInterface.spdJobFail.LEFT = frmInterface.spdResult.LEFT
        frmInterface.spdJobFail.TOP = frmInterface.spdResult.TOP
        frmInterface.spdJobFail.HEIGHT = frmInterface.spdResult.HEIGHT
        
        frmInterface.spdJobFail.Visible = True
    End If
...
Private Sub lblDBStatus_DblClick()

    If frmInterface.spdPatOrder.Visible = True Then
        frmInterface.spdPatOrder.Visible = False
    Else
        frmInterface.spdPatOrder.Visible = True
    End If
