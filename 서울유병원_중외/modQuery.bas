        ...
        Select Case gEMR
            ...
            Case Else
                ...
                If DBExec(AdoCn_Local, SQL) Then
                    ...
                    '왜인지는 모르나 CM-MB 일때 처방코드를 못 물고옴
                    If Trim(GetText(.spdResult, asRow2, colRCHANNEL)) = "CK-MB" Then
                        SQL = SQL & ",'D4040'"
                    ElseIf Trim(GetText(.spdResult, asRow2, colRCHANNEL)) = "NTproBNP" Then
                        SQL = SQL & ",'D4062010S'"
                    ElseIf Trim(GetText(.spdResult, asRow2, colRCHANNEL)) = "cTnI" Then
                        SQL = SQL & ",'D4023'"
                    ElseIf Trim(GetText(.spdResult, asRow2, colRCHANNEL)) = "P-SEP" Then
                        SQL = SQL & ",'D0150'"
                    Else
