...
Begin VB.Form frmInterface 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin FPSpread.vaSpread vasRes 
         ...
         RetainSelBlock  =   0   'False
         ScrollBars      =   2
         SpreadDesigner  =   "frmInterface.frx":219F
      End
   End
   ...
   Begin VB.Frame FrmHideControl 
      ...
      Begin FPSpread.vaSpread vasExcel 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":3935
      End
      ...
      Begin VB.Frame Frame4 
         ...
         Begin FPSpread.vaSpread vasPrint 
            ...
            EndProperty
            MaxCols         =   9
            SpreadDesigner  =   "frmInterface.frx":3BCB
         End
         Begin FPSpread.vaSpread vasPrintBuf 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            SpreadDesigner  =   "frmInterface.frx":56C2
         End
      End
      ...
      Begin FPSpread.vaSpread vasCode 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":5958
      End
      Begin FPSpread.vaSpread vasTemp1 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":5BEE
      End
         ...
         Begin MSComctlLib.ImageList imlStatus 
            ...
            BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
               ...
               BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":640E
                  Key             =   "RUN"
               EndProperty
               BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":69A8
                  Key             =   "NOT"
               EndProperty
               BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":6F42
                  Key             =   "STOP"
               EndProperty
               BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":74DC
                  Key             =   "LST"
               EndProperty
               BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":7D6E
                  Key             =   "ITM"
               EndProperty
               BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":7EC8
                  Key             =   "ERR"
               EndProperty
               BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":8022
                  Key             =   "NOF"
               EndProperty
            EndProperty
         End
      ...
      Begin FPSpread.vaSpread vasList 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":817C
      End
      Begin FPSpread.vaSpread vasResTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":8412
      End
      Begin FPSpread.vaSpread vasTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":86A8
      End
...
'''
'''                    strFNm = Han2Eng.HanToEng(Mid(varTmp, 1, 1))
'''                    strLNm = Han2Eng.HanToEng(Mid(varTmp, 2))
'''
...
'    AllergyFile.ShowOpen
    ...
    AllergyFile.Filename = gAssayNM.ResultPath & "\export.csv"
...
Private Sub cmdRsltSearch_Click()
    ...
    StatusBar1.Panels(3).Text = ""
          ...
          SQL = " SELECT '', SAVESEQ, MID(EXAMDATE,1,8) AS EXAMDATE, HOSPDATE AS 접수일자, BARCODE AS 바코드번호, CHARTNO AS 차트번호, PID AS 내원번호, PNAME AS 이름,PSEX AS 성별, PAGE AS 나이, DISKNO, POSNO, EXAMCODE, RESULT, REFFLAG, SENDFLAG, HOSPITAL,INOUT " & vbCrLf
        ...
        Do Until RS.EOF
            With vasID
                ...
                If blnSame = False Then
                    ...
                    SetText vasID, Trim(RS.Fields("INOUT")) & "", .MaxRows, colIO
...
'    sUrl = NUAPI.APIURL & NUAPI.APIOrdPath
'
...
'            End If
'
'            strAssayNm = Trim(mGetP(varPetData(4), 2, ":"))
...
'On Error GoTo ErrorTrap
  ...
  '  http://his012edu.cmcnu.or.kr/himed/webapps/com/commonweb/xrw/.live?submit_id=TRLII00103&business_id=lis&ex_interface=12345678|012&
...
'INSTCD
    ...
    '바코드
        ...
        sParam = sParam & "instcd=" & NUAPI.HOSPCD & "&"                          '기관코드
        sParam = sParam & "eqmtcd=" & NUAPI.INSTCD & "&"                          '장비코드
        sParam = sParam & "bcno=O55RT09S0"                                                        '바코드
...
'http://his012.cmcnu.or.kr/himed/webapps/com/commonweb/xrw/.live?submit_id=TRLII00119&business_id=lis&ex_interface=12345678|012&
'http://his012.cmcnu.or.kr/himed/webapps/com/commonweb/xrw/.live?submit_id=TRLII00119&business_id=lis&ex_interface=21302115|015&instcd=015&eqmtcd=I11&bcno=O55RT09S0
...
Private Sub EditRcvDataASTM()
    ...
    Dim Cube_ACK As String
    Dim varBarCd As Variant
    Dim strSend  As String
    
        
'     func:= Copy(sData,8,2);
'      if func = '50' then begin
'          //'>000C015001120802035';
'          SendStr(Cube_ACK);
'          sleep(100);
'          SendStr(sData + CR + CubeStr( BCCCheckSum_Char (sData+CR) ));
'
'          exit;
'      End
'      Else
'      if func = '51' then begin
'          try
'              //Result
'              sHeader:= TokenStr(sData, '' ,1);
'              ResStr := Copy(sData, Pos('', sData)+1, 1000);
'              TMaster.FBarCode := Trim(Copy(sHeader, 12, 15));
'
'              //if Length(TMaster.FBarCode) < 11 then
'              //    TMaster.FBarCode:= TMaster.FBarCode;
'
'              TMaster.FInstTime:= '20'+Copy(ResStr,5,2)+Copy(ResStr,3,2)+Copy(ResStr,1,2)+Copy(ResStr,7,2)+Copy(ResStr,9,2)+'00';
'              TMaster.FRcvTime := Str2ViewDTM(TMaster.FInstTime);
'              TMaster.FRack  := ''; //Trim(Copy(ResStr,39,4));
'              TMaster.FPos   := Trim(Copy(ResStr,21,2));
'              TMaster.FUpCode:= 'ESR';
'              TMaster.FIfCode:= 'ESR';
'              TMaster.FAbbr:= TCode.GetAbbr_Up(TMaster.FUpCode);
'              TMaster.FResFlag:= Copy(ResStr, 15, 2);
'
'              if Trim(TMaster.FBarCode) = '' then
'                  TMaster.FBarCode:= TMaster.FPos
'              Else
'                  DM.DownLoadOrder_KN_YUHS(TMaster);
'
'              if IsEndData(TMaster) = True then exit;
'
'              TMaster.FFlag:= 'N';
'
'              if TMaster.FResFlag = '01' then begin
'                  TMaster.FFlag:= 'X';
'                  TMaster.FResult:= 'High';
'              End
'              else if TMaster.FResFlag = '02' then begin
'                  TMaster.FFlag:= 'X';
'                  TMaster.FResult:= 'Low';
'              End
'              Else: begin
'                  TMaster.FResult:= Trim(Copy(ResStr,11,4));
'
'                  if TMaster.FResFlag = '08' then
'                       TMaster.FResult:= TMaster.FResult + '*';
'              end;
'
...
'      end;
    ...
    'If IsNumeric(strType) Then
        strType = Mid$(strRcvBuf, 8, 2)
    'End If
    
    'MsgBox strType
    
    'Cube_ACK = Chr(6) + "01" + Chr(13) + CubeStr(GetChkSum(Chr(6) + "01" + Chr(13)))
    Cube_ACK = ACK & "01" & Chr(13)
    
    Select Case strType
        Case "50"    '## Order
            '>000C015001120802035';
            comEqp.Output = Cube_ACK
            SetRawData "[Tx]" & Cube_ACK
            Call Sleep(100)
            comEqp.Output = strRcvBuf + vbCr + GetChkSum(strRcvBuf + vbCr)
            
            'strSend = strRcvBuf + vbCr + GetChkSum(strRcvBuf + vbCr)
            
            comEqp.Output = strRcvBuf
            SetRawData "[Tx]" & strRcvBuf
              
            strBarNo = Mid$(strRcvBuf, 12, 9)
            Call SetPatInfo(strBarNo)
            
            'strRcvBuf = Mid(strRcvBuf, 12)
            'varBarCd = Split(strRcvBuf, "")
            
            
            'For i = 0 To UBound(varBarCd) - 1
        ...
        Case "51"    '## Result
          ...
          '  MsgBox strBarNo
            ...
            If Trim(strBarNo) <> "" Then
                ...
                strResult = Trim(Mid$(strRcvBuf, InStr(strRcvBuf, "") + 11, 4))
            ...
            '    MsgBox strResult
                ...
                If strResult <> "" And Len(strBarNo) = 9 Then
                    SQL = ""
...
Private Sub VesMatic(asData As String)
    ...
    varData = Split(strData, vbCr)
    
    For i = 0 To UBound(varData)
        SetRawData "[RCV]" & i & ":" & varData(i)
        '  1 = O403F04S0....  22
        strHeader = Trim(mGetP(varData(i), 1, "="))
        strBuffer = varData(i)
    '    SetRawData "[strHeader]" & strHeader
        
        'If strHeader <> "" And IsNumeric(strHeader) Then
            Call EditRcvDataVesCube_OLD
        'Else
        '    Exit Sub
        'End If
    Next
...
'   기능 : 장비로부 수신한 데이터 편집
'-----------------------------------------------------------------------------'
Private Sub EditRcvDataVesCube_OLD()
    Dim strRcvBuf    As String   '수신한 Data
    Dim strType      As String   '수신한 Record Type
    Dim strBarNo     As String   '수신한 바코드번호
    Dim strSeq       As String   '수신한 Sequence
...
' SetRawData "[Rcv3]" & strBuffer
    
     ' 1 = O403F04S0....  22
      
    strBuffer = mGetP(strBuffer, 2, "=")
    strBarNo = Trim(mGetP(strBuffer, 1, "...."))
'    SetRawData "[strBarNo]" & strBarNo

'    If Trim(strBarNo) <> "" And Len(strBarNo) = 9 Then
    If Trim(strBarNo) <> "" Then
        
        strIntBase = "ESR"
        strResult = Trim(Right(strBuffer, 5))
     '   strResult = Trim(mGetP(strBuffer, 2, "...."))
' SetRawData "[strResult]" & strResult
...
Private Sub EditRcvDataINPROVE_CSV()
    ...
    For i = 2 To UBound(strRecvData)
        ...
        For intCnt = 0 To UBound(varTmp) - 1
            If intCnt = 1 Then
                strGubun = varTmp(intCnt)
                If InStr(UCase(strGubun), "INHALANT") > 0 Then
                    strAssayNm = "IN"
                ElseIf InStr(UCase(strGubun), "FOOD") > 0 Then
                    strAssayNm = "FD"
                Else
                    strAssayNm = ""
                End If
            ...
            If intCnt = 8 Then
                ...
                For j = 1 To vasID.DataRowCnt
                    'If Trim(GetText(vasID, j, colBARCODE)) = strBarNo Then
                    If Trim(GetText(vasID, j, colBARCODE)) = strBarNo And Trim(GetText(vasID, j, colASSAYNM)) = strAssayNm Then
                    'If Trim(GetText(vasID, j, colBARCODE)) = strBarNo And InStr(UCase(Trim(GetText(vasID, j, colASSAYNM))), strAssayNm) > 0 Then
                        If Trim(GetText(vasID, j, colSTATE)) = "" Then
                            blnSame = False
                        Else
                            blnSame = True
                ...
                'If blnSame = False And strAssay = "" Then
                If blnSame = False Then
                    Call SetPatInfo(strBarNo)
                    strAssay = Trim(GetText(vasID, gRow, colASSAYNM))
                    'Call SetText(vasID, mResult.RsltDate, intRow, colEXAMDATE)
                    'Call SetText(vasID, mResult.RsltSeq, intRow, colSAVESEQ)
                    If strAssay = "" Then
                        If InStr(UCase(varTmp(1)), "INHALANT") > 0 Then
                            Call SetText(vasID, "IN", gRow, colASSAYNM)
                        ElseIf InStr(UCase(varTmp(1)), "FOOD") > 0 Then
                            Call SetText(vasID, "FD", gRow, colASSAYNM)
                        Else
                            strAssayNm = ""
                        End If
                    End If
                ...
                Select Case UCase(strAssay)
                    Case "FOOD":        strAssayNm = "FD"
                    Case "INHALANT":    strAssayNm = "IN"
                    Case Else:
                        If InStr(UCase(varTmp(1)), "INHALANT") > 0 Then
                            strAssayNm = "IN"
                        ElseIf InStr(UCase(varTmp(1)), "FOOD") > 0 Then
                        ...
                        Else
                            strAssayNm = ""
                        End If
                        'Call SetText(vasID, strAssayNm, gRow, colASSAYNM)
                End Select
...
'                End If
                ...
                If blnSame = False Then
                    ...
                    Call SetText(vasID, mResult.RsltDate, gRow, colEXAMDATE)
                    Call SetText(vasID, mResult.RsltSeq, gRow, colSAVESEQ)
...
'                End If
                ...
                If UCase(strIntBase) = "CTRL" Then
                    If strAssayNm = "IN" Then
                        strIntBase = "Inhalant"
                        strResult = "IU/ML"
                        strClass = "CLASS"
                    ElseIf strAssayNm = "FD" Then
                        strIntBase = "Food"
                        strResult = "IU/ML"
                        strClass = "CLASS"
                    End If
                Else
                    '-- Class 추가
                    If strIntBase = "Total_IgE" Or strIntBase = "IgE" Then
                        If strIntResult = "<100" Then
                            strClass = "1.0"
                        ElseIf strIntResult = "100-200" Then
                            strClass = "2.0"
...
'    Else
        ...
        SQL = SQL & "','" & gEquip
        SQL = SQL & "','" & Trim(GetText(vasID, asRow1, colIO))
...
'POBALL™ Premium_Intensive
    ...
    Select Case GetText(vasID, Row, colASSAYNM)
        Case "POBALL™ Premium":              strAssayNm = "PREMIUM"
        Case "POBALL™ Premium_Intensive":    strAssayNm = "PREMIUM_I"
        Case "POBALL™ Food_Advanced":        strAssayNm = "FOOD_A"
        Case "POBALL™ Food_Intensive":       strAssayNm = "FOOD_I"
        Case "POBALL™ Inhalant_Advanced":    strAssayNm = "INHALANT_I"
    ...
    ElseIf KeyCode = vbKeyReturn Then
        If iCol = colBARCODE Then
            ...
            If lsID <> lblBarcode(0).Caption Then
                      SQL = "UPDATE PATRESULT SET"
                SQL = SQL & " HOSPDATE = '" & Format(Mid(Trim(GetText(vasID, iRow, colHOSPDATE)), 1, 10), "yyyy-mm-dd") & "' " & vbCrLf
...
'                SQL = SQL & ",CHARTNO = '" & Trim(GetText(vasID, iRow, colCHARTNO)) & "' " & vbCrLf
                ...
                SQL = SQL & ",HOSPITAL = '" & Trim(GetText(vasID, iRow, colASSAYNM)) & "' " & vbCrLf
                SQL = SQL & ",INOUT = '" & Trim(GetText(vasID, iRow, colIO)) & "' " & vbCrLf
