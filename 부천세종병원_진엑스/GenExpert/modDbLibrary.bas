...
'        SQL = SQL & "   AND POSNO = '" & Trim(GetText(.vasID, argSpcRow, colASSAYNM)) & "' "                    'POS 번호(진료지원ID)
    ...
    '            Case 0.35 To 0.69:      sResult = sResult1 & " / " & sResult2
    '            Case 0.7 To 3.49:       sResult = sResult1 & " / " & sResult2
    '            Case 3.5 To 17.49:      sResult = sResult1 & " / " & sResult2
    '            Case 17.5 To 49.9:      sResult = sResult1 & " / " & sResult2
    '            Case 50 To 100:         sResult = sResult1 & " / " & sResult2
    '            Case Is > 100:          sResult = sResult1 & " / " & sResult2
