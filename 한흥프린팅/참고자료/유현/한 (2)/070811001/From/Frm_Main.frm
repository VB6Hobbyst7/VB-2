...
'    Dim varTmp1, varTmp2, varTmp3
    ...
    Call Frm_New.Spr_C.IsExcelFile(LS_Filename)
    
    y = Frm_New.Spr_C.GetExcelSheetList(LS_Filename, List, ListCount, "report.txt", handle, True)
    If y = True Then
        z = Frm_New.Spr_C.ImportExcelSheet(handle, 0)
    End If
