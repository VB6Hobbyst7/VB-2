...
Begin VB.Form Frm_New 
   ...
   Begin VB.Frame Fam_B 
      ...
      Begin VB.ComboBox Cbo_HeadDarkness 
         ...
         EndProperty
         Height          =   315
         ItemData        =   "Frm_New.frx":743E
         Left            =   11895
         List            =   "Frm_New.frx":749C
         TabIndex        =   18
         Text            =   "15"
         Top             =   2940
         Width           =   1710
      ...
      Begin VB.ComboBox Cbo_PrinterSpeed 
         ...
         EndProperty
         Height          =   315
         ItemData        =   "Frm_New.frx":7519
         Left            =   11895
         List            =   "Frm_New.frx":752F
         TabIndex        =   16
         Text            =   " 3"
         Top             =   2415
         Width           =   1710
      ...
      Begin VB.ComboBox cbo_Port 
         ...
         EndProperty
         Height          =   315
         ItemData        =   "Frm_New.frx":754B
         Left            =   11895
         List            =   "Frm_New.frx":756A
         TabIndex        =   10
         Text            =   "COM1"
         Top             =   525
         Width           =   1710
      ...
      Begin VB.ComboBox Cbo_Baud 
         ...
         EndProperty
         Height          =   315
         ItemData        =   "Frm_New.frx":75A4
         Left            =   11895
         List            =   "Frm_New.frx":75B7
         TabIndex        =   9
         Text            =   "9600"
         Top             =   1245
         Width           =   1710
      ...
      Begin FPSpread.vaSpread Spr_B 
         ...
         ShadowColor     =   16761024
         SpreadDesigner  =   "Frm_New.frx":75DE
      End
...
Dim Ls_SprC_Datatmp As String
    ...
    If cnt > 0 Then
        ...
        .Output = "NASCD " & Chr(34) & "CARD1:KSC5601.NCD" & Chr(34) & vbCrLf
        ...
        LS_StrarryA = Split(Ls_SprBTempData(1), ",")  '바코드
