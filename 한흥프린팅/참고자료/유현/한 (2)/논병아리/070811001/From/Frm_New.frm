...
Begin VB.Form Frm_New 
   ...
   Begin VB.Frame Fam_B 
      ...
      Begin VB.ComboBox Cbo_HeadDarkness 
         ...
         EndProperty
         Height          =   315
         ItemData        =   "Frm_New.frx":71C6
         Left            =   11895
         List            =   "Frm_New.frx":7209
         TabIndex        =   18
         Text            =   "15"
         Top             =   2940
         Width           =   1710
      ...
      Begin VB.ComboBox Cbo_PrinterSpeed 
         ...
         EndProperty
         Height          =   315
         ItemData        =   "Frm_New.frx":7258
         Left            =   11895
         List            =   "Frm_New.frx":7271
         TabIndex        =   16
         Text            =   " 3"
         Top             =   2415
         Width           =   1710
      ...
      Begin VB.ComboBox cbo_Port 
         ...
         EndProperty
         Height          =   315
         ItemData        =   "Frm_New.frx":728B
         Left            =   11895
         List            =   "Frm_New.frx":72AA
         TabIndex        =   10
         Text            =   "COM1"
         Top             =   525
         Width           =   1710
      ...
      Begin VB.ComboBox Cbo_Baud 
         ...
         EndProperty
         Height          =   315
         ItemData        =   "Frm_New.frx":72E4
         Left            =   11895
         List            =   "Frm_New.frx":72F7
         TabIndex        =   9
         Text            =   "9600"
         Top             =   1245
         Width           =   1710
      ...
      Begin FPSpread.vaSpread Spr_B 
         ...
         ShadowColor     =   16761024
         SpreadDesigner  =   "Frm_New.frx":731E
      End
