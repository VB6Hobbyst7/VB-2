  ...
  '        End If
          ...
          Ls_MaxBarcodeData = ""
            ...
            If Val(Cbo_PrinterSpeed.Text) = 2 Then
                        ...
                        aflag = "N"
                        Do While (aflag <> "Y")
                            If ((GetTickCount() - RefTime) > Val(Trim(Ls_SprOrnData(9)) * 600)) Then aflag = "Y"
                        Loop
            ElseIf Val(Cbo_PrinterSpeed.Text) = 3 Then
            
                        aflag = "N"
                        Do While (aflag <> "Y")
                            If ((GetTickCount() - RefTime) > Val(Trim(Ls_SprOrnData(9)) * 550)) Then aflag = "Y"
                        Loop
            ...
            ElseIf Val(Cbo_PrinterSpeed.Text) = 5 Then
                        ...
                        aflag = "N"
                        Do While (aflag <> "Y")
                            If ((GetTickCount() - RefTime) > Val(Trim(Ls_SprOrnData(9)) * 400)) Then aflag = "Y"
                        Loop
