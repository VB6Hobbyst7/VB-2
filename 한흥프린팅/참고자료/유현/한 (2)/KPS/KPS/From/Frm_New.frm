...
Begin VB.Form Frm_New 
   ...
   Begin VB.Frame Fam_C 
      ...
      Begin FPSpread.vaSpread Spr_C 
         ...
         RetainSelBlock  =   0   'False
         ShadowColor     =   16761024
         SpreadDesigner  =   "Frm_New.frx":1502
      End
...
'
 ...
 If cnt > 0 Then
       ...
       Do
            ...
            '----------------------------------------------------------------------------------------------------------------------------
            Li_SprC_MaxTempB = 0
            LS_StrarryB = Split(Ls_SprBTempData(2), ",")   '글자 A(S)
            ...
            '----------------------------------------------------------------------------------------------------------------------------
            Li_SprC_MaxTempC = 0
            LS_StrarryC = Split(Ls_SprBTempData(3), ",")   '글자 B
            ...
            '  글자 B(S)
            '----------------------------------------------------------------------------------------------------------------------------
            LS_StrarryD = Split(Ls_SprBTempData(4), ",")   '글자 B(S)
...
'            '----------------------------------------------------------------------------------------------------------------------------
            Li_SprC_MaxTempE = 0
            LS_StrarryE = Split(Ls_SprBTempData(5), ",")   '글자 C
            ...
            If Ls_SprDataE(0) = "1" Then
               ' Call Label_Print(Ls_SprOrnData(6), Val(Ls_SprDataD(1)), Val(Ls_SprDataD(2)), Val(Ls_SprDataD(3)))
                Call Label_Print(Ls_SprOrnData(5), Val(Ls_SprDataE(1)), Val(Ls_SprDataE(2)), Val(Ls_SprDataE(3)))
...
'            '  글자 C(S)
'            '----------------------------------------------------------------------------------------------------------------------------
            LS_StrarryF = Split(Ls_SprBTempData(6), ",")   '글자 C(S)
            ...
            If Ls_SprDataF(0) = "1" Then
             ' Call Label_Print(Ls_SprOrnData(6), Val(Ls_SprDataD(1)), Val(Ls_SprDataD(2)), Val(Ls_SprDataD(3)))
               Call Label_Print(Ls_SprOrnData(6), Val(Ls_SprDataF(1)), Val(Ls_SprDataF(2)), Val(Ls_SprDataF(3)))
...
'            '----------------------------------------------------------------------------------------------------------------------------
            Li_SprC_MaxTempG = 0
            LS_Strarryg = Split(Ls_SprBTempData(7), ",")   '글자 D
            ...
            If Ls_SprDataG(0) = "1" Then
               ' Call Label_Print(Ls_SprOrnData(6), Val(Ls_SprDataD(1)), Val(Ls_SprDataD(2)), Val(Ls_SprDataD(3)))
                Call Label_Print(Ls_SprOrnData(7), Val(Ls_SprDataG(1)), Val(Ls_SprDataG(2)), Val(Ls_SprDataG(3)))
                Debug.Print "^FO" & Ls_SprDataE(1) & "," & Ls_SprDataE(2) & "^A0" & Ls_SprDataE(3) & "," & Ls_SprDataE(4) & "^FD" & Ls_SprDataE(4) & "^FS  글자 E "
            End If
...
'            '  글자 D(S)
'            '----------------------------------------------------------------------------------------------------------------------------
            LS_Strarryh = Split(Ls_SprBTempData(8), ",")   '글자 D(S)
            ...
            If Ls_SprDataH(0) = "1" Then
             ' Call Label_Print(Ls_SprOrnData(6), Val(Ls_SprDataD(1)), Val(Ls_SprDataD(2)), Val(Ls_SprDataD(3)))
              '  Frm_Main.Mcom.Output = "^FO" & Ls_SprDataF(1) & "," & Ls_SprDataF(2) & "^A0" & Ls_SprDataF(3) & "," & Ls_SprDataF(4) & "^FD" & Ls_SprDataF(5) & "^FS"
                Call Label_Print(Ls_SprOrnData(8), Val(Ls_SprDataH(1)), Val(Ls_SprDataH(2)), Val(Ls_SprDataH(3)))
                Debug.Print "^FO" & Ls_SprDataF(1) & "," & Ls_SprDataF(2) & "^A0" & Ls_SprDataF(3) & "," & Ls_SprDataF(4) & "^FD" & Ls_SprDataF(4) & "^FS  글자 F "
            End If
          ...
          Ls_MaxBarcodeData = ""
            ...
            If Val(Cbo_PrinterSpeed.Text) = 2 Then
                        ...
                        aflag = "N"
                        Do While (aflag <> "Y")
                            If ((GetTickCount() - RefTime) > Val(Trim(Ls_SprOrnData(9)) * 200)) Then aflag = "Y"
                        Loop
            ElseIf Val(Cbo_PrinterSpeed.Text) = 3 Then
            
                        aflag = "N"
                        Do While (aflag <> "Y")
                            If ((GetTickCount() - RefTime) > Val(Trim(Ls_SprOrnData(9)) * 350)) Then aflag = "Y"
                        Loop
            ElseIf Val(Cbo_PrinterSpeed.Text) = 4 Then
            
                        aflag = "N"
                        Do While (aflag <> "Y")
                            If ((GetTickCount() - RefTime) > Val(Trim(Ls_SprOrnData(9)) * 450)) Then aflag = "Y"
                        Loop
            ElseIf Val(Cbo_PrinterSpeed.Text) = 5 Then
            
                        aflag = "N"
                        Do While (aflag <> "Y")
                            If ((GetTickCount() - RefTime) > Val(Trim(Ls_SprOrnData(9)) * 500)) Then aflag = "Y"
                        Loop
            ElseIf Val(Cbo_PrinterSpeed.Text) = 6 Then
            
                        aflag = "N"
                        Do While (aflag <> "Y")
                            If ((GetTickCount() - RefTime) > Val(Trim(Ls_SprOrnData(9)) * 650)) Then aflag = "Y"
                        Loop
            ElseIf Val(Cbo_PrinterSpeed.Text) = 8 Then
            
                        aflag = "N"
                        Do While (aflag <> "Y")
                            If ((GetTickCount() - RefTime) > Val(Trim(Ls_SprOrnData(9)) * 300)) Then aflag = "Y"
                        Loop
            End If
