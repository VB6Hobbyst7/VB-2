...
Begin VB.MDIForm Frm_Main 
   BackColor       =   &H8000000C&
   Caption         =   "KPS발행프로그램[자율안전확인] Ver 2.0 07.04.06"
   ClientHeight    =   9750
   ClientLeft      =   165
   ClientTop       =   555
   ClientWidth     =   14115
      ...
      With Me.ActiveForm.Spr_B
           ...
           For i = 1 To .MaxRows
                  ...
                  .Text = LS_Strarry(Ls_Count)
                   ...
                   If Ls_Count = 8 Then      '자율안전확인 신고필증번호(S)
                   
'                      If LS_Strarry(Ls_Count) = "1" Then
'
'                      Me.ActiveForm.Spr_C
'
'                      End If
                   ...
                   ElseIf Ls_Count = 10 Then
                   
                   ElseIf Ls_Count = 12 Then
                   
                   ElseIf Ls_Count = 14 Then
                                      
                   ElseIf Ls_Count = 16 Then
...
Dim strsize  As String
 ...
 With Me.ActiveForm.Spr_B
      ...
      Ls_DataMain(1) = Ls_DataMain(1) & Ls_SprB_DataSave(Ll_SprB_Count)
      
      Next Ll_SprBi_Count
        
 End With
   
'  Ls_SprB_DataSave (1) & _
