...
Begin VB.Form frmIISArchitect 
   ...
   Begin FPSpread.vaSpread tblComplete 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISArchitect.frx":0477
   End
   ...
   Begin FPSpread.vaSpread tblResult 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   13697023
      SpreadDesigner  =   "frmIISArchitect.frx":0C26
      TextTip         =   2
   End
End
...
Private Sub Command1_Click()
    ...
    strDump = strDump & "4R|1|^^^639^Anti-HCV^UNDILUTED^P^48229HN00^04462^^F|0.06|S/CO||||F||FSE^FSE||20070801102234|iSR03698" & vbNewLine
    strDump = strDump & "42" & vbNewLine
    strDump = strDump & "5R|2|^^^639^Anti-HCV^UNDILUTED^P^48229HN00^04462^^I|Nonreactive|||||F||FSE^FSE||20070801102234|iSR03698" & vbNewLine
    strDump = strDump & "ED" & vbNewLine
    strDump = strDump & "6R|3|^^^639^Anti-HCV^UNDILUTED^P^48229HN00^04462^^P|1448|RLU||||F||FSE^FSE||20070801102234|iSR03698" & vbNewLine
...
'               3O|1|17000416672|17000416672^J401^1|^^^161^Anti-HCV^UNDILUTED^P|R||||||||||||||||||||F" & vbNewLine
                If strBarNo <> mGetP(strRcvBuf, 3, "|") Then
...
'                strDump = strDump & "6R|3|^^^161^Anti-HCV^UNDILUTED^P^48229HN00^04462^^P|1448|RLU||||F||FSE^FSE||20070801102234|iSR03698" & vbNewLine
                ...
                ' ^^^161^Anti-HCV^UNDILUTED^P^48229HN00^04462^^F
                strTemp = mGetP(strRcvBuf, 3, "|")
                strIntBase = mGetP(strTemp, 4, "^")
                strFlag = mGetP(strTemp, 11, "^")
                ...
                Select Case strFlag
                    ...
                    Case "I"    '## 정성
                        strIntBase = strIntBase & "C"
                        'HBsAg 628C
                        If strIntBase = "628C" Then
                            Select Case CDbl(strResult)
                                Case Is >= 3:   strResult = "양성"
                                Case Else:      strResult = "음성"
                            End Select
                            strIntResult = strResult
                        Else
                            Select Case Mid$(strIntResult, 1, 1)
                                Case "N":   strResult = "음성"
                                Case "G":   strResult = "약양성"
                                Case "R":   strResult = "양성"
                                Case "P":   strResult = "양성"
                            End Select
                            strIntResult = strResult
