...
Begin VB.Form frmHospInfo 
   ...
   Begin BHButton.BHImageButton cmdCancel 
      ...
      ImgOutLineSize  =   3
   End
   Begin BHButton.BHImageButton cmdLocalDBSet 
      Height          =   375
      Left            =   2430
      TabIndex        =   31
      Top             =   4860
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmHospInfo.frx":0F2E
      BackColor       =   12640511
      AlphaColor      =   12640511
      ImgOutLineSize  =   3
   End
   Begin BHButton.BHImageButton cmdDBSet 
      Height          =   375
      Left            =   3780
      TabIndex        =   32
      Top             =   4860
