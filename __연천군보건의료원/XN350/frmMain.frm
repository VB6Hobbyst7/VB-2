...
RST:
    strErrMsg = ""
    strErrMsg = strErrMsg & "위    치 : " & gHOSP.MACHNM & "_SerialRcvData_XN350" & vbNewLine & vbNewLine
    strErrMsg = strErrMsg & "오류번호 : " & Err.Number & vbNewLine & vbNewLine
    strErrMsg = strErrMsg & "오류내용 : " & Err.Description & vbNewLine
    frmErrMsg.txtErr = vbNewLine & strErrMsg
    frmErrMsg.Show
...
'    Me.Height = 12585
    ...
    strIFStatus = ""
    strIFStatus = strIFStatus & IIf(gHOSP.SAVEAUTO = "Y", "▣ 자동결과전송", "▣ 수동결과전송")
    If gHOSP.BARUSE = "Y" Then
