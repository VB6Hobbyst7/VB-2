...
Global Const REG_IN_PATH    As String = "오더폴더"
Global Const REG_OUT_PATH   As String = "결과폴더"
...
Global gIn_Path    As String
Global gOut_Path   As String
...
On Error GoTo ConnectError
    ...
    UserName = GetString(HKEY_CURRENT_USER, REG_JETDB, REG_USER_ID)
    Password = GetString(HKEY_CURRENT_USER, REG_JETDB, REG_PASSWD)
    gIn_Path = GetString(HKEY_CURRENT_USER, REG_JETDB, REG_IN_PATH)
    gOut_Path = GetString(HKEY_CURRENT_USER, REG_JETDB, REG_OUT_PATH)
