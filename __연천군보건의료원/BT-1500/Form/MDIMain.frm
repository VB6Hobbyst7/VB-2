...
Private Const MAIN_HEGHT    As Long = 11600
...
Private Const TLBKEY_WEB_AS     As String = "WEB_AS"
...
On Error GoTo ErrorRouten
    ...
    If GetFileSize(App.Path + "\" + REG_INSNAME + ".LOG") > 1000000 Then
        Open App.Path + "\" + REG_INSNAME + ".LOG" For Output As #99
        Close #99
    End If
...
On Error GoTo ErrorRouten
    With tlbMain
        ...
        Call .Buttons.Add(, "", "", tbrSeparator)
'        Call .Buttons.Add(, TLBKEY_WEB_AS, "원격지원요청", tbrDefault, "WEB_AS")
