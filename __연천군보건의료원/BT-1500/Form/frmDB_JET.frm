...
Private Sub cmdOk_Click()
    ...
    Else
        ...
        Call SaveString(HKEY_CURRENT_USER, REG_JETDB, REG_IN_PATH, Trim(txt_In_Path))
        Call SaveString(HKEY_CURRENT_USER, REG_JETDB, REG_OUT_PATH, Trim(txt_Out_Path))
        
        gIn_Path = txt_In_Path
        gOut_Path = txt_Out_Path
...
Private Sub Form_Load()
    ...
    txt_In_Path = GetString(HKEY_CURRENT_USER, REG_JETDB, REG_IN_PATH)
    txt_Out_Path = GetString(HKEY_CURRENT_USER, REG_JETDB, REG_OUT_PATH)
