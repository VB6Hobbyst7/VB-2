...
Begin VB.Form frmMain 
   ...
   Begin VB.PictureBox Picture2 
      ...
      Begin VB.Frame fraResult 
         ...
         Begin VB.ComboBox cboRstType 
            Appearance      =   0  '평면
            Height          =   300
            ItemData        =   "frmMain.frx":9AA1
            Left            =   420
            List            =   "frmMain.frx":9AA3
            TabIndex        =   118
            Top             =   180
            Width           =   1245
         End
         Begin VB.ComboBox cboState 
            Height          =   300
            ItemData        =   "frmMain.frx":9AA5
            Left            =   4710
            List            =   "frmMain.frx":9AA7
            TabIndex        =   117
            Top             =   180
            Width           =   1395
         End
   ...
   Begin VB.Frame frame1 
      ...
      Begin VB.Frame fraDUREADER720 
         ...
         Begin VB.ComboBox cboWbcM 
            ...
            EndProperty
            Height          =   300
            ItemData        =   "frmMain.frx":CE48
            Left            =   1020
            List            =   "frmMain.frx":CE58
            TabIndex        =   183
            Text            =   "Combo3"
            Top             =   360
            Width           =   1695
      ...
      Begin FPSpread.vaSpread spdOrder 
         ...
         SpreadDesigner  =   "frmMain.frx":CE68
         UserResize      =   2
      End
      Begin FPSpread.vaSpread spdResult 
         ...
         SpreadDesigner  =   "frmMain.frx":113BA
         TextTip         =   2
      End
   End
   Begin VB.Frame frame3 
      ...
      Begin VB.Frame frameTestSet 
         ...
         Begin VB.Frame frameOrder 
            ...
            Begin FPSpread.vaSpread spdOrdMst 
               ...
               SelectBlockOptions=   0
               ShadowColor     =   13697023
               SpreadDesigner  =   "frmMain.frx":11C0C
               TextTip         =   2
            End
         End
         Begin VB.ComboBox cboResultType 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmMain.frx":11F4B
            Left            =   1650
            List            =   "frmMain.frx":11F4D
            TabIndex        =   32
            Top             =   5220
            Visible         =   0   'False
            Width           =   1575
      ...
      Begin FPSpread.vaSpread spdTest 
         ...
         RetainSelBlock  =   0   'False
         SelectBlockOptions=   0
         SpreadDesigner  =   "frmMain.frx":14E47
      End
   End
   Begin VB.Frame frame4 
      ...
      Begin VB.Frame frameCom 
         ...
         Begin VB.ComboBox cboPort 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmMain.frx":1692C
            Left            =   2190
            List            =   "frmMain.frx":1692E
            TabIndex        =   52
            Top             =   390
            Width           =   2205
         End
         Begin VB.ComboBox cboBaudrate 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmMain.frx":16930
            Left            =   2190
            List            =   "frmMain.frx":16932
            TabIndex        =   51
            Top             =   780
            Width           =   2205
         End
         Begin VB.ComboBox cboDatabit 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmMain.frx":16934
            Left            =   2190
            List            =   "frmMain.frx":16936
            TabIndex        =   50
            Top             =   1170
            Width           =   2205
         End
         ...
         Begin VB.ComboBox cboParity 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmMain.frx":16938
            Left            =   2190
            List            =   "frmMain.frx":1693A
            TabIndex        =   47
            Top             =   2520
            Width           =   2205
         End
   ...
   Begin VB.Frame frame2 
      ...
      Begin FPSpread.vaSpread spdRResult 
         ...
         SelectBlockOptions=   0
         ShadowColor     =   13697023
         SpreadDesigner  =   "frmMain.frx":180B8
         TextTip         =   2
      End
      Begin FPSpread.vaSpread spdROrder 
         ...
         SelectBlockOptions=   0
         ShadowColor     =   14548991
         SpreadDesigner  =   "frmMain.frx":18884
         UserResize      =   2
      End
...
Private Function GetEquipExamCode_AU680(argEquipCode As String, argPID As String, Optional intRow As Long) As String
    ...
    If Not AdoRs_Local.EOF = True And Not AdoRs_Local.BOF = True Then
        Do Until AdoRs_Local.EOF
            ...
            '## GLOB (032)항목은 계산항목이라 오더를 보내면 안됨
            '## I.Bil(033)항목은 계산항목이라 오더를 보내면 안됨
            If strIntBase <> "027" And strIntBase <> "026" And strIntBase <> "025" And strIntBase <> "032" And strIntBase <> "033" Then

                '## HbA1C(23)항목은 Hgb(20)와 A1C(21) 오더를 보내야 함
                If strIntBase = "023" Then
                    strItems = strItems & "020" & "0"
                    strItems = strItems & "021" & "0"
                Else
    ...
    GetEquipExamCode_AU680 = strItems
    
End Function

'검체번호에 존재하는 장비번호 해당하는 수가코드 가져오기
'한 장비 번호에 검사코드가 1개이상 존재
Private Function GetEquipExamCode_BT1500(argEquipCode As String, argPID As String, Optional intRow As Long) As String
    Dim lngIntBase  As Long
    Dim strItems    As String           '전송할 검사항목
    Dim blnISE      As Boolean          'Na, K, Cl 검사여부
    Dim strIntBase  As String
    
    GetEquipExamCode_BT1500 = ""
    ...
    If Not AdoRs_Local.EOF = True And Not AdoRs_Local.BOF = True Then
        Do Until AdoRs_Local.EOF
            ...
            If strIntBase <> "" Then
                strItems = strItems & Left(strIntBase & Space(4), 4)
                mOrder.SendCnt = mOrder.SendCnt + 1
            End If
    ...
    GetEquipExamCode_BT1500 = strItems
    
End Function

'검체번호에 존재하는 장비번호 해당하는 수가코드 가져오기
'한 장비 번호에 검사코드가 1개이상 존재
Private Function GetEquipExamCode_XN350(argEquipCode As String, argPID As String, Optional intRow As Long) As String
    Dim strExamCode     As String
    Dim lngIntBase  As Long
    Dim strItems    As String           '전송할 검사항목
    Dim blnISE      As Boolean          'Na, K, Cl 검사여부
    ...
    If Trim(argEquipCode) = "" Or gPatOrdCd = "" Then
        strExamCode = ""
        strExamCode = strExamCode & "^^^^WBC\^^^^RBC\^^^^HGB\^^^^HCT\^^^^MCV\^^^^MCH\^^^^MCHC\^^^^PLT\^^^^RDW-SD\^^^^RDW-CV\^^^^PDW\^^^^MPV\^^^^P-LCR\^^^^PCT\^^^^NRBC#\^^^^NRBC%\"
    ...
    If Not AdoRs_Local.EOF = True And Not AdoRs_Local.BOF = True Then
        Do Until AdoRs_Local.EOF
            strSendCH = AdoRs_Local.Fields("SENDCHANNEL").Value
...
Private Sub GetOrder_AU680(ByVal pBarno As String, ByVal pType As String)
    ...
    With frmMain
        ...
        If mOrder.SendCnt = 0 Then
            ...
            GetOrder = STX & "S " & mOrder.RackNo & mOrder.TubePos & mOrder.Seq & Space(26 - Len(mOrder.OrgBarNo)) & mOrder.OrgBarNo & Space(4) & "E" & ETX
        ...
        Else
            ...
            GetOrder = STX & "S " & mOrder.RackNo & mOrder.TubePos & mOrder.Seq & Space(26 - Len(mOrder.OrgBarNo)) & mOrder.OrgBarNo & Space(4) & "E" & mOrder.Order & ETX
        ...
        comEqp.Output = GetOrder
        SetRawData "[Tx]" & Format(Now, "hh:mm:ss") & GetOrder
...
'    End If
    ...
    With frmMain
                ...
                Case "3"
                    For i = 1 To .spdOrder.DataRowCnt
                        If GetText(frmMain.spdOrder, i, colCHECKBOX) = "1" Then
                            pBarno = Trim(GetText(frmMain.spdOrder, i, colBARCODE))
                            mOrder.BarNo = pBarno
                            mOrder.Seq = Trim(GetText(frmMain.spdOrder, i, colSEQNO))
                            intRow = i
                            blnOrder = True
                            Exit For
                        End If
        ...
        '-- 스프레드에서 못찾았음..
        If intRow < 0 Then
            If UCase(gHOSP.MACHNM) = "BT1500" Then
        ...
        If mOrder.SendCnt = 0 Then
            ...
            'sSender:= PadLeftStr(TMaster.FExamPos,'0', 15)+'TSN'+TMaster.FExamPos+PadLeftStr(IntToStr(OrdCnt),'0',2)+sOrder;
            'slSender.Add(sSender + Bt1500CheckSum(sSender) + EOT);
              
            GetOrder = Left(mOrder.BarNo & Space(15), 15) & "T" & "S" & "N" & Format(mOrder.Seq, "00") & Format(CStr(mOrder.SendCnt), "00") & mOrder.Order
            
            'GetOrder = Left(mOrder.BarNo & Space(15), 15) & "T" & "S" & "N" & Format(mOrder.Seq, "00") & "01" & "GOT "
...
Private Sub SerialRcvData_AU680()
    ...
    With frmMain
        For intCnt = 1 To UBound(strRecvData)
            ...
            Select Case strType
                Case "R "
                    strOrgBarno = Trim(Mid(strRcvBuf, 14, 26))
                ...
                Case "D "
                    ...
                    strRackNo = Trim(Mid(strRcvBuf, 3, 4))
                    strTubePos = Trim(Mid(strRcvBuf, 7, 2))
                    strOrgBarno = Trim(Mid(strRcvBuf, 14, 26))
                    strBarno = Mid(strOrgBarno, 1, 11)
                    ...
                    For i = 45 To Len(strRcvBuf) - 1 Step 11
                        strIntBase = Trim(Mid(strRcvBuf, i, 3))
                        strResult = Trim(Mid(strRcvBuf, i + 3, 6))
...
ErrHandle:
    strErrMsg = ""
    strErrMsg = strErrMsg & "위    치 : " & gHOSP.MACHNM & "SerialRcvData_INDIKO" & vbNewLine & vbNewLine
...
On Error GoTo ErrHandle
    ...
    '              3TS008 GLU80.0020 CHO217.270 HDL69.1660 T-G88.2140 CRE0.97300 GOT30.8730 GPT36.8630 GGT18.1420055
    '             17TS008 GLU86.6470 CHO211.614 HDL89.2610 T-G71.6090 CRE0.82600 GOT15.7450 GPT12.9110 GGT23.1510073
    '000000000000001RS003GLY 000.000BUN 0010.10CHO 00100.0245EOT
    ...
    With frmMain
        'For intCnt = 1 To UBound(strRData)
            ...
            '
            '   19000027331TSNK001                    005 GOT23.6370 GPT10.4990 GLU134.630 BUN20.0020 CRE1.01600123

            If Len(strRcvBuf) < 21 Then
                Exit Sub
            End If
            
            strBarno = Mid(strRcvBuf, 1, 15)
            strBarno = Trim(strBarno)
            
'MsgBox Mid(strRcvBuf, 1, 15)
            
            strCnt = Mid(strRcvBuf, 43, 3)

'MsgBox Mid(strRcvBuf, 42, 3)
...
'MsgBox strTemp1
            ...
            For i = 0 To strCnt - 1
                ...
                strResult = Trim(Mid(strTemp1, (i * 11) + 5, 7))
...
'6. 장비에서    Y/N 수신
'7-1. 오더가 있으면 STX 송신
'7-2. 오더가 없으면 "R" & EOT 송신

'#. NAK 수신하면 버퍼 초기화 (오더받는걸 종료하고 결과를 보내겠다는 의미)
'#. STX 수신하면 결과받기 시작하는데 NAK 수신이후(버퍼가 비어있을때)일 경우에는 ACk를 전송한다.
'#. EOT 수신하면 결과받기 종료 ACk를 전송한다.


'[오더전송]
'
'[Tx]19000027863    TSN0103GLU GOT GPT 138
'Y
Private Sub Phase_Serial_BT1500()
    ...
    '-- medimate
'''    RcvBuffer = RcvBuffer & pBuffer
'''
'''    If Left(pBuffer, 1) = STX Or Left(pBuffer, 1) = EOT Then
'''        comEqp.Output = ACK
'''        SetRawData "[Tx]" & ACK
'''        RcvBuffer = ""
'''    End If
'''
'''    lngBufLen = Len(RcvBuffer)
'''
'''    For i = 1 To lngBufLen
'''        BufChar = Mid$(RcvBuffer, i, 1)
'''
'''        Select Case BufChar
'''            Case NAK
'''                    SendCount = 0
...
'
'            Case ACK
'                'strBarno = Trim(Mid(strBarno, 1, 15))
'                If cmdReceive.Caption = "수신중.." Then
'                    comEqp.Output = "R" & EOT
'                    SetRawData "[Tx]" & "R" & EOT
'                Else
'                    Call GetOrder_BT1500(strBarno, gHOSP.RSTTYPE)
    ...
    Select Case comEqp.CommEvent
        Case comEvReceive
            ...
            Select Case UCase(gHOSP.MACHNM)
                ...
                Case "XN350"
                        Call Phase_Serial_XN350
                
                ' 타이머를 사용해야 해서 메인에서 처리함
                Case "ADVIA2120", "ADVIA2120-1", "ADVIA2120-2"
                        Call Phase_Serial_ADVIA2120
...
On Error GoTo RST
    ...
    If gComm.COMTYPE = "1" Then
        ...
        comEqp.Handshaking = 0 'comXOnXoff
        comEqp.RTSEnable = 1
        comEqp.RThreshold = 1 'Trim(mAdoRs.Fields("COM_RTH") & "")
        comEqp.SThreshold = 1 'Trim(mAdoRs.Fields("COM_STH") & "")
...
Private Sub txtBarcode_KeyDown(KeyCode As Integer, Shift As Integer)
    ...
    If Len(Trim(txtBarcode)) = 11 And Trim(txtBarcode) <> "" And KeyCode = vbKeyReturn Then
