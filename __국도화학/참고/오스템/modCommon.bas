...
Public gLastOpen  As String     '-- 최근 오픈한 경로
...
'%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Public moCommonWrapper As clsCommonWrapper
Public moCommonDialog As New clsCommDialogs
Public moMultiLngSupport As New clsMultiLngsupport
'%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
Public Sub obj_Click(obj As Object, objtype As Integer)
    ...
    With frmLabelDesign
'        For intRow = 1 To .spdList.Rows
'            If .spdList.CellValue(intRow, 29) = obj.Name Then
'                x1 = .spdList.CellValue(intRow, 4)
'                x2 = .spdList.CellValue(intRow, 6)
'                y1 = .spdList.CellValue(intRow, 5)
'                y2 = .spdList.CellValue(intRow, 7)
'                Exit For
'            End If
'        Next
        ...
        Select Case objtype
            Case 0
                ...
                .txtFontSize(0).Text = Round(obj.Font.Size / gDevide, 0)
                .chkFontBold(0).Value = IIf(obj.Font.Bold = True, "1", "0")
                .chkFontItalic(0).Value = IIf(obj.Font.Italic = True, "1", "0")
                .chkFontUnder(0).Value = IIf(obj.Font.Underline = True, "1", "0")
                .txtYpos.Text = Round(obj.Top / gDevide, 0)
                .txtXpos.Text = Round(obj.Left / gDevide, 0)
                .txtContent(0).Text = CVar(obj.Caption)
            ...
            Case 1
                ...
                .txtFontSize(1).Text = Round(obj.Font.Size / gDevide, 0)
                .chkFontBold(1).Value = IIf(obj.Font.Bold = True, "1", "0")
                .chkFontItalic(1).Value = IIf(obj.Font.Italic = True, "1", "0")
                .chkFontUnder(1).Value = IIf(obj.Font.Underline = True, "1", "0")
                .txtYpos.Text = Round(obj.Top / gDevide, 0)
                .txtXpos.Text = Round(obj.Left / gDevide, 0)
                .txtContent(1).Text = CVar(obj.Caption)
            ...
            Case 3
                .txtTitle.Text = obj.Tag
                .txtTag.Text = obj.Name
''                .txtYpos.Text = x2 'Round(obj.Top / gDevide, 0)
''                .txtXpos.Text = x1 'Round(obj.Left / gDevide, 0)
''                .txtImageWSize(1).Text = y1 'Round(obj.Width / gDevide, 0)
''                .txtImageHSize(1).Text = y2 'Round(obj.Height / gDevide, 0)
                .txtYpos.Text = Round(obj.Top / gDevide, 0)
                .txtXpos.Text = Round(obj.Left / gDevide, 0)
            ...
            Case 4
                ...
                If frmLabelDesign.chkBarRotate.Value = "0" Then
                    .txtBarWSize.Text = Round(obj.Width / gDevide, 0)
                    .txtBarHSize.Text = Round(obj.Height / gDevide, 0)
                Else
                    .txtBarHSize.Text = Round(obj.Width / gDevide, 0)
                    .txtBarWSize.Text = Round(obj.Height / gDevide, 0)
                End If
    ...
    Call frmLabelDesign.cmdSet_Click
...
Public Sub obj_MouseDown(obj As Object, Button As Integer, Shift As Integer, x As Single, y As Single)
    ...
    frmLabelDesign.txtTitle.Text = obj.Tag
    frmLabelDesign.txtTag.Text = obj.Name
...
Public Sub obj_MouseMove(obj As Object, Button As Integer, Shift As Integer, x As Single, y As Single)
    ...
    If Button = vbLeftButton Or Button = vbRightButton Then
        ...
        frmLabelDesign.txtXpos.Text = LPanPos.x / gDevide
        frmLabelDesign.txtYpos.Text = LPanPos.y / gDevide
