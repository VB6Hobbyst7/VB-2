...
Private Sub cmdAdd_Click()
    ...
    Dim strLablGbn  As String
    
    If Mid(cboLabelType.Text, 1, 1) = "R" Then
        strLablGbn = "T01"
    ElseIf Mid(cboLabelType.Text, 1, 1) = "P" Then
        strLablGbn = "T02"
    ElseIf Mid(cboLabelType.Text, 1, 1) = "I" Then
        strLablGbn = "T03"
    End If
    ...
    With spdRegLabelDetail
        ...
        Set pAdoRS = Get_TempMaster(strLablGbn, "", "", "", "Desc")
