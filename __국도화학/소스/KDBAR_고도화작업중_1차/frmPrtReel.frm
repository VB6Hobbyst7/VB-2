   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.Frame Frame3 
         ...
         Begin FPSpread.vaSpread spdRegOrderDetail 
            ...
            SpreadDesigner  =   "frmPrtReel.frx":F1FA
            ScrollBarTrack  =   3
            ShowScrollTips  =   3
         End
      ...
      Begin FPSpread.vaSpread spdPrtReel 
         ...
         ScrollBars      =   2
         ShadowColor     =   16774120
         SpreadDesigner  =   "frmPrtReel.frx":1031B
         ScrollBarTrack  =   3
         ShowScrollTips  =   3
      End
   End
      ...
      Begin MSComctlLib.ImageList imlStatus 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmPrtReel.frx":1180D
               Key             =   "RUN"
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmPrtReel.frx":11DA7
               Key             =   "NOT"
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmPrtReel.frx":12341
               Key             =   "STOP"
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmPrtReel.frx":128DB
               Key             =   "LST"
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmPrtReel.frx":1316D
               Key             =   "ITM"
            EndProperty
            BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmPrtReel.frx":132C7
               Key             =   "ERR"
            EndProperty
            BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmPrtReel.frx":13421
               Key             =   "NOF"
            EndProperty
            BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmPrtReel.frx":1357B
               Key             =   "ON"
               Object.Tag             =   "OFF"
            EndProperty
            BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmPrtReel.frx":13E55
               Key             =   ""
            EndProperty
         EndProperty
      End
...
'    strAFont = "^A0N,35,30"
    ...
    strHeader = "^XA" & vbLf    '출력시작
    strHeader = strHeader & "^SEE:UHANGUL.DAT^FS" & vbLf    '^SE (Select Encoding Table) 한글폰트 사용
    strHeader = strHeader & "^PON^FS" & vbLf                '^PO (Print Orientation) : N = normal, I = invert(180도 회전)
    strHeader = strHeader & "^CWJ,E:KFONT3.FNT^FS" & vbLf   '^CW (Font Identifier)
    strHeader = strHeader & "^CI26"                         '^CI (Change International Font/Encoding) : 26 = Multibyte Asian Encodings with ASCII Transparency a and
    strHeader = strHeader & "^PR12,12"                      '^PR 출력속도
    strHeader = strHeader & "^MD8"                          '^MD 명도
            ...
            With spdPrtReelDetail
                For intRow = 1 To .MaxRows
                    ...
                    If strType = "바코드" Then
                        ...
                        'strLotSub = Mid(strPrtFNo, 1, 2) & Format(intPrt, "00")
                        'ex) P101, 0101, 101
                        ...
                        If Mid(strBarType, 1, 1) = "1" Then
                            ...
                            strPrtData(i) = strPrtData(i) & "^BC" & "N," & strFont & ",N,N,N"
                            ...
                            i = i + 1
                        '2D 바코드
                        ElseIf Mid(strBarType, 1, 1) = "2" Then
                            '좌측 출력
                            ReDim Preserve strPrtData(i) As String
                            strPrtData(i) = strPrtData(i) & "^FO" & strXPos & "," & strYPos
                    ...
                    Else
                        ...
                        ElseIf strType = "PartsID" Then
                            ...
                            'strPrtData(i) = strPrtData(i) & "^BY" & "1,1"
                            strPrtData(i) = strPrtData(i) & "^FD" & strData
                            strPrtData(i) = strPrtData(i) & "^FS" & vbLf
                            i = i + 1
                            '우측 출력
        ...
        Do Until AdoRs.EOF
            With spdPrtReelDetail
                ...
                ElseIf AdoRs.Fields("LABEL_ITEM_NAME").Value & "" = "PartsID" Then
                    strBarData = Mid(strBarData, 1, 4) & strGu & Mid(strBarData, 5)
                    Call SetText(spdPrtReelDetail, strBarData, .MaxRows, 3)
                    strContents = strBarData
                ...
                strLeft = 0
                If AdoRs.Fields("LABEL_ITEM_NAME").Value & "" = "바코드" Then
                    If AdoRs.Fields("LABEL_ITEM_GU").Value & "" = "1D 바코드" Then
                        ...
                        imgBar1.WIDTH = 4365
                    ElseIf AdoRs.Fields("LABEL_ITEM_GU").Value & "" = "2D 바코드" Then
