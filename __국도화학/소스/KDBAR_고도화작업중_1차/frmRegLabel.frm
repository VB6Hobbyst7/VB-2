...
Begin VB.Form frmRegLabel 
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.Frame Frame3 
         ...
         Begin VB.Frame Frame5 
            ...
            Begin VB.TextBox txtBarSNoLen 
               ...
               Width           =   570
            End
            Begin VB.ComboBox cboBarSAddYN 
               Height          =   375
               ...
               Width           =   1425
            End
            Begin VB.ComboBox cboBarPAddYN 
               Height          =   375
         ...
         Begin VB.ComboBox cboPrtSide 
            Height          =   375
            ItemData        =   "frmRegLabel.frx":0010
            Left            =   2490
            List            =   "frmRegLabel.frx":0012
            Style           =   2  '드롭다운 목록
            TabIndex        =   11
            Top             =   2700
            Width           =   3735
         ...
         Begin VB.ComboBox cboLabelType 
            Height          =   375
            ItemData        =   "frmRegLabel.frx":0014
            Left            =   2490
            List            =   "frmRegLabel.frx":0016
            Style           =   2  '드롭다운 목록
            TabIndex        =   8
            Top             =   1260
            Width           =   3735
         ...
         Begin FPSpread.vaSpread spdRegLabelDetail 
            ...
            SpreadDesigner  =   "frmRegLabel.frx":0018
            ScrollBarTrack  =   3
            ShowScrollTips  =   3
         End
         Begin VB.Label lblMatInfo 
            BackStyle       =   0  '투명
            Caption         =   "연속용지일 경우에만 예를 선택하세요"
            Height          =   465
            Left            =   6300
            TabIndex        =   49
            Top             =   2760
      ...
      Begin FPSpread.vaSpread spdRegLabel 
         ...
         SpreadDesigner  =   "frmRegLabel.frx":0BF5
         ScrollBarTrack  =   3
         ShowScrollTips  =   3
      End
   End
...
Private Sub cmdClear_Click()
    ...
    cboBarPAddYN.Clear
    cboBarPAddYN.AddItem "아니오"
    cboBarPAddYN.AddItem "예"
    cboBarPAddYN.ListIndex = 0
    
    txtBarSNoPos.Text = "0"
    txtBarSNoLen.Text = "0"
    
    cboBarSAddYN.Clear
    cboBarSAddYN.AddItem "아니오"
    cboBarSAddYN.AddItem "예"
    cboBarSAddYN.ListIndex = 0
...
Private Sub SetLabel()
    ...
    gLblMaster.BARMAXLEN = txtBarMaxLen.Text
    gLblMaster.BARPNOPOS = txtBarPNoPos.Text
    gLblMaster.BARPNOLEN = txtBarPNoLen.Text
    gLblMaster.BARPADDYN = IIf(cboBarPAddYN.Text = "아니오", "N", "Y")
    
    gLblMaster.BARSNOPOS = txtBarSNoPos.Text
    gLblMaster.BARSNOLEN = txtBarSNoLen.Text
    gLblMaster.BARSADDYN = IIf(cboBarSAddYN.Text = "아니오", "N", "Y")
    ...
    Else
        Do Until AdoRs.EOF
            With spdRegLabel
                ...
                Call SetText(spdRegLabel, AdoRs.Fields("BAR_MAX_LEN").Value & "", .MaxRows, 20)
                Call SetText(spdRegLabel, AdoRs.Fields("BAR_PNO_POS").Value & "", .MaxRows, 21)
                Call SetText(spdRegLabel, AdoRs.Fields("BAR_PNO_LEN").Value & "", .MaxRows, 22)
                Call SetText(spdRegLabel, AdoRs.Fields("BAR_PADD_YN").Value & "", .MaxRows, 23)
                
                Call SetText(spdRegLabel, AdoRs.Fields("BAR_SNO_POS").Value & "", .MaxRows, 24)
                Call SetText(spdRegLabel, AdoRs.Fields("BAR_SNO_LEN").Value & "", .MaxRows, 25)
                Call SetText(spdRegLabel, AdoRs.Fields("BAR_SADD_YN").Value & "", .MaxRows, 26)
...
Private Sub CtlInitializing()
    ...
    With spdRegLabel
        ...
        Call SetText(spdRegLabel, "", 0, 20):                   .ColWidth(20) = 0
        Call SetText(spdRegLabel, "", 0, 21):                   .ColWidth(21) = 0
        Call SetText(spdRegLabel, "", 0, 22):                   .ColWidth(22) = 0
        Call SetText(spdRegLabel, "", 0, 23):                   .ColWidth(23) = 0
        Call SetText(spdRegLabel, "", 0, 24):                   .ColWidth(24) = 0
        Call SetText(spdRegLabel, "", 0, 25):                   .ColWidth(25) = 0
        Call SetText(spdRegLabel, "", 0, 26):                   .ColWidth(26) = 0
...
Private Sub spdRegLabel_Click(ByVal Col As Long, ByVal Row As Long)
    ...
    txtBarMaxLen.Text = GetText(spdRegLabel, Row, 20)
    txtBarPNoPos.Text = GetText(spdRegLabel, Row, 21)
    txtBarPNoLen.Text = GetText(spdRegLabel, Row, 22)
    If GetText(spdRegLabel, Row, 23) = "Y" Then
        cboBarPAddYN.Text = "예"
    Else
        cboBarPAddYN.Text = "아니오"
    End If
    
    txtBarSNoPos.Text = GetText(spdRegLabel, Row, 24)
    txtBarSNoLen.Text = GetText(spdRegLabel, Row, 25)
    If GetText(spdRegLabel, Row, 26) = "Y" Then
        cboBarSAddYN.Text = "예"
    Else
        cboBarSAddYN.Text = "아니오"
    End If
