...
On Error GoTo ErrorRoutine
    ...
    SQL = SQL & "     , LM.BAR_MAX_LEN              " & vbCrLf
    SQL = SQL & "     , LM.BAR_PNO_POS              " & vbCrLf
    SQL = SQL & "     , LM.BAR_PNO_LEN              " & vbCrLf
    SQL = SQL & "     , LM.BAR_PADD_YN              " & vbCrLf
    SQL = SQL & "     , LM.BAR_SNO_POS              " & vbCrLf
    SQL = SQL & "     , LM.BAR_SNO_LEN              " & vbCrLf
    SQL = SQL & "     , LM.BAR_SADD_YN              " & vbCrLf
    SQL = SQL & "     , LM.USED_YN                  "
...
On Error GoTo ErrorRoutine
    ...
    If pState = "IN" Then
        ...
        SQL = SQL & ", BAR_MAX_LEN" & vbCrLf
        SQL = SQL & ", BAR_PNO_POS" & vbCrLf
        SQL = SQL & ", BAR_PNO_LEN" & vbCrLf
        SQL = SQL & ", BAR_PADD_YN" & vbCrLf
        SQL = SQL & ", BAR_SNO_POS" & vbCrLf
        SQL = SQL & ", BAR_SNO_LEN" & vbCrLf
        SQL = SQL & ", BAR_SADD_YN" & vbCrLf
        SQL = SQL & ", USED_YN" & vbCrLf
        SQL = SQL & ", REGIST_ID" & vbCrLf
        SQL = SQL & ", REGIST_DT)  " & vbCrLf
        SQL = SQL & "  VALUES                       " & vbCrLf
        SQL = SQL & "('" & gLblMaster.LABELCD & "'" & vbCrLf
        SQL = SQL & ",'" & gLblMaster.PRODCD & "'" & vbCrLf
        SQL = SQL & ",'" & gLblMaster.COMPCD & "'" & vbCrLf
        SQL = SQL & ",'" & gLblMaster.LBLTYPE & "'" & vbCrLf
        SQL = SQL & "," & IIf(gLblMaster.LBLPRTNO = "", "0", gLblMaster.LBLPRTNO)
        SQL = SQL & ",'" & gLblMaster.LBLPRTSIDE & "'" & vbCrLf
        SQL = SQL & ",'" & gLblMaster.LBLBARSIDE1 & "'" & vbCrLf
        SQL = SQL & ",'" & gLblMaster.LBLBARSIDE2 & "'" & vbCrLf
        SQL = SQL & "," & IIf(gLblMaster.PRODMAXTOT = "", "0", gLblMaster.PRODMAXTOT)
        SQL = SQL & ",'" & gLblMaster.BARMAXLEN & "'" & vbCrLf
        SQL = SQL & ",'" & gLblMaster.BARPNOPOS & "'" & vbCrLf
        SQL = SQL & ",'" & gLblMaster.BARPNOLEN & "'" & vbCrLf
        SQL = SQL & ",'" & gLblMaster.BARPADDYN & "'" & vbCrLf
        SQL = SQL & ",'" & gLblMaster.BARSNOPOS & "'" & vbCrLf
        SQL = SQL & ",'" & gLblMaster.BARSNOLEN & "'" & vbCrLf
        SQL = SQL & ",'" & gLblMaster.BARSADDYN & "'" & vbCrLf
    ...
    ElseIf pState = "UP" Then
        ...
        SQL = SQL & ", BAR_MAX_LEN              = '" & gLblMaster.BARMAXLEN & "'" & vbCrLf
        SQL = SQL & ", BAR_PNO_POS              = '" & gLblMaster.BARPNOPOS & "'" & vbCrLf
        SQL = SQL & ", BAR_PNO_LEN              = '" & gLblMaster.BARPNOLEN & "'" & vbCrLf
        SQL = SQL & ", BAR_PADD_YN              = '" & gLblMaster.BARPADDYN & "'" & vbCrLf
        SQL = SQL & ", BAR_SNO_POS              = '" & gLblMaster.BARSNOPOS & "'" & vbCrLf
        SQL = SQL & ", BAR_SNO_LEN              = '" & gLblMaster.BARSNOLEN & "'" & vbCrLf
        SQL = SQL & ", BAR_SADD_YN              = '" & gLblMaster.BARSADDYN & "'" & vbCrLf
...
Public Function Set_Pack_Track(ByVal pState As String, ByVal pGbn As String) As Boolean
    ...
    pCallForm = "Public Function Set_Pack_Track(ByVal pState As String) As Boolean"
