...
Begin VB.Form frmPrtReprint 
   ...
   Begin VB.Frame Frame9 
      ...
      Begin VB.ComboBox cboICE 
         ...
         EndProperty
         Height          =   375
         ItemData        =   "frmPrtReprint.frx":0004
         Left            =   11970
         List            =   "frmPrtReprint.frx":0006
         Sorted          =   -1  'True
         Style           =   2  '드롭다운 목록
         TabIndex        =   48
         Top             =   180
      ...
      Begin VB.ComboBox cboPPIN 
         ...
         EndProperty
         Height          =   375
         ItemData        =   "frmPrtReprint.frx":0008
         Left            =   6660
         List            =   "frmPrtReprint.frx":000A
         Sorted          =   -1  'True
         Style           =   2  '드롭다운 목록
         TabIndex        =   46
         Top             =   180
      ...
      Begin VB.ComboBox cboPP 
         ...
         EndProperty
         Height          =   375
         ItemData        =   "frmPrtReprint.frx":000C
         Left            =   1590
         List            =   "frmPrtReprint.frx":000E
         Sorted          =   -1  'True
         Style           =   2  '드롭다운 목록
         TabIndex        =   44
         Top             =   180
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.Frame Frame8 
         ...
         Begin VB.ComboBox cboSlittingNo 
            ...
            EndProperty
            Height          =   375
            ItemData        =   "frmPrtReprint.frx":0010
            Left            =   3210
            List            =   "frmPrtReprint.frx":0012
            Style           =   2  '드롭다운 목록
            TabIndex        =   39
            Top             =   1230
            Visible         =   0   'False
         ...
         Begin MSComctlLib.ImageList imlStatus 
            ...
            BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
               ...
               BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmPrtReprint.frx":0014
                  Key             =   "RUN"
               EndProperty
               BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmPrtReprint.frx":05AE
                  Key             =   "NOT"
               EndProperty
               BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmPrtReprint.frx":0B48
                  Key             =   "STOP"
               EndProperty
               BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmPrtReprint.frx":10E2
                  Key             =   "LST"
               EndProperty
               BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmPrtReprint.frx":1974
                  Key             =   "ITM"
               EndProperty
               BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmPrtReprint.frx":1ACE
                  Key             =   "ERR"
               EndProperty
               BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmPrtReprint.frx":1C28
                  Key             =   "NOF"
               EndProperty
               BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmPrtReprint.frx":1D82
                  Key             =   "ON"
                  Object.Tag             =   "OFF"
               EndProperty
               BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmPrtReprint.frx":265C
                  Key             =   ""
               EndProperty
            EndProperty
         End
      ...
      Begin FPSpread.vaSpread spdPrtReprint 
         ...
         SpreadDesigner  =   "frmPrtReprint.frx":2F36
         ScrollBarTrack  =   3
         ShowScrollTips  =   3
      End
   End
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame3 
         ...
         Begin VB.ComboBox cboLabelType 
            ...
            EndProperty
            Height          =   375
            ItemData        =   "frmPrtReprint.frx":4218
            Left            =   1650
            List            =   "frmPrtReprint.frx":421A
            Style           =   2  '드롭다운 목록
            TabIndex        =   6
            Top             =   180
            Width           =   1905
      ...
      Begin VB.Image imgPort 
         Height          =   240
         Left            =   19200
         Picture         =   "frmPrtReprint.frx":421C
         Top             =   480
         Width           =   240
      End
        ...
        With spdPrtReprint
            ...
            Do Until AdoRs.EOF
                ...
                If AdoRs.Fields("PROD_PP_BAR").Value & "" <> "" Then
                    cboPP.AddItem AdoRs.Fields("PROD_PP_BAR").Value & ""
                End If
                If AdoRs.Fields("PROD_PP_BAR_in").Value & "" <> "" Then
                    cboPPIN.AddItem AdoRs.Fields("PROD_PP_BAR_in").Value & ""
                End If
                If AdoRs.Fields("PROD_ICE_BAR").Value & "" <> "" Then
                    cboICE.AddItem AdoRs.Fields("PROD_ICE_BAR").Value & ""
                End If
                If AdoRs.Fields("PROD_ICE_BAR_IN").Value & "" <> "" Then
                    cboICEIN.AddItem AdoRs.Fields("PROD_ICE_BAR_IN").Value & ""
                End If
...
On Error GoTo ErrHandler
    ...
    If spdPrtReprint.DataRowCnt < 1 Then
    ...
    Else
        With CommonDialog1
            ...
            SaveExcel sFileName, spdPrtReprint
...
Private Sub GetBoxFilter()
    ...
    J = 0
    For i = 0 To cboPP.ListCount
        If i > 0 Then
            If cboPP.List(i) <> strFilter Then
                ReDim Preserve strData(J) As String
                strData(J) = cboPP.List(i)
                J = J + 1
            End If
        Else
            ReDim Preserve strData(J) As String
            ...
            J = J + 1
        End If
        strFilter = cboPP.List(i)
    Next

    cboPP.Clear
    For i = 0 To UBound(strData)
        cboPP.AddItem strData(i)
    Next
    ...
    For i = 0 To cboPPIN.ListCount
        If i > 0 Then
            If cboPPIN.List(i) <> strFilter Then
                ReDim Preserve strData(J) As String
                strData(J) = cboPPIN.List(i)
                J = J + 1
            End If
        Else
            ReDim Preserve strData(J) As String
            ...
            J = J + 1
        End If
        strFilter = cboPPIN.List(i)
    Next

    cboPPIN.Clear
    For i = 0 To UBound(strData)
        cboPPIN.AddItem strData(i)
    Next
    ...
    For i = 0 To cboICE.ListCount
        If i > 0 Then
            If cboICE.List(i) <> strFilter Then
                ReDim Preserve strData(J) As String
                strData(J) = cboICE.List(i)
                J = J + 1
            End If
        Else
            ReDim Preserve strData(J) As String
            ...
            J = J + 1
        End If
        strFilter = cboICE.List(i)
    Next

    cboICE.Clear
    For i = 0 To UBound(strData)
        cboICE.AddItem strData(i)
    Next
    ...
    For i = 0 To cboICEIN.ListCount
        If i > 0 Then
            If cboICEIN.List(i) <> strFilter Then
                ReDim Preserve strData(J) As String
                strData(J) = cboICEIN.List(i)
                J = J + 1
            End If
        Else
            ReDim Preserve strData(J) As String
            ...
            J = J + 1
        End If
        strFilter = cboICEIN.List(i)
    Next

    cboICEIN.Clear
    For i = 0 To UBound(strData)
        cboICEIN.AddItem strData(i)
    Next
...
Private Sub CtlInitializing()
    ...
    With spdPrtReprint
        ...
        Call SetText(spdPrtReprint, "생산LotNo", 0, 2):             .ColWidth(2) = 12 '15
        Call SetText(spdPrtReprint, "생산일자", 0, 3):              .ColWidth(3) = 10
        Call SetText(spdPrtReprint, "제품명", 0, 4):                .ColWidth(4) = 10 '15
        ...
        Call SetText(spdPrtReprint, "PP 바코드", 0, 8):             .ColWidth(8) = 15
        Call SetText(spdPrtReprint, "PP 내부바코드", 0, 9):         .ColWidth(9) = 15
        Call SetText(spdPrtReprint, "ICE 바코드", 0, 10):           .ColWidth(10) = 15
        Call SetText(spdPrtReprint, "ICE 내부바코드", 0, 11):       .ColWidth(11) = 15
        Call SetText(spdPrtReprint, "R 출력자", 0, 12):          .ColWidth(12) = 0 '8
        Call SetText(spdPrtReprint, "R 출력시간", 0, 13):        .ColWidth(13) = 0 '10
        Call SetText(spdPrtReprint, "P 출력자", 0, 14):        .ColWidth(14) = 0 '8
        Call SetText(spdPrtReprint, "P 출력시간", 0, 15):      .ColWidth(15) = 0 '10
        Call SetText(spdPrtReprint, "I 출력자", 0, 16):       .ColWidth(16) = 0 '8
        Call SetText(spdPrtReprint, "I 출력시간", 0, 17):      .ColWidth(17) = 0 '10
        
        Call SetText(spdPrtReprint, "R 데이터", 0, 18):      .ColWidth(18) = 15 '30
        Call SetText(spdPrtReprint, "P 데이터", 0, 19):      .ColWidth(19) = 15 '30
        Call SetText(spdPrtReprint, "I 데이터", 0, 20):      .ColWidth(20) = 15 '30
'        .ColWidth(12) = 0
'        .ColWidth(13) = 0
'        .ColWidth(14) = 0
'        .ColWidth(15) = 0
...
Private Sub spdPrtReprint_MouseUp(Button As Integer, Shift As Integer, x As Single, y As Single)
    Dim i As Integer

    With spdPrtReprint
        For i = 1 To .MaxRows
            Call SetText(spdPrtReprint, "0", i, colCHECKBOX)
        Next
        
        For i = .SelBlockRow To .SelBlockRow2
            Call SetText(spdPrtReprint, "1", i, colCHECKBOX)
        Next
    End With

End Sub

Private Sub spdPrtReprint_LeaveCell(ByVal Col As Long, ByVal Row As Long, ByVal NewCol As Long, ByVal NewRow As Long, Cancel As Boolean)
