...
Private Sub cmdConfirm_Click()
    ...
    Else
        ...
        Call WritePrivateProfileString("HOSP", "USEURL", strUseUrl, App.PATH & "\KDBAR.ini")
        Call WritePrivateProfileString("HOSP", "APIURL", txtAPIURL.Text, App.PATH & "\KDBAR.ini")
        Call WritePrivateProfileString("HOSP", "STDURL", txtSTDURL.Text, App.PATH & "\KDBAR.ini")
        Call WritePrivateProfileString("HOSP", "EDUURL", txtDEVURL.Text, App.PATH & "\KDBAR.ini")
...
Private Sub Form_Load()
    ...
    txtAPIURL.Text = gKUKDO.APIURL
    txtSTDURL.Text = gKUKDO.STDURL
    txtDEVURL.Text = gKUKDO.DEVURL
    
    If gKUKDO.USEURL = "STD" Then
