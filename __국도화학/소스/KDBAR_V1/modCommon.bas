...
Type LabelInfoParam
    ...
    COMPCD          As String   'key
    LBLTYPE         As String   'key
    LBLPRTNO        As String
    LBLPRTDEFAULTNO As String   '박스당 릴 기본수량
    LBLPRTSIDE      As String
    LBLBARSIDE1     As String
    LBLBARSIDE2     As String
    LBLBARSIDE3     As String
    LBLBARSIDE4     As String
...
Public gLblInfo    As LabelInfoParam
'##########  제품라벨 정보(Header) (DB 전달용)
...
Type LabelMstParam
    ...
    LBLITEM_FNAME() As String
    LBLITEM_FSIZE() As String
...
Public gLblMst    As LabelMstParam
'##########  제품라벨 정보(Master) (DB 전달용)
...
Public gBarInfo    As BarInfoParam
'##########  바코드마스터 정보(Header) (DB 전달용)
...
Type BarMstParam
    BARCD           As String   'key
    BARITEMNO()     As String
    BARITEMSEQ()    As String
    BARITEMNAME()   As String
    BARCHRNUM()     As String
...
Public Sub GetSetup()
    ...
    '-- MSSQL DB GET
    strSetup = "":    strSetUp1 = ""
    Call GetPrivateProfileString("DATABASE", "MSSQLIP", "", strSetup, 100, App.PATH & "\KDBAR.ini")
    strSetUp1 = Trim(strSetup)
    strSetUp1 = Mid(strSetUp1, 1, Len(strSetUp1) - 1)
    gSQLDB.IP = Trim(strSetUp1)

    strSetup = "":    strSetUp1 = ""
    Call GetPrivateProfileString("DATABASE", "MSSQLDB", "", strSetup, 100, App.PATH & "\KDBAR.ini")
    strSetUp1 = Trim(strSetup)
    strSetUp1 = Mid(strSetUp1, 1, Len(strSetUp1) - 1)
    gSQLDB.DB = Trim(strSetUp1)

    strSetup = "":    strSetUp1 = ""
    Call GetPrivateProfileString("DATABASE", "MSSQLUID", "", strSetup, 100, App.PATH & "\KDBAR.ini")
    strSetUp1 = Trim(strSetup)
    strSetUp1 = Mid(strSetUp1, 1, Len(strSetUp1) - 1)
    gSQLDB.UID = Trim(strSetUp1)
    
    strSetup = "":    strSetUp1 = ""
    Call GetPrivateProfileString("DATABASE", "MSSQLPWD", "", strSetup, 100, App.PATH & "\KDBAR.ini")
    strSetUp1 = Trim(strSetup)
    strSetUp1 = Mid(strSetUp1, 1, Len(strSetUp1) - 1)
...
Public Sub frmShow(frm As Form)
    ...
    frmMDI.lblFrmInfo.Caption = "현재화면 : " & frm.Caption
    frm.Show
    frm.ZOrder 0
