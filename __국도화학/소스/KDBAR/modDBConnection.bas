...
'-- MDB 연결
Public Function DbConnect_Local_UpDate() As Boolean
    Dim DB_Name         As String
    Dim UserName        As String
    Dim Password        As String
    Dim blnWinNTAuth    As Boolean
...
On Error GoTo ConnectError
    ...
    If ServerName = "" Then
        Select Case gERP
            Case "KDEXT":       ServerName = "172.16.1.71,1833"
        End Select
    End If
    
    If DatabaseName = "" Then
        Select Case gERP
            Case "KDEXT":       DatabaseName = "KDEXT"
        End Select
    End If
    
    If UserName = "" Then
        Select Case gERP
            Case "KDEXT":       UserName = "kdextuser"
        End Select
    End If
    
    If Password = "" Then
        Select Case gERP
            Case "KDEXT":       Password = "extP@ssW0rd"
        End Select
    End If
