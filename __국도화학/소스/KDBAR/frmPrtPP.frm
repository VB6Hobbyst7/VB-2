   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.Frame Frame3 
         ...
         Begin FPSpread.vaSpread spdPrtReelDetail 
            ...
            SpreadDesigner  =   "frmPrtPP.frx":9E761
            ScrollBarTrack  =   3
            ShowScrollTips  =   3
         End
      ...
      Begin FPSpread.vaSpread spdPrtReel 
         ...
         ShadowColor     =   16774120
         SpreadDesigner  =   "frmPrtPP.frx":9F3C9
         ScrollBarTrack  =   3
         ShowScrollTips  =   3
      End
   End
...
'2021-03-15 수정 : 내부바코드 체계변경으로 자릿수가 늘어나 보이지 않고 스캔이 되지 않는다.
'포지션 수정
...
'^PON^FS
'^CWJ,E:KFONT3.FNT^FS
'^MD10^PRD^FO500,50^CI26^AJN,50,30^FD국도화학 내부관리용코드^FS
'^FO400,100^CI26^BY4,3,100^BC^FDMP0003210315101^FS
'^XZ
...
'^CWJ,E:KFONT3.FNT^FS
'^MD10^PRD^FO500,50^CI26^AJN,50,30^FD국도화학 내부관리용코드^FS
' >>>   ^FO100,400^CI26^BY4,3,100^BC^FDMP0003210315101^FS
'^XZ
        ...
        strOutput = strOutput & "^FO100,400^CI26^BY4,3,100^BC^FD" & pBarcode
    Else
        strOutput = strOutput & "^FO100,100^CI26" & strAFont & "^FD국도화학 내부관리용코드^FS" & vbLf
        '-- 2021-01-26 내부바코드번호 위치조정
        'strOutput = strOutput & "^FO100,100^CI26^BY3,3,100^BC^FD" & pBarcode
        strOutput = strOutput & "^FO50,100^CI26^BY3,3,100^BC^FD" & pBarcode
    End If
...
Private Sub cmdPrint_Click()
    ...
    'Dim strYPos1    As String
    'Dim strYPos2    As String
    'Dim strYPos3    As String
...
'    strHeader = strHeader & "^PRD"
    ...
    Select Case lblstrPrtLabelName.Caption
        Case "P0011", "P0018", "P0019", "P0020", "P0021", "P0022", "P0023"
...
'            strOutput = ""
    ...
    If chkReelPrint.Value = "1" Then
        ...
        With spdScan
            ...
            ElseIf lblstrPrtLabelName.Caption = "P0011" Or lblstrPrtLabelName.Caption = "P0018" Or lblstrPrtLabelName.Caption = "P0019" Or lblstrPrtLabelName.Caption = "P0020" Or _
                    lblstrPrtLabelName.Caption = "P0021" Or lblstrPrtLabelName.Caption = "P0022" Or lblstrPrtLabelName.Caption = "P0023" Then
                
                '-- 연속용지 출력 시(신규 작은사이즈 4종)
                '-- PP BOX 옆면
                i = 0
                For intY = 1 To .MaxRows
                    .Row = intY
                    .Col = 1
'^FO50,1000^CI26^BY1,3,40^BCN^FD12U090101P101^FS
'^FO270,1000^CI26^BY1,3,40^BCN^FD12U090101P103^FS
'^FO490,1000^CI26^BY1,3,40^BCN^FD12U090101P105^FS
'^FO50,1060^CI26^BY1,3,40^BCN^FD12U090101P107^FS
'^FO270,1060^CI26^BY1,3,40^BCN^FD12U090101P109^FS
'^FO490,1060^CI26^BY1,3,40^BCN^FD12U090101P111^FS
'^FO50,1120^CI26^BY1,3,40^BCN^FD12U090101P113^FS
'^FO270,1120^CI26^BY1,3,40^BCN^FD12U090101P115^FS
'^FO490,1120^CI26^BY1,3,40^BCN^FD12U090101P117^FS
'^FO50,1180^CI26^BY1,3,40^BCN^FD12U090101P121^FS
'^FO270,1180^CI26^BY1,3,40^BCN^FD12U090101P119^FS
'^FO490,1180^CI26^BY1,3,40^BCN^FD12U090101P123^FS
'^FO50,1240^CI26^BY1,3,40^BCN^FD12U090101P125^FS
'^FO270,1240^CI26^BY1,3,40^BCN^FD12U090101P129^FS
'^FO490,1240^CI26^BY1,3,40^BCN^FD12U090101P104^FS
'^FO50,1300^CI26^BY1,3,40^BCN^FD12U090101P106^FS
'^FO270,1300^CI26^BY1,3,40^BCN^FD12U090101P108^FS
'^FO490,1300^CI26^BY1,3,40^BCN^FD12U090101P110^FS
'^FO50,1360^CI26^BY1,3,40^BCN^FD12U090101P114^FS
'^FO270,1360^CI26^BY1,3,40^BCN^FD12U090101P116^FS
'^FO490,1360^CI26^BY1,3,40^BCN^FD12U090101P118^FS
'^FO50,1420^CI26^BY1,3,40^BCN^FD12U090101P122^FS
'^FO270,1420^CI26^BY1,3,40^BCN^FD12U090101P124^FS
'^FO490,1420^CI26^BY1,3,40^BCN^FD12U090101P126^FS
'^FO50,1480^CI26^BY1,3,40^BCN^FD12U090101P128^FS
'^FO270,1480^CI26^BY1,3,40^BCN^FD12U090101P130^FS
'^FO490,1480^CI26^BY1,3,40^BCN^FD12U090101P126^FS
'^FO50,1540^CI26^BY1,3,40^BCN^FD12U090101P199^FS
'^FO270,1540^CI26^BY1,3,40^BCN^FD12U090101P198^FS
'^FO490,1540^CI26^BY1,3,40^BCN^FD12U090101P197^FS
'^XZ
                    
                    
                    Select Case intY
                        Case 1:     strXPos = 50: strYPos = 1000
                        Case 2:     strXPos = 270: strYPos = 1000
                        Case 3:     strXPos = 490: strYPos = 1000
                        
                        Case 4:     strXPos = 50: strYPos = 1060
                        Case 5:     strXPos = 270: strYPos = 1060
                        Case 6:     strXPos = 490: strYPos = 1060
                        
                        Case 7:     strXPos = 50: strYPos = 1120
                        Case 8:     strXPos = 270: strYPos = 1120
                        Case 9:     strXPos = 490: strYPos = 1120
                        
                        Case 10:    strXPos = 50: strYPos = 1180
                        Case 11:    strXPos = 270: strYPos = 1180
                        Case 12:    strXPos = 490: strYPos = 1180
                        
                        Case 13:    strXPos = 50: strYPos = 1240
                        Case 14:    strXPos = 270: strYPos = 1240
                        Case 15:    strXPos = 490: strYPos = 1240
                        
                        Case 16:    strXPos = 50: strYPos = 1300
                        Case 17:    strXPos = 270: strYPos = 1300
                        Case 18:    strXPos = 490: strYPos = 1300
                        
                        Case 19:    strXPos = 50: strYPos = 1360
                        Case 20:    strXPos = 270: strYPos = 1360
                        Case 21:    strXPos = 490: strYPos = 1360
                        
                        Case 22:    strXPos = 50: strYPos = 1420
                        Case 23:    strXPos = 270: strYPos = 1420
                        Case 24:    strXPos = 490: strYPos = 1420
                        
                        Case 25:    strXPos = 50: strYPos = 1480
                        Case 26:    strXPos = 270: strYPos = 1480
                        Case 27:    strXPos = 490: strYPos = 1480
                        
                        Case 28:    strXPos = 50: strYPos = 1540
                        Case 29:    strXPos = 270: strYPos = 1540
                        Case 30:    strXPos = 490: strYPos = 1540
                    End Select
                    ...
                    strPrtData(i) = strPrtData(i) & "^FO" & strXPos & "," & strYPos
                    strPrtData(i) = strPrtData(i) & "^CI26"
                    strPrtData(i) = strPrtData(i) & "^BY1,3,40^BCN"
                    strPrtData(i) = strPrtData(i) & "^FD" & .Text
                    strPrtData(i) = strPrtData(i) & "^FS" & vbLf
...
'            End If
        Else
            ...
            If strOutput <> "" Then
                If lblstrPrtLabelName.Caption = "P0001" Or lblstrPrtLabelName.Caption = "P0002" Or lblstrPrtLabelName.Caption = "P0011" _
                 Or lblstrPrtLabelName.Caption = "P0018" Or lblstrPrtLabelName.Caption = "P0019" Or lblstrPrtLabelName.Caption = "P0020" _
                 Or lblstrPrtLabelName.Caption = "P0021" Or lblstrPrtLabelName.Caption = "P0022" Or lblstrPrtLabelName.Caption = "P0023" Then
    ...
    If blnPrint = True Then
        ...
        '*********************** 2021-01-22 같은 내부바코드번호가 나올 수 있다. ***********************************
        '***********************                수정해야함                      ***********************************
        
        'PP 박스 M+210302(제조일자) + 100(박스번호) (100번부터 시작)
        'txtInBarcode.Text = "M" & Mid(strDate, 3, 6) & Format(100 + intMaxNo, "000")
        '제품코드 5자리를 추가함 : P0001
        txtInBarcode.Text = "M" & lblstrPrtLabelName.Caption & Mid(strDate, 3, 6) & Format(100 + intMaxNo, "000")
        ...
        If lblstrPrtLabelName.Caption = "P0001" Or lblstrPrtLabelName.Caption = "P0002" Or lblstrPrtLabelName.Caption = "P0003" Or lblstrPrtLabelName.Caption = "P0011" _
            ...
            If strInBarcode <> "" Then
                ...
                If strInBarData <> "" Then
                    ...
                    '-2021.07.15 수정 (If lblstrPrtLabelName.Caption = "P0003" Then 부분 추가함)
                    If lblstrPrtLabelName.Caption = "P0003" Then
                        strPrintVal(intCnt) = strPrintVal(intCnt) & ETX & strInBarData
                    Else
...
Private Sub lblComp_DblClick(Index As Integer)
    ...
    If txtProdNm.Text = "HA125CM3" Then
        For i = 1 To 30
            txtReelBarcode.Text = strNum
            Call txtReelBarcode_KeyPress(vbKeyReturn)
            strNum = Mid(strNum, 1, 10) & Format(CCur(Mid(strNum, 11, 3)) + 1, "000")
        Next
    Else
        For i = 1 To 10
            txtReelBarcode.Text = strNum
...
'    txtProdPosNo.Text = GetText(spdPrtReel, Row, 4)
    ...
    Else
        ...
        Do Until AdoRs.EOF
            With spdPrtReelDetail
                If Trim(AdoRs.Fields("USED_YN").Value & "") = "Y" Then
                    .MaxRows = .MaxRows + 1
    ...
    If KeyAscii = vbKeyReturn Then
        If txtReelBarcode.Text <> "" Then
            ...
            If AdoRs.RecordCount = 0 Then
                ...
                Exit Sub
            Else
                '2021-03-29 수정 408G는 PROD_PP_BAR 값이 없음
                'If AdoRs.Fields("PROD_PP_BAR").Value & "" <> "" Then
                If AdoRs.Fields("PROD_PP_BAR_IN").Value & "" <> "" Then
