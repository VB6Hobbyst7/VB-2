...
Begin VB.Form frmPrtICE 
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.Frame Frame3 
         ...
         Begin VB.Frame fraLotNo2 
            ...
            Begin FPSpread.vaSpread spdScan2 
               ...
               SpreadDesigner  =   "frmPrtICE.frx":0C68
               ScrollBarTrack  =   3
               ShowScrollTips  =   3
            End
            Begin VB.Label lblComp 
         ...
         Begin FPSpread.vaSpread spdPrtReelDetail 
            ...
            ScrollBarShowMax=   0   'False
            ShadowColor     =   16775150
            SpreadDesigner  =   "frmPrtICE.frx":403B2
            ScrollBarTrack  =   3
            ShowScrollTips  =   3
         End
         Begin FPSpread.vaSpread spdScan 
            ...
            ScrollBars      =   2
            ShadowColor     =   16774120
            SpreadDesigner  =   "frmPrtICE.frx":4101A
            ScrollBarTrack  =   3
            ShowScrollTips  =   3
         End
      ...
      Begin FPSpread.vaSpread spdPrtReel 
         ...
         ShadowColor     =   16774120
         SpreadDesigner  =   "frmPrtICE.frx":423F6
         ScrollBarTrack  =   3
         ShowScrollTips  =   3
      End
   End
      ...
      Begin MSComctlLib.ImageList imlStatus 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmPrtICE.frx":43A8E
               Key             =   "RUN"
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmPrtICE.frx":44028
               Key             =   "NOT"
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmPrtICE.frx":445C2
               Key             =   "STOP"
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmPrtICE.frx":44B5C
               Key             =   "LST"
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmPrtICE.frx":453EE
               Key             =   "ITM"
            EndProperty
            BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmPrtICE.frx":45548
               Key             =   "ERR"
            EndProperty
            BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmPrtICE.frx":456A2
               Key             =   "NOF"
            EndProperty
            BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmPrtICE.frx":457FC
               Key             =   "ON"
               Object.Tag             =   "OFF"
            EndProperty
            BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmPrtICE.frx":460D6
               Key             =   ""
            EndProperty
         EndProperty
      End
...
Private Sub cmd500ePrt_Click()
    ...
    strData = get500ePrtData
    
    If strData <> "" Then
        comEqp.Output = strData
    End If
    
End Sub


Private Function get500ePrtData()
...
Private Sub cmdPrint_Click()
    ...
    Select Case lblstrPrtLabelName.Caption
        Case "P0001", "P0002", "P0011", "P0018", "P0019", "P0020", "P0021", "P0022", "P0023"
            '폰트
...
'    End If
    ...
    If blnPrint = True Then
        ...
        '제품코드 5자리를 추가함 : P0001
        txtInBarcode.Text = "B" & lblstrPrtLabelName.Caption & Mid(strDate, 3, 6) & Format(intMaxNo, "000")
        ...
        For intRow = 1 To .MaxRows
            ...
            If strType = "바코드" Then
                If Mid(strBarType, 1, 1) = "1" Then
                    ...
                    strPrtData(i) = strPrtData(i) & "^BY4,4,120^BC"
                    'strPrtData(i) = strPrtData(i) & "^BC" & "B,120,Y,N,N"
                    strPrtData(i) = strPrtData(i) & "^BC" & "N,120,Y,N,N"
                    strPrtData(i) = strPrtData(i) & "^FD" & strData
                    strPrtData(i) = strPrtData(i) & "^FS" & vbLf
                    i = i + 1
                Else
...
Private Sub ICEPrint_500BE_350()
    Dim intPRow     As Integer
    Dim intPrt      As Integer
    Dim strPrtFNo   As String
    Dim strPrtTNo   As String
    ...
    If blnPrint = True Then
        ...
        Dim str500BEData As String
    
        str500BEData = get500ePrtData
        If str500BEData <> "" Then
            strPrintVal(0) = strPrintVal(0) & ETX & str500BEData
        End If
        
        str500BEData = ""
        str500BEData = getLabelPrint
        If str500BEData <> "" Then
            strPrintVal(0) = strPrintVal(0) & ETX & str500BEData
        End If
...
'    strAFont = "^A0N,75,45"
    ...
    If blnPrint = True Then
        ...
        '고객사전용라벨 데이터 가져오기
        strTemp1 = getTopPrint
        If strTemp1 <> "" Then
            strPrintVal(0) = strPrintVal(0) & ETX & strTemp1
            '트래킹 저장
            Call SetPackTrack(strBarcode, strInBarcode, strPrintVal)
        Else
            '트래킹 저장
...
'        strOutput = ""
'        strOutput = strOutput & "^FO 250,200"
'        strOutput = strOutput & "^CI26"
'        strOutput = strOutput & "^BC" & "N,150,Y,N,N"
'        strOutput = strOutput & "^FD" & txtTopPrtNo.Text
'        strOutput = strOutput & "^FS" & vbLf
'        strOutput = strHeader & strOutput & strFooter
        
        strOutput = getTopPrint
...
'고객사전용라벨(내용은 자재코드)
Private Function getTopPrint() As String
    Dim strOutput   As String
    Dim strHeader   As String
    Dim strFooter   As String
    Dim strAFont   As String
    ...
    If txtTopPrtNo.Text <> "" Then
        ...
        '-- 2020.07.24 X좌표 수정
        'strOutput = strOutput & "^FO 250,200"
        'strOutput = strOutput & "^FO 80,200"
        strOutput = strOutput & "^FO 60,200"
        strOutput = strOutput & "^CI26"
        strOutput = strOutput & "^BY3"
        strOutput = strOutput & "^BC" & "N,150,Y,N,N"
        strOutput = strOutput & "^FD" & txtTopPrtNo.Text
        strOutput = strOutput & "^FS" & vbLf
        strOutput = strHeader & strOutput & strFooter
        
        getTopPrint = strOutput
...
'^PON^FS
'^CWJ,E:KFONT3.FNT^FS
'^FO 60,200^CI26^BY3^BCN,150,Y,N,N^FD32401002000001S2L3F001001000^FS
'^XZ
...
'    strPrtData(i) = ""
'    'strPrtData(i) = strPrtData(i) & "^FO" & strPlusXPos & "," & strYPos
'    strPrtData(i) = strPrtData(i) & "^FO" & "500" & "," & strYPos
'    strPrtData(i) = strPrtData(i) & "^CI26"
'    strPrtData(i) = strPrtData(i) & "^BC" & "N,100,Y,N,N"
'    strPrtData(i) = strPrtData(i) & "^FD" & txtInBarcode.Text
'    strPrtData(i) = strPrtData(i) & "^FS" & vbLf
...
'        If intCnt = 1 Then
'            strXPos = 100: strYPos = 300
'        Else
'            If intCnt Mod 2 = 0 Then
'                strXPos = strPlusXPos:  strYPos = strYPos
'            Else
'                strXPos = 100:          strYPos = strYPos + 180
'            End If
'        End If
'
'        ReDim Preserve strPrtData(i) As String
...
'    strOutput = strHeader & strOutput & strFooter
    ...
    '전용라벨출력 버튼이 있는데
    '자재코드출력는 408G만 씁니다
    '전용라벨출력버튼은 문구는 이게 맞는데
    '제대로 나오는건 전용라벨출력 이버튼에서 나와야하는데 이상한 바코드가 나오고
    '자재코드출력(408G만씀) 을 눌러야 500E 전용라벨이 인쇄됩니다
    
    '500E에 자재코드출력 버튼 없애고,
   ' 전용라벨문구가 자재코드출력버튼에서 나오니 전용라벨출력 버튼에서 나오게 해주심  됩니다
'    strData = getLabelPrint
'
'    If strData <> "" Then
'        comEqp.Output = strData
'    End If
...
Private Function getLabelPrint()
    Dim strPlusXPos As String
    Dim strXPos     As String
    Dim strYPos     As String
    Dim strAFont    As String
    ...
    strPrtData(i) = strPrtData(i) & "^FO" & "500" & "," & strYPos
    strPrtData(i) = strPrtData(i) & "^CI26"
    strPrtData(i) = strPrtData(i) & "^BY" & "3"
    strPrtData(i) = strPrtData(i) & "^BC" & "N,100,Y,N,N"
    strPrtData(i) = strPrtData(i) & "^FD" & txtInBarcode.Text
    strPrtData(i) = strPrtData(i) & "^FS" & vbLf
    i = i + 1
                    ...
                    Select Case strPrtLabelName
                        Case "P0011", "P0018", "P0019", "P0020", "P0021", "P0022", "P0023"
                            ...
                            ElseIf AdoRs.Fields("LABEL_ITEM_NAME").Value & "" = "Total Quantity/Length" Then
                                ...
                                strContents = CCur(strMaxTot) & "Reels/" & CCur(strProdLen) * CCur(strMaxTot) & "M"
                        ...
                        Select Case lblstrPrtLabelName.Caption
                            Case "P0011", "P0018", "P0019", "P0020", "P0021", "P0022", "P0023"
                                ...
                                If GetText(spdPrtReelDetail2, i, 1) = "Total Quantity/Length" Then
                                    ...
                                    strContents = CCur(strASReelCnt) & "Reels/" & CCur(strASReelCnt) * (CCur((txtProdLen.Text))) & "M"
                ...
                Select Case lblstrPrtLabelName.Caption
                    Case "P0011", "P0018", "P0019", "P0020", "P0021", "P0022", "P0023"
                        ...
                        If GetText(spdPrtReelDetail, i, 1) = "바코드" Then
                            ...
                            strProdLen = Mid(strProdLen, 1, 13)
