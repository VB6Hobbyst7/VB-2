   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.Frame Frame3 
         ...
         Begin FPSpread.vaSpread spdRegOrderDetail 
            ...
            SpreadDesigner  =   "frmPrtReel.frx":F23A
            ScrollBarTrack  =   3
            ShowScrollTips  =   3
         End
      ...
      Begin FPSpread.vaSpread spdPrtReel 
         ...
         ScrollBars      =   2
         ShadowColor     =   16774120
         SpreadDesigner  =   "frmPrtReel.frx":1039B
         ScrollBarTrack  =   3
         ShowScrollTips  =   3
      End
   End
      ...
      Begin MSComctlLib.ImageList imlStatus 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmPrtReel.frx":118CD
               Key             =   "RUN"
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmPrtReel.frx":11E67
               Key             =   "NOT"
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmPrtReel.frx":12401
               Key             =   "STOP"
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmPrtReel.frx":1299B
               Key             =   "LST"
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmPrtReel.frx":1322D
               Key             =   "ITM"
            EndProperty
            BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmPrtReel.frx":13387
               Key             =   "ERR"
            EndProperty
            BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmPrtReel.frx":134E1
               Key             =   "NOF"
            EndProperty
            BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmPrtReel.frx":1363B
               Key             =   "ON"
               Object.Tag             =   "OFF"
            EndProperty
            BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmPrtReel.frx":13F15
               Key             =   ""
            EndProperty
         EndProperty
      End
...
'    strHeader = strHeader & "^MD7"      'darkness
    ...
    Select Case lblstrPrtLabelName.Caption
        Case "P0011", "P0018", "P0019", "P0020", "P0021", "P0022", "P0023"
            'If txtFont1.Text <> "" And txtFont2.Text <> "" Then
            '    If IsNumeric(txtFont1.Text) And IsNumeric(txtFont2.Text) Then
            '        strAFont = "^A0N," & txtFont1.Text & "," & txtFont2.Text & ",30"
            '    End If
            'End If
            
            If txtFont.Text <> "" Then
                strAFont = txtFont.Text
            End If
...
'''                strHeader = strHeader & "^PR" & txtSpeed.Text    'speed
'''            End If
'''            If txtDarkness.Text <> "" Then
'''                strHeader = strHeader & "^MD" & txtDarkness.Text    'darkness
'''            End If
...
'                                strPrtData(i) = strPrtData(i) & "^CI26"
                            ...
                            ElseIf strType = "LotNo" Then
                                ...
                                strPrtData(i) = ""
                                strPrtData(i) = strPrtData(i) & "^FO" & strXPos & "," & strYPos
                                strPrtData(i) = strPrtData(i) & "^A0N,25,20"
                                strPrtData(i) = strPrtData(i) & "^FH"
                                If strNamePrt = "Y" Then
                                    strPrtData(i) = strPrtData(i) & "^FD" & strType & " : " & strLot
                                Else
                            ...
                            ElseIf strType = "보관온도" Then
                                ...
                                strPrtData(i) = strPrtData(i) & "^FS" & vbLf
                                'o 추가
                                strPrtData(i) = strPrtData(i) & "^FO" & strXPos + 80 & "," & strYPos & "^A0N,10,10^FH^FDo^FS"
                                'C 추가
                                strPrtData(i) = strPrtData(i) & "^FO" & strXPos + 85 & "," & strYPos & strAFont200DPI & "^FH^FDC^FS"
                                ...
                                strPrtData(i) = strPrtData(i) & "^FS" & vbLf
                                'o 추가
                                strPrtData(i) = strPrtData(i) & "^FO" & CCur(strXPos) + CCur(strPlusXPos200DPI) + 80 & "," & strYPos & "^A0N,10,10^FH^FDo^FS"
                                'C 추가
                                strPrtData(i) = strPrtData(i) & "^FO" & CCur(strXPos) + CCur(strPlusXPos200DPI) + 85 & "," & strYPos & strAFont200DPI & "^FH^FDC^FS"
                                i = i + 1
                            Else
                                If strType = "생산일자" Then
                                    ReDim Preserve strPrtData(i) As String
                                    strPrtData(i) = ""
                                    strPrtData(i) = strPrtData(i) & "^FO" & strXPos & "," & strYPos
                                    strPrtData(i) = strPrtData(i) & "^A0N,25,20"
                                ...
                                ElseIf strType = "유효기간" Then
                                    ...
                                    strPrtData(i) = strPrtData(i) & "^FS" & vbLf
                                    i = i + 1
                                ElseIf UCase(strType) = "SIZE" Then
                                    ReDim Preserve strPrtData(i) As String
                                    strPrtData(i) = ""
                                    strPrtData(i) = strPrtData(i) & "^FO" & strXPos & "," & strYPos
                                    strPrtData(i) = strPrtData(i) & "^A0N,25,20"
    ...
    '                                strPrtData(i) = strPrtData(i) & "^CI26"
                                    If strType = "Name" Then
                                        strPrtData(i) = strPrtData(i) & "^A0N,35,30"
                                    Else
                        ...
                        For intRow = 1 To .MaxRows
                            ...
                            Else
                                If strType = "생산일자" Then
                                    ...
                                    strPrtData(i) = ""
                                    strPrtData(i) = strPrtData(i) & "^FO" & strXPos & "," & strYPos
                                    strPrtData(i) = strPrtData(i) & "^A0N,25,25"
                                    strPrtData(i) = strPrtData(i) & "^FH"
                                    If strNamePrt = "Y" Then
                                        strPrtData(i) = strPrtData(i) & "^FD" & strType & " : " & strData
                                    Else
...
'''                '2020-08-27
'''                txtSpeed.Text = Mid(AdoRs.Fields("LABEL_BAR_SIDE02_TYPE").Value & "", 1, 1)
'''                txtDarkness.Text = Mid(AdoRs.Fields("LABEL_BAR_SIDE02_TYPE").Value & "", 2, 1)
