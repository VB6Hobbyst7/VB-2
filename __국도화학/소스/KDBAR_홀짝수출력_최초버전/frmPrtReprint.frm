   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame3 
         ...
         Begin VB.ComboBox cboLabelType 
            ...
            EndProperty
            Height          =   375
            ItemData        =   "frmPrtReprint.frx":13C6
            Left            =   1650
            List            =   "frmPrtReprint.frx":13C8
            Style           =   2  '드롭다운 목록
            TabIndex        =   8
            Top             =   240
            Width           =   1905
      ...
      Begin VB.ComboBox cboSlittingNo 
         ...
         EndProperty
         Height          =   375
         ItemData        =   "frmPrtReprint.frx":13CA
         Left            =   17820
         List            =   "frmPrtReprint.frx":13CC
         Style           =   2  '드롭다운 목록
         TabIndex        =   1
         Top             =   330
         Visible         =   0   'False
      ...
      Begin MSComctlLib.ImageList imlStatus 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmPrtReprint.frx":13CE
               Key             =   "RUN"
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmPrtReprint.frx":1968
               Key             =   "NOT"
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmPrtReprint.frx":1F02
               Key             =   "STOP"
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmPrtReprint.frx":249C
               Key             =   "LST"
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmPrtReprint.frx":2D2E
               Key             =   "ITM"
            EndProperty
            BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmPrtReprint.frx":2E88
               Key             =   "ERR"
            EndProperty
            BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmPrtReprint.frx":2FE2
               Key             =   "NOF"
            EndProperty
            BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmPrtReprint.frx":313C
               Key             =   "ON"
               Object.Tag             =   "OFF"
            EndProperty
            BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmPrtReprint.frx":3A16
               Key             =   ""
            EndProperty
         EndProperty
      End
      ...
      Begin VB.Image imgPort 
         Height          =   240
         Left            =   15690
         Picture         =   "frmPrtReprint.frx":42F0
         Top             =   930
         Width           =   240
      End
    ...
    Else
        Do Until AdoRs.EOF
            With spdPrtReprint
                ...
                Else
                    Call SetText(spdPrtReprint, AdoRs.Fields("PROD_PP_BAR_IN").Value & "", .MaxRows, 8)
                End If
                
                If AdoRs.Fields("PROD_ICE_BAR_IN").Value & "" = "" Then
                    Call SetText(spdPrtReprint, AdoRs.Fields("PROD_ICE_BAR").Value & "", .MaxRows, 9)
                Else
                    Call SetText(spdPrtReprint, AdoRs.Fields("PROD_ICE_BAR_IN").Value & "", .MaxRows, 9)
                End If
                Call SetText(spdPrtReprint, AdoRs.Fields("USER_NAME").Value & "", .MaxRows, 10)
                Call SetText(spdPrtReprint, AdoRs.Fields("REGIST_DT_R").Value & "", .MaxRows, 11)
        ...
        For i = 1 To .MaxRows
            ...
            If .Value = "1" Then
                Select Case UCase(Mid(cboLabelType.Text, 1, 1))
                    Case "R"
                            strPrtData = GetText(spdPrtReprint, i, 12)
                            comEqp.Output = strPrtData
                    Case "P"
                            strPrtData = GetText(spdPrtReprint, i, 13)
                            ...
                            End If
                    Case "I"
                            strPrtData = GetText(spdPrtReprint, i, 14)
                            If InStr(strPrtData, ETX) > 0 Then
                                comEqp.Output = Mid(strPrtData, 1, InStr(strPrtData, ETX) - 1)
                                comEqp.Output = Mid(strPrtData, InStr(strPrtData, ETX) + 1)
                            Else
...
Private Sub CtlInitializing()
    ...
    With spdPrtReprint
        ...
        Call SetText(spdPrtReprint, "PP BOX 바코드", 0, 8):     .ColWidth(8) = 25
        Call SetText(spdPrtReprint, "ICE BOX 바코드", 0, 9):    .ColWidth(9) = 25
        Call SetText(spdPrtReprint, "출력자", 0, 10):           .ColWidth(10) = 8
        Call SetText(spdPrtReprint, "출력시간", 0, 11):         .ColWidth(11) = 20
        .ColWidth(12) = 0
        .ColWidth(13) = 0
        .ColWidth(14) = 0
        .ColWidth(15) = 0
