   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame3 
         ...
         Begin VB.ComboBox cboLabelType 
            ...
            EndProperty
            Height          =   375
            ItemData        =   "frmPrtReprint.frx":4274
            Left            =   1650
            List            =   "frmPrtReprint.frx":4276
            Style           =   2  '드롭다운 목록
            TabIndex        =   6
            Top             =   180
            Width           =   1905
      ...
      Begin VB.Image imgPort 
         Height          =   240
         Left            =   19200
         Picture         =   "frmPrtReprint.frx":4278
         Top             =   480
         Width           =   240
      End
...
Private Sub CtlInitializing()
    ...
    With spdPrtReprint
        ...
        Call SetText(spdPrtReprint, "R 데이터", 0, 18):      .ColWidth(18) = 30
        Call SetText(spdPrtReprint, "P 데이터", 0, 19):      .ColWidth(19) = 30
        Call SetText(spdPrtReprint, "I 데이터", 0, 20):      .ColWidth(20) = 30
'        .ColWidth(12) = 0
'        .ColWidth(13) = 0
'        .ColWidth(14) = 0
'        .ColWidth(15) = 0
...
'Private Sub spdPrtReprint_DragOver(Source As Control, x As Single, y As Single, State As Integer)
'
'    Debug.Print spdPrtReprint.ActiveRow
'
'End Sub

'Private Sub spdPrtReprint_MouseDown(Button As Integer, Shift As Integer, x As Single, y As Single)
'    Debug.Print "start:" & spdPrtReprint.ActiveRow
'End Sub

Private Sub spdPrtReprint_MouseUp(Button As Integer, Shift As Integer, x As Single, y As Single)
    Dim i As Integer
    
    'Debug.Print "stop:" & spdPrtReprint.ActiveRow
    With spdPrtReprint
        For i = 1 To .MaxRows
            Call SetText(spdPrtReprint, "0", i, colCHECKBOX)
        Next
        
        For i = intFrom To .ActiveRow
