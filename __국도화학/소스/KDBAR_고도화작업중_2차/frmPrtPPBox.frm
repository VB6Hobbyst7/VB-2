                            ...
                            Else
                                ...
                                Do Until pAdoRS1.EOF
                                    ...
                                    Select Case strTmp
                                        ...
                                        Case "제조일_월":       strBarData = strBarData & Get_YMD(pAdoRS1.Fields("LABEL_ITEM_TYPE").Value & "", Year(strDate))
                                        Case "제조일_일":       strBarData = strBarData & Get_YMD(pAdoRS1.Fields("LABEL_ITEM_TYPE").Value & "", Year(strDate))
                                        ...
                                        Case "제품길이":        strBarData = strBarData & strProdLen
                                    End Select
                                    pAdoRS1.MoveNext
                                Loop
                                pAdoRS1.Close
