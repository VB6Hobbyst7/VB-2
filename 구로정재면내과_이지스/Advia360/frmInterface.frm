...
Begin VB.Form frmInterface 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin FPSpread.vaSpread vasRes 
         ...
         RetainSelBlock  =   0   'False
         ScrollBars      =   2
         SpreadDesigner  =   "frmInterface.frx":5661
      End
   End
...
'16:07:20 [Rcv]6:
'16:07:20 [Rcv]7:
'16:07:20 [Rcv]8:Serial No.: S010734
'16:07:20 [Rcv]9:RecNo:  15
'16:07:20 [Rcv]10:Sample ID: 12346
'16:07:20 [Rcv]11:Patient ID:
'16:07:20 [Rcv]12:Patient Name:
'16:07:20 [Rcv]13:Mode:  Human
'16:07:20 [Rcv]14:Doctor:
'16:07:20 [Rcv]15:Age:   0   years
'16:07:20 [Rcv]16:Birth(ymd):    00000000
'16:07:20 [Rcv]17:Sex:   -
'16:07:20 [Rcv]18:Test date(ymd):    20170609
'16:07:20 [Rcv]19:Test time(hm): 141300
'16:07:20 [Rcv]20:Param  Flags   Value   Unit    [min-max]
'16:07:20 [Rcv]21:WBC    H   18.51   10^9/l  [4.00-11.70]
'16:07:20 [Rcv]22:LYM        2.92    10^9/l  [0.80-3.30]
'16:07:20 [Rcv]23:MID        1.35    10^9/l  [0.30-1.70]
'16:07:20 [Rcv]24:GRA    H   14.24   10^9/l  [2.30-8.80]
'16:07:20 [Rcv]25:LY%        15.8    %   [10.8-45.4]
'16:07:20 [Rcv]26:MO%         7.3    %   [ 1.8-17.0]
'16:07:20 [Rcv]27:GR%        76.9    %   [44.0-80.9]
'16:07:20 [Rcv]28:RBC        5.68    10^12/l [2.76-5.74]
'16:07:20 [Rcv]29:HGB    H   18.9    g/dl    [ 8.8-16.5]
'16:07:20 [Rcv]30:HCT    H   56.58   %   [26.10-49.60]
'16:07:20 [Rcv]31:MCV        99.6    fl  [76.4-102.0]
'16:07:20 [Rcv]32:MCH        33.2    pg  [23.3-36.1]
'16:07:20 [Rcv]33:MCHC       33.4    g/dl    [29.7-36.8]
'16:07:20 [Rcv]34:RDWc       15.8    %   [11.3-16.7]
'16:07:20 [Rcv]35:PLT    H    480    10^9/l  [  97- 390]
'16:07:20 [Rcv]36:MPV         8.7    fl  [ 7.5-13.1]

'    For intCnt = 1 To UBound(strRecvData)
'        strRcvBuf = strRecvData(intCnt)
'        strType = Mid$(strRcvBuf, 2, 1)
'
'        'SetRawData "[Rcv]" & intCnt & ":" & strRcvBuf
'        'Select Case strType
'    Next

    
    
    varRcvBuf = Split(strRecvData(1), vbCrLf)
    
    If UBound(varRcvBuf) < 36 Then
        Exit Sub
    End If
    ...
    For intCnt = 20 To 36
        ...
        Else
            strIntBase = intCnt 'mGetP(strRcvBuf, 1, vbTab)
            strResult = mGetP(strRcvBuf, 3, vbTab)
            ...
            If strResult <> "" Then
                ...
                If Res > 0 Then
                    ...
                    SetText vasID, "0", gRow, colCheckBox                 '체크 푼다
...
'
'                            If gsFlag = "H" Then
'                                vasID.BackColor = vbRed
'                            ElseIf gsFlag = "L" Then
'                                vasID.BackColor = vbBlue
'                            Else
'                                vasID.BackColor = vbBlack
'                            End If
