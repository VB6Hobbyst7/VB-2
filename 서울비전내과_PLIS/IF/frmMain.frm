...
Begin VB.Form frmMain 
   ...
   Begin VB.PictureBox Picture2 
      ...
      Begin VB.Frame fraResult 
         ...
         Begin VB.ComboBox cboRstType 
            Appearance      =   0  '평면
            Height          =   300
            ItemData        =   "frmMain.frx":9E6F
            Left            =   420
            List            =   "frmMain.frx":9E71
            TabIndex        =   118
            Top             =   180
            Width           =   1245
         End
         Begin VB.ComboBox cboState 
            Height          =   300
            ItemData        =   "frmMain.frx":9E73
            Left            =   4710
            List            =   "frmMain.frx":9E75
            TabIndex        =   117
            Top             =   180
            Width           =   1395
         End
   ...
   Begin VB.Frame frame2 
      ...
      Begin FPSpread.vaSpread spdROrder 
         ...
         SpreadDesigner  =   "frmMain.frx":D80C
         UserResize      =   2
      End
   ...
   Begin VB.Frame frame1 
      ...
      Begin VB.Frame fraDUREADER720 
         ...
         Begin VB.ComboBox cboWbcM 
            ...
            EndProperty
            Height          =   300
            ItemData        =   "frmMain.frx":11D7B
            Left            =   1020
            List            =   "frmMain.frx":11D8B
            TabIndex        =   183
            Text            =   "Combo3"
            Top             =   360
            Width           =   1695
      ...
      Begin FPSpread.vaSpread spdOrder 
         ...
         SelectBlockOptions=   0
         ShadowColor     =   14548991
         SpreadDesigner  =   "frmMain.frx":11D9B
         UserResize      =   2
      End
      Begin FPSpread.vaSpread spdResult 
         ...
         SelectBlockOptions=   0
         ShadowColor     =   13697023
         SpreadDesigner  =   "frmMain.frx":162F8
         TextTip         =   2
      End
   End
   Begin VB.Frame frame3 
      ...
      Begin VB.Frame frameTestSet 
         ...
         Begin VB.Frame frameOrder 
            ...
            Begin FPSpread.vaSpread spdOrdMst 
               ...
               SelectBlockOptions=   0
               ShadowColor     =   13697023
               SpreadDesigner  =   "frmMain.frx":16D5E
               TextTip         =   2
            End
         End
         Begin VB.ComboBox cboResultType 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmMain.frx":172BB
            Left            =   1650
            List            =   "frmMain.frx":172BD
            TabIndex        =   32
            Top             =   5220
            Visible         =   0   'False
            Width           =   1575
      ...
      Begin FPSpread.vaSpread spdTest 
         ...
         RetainSelBlock  =   0   'False
         SelectBlockOptions=   0
         SpreadDesigner  =   "frmMain.frx":1A1B7
      End
   End
   Begin VB.Frame frame4 
      ...
      Begin VB.Frame frameCom 
         ...
         Begin VB.ComboBox cboPort 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmMain.frx":1BC82
            Left            =   2190
            List            =   "frmMain.frx":1BC84
            TabIndex        =   52
            Top             =   390
            Width           =   2205
         End
         Begin VB.ComboBox cboBaudrate 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmMain.frx":1BC86
            Left            =   2190
            List            =   "frmMain.frx":1BC88
            TabIndex        =   51
            Top             =   780
            Width           =   2205
         End
         Begin VB.ComboBox cboDatabit 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmMain.frx":1BC8A
            Left            =   2190
            List            =   "frmMain.frx":1BC8C
            TabIndex        =   50
            Top             =   1170
            Width           =   2205
         End
         ...
         Begin VB.ComboBox cboParity 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmMain.frx":1BC8E
            Left            =   2190
            List            =   "frmMain.frx":1BC90
            TabIndex        =   47
            Top             =   2520
            Width           =   2205
         End
    ...
    If KeyCode = vbKeyReturn Then
        If colBARCODE = sCol Then
            ...
            Else
                ...
                SQL = SQL & " ,CHARTNO = '" & mOrder.ORDDT & "'" & vbCr
        ...
        ElseIf spdOrder.ActiveCol > colSTATE Then
            strTestNm = GetText(spdOrder, 0, sCol)
            strResult = GetText(spdOrder, sRow, sCol)
            
            For intRow = 1 To spdResult.MaxRows
                If strTestNm = GetText(spdResult, intRow, colRTESTNM) Then
                    strTestCd = GetText(spdResult, intRow, colRTESTCD)
                    strIntBase = GetText(spdResult, intRow, colRCHANNEL)
                    ...
                    If DBExec(AdoCn_Local, SQL) Then
                        '-- 성공
                        Call SetText(spdOrder, strResult, sRow, sCol)
                        Call spdOrder_Click(sCol, sRow)
                    End If
                End If
            Next
        End If
...
'
'            '## Secondary Aspiration Mode일때는 "S" 표시!
...
On Error GoTo RST
    ...
    SQL = ""
    SQL = SQL & "SELECT DISTINCT SEQNO, EXAMNAME, RESULT,EXAMCODE,EQUIPCODE,REFJUDGE " & vbCr
    ...
    If Not AdoRs_Local.EOF = True And Not AdoRs_Local.BOF = True Then
        With frmMain.spdResult
            ...
            Do Until AdoRs_Local.EOF
                ...
                strJudge = AdoRs_Local.Fields("REFJUDGE").Value & ""
                If strJudge = "H" Then
                    frmMain.spdResult.Row = intRow
                    frmMain.spdResult.Col = colRLISRESULT
                    frmMain.spdResult.ForeColor = vbRed
                ElseIf strJudge = "L" Then
                    frmMain.spdResult.Row = intRow
                    frmMain.spdResult.Col = colRLISRESULT
                    frmMain.spdResult.ForeColor = vbBlue
                Else
                    frmMain.spdResult.Row = intRow
                    frmMain.spdResult.Col = colRLISRESULT
    ...
    If Not AdoRs_Local.EOF = True And Not AdoRs_Local.BOF = True Then
        With frmMain.spdRResult
            ...
            Do Until AdoRs_Local.EOF
                ...
                strJudge = AdoRs_Local.Fields("REFJUDGE").Value & ""
                If strJudge = "H" Then
                    frmMain.spdRResult.Row = intRow
                    frmMain.spdRResult.Col = colRLISRESULT
                    frmMain.spdRResult.ForeColor = vbRed
                ElseIf strJudge = "L" Then
                    frmMain.spdRResult.Row = intRow
                    frmMain.spdRResult.Col = colRLISRESULT
                    frmMain.spdRResult.ForeColor = vbBlue
                Else
                    frmMain.spdRResult.Row = intRow
                    frmMain.spdRResult.Col = colRLISRESULT
