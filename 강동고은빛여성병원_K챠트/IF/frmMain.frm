...
Begin VB.Form frmMain 
   ...
   Begin VB.Frame frame3 
      ...
      Begin VB.Frame frameTestSet 
         ...
         Begin VB.ComboBox cboResultType 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmMain.frx":435C
            Left            =   1650
            List            =   "frmMain.frx":435E
            TabIndex        =   43
            Top             =   5220
            Visible         =   0   'False
            Width           =   1575
         ...
         Begin VB.Frame frameCutOff 
            ...
            Begin VB.ComboBox cboCOH 
               ...
               EndProperty
               Height          =   315
               ItemData        =   "frmMain.frx":4360
               Left            =   2730
               List            =   "frmMain.frx":4362
               TabIndex        =   39
               Top             =   1020
               Width           =   735
            End
            ...
            Begin VB.ComboBox cboCOL 
               ...
               EndProperty
               Height          =   315
               ItemData        =   "frmMain.frx":4364
               Left            =   2730
               List            =   "frmMain.frx":4366
               TabIndex        =   30
               Top             =   300
               Width           =   735
            End
      ...
      Begin FPSpread.vaSpread spdTest 
         ...
         RetainSelBlock  =   0   'False
         SelectBlockOptions=   0
         SpreadDesigner  =   "frmMain.frx":7E1E
      End
   End
   Begin VB.Frame frame1 
      ...
      Begin FPSpread.vaSpread spdOrder 
         ...
         SpreadDesigner  =   "frmMain.frx":8D7D
         UserResize      =   2
      End
      Begin FPSpread.vaSpread spdResult 
         ...
         SelectBlockOptions=   0
         ShadowColor     =   13697023
         SpreadDesigner  =   "frmMain.frx":D2C5
         TextTip         =   2
      End
   End
   Begin VB.Frame FraHidden 
      ...
      Begin MSComctlLib.ImageList imlStatus 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMain.frx":10053
               Key             =   "RUN"
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMain.frx":105ED
               Key             =   "NOT"
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMain.frx":10B87
               Key             =   "STOP"
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMain.frx":11121
               Key             =   "LST"
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMain.frx":119B3
               Key             =   "ITM"
            EndProperty
      ...
      Begin FPSpread.vaSpread vasTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmMain.frx":11DC1
      End
      Begin FPSpread.vaSpread spdQcResult 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmMain.frx":11FFA
      End
   ...
   Begin VB.Frame frame4 
      ...
      Begin VB.Frame frameCom 
         ...
         Begin VB.ComboBox cboPort 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmMain.frx":16D3E
            Left            =   2190
            List            =   "frmMain.frx":16D40
            TabIndex        =   63
            Top             =   390
            Width           =   2205
         End
         Begin VB.ComboBox cboBaudrate 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmMain.frx":16D42
            Left            =   2190
            List            =   "frmMain.frx":16D44
            TabIndex        =   62
            Top             =   780
            Width           =   2205
         End
         Begin VB.ComboBox cboDatabit 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmMain.frx":16D46
            Left            =   2190
            List            =   "frmMain.frx":16D48
            TabIndex        =   61
            Top             =   1170
            Width           =   2205
         End
         ...
         Begin VB.ComboBox cboParity 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmMain.frx":16D4A
            Left            =   2190
            List            =   "frmMain.frx":16D4C
            TabIndex        =   58
            Top             =   2520
            Width           =   2205
         End
   ...
   Begin VB.Frame frame2 
      ...
      Begin FPSpread.vaSpread spdRResult 
         ...
         SelectBlockOptions=   0
         ShadowColor     =   13697023
         SpreadDesigner  =   "frmMain.frx":184CA
         TextTip         =   2
      End
      Begin FPSpread.vaSpread spdROrder 
         ...
         SelectBlockOptions=   0
         ShadowColor     =   14548991
         SpreadDesigner  =   "frmMain.frx":18E9B
         UserResize      =   2
      End
                    ...
                    If strIntBase <> "" And strResult <> "" Then
                        If gPatOrdCd <> "" Then
                            ...
                            If Not RS_L.EOF = True And Not RS_L.BOF = True Then
                                ...
                                strJudge = SetJudge_KCHART(strResult, lsTestCode)
...
Private Sub SerialRcvData_HORIBA()
    ...
    With frmMain
        ...
        For i = 0 To UBound(varRcvBuf)
            Select Case i
            Case 4
                strBarno = Mid(varRcvBuf(i), 3)
                'u 000000000AUTO_SID012               --AUTO가 나오면 끝3자리 이용해서 12로 사용
                
                
                If InStr(varRcvBuf(i), "AUTO_SID") > 0 Then
                    strSeq = Mid(strTemp1, InStr(varRcvBuf(i), "AUTO_SID") + 8)
                    For j = 1 To .spdOrder.DataRowCnt
                        If Val(GetText(.spdOrder, j, colSPECNO)) = Val(strSeq) Then
            ...
            Case 9 To 27
                strIntBase = Trim(Mid(varRcvBuf(i), 1, 2))
                strResult = Trim(Mid(varRcvBuf(i), 3))
...
Private Sub SerialRcvData_UrinscanOptima()
    Dim RS_L            As ADODB.Recordset
    Dim strRcvBuf       As String   '수신한 Data
    Dim strType         As String   '수신한 Record Type
    Dim strBarno        As String   '수신한 바코드번호
...
Public Sub TCPRcvData_BS240PRO_HL7()
    Dim RS_L            As ADODB.Recordset
    Dim strRcvBuf    As String   '수신한 Data
    Dim strType      As String   '수신한 Record Type
    Dim strBarno     As String   '수신한 바코드번호
            ...
            Select Case strType
                Case "MSH"
                    ...
                    Select Case mOrder.BSMType
                        ...
                        Case "ACK^Q03"
                            '-- 최초이후전송
                            Call GetOrder_BS240PRO_HL7(strBarno, gHOSP.RSTTYPE)
                ...
                Case "PID"
                    ...
                    Call SetPatInfo_BS240PRO_HL7(strBarno, gHOSP.RSTTYPE)
...
Public Sub SetPatInfo_BS240PRO_HL7(ByVal pBarno As String, ByVal pType As String)
...
'                   3 : 체크된것중 제일 위에 것
'-----------------------------------------------------------------------------'
Private Sub GetOrder_BS240PRO_HL7(ByVal pBarno As String, ByVal pType As String) ', _
    ...
    With frmMain
        ...
        '-- 로컬테이블에서 검사항목에 해당하는 검사채널 찾아오기 (intRow = 기존 검사했던 바코드가 다시 올라올 경우 위치를 못찾는다.)
        strItems = GetEquipExamCode_BS240PRO_HL7(gHOSP.MACHCD, pBarno, intRow)
...
'검체번호에 존재하는 장비번호 해당하는 수가코드 가져오기
'한 장비 번호에 검사코드가 1개이상 존재
Private Function GetEquipExamCode_BS240PRO_HL7(argEquipCode As String, argPID As String, Optional intRow As Long) As String
    Dim i As Integer
    Dim sExamCode As String
    Dim strExamCode As String
    Dim sSpecNo     As String
    ...
    GetEquipExamCode_BS240PRO_HL7 = strExamCode
