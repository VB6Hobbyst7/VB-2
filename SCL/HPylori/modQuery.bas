    ...
    With frmMain
        ...
        If Not RsLocal.EOF = True And Not RsLocal.BOF = True Then
            Do Until RsLocal.EOF
                ...
                If strPatID <> "" And strTestCd <> "" And sResult <> "" Then
                    If UCase(sResult) = "ERROR" Then
                        blnSave = False
                    ElseIf UCase(sResult) = "INVALID" Then
                        blnSave = False
                    Else
                        '-- 서버저장
                        SQL = ""
                        ...
                        SQL = SQL & "   And mcode       = '" & mResult.EqpCd & "'    " & vbCrLf 'mResult.EqpCd
        ...
        If strBarcode <> "" And blnSave = False Then
            Set AdoCmd = New ADODB.Command
            Set AdoCmd.ActiveConnection = AdoCn
            With AdoCmd
                .CommandTimeout = 15
...
On Error GoTo DBErr
    ...
    Call SetSQLData("바코드조회", strBarcode & ":" & mResult.EqpCd, "A")
