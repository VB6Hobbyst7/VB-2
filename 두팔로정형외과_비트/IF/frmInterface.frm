...
Begin VB.Form frmInterface 
   ...
   Begin FPSpread.vaSpread spdResult 
      ...
      ScrollBarExtMode=   -1  'True
      ShadowColor     =   16777215
      SpreadDesigner  =   "frmInterface.frx":5FA5
      ScrollBarTrack  =   3
      ShowScrollTips  =   3
   End
   ...
   Begin FPSpread.vaSpread spdWork 
      ...
      ScrollBarExtMode=   -1  'True
      ShadowColor     =   16777215
      SpreadDesigner  =   "frmInterface.frx":B4C1
      ScrollBarTrack  =   3
      ShowScrollTips  =   3
   End
End
...
Private Sub cmdOrderSend_Click()
    ...
    If UCase(gHOSP.MACHNM) = "DOTTO2000" Then
        ...
        With spdOrder
            If .MaxRows > 0 Then
                For i = 1 To .MaxRows
                    .Row = i
                    .Col = colCHECKBOX
                    If .Value = "1" And GetText(spdOrder, i, colSTATE) = "오더준비" Then
...
Private Sub cmdSearch_Click()
    ...
    With spdWork
        .MaxRows = .MaxRows + 10
        For i = 1 To .MaxRows
            Call SetText(spdWork, CStr(i + 5561), i, colBARCODE)
            Call SetText(spdWork, "^^^ALP\^^^BUN\^^^GGT\^^^TP", i, colSPECIMEN)
            ...
            Case "L"
                ...
                For i = colSTATE + 1 To spdOrder.MaxCols
                    ...
                    If spdOrder.FontBold = True Then
                        ...
                        '-- 하나의 검사항목당 "%"가 2개 이므로
                        For j = 1 To UBound(varCalCulate) Step 2
