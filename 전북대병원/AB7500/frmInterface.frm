...
Begin VB.Form frmInterface 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin FPSpread.vaSpread vasRes 
         ...
         RetainSelBlock  =   0   'False
         ScrollBars      =   2
         SpreadDesigner  =   "frmInterface.frx":2331
      End
   End
   ...
   Begin VB.Frame FrmHideControl 
      ...
      Begin VB.Frame Frame4 
         ...
         Begin FPSpread.vaSpread vasPrint 
            ...
            EndProperty
            MaxCols         =   9
            SpreadDesigner  =   "frmInterface.frx":3A1E
         End
         Begin FPSpread.vaSpread vasPrintBuf 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            SpreadDesigner  =   "frmInterface.frx":5497
         End
      End
      ...
      Begin FPSpread.vaSpread vasCode 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":56AF
      End
      Begin FPSpread.vaSpread vasTemp1 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":58C7
      End
         ...
         Begin MSComctlLib.ImageList imlStatus 
            ...
            BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
               ...
               BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":6069
                  Key             =   "RUN"
               EndProperty
               BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":6603
                  Key             =   "NOT"
               EndProperty
               BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":6B9D
                  Key             =   "STOP"
               EndProperty
               BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":7137
                  Key             =   "LST"
               EndProperty
               BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":79C9
                  Key             =   "ITM"
               EndProperty
               BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":7B23
                  Key             =   "ERR"
               EndProperty
               BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":7C7D
                  Key             =   "NOF"
               EndProperty
            EndProperty
         End
      ...
      Begin FPSpread.vaSpread vasList 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":7DD7
      End
      Begin FPSpread.vaSpread vasResTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":7FEF
      End
      Begin FPSpread.vaSpread vasTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":8207
      End
...
'Dim tot_row_count As Long
  ...
  ' CommonDialog1.Filter = "Excel(*.xlsx)|*.xlsx|Excel(*.xls)|*.xls"
    ...
    Call xlApp.Workbooks.Open(Trim(CommonDialog1.Filename))
    ...
    For i = 1 To lngSCnt
        ...
        xlApp.ActiveWorkbook.SaveAs "C:\AB7500_EXCEL\" & Trim(i) & ".txt", xlText, "", "", False, False '==>2000 + 2003 공용
...
'''        Open (App.Path & "\" & Trim(i) & ".txt") For Input As #1
        Open ("C:\AB7500_EXCEL\" & Trim(i) & ".txt") For Input As #1
        While Not EOF(1)
            Line Input #1, dummy
...
Private Sub cmdResult_Click()
    ...
    Dim strFamRslt  As String
    Dim strVicRslt  As String
...
'On Error Resume Next
    ...
    With vasExcel
        For intRow = 8 To .DataRowCnt
            .GetText 2, intRow, varTmp: sSeq = varTmp
            .GetText 1, intRow, varTmp: sWell = varTmp
            If sSeq <> "" Then
                With mResult
                    .BarNo = sSeq
                ...
                If strIntBase = "FAM" Then
                    .GetText 7, intRow, varTmp: strFamRslt = varTmp
                    .GetText 7, intRow - 1, varTmp: strVicRslt = varTmp

                    If IsNumeric(strFamRslt) Then
                        strLisResult = "Positive"
                    Else
                        If IsNumeric(strVicRslt) Then
                            If strVicRslt < 35 Then
                                strLisResult = "Negative" ' & " (" & Format(strVicRslt, "#.#0") & ")"
                            Else
                                strLisResult = ""   'Retest
                            End If
                        Else
                            strLisResult = strVicRslt
                        End If
                    End If
...
'                    End If
                    ...
                    If strLisResult <> "" And strLisResult <> "ReTest" Then
...
Function Convert2EXP(ByVal srcV#, Optional fmt$) As String
    ...
    ElseIf Right(Convert2EXP, 2) = "02" Then
        ...
        Convert2EXP = Format(Convert2EXP, "#.#0")
    Else
        Convert2EXP = Format(Mid(Convert2EXP, 1, InStr(Convert2EXP, "E") - 1), "#.#0") & "X10^" & Mid(Convert2EXP, InStr(Convert2EXP, "E") + 2)
        'Convert2EXP = Convert2EXP * 100
        'Convert2EXP = Format(Convert2EXP, "#.#0")
    End If
...
Private Sub GetWorkList_JBUNIV(ByVal pFrDt As String, ByVal pToDt As String, Optional pBarNo As String)
    ...
    If Not RS.EOF = True And Not RS.BOF = True Then
        ...
        Do Until RS.EOF
            ...
            If txtRack.Text = "13" And txtPos.Text = "H" Then
                txtRack.Text = "1"
                txtPos.Text = "A"
            End If
...
Private Sub Label1_DblClick(Index As Integer)
    If vasExcel.Visible = True Then
        vasExcel.Visible = False
    Else
...
Private Sub SetPatInfo(ByVal pBarNo As String, Optional ByVal pRno As String, Optional ByVal pPno As String)
    ...
    '-- Well
    For i = 1 To vasID.DataRowCnt
        If Trim(GetText(vasID, i, colDISKNO)) = mResult.RackNo Then
            If Trim(GetText(vasID, i, colPOSNO)) = mResult.TubePos Then
...
'        Call SetText(vasID, mResult.RsltSeq, intRow, colSAVESEQ)
    ...
    'Call GetSampleInfoW_JBUNIV(intRow)
