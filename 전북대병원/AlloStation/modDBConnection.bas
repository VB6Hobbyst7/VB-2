...
'Allo JetDB
Global AdoCn_Allo          As ADODB.Connection
Global AdoRs_Allo          As ADODB.Recordset
Global AdoRs_Allo2         As ADODB.Recordset
Global AdoCmd_Allo         As ADODB.Command
Global AdoParm_Allo        As ADODB.Parameter
