...
Public Sub SetPatInfo(ByVal pBarNo As String, ByVal pType As String)
    ...
    With frmMain
            ...
            Case "0"
                For i = 1 To .spdOrder.DataRowCnt
                    If GetText(frmMain.spdOrder, i, colBARCODE) = pBarNo Then
                        If GetText(frmMain.spdOrder, i, colINOUT) = mResult.Kind Then
                            intRow = i
                            Exit For
                        End If
                    End If
        ...
        Call SetText(.spdOrder, mResult.Kind, intRow, colINOUT)
...
Function SaveTransData(ByVal argSpcRow As Integer, ByVal SPD As Object) As Integer
    ...
    Select Case gEMR
        Case "JBUNIV"
            SaveTransData = SaveTransData_JBUNIV(argSpcRow, SPD)
