...
'SetRawData strInVal
                ...
                With AdoCmd
                    ...
                    Set prm7 = .CreateParameter("in_rstflg", adVarChar, adParamInput, 2000, "1")
                    .Parameters.Append prm7               '상태: 1(결과저장), 2(중간보고), 3(최종보고)
...
'    SQL = SQL & " WHERE j011m.bcno              = '" & strBarcode & "'      " & vbCrLf
    SQL = SQL & " WHERE j011m.bcno              = fn_ack_get_bcno_normal(" & strBarcode & ")" & vbCrLf
    SQL = SQL & "   AND j011m.spcflg            = '4'                       " & vbCrLf
    SQL = SQL & "   AND NVL(j011m.rstflg, '0')  = '0'                       " & vbCrLf
    SQL = SQL & " UNION                                                     " & vbCrLf
    SQL = SQL & " SELECT "
