...
Begin VB.Form frmInterface 
   ...
   ScaleWidth      =   16080
   WindowState     =   2  '최대화
   Begin FPSpreadADO.fpSpread spdJobFail 
   ...
   End
   Begin FPSpreadADO.fpSpread spdPatOrder 
      Height          =   2265
      Left            =   6900
      TabIndex        =   86
      Top             =   3210
      ...
      MaxCols         =   2
      MaxRows         =   1
      SpreadDesigner  =   "frmInterface.frx":5DEF
   End
      ...
      Begin MSComctlLib.ImageList imlStatus 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmInterface.frx":626D
               Key             =   "RUN"
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmInterface.frx":6807
               Key             =   "NOT"
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmInterface.frx":6DA1
               Key             =   "STOP"
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmInterface.frx":733B
               Key             =   "LST"
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmInterface.frx":7BCD
               Key             =   "ITM"
            EndProperty
            BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmInterface.frx":7D27
               Key             =   "ERR"
            EndProperty
            BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmInterface.frx":7E81
               Key             =   "NOF"
            EndProperty
            BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmInterface.frx":7FDB
               Key             =   "ON"
               Object.Tag             =   "OFF"
            EndProperty
            BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmInterface.frx":88B5
               Key             =   ""
            EndProperty
         EndProperty
      End
   ...
   Begin FPSpreadADO.fpSpread spdWork 
      ...
      ShadowColor     =   14737632
      ShadowDark      =   12632256
      SpreadDesigner  =   "frmInterface.frx":B859
      VisibleCols     =   3
      VisibleRows     =   10
      ScrollBarTrack  =   1
      ShowScrollTips  =   1
   ...
   Begin FPSpreadADO.fpSpread spdOrder 
      ...
      ShadowColor     =   14737632
      ShadowDark      =   12632256
      SpreadDesigner  =   "frmInterface.frx":C575
      UnitType        =   0
      VisibleCols     =   3
      VisibleRows     =   10
      ScrollBarTrack  =   3
   ...
   Begin FPSpreadADO.fpSpread spdResult 
      ...
      ShadowColor     =   14737632
      ShadowDark      =   12632256
      SpreadDesigner  =   "frmInterface.frx":D239
      VisibleCols     =   3
      VisibleRows     =   10
      CellNoteIndicatorColor=   16576
      HighlightAlphaBlendColor=   16755285
...
Private mIntIF          As clsIISInterface    '인터페이스 클래스
        ...
        For intWRow = 1 To .MaxRows
            ...
            If .Value = "1" Then
                ...
                If blnSame = False Then
                    ...
                    Call SetText(spdOrder, txtRackNo.Text, intWRow, colRACKNO)
                    Call SetText(spdOrder, txtPosNo.Text, intWRow, colPOSNO)
                    txtPosNo.Text = txtPosNo.Text + 1
                    If txtPosNo.Text > 103 Then
                        txtRackNo.Text = txtRackNo.Text + 1
                        txtPosNo.Text = 1
                    End If
...
'                Call SetText(spdWork, "^^^910^\^^^120^", i, colSPECIMEN)
'                Call SetText(spdWork, "오더준비", i, colSTATE)
'
'            Next
...
'    End If
    ...
    '이미 등록된 사람은 뺀다.
    For i = spdWork.MaxRows To 1 Step -1
        For j = 1 To spdOrder.MaxRows
            If GetText(spdWork, i, colBARCODE) = GetText(spdOrder, j, colBARCODE) Then
                DeleteRow spdWork, i, i
                spdWork.MaxRows = spdWork.MaxRows - 1
                GoTo RST
            End If
        Next
...
Private Sub ReceiveProcess()
    ...
    If gComm.COMTYPE = "1" Then
        ...
        Select Case UCase(gHOSP.MACHNM)
            ...
            Case "E411":            Call Phase_Serial_E411
            Case "E411_BATCH":      Call Phase_Serial_E411_Batch
            Case "BM850":           Call Phase_Serial_SWELAB
    ...
    ElseIf gComm.COMTYPE = "2" Then
        Select Case UCase(gHOSP.MACHNM)
            Case "XL200":           Call Phase_TCP_XL200
            'Case "BM850":           Call TCPRcvData_BM850
...
Private Sub GetOrder_E411(ByVal pBarno As String, ByVal pType As String)
    Dim i           As Integer
    Dim intRow      As Long
    Dim strItems    As String
    Dim strOrder    As String
    ...
    With frmInterface
        ...
        '-- 로컬테이블에서 검사항목에 해당하는 검사채널 찾아오기 (intRow = 기존 검사했던 바코드가 다시 올라올 경우 위치를 못찾는다.)
        strItems = GetEquipExamCode_E411(gHOSP.MACHCD, pBarno, intRow)
...
Private Sub GetOrder_LIAISON(ByVal pBarno As String, ByVal pType As String)
    ...
    With frmInterface
        ...
        Else
            ...
            '-- 진행상태(Order) 표시
            Call SetText(frmInterface.spdOrder, "오더준비", intRow, colSTATE)
            Call SetText(frmInterface.spdOrder, strItems, intRow, colSPECIMEN)
...
'-- 장비로 전송 및 기록
Public Sub SendData(ByVal pSendData As Variant)
...
'                    End If
                ...
                Case "OBX"
'                    OBX|1|ST|ID2||""||||||P<CR>
'                    OBX|2|ST|PROF||Blood||||||P<CR>
'                    OBX|3|ST|METH||OT||||||P<CR>
'                    OBX|4|ST|OPID||Operator||||||P<CR>
'                    OBX|5|NM|RBC||4.67|10*12/L|3.50-5.50|""|||P<CR>
...
ErrHandle:
    strErrMsg = ""
    strErrMsg = strErrMsg & "위    치 : " & gHOSP.MACHNM & "_TCPRcvData_BM850" & vbNewLine & vbNewLine
    strErrMsg = strErrMsg & "오류번호 : " & Err.Number & vbNewLine & vbNewLine
    strErrMsg = strErrMsg & "오류내용 : " & Err.Description & vbNewLine
    frmErrMsg.txtErr = vbNewLine & strErrMsg
    frmErrMsg.Show
...
Private Function ResultProcess(ByVal pBarno As String, ByVal pIntBase As String, ByVal pResult As String, ByVal pIntResult As String) As Boolean
    ...
    Dim strMachResult   As String   '수신한 장비결과
    Dim strAMRResult    As String   '수신한 결과(정성)
    Dim strUseFormat    As String   '장비결과형태
    ...
    If Not RS_L.EOF = True And Not RS_L.BOF = True Then
        ...
        strUseFormat = Trim(RS_L.Fields("AMRINResult")) & ""
        
        '# 1 # 소수점변환 사용여부와 변환자리수 가져온다.
        intResPrecUse = Trim(RS_L.Fields("RESPRECUSE")) & ""
        ...
        If mResult.Kind = "QC" Then
            ...
            '-- 수치결과 안에 문자값이 있을 경우 제외(<, >, = 등)
            If InStr(strIntResult, "<") > 0 Then
            ...
            If intResPrecUse = 1 Then
                For i = 0 To intResPrec
                    ...
                    End If
                Next
                strIntResult = Format(strIntResult, strResType)
            End If
            '최종결과
            strResult = strIntResult
        Else
            '사용결과  (0:수치결과사용,1:문자결과사용,2:둘다사용)
            ...
            If strResType = 0 Then
                ...
                If IsNumeric(strIntResult) Then
                    blnAMRChange = False
                    If Trim(RS_L.Fields("AMRNUMLIMIT1")) & "" <> "" Then
                        If CCur(strIntResult) < CCur(Trim(RS_L.Fields("AMRNUMLIMIT1"))) Then
                            strChrResult = Trim(RS_L.Fields("AMRNUMRESULT1"))
                            blnAMRChange = True
                        End If
                    End If
                    If Trim(RS_L.Fields("AMRNUMLIMIT2")) & "" <> "" Then
                        If CCur(strIntResult) <= CCur(Trim(RS_L.Fields("AMRNUMLIMIT2"))) Then
                            strChrResult = Trim(RS_L.Fields("AMRNUMRESULT2"))
                            blnAMRChange = True
                        End If
                    End If
                    If Trim(RS_L.Fields("AMRNUMLIMIT3")) & "" <> "" Then
                        If CCur(strIntResult) > CCur(Trim(RS_L.Fields("AMRNUMLIMIT3"))) Then
                            strChrResult = Trim(RS_L.Fields("AMRNUMRESULT3"))
                            blnAMRChange = True
                        End If
                    End If
                    If Trim(RS_L.Fields("AMRNUMLIMIT4")) & "" <> "" Then
                        If CCur(strIntResult) >= CCur(Trim(RS_L.Fields("AMRNUMLIMIT4"))) Then
                            strChrResult = Trim(RS_L.Fields("AMRNUMRESULT4"))
                            blnAMRChange = True
                        End If
                    End If
                    If Trim(RS_L.Fields("AMRNUMLIMIT5")) & "" <> "" Then
                        If blnAMRChange = False Then
                            strChrResult = Trim(RS_L.Fields("AMRNUMRESULT5"))
                        End If
                    End If
                End If
                
                '-- 최종결과
                If strUseFormat > 0 Then
                    If strIntResult <> "" And strChrResult <> "" Then
                        If strUseFormat = "1" Then
                            strResult = strChrResult & "(" & strIntResult & ")"
                        ElseIf strUseFormat = "2" Then
            ...
            ElseIf strResType = 1 Then
                ...
                If strChrResult <> "" Then
                    '-- AMR 적용 (문자형)
                    If Trim(RS_L.Fields("AMRCHARLIMIT1")) & "" <> "" Then
                        If pResult = Trim(RS_L.Fields("AMRCHARLIMIT1")) Then
                            strChrResult = Trim(RS_L.Fields("AMRCHARRESULT1"))
                            blnAMRChange = True
                        End If
                    End If
                    If Trim(RS_L.Fields("AMRCHARLIMIT2")) & "" <> "" Then
                        If pResult = Trim(RS_L.Fields("AMRCHARLIMIT2")) Then
                            strChrResult = Trim(RS_L.Fields("AMRCHARRESULT2"))
                            blnAMRChange = True
                        End If
                    End If
                    If Trim(RS_L.Fields("AMRCHARLIMIT3")) & "" <> "" Then
                        If pResult = Trim(RS_L.Fields("AMRCHARLIMIT3")) Then
                            strChrResult = Trim(RS_L.Fields("AMRCHARRESULT3"))
                            blnAMRChange = True
                        End If
                    End If
                    If Trim(RS_L.Fields("AMRCHARLIMIT4")) & "" <> "" Then
                        If pResult = Trim(RS_L.Fields("AMRCHARLIMIT4")) Then
                            strChrResult = Trim(RS_L.Fields("AMRCHARRESULT4"))
                            blnAMRChange = True
                        End If
                    End If
                    If Trim(RS_L.Fields("AMRCHARLIMIT5")) & "" <> "" Then
                        If blnAMRChange = False Then
                            strChrResult = Trim(RS_L.Fields("AMRCHARRESULT5"))
                        End If
                    End If
...
Private Sub SerialRcvData_XL200()
    '장비 수신 변수
    Dim strRcvBuf       As String   '수신한 Data
    Dim strType         As String   '수신한 Record Type
    Dim strBarno        As String   '수신한 바코드번호
    ...
    With frmInterface
        ...
        Select Case strType
            ...
            Case "O"
                ...
                strState = "O"
            Case "R"
                'R|1|^^^EALB|4.5|g/dl|^DEFAULT|N|N|F||||20210323110755
...
RST:
    strErrMsg = ""
    strErrMsg = strErrMsg & "위    치 : " & gHOSP.MACHNM & "_SerialRcvData_XL200" & vbNewLine & vbNewLine
    strErrMsg = strErrMsg & "오류번호 : " & Err.Number & vbNewLine & vbNewLine
    strErrMsg = strErrMsg & "오류내용 : " & Err.Description & vbNewLine
    frmErrMsg.txtErr = vbNewLine & strErrMsg
    frmErrMsg.Show
...
Private Sub SerialRcvData_E411()
    '장비 수신 변수
    Dim strRcvBuf       As String   '수신한 Data
    Dim strType         As String   '수신한 Record Type
    Dim strBarno        As String   '수신한 바코드번호
    ...
    With frmInterface
        ...
        Select Case strType
            ...
            Case "Q"    '## Request Information
                ...
                strBarno = mGetP(strTemp1, 2, "^")
                strSeq = mGetP(strTemp1, 3, "^")
                strRackNo = mGetP(strTemp1, 4, "^")
                strTubePos = mGetP(strTemp1, 5, "^")
                ...
                Call GetOrder_E411(strBarno, gHOSP.RSTTYPE)
            ...
            Case "R"
                strTemp1 = mGetP(strRcvBuf, 3, "|")
                strIntBase = mGetP(mGetP(strTemp1, 4, "^"), 1, "/")
                strTemp2 = mGetP(strRcvBuf, 4, "|")
                strFlag = mGetP(strRcvBuf, 7, "|")
...
RST:
    strErrMsg = ""
    strErrMsg = strErrMsg & "위    치 : " & gHOSP.MACHNM & "_SerialRcvData_E411" & vbNewLine & vbNewLine
    strErrMsg = strErrMsg & "오류번호 : " & Err.Number & vbNewLine & vbNewLine
    strErrMsg = strErrMsg & "오류내용 : " & Err.Description & vbNewLine
    frmErrMsg.txtErr = vbNewLine & strErrMsg
    frmErrMsg.Show
...
On Error GoTo RST
    ...
    With frmInterface
        For Each objBuffer In mIntIF.Buffers
            ...
            Select Case strType
                ...
                Case "L"
                    ...
                    '## DB에 결과저장
                    If cn_Server_Flag = True And gHOSP.SAVEAUTO = "Y" And mIntIF.State = "R" Then
                        Dim strBarcode  As String
                        Dim strPatNm    As String
                        
                        strBarcode = Trim(GetText(spdOrder, gRow, colBARCODE))
                        strPatNm = Trim(GetText(spdOrder, gRow, colPNAME))
...
RST:
    strErrMsg = ""
    strErrMsg = strErrMsg & "위    치 : " & gHOSP.MACHNM & "_SerialRcvData_LIAISON" & vbNewLine & vbNewLine
    strErrMsg = strErrMsg & "오류번호 : " & Err.Number & vbNewLine & vbNewLine
    strErrMsg = strErrMsg & "오류내용 : " & Err.Description & vbNewLine
    frmErrMsg.txtErr = vbNewLine & strErrMsg
    frmErrMsg.Show
...
Private Sub SerialRcvData_LIAISON_OneFrame()
    '장비 수신 변수
    Dim strRcvBuf       As String   '수신한 Data
    Dim strType         As String   '수신한 Record Type
    Dim strBarno        As String   '수신한 바코드번호
    ...
    With frmInterface
        ...
        'For i = 0 To UBound(strRData)
            ...
            Select Case strType
                ...
                Case "O"
                    'JOBFAIL
                    '3O|1|#6850190||^^^Myco-M^|R||||||Q||||||||||||||X
                    'MORMAL
                    '7O|1|#8960190||^^^Myco-M^|R||||||Q||||||||||||||F
                    ...
                    If UCase(mGetP(strRcvBuf, 26, "|")) = "X" Then
                        spdJobFail.MaxRows = spdJobFail.MaxRows + 1
                        Call SetText(spdJobFail, mGetP(strRcvBuf, 3, "|"), spdJobFail.MaxRows, 1)
                        spdJobFail.RowHeight(-1) = gROWHEIGHT
                        'spdJobFail.ColWidth(1) = gCOLWIDTH
                ...
                Case "R"
                    ...
                    '4R|1|^^^Myco-M^^DOSE|6.7|INDEX||N||F\R||||20210407114252
                    strIntBase = Trim$(mGetP(mGetP(strRcvBuf, 3, "|"), 4, "^"))
                    strIntResult = mGetP(strRcvBuf, 4, "|")
                    strResult = mGetP(strRcvBuf, 7, "|")
                    'strResult = ""
                ...
                Case "C"
                    '2C|1|I|JOB_FAILED|I
                    strComm = Trim$(mGetP(strRcvBuf, 4, "|"))
                    mResult.MnmCd = strComm
                    
                    '검사오류(결과없음)
                    '4R|1|^^^Myco-M^^DOSE||||N||X\R||||20210415095846
                    '5C|1|I|JOB_FAILED|I   ==> 코멘트 : "JOB_FAILED"
                    '정상검사
                    '0R|1|^^^Myco-M^^DOSE|15|INDEX||N||F\R||||20210415103209
...
On Error GoTo RST
    ...
    With frmInterface
        For intCnt = 0 To UBound(strRecvData) - 1
            ...
            If strState = "O" Then
                ...
                If InStr(strRcvBuf, "<n>ID</n>") Then
                    If InStr(strRcvBuf, "<v>") Then
                        strBarno = mGetP(strRcvBuf, 5, "<")
                        strBarno = mGetP(strBarno, 2, ">")
                        If strBarno = "AUTOBACKGROUND" Then
                            Exit Sub
                        End If
                    Else
                        strBarno = Format(Now, "yymmddhhmmss")
            ...
            '## DB에 결과저장
            If gHOSP.SAVEAUTO = "Y" And strState = "L" Then
                Res = SaveTransData(gRow, spdOrder)
                Call SetUpdateStatus(spdOrder, gRow, Res)
                strState = ""
            End If
...
'-- Cobas Type (One Frame)
'-- Elecsys Type (Multi Frame)
Private Sub SendOrder_E411()
    ...
    Dim strTmp      As String
            ...
            'sTmp = m_iFrameN & "O|1|" & Trim(pSampleInfo.ID) & "|" _
                ...
                & TestDat & "|R||||||" _
                & sActionCd & "||||||||||||||" & sReportType & vbCr & Chr(3)
    
    With mOrder
        Select Case intSndPhase
            Case 1
                strOutput = intFrameNo & "H|\^&|||ASTM-Host|||||||P" & vbCr & ETX
                intSndPhase = 2
            ...
            Case 3
                If .IsSending = False Then   '## 최초 보낼때
                    If .NoOrder = True Then
                        strOutput = intFrameNo & "O|1|" & .BarNo & "|" & .Seq & "^" & Format(.RackNo, "00000") & "^" & Trim(.TubePos) & "^^SAMPLE^NORMAL|" _
                                               & .Order & "|R||||||N||||||||||||||Z"
                    Else
                        strOutput = intFrameNo & "O|1|" & .BarNo & "|" & .Seq & "^" & Format(.RackNo, "00000") & "^" & Trim(.TubePos) & "^^SAMPLE^NORMAL|" _
                                               & .Order & "|R||||||N||||||||||||||Q"
                    ...
                    If Len(strOutput) >= 241 Then
                        .NextData = Mid(strOutput, 241)
                        strOutput = LEFT(strOutput, 240)
                        strOutput = strOutput & vbCr & ETB
                        intSndPhase = 3
                    Else
                        strOutput = strOutput & vbCr & ETX
                        intSndPhase = 4
                    End If
                    .IsSending = True
                    intFrameNo = intFrameNo + 1
                Else
                    strOutput = mOrder.NextData
                    .IsSending = False
...
'-- Cobas Type (One Frame)
'-- Elecsys Type (Multi Frame)
Private Sub SendOrder_E411_Batch()
    Dim strOutput   As String     '송신할 데이터
    Dim blnLast     As Boolean
    Dim blnOrder    As Boolean
    Dim intRow      As Integer
    ...
    With spdOrder
        If intSndPhase = 1 Then
            For intRow = 1 To .DataRowCnt
                If GetText(spdOrder, intRow, colCHECKBOX) = "1" And GetText(spdOrder, intRow, colSTATE) = "오더준비" Then
                    blnOrder = True
                    With mOrder
                        .BarNo = Trim(GetText(spdOrder, intRow, colBARCODE))
                        .PID = Trim(GetText(spdOrder, intRow, colCHARTNO))
                        .Order = Trim(GetText(spdOrder, intRow, colSPECIMEN))
                        .RackNo = Trim(GetText(spdOrder, intRow, colRACKNO))
                        .TubePos = Trim(GetText(spdOrder, intRow, colPOSNO))
                        If LEFT(.RackNo, 1) = "4" Then
                            .Stat = "S"
                        Else
                            .Stat = "R"
                        End If
                    ...
                    If intRow = .DataRowCnt Then
                        mOrder.LastORDER = True
                    Else
                        mOrder.LastORDER = False
                    End If
                    gRow = intRow
                    Exit For
    ...
    With mOrder
        Select Case intSndPhase
            Case 1
                '1H|\^&|||host^1|||||cobas-e411|TSDWN^BATCH|P|1
                'P|1
                'O|1|190422-204503|^00000^1^^S1^SC|^^^900^\^^^410^\^^^630^|R||20200203082715||||A||||1||||||||||O
                'C|1|L|190422^^^^|G
                'L|1|N
                '10

                strOutput = intFrameNo
                strOutput = strOutput & "H|\^&|||host^1|||||cobas-e411|TSDWN^BATCH|P|1" & vbCr
                strOutput = strOutput & "P|1" & vbCr
                strOutput = strOutput & "O|1|" & .BarNo & "|^" & Format(.RackNo, "00000") & "^" & Trim(.TubePos) & "^^S1^SC|" _
                                      & .Order & "|" & .Stat & "||" & Format(Now, "YYYYMMDDHHMMSS") & "||||A||||" & .SPCCD & "||||||||||O" & vbCr
                'strOutput = strOutput & "C|1|L|" & .PID & "^^^^|G" & vbCr
                strOutput = strOutput & "L|1|N"

                If Len(strOutput) >= 241 Then
                    .NextData = Mid(strOutput, 241)
                    strOutput = LEFT(strOutput, 240)
                    strOutput = strOutput & ETB
            ...
            Case 2
                strOutput = intFrameNo & .NextData & vbCr & ETX
                .NextData = ""
                intSndPhase = 3
            ...
            Case 3  '## EOT
                ...
                Call SetText(spdOrder, "0", gRow, colCHECKBOX)
                Call SetText(spdOrder, "오더전송", gRow, colSTATE)
                
                Call Sleep(200)
                
                If .LastORDER = False Then
                    strState = "Q"
                    Call SendData(ENQ)
                Else
                    strState = ""
...
Private Sub Phase_Serial_E411_Batch()
    Dim Buffer      As Variant
    Dim BufChar     As String
    Dim lngBufLen   As Long
    Dim i           As Long
...
Private Sub Phase_Serial_XL200()
    Dim Buffer      As Variant
    Dim BufChar     As String
    Dim lngBufLen   As Long
    Dim i           As Long
...
Private Sub Phase_Serial_SWELAB()
    Dim Buffer      As Variant
    Dim BufChar     As String
    Dim lngBufLen   As Long
    Dim i           As Long
...
Private Sub SendOrder_LIAISON()
        ...
        If intSndPhase <= 3 Then
            For intRow = 1 To .DataRowCnt
                If GetText(spdOrder, intRow, colCHECKBOX) = "1" And GetText(spdOrder, intRow, colSTATE) = "오더준비" Then
                    ...
                    strBarno = Trim(GetText(spdOrder, intRow, colBARCODE))
                    strPtId = Trim(GetText(spdOrder, intRow, colCHARTNO))
                    strItems = Trim(GetText(spdOrder, intRow, colSPECIMEN))
    ...
    If intRow = spdOrder.DataRowCnt Then
        blnLast = True
    End If
...
'    If gPhaseFrame = "1" Then
    If gPhaseFrame = "99" Then
        For ix1 = 1 To lngBufLen
            BufChar = Mid$(pBuffer, ix1, 1)
            ...
            Select Case intPhase
                ...
                Case 2
                    Select Case Asc(BufChar)
                        ...
                        Case 10     'LF
                            If bEndChk = True Then
                                Call SerialRcvData_LIAISON_OneFrame
                                RcvBuffer = ""
                            End If
                            Call SendData(ACK)
            ...
            Select Case mIntIF.Phase
                ...
                Case 2      '## Transfer Phase
                    Select Case BufChar
                        ...
                        Case ETX
                            mIntIF.Phase = 3
                            mIntIF.BufCnt = mIntIF.BufCnt + 1
                        Case EOT
                            mIntIF.Phase = 1
                        Case vbCr
                        Case Else
                            If mIntIF.IsETB = False Then
                                Call mIntIF.AddBuffer(BufChar)
                            Else
                                mIntIF.IsETB = False
                            End If
                    End Select
                Case 3      '## Transfer Phase
                    Select Case BufChar
                        Case vbCr
                        Case vbLf
                            mIntIF.Phase = IIf(mIntIF.IsETB = False, 4, 2)
                            Call SendData(ACK)
                    End Select
                Case 4      '## Termination Phase
                    Select Case BufChar
...
On Error GoTo ErrHandle
    ...
    Set mIntIF = New clsIISInterface
...
Private Sub spdJobFail_DblClick(ByVal Col As Long, ByVal Row As Long)

    If MsgBox("화면을 지우시겠습니까?", vbInformation + vbYesNo, "알림") = vbYes Then
        spdJobFail.MaxRows = 0
        spdJobFail.Visible = False
    End If
    ...
    If KeyCode = vbKeyReturn Then
        If colBARCODE = sCol Then
            ...
            Else
                ...
                '처방난 검사명 검사코드를 갖고있음
                For i = 1 To spdPatOrder.MaxRows
                    For j = colSTATE + 1 To spdOrder.MaxCols
                        spdOrder.Row = sRow
                        spdOrder.Col = j
                        'If spdOrder.BackColor = &HC0FFFF Then
                        If spdOrder.Text <> "" Then
                            spdOrder.Row = 0
                            spdOrder.Col = j
                            '대상 검사코드
                            strTestCds = GetTestCd(spdOrder.Text)
                            If GetText(spdPatOrder, i, 1) = spdOrder.Text Then
                                SQL = ""
                                SQL = SQL & "UPDATE PATRESULT SET "
                                SQL = SQL & "  EXAMCODE  = '" & GetText(spdPatOrder, i, 2) & "'" & vbCrLf
                                SQL = SQL & " WHERE EQUIPNO  = '" & gHOSP.MACHCD & "'" & vbCrLf
                                SQL = SQL & "   AND EXAMDATE = '" & Trim(GetText(spdOrder, sRow, colEXAMDATE)) & "'" & vbCrLf
                                SQL = SQL & "   AND EXAMTIME = '" & Trim(GetText(spdOrder, sRow, colEXAMTIME)) & "'" & vbCrLf
                                SQL = SQL & "   AND SAVESEQ  = " & Trim(GetText(spdOrder, sRow, colSAVESEQ)) & vbCrLf
                                SQL = SQL & "   AND EXAMCODE IN (" & strTestCds & ")" & vbCrLf
        ...
        ElseIf sCol = colSEQNO Then
            ...
            End With
        '검사결과 수정
        ElseIf sCol > colSTATE And sCol <= spdOrder.MaxCols Then
            If strNewBarNo = "" Then
                Exit Sub
            End If
            ...
            With spdOrder
                With mResult
                    ...
                    If strSaveSeq = "" Then
                        ...
                        Call SetText(spdOrder, .RsltDate, sRow, colEXAMDATE)
                        Call SetText(spdOrder, .RsltTime, sRow, colEXAMTIME)
                        Call SetText(spdOrder, .RsltSeq, sRow, colSAVESEQ)
                    Else
                        .RsltDate = GetText(spdOrder, sRow, colEXAMDATE)
                        .RsltTime = GetText(spdOrder, sRow, colEXAMTIME)
                        .RsltSeq = GetText(spdOrder, sRow, colSAVESEQ)
                    End If
                End With
                
                '-- 결과환자정보
                Call GetSampleInfo(sRow, spdOrder)
                    
                gRow = sRow
                strTestNm = GetText(spdOrder, 0, sCol)      '입력한 컬럼의 검사명 찾기
                strIntBase = GetChannel(strTestNm)          '검사명으로 채널찾기
                strResult = GetText(spdOrder, sRow, sCol)   '결과값
                ...
                If gHOSP.PARTNM = "LFT" Then
                    ...
                    For intCol = colSTATE + 1 To spdOrder.MaxCols
                        With spdOrder
                            ...
                            .Col = intCol
                            Select Case .Text
                                Case "TC":  strTC = GetText(spdOrder, sRow, intCol)
                                Case "TG":  strTG = GetText(spdOrder, sRow, intCol)
                                Case "HDL": strHDL = GetText(spdOrder, sRow, intCol)
                                Case "BUN": strBUN = GetText(spdOrder, sRow, intCol)
                                Case "CRE": strCREA = GetText(spdOrder, sRow, intCol)
                            End Select
                        End With
                    Next
...
Private Sub spdWork_DblClick(ByVal Col As Long, ByVal Row As Long)
    ...
    With spdOrder
        ...
        If blnSame = False Then
            ...
            Call SetText(spdOrder, txtRackNo.Text, intRow, colRACKNO)
            Call SetText(spdOrder, txtPosNo.Text, intRow, colPOSNO)
            txtPosNo.Text = txtPosNo.Text + 1
            If txtPosNo.Text > 103 Then
                txtRackNo.Text = txtRackNo.Text + 1
                txtPosNo.Text = 1
...
ErrHandle:
    ...
    strErrMsg = strErrMsg & "오류내용 : " & Err.Description & vbNewLine
    frmErrMsg.txtErr = vbNewLine & strErrMsg
    MDIIF.lblDBStatus.Caption = Format(Now, "hh:mm:ss") & " 데이터베이스 연결실패"
'    frmErrMsg.Show
...
'-- 아래는 파일 통신 예제임
'https://blog.daum.net/admlrogers/7835699
' Dim rMsg As String
    Dim rMsg() As Byte
    Dim pos As Long
    Dim size As Long
    ...
    ' 수신하니 주의바람.
    wSck.GetData rMsg, vbArray + vbByte ' 바이트배열 형태로 데이터 수신
    ...
    pos = InStrB(1, mLeftData, ChrB(&HE) & ChrB(&H8) & ChrB(&H44) & ChrB(&H13))
    If pos < 1 Then
    ...
    If LenB(MidB(mLeftData, pos + 4, 8)) < 8 Then
    ...
    ' 수신된 데이타크기를 숫자로 변환한다.
    size = Val(StrConv(MidB(mLeftData, pos + 4, 8), vbUnicode))

    ' 수신될 데이타의 크기를 받았으므로 이제는 데이타의 타입을 확인해 본다.
    If LenB(MidB(mLeftData, pos + 4 + 8, 1)) < 1 Then
        ' 데이타크기 다음에 데이타 타입정보가 아직 수신되지 안았기 때문에 이벤트를 빠져나간다.
        Exit Sub
    End If

    ' 수신된 데이타 타입을 ASCII에서 문자형(UNICODE)으로 변환한다.
    dataType = StrConv(MidB(mLeftData, pos + 4 + 8, 1), vbUnicode)
    ...
    data = MidB(mLeftData, pos + 4 + 8 + 1, size)
