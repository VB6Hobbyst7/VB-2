...
'    SQL = SQL & " ORDER BY R.SPCMNO                                             " & vbCr
    ...
    SQL = SQL & "       b.OBODSDTE          as HOSPDATE " & vbCr    '처방시작일
...
'    SQL = SQL & "   AND (c.OBSURSLT IS NULL OR c.OBSURSLT = '')" & vbCr                 '검사결과
    ...
    SQL = SQL & "   AND b.OBODSDTE between '" & pFrom & "' AND '" & pTo & "'" & vbCr    '처방시작일
    ...
    SQL = SQL & " GROUP BY b.OBODSDTE, b.OBODMRNO, b.OBODCASE, b.OBODORNO, b.OBODIOGB, a.APATNAME, a.APATPSEX, a.APATJMN1, a.APATJMN2" & vbCr
    SQL = SQL & " Order by b.OBODSDTE, b.OBODMRNO" & vbCr
...
'    SQL = SQL & "     , b.OBODORSQ          as ORDCODE  " & vbCr    'ORDER SEQUENCE
                        '-- 처방코드
                        gArrEQP(intCol - colSTATE, 16) = Trim(RS.Fields("PID")) & ""
                        gArrEQP(intCol - colSTATE, 17) = Trim(RS.Fields("ORDCODE")) & ""
