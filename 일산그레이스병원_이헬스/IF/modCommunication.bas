    ...
    With frmMain
        ...
        For intRow = 1 To .vasTemp.DataRowCnt
            ...
            If strBarcode <> "" And strTestCd <> "" And sResult <> "" Then
                ...
                SQL = SQL & "   And OBSUORNO = '" & strOrdCd & "'" & vbCr
                SQL = SQL & "   And OBSUORSQ = '" & strSubCode & "'" & vbCr
...
Function SaveTransDataR_EHEALTH(ByVal argSpcRow As Integer) As Integer
    Dim RS_L            As ADODB.Recordset
    Dim intRow          As Integer
    Dim strDate         As String
    Dim strTime         As String
...
'            SaveTransDataR = SaveTransDataR_EONM(argSpcRow)
        ...
        Case "EHEALTH"
            SaveTransDataR = SaveTransDataR_EHEALTH(argSpcRow)
