...
Begin VB.Form frmInterface 
   ...
   Begin FPSpread.vaSpread spdResult 
      ...
      ScrollBarExtMode=   -1  'True
      ShadowColor     =   16777215
      SpreadDesigner  =   "frmInterface.frx":B2CD
      ScrollBarTrack  =   3
      ShowScrollTips  =   3
   End
   ...
   Begin VB.PictureBox picBottom 
      ...
      Begin VB.Image imgNet1 
         Height          =   240
         Left            =   390
         Picture         =   "frmInterface.frx":10138
         Top             =   180
         Width           =   240
      End
      Begin VB.Image imgNet2 
         Height          =   240
         Left            =   390
         Picture         =   "frmInterface.frx":10282
         Top             =   180
         Width           =   240
      End
      Begin VB.Image imgNet3 
         Height          =   240
         Left            =   390
         Picture         =   "frmInterface.frx":103CC
         Top             =   180
         Width           =   240
      End
   ...
   Begin FPSpread.vaSpread spdWork 
      ...
      ScrollBarExtMode=   -1  'True
      ShadowColor     =   16777215
      SpreadDesigner  =   "frmInterface.frx":10516
      ScrollBarTrack  =   3
      ShowScrollTips  =   3
   End
End
...
Private Sub ReceiveProcess()
    ...
    If gComm.COMTYPE = "1" Then
        ...
        Select Case UCase(gHOSP.MACHNM)
            Case "NX10N":           Call Phase_Serial_NX10N
...
'                        End If
                    ...
                    If strCREA <> "" And IsNumeric(strCREA) Then
                        '18세 이상만 적용
                        If mPatient.AGE <> "" And IsNumeric(mPatient.AGE) Then 'And CCur(mPatient.AGE) > 18
...
Private Sub SerialRcvData_NX10N()
    Dim RS_L            As ADODB.Recordset
...
On Error GoTo RST
    ...
    With frmInterface
        ...
        If strType = "N" Then
            'NORMAL 20.19-12-1310:4819121356439  19121356439  01NH3-W  =22       ug/dl 1            
            
'            NORMAL 2020-08-1111:421            1            01NH3-W  =20       ug/dl 1            
'            NORMAL 2020-08-1111:421            1            01NH3-W  =20       ug/dl 1            
'            NORMAL 2020-08-1210:060            0            01NH3-W  =80       ug/dl 1            
'            NORMAL 2020-08-1210:102200087199   2200087199   01NH3-W  =135      ug/dl 1            
            ...
            strIntResult = strResult
            strFlag = Trim$(Mid(strRcvBuf, 58, 1))
            If strFlag <> "" And strFlag <> "=" Then
                strResult = strFlag & " " & strResult
            Else
                strResult = strResult
            End If
...
RST:
    strErrMsg = ""
    strErrMsg = strErrMsg & "위    치 : " & gHOSP.MACHNM & "_SerialRcvData_NX10N" & vbNewLine & vbNewLine
    strErrMsg = strErrMsg & "오류번호 : " & Err.Number & vbNewLine & vbNewLine
    strErrMsg = strErrMsg & "오류내용 : " & Err.Description & vbNewLine
    frmErrMsg.txtErr = vbNewLine & strErrMsg
    frmErrMsg.Show
...
Private Sub Phase_Serial_NX10N()
    Dim Buffer      As Variant
    Dim BufChar     As String
    Dim lngBufLen   As Long
    Dim i           As Long
