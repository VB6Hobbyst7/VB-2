...
Begin VB.Form frmInterface 
   ...
   Begin VB.Frame FrmHideControl 
      ...
      Begin VB.Frame Frame4 
         ...
         Begin FPSpread.vaSpread vasPrintBuf 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            SpreadDesigner  =   "frmInterface.frx":1800
         End
      End
      ...
      Begin FPSpread.vaSpread vasCode 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":1A18
      End
      Begin FPSpread.vaSpread vasTemp1 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":1C30
      End
         ...
         Begin MSComctlLib.ImageList imlStatus 
            ...
            BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
               ...
               BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":23D2
                  Key             =   "RUN"
               EndProperty
               BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":296C
                  Key             =   "NOT"
               EndProperty
               BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":2F06
                  Key             =   "STOP"
               EndProperty
               BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":34A0
                  Key             =   "LST"
               EndProperty
               BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":3D32
                  Key             =   "ITM"
               EndProperty
               BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":3E8C
                  Key             =   "ERR"
               EndProperty
               BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":3FE6
                  Key             =   "NOF"
               EndProperty
            EndProperty
         End
      ...
      Begin FPSpread.vaSpread vasList 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":4140
      End
      Begin FPSpread.vaSpread vasResTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":4358
      End
      Begin FPSpread.vaSpread vasTemp 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":4570
      End
      Begin FPSpread.vaSpread vasExcel 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":4788
      End
   ...
   Begin VB.PictureBox Picture2 
      ...
      Begin VB.Frame fraWork 
         ...
         Begin VB.ComboBox cboChk 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frmInterface.frx":49A0
            Left            =   9540
            List            =   "frmInterface.frx":49AD
            TabIndex        =   43
            Top             =   180
            Visible         =   0   'False
            Width           =   975
   ...
   Begin VB.Frame Frame1 
      ...
      Begin FPSpread.vaSpread vasID 
         ...
         SpreadDesigner  =   "frmInterface.frx":49C3
      End
      Begin FPSpread.vaSpread vasRes 
         ...
         RetainSelBlock  =   0   'False
         ScrollBars      =   2
         SpreadDesigner  =   "frmInterface.frx":563E
      End
   End
...
'''''                    '-- 같은 검사항목이 있는지 찾는다.
'''''                    SQL = ""
'''''                    SQL = SQL & "SELECT SAVESEQ,EXAMDATE "
'''''                    SQL = SQL & "  FROM PATRESULT"
'''''                    SQL = SQL & " WHERE EQUIPNO = '" & gEquip & "' "
'''''                    SQL = SQL & "   AND SAVESEQ = '" & strSaveSeq & "' "
'''''                    SQL = SQL & "   AND EXAMDATE = '" & strSaveDate & "' "
'''''                    'SQL = SQL & "   AND EQUIPCODE = '" & strIntBase & "' "
'''''
'''''                    Res = GetDBSelectColumn(gLocal, SQL)
'''''
...
'''''                            .BarNo = strBarNo
'''''                            .SpcPos = strSeq
'''''                            .RsltDate = Trim(gReadBuf(1))
'''''                            .RsltSeq = mGetP(Trim(gReadBuf(0)), 1, "-") & "-" & mGetP(Trim(gReadBuf(0)), 1, "-") + 1 'Trim(gReadBuf(0))
'''''                            .PatNo = strTestDate
'''''                        End With
'''''
'''''                    End If
                ...
                Else
                    ...
                    If Res > 0 Then
                        ...
                        With mResult
                            ...
                            .SpcPos = strSeq
                            .RsltDate = Trim(gReadBuf(1))
                            .RsltSeq = Trim(gReadBuf(0)) + 1 'mGetP(Trim(gReadBuf(0)), 1, "-") & "-" & mGetP(Trim(gReadBuf(0)), 2, "-") + 1 'Trim(gReadBuf(0))
                            .PatNo = strTestDate
                        End With
                    Else
                        mResult.RsltSeq = strSaveSeq '+ 1
                    End If
