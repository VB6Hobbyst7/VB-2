   ...
   Begin TabDlg.SSTab tabWork 
      ...
      Begin BHButton.BHImageButton cmdNext 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         TransparentPicture=   "frmComm.frx":9CF1
         ForeColor       =   16711680
         BackColor       =   255
         AlphaColor      =   255
         ImgOutLineSize  =   3
      ...
      Begin VB.ListBox List1 
         Height          =   2220
         ItemData        =   "frmComm.frx":AA53
         Left            =   7950
         List            =   "frmComm.frx":AA55
         TabIndex        =   44
         Top             =   6000
         Width           =   7215
      End
      Begin FPSpread.vaSpread spdResult2 
         ...
         SpreadDesigner  =   "frmComm.frx":AA57
         UserResize      =   0
      End
      ...
      Begin FPSpread.vaSpread spdRstview 
         ...
         ScrollBars      =   0
         ShadowColor     =   14735310
         SpreadDesigner  =   "frmComm.frx":AEA1
         UserResize      =   0
      End
      ...
      Begin FPSpread.vaSpread spdWorklist 
         ...
         ScrollBarMaxAlign=   0   'False
         ShadowColor     =   14735310
         SpreadDesigner  =   "frmComm.frx":B722
         UserResize      =   2
      End
      ...
      Begin Threed.SSPanel SSPanel1 
         ...
         Begin VB.ComboBox cboChk 
            Height          =   300
            ItemData        =   "frmComm.frx":BC5F
            Left            =   5160
            List            =   "frmComm.frx":BC69
            TabIndex        =   62
            Top             =   90
            Width           =   1095
         End
         Begin VB.ComboBox cboComNm 
            Height          =   300
            ItemData        =   "frmComm.frx":BC7D
            Left            =   4590
            List            =   "frmComm.frx":BC7F
            TabIndex        =   61
            Top             =   480
            Visible         =   0   'False
            Width           =   1725
      ...
      Begin Threed.SSPanel SSPanel 
         ...
         Begin VB.ComboBox cboOrdDt 
            Height          =   300
            ItemData        =   "frmComm.frx":BC81
            Left            =   4590
            List            =   "frmComm.frx":BC83
            TabIndex        =   89
            Top             =   90
            Visible         =   0   'False
            Width           =   1185
         ...
         Begin VB.ComboBox cboChk1 
            Height          =   300
            ItemData        =   "frmComm.frx":BC85
            Left            =   2610
            List            =   "frmComm.frx":BC8F
            TabIndex        =   88
            Top             =   90
            Visible         =   0   'False
            Width           =   1905
         ...
         Begin VB.ComboBox cboRstgbn 
            Height          =   300
            Index           =   1
            ItemData        =   "frmComm.frx":BCA3
            Left            =   5850
            List            =   "frmComm.frx":BCB0
            Style           =   2  '드롭다운 목록
            TabIndex        =   75
            Top             =   75
            Visible         =   0   'False
         ...
         Begin VB.ComboBox Combo2 
            Height          =   300
            ItemData        =   "frmComm.frx":BCDA
            Left            =   4590
            List            =   "frmComm.frx":BCDC
            TabIndex        =   74
            Top             =   480
            Visible         =   0   'False
            Width           =   1725
      ...
      Begin FPSpread.vaSpread tblexcel 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmComm.frx":BCDE
      End
...
On Error GoTo ErrorTrap
    CallForm = "clsCommon - Public Function f_subSet_WorkList() As ADODB.Recordset"
        ...
        Set AdoRs_SQL = New ADODB.Recordset
                 ...
                 sqlDoc = "Select DISTINCT R.RESULTDATE, P.PATID, P.PATNAME, R.SPCMNO "
        sqlDoc = sqlDoc & "  From RESULTOFNUM R, REGISTINFOS L, PATMST P "
        sqlDoc = sqlDoc & " Where R.RESULTDATE = '" & Format(Now, "yyyymmdd") & "'"
        sqlDoc = sqlDoc & "   And R.SPCMNO = '" & strBarno & "'"
        sqlDoc = sqlDoc & "   And R.ACPTDATE = L.ACPTDATE"
        sqlDoc = sqlDoc & "   And R.ACPTSEQ = L.ACPTSEQ"
        sqlDoc = sqlDoc & "   And R.PATID = P.PATID"

'--오더조회
'SELECT DISTINCT R.RESULTDATE, P.PATID, P.PATNAME, R.SPCMNO
'FROM RESULTOFNUM R, REGISTINFOS L, PATMST P
'WHERE  R.RESULTDATE =:조회일
'AND R.SPCMNO = :검체번호
'AND R.ACPTDATE = L.ACPTDATE
'AND  R.ACPTSEQ = L.ACPTSEQ
'AND  R.PATID = P.PATID
                ...
                For intCol = 8 To .MaxCols
                    ...
                    If Trim$(strResult) <> "" Then         '-- 결과값이 있으면
                        ...
                        If Not itemX Is Nothing Then
                           ...
                           If Index = 0 Then
                               If strTestCd <> "" Then
'                                             sqlDoc = " UPDATE cli.검사검체1v set 결과 = '" & strResult & "'"
'                                    sqlDoc = sqlDoc & "  WHERE 검체번호 = '" & strBarno & "'"
'                                    sqlDoc = sqlDoc & "    AND 품목코드 = '" & strTestCd & "'"
'                                    sqlDoc = sqlDoc & "    AND (처리구분코드 <> 'N' or 처리구분코드 <> 'R' or 처리구분코드 <> 'E') "
                                                                        
'--결과업데이트
'Update RESULTOFNUM
'SET     TEXTRESULTVAL = :결과값,
'RESULTINDATE = '날짜',
'RESULTINTIME = '시간',
'RESULTFLAG = 1
'WHERE   SPCMNO = :검체번호
'AND     RESULTITEMCODE IN
'        (SELECT RESULTITEMCODE FROM LABRSLTITEMBASES
'        WHERE   CHANNELNO = :CHANNELNO)
        
                                    '--결과업데이트
                                             sqlDoc = "Update RESULTOFNUM"
                                    sqlDoc = sqlDoc & "   Set TEXTRESULTVAL = '" & strResult & "',"
                                    sqlDoc = sqlDoc & "       RESULTINDATE  = '" & Format(Now, "yyyymmdd") & "',"
                                    sqlDoc = sqlDoc & "       RESULTINTIME  = '" & Format(Now, "hhmm") & "',"
                                    sqlDoc = sqlDoc & "       RESULTFLAG    = 1 "
                                    sqlDoc = sqlDoc & " Where SPCMNO = '" & strBarno & "'"
                                    sqlDoc = sqlDoc & "   And RESULTITEMCODE = '" & strTestCd & "'"
'                                    sqlDoc = sqlDoc & "   And RESULTITEMCODE IN "
'                                    sqlDoc = sqlDoc & "      (SELECT RESULTITEMCODE FROM LABRSLTITEMBASES"
'                                    sqlDoc = sqlDoc & "        WHERE   CHANNELNO = '" & strTestCd & "')"
            ...
            Select Case strType
                ...
                Case "P"    '## Patient
                    ...
                    If RecordChk = True Then
                        Do Until mAdoRs.EOF
                            'strSexAge = Trim(mAdoRs.Fields("성별코드")) & "/" & FindAge(Format(Trim(mAdoRs.Fields("생년월일")), "yyyymmdd"), "Y")
                            spdResult1.SetText 2, pGrid_Point, strBarno
                            spdResult1.SetText 3, pGrid_Point, Trim(mAdoRs.Fields("PATID"))
                            spdResult1.SetText 4, pGrid_Point, Trim(mAdoRs.Fields("PATNAME"))
                            spdResult1.SetText 5, pGrid_Point, "" 'strSexAge
                            mAdoRs.MoveNext
                        Loop
                    End If
                    Set mAdoRs = Nothing
...
'                                spdResult1.Col = 3: spdResult1.Row = pGrid_Point: strBarno = spdResult1.text
                                ...
                                '-- 키 추가 받은결과에서 서버저장용
                                spdResult1.GetText 3, pGrid_Point, strKey1  'PATID
                                spdResult1.GetText 5, pGrid_Point, strKey2  '성별/나이
