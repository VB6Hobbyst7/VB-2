...
Type RecvData
    ...
    LBQACPNUM   As String   '검사실접수번호
    LBQOCMNUM   As String   '내원번호
    RESODRSEQ   As String   '처방시퀀스
    RESSEQ      As String   '검사접수시퀀스
    RESSUBSEQ   As String   '검사접수서브시퀀스

    B1530_RESODRSEQ()   As String   '처방시퀀스
    B1530_RESSEQ()      As String   '검사접수시퀀스
    B1530_RESSUBSEQ()   As String   '검사접수서브시퀀스

    B1540_RESODRSEQ()   As String   '처방시퀀스
    B1540_RESSEQ()      As String   '검사접수시퀀스
    B1540_RESSUBSEQ()   As String   '검사접수서브시퀀스

    B1540A_RESODRSEQ()   As String   '처방시퀀스
    B1540A_RESSEQ()      As String   '검사접수시퀀스
    B1540A_RESSUBSEQ()   As String   '검사접수서브시퀀스
End Type
...
''검사결과 인터페이스 개체선언
Public LabResultObject As BITLabResultInterface.BITLabResultInterface
...
'    gQCEquip = Trim(frmInterface.txtTemp)
    ...
    db_tmp = ""
    Call GetPrivateProfileString("Server", "IFPart", "", db_tmp, 100, App.Path & "\Interface.ini")
    frmInterface.txtTemp = Trim(db_tmp)
    gPartCD = Trim(frmInterface.txtTemp)
