...
Begin VB.Form frmInterface 
   ...
   Begin VB.Frame FrmHideControl 
      ...
      Begin VB.ComboBox cboChk 
         ...
         EndProperty
         Height          =   315
         ItemData        =   "frmInterface.frx":3838
         Left            =   5970
         List            =   "frmInterface.frx":3845
         TabIndex        =   64
         Top             =   4050
         Visible         =   0   'False
         Width           =   975
      ...
      Begin VB.ComboBox cboTest 
         ...
         ForeColor       =   &H00FF0000&
         Height          =   300
         ItemData        =   "frmInterface.frx":385D
         Left            =   4140
         List            =   "frmInterface.frx":385F
         Style           =   2  '드롭다운 목록
         TabIndex        =   61
         Top             =   4110
         Visible         =   0   'False
      ...
      Begin VB.Frame Frame4 
         ...
         Begin FPSpread.vaSpread vasPrint 
            ...
            EndProperty
            MaxCols         =   9
            SpreadDesigner  =   "frmInterface.frx":3861
         End
         Begin FPSpread.vaSpread vasPrintBuf 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            SpreadDesigner  =   "frmInterface.frx":52DA
         End
      End
         ...
         Begin MSComctlLib.ImageList imlStatus 
            ...
            BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
               ...
               BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":5EAC
                  Key             =   "RUN"
               EndProperty
               BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":6446
                  Key             =   "NOT"
               EndProperty
               BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":69E0
                  Key             =   "STOP"
               EndProperty
               BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":6F7A
                  Key             =   "LST"
               EndProperty
               BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":780C
                  Key             =   "ITM"
               EndProperty
               BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":7966
                  Key             =   "ERR"
               EndProperty
               BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmInterface.frx":7AC0
                  Key             =   "NOF"
               EndProperty
            EndProperty
         End
      ...
      Begin FPSpread.vaSpread vasList 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmInterface.frx":7C1A
      End
...
'''    End If
    ...
    Set xlSheet = xlBook.Worksheets(1)
    Clipboard.Clear
    vasID.Col = 1:     vasID.Col2 = vasID.MaxCols
    vasID.Row = 0:     vasID.Row2 = vasID.MaxRows
    Clipboard.SetText vasID.Clip
    xlSheet.Paste
    xlSheet.Cells.EntireColumn.AutoFit
    xlSheet.Name = Format(Now, "yymmdd")
    Clipboard.Clear
    '=========================================
    
    xlBook.SaveAs ("C:\ULTRA검사결과_" & Format(Now, "yymmdd") & ".xls")
    xlApp.Quit
    
    MsgBox "엑셀저장완료" & vbNewLine & vbNewLine & "C:\ULTRA검사결과_" & Format(Now, "yymmdd") & ".xls", vbInformation, Me.Caption
...
'    Dim strAllStr   As String
    ...
    For lRow = 1 To vasID.DataRowCnt
        ...
        If vasID.Value = 1 Then
            ...
            For iRow = 1 To vasTemp.DataRowCnt
                ...
                If strResTemp = "" Then
                    strResTemp = strExamSeq & "," & sResult
                Else
                    strResTemp = strResTemp & "," & strExamSeq & "," & sResult
                End If
            Next iRow
    ...
    'Server 프로시져 실행 =================================================================================================================================================================
        Res = Shell("rsh " & gWebServer.IP & " -l " & gWebServer.ID & " /usr/local/9ias/10221/expect_test/exp_interface_java.sh clbdvt02m3 " & gEquip & " " & gExamUID & " u_stat=R", 0)
    '======================================================================================================================================================================================
...
Private Sub cmdRsltSearch_Click()
    ...
    If chkQC.Value = "1" Then
        'SQL = SQL & "  AND MID(BARCODE,1,7) = 'control'"
        SQL = SQL & "  AND BARCODE IN ('A_Positive','B_Positive','Negative','Blank_A+B+') "
    End If
        ...
        Do Until RS.EOF
            With vasID
                For i = 1 To .DataRowCnt
                    strDate = GetText(vasID, i, colEXAMDATE)
                    strChart = GetText(vasID, i, colBARCODE)
                    strSaveSeq = GetText(vasID, i, colSAVESEQ)
                    
                    If Trim(RS("EXAMDATE")) = strDate And Trim(RS("SAVESEQ")) = strSaveSeq And Trim(RS("바코드번호")) = strChart Then
                        blnSame = True
                    End If
...
'    '-- osw 추가
    ...
    Winsock1.LocalPort = CInt(gTCPPort)
    Winsock1.Listen
   ...
   ' On Error Resume Next
    ...
    Select Case comEqp.CommEvent
        ...
        Case comEvReceive
            ...
            'Res = Shell("C:\IF_EPOC\COM\EPOC.exe 3 C:\IF_EPOC\LOG N ", 0)
            
            'tmrEPOC.Interval = 100
...
Private Sub EditRcvDataASTM()
    ...
    For intCnt = 0 To UBound(strRecvData)
        ...
        If IsNumeric(strType) Then
            strType = Mid(mGetP(strRcvBuf, 1, "|"), 2, 1)
        End If
        strTemp1 = strRcvBuf
        ...
        Select Case strType
            Case "H"
            Case "P"
                strBarNo = Trim(mGetP(strRcvBuf, gBarPos, "|"))
        
                If Trim(strBarNo) = "01" Then
                   strBarNo = "A_Positive"
                ElseIf Trim(strBarNo) = "02" Then
                   strBarNo = "B_Positive"
                ElseIf Trim(strBarNo) = "03" Then
                   strBarNo = "Negative"
                ElseIf Trim(strBarNo) = "04" Then
                   strBarNo = "Blank_A+B+"
                End If
            ...
            Case "O"
            Case "R"
                strIntBase = Trim(mGetP(mGetP(strRcvBuf, gChalPos1, "|"), gChalPos2, "^"))
                If gRstType = "1" Then
                    strResult = Trim(mGetP(strRcvBuf, gQualPos, "|"))      '정량(=1)
                Else
                    strResult = Trim(mGetP(strRcvBuf, gQuanPos, "|"))      '정성(=2)
                    If UCase(Mid(strResult, 1, 1)) = "P" Then
                        strResult = "Positive"
                    Else
                        strResult = "Negative"
                    End If
...
'        End If
    ...
    ElseIf KeyCode = vbKeyReturn Then
        If iCol = colBARCODE Then
            ...
            '-- 바뀐 바코드로 환자정보 불러오기
            Call GetSampleInfoW_MEDIOUS(iRow)
