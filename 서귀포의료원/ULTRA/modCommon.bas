...
Type WebServer
    ...
    PW  As String
End Type
Public gWebServer As WebServer

Public gExamUID As String
Public Declare Function WinExec Lib "kernel32" (ByVal lpCmdLine As String, ByVal nCmdShow As Long) As Long

Public gTCPIP       As String
Public gTCPPort     As String
Public gRstType     As String
Public gBarPos      As String
Public gChalPos1    As String
Public gChalPos2    As String
Public gQualPos     As String
Public gQuanPos     As String
...
'    gQCEquip = Trim(frmInterface.txtTemp)
    ...
    db_tmp = ""
    Call GetPrivateProfileString("WebServer", "IP", "", db_tmp, 100, App.Path & "\Interface.ini")
    frmInterface.txtTemp = Trim(db_tmp)
    gWebServer.IP = Trim(frmInterface.txtTemp)
    
    db_tmp = ""
    Call GetPrivateProfileString("WebServer", "ID", "", db_tmp, 100, App.Path & "\Interface.ini")
    frmInterface.txtTemp = Trim(db_tmp)
    gWebServer.ID = Trim(frmInterface.txtTemp)
    
    db_tmp = ""
    Call GetPrivateProfileString("WebServer", "PW", "", db_tmp, 100, App.Path & "\Interface.ini")
    frmInterface.txtTemp = Trim(db_tmp)
    gWebServer.PW = Trim(frmInterface.txtTemp)
    ...
    '==================================================================================================
    db_tmp = ""
    Call GetPrivateProfileString("TCPIP", "IP", "", db_tmp, 20, App.Path & "\Interface.ini")
    frmInterface.txtTemp = Trim(db_tmp)
    gTCPIP = Trim(frmInterface.txtTemp)
    
    db_tmp = ""
    Call GetPrivateProfileString("TCPIP", "PORT", "", db_tmp, 20, App.Path & "\Interface.ini")
    frmInterface.txtTemp = Trim(db_tmp)
    gTCPPort = Trim(frmInterface.txtTemp)
        
    db_tmp = ""
    Call GetPrivateProfileString("RSTTYPE", "TYPE", "", db_tmp, 20, App.Path & "\Interface.ini")
    frmInterface.txtTemp = Trim(db_tmp)
    gRstType = Trim(frmInterface.txtTemp)
    
    db_tmp = ""
    Call GetPrivateProfileString("RSTTYPE", "BARPOS", "", db_tmp, 20, App.Path & "\Interface.ini")
    frmInterface.txtTemp = Trim(db_tmp)
    gBarPos = Trim(frmInterface.txtTemp)
    
    db_tmp = ""
    Call GetPrivateProfileString("RSTTYPE", "CHALPOS1", "", db_tmp, 20, App.Path & "\Interface.ini")
    frmInterface.txtTemp = Trim(db_tmp)
    gChalPos1 = Trim(frmInterface.txtTemp)
    
    db_tmp = ""
    Call GetPrivateProfileString("RSTTYPE", "CHALPOS2", "", db_tmp, 20, App.Path & "\Interface.ini")
    frmInterface.txtTemp = Trim(db_tmp)
    gChalPos2 = Trim(frmInterface.txtTemp)
    
    db_tmp = ""
    Call GetPrivateProfileString("RSTTYPE", "QUALPOS", "", db_tmp, 20, App.Path & "\Interface.ini")
    frmInterface.txtTemp = Trim(db_tmp)
    gQualPos = Trim(frmInterface.txtTemp)
        
    db_tmp = ""
    Call GetPrivateProfileString("RSTTYPE", "QUANPOS", "", db_tmp, 20, App.Path & "\Interface.ini")
    frmInterface.txtTemp = Trim(db_tmp)
    gQuanPos = Trim(frmInterface.txtTemp)
    '==================================================================================================
