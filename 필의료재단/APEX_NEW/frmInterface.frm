...
Begin VB.Form frmInterface 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin FPSpread.vaSpread vasRes 
         ...
         RetainSelBlock  =   0   'False
         ScrollBars      =   2
         SpreadDesigner  =   "frmInterface.frx":AF6C
      End
...
'pro_code  : gAssayNM.INHALANT_CD =  5150 ==> 5150-1
'exam_code :
...
'    SQL = SQL & "   AND R.검사코드 = E.검사코드 " & vbCr
...
'If strBarNo = "2017022107202" Then
'    Stop
'Else
'    GoTo Rst
'End If
