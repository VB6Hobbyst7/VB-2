            ...
            If lsID <> "" And strRegDate <> "" And sResult <> "" Then
                ...
                If strEqpCd = "1131" Or strEqpCd = "1132" Or strEqpCd = "1133" Then
                    ...
                    With cmdSQL
                        ...
                        Set prm3 = .CreateParameter("labmemo", adVarChar, adParamInput, 2000, sResult)
                        .Parameters.Append prm3
                        Set prm4 = .CreateParameter("employeecode", adVarChar, adParamInput, 30, gUserID)
                        .Parameters.Append prm4
                        Set prm5 = .CreateParameter("computerid", adVarChar, adParamInput, 30, CStr(frmInterface.Winsock1.LocalIP))
                        .Parameters.Append prm5
                        Set prm6 = .CreateParameter("overwrite", adVarChar, adParamInput, 1, "")
                        .Parameters.Append prm6
                        Set prm7 = .CreateParameter("updatecount", adVarChar, adParamInputOutput, 100, 0)
                        .Parameters.Append prm7
                        
                        .Execute
                        
                        
                        '형식 매개 변수 "@overwrite"이(가) OUTPUT 매개 변수로 선언되지 않았지만 실제 매개 변수가 요청된 출력에 전달되었습니다.
                ...
                Else
                    ...
                    With cmdSQL
                        ...
                        Set prm2 = .CreateParameter("receiptnum", adVarChar, adParamInput, 30, lsPid)
                        .Parameters.Append prm2
                        Set prm3 = .CreateParameter("labcode", adVarChar, adParamInput, 30, strEqpCd)
                        .Parameters.Append prm3
                        ...
                        .Parameters.Append prm6
                        Set prm7 = .CreateParameter("abnormal", adVarChar, adParamInput, 30, "")
                        .Parameters.Append prm7
...
'    SQL = SQL & " ORDER BY P.request_date, P.exam_no "
    ...
    SQL = SQL & "   AND E.학부코드 = 'E2' " & vbCr
    SQL = SQL & "   AND E.검사코드 IN ('" & gAssayNM.INHALANT_CD & "','" & gAssayNM.FOOD_CD & "','" & gAssayNM.ATOPY_CD & "') " & vbCr
