...
Public Function GetEquipExamCode_LIAISON(argEquipCode As String, argPID As String, Optional intRow As Long) As String
    ...
    Call SetText(frmMain.spdOrder, GetEquipExamCode_LIAISON, intRow, colINOUT)
    ...
    With frmMain
        ...
        If Not RsLocal.EOF = True And Not RsLocal.BOF = True Then
            Do Until RsLocal.EOF
                ...
                If strPatID <> "" And strTestCd <> "" And sResult <> "" And sResult <> "Err" Then
                    '-- 서버저장
                    ...
                    With AdoCmd
                        ...
                        'MsgBox CStr(frmMain.wSck.LocalIP)
...
'    Call SetCommStatus("R", pBarNo, frmMain.lstComStatus)
    ...
    With frmMain
        ...
        Call SetText(.spdOrder, mResult.Kind, intRow, colPNAME)
...
On Error GoTo DBErr
    ...
    If Len(strBarcode) <> gHOSP.BARLEN Then
        Exit Function
    End If
