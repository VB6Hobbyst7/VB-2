...
Private Sub spdWork_DblClick(ByVal Col As Long, ByVal Row As Long)
    ...
    strGubun_Work = GetText(spdWork, Row, colRACKNO)
    ...
    With frmMain.spdOrder
        ...
        For intORow = 1 To .MaxRows
            .Row = intORow
            .Col = colBARCODE
            If strBarno_Work = Trim(.Text) And strGubun_Work = GetText(frmMain.spdOrder, intORow, colRACKNO) Then
                blnSame = True
                Exit For
            End If
        Next
