...
Begin VB.Form frmInterface 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin FPSpread.vaSpread vasRes 
         ...
         RetainSelBlock  =   0   'False
         ScrollBars      =   2
         SpreadDesigner  =   "frmInterface.frx":7EA1
      End
   End
...
'                If Trim(mGetP(strRcvBuf, 16, "|")) = "I" Or Trim(mGetP(strRcvBuf, 16, "|")) = "Q" Then
'                    tmpKind = "QC"
'                End If
            ...
            Case "R"
                strIntBase = mGetP(mGetP(strRcvBuf, 3, "|"), 4, "^")
                            '부등호
                strResult = Trim$(mGetP(strRcvBuf, 7, "|")) & Trim$(mGetP(strRcvBuf, 4, "|"))
