...
'    gDBTYPE = Trim(strSetUp1)
    ...
    strSetup = "":    strSetUp1 = ""
    Call GetPrivateProfileString("G7", "SEQLEN", "", strSetup, 100, App.PATH & "\INI\" & gMACH & ".ini")
    strSetUp1 = Trim(strSetup)
    strSetUp1 = Mid(strSetUp1, 1, Len(strSetUp1) - 1)
    G7.SEQLEN = Trim(strSetUp1)
    
    strSetup = "":    strSetUp1 = ""
    Call GetPrivateProfileString("G7", "BARLEN", "", strSetup, 100, App.PATH & "\INI\" & gMACH & ".ini")
    strSetUp1 = Trim(strSetup)
    strSetUp1 = Mid(strSetUp1, 1, Len(strSetUp1) - 1)
    G7.BARLEN = Trim(strSetUp1)
