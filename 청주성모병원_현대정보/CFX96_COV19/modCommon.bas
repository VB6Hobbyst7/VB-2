...
'    gDBTYPE = Trim(strSetUp1)
    ...
    If gComm.COMTYPE <> "" Then
        ...
        strSetup = "":    strSetUp1 = ""
        Call GetPrivateProfileString("COMM", "COV19", "", strSetup, 100, App.PATH & "\INI\" & gMACH & ".ini")
        strSetUp1 = Trim(strSetup)
        strSetUp1 = Mid(strSetUp1, 1, Len(strSetUp1) - 1)
        gComm.COV19 = Trim(strSetUp1)
    
        strSetup = "":    strSetUp1 = ""
        Call GetPrivateProfileString("COMM", "COVCNT", "", strSetup, 100, App.PATH & "\INI\" & gMACH & ".ini")
        strSetUp1 = Trim(strSetup)
        strSetUp1 = Mid(strSetUp1, 1, Len(strSetUp1) - 1)
        gComm.COVCNT = Trim(strSetUp1)
