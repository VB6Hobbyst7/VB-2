...
Begin VB.Form frmMain 
   ...
   Begin FPSpread.vaSpread spdOrder 
      ...
      SpreadDesigner  =   "frmMain.frx":10D2
      ScrollBarTrack  =   3
      ShowScrollTips  =   3
   End
   ...
   Begin VB.PictureBox picComm 
      ...
      Begin FPSpread.vaSpread spdExcel 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "frmMain.frx":2E16
      End
   ...
   Begin VB.PictureBox picBottom 
      ...
      Begin FPSpread.vaSpread spdComStatus 
         ...
         ShadowColor     =   16777215
         SpreadDesigner  =   "frmMain.frx":4E14
         UserResize      =   0
         TextTip         =   2
         ScrollBarTrack  =   3
         ShowScrollTips  =   3
   ...
   Begin FPSpread.vaSpread spdResult 
      ...
      ScrollBarExtMode=   -1  'True
      ShadowColor     =   16777215
      SpreadDesigner  =   "frmMain.frx":6696
      ScrollBarTrack  =   3
      ShowScrollTips  =   3
   End
   ...
   Begin FPSpread.vaSpread spdWork 
      ...
      SelectBlockOptions=   0
      ShadowColor     =   16777215
      SpreadDesigner  =   "frmMain.frx":7324
      ScrollBarTrack  =   3
      ShowScrollTips  =   3
   End
...
Private Sub cmdOrder_Click()
    ...
    With spdOrder
        ...
        If optTest(0).Value = True Then
            ...
            MsgBox "MTB는 현재 오더 전송기능이 없습니다.", vbOKOnly + vbInformation, "오더전송"
            Exit Sub
    ...
    With frmMain
        For intR = 3 To spdExcel.MaxRows
            For intC = 1 To .spdExcel.MaxCols
                ...
                ElseIf intC = 6 Or intC = 8 Or intC = 10 Or intC = 12 Or intC = 14 Or intC = 16 Then
...
Private Sub Phase_File_CFX96()
    ...
    If spdExcel.MaxRows > 0 Then
        ...
        If gHOSP.MACHNM = "CFX96_MTB" Then
            
            Call FileRcvData_CFX96_MTB
        
        ElseIf gHOSP.MACHNM = "CFX96_RP19" Then
            
            Call FileRcvData_CFX96_RP19
        
        ElseIf gHOSP.MACHNM = "CFX96_RV6" Then
