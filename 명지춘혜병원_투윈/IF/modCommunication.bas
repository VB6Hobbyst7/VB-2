...
'                '-- HGB
'                If strTestCd = "HR06" Then
'                    SQL = SQL & "   And MASTERCODE IN ('HR01', 'HR06') " & vbCr
'                '-- HCT
'                ElseIf strTestCd = "HR07" Then
'                    SQL = SQL & "   And MASTERCODE IN ('HR01', 'HR07') " & vbCr
'                Else
'                    SQL = SQL & "   And MASTERCODE = 'HR01' " & vbCr
'                End If
